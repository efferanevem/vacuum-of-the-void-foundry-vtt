import { V as K, c as ae } from "./vacuum-of-the-void-BKbb_ATY.mjs";
class U extends Application {
  ...
  getData(t = {}) {
    var S, b, g, n, o, c, d, I, P, V, y, M, B, x;
    ...
    if (this._isWeaponAttack && ((n = (g = game.user) == null ? void 0 : g.targets) != null && n.size)) {
      ...
      a = (j == null ? void 0 : j.name) || (k == null ? void 0 : k.name) || "", (c = (o = j == null ? void 0 : j.statuses) == null ? void 0 : o.has) != null && c.call(o, "stunned") && (u = 1, f.push(game.i18n.localize("VOTV.RollSheet.AdvantageStunnedTarget"))), (I = (d = j == null ? void 0 : j.statuses) == null ? void 0 : d.has) != null && I.call(d, "dodge") && (r = 1, l.push(game.i18n.localize("VOTV.StatusDodge")));
    }
  ...
  async _doRoll(t) {
    ...
    if (e)
      try {
        const b = t.querySelector("[name='moraleDice']"), g = t.querySelector("[name='advantage']"), n = t.querySelector("[name='constantBonus']"), o = Math.min(3, Math.max(0, parseInt((b == null ? void 0 : b.value) ?? "0", 10) || 0)), c = Math.max(0, Number(((i = (s = e.system) == null ? void 0 : s.resources) == null ? void 0 : i.morale) ?? 0) || 0), d = Math.min(o, c), I = Math.min(3, Math.max(-3, parseInt((g == null ? void 0 : g.value) ?? "0", 10) || 0)), P = parseInt((n == null ? void 0 : n.value) ?? "0", 10) || 0, V = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, y = this._isWeaponAttack ? 0 : this._injuryModifier, M = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, x = ((_ = (m = e.statuses) == null ? void 0 : m.has) == null ? void 0 : _.call(m, "diseased")) || ((a = (h = e.statuses) == null ? void 0 : h.has) == null ? void 0 : a.call(h, "poisoned")) ? -1 : 0, N = V + y + M + P + x, k = [
          "3d6",
...
function ie(w, t, e) {
  var a, u;
  if (!w) return;
  const s = Number(((u = (a = w.system) == null ? void 0 : a.skills) == null ? void 0 : u[t]) ?? 0) || 0, i = K.BODY_PART_BY_SKILL[t] ? K._getSkillHealthStatusStatic(w, t) : void 0;
  let m = 0;
  i === 1 ? m = -6 : i === 2 && (m = -3);
...
//# sourceMappingURL=roll-sheet-tdBL3W3x.mjs.map
