...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], C = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, T = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Fe = O.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), A = (((Ee = O.slot3) == null ? void 0 : Ee.itemId) ?? "").trim(), U = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, D) => {
      ...
      const Ne = D && ((qe = f.system) != null && qe.damage) ? f.system.damage : "", se = D && typeof ((ke = f.system) == null ? void 0 : ke.range) == "string" ? (f.system.range || "").trim() : "", Oe = J ? Number((ve = b[J]) == null ? void 0 : ve.bonus) || 0 : "";
      return {
        id: f.id,
        name: f.name,
        img: f.img,
    ...
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", V = q.filter((f) => {
    ...
    const le = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((f) => f.type === "Pancel");
    e.armorTable = le.map((f) => {
      var L, M;
    ...
    const ue = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((f) => f.type === "MikroChip"), ee = ue.map((f) => ({ id: f.id, name: f.name, img: f.img })), te = "— Nincs Mikro-Chip —", ye = ["slot1", "slot2", "slot3"], de = (f) => {
      var _, L, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = ee.filter((f) => !de(1).includes(f.id)), e.microchipItemsSlot2 = ee.filter((f) => !de(2).includes(f.id)), e.microchipItemsSlot3 = ee.filter((f) => !de(3).includes(f.id)), e.microchipSlots = ye.map((f) => {
      const D = O[f] ?? {}, _ = (D.itemId ?? "").trim(), L = ue.find((M) => M.id === _);
      return {
        slotKey: f,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || te,
        img: (L == null ? void 0 : L.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((f) => {
      const D = `slot${f}`, _ = O[D] ?? {}, L = (_.itemId ?? "").trim(), M = ee.find((J) => J.id === L);
      e[`microchip${f}ItemId`] = L, e[`microchip${f}DisplayName`] = (M == null ? void 0 : M.name) || _.name || te, e[`microchip${f}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = ue.map((f) => {
      var fe, Ce, qe, ke;
      const D = f.id;
      let _ = null;
      for (const ve of ye)
        if ((((fe = O[ve]) == null ? void 0 : fe.itemId) ?? "").trim() === D) {
          _ = ve;
          break;
        }
    ...
    const ge = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((f) => {
      var D, _, L;
      return {
        id: f.id,
        name: f.name,
      ...
      const D = ge[f] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-3wYSKKGt.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-3wYSKKGt.mjs");
      l(this.actor, a, n);
      ...
      if (!p) return;
      const b = ((C = (q = this.actor.items).get) == null ? void 0 : C.call(q, p)) ?? ((T = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : T.call(O, (A) => A.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], C = q.find((O) => {
          var T;
          return (((T = b[O]) == null ? void 0 : T.itemId) ?? "").trim() === a;
        });
        if (C) {
          const O = q.filter((T) => T !== C);
          p["system.weapons.slotOrder"] = O.join(","), p[`system.weapons.${C}.itemId`] = "", p[`system.weapons.${C}.name`] = "", p[`system.weapons.${C}.damage`] = "", p[`system.weapons.${C}.bonus`] = "";
        }
      }
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((C = n == null ? void 0 : n.system) == null ? void 0 : C.damage) ?? "",
      ...
      const C = p ? this.actor.items.get(p) : null, O = {
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((C = n.system) == null ? void 0 : C.damage) ?? "",
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, q = (I.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = q ? q.split(/\s*,\s*/).filter((S) => C.includes(S)) : [], T = O.filter((S) => {
              var A;
              return (((A = I[S]) == null ? void 0 : A.itemId) ?? "").trim() === v;
            });
            if (T.length > 0) {
              const A = {
                "system.weapons.slotOrder": O.filter((N) => !T.includes(N)).join(",")
              };
              for (const N of T)
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, V, we, Ie, le, Se, Te, ue, ee, te, ye, de, ge;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const he = !!x, W = (k == null ? void 0 : k.system) ?? {}, Pe = typeof W.range == "string" ? (W.range || "").trim() : "", me = W.type ?? "", be = (l[me] ?? me) || "—", pe = W.size ?? "", _e = (p[pe] ?? pe) || "", De = [be, _e].filter(Boolean).join(", ") || be || "—", Me = me === "projectile" || pe === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const T = (((ue = e.weaponsTable) == null ? void 0 : ue.length) ?? 0) > 0 || (((ee = e.armorTable) == null ? void 0 : ee.length) ?? 0) > 0 || (((te = e.microchipsTable) == null ? void 0 : te.length) ?? 0) > 0 || (((ye = e.itemsTable) == null ? void 0 : ye.length) ?? 0) > 0 || (((de = e.egyebList) == null ? void 0 : de.length) ?? 0) > 0;
    e.showEquipmentDropZone = !T;
    const S = ((ge = t == null ? void 0 : t.system) == null ? void 0 : ge.abilities) ?? {}, A = o.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-3wYSKKGt.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
      ...
      const n = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, p = (Array.isArray((O = n[r]) == null ? void 0 : O.items) ? n[r].items.slice() : []).filter((T) => T !== a);
      ...
      const a = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((q) => {
        var C;
        return (((C = a[q]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, a, n, l, p, b, v, I, q, C, O, T;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((T = (O = c.system) == null ? void 0 : O.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((U) => {
        var H;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, y, m, g) => {
    ...
    for (const S of l)
      ((q = S.document) == null ? void 0 : q.id) !== h || ((C = S.document) == null ? void 0 : C.documentName) !== "Actor" || ((O = S.constructor) == null ? void 0 : O.name) !== "VoidKarakterSheet" || a.includes(S) || a.push(S);
    if (r && a.some((S) => {
  ...
  if (y) {
    ...
    if (c && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (!y.querySelector(".votv-weapon-outcome")) {
        ...
        const p = !!u.isHit, b = Number(u.defense ?? 0) || 0, v = u.targetName || "Célpont";
        l.textContent = p ? `Találat – ${v} (VÉ: ${b})` : `Nem talált – ${v} (VÉ: ${b})`, a.appendChild(l);
      }
      if (u.isHit && !y.querySelector(".votv-weapon-damage-chat")) {
        const p = document.createElement("button");
        p.type = "button", p.className = "votv-weapon-damage-chat", p.textContent = "Sebzés", p.dataset.actorId = u.actorId || ((i = E.speaker) == null ? void 0 : i.actor) || "", p.dataset.itemId = u.itemId || "", p.dataset.slotKey = u.slotKey || "", a.appendChild(p), p.addEventListener("click", async (b) => {
          var H, Z, G, V, we, Ie, le, Se, Te, ue, ee, te, ye, de;
          b.preventDefault(), b.stopPropagation();
          const v = b.currentTarget.dataset.actorId || "", I = b.currentTarget.dataset.itemId || "", q = b.currentTarget.dataset.slotKey || "", C = v && ((H = game.actors) == null ? void 0 : H.get(v)) || ((Z = E.speaker) == null ? void 0 : Z.actor) && ((G = game.actors) == null ? void 0 : G.get(E.speaker.actor)) || null;
          if (!C) return;
          let O = I ? ((we = (V = C.items) == null ? void 0 : V.get) == null ? void 0 : we.call(V, I)) ?? ((Se = (le = (Ie = C.items) == null ? void 0 : Ie.contents) == null ? void 0 : le.find) == null ? void 0 : Se.call(le, (ge) => ge.id === I)) : null;
          if (!O || O.type !== "Fegyver") return;
          let T = (((Te = O.system) == null ? void 0 : Te.damage) ?? "").trim();
          if (!T && q && (T = (((((ue = C.system) == null ? void 0 : ue.weapons) ?? {})[q] ?? {}).damage ?? "").trim()), !T) {
            (de = (ee = ui.notifications) == null ? void 0 : ee.warn) == null || de.call(
              ee,
              ((ye = (te = game.i18n) == null ? void 0 : te.localize) == null ? void 0 : ye.call(te, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája."
            );
            return;
          }
          const S = new Roll(T);
          await S.evaluate({ async: !0 });
          const A = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, N = u.targetName || "", U = N ? `${O.name} – sebzés – ${N}` : `${O.name} – sebzés`;
          await S.toMessage({
            speaker: ChatMessage.getSpeaker({ actor: C }),
            flavor: U,
            flags: { "vacuum-of-the-void": {} },
            rollMode: A
          });
...
//# sourceMappingURL=vacuum-of-the-void-DiqgkRbw.mjs.map
