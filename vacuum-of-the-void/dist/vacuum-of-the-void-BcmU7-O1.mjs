...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const p of u) {
      const _ = ((oe = d[p]) == null ? void 0 : oe.value) ?? 0, T = c[p] ?? 0;
      e.computedHealthStatus[p] = U._healthStatusFromRatio(T, _);
    }
    ...
    for (const [p, _] of Object.entries(y)) {
      const T = e.computedHealthStatus[_];
      e.skillHealthStatus[p] = T, e.skillDisabled[p] = T === 0 ? " disabled" : "", e.skillHasHealthTint[p] = !0;
    }
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], L = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, D = L && typeof L == "object" && !Array.isArray(L) ? L : {}, O = (((Ke = D.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = D.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), E = (((Te = D.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, _) => {
      const T = typeof p.sort == "number" ? p.sort : 0, C = typeof _.sort == "number" ? _.sort : 0;
      return T - C;
    }).map((p) => {
      var ce, be, ke, de, me, Pe;
      const _ = p.type === "Fegyver", T = p.type === "MikroChip";
      let C = 0, x = "", Y = null;
      ...
      const Le = _ && ((ke = p.system) != null && ke.damage) ? p.system.damage : "", Z = _ && typeof ((de = p.system) == null ? void 0 : de.range) == "string" ? (p.system.range || "").trim() : "", he = Y ? Number((me = b[Y]) == null ? void 0 : me.bonus) || 0 : "";
      return {
        id: p.id,
        name: p.name,
        img: p.img,
    ...
    e.weaponsTable = B.map((p) => {
      ...
      let T = null, C = {};
      for (const Be of q)
        if ((((ot = b[Be]) == null ? void 0 : ot.itemId) ?? "").trim() === _) {
          T = Be, C = b[Be] ?? {};
          break;
        }
    ...
    e.armorTable = Ne.map((p) => {
      var C, x;
      const _ = (p == null ? void 0 : p.system) ?? {}, T = ((C = p.system) == null ? void 0 : C.equipped) !== void 0 && ((x = p.system) == null ? void 0 : x.equipped) !== null ? !!p.system.equipped : !1;
      return {
        itemId: p.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = $e.map((p) => {
      const _ = (p == null ? void 0 : p.system) ?? {}, T = (_.description ?? "").trim(), C = T ? T.length > 60 ? T.slice(0, 57) + "…" : T : "—", x = _.quantity != null ? String(_.quantity).trim() : "1";
      return {
        itemId: p.id,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), fe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), _e = "— Nincs Mikro-Chip —", De = ["slot1", "slot2", "slot3"], Ie = (p) => {
      var T, C, x;
      const _ = [];
      return p !== 1 && _.push((((T = D.slot1) == null ? void 0 : T.itemId) ?? "").trim()), p !== 2 && _.push((((C = D.slot2) == null ? void 0 : C.itemId) ?? "").trim()), p !== 3 && _.push((((x = D.slot3) == null ? void 0 : x.itemId) ?? "").trim()), _.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((p) => !Ie(1).includes(p.id)), e.microchipItemsSlot2 = fe.filter((p) => !Ie(2).includes(p.id)), e.microchipItemsSlot3 = fe.filter((p) => !Ie(3).includes(p.id)), e.microchipSlots = De.map((p) => {
      const _ = D[p] ?? {}, T = (_.itemId ?? "").trim(), C = we.find((x) => x.id === T);
      return {
        slotKey: p,
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || _.name || _e,
        img: (C == null ? void 0 : C.img) || "",
        active: _.active === !0
      };
    }), ["1", "2", "3"].forEach((p) => {
      const _ = `slot${p}`, T = D[_] ?? {}, C = (T.itemId ?? "").trim(), x = fe.find((Y) => Y.id === C);
      e[`microchip${p}ItemId`] = C, e[`microchip${p}DisplayName`] = (x == null ? void 0 : x.name) || T.name || _e, e[`microchip${p}Img`] = (x == null ? void 0 : x.img) || "";
    }), e.microchipsTable = we.map((p) => {
      var ce, be, ke, de;
      const _ = p.id;
      let T = null;
      for (const me of De)
        if ((((ce = D[me]) == null ? void 0 : ce.itemId) ?? "").trim() === _) {
          T = me;
          break;
        }
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      ...
      return {
        ...
        name: p.name,
        img: p.img,
        kind: ((_ = p.system) == null ? void 0 : _.kind) ?? "passive",
      ...
      const _ = Ce[p] ?? {}, T = (_.itemId ?? "").trim(), C = T ? F.get(T) : null, x = (C == null ? void 0 : C.description) ?? "", Y = (C == null ? void 0 : C.kp) ?? 0;
      return {
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || _.name || N,
        img: (C == null ? void 0 : C.img) || "",
        description: x,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BQQM3imF.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((y = r.textContent) == null ? void 0 : y.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-BQQM3imF.mjs");
      l(this.actor, a, n);
      ...
      if (!y) return;
      const b = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, y)) ?? ((O = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : O.call(D, (E) => E.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((D) => I.includes(D)) : [], L = q.find((D) => {
          var O;
          return (((O = b[D]) == null ? void 0 : O.itemId) ?? "").trim() === a;
        });
        if (L) {
          const D = q.filter((O) => O !== L);
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.bonus`]: ((D = n == null ? void 0 : n.system) == null ? void 0 : D.bonus) ?? ""
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.bonus`]: ((D = n.system) == null ? void 0 : D.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (I) {
        const O = v.filter((S) => S !== I);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, q = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = q ? q.split(/\s*,\s*/).filter((S) => L.includes(S)) : [], O = D.filter((S) => {
              var E;
              return (((E = I[S]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (O.length > 0) {
              const E = {
                "system.weapons.slotOrder": D.filter((M) => !O.includes(M)).join(",")
              };
              for (const M of O)
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Q, pe, Ee, Fe, Ne, $e, xe, we, fe, _e, De, Ie, Ce;
    ...
    const O = (((we = e.weaponsTable) == null ? void 0 : we.length) ?? 0) > 0 || (((fe = e.armorTable) == null ? void 0 : fe.length) ?? 0) > 0 || (((_e = e.microchipsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((De = e.itemsTable) == null ? void 0 : De.length) ?? 0) > 0 || (((Ie = e.egyebList) == null ? void 0 : Ie.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-BQQM3imF.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
      ...
      const n = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, y = (Array.isArray((D = n[r]) == null ? void 0 : D.items) ? n[r].items.slice() : []).filter((O) => O !== a);
  ...
  async _onDropItem(s, e) {
    var f, h, i, r, a, n, l, y, b, v, I, q, L, D, O;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((O = (D = c.system) == null ? void 0 : D.gear) == null ? void 0 : O.microchips) ?? {}, M = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
...
//# sourceMappingURL=vacuum-of-the-void-BcmU7-O1.mjs.map
