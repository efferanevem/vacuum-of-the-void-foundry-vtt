...
const { NumberField: de, StringField: Be } = foundry.data.fields;
...
const { NumberField: wt, StringField: He } = foundry.data.fields;
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-CIqCWxUb.mjs");
      c(this.actor, r);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (n) => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, r = l.dataset.skill, c = ((f = l.textContent) == null ? void 0 : f.trim()) || r, { openRollSheetForSkill: m } = await import("./roll-sheet-CIqCWxUb.mjs");
      m(this.actor, r, c);
...
U(H, "PARTS", foundry.utils.mergeObject(P(H, H, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Xe = P(H, H, "DEFAULT_OPTIONS")) == null ? void 0 : Xe.form) ?? {}, { submitOnChange: !1 })
}));
let fe = H;
var Ze;
...
//# sourceMappingURL=vacuum-of-the-void-D7odZpOI.mjs.map
