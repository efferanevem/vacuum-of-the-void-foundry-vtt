...
function nt(F) {
  ...
  p(F.terms, 1);
  const r = i.filter((n) => n === 6).length, a = i.filter((n) => n === 1).length, m = e.filter((n) => n === 6).length, u = t.filter((n) => n === 6).length, y = r + m, g = a + u;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const u = this.element, y = this.form ?? this.element, g = a.scrollState, n = a.focus, d = typeof (g == null ? void 0 : g.formScrollTop) == "number" || typeof (g == null ? void 0 : g.windowScrollTop) == "number", o = () => {
      var l, h;
      if (this._applyScrollState(u, g), (n == null ? void 0 : n.name) != null || (n == null ? void 0 : n.id) != null) {
      ...
      this._applyScrollState(u, g);
    };
    return (d || n) && (requestAnimationFrame(o), setTimeout(o, 0), setTimeout(o, 50), setTimeout(o, 150), setTimeout(o, 300), setTimeout(o, 450)), m;
  }
  /**
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const r of i) {
      const a = String(((p = r.system) == null ? void 0 : p.speedPenalty) ?? "").trim().replace(",", "."), m = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const r of i) {
      const a = String(((p = r.system) == null ? void 0 : p.protectionBonus) ?? "").trim().replace(",", "."), m = Number(a);
      Number.isFinite(m) && (e += m);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((d = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : d.resources) ?? {}, p = ((c = (o = s.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, r = ((l = s.currentHealth) == null ? void 0 : l.legs) ?? 0, a = x._healthStatusFromRatio(r, p), m = Number(((v = (b = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let u;
    a === 0 ? u = 0 : a === 1 ? u = -6 : a === 2 ? u = -3 : u = m;
    const y = this._getTotalArmorSpeedPenalty();
    u += y, t.textContent = String(u);
  }
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const p = (Number(((u = (m = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : m.combat) == null ? void 0 : u.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((r = this.actor.system) == null ? void 0 : r.resources) ?? {}, s = ((m = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : m.value) ?? 0, p = ((u = t.currentHealth) == null ? void 0 : u[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const s = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, p = ((u = (m = s.hitLocations) == null ? void 0 : m[t]) == null ? void 0 : u.value) ?? 0, r = ((y = s.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return x._healthStatusFromRatio(r, p);
  }
  async _prepareContext(i) {
    var Ee, Ne, $e, xe, je, Re, Me, Ke, Ue, Be, He, Ge, ze, We, Ye, Qe, Je, Xe;
    ...
    for (const f of a) {
      const S = ((xe = p[f]) == null ? void 0 : xe.value) ?? 0, T = r[f] ?? 0;
      e.computedHealthStatus[f] = x._healthStatusFromRatio(T, S);
    }
    const m = (Number(r.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((f) => (Number(r[f]) || 0) === 0).length;
    ...
    let d;
    g === 0 ? d = 0 : g === 1 ? d = -6 : g === 2 ? d = -3 : d = n;
    const o = this._getTotalArmorSpeedPenalty();
    d += o, e.effectiveGivenSpeed = d;
    const l = (Number(((Ke = (Me = this.actor.system) == null ? void 0 : Me.combat) == null ? void 0 : Ke.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: d, givenProtection: l } },
      { inplace: !1 }
    );
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), D = I ? I.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], C = (Ue = this.actor.system.gear) == null ? void 0 : Ue.microchips, q = C && typeof C == "object" && !Array.isArray(C) ? C : {}, w = (((Be = q.slot1) == null ? void 0 : Be.itemId) ?? "").trim(), E = (((He = q.slot2) == null ? void 0 : He.itemId) ?? "").trim(), N = (((Ge = q.slot3) == null ? void 0 : Ge.itemId) ?? "").trim(), wt = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, S) => {
      ...
      let M = null;
      T && (w === f.id ? M = "slot1" : E === f.id ? M = "slot2" : N === f.id && (M = "slot3"));
    ...
    e.weaponsTable = de.map((f) => {
      ...
      const L = !!T, K = ((Ve = f.system) == null ? void 0 : Ve.equipped) !== void 0 && ((et = f.system) == null ? void 0 : et.equipped) !== null ? !!f.system.equipped : L, M = (f == null ? void 0 : f.system) ?? {}, ne = typeof M.range == "string" ? (M.range || "").trim() : "", H = M.type ?? "", ee = (Tt[H] ?? H) || "—", X = M.size ?? "", te = (St[X] ?? X) || "", ie = [ee, te].filter(Boolean).join(", ") || ee || "—", Z = H === "projectile" || X === "thrown", V = M.quantity, ae = V != null ? String(V).trim() : "1", re = String(O.bonus ?? "").trim(), oe = String(M.bonus ?? "").trim(), Lt = re || oe || "0";
      return {
        slotKey: T ?? "",
        itemId: S,
    ...
    e.microchipItemsSlot1 = ce.filter((f) => !pe(1).includes(f.id)), e.microchipItemsSlot2 = ce.filter((f) => !pe(2).includes(f.id)), e.microchipItemsSlot3 = ce.filter((f) => !pe(3).includes(f.id)), e.microchipSlots = qe.map((f) => {
      ...
      const O = !!T, L = ((te = f == null ? void 0 : f.system) == null ? void 0 : te.abilityType) ?? "", K = L === "active" ? "Aktív" : L === "passive" ? "Passzív" : L || "—", M = L === "active", ne = Number((ie = f == null ? void 0 : f.system) == null ? void 0 : ie.replaceCost) >= 0 ? Number(f.system.replaceCost) : 0, H = (((Z = f == null ? void 0 : f.system) == null ? void 0 : Z.description) ?? "").trim(), ee = H ? H.length > 60 ? H.slice(0, 57) + "…" : H : "—";
      return {
        itemId: S,
        actorId: this.actor.id,
        name: (f == null ? void 0 : f.name) ?? "—",
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-U1KeGslo.mjs");
      c(this.actor, o);
    }), t.on("click", ".karakter-weapon-damage", async (n) => {
      var c, l, h;
      n.preventDefault(), n.stopPropagation();
      const d = n.currentTarget;
      let o = (d.dataset.itemId ?? "").trim();
      if (!o) {
        const b = (d.dataset.slot ?? "").trim();
        if (!b) return;
        o = (((((l = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : l.weapons) ?? {})[b] ?? {}).itemId ?? "").trim();
      }
      o && await this._rollWeaponDamage(o, ((h = d.dataset.slot) == null ? void 0 : h.trim()) ?? "");
    }), !this.isEditable) return;
    const s = (n) => {
      var c;
      const d = n ? n.currentTarget : (c = e.querySelector) == null ? void 0 : c.call(e, 'input[name="system.resources.stress.value"]');
      if (!d) return;
      const o = Number(d.value) || 0;
      d.classList.toggle("karakter-stress-over-10", o > 10);
    };
    ...
    p && s({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var c, l, h;
      n.preventDefault(), n.stopPropagation();
      const d = ((h = (l = (c = foundry.applications) == null ? void 0 : c.apps) == null ? void 0 : l.FilePicker) == null ? void 0 : h.implementation) ?? globalThis.FilePicker;
      new d({
        type: "image",
      ...
      var h;
      n.preventDefault();
      const d = n.currentTarget, o = d.dataset.skill, c = ((h = d.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-U1KeGslo.mjs");
      l(this.actor, o, c);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const d = n.currentTarget, o = d.dataset.itemId;
      if (!o) return;
      const c = this.actor.items.get(o);
      if (!c) return;
      let l = Number(d.value);
      ...
      var C, q;
      const d = n.currentTarget, o = (d.dataset.itemId ?? "").trim();
      if (!o) return;
      const c = this.actor.items.get(o);
      ...
      const o = d.closest(".karakter-microchip-slot-select-wrap"), c = o == null ? void 0 : o.classList.contains("karakter-microchip-slot-open");
      ...
      var w;
      n.preventDefault();
      const d = n.currentTarget, o = d.closest(".karakter-microchip-slot-select-wrap"), c = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), l = c == null ? void 0 : c.dataset.slot;
      if (!l) return;
      const h = (d.dataset.itemId ?? "").trim(), b = (d.dataset.itemName ?? ((w = d.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", v = (d.dataset.itemImg ?? "").trim(), I = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = b);
      ...
      if (!d) return;
      const o = this.actor.items.get(d);
      ...
      const c = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((I) => {
        var D;
        return (((D = c[I]) == null ? void 0 : D.itemId) ?? "").trim() === d;
      });
      ...
      await this.actor.update({ [`system.gear.microchips.${d}.active`]: o }), this.render(!0);
    }), t.find(".karakter-microchip-slot").each((n, d) => {
      const o = d.dataset.slot;
      d.addEventListener("dragover", (c) => this._onMicrochipSlotDragOver(c, o)), d.addEventListener("dragleave", (c) => {
        var l;
        return (l = c.currentTarget) == null ? void 0 : l.classList.remove("karakter-microchip-slot-drag-over");
      }), d.addEventListener("drop", (c) => this._onMicrochipSlotDrop(c, o));
    }), t.find(".karakter-ability-slot-single").each((n, d) => {
      const o = d.dataset.slot;
      o && (d.addEventListener("dragover", (c) => this._onAbilitySingleDragOver(c, o)), d.addEventListener("dragleave", (c) => {
        var l;
        return (l = c.currentTarget) == null ? void 0 : l.classList.remove("karakter-ability-slot-drag-over");
      }), d.addEventListener("drop", (c) => {
        var l;
        (l = c.currentTarget) == null || l.classList.remove("karakter-ability-slot-drag-over");
      }));
    }), t.find(".karakter-ability-area").each((n, d) => {
      const o = d.dataset.area;
      o && (d.addEventListener("dragover", (c) => this._onAbilityAreaDragOver(c, o)), d.addEventListener("dragleave", (c) => {
        var l;
      ...
      var b;
      if (n.preventDefault(), !n.altKey) return;
      const d = n.currentTarget.dataset.area, o = n.currentTarget.dataset.itemId;
      if (!d || !o) return;
      const c = this.actor.system.abilities ?? {}, h = (Array.isArray((b = c[d]) == null ? void 0 : b.items) ? c[d].items.slice() : []).filter((v) => v !== o);
      await this.actor.update({ [`system.abilities.${d}.items`]: h });
      ...
      if (!o) return;
      const c = this.actor.items.get(o);
      !c || c.type !== "Pancel" || (await c.update({ "system.equipped": d.checked }), this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection());
      ...
      if (!d) return;
      const o = this.actor.items.get(d);
      !o || o.type !== "Pancel" || await this.actor.deleteEmbeddedDocuments("Item", [d]);
      ...
      if (!d) return;
      const o = this.actor.items.get(d);
      !o || o.type !== "Targy" && o.type !== "Egyeb" || await this.actor.deleteEmbeddedDocuments("Item", [d]);
    });
    const a = this, m = (n) => {
      var c, l, h, b;
      if (!n) return;
      const d = a._getFormDataForUpdate(n);
      if (Object.keys(d).length === 0) return;
      const o = ((l = (c = d.system) == null ? void 0 : c.resources) == null ? void 0 : l.currentHealth) != null || ((b = (h = d.system) == null ? void 0 : h.resources) == null ? void 0 : b.hitLocations) != null;
      a.actor.update(d).then(() => {
        o && setTimeout(() => a.render(!0), 260);
      }).catch((v) => console.warn("VoidKarakterSheet save failed", v));
    }, u = (n) => {
      var d, o, c;
      return n && (((o = (d = a.element) == null ? void 0 : d.contains) == null ? void 0 : o.call(d, n)) || a.id && ((c = n.closest) == null ? void 0 : c.call(n, `#${CSS.escape(a.id)}`)));
    };
    a._votvBlur = (n) => {
      var h;
      const d = n.target;
      ...
      l && (c.contains(l) || a.id && ((h = l.closest) != null && h.call(l, `#${CSS.escape(a.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), m(c));
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          const h = this.actor, b = ((u = l.parent) == null ? void 0 : u.id) !== h.id;
          let v = l.id;
          if (b) {
        ...
        if (l && l.documentName === "Item" && l.type === "MikroChip") {
          const h = this.actor;
          ((d = l.parent) == null ? void 0 : d.id) !== h.id && await h.createEmbeddedDocuments("Item", [l.toObject()]);
          return;
        }
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((m = i.dataTransfer) == null ? void 0 : m.getData("text/plain")) || ((u = i.dataTransfer) == null ? void 0 : u.getData("application/json")) || "";
    let s;
    try {
      s = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
    ...
    if (((y = p.parent) == null ? void 0 : y.id) !== this.actor.id) {
      const d = foundry.utils.mergeObject(p.toObject(), { system: { ...p.toObject().system ?? {}, equipped: !1 } });
  ...
  async _onInventoryRowDrop(i, e) {
    var u, y;
    i.preventDefault(), (u = i.currentTarget) == null || u.classList.remove("karakter-actions-row-drag-over");
    ...
    const p = this.actor.items.contents.slice().sort((g, n) => {
      const d = typeof g.sort == "number" ? g.sort : 0, o = typeof n.sort == "number" ? n.sort : 0;
      return d - o;
  ...
  async _postItemToChat(i) {
    ...
    let s, p = "";
    if (e.type === "MikroChip") {
      const g = ((u = e.system) == null ? void 0 : u.abilityType) ?? "passive";
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", s = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, p = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", m = p ? `<p>${p}</p>` : "", u = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = s.parent) == null ? void 0 : a.id) !== this.actor.id) {
      const u = foundry.utils.mergeObject(s.toObject(), { type: "Kepesseg" });
      p = ((m = (await this.actor.createEmbeddedDocuments("Item", [u]))[0]) == null ? void 0 : m.id) ?? p;
    }
    await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    r === 1 ? p -= 6 : r === 2 && (p -= 3);
    const m = `3d6${p !== 0 ? p > 0 ? `+${p}` : `${p}` : ""}`, u = new Roll(m);
    await u.evaluate({ async: !0 });
    const { resultType: y, label: g } = nt(u), n = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    ...
    const a = r && r.name || t.name || `Fegyver (${i})`, m = Number(t.bonus || 0) || 0, y = (((v = r == null ? void 0 : r.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", g = Number(s[y] || 0) || 0, n = m + g, o = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, c = new Roll(o);
  ...
  async _rollWeaponDamage(i, e = "") {
    var m, u, y, g, n, d, o, c, l, h;
    const t = this.actor;
    if (!t) return;
    let s = ((u = (m = t.items).get) == null ? void 0 : u.call(m, i)) ?? ((g = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : g.call(y, (b) => b.id === i));
    if (!s || s.type !== "Fegyver") return;
    let p = (((n = s.system) == null ? void 0 : n.damage) ?? "").trim();
    if (!p && e && (p = (((((d = t.system) == null ? void 0 : d.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !p) {
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    const t = ((g = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : g.abilities) ?? {}, s = (((d = (n = this.actor) == null ? void 0 : n.items) == null ? void 0 : d.contents) ?? []).filter((o) => o.type === "Kepesseg" || o.type === "ability").map((o) => {
      var c, l;
      return {
        id: o.id,
        name: o.name,
    ...
    }), p = new Map(s.map((o) => [o.id, o])), r = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    return e.abilityPassiveList = m(a("passive")), e.abilityActiveList = m(a("active")), e;
  }
  _attachFrameListeners(i) {
    var a;
    super._attachFrameListeners(i);
    const e = this.form ?? ((a = i == null ? void 0 : i.querySelector) == null ? void 0 : a.call(i, "form.votv.npc-sheet")) ?? i ?? this.element, t = e ? $(e) : $([]);
    t.on("click", ".karakter-portrait-img", (m) => {
      var g, n, d;
      if (m.preventDefault(), m.stopPropagation(), !this.actor) return;
      const u = ((d = (n = (g = foundry.applications) == null ? void 0 : g.apps) == null ? void 0 : n.FilePicker) == null ? void 0 : d.implementation) ?? globalThis.FilePicker;
      new u({
        type: "image",
        current: this.actor.img || "",
        callback: (o) => {
    ...
    }), t.on("click", ".karakter-ability-open", (m) => {
      var g, n, d;
      m.preventDefault();
      const u = (n = (g = m.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : n.itemId;
      if (!u || !this.actor) return;
      const y = this.actor.items.get(u);
      (d = y == null ? void 0 : y.sheet) == null || d.render(!0);
    }), t.on("click", ".karakter-ability-chat", async (m) => {
      var y, g;
      m.preventDefault();
      const u = (g = (y = m.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : g.itemId;
      u && await this._postAbilityToChat(u);
    }), t.on("click", ".karakter-ability-pill-remove", async (m) => {
      var o, c, l, h, b, v;
      if (m.preventDefault(), !m.altKey) return;
      const u = (c = (o = m.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : c.area, y = (h = (l = m.currentTarget) == null ? void 0 : l.dataset) == null ? void 0 : h.itemId;
      if (!u || !y || !this.actor) return;
      const g = ((b = this.actor.system) == null ? void 0 : b.abilities) ?? {}, d = (Array.isArray((v = g[u]) == null ? void 0 : v.items) ? g[u].items.slice() : []).filter((I) => I !== y);
      await this.actor.update({ [`system.abilities.${u}.items`]: d }), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-ability-slot-clear", async (m) => {
      var y, g;
      if (m.preventDefault(), !m.altKey) return;
      const u = (g = (y = m.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : g.slot;
    ...
    const s = this, p = (m) => {
      if (!m) return;
      const u = s._getFormDataForUpdate(m);
      Object.keys(u).length !== 0 && s.actor.update(u).catch((y) => console.warn("VoidNpcSheet save failed", y));
    }, r = (m) => {
      var u, y, g;
      return m && (((y = (u = s.element) == null ? void 0 : u.contains) == null ? void 0 : y.call(u, m)) || s.id && ((g = m.closest) == null ? void 0 : g.call(m, `#${CSS.escape(s.id)}`)));
    };
    s._votvNpcBlur = (m) => {
      var d;
      const u = m.target;
      ...
      n && (g.contains(n) || s.id && ((d = n.closest) != null && d.call(n, `#${CSS.escape(s.id)}`))) || p(g);
  ...
  async _onDropItem(i, e) {
    var m, u, y, g, n, d, o, c, l;
    if (!this.actor) return (m = super._onDropItem) == null ? void 0 : m.call(this, i, e);
    const s = ((h) => {
      var v;
      if (!h) return null;
    ...
    if (!s) return (u = super._onDropItem) == null ? void 0 : u.call(this, i, e);
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      let h = p.id;
      if (((g = p.parent) == null ? void 0 : g.id) !== r.id) {
      ...
      const b = (((d = p.system) == null ? void 0 : d.kind) ?? "passive").toString(), v = ((o = r.system) == null ? void 0 : o.abilities) ?? {}, I = b === "active" ? "active" : "passive", D = Array.isArray((c = v[I]) == null ? void 0 : c.items) ? v[I].items.slice() : Array.isArray(v[I]) ? v[I].slice() : [];
      D.includes(h) || D.push(h), await r.update({ [`system.abilities.${I}.items`]: D }), typeof this.render == "function" && this.render(!0);
      return;
    }
    if (((l = p.parent) == null ? void 0 : l.id) === r.id) return;
    const a = p.toObject();
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (r) => {
      var u, y, g, n, d, o, c;
      if (!e.isEditable || !((y = (u = r.target) == null ? void 0 : u.closest) != null && y.call(u, ".profile")) && ((n = (g = r.target) == null ? void 0 : g.getAttribute) == null ? void 0 : n.call(g, "data-edit")) !== "img") return;
      r.preventDefault(), r.stopPropagation();
      const a = ((c = (o = (d = foundry.applications) == null ? void 0 : d.apps) == null ? void 0 : o.FilePicker) == null ? void 0 : c.implementation) ?? globalThis.FilePicker;
      new a({
        type: "image",
    ...
    const s = (r) => {
      ...
      var a, m, u;
      return r && (((m = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : m.call(a, r)) || e.id && ((u = r.closest) == null ? void 0 : u.call(r, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (r) => {
      var m, u, y;
      const a = ((m = r.target) == null ? void 0 : m.form) ?? ((y = (u = r.target) == null ? void 0 : u.closest) == null ? void 0 : y.call(u, "form"));
      p(a) && s(a);
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (r) => {
      ...
      const m = (a == null ? void 0 : a.form) ?? ((u = a == null ? void 0 : a.closest) == null ? void 0 : u.call(a, "form"));
      p(m) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => s(m), 300));
...
Hooks.once("init", () => {
  ...
  const F = 500;
  Hooks.on("updateActor", (r, a, m, u) => {
    var v, I, D, C, q;
    const y = r == null ? void 0 : r.id;
    if (!y) return;
    const g = document.activeElement, n = g && (g.tagName === "INPUT" && g.type !== "checkbox" && g.type !== "radio" || g.tagName === "TEXTAREA" || g.isContentEditable), d = [], o = (v = game.actors) == null ? void 0 : v.get(y);
    o != null && o.apps && d.push(...Array.from(o.apps));
    const c = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const w of c)
      ((I = w.document) == null ? void 0 : I.id) !== y || ((D = w.document) == null ? void 0 : D.documentName) !== "Actor" || ((C = w.constructor) == null ? void 0 : C.name) !== "VoidKarakterSheet" || d.includes(w) || d.push(w);
    if (n && d.some((w) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (u = (m = e.target) == null ? void 0 : m.closest) == null ? void 0 : u.call(m, "[data-document-id]"), s = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!s) return;
...
Hooks.on("renderChatMessageHTML", (F, i, e) => {
  ...
  if (!s && !p) return;
  const r = (m = i == null ? void 0 : i.querySelector) == null ? void 0 : m.call(i, ".dice-roll");
  if (r && (s && r.classList.add(`votv-${s}`), p)) {
    const u = r.querySelector(".votv-crit-label");
    if (u) {
      u.textContent = p;
      return;
    }
...
//# sourceMappingURL=vacuum-of-the-void-BqHWgYxC.mjs.map
