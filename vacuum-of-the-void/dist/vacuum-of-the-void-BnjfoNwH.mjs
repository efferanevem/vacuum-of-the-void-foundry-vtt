...
var Rt = Reflect.get;
var jt = (E, s, e) => s in E ? xt(E, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : E[s] = e;
var z = (E, s, e) => jt(E, typeof s != "symbol" ? s + "" : s, e);
var j = (E, s, e) => Rt(Mt(E), e, s);
const { HTMLField: Kt, NumberField: P, SchemaField: R, StringField: w, BooleanField: Q, ArrayField: He } = foundry.data.fields;
class Ft extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new R({
        biography: new Kt({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: ze, SchemaField: Ht } = foundry.data.fields;
class Ut extends Ft {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Bt, NumberField: es, StringField: qe } = foundry.data.fields;
...
const { NumberField: Ge, StringField: gt } = foundry.data.fields;
...
const { NumberField: Jt, StringField: ht } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const D = ((Te = d[g]) == null ? void 0 : Te.value) ?? 0, _ = a[g] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), C = I ? I.split(/\s*,\s*/).filter((g) => v.includes(g)) : [], q = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, O = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ae = O.slot1) == null ? void 0 : Ae.itemId) ?? "").trim(), S = (((Pe = O.slot2) == null ? void 0 : Pe.itemId) ?? "").trim(), A = (((st = O.slot3) == null ? void 0 : st.itemId) ?? "").trim(), H = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, D) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return _ - L;
    }).map((g) => {
      var ge, Oe, Ce, ke, ve, Ne;
      const D = g.type === "Fegyver", _ = g.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Ee = 0; Ee < C.length; Ee++) {
        const $e = C[Ee];
        if ((((ge = b[$e]) == null ? void 0 : ge.itemId) ?? "") === g.id) {
          L = Ee + 1, M = ((Oe = b[$e]) == null ? void 0 : Oe.bonus) ?? "", J = $e;
          break;
        }
      }
      let Y = null;
      _ && (T === g.id ? Y = "slot1" : S === g.id ? Y = "slot2" : A === g.id && (Y = "slot3"));
      const Fe = D && ((Ce = g.system) != null && Ce.damage) ? g.system.damage : "", se = D && typeof ((ke = g.system) == null ? void 0 : ke.range) == "string" ? (g.system.range || "").trim() : "", De = J ? Number((ve = b[J]) == null ? void 0 : ve.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.weaponsTable = U.map((g) => {
      ...
      let _ = null, L = {};
      for (const Be of C)
        if ((((pt = b[Be]) == null ? void 0 : pt.itemId) ?? "").trim() === D) {
          _ = Be, L = b[Be] ?? {};
          break;
        }
      const M = !!_, J = ((ft = g.system) == null ? void 0 : ft.equipped) !== void 0 && ((yt = g.system) == null ? void 0 : yt.equipped) !== null ? !!g.system.equipped : M, Y = (g == null ? void 0 : g.system) ?? {}, Fe = typeof Y.range == "string" ? (Y.range || "").trim() : "", se = Y.type ?? "", De = (we[se] ?? se) || "—", ge = Y.size ?? "", Oe = (le[ge] ?? ge) || "", Ce = [De, Oe].filter(Boolean).join(", ") || De || "—", ke = se === "projectile" || ge === "thrown", ve = Y.quantity, Ne = ve != null ? String(ve).trim() : "1", Ee = String(L.bonus ?? "").trim(), $e = String(Y.bonus ?? "").trim(), $t = Ee || $e || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    e.microchipItemsSlot1 = te.filter((g) => !pe(1).includes(g.id)), e.microchipItemsSlot2 = te.filter((g) => !pe(2).includes(g.id)), e.microchipItemsSlot3 = te.filter((g) => !pe(3).includes(g.id)), e.microchipSlots = V.map((g) => {
      ...
      const L = !!_, M = ((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Fe = Number((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, se = (((ke = g == null ? void 0 : g.system) == null ? void 0 : ke.description) ?? "").trim(), De = se ? se.length > 60 ? se.slice(0, 57) + "…" : se : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const k = this.actor.system.abilities ?? {}, x = (((mt = this.actor.items) == null ? void 0 : mt.contents) ?? []).map((g) => {
      ...
      const D = k[g] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? N.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || K,
        img: (L == null ? void 0 : L.img) || "",
        description: M,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BO1Xb89C.mjs");
      n(this.actor, c);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-BO1Xb89C.mjs");
      u(this.actor, c, n);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], q = C.find((O) => {
          var T;
          return (((T = b[O]) == null ? void 0 : T.itemId) ?? "").trim() === c;
        });
        if (q) {
...
z(B, "PARTS", foundry.utils.mergeObject(
  ...
  j(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((vt = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : vt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((wt = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : wt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((St = (It = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : It.window) == null ? void 0 : St.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-BO1Xb89C.mjs");
      u(this.actor, c, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, n;
      i.preventDefault();
      ...
      const n = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, p = (Array.isArray((O = n[r]) == null ? void 0 : O.items) ? n[r].items.slice() : []).filter((T) => T !== c);
  ...
  async _rollWeapon(s) {
    ...
    const f = l && l.name || o.name || "Fegyver", m = Number(o.bonus || 0) || 0, h = (((O = l == null ? void 0 : l.system) == null ? void 0 : O.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", i = Number(d[h] || 0) || 0, r = m + i, n = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, u = new Roll(n);
  ...
  async _onDropItem(s, e) {
    var y, h, i, r, c, n, u, p, b, v, I, C, q, O, T;
...
z(Z, "PARTS", foundry.utils.mergeObject(
  ...
  j(Z, Z, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((_t = j(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : _t.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ot = (Dt = j(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.window) == null ? void 0 : Ot.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
z(ie, "PARTS", foundry.utils.mergeObject(j(ie, ie, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ct = j(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = ie;
var qt;
...
z(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((qt = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : qt.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = re;
var Lt;
...
z(ne, "PARTS", foundry.utils.mergeObject(j(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Lt = j(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Lt.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = ne;
var Pt;
...
z(ae, "PARTS", foundry.utils.mergeObject(j(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Pt = j(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Pt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = ae;
var Et;
...
z(oe, "PARTS", foundry.utils.mergeObject(j(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Et = j(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Et.form) ?? {}, { submitOnChange: !1 })
}));
let et = oe;
var At;
...
z(ce, "PARTS", foundry.utils.mergeObject(j(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((At = j(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : At.form) ?? {}, { submitOnChange: !1 })
}));
let tt = ce;
const Nt = "systems/vacuum-of-the-void/assets/void-bg.jpg";
Hooks.once("init", () => {
  var s, e, t, o, d, a;
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Ut, CONFIG.Actor.dataModels.Npc = Ft, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = zt, CONFIG.Item.dataModels.Pancel = Wt, CONFIG.Item.dataModels.MikroChip = Yt, CONFIG.Item.dataModels.Kepesseg = bt, CONFIG.Item.dataModels.ability = bt, CONFIG.Item.dataModels.Targy = Qt, CONFIG.Item.dataModels.Egyeb = Zt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    for (const S of u)
      ((C = S.document) == null ? void 0 : C.id) !== h || ((q = S.document) == null ? void 0 : q.documentName) !== "Actor" || ((O = S.constructor) == null ? void 0 : O.name) !== "VoidKarakterSheet" || c.includes(S) || c.push(S);
    if (r && c.some((S) => {
...
//# sourceMappingURL=vacuum-of-the-void-BnjfoNwH.mjs.map
