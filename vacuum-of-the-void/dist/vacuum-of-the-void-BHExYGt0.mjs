...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Pe, pe, ke, fe, _e, De, Me, je, Re, Ke, Fe, Ee, tt, st, it, rt, nt, at;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((ke = (pe = (Pe = this.actor.system) == null ? void 0 : Pe.resources) == null ? void 0 : pe.stress) == null ? void 0 : ke.value) || 0;
    e.stressOver10 = t > 10;
    const o = this.actor.system.resources ?? {}, d = o.hitLocations ?? {}, c = o.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const f of u) {
      const D = ((fe = d[f]) == null ? void 0 : fe.value) ?? 0, _ = c[f] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], O = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = O && typeof O == "object" && !Array.isArray(O) ? O : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Fe = C.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), A = (((Ee = C.slot3) == null ? void 0 : Ee.itemId) ?? "").trim(), U = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, D) => {
      ...
      const Ne = D && ((qe = f.system) != null && qe.damage) ? f.system.damage : "", ie = D && typeof ((ve = f.system) == null ? void 0 : ve.range) == "string" ? (f.system.range || "").trim() : "", Oe = J ? Number((we = b[J]) == null ? void 0 : we.bonus) || 0 : "";
      return {
        id: f.id,
        name: f.name,
        img: f.img,
    ...
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", ee = q.filter((f) => {
    ...
    const Ie = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ue = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((f) => {
      ...
      const M = !!_, J = ((ct = f.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = f.system) == null ? void 0 : lt.equipped) !== null ? !!f.system.equipped : M, Y = (f == null ? void 0 : f.system) ?? {}, Ne = typeof Y.range == "string" ? (Y.range || "").trim() : "", ie = Y.type ?? "", Oe = (Ie[ie] ?? ie) || "—", ye = Y.size ?? "", Ce = (ue[ye] ?? ye) || "", qe = [Oe, Ce].filter(Boolean).join(", ") || Oe || "—", ve = ie === "projectile" || ye === "thrown", we = Y.quantity, $e = we != null ? String(we).trim() : "1", Ae = String(L.bonus ?? "").trim(), xe = String(Y.bonus ?? "").trim(), Lt = Ae || xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const Te = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((f) => f.type === "Targy");
    e.itemsTable = Te.map((f) => {
    ...
    const de = (((rt = this.actor.items) == null ? void 0 : rt.contents) ?? []).filter((f) => f.type === "Egyeb");
    e.egyebList = de.map((f) => {
    ...
    const me = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((f) => f.type === "MikroChip"), te = me.map((f) => ({ id: f.id, name: f.name, img: f.img })), ge = "— Nincs Mikro-Chip —", se = ["slot1", "slot2", "slot3"], V = (f) => {
      var _, L, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = te.filter((f) => !V(1).includes(f.id)), e.microchipItemsSlot2 = te.filter((f) => !V(2).includes(f.id)), e.microchipItemsSlot3 = te.filter((f) => !V(3).includes(f.id)), e.microchipSlots = se.map((f) => {
      const D = C[f] ?? {}, _ = (D.itemId ?? "").trim(), L = me.find((M) => M.id === _);
      return {
        slotKey: f,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || ge,
        img: (L == null ? void 0 : L.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((f) => {
      const D = `slot${f}`, _ = C[D] ?? {}, L = (_.itemId ?? "").trim(), M = te.find((J) => J.id === L);
      e[`microchip${f}ItemId`] = L, e[`microchip${f}DisplayName`] = (M == null ? void 0 : M.name) || _.name || ge, e[`microchip${f}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = me.map((f) => {
      var ye, Ce, qe, ve;
      const D = f.id;
      let _ = null;
      for (const we of se)
        if ((((ye = C[we]) == null ? void 0 : ye.itemId) ?? "").trim() === D) {
          _ = we;
          break;
        }
      const L = !!_, M = ((Ce = f == null ? void 0 : f.system) == null ? void 0 : Ce.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Ne = Number((qe = f == null ? void 0 : f.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(f.system.replaceCost) : 0, ie = (((ve = f == null ? void 0 : f.system) == null ? void 0 : ve.description) ?? "").trim(), Oe = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (f == null ? void 0 : f.name) ?? "—",
    ...
    const he = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((f) => {
      var D, _, L;
      return {
        id: f.id,
        name: f.name,
      ...
      const D = he[f] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
    ...
    return e.abilityPassiveList = W(be("passive")), e.abilityActiveList = W(be("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-DNVXwNwW.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-DNVXwNwW.mjs");
      l(this.actor, a, n);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, ee, Ie, ue, Se, Te, de, me, te, ge, se, V, he;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((G = this.actor) == null ? void 0 : G.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ie = (ee = e.system) == null ? void 0 : ee.identity) == null ? void 0 : Ie.size) ?? "").trim() || "Közepes";
    const t = this.actor, o = ((ue = t == null ? void 0 : t.items) == null ? void 0 : ue.contents) ?? [], d = ((Se = t == null ? void 0 : t.system) == null ? void 0 : Se.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), y = u ? u.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = y.length > 0 ? y : c, r = c.filter((k) => !i.includes(k)), a = [...i, ...r], n = a.filter((k) => {
      var x;
      const F = (((x = d[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return F && m.some((K) => K.id === F);
    });
    e.weaponSlots = n.map((k) => {
      const F = d[k] ?? {}, x = (F.itemId ?? "").trim(), K = g.find((be) => be.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const be = !!x, W = (k == null ? void 0 : k.system) ?? {}, Pe = typeof W.range == "string" ? (W.range || "").trim() : "", pe = W.type ?? "", ke = (l[pe] ?? pe) || "—", fe = W.size ?? "", _e = (p[fe] ?? fe) || "", De = [ke, _e].filter(Boolean).join(", ") || ke || "—", Me = pe === "projectile" || fe === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((de = (Te = t == null ? void 0 : t.system) == null ? void 0 : Te.gear) == null ? void 0 : de.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], q = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = q.map((k) => {
      ...
      const K = ((ke = k == null ? void 0 : k.system) == null ? void 0 : ke.abilityType) ?? "", be = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", W = (((fe = k == null ? void 0 : k.system) == null ? void 0 : fe.description) ?? "").trim(), Pe = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const T = (((me = e.weaponsTable) == null ? void 0 : me.length) ?? 0) > 0 || (((te = e.armorTable) == null ? void 0 : te.length) ?? 0) > 0 || (((ge = e.microchipsTable) == null ? void 0 : ge.length) ?? 0) > 0 || (((se = e.itemsTable) == null ? void 0 : se.length) ?? 0) > 0 || (((V = e.egyebList) == null ? void 0 : V.length) ?? 0) > 0;
    e.showEquipmentDropZone = !T;
    const S = ((he = t == null ? void 0 : t.system) == null ? void 0 : he.abilities) ?? {}, A = o.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-DNVXwNwW.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), N = ((l = c.system) == null ? void 0 : l.abilities) ?? {}, U = A === "active" ? "active" : "passive", H = Array.isArray((p = N[U]) == null ? void 0 : p.items) ? N[U].items.slice() : Array.isArray(N[U]) ? N[U].slice() : [];
...
z(re, "PARTS", foundry.utils.mergeObject(R(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((St = R(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : St.form) ?? {}, { submitOnChange: !1 })
}));
let Je = re;
var Tt;
...
z(ne, "PARTS", foundry.utils.mergeObject(R(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Tt = R(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Tt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = ne;
var _t;
...
z(ae, "PARTS", foundry.utils.mergeObject(R(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((_t = R(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ae;
var Dt;
...
z(oe, "PARTS", foundry.utils.mergeObject(R(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Dt = R(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !0 })
}));
let Ze = oe;
var Ot;
...
z(ce, "PARTS", foundry.utils.mergeObject(R(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ot = R(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.form) ?? {}, { submitOnChange: !1 })
}));
let Ve = ce;
var Ct;
...
z(le, "PARTS", foundry.utils.mergeObject(R(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ct = R(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 })
}));
let et = le;
    ...
    if (c && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !y.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = u.actorId || ((i = E.speaker) == null ? void 0 : i.actor) || "", p.dataset.itemId = u.itemId || "", p.dataset.slotKey = u.slotKey || "", a.appendChild(p), p.addEventListener("click", async (I) => {
          var G, ee, Ie, ue, Se, Te, de, me, te, ge, se, V, he, k;
          I.preventDefault(), I.stopPropagation();
          const q = I.currentTarget.dataset.actorId || "", O = I.currentTarget.dataset.itemId || "", C = I.currentTarget.dataset.slotKey || "", T = q && ((G = game.actors) == null ? void 0 : G.get(q)) || ((ee = E.speaker) == null ? void 0 : ee.actor) && ((Ie = game.actors) == null ? void 0 : Ie.get(E.speaker.actor)) || null;
          if (!T) return;
          let S = O ? ((Se = (ue = T.items) == null ? void 0 : ue.get) == null ? void 0 : Se.call(ue, O)) ?? ((me = (de = (Te = T.items) == null ? void 0 : Te.contents) == null ? void 0 : de.find) == null ? void 0 : me.call(de, (F) => F.id === O)) : null;
          if (!S || S.type !== "Fegyver") return;
          let A = (((te = S.system) == null ? void 0 : te.damage) ?? "").trim();
          if (!A && C && (A = (((((ge = T.system) == null ? void 0 : ge.weapons) ?? {})[C] ?? {}).damage ?? "").trim()), !A) {
            (k = (se = ui.notifications) == null ? void 0 : se.warn) == null || k.call(
              se,
              ((he = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : he.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája."
            );
            return;
          }
          const N = new Roll(A);
          await N.evaluate({ async: !0 });
          const U = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, H = u.targetName || "", Z = H ? `${S.name} – sebzés – ${H}` : `${S.name} – sebzés`;
          await N.toMessage({
            speaker: ChatMessage.getSpeaker({ actor: T }),
            flavor: Z,
            flags: { "vacuum-of-the-void": {} },
...
//# sourceMappingURL=vacuum-of-the-void-BHExYGt0.mjs.map
