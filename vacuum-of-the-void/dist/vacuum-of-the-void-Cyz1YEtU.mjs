...
const { HTMLField: hs, NumberField: O, SchemaField: K, StringField: S, BooleanField: se, ArrayField: st } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var We, Ye, Je, Qe, Xe, k, F, x, j, ae, X, Fe, he, Ie, be, qe, Le, dt, mt, pt, ft, Ze, $e, Nt, Pt, At, Et, Ft, $t, xt, Rt;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((k = (Xe = this.actor.system) == null ? void 0 : Xe.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const a = (Number(((x = (F = this.actor.system) == null ? void 0 : F.combat) == null ? void 0 : x.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const p = ((j = e.system) == null ? void 0 : j.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (ae = this.actor.system.gear) == null ? void 0 : ae.microchips, E = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((X = E.slot1) == null ? void 0 : X.itemId) ?? "").trim(), H = (((Fe = E.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), B = (((he = E.slot3) == null ? void 0 : he.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      const D = typeof y.sort == "number" ? y.sort : 0, q = typeof _.sort == "number" ? _.sort : 0;
      return D - q;
    }).map((y) => {
      var ke, Pe, Ae, Se, Te, et;
      const _ = y.type === "Fegyver", D = y.type === "MikroChip";
      let q = 0, M = "", te = null;
      for (let xe = 0; xe < A.length; xe++) {
        const tt = A[xe];
        if ((((ke = T[tt]) == null ? void 0 : ke.itemId) ?? "") === y.id) {
          q = xe + 1, M = ((Pe = T[tt]) == null ? void 0 : Pe.bonus) ?? "", te = tt;
          break;
        }
      }
      let V = null;
      D && (N === y.id ? V = "slot1" : H === y.id ? V = "slot2" : B === y.id && (V = "slot3"));
      const Ve = _ && ((Ae = y.system) != null && Ae.damage) ? y.system.damage : "", oe = _ && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = te ? Number((Te = T[te]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.actionsTable = G;
    const ee = (((Ie = this.actor.items) == null ? void 0 : Ie.contents) ?? []).filter((y) => y.type === "Fegyver"), R = ee.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = R;
    ...
    e.weaponsTable = ee.map((y) => {
      ...
      const M = !!D, te = ((Kt = y.system) == null ? void 0 : Kt.equipped) !== void 0 && ((jt = y.system) == null ? void 0 : jt.equipped) !== null ? !!y.system.equipped : M, V = (y == null ? void 0 : y.system) ?? {}, Ve = typeof V.range == "string" ? (V.range || "").trim() : "", oe = V.type ?? "", Ne = (ve[oe] ?? oe) || "—", ke = V.size ?? "", Pe = (re[ke] ?? ke) || "", Ae = [Ne, Pe].filter(Boolean).join(", ") || Ne || "—", Se = oe === "projectile" || ke === "thrown", Te = V.quantity, et = Te != null ? String(Te).trim() : "1", xe = String(q.bonus ?? "").trim(), tt = String(V.bonus ?? "").trim(), ms = xe || tt || "0";
      return {
        slotKey: D ?? "",
        itemId: _,
    ...
    const fe = (((be = this.actor.items) == null ? void 0 : be.contents) ?? []).filter((y) => y.type === "Pancel");
    ...
    const Re = (((qe = this.actor.items) == null ? void 0 : qe.contents) ?? []).filter((y) => y.type === "Targy");
    ...
    const ie = (((Le = this.actor.items) == null ? void 0 : Le.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const Z = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((y) => y.type === "MikroChip"), ye = Z.map((y) => ({ id: y.id, name: y.name, img: y.img })), it = "— Nincs Mikro-Chip —", Me = ["slot1", "slot2", "slot3"], Ee = (y) => {
      var D, q, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = ye.filter((y) => !Ee(1).includes(y.id)), e.microchipItemsSlot2 = ye.filter((y) => !Ee(2).includes(y.id)), e.microchipItemsSlot3 = ye.filter((y) => !Ee(3).includes(y.id)), e.microchipSlots = Me.map((y) => {
      ...
      return {
        slotKey: y,
        itemId: D,
        displayName: (q == null ? void 0 : q.name) || _.name || it,
        img: (q == null ? void 0 : q.img) || "",
        active: _.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const _ = `slot${y}`, D = E[_] ?? {}, q = (D.itemId ?? "").trim(), M = ye.find((te) => te.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || D.name || it, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    ...
    const gt = (((mt = e.weaponsTable) == null ? void 0 : mt.length) ?? 0) > 0 || (((pt = e.armorTable) == null ? void 0 : pt.length) ?? 0) > 0 || (((ft = e.microchipsTable) == null ? void 0 : ft.length) ?? 0) > 0 || (((Ze = e.itemsTable) == null ? void 0 : Ze.length) ?? 0) > 0;
    e.showEquipmentDropZone = !gt;
    const ht = this.actor.system.abilities ?? {}, Ke = ((($e = this.actor.items) == null ? void 0 : $e.contents) ?? []).map((y) => {
      var _, D, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), je = new Map(Ke.map((y) => [y.id, y])), nt = "— Nincs képesség —", He = (y) => {
      const _ = ht[y] ?? {}, D = (_.itemId ?? "").trim(), q = D ? je.get(D) : null, M = (q == null ? void 0 : q.description) ?? "", te = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: D,
    ...
    const rt = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, at = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (At = (Pt = e.system) == null ? void 0 : Pt.combat) == null ? void 0 : At.initiativeResult, ge = typeof _e == "number" ? _e : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Be = (Ft = (Et = e.system) == null ? void 0 : Et.combat) == null ? void 0 : Ft.initiativeRanges, Ce = Array.isArray(Be) ? Be.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : ot).slice().sort((y, _) => y.min - _.min), Oe = Ce.map((y) => y.min), ct = Oe.length ? Math.min(...Oe) : 0, lt = Oe.length ? Math.max(...Oe) : 0;
    ...
    e.kpDots = at.map((y, _) => {
      const D = _ + 1, q = !!Number(rt[y]), M = D <= Ge;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-C4L_mr8d.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-C4L_mr8d.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-C4L_mr8d.mjs");
      p(this.actor, o, a);
...
const ne = class ne extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var nt, He, Ue, ze, rt, at, _e, ge, ot, Be, Ce, bt, we, Oe, ct, lt, Ge, ut, We, Ye, Je, Qe, Xe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((nt = this.actor) == null ? void 0 : nt.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ue = (He = e.system) == null ? void 0 : He.identity) == null ? void 0 : Ue.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((ze = t == null ? void 0 : t.items) == null ? void 0 : ze.contents) ?? [], d = ((rt = t == null ? void 0 : t.system) == null ? void 0 : rt.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const $e of c)
        if ((((Ze = d[$e]) == null ? void 0 : Ze.itemId) ?? "").trim() === F) {
          x = $e, j = d[$e] ?? {};
          break;
        }
      const ae = !!x, X = (k == null ? void 0 : k.system) ?? {}, Fe = typeof X.range == "string" ? (X.range || "").trim() : "", he = X.type ?? "", Ie = (a[he] ?? he) || "—", be = X.size ?? "", qe = (p[be] ?? be) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", dt = he === "projectile" || be === "thrown", mt = X.quantity != null ? String(X.quantity).trim() : "1", pt = String(X.bonus ?? j.bonus ?? "").trim() || "0", ft = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((_e = (at = t == null ? void 0 : t.system) == null ? void 0 : at.gear) == null ? void 0 : _e.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    ...
    const A = (((ge = e.weaponsTable) == null ? void 0 : ge.length) ?? 0) > 0 || (((ot = e.armorTable) == null ? void 0 : ot.length) ?? 0) > 0 || (((Be = e.microchipsTable) == null ? void 0 : Be.length) ?? 0) > 0 || (((Ce = e.itemsTable) == null ? void 0 : Ce.length) ?? 0) > 0 || (((bt = e.egyebList) == null ? void 0 : bt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const C = ((we = t == null ? void 0 : t.system) == null ? void 0 : we.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const G = t == null ? void 0 : t.id, ee = !!((ct = (Oe = game.combat) == null ? void 0 : Oe.combatants) != null && ct.some(
      (k) => {
        var F;
    ...
    const R = ((lt = e.system) == null ? void 0 : lt.resources) ?? {}, Y = (ut = (Ge = e.system) == null ? void 0 : Ge.combat) == null ? void 0 : ut.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], re = (Ye = (We = e.system) == null ? void 0 : We.combat) == null ? void 0 : Ye.initiativeRanges, fe = Array.isArray(re) ? re.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (fe.length > 0 ? fe : ve).slice().sort((k, F) => k.min - F.min), Z = fe.map((k) => k.min), ye = Z.length ? Math.min(...Z) : 0, it = Z.length ? Math.max(...Z) : 0;
    e.initiativeRanges = fe.map((k) => ({ ...k, isFirst: k.min === ye, isLast: k.min === it }));
    let Me = 0;
    if (typeof J == "number" && J >= 0 && ie.length > 0) {
      const k = ie[0], F = ie[ie.length - 1];
      let x = null;
      J <= k.max ? x = k : J >= F.min ? x = F : x = ie.find((j) => J >= j.min && J <= j.max), x && (Me = x.kp);
    }
    const Ee = ie.length > 0 ? ie[ie.length - 1] : null, gt = Math.min(10, Ee ? Ee.kp : 6), Ke = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, gt)).map((k, F) => {
      const x = F + 1, j = !!Number(R[k]), ae = x <= Me;
      return { index: x, used: j, usable: ae };
    }), je = Math.ceil(Ke.length / 2);
    return e.kpDotsRow1 = Ke.slice(0, je), e.kpDotsRow2 = Ke.slice(je), e.canEditInitiative = !!((Je = game.user) != null && Je.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e.speedUnitForSelect = ((Xe = (Qe = e.system) == null ? void 0 : Qe.combat) == null ? void 0 : Xe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-C4L_mr8d.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-C4L_mr8d.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-C4L_mr8d.mjs");
      a(this.actor, c, o);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const m = r.itemId ? ((H = (N = f.items) == null ? void 0 : N.get) == null ? void 0 : H.call(N, r.itemId)) ?? ((G = (U = (B = f.items) == null ? void 0 : B.contents) == null ? void 0 : U.find) == null ? void 0 : G.call(U, (ie) => ie.id === r.itemId)) : null;
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Re = (((fe = f.system) == null ? void 0 : fe.weapons) ?? {})[r.slotKey]) == null ? void 0 : Re.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-Cyz1YEtU.mjs.map
