...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const y of l) {
      const _ = ((ae = d[y]) == null ? void 0 : ae.value) ?? 0, C = a[y] ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-fdSXapzZ.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-fdSXapzZ.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-fdSXapzZ.mjs");
      m(this.actor, o, r);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((P) => T.includes(P)) : [], A = q.find((P) => {
          var D;
          return (((D = v[P]) == null ? void 0 : D.itemId) ?? "").trim() === o;
        });
        if (A) {
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-fdSXapzZ.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-fdSXapzZ.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-fdSXapzZ.mjs");
      r(this.actor, c, o);
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, m = (Array.isArray((A = o[i]) == null ? void 0 : A.items) ? o[i].items.slice() : []).filter((P) => P !== c);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, a = ((A = e.items) == null ? void 0 : A.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = a.find((E) => E.id === n.itemId) ?? null);
    const f = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, g = ((P = l == null ? void 0 : l.system) == null ? void 0 : P.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = p + i, r = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, m = new Roll(r);
  ...
  async _onDropItem(s, e) {
    var g, b, u, i, c, o, r, m, h, v, I, T, q, A, P, D, E;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    let f = ((A = game.actors) == null ? void 0 : A.get(a.actorId)) ?? ((P = game.actors) == null ? void 0 : P.get(l));
    if (f || (f = ((E = (D = game.scenes) == null ? void 0 : D.contents) == null ? void 0 : E.flatMap((ie) => {
      var re;
      return ((re = ie.tokens) == null ? void 0 : re.contents) ?? [];
    }).map((ie) => ie.actor).find((ie) => ie && (ie.id === l || ie.id === a.actorId))) ?? null), !f) return;
    const p = a.itemId ? ((j = (N = f.items) == null ? void 0 : N.get) == null ? void 0 : j.call(N, a.itemId)) ?? ((G = (H = (B = f.items) == null ? void 0 : B.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (ke) => ke.id === a.itemId)) : null;
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = a.targetName || "", c = a.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (a.slotKey ? ((Ne = (((be = f.system) == null ? void 0 : be.weapons) ?? {})[a.slotKey]) == null ? void 0 : Ne.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-XKt0_U0s.mjs.map
