...
var ss = Reflect.get;
var is = (D, s, e) => s in D ? es(D, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : D[s] = e;
var W = (D, s, e) => is(D, typeof s != "symbol" ? s + "" : s, e);
var j = (D, s, e) => ss(ts(D), e, s);
const { HTMLField: ns, NumberField: C, SchemaField: K, StringField: I, BooleanField: Z, ArrayField: He } = foundry.data.fields;
...
const { NumberField: Be, SchemaField: rs } = foundry.data.fields;
class as extends Qt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: os, NumberField: ks, StringField: ve } = foundry.data.fields;
...
const { BooleanField: ls, StringField: Ue } = foundry.data.fields;
...
const { NumberField: Ge, StringField: Nt } = foundry.data.fields;
...
const { NumberField: ds, StringField: At } = foundry.data.fields;
...
function We(D) {
  if (!D || !Array.isArray(D.terms)) return { resultType: null, label: null };
  const s = [], e = [], t = [];
  let a = !1;
  const d = (u, i = 1) => {
...
function ys(D) {
  return D ? D === "1" ? "1. szint" : D === "2" ? "2. szint" : D === "3" ? "3. szint" : D === "Alap" ? "Alap" : D : "Alap";
}
var $t, xt, Mt, Rt;
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var $e, Ne, st, it, nt, rt, at, ot, lt, ct, ut, dt, mt, pt, ft, yt, gt, ht, bt, kt, vt, wt, It, St, Tt, Dt, _t, Ot;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((st = (Ne = ($e = this.actor.system) == null ? void 0 : $e.resources) == null ? void 0 : Ne.stress) == null ? void 0 : st.value) || 0;
    e.stressOver10 = t > 10;
    const a = this.actor.system.resources ?? {}, d = a.hitLocations ?? {}, n = a.currentHealth ?? {}, c = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const g of c) {
      const O = ((it = d[g]) == null ? void 0 : it.value) ?? 0, _ = n[g] ?? 0;
    ...
    const r = (Number(((ot = (at = this.actor.system) == null ? void 0 : at.combat) == null ? void 0 : ot.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (S.slotOrder ?? "").trim(), E = A ? A.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], T = (ct = this.actor.system.gear) == null ? void 0 : ct.microchips, F = T && typeof T == "object" && !Array.isArray(T) ? T : {}, P = (((ut = F.slot1) == null ? void 0 : ut.itemId) ?? "").trim(), N = (((dt = F.slot2) == null ? void 0 : dt.itemId) ?? "").trim(), H = (((mt = F.slot3) == null ? void 0 : mt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      ...
      var fe, Ce, qe, be, ke, Me;
      const O = g.type === "Fegyver", _ = g.type === "MikroChip";
      let L = 0, M = "", X = null;
      for (let Ae = 0; Ae < E.length; Ae++) {
        const Re = E[Ae];
        if ((((fe = S[Re]) == null ? void 0 : fe.itemId) ?? "") === g.id) {
          L = Ae + 1, M = ((Ce = S[Re]) == null ? void 0 : Ce.bonus) ?? "", X = Re;
          break;
        }
      }
      let Q = null;
      _ && (P === g.id ? Q = "slot1" : N === g.id ? Q = "slot2" : H === g.id && (Q = "slot3"));
      const xe = O && ((qe = g.system) != null && qe.damage) ? g.system.damage : "", ne = O && typeof ((be = g.system) == null ? void 0 : be.range) == "string" ? (g.system.range || "").trim() : "", Oe = X ? Number((ke = S[X]) == null ? void 0 : ke.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        ...
        rangeStr: ne,
        slotBonusNum: Oe,
        quantity: Number(((Me = g.system) == null ? void 0 : Me.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = G;
    ...
    const se = "— Nincs fegyver —", de = E.filter((g) => {
      const _ = ((S[g] ?? {}).itemId ?? "").trim();
      return _ ? !!te.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = de.map((g, O) => {
      const _ = S[g] ?? {}, L = (_.itemId ?? "").trim(), M = Y.find((X) => X.id === L);
      return {
        slotKey: g,
        itemId: L,
        slotNum: O + 1,
        displayName: (M == null ? void 0 : M.name) || _.name || se,
    ...
    e.weaponsTable = te.map((g) => {
      ...
      let _ = null, L = {};
      for (const ze of E)
        if ((((Ct = S[ze]) == null ? void 0 : Ct.itemId) ?? "").trim() === O) {
          _ = ze, L = S[ze] ?? {};
          break;
        }
      const M = !!_, X = ((qt = g.system) == null ? void 0 : qt.equipped) !== void 0 && ((Lt = g.system) == null ? void 0 : Lt.equipped) !== null ? !!g.system.equipped : M, Q = (g == null ? void 0 : g.system) ?? {}, xe = typeof Q.range == "string" ? (Q.range || "").trim() : "", ne = Q.type ?? "", Oe = (we[ne] ?? ne) || "—", fe = Q.size ?? "", Ce = (Ie[fe] ?? fe) || "", qe = [Oe, Ce].filter(Boolean).join(", ") || Oe || "—", be = ne === "projectile" || fe === "thrown", ke = Q.quantity, Me = ke != null ? String(ke).trim() : "1", Ae = String(L.bonus ?? "").trim(), Re = String(Q.bonus ?? "").trim(), Vt = Ae || Re || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    e.armorTable = Se.map((g) => {
      ...
      return {
        ...
        level: ys((O.level ?? "").toString().trim()),
    ...
    const V = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((g) => g.type === "MikroChip"), ie = V.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ee = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var _, L, M;
      const O = [];
      return g !== 1 && O.push((((_ = F.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && O.push((((L = F.slot2) == null ? void 0 : L.itemId) ?? "").trim()), g !== 3 && O.push((((M = F.slot3) == null ? void 0 : M.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = ie.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = ie.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = ie.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      const O = F[g] ?? {}, _ = (O.itemId ?? "").trim(), L = V.find((M) => M.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || O.name || Ee,
        img: (L == null ? void 0 : L.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, _ = F[O] ?? {}, L = (_.itemId ?? "").trim(), M = ie.find((X) => X.id === L);
      e[`microchip${g}ItemId`] = L, e[`microchip${g}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Ee, e[`microchip${g}Img`] = (M == null ? void 0 : M.img) || "";
      ...
      const L = !!_, M = ((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.abilityType) ?? "", X = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Q = M === "active", xe = Number((qe = g == null ? void 0 : g.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ne = (((be = g == null ? void 0 : g.system) == null ? void 0 : be.description) ?? "").trim(), Oe = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    }), J = new Map(De.map((g) => [g.id, g])), Fe = "— Nincs képesség —", me = (g) => {
      const O = U[g] ?? {}, _ = (O.itemId ?? "").trim(), L = _ ? J.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", X = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
    ...
    const Le = ((St = e.system) == null ? void 0 : St.resources) ?? {}, Pe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ke = (Dt = (Tt = e.system) == null ? void 0 : Tt.combat) == null ? void 0 : Dt.initiativeResult, _e = typeof Ke == "number" ? Ke : -1;
    let he = 0;
    _e >= 25 ? he = 6 : _e >= 19 ? he = 5 : _e >= 13 ? he = 4 : _e >= 7 ? he = 3 : _e >= 0 && (he = 2), e.kpDots = Pe.map((g, O) => {
      const _ = O + 1, L = !!Number(Le[g]), M = _ <= he;
      return { index: _, used: L, usable: M };
    });
    const je = (Ot = (_t = e.system) == null ? void 0 : _t.combat) == null ? void 0 : Ot.initiativeResult;
    return e.showInitiativeResult = typeof je == "number", e.initiativeResult = e.showInitiativeResult ? je : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CMuxY58u.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CMuxY58u.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, r = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-CMuxY58u.mjs");
      p(this.actor, o, r);
...
W(B, "PARTS", foundry.utils.mergeObject(
  ...
  j(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject((($t = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : $t.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((xt = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : xt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Rt = (Mt = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Mt.window) == null ? void 0 : Rt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, te, Y, se, de, we, Ie, Se, Te, ye, V, ie, Ee;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let R = null, U = {};
      for (const Ne of l)
        if (((($e = d[Ne]) == null ? void 0 : $e.itemId) ?? "").trim() === x) {
          R = Ne, U = d[Ne] ?? {};
          break;
        }
      const De = !!R, J = (k == null ? void 0 : k.system) ?? {}, Fe = typeof J.range == "string" ? (J.range || "").trim() : "", me = J.type ?? "", ge = (r[me] ?? me) || "—", pe = J.size ?? "", Le = (p[pe] ?? pe) || "", Pe = [ge, Le].filter(Boolean).join(", ") || ge || "—", Ke = me === "projectile" || pe === "thrown", _e = J.quantity != null ? String(J.quantity).trim() : "1", he = String(J.bonus ?? U.bonus ?? "").trim() || "0", je = (J.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: gs((x.level ?? "").toString().trim()),
    ...
    e.microchipsTable = S.map((k) => {
      ...
      const U = ((ge = k == null ? void 0 : k.system) == null ? void 0 : ge.abilityType) ?? "", De = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", J = (((pe = k == null ? void 0 : k.system) == null ? void 0 : pe.description) ?? "").trim(), Fe = J ? J.length > 60 ? J.slice(0, 57) + "…" : J : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const T = ((Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.abilities) ?? {}, F = a.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, R;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CMuxY58u.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CMuxY58u.mjs");
      r(this.actor, l, o);
...
W(ee, "PARTS", foundry.utils.mergeObject(
  ...
  j(ee, ee, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Kt = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Kt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((jt = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : jt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ut = (Ht = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ht.window) == null ? void 0 : Ut.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
W(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((zt = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : zt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = re;
var Bt;
...
W(ae, "PARTS", foundry.utils.mergeObject(j(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Bt = j(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Bt.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ae;
var Gt;
...
W(oe, "PARTS", foundry.utils.mergeObject(j(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Gt = j(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Gt.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = oe;
var Wt;
...
W(le, "PARTS", foundry.utils.mergeObject(j(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Wt = j(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Wt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = le;
var Yt;
...
W(ce, "PARTS", foundry.utils.mergeObject(j(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Yt = j(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.form) ?? {}, { submitOnChange: !1 })
}));
let et = ce;
var Jt;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = as, CONFIG.Actor.dataModels.Npc = Qt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Pt, CONFIG.Item.dataModels.weapon = Pt, CONFIG.Item.dataModels.Pancel = cs, CONFIG.Item.dataModels.MikroChip = us, CONFIG.Item.dataModels.Kepesseg = Et, CONFIG.Item.dataModels.ability = Et, CONFIG.Item.dataModels.Targy = ms, CONFIG.Item.dataModels.Egyeb = fs, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (c, f, m, y) => {
    ...
    if (c.type === "Npc" && ((w = f == null ? void 0 : f.system) != null && w.identity) && "size" in f.system.identity) {
      const N = Zt((q = (S = c.system) == null ? void 0 : S.identity) == null ? void 0 : q.size);
      c.update({
    ...
    const h = (P = game.votv) == null ? void 0 : P._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < D ? h.appId : null;
    setTimeout(() => {
      for (const N of l)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    !0
  ), (D = game.user) != null && D.isGM && ((s = game.scenes) == null ? void 0 : s.size) === 0 && (async () => {
    var e, t;
    try {
...
Hooks.on("preCreateToken", (D, s, e) => {
  var n, c, f, m;
  const t = (n = game.votv) == null ? void 0 : n._dragSourceActorId, a = t ?? D.actorId ?? null;
...
Hooks.on("preCreateCombatant", (D, s, e) => {
  const t = D.initiative;
  (t == null || typeof t == "number" && isNaN(t)) && D.updateSource({ initiative: 0 });
});
Hooks.on("renderSidebarTab", (D, s, e) => {
  if ((D == null ? void 0 : D.id) !== "combat") return;
  const t = s[0] ?? s;
...
Hooks.on("renderTokenHUD", (D, s, e) => {
  var d;
  const t = D == null ? void 0 : D.object, a = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
  if ((a == null ? void 0 : a.type) === "Karakter") {
    const n = s[0] ?? s;
    n != null && n.classList && n.classList.add("votv-karakter-token-hud");
  }
});
Hooks.on("preCreateScene", (D, s) => {
  var e;
  (e = s == null ? void 0 : s.background) != null && e.src || D.updateSource({
    width: 3840,
    height: 2160,
    "background.src": Xt,
    backgroundColor: "#0f0f0f",
...
Hooks.on("renderChatMessageHTML", (D, s, e) => {
  var m, y, b, u;
  const t = ((m = D.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, a = t.resultType, d = t.critLabel, n = t.weaponAttack, c = t.weapon;
  if (!a && !d && !n) return;
  ...
  if (f) {
    ...
    if (n && c && (c.actorId || (b = D.speaker) != null && b.actor)) {
      ...
      if (c.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", p.dataset.actorId = String(c.actorId ?? ((u = D.speaker) == null ? void 0 : u.actor) ?? ""), p.dataset.itemId = String(c.itemId ?? ""), p.dataset.slotKey = String(c.slotKey ?? ""), p.dataset.targetName = String(c.targetName ?? ""), p.dataset.hitLocationName = String(c.hitLocationName ?? ""), p.dataset.messageId = String(D.id ?? ""), l.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-CdWqPe-a.mjs.map
