...
const { HTMLField: os, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: tt } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (p = n.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : m.value) ?? 0, r = ((y = n.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return W._healthStatusFromRatio(r, d);
  }
  async _prepareContext(s) {
    var U, oe, X, Pe, ye, ke, ge, _e, Ce, Xe, Ze, Ve, et, He, Ae, yt, gt, ht, bt, kt, vt, wt, It, St, Tt, Dt, _t, Ct, Ot;
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], D = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, E = D && typeof D == "object" && !Array.isArray(D) ? D : {}, N = (((Ze = E.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), j = (((Ve = E.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), B = (((et = E.slot3) == null ? void 0 : et.itemId) ?? "").trim(), G = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, _) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DKQmZNZ4.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DKQmZNZ4.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DKQmZNZ4.mjs");
      f(this.actor, o, a);
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((b = e.system) == null ? void 0 : b.kp) ?? 0) || 0, d = (((u = e.system) == null ? void 0 : u.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const l = r && r.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, m = ((I = r == null ? void 0 : r.system) == null ? void 0 : I.type) || "kinetic", y = (((T = r == null ? void 0 : r.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = y && n[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", u = Number(n[b] || 0) || 0, i = p + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((se = t == null ? void 0 : t.items) == null ? void 0 : se.contents) ?? [], d = ((ae = t == null ? void 0 : t.system) == null ? void 0 : ae.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), p = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), y = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = p.length > 0 ? p : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var R;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const oe = !!R, X = (k == null ? void 0 : k.system) ?? {}, Pe = typeof X.range == "string" ? (X.range || "").trim() : "", ye = X.type ?? "", ke = (a[ye] ?? ye) || "—", ge = X.size ?? "", _e = (f[ge] ?? ge) || "", Ce = [ke, _e].filter(Boolean).join(", ") || ke || "—", Xe = ye === "projectile" || ge === "thrown", Ze = X.quantity != null ? String(X.quantity).trim() : "1", Ve = String(X.bonus ?? U.bonus ?? "").trim() || "0", et = (X.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const A = (((Ne = e.weaponsTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((Ge = e.armorTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((xe = e.microchipsTable) == null ? void 0 : xe.length) ?? 0) > 0 || (((We = e.itemsTable) == null ? void 0 : We.length) ?? 0) > 0 || (((Re = e.egyebList) == null ? void 0 : Re.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const D = ((Ye = t == null ? void 0 : t.system) == null ? void 0 : Ye.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, R;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DKQmZNZ4.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DKQmZNZ4.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const p = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, y = ((A = l == null ? void 0 : l.system) == null ? void 0 : A.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(a);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const j = (((f = d.system) == null ? void 0 : f.kind) ?? "passive").toString(), B = ((h = r.system) == null ? void 0 : h.abilities) ?? {}, H = j === "active" ? "active" : "passive", G = Array.isArray((v = B[H]) == null ? void 0 : v.items) ? B[H].items.slice() : Array.isArray(B[H]) ? B[H].slice() : [];
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, q, P, A, D, E, N, j, B, H, G, V, x, Y, Q, ne, re, Se, Te;
    ...
    let p = ((P = game.actors) == null ? void 0 : P.get(r.actorId)) ?? ((A = game.actors) == null ? void 0 : A.get(l));
    ...
    const m = r.itemId ? ((j = (N = p.items) == null ? void 0 : N.get) == null ? void 0 : j.call(N, r.itemId)) ?? ((G = (H = (B = p.items) == null ? void 0 : B.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (be) => be.id === r.itemId)) : null;
    let y = (r.damageFormula ?? "").trim();
    if (y || (y = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !y && r.slotKey && (y = (((((x = p.system) == null ? void 0 : x.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Te = (((Se = p.system) == null ? void 0 : Se.weapons) ?? {})[r.slotKey]) == null ? void 0 : Te.name) ?? "" : "")) || "Fegyver";
...
function es(w) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" || n.update(ws).catch((d) => {
...
function ts() {
  ...
  for (const n of ((s = game.actors) == null ? void 0 : s.filter((d) => d.type === "Karakter")) ?? []) {
  ...
  for (const n of Object.values((ui == null ? void 0 : ui.windows) ?? {}))
    ((e = n == null ? void 0 : n.document) == null ? void 0 : e.documentName) !== "Actor" || ((t = n == null ? void 0 : n.document) == null ? void 0 : t.type) !== "Karakter" || w.has(n.id) || (w.add(n.id), typeof n.render == "function" && n.render(!0));
}
...
//# sourceMappingURL=vacuum-of-the-void-CmauptaY.mjs.map
