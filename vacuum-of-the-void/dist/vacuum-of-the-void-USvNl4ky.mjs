...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const O = ((Re = d[g]) == null ? void 0 : Re.value) ?? 0, _ = n[g] ?? 0;
    ...
    const T = this.actor.system.weapons ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = (T.slotOrder ?? "").trim(), q = L ? L.split(/\s*,\s*/).filter((g) => E.includes(g)) : [], w = (it = this.actor.system.gear) == null ? void 0 : it.microchips, C = w && typeof w == "object" && !Array.isArray(w) ? w : {}, F = (((rt = C.slot1) == null ? void 0 : rt.itemId) ?? "").trim(), D = (((nt = C.slot2) == null ? void 0 : nt.itemId) ?? "").trim(), H = (((at = C.slot3) == null ? void 0 : at.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
    ...
    const X = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((g) => g.type === "MikroChip"), se = X.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ne = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var _, P, R;
      const O = [];
      return g !== 1 && O.push((((_ = C.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && O.push((((P = C.slot2) == null ? void 0 : P.itemId) ?? "").trim()), g !== 3 && O.push((((R = C.slot3) == null ? void 0 : R.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = se.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = se.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = se.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      const O = C[g] ?? {}, _ = (O.itemId ?? "").trim(), P = X.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || O.name || Ne,
        img: (P == null ? void 0 : P.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, _ = C[O] ?? {}, P = (_.itemId ?? "").trim(), R = se.find((J) => J.id === P);
      ...
      const P = !!_, R = ((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.abilityType) ?? "", J = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Y = R === "active", Fe = Number((qe = g == null ? void 0 : g.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ie = (((he = g == null ? void 0 : g.system) == null ? void 0 : he.description) ?? "").trim(), Oe = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const U = this.actor.system.abilities ?? {}, Te = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).map((g) => {
      ...
      const O = U[g] ?? {}, _ = (O.itemId ?? "").trim(), P = _ ? G.get(_) : null, R = (P == null ? void 0 : P.description) ?? "", J = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || O.name || Ee,
        img: (P == null ? void 0 : P.img) || "",
        description: R,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-C4M1IB-d.mjs");
      r(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-C4M1IB-d.mjs");
      f(this.actor, o, r);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-C4M1IB-d.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-C4M1IB-d.mjs");
      r(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const C = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), F = ((r = n.system) == null ? void 0 : r.abilities) ?? {}, D = C === "active" ? "active" : "passive", H = Array.isArray((f = F[D]) == null ? void 0 : f.items) ? F[D].items.slice() : Array.isArray(F[D]) ? F[D].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const w = ((I = n.system) == null ? void 0 : I.weapons) ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = (w.slotOrder ?? "").trim(), D = F ? F.split(/\s*,\s*/).filter((W) => C.includes(W)) : [];
      let H = C.find((W) => {
        var ee;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, p, m, y) => {
    ...
    for (const D of r)
      ((q = D.document) == null ? void 0 : q.id) !== b || ((w = D.document) == null ? void 0 : w.documentName) !== "Actor" || ((C = D.constructor) == null ? void 0 : C.name) !== "VoidKarakterSheet" || c.includes(D) || c.push(D);
    if (i && c.some((D) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, E, L, q, w, C, F, D, H, V, W, ee, fe, te, ue, ve, we, Ie, Se;
...
//# sourceMappingURL=vacuum-of-the-void-USvNl4ky.mjs.map
