...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-_ZgUXETN.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-_ZgUXETN.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-_ZgUXETN.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((L = (C = this.actor.items).get) == null ? void 0 : L.call(C, h)) ?? ((_ = (N = this.actor.items.contents) == null ? void 0 : N.find) == null ? void 0 : _.call(N, (P) => P.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = I ? I.split(/\s*,\s*/).filter((N) => S.includes(N)) : [], L = C.find((N) => {
          var _;
          return (((_ = v[N]) == null ? void 0 : _.itemId) ?? "").trim() === o;
        });
        if (L) {
          const N = C.filter((_) => _ !== L);
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((_) => v.includes(_)) : [], S = I.find((_) => {
        var F;
        return (((F = f[_]) == null ? void 0 : F.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (S) return;
        let _ = I.find((P) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${_}.name`]: (r == null ? void 0 : r.name) ?? "",
          [`system.weapons.${_}.damage`]: ((L = r == null ? void 0 : r.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${_}.bonus`]: ((N = r == null ? void 0 : r.system) == null ? void 0 : N.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const _ = I.filter((F) => F !== S);
        await this.actor.update({
      ...
      if (!f) return;
      const h = (c.dataset.itemId ?? "").trim(), v = (c.dataset.itemName ?? ((_ = c.textContent) == null ? void 0 : _.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (c.dataset.itemImg ?? "").trim(), S = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          "system.weapons.slotOrder": I.join(","),
          [`system.weapons.${_}.itemId`]: o,
          [`system.weapons.${_}.name`]: r.name ?? "",
          [`system.weapons.${_}.damage`]: ((L = r.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${_}.bonus`]: ((N = r.system) == null ? void 0 : N.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const _ = I.filter((F) => F !== S);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((_) => C.includes(_)) : [], N = L.filter((_) => {
              var F;
              return (((F = I[_]) == null ? void 0 : F.itemId) ?? "").trim() === v;
            });
            if (N.length > 0) {
              const F = {
                "system.weapons.slotOrder": L.filter((P) => !N.includes(P)).join(",")
              };
              for (const P of N)
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    const _ = ((ht = t == null ? void 0 : t.system) == null ? void 0 : ht.abilities) ?? {}, F = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var E, x;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-_ZgUXETN.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-_ZgUXETN.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-_ZgUXETN.mjs");
      r(this.actor, c, o);
      ...
      const o = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, f = (Array.isArray((L = o[s]) == null ? void 0 : L.items) ? o[s].items.slice() : []).filter((N) => N !== c);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, d = ((C = e.system) == null ? void 0 : C.skills) ?? {}, a = ((L = e.items) == null ? void 0 : L.filter((F) => F.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = a.find((F) => F.id === n.itemId) ?? null);
    const m = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, g = ((N = l == null ? void 0 : l.system) == null ? void 0 : N.type) || "kinetic", b = (((_ = l == null ? void 0 : l.system) == null ? void 0 : _.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", s = Number(d[u] || 0) || 0, c = p + s, r = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(r);
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, S, C, L, N, _, F;
    ...
    if (d.type === "MikroChip" && p) {
      const P = ((F = (_ = a.system) == null ? void 0 : _.gear) == null ? void 0 : F.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var V;
    ...
    setTimeout(() => {
      ...
      if (c <= 0 && !o) {
        ...
        s.createEmbeddedDocuments("ActiveEffect", [{
          ...
          var C, L, N;
          const S = ((L = (C = canvas.scene) == null ? void 0 : C.tokens) == null ? void 0 : L.filter((_) => {
            var F;
            return ((F = _.actor) == null ? void 0 : F.id) === s.id;
          })) ?? [];
          for (const _ of S)
            (N = _ == null ? void 0 : _.object) != null && N.draw && _.object.draw();
        ...
        for (const L of I)
          ((C = L == null ? void 0 : L.document) == null ? void 0 : C.actorId) === u && typeof L.draw == "function" && L.draw();
      }).catch((I) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", I));
    }, 0);
  });
  const i = 500;
  Hooks.on("updateActor", (m, p, g, b) => {
    var S, C, L, N, _, F, P, z, G, H, V, Z, Y;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((L = (C = m.system) == null ? void 0 : C.combat) == null ? void 0 : L.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
        const ge = ((N = oe.combatants) == null ? void 0 : N.contents) ?? Array.from(oe.combatants ?? []);
        for (const re of ge)
          if (((_ = re.actor) == null ? void 0 : _.id) === u || re.actorId === u) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, C, L, N, _, F, P, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
    ...
    if (m || (m = ((F = (_ = game.scenes) == null ? void 0 : _.contents) == null ? void 0 : F.flatMap((se) => {
      var ne;
...
//# sourceMappingURL=vacuum-of-the-void-kkXu9C3t.mjs.map
