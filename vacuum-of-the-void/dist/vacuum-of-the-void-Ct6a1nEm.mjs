...
const { BooleanField: pt, NumberField: kt, StringField: Q } = foundry.data.fields;
...
const { NumberField: ht, StringField: Ue } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var qe, Te, De, Oe, _e, Le, Ae, Fe, Ne, Ee, $e, Ce, xe, Pe, je, Ke;
    ...
    const st = (((Ce = this.actor.items) == null ? void 0 : Ce.contents) ?? []).filter((u) => u.type === "Pancél");
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (r) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-DLVIVZn-.mjs");
      c(this.actor, l);
    ...
    n && i({ currentTarget: n }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (r) => {
      ...
      var f;
      r.preventDefault();
      const a = r.currentTarget, l = a.dataset.skill, c = ((f = a.textContent) == null ? void 0 : f.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-DLVIVZn-.mjs");
      m(this.actor, l, c);
...
let ye = G;
const bt = "systems/vacuum-of-the-void/assets/void-bg.jpg";
Hooks.once("init", () => {
  var s, e, t, i, n;
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = mt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ft, CONFIG.Item.dataModels.microchip = gt, CONFIG.Item.dataModels.Kepesseg = He, CONFIG.Item.dataModels.ability = He, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-Ct6a1nEm.mjs.map
