...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = (T.slotOrder ?? "").trim(), P = L ? L.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], w = (it = this.actor.system.gear) == null ? void 0 : it.microchips, D = w && typeof w == "object" && !Array.isArray(w) ? w : {}, F = (((rt = D.slot1) == null ? void 0 : rt.itemId) ?? "").trim(), O = (((nt = D.slot2) == null ? void 0 : nt.itemId) ?? "").trim(), H = (((at = D.slot3) == null ? void 0 : at.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, C) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, N = typeof C.sort == "number" ? C.sort : 0;
      return _ - N;
    }).map((g) => {
    ...
    e.weaponItems = fe;
    const te = "— Nincs fegyver —", ue = P.filter((g) => {
    ...
    e.armorTable = Ie.map((g) => {
      var N, R;
      const C = (g == null ? void 0 : g.system) ?? {}, _ = ((N = g.system) == null ? void 0 : N.equipped) !== void 0 && ((R = g.system) == null ? void 0 : R.equipped) !== null ? !!g.system.equipped : !1;
      return {
        itemId: g.id,
        actorId: this.actor.id,
        ...
        level: _armorLevelLabel((C.level ?? "").toString().trim()),
    ...
    e.itemsTable = Se.map((g) => {
      const C = (g == null ? void 0 : g.system) ?? {}, _ = (C.description ?? "").trim(), N = _ ? _.length > 60 ? _.slice(0, 57) + "…" : _ : "—", R = C.quantity != null ? String(C.quantity).trim() : "1";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const X = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((g) => g.type === "MikroChip"), se = X.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ne = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var _, N, R;
      const C = [];
      return g !== 1 && C.push((((_ = D.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && C.push((((N = D.slot2) == null ? void 0 : N.itemId) ?? "").trim()), g !== 3 && C.push((((R = D.slot3) == null ? void 0 : R.itemId) ?? "").trim()), C.filter(Boolean);
    };
    e.microchipItemsSlot1 = se.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = se.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = se.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      const C = D[g] ?? {}, _ = (C.itemId ?? "").trim(), N = X.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (N == null ? void 0 : N.name) || C.name || Ne,
        img: (N == null ? void 0 : N.img) || "",
        active: C.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const C = `slot${g}`, _ = D[C] ?? {}, N = (_.itemId ?? "").trim(), R = se.find((J) => J.id === N);
    ...
    const U = this.actor.system.abilities ?? {}, Te = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).map((g) => {
      ...
      const C = U[g] ?? {}, _ = (C.itemId ?? "").trim(), N = _ ? G.get(_) : null, R = (N == null ? void 0 : N.description) ?? "", J = (N == null ? void 0 : N.kp) ?? 0;
      return {
        itemId: _,
        displayName: (N == null ? void 0 : N.name) || C.name || Ee,
        img: (N == null ? void 0 : N.img) || "",
        description: R,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-B-vlEU25.mjs");
      n(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, n = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-B-vlEU25.mjs");
      f(this.actor, o, n);
      ...
      if (!h) return;
      const v = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, h)) ?? ((w = (P = this.actor.items.contents) == null ? void 0 : P.find) == null ? void 0 : w.call(P, (F) => F.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = n.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((P) => T.includes(P)) : [], L = q.find((P) => {
          var w;
          return (((w = v[P]) == null ? void 0 : w.itemId) ?? "").trim() === o;
        });
        if (L) {
          const P = q.filter((w) => w !== L);
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((L = n == null ? void 0 : n.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${w}.bonus`]: ((P = n == null ? void 0 : n.system) == null ? void 0 : P.bonus) ?? ""
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((L = n.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${w}.bonus`]: ((P = n.system) == null ? void 0 : P.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (T) {
        const w = I.filter((D) => D !== T);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (n && n.documentName === "Item" && n.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = T ? T.split(/\s*,\s*/).filter((w) => q.includes(w)) : [], P = L.filter((w) => {
              var D;
              return (((D = I[w]) == null ? void 0 : D.itemId) ?? "").trim() === v;
            });
            if (P.length > 0) {
              const D = {
                "system.weapons.slotOrder": L.filter((F) => !P.includes(F)).join(",")
              };
              for (const F of P)
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const P = (((Ie = e.weaponsTable) == null ? void 0 : Ie.length) ?? 0) > 0 || (((Se = e.armorTable) == null ? void 0 : Se.length) ?? 0) > 0 || (((ye = e.microchipsTable) == null ? void 0 : ye.length) ?? 0) > 0 || (((X = e.itemsTable) == null ? void 0 : X.length) ?? 0) > 0 || (((se = e.egyebList) == null ? void 0 : se.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-B-vlEU25.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-B-vlEU25.mjs");
      n(this.actor, c, o);
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, f = (Array.isArray((L = o[i]) == null ? void 0 : L.items) ? o[i].items.slice() : []).filter((P) => P !== c);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const a = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, r = ((L = e.items) == null ? void 0 : L.filter((D) => D.type === "Fegyver")) ?? [];
    let l = null;
    a.itemId && (l = r.find((D) => D.id === a.itemId) ?? null);
    const p = l && l.name || a.name || "Fegyver", m = Number(a.bonus || 0) || 0, y = ((P = l == null ? void 0 : l.system) == null ? void 0 : P.type) || "kinetic", b = (((w = l == null ? void 0 : l.system) == null ? void 0 : w.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, n = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(n);
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, n, f, h, v, I, T, q, L, P;
    ...
    if (d.type === "MikroChip" && m) {
      const w = ((P = (L = r.system) == null ? void 0 : L.gear) == null ? void 0 : P.microchips) ?? {}, F = ["slot1", "slot2", "slot3"].find((O) => {
        var H;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, p, m, y) => {
    ...
    if (l.type === "Npc" && ((I = p == null ? void 0 : p.system) != null && I.identity) && "size" in p.system.identity) {
      const O = Kt((q = (T = l.system) == null ? void 0 : T.identity) == null ? void 0 : q.size);
      l.update({
    ...
    for (const O of n)
      ((P = O.document) == null ? void 0 : P.id) !== b || ((w = O.document) == null ? void 0 : w.documentName) !== "Actor" || ((D = O.constructor) == null ? void 0 : D.name) !== "VoidKarakterSheet" || c.includes(O) || c.push(O);
    if (i && c.some((O) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, q, L, P, w, D, F, O, H, V, W, ee, fe, te, ue, ve, we, Ie, Se;
    ...
    let p = ((L = game.actors) == null ? void 0 : L.get(r.actorId)) ?? ((P = game.actors) == null ? void 0 : P.get(l));
...
//# sourceMappingURL=vacuum-of-the-void-B6uyh2Ux.mjs.map
