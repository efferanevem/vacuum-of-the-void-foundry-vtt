...
var Bt = Reflect.get;
var zt = (N, s, e) => s in N ? Ht(N, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[s] = e;
var z = (N, s, e) => zt(N, typeof s != "symbol" ? s + "" : s, e);
var K = (N, s, e) => Bt(Ut(N), e, s);
const { HTMLField: Gt, NumberField: A, SchemaField: j, StringField: S, BooleanField: Q, ArrayField: He } = foundry.data.fields;
...
const { BooleanField: Jt, NumberField: ns, StringField: qe } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const a = ((i = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : i.resources) ?? {}, d = ((o = (c = a.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((r = a.currentHealth) == null ? void 0 : r.legs) ?? 0, l = B._healthStatusFromRatio(n, d), f = Number(((v = (h = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CABIBF5e.mjs");
      r(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-CABIBF5e.mjs");
      p(this.actor, o, r);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const L = h ? this.actor.items.get(h) : null, q = {
        ...
        [`system.gear.microchips.${p}.name`]: (L == null ? void 0 : L.name) ?? ""
      };
      h && (q[`system.gear.microchips.${p}.active`] = !0), await this.actor.update(q);
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
            ...
            p = ((d = (await this.actor.createEmbeddedDocuments("Item", [E]))[0]) == null ? void 0 : d.id) ?? p;
          }
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = p.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = T ? T.split(/\s*,\s*/).filter((w) => E.includes(w)) : [], q = L.filter((w) => {
              var O;
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const Se = !!M, G = (k == null ? void 0 : k.system) ?? {}, Ee = typeof G.range == "string" ? (G.range || "").trim() : "", de = G.type ?? "", ge = (r[de] ?? de) || "—", me = G.size ?? "", Te = (p[me] ?? me) || "", _e = [ge, Te].filter(Boolean).join(", ") || ge || "—", Me = de === "projectile" || me === "thrown", Re = G.quantity != null ? String(G.quantity).trim() : "1", je = String(G.bonus ?? U.bonus ?? "").trim() || "0", Ke = (G.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: x,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CABIBF5e.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CABIBF5e.mjs");
      r(this.actor, c, o);
      ...
      const o = ((E = this.actor.system) == null ? void 0 : E.abilities) ?? {}, p = (Array.isArray((L = o[i]) == null ? void 0 : L.items) ? o[i].items.slice() : []).filter((q) => q !== c);
  ...
  async _rollWeapon(s) {
    ...
    const f = l && l.name || a.name || "Fegyver", m = Number(a.bonus || 0) || 0, b = (((L = l == null ? void 0 : l.system) == null ? void 0 : L.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", u = Number(d[b] || 0) || 0, i = m + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, r = new Roll(o);
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, r, p, h, v, I, T, E, L, q;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const O = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), F = ((r = n.system) == null ? void 0 : r.abilities) ?? {}, D = O === "active" ? "active" : "passive", H = Array.isArray((p = F[D]) == null ? void 0 : p.items) ? F[D].items.slice() : Array.isArray(F[D]) ? F[D].slice() : [];
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    if (l.type === "Npc" && ((I = f == null ? void 0 : f.system) != null && I.identity) && "size" in f.system.identity) {
      const D = is((E = (T = l.system) == null ? void 0 : T.identity) == null ? void 0 : E.size);
      l.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, E, L, q, w, O, F, D, H, V, W, ee, fe, te, ue, ke, ve, we, Ie;
    ...
    let f = ((L = game.actors) == null ? void 0 : L.get(n.actorId)) ?? ((q = game.actors) == null ? void 0 : q.get(l));
    ...
    const m = n.itemId ? ((D = (F = f.items) == null ? void 0 : F.get) == null ? void 0 : D.call(F, n.itemId)) ?? ((W = (V = (H = f.items) == null ? void 0 : H.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (ye) => ye.id === n.itemId)) : null;
  ...
  if (f) {
    ...
    if (n && l && (l.actorId || (b = N.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((u = N.speaker) == null ? void 0 : u.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(N.id ?? ""), c.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-eXxGUI8X.mjs.map
