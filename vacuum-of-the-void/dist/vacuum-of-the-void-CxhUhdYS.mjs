...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((r = i.querySelector) == null ? void 0 : r.call(i, "form.votv.karakter-sheet")) ?? ((f = i.querySelector) == null ? void 0 : f.call(i, "form.votv")) ?? null, t = ((s = i.querySelector) == null ? void 0 : s.call(i, ".votv-scroll")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const f = this.element, s = this.form ?? this.element;
    let a = { scrollState: {}, focus: null };
    if (f) {
      a.scrollState = this._saveScrollState(f);
      const m = document.activeElement, g = s.contains(m), v = m && (m.tagName === "INPUT" && m.type !== "checkbox" && m.type !== "radio" || m.tagName === "TEXTAREA");
      g && v && (a.focus = {
        name: m.name || null,
        id: m.id || null,
    ...
    const d = await super.render(i, e);
    requestAnimationFrame(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }), setTimeout(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }, 150);
    const p = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, c = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var m, g;
      if (this._applyScrollState(p, h), (n == null ? void 0 : n.name) != null || (n == null ? void 0 : n.id) != null) {
        const v = ((m = y.querySelector) == null ? void 0 : m.call(y, n.id ? `#${CSS.escape(n.id)}` : null)) ?? (n.name ? (g = y.querySelector) == null ? void 0 : g.call(y, `[name="${CSS.escape(n.name)}"]`) : null);
        v && (v.tagName === "INPUT" || v.tagName === "TEXTAREA") && (v.focus({ preventScroll: !0 }), typeof v.selectionStart == "number" && (v.selectionStart = n.selectionStart ?? 0, v.selectionEnd = n.selectionEnd ?? n.selectionStart ?? 0));
      }
      this._applyScrollState(p, h);
    };
    return (c || n) && (requestAnimationFrame(l), setTimeout(l, 0), setTimeout(l, 50), setTimeout(l, 150), setTimeout(l, 300), setTimeout(l, 450)), d;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (r <= 0 || t <= 0) return 0;
    const f = Math.floor(r / 3), s = Math.floor(2 * r / 3);
    return t <= f ? 1 : t <= s ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.speedPenalty) ?? "").trim().replace(",", "."), d = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.protectionBonus) ?? "").trim().replace(",", "."), d = Number(a);
      Number.isFinite(d) && (e += d);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, f = ((u = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : u.value) ?? 0, s = ((m = r.currentHealth) == null ? void 0 : m.legs) ?? 0, a = N._healthStatusFromRatio(s, f), d = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let p;
    a === 0 ? p = 0 : a === 1 ? p = -6 : a === 2 ? p = -3 : p = d;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const f = (Number(((p = (d = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : d.combat) == null ? void 0 : p.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((s = this.actor.system) == null ? void 0 : s.resources) ?? {}, r = ((d = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : d.value) ?? 0, f = ((p = t.currentHealth) == null ? void 0 : p[e]) ?? 0;
    return N._healthStatusFromRatio(f, r);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, f = ((p = (d = r.hitLocations) == null ? void 0 : d[t]) == null ? void 0 : p.value) ?? 0, s = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return N._healthStatusFromRatio(s, f);
  }
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const r = this.actor.system.resources ?? {}, f = r.hitLocations ?? {}, s = r.currentHealth ?? {}, a = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const o of a) {
      const I = ((Ne = f[o]) == null ? void 0 : Ne.value) ?? 0, w = s[o] ?? 0;
      e.computedHealthStatus[o] = N._healthStatusFromRatio(w, I);
    }
    const d = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((o) => (Number(s[o]) || 0) === 0).length;
    e.showDeathSkull = d || y >= 2;
    const h = e.computedHealthStatus.legs ?? 3, n = Number(((xe = ($e = this.actor.system) == null ? void 0 : $e.combat) == null ? void 0 : xe.givenSpeed) ?? 0) || 0;
    let c;
    h === 0 ? c = 0 : h === 1 ? c = -6 : h === 2 ? c = -3 : c = n;
    ...
    const v = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (v.slotOrder ?? "").trim(), L = q ? q.split(/\s*,\s*/).filter((o) => S.includes(o)) : [], P = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = P && typeof P == "object" && !Array.isArray(P) ? P : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), A = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((o) => o.type !== "Kepesseg" && o.type !== "ability").slice().sort((o, I) => {
      ...
      for (let ie = 0; ie < L.length; ie++) {
        const re = L[ie];
        if ((((X = v[re]) == null ? void 0 : X.itemId) ?? "") === o.id) {
      ...
      const ne = I && ((te = o.system) != null && te.damage) ? o.system.damage : "", Q = I && typeof ((Z = o.system) == null ? void 0 : Z.range) == "string" ? (o.system.range || "").trim() : "", J = j ? Number((V = v[j]) == null ? void 0 : V.bonus) || 0 : "";
      return {
        id: o.id,
        name: o.name,
        img: o.img,
    ...
    const Te = "— Nincs fegyver —", pt = L.filter((o) => {
      const w = ((v[o] ?? {}).itemId ?? "").trim();
      return w ? !!ue.find((D) => D.id === w) : !1;
    });
    e.weaponSlots = pt.map((o, I) => {
      const w = v[o] ?? {}, T = (w.itemId ?? "").trim(), D = Se.find((j) => j.id === T);
      return {
        slotKey: o,
        itemId: T,
        slotNum: I + 1,
    ...
    const vt = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).filter((o) => o.type === "Egyeb");
    e.egyebList = vt.map((o) => {
    ...
    const Oe = this.actor.system.abilities ?? {}, bt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((o) => {
      var I, w, T;
      return {
        id: o.id,
        name: o.name,
    ...
    }), De = new Map(bt.map((o) => [o.id, o])), kt = "— Nincs képesség —", Ce = (o) => {
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-dS2YQOcZ.mjs");
      u(this.actor, l);
      ...
      if (!l) {
        ...
        if (!v) return;
        l = (((((m = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : m.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      l && await this._rollWeaponDamage(l, ((g = c.dataset.slot) == null ? void 0 : g.trim()) ?? "");
    }), !this.isEditable) return;
    const r = (n) => {
      var u;
      const c = n ? n.currentTarget : (u = e.querySelector) == null ? void 0 : u.call(e, 'input[name="system.resources.stress.value"]');
      if (!c) return;
    ...
    const f = (h = e.querySelector) == null ? void 0 : h.call(e, 'input[name="system.resources.stress.value"]');
    f && r({ currentTarget: f }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }), setTimeout(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
      ...
      var g;
      n.preventDefault();
      const c = n.currentTarget, l = c.dataset.skill, u = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-dS2YQOcZ.mjs");
      m(this.actor, l, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if (!l) return;
      const u = this.actor, m = u.items.get(l), g = {};
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const v = u.system.weapons ?? {}, S = (v.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((O) => q.includes(O)) : [], P = L.find((O) => {
          var k;
      ...
      const m = this.actor.system.weapons ?? {}, g = (m.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = g ? g.split(/\s*,\s*/).filter((k) => v.includes(k)) : [], q = S.find((k) => {
        var A;
        return (((A = m[k]) == null ? void 0 : A.itemId) ?? "").trim() === l;
      }) ?? null;
      if (c.checked) {
        if (q) return;
        let k = S.find((x) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${k}.name`]: (u == null ? void 0 : u.name) ?? "",
          [`system.weapons.${k}.damage`]: ((P = u == null ? void 0 : u.system) == null ? void 0 : P.damage) ?? "",
          [`system.weapons.${k}.bonus`]: ((O = u == null ? void 0 : u.system) == null ? void 0 : O.bonus) ?? ""
      ...
      var k;
      n.preventDefault();
      const c = n.currentTarget, l = c.closest(".karakter-microchip-slot-select-wrap"), u = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), m = u == null ? void 0 : u.dataset.slot;
      if (!m) return;
      const g = (c.dataset.itemId ?? "").trim(), v = (c.dataset.itemName ?? ((k = c.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (c.dataset.itemImg ?? "").trim(), q = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      q && (q.textContent = v);
      let L = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-thumb");
      S ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", u == null || u.insertBefore(L, q)), L.src = S, L.style.display = "") : L && L.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
      ...
      const u = ((S = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : S.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((q) => {
        var L;
        return (((L = u[q]) == null ? void 0 : L.itemId) ?? "").trim() === c;
      });
      ...
      if (!c || !l) return;
      const u = this.actor.system.abilities ?? {}, g = (Array.isArray((v = u[c]) == null ? void 0 : v.items) ? u[c].items.slice() : []).filter((S) => S !== l);
      ...
      if (!l) return;
      const u = this.actor.items.get(l);
      !u || u.type !== "Pancel" || (await u.update({ "system.equipped": c.checked }), this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection());
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          "system.weapons.slotOrder": S.join(","),
          [`system.weapons.${k}.itemId`]: l,
          [`system.weapons.${k}.name`]: u.name ?? "",
          [`system.weapons.${k}.damage`]: ((P = u.system) == null ? void 0 : P.damage) ?? "",
          [`system.weapons.${k}.bonus`]: ((O = u.system) == null ? void 0 : O.bonus) ?? ""
        }), await u.update({ "system.equipped": !0 });
      } else if (q) {
        const k = S.filter((A) => A !== q);
        await this.actor.update({
      ...
      if (!c) return;
      const l = this.actor.items.get(c);
      !l || l.type !== "Targy" && l.type !== "Egyeb" || await this.actor.deleteEmbeddedDocuments("Item", [c]);
    });
    const a = this, d = (n) => {
      var u, m, g, v;
      if (!n) return;
      const c = a._getFormDataForUpdate(n);
      if (Object.keys(c).length === 0) return;
      const l = ((m = (u = c.system) == null ? void 0 : u.resources) == null ? void 0 : m.currentHealth) != null || ((v = (g = c.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      a.actor.update(c).then(() => {
        l && setTimeout(() => a.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, p = (n) => {
      var c, l, u;
      return n && (((l = (c = a.element) == null ? void 0 : c.contains) == null ? void 0 : l.call(c, n)) || a.id && ((u = n.closest) == null ? void 0 : u.call(n, `#${CSS.escape(a.id)}`)));
    };
    a._votvBlur = (n) => {
      const c = n.target;
      if (!c || !c.form) return;
      ...
      const u = c.form;
      p(u) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), d(u));
  ...
  _getFormDataForUpdate(i) {
    ...
    ), r = t.hitLocations ?? {}, f = t.currentHealth ?? {}, s = ["head", "torso", "arms", "legs"];
    for (const y of s) {
      const h = ((p = r[y]) == null ? void 0 : p.value) ?? 0, n = f[y] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, N._healthStatusFromRatio(n, h));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, r, f, s, a, d, p, y, h, n, c, l;
    if (e) {
      ...
      if (u) {
        ...
        if (m && m.documentName === "Item" && (m.type === "Kepesseg" || m.type === "ability")) {
          ...
          if (((r = m.parent) == null ? void 0 : r.id) !== this.actor.id) {
            ...
            g = ((f = (await this.actor.createEmbeddedDocuments("Item", [P]))[0]) == null ? void 0 : f.id) ?? g;
          }
          const v = (((s = m.system) == null ? void 0 : s.kind) ?? "passive").toString(), S = this.actor.system.abilities ?? {};
          if (v === "species") {
            await this.actor.update({
          ...
          const q = v === "active" ? "active" : "passive", L = Array.isArray((a = S[q]) == null ? void 0 : a.items) ? S[q].items.slice() : Array.isArray(S[q]) ? S[q].slice() : [];
    ...
    if (e) {
      let u = e.uuid ?? e.documentUuid ?? ((d = e.data) == null ? void 0 : d.uuid) ?? (typeof e == "string" ? e : null);
      if (!u && typeof e == "object") {
        for (const m of Object.values(e))
          if (typeof m == "string" && m.includes(".") && m.startsWith("Item.")) {
            u = m;
      ...
      if (u) {
        ...
        if (m && m.documentName === "Item" && m.type === "Fegyver") {
          const g = this.actor, v = ((p = m.parent) == null ? void 0 : p.id) !== g.id;
          let S = m.id;
          if (v) {
        ...
        if (m && m.documentName === "Item" && m.type === "Pancel") {
          ...
          if (((n = m.parent) == null ? void 0 : n.id) !== g.id) {
            const v = foundry.utils.mergeObject(m.toObject(), { system: { ...m.toObject().system ?? {}, equipped: !1 } });
        ...
        if (m && m.documentName === "Item" && (m.type === "Targy" || m.type === "Egyeb")) {
          const g = this.actor;
          ((l = m.parent) == null ? void 0 : l.id) !== g.id && await g.createEmbeddedDocuments("Item", [m.toObject()]);
          return;
        }
      }
    }
  ...
  _onWeaponSlotDragOver(i, e) {
    var f, s, a;
    const t = ((f = i.dataTransfer) == null ? void 0 : f.getData("text/plain")) || ((s = i.dataTransfer) == null ? void 0 : s.getData("application/json")) || "";
    let r;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((d = i.dataTransfer) == null ? void 0 : d.getData("text/plain")) || ((p = i.dataTransfer) == null ? void 0 : p.getData("application/json")) || "";
    let r;
    try {
      r = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
    ...
    const f = await fromUuid(r.uuid);
    if (!f || f.type !== "Fegyver") return;
    if (((y = f.parent) == null ? void 0 : y.id) !== this.actor.id) {
      const c = foundry.utils.mergeObject(f.toObject(), { system: { ...f.toObject().system ?? {}, equipped: !1 } });
    ...
    await this.actor.update({
      ...
      [`system.weapons.${e}.damage`]: ((h = f.system) == null ? void 0 : h.damage) ?? "",
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const f = this.actor.items.contents.slice().sort((h, n) => {
      const c = typeof h.sort == "number" ? h.sort : 0, l = typeof n.sort == "number" ? n.sort : 0;
      return c - l;
    }).map((h) => h.id), s = f.indexOf(t), a = f.indexOf(e);
    if (s === -1 || a === -1) return;
    f.splice(s, 1), f.splice(a, 0, t);
    const d = f.map((h, n) => ({
      _id: h,
      sort: (n + 1) * 10
    }));
  ...
  _onInventoryAreaDragOver(i) {
    var r, f, s;
    const e = ((r = i.dataTransfer) == null ? void 0 : r.getData("text/plain")) || ((f = i.dataTransfer) == null ? void 0 : f.getData("application/json")) || "";
    let t = null;
  ...
  async _postItemToChat(i) {
    ...
    let r;
    e.type === "MikroChip" ? r = ((((d = e.system) == null ? void 0 : d.abilityType) ?? "passive") === "active" ? "Aktív" : "Passzív") + " Mikro-Chip" : r = "Egyéb Információ";
    const f = t ? `<p>${t}</p>` : "", s = `
      <h2>${e.name}</h2>
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, f = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", d = f ? `<p>${f}</p>` : "", p = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      f = ((d = (await this.actor.createEmbeddedDocuments("Item", [p]))[0]) == null ? void 0 : d.id) ?? f;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    var d, p, y, h;
    i.preventDefault(), (d = i.currentTarget) == null || d.classList.remove("karakter-ability-area-drag-over");
    const t = this._parseAbilityDrop(i);
    if (!t || !t.uuid) return;
    const r = await fromUuid(t.uuid);
    if (!r || r.type !== "Kepesseg" && r.type !== "ability") return;
    ...
    if (((p = r.parent) == null ? void 0 : p.id) !== this.actor.id) {
      ...
      f = ((y = (await this.actor.createEmbeddedDocuments("Item", [n]))[0]) == null ? void 0 : y.id) ?? f;
    }
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let s = f.id;
    ((y = f.parent) == null ? void 0 : y.id) !== this.actor.id && (s = ((h = (await this.actor.createEmbeddedDocuments("Item", [f.toObject()]))[0]) == null ? void 0 : h.id) ?? s), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    s === 1 ? f -= 6 : s === 2 && (f -= 3);
    const d = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, p = new Roll(d);
    await p.evaluate({ async: !0 });
    const y = p.total >= 18 ? "critical" : p.total <= 3 ? "fumble" : null, h = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollMorale() {
    var f;
    const i = Number(((f = this.actor.system.resources) == null ? void 0 : f.morale) ?? 0) || 0;
    if (i <= 0) return;
  ...
  async _rollWeapon(i) {
    var v;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, f = this.actor.items.filter((S) => S.type === "Fegyver");
    let s = null;
    t.itemId && (s = f.find((S) => S.id === t.itemId) ?? null);
    const a = s && s.name || t.name || `Fegyver (${i})`, d = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = d + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, u = new Roll(l);
    await u.evaluate({ async: !0 });
    const m = u.total >= 18 ? "critical" : u.total <= 3 ? "fumble" : null, g = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${a} – találat`,
  ...
  async _rollWeaponDamage(i, e = "") {
    var d, p, y, h, n, c, l, u, m, g;
    const t = this.actor;
    if (!t) return;
    let r = ((p = (d = t.items).get) == null ? void 0 : p.call(d, i)) ?? ((h = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : h.call(y, (v) => v.id === i));
    if (!r || r.type !== "Fegyver") return;
    let f = (((n = r.system) == null ? void 0 : n.damage) ?? "").trim();
    if (!f && e && (f = (((((c = t.system) == null ? void 0 : c.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (g = (l = ui.notifications) == null ? void 0 : l.warn) == null || g.call(l, ((m = (u = game.i18n) == null ? void 0 : u.localize) == null ? void 0 : m.call(u, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const s = new Roll(f);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var d, p, y, h;
      if (!e.isEditable || !((p = (d = s.target) == null ? void 0 : d.closest) != null && p.call(d, ".profile")) && ((h = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
    ...
    const r = (s) => {
      ...
      var a, d, p;
      return s && (((d = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : d.call(a, s)) || e.id && ((p = s.closest) == null ? void 0 : p.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var d, p, y;
      const a = ((d = s.target) == null ? void 0 : d.form) ?? ((y = (p = s.target) == null ? void 0 : p.closest) == null ? void 0 : y.call(p, "form"));
      f(a) && r(a);
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (s) => {
      ...
      f(d) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(d), 300));
...
R(z, "PARTS", foundry.utils.mergeObject(F(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((lt = F(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : lt.form) ?? {}, { submitOnChange: !0 })
}));
let ke = z;
var ct;
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var p, y, h, n, c, l, u;
      if (!e.isEditable || !((y = (p = s.target) == null ? void 0 : p.closest) != null && y.call(p, ".profile")) && ((n = (h = s.target) == null ? void 0 : h.getAttribute) == null ? void 0 : n.call(h, "data-edit")) !== "img") return;
      s.preventDefault(), s.stopPropagation();
      const a = ((u = (l = (c = foundry.applications) == null ? void 0 : c.apps) == null ? void 0 : l.FilePicker) == null ? void 0 : u.implementation) ?? globalThis.FilePicker;
      new a({
        type: "image",
        current: e.document.img || "",
        callback: (m) => {
...
R(W, "PARTS", foundry.utils.mergeObject(F(W, W, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ct = F(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : ct.form) ?? {}, { submitOnChange: !1 })
}));
let we = W;
var ut;
...
Hooks.once("init", () => {
  ...
  console.log("Vacuum of the Void | Initializing system"), game.votv = {
    ...
    value: []
  }, (r = CONFIG.Actor).typeLabels ?? (r.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", (f = CONFIG.Item).typeLabels ?? (f.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", ge, {
    types: ["Karakter"],
    makeDefault: !0,
  ...
  const E = 500;
  Hooks.on("updateActor", (s, a, d, p) => {
    var S, q, L, P, O;
    const y = s == null ? void 0 : s.id;
    if (!y) return;
    const h = document.activeElement, n = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), c = [], l = (S = game.actors) == null ? void 0 : S.get(y);
    ...
    const g = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, v = g && Date.now() - g.at < E ? g.appId : null;
    setTimeout(() => {
      for (const k of c)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (p = (d = e.target) == null ? void 0 : d.closest) == null ? void 0 : p.call(d, "[data-document-id]"), r = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!r) return;
      const f = r.includes(".") ? r.split(".").pop() : r;
      f && ((h = game.actors) != null && h.get(f)) && (game.votv._dragSourceActorId = f);
    },
    !0
...
Hooks.on("preCreateToken", (E, i, e) => {
  ...
  const f = r ? (a = game.actors) == null ? void 0 : a.get(r) : null;
  !f || f.type !== "Karakter" || E.updateSource({
    ...t ? { actorId: t } : {},
    actorLink: !0
  });
});
...
Hooks.on("renderChatMessageHTML", (E, i, e) => {
  var f, s, a;
  const t = (s = (f = E.flags) == null ? void 0 : f["vacuum-of-the-void"]) == null ? void 0 : s.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-CxhUhdYS.mjs.map
