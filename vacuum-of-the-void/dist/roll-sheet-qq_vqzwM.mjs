import { V as le, c as Ce } from "./vacuum-of-the-void-CPoqNbyS.mjs";
class me extends Application {
  ...
  getData(t = {}) {
    var u, i, g, V, z, b, S, E, N, A, j, $, B, Q, D, Y, F, O;
    ...
    if (this._isWeaponAttack && ((V = (g = game.user) == null ? void 0 : g.targets) != null && V.size)) {
      ...
      s = (d == null ? void 0 : d.name) || (C == null ? void 0 : C.name) || "", (b = (z = d == null ? void 0 : d.statuses) == null ? void 0 : z.has) != null && b.call(z, "stunned") && (c += 1, m.push(game.i18n.localize("VOTV.RollSheet.AdvantageStunnedTarget"))), (E = (S = d == null ? void 0 : d.statuses) == null ? void 0 : S.has) != null && E.call(S, "unconscious") && (c += 1, m.push(game.i18n.localize("VOTV.StatusUnconscious"))), (A = (N = d == null ? void 0 : d.statuses) == null ? void 0 : N.has) != null && A.call(N, "grappled") && (c += 1, m.push(game.i18n.localize("VOTV.StatusGrappled"))), ($ = (j = d == null ? void 0 : d.statuses) == null ? void 0 : j.has) != null && $.call(j, "dodge") && (v = 1, o.push(game.i18n.localize("VOTV.StatusDodge")));
    }
    let p = v;
  ...
  async _doRoll(t) {
    var a, r, f, k, h, s, c, m, o, v, p, T, y, M, _, n, l, u, i, g, V, z, b, S, E, N, A, j, $, B, Q, D, Y, F, O;
    const e = this.actor;
    if (e) {
      ...
      try {
        ...
        if ((S = (b = game.user) == null ? void 0 : b.targets) != null && S.size) {
          ...
          if (I) {
            const re = ((E = I.system) == null ? void 0 : E.combat) ?? {}, ge = Number(re.defense ?? 0) || 0, be = Number(re.defenseBonus ?? 0) || 0, Se = Number(re.givenProtection ?? 0) || 0, ke = (A = (N = I.statuses) == null ? void 0 : N.has) != null && A.call(N, "lookaround") ? 1 : 0, _e = ($ = (j = I.statuses) == null ? void 0 : j.has) != null && $.call(j, "halfcover") ? 3 : 0, we = (Q = (B = I.statuses) == null ? void 0 : B.has) != null && Q.call(B, "threequarteredcover") ? 6 : 0;
            let ce = 0;
            if (I.type === "Karakter") {
...
function Fe(L, t) {
  ...
  const g = (((w = s == null ? void 0 : s.system) == null ? void 0 : w.damage) ?? "").trim(), V = (r.damage ?? "").trim(), z = g || V || "", b = (((U = s == null ? void 0 : s.system) == null ? void 0 : U.size) ?? r.size ?? "").toString().toLowerCase(), S = b === "heavy", E = b === "medium", N = b === "thrown", A = ((ne = (J = e.statuses) == null ? void 0 : J.has) == null ? void 0 : ne.call(J, "halfcover")) ?? !1, j = ((oe = (X = e.statuses) == null ? void 0 : X.has) == null ? void 0 : oe.call(X, "threequarteredcover")) ?? !1, $ = ((G = (Z = e.statuses) == null ? void 0 : Z.has) == null ? void 0 : G.call(Z, "fullcover")) ?? !1, B = S && A, Q = j && (E || S), D = $ && !N;
  new me({
    actor: L,
    skillKey: n,
    label: c,
...
//# sourceMappingURL=roll-sheet-qq_vqzwM.mjs.map
