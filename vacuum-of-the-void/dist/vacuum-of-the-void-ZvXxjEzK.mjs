...
const { BooleanField: jt, NumberField: Jt, StringField: Ie } = foundry.data.fields;
...
function ft(E) {
  ...
  const d = (i, r = 1) => {
    ...
    for (const a of i) {
      ...
      const u = typeof a.faces == "number" ? a.faces : void 0, p = Array.isArray(a.results) ? a.results : null;
  ...
  d(E.terms, 1);
  const c = s.filter((i) => i === 6).length, l = s.filter((i) => i === 1).length, f = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, g = c + f, h = l + m;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((o = s.querySelector) == null ? void 0 : o.call(s, "form.votv.karakter-sheet")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, "form.votv")) ?? null, t = ((c = s.querySelector) == null ? void 0 : c.call(s, ".votv-scroll")) ?? ((l = s.querySelector) == null ? void 0 : l.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const u = document.activeElement, p = c.contains(u), b = u && (u.tagName === "INPUT" && u.type !== "checkbox" && u.type !== "radio" || u.tagName === "TEXTAREA");
      p && b && (l.focus = {
        name: u.name || null,
        id: u.id || null,
    ...
    const m = this.element, g = this.form ?? this.element, h = l.scrollState, i = l.focus, r = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", n = () => {
      var u, p;
      if (this._applyScrollState(m, h), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const b = ((u = g.querySelector) == null ? void 0 : u.call(g, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (p = g.querySelector) == null ? void 0 : p.call(g, `[name="${CSS.escape(i.name)}"]`) : null);
    ...
    return (r || i) && (requestAnimationFrame(n), setTimeout(n, 0), setTimeout(n, 50), setTimeout(n, 150), setTimeout(n, 300), setTimeout(n, 450)), f;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, r, n, a, u, p, b, v;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const o = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((a = (n = o.hitLocations) == null ? void 0 : n.legs) == null ? void 0 : a.value) ?? 0, c = ((u = o.currentHealth) == null ? void 0 : u.legs) ?? 0, l = B._healthStatusFromRatio(c, d), f = Number(((v = (b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, o = ((f = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : f.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const o = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (f = o.hitLocations) == null ? void 0 : f[t]) == null ? void 0 : m.value) ?? 0, c = ((g = o.currentHealth) == null ? void 0 : g[t]) ?? 0;
    return B._healthStatusFromRatio(c, d);
  }
  async _prepareContext(s) {
    var _e, ce, pe, le, he, be, Me, je, Re, Ke, Pe, De, tt, st, it, rt, at, nt;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((pe = (ce = (_e = this.actor.system) == null ? void 0 : _e.resources) == null ? void 0 : ce.stress) == null ? void 0 : pe.value) || 0;
    e.stressOver10 = t > 10;
    const o = this.actor.system.resources ?? {}, d = o.hitLocations ?? {}, c = o.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    ...
    const u = (Number(((je = (Me = this.actor.system) == null ? void 0 : Me.combat) == null ? void 0 : je.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), O = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Pe = C.slot2) == null ? void 0 : Pe.itemId) ?? "").trim(), A = (((De = C.slot3) == null ? void 0 : De.itemId) ?? "").trim(), K = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return _ - L;
    }).map((y) => {
      var ue, ve, we, fe, ye, Ae;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Oe = 0; Oe < O.length; Oe++) {
        const Fe = O[Oe];
        if ((((ue = b[Fe]) == null ? void 0 : ue.itemId) ?? "") === y.id) {
          L = Oe + 1, M = ((ve = b[Fe]) == null ? void 0 : ve.bonus) ?? "", J = Fe;
          break;
        }
      }
      let Y = null;
      _ && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : A === y.id && (Y = "slot3"));
      const Ee = D && ((we = y.system) != null && we.damage) ? y.system.damage : "", te = D && typeof ((fe = y.system) == null ? void 0 : fe.range) == "string" ? (y.system.range || "").trim() : "", ke = J ? Number((ye = b[J]) == null ? void 0 : ye.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.actionsTable = K;
    const H = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((y) => y.type === "Fegyver"), V = H.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = V;
    const G = "— Nincs fegyver —", Z = O.filter((y) => {
      const _ = ((b[y] ?? {}).itemId ?? "").trim();
      return _ ? !!H.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = Z.map((y, D) => {
      const _ = b[y] ?? {}, L = (_.itemId ?? "").trim(), M = V.find((J) => J.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: D + 1,
    ...
    const de = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ee = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((y) => {
      var ot, ct, lt;
      const D = y.id;
      let _ = null, L = {};
      for (const Be of O)
      ...
      const M = !!_, J = ((ct = y.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = y.system) == null ? void 0 : lt.equipped) !== null ? !!y.system.equipped : M, Y = (y == null ? void 0 : y.system) ?? {}, Ee = typeof Y.range == "string" ? (Y.range || "").trim() : "", te = Y.type ?? "", ke = (de[te] ?? te) || "—", ue = Y.size ?? "", ve = (ee[ue] ?? ue) || "", we = [ke, ve].filter(Boolean).join(", ") || ke || "—", fe = te === "projectile" || ue === "thrown", ye = Y.quantity, Ae = ye != null ? String(ye).trim() : "1", Oe = String(L.bonus ?? "").trim(), Fe = String(Y.bonus ?? "").trim(), Lt = Oe || Fe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const Se = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).filter((y) => y.type === "MikroChip"), ge = Se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Ce = "— Nincs Mikro-Chip —", qe = ["slot1", "slot2", "slot3"], Te = (y) => {
      var _, L, M;
      const D = [];
      return y !== 1 && D.push((((_ = C.slot1) == null ? void 0 : _.itemId) ?? "").trim()), y !== 2 && D.push((((L = C.slot2) == null ? void 0 : L.itemId) ?? "").trim()), y !== 3 && D.push((((M = C.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = ge.filter((y) => !Te(1).includes(y.id)), e.microchipItemsSlot2 = ge.filter((y) => !Te(2).includes(y.id)), e.microchipItemsSlot3 = ge.filter((y) => !Te(3).includes(y.id)), e.microchipSlots = qe.map((y) => {
      const D = C[y] ?? {}, _ = (D.itemId ?? "").trim(), L = Se.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || Ce,
        img: (L == null ? void 0 : L.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const D = `slot${y}`, _ = C[D] ?? {}, L = (_.itemId ?? "").trim(), M = ge.find((J) => J.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Ce, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = Se.map((y) => {
      var ue, ve, we, fe;
      const D = y.id;
      let _ = null;
      for (const ye of qe)
        if ((((ue = C[ye]) == null ? void 0 : ue.itemId) ?? "").trim() === D) {
          _ = ye;
          break;
        }
      const L = !!_, M = ((ve = y == null ? void 0 : y.system) == null ? void 0 : ve.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Ee = Number((we = y == null ? void 0 : y.system) == null ? void 0 : we.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, te = (((fe = y == null ? void 0 : y.system) == null ? void 0 : fe.description) ?? "").trim(), ke = te ? te.length > 60 ? te.slice(0, 57) + "…" : te : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Le = this.actor.system.abilities ?? {}, k = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).map((y) => {
      var D, _, L;
      return {
        id: y.id,
        name: y.name,
    ...
    }), F = new Map(k.map((y) => [y.id, y])), x = "— Nincs képesség —", U = (y) => {
      const D = Le[y] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
    ...
    e.abilityFajiSlot = U("faji"), e.abilityHatterSlot = U("hatter");
    const me = (y) => {
      const D = Le[y];
    ...
    return e.abilityPassiveList = W(me("passive")), e.abilityActiveList = W(me("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!n) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-vapccMvt.mjs");
      a(this.actor, n);
      ...
      if (!n) {
        ...
        if (!b) return;
        n = (((((u = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : u.weapons) ?? {})[b] ?? {}).itemId ?? "").trim();
      }
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var a, u, p;
      i.preventDefault(), i.stopPropagation();
      const r = ((p = (u = (a = foundry.applications) == null ? void 0 : a.apps) == null ? void 0 : u.FilePicker) == null ? void 0 : p.implementation) ?? globalThis.FilePicker;
      new r({
        type: "image",
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, n = r.dataset.skill, a = ((p = r.textContent) == null ? void 0 : p.trim()) || n, { openRollSheetForSkill: u } = await import("./roll-sheet-vapccMvt.mjs");
      u(this.actor, n, a);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      (!Number.isFinite(u) || u < 0) && (u = 0), await a.update({ "system.quantity": u });
    }), t.on("click", ".karakter-item-delete", async (i) => {
      if (i.preventDefault(), !i.altKey) return;
      const n = i.currentTarget.dataset.itemId;
      if (!n) return;
      const a = this.actor, u = a.items.get(n), p = {};
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const b = a.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = v ? v.split(/\s*,\s*/).filter((C) => I.includes(C)) : [], q = O.find((C) => {
          var T;
          return (((T = b[C]) == null ? void 0 : T.itemId) ?? "").trim() === n;
        });
        if (q) {
      ...
      const u = this.actor.system.weapons ?? {}, p = (u.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = p ? p.split(/\s*,\s*/).filter((T) => b.includes(T)) : [], I = v.find((T) => {
        var S;
        return (((S = u[T]) == null ? void 0 : S.itemId) ?? "").trim() === n;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let T = v.find((A) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.bonus`]: ((C = a == null ? void 0 : a.system) == null ? void 0 : C.bonus) ?? ""
      ...
      var T;
      i.preventDefault();
      const r = i.currentTarget, n = r.closest(".karakter-microchip-slot-select-wrap"), a = n == null ? void 0 : n.querySelector(".karakter-microchip-slot-display"), u = a == null ? void 0 : a.dataset.slot;
      if (!u) return;
      ...
      I && (I.textContent = b);
      let O = n == null ? void 0 : n.querySelector(".karakter-microchip-slot-thumb");
      v ? (O || (O = document.createElement("img"), O.className = "karakter-microchip-slot-thumb", O.alt = "", a == null || a.insertBefore(O, I)), O.src = v, O.style.display = "") : O && O.remove(), n == null || n.classList.remove("karakter-microchip-slot-open");
      ...
      p && (C[`system.gear.microchips.${u}.active`] = !0), await this.actor.update(C);
      ...
      const a = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, p = ["slot1", "slot2", "slot3"].find((I) => {
        var O;
        return (((O = a[I]) == null ? void 0 : O.itemId) ?? "").trim() === r;
      });
      ...
      r.addEventListener("dragover", (a) => this._onMicrochipSlotDragOver(a, n)), r.addEventListener("dragleave", (a) => {
        var u;
        return (u = a.currentTarget) == null ? void 0 : u.classList.remove("karakter-microchip-slot-drag-over");
      ...
      n && (r.addEventListener("dragover", (a) => this._onAbilitySingleDragOver(a, n)), r.addEventListener("dragleave", (a) => {
        var u;
        return (u = a.currentTarget) == null ? void 0 : u.classList.remove("karakter-ability-slot-drag-over");
      }), r.addEventListener("drop", (a) => {
        var u;
        (u = a.currentTarget) == null || u.classList.remove("karakter-ability-slot-drag-over");
      }));
      ...
      n && (r.addEventListener("dragover", (a) => this._onAbilityAreaDragOver(a, n)), r.addEventListener("dragleave", (a) => {
        var u;
        return (u = a.currentTarget) == null ? void 0 : u.classList.remove("karakter-ability-area-drag-over");
      }), r.addEventListener("drop", (a) => {
        var u;
        (u = a.currentTarget) == null || u.classList.remove("karakter-ability-area-drag-over");
      }));
      ...
      await a.update({ "system.quantity": u }), setTimeout(() => {
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.bonus`]: ((C = a.system) == null ? void 0 : C.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (I) {
        const T = v.filter((S) => S !== I);
        await this.actor.update({
    ...
    const l = this, f = (i) => {
      ...
      const n = ((u = (a = r.system) == null ? void 0 : a.resources) == null ? void 0 : u.currentHealth) != null || ((b = (p = r.system) == null ? void 0 : p.resources) == null ? void 0 : b.hitLocations) != null;
      l.actor.update(r).then(() => {
        n && setTimeout(() => l.render(!0), 260);
      }).catch((v) => console.warn("VoidKarakterSheet save failed", v));
    }, m = (i) => {
      var r, n, a;
      return i && (((n = (r = l.element) == null ? void 0 : r.contains) == null ? void 0 : n.call(r, i)) || l.id && ((a = i.closest) == null ? void 0 : a.call(i, `#${CSS.escape(l.id)}`)));
    };
    l._votvBlur = (i) => {
      var p;
      const r = i.target;
      ...
      u && (a.contains(u) || l.id && ((p = u.closest) != null && p.call(u, `#${CSS.escape(l.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: l.id, at: Date.now() }), f(a));
    ...
    if (e) {
      ...
      if (a) {
        ...
        if (u && u.documentName === "Item" && (u.type === "Kepesseg" || u.type === "ability")) {
          ...
          const b = (((c = u.system) == null ? void 0 : c.kind) ?? "passive").toString(), v = this.actor.system.abilities ?? {};
          if (b === "species") {
            await this.actor.update({
          ...
          const I = b === "active" ? "active" : "passive", O = Array.isArray((l = v[I]) == null ? void 0 : l.items) ? v[I].items.slice() : Array.isArray(v[I]) ? v[I].slice() : [];
          O.includes(p) || O.push(p), await this.actor.update({ [`system.abilities.${I}.items`]: O });
          return;
        }
      }
    }
    if (e) {
      ...
      if (a) {
        ...
        if (u && u.documentName === "Item" && u.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, O = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = O ? O.split(/\s*,\s*/).filter((S) => q.includes(S)) : [], T = C.filter((S) => {
              var A;
        ...
        if (u && u.documentName === "Item" && (u.type === "Targy" || u.type === "Egyeb")) {
          const p = this.actor;
          ((n = u.parent) == null ? void 0 : n.id) !== p.id && await p.createEmbeddedDocuments("Item", [u.toObject()]);
          return;
        }
      }
    }
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const d = this.actor.items.contents.slice().sort((h, i) => {
      ...
      return r - n;
    }).map((h) => h.id), c = d.indexOf(t), l = d.indexOf(e);
    if (c === -1 || l === -1) return;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", o = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = o > 0 ? `<p><strong>KP:</strong> ${o}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const c = this.actor.system.abilities ?? {}, l = Array.isArray((h = c[e]) == null ? void 0 : h.items) ? c[e].items.slice() : Array.isArray(c[e]) ? c[e].slice() : [];
  ...
  async _rollWeapon(s) {
    ...
    const l = c && c.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, g = (((v = c == null ? void 0 : c.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(o[g] || 0) || 0, i = f + h, n = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(n);
    await a.evaluate({ async: !0 });
    const { resultType: u, label: p } = ft(a), b = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (p = (n = ui.notifications) == null ? void 0 : n.warn) == null || p.call(n, ((u = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : u.call(a, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const c = new Roll(d);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = await super.render(s, e), l = this.element, f = this.form ?? this.element, m = d.scrollState, g = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var r, n;
      if (this._applyScrollState(l, m), (g == null ? void 0 : g.name) != null || (g == null ? void 0 : g.id) != null) {
        const a = ((r = f.querySelector) == null ? void 0 : r.call(f, g.id ? `#${CSS.escape(g.id)}` : null)) ?? (g.name ? (n = f.querySelector) == null ? void 0 : n.call(f, `[name="${CSS.escape(g.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    var G, Z, de, ee, Ne, $e, xe, Se, ge, Ce, qe, Te, Le;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((G = this.actor) == null ? void 0 : G.system), e.showDeathSkull = !1, e.sizeForSelect = (((de = (Z = e.system) == null ? void 0 : Z.identity) == null ? void 0 : de.size) ?? "").trim() || "Közepes";
    const t = this.actor, o = ((ee = t == null ? void 0 : t.items) == null ? void 0 : ee.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = f.length > 0 ? f : c, r = c.filter((k) => !i.includes(k)), n = [...i, ...r], a = n.filter((k) => {
      var x;
      const F = (((x = d[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return F && m.some((U) => U.id === F);
    });
    e.weaponSlots = a.map((k) => {
      const F = d[k] ?? {}, x = (F.itemId ?? "").trim(), U = g.find((me) => me.id === x);
      return {
        slotKey: k,
        itemId: x,
        displayName: (U == null ? void 0 : U.name) || F.name || h,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, U = {};
      for (const De of n)
        if ((((Pe = d[De]) == null ? void 0 : Pe.itemId) ?? "").trim() === F) {
          x = De, U = d[De] ?? {};
          break;
        }
      const me = !!x, W = (k == null ? void 0 : k.system) ?? {}, _e = typeof W.range == "string" ? (W.range || "").trim() : "", ce = W.type ?? "", pe = (u[ce] ?? ce) || "—", le = W.size ?? "", he = (p[le] ?? le) || "", be = [pe, he].filter(Boolean).join(", ") || pe || "—", Me = ce === "projectile" || le === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? U.bonus ?? "").trim() || "0", Ke = (W.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    e.armorTable = b.map((k) => {
      var U;
      const F = (k == null ? void 0 : k.system) ?? {}, x = ((U = k.system) == null ? void 0 : U.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], O = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = O.map((k) => {
      var ce, pe, le, he;
      const F = k.id;
      let x = null;
      for (const be of I)
        if ((((ce = v[be]) == null ? void 0 : ce.itemId) ?? "").trim() === F) {
          x = be;
          break;
        }
      const U = ((pe = k == null ? void 0 : k.system) == null ? void 0 : pe.abilityType) ?? "", me = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", W = (((le = k == null ? void 0 : k.system) == null ? void 0 : le.description) ?? "").trim(), _e = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.itemsTable = q.map((k) => {
      const F = (k == null ? void 0 : k.system) ?? {}, x = (F.description ?? "").trim(), U = x ? x.length > 60 ? x.slice(0, 57) + "…" : x : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.egyebList = C.map((k) => {
      const x = (((k == null ? void 0 : k.system) ?? {}).description ?? "").trim(), U = x ? x.length > 80 ? x.slice(0, 77) + "…" : x : "";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    }), N = new Map(A.map((k) => [k.id, k])), K = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var a, u, p;
      i.preventDefault();
      const r = (u = (a = i.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : u.itemId;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var u, p, b, v;
      i.preventDefault();
      const r = (p = (u = i.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : p.call(u, ".karakter-weapon-slot"), n = (((b = r == null ? void 0 : r.dataset) == null ? void 0 : b.itemId) ?? "").trim();
      ...
      var u;
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget, n = (((u = r == null ? void 0 : r.dataset) == null ? void 0 : u.slot) ?? "").trim();
      if (!n || !this.actor) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-vapccMvt.mjs");
      a(this.actor, n);
    }), t.on("click", ".karakter-weapon-damage", async (i) => {
      ...
      !n && ((u = r == null ? void 0 : r.dataset) != null && u.slot) && (n = (((((b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.weapons) ?? {})[r.dataset.slot] ?? {}).itemId ?? "").trim()), !(!n || !this.actor) && await this._rollWeaponDamage(n, (((v = r == null ? void 0 : r.dataset) == null ? void 0 : v.slot) ?? "").trim());
    }), t.on("click", ".karakter-skill-label", async (i) => {
      var p, b;
      i.preventDefault();
      ...
      if (!n || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-vapccMvt.mjs");
      u(this.actor, n, a);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var n, a;
      i.preventDefault();
      ...
      var a, u;
      i.preventDefault();
      const r = (((u = (a = i.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : u.itemId) ?? "").trim();
      if (!r || !this.actor) return;
      const n = this.actor.items.get(r);
      ...
      var b, v, I, O, q, C;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, n = (O = (I = i.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : O.itemId;
      if (!r || !n || !this.actor) return;
      const a = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, p = (Array.isArray((C = a[r]) == null ? void 0 : C.items) ? a[r].items.slice() : []).filter((T) => T !== n);
      ...
      if (!n || !this.actor) return;
      const a = this.actor, u = (((v = r == null ? void 0 : r.dataset) == null ? void 0 : v.slotKey) ?? "").trim(), p = {};
      u && (p[`system.weapons.${u}.itemId`] = "", p[`system.weapons.${u}.name`] = "", p[`system.weapons.${u}.damage`] = "", p[`system.weapons.${u}.bonus`] = ""), Object.keys(p).length && await a.update(p), await a.deleteEmbeddedDocuments("Item", [n]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (i) => {
      var n, a;
      if (i.preventDefault(), !i.altKey) return;
      ...
      if (!r || !this.actor) return;
      const n = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, u = ["slot1", "slot2", "slot3"].find((O) => {
        var q;
        return (((q = n[O]) == null ? void 0 : q.itemId) ?? "").trim() === r;
      });
    ...
    c._votvNpcBlur = (i) => {
      ...
      if (!f(a)) return;
      const u = i.relatedTarget;
      u && (a.contains(u) || c.id && ((p = u.closest) != null && p.call(u, `#${CSS.escape(c.id)}`))) || l(a);
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, n, a, u, p, b, v, I, O, q, C, T;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((a = d.system) == null ? void 0 : a.kind) ?? "passive").toString(), N = ((u = c.system) == null ? void 0 : u.abilities) ?? {}, K = A === "active" ? "active" : "passive", H = Array.isArray((p = N[K]) == null ? void 0 : p.items) ? N[K].items.slice() : Array.isArray(N[K]) ? N[K].slice() : [];
      H.includes(S) || H.push(S), await c.update({ [`system.abilities.${K}.items`]: H }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    const m = (v = (await c.createEmbeddedDocuments("Item", [l]))[0]) == null ? void 0 : v.id;
    if (d.type === "Fegyver" && m) {
      const S = ((I = c.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), K = N ? N.split(/\s*,\s*/).filter((G) => A.includes(G)) : [];
      let H = A.find((G) => {
        var Z;
        return !(((Z = S[G]) == null ? void 0 : Z.itemId) ?? "").trim();
      });
      H || (H = A.find((G) => !K.includes(G)) ?? "slot1");
      const V = K.includes(H) ? K : [...K, H].filter((G) => A.includes(G));
      await c.update({
        "system.weapons.slotOrder": V.join(","),
        [`system.weapons.${H}.itemId`]: m,
        [`system.weapons.${H}.name`]: d.name ?? "",
        [`system.weapons.${H}.damage`]: ((O = d.system) == null ? void 0 : O.damage) ?? "",
        [`system.weapons.${H}.bonus`]: ((q = d.system) == null ? void 0 : q.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const S = ((T = (C = c.system) == null ? void 0 : C.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((K) => {
        var H;
        return !(((H = S[K]) == null ? void 0 : H.itemId) ?? "").trim();
      });
      N && await c.update({
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", o = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = o > 0 ? `<p><strong>KP:</strong> ${o}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${l}
      ${f}
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (c) => {
      ...
      const l = ((a = (n = (r = foundry.applications) == null ? void 0 : r.apps) == null ? void 0 : n.FilePicker) == null ? void 0 : a.implementation) ?? globalThis.FilePicker;
      new l({
        type: "image",
    ...
    const o = (c) => {
      ...
      var l, f, m;
      return c && (((f = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : f.call(l, c)) || e.id && ((m = c.closest) == null ? void 0 : m.call(c, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (c) => {
      var f, m, g;
      const l = ((f = c.target) == null ? void 0 : f.form) ?? ((g = (m = c.target) == null ? void 0 : m.closest) == null ? void 0 : g.call(m, "form"));
      d(l) && o(l);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    for (const S of u)
      ((O = S.document) == null ? void 0 : O.id) !== h || ((q = S.document) == null ? void 0 : q.documentName) !== "Actor" || ((C = S.constructor) == null ? void 0 : C.name) !== "VoidKarakterSheet" || n.includes(S) || n.push(S);
    if (r && n.some((S) => {
    ...
    for (const [p, b] of Object.entries(i)) {
      ...
      !v || v !== l.id || (r[`system.weapons.${p}.name`] = l.name ?? "", r[`system.weapons.${p}.damage`] = ((a = l.system) == null ? void 0 : a.damage) ?? "", r[`system.weapons.${p}.bonus`] = ((u = l.system) == null ? void 0 : u.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var a, u, p, b, v, I, O, q, C, T, S, A, N, K, H, V, G;
    const t = (u = (a = e.target) == null ? void 0 : a.closest) == null ? void 0 : u.call(a, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    e.preventDefault(), e.stopPropagation();
    let o = (t.dataset.actorId ?? "").trim(), d = (t.dataset.itemId ?? "").trim(), c = (t.dataset.slotKey ?? "").trim(), l = (t.dataset.targetName ?? "").trim(), f = (t.dataset.hitLocationName ?? "").trim();
    if (!o || !d) {
      const Z = (t.dataset.messageId ?? "").trim(), de = Z ? (p = game.messages) == null ? void 0 : p.get(Z) : null, ee = (v = (b = de == null ? void 0 : de.flags) == null ? void 0 : b["vacuum-of-the-void"]) == null ? void 0 : v.weapon;
      ee && (o = o || ee.actorId || "", d = d || ee.itemId || "", c = c || ee.slotKey || "", l = l || ee.targetName || "", f = f || ee.hitLocationName || "");
    }
    const m = o ? (I = game.actors) == null ? void 0 : I.get(o) : null;
    if (!m) return;
    const g = d ? ((q = (O = m.items) == null ? void 0 : O.get) == null ? void 0 : q.call(O, d)) ?? ((S = (T = (C = m.items) == null ? void 0 : C.contents) == null ? void 0 : T.find) == null ? void 0 : S.call(T, (Z) => Z.id === d)) : null;
    if (!g || g.type !== "Fegyver") return;
    let h = (((A = g.system) == null ? void 0 : A.damage) ?? "").trim();
    if (!h && c && (h = (((((N = m.system) == null ? void 0 : N.weapons) ?? {})[c] ?? {}).damage ?? "").trim()), !h) {
      (G = (K = ui.notifications) == null ? void 0 : K.warn) == null || G.call(K, ((V = (H = game.i18n) == null ? void 0 : H.localize) == null ? void 0 : V.call(H, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const i = new Roll(h);
    await i.evaluate({ async: !0 });
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    let n = l ? `${g.name} – sebzés – ${l}` : `${g.name} – sebzés`;
    f && (n += ` (${f})`), await i.toMessage({
    ...
    (e) => {
      ...
      const t = (m = (f = e.target) == null ? void 0 : f.closest) == null ? void 0 : m.call(f, "[data-document-id]"), o = (g = t == null ? void 0 : t.getAttribute) == null ? void 0 : g.call(t, "data-document-id");
      if (!o) return;
    ...
    for (const i of t)
      try {
        const r = i.prototypeToken, n = ((l = r == null ? void 0 : r.bar1) == null ? void 0 : l.attribute) ?? "", a = ((f = r == null ? void 0 : r.bar2) == null ? void 0 : f.attribute) ?? "";
        (n || a) && await i.update({
...
Hooks.on("renderChatMessageHTML", (E, s, e) => {
  var m, g, h, i;
  const t = ((m = E.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, o = t.resultType, d = t.critLabel, c = t.weaponAttack, l = t.weapon;
  if (!o && !d && !c) return;
  ...
  if (f) {
    if (o && f.classList.add(`votv-${o}`), d) {
      ...
      if (r)
        ...
        const n = f.querySelector(".dice-total"), a = (n == null ? void 0 : n.parentElement) ?? f, u = document.createElement("div");
        u.className = `votv-crit-label votv-crit-label-${o || "neutral"}`, u.textContent = d, a.appendChild(u);
      }
    }
    if (c && l && (l.actorId || (h = E.speaker) != null && h.actor)) {
      const r = f.querySelector(".dice-total"), n = (r == null ? void 0 : r.parentElement) ?? f;
      if (!f.querySelector(".votv-weapon-outcome")) {
        const u = document.createElement("div");
        u.className = "votv-weapon-outcome";
        const p = !!l.isHit, b = l.targetName || "Célpont";
        u.textContent = p ? `Találat – ${b}` : `Nem talált – ${b}`, n.appendChild(u);
      }
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((i = E.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(E.id ?? ""), n.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-ZvXxjEzK.mjs.map
