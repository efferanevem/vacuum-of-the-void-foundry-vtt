...
const { HTMLField: st, NumberField: S, SchemaField: _, StringField: f, BooleanField: R, ArrayField: le } = foundry.data.fields;
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(r = !1, e = {}) {
    ...
    const b = this.element, k = this.form ?? this.element, v = u.scrollState, s = u.focus, o = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      ...
      if (this._applyScrollState(b, v), (s == null ? void 0 : s.name) != null || (s == null ? void 0 : s.id) != null) {
        const w = ((m = k.querySelector) == null ? void 0 : m.call(k, s.id ? `#${CSS.escape(s.id)}` : null)) ?? (s.name ? (h = k.querySelector) == null ? void 0 : h.call(k, `[name="${CSS.escape(s.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(r = null) {
    ...
    const i = ((s = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : s.resources) ?? {}, a = ((c = (o = i.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = i.currentHealth) == null ? void 0 : l.legs) ?? 0, u = C._healthStatusFromRatio(n, a), p = Number(((w = (h = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : h.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
  ...
  async _prepareContext(r) {
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], h = (l.slotOrder ?? "").trim(), w = h ? h.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], y = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = y && typeof y == "object" && !Array.isArray(y) ? y : {}, N = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = (((Ne = I.slot2) == null ? void 0 : Ne.itemId) ?? "").trim(), O = ((($e = I.slot3) == null ? void 0 : $e.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
  ...
  _attachFrameListeners(r) {
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(r), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (s) => {
      ...
      var h;
      s.preventDefault();
      const o = s.currentTarget, c = o.dataset.skill, l = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-9goX295z.mjs");
      m(this.actor, c, l);
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const w = l.system.weapons ?? {}, y = (w.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = y ? y.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], q = N.find((O) => {
          var g;
          return (((g = w[O]) == null ? void 0 : g.itemId) ?? "").trim() === c;
        });
        if (q) {
          const O = N.filter((g) => g !== q);
      ...
      if (!c) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-9goX295z.mjs");
      l(this.actor, c);
      ...
      if (!c) {
        const m = (o.dataset.slot ?? "").trim();
        if (!m) return;
        c = (((((l = this.actor.system) == null ? void 0 : l.weapons) ?? {})[m] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c);
      ...
      y ? (N || (N = document.createElement("img"), N.className = "karakter-microchip-slot-thumb", N.alt = "", l == null || l.insertBefore(N, I)), N.src = y, N.style.display = "") : N && N.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
    ...
    if (e) {
      ...
      if (w) {
        ...
        if (y && y.documentName === "Item" && y.type === "ability") {
          ...
          const O = N === "active" ? "active" : "passive", g = Array.isArray((o = q[O]) == null ? void 0 : o.items) ? q[O].items.slice() : Array.isArray(q[O]) ? q[O].slice() : [];
    ...
    if (e) {
      ...
      if (w) {
        ...
        if (y && y.documentName === "Item" && y.type === "Fegyver") {
          const I = this.actor, N = ((l = y.parent) == null ? void 0 : l.id) !== I.id;
          let q = y.id;
          if (N) {
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, p, b) => {
    ...
    if (!k) return;
    const v = document.activeElement, s = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), o = [], c = (y = game.actors) == null ? void 0 : y.get(k);
    c != null && c.apps && o.push(...Array.from(c.apps));
    const l = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const g of l)
      ((I = g.document) == null ? void 0 : I.id) !== k || ((N = g.document) == null ? void 0 : N.documentName) !== "Actor" || ((q = g.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || o.includes(g) || o.push(g);
    if (s && o.some((g) => {
      const A = (g == null ? void 0 : g.form) ?? (g == null ? void 0 : g.element);
      return A && A.contains(v);
    })) return;
    const h = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, w = h && Date.now() - h.at < E ? h.appId : null;
    setTimeout(() => {
      for (const g of o)
...
//# sourceMappingURL=vacuum-of-the-void-BO2EAN3P.mjs.map
