...
const { HTMLField: hs, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: tt } = foundry.data.fields;
      ...
      combat: new K({
        ...
        initiativeRanges: new tt(
          new K({
            ...
            kp: new O({ required: !1, integer: !0, min: 0, max: 10, initial: 0 })
          }),
          { required: !1, initial: [] }
        )
      }),
...
const { NumberField: vt, SchemaField: bs } = foundry.data.fields;
class ks extends os {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ws, StringField: ht } = foundry.data.fields;
...
const { NumberField: wt, StringField: Ut } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Be, Ge, We, Ye, Je, Qe, k, F, x, j, oe, X, $e, be, Ie, ke, qe, Le, pt, ft, yt, gt, Xe, xe, Pt, At, Et, Ft, $t, xt, Rt;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((We = (Ge = (Be = this.actor.system) == null ? void 0 : Be.resources) == null ? void 0 : Ge.stress) == null ? void 0 : We.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const _ = ((Ye = d[y]) == null ? void 0 : Ye.value) ?? 0, D = r[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Qe = (Je = this.actor.system) == null ? void 0 : Je.combat) == null ? void 0 : Qe.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const a = (Number(((F = (k = this.actor.system) == null ? void 0 : k.combat) == null ? void 0 : F.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (j = this.actor.system.gear) == null ? void 0 : j.microchips, E = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((oe = E.slot1) == null ? void 0 : oe.itemId) ?? "").trim(), H = (((X = E.slot2) == null ? void 0 : X.itemId) ?? "").trim(), B = ((($e = E.slot3) == null ? void 0 : $e.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      const D = typeof y.sort == "number" ? y.sort : 0, q = typeof _.sort == "number" ? _.sort : 0;
      return D - q;
    }).map((y) => {
      var ve, Pe, Ae, Se, Te, Ve;
      const _ = y.type === "Fegyver", D = y.type === "MikroChip";
      let q = 0, M = "", ee = null;
      for (let Re = 0; Re < A.length; Re++) {
        const et = A[Re];
        if ((((ve = T[et]) == null ? void 0 : ve.itemId) ?? "") === y.id) {
          q = Re + 1, M = ((Pe = T[et]) == null ? void 0 : Pe.bonus) ?? "", ee = et;
          break;
        }
      }
      let Z = null;
      D && (N === y.id ? Z = "slot1" : H === y.id ? Z = "slot2" : B === y.id && (Z = "slot3"));
      const Ze = _ && ((Ae = y.system) != null && Ae.damage) ? y.system.damage : "", ce = _ && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = ee ? Number((Te = T[ee]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
        ...
        rangeStr: ce,
        slotBonusNum: Ne,
        quantity: Number(((Ve = y.system) == null ? void 0 : Ve.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = G;
    const V = (((be = this.actor.items) == null ? void 0 : be.contents) ?? []).filter((y) => y.type === "Fegyver"), R = V.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = R;
    const Y = "— Nincs fegyver —", J = A.filter((y) => {
      const D = ((T[y] ?? {}).itemId ?? "").trim();
      return D ? !!V.find((M) => M.id === D) : !1;
    });
    e.weaponSlots = J.map((y, _) => {
      const D = T[y] ?? {}, q = (D.itemId ?? "").trim(), M = R.find((ee) => ee.id === q);
      return {
        slotKey: y,
        itemId: q,
        slotNum: _ + 1,
    ...
    const ye = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ae = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = V.map((y) => {
      var Mt, Kt, jt;
      const _ = y.id;
      let D = null, q = {};
      for (const kt of A)
        if ((((Mt = T[kt]) == null ? void 0 : Mt.itemId) ?? "").trim() === _) {
          D = kt, q = T[kt] ?? {};
          break;
        }
      const M = !!D, ee = ((Kt = y.system) == null ? void 0 : Kt.equipped) !== void 0 && ((jt = y.system) == null ? void 0 : jt.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, Ze = typeof Z.range == "string" ? (Z.range || "").trim() : "", ce = Z.type ?? "", Ne = (ye[ce] ?? ce) || "—", ve = Z.size ?? "", Pe = (ae[ve] ?? ve) || "", Ae = [Ne, Pe].filter(Boolean).join(", ") || Ne || "—", Se = ce === "projectile" || ve === "thrown", Te = Z.quantity, Ve = Te != null ? String(Te).trim() : "1", Re = String(q.bonus ?? "").trim(), et = String(Z.bonus ?? "").trim(), ms = Re || et || "0";
      return {
        slotKey: D ?? "",
        itemId: _,
        ...
        typeAndSize: Ae,
        quantity: Ve,
        quantityDisplay: Se ? Ve : "—",
        isProjectile: Se,
        equipped: ee,
        special: (Z.special ?? "").trim() || "—"
      };
    });
    const ge = (((Ie = this.actor.items) == null ? void 0 : Ie.contents) ?? []).filter((y) => y.type === "Pancel");
    e.armorTable = ge.map((y) => {
      var q, M;
    ...
    const Me = (((ke = this.actor.items) == null ? void 0 : ke.contents) ?? []).filter((y) => y.type === "Targy");
    e.itemsTable = Me.map((y) => {
    ...
    const se = (((qe = this.actor.items) == null ? void 0 : qe.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const ie = (((Le = this.actor.items) == null ? void 0 : Le.contents) ?? []).filter((y) => y.type === "MikroChip"), re = ie.map((y) => ({ id: y.id, name: y.name, img: y.img })), st = "— Nincs Mikro-Chip —", it = ["slot1", "slot2", "slot3"], Ee = (y) => {
      var D, q, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = re.filter((y) => !Ee(1).includes(y.id)), e.microchipItemsSlot2 = re.filter((y) => !Ee(2).includes(y.id)), e.microchipItemsSlot3 = re.filter((y) => !Ee(3).includes(y.id)), e.microchipSlots = it.map((y) => {
      const _ = E[y] ?? {}, D = (_.itemId ?? "").trim(), q = ie.find((M) => M.id === D);
      return {
        slotKey: y,
        itemId: D,
      ...
      const _ = `slot${y}`, D = E[_] ?? {}, q = (D.itemId ?? "").trim(), M = re.find((ee) => ee.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || D.name || st, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
      ...
      const q = !!D, M = ((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Z = M === "active", Ze = Number((Ae = y == null ? void 0 : y.system) == null ? void 0 : Ae.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, ce = (((Se = y == null ? void 0 : y.system) == null ? void 0 : Se.description) ?? "").trim(), Ne = ce ? ce.length > 60 ? ce.slice(0, 57) + "…" : ce : "—";
      return {
        itemId: _,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const nt = (((pt = e.weaponsTable) == null ? void 0 : pt.length) ?? 0) > 0 || (((ft = e.armorTable) == null ? void 0 : ft.length) ?? 0) > 0 || (((yt = e.microchipsTable) == null ? void 0 : yt.length) ?? 0) > 0 || (((gt = e.itemsTable) == null ? void 0 : gt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !nt;
    const rt = this.actor.system.abilities ?? {}, Nt = (((Xe = this.actor.items) == null ? void 0 : Xe.contents) ?? []).map((y) => {
      var _, D, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), Fe = new Map(Nt.map((y) => [y.id, y])), at = "— Nincs képesség —", Ke = (y) => {
      const _ = rt[y] ?? {}, D = (_.itemId ?? "").trim(), q = D ? Fe.get(D) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: D,
        displayName: (q == null ? void 0 : q.name) || _.name || at,
        img: (q == null ? void 0 : q.img) || "",
        description: M,
        kp: ee
      };
    ...
    e.abilityPassiveList = He(je("passive")), e.abilityActiveList = He(je("active"));
    const ot = ((xe = e.system) == null ? void 0 : xe.resources) ?? {}, ct = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (At = (Pt = e.system) == null ? void 0 : Pt.combat) == null ? void 0 : At.initiativeResult, he = typeof _e == "number" ? _e : -1, lt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ue = (Ft = (Et = e.system) == null ? void 0 : Et.combat) == null ? void 0 : Ft.initiativeRanges, Ce = Array.isArray(Ue) ? Ue.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : lt).slice().sort((y, _) => y.min - _.min), Oe = Ce.map((y) => y.min), ut = Oe.length ? Math.min(...Oe) : 0, dt = Oe.length ? Math.max(...Oe) : 0;
    e.initiativeRanges = Ce.map((y) => ({ ...y, isFirst: y.min === ut, isLast: y.min === dt }));
    let ze = 0;
    if (typeof he == "number" && he >= 0 && we.length > 0) {
      const y = we[0], _ = we[we.length - 1];
      let D = null;
      he <= y.max ? D = y : he >= _.min ? D = _ : D = we.find((q) => he >= q.min && he <= q.max), D && (ze = D.kp);
    }
    e.kpDots = ct.map((y, _) => {
      const D = _ + 1, q = !!Number(ot[y]), M = D <= ze;
      return { index: D, used: q, usable: M };
    });
    const mt = !!((xt = ($t = game.combat) == null ? void 0 : $t.combatants) != null && xt.some((y) => {
      var _;
      return ((_ = y.actor) == null ? void 0 : _.type) === "Karakter";
    }));
    return e.showHarcSection = mt, e.canEditInitiative = !!((Rt = game.user) != null && Rt.isGM), e.showInitiativeResult = typeof _e == "number", e.initiativeResult = e.showInitiativeResult ? _e : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-2au-rNRK.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-2au-rNRK.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-2au-rNRK.mjs");
      p(this.actor, o, a);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: g, label: b } = It(m), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: p, label: h } = It(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
const ne = class ne extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ke, je, He, ot, ct, _e, he, lt, Ue, Ce, bt, we, Oe, ut, dt, ze, mt, Be, Ge, We, Ye, Je, Qe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Ke = this.actor) == null ? void 0 : Ke.system), e.showDeathSkull = !1, e.sizeForSelect = (((He = (je = e.system) == null ? void 0 : je.identity) == null ? void 0 : He.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((ot = t == null ? void 0 : t.items) == null ? void 0 : ot.contents) ?? [], d = ((ct = t == null ? void 0 : t.system) == null ? void 0 : ct.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
      const F = (((x = d[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return F && m.some((j) => j.id === F);
    });
    e.weaponSlots = o.map((k) => {
      const F = d[k] ?? {}, x = (F.itemId ?? "").trim(), j = g.find((oe) => oe.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const xe of c)
        if ((((Xe = d[xe]) == null ? void 0 : Xe.itemId) ?? "").trim() === F) {
          x = xe, j = d[xe] ?? {};
          break;
        }
      const oe = !!x, X = (k == null ? void 0 : k.system) ?? {}, $e = typeof X.range == "string" ? (X.range || "").trim() : "", be = X.type ?? "", Ie = (a[be] ?? be) || "—", ke = X.size ?? "", qe = (p[ke] ?? ke) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", pt = be === "projectile" || ke === "thrown", ft = X.quantity != null ? String(X.quantity).trim() : "1", yt = String(X.bonus ?? j.bonus ?? "").trim() || "0", gt = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((he = (_e = t == null ? void 0 : t.system) == null ? void 0 : _e.gear) == null ? void 0 : he.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var be, Ie, ke, qe;
      const F = k.id;
      let x = null;
      for (const Le of I)
        if ((((be = v[Le]) == null ? void 0 : be.itemId) ?? "").trim() === F) {
          x = Le;
          break;
        }
      const j = ((Ie = k == null ? void 0 : k.system) == null ? void 0 : Ie.abilityType) ?? "", oe = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", X = (((ke = k == null ? void 0 : k.system) == null ? void 0 : ke.description) ?? "").trim(), $e = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const A = (((lt = e.weaponsTable) == null ? void 0 : lt.length) ?? 0) > 0 || (((Ue = e.armorTable) == null ? void 0 : Ue.length) ?? 0) > 0 || (((Ce = e.microchipsTable) == null ? void 0 : Ce.length) ?? 0) > 0 || (((bt = e.itemsTable) == null ? void 0 : bt.length) ?? 0) > 0 || (((we = e.egyebList) == null ? void 0 : we.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const C = ((Oe = t == null ? void 0 : t.system) == null ? void 0 : Oe.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const G = t == null ? void 0 : t.id, V = !!((dt = (ut = game.combat) == null ? void 0 : ut.combatants) != null && dt.some(
      (k) => {
        var F;
    ...
    e.showHarcSection = V;
    const R = ((ze = e.system) == null ? void 0 : ze.resources) ?? {}, Y = (Be = (mt = e.system) == null ? void 0 : mt.combat) == null ? void 0 : Be.initiativeResult, J = typeof Y == "number" ? Y : -1, ye = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ae = (We = (Ge = e.system) == null ? void 0 : Ge.combat) == null ? void 0 : We.initiativeRanges, ge = Array.isArray(ae) ? ae.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], se = (ge.length > 0 ? ge : ye).slice().sort((k, F) => k.min - F.min), ie = ge.length > 0 ? ge : ye, re = ie.map((k) => k.min), st = re.length ? Math.min(...re) : 0, it = re.length ? Math.max(...re) : 0;
    e.initiativeRanges = ie.map((k) => ({ ...k, isFirst: k.min === st, isLast: k.min === it }));
    let Ee = 0;
    if (typeof J == "number" && J >= 0 && se.length > 0) {
      const k = se[0], F = se[se.length - 1];
      let x = null;
      J <= k.max ? x = k : J >= F.min ? x = F : x = se.find((j) => J >= j.min && J <= j.max), x && (Ee = x.kp);
    }
    const nt = se.length > 0 ? se[se.length - 1] : null, rt = Math.min(10, nt ? nt.kp : 6), Fe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, rt)).map((k, F) => {
      const x = F + 1, j = !!Number(R[k]), oe = x <= Ee;
      return { index: x, used: j, usable: oe };
    }), at = Math.ceil(Fe.length / 2);
    return e.kpDotsRow1 = Fe.slice(0, at), e.kpDotsRow2 = Fe.slice(at), e.canEditInitiative = !!((Ye = game.user) != null && Ye.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e.speedUnitForSelect = ((Qe = (Je = e.system) == null ? void 0 : Je.combat) == null ? void 0 : Qe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-2au-rNRK.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-2au-rNRK.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-2au-rNRK.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: v } = It(p), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
...
Q(ne, "PARTS", foundry.utils.mergeObject(
  ...
  z(ne, ne, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Zt = z(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((es = (Vt = z(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.window) == null ? void 0 : es.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Q(le, "PARTS", foundry.utils.mergeObject(z(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ts = z(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : ts.form) ?? {}, { submitOnChange: !1 })
}));
let Dt = le;
var ss;
...
Q(ue, "PARTS", foundry.utils.mergeObject(z(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ss = z(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : ss.form) ?? {}, { submitOnChange: !1 })
}));
let _t = ue;
var is;
...
Q(de, "PARTS", foundry.utils.mergeObject(z(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((is = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : is.form) ?? {}, { submitOnChange: !1 })
}));
let Ct = de;
var ns;
...
Q(me, "PARTS", foundry.utils.mergeObject(z(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ns = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : ns.form) ?? {}, { submitOnChange: !0 })
}));
let Ot = me;
var rs;
...
Q(pe, "PARTS", foundry.utils.mergeObject(z(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((rs = z(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : rs.form) ?? {}, { submitOnChange: !1 })
}));
let qt = pe;
var as;
...
Q(fe, "PARTS", foundry.utils.mergeObject(z(fe, fe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Q(fe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(fe, fe, "DEFAULT_OPTIONS"), {
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      ...
      if (J) {
        const ye = ((P = J.combatants) == null ? void 0 : P.contents) ?? Array.from(J.combatants ?? []);
        for (const ae of ye)
          if (((A = ae.actor) == null ? void 0 : A.id) === b || ae.actorId === b) {
            J.updateEmbeddedDocuments("Combatant", [{ _id: ae.id, initiative: Y }]).catch(() => {
            });
            break;
          }
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, L, P, A, C, E, N, H, B, U, G, V, R, Y, J, ye, ae, ge, Me;
    ...
    if (f || (f = ((E = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : E.flatMap((ie) => {
      var re;
      return ((re = ie.tokens) == null ? void 0 : re.contents) ?? [];
    }).map((ie) => ie.actor).find((ie) => ie && (ie.id === l || ie.id === r.actorId))) ?? null), !f) return;
    ...
    if (g || (g = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !g && r.slotKey && (g = (((((R = f.system) == null ? void 0 : R.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
      (ae = (Y = ui.notifications) == null ? void 0 : Y.warn) == null || ae.call(Y, ((ye = (J = game.i18n) == null ? void 0 : J.localize) == null ? void 0 : ye.call(J, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(g);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Me = (((ge = f.system) == null ? void 0 : ge.weapons) ?? {})[r.slotKey]) == null ? void 0 : Me.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-DZyohgDs.mjs.map
