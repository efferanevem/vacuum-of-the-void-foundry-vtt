...
var te = (S, s, e) => ii(S, typeof s != "symbol" ? s + "" : s, e);
var z = (S, s, e) => si(ti(S), e, s);
...
const { BooleanField: fi, NumberField: Ai, StringField: Ve } = foundry.data.fields;
...
const { NumberField: zt, StringField: vs } = foundry.data.fields;
...
const { NumberField: jt, StringField: ut, SchemaField: Ss, ArrayField: Ii } = foundry.data.fields;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var mt, pt, ft, yt, gt, ht, bt, vt, kt, Ze, wt, It, Ye, I, P, x, G, ke, ne, Ce, De, we, xe, Xe, Qe, Nt, Ft, At, Et, St, ct, Qt, es, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms;
    ...
    const me = (((Qt = this.actor.items) == null ? void 0 : Qt.contents) ?? []).filter((b) => b.type === "MikroChip"), ae = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ve = "— Nincs Mikro-Chip —", ce = ["slot1", "slot2", "slot3"], pe = (b) => {
      var L, A, B;
      const N = [];
    ...
    const Me = (((es = e.weaponsTable) == null ? void 0 : es.length) ?? 0) > 0 || (((ts = e.armorTable) == null ? void 0 : ts.length) ?? 0) > 0 || (((ss = e.microchipsTable) == null ? void 0 : ss.length) ?? 0) > 0 || (((is = e.itemsTable) == null ? void 0 : is.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Me;
    const ze = this.actor.system.abilities ?? {}, Pe = (((ns = this.actor.items) == null ? void 0 : ns.contents) ?? []).map((b) => {
      var N, L, A;
      return {
        id: b.id,
        name: b.name,
    ...
    const at = ((as = e.system) == null ? void 0 : as.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], fe = (os = (rs = e.system) == null ? void 0 : rs.combat) == null ? void 0 : os.initiativeResult, ie = typeof fe == "number" ? fe : -1, rt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], $e = (ls = (cs = e.system) == null ? void 0 : cs.combat) == null ? void 0 : ls.initiativeRanges, Oe = Array.isArray($e) ? $e.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Be = (Oe.length > 0 ? Oe : rt).slice().sort((b, N) => b.min - N.min), Je = Oe.map((b) => b.min), Ct = Je.length ? Math.min(...Je) : 0, qt = Je.length ? Math.max(...Je) : 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-BiQI4B02.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-BiQI4B02.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-BiQI4B02.mjs");
      h(this.actor, o, m);
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BiQI4B02.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BiQI4B02.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-BiQI4B02.mjs");
      m(this.actor, r, o);
...
//# sourceMappingURL=vacuum-of-the-void-2JXZ_oNI.mjs.map
