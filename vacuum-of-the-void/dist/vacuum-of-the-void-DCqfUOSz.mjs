...
var zt = Reflect.get;
var Gt = (q, s, e) => s in q ? Ut(q, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : q[s] = e;
var z = (q, s, e) => Gt(q, typeof s != "symbol" ? s + "" : s, e);
var K = (q, s, e) => zt(Bt(q), e, s);
...
const { BooleanField: Qt, NumberField: os, StringField: ke } = foundry.data.fields;
...
function We(q) {
  if (!q || !Array.isArray(q.terms)) return { resultType: null, label: null };
  const s = [], e = [], t = [];
  let a = !1;
  const d = (u, i = 1) => {
...
function rs(q) {
  return q ? q === "1" ? "1. szint" : q === "2" ? "2. szint" : q === "3" ? "3. szint" : q === "Alap" ? "Alap" : q : "Alap";
}
var _t, Dt, Ot, Ct;
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const a = ((i = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : i.resources) ?? {}, d = ((o = (l = a.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : o.value) ?? 0, r = ((n = a.currentHealth) == null ? void 0 : n.legs) ?? 0, c = B._healthStatusFromRatio(r, d), p = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(s) {
    ...
    for (const g of c) {
      const C = ((Re = d[g]) == null ? void 0 : Re.value) ?? 0, _ = r[g] ?? 0;
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), N = P ? P.split(/\s*,\s*/).filter((g) => L.includes(g)) : [], w = (it = this.actor.system.gear) == null ? void 0 : it.microchips, D = w && typeof w == "object" && !Array.isArray(w) ? w : {}, F = (((rt = D.slot1) == null ? void 0 : rt.itemId) ?? "").trim(), O = (((nt = D.slot2) == null ? void 0 : nt.itemId) ?? "").trim(), H = (((at = D.slot3) == null ? void 0 : at.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, C) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, A = typeof C.sort == "number" ? C.sort : 0;
      return _ - A;
    }).map((g) => {
      ...
      let Y = null;
      _ && (F === g.id ? Y = "slot1" : O === g.id ? Y = "slot2" : H === g.id && (Y = "slot3"));
      const Fe = C && ((qe = g.system) != null && qe.damage) ? g.system.damage : "", ie = C && typeof ((he = g.system) == null ? void 0 : he.range) == "string" ? (g.system.range || "").trim() : "", Oe = J ? Number((be = T[J]) == null ? void 0 : be.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.weaponSlots = ue.map((g, C) => {
      const _ = T[g] ?? {}, A = (_.itemId ?? "").trim(), R = fe.find((J) => J.id === A);
      return {
        slotKey: g,
        itemId: A,
        slotNum: C + 1,
    ...
    e.armorTable = Ie.map((g) => {
      var A, R;
      const C = (g == null ? void 0 : g.system) ?? {}, _ = ((A = g.system) == null ? void 0 : A.equipped) !== void 0 && ((R = g.system) == null ? void 0 : R.equipped) !== null ? !!g.system.equipped : !1;
      return {
        itemId: g.id,
        actorId: this.actor.id,
        ...
        level: rs((C.level ?? "").toString().trim()),
    ...
    e.itemsTable = Se.map((g) => {
      const C = (g == null ? void 0 : g.system) ?? {}, _ = (C.description ?? "").trim(), A = _ ? _.length > 60 ? _.slice(0, 57) + "…" : _ : "—", R = C.quantity != null ? String(C.quantity).trim() : "1";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    e.egyebList = ye.map((g) => {
      const _ = (((g == null ? void 0 : g.system) ?? {}).description ?? "").trim(), A = _ ? _.length > 80 ? _.slice(0, 77) + "…" : _ : "";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const X = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((g) => g.type === "MikroChip"), se = X.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ne = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var _, A, R;
      const C = [];
      return g !== 1 && C.push((((_ = D.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && C.push((((A = D.slot2) == null ? void 0 : A.itemId) ?? "").trim()), g !== 3 && C.push((((R = D.slot3) == null ? void 0 : R.itemId) ?? "").trim()), C.filter(Boolean);
    };
    e.microchipItemsSlot1 = se.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = se.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = se.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      const C = D[g] ?? {}, _ = (C.itemId ?? "").trim(), A = X.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (A == null ? void 0 : A.name) || C.name || Ne,
        img: (A == null ? void 0 : A.img) || "",
        active: C.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const C = `slot${g}`, _ = D[C] ?? {}, A = (_.itemId ?? "").trim(), R = se.find((J) => J.id === A);
      e[`microchip${g}ItemId`] = A, e[`microchip${g}DisplayName`] = (R == null ? void 0 : R.name) || _.name || Ne, e[`microchip${g}Img`] = (R == null ? void 0 : R.img) || "";
    }), e.microchipsTable = X.map((g) => {
      var pe, Ce, qe, he;
      const C = g.id;
      let _ = null;
      for (const be of k)
        if ((((pe = D[be]) == null ? void 0 : pe.itemId) ?? "").trim() === C) {
          _ = be;
          break;
        }
      const A = !!_, R = ((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.abilityType) ?? "", J = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Y = R === "active", Fe = Number((qe = g == null ? void 0 : g.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ie = (((he = g == null ? void 0 : g.system) == null ? void 0 : he.description) ?? "").trim(), Oe = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: C,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const U = this.actor.system.abilities ?? {}, Te = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).map((g) => {
      ...
      const C = U[g] ?? {}, _ = (C.itemId ?? "").trim(), A = _ ? G.get(_) : null, R = (A == null ? void 0 : A.description) ?? "", J = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: _,
        displayName: (A == null ? void 0 : A.name) || C.name || Ae,
        img: (A == null ? void 0 : A.img) || "",
        description: R,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-CVYrWKaV.mjs");
      n(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, n = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-CVYrWKaV.mjs");
      f(this.actor, o, n);
      ...
      (D = v == null ? void 0 : v.sheet) == null || D.render(!0);
    });
    const c = (i, l) => {
      var f;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((w) => v.includes(w)) : [], T = I.find((w) => {
        var D;
        return (((D = f[w]) == null ? void 0 : D.itemId) ?? "").trim() === o;
      }) ?? null;
      if (l.checked) {
        if (T) return;
        let w = I.find((F) => {
          var O;
          return !((O = f[F]) != null && O.itemId);
        });
        const D = new Set(I);
        if (!w) {
          const F = v.find((O) => !D.has(O));
          if (!F) return;
          w = F, I.push(F);
        }
        ...
        if (n && n.documentName === "Item" && n.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = T ? T.split(/\s*,\s*/).filter((w) => L.includes(w)) : [], N = P.filter((w) => {
              var D;
              return (((D = I[w]) == null ? void 0 : D.itemId) ?? "").trim() === v;
            });
            if (N.length > 0) {
              const D = {
              ...
              for (const F of N)
                D[`system.weapons.${F}.itemId`] = "", D[`system.weapons.${F}.name`] = "", D[`system.weapons.${F}.damage`] = "", D[`system.weapons.${F}.bonus`] = "";
              await f.update(D);
            }
          }
          return;
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: _armorLevelLabel((x.level ?? "").toString().trim()),
    ...
    const w = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.abilities) ?? {}, D = a.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, M;
      return {
        id: k.id,
        name: k.name,
    ...
    }), F = new Map(D.map((k) => [k.id, k])), O = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    e.abilityFajiSlot = O, e.abilityHatterSlot = O;
    const H = (k) => {
      const x = w[k];
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CVYrWKaV.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-CVYrWKaV.mjs");
      n(this.actor, l, o);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const a = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((L = e.system) == null ? void 0 : L.skills) ?? {}, r = ((P = e.items) == null ? void 0 : P.filter((D) => D.type === "Fegyver")) ?? [];
    let c = null;
    a.itemId && (c = r.find((D) => D.id === a.itemId) ?? null);
  ...
  async _onDropItem(s, e) {
    ...
    const a = ((w) => {
      var F;
      if (!w) return null;
      const D = w.uuid ?? w.documentUuid ?? ((F = w.data) == null ? void 0 : F.uuid) ?? (typeof w == "string" ? w : null);
      if (D) return D;
      if (typeof w == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const D = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), F = ((n = r.system) == null ? void 0 : n.abilities) ?? {}, O = D === "active" ? "active" : "passive", H = Array.isArray((f = F[O]) == null ? void 0 : f.items) ? F[O].items.slice() : Array.isArray(F[O]) ? F[O].slice() : [];
      H.includes(w) || H.push(w), await r.update({ [`system.abilities.${O}.items`]: H }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && m) {
      const w = ((I = r.system) == null ? void 0 : I.weapons) ?? {}, D = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = (w.slotOrder ?? "").trim(), O = F ? F.split(/\s*,\s*/).filter((W) => D.includes(W)) : [];
      let H = D.find((W) => {
        var ee;
        return !(((ee = w[W]) == null ? void 0 : ee.itemId) ?? "").trim();
      });
      H || (H = D.find((W) => !O.includes(W)) ?? "slot1");
      const V = O.includes(H) ? O : [...O, H].filter((W) => D.includes(W));
      await r.update({
    ...
    if (d.type === "MikroChip" && m) {
      const w = ((N = (P = r.system) == null ? void 0 : P.gear) == null ? void 0 : N.microchips) ?? {}, F = ["slot1", "slot2", "slot3"].find((O) => {
        var H;
        return !(((H = w[O]) == null ? void 0 : H.itemId) ?? "").trim();
      });
      F && await r.update({
...
const re = class re extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = ns, e;
  }
};
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (c, p, m, y) => {
    ...
    if (c.type === "Npc" && ((I = p == null ? void 0 : p.system) != null && I.identity) && "size" in p.system.identity) {
      const O = Kt((L = (T = c.system) == null ? void 0 : T.identity) == null ? void 0 : L.size);
      c.update({
        "prototypeToken.width": O,
        "prototypeToken.height": O
    ...
    for (const O of n)
      ((N = O.document) == null ? void 0 : N.id) !== b || ((w = O.document) == null ? void 0 : w.documentName) !== "Actor" || ((D = O.constructor) == null ? void 0 : D.name) !== "VoidKarakterSheet" || l.includes(O) || l.push(O);
    if (i && l.some((O) => {
      const H = (O == null ? void 0 : O.form) ?? (O == null ? void 0 : O.element);
      return H && H.contains(u);
    })) return;
    const h = (F = game.votv) == null ? void 0 : F._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < q ? h.appId : null;
    setTimeout(() => {
      for (const O of l)
        !(O != null && O.rendered) || typeof O.render != "function" || O.id !== v && O.render(!0);
    }, 0);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, L, P, N, w, D, F, O, H, V, W, ee, fe, te, ue, ve, we, Ie, Se;
    ...
    if (p || (p = ((D = (w = game.scenes) == null ? void 0 : w.contents) == null ? void 0 : D.flatMap((X) => {
      var se;
      return ((se = X.tokens) == null ? void 0 : se.contents) ?? [];
    }).map((X) => X.actor).find((X) => X && (X.id === c || X.id === r.actorId))) ?? null), !p) return;
    const m = r.itemId ? ((O = (F = p.items) == null ? void 0 : F.get) == null ? void 0 : O.call(F, r.itemId)) ?? ((W = (V = (H = p.items) == null ? void 0 : H.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (ye) => ye.id === r.itemId)) : null;
    ...
    !0
  ), (q = game.user) != null && q.isGM && ((s = game.scenes) == null ? void 0 : s.size) === 0 && (async () => {
    var e, t;
    try {
...
Hooks.on("preCreateToken", (q, s, e) => {
  var r, c, p, m;
  const t = (r = game.votv) == null ? void 0 : r._dragSourceActorId, a = t ?? q.actorId ?? null;
...
Hooks.on("preCreateCombatant", (q, s, e) => {
  const t = q.initiative;
  (t == null || typeof t == "number" && isNaN(t)) && q.updateSource({ initiative: 0 });
});
Hooks.on("renderSidebarTab", (q, s, e) => {
  if ((q == null ? void 0 : q.id) !== "combat") return;
  const t = s[0] ?? s;
...
Hooks.on("renderTokenHUD", (q, s, e) => {
  var d;
  const t = q == null ? void 0 : q.object, a = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
  if ((a == null ? void 0 : a.type) === "Karakter") {
    const r = s[0] ?? s;
    r != null && r.classList && r.classList.add("votv-karakter-token-hud");
  }
});
Hooks.on("preCreateScene", (q, s) => {
  var e;
  (e = s == null ? void 0 : s.background) != null && e.src || q.updateSource({
    width: 3840,
    height: 2160,
    "background.src": jt,
    backgroundColor: "#0f0f0f",
...
Hooks.on("renderChatMessageHTML", (q, s, e) => {
  var m, y, b, u;
  const t = ((m = q.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, a = t.resultType, d = t.critLabel, r = t.weaponAttack, c = t.weapon;
  if (!a && !d && !r) return;
  ...
  if (p) {
    ...
    if (r && c && (c.actorId || (b = q.speaker) != null && b.actor)) {
      ...
      if (c.isHit && !p.querySelector(".votv-weapon-damage-chat")) {
        ...
        f.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", f.dataset.actorId = String(c.actorId ?? ((u = q.speaker) == null ? void 0 : u.actor) ?? ""), f.dataset.itemId = String(c.itemId ?? ""), f.dataset.slotKey = String(c.slotKey ?? ""), f.dataset.targetName = String(c.targetName ?? ""), f.dataset.hitLocationName = String(c.hitLocationName ?? ""), f.dataset.messageId = String(q.id ?? ""), l.appendChild(f);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-DCqfUOSz.mjs.map
