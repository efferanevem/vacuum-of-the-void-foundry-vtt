...
const { BooleanField: Ti, StringField: zt } = foundry.data.fields;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const l = Number(((It = (wt = this.actor.system) == null ? void 0 : wt.combat) == null ? void 0 : It.givenProtection) ?? 0) || 0, m = (Tt = (Xe = (St = this.actor) == null ? void 0 : St.statuses) == null ? void 0 : Xe.has) != null && Tt.call(Xe, "lookaround") ? 1 : 0, h = (S = (Qe = (Dt = this.actor) == null ? void 0 : Dt.statuses) == null ? void 0 : Qe.has) != null && S.call(Qe, "halfcover") ? 3 : 0, g = (G = (x = (P = this.actor) == null ? void 0 : P.statuses) == null ? void 0 : x.has) != null && G.call(x, "threequarteredcover") ? 6 : 0, v = l + this._getTotalArmorProtectionBonus() + m + h + g;
    ...
    e.microchipItemsSlot1 = ae.filter((b) => !fe(1).includes(b.id)), e.microchipItemsSlot2 = ae.filter((b) => !fe(2).includes(b.id)), e.microchipItemsSlot3 = ae.filter((b) => !fe(3).includes(b.id)), e.microchipSlots = ce.map((b) => {
      ...
      let L = null;
      for (const Ve of ce)
        if ((((ze = M[Ve]) == null ? void 0 : ze.itemId) ?? "").trim() === N) {
          L = Ve;
          break;
        }
    ...
    const Me = (((as = e.weaponsTable) == null ? void 0 : as.length) ?? 0) > 0 || (((rs = e.armorTable) == null ? void 0 : rs.length) ?? 0) > 0 || (((os = e.microchipsTable) == null ? void 0 : os.length) ?? 0) > 0 || (((cs = e.itemsTable) == null ? void 0 : cs.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-B27eZnH1.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-B27eZnH1.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-B27eZnH1.mjs");
      h(this.actor, l, m);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: g } = Gt(m), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${p} – találat`,
...
X(Q, "PARTS", foundry.utils.mergeObject(
  ...
  z(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ns = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Fs = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Es = (As = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : As.window) == null ? void 0 : Es.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((ct = e.system) == null ? void 0 : ct.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, u = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, p = (lt = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && lt.call(ie, "halfcover") ? 3 : 0, d = (Ce = (xe = t == null ? void 0 : t.statuses) == null ? void 0 : xe.has) != null && Ce.call(xe, "threequarteredcover") ? 6 : 0;
    ...
    const Me = ae.length > 0 ? ae[ae.length - 1] : null, je = Math.min(10, Me ? Me.kp : 6), Ke = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((S, P) => {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-B27eZnH1.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-B27eZnH1.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-B27eZnH1.mjs");
      m(this.actor, c, l);
...
X(ge, "PARTS", foundry.utils.mergeObject(
  ...
  z(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ps = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject((($s = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : $s.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Rs = (xs = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) == null ? void 0 : Rs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const D of r) {
      ...
      const fe = E.health ?? {}, Me = Number(fe.max ?? 0) || 0, je = Number(fe.value ?? 0) || 0;
      let $e;
      if (Me <= 0)
        $e = void 0;
      else if (je <= 0)
...
X(he, "PARTS", foundry.utils.mergeObject(
  ...
  z(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((zs = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : zs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ms = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ks = (js = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : js.window) == null ? void 0 : Ks.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const rt = class rt extends jt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (y == null ? void 0 : y.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((W = (M = this.actor) == null ? void 0 : M.items) == null ? void 0 : W.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ls(this.actor), O = m + h + k + w + T;
      r.value = O;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, p = f.assignment ?? "", d = f.subAssignment ?? "", a = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[p] ?? 0, i = o[d] ?? 0, c = e.sizeForSelect ?? "Kicsi", l = y[c] ?? 0, m = Number(u.threatBonus ?? 0) || 0, h = Ls(this.actor), g = r + i + l + m + h;
      e.system = foundry.utils.mergeObject(
...
X(rt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(rt, rt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Us = z(rt, rt, "DEFAULT_OPTIONS")) == null ? void 0 : Us.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Wt = rt;
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  z(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Bs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !0 }),
    window: foundry.utils.mergeObject(((Hs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Vs = (Gs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.window) == null ? void 0 : Vs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(Le, "PARTS", foundry.utils.mergeObject(z(Le, Le, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), X(Le, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Le, Le, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ws = z(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.form) ?? {}, { submitOnChange: !1 })
}));
let Zt = Le;
var Js;
...
X(Ae, "PARTS", foundry.utils.mergeObject(z(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ys = z(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ys.form) ?? {}, { submitOnChange: !0 })
}));
let Qt = Ae;
var Xs;
...
X(Ee, "PARTS", foundry.utils.mergeObject(z(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Xs = z(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Xs.form) ?? {}, { submitOnChange: !1 })
}));
let es = Ee;
var Qs;
...
X(Se, "PARTS", foundry.utils.mergeObject(z(Se, Se, "PARTS") ?? {}, {
  ...
  z(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ei = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : ei.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ti = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : ti.dragDrop) ?? [],
      {
        dragSelector: null,
...
X(Te, "PARTS", foundry.utils.mergeObject(z(Te, Te, "PARTS") ?? {}, {
  ...
  z(Te, Te, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((si = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : si.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ii = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : ii.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, o, y, r) => {
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const R = ai((M = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : M.size);
      a.update({
...
//# sourceMappingURL=vacuum-of-the-void-CWz2Dy8W.mjs.map
