...
const { HTMLField: hs, NumberField: O, SchemaField: K, StringField: S, BooleanField: se, ArrayField: Xe } = foundry.data.fields;
...
const { NumberField: ft, SchemaField: bs } = foundry.data.fields;
class ks extends os {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ws, StringField: dt } = foundry.data.fields;
...
const { NumberField: yt, StringField: Ut } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var F, x, j, ae, X, Ee, he, Ie, be, qe, Le, ot, ct, lt, ut, We, Fe, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et, Ft, $t, xt, Rt;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((j = (x = (F = this.actor.system) == null ? void 0 : F.resources) == null ? void 0 : x.stress) == null ? void 0 : j.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const _ = ((ae = d[y]) == null ? void 0 : ae.value) ?? 0, D = r[y] ?? 0;
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (qe = this.actor.system.gear) == null ? void 0 : qe.microchips, E = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((Le = E.slot1) == null ? void 0 : Le.itemId) ?? "").trim(), H = (((ot = E.slot2) == null ? void 0 : ot.itemId) ?? "").trim(), B = (((ct = E.slot3) == null ? void 0 : ct.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      const D = typeof y.sort == "number" ? y.sort : 0, q = typeof _.sort == "number" ? _.sort : 0;
      return D - q;
    }).map((y) => {
      var ke, Pe, Ae, Se, Te, Je;
      const _ = y.type === "Fegyver", D = y.type === "MikroChip";
      let q = 0, M = "", te = null;
      for (let $e = 0; $e < A.length; $e++) {
        const Qe = A[$e];
        if ((((ke = T[Qe]) == null ? void 0 : ke.itemId) ?? "") === y.id) {
          q = $e + 1, M = ((Pe = T[Qe]) == null ? void 0 : Pe.bonus) ?? "", te = Qe;
          break;
        }
      }
      let V = null;
      D && (N === y.id ? V = "slot1" : H === y.id ? V = "slot2" : B === y.id && (V = "slot3"));
      const Ye = _ && ((Ae = y.system) != null && Ae.damage) ? y.system.damage : "", oe = _ && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = te ? Number((Te = T[te]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponsTable = ee.map((y) => {
      ...
      let D = null, q = {};
      for (const pt of A)
        if ((((Mt = T[pt]) == null ? void 0 : Mt.itemId) ?? "").trim() === _) {
          D = pt, q = T[pt] ?? {};
          break;
        }
      const M = !!D, te = ((Kt = y.system) == null ? void 0 : Kt.equipped) !== void 0 && ((jt = y.system) == null ? void 0 : jt.equipped) !== null ? !!y.system.equipped : M, V = (y == null ? void 0 : y.system) ?? {}, Ye = typeof V.range == "string" ? (V.range || "").trim() : "", oe = V.type ?? "", Ne = (ve[oe] ?? oe) || "—", ke = V.size ?? "", Pe = (ne[ke] ?? ke) || "", Ae = [Ne, Pe].filter(Boolean).join(", ") || Ne || "—", Se = oe === "projectile" || ke === "thrown", Te = V.quantity, Je = Te != null ? String(Te).trim() : "1", $e = String(q.bonus ?? "").trim(), Qe = String(V.bonus ?? "").trim(), ms = $e || Qe || "0";
      return {
        slotKey: D ?? "",
        itemId: _,
    ...
    const Z = (((Dt = this.actor.items) == null ? void 0 : Dt.contents) ?? []).filter((y) => y.type === "MikroChip"), ye = Z.map((y) => ({ id: y.id, name: y.name, img: y.img })), Ze = "— Nincs Mikro-Chip —", Re = ["slot1", "slot2", "slot3"], Me = (y) => {
      var D, q, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = ye.filter((y) => !Me(1).includes(y.id)), e.microchipItemsSlot2 = ye.filter((y) => !Me(2).includes(y.id)), e.microchipItemsSlot3 = ye.filter((y) => !Me(3).includes(y.id)), e.microchipSlots = Re.map((y) => {
      ...
      return {
        slotKey: y,
        itemId: D,
        displayName: (q == null ? void 0 : q.name) || _.name || Ze,
        img: (q == null ? void 0 : q.img) || "",
        active: _.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const _ = `slot${y}`, D = E[_] ?? {}, q = (D.itemId ?? "").trim(), M = ye.find((te) => te.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || D.name || Ze, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    ...
    const Ve = (((_t = e.weaponsTable) == null ? void 0 : _t.length) ?? 0) > 0 || (((Ct = e.armorTable) == null ? void 0 : Ct.length) ?? 0) > 0 || (((Ot = e.microchipsTable) == null ? void 0 : Ot.length) ?? 0) > 0 || (((qt = e.itemsTable) == null ? void 0 : qt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Ve;
    const Ke = this.actor.system.abilities ?? {}, et = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).map((y) => {
      var _, D, q;
      return {
        id: y.id,
        name: y.name,
    ...
    const st = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, it = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (At = (Pt = e.system) == null ? void 0 : Pt.combat) == null ? void 0 : At.initiativeResult, ge = typeof _e == "number" ? _e : -1, nt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Be = (Ft = (Et = e.system) == null ? void 0 : Et.combat) == null ? void 0 : Ft.initiativeRanges, Ce = Array.isArray(Be) ? Be.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : nt).slice().sort((y, _) => y.min - _.min), Oe = Ce.map((y) => y.min), rt = Oe.length ? Math.min(...Oe) : 0, at = Oe.length ? Math.max(...Oe) : 0;
    e.initiativeRanges = Ce.map((y) => ({ ...y, isFirst: y.min === rt, isLast: y.min === at }));
    let Ge = 0;
    ...
    e.kpDots = it.map((y, _) => {
      const D = _ + 1, q = !!Number(st[y]), M = D <= Ge;
      return { index: D, used: q, usable: M };
    });
    const k = !!((xt = ($t = game.combat) == null ? void 0 : $t.combatants) != null && xt.some((y) => {
      var _;
      return ((_ = y.actor) == null ? void 0 : _.type) === "Karakter";
    }));
    return e.showHarcSection = k, e.canEditInitiative = !!((Rt = game.user) != null && Rt.isGM), e.showInitiativeResult = typeof _e == "number", e.initiativeResult = e.showInitiativeResult ? _e : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CCdpyxf8.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-CCdpyxf8.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-CCdpyxf8.mjs");
      p(this.actor, o, a);
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ve, Ke, et, je, tt, He, Ue, ze, st, it, _e, ge, nt, Be, Ce, mt, we, Oe, rt, at, Ge;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Ve = this.actor) == null ? void 0 : Ve.system), e.showDeathSkull = !1, e.sizeForSelect = (((et = (Ke = e.system) == null ? void 0 : Ke.identity) == null ? void 0 : et.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((je = t == null ? void 0 : t.items) == null ? void 0 : je.contents) ?? [], d = ((tt = t == null ? void 0 : t.system) == null ? void 0 : tt.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const Fe of c)
        if ((((We = d[Fe]) == null ? void 0 : We.itemId) ?? "").trim() === F) {
          x = Fe, j = d[Fe] ?? {};
          break;
        }
      const ae = !!x, X = (k == null ? void 0 : k.system) ?? {}, Ee = typeof X.range == "string" ? (X.range || "").trim() : "", he = X.type ?? "", Ie = (a[he] ?? he) || "—", be = X.size ?? "", qe = (p[be] ?? be) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", ot = he === "projectile" || be === "thrown", ct = X.quantity != null ? String(X.quantity).trim() : "1", lt = String(X.bonus ?? j.bonus ?? "").trim() || "0", ut = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const A = (((ze = e.weaponsTable) == null ? void 0 : ze.length) ?? 0) > 0 || (((st = e.armorTable) == null ? void 0 : st.length) ?? 0) > 0 || (((it = e.microchipsTable) == null ? void 0 : it.length) ?? 0) > 0 || (((_e = e.itemsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((ge = e.egyebList) == null ? void 0 : ge.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const C = ((nt = t == null ? void 0 : t.system) == null ? void 0 : nt.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const R = ((mt = e.system) == null ? void 0 : mt.resources) ?? {}, Y = (Oe = (we = e.system) == null ? void 0 : we.combat) == null ? void 0 : Oe.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ne = (at = (rt = e.system) == null ? void 0 : rt.combat) == null ? void 0 : at.initiativeRanges, fe = Array.isArray(ne) ? ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (fe.length > 0 ? fe : ve).slice().sort((k, F) => k.min - F.min), Z = fe.map((k) => k.min), ye = Z.length ? Math.min(...Z) : 0, Ze = Z.length ? Math.max(...Z) : 0;
    e.initiativeRanges = fe.map((k) => ({ ...k, isFirst: k.min === ye, isLast: k.min === Ze }));
    let Re = 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CCdpyxf8.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CCdpyxf8.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CCdpyxf8.mjs");
      a(this.actor, c, o);
...
//# sourceMappingURL=vacuum-of-the-void-OeFGmi09.mjs.map
