...
const { HTMLField: qt, NumberField: q, SchemaField: L, StringField: v, BooleanField: U, ArrayField: ce } = foundry.data.fields;
...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const f = this.element, y = this.form ?? this.element, h = o.scrollState, a = o.focus, d = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var p, g;
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((d = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : d.resources) ?? {}, n = ((m = (l = s.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : m.value) ?? 0, r = ((p = s.currentHealth) == null ? void 0 : p.legs) ?? 0, o = N._healthStatusFromRatio(r, n), u = Number(((S = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let f;
  ...
  async _prepareContext(i) {
    ...
    for (const c of o) {
      const I = ((Ne = n[c]) == null ? void 0 : Ne.value) ?? 0, k = r[c] ?? 0;
      e.computedHealthStatus[c] = N._healthStatusFromRatio(k, I);
    }
    ...
    for (const [c, I] of Object.entries(g)) {
      ...
      e.skillHealthStatus[c] = k, e.skillDisabled[c] = k === 0 ? " disabled" : "", e.skillHasHealthTint[c] = !0;
    }
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (b.slotOrder ?? "").trim(), C = O ? O.split(/\s*,\s*/).filter((c) => S.includes(c)) : [], F = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, D = F && typeof F == "object" && !Array.isArray(F) ? F : {}, w = (((Ke = D.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), P = (((Ue = D.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = D.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((c) => c.type !== "Kepesseg" && c.type !== "ability").slice().sort((c, I) => {
      const k = typeof c.sort == "number" ? c.sort : 0, T = typeof I.sort == "number" ? I.sort : 0;
      return k - T;
    }).map((c) => {
      var X, ee, te, Z, V, ne;
      const I = c.type === "Fegyver", k = c.type === "MikroChip";
      let T = 0, _ = "", j = null;
      ...
      let K = null;
      k && (w === c.id ? K = "slot1" : P === c.id ? K = "slot2" : x === c.id && (K = "slot3"));
    ...
    e.weaponItems = Se;
    const Te = "— Nincs fegyver —", pt = C.filter((c) => {
      const k = ((b[c] ?? {}).itemId ?? "").trim();
      return k ? !!ue.find((_) => _.id === k) : !1;
    });
    e.weaponSlots = pt.map((c, I) => {
      const k = b[c] ?? {}, T = (k.itemId ?? "").trim(), _ = Se.find((j) => j.id === T);
      return {
        slotKey: c,
        itemId: T,
        slotNum: I + 1,
    ...
    e.weaponsTable = ue.map((c) => {
      ...
      const _ = !!k, j = ((re = c.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = c.system) == null ? void 0 : Je.equipped) !== null ? !!c.system.equipped : _, K = (c == null ? void 0 : c.system) ?? {}, ae = typeof K.range == "string" ? (K.range || "").trim() : "", Q = K.type ?? "", J = (ft[Q] ?? Q) || "—", X = K.size ?? "", ee = (yt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = K.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: k ?? "",
        itemId: I,
    ...
    e.armorTable = gt.map((c) => {
      var T, _;
      const I = (c == null ? void 0 : c.system) ?? {}, k = ((T = c.system) == null ? void 0 : T.equipped) !== void 0 && ((_ = c.system) == null ? void 0 : _.equipped) !== null ? !!c.system.equipped : !1;
      return {
        itemId: c.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = ht.map((c) => {
      const I = (c == null ? void 0 : c.system) ?? {}, k = (I.description ?? "").trim(), T = k ? k.length > 60 ? k.slice(0, 57) + "…" : k : "—", _ = I.quantity != null ? String(I.quantity).trim() : "1";
      return {
        itemId: c.id,
        actorId: this.actor.id,
        name: (c == null ? void 0 : c.name) ?? "—",
    ...
    e.egyebList = bt.map((c) => {
      const k = (((c == null ? void 0 : c.system) ?? {}).description ?? "").trim(), T = k ? k.length > 80 ? k.slice(0, 77) + "…" : k : "";
      return {
        itemId: c.id,
        actorId: this.actor.id,
        name: (c == null ? void 0 : c.name) ?? "—",
    ...
    const de = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).filter((c) => c.type === "MikroChip"), oe = de.map((c) => ({ id: c.id, name: c.name, img: c.img })), qe = "— Nincs Mikro-Chip —", Oe = ["slot1", "slot2", "slot3"], me = (c) => {
      var k, T, _;
      const I = [];
      return c !== 1 && I.push((((k = D.slot1) == null ? void 0 : k.itemId) ?? "").trim()), c !== 2 && I.push((((T = D.slot2) == null ? void 0 : T.itemId) ?? "").trim()), c !== 3 && I.push((((_ = D.slot3) == null ? void 0 : _.itemId) ?? "").trim()), I.filter(Boolean);
    };
    e.microchipItemsSlot1 = oe.filter((c) => !me(1).includes(c.id)), e.microchipItemsSlot2 = oe.filter((c) => !me(2).includes(c.id)), e.microchipItemsSlot3 = oe.filter((c) => !me(3).includes(c.id)), e.microchipSlots = Oe.map((c) => {
      const I = D[c] ?? {}, k = (I.itemId ?? "").trim(), T = de.find((_) => _.id === k);
      return {
        slotKey: c,
        itemId: k,
      ...
      const I = `slot${c}`, k = D[I] ?? {}, T = (k.itemId ?? "").trim(), _ = oe.find((j) => j.id === T);
      e[`microchip${c}ItemId`] = T, e[`microchip${c}DisplayName`] = (_ == null ? void 0 : _.name) || k.name || qe, e[`microchip${c}Img`] = (_ == null ? void 0 : _.img) || "";
      ...
      const T = !!k, _ = ((ee = c == null ? void 0 : c.system) == null ? void 0 : ee.abilityType) ?? "", j = _ === "active" ? "Aktív" : _ === "passive" ? "Passzív" : _ || "—", K = _ === "active", ae = Number((te = c == null ? void 0 : c.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(c.system.replaceCost) : 0, Q = (((Z = c == null ? void 0 : c.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (c == null ? void 0 : c.name) ?? "—",
    ...
    const De = this.actor.system.abilities ?? {}, vt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((c) => {
      var I, k, T;
      return {
        id: c.id,
        name: c.name,
        ...
        description: ((k = c.system) == null ? void 0 : k.description) ?? "",
        kp: Number(((T = c.system) == null ? void 0 : T.kp) ?? 0) || 0
      };
    }), _e = new Map(vt.map((c) => [c.id, c])), wt = "— Nincs képesség —", Le = (c) => {
      const I = De[c] ?? {}, k = (I.itemId ?? "").trim(), T = k ? _e.get(k) : null, _ = (T == null ? void 0 : T.description) ?? "", j = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: k,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-Da78Ue9n.mjs");
      m(this.actor, l);
    ...
    n && s({ currentTarget: n }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      a.preventDefault();
      const d = a.currentTarget, l = d.dataset.skill, m = ((g = d.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: p } = await import("./roll-sheet-Da78Ue9n.mjs");
      p(this.actor, l, m);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if ((p == null ? void 0 : p.type) === "Fegyver") {
        const b = m.system.weapons ?? {}, S = (b.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = S ? S.split(/\s*,\s*/).filter((D) => O.includes(D)) : [], F = C.find((D) => {
          var w;
          return (((w = b[D]) == null ? void 0 : w.itemId) ?? "").trim() === l;
        });
        if (F) {
      ...
      const p = this.actor.system.weapons ?? {}, g = (p.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = g ? g.split(/\s*,\s*/).filter((w) => b.includes(w)) : [], O = S.find((w) => {
        var P;
        return (((P = p[w]) == null ? void 0 : P.itemId) ?? "").trim() === l;
      }) ?? null;
      if (d.checked) {
        if (O) return;
        let w = S.find((x) => {
      ...
      if (!p) return;
      const g = (d.dataset.itemId ?? "").trim(), b = (d.dataset.itemName ?? ((w = d.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (d.dataset.itemImg ?? "").trim(), O = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = b);
      let C = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-thumb");
      S ? (C || (C = document.createElement("img"), C.className = "karakter-microchip-slot-thumb", C.alt = "", m == null || m.insertBefore(C, O)), C.src = S, C.style.display = "") : C && C.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
    ...
    const o = this, u = (a) => {
      ...
      o.actor.update(d).then(() => {
        l && setTimeout(() => o.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, f = (a) => {
      var d, l, m;
      return a && (((l = (d = o.element) == null ? void 0 : d.contains) == null ? void 0 : l.call(d, a)) || o.id && ((m = a.closest) == null ? void 0 : m.call(a, `#${CSS.escape(o.id)}`)));
    };
    o._votvBlur = (a) => {
      const d = a.target;
      if (!d || !d.form) return;
  ...
  async _rollWeapon(i) {
    ...
    const o = r && r.name || t.name || `Fegyver (${i})`, u = Number(t.bonus || 0) || 0, y = (((b = r == null ? void 0 : r.system) == null ? void 0 : b.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(s[y] || 0) || 0, a = u + h, l = `3d6${a !== 0 ? a > 0 ? `+${a}` : `${a}` : ""}`, m = new Roll(l);
...
Hooks.on("preCreateToken", (A, i, e) => {
  var r, o;
  const t = (r = game.votv) == null ? void 0 : r._dragSourceActorId, s = t ?? A.actorId ?? null;
...
Hooks.on("renderChatMessageHTML", (A, i, e) => {
  var n, r, o;
  const t = (r = (n = A.flags) == null ? void 0 : n["vacuum-of-the-void"]) == null ? void 0 : r.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-zOoS-nsi.mjs.map
