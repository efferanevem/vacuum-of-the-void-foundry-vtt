...
function Ut(I) {
  ...
  const f = (a, i = 1) => {
    ...
    for (const l of a) {
      ...
      const g = !n && r >= 0 && (l.number === 3 || l.number === "3") ? (n = !0, s) : r >= 0 ? e : t;
      for (const v of h) {
  ...
  f(I.terms, 1);
  const u = s.filter((a) => a === 6).length, p = s.filter((a) => a === 1).length, m = e.filter((a) => a === 6).length, o = t.filter((a) => a === 6).length, c = u + m, y = p + o;
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const o = this.element, c = this.form ?? this.element, y = p.scrollState, a = p.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", r = () => {
      var d, h;
  ...
  static getTotalSpeedRaw(s) {
    var c, y, a, i, r, l, d, h, g;
    if (!(s != null && s.system)) return 0;
    const e = s.system.resources ?? {}, t = ((y = (c = e.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : y.value) ?? 0, n = ((a = e.currentHealth) == null ? void 0 : a.legs) ?? 0, f = X._healthStatusFromRatio(n, t);
    if (f === 0) return 0;
  ...
  async _prepareContext(s) {
    var mt, pt, ft, yt, gt, ht, bt, vt, kt, Ze, wt, It, Ye, S, P, x, G, ve, ne, Ce, De, ke, xe, Xe, Qe, Nt, Ft, At, Et, St, ct, es, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms, ps;
    ...
    for (const b of p) {
      ...
      e.computedHealthStatus[b] = X._healthStatusFromRatio(L, N);
    }
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], z = (O.slotOrder ?? "").trim(), K = z ? z.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, M = U && typeof U == "object" && !Array.isArray(U) ? U : {}, W = (((Qe = M.slot1) == null ? void 0 : Qe.itemId) ?? "").trim(), Z = (((Nt = M.slot2) == null ? void 0 : Nt.itemId) ?? "").trim(), J = (((Ft = M.slot3) == null ? void 0 : Ft.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      const et = N && ((st = b.system) != null && st.damage) ? b.system.damage : "", we = N && typeof ((He = b.system) == null ? void 0 : He.range) == "string" ? (b.system.range || "").trim() : "", _e = ue ? Number((Ge = O[ue]) == null ? void 0 : Ge.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.weaponSlots = Te.map((b, N) => {
      const L = O[b] ?? {}, A = (L.itemId ?? "").trim(), B = te.find((_e) => _e.id === A), ue = R.find((_e) => _e.id === A), re = (ue == null ? void 0 : ue.system) ?? {}, et = re.size === "thrown", we = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
    ...
    e.microchipItemsSlot1 = ae.filter((b) => !fe(1).includes(b.id)), e.microchipItemsSlot2 = ae.filter((b) => !fe(2).includes(b.id)), e.microchipItemsSlot3 = ae.filter((b) => !fe(3).includes(b.id)), e.microchipSlots = ce.map((b) => {
      ...
      let L = null;
      for (const Ge of ce)
        if ((((Re = M[Ge]) == null ? void 0 : Re.itemId) ?? "").trim() === N) {
          L = Ge;
          break;
        }
    ...
    return e.showHarcSection = Lt, e.canEditInitiative = !!((ps = game.user) != null && ps.isGM), e.showInitiativeResult = typeof ye == "number", e.initiativeResult = e.showInitiativeResult ? ye : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-DVPgbDEZ.mjs");
      d(this.actor, l);
      ...
      l && await this._rollWeaponDamage(l, ((g = r.dataset.slot) == null ? void 0 : g.trim()) ?? "");
    }), t.on("click", ".karakter-harc-initiative", async (i) => {
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DVPgbDEZ.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, l = r.dataset.skill, d = ((g = r.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-DVPgbDEZ.mjs");
      h(this.actor, l, d);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const l = r.closest(".karakter-microchip-slot-select-wrap"), d = l == null ? void 0 : l.classList.contains("karakter-microchip-slot-open");
      ...
      var C;
      i.preventDefault();
      const r = i.currentTarget, l = r.closest(".karakter-microchip-slot-select-wrap"), d = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), h = d == null ? void 0 : d.dataset.slot;
      if (!h) return;
      const g = (r.dataset.itemId ?? "").trim(), v = (r.dataset.itemName ?? ((C = r.textContent) == null ? void 0 : C.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", k = (r.dataset.itemImg ?? "").trim(), w = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      w && (w.textContent = v);
      ...
      r.addEventListener("dragover", (d) => this._onMicrochipSlotDragOver(d, l)), r.addEventListener("dragleave", (d) => {
        var h;
        return (h = d.currentTarget) == null ? void 0 : h.classList.remove("karakter-microchip-slot-drag-over");
      }), r.addEventListener("drop", (d) => this._onMicrochipSlotDrop(d, l));
    }), t.find(".karakter-ability-slot-single").each((i, r) => {
      const l = r.dataset.slot;
      l && (r.addEventListener("dragover", (d) => this._onAbilitySingleDragOver(d, l)), r.addEventListener("dragleave", (d) => {
        var h;
      ...
      l && (r.addEventListener("dragover", (d) => this._onAbilityAreaDragOver(d, l)), r.addEventListener("dragleave", (d) => {
        var h;
      ...
      if (!r || !l) return;
      const d = this.actor.system.abilities ?? {}, g = (Array.isArray((v = d[r]) == null ? void 0 : v.items) ? d[r].items.slice() : []).filter((k) => k !== l);
    ...
    const m = this, o = (i) => {
      ...
      const l = ((h = (d = r.system) == null ? void 0 : d.resources) == null ? void 0 : h.currentHealth) != null || ((v = (g = r.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      m.actor.update(r).then(() => {
        l && setTimeout(() => m.render(!0), 260);
      }).catch((k) => console.warn("VoidKarakterSheet save failed", k));
    }, c = (i) => {
      var r, l, d;
      return i && (((l = (r = m.element) == null ? void 0 : r.contains) == null ? void 0 : l.call(r, i)) || m.id && ((d = i.closest) == null ? void 0 : d.call(i, `#${CSS.escape(m.id)}`)));
    };
    m._votvBlur = (i) => {
      var g;
      const r = i.target;
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const c of u) {
      const y = ((o = n[c]) == null ? void 0 : o.value) ?? 0, a = f[c] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${c}`, X._healthStatusFromRatio(a, y));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, n, f, u, p, m, o, c, y, a, i, r, l, d;
    if (e) {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((c = e.system) == null ? void 0 : c.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: c, label: y } = Ut(o), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const p = u && u.name || t.name || `Fegyver (${s})`, m = Number(t.bonus || 0) || 0, o = ((k = u == null ? void 0 : u.system) == null ? void 0 : k.type) || "kinetic", c = (((w = u == null ? void 0 : u.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = c && n[c] !== void 0 ? c : o === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = m + a, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, d = new Roll(l);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (r = ui.notifications) == null ? void 0 : r.warn) == null || h.call(r, ((d = (l = game.i18n) == null ? void 0 : l.localize) == null ? void 0 : d.call(l, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const u = new Roll(f);
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const u = await super.render(s, e), p = this.element, m = this.form ?? this.element, o = f.scrollState, c = f.focus, y = typeof (o == null ? void 0 : o.formScrollTop) == "number" || typeof (o == null ? void 0 : o.windowScrollTop) == "number", a = () => {
      var i, r;
      if (this._applyScrollState(p, o), (c == null ? void 0 : c.name) != null || (c == null ? void 0 : c.id) != null) {
        const l = ((i = m.querySelector) == null ? void 0 : i.call(m, c.id ? `#${CSS.escape(c.id)}` : null)) ?? (c.name ? (r = m.querySelector) == null ? void 0 : r.call(m, `[name="${CSS.escape(c.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    var Ke, We, Ue, at, Q, ye, ie, rt, $e, Oe, ot, Be, Je, Ct, qt, dt, Lt, mt, pt, ft, yt, gt, ht, bt, vt, kt, Ze, wt, It, Ye;
    ...
    const o = ((ot = t == null ? void 0 : t.items) == null ? void 0 : ot.contents) ?? [], c = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (c.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], r = o.filter((S) => S.type === "Fegyver"), l = r.map((S) => ({ id: S.id, name: S.name, img: S.img })), d = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
      const P = (((x = c[S]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && r.some((G) => G.id === P);
    });
    e.weaponSlots = k.map((S) => {
      const P = c[S] ?? {}, x = (P.itemId ?? "").trim(), G = l.find((ke) => ke.id === x), ve = r.find((ke) => ke.id === x), ne = (ve == null ? void 0 : ve.system) ?? {}, Ce = ne.size === "thrown", De = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: S,
        itemId: x,
    ...
    e.weaponsTable = r.map((S) => {
      ...
      const ve = !!x, ne = (S == null ? void 0 : S.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", De = ne.type ?? "", ke = (w[De] ?? De) || "—", xe = ne.size ?? "", Xe = (T[xe] ?? xe) || "", Qe = [ke, Xe].filter(Boolean).join(", ") || ke || "—", Nt = De === "projectile" || xe === "thrown", Ft = ne.quantity != null ? String(ne.quantity).trim() : "1", At = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Et = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const M = (((qt = e.weaponsTable) == null ? void 0 : qt.length) ?? 0) > 0 || (((dt = e.armorTable) == null ? void 0 : dt.length) ?? 0) > 0 || (((Lt = e.microchipsTable) == null ? void 0 : Lt.length) ?? 0) > 0 || (((mt = e.itemsTable) == null ? void 0 : mt.length) ?? 0) > 0 || (((pt = e.egyebList) == null ? void 0 : pt.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-DVPgbDEZ.mjs");
      l(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DVPgbDEZ.mjs");
      ...
      const l = !!Number((h = (d = this.actor.system) == null ? void 0 : d.resources) == null ? void 0 : h[`kpDot${r}`]);
      await this.actor.update({ [`system.resources.kpDot${r}`]: l ? 0 : 1 });
    }), t.on("click", ".karakter-skill-label", async (a) => {
      var h, g;
      a.preventDefault();
      const i = a.currentTarget, r = (((h = i == null ? void 0 : i.dataset) == null ? void 0 : h.skill) ?? "").trim(), l = ((g = i == null ? void 0 : i.textContent) == null ? void 0 : g.trim()) || r;
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-DVPgbDEZ.mjs");
      d(this.actor, r, l);
    }), t.on("click", ".karakter-ability-chat", async (a) => {
      var r, l;
      a.preventDefault();
      const i = (l = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : l.itemId;
      ...
      const l = ((T = this.actor.system) == null ? void 0 : T.abilities) ?? {}, h = (Array.isArray((_ = l[i]) == null ? void 0 : _.items) ? l[i].items.slice() : []).filter((O) => O !== r);
      ...
      var r, l;
      if (a.preventDefault(), !a.altKey) return;
      const i = (l = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : l.slot;
      ...
      d && (h[`system.weapons.${d}.itemId`] = "", h[`system.weapons.${d}.name`] = "", h[`system.weapons.${d}.damage`] = "", h[`system.weapons.${d}.bonus`] = ""), Object.keys(h).length && await l.update(h), await l.deleteEmbeddedDocuments("Item", [r]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (a) => {
      var r, l;
      if (a.preventDefault(), !a.altKey) return;
      const i = (((l = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : l.itemId) ?? "").trim();
    ...
    const u = this, p = (a) => {
      ...
      var i, r, l;
      return a && (((r = (i = u.element) == null ? void 0 : i.contains) == null ? void 0 : r.call(i, a)) || u.id && ((l = a.closest) == null ? void 0 : l.call(a, `#${CSS.escape(u.id)}`)));
    };
    u._votvNpcBlur = (a) => {
      var h;
      const i = a.target;
  ...
  async _rollWeapon(s) {
    ...
    const m = p && p.name || n.name || "Fegyver", o = Number(n.bonus || 0) || 0, c = ((O = p == null ? void 0 : p.system) == null ? void 0 : O.type) || "kinetic", y = (((C = p == null ? void 0 : p.system) == null ? void 0 : C.skillKey) ?? "").trim(), a = y && f[y] !== void 0 ? y : c === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, r = o + i, d = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, h = new Roll(d);
  ...
  async _onDropItem(s, e) {
    var c, y, a, i, r, l, d, h, g, v, k, w, T, _, O, C, z, K, U;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((a = e.system) == null ? void 0 : a.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${m}
...
ee(ge, "PARTS", foundry.utils.mergeObject(
  ...
  j(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ls = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ns = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.window) ?? {}, {
      resizable: !0,
      contentClasses: [
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (m) => {
      ...
      var y, a, i;
      m.preventDefault();
      const o = (a = (y = m.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : a.itemId;
      if (!o) return;
      ...
      var a;
      const o = m.currentTarget, c = (a = o == null ? void 0 : o.dataset) == null ? void 0 : a.itemId;
      if (!c) return;
      ...
      var y, a, i, r;
      m.preventDefault();
      const o = (((a = (y = m.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : a.itemId) ?? ((r = (i = m.currentTarget) == null ? void 0 : i.getAttribute) == null ? void 0 : r.call(i, "data-item-id")) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (m) => {
      ...
      var a, i, r, l;
      const o = (i = (a = m.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : i.itemId, c = n._draggingUnitId;
      if (!c || !o || c === o) return;
      m.preventDefault();
      ...
      const a = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", r = this.actor.items.contents.filter((T) => T.type === a).sort((T, _) => {
        ...
        return O - C;
      }).map((T) => T.id), l = r.indexOf(c), d = r.indexOf(o);
      if (l === -1 || d === -1) return;
      r.splice(l, 1), r.splice(d, 0, c);
      const h = r.map((T, _) => ({
        _id: T,
        sort: (_ + 1) * 10
      }));
      ...
      var a, i, r, l, d, h, g, v, k, w;
      m.preventDefault();
      const o = (l = (r = (i = (a = m.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : r.dataset) == null ? void 0 : l.abilityRef, c = (v = (g = (h = (d = m.currentTarget) == null ? void 0 : d.closest) == null ? void 0 : h.call(d, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (o)
        try {
          y = await fromUuid(o);
      ...
      var i, r, l, d;
      m.preventDefault();
      const o = (r = (i = m.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : r.call(i, ".jarmu-unit-ability-pill"), c = (l = o == null ? void 0 : o.dataset) == null ? void 0 : l.abilityRef, y = (d = o == null ? void 0 : o.dataset) == null ? void 0 : d.abilityId, a = c || y;
    ...
    this._votvJarmuBlur = (m) => {
      ...
      const a = (o.value ?? "").trim(), i = a === "" ? 0 : Number(a), r = (d = o.closest) == null ? void 0 : d.call(o, ".jarmu-unit-row");
      if (r) {
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${m}
...
const it = class it extends xt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var O, C, z, K, U, M, W;
      const o = ((O = e.querySelector) == null ? void 0 : O.call(e, "form")) ?? e, c = (C = o.querySelector) == null ? void 0 : C.call(o, 'select[name="system.identity.assignment"]'), y = (z = o.querySelector) == null ? void 0 : z.call(o, 'select[name="system.identity.subAssignment"]'), a = (K = o.querySelector) == null ? void 0 : K.call(o, "input.bazis-threat-total"), i = (U = o.querySelector) == null ? void 0 : U.call(o, 'input[name="system.combat.threatBonus"]');
      if (!c || !a || !i) return;
      const r = c.value ?? "", l = (y == null ? void 0 : y.value) ?? "", d = t[r] ?? 0, h = n[l] ?? 0, g = (((W = (M = this.actor) == null ? void 0 : M.items) == null ? void 0 : W.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ds(this.actor), _ = d + h + k + w + T;
      a.value = _;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, p = f.assignment ?? "", m = f.subAssignment ?? "", o = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = o[p] ?? 0, i = c[m] ?? 0, r = e.sizeForSelect ?? "Kicsi", l = y[r] ?? 0, d = Number(u.threatBonus ?? 0) || 0, h = Ds(this.actor), g = a + i + l + d + h;
      e.system = foundry.utils.mergeObject(
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (u) => {
      var o, c, y, a, i, r, l;
      if (!e.isEditable || !((c = (o = u.target) == null ? void 0 : o.closest) != null && c.call(o, ".profile")) && ((a = (y = u.target) == null ? void 0 : y.getAttribute) == null ? void 0 : a.call(y, "data-edit")) !== "img") return;
      u.preventDefault(), u.stopPropagation();
      const p = ((l = (r = (i = foundry.applications) == null ? void 0 : i.apps) == null ? void 0 : r.FilePicker) == null ? void 0 : l.implementation) ?? globalThis.FilePicker;
      new p({
        type: "image",
...
const Ie = class Ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      !l && r && (l = ((k = game.items) == null ? void 0 : k.get(r)) ?? null), (w = l == null ? void 0 : l.sheet) == null || w.render(!0);
    }), n.on("click", ".karakter-ability-chat", async (a) => {
      var d, h, g, v;
      a.preventDefault();
      const i = (h = (d = a.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemRef, r = (v = (g = a.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.itemId, l = i || r;
      l && await this._postAbilityToChat(l);
      ...
      if (!i) return;
      const r = this.document.system ?? {}, l = Array.isArray((k = r.abilities) == null ? void 0 : k.items) ? r.abilities.items.slice() : [], d = l.indexOf(i), h = d >= 0 ? [...l.slice(0, d), ...l.slice(d + 1)] : l;
    ...
    const u = (a) => {
      ...
      var i, r, l;
      return a && (((r = (i = e.element) == null ? void 0 : i.contains) == null ? void 0 : r.call(i, a)) || e.id && ((l = a.closest) == null ? void 0 : l.call(a, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (a) => {
      var r, l, d;
      const i = ((r = a.target) == null ? void 0 : r.form) ?? ((d = (l = a.target) == null ? void 0 : l.closest) == null ? void 0 : d.call(l, "form"));
      p(i) && u(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
  ...
  async _prepareContext(s) {
    ...
    const p = (await Promise.all(
      ...
      var i, r;
      const c = (((i = m.system) == null ? void 0 : i.kind) ?? "passive").toString(), y = Number(((r = m.system) == null ? void 0 : r.kp) ?? 0) || 0, a = c === "species";
      return {
        id: m.id,
        ref: o,
        name: m.name,
...
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".karakter-ability-open", async (c) => {
      var r, l, d, h, g, v;
      c.preventDefault();
      const y = (l = (r = c.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : l.itemRef, a = (h = (d = c.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemId;
      let i = null;
      if (y)
        try {
          i = await fromUuid(y);
      ...
      var r, l, d, h;
      c.preventDefault();
      const y = (l = (r = c.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : l.itemRef, a = (h = (d = c.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemId, i = y || a;
      i && await this._postAbilityToChat(i);
      ...
      if (!y) return;
      const a = this.document.system ?? {}, i = Array.isArray((g = a.abilities) == null ? void 0 : g.items) ? a.abilities.items.slice() : [], r = i.indexOf(y), l = r >= 0 ? [...i.slice(0, r), ...i.slice(r + 1)] : i;
    ...
    if (f && (f.addEventListener("dragover", (c) => {
      ...
      try {
        ...
        if (!(this.element && r.includes(this.element) || this.id && ((a = (y = c.target) == null ? void 0 : y.closest) == null ? void 0 : a.call(y, `#${CSS.escape(this.id)}`)))) return;
        let d = null;
        try {
    ...
    e._votvChange = (c) => {
      var a, i, r;
      const y = ((a = c.target) == null ? void 0 : a.form) ?? ((r = (i = c.target) == null ? void 0 : i.closest) == null ? void 0 : r.call(i, "form"));
      p(y) && u(y);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
...
Hooks.once("init", () => {
  ...
  Hooks.on("preCreateActor", (o, c, y) => {
    ...
    const o = s, c = (((y = game.actors) == null ? void 0 : y.contents) ?? []).filter(
      (a) => a.type === "Bazis" && (a.img ?? "").toString().trim() !== "" && (a.img ?? "").toString().trim() !== o
    );
    c.length && c.forEach((a) => a.update({ img: o }).catch(() => {
    }));
  }), Hooks.on("updateActor", (o, c, y, a) => {
    if ((o == null ? void 0 : o.type) !== "Karakter" || !(o != null && o.id)) return;
    const i = o.id;
    setTimeout(() => {
      var h, g, v, k;
      const r = (h = game.actors) == null ? void 0 : h.get(i);
      if (!r || r.type !== "Karakter") return;
      const l = Ot.getTotalSpeedRaw(r), d = (g = r.effects) == null ? void 0 : g.find((w) => w.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (l <= 0 && !d) {
        const w = ((k = (v = CONFIG.statusEffects) == null ? void 0 : v.find((T) => T.id === "immobilized")) == null ? void 0 : k.img) ?? "";
        r.createEmbeddedDocuments("ActiveEffect", [{
          name: "Mozgásképtelen",
          icon: w,
  ...
  Hooks.on("updateActor", (o, c, y, a) => {
    ...
    const r = document.activeElement, l = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA" || r.isContentEditable), d = [], h = (W = game.actors) == null ? void 0 : W.get(i);
  ...
  }), Hooks.on("updateItem", (o, c, y, a) => {
    var d, h, g;
    const i = o == null ? void 0 : o.parent;
    if (!i || i.documentName !== "Actor" || i.type !== "Karakter" || o.type !== "Fegyver") return;
    const r = ((d = i.system) == null ? void 0 : d.weapons) ?? {}, l = {};
    for (const [v, k] of Object.entries(r)) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = u.targetName || "", r = u.hitLocationName || "", l = ((o == null ? void 0 : o.name) ?? (u.slotKey ? ((D = (((Te = m.system) == null ? void 0 : Te.weapons) ?? {})[u.slotKey]) == null ? void 0 : D.name) ?? "" : "")) || "Fegyver";
    ...
    for (const a of t)
      try {
        const i = a.prototypeToken, r = ((p = i == null ? void 0 : i.bar1) == null ? void 0 : p.attribute) ?? "", l = ((m = i == null ? void 0 : i.bar2) == null ? void 0 : m.attribute) ?? "";
        (r || l) && await a.update({
  ...
  if (c) {
    ...
    if (u && p && (p.actorId || (i = I.speaker) != null && i.actor)) {
      ...
      if (p.isHit && !c.querySelector(".votv-weapon-damage-chat")) {
        ...
        v.textContent = k != null && w ? `Sebzés (Találati Hely ${k} - ${w})` : "Sebzés", v.dataset.actorId = String(p.actorId ?? ((r = I.speaker) == null ? void 0 : r.actor) ?? ""), v.dataset.itemId = String(p.itemId ?? ""), v.dataset.slotKey = String(p.slotKey ?? ""), v.dataset.targetName = String(p.targetName ?? ""), v.dataset.hitLocationName = String(p.hitLocationName ?? ""), v.dataset.messageId = String(I.id ?? ""), d.appendChild(v);
      }
    }
    if (!u && m && o) {
...
//# sourceMappingURL=vacuum-of-the-void-D_w700bA.mjs.map
