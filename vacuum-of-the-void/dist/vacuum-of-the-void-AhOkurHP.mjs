...
var St = Reflect.get;
var Tt = (C, i, e) => i in C ? kt(C, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : C[i] = e;
var K = (C, i, e) => Tt(C, typeof i != "symbol" ? i + "" : i, e);
var E = (C, i, e) => St(It(C), e, i);
...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((s = i.querySelector) == null ? void 0 : s.call(i, "form.votv.karakter-sheet")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, "form.votv")) ?? null, t = ((r = i.querySelector) == null ? void 0 : r.call(i, ".votv-scroll")) ?? ((l = i.querySelector) == null ? void 0 : l.call(i, ".window-content")) ?? null;
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, a = ((d = (u = s.hitLocations) == null ? void 0 : u.legs) == null ? void 0 : d.value) ?? 0, r = ((m = s.currentHealth) == null ? void 0 : m.legs) ?? 0, l = P._healthStatusFromRatio(r, a), p = Number(((S = (g = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : g.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let y;
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((r = this.actor.system) == null ? void 0 : r.resources) ?? {}, s = ((p = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : p.value) ?? 0, a = ((y = t.currentHealth) == null ? void 0 : y[e]) ?? 0;
    return P._healthStatusFromRatio(a, s);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const s = ((l = i == null ? void 0 : i.system) == null ? void 0 : l.resources) ?? {}, a = ((y = (p = s.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : y.value) ?? 0, r = ((h = s.currentHealth) == null ? void 0 : h[t]) ?? 0;
  ...
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const s = this.actor.system.resources ?? {}, a = s.hitLocations ?? {}, r = s.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    ...
    const g = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (g.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((o) => S.includes(o)) : [], A = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, D = A && typeof A == "object" && !Array.isArray(A) ? A : {}, v = (((Re = D.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), N = (((Ue = D.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = D.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((o) => o.type !== "Kepesseg" && o.type !== "ability").slice().sort((o, I) => {
      ...
      for (let ie = 0; ie < F.length; ie++) {
        ...
        if ((((X = g[ae]) == null ? void 0 : X.itemId) ?? "") === o.id) {
          T = ie + 1, _ = ((ee = g[ae]) == null ? void 0 : ee.bonus) ?? "", j = ae;
          break;
        }
      }
      let R = null;
    ...
    e.weaponsTable = ue.map((o) => {
      ...
      let k = null, T = {};
      for (const pe of F)
        if ((((ie = g[pe]) == null ? void 0 : ie.itemId) ?? "").trim() === I) {
          k = pe, T = g[pe] ?? {};
          break;
        }
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-xDu0KelZ.mjs");
      d(this.actor, u);
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const c = n.currentTarget, u = c.dataset.skill, d = ((f = c.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-xDu0KelZ.mjs");
      m(this.actor, u, d);
  ...
  _onWeaponSlotDragOver(i, e) {
    ...
    (s == null ? void 0 : s.type) === "Item" && (i.preventDefault(), (l = i.currentTarget) == null || l.classList.add("karakter-weapon-slot-drag-over"));
  }
  ...
  async _postItemToChat(i) {
    ...
    let s;
    e.type === "MikroChip" ? s = ((((p = e.system) == null ? void 0 : p.abilityType) ?? "passive") === "active" ? "Aktív" : "Passzív") + " Mikro-Chip" : s = "Egyéb Információ";
    const a = t ? `<p>${t}</p>` : "", r = `
      <h2>${e.name}</h2>
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((h = e.system) == null ? void 0 : h.kind) ?? "passive", s = Number(((w = e.system) == null ? void 0 : w.kp) ?? 0) || 0, a = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", p = a ? `<p>${a}</p>` : "", y = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    let a = s.id;
    if (((l = s.parent) == null ? void 0 : l.id) !== this.actor.id) {
  ...
  _onMicrochipSlotDragOver(i, e) {
    ...
    (s == null ? void 0 : s.type) === "Item" && (i.preventDefault(), (l = i.currentTarget) == null || l.classList.add("karakter-microchip-slot-drag-over"));
  }
  ...
  async _rollWeapon(i) {
    var g;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, s = this.actor.system.skills ?? {}, a = this.actor.items.filter((S) => S.type === "Fegyver");
    let r = null;
    t.itemId && (r = a.find((S) => S.id === t.itemId) ?? null);
    const l = r && r.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, h = (((g = r == null ? void 0 : r.system) == null ? void 0 : g.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", w = Number(s[h] || 0) || 0, n = p + w, u = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, d = new Roll(u);
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    let s = ((y = (p = t.items).get) == null ? void 0 : y.call(p, i)) ?? ((w = (h = t.items.contents) == null ? void 0 : h.find) == null ? void 0 : w.call(h, (g) => g.id === i));
...
K(P, "PARTS", foundry.utils.mergeObject(E(P, P, "PARTS") ?? {}, {
  ...
  window: foundry.utils.mergeObject(((it = E(P, P, "DEFAULT_OPTIONS")) == null ? void 0 : it.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((at = (st = E(P, P, "DEFAULT_OPTIONS")) == null ? void 0 : st.window) == null ? void 0 : at.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
Hooks.on("ready", () => {
  ...
  if (document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (y = (p = e.target) == null ? void 0 : p.closest) == null ? void 0 : y.call(p, "[data-document-id]"), s = (h = t == null ? void 0 : t.getAttribute) == null ? void 0 : h.call(t, "data-document-id");
      if (!s) return;
      const a = s.includes(".") ? s.split(".").pop() : s;
      a && ((w = game.actors) != null && w.get(a)) && (game.votv._dragSourceActorId = a);
    },
    !0
  ), (C = game.user) != null && C.isGM && ((i = game.scenes) == null ? void 0 : i.size) === 0)
    try {
      const e = game.scenes.createDocument ?? game.scenes.create;
      if (typeof e != "function") {
        console.warn("Vacuum of the Void | Default scene: no create/createDocument on game.scenes");
        return;
      }
      const t = e.call(game.scenes, {
        ...
        a != null && a.activate && typeof a.activate == "function" && a.activate();
      };
      t && typeof t.then == "function" ? t.then(s).catch((a) => console.warn("Vacuum of the Void | Default scene creation failed:", a)) : t && s(t), console.log("Vacuum of the Void | Default scene create requested.");
    } catch (e) {
...
Hooks.on("preCreateToken", (C, i, e) => {
  ...
  const a = s ? (l = game.actors) == null ? void 0 : l.get(s) : null;
...
Hooks.on("renderChatMessageHTML", (C, i, e) => {
  ...
  if (!t) return;
  const s = (l = i == null ? void 0 : i.querySelector) == null ? void 0 : l.call(i, ".dice-roll");
  s && s.classList.add(`votv-${t}`);
});
export {
  ge as V
};
//# sourceMappingURL=vacuum-of-the-void-AhOkurHP.mjs.map
