...
const { BooleanField: Ct, NumberField: Mt, StringField: se } = foundry.data.fields;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (b.slotOrder ?? "").trim(), D = q ? q.split(/\s*,\s*/).filter((d) => S.includes(d)) : [], C = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), E = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), A = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, I) => {
      ...
      for (let ie = 0; ie < D.length; ie++) {
        const re = D[ie];
        if ((((J = b[re]) == null ? void 0 : J.itemId) ?? "") === d.id) {
          T = ie + 1, L = ((ee = b[re]) == null ? void 0 : ee.bonus) ?? "", M = re;
          break;
        }
      }
      let K = null;
      w && (k === d.id ? K = "slot1" : E === d.id ? K = "slot2" : A === d.id && (K = "slot3"));
      const ne = I && ((te = d.system) != null && te.damage) ? d.system.damage : "", H = I && typeof ((X = d.system) == null ? void 0 : X.range) == "string" ? (d.system.range || "").trim() : "", V = M ? Number((Z = b[M]) == null ? void 0 : Z.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
    ...
    e.weaponSlots = pt.map((d, I) => {
      const w = b[d] ?? {}, T = (w.itemId ?? "").trim(), L = Se.find((M) => M.id === T);
      return {
        slotKey: d,
        itemId: T,
        slotNum: I + 1,
    ...
    e.weaponsTable = ue.map((d) => {
      ...
      const L = !!w, M = ((re = d.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = d.system) == null ? void 0 : Je.equipped) !== null ? !!d.system.equipped : L, K = (d == null ? void 0 : d.system) ?? {}, ne = typeof K.range == "string" ? (K.range || "").trim() : "", H = K.type ?? "", V = (ft[H] ?? H) || "—", J = K.size ?? "", ee = (yt[J] ?? J) || "", te = [V, ee].filter(Boolean).join(", ") || V || "—", X = H === "projectile" || J === "thrown", Z = K.quantity, ae = Z != null ? String(Z).trim() : "1";
      return {
        slotKey: w ?? "",
        itemId: I,
    ...
    e.microchipItemsSlot1 = oe.filter((d) => !me(1).includes(d.id)), e.microchipItemsSlot2 = oe.filter((d) => !me(2).includes(d.id)), e.microchipItemsSlot3 = oe.filter((d) => !me(3).includes(d.id)), e.microchipSlots = qe.map((d) => {
      ...
      const I = `slot${d}`, w = O[I] ?? {}, T = (w.itemId ?? "").trim(), L = oe.find((M) => M.id === T);
      ...
      const T = !!w, L = ((ee = d == null ? void 0 : d.system) == null ? void 0 : ee.abilityType) ?? "", M = L === "active" ? "Aktív" : L === "passive" ? "Passzív" : L || "—", K = L === "active", ne = Number((te = d == null ? void 0 : d.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(d.system.replaceCost) : 0, H = (((X = d == null ? void 0 : d.system) == null ? void 0 : X.description) ?? "").trim(), V = H ? H.length > 60 ? H.slice(0, 57) + "…" : H : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const Oe = this.actor.system.abilities ?? {}, vt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((d) => {
      ...
      const I = Oe[d] ?? {}, w = (I.itemId ?? "").trim(), T = w ? De.get(w) : null, L = (T == null ? void 0 : T.description) ?? "", M = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: w,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-y1U_IdcK.mjs");
      l(this.actor, o);
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, o = u.dataset.skill, l = ((g = u.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: c } = await import("./roll-sheet-y1U_IdcK.mjs");
      c(this.actor, o, l);
...
R(G, "PARTS", foundry.utils.mergeObject(N(G, G, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((at = N(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : at.form) ?? {}, { submitOnChange: !1 })
}));
let be = G;
var ot;
...
R(z, "PARTS", foundry.utils.mergeObject(N(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ot = N(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : ot.form) ?? {}, { submitOnChange: !1 })
}));
let ve = z;
var lt;
...
R(W, "PARTS", foundry.utils.mergeObject(N(W, W, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((lt = N(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : lt.form) ?? {}, { submitOnChange: !0 })
}));
let ke = W;
var ct;
...
R(Q, "PARTS", foundry.utils.mergeObject(N(Q, Q, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ut = N(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : ut.form) ?? {}, { submitOnChange: !1 })
}));
let Ie = Q;
...
//# sourceMappingURL=vacuum-of-the-void-DX7jXIxs.mjs.map
