...
const { SchemaField: hi, StringField: bi, NumberField: vi } = foundry.data.fields, { BooleanField: ei, NumberField: ki, StringField: Ue } = foundry.data.fields;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var ct, lt, ut, dt, mt, pt, ft, yt, gt, We, ht, bt, Je, I, A, P, G, ke, ne, Ce, Te, we, $e, Ye, Xe, Ct, qt, Nt, Lt, vt, nt, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Ye = this.actor.system.gear) == null ? void 0 : Ye.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Xe = R.slot1) == null ? void 0 : Xe.itemId) ?? "").trim(), Z = (((Ct = R.slot2) == null ? void 0 : Ct.itemId) ?? "").trim(), J = (((qt = R.slot3) == null ? void 0 : qt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      ...
      for (let at = 0; at < K.length; at++) {
        ...
        if ((((xe = O[wt]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          E = at + 1, z = ((Ze = O[wt]) == null ? void 0 : Ze.bonus) ?? "", de = wt;
          break;
        }
      }
      let re = null;
    ...
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, E = (N.itemId ?? "").trim(), z = ce.find((De) => De.id === E), de = W.find((De) => De.id === E), re = (de == null ? void 0 : de.system) ?? {}, Qe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: E,
        slotNum: L + 1,
    ...
    e.armorTable = Q.map((b) => {
      var E, z;
      const L = (b == null ? void 0 : b.system) ?? {}, N = ((E = b.system) == null ? void 0 : E.equipped) !== void 0 && ((z = b.system) == null ? void 0 : z.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = oe.map((b) => {
      const L = (b == null ? void 0 : b.system) ?? {}, N = (L.description ?? "").trim(), E = N ? N.length > 60 ? N.slice(0, 57) + "…" : N : "—", z = L.quantity != null ? String(L.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const me = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Re = (b) => {
      var N, E, z;
      const L = [];
      return b !== 1 && L.push((((N = R.slot1) == null ? void 0 : N.itemId) ?? "").trim()), b !== 2 && L.push((((E = R.slot2) == null ? void 0 : E.itemId) ?? "").trim()), b !== 3 && L.push((((z = R.slot3) == null ? void 0 : z.itemId) ?? "").trim()), L.filter(Boolean);
    };
    e.microchipItemsSlot1 = ie.filter((b) => !Re(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Re(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Re(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      const L = R[b] ?? {}, N = (L.itemId ?? "").trim(), E = me.find((z) => z.id === N);
      return {
        slotKey: b,
        itemId: N,
      ...
      const L = `slot${b}`, N = R[L] ?? {}, E = (N.itemId ?? "").trim(), z = ie.find((de) => de.id === E);
      e[`microchip${b}ItemId`] = E, e[`microchip${b}DisplayName`] = (z == null ? void 0 : z.name) || N.name || ge, e[`microchip${b}Img`] = (z == null ? void 0 : z.img) || "";
    ...
    const tt = this.actor.system.abilities ?? {}, Tt = (((es = this.actor.items) == null ? void 0 : es.contents) ?? []).map((b) => {
      ...
      const L = tt[b] ?? {}, N = (L.itemId ?? "").trim(), E = N ? Pe.get(N) : null, z = (E == null ? void 0 : E.description) ?? "", de = (E == null ? void 0 : E.kp) ?? 0;
      return {
        itemId: N,
    ...
    if (typeof be == "number" && be >= 0 && je.length > 0) {
      ...
      let N = null;
      be <= b.max ? N = b : be >= L.min ? N = L : N = je.find((E) => be >= E.min && be <= E.max), N && (ot = N.kp);
    }
    e.kpDots = he.map((b, L) => {
      const N = L + 1, E = !!Number(te[b]), z = N <= ot;
      return { index: N, used: E, usable: z };
    });
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-D-9_zRNg.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D-9_zRNg.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-D-9_zRNg.mjs");
      h(this.actor, r, u);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = o.map((I) => {
      ...
      let P = null, G = {};
      for (const nt of v)
        if ((((vt = m[nt]) == null ? void 0 : vt.itemId) ?? "").trim() === A) {
          P = nt, G = m[nt] ?? {};
          break;
        }
    ...
    const D = ((pt = e.system) == null ? void 0 : pt.resources) ?? {}, x = (yt = (ft = e.system) == null ? void 0 : ft.combat) == null ? void 0 : yt.initiativeResult, V = typeof x == "number" ? x : -1, Q = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : Q).slice().sort((I, A) => I.min - A.min), ge = 3;
    ...
    const He = ie.length > 0 ? ie[ie.length - 1] : null, tt = Math.min(10, He ? He.kp : 6), Pe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, tt)).map((I, A) => {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D-9_zRNg.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D-9_zRNg.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-D-9_zRNg.mjs");
      u(this.actor, o, r);
...
se(Fe, "PARTS", foundry.utils.mergeObject(U(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((As = U(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !0 })
}));
let Ht = Fe;
var Ps;
const Ee = class Ee extends foundry.applications.api.HandlebarsApplicationMixin(
...
se(Ee, "PARTS", foundry.utils.mergeObject(U(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ps = U(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 })
}));
let Bt = Ee;
var $s;
...
//# sourceMappingURL=vacuum-of-the-void-CJ2fl2kg.mjs.map
