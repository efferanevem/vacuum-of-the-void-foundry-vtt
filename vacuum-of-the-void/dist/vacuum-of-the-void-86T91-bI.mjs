...
var At = Reflect.get;
var Ft = (F, s, e) => s in F ? Pt(F, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : F[s] = e;
var z = (F, s, e) => Ft(F, typeof s != "symbol" ? s + "" : s, e);
var R = (F, s, e) => At(Et(F), e, s);
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    }), A = new Map(k.map((p) => [p.id, p])), N = "— Nincs képesség —", K = (p) => {
      const D = Ce[p] ?? {}, T = (D.itemId ?? "").trim(), C = T ? A.get(T) : null, x = (C == null ? void 0 : C.description) ?? "", Y = (C == null ? void 0 : C.kp) ?? 0;
      return {
        itemId: T,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-DTzraODO.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((y = r.textContent) == null ? void 0 : y.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-DTzraODO.mjs");
      l(this.actor, a, n);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, o = ((Fe = t == null ? void 0 : t.items) == null ? void 0 : Fe.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), f = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : c, r = c.filter((k) => !i.includes(k)), a = [...i, ...r], n = a.filter((k) => {
      var N;
      const A = (((N = d[k]) == null ? void 0 : N.itemId) ?? "").trim();
      return A && m.some((K) => K.id === A);
    });
    e.weaponSlots = n.map((k) => {
      const A = d[k] ?? {}, N = (A.itemId ?? "").trim(), K = f.find((le) => le.id === N);
      return {
        slotKey: k,
        itemId: N,
    ...
    e.armorTable = b.map((k) => {
      var K;
      const A = (k == null ? void 0 : k.system) ?? {}, N = ((K = k.system) == null ? void 0 : K.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    e.itemsTable = L.map((k) => {
      const A = (k == null ? void 0 : k.system) ?? {}, N = (A.description ?? "").trim(), K = N ? N.length > 60 ? N.slice(0, 57) + "…" : N : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-DTzraODO.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, g, m, f) => {
    ...
    const b = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, v = b && Date.now() - b.at < F ? b.appId : null;
    setTimeout(() => {
      for (const S of a)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    !0
  ), (F = game.user) != null && F.isGM && ((s = game.scenes) == null ? void 0 : s.size) === 0 && (async () => {
    var e, t;
    try {
...
Hooks.on("preCreateToken", (F, s, e) => {
  var c, u;
  const t = (c = game.votv) == null ? void 0 : c._dragSourceActorId, o = t ?? F.actorId ?? null;
...
Hooks.on("renderCombatTracker", (F, s, e) => {
  s.querySelectorAll("[data-action='rollAll'], [data-action='rollNPCs'], [data-action='rollInitiative'], .combat-control[title*='Roll'], .combat-control[title*='roll']").forEach((o) => {
    o.style.display = "none";
  });
});
Hooks.on("renderTokenHUD", (F, s, e) => {
  var d;
  const t = F == null ? void 0 : F.object, o = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (F, s, e) => {
  var u, g;
  const t = ((u = F.flags) == null ? void 0 : u["vacuum-of-the-void"]) ?? {}, o = t.resultType, d = t.critLabel;
  if (!o && !d) return;
...
//# sourceMappingURL=vacuum-of-the-void-86T91-bI.mjs.map
