...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((l = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : l.resources) ?? {}, m = ((o = (c = s.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, r = ((u = s.currentHealth) == null ? void 0 : u.legs) ?? 0, a = x._healthStatusFromRatio(r, m), f = Number(((k = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let d;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CaYH4D4c.mjs");
      o(this.actor, c);
    ...
    m && s({ currentTarget: m }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const l = n.currentTarget, c = l.dataset.skill, o = ((g = l.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-CaYH4D4c.mjs");
      u(this.actor, c, o);
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    if (((y = m.parent) == null ? void 0 : y.id) !== this.actor.id) {
      const l = foundry.utils.mergeObject(m.toObject(), { system: { ...m.toObject().system ?? {}, equipped: !1 } });
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    if (!m && e && (m = (((((l = t.system) == null ? void 0 : l.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !m) {
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    s._votvNpcBlur = (f) => {
      ...
      n && (h.contains(n) || s.id && ((l = n.closest) != null && l.call(n, `#${CSS.escape(s.id)}`))) || m(h);
  ...
  async _onDropItem(i, e) {
    ...
    if (m.type === "Kepesseg" || m.type === "ability") {
      ...
      const b = (((l = m.system) == null ? void 0 : l.kind) ?? "passive").toString(), k = ((c = r.system) == null ? void 0 : c.abilities) ?? {};
      if (b === "species") {
        await r.update({ "system.abilities.faji.itemId": g, "system.abilities.faji.name": m.name });
        return;
      }
      if (b === "background") {
        await r.update({ "system.abilities.hatter.itemId": g, "system.abilities.hatter.name": m.name });
        return;
      }
      const I = b === "active" ? "active" : "passive", D = Array.isArray((o = k[I]) == null ? void 0 : o.items) ? k[I].items.slice() : Array.isArray(k[I]) ? k[I].slice() : [];
      D.includes(g) || D.push(g), await r.update({ [`system.abilities.${I}.items`]: D });
      return;
    }
    if (((u = m.parent) == null ? void 0 : u.id) === r.id) return;
    const a = m.toObject();
...
//# sourceMappingURL=vacuum-of-the-void-CZZO4oBr.mjs.map
