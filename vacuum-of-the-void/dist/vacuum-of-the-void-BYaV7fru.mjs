...
var Vt = Reflect.get;
var es = (_, s, e) => s in _ ? Xt(_, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : _[s] = e;
var W = (_, s, e) => es(_, typeof s != "symbol" ? s + "" : s, e);
var j = (_, s, e) => Vt(Zt(_), e, s);
const { HTMLField: ts, NumberField: C, SchemaField: K, StringField: I, BooleanField: Z, ArrayField: He } = foundry.data.fields;
class Wt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new K({
        biography: new ts({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: Be, SchemaField: ss } = foundry.data.fields;
class is extends Wt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ns, NumberField: gs, StringField: ve } = foundry.data.fields;
class Ct extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Felszerelve a karakteren (karakter lap checkbox; a fegyver lapon nem jelenik meg). */
      equipped: new ns({ required: !1, initial: !1 }),
      type: new ve({
        required: !0,
        blank: !1,
...
const { BooleanField: rs, StringField: Ue } = foundry.data.fields;
...
const { NumberField: Ge, StringField: qt } = foundry.data.fields;
...
const { NumberField: ls, StringField: Lt } = foundry.data.fields;
...
class cs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      quantity: new Nt({ required: !1, blank: !0, initial: "1" })
    };
  }
}
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var je, xe, Ae, st, it, nt, rt, at, ot, lt, ct, ut, dt, mt, pt, ft, yt, gt, ht, bt, kt, vt, wt, It, St, Tt;
    ...
    e.weaponsTable = te.map((g) => {
      ...
      let D = null, L = {};
      for (const ze of E)
        if ((((_t = S[ze]) == null ? void 0 : _t.itemId) ?? "").trim() === O) {
          D = ze, L = S[ze] ?? {};
          break;
        }
      const M = !!D, X = ((Dt = g.system) == null ? void 0 : Dt.equipped) !== void 0 && ((Ot = g.system) == null ? void 0 : Ot.equipped) !== null ? !!g.system.equipped : M, Q = (g == null ? void 0 : g.system) ?? {}, Me = typeof Q.range == "string" ? (Q.range || "").trim() : "", ne = Q.type ?? "", Oe = (we[ne] ?? ne) || "—", fe = Q.size ?? "", Ce = (Ie[fe] ?? fe) || "", qe = [Oe, Ce].filter(Boolean).join(", ") || Oe || "—", be = ne === "projectile" || fe === "thrown", ke = Q.quantity, Re = ke != null ? String(ke).trim() : "1", Ee = String(L.bonus ?? "").trim(), Ke = String(Q.bonus ?? "").trim(), Qt = Ee || Ke || "0";
      return {
        slotKey: D ?? "",
        itemId: O,
    ...
    e.armorTable = Se.map((g) => {
      ...
      return {
        ...
        level: ms((O.level ?? "").toString().trim()),
    ...
    }), e.showInitiativeResult = typeof Ne == "number", e.initiativeResult = e.showInitiativeResult ? Ne : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-X5HLOJKf.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: l } = await import("./roll-sheet-X5HLOJKf.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, r = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-X5HLOJKf.mjs");
      p(this.actor, o, r);
...
W(B, "PARTS", foundry.utils.mergeObject(
  ...
  j(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((At = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : At.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Et = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Et.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...(($t = (Ft = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Ft.window) == null ? void 0 : $t.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: ps((x.level ?? "").toString().trim()),
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-X5HLOJKf.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-X5HLOJKf.mjs");
      r(this.actor, l, o);
...
W(ee, "PARTS", foundry.utils.mergeObject(
  ...
  j(ee, ee, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((xt = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : xt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Mt = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Mt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Kt = (Rt = j(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Rt.window) == null ? void 0 : Kt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const re = class re extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = fs, e;
  }
};
W(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((jt = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : jt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = re;
var Ht;
...
W(ae, "PARTS", foundry.utils.mergeObject(j(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ht = j(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ht.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ae;
var Ut;
...
W(oe, "PARTS", foundry.utils.mergeObject(j(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ut = j(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Ut.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = oe;
var zt;
...
W(le, "PARTS", foundry.utils.mergeObject(j(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((zt = j(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : zt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = le;
var Bt;
...
W(ce, "PARTS", foundry.utils.mergeObject(j(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Bt = j(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Bt.form) ?? {}, { submitOnChange: !1 })
}));
let et = ce;
var Gt;
...
W(ue, "PARTS", foundry.utils.mergeObject(j(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Gt = j(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : Gt.form) ?? {}, { submitOnChange: !1 })
}));
let tt = ue;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = is, CONFIG.Actor.dataModels.Npc = Wt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Ct, CONFIG.Item.dataModels.weapon = Ct, CONFIG.Item.dataModels.Pancel = as, CONFIG.Item.dataModels.MikroChip = os, CONFIG.Item.dataModels.Kepesseg = Pt, CONFIG.Item.dataModels.ability = Pt, CONFIG.Item.dataModels.Targy = cs, CONFIG.Item.dataModels.Egyeb = ds, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (c, f, m, y) => {
    ...
    if (c.type === "Npc" && ((w = f == null ? void 0 : f.system) != null && w.identity) && "size" in f.system.identity) {
      const N = Jt((q = (S = c.system) == null ? void 0 : S.identity) == null ? void 0 : q.size);
      c.update({
...
Hooks.on("preCreateToken", (_, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const y = Jt((m = (f = d.system) == null ? void 0 : f.identity) == null ? void 0 : m.size);
      _.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-BYaV7fru.mjs.map
