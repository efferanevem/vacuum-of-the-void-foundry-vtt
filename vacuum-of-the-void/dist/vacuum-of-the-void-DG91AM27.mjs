...
const { HTMLField: hs, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: st } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ye, Je, Qe, Xe, k, A, x, j, oe, X, Fe, he, Ie, be, qe, Le, dt, mt, pt, ft, Ze, $e, Lt, Nt, At, Pt, Et, Ft, $t, xt, Rt;
    ...
    for (const y of l) {
      const _ = ((Xe = d[y]) == null ? void 0 : Xe.value) ?? 0, D = r[y] ?? 0;
    ...
    const p = ((oe = e.system) == null ? void 0 : oe.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), E = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (X = this.actor.system.gear) == null ? void 0 : X.microchips, F = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((Fe = F.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), H = (((he = F.slot2) == null ? void 0 : he.itemId) ?? "").trim(), B = (((Ie = F.slot3) == null ? void 0 : Ie.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      const D = typeof y.sort == "number" ? y.sort : 0, q = typeof _.sort == "number" ? _.sort : 0;
      return D - q;
    }).map((y) => {
      var ke, Ae, Pe, Se, Te, et;
      const _ = y.type === "Fegyver", D = y.type === "MikroChip";
      let q = 0, M = "", ee = null;
      for (let xe = 0; xe < E.length; xe++) {
        const tt = E[xe];
        if ((((ke = T[tt]) == null ? void 0 : ke.itemId) ?? "") === y.id) {
      ...
      const Ve = _ && ((Pe = y.system) != null && Pe.damage) ? y.system.damage : "", ce = _ && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = ee ? Number((Te = T[ee]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    const ve = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ae = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = V.map((y) => {
      ...
      const M = !!D, ee = ((Kt = y.system) == null ? void 0 : Kt.equipped) !== void 0 && ((jt = y.system) == null ? void 0 : jt.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, Ve = typeof Z.range == "string" ? (Z.range || "").trim() : "", ce = Z.type ?? "", Ne = (ve[ce] ?? ce) || "—", ke = Z.size ?? "", Ae = (ae[ke] ?? ke) || "", Pe = [Ne, Ae].filter(Boolean).join(", ") || Ne || "—", Se = ce === "projectile" || ke === "thrown", Te = Z.quantity, et = Te != null ? String(Te).trim() : "1", xe = String(q.bonus ?? "").trim(), tt = String(Z.bonus ?? "").trim(), ms = xe || tt || "0";
      return {
        slotKey: D ?? "",
        itemId: _,
    ...
    const ye = (((qe = this.actor.items) == null ? void 0 : qe.contents) ?? []).filter((y) => y.type === "Pancel");
    e.armorTable = ye.map((y) => {
      var q, M;
    ...
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      ...
      let D = null;
      for (const Te of Ke)
        if ((((ke = F[Te]) == null ? void 0 : ke.itemId) ?? "").trim() === _) {
          D = Te;
          break;
        }
      const q = !!D, M = ((Ae = y == null ? void 0 : y.system) == null ? void 0 : Ae.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Z = M === "active", Ve = Number((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, ce = (((Se = y == null ? void 0 : y.system) == null ? void 0 : Se.description) ?? "").trim(), Ne = ce ? ce.length > 60 ? ce.slice(0, 57) + "…" : ce : "—";
      return {
        itemId: _,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const qt = (((pt = e.weaponsTable) == null ? void 0 : pt.length) ?? 0) > 0 || (((ft = e.armorTable) == null ? void 0 : ft.length) ?? 0) > 0 || (((Ze = e.microchipsTable) == null ? void 0 : Ze.length) ?? 0) > 0 || ((($e = e.itemsTable) == null ? void 0 : $e.length) ?? 0) > 0;
    ...
    const rt = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, at = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (Pt = (At = e.system) == null ? void 0 : At.combat) == null ? void 0 : Pt.initiativeResult, ge = typeof _e == "number" ? _e : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ge = (Ft = (Et = e.system) == null ? void 0 : Et.combat) == null ? void 0 : Ft.initiativeRanges, Ce = Array.isArray(Ge) ? Ge.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : ot).slice().sort((y, _) => y.min - _.min), Oe = Ce.map((y) => y.min), ct = Oe.length ? Math.min(...Oe) : 0, lt = Oe.length ? Math.max(...Oe) : 0;
    ...
    if (typeof ge == "number" && ge >= 0 && we.length > 0) {
      ...
      let D = null;
      ge <= y.max ? D = y : ge >= _.min ? D = _ : D = we.find((q) => ge >= q.min && ge <= q.max), D && (We = D.kp);
    }
    e.kpDots = at.map((y, _) => {
      const D = _ + 1, q = !!Number(rt[y]), M = D <= We;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DEuKRefy.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DEuKRefy.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-DEuKRefy.mjs");
      p(this.actor, o, a);
      ...
      if (!h) return;
      const v = ((P = (L = this.actor.items).get) == null ? void 0 : P.call(L, h)) ?? ((C = (E = this.actor.items.contents) == null ? void 0 : E.find) == null ? void 0 : C.call(E, (N) => N.id === h));
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = p.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = T ? T.split(/\s*,\s*/).filter((C) => L.includes(C)) : [], E = P.filter((C) => {
              var F;
...
const re = class re extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var He, nt, Ue, ze, Be, rt, at, _e, ge, ot, Ge, Ce, gt, we, Oe, ct, lt, We, ut, Ye, Je, Qe, Xe;
    ...
    e.weaponSlots = o.map((k) => {
      const A = d[k] ?? {}, x = (A.itemId ?? "").trim(), j = g.find((oe) => oe.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const $e of c)
        if ((((Ze = d[$e]) == null ? void 0 : Ze.itemId) ?? "").trim() === A) {
          x = $e, j = d[$e] ?? {};
          break;
        }
      const oe = !!x, X = (k == null ? void 0 : k.system) ?? {}, Fe = typeof X.range == "string" ? (X.range || "").trim() : "", he = X.type ?? "", Ie = (a[he] ?? he) || "—", be = X.size ?? "", qe = (p[be] ?? be) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", dt = he === "projectile" || be === "thrown", mt = X.quantity != null ? String(X.quantity).trim() : "1", pt = String(X.bonus ?? j.bonus ?? "").trim() || "0", ft = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: A,
        actorId: t.id,
    ...
    const v = ((at = (rt = t == null ? void 0 : t.system) == null ? void 0 : rt.gear) == null ? void 0 : at.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var he, Ie, be, qe;
      const A = k.id;
      let x = null;
      for (const Le of I)
        if ((((he = v[Le]) == null ? void 0 : he.itemId) ?? "").trim() === A) {
          x = Le;
          break;
        }
      const j = ((Ie = k == null ? void 0 : k.system) == null ? void 0 : Ie.abilityType) ?? "", oe = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", X = (((be = k == null ? void 0 : k.system) == null ? void 0 : be.description) ?? "").trim(), Fe = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: A,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const E = (((_e = e.weaponsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((ge = e.armorTable) == null ? void 0 : ge.length) ?? 0) > 0 || (((ot = e.microchipsTable) == null ? void 0 : ot.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Ce = e.egyebList) == null ? void 0 : Ce.length) ?? 0) > 0;
    e.showEquipmentDropZone = !E;
    const C = ((gt = t == null ? void 0 : t.system) == null ? void 0 : gt.abilities) ?? {}, F = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var A, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const G = t == null ? void 0 : t.id, V = !!((Oe = (we = game.combat) == null ? void 0 : we.combatants) != null && Oe.some(
      (k) => {
        var A;
    ...
    e.showHarcSection = V;
    const R = ((ct = e.system) == null ? void 0 : ct.resources) ?? {}, Y = (We = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : We.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ae = (Ye = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ye.initiativeRanges, ye = Array.isArray(ae) ? ae.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], se = (ye.length > 0 ? ye : ve).slice().sort((k, A) => k.min - A.min), ie = 3;
    let ne = ye.length > 0 ? ye : [];
    ...
    if (typeof J == "number" && J >= 0 && se.length > 0) {
      ...
      let x = null;
      J <= k.max ? x = k : J >= A.min ? x = A : x = se.find((j) => J >= j.min && J <= j.max), x && (Me = x.kp);
    }
    const Ke = se.length > 0 ? se[se.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, A) => {
      const x = A + 1, j = !!Number(R[k]), oe = x <= Me;
      return { index: x, used: j, usable: oe };
    }), it = Math.ceil(Ee.length / 2);
    return e.kpDotsRow1 = Ee.slice(0, it), e.kpDotsRow2 = Ee.slice(it), e.canEditInitiative = !!((Je = game.user) != null && Je.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e.speedUnitForSelect = ((Xe = (Qe = e.system) == null ? void 0 : Qe.combat) == null ? void 0 : Xe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DEuKRefy.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DEuKRefy.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DEuKRefy.mjs");
      a(this.actor, c, o);
      ...
      const o = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, p = (Array.isArray((P = o[i]) == null ? void 0 : P.items) ? o[i].items.slice() : []).filter((E) => E !== c);
  ...
  async _onDropItem(s, e) {
    var g, b, u, i, c, o, a, p, h, v, I, T, L, P, E, C, F;
...
Q(re, "PARTS", foundry.utils.mergeObject(
  z(re, re, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(re, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(re, re, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Xt = z(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Xt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Zt = z(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((es = (Vt = z(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.window) == null ? void 0 : es.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      ...
      if (J) {
        ...
        for (const ae of ve)
          if (((E = ae.actor) == null ? void 0 : E.id) === b || ae.actorId === b) {
    ...
    if (l.type === "Npc" && ((C = f == null ? void 0 : f.system) != null && C.identity) && "size" in f.system.identity) {
      const R = ls((N = (F = l.system) == null ? void 0 : F.identity) == null ? void 0 : N.size);
      l.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, L, P, E, C, F, N, H, B, U, G, V, R, Y, J, ve, ae, ye, Re;
    ...
    let f = ((P = game.actors) == null ? void 0 : P.get(r.actorId)) ?? ((E = game.actors) == null ? void 0 : E.get(l));
    if (f || (f = ((F = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : F.flatMap((ie) => {
      var ne;
    ...
    if (g || (g = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !g && r.slotKey && (g = (((((R = f.system) == null ? void 0 : R.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
      (ae = (Y = ui.notifications) == null ? void 0 : Y.warn) == null || ae.call(Y, ((ve = (J = game.i18n) == null ? void 0 : J.localize) == null ? void 0 : ve.call(J, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(g);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Re = (((ye = f.system) == null ? void 0 : ye.weapons) ?? {})[r.slotKey]) == null ? void 0 : Re.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-DG91AM27.mjs.map
