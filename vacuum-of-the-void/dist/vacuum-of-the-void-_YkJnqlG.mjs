...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var We, Ye, Je, Qe, k, A, x, j, ce, Q, Ie, be, Se, ke, Le, Ne, mt, pt, ft, yt, Xe, $e, Lt, Nt, At, Pt, Ft, Et, $t, xt, Rt, Mt, Kt, jt, zt, Ht;
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), F = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], O = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, N = (((Ne = E.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), z = (((mt = E.slot2) == null ? void 0 : mt.itemId) ?? "").trim(), G = (((pt = E.slot3) == null ? void 0 : pt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      ...
      let X = null;
      _ && (N === y.id ? X = "slot1" : z === y.id ? X = "slot2" : G === y.id && (X = "slot3"));
      const Ze = D && ((Fe = y.system) != null && Fe.damage) ? y.system.damage : "", le = D && typeof ((Te = y.system) == null ? void 0 : Te.range) == "string" ? (y.system.range || "").trim() : "", Ae = ee ? Number((_e = T[ee]) == null ? void 0 : _e.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponsTable = Z.map((y) => {
      ...
      const M = !!_, ee = ((Bt = y.system) == null ? void 0 : Bt.equipped) !== void 0 && ((Gt = y.system) == null ? void 0 : Gt.equipped) !== null ? !!y.system.equipped : M, X = (y == null ? void 0 : y.system) ?? {}, Ze = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", Ae = (oe[le] ?? le) || "—", ve = X.size ?? "", Pe = (ge[ve] ?? ve) || "", Fe = [Ae, Pe].filter(Boolean).join(", ") || Ae || "—", Te = le === "projectile" || ve === "thrown", _e = X.quantity, et = _e != null ? String(_e).trim() : "1", xe = String(q.bonus ?? "").trim(), tt = String(X.bonus ?? "").trim(), bi = xe || tt || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const Ee = this.actor.system.abilities ?? {}, nt = (((Et = this.actor.items) == null ? void 0 : Et.contents) ?? []).map((y) => {
      ...
      const D = Ee[y] ?? {}, _ = (D.itemId ?? "").trim(), q = _ ? ze.get(_) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || at,
        img: (q == null ? void 0 : q.img) || "",
        description: M,
        kp: ee
      };
    ...
    e.kpDots = ot.map((y, D) => {
      const _ = D + 1, q = !!Number(rt[y]), M = _ <= Ve;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DydPJXum.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DydPJXum.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DydPJXum.mjs");
      f(this.actor, o, r);
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = I ? I.split(/\s*,\s*/).filter((F) => T.includes(F)) : [], P = L.find((F) => {
          var O;
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((P = r == null ? void 0 : r.system) == null ? void 0 : P.damage) ?? "",
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((P = r.system) == null ? void 0 : P.damage) ?? "",
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: Ei((A.level ?? "").toString().trim()),
        special: (A.special ?? A.other ?? "").toString().trim() || "—",
        equipped: x
      };
    });
    const v = ((ot = (rt = t == null ? void 0 : t.system) == null ? void 0 : rt.gear) == null ? void 0 : ot.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var be, Se, ke, Le;
      const A = k.id;
      let x = null;
      for (const Ne of I)
        if ((((be = v[Ne]) == null ? void 0 : be.itemId) ?? "").trim() === A) {
          x = Ne;
          break;
        }
    ...
    const F = (((Oe = e.weaponsTable) == null ? void 0 : Oe.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ct = e.microchipsTable) == null ? void 0 : ct.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Ce = e.egyebList) == null ? void 0 : Ce.length) ?? 0) > 0;
    ...
    }), N = new Map(E.map((k) => [k.id, k])), z = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const V = t == null ? void 0 : t.id, Z = !!((qe = (we = game.combat) == null ? void 0 : we.combatants) != null && qe.some(
      (k) => {
        var A;
        return (((A = k.actor) == null ? void 0 : A.id) ?? k.actorId) === V;
      }
    ));
    e.showHarcSection = Z;
    const Y = ((lt = e.system) == null ? void 0 : lt.resources) ?? {}, R = (Ve = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ve.initiativeResult, W = typeof R == "number" ? R : -1, oe = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (We = (dt = e.system) == null ? void 0 : dt.combat) == null ? void 0 : We.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, A) => k.min - A.min), se = 3;
    ...
    if (typeof W == "number" && W >= 0 && ie.length > 0) {
      ...
      let x = null;
      W <= k.max ? x = k : W >= A.min ? x = A : x = ie.find((j) => W >= j.min && W <= j.max), x && (Me = x.kp);
    }
    const Ke = ie.length > 0 ? ie[ie.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, A) => {
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DydPJXum.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-DydPJXum.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DydPJXum.mjs");
      r(this.actor, c, o);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[i] ?? {}, d = ((L = e.system) == null ? void 0 : L.skills) ?? {}, a = ((P = e.items) == null ? void 0 : P.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, T, L, P, F, O, E;
    ...
    if (d.type === "Fegyver" && p) {
      const N = ((L = a.system) == null ? void 0 : L.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (N.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((Y) => z.includes(Y)) : [];
      let V = z.find((Y) => {
        var R;
      ...
      await a.update({
        ...
        [`system.weapons.${V}.damage`]: ((P = d.system) == null ? void 0 : P.damage) ?? "",
        [`system.weapons.${V}.bonus`]: ((F = d.system) == null ? void 0 : F.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && p) {
      const N = ((E = (O = a.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var V;
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    if ((m == null ? void 0 : m.type) === "Karakter") {
      const s = st.getTotalSpeedRaw(m), c = (u = m.effects) == null ? void 0 : u.find((o) => {
        var r;
  ...
  Hooks.on("updateActor", (m, p, g, b) => {
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((T = p == null ? void 0 : p.system) != null && T.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((P = (L = m.system) == null ? void 0 : L.combat) == null ? void 0 : P.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
    ...
    if (m.type === "Npc" && ((E = p == null ? void 0 : p.system) != null && E.identity) && "size" in p.system.identity) {
      const R = yi((z = (N = m.system) == null ? void 0 : N.identity) == null ? void 0 : z.size);
      m.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, L, P, F, O, E, N, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
    ...
    let m = ((P = game.actors) == null ? void 0 : P.get(a.actorId)) ?? ((F = game.actors) == null ? void 0 : F.get(l));
    ...
    const p = a.itemId ? ((z = (N = m.items) == null ? void 0 : N.get) == null ? void 0 : z.call(N, a.itemId)) ?? ((V = (H = (G = m.items) == null ? void 0 : G.contents) == null ? void 0 : H.find) == null ? void 0 : V.call(H, (ie) => ie.id === a.itemId)) : null;
    ...
    for (const d of e) {
      const a = st.getTotalSpeedRaw(d), l = (n = d.effects) == null ? void 0 : n.find((m) => {
        var p;
        return ((p = m.flags["vacuum-of-the-void"]) == null ? void 0 : p.immobilizedFromSpeed) === !0;
      });
      a <= 0 && !l ? await d.createEmbeddedDocuments("ActiveEffect", [{
        name: "Mozgásképtelen (sebesség)",
        statuses: ["immobilized"],
        flags: { "vacuum-of-the-void": { immobilizedFromSpeed: !0 } },
        origin: d.uuid
...
//# sourceMappingURL=vacuum-of-the-void-_YkJnqlG.mjs.map
