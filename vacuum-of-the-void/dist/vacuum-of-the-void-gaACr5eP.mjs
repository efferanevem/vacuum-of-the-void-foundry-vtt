...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponSlots = fe.map((h, L) => {
      const q = N[h] ?? {}, F = (q.itemId ?? "").trim(), K = re.find((pe) => pe.id === F), ee = Y.find((pe) => pe.id === F), Q = (ee == null ? void 0 : ee.system) ?? {}, je = Q.size === "thrown", le = (typeof Q.range == "string" ? (Q.range || "").trim() : "") || "—";
      return {
        slotKey: h,
        itemId: F,
        slotNum: L + 1,
    ...
    e.weaponsTable = Y.map((h) => {
      ...
      const K = !!q, ee = ((as = h.system) == null ? void 0 : as.equipped) !== void 0 && ((os = h.system) == null ? void 0 : os.equipped) !== null ? !!h.system.equipped : K, Q = (h == null ? void 0 : h.system) ?? {}, je = typeof Q.range == "string" ? (Q.range || "").trim() : "", le = Q.type ?? "", pe = (Se[le] ?? le) || "—", _e = Q.size ?? "", Ke = (ae[_e] ?? _e) || "", ze = [pe, Ke].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || _e === "thrown", qe = Q.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(Q.bonus ?? "").trim(), $s = Ve || pt || "0";
      return {
        slotKey: q ?? "",
        itemId: L,
    ...
    e.microchipItemsSlot1 = ne.filter((h) => !He(1).includes(h.id)), e.microchipItemsSlot2 = ne.filter((h) => !He(2).includes(h.id)), e.microchipItemsSlot3 = ne.filter((h) => !He(3).includes(h.id)), e.microchipSlots = Te.map((h) => {
      ...
      const F = !!q, K = ((Ke = h == null ? void 0 : h.system) == null ? void 0 : Ke.abilityType) ?? "", ee = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", Q = K === "active", je = Number((ze = h == null ? void 0 : h.system) == null ? void 0 : ze.replaceCost) >= 0 ? Number(h.system.replaceCost) : 0, le = (((Ce = h == null ? void 0 : h.system) == null ? void 0 : Ce.description) ?? "").trim(), pe = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: L,
        actorId: this.actor.id,
        name: (h == null ? void 0 : h.name) ?? "—",
    ...
    const kt = ((Qt = e.system) == null ? void 0 : Qt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Pe = (Zt = (Jt = e.system) == null ? void 0 : Jt.combat) == null ? void 0 : Zt.initiativeResult, de = typeof Pe == "number" ? Pe : -1, wt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-fmuOrV5H.mjs");
      r(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-fmuOrV5H.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var b;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, r = ((b = o.textContent) == null ? void 0 : b.trim()) || c, { openRollSheetForSkill: y } = await import("./roll-sheet-fmuOrV5H.mjs");
      y(this.actor, c, r);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Qe, Je, kt, Ge, Pe, de, wt, Ae, Fe, Lt, Oe, Ee, It, St, Ze, Tt, et, tt, st, it, nt, rt, at, ot, ct, $e, lt, ut, xe;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-fmuOrV5H.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-fmuOrV5H.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-fmuOrV5H.mjs");
      r(this.actor, o, c);
...
//# sourceMappingURL=vacuum-of-the-void-gaACr5eP.mjs.map
