...
var qt = Reflect.get;
var Ot = (F, i, e) => i in F ? Tt(F, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : F[i] = e;
var R = (F, i, e) => Ot(F, typeof i != "symbol" ? i + "" : i, e);
var N = (F, i, e) => qt(_t(F), e, i);
const { HTMLField: Dt, NumberField: _, SchemaField: P, StringField: v, BooleanField: U, ArrayField: le } = foundry.data.fields;
class Ct extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new P({
        biography: new Dt({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: fe, SchemaField: Lt } = foundry.data.fields;
class Pt extends Ct {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Ft, NumberField: Ut, StringField: ie } = foundry.data.fields;
...
const { NumberField: xt, StringField: et } = foundry.data.fields;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (b.slotOrder ?? "").trim(), D = q ? q.split(/\s*,\s*/).filter((d) => S.includes(d)) : [], C = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), E = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), A = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), ft = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, I) => {
      ...
      for (let se = 0; se < D.length; se++) {
        ...
        if ((((J = b[ae]) == null ? void 0 : J.itemId) ?? "") === d.id) {
          T = se + 1, L = ((ee = b[ae]) == null ? void 0 : ee.bonus) ?? "", K = ae;
          break;
        }
      }
      let M = null;
      w && (k === d.id ? M = "slot1" : E === d.id ? M = "slot2" : A === d.id && (M = "slot3"));
      const re = I && ((te = d.system) != null && te.damage) ? d.system.damage : "", H = I && typeof ((X = d.system) == null ? void 0 : X.range) == "string" ? (d.system.range || "").trim() : "", V = K ? Number((Z = b[K]) == null ? void 0 : Z.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
    ...
    e.weaponSlots = yt.map((d, I) => {
      const w = b[d] ?? {}, T = (w.itemId ?? "").trim(), L = Se.find((K) => K.id === T);
      return {
        slotKey: d,
        itemId: T,
        slotNum: I + 1,
    ...
    e.weaponsTable = ue.map((d) => {
      ...
      const L = !!w, K = ((Xe = d.system) == null ? void 0 : Xe.equipped) !== void 0 && ((Ze = d.system) == null ? void 0 : Ze.equipped) !== null ? !!d.system.equipped : L, M = (d == null ? void 0 : d.system) ?? {}, re = typeof M.range == "string" ? (M.range || "").trim() : "", H = M.type ?? "", V = (gt[H] ?? H) || "—", J = M.size ?? "", ee = (ht[J] ?? J) || "", te = [V, ee].filter(Boolean).join(", ") || V || "—", X = H === "projectile" || J === "thrown", Z = M.quantity, ne = Z != null ? String(Z).trim() : "1", se = String(T.bonus ?? "").trim(), ae = String(M.bonus ?? "").trim(), St = se || ae || "0";
      return {
        slotKey: w ?? "",
        itemId: I,
    ...
    e.microchipItemsSlot1 = oe.filter((d) => !me(1).includes(d.id)), e.microchipItemsSlot2 = oe.filter((d) => !me(2).includes(d.id)), e.microchipItemsSlot3 = oe.filter((d) => !me(3).includes(d.id)), e.microchipSlots = qe.map((d) => {
      ...
      const I = `slot${d}`, w = O[I] ?? {}, T = (w.itemId ?? "").trim(), L = oe.find((K) => K.id === T);
      ...
      const T = !!w, L = ((ee = d == null ? void 0 : d.system) == null ? void 0 : ee.abilityType) ?? "", K = L === "active" ? "Aktív" : L === "passive" ? "Passzív" : L || "—", M = L === "active", re = Number((te = d == null ? void 0 : d.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(d.system.replaceCost) : 0, H = (((X = d == null ? void 0 : d.system) == null ? void 0 : X.description) ?? "").trim(), V = H ? H.length > 60 ? H.slice(0, 57) + "…" : H : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const Oe = this.actor.system.abilities ?? {}, wt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((d) => {
      ...
      const I = Oe[d] ?? {}, w = (I.itemId ?? "").trim(), T = w ? De.get(w) : null, L = (T == null ? void 0 : T.description) ?? "", K = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: w,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-BNX_COtA.mjs");
      l(this.actor, o);
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, o = u.dataset.skill, l = ((g = u.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: c } = await import("./roll-sheet-BNX_COtA.mjs");
      c(this.actor, o, l);
...
R(Q, "PARTS", foundry.utils.mergeObject(N(Q, Q, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), R(Q, "DEFAULT_OPTIONS", foundry.utils.mergeObject(N(Q, Q, "DEFAULT_OPTIONS"), {
...
Hooks.once("init", () => {
  ...
  }, (i = CONFIG.Actor).dataModels ?? (i.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Pt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Et, CONFIG.Item.dataModels.Pancel = Nt, CONFIG.Item.dataModels.MikroChip = $t, CONFIG.Item.dataModels.Kepesseg = tt, CONFIG.Item.dataModels.ability = tt, CONFIG.Item.dataModels.Targy = jt, CONFIG.Item.dataModels.Egyeb = Rt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-CdEtuHA_.mjs.map
