...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const _ = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Qe = this.actor.system.gear) == null ? void 0 : Qe.microchips, z = U && typeof U == "object" && !Array.isArray(U) ? U : {}, W = (((et = z.slot1) == null ? void 0 : et.itemId) ?? "").trim(), Z = (((Et = z.slot2) == null ? void 0 : Et.itemId) ?? "").trim(), J = (((Pt = z.slot3) == null ? void 0 : Pt.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      const L = typeof b.sort == "number" ? b.sort : 0, A = typeof N.sort == "number" ? N.sort : 0;
      return L - A;
    }).map((b) => {
      var Me, st, it, Ge, Ve, Dt;
      ...
      const tt = N && ((it = b.system) != null && it.damage) ? b.system.damage : "", Ie = N && typeof ((Ge = b.system) == null ? void 0 : Ge.range) == "string" ? (b.system.range || "").trim() : "", _e = ue ? Number((Ve = _[ue]) == null ? void 0 : Ve.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.weaponsTable = R.map((b) => {
      ...
      const B = !!L, ue = ((vs = b.system) == null ? void 0 : vs.equipped) !== void 0 && ((ks = b.system) == null ? void 0 : ks.equipped) !== null ? !!b.system.equipped : B, re = (b == null ? void 0 : b.system) ?? {}, tt = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", _e = (D[Ie] ?? Ie) || "—", Me = re.size ?? "", st = (E[Me] ?? Me) || "", it = [_e, st].filter(Boolean).join(", ") || _e || "—", Ge = Ie === "projectile" || Me === "thrown", Ve = re.quantity, Dt = Ve != null ? String(Ve).trim() : "1", ut = String(A.bonus ?? "").trim(), Ot = String(re.bonus ?? "").trim(), ci = ut || Ot || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const V = (((xt = this.actor.items) == null ? void 0 : xt.contents) ?? []).filter((b) => b.type === "Pancel");
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-Bo6HHu2w.mjs");
      d(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-Bo6HHu2w.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, d = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-Bo6HHu2w.mjs");
      h(this.actor, l, d);
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((rt = e.system) == null ? void 0 : rt.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, u = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, p = (ot = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && ot.call(ie, "halfcover") ? 3 : 0, m = (Ce = (xe = t == null ? void 0 : t.statuses) == null ? void 0 : xe.has) != null && Ce.call(xe, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + u + p + m;
    const a = ((ct = t == null ? void 0 : t.items) == null ? void 0 : ct.contents) ?? [], o = ((He = t == null ? void 0 : t.system) == null ? void 0 : He.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (o.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], c = a.filter((S) => S.type === "Fegyver"), l = c.map((S) => ({ id: S.id, name: S.name, img: S.img })), d = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
    ...
    e.weaponsTable = c.map((S) => {
      ...
      let x = null, G = {};
      for (const lt of v)
        if ((((Tt = o[lt]) == null ? void 0 : Tt.itemId) ?? "").trim() === P) {
          x = lt, G = o[lt] ?? {};
          break;
        }
    ...
    const W = ((yt = t == null ? void 0 : t.system) == null ? void 0 : yt.abilities) ?? {}, Z = a.filter((S) => S.type === "Kepesseg" || S.type === "ability").map((S) => {
      var P, x, G;
      return {
        id: S.id,
        name: S.name,
    ...
    const De = ((bt = e.system) == null ? void 0 : bt.resources) ?? {}, D = (kt = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : kt.initiativeResult, E = typeof D == "number" ? D : -1, V = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], se = (Ye = (wt = e.system) == null ? void 0 : wt.combat) == null ? void 0 : Ye.initiativeRanges, le = Array.isArray(se) ? se.map((S) => ({ min: Number(S.min) ?? 0, max: Number(S.max) ?? 0, kp: Math.min(10, Math.max(0, Number(S.kp) ?? 0)) })) : [], ae = (le.length > 0 ? le : V).slice().sort((S, P) => S.min - P.min), ve = 3;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Bo6HHu2w.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Bo6HHu2w.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-Bo6HHu2w.mjs");
      d(this.actor, c, l);
...
Hooks.once("init", () => {
  ...
  Hooks.on("preCreateActor", (a, o, y) => {
    ...
    setTimeout(() => {
      ...
      const l = qt.getTotalSpeedRaw(c), d = (g = c.effects) == null ? void 0 : g.find((w) => w.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (l <= 0 && !d) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    for (const p of e) {
      const m = qt.getTotalSpeedRaw(p), a = (n = p.effects) == null ? void 0 : n.find((o) => o.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (m <= 0 && !a) {
...
//# sourceMappingURL=vacuum-of-the-void-BQ_amiqc.mjs.map
