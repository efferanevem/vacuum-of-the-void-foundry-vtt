import { V as K, c as ae } from "./vacuum-of-the-void-B8wcUfJa.mjs";
class U extends Application {
  ...
  async _doRoll(t) {
    ...
    if (e)
      try {
        const v = t.querySelector("[name='moraleDice']"), b = t.querySelector("[name='advantage']"), n = t.querySelector("[name='constantBonus']"), i = Math.min(3, Math.max(0, parseInt((v == null ? void 0 : v.value) ?? "0", 10) || 0)), m = Math.max(0, Number(((u = (s = e.system) == null ? void 0 : s.resources) == null ? void 0 : u.morale) ?? 0) || 0), l = Math.min(i, m), w = Math.min(3, Math.max(-3, parseInt((b == null ? void 0 : b.value) ?? "0", 10) || 0)), I = parseInt((n == null ? void 0 : n.value) ?? "0", 10) || 0, V = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, y = this._isWeaponAttack ? 0 : this._injuryModifier, M = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, B = ((g = (d = e.statuses) == null ? void 0 : d.has) == null ? void 0 : g.call(d, "diseased")) || ((a = (h = e.statuses) == null ? void 0 : h.has) == null ? void 0 : a.call(h, "poisoned")) ? -1 : 0, L = V + y + M + I + B, x = [
          "3d6",
        ...
        if (this._isWeaponAttack && ((f = (c = game.user) == null ? void 0 : c.targets) != null && f.size)) {
          ...
          if (P) {
            const O = ((r = P.system) == null ? void 0 : r.combat) ?? {}, X = Number(O.defense ?? 0) || 0, Z = Number(O.defenseBonus ?? 0) || 0, ee = Number(O.givenProtection ?? 0) || 0, te = (p = (o = P.statuses) == null ? void 0 : o.has) != null && p.call(o, "lookaround") ? 1 : 0;
            let W = 0;
            if (P.type === "Karakter") {
              const C = (((S = P.items) == null ? void 0 : S.contents) ?? []).filter(
                (q) => {
                  var A;
...
function ie(j, t, e) {
  var a, c;
  if (!j) return;
  const s = Number(((c = (a = j.system) == null ? void 0 : a.skills) == null ? void 0 : c[t]) ?? 0) || 0, u = K.BODY_PART_BY_SKILL[t] ? K._getSkillHealthStatusStatic(j, t) : void 0;
  let d = 0;
  u === 1 ? d = -6 : u === 2 && (d = -3);
...
function re(j, t) {
  var l, w, I, V, y, M, N, B;
  if (!j || !t) return;
  const e = j != null && j.id ? game.actors.get(j.id) ?? j : j, u = (((l = e.system) == null ? void 0 : l.weapons) ?? {})[t] ?? {}, d = ((w = e.system) == null ? void 0 : w.skills) ?? {}, g = ((V = (I = e.items) == null ? void 0 : I.filter) == null ? void 0 : V.call(I, (L) => L.type === "Fegyver")) ?? [], h = (u.itemId ?? "").trim(), a = h ? g.find((L) => L.id === h) ?? null : null, c = ((a == null ? void 0 : a.name) ?? u.name ?? "").trim() || "Fegyver", f = Number(u.bonus ?? ((y = a == null ? void 0 : a.system) == null ? void 0 : y.bonus) ?? 0) || 0, r = ((M = a == null ? void 0 : a.system) == null ? void 0 : M.type) || "kinetic", o = (((N = a == null ? void 0 : a.system) == null ? void 0 : N.skillKey) ?? "").trim(), p = o && d[o] !== void 0 ? o : r === "explosive" ? "grenadeUse" : "firearms", S = Number(d[p] || 0) || 0, _ = f + S;
  let v = 0;
  if (e.type === "Karakter") {
    const L = K._getSkillHealthStatusStatic(e, p);
    L === 1 ? v = -6 : L === 2 && (v = -3);
  }
...
//# sourceMappingURL=roll-sheet-B9a0z5y_.mjs.map
