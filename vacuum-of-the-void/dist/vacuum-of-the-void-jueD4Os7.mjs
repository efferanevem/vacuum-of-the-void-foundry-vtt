...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Le, fe, be, ye, Te, _e, Me, Re, je, Ke, Fe, Pe, tt, st, it, rt, nt, at;
    ...
    e.actionsTable = H;
    const U = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((g) => g.type === "Fegyver"), X = U.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = X;
    ...
    e.weaponsTable = U.map((g) => {
      ...
      const M = !!_, J = ((ct = g.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = g.system) == null ? void 0 : lt.equipped) !== null ? !!g.system.equipped : M, Y = (g == null ? void 0 : g.system) ?? {}, Ne = typeof Y.range == "string" ? (Y.range || "").trim() : "", se = Y.type ?? "", De = (we[se] ?? se) || "—", ge = Y.size ?? "", Oe = (le[ge] ?? ge) || "", Ce = [De, Oe].filter(Boolean).join(", ") || De || "—", ke = se === "projectile" || ge === "thrown", ve = Y.quantity, $e = ve != null ? String(ve).trim() : "1", Ee = String(L.bonus ?? "").trim(), xe = String(Y.bonus ?? "").trim(), Pt = Ee || xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const ue = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((g) => g.type === "Pancel");
    ...
    const Ie = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const Se = (((rt = this.actor.items) == null ? void 0 : rt.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const de = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((g) => g.type === "MikroChip"), te = de.map((g) => ({ id: g.id, name: g.name, img: g.img })), me = "— Nincs Mikro-Chip —", V = ["slot1", "slot2", "slot3"], pe = (g) => {
      var _, L, M;
      const D = [];
    ...
    const Ae = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((g) => {
      var D, _, L;
      return {
        id: g.id,
        name: g.name,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-B-e6WV9s.mjs");
      n(this.actor, o);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || o, { openRollSheetForSkill: u } = await import("./roll-sheet-B-e6WV9s.mjs");
      u(this.actor, o, n);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: y, label: h } = ft(m), i = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-B-e6WV9s.mjs");
      u(this.actor, o, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, n;
      i.preventDefault();
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: p, label: b } = computeVotvCritInfo(u), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Mt, CONFIG.Actor.dataModels.Npc = qt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = jt, CONFIG.Item.dataModels.Pancel = Ht, CONFIG.Item.dataModels.MikroChip = Ut, CONFIG.Item.dataModels.Kepesseg = mt, CONFIG.Item.dataModels.ability = mt, CONFIG.Item.dataModels.Targy = zt, CONFIG.Item.dataModels.Egyeb = Wt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-jueD4Os7.mjs.map
