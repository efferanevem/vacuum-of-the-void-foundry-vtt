...
var Ys = Reflect.get;
var Xs = (S, s, e) => s in S ? Ws(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var te = (S, s, e) => Xs(S, typeof s != "symbol" ? s + "" : s, e);
var K = (S, s, e) => Ys(Js(S), e, s);
const { HTMLField: Qs, NumberField: F, SchemaField: H, StringField: C, BooleanField: pe, ArrayField: St } = foundry.data.fields;
class Pt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new H({
        biography: new Qs({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: Rt, SchemaField: Zs } = foundry.data.fields;
class ei extends Pt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ci, StringField: Et } = foundry.data.fields;
...
function Kt(S) {
  ...
  f(S.terms, 1);
  const c = s.filter((a) => a === 6).length, p = s.filter((a) => a === 1).length, d = e.filter((a) => a === 6).length, l = t.filter((a) => a === 6).length, m = c + d, y = p + l;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const l = this.element, m = this.form ?? this.element, y = p.scrollState, a = p.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", o = () => {
      var u, h;
      if (this._applyScrollState(l, y), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const g = ((u = m.querySelector) == null ? void 0 : u.call(m, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (h = m.querySelector) == null ? void 0 : h.call(m, `[name="${CSS.escape(a.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((u = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : u.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, c = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = ee._healthStatusFromRatio(c, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let l;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const d = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, l = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, m = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
  ...
  async _prepareContext(s) {
    var lt, ut, dt, mt, pt, ft, yt, gt, ht, We, bt, vt, Je, I, A, P, G, ke, ne, Ce, Te, we, $e, Ye, Xe, qt, Nt, Lt, Ft, kt, at, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs, ls, us;
    ...
    const r = Number(((gt = (yt = this.actor.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.givenProtection) ?? 0) || 0, u = (bt = (We = (ht = this.actor) == null ? void 0 : ht.statuses) == null ? void 0 : We.has) != null && bt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (vt = this.actor) == null ? void 0 : vt.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, g = (G = (P = (A = this.actor) == null ? void 0 : A.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = r + this._getTotalArmorProtectionBonus() + u + h + g;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), z = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Ye = this.actor.system.gear) == null ? void 0 : Ye.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Xe = R.slot1) == null ? void 0 : Xe.itemId) ?? "").trim(), Z = (((qt = R.slot2) == null ? void 0 : qt.itemId) ?? "").trim(), J = (((Nt = R.slot3) == null ? void 0 : Nt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      const N = typeof b.sort == "number" ? b.sort : 0, E = typeof L.sort == "number" ? L.sort : 0;
      return N - E;
    }).map((b) => {
      var xe, Ze, et, Ke, ze, wt;
      const L = b.type === "Fegyver", N = b.type === "MikroChip";
      let E = 0, U = "", de = null;
      for (let rt = 0; rt < z.length; rt++) {
        const It = z[rt];
        if ((((xe = O[It]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          E = rt + 1, U = ((Ze = O[It]) == null ? void 0 : Ze.bonus) ?? "", de = It;
          break;
        }
      }
      let re = null;
    ...
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, E = (N.itemId ?? "").trim(), U = ce.find((De) => De.id === E), de = W.find((De) => De.id === E), re = (de == null ? void 0 : de.system) ?? {}, Qe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: E,
        slotNum: L + 1,
    ...
    const Q = (((Ft = this.actor.items) == null ? void 0 : Ft.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = Q.map((b) => {
      var E, U;
      const L = (b == null ? void 0 : b.system) ?? {}, N = ((E = b.system) == null ? void 0 : E.equipped) !== void 0 && ((U = b.system) == null ? void 0 : U.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = oe.map((b) => {
      const L = (b == null ? void 0 : b.system) ?? {}, N = (L.description ?? "").trim(), E = N ? N.length > 60 ? N.slice(0, 57) + "…" : N : "—", U = L.quantity != null ? String(L.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const me = (((Xt = this.actor.items) == null ? void 0 : Xt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Re = (b) => {
      var N, E, U;
      const L = [];
      return b !== 1 && L.push((((N = R.slot1) == null ? void 0 : N.itemId) ?? "").trim()), b !== 2 && L.push((((E = R.slot2) == null ? void 0 : E.itemId) ?? "").trim()), b !== 3 && L.push((((U = R.slot3) == null ? void 0 : U.itemId) ?? "").trim()), L.filter(Boolean);
    };
    e.microchipItemsSlot1 = ie.filter((b) => !Re(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Re(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Re(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      const L = R[b] ?? {}, N = (L.itemId ?? "").trim(), E = me.find((U) => U.id === N);
      return {
        slotKey: b,
        itemId: N,
        displayName: (E == null ? void 0 : E.name) || L.name || ge,
        img: (E == null ? void 0 : E.img) || "",
        active: L.active === !0
      };
    }), ["1", "2", "3"].forEach((b) => {
      const L = `slot${b}`, N = R[L] ?? {}, E = (N.itemId ?? "").trim(), U = ie.find((de) => de.id === E);
      e[`microchip${b}ItemId`] = E, e[`microchip${b}DisplayName`] = (U == null ? void 0 : U.name) || N.name || ge, e[`microchip${b}Img`] = (U == null ? void 0 : U.img) || "";
    ...
    const He = (((Qt = e.weaponsTable) == null ? void 0 : Qt.length) ?? 0) > 0 || (((Zt = e.armorTable) == null ? void 0 : Zt.length) ?? 0) > 0 || (((es = e.microchipsTable) == null ? void 0 : es.length) ?? 0) > 0 || (((ts = e.itemsTable) == null ? void 0 : ts.length) ?? 0) > 0;
    ...
    }), Pe = new Map(Dt.map((b) => [b.id, b])), Be = "— Nincs képesség —", Me = (b) => {
      const L = st[b] ?? {}, N = (L.itemId ?? "").trim(), E = N ? Pe.get(N) : null, U = (E == null ? void 0 : E.description) ?? "", de = (E == null ? void 0 : E.kp) ?? 0;
      return {
        itemId: N,
        displayName: (E == null ? void 0 : E.name) || L.name || Be,
        img: (E == null ? void 0 : E.img) || "",
        description: U,
        kp: de
      };
    ...
    if (typeof be == "number" && be >= 0 && je.length > 0) {
      ...
      let N = null;
      be <= b.max ? N = b : be >= L.min ? N = L : N = je.find((E) => be >= E.min && be <= E.max), N && (ct = N.kp);
    }
    e.kpDots = he.map((b, L) => {
      const N = L + 1, E = !!Number(se[b]), U = N <= ct;
      return { index: N, used: E, usable: U };
    });
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-BRyyNhzm.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-BRyyNhzm.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((g = o.textContent) == null ? void 0 : g.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-BRyyNhzm.mjs");
      h(this.actor, r, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (o.checked) {
        ...
        let q = k.find((z) => {
          var B;
          return !((B = h[z]) != null && B.itemId);
        });
        const j = new Set(k);
        if (!q) {
          const z = v.find((B) => !j.has(B));
          if (!z) return;
          q = z, k.push(z);
        }
  ...
  async _onDropItem(s, e) {
    var t, n, f, c, p, d, l, m, y, a, i, o, r, u;
    if (e) {
        ...
        if (g && g.documentName === "Item" && g.type === "Fegyver") {
          ...
          if (k) {
            const T = ((i = v.system) == null ? void 0 : i.weapons) ?? {}, _ = (T.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = _ ? _.split(/\s*,\s*/).filter((z) => O.includes(z)) : [], j = q.filter((z) => {
              var B;
              return (((B = T[z]) == null ? void 0 : B.itemId) ?? "").trim() === w;
            });
            if (j.length > 0) {
              const B = {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((m = e.system) == null ? void 0 : m.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const p = c && c.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, l = ((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic", m = (((w = c == null ? void 0 : c.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = m && n[m] !== void 0 ? m : l === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = d + a, r = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, u = new Roll(r);
    await u.evaluate({ async: !0 });
    const { resultType: h, label: g } = Kt(u), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${p} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    var d, l, m, y, a, i, o, r, u, h;
    const t = this.actor;
    if (!t) return;
    let n = ((l = (d = t.items).get) == null ? void 0 : l.call(d, s)) ?? ((y = (m = t.items.contents) == null ? void 0 : m.find) == null ? void 0 : y.call(m, (g) => g.id === s));
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = await super.render(s, e), p = this.element, d = this.form ?? this.element, l = f.scrollState, m = f.focus, y = typeof (l == null ? void 0 : l.formScrollTop) == "number" || typeof (l == null ? void 0 : l.windowScrollTop) == "number", a = () => {
      var i, o;
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((se = e.system) == null ? void 0 : se.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, c = (ae = (he = t == null ? void 0 : t.statuses) == null ? void 0 : he.has) != null && ae.call(he, "lookaround") ? 1 : 0, p = (nt = (be = t == null ? void 0 : t.statuses) == null ? void 0 : be.has) != null && nt.call(be, "halfcover") ? 3 : 0, d = (Oe = (_e = t == null ? void 0 : t.statuses) == null ? void 0 : _e.has) != null && Oe.call(_e, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + c + p + d;
    const l = (($t = t == null ? void 0 : t.items) == null ? void 0 : $t.contents) ?? [], m = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (m.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((I) => y.includes(I)) : [], o = l.filter((I) => I.type === "Fegyver"), r = o.map((I) => ({ id: I.id, name: I.name, img: I.img })), u = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((I) => !h.includes(I)), v = [...h, ...g], k = v.filter((I) => {
      var P;
      const A = (((P = m[I]) == null ? void 0 : P.itemId) ?? "").trim();
      return A && o.some((G) => G.id === A);
    });
    e.weaponSlots = k.map((I) => {
      const A = m[I] ?? {}, P = (A.itemId ?? "").trim(), G = r.find((we) => we.id === P), ke = o.find((we) => we.id === P), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", Te = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: I,
        itemId: P,
        displayName: (G == null ? void 0 : G.name) || A.name || u,
    ...
    e.weaponsTable = o.map((I) => {
      ...
      let P = null, G = {};
      for (const at of v)
        if ((((kt = m[at]) == null ? void 0 : kt.itemId) ?? "").trim() === A) {
          P = at, G = m[at] ?? {};
          break;
        }
      const ke = !!P, ne = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", Te = ne.type ?? "", we = (w[Te] ?? Te) || "—", $e = ne.size ?? "", Ye = (T[$e] ?? $e) || "", Xe = [we, Ye].filter(Boolean).join(", ") || we || "—", qt = Te === "projectile" || $e === "thrown", Nt = ne.quantity != null ? String(ne.quantity).trim() : "1", Lt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Ft = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: A,
        actorId: t.id,
    ...
    e.armorTable = _.map((I) => {
      var G;
      const A = (I == null ? void 0 : I.system) ?? {}, P = ((G = I.system) == null ? void 0 : G.equipped) === !0;
      return {
        itemId: I.id,
        actorId: t.id,
        ...
        level: vi((A.level ?? "").toString().trim()),
    ...
    e.microchipsTable = j.map((I) => {
      ...
      let P = null;
      for (const Xe of q)
        if ((((Te = O[Xe]) == null ? void 0 : Te.itemId) ?? "").trim() === A) {
          P = Xe;
          break;
        }
    ...
    e.itemsTable = z.map((I) => {
      const A = (I == null ? void 0 : I.system) ?? {}, P = (A.description ?? "").trim(), G = P ? P.length > 60 ? P.slice(0, 57) + "…" : P : "—";
      return {
        itemId: I.id,
        actorId: t.id,
        name: (I == null ? void 0 : I.name) ?? "—",
    ...
    const Y = ((dt = t == null ? void 0 : t.system) == null ? void 0 : dt.abilities) ?? {}, Z = l.filter((I) => I.type === "Kepesseg" || I.type === "ability").map((I) => {
      var A, P, G;
      return {
        id: I.id,
        name: I.name,
        img: I.img,
        description: ((A = I.system) == null ? void 0 : A.description) ?? "",
    ...
    const ce = t == null ? void 0 : t.id, ve = !!((pt = (mt = game.combat) == null ? void 0 : mt.combatants) != null && pt.some(
      (I) => {
        var A;
        return (((A = I.actor) == null ? void 0 : A.id) ?? I.actorId) === ce;
      }
    ));
    e.showHarcSection = ve;
    const D = ((ft = e.system) == null ? void 0 : ft.resources) ?? {}, x = (gt = (yt = e.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.initiativeResult, V = typeof x == "number" ? x : -1, Q = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (ht = e.system) == null ? void 0 : ht.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : Q).slice().sort((I, A) => I.min - A.min), ge = 3;
    let ue = le.length > 0 ? le : [];
    ue.length < ge && (ue = [...ue, ...Array(ge - ue.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ue.map((I, A) => ({
      ...I,
      isFirst: A === 0,
      isLast: A === ue.length - 1
    }));
    let Re = 0;
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      const I = ie[0], A = ie[ie.length - 1];
      let P = null;
      V <= I.max ? P = I : V >= A.min ? P = A : P = ie.find((G) => V >= G.min && V <= G.max), P && (Re = P.kp);
    }
    const He = ie.length > 0 ? ie[ie.length - 1] : null, st = Math.min(10, He ? He.kp : 6), Pe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, st)).map((I, A) => {
      const P = A + 1, G = !!Number(D[I]), ke = P <= Re;
      return { index: P, used: G, usable: ke };
    }), Be = Math.ceil(Pe.length / 2);
    return e.kpDotsRow1 = Pe.slice(0, Be), e.kpDotsRow2 = Pe.slice(Be), e.canEditInitiative = !!((bt = game.user) != null && bt.isGM), e.showInitiativeResult = typeof x == "number", e.initiativeResult = e.showInitiativeResult ? x : "", e.speedUnitForSelect = ((Je = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : Je.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var l, m, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-BRyyNhzm.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BRyyNhzm.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-BRyyNhzm.mjs");
      u(this.actor, o, r);
  ...
  async _rollWeapon(s) {
    ...
    const d = p && p.name || n.name || "Fegyver", l = Number(n.bonus || 0) || 0, m = ((O = p == null ? void 0 : p.system) == null ? void 0 : O.type) || "kinetic", y = (((q = p == null ? void 0 : p.system) == null ? void 0 : q.skillKey) ?? "").trim(), a = y && f[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, o = l + i, u = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, h = new Roll(u);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((l = (d = t.items).get) == null ? void 0 : l.call(d, s)) ?? ((y = (m = t.items.contents) == null ? void 0 : m.find) == null ? void 0 : y.call(m, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((u = (r = game.i18n) == null ? void 0 : r.localize) == null ? void 0 : u.call(r, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var m, y, a, i, o, r, u, h, g, v, k, w, T, _, O, q, j, z, B;
    ...
    if (f.type === "MikroChip" && l) {
      const R = ((B = (z = c.system) == null ? void 0 : z.gear) == null ? void 0 : B.microchips) ?? {}, Z = ["slot1", "slot2", "slot3"].find((J) => {
        var X;
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var q, j, z, B, R, Y, Z, J, X, M, W, ce, ve;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = p.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, V = x.type ?? "", Q = (n[V] ?? V) || "—", oe = x.size ?? "", le = (f[oe] ?? oe) || "", me = [Q, le].filter(Boolean).join(", ") || Q || "—", ie = V === "projectile" || oe === "thrown", ge = x.quantity != null ? String(x.quantity).trim() : "1", ue = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.armorTable = d.map((D) => {
      var Q;
      const x = (D == null ? void 0 : D.system) ?? {}, V = !!((Q = D.system) != null && Q.equipped);
      return {
        itemId: D.id,
        actorId: this.actor.id,
    ...
    const l = (((B = this.actor.items) == null ? void 0 : B.contents) ?? []).filter((D) => D.type === "MikroChip");
    e.microchipsTable = l.map((D) => {
      var ie, ge, ue;
      const x = ((ie = D == null ? void 0 : D.system) == null ? void 0 : ie.abilityType) ?? "", V = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—", Q = x === "active", oe = Number((ge = D == null ? void 0 : D.system) == null ? void 0 : ge.replaceCost) >= 0 ? Number(D.system.replaceCost) : 0, le = (((ue = D == null ? void 0 : D.system) == null ? void 0 : ue.description) ?? "").trim(), me = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    e.itemsTable = m.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, V = (x.description ?? "").trim(), Q = V ? V.length > 60 ? V.slice(0, 57) + "…" : V : "—", oe = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    const y = (((Y = this.actor.items) == null ? void 0 : Y.contents) ?? []).filter((D) => D.type === "Jarmuegyseg").sort((D, x) => {
      const V = typeof D.sort == "number" ? D.sort : 0, Q = typeof x.sort == "number" ? x.sort : 0;
      return V - Q;
    }), a = [];
    let i = 0, o = 0, r = 0;
    const u = Number(((J = (Z = this.actor.system) == null ? void 0 : Z.vehicle) == null ? void 0 : J.storage) ?? 0) || 0;
    for (const D of y) {
      const x = (D == null ? void 0 : D.system) ?? {}, V = x.health ?? {}, Q = Number(x.level ?? 0) || 0, oe = Number(V.max ?? 0) || 0, le = Number(V.value ?? 0) || 0;
      let me;
      if (oe <= 0)
        me = void 0;
      else if (le <= 0)
      ...
      const st = (x.damage ?? "").toString().trim(), Dt = (x.storage ?? "").toString().trim().replace(",", "."), Pe = Number(Dt);
    ...
    return e.egyebList = O.map((D) => {
      const V = (((D == null ? void 0 : D.system) ?? {}).description ?? "").trim(), Q = V ? V.length > 80 ? V.slice(0, 77) + "…" : V : "";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      var m, y, a, i;
      d.preventDefault();
      const l = (y = (m = d.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : y.itemId;
      ...
      var y;
      d.preventDefault(), d.stopPropagation();
      const l = d.currentTarget, m = (((y = l == null ? void 0 : l.dataset) == null ? void 0 : y.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      d.preventDefault();
      const l = (r = (o = (i = (a = d.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : o.dataset) == null ? void 0 : r.abilityRef, m = (v = (g = (h = (u = d.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : h.call(u, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (l)
        try {
          y = await fromUuid(l);
      ...
      var i, o, r, u;
      d.preventDefault();
      const l = (o = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, ".jarmu-unit-ability-pill"), m = (r = l == null ? void 0 : l.dataset) == null ? void 0 : r.abilityRef, y = (u = l == null ? void 0 : l.dataset) == null ? void 0 : u.abilityId, a = m || y;
    ...
    const f = (d) => {
      ...
      var l, m, y;
      return d && (((m = (l = this.element) == null ? void 0 : l.contains) == null ? void 0 : m.call(l, d)) || this.id && ((y = d.closest) == null ? void 0 : y.call(d, `#${CSS.escape(this.id)}`)));
    };
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${p}
      ${d}
...
te(ye, "PARTS", foundry.utils.mergeObject(
  ...
  K(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Ls = K(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Es = (Fs = K(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) == null ? void 0 : Es.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const tt = class tt extends At {
  activateListeners(s) {
    ...
    if (!e) return;
    const t = e.querySelector('select[name="system.identity.assignment"]'), n = e.querySelector("input.bazis-threat-total"), f = e.querySelector('input[name="system.combat.threatBonus"]');
    if (t && n && f) {
      const c = {
        ...
        var a, i;
        const d = t.value ?? "", l = c[d] ?? 0, m = Number(f.value ?? 0) || 0, y = l + m;
        n.value = y, (i = (a = this.actor) == null ? void 0 : a.update) == null || i.call(a, {
          "system.combat.threat": y,
          "system.combat.threatBonus": m
        });
      };
      t.addEventListener("change", p), f.addEventListener("change", p), f.addEventListener("input", p);
    }
  }
  async _prepareContext(s) {
    var t;
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, c = n.combat ?? {}, p = f.assignment ?? "", l = {
        ...
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }[p] ?? 0, m = Number(c.threatBonus ?? 0) || 0, y = l + m;
      e.system = foundry.utils.mergeObject(
        foundry.utils.duplicate(n),
        { combat: { ...c, threat: y, threatBonus: m } },
        { inplace: !1 }
      ), e.bazisThreatBase = l;
    }
    return e;
...
te(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  K(tt, tt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((As = K(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Ut = tt;
...
te(Ee, "PARTS", foundry.utils.mergeObject(K(Ee, Ee, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), te(Ee, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Ee, Ee, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ms = K(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 })
}));
let Wt = Ee;
var js;
...
te(Ae, "PARTS", foundry.utils.mergeObject(K(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((js = K(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Jt = Ae;
var Ks, zs;
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const p = (await Promise.all(
      ...
      var i, o;
      const m = (((i = d.system) == null ? void 0 : i.kind) ?? "passive").toString(), y = Number(((o = d.system) == null ? void 0 : o.kp) ?? 0) || 0, a = m === "species";
      return {
        id: d.id,
        ref: l,
        name: d.name,
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (d, l, m, y) => {
    ...
    if ((d.type === "Karakter" || d.type === "Npc") && ((w = l == null ? void 0 : l.system) != null && w.combat) && "initiativeResult" in l.system.combat) {
      const M = Number((_ = (T = d.system) == null ? void 0 : T.combat) == null ? void 0 : _.initiativeResult), W = Number.isFinite(M) ? M : 0, ce = game.combat;
      if (ce) {
    ...
    if (d.type === "Npc" && ((j = l == null ? void 0 : l.system) != null && j.identity) && "size" in l.system.identity) {
      const M = Hs((B = (z = d.system) == null ? void 0 : z.identity) == null ? void 0 : B.size);
      d.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, _, O, q, j, z, B, R, Y, Z, J, X, M, W, ce, ve, D, x;
    ...
    const l = c.itemId ? ((B = (z = d.items) == null ? void 0 : z.get) == null ? void 0 : B.call(z, c.itemId)) ?? ((Z = (Y = (R = d.items) == null ? void 0 : R.contents) == null ? void 0 : Y.find) == null ? void 0 : Z.call(Y, (V) => V.id === c.itemId)) : null;
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = c.targetName || "", o = c.hitLocationName || "", r = ((l == null ? void 0 : l.name) ?? (c.slotKey ? ((x = (((D = d.system) == null ? void 0 : D.weapons) ?? {})[c.slotKey]) == null ? void 0 : x.name) ?? "" : "")) || "Fegyver";
    ...
    for (const p of e) {
      const d = Tt.getTotalSpeedRaw(p), l = (n = p.effects) == null ? void 0 : n.find((m) => m.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (d <= 0 && !l) {
...
Hooks.on("preCreateToken", (S, s, e) => {
  ...
  if (f) {
    ...
    if (f.type === "Npc") {
      const m = Hs((l = (d = f.system) == null ? void 0 : d.identity) == null ? void 0 : l.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("combatRound", (S, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || Bs(S);
});
function Gs() {
  var s, e, t;
...
Hooks.on("updateCombat", (S, s, e) => {
  (s == null ? void 0 : s.round) != null && Bs(S), setTimeout(Gs, 0);
});
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var y, a, i, o;
  const t = ((y = S.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, c = t.weaponAttack, p = t.weapon, d = t.vsDefense, l = t.vsDefenseInfo;
  if (!n && !f && !c && !d) return;
  ...
  if (m) {
    if (n && m.classList.add(`votv-${n}`), f) {
      ...
      if (r)
        ...
        const u = m.querySelector(".dice-total"), h = (u == null ? void 0 : u.parentElement) ?? m, g = document.createElement("div");
    ...
    if (!c && d && l) {
      const r = m.querySelector(".dice-total"), u = (r == null ? void 0 : r.parentElement) ?? m, h = !!l.isHit, g = l.targetName || "Célpont", v = l.hitLocationRoll, k = l.hitLocationName;
...
//# sourceMappingURL=vacuum-of-the-void-DICr1aCK.mjs.map
