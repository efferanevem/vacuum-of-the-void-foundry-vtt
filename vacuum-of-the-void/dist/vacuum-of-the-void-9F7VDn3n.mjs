...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const ct = ((ps = e.system) == null ? void 0 : ps.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (ys = (fs = e.system) == null ? void 0 : fs.combat) == null ? void 0 : ys.initiativeResult, ie = typeof ye == "number" ? ye : -1, lt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Me = (hs = (gs = e.system) == null ? void 0 : gs.combat) == null ? void 0 : hs.initiativeRanges, Ne = Array.isArray(Me) ? Me.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ve = (Ne.length > 0 ? Ne : lt).slice().sort((b, L) => b.min - L.min), Xe = Ne.map((b) => b.min), At = Xe.length ? Math.min(...Xe) : 0, Ft = Xe.length ? Math.max(...Xe) : 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-D96CvfMj.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-D96CvfMj.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-D96CvfMj.mjs");
      h(this.actor, l, m);
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-D96CvfMj.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D96CvfMj.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-D96CvfMj.mjs");
      m(this.actor, c, l);
...
const at = class at extends Kt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (y == null ? void 0 : y.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((V = (E = this.actor) == null ? void 0 : E.items) == null ? void 0 : V.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", w = p[v] ?? 0, k = Number(i.value ?? 0) || 0, I = As(this.actor), _ = m + h + w + k + I;
      r.value = _;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, p = n.identity ?? {}, d = n.combat ?? {}, f = p.assignment ?? "", u = p.subAssignment ?? "", a = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[f] ?? 0, i = o[u] ?? 0, c = e.sizeForSelect ?? "Kicsi", l = y[c] ?? 0, m = Number(d.threatBonus ?? 0) || 0, h = As(this.actor), g = r + i + l + m + h;
      e.system = foundry.utils.mergeObject(
...
X(at, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(at, at, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Gs = j(at, at, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Zt = at;
...
X(ve, "PARTS", foundry.utils.mergeObject(
  ...
  j(ve, ve, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Vs = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.form) ?? {}, { submitOnChange: !0 }),
...
X(_e, "PARTS", foundry.utils.mergeObject(j(_e, _e, "PARTS") ?? {}, {
  ...
  j(_e, _e, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ri = j(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ri.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ai = j(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ai.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, o, y, r) => {
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const R = ci((E = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : E.size);
      a.update({
...
function Bi(S) {
  ...
  for (const n of ((t = game.actors) == null ? void 0 : t.contents) ?? [])
    !n || n.type !== "Karakter" || n.update(Fs).catch((p) => {
  ...
  for (const n of e) {
    const p = n.actor;
    !p || p.type !== "Npc" || p.update(Fs).catch((d) => {
...
//# sourceMappingURL=vacuum-of-the-void-9F7VDn3n.mjs.map
