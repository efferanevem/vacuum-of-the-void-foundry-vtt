...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-CpjWQyl0.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-CpjWQyl0.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((g = o.textContent) == null ? void 0 : g.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-CpjWQyl0.mjs");
      h(this.actor, r, u);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = o.map((I) => {
      ...
      let P = null, G = {};
      for (const at of v)
        if ((((kt = m[at]) == null ? void 0 : kt.itemId) ?? "").trim() === E) {
          P = at, G = m[at] ?? {};
          break;
        }
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CpjWQyl0.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CpjWQyl0.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-CpjWQyl0.mjs");
      u(this.actor, o, r);
...
const tt = class tt extends Et {
  activateListeners(s) {
    ...
    if (!e) return;
    const t = e.querySelector('select[name="system.identity.assignment"]'), n = e.querySelector('input[name="system.combat.threat"]');
    if (t && n) {
      const f = {
      ...
      t.addEventListener("change", (c) => {
        var l, m, y;
        const p = ((l = c.currentTarget) == null ? void 0 : l.value) ?? "", d = f[p] ?? 0;
        n.value = d, (y = (m = this.actor) == null ? void 0 : m.update) == null || y.call(m, { "system.combat.threat": d });
      });
    }
  }
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, c = n.combat ?? {}, p = f.assignment ?? "", m = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }[p] ?? 0;
...
//# sourceMappingURL=vacuum-of-the-void-aFsDgswr.mjs.map
