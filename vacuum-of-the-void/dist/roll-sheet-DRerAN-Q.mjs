import { V as E, c as Y } from "./vacuum-of-the-void-BgcJpXd1.mjs";
class T extends Application {
  ...
  _bindRollSheetListeners() {
    ...
    const c = t.querySelector(".roll-sheet-morale-wrap"), a = Math.min(3, Math.max(0, parseInt(((b = c == null ? void 0 : c.dataset) == null ? void 0 : b.moraleMax) ?? "3", 10) || 0)), l = t.querySelector("input[name='moraleDice']"), d = t.querySelectorAll(".roll-sheet-morale-d8"), m = (s) => {
...
//# sourceMappingURL=roll-sheet-DRerAN-Q.mjs.map
