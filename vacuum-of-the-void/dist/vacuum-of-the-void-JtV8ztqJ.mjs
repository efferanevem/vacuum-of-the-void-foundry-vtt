...
const { NumberField: He, StringField: ut } = foundry.data.fields;
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var le, oe, ye, ge, $e, xe, je, Re, _e, Se, Ve, et, tt, st, it, rt, nt, at;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (b.slotOrder ?? "").trim(), q = S ? S.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], C = (_e = this.actor.system.gear) == null ? void 0 : _e.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, w = (((Se = O.slot1) == null ? void 0 : Se.itemId) ?? "").trim(), L = (((Ve = O.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), F = (((et = O.slot3) == null ? void 0 : et.itemId) ?? "").trim(), B = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-7F3T83Cq.mjs");
      c(this.actor, o);
    ...
    d && n({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, c = ((y = r.textContent) == null ? void 0 : y.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-7F3T83Cq.mjs");
      l(this.actor, o, c);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const fe = !!E, G = (k == null ? void 0 : k.system) ?? {}, Ie = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", le = (l[ae] ?? ae) || "—", oe = G.size ?? "", ye = (y[oe] ?? oe) || "", ge = [le, ye].filter(Boolean).join(", ") || le || "—", $e = ae === "projectile" || oe === "thrown", xe = G.quantity != null ? String(G.quantity).trim() : "1", je = String(G.bonus ?? K.bonus ?? "").trim() || "0", Re = (G.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: A,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-7F3T83Cq.mjs");
      l(this.actor, o, c);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, c;
      i.preventDefault();
...
//# sourceMappingURL=vacuum-of-the-void-JtV8ztqJ.mjs.map
