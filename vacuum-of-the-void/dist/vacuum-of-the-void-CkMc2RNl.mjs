...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Oe, _e, Le, Ae, Fe, Ne, Ee, Ce, $e, Pe, xe, je, Ke, Me, Re, Be, Ue, He;
    ...
    e.weaponsTable = le.map((d) => {
      ...
      const _ = !!q, P = ((Z = d.system) == null ? void 0 : Z.equipped) !== void 0 && ((Ge = d.system) == null ? void 0 : Ge.equipped) !== null ? !!d.system.equipped : _, j = (d == null ? void 0 : d.system) ?? {}, X = typeof j.range == "string" ? (j.range || "").trim() : "", Y = j.type ?? "", W = (at[Y] ?? Y) || "—", V = j.size ?? "", re = (nt[V] ?? V) || "", ae = [W, re].filter(Boolean).join(", ") || W || "—", ee = W === "Lövedékes", te = j.quantity, se = te != null ? String(te).trim() : "1";
      return {
        slotKey: q ?? "",
        itemId: k,
    ...
    e.microchipItemsSlot1 = ie.filter((d) => !ce(1).includes(d.id)), e.microchipItemsSlot2 = ie.filter((d) => !ce(2).includes(d.id)), e.microchipItemsSlot3 = ie.filter((d) => !ce(3).includes(d.id)), ["1", "2", "3"].forEach((d) => {
      const k = `slot${d}`, q = L[k] ?? {}, T = (q.itemId ?? "").trim(), _ = ie.find((P) => P.id === T);
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-CiRhlwFd.mjs");
      c(this.actor, r);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (o) => {
      ...
      var f;
      o.preventDefault();
      const l = o.currentTarget, r = l.dataset.skill, c = ((f = l.textContent) == null ? void 0 : f.trim()) || r, { openRollSheetForSkill: m } = await import("./roll-sheet-CiRhlwFd.mjs");
      m(this.actor, r, c);
...
R(z, "PARTS", foundry.utils.mergeObject(x(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((st = x(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : st.form) ?? {}, { submitOnChange: !0 })
}));
let he = z;
...
//# sourceMappingURL=vacuum-of-the-void-CkMc2RNl.mjs.map
