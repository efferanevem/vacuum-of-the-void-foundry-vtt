...
const { NumberField: xt, SchemaField: Zs } = foundry.data.fields;
class ei extends Et {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      attributes: new Zs({
        body: new xt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        mind: new xt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        soul: new xt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 })
      })
    };
  }
}
const { SchemaField: ti, StringField: ps, NumberField: si } = foundry.data.fields;
class ii extends Et {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      vehicle: new ti({
        ...
        type: new ps({ required: !1, blank: !0, initial: "" }),
        /** Eszközök hatótávolsága (TE). */
        toolsRange: new ps({ required: !1, blank: !0, initial: "" }),
...
const { SchemaField: ni, StringField: fs, NumberField: ai } = foundry.data.fields;
class ri extends Et {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: oi, NumberField: Ti, StringField: He } = foundry.data.fields;
class ys extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      bonus: new He({ required: !1, blank: !0, initial: "" }),
      damage: new He({
        required: !1,
        blank: !0,
        initial: ""
      }),
      range: new He({ required: !1, blank: !0, initial: "" }),
      special: new He({ required: !1, blank: !0, initial: "" }),
      quantity: new He({ required: !1, blank: !0, initial: "1" }),
      /** Jártasság kulcs (pl. grenadeUse, firearms) – ezt a bónuszt adja hozzá a támadáshoz. Alapértelmezett: Kézifegyver Használat. */
      skillKey: new He({ required: !1, blank: !0, initial: "grenadeUse" })
    };
  }
}
...
const { NumberField: Rt, StringField: gs } = foundry.data.fields;
...
const { NumberField: mi, StringField: hs } = foundry.data.fields;
...
class pi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      quantity: new vs({ required: !1, blank: !0, initial: "1" })
    };
  }
}
...
const { NumberField: Mt, StringField: ot, SchemaField: ks, ArrayField: gi } = foundry.data.fields;
class hi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Szint (0–3). */
      level: new Mt({ required: !0, integer: !0, min: 0, max: 3, initial: 0 }),
      /** Életerő: max / aktuális. */
      health: new ks({
        max: new Mt({ required: !0, integer: !0, min: 0, initial: 0 }),
        value: new Mt({ required: !0, integer: !0, min: 0, initial: 0 })
      }),
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((u = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : u.resources) ?? {}, f = ((y = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : y.value) ?? 0, c = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = ee._healthStatusFromRatio(c, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let l;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const d = ((v = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : v.resources) ?? {}, l = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, m = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
  ...
  async _prepareContext(s) {
    var lt, ut, dt, mt, pt, ft, yt, gt, ht, Je, bt, vt, Ye, I, E, P, G, ke, ne, Ce, Te, we, xe, Xe, Qe, qt, Nt, Lt, Ft, kt, at, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs, ls;
    ...
    const r = Number(((gt = (yt = this.actor.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.givenProtection) ?? 0) || 0, u = (bt = (Je = (ht = this.actor) == null ? void 0 : ht.statuses) == null ? void 0 : Je.has) != null && bt.call(Je, "lookaround") ? 1 : 0, h = (I = (Ye = (vt = this.actor) == null ? void 0 : vt.statuses) == null ? void 0 : Ye.has) != null && I.call(Ye, "halfcover") ? 3 : 0, y = (G = (P = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = r + this._getTotalArmorProtectionBonus() + u + h + y;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), U = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Qe = R.slot1) == null ? void 0 : Qe.itemId) ?? "").trim(), Z = (((qt = R.slot2) == null ? void 0 : qt.itemId) ?? "").trim(), J = (((Nt = R.slot3) == null ? void 0 : Nt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      const N = typeof b.sort == "number" ? b.sort : 0, A = typeof L.sort == "number" ? L.sort : 0;
      return N - A;
    }).map((b) => {
      var Re, et, tt, Ue, ze, wt;
      const L = b.type === "Fegyver", N = b.type === "MikroChip";
      let A = 0, z = "", de = null;
      for (let rt = 0; rt < U.length; rt++) {
        const It = U[rt];
        if ((((Re = O[It]) == null ? void 0 : Re.itemId) ?? "") === b.id) {
          A = rt + 1, z = ((et = O[It]) == null ? void 0 : et.bonus) ?? "", de = It;
          break;
        }
      }
      let re = null;
      N && (Y === b.id ? re = "slot1" : Z === b.id ? re = "slot2" : J === b.id && (re = "slot3"));
      const Ze = L && ((tt = b.system) != null && tt.damage) ? b.system.damage : "", Ie = L && typeof ((Ue = b.system) == null ? void 0 : Ue.range) == "string" ? (b.system.range || "").trim() : "", De = de ? Number((ze = O[de]) == null ? void 0 : ze.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.weaponItems = ce;
    const ve = "— Nincs fegyver —", D = U.filter((b) => {
      const N = ((O[b] ?? {}).itemId ?? "").trim();
      return N ? !!W.find((z) => z.id === N) : !1;
    });
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, A = (N.itemId ?? "").trim(), z = ce.find((De) => De.id === A), de = W.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Ze = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: L + 1,
    ...
    e.weaponsTable = W.map((b) => {
      ...
      let N = null, A = {};
      for (const $t of U)
        if ((((us = O[$t]) == null ? void 0 : us.itemId) ?? "").trim() === L) {
          N = $t, A = O[$t] ?? {};
          break;
        }
      const z = !!N, de = ((ds = b.system) == null ? void 0 : ds.equipped) !== void 0 && ((ms = b.system) == null ? void 0 : ms.equipped) !== null ? !!b.system.equipped : z, re = (b == null ? void 0 : b.system) ?? {}, Ze = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", De = (x[Ie] ?? Ie) || "—", Re = re.size ?? "", et = (V[Re] ?? Re) || "", tt = [De, et].filter(Boolean).join(", ") || De || "—", Ue = Ie === "projectile" || Re === "thrown", ze = re.quantity, wt = ze != null ? String(ze).trim() : "1", rt = String(A.bonus ?? "").trim(), It = String(re.bonus ?? "").trim(), Vs = rt || It || "0";
      return {
        slotKey: N ?? "",
        itemId: L,
    ...
    const me = (((Yt = this.actor.items) == null ? void 0 : Yt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Me = (b) => {
      var N, A, z;
      const L = [];
    ...
    e.microchipItemsSlot1 = ie.filter((b) => !Me(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Me(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Me(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      ...
      let N = null;
      for (const ze of ue)
        if ((((Re = R[ze]) == null ? void 0 : Re.itemId) ?? "").trim() === L) {
          N = ze;
          break;
        }
      const A = !!N, z = ((et = b == null ? void 0 : b.system) == null ? void 0 : et.abilityType) ?? "", de = z === "active" ? "Aktív" : z === "passive" ? "Passzív" : z || "—", re = z === "active", Ze = Number((tt = b == null ? void 0 : b.system) == null ? void 0 : tt.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, Ie = (((Ue = b == null ? void 0 : b.system) == null ? void 0 : Ue.description) ?? "").trim(), De = Ie ? Ie.length > 60 ? Ie.slice(0, 57) + "…" : Ie : "—";
      return {
        itemId: L,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const Be = (((Xt = e.weaponsTable) == null ? void 0 : Xt.length) ?? 0) > 0 || (((Qt = e.armorTable) == null ? void 0 : Qt.length) ?? 0) > 0 || (((Zt = e.microchipsTable) == null ? void 0 : Zt.length) ?? 0) > 0 || (((es = e.itemsTable) == null ? void 0 : es.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Be;
    const st = this.actor.system.abilities ?? {}, Dt = (((ts = this.actor.items) == null ? void 0 : ts.contents) ?? []).map((b) => {
      var L, N, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), $e = new Map(Dt.map((b) => [b.id, b])), Ge = "— Nincs képesség —", je = (b) => {
      const L = st[b] ?? {}, N = (L.itemId ?? "").trim(), A = N ? $e.get(N) : null, z = (A == null ? void 0 : A.description) ?? "", de = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: N,
        displayName: (A == null ? void 0 : A.name) || L.name || Ge,
        img: (A == null ? void 0 : A.img) || "",
    ...
    e.abilityPassiveList = Ve(it("passive")), e.abilityActiveList = Ve(it("active"));
    const se = ((ss = e.system) == null ? void 0 : ss.resources) ?? {}, he = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ae = (ns = (is = e.system) == null ? void 0 : is.combat) == null ? void 0 : ns.initiativeResult, be = typeof ae == "number" ? ae : -1, nt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], _e = (rs = (as = e.system) == null ? void 0 : as.combat) == null ? void 0 : rs.initiativeRanges, Oe = Array.isArray(_e) ? _e.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ke = (Oe.length > 0 ? Oe : nt).slice().sort((b, L) => b.min - L.min), We = Oe.map((b) => b.min), _t = We.length ? Math.min(...We) : 0, Ot = We.length ? Math.max(...We) : 0;
    e.initiativeRanges = Oe.map((b) => ({ ...b, isFirst: b.min === _t, isLast: b.min === Ot }));
    let ct = 0;
    if (typeof be == "number" && be >= 0 && Ke.length > 0) {
      const b = Ke[0], L = Ke[Ke.length - 1];
      let N = null;
      be <= b.max ? N = b : be >= L.min ? N = L : N = Ke.find((A) => be >= A.min && be <= A.max), N && (ct = N.kp);
    }
    e.kpDots = he.map((b, L) => {
      const N = L + 1, A = !!Number(se[b]), z = N <= ct;
      return { index: N, used: A, usable: z };
    });
    const Ct = !!((cs = (os = game.combat) == null ? void 0 : os.combatants) != null && cs.some((b) => {
      var L;
      return ((L = b.actor) == null ? void 0 : L.type) === "Karakter";
    }));
    return e.showHarcSection = Ct, e.canEditInitiative = !!((ls = game.user) != null && ls.isGM), e.showInitiativeResult = typeof ae == "number", e.initiativeResult = e.showInitiativeResult ? ae : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-sgqgwQQa.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-sgqgwQQa.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-sgqgwQQa.mjs");
      h(this.actor, r, u);
      ...
      if (!y) return;
      const v = ((_ = (T = this.actor.items).get) == null ? void 0 : _.call(T, y)) ?? ((q = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : q.call(O, (U) => U.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (o.checked) {
        ...
        let q = k.find((U) => {
          var B;
          return !((B = h[U]) != null && B.itemId);
        });
        const j = new Set(k);
        if (!q) {
          const U = v.find((B) => !j.has(B));
          if (!U) return;
          q = U, k.push(U);
        }
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (y && y.documentName === "Item" && y.type === "Fegyver") {
          ...
          if (k) {
            const T = ((i = v.system) == null ? void 0 : i.weapons) ?? {}, _ = (T.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = _ ? _.split(/\s*,\s*/).filter((U) => O.includes(U)) : [], j = q.filter((U) => {
              var B;
              return (((B = T[U]) == null ? void 0 : B.itemId) ?? "").trim() === w;
            });
            if (j.length > 0) {
              const B = {
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: m, label: g } = jt(l), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return l.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: y } = jt(u), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${p} – találat`,
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var je, it, Ve, se, he, ae, be, nt, _e, Oe, Pt, Ke, We, _t, Ot, ct, Ct, lt, ut, dt, mt, pt, ft, yt, gt, ht, Je, bt, vt, Ye;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((je = this.actor) == null ? void 0 : je.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ve = (it = e.system) == null ? void 0 : it.identity) == null ? void 0 : Ve.size) ?? "").trim() || "Közepes";
    ...
    e.weaponsTable = o.map((I) => {
      ...
      const ke = !!P, ne = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", Te = ne.type ?? "", we = (w[Te] ?? Te) || "—", xe = ne.size ?? "", Xe = (T[xe] ?? xe) || "", Qe = [we, Xe].filter(Boolean).join(", ") || we || "—", qt = Te === "projectile" || xe === "thrown", Nt = ne.quantity != null ? String(ne.quantity).trim() : "1", Lt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Ft = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: E,
        actorId: t.id,
    ...
    const O = ((_t = (We = t == null ? void 0 : t.system) == null ? void 0 : We.gear) == null ? void 0 : _t.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], j = l.filter((I) => I.type === "MikroChip");
    e.microchipsTable = j.map((I) => {
      var Te, we, xe, Xe;
      const E = I.id;
      let P = null;
      for (const Qe of q)
        if ((((Te = O[Qe]) == null ? void 0 : Te.itemId) ?? "").trim() === E) {
          P = Qe;
          break;
        }
    ...
    const U = l.filter((I) => I.type === "Targy");
    e.itemsTable = U.map((I) => {
    ...
    const D = ((ft = e.system) == null ? void 0 : ft.resources) ?? {}, x = (gt = (yt = e.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.initiativeResult, V = typeof x == "number" ? x : -1, Q = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (Je = (ht = e.system) == null ? void 0 : ht.combat) == null ? void 0 : Je.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : Q).slice().sort((I, E) => I.min - E.min), ge = 3;
    ...
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      ...
      let P = null;
      V <= I.max ? P = I : V >= E.min ? P = E : P = ie.find((G) => V >= G.min && V <= G.max), P && (Me = P.kp);
    }
    const Be = ie.length > 0 ? ie[ie.length - 1] : null, st = Math.min(10, Be ? Be.kp : 6), $e = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, st)).map((I, E) => {
      const P = E + 1, G = !!Number(D[I]), ke = P <= Me;
      return { index: P, used: G, usable: ke };
    }), Ge = Math.ceil($e.length / 2);
    return e.kpDotsRow1 = $e.slice(0, Ge), e.kpDotsRow2 = $e.slice(Ge), e.canEditInitiative = !!((bt = game.user) != null && bt.isGM), e.showInitiativeResult = typeof x == "number", e.initiativeResult = e.showInitiativeResult ? x : "", e.speedUnitForSelect = ((Ye = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : Ye.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var l, m, g;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-sgqgwQQa.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-sgqgwQQa.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-sgqgwQQa.mjs");
      u(this.actor, o, r);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: y, label: v } = jt(h), k = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return h.toMessage({
  ...
  async _onDropItem(s, e) {
    var m, g, a, i, o, r, u, h, y, v, k, w, T, _, O, q, j, U, B;
    ...
    if (f.type === "MikroChip" && l) {
      const R = ((B = (U = c.system) == null ? void 0 : U.gear) == null ? void 0 : B.microchips) ?? {}, Z = ["slot1", "slot2", "slot3"].find((J) => {
        var X;
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var q, j, U, B, R, Y, Z, J, X, M, W, ce, ve;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    for (const D of g) {
      ...
      const Me = (x.range ?? "").toString().trim().replace(",", "."), Be = Number(Me);
      Number.isFinite(Be) && (o += Be);
      const st = (x.damage ?? "").toString().trim(), Dt = (x.storage ?? "").toString().trim().replace(",", "."), $e = Number(Dt);
      Number.isFinite($e) && (r += $e);
      const Ge = x.abilities ?? {}, je = Array.isArray(Ge.items) ? Ge.items : [], Ve = (await Promise.all(
        je.map(async (se) => {
          var he;
          if (!se) return null;
          try {
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    let e = await super._prepareContext(s);
    return e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system, e;
  }
};
te(qe, "PARTS", foundry.utils.mergeObject(K(qe, qe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/actor/bazis-sheet.hbs" }
})), te(qe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  K(qe, qe, "DEFAULT_OPTIONS"),
  {
    classes: ["vacuum-of-the-void", "sheet", "actor", "Bazis"],
    template: "systems/vacuum-of-the-void/templates/actor/bazis-sheet.hbs",
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Es = K(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let ws = qe;
...
te(Ne, "PARTS", foundry.utils.mergeObject(K(Ne, Ne, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ps = K(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 })
}));
let zt = Ne;
var $s;
...
te(Fe, "PARTS", foundry.utils.mergeObject(K(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((xs = K(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : xs.form) ?? {}, { submitOnChange: !1 })
}));
let Bt = Fe;
var Rs;
...
te(Ae, "PARTS", foundry.utils.mergeObject(K(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Rs = K(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !0 })
}));
let Gt = Ae;
var Ms;
const Ee = class Ee extends foundry.applications.api.HandlebarsApplicationMixin(
...
te(Se, "PARTS", foundry.utils.mergeObject(K(Se, Se, "PARTS") ?? {}, {
  ...
  K(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    dragDrop: [
      ...((Us = K(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Us.dragDrop) ?? [],
      {
        dragSelector: null,
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = ei, CONFIG.Actor.dataModels.Npc = Et, CONFIG.Actor.dataModels.Jarmu = ii, CONFIG.Actor.dataModels.Bazis = ri, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ys, CONFIG.Item.dataModels.weapon = ys, CONFIG.Item.dataModels.Pancel = li, CONFIG.Item.dataModels.MikroChip = di, CONFIG.Item.dataModels.Kepesseg = bs, CONFIG.Item.dataModels.ability = bs, CONFIG.Item.dataModels.Targy = pi, CONFIG.Item.dataModels.Egyeb = yi, CONFIG.Item.dataModels.Jarmuegyseg = hi, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (d, l, m, g) => {
    ...
    if (d.type === "Npc" && ((j = l == null ? void 0 : l.system) != null && j.identity) && "size" in l.system.identity) {
      const M = Hs((B = (U = d.system) == null ? void 0 : U.identity) == null ? void 0 : B.size);
      d.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, y, v, k, w, T, _, O, q, j, U, B, R, Y, Z, J, X, M, W, ce, ve, D, x;
    ...
    const l = c.itemId ? ((B = (U = d.items) == null ? void 0 : U.get) == null ? void 0 : B.call(U, c.itemId)) ?? ((Z = (Y = (R = d.items) == null ? void 0 : R.contents) == null ? void 0 : Y.find) == null ? void 0 : Z.call(Y, (V) => V.id === c.itemId)) : null;
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  ...
  if (m) {
    ...
    if (!c && d && l) {
      const r = m.querySelector(".dice-total"), u = (r == null ? void 0 : r.parentElement) ?? m, h = !!l.isHit, y = l.targetName || "Célpont", v = l.hitLocationRoll, k = l.hitLocationName;
...
//# sourceMappingURL=vacuum-of-the-void-CR5bEuxm.mjs.map
