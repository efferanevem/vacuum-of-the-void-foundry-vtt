...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const n = ((s = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : s.resources) ?? {}, d = ((o = (c = n.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, a = ((r = n.currentHealth) == null ? void 0 : r.legs) ?? 0, l = B._healthStatusFromRatio(a, d), m = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let p;
  ...
  _writeTotalSpeed(i = null) {
    ...
    if (!n) return;
    const m = ((r = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : r.resources) ?? {}, p = ((h = (f = m.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, g = ((v = m.currentHealth) == null ? void 0 : v.legs) ?? 0;
  ...
  async _prepareContext(i) {
    var Ve, Ye, Je, Qe, k, P, x, j, ce, Q, Ee, be, Ie, ke, qe, Le, dt, mt, pt, ft, Xe, $e, Lt, Nt, Pt, At, Ft, Et, $t, xt, Rt;
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (T.slotOrder ?? "").trim(), F = A ? A.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], O = (Q = this.actor.system.gear) == null ? void 0 : Q.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, N = (((Ee = E.slot1) == null ? void 0 : Ee.itemId) ?? "").trim(), H = (((be = E.slot2) == null ? void 0 : be.itemId) ?? "").trim(), G = (((Ie = E.slot3) == null ? void 0 : Ie.itemId) ?? "").trim(), W = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, q = typeof D.sort == "number" ? D.sort : 0;
      return _ - q;
    }).map((y) => {
      var ve, Pe, Ae, Se, Te, et;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let q = 0, M = "", ee = null;
      for (let xe = 0; xe < F.length; xe++) {
        const tt = F[xe];
        if ((((ve = T[tt]) == null ? void 0 : ve.itemId) ?? "") === y.id) {
          q = xe + 1, M = ((Pe = T[tt]) == null ? void 0 : Pe.bonus) ?? "", ee = tt;
          break;
        }
      }
      let X = null;
      _ && (N === y.id ? X = "slot1" : H === y.id ? X = "slot2" : G === y.id && (X = "slot3"));
      const Ze = D && ((Ae = y.system) != null && Ae.damage) ? y.system.damage : "", le = D && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = ee ? Number((Te = T[ee]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      ...
      const q = !!_, M = ((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", Ze = Number((Ae = y == null ? void 0 : y.system) == null ? void 0 : Ae.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, le = (((Se = y == null ? void 0 : y.system) == null ? void 0 : Se.description) ?? "").trim(), Ne = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const at = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, rt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], De = (At = (Pt = e.system) == null ? void 0 : Pt.combat) == null ? void 0 : At.initiativeResult, he = typeof De == "number" ? De : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-Bzd8MYFl.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-Bzd8MYFl.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-Bzd8MYFl.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((A = (L = this.actor.items).get) == null ? void 0 : A.call(L, h)) ?? ((O = (F = this.actor.items.contents) == null ? void 0 : F.find) == null ? void 0 : O.call(F, (N) => N.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = I ? I.split(/\s*,\s*/).filter((F) => T.includes(F)) : [], A = L.find((F) => {
          var O;
          return (((O = v[F]) == null ? void 0 : O.itemId) ?? "").trim() === o;
        });
        if (A) {
          const F = L.filter((O) => O !== A);
          h["system.weapons.slotOrder"] = F.join(","), h[`system.weapons.${A}.itemId`] = "", h[`system.weapons.${A}.name`] = "", h[`system.weapons.${A}.damage`] = "", h[`system.weapons.${A}.bonus`] = "";
        }
      }
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((A = r == null ? void 0 : r.system) == null ? void 0 : A.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((F = r == null ? void 0 : r.system) == null ? void 0 : F.bonus) ?? ""
      ...
      I ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", r == null || r.insertBefore(L, T)), L.src = I, L.style.display = "") : L && L.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const A = h ? this.actor.items.get(h) : null, F = {
      ...
      const r = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((T) => {
        var L;
        return (((L = r[T]) == null ? void 0 : L.itemId) ?? "").trim() === c;
      });
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((A = r.system) == null ? void 0 : A.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((F = r.system) == null ? void 0 : F.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (T) {
        const O = I.filter((E) => E !== T);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = T ? T.split(/\s*,\s*/).filter((O) => L.includes(O)) : [], F = A.filter((O) => {
              var E;
              return (((E = I[O]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (F.length > 0) {
              const E = {
                "system.weapons.slotOrder": A.filter((N) => !F.includes(N)).join(",")
              };
              for (const N of F)
  ...
  async _rollSkill(i, e) {
    ...
    const { resultType: g, label: b } = vt(p), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    ...
    let a = null;
    t.itemId && (a = d.find((L) => L.id === t.itemId) ?? null);
    const l = a && a.name || t.name || `Fegyver (${i})`, m = Number(t.bonus || 0) || 0, p = ((I = a == null ? void 0 : a.system) == null ? void 0 : I.type) || "kinetic", g = (((T = a == null ? void 0 : a.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = g && n[g] !== void 0 ? g : p === "explosive" ? "grenadeUse" : "firearms", u = Number(n[b] || 0) || 0, s = m + u, o = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, r = new Roll(o);
    await r.evaluate({ async: !0 });
    const { resultType: f, label: h } = vt(r), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return r.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
J(B, "PARTS", foundry.utils.mergeObject(
  ...
  z(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Wt = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Wt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Vt = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Jt = (Yt = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.window) == null ? void 0 : Jt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    e.weaponsTable = p.map((k) => {
      ...
      const ce = !!x, Q = (k == null ? void 0 : k.system) ?? {}, Ee = typeof Q.range == "string" ? (Q.range || "").trim() : "", be = Q.type ?? "", Ie = (r[be] ?? be) || "—", ke = Q.size ?? "", qe = (f[ke] ?? ke) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", dt = be === "projectile" || ke === "thrown", mt = Q.quantity != null ? String(Q.quantity).trim() : "1", pt = String(Q.bonus ?? j.bonus ?? "").trim() || "0", ft = (Q.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    e.microchipsTable = T.map((k) => {
      ...
      let x = null;
      for (const Le of I)
        if ((((be = v[Le]) == null ? void 0 : be.itemId) ?? "").trim() === P) {
          x = Le;
          break;
        }
    ...
    e.abilityPassiveList = U(G("passive")), e.abilityActiveList = U(G("active"));
    const W = t == null ? void 0 : t.id, Z = !!((Ce = (we = game.combat) == null ? void 0 : we.combatants) != null && Ce.some(
      (k) => {
        var P;
        return (((P = k.actor) == null ? void 0 : P.id) ?? k.actorId) === W;
      }
    ));
    e.showHarcSection = Z;
    const Y = ((ct = e.system) == null ? void 0 : ct.resources) ?? {}, R = (We = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : We.initiativeResult, V = typeof R == "number" ? R : -1, oe = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (Ve = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ve.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, P) => k.min - P.min), se = 3;
    ...
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      ...
      let x = null;
      V <= k.max ? x = k : V >= P.min ? x = P : x = ie.find((j) => V >= j.min && V <= j.max), x && (Me = x.kp);
    }
    const Ke = ie.length > 0 ? ie[ie.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Fe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, P) => {
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Bzd8MYFl.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-Bzd8MYFl.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-Bzd8MYFl.mjs");
      r(this.actor, c, o);
      ...
      const o = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, f = (Array.isArray((A = o[s]) == null ? void 0 : A.items) ? o[s].items.slice() : []).filter((F) => F !== c);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[i] ?? {}, d = ((L = e.system) == null ? void 0 : L.skills) ?? {}, a = ((A = e.items) == null ? void 0 : A.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = a.find((E) => E.id === n.itemId) ?? null);
    const m = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, g = ((F = l == null ? void 0 : l.system) == null ? void 0 : F.type) || "kinetic", b = (((O = l == null ? void 0 : l.system) == null ? void 0 : O.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", s = Number(d[u] || 0) || 0, c = p + s, r = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(r);
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, T, L, A, F, O, E;
    if (!this.actor) return (g = super._onDropItem) == null ? void 0 : g.call(this, i, e);
    const n = ((N) => {
      var G;
      if (!N) return null;
      const H = N.uuid ?? N.documentUuid ?? ((G = N.data) == null ? void 0 : G.uuid) ?? (typeof N == "string" ? N : null);
      if (H) return H;
      if (typeof N == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((o = d.parent) == null ? void 0 : o.id) !== a.id) {
        ...
        N = ((r = (await a.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : r.id) ?? N;
      }
      const H = (((f = d.system) == null ? void 0 : f.kind) ?? "passive").toString(), G = ((h = a.system) == null ? void 0 : h.abilities) ?? {}, U = H === "active" ? "active" : "passive", W = Array.isArray((v = G[U]) == null ? void 0 : v.items) ? G[U].items.slice() : Array.isArray(G[U]) ? G[U].slice() : [];
      W.includes(N) || W.push(N), await a.update({ [`system.abilities.${U}.items`]: W }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && p) {
      const N = ((L = a.system) == null ? void 0 : L.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (N.slotOrder ?? "").trim(), U = G ? G.split(/\s*,\s*/).filter((Y) => H.includes(Y)) : [];
      let W = H.find((Y) => {
        var R;
        return !(((R = N[Y]) == null ? void 0 : R.itemId) ?? "").trim();
      });
      W || (W = H.find((Y) => !U.includes(Y)) ?? "slot1");
      const Z = U.includes(W) ? U : [...U, W].filter((Y) => H.includes(Y));
      await a.update({
        ...
        [`system.weapons.${W}.bonus`]: ((F = d.system) == null ? void 0 : F.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && p) {
      const N = ((E = (O = a.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((U) => {
        var W;
        return !(((W = N[U]) == null ? void 0 : W.itemId) ?? "").trim();
      });
      G && await a.update({
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (m, p, g, b) => {
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((T = p == null ? void 0 : p.system) != null && T.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((A = (L = m.system) == null ? void 0 : L.combat) == null ? void 0 : A.initiativeResult), V = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
    ...
    if (m.type === "Npc" && ((E = p == null ? void 0 : p.system) != null && E.identity) && "size" in p.system.identity) {
      const R = li((H = (N = m.system) == null ? void 0 : N.identity) == null ? void 0 : H.size);
      m.update({
    ...
    for (const R of f)
      ((U = R.document) == null ? void 0 : U.id) !== u || ((W = R.document) == null ? void 0 : W.documentName) !== "Actor" || ((Z = R.constructor) == null ? void 0 : Z.name) !== "VoidKarakterSheet" || o.includes(R) || o.push(R);
    if (c && o.some((R) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, L, A, F, O, E, N, H, G, U, W, Z, Y, R, V, oe, ge, re, Re;
    ...
    if (!a) return;
    const l = a.actorId ?? ((L = d == null ? void 0 : d.speaker) == null ? void 0 : L.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let m = ((A = game.actors) == null ? void 0 : A.get(a.actorId)) ?? ((F = game.actors) == null ? void 0 : F.get(l));
    ...
    const p = a.itemId ? ((H = (N = m.items) == null ? void 0 : N.get) == null ? void 0 : H.call(N, a.itemId)) ?? ((W = (U = (G = m.items) == null ? void 0 : G.contents) == null ? void 0 : U.find) == null ? void 0 : W.call(U, (ie) => ie.id === a.itemId)) : null;
...
Hooks.on("preCreateToken", (w, i, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = li((p = (m = d.system) == null ? void 0 : m.identity) == null ? void 0 : p.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-Ba-8gbZJ.mjs.map
