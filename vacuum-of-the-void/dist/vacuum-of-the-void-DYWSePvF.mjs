...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Te, De, Oe, _e, Le, Ae, Fe, Ne, Ee, Ce, $e, xe, je, Pe, Ke, Me;
    ...
    e.actionsTable = E;
    const P = ((($e = this.actor.items) == null ? void 0 : $e.contents) ?? []).filter((u) => u.type === "Fegyver"), R = P.map((u) => ({ id: u.id, name: u.name, img: u.img }));
    e.weaponItems = R;
    const he = "— Nincs fegyver —", Ve = k.filter((u) => {
      const q = ((o[u] ?? {}).itemId ?? "").trim();
      return q ? !!P.find((_) => _.id === q) : !1;
    });
    ...
    }), e.generalItems = Array.isArray((Pe = (je = this.actor.system) == null ? void 0 : je.gear) == null ? void 0 : Pe.generalItems) ? this.actor.system.gear.generalItems : [];
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!i) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-D21j12-f.mjs");
      o(this.actor, i);
    ...
    r && a({ currentTarget: r }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (n) => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, i = l.dataset.skill, o = ((f = l.textContent) == null ? void 0 : f.trim()) || i, { openRollSheetForSkill: m } = await import("./roll-sheet-D21j12-f.mjs");
      m(this.actor, i, o);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if (l.checked) {
        ...
        let y = I.find((P) => {
          var R;
          return !((R = m[P]) != null && R.itemId);
        });
        const E = new Set(I);
        if (!y) {
          const P = k.find((R) => !E.has(R));
          if (!P) return;
          y = P, I.push(P);
        }
...
U(C, "PARTS", foundry.utils.mergeObject(j(C, C, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
})), U(C, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(C, C, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "actor", "Karakter"],
  template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs",
  width: 1e3,
  minWidth: 1e3,
  height: 800,
  form: foundry.utils.mergeObject(((ze = j(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : ze.form) ?? {}, { submitOnChange: !1 }),
  window: foundry.utils.mergeObject(((Ge = j(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : Ge.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((Ye = (We = j(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : We.window) == null ? void 0 : Ye.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
U(H, "PARTS", foundry.utils.mergeObject(j(H, H, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), U(H, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(H, H, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Je = j(H, H, "DEFAULT_OPTIONS")) == null ? void 0 : Je.form) ?? {}, { submitOnChange: !1 })
}));
let pe = H;
var Qe;
...
U(B, "PARTS", foundry.utils.mergeObject(j(B, B, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), U(B, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(B, B, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pajzs"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Qe = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Qe.form) ?? {}, { submitOnChange: !1 })
}));
let fe = B;
var Xe;
...
U(z, "PARTS", foundry.utils.mergeObject(j(z, z, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), U(z, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(z, z, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "microchip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xe = j(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : Xe.form) ?? {}, { submitOnChange: !0 })
}));
let ye = z;
var Ze;
...
U(G, "PARTS", foundry.utils.mergeObject(j(G, G, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), U(G, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(G, G, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ze = j(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : Ze.form) ?? {}, { submitOnChange: !0 })
}));
let ge = G;
...
//# sourceMappingURL=vacuum-of-the-void-DYWSePvF.mjs.map
