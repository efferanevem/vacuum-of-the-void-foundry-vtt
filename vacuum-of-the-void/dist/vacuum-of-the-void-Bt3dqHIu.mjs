...
const { BooleanField: Zs, NumberField: gi, StringField: Ue } = foundry.data.fields;
...
const { NumberField: xt, StringField: rt, SchemaField: bs, ArrayField: oi } = foundry.data.fields;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((d = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : d.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, c = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, m = ee._healthStatusFromRatio(c, f), u = Number(((D = (I = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : I.combat) == null ? void 0 : D.givenSpeed) ?? 0) || 0;
    let l;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const u = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, l = ((I = (k = u.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : I.value) ?? 0, p = ((D = u.currentHealth) == null ? void 0 : D.legs) ?? 0;
  ...
  async _prepareContext(s) {
    var ct, lt, ut, dt, mt, pt, ft, yt, gt, We, ht, bt, Je, w, E, P, G, ke, ne, Ce, Te, we, $e, Ye, Xe, Ct, qt, Lt, Nt, vt, nt, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs;
    ...
    const o = Number(((yt = (ft = this.actor.system) == null ? void 0 : ft.combat) == null ? void 0 : yt.givenProtection) ?? 0) || 0, d = (ht = (We = (gt = this.actor) == null ? void 0 : gt.statuses) == null ? void 0 : We.has) != null && ht.call(We, "lookaround") ? 1 : 0, h = (w = (Je = (bt = this.actor) == null ? void 0 : bt.statuses) == null ? void 0 : Je.has) != null && w.call(Je, "halfcover") ? 3 : 0, g = (G = (P = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + d + h + g;
    ...
    const I = Number(k.givenSpeed);
    let D = (Number(k.speed) || 0) + (Number(k.speedBonus) || 0) + (Number.isFinite(I) ? I : 0);
    y === 0 && (D = 0), (Te = (Ce = (ne = this.actor) == null ? void 0 : ne.statuses) == null ? void 0 : Ce.has) != null && Te.call(Ce, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Ye = this.actor.system.gear) == null ? void 0 : Ye.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Xe = R.slot1) == null ? void 0 : Xe.itemId) ?? "").trim(), Z = (((Ct = R.slot2) == null ? void 0 : Ct.itemId) ?? "").trim(), J = (((qt = R.slot3) == null ? void 0 : qt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      let re = null;
      L && (Y === b.id ? re = "slot1" : Z === b.id ? re = "slot2" : J === b.id && (re = "slot3"));
      const Qe = N && ((et = b.system) != null && et.damage) ? b.system.damage : "", Ie = N && typeof ((Ke = b.system) == null ? void 0 : Ke.range) == "string" ? (b.system.range || "").trim() : "", De = de ? Number((ze = O[de]) == null ? void 0 : ze.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    const ve = "— Nincs fegyver —", T = K.filter((b) => {
      ...
      return L ? !!W.find((z) => z.id === L) : !1;
    });
    e.weaponSlots = T.map((b, N) => {
      const L = O[b] ?? {}, A = (L.itemId ?? "").trim(), z = ce.find((De) => De.id === A), de = W.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Qe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
        displayName: (z == null ? void 0 : z.name) || L.name || ve,
    ...
    const Q = (((Nt = this.actor.items) == null ? void 0 : Nt.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = Q.map((b) => {
      var A, z;
      const N = (b == null ? void 0 : b.system) ?? {}, L = ((A = b.system) == null ? void 0 : A.equipped) !== void 0 && ((z = b.system) == null ? void 0 : z.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = oe.map((b) => {
      const N = (b == null ? void 0 : b.system) ?? {}, L = (N.description ?? "").trim(), A = L ? L.length > 60 ? L.slice(0, 57) + "…" : L : "—", z = N.quantity != null ? String(N.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const me = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Re = (b) => {
      var L, A, z;
      const N = [];
      return b !== 1 && N.push((((L = R.slot1) == null ? void 0 : L.itemId) ?? "").trim()), b !== 2 && N.push((((A = R.slot2) == null ? void 0 : A.itemId) ?? "").trim()), b !== 3 && N.push((((z = R.slot3) == null ? void 0 : z.itemId) ?? "").trim()), N.filter(Boolean);
    };
    e.microchipItemsSlot1 = ie.filter((b) => !Re(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Re(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Re(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      const N = R[b] ?? {}, L = (N.itemId ?? "").trim(), A = me.find((z) => z.id === L);
      return {
        slotKey: b,
        itemId: L,
    ...
    const tt = this.actor.system.abilities ?? {}, Tt = (((es = this.actor.items) == null ? void 0 : es.contents) ?? []).map((b) => {
      ...
      const N = tt[b] ?? {}, L = (N.itemId ?? "").trim(), A = L ? Pe.get(L) : null, z = (A == null ? void 0 : A.description) ?? "", de = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: L,
    ...
    const te = ((ts = e.system) == null ? void 0 : ts.resources) ?? {}, he = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ae = (is = (ss = e.system) == null ? void 0 : ss.combat) == null ? void 0 : is.initiativeResult, be = typeof ae == "number" ? ae : -1, it = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], _e = (as = (ns = e.system) == null ? void 0 : ns.combat) == null ? void 0 : as.initiativeRanges, Oe = Array.isArray(_e) ? _e.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], je = (Oe.length > 0 ? Oe : it).slice().sort((b, N) => b.min - N.min), Ve = Oe.map((b) => b.min), Dt = Ve.length ? Math.min(...Ve) : 0, _t = Ve.length ? Math.max(...Ve) : 0;
    e.initiativeRanges = Oe.map((b) => ({ ...b, isFirst: b.min === Dt, isLast: b.min === _t }));
    let ot = 0;
    if (typeof be == "number" && be >= 0 && je.length > 0) {
      const b = je[0], N = je[je.length - 1];
      let L = null;
      be <= b.max ? L = b : be >= N.min ? L = N : L = je.find((A) => be >= A.min && be <= A.max), L && (ot = L.kp);
    }
    e.kpDots = he.map((b, N) => {
      const L = N + 1, A = !!Number(te[b]), z = L <= ot;
      return { index: L, used: A, usable: z };
    });
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-BLlnCuDe.mjs");
      d(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-BLlnCuDe.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, d = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-BLlnCuDe.mjs");
      h(this.actor, o, d);
      ...
      if (!d) return;
      const g = (((I = (((k = this.actor.system) == null ? void 0 : k.weapons) ?? {})[d]) == null ? void 0 : I.itemId) ?? "").trim();
      if (!g) return;
      const v = ((_ = (D = this.actor.items).get) == null ? void 0 : _.call(D, g)) ?? ((q = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : q.call(O, (K) => K.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((h == null ? void 0 : h.type) === "Fegyver") {
        const v = d.system.weapons ?? {}, k = (v.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = k ? k.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], _ = D.find((O) => {
          var q;
      ...
      const h = this.actor.system.weapons ?? {}, g = (h.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], k = g ? g.split(/\s*,\s*/).filter((q) => v.includes(q)) : [], I = k.find((q) => {
        var j;
      ...
      if (!h) return;
      const g = (r.dataset.itemId ?? "").trim(), v = (r.dataset.itemName ?? ((q = r.textContent) == null ? void 0 : q.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", k = (r.dataset.itemImg ?? "").trim(), I = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = v);
      let D = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      k ? (D || (D = document.createElement("img"), D.className = "karakter-microchip-slot-thumb", D.alt = "", d == null || d.insertBefore(D, I)), D.src = k, D.style.display = "") : D && D.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      const d = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((I) => {
        var D;
        return (((D = d[I]) == null ? void 0 : D.itemId) ?? "").trim() === r;
      });
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (g && g.documentName === "Item" && (g.type === "Kepesseg" || g.type === "ability")) {
          ...
          const I = this.actor.system.abilities ?? {};
          if (k === "species") {
            await this.actor.update({
          ...
          const D = k === "active" ? "active" : "passive", _ = Array.isArray((l = I[D]) == null ? void 0 : l.items) ? I[D].items.slice() : Array.isArray(I[D]) ? I[D].slice() : [];
      ...
      if (h) {
        ...
        if (g && g.documentName === "Item" && g.type === "Fegyver") {
          ...
          if (k) {
            ...
            I = ((a = (await v.createEmbeddedDocuments("Item", [D]))[0]) == null ? void 0 : a.id) ?? I;
          }
          if (k) {
            const D = ((i = v.system) == null ? void 0 : i.weapons) ?? {}, _ = (D.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = _ ? _.split(/\s*,\s*/).filter((K) => O.includes(K)) : [], j = q.filter((K) => {
              var B;
              return (((B = D[K]) == null ? void 0 : B.itemId) ?? "").trim() === I;
            });
            if (j.length > 0) {
              const B = {
  ...
  async _rollWeapon(s) {
    ...
    const m = c && c.name || t.name || `Fegyver (${s})`, u = Number(t.bonus || 0) || 0, l = ((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic", p = (((I = c == null ? void 0 : c.system) == null ? void 0 : I.skillKey) ?? "").trim(), y = p && n[p] !== void 0 ? p : l === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = u + a, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, d = new Roll(o);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((te = e.system) == null ? void 0 : te.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, c = (ae = (he = t == null ? void 0 : t.statuses) == null ? void 0 : he.has) != null && ae.call(he, "lookaround") ? 1 : 0, m = (it = (be = t == null ? void 0 : t.statuses) == null ? void 0 : be.has) != null && it.call(be, "halfcover") ? 3 : 0, u = (Oe = (_e = t == null ? void 0 : t.statuses) == null ? void 0 : _e.has) != null && Oe.call(_e, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + c + m + u;
    const l = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], p = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (p.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((w) => y.includes(w)) : [], r = l.filter((w) => w.type === "Fegyver"), o = r.map((w) => ({ id: w.id, name: w.name, img: w.img })), d = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((w) => !h.includes(w)), v = [...h, ...g], k = v.filter((w) => {
      var P;
      const E = (((P = p[w]) == null ? void 0 : P.itemId) ?? "").trim();
      return E && r.some((G) => G.id === E);
    });
    e.weaponSlots = k.map((w) => {
      const E = p[w] ?? {}, P = (E.itemId ?? "").trim(), G = o.find((we) => we.id === P), ke = r.find((we) => we.id === P), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", Te = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: w,
        itemId: P,
        displayName: (G == null ? void 0 : G.name) || E.name || d,
    ...
    e.weaponsTable = r.map((w) => {
      ...
      let P = null, G = {};
      for (const nt of v)
        if ((((vt = p[nt]) == null ? void 0 : vt.itemId) ?? "").trim() === E) {
          P = nt, G = p[nt] ?? {};
          break;
        }
      const ke = !!P, ne = (w == null ? void 0 : w.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", Te = ne.type ?? "", we = (I[Te] ?? Te) || "—", $e = ne.size ?? "", Ye = (D[$e] ?? $e) || "", Xe = [we, Ye].filter(Boolean).join(", ") || we || "—", Ct = Te === "projectile" || $e === "thrown", qt = ne.quantity != null ? String(ne.quantity).trim() : "1", Lt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Nt = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: E,
        actorId: t.id,
    ...
    e.armorTable = _.map((w) => {
      var G;
      const E = (w == null ? void 0 : w.system) ?? {}, P = ((G = w.system) == null ? void 0 : G.equipped) === !0;
      return {
        itemId: w.id,
        actorId: t.id,
    ...
    const O = ((Dt = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : Dt.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], j = l.filter((w) => w.type === "MikroChip");
    e.microchipsTable = j.map((w) => {
      var Te, we, $e, Ye;
      const E = w.id;
      let P = null;
      for (const Xe of q)
      ...
      const G = ((we = w == null ? void 0 : w.system) == null ? void 0 : we.abilityType) ?? "", ke = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ne = ((($e = w == null ? void 0 : w.system) == null ? void 0 : $e.description) ?? "").trim(), Ce = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: E,
        actorId: t.id,
        name: (w == null ? void 0 : w.name) ?? "—",
        ...
        typeLabel: ke,
        description: Ce,
        kp: Number((Ye = w == null ? void 0 : w.system) == null ? void 0 : Ye.replaceCost) >= 0 ? Number(w.system.replaceCost) : 0,
        isActive: G === "active",
        slotKey: P ?? "",
        equipped: !!P
      };
    });
    const K = l.filter((w) => w.type === "Targy");
    e.itemsTable = K.map((w) => {
      const E = (w == null ? void 0 : w.system) ?? {}, P = (E.description ?? "").trim(), G = P ? P.length > 60 ? P.slice(0, 57) + "…" : P : "—";
      return {
        itemId: w.id,
        actorId: t.id,
        name: (w == null ? void 0 : w.name) ?? "—",
    ...
    e.egyebList = B.map((w) => {
      const P = (((w == null ? void 0 : w.system) ?? {}).description ?? "").trim(), G = P ? P.length > 80 ? P.slice(0, 77) + "…" : P : "";
      return {
        itemId: w.id,
        actorId: t.id,
        name: (w == null ? void 0 : w.name) ?? "—",
    ...
    const Y = ((ut = t == null ? void 0 : t.system) == null ? void 0 : ut.abilities) ?? {}, Z = l.filter((w) => w.type === "Kepesseg" || w.type === "ability").map((w) => {
      var E, P, G;
      return {
        id: w.id,
        name: w.name,
        img: w.img,
        description: ((E = w.system) == null ? void 0 : E.description) ?? "",
        kp: Number(((P = w.system) == null ? void 0 : P.kp) ?? 0) || 0,
        kind: (((G = w.system) == null ? void 0 : G.kind) ?? "passive").toString()
      };
    }), J = new Map(Z.map((w) => [w.id, w])), X = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const ce = t == null ? void 0 : t.id, ve = !!((mt = (dt = game.combat) == null ? void 0 : dt.combatants) != null && mt.some(
      (w) => {
        var E;
        return (((E = w.actor) == null ? void 0 : E.id) ?? w.actorId) === ce;
      }
    ));
    ...
    const T = ((pt = e.system) == null ? void 0 : pt.resources) ?? {}, x = (yt = (ft = e.system) == null ? void 0 : ft.combat) == null ? void 0 : yt.initiativeResult, V = typeof x == "number" ? x : -1, Q = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((w) => ({ min: Number(w.min) ?? 0, max: Number(w.max) ?? 0, kp: Math.min(10, Math.max(0, Number(w.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : Q).slice().sort((w, E) => w.min - E.min), ge = 3;
    let ue = le.length > 0 ? le : [];
    ue.length < ge && (ue = [...ue, ...Array(ge - ue.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ue.map((w, E) => ({
      ...w,
      isFirst: E === 0,
    ...
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      const w = ie[0], E = ie[ie.length - 1];
      let P = null;
      V <= w.max ? P = w : V >= E.min ? P = E : P = ie.find((G) => V >= G.min && V <= G.max), P && (Re = P.kp);
    }
    const He = ie.length > 0 ? ie[ie.length - 1] : null, tt = Math.min(10, He ? He.kp : 6), Pe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, tt)).map((w, E) => {
      const P = E + 1, G = !!Number(T[w]), ke = P <= Re;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BLlnCuDe.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BLlnCuDe.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-BLlnCuDe.mjs");
      d(this.actor, r, o);
      ...
      const i = (v = (g = a.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.area, r = (I = (k = a.currentTarget) == null ? void 0 : k.dataset) == null ? void 0 : I.itemId;
      ...
      if (!i || !this.actor) return;
      const r = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, d = ["slot1", "slot2", "slot3"].find((I) => {
        var D;
        return (((D = r[I]) == null ? void 0 : D.itemId) ?? "").trim() === i;
      });
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((I = e.system) == null ? void 0 : I.weapons) ?? {})[s] ?? {}, f = ((D = e.system) == null ? void 0 : D.skills) ?? {}, c = ((_ = e.items) == null ? void 0 : _.filter((j) => j.type === "Fegyver")) ?? [];
    let m = null;
    ...
    const { resultType: g, label: v } = Rt(h), k = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return h.toMessage({
  ...
  async _onDropItem(s, e) {
    var p, y, a, i, r, o, d, h, g, v, k, I, D, _, O, q, j, K, B;
    ...
    if (f.type === "Kepesseg" || f.type === "ability") {
      ...
      const Z = ((k = c.system) == null ? void 0 : k.abilities) ?? {}, J = R === "active" ? "active" : "passive", X = Array.isArray((I = Z[J]) == null ? void 0 : I.items) ? Z[J].items.slice() : Array.isArray(Z[J]) ? Z[J].slice() : [];
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, f = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, c = "— Nincs fegyver —", m = (((j = this.actor.items) == null ? void 0 : j.contents) ?? []).filter((T) => T.type === "Fegyver");
    ...
    const u = (((K = this.actor.items) == null ? void 0 : K.contents) ?? []).filter((T) => T.type === "Pancel");
    ...
    const p = (((R = this.actor.items) == null ? void 0 : R.contents) ?? []).filter((T) => T.type === "Targy");
    e.itemsTable = p.map((T) => {
    ...
    const y = (((Y = this.actor.items) == null ? void 0 : Y.contents) ?? []).filter((T) => T.type === "Jarmuegyseg").sort((T, x) => {
      const V = typeof T.sort == "number" ? T.sort : 0, Q = typeof x.sort == "number" ? x.sort : 0;
      return V - Q;
    }), a = [];
    let i = 0, r = 0, o = 0;
    const d = Number(((J = (Z = this.actor.system) == null ? void 0 : Z.vehicle) == null ? void 0 : J.storage) ?? 0) || 0;
    for (const T of y) {
    ...
    const h = y.length;
    let g = "Kicsi", v = 0, k = 0;
    h >= 11 ? (g = "Nagy", v = -4, k = -6) : h >= 6 ? (g = "Közepes", v = -2, k = -3) : (g = "Kicsi", v = 0, k = 0), e.sizeForSelect = g, e.sizeSpeedPenalty = v, e.sizeDefensePenalty = k;
    const I = i + v, D = r;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system ?? {}),
      {
        combat: { speed: I },
        vehicle: { toolsRange: D, storage: d },
        identity: { size: g }
      },
      { inplace: !1 }
    );
  ...
  _attachFrameListeners(s) {
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (u) => {
      ...
      const i = this.actor.items.contents.filter((I) => I.type === "Jarmuegyseg").sort((I, D) => {
        const _ = typeof I.sort == "number" ? I.sort : 0, O = typeof D.sort == "number" ? D.sort : 0;
        return _ - O;
      }).map((I) => I.id), r = i.indexOf(p), o = i.indexOf(l);
      if (r === -1 || o === -1) return;
      ...
      !y && p && (y = ((k = game.items) == null ? void 0 : k.get(p)) ?? null), (I = y == null ? void 0 : y.sheet) == null || I.render(!0);
    ...
    this._votvJarmuBlur = (u) => {
      ...
      if (r) {
        ...
        if (k <= 0)
          ...
          const D = i / k;
          D > 2 / 3 ? I = 3 : D > 1 / 3 ? I = 2 : I = 1;
        }
        I === void 0 ? r.removeAttribute("data-hp-status") : r.dataset.hpStatus = String(I);
      }
...
se(ye, "PARTS", foundry.utils.mergeObject(
  ...
  U(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Cs = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ls = (qs = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : qs.window) == null ? void 0 : Ls.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
se(qe, "PARTS", foundry.utils.mergeObject(U(qe, qe, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ns = U(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = qe;
var Fs;
...
se(Le, "PARTS", foundry.utils.mergeObject(U(Le, Le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Fs = U(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !1 })
}));
let zt = Le;
var As;
...
se(Ne, "PARTS", foundry.utils.mergeObject(U(Ne, Ne, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((As = U(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !1 })
}));
let Ut = Ne;
var Es;
const Fe = class Fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      try {
        ...
        const I = await fromUuid(k);
        if (console.log("VOTV JarmuEgysegSheet global drop doc=", I == null ? void 0 : I.id, I == null ? void 0 : I.type), !I || I.documentName !== "Item") return;
        if (I.type === "Kepesseg" || I.type === "ability") {
          const D = I.uuid ?? I.id, _ = this.document.system ?? {}, O = Array.isArray((o = _.abilities) == null ? void 0 : o.items) ? _.abilities.items.slice() : [];
      ...
      !o && r && (o = ((k = game.items) == null ? void 0 : k.get(r)) ?? null), (I = o == null ? void 0 : o.sheet) == null || I.render(!0);
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const r = St.getTotalSpeedRaw(i), o = (h = i.effects) == null ? void 0 : h.find((k) => k.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (r <= 0 && !o) {
        const k = ((v = (g = CONFIG.statusEffects) == null ? void 0 : g.find((I) => I.id === "immobilized")) == null ? void 0 : v.img) ?? "";
  ...
  const s = 500;
  Hooks.on("updateActor", (u, l, p, y) => {
    var I, D, _, O, q, j, K, B, R, Y, Z, J, X;
    const a = u == null ? void 0 : u.id;
    if (!a) return;
    if ((u.type === "Karakter" || u.type === "Npc") && ((I = l == null ? void 0 : l.system) != null && I.combat) && "initiativeResult" in l.system.combat) {
      const M = Number((_ = (D = u.system) == null ? void 0 : D.combat) == null ? void 0 : _.initiativeResult), W = Number.isFinite(M) ? M : 0, ce = game.combat;
      if (ce) {
    ...
    if (u.type === "Npc" && ((j = l == null ? void 0 : l.system) != null && j.identity) && "size" in l.system.identity) {
      const M = js((B = (K = u.system) == null ? void 0 : K.identity) == null ? void 0 : B.size);
      u.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, I, D, _, O, q, j, K, B, R, Y, Z, J, X, M, W, ce, ve, T, x;
    ...
    if (!n) return;
    const f = (v = game.messages) == null ? void 0 : v.get(n), c = (I = (k = f == null ? void 0 : f.flags) == null ? void 0 : k["vacuum-of-the-void"]) == null ? void 0 : I.weapon;
    if (!c) return;
    ...
    if (u || (u = ((j = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : j.flatMap((Q) => {
      var oe;
      return ((oe = Q.tokens) == null ? void 0 : oe.contents) ?? [];
    }).map((Q) => Q.actor).find((Q) => Q && (Q.id === m || Q.id === c.actorId))) ?? null), !u) return;
    const l = c.itemId ? ((B = (K = u.items) == null ? void 0 : K.get) == null ? void 0 : B.call(K, c.itemId)) ?? ((Z = (Y = (R = u.items) == null ? void 0 : R.contents) == null ? void 0 : Y.find) == null ? void 0 : Z.call(Y, (V) => V.id === c.itemId)) : null;
    let p = (c.damageFormula ?? "").trim();
    if (p || (p = (((J = l == null ? void 0 : l.system) == null ? void 0 : J.damage) ?? "").trim()), !p && c.slotKey && (p = (((((X = u.system) == null ? void 0 : X.weapons) ?? {})[c.slotKey] ?? {}).damage ?? "").trim()), !p) {
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = c.targetName || "", r = c.hitLocationName || "", o = ((l == null ? void 0 : l.name) ?? (c.slotKey ? ((x = (((T = u.system) == null ? void 0 : T.weapons) ?? {})[c.slotKey]) == null ? void 0 : x.name) ?? "" : "")) || "Fegyver";
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var l, p, y, a;
  const t = ((l = S.flags) == null ? void 0 : l["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, c = t.weaponAttack, m = t.weapon;
  if (!n && !f && !c) return;
  ...
  if (u) {
    ...
    if (c && m && (m.actorId || (y = S.speaker) != null && y.actor)) {
      ...
      if (m.isHit && !u.querySelector(".votv-weapon-damage-chat")) {
        ...
        h.textContent = g != null && v ? `Sebzés (Találati Hely ${g} - ${v})` : "Sebzés", h.dataset.actorId = String(m.actorId ?? ((a = S.speaker) == null ? void 0 : a.actor) ?? ""), h.dataset.itemId = String(m.itemId ?? ""), h.dataset.slotKey = String(m.slotKey ?? ""), h.dataset.targetName = String(m.targetName ?? ""), h.dataset.hitLocationName = String(m.hitLocationName ?? ""), h.dataset.messageId = String(S.id ?? ""), r.appendChild(h);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-Bt3dqHIu.mjs.map
