...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    if (p) {
      ...
      const d = document.activeElement, h = s.contains(d), v = d && (d.tagName === "INPUT" && d.type !== "checkbox" && d.type !== "radio" || d.tagName === "TEXTAREA");
      h && v && (n.focus = {
        name: d.name || null,
        id: d.id || null,
    ...
    const m = this.element, y = this.form ?? this.element, g = n.scrollState, a = n.focus, c = typeof (g == null ? void 0 : g.formScrollTop) == "number" || typeof (g == null ? void 0 : g.windowScrollTop) == "number", o = () => {
      var d, h;
      if (this._applyScrollState(m, g), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const v = ((d = y.querySelector) == null ? void 0 : d.call(y, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (h = y.querySelector) == null ? void 0 : h.call(y, `[name="${CSS.escape(a.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((c = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : c.resources) ?? {}, p = ((u = (o = r.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : u.value) ?? 0, s = ((d = r.currentHealth) == null ? void 0 : d.legs) ?? 0, n = N._healthStatusFromRatio(s, p), f = Number(((S = (v = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(i) {
    ...
    for (const l of n) {
      const I = ((Ne = p[l]) == null ? void 0 : Ne.value) ?? 0, w = s[l] ?? 0;
      e.computedHealthStatus[l] = N._healthStatusFromRatio(w, I);
    }
    const f = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((l) => (Number(s[l]) || 0) === 0).length;
    e.showDeathSkull = f || y >= 2;
    const g = e.computedHealthStatus.legs ?? 3, a = Number(((xe = ($e = this.actor.system) == null ? void 0 : $e.combat) == null ? void 0 : xe.givenSpeed) ?? 0) || 0;
    let c;
    g === 0 ? c = 0 : g === 1 ? c = -6 : g === 2 ? c = -3 : c = a;
    ...
    const h = N.BODY_PART_BY_SKILL;
    e.skillHealthStatus = {}, e.skillDisabled = {}, e.skillHasHealthTint = {};
    for (const [l, I] of Object.entries(h)) {
      const w = e.computedHealthStatus[I];
      e.skillHealthStatus[l] = w, e.skillDisabled[l] = w === 0 ? " disabled" : "", e.skillHasHealthTint[l] = !0;
    }
    const v = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (v.slotOrder ?? "").trim(), L = q ? q.split(/\s*,\s*/).filter((l) => S.includes(l)) : [], P = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = P && typeof P == "object" && !Array.isArray(P) ? P : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), A = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((l) => l.type !== "Kepesseg" && l.type !== "ability").slice().sort((l, I) => {
      const w = typeof l.sort == "number" ? l.sort : 0, T = typeof I.sort == "number" ? I.sort : 0;
      return w - T;
    }).map((l) => {
      var X, ee, te, Z, V, ae;
      const I = l.type === "Fegyver", w = l.type === "MikroChip";
      let T = 0, D = "", j = null;
      for (let ie = 0; ie < L.length; ie++) {
        const re = L[ie];
        if ((((X = v[re]) == null ? void 0 : X.itemId) ?? "") === l.id) {
          T = ie + 1, D = ((ee = v[re]) == null ? void 0 : ee.bonus) ?? "", j = re;
          break;
        }
      }
      let K = null;
      w && (k === l.id ? K = "slot1" : A === l.id ? K = "slot2" : x === l.id && (K = "slot3"));
      const ne = I && ((te = l.system) != null && te.damage) ? l.system.damage : "", Q = I && typeof ((Z = l.system) == null ? void 0 : Z.range) == "string" ? (l.system.range || "").trim() : "", J = j ? Number((V = v[j]) == null ? void 0 : V.bonus) || 0 : "";
      return {
        id: l.id,
        name: l.name,
        img: l.img,
    ...
    e.weaponItems = Se;
    const Te = "— Nincs fegyver —", pt = L.filter((l) => {
      const w = ((v[l] ?? {}).itemId ?? "").trim();
      return w ? !!ue.find((D) => D.id === w) : !1;
    });
    e.weaponSlots = pt.map((l, I) => {
      const w = v[l] ?? {}, T = (w.itemId ?? "").trim(), D = Se.find((j) => j.id === T);
      return {
        slotKey: l,
        itemId: T,
        slotNum: I + 1,
    ...
    e.weaponsTable = ue.map((l) => {
      ...
      const D = !!w, j = ((re = l.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = l.system) == null ? void 0 : Je.equipped) !== null ? !!l.system.equipped : D, K = (l == null ? void 0 : l.system) ?? {}, ne = typeof K.range == "string" ? (K.range || "").trim() : "", Q = K.type ?? "", J = (ft[Q] ?? Q) || "—", X = K.size ?? "", ee = (yt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = K.quantity, ae = V != null ? String(V).trim() : "1";
      return {
        slotKey: w ?? "",
        itemId: I,
    ...
    e.armorTable = gt.map((l) => {
      var T, D;
      const I = (l == null ? void 0 : l.system) ?? {}, w = ((T = l.system) == null ? void 0 : T.equipped) !== void 0 && ((D = l.system) == null ? void 0 : D.equipped) !== null ? !!l.system.equipped : !1;
      return {
        itemId: l.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = ht.map((l) => {
      const I = (l == null ? void 0 : l.system) ?? {}, w = (I.description ?? "").trim(), T = w ? w.length > 60 ? w.slice(0, 57) + "…" : w : "—", D = I.quantity != null ? String(I.quantity).trim() : "1";
      return {
        itemId: l.id,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const vt = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).filter((l) => l.type === "Egyeb");
    e.egyebList = vt.map((l) => {
      const w = (((l == null ? void 0 : l.system) ?? {}).description ?? "").trim(), T = w ? w.length > 80 ? w.slice(0, 77) + "…" : w : "";
      return {
        itemId: l.id,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const de = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).filter((l) => l.type === "MikroChip"), oe = de.map((l) => ({ id: l.id, name: l.name, img: l.img })), _e = "— Nincs Mikro-Chip —", qe = ["slot1", "slot2", "slot3"], me = (l) => {
      var w, T, D;
      const I = [];
      return l !== 1 && I.push((((w = O.slot1) == null ? void 0 : w.itemId) ?? "").trim()), l !== 2 && I.push((((T = O.slot2) == null ? void 0 : T.itemId) ?? "").trim()), l !== 3 && I.push((((D = O.slot3) == null ? void 0 : D.itemId) ?? "").trim()), I.filter(Boolean);
    };
    e.microchipItemsSlot1 = oe.filter((l) => !me(1).includes(l.id)), e.microchipItemsSlot2 = oe.filter((l) => !me(2).includes(l.id)), e.microchipItemsSlot3 = oe.filter((l) => !me(3).includes(l.id)), e.microchipSlots = qe.map((l) => {
      const I = O[l] ?? {}, w = (I.itemId ?? "").trim(), T = de.find((D) => D.id === w);
      return {
        slotKey: l,
        itemId: w,
      ...
      const I = `slot${l}`, w = O[I] ?? {}, T = (w.itemId ?? "").trim(), D = oe.find((j) => j.id === T);
      e[`microchip${l}ItemId`] = T, e[`microchip${l}DisplayName`] = (D == null ? void 0 : D.name) || w.name || _e, e[`microchip${l}Img`] = (D == null ? void 0 : D.img) || "";
      ...
      const T = !!w, D = ((ee = l == null ? void 0 : l.system) == null ? void 0 : ee.abilityType) ?? "", j = D === "active" ? "Aktív" : D === "passive" ? "Passzív" : D || "—", K = D === "active", ne = Number((te = l == null ? void 0 : l.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(l.system.replaceCost) : 0, Q = (((Z = l == null ? void 0 : l.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const Oe = this.actor.system.abilities ?? {}, bt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((l) => {
      var I, w, T;
      return {
        id: l.id,
        name: l.name,
        ...
        description: ((w = l.system) == null ? void 0 : w.description) ?? "",
        kp: Number(((T = l.system) == null ? void 0 : T.kp) ?? 0) || 0
      };
    }), De = new Map(bt.map((l) => [l.id, l])), kt = "— Nincs képesség —", Ce = (l) => {
      const I = Oe[l] ?? {}, w = (I.itemId ?? "").trim(), T = w ? De.get(w) : null, D = (T == null ? void 0 : T.description) ?? "", j = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: w,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-CGAUjVC2.mjs");
      u(this.actor, o);
      ...
      if (!o) {
        ...
        if (!v) return;
        o = (((((d = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : d.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      o && await this._rollWeaponDamage(o, ((h = c.dataset.slot) == null ? void 0 : h.trim()) ?? "");
    }), !this.isEditable) return;
    const r = (a) => {
      var u;
      const c = a ? a.currentTarget : (u = e.querySelector) == null ? void 0 : u.call(e, 'input[name="system.resources.stress.value"]');
      if (!c) return;
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var h;
      a.preventDefault();
      const c = a.currentTarget, o = c.dataset.skill, u = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: d } = await import("./roll-sheet-CGAUjVC2.mjs");
      d(this.actor, o, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o) return;
      const u = this.actor, d = u.items.get(o), h = {};
      if ((d == null ? void 0 : d.type) === "Fegyver") {
        ...
        if (P) {
          ...
          h["system.weapons.slotOrder"] = O.join(","), h[`system.weapons.${P}.itemId`] = "", h[`system.weapons.${P}.name`] = "", h[`system.weapons.${P}.damage`] = "", h[`system.weapons.${P}.bonus`] = "";
        }
      }
      Object.keys(h).length && await u.update(h), await u.deleteEmbeddedDocuments("Item", [o]);
      ...
      const d = this.actor.system.weapons ?? {}, h = (d.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = h ? h.split(/\s*,\s*/).filter((k) => v.includes(k)) : [], q = S.find((k) => {
        var A;
      ...
      const o = c.closest(".karakter-microchip-slot-select-wrap"), u = o == null ? void 0 : o.classList.contains("karakter-microchip-slot-open");
      ...
      var k;
      a.preventDefault();
      const c = a.currentTarget, o = c.closest(".karakter-microchip-slot-select-wrap"), u = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), d = u == null ? void 0 : u.dataset.slot;
      if (!d) return;
      const h = (c.dataset.itemId ?? "").trim(), v = (c.dataset.itemName ?? ((k = c.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (c.dataset.itemImg ?? "").trim(), q = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      q && (q.textContent = v);
      let L = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      S ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", u == null || u.insertBefore(L, q)), L.src = S, L.style.display = "") : L && L.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const P = h ? this.actor.items.get(h) : null, O = {
        [`system.gear.microchips.${d}.itemId`]: h,
        [`system.gear.microchips.${d}.name`]: (P == null ? void 0 : P.name) ?? ""
      };
      h && (O[`system.gear.microchips.${d}.active`] = !0), await this.actor.update(O);
      ...
      const u = ((S = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : S.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((q) => {
        var L;
      ...
      c.addEventListener("dragover", (u) => this._onMicrochipSlotDragOver(u, o)), c.addEventListener("dragleave", (u) => {
        var d;
        return (d = u.currentTarget) == null ? void 0 : d.classList.remove("karakter-microchip-slot-drag-over");
      }), c.addEventListener("drop", (u) => this._onMicrochipSlotDrop(u, o));
    }), t.find(".karakter-ability-slot-single").each((a, c) => {
      const o = c.dataset.slot;
      o && (c.addEventListener("dragover", (u) => this._onAbilitySingleDragOver(u, o)), c.addEventListener("dragleave", (u) => {
        var d;
      ...
      o && (c.addEventListener("dragover", (u) => this._onAbilityAreaDragOver(u, o)), c.addEventListener("dragleave", (u) => {
        var d;
      ...
      if (!c || !o) return;
      const u = this.actor.system.abilities ?? {}, h = (Array.isArray((v = u[c]) == null ? void 0 : v.items) ? u[c].items.slice() : []).filter((S) => S !== o);
    ...
    const n = this, f = (a) => {
      ...
      const o = ((d = (u = c.system) == null ? void 0 : u.resources) == null ? void 0 : d.currentHealth) != null || ((v = (h = c.system) == null ? void 0 : h.resources) == null ? void 0 : v.hitLocations) != null;
      n.actor.update(c).then(() => {
        o && setTimeout(() => n.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, m = (a) => {
      var c, o, u;
      return a && (((o = (c = n.element) == null ? void 0 : c.contains) == null ? void 0 : o.call(c, a)) || n.id && ((u = a.closest) == null ? void 0 : u.call(a, `#${CSS.escape(n.id)}`)));
    };
    n._votvBlur = (a) => {
      const c = a.target;
      if (!c || !c.form) return;
      ...
      const u = c.form;
      m(u) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: n.id, at: Date.now() }), f(u));
  ...
  _getFormDataForUpdate(i) {
    ...
    for (const y of s) {
      const g = ((m = r[y]) == null ? void 0 : m.value) ?? 0, a = p[y] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, N._healthStatusFromRatio(a, g));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, r, p, s, n, f, m, y, g, a, c, o;
    if (e) {
      ...
      if (u) {
        ...
        if (d && d.documentName === "Item" && (d.type === "Kepesseg" || d.type === "ability")) {
          ...
          if (((r = d.parent) == null ? void 0 : r.id) !== this.actor.id) {
            ...
            h = ((p = (await this.actor.createEmbeddedDocuments("Item", [P]))[0]) == null ? void 0 : p.id) ?? h;
          }
          ...
          L.includes(h) || L.push(h), await this.actor.update({ [`system.abilities.${q}.items`]: L });
          return;
        }
      }
    }
    if (e) {
      let u = e.uuid ?? e.documentUuid ?? ((f = e.data) == null ? void 0 : f.uuid) ?? (typeof e == "string" ? e : null);
      if (!u && typeof e == "object") {
        for (const d of Object.values(e))
          if (typeof d == "string" && d.includes(".") && d.startsWith("Item.")) {
            u = d;
      ...
      if (u) {
        ...
        if (d && d.documentName === "Item" && d.type === "Fegyver") {
          const h = this.actor, v = ((m = d.parent) == null ? void 0 : m.id) !== h.id;
          let S = d.id;
          if (v) {
            const q = foundry.utils.mergeObject(d.toObject(), { system: { ...d.toObject().system ?? {}, equipped: !1 } });
            S = ((y = (await h.createEmbeddedDocuments("Item", [q]))[0]) == null ? void 0 : y.id) ?? S;
          }
          if (v) {
            const q = ((g = h.system) == null ? void 0 : g.weapons) ?? {}, L = (q.slotOrder ?? "").trim(), P = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = L ? L.split(/\s*,\s*/).filter((A) => P.includes(A)) : [], k = O.filter((A) => {
              var x;
        ...
        if (d && d.documentName === "Item" && d.type === "Pancel") {
          const h = this.actor;
          if (((a = d.parent) == null ? void 0 : a.id) !== h.id) {
        ...
        if (d && d.documentName === "Item" && d.type === "MikroChip") {
          const h = this.actor;
          ((c = d.parent) == null ? void 0 : c.id) !== h.id && await h.createEmbeddedDocuments("Item", [d.toObject()]);
          return;
        }
        if (d && d.documentName === "Item" && (d.type === "Targy" || d.type === "Egyeb")) {
          const h = this.actor;
          ((o = d.parent) == null ? void 0 : o.id) !== h.id && await h.createEmbeddedDocuments("Item", [d.toObject()]);
          return;
        }
      }
    }
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const p = this.actor.items.contents.slice().sort((g, a) => {
      const c = typeof g.sort == "number" ? g.sort : 0, o = typeof a.sort == "number" ? a.sort : 0;
      return c - o;
    }).map((g) => g.id), s = p.indexOf(t), n = p.indexOf(e);
    if (s === -1 || n === -1) return;
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, p = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", n = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", f = p ? `<p>${p}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    const s = this.actor.system.abilities ?? {}, n = Array.isArray((g = s[e]) == null ? void 0 : g.items) ? s[e].items.slice() : Array.isArray(s[e]) ? s[e].slice() : [];
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let s = p.id;
    ((y = p.parent) == null ? void 0 : y.id) !== this.actor.id && (s = ((g = (await this.actor.createEmbeddedDocuments("Item", [p.toObject()]))[0]) == null ? void 0 : g.id) ?? s), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    const y = m.total >= 18 ? "critical" : m.total <= 3 ? "fumble" : null, g = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    ...
    const n = s && s.name || t.name || `Fegyver (${i})`, f = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", g = Number(r[y] || 0) || 0, a = f + g, o = `3d6${a !== 0 ? a > 0 ? `+${a}` : `${a}` : ""}`, u = new Roll(o);
    await u.evaluate({ async: !0 });
    const d = u.total >= 18 ? "critical" : u.total <= 3 ? "fumble" : null, h = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${n} – találat`,
  ...
  async _rollWeaponDamage(i, e = "") {
    var f, m, y, g, a, c, o, u, d, h;
    const t = this.actor;
    if (!t) return;
    let r = ((m = (f = t.items).get) == null ? void 0 : m.call(f, i)) ?? ((g = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : g.call(y, (v) => v.id === i));
    ...
    if (!p && e && (p = (((((c = t.system) == null ? void 0 : c.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !p) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((d = (u = game.i18n) == null ? void 0 : u.localize) == null ? void 0 : d.call(u, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const s = new Roll(p);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var m, y, g, a, c, o, u;
      if (!e.isEditable || !((y = (m = s.target) == null ? void 0 : m.closest) != null && y.call(m, ".profile")) && ((a = (g = s.target) == null ? void 0 : g.getAttribute) == null ? void 0 : a.call(g, "data-edit")) !== "img") return;
      s.preventDefault(), s.stopPropagation();
      const n = ((u = (o = (c = foundry.applications) == null ? void 0 : c.apps) == null ? void 0 : o.FilePicker) == null ? void 0 : u.implementation) ?? globalThis.FilePicker;
      new n({
        type: "image",
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var f, m, y, g;
      if (!e.isEditable || !((m = (f = s.target) == null ? void 0 : f.closest) != null && m.call(f, ".profile")) && ((g = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : g.call(y, "data-edit")) !== "img") return;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (s, n, f, m) => {
    ...
    if (!y) return;
    const g = document.activeElement, a = g && (g.tagName === "INPUT" && g.type !== "checkbox" && g.type !== "radio" || g.tagName === "TEXTAREA" || g.isContentEditable), c = [], o = (S = game.actors) == null ? void 0 : S.get(y);
    ...
    const h = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < F ? h.appId : null;
    setTimeout(() => {
      for (const k of c)
...
//# sourceMappingURL=vacuum-of-the-void-C_VD7UqP.mjs.map
