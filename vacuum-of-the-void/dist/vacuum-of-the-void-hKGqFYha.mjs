...
function ft(R) {
  ...
  const d = (i, a = 1) => {
    ...
    for (const o of i) {
      ...
      const v = !r && c >= 0 && (o.number === 3 || o.number === "3") ? (r = !0, s) : c >= 0 ? e : t;
      for (const w of g) {
  ...
  d(R.terms, 1);
  const n = s.filter((i) => i === 6).length, l = s.filter((i) => i === 1).length, y = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, f = n + y, h = l + m;
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const u = document.activeElement, g = n.contains(u), v = u && (u.tagName === "INPUT" && u.type !== "checkbox" && u.type !== "radio" || u.tagName === "TEXTAREA");
      g && v && (l.focus = {
        name: u.name || null,
        id: u.id || null,
    ...
    const m = this.element, f = this.form ?? this.element, h = l.scrollState, i = l.focus, a = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", c = () => {
      var u, g;
      if (this._applyScrollState(m, h), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const v = ((u = f.querySelector) == null ? void 0 : u.call(f, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (g = f.querySelector) == null ? void 0 : g.call(f, `[name="${CSS.escape(i.name)}"]`) : null);
    ...
    return (a || i) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), y;
  }
  /**
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const n of s) {
      const l = String(((d = n.system) == null ? void 0 : d.speedPenalty) ?? "").trim().replace(",", "."), y = Number(l);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const n of s) {
      const l = String(((d = n.system) == null ? void 0 : d.protectionBonus) ?? "").trim().replace(",", "."), y = Number(l);
      Number.isFinite(y) && (e += y);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, a, c, o, u, g, v, w;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const r = ((a = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, d = ((o = (c = r.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((u = r.currentHealth) == null ? void 0 : u.legs) ?? 0, l = U._healthStatusFromRatio(n, d), y = Number(((w = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let m;
    l === 0 ? m = 0 : l === 1 ? m = -6 : l === 2 ? m = -3 : m = y;
  ...
  _writeEffectiveGivenProtection(s = null) {
    ...
    const d = (Number(((m = (y = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : y.combat) == null ? void 0 : m.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, r = ((y = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : y.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const r = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (y = r.hitLocations) == null ? void 0 : y[t]) == null ? void 0 : m.value) ?? 0, n = ((f = r.currentHealth) == null ? void 0 : f[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    const y = (Number(n.head) || 0) === 0, f = ["torso", "arms", "legs"].filter((p) => (Number(n[p]) || 0) === 0).length;
    e.showDeathSkull = y || f >= 2;
    ...
    for (const [p, O] of Object.entries(g)) {
      const T = e.computedHealthStatus[O];
      e.skillHealthStatus[p] = T, e.skillDisabled[p] = T === 0 ? " disabled" : "", e.skillHasHealthTint[p] = !0;
    }
    const v = this.actor.system.weapons ?? {}, w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (v.slotOrder ?? "").trim(), D = S ? S.split(/\s*,\s*/).filter((p) => w.includes(p)) : [], L = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, _ = L && typeof L == "object" && !Array.isArray(L) ? L : {}, k = (((Ze = _.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), q = (((Ve = _.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), F = (((et = _.slot3) == null ? void 0 : et.itemId) ?? "").trim(), B = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, O) => {
      ...
      for (let Ie = 0; Ie < D.length; Ie++) {
        const _e = D[Ie];
        if ((((ce = v[_e]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          C = Ie + 1, N = ((he = v[_e]) == null ? void 0 : he.bonus) ?? "", Y = _e;
          break;
        }
      }
      let W = null;
      T && (k === p.id ? W = "slot1" : q === p.id ? W = "slot2" : F === p.id && (W = "slot3"));
    ...
    e.weaponItems = ne;
    const Q = "— Nincs fegyver —", me = D.filter((p) => {
      const T = ((v[p] ?? {}).itemId ?? "").trim();
      return T ? !!H.find((N) => N.id === T) : !1;
    });
    e.weaponSlots = me.map((p, O) => {
      const T = v[p] ?? {}, C = (T.itemId ?? "").trim(), N = ne.find((Y) => Y.id === C);
      return {
        slotKey: p,
        itemId: C,
        slotNum: O + 1,
    ...
    const De = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, qe = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((p) => {
      ...
      const N = !!T, Y = ((ct = p.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = p.system) == null ? void 0 : lt.equipped) !== null ? !!p.system.equipped : N, W = (p == null ? void 0 : p.system) ?? {}, Te = typeof W.range == "string" ? (W.range || "").trim() : "", Z = W.type ?? "", ge = (De[Z] ?? Z) || "—", ce = W.size ?? "", he = (qe[ce] ?? ce) || "", be = [ge, he].filter(Boolean).join(", ") || ge || "—", ue = Z === "projectile" || ce === "thrown", de = W.quantity, Oe = de != null ? String(de).trim() : "1", Ie = String(C.bonus ?? "").trim(), _e = String(W.bonus ?? "").trim(), Lt = Ie || _e || "0";
      return {
        slotKey: T ?? "",
        itemId: O,
    ...
    e.armorTable = Ce.map((p) => {
      var C, N;
      const O = (p == null ? void 0 : p.system) ?? {}, T = ((C = p.system) == null ? void 0 : C.equipped) !== void 0 && ((N = p.system) == null ? void 0 : N.equipped) !== null ? !!p.system.equipped : !1;
      return {
        itemId: p.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = b.map((p) => {
      const O = (p == null ? void 0 : p.system) ?? {}, T = (O.description ?? "").trim(), C = T ? T.length > 60 ? T.slice(0, 57) + "…" : T : "—", N = O.quantity != null ? String(O.quantity).trim() : "1";
      return {
        itemId: p.id,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const A = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), M = A.map((p) => ({ id: p.id, name: p.name, img: p.img })), le = "— Nincs Mikro-Chip —", G = ["slot1", "slot2", "slot3"], pe = (p) => {
      var T, C, N;
      const O = [];
      return p !== 1 && O.push((((T = _.slot1) == null ? void 0 : T.itemId) ?? "").trim()), p !== 2 && O.push((((C = _.slot2) == null ? void 0 : C.itemId) ?? "").trim()), p !== 3 && O.push((((N = _.slot3) == null ? void 0 : N.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = M.filter((p) => !pe(1).includes(p.id)), e.microchipItemsSlot2 = M.filter((p) => !pe(2).includes(p.id)), e.microchipItemsSlot3 = M.filter((p) => !pe(3).includes(p.id)), e.microchipSlots = G.map((p) => {
      const O = _[p] ?? {}, T = (O.itemId ?? "").trim(), C = A.find((N) => N.id === T);
      return {
        slotKey: p,
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || O.name || le,
        img: (C == null ? void 0 : C.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((p) => {
      const O = `slot${p}`, T = _[O] ?? {}, C = (T.itemId ?? "").trim(), N = M.find((Y) => Y.id === C);
      e[`microchip${p}ItemId`] = C, e[`microchip${p}DisplayName`] = (N == null ? void 0 : N.name) || T.name || le, e[`microchip${p}Img`] = (N == null ? void 0 : N.img) || "";
      ...
      const C = !!T, N = ((he = p == null ? void 0 : p.system) == null ? void 0 : he.abilityType) ?? "", Y = N === "active" ? "Aktív" : N === "passive" ? "Passzív" : N || "—", W = N === "active", Te = Number((be = p == null ? void 0 : p.system) == null ? void 0 : be.replaceCost) >= 0 ? Number(p.system.replaceCost) : 0, Z = (((ue = p == null ? void 0 : p.system) == null ? void 0 : ue.description) ?? "").trim(), ge = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const ae = this.actor.system.abilities ?? {}, fe = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      ...
      const O = ae[p] ?? {}, T = (O.itemId ?? "").trim(), C = T ? oe.get(T) : null, N = (C == null ? void 0 : C.description) ?? "", Y = (C == null ? void 0 : C.kp) ?? 0;
      return {
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || O.name || ke,
        img: (C == null ? void 0 : C.img) || "",
        description: N,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CYxatSwd.mjs");
      o(this.actor, c);
      ...
      if (!c) {
        ...
        if (!v) return;
        c = (((((u = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : u.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c, ((g = a.dataset.slot) == null ? void 0 : g.trim()) ?? "");
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var o, u, g;
      i.preventDefault(), i.stopPropagation();
      const a = ((g = (u = (o = foundry.applications) == null ? void 0 : o.apps) == null ? void 0 : u.FilePicker) == null ? void 0 : g.implementation) ?? globalThis.FilePicker;
      new a({
        type: "image",
      ...
      var g;
      i.preventDefault();
      const a = i.currentTarget, c = a.dataset.skill, o = ((g = a.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-CYxatSwd.mjs");
      u(this.actor, c, o);
      ...
      if (!g) return;
      const v = ((L = (D = this.actor.items).get) == null ? void 0 : L.call(D, g)) ?? ((k = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : k.call(_, (F) => F.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const v = o.system.weapons ?? {}, w = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = w ? w.split(/\s*,\s*/).filter((_) => S.includes(_)) : [], L = D.find((_) => {
          var k;
          return (((k = v[_]) == null ? void 0 : k.itemId) ?? "").trim() === c;
        });
        if (L) {
          const _ = D.filter((k) => k !== L);
          g["system.weapons.slotOrder"] = _.join(","), g[`system.weapons.${L}.itemId`] = "", g[`system.weapons.${L}.name`] = "", g[`system.weapons.${L}.damage`] = "", g[`system.weapons.${L}.bonus`] = "";
        }
      }
      ...
      const u = this.actor.system.weapons ?? {}, g = (u.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], w = g ? g.split(/\s*,\s*/).filter((k) => v.includes(k)) : [], S = w.find((k) => {
        var q;
        return (((q = u[k]) == null ? void 0 : q.itemId) ?? "").trim() === c;
      }) ?? null;
      if (a.checked) {
        if (S) return;
        let k = w.find((F) => {
      ...
      var k;
      i.preventDefault();
      const a = i.currentTarget, c = a.closest(".karakter-microchip-slot-select-wrap"), o = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), u = o == null ? void 0 : o.dataset.slot;
      if (!u) return;
      const g = (a.dataset.itemId ?? "").trim(), v = (a.dataset.itemName ?? ((k = a.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", w = (a.dataset.itemImg ?? "").trim(), S = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      let D = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      w ? (D || (D = document.createElement("img"), D.className = "karakter-microchip-slot-thumb", D.alt = "", o == null || o.insertBefore(D, S)), D.src = w, D.style.display = "") : D && D.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      const L = g ? this.actor.items.get(g) : null, _ = {
        [`system.gear.microchips.${u}.itemId`]: g,
        [`system.gear.microchips.${u}.name`]: (L == null ? void 0 : L.name) ?? ""
      };
      g && (_[`system.gear.microchips.${u}.active`] = !0), await this.actor.update(_);
      ...
      const o = ((w = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : w.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((S) => {
        var D;
        return (((D = o[S]) == null ? void 0 : D.itemId) ?? "").trim() === a;
      });
      ...
      if (!a || !c) return;
      const o = this.actor.system.abilities ?? {}, g = (Array.isArray((v = o[a]) == null ? void 0 : v.items) ? o[a].items.slice() : []).filter((w) => w !== c);
      ...
      if (a.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${k}.damage`]: ((L = o.system) == null ? void 0 : L.damage) ?? "",
    ...
    const l = this, y = (i) => {
      ...
      const c = ((u = (o = a.system) == null ? void 0 : o.resources) == null ? void 0 : u.currentHealth) != null || ((v = (g = a.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      l.actor.update(a).then(() => {
        c && setTimeout(() => l.render(!0), 260);
      }).catch((w) => console.warn("VoidKarakterSheet save failed", w));
    }, m = (i) => {
      var a, c, o;
      return i && (((c = (a = l.element) == null ? void 0 : a.contains) == null ? void 0 : c.call(a, i)) || l.id && ((o = i.closest) == null ? void 0 : o.call(i, `#${CSS.escape(l.id)}`)));
    };
    l._votvBlur = (i) => {
      var g;
      const a = i.target;
      ...
      u && (o.contains(u) || l.id && ((g = u.closest) != null && g.call(u, `#${CSS.escape(l.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: l.id, at: Date.now() }), y(o));
      ...
      if (o) {
        ...
        if (u && u.documentName === "Item" && (u.type === "Kepesseg" || u.type === "ability")) {
          ...
          if (((r = u.parent) == null ? void 0 : r.id) !== this.actor.id) {
            ...
            g = ((d = (await this.actor.createEmbeddedDocuments("Item", [L]))[0]) == null ? void 0 : d.id) ?? g;
          }
          const v = (((n = u.system) == null ? void 0 : n.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (v === "species") {
            await this.actor.update({
          ...
          const S = v === "active" ? "active" : "passive", D = Array.isArray((l = w[S]) == null ? void 0 : l.items) ? w[S].items.slice() : Array.isArray(w[S]) ? w[S].slice() : [];
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (u && u.documentName === "Item" && u.type === "Fegyver") {
          const g = this.actor, v = ((m = u.parent) == null ? void 0 : m.id) !== g.id;
          let w = u.id;
          if (v) {
          ...
          if (v) {
            const S = ((h = g.system) == null ? void 0 : h.weapons) ?? {}, D = (S.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = D ? D.split(/\s*,\s*/).filter((q) => L.includes(q)) : [], k = _.filter((q) => {
              var F;
              return (((F = S[q]) == null ? void 0 : F.itemId) ?? "").trim() === w;
            });
            if (k.length > 0) {
              const F = {
        ...
        if (u && u.documentName === "Item" && u.type === "Pancel") {
          const g = this.actor;
          if (((i = u.parent) == null ? void 0 : i.id) !== g.id) {
        ...
        if (u && u.documentName === "Item" && u.type === "MikroChip") {
          const g = this.actor;
          ((a = u.parent) == null ? void 0 : a.id) !== g.id && await g.createEmbeddedDocuments("Item", [u.toObject()]);
          return;
        }
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((f = e.system) == null ? void 0 : f.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", y = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const l = n && n.name || t.name || `Fegyver (${s})`, y = Number(t.bonus || 0) || 0, f = (((w = n == null ? void 0 : n.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[f] || 0) || 0, i = y + h, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, o = new Roll(c);
    await o.evaluate({ async: !0 });
    const { resultType: u, label: g } = ft(o), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    var y, m, f, h, i, a, c, o, u, g;
    const t = this.actor;
    if (!t) return;
    let r = ((m = (y = t.items).get) == null ? void 0 : m.call(y, s)) ?? ((h = (f = t.items.contents) == null ? void 0 : f.find) == null ? void 0 : h.call(f, (v) => v.id === s));
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const n = await super.render(s, e), l = this.element, y = this.form ?? this.element, m = d.scrollState, f = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var a, c;
      if (this._applyScrollState(l, m), (f == null ? void 0 : f.name) != null || (f == null ? void 0 : f.id) != null) {
        const o = ((a = y.querySelector) == null ? void 0 : a.call(y, f.id ? `#${CSS.escape(f.id)}` : null)) ?? (f.name ? (c = y.querySelector) == null ? void 0 : c.call(y, `[name="${CSS.escape(f.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    ...
    const u = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, g = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = m.map((b) => {
      ...
      const le = !!A, G = (b == null ? void 0 : b.system) ?? {}, pe = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", fe = (u[ae] ?? ae) || "—", oe = G.size ?? "", ke = (g[oe] ?? oe) || "", ye = [fe, ke].filter(Boolean).join(", ") || fe || "—", Le = ae === "projectile" || oe === "thrown", Pe = G.quantity != null ? String(G.quantity).trim() : "1", Ae = String(M.bonus ?? G.bonus ?? "").trim() || "0";
      return {
        slotKey: A ?? "",
        itemId: E,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? h,
    ...
    const w = ((qe = (De = t == null ? void 0 : t.system) == null ? void 0 : De.gear) == null ? void 0 : qe.microchips) ?? {}, S = ["slot1", "slot2", "slot3"], D = r.filter((b) => b.type === "MikroChip");
    e.microchipsTable = D.map((b) => {
      var ae, fe, oe, ke;
      const E = b.id;
      let A = null;
      for (const ye of S)
        if ((((ae = w[ye]) == null ? void 0 : ae.itemId) ?? "").trim() === E) {
          A = ye;
          break;
        }
    ...
    const k = ((Ce = t == null ? void 0 : t.system) == null ? void 0 : Ce.abilities) ?? {}, q = r.filter((b) => b.type === "Kepesseg" || b.type === "ability").map((b) => {
      var E, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), F = new Map(q.map((b) => [b.id, b])), j = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var o, u, g;
      i.preventDefault();
      const a = (u = (o = i.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : u.itemId;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var g, v, w, S, D, L, _, k, q;
      i.preventDefault();
      const a = (v = (g = i.currentTarget) == null ? void 0 : g.closest) == null ? void 0 : v.call(g, ".karakter-weapon-slot"), c = (w = a == null ? void 0 : a.dataset) == null ? void 0 : w.slot, o = ((S = a == null ? void 0 : a.dataset) == null ? void 0 : S.itemId) ?? (((k = (_ = (L = (D = this.actor) == null ? void 0 : D.system) == null ? void 0 : L.weapons) == null ? void 0 : _[c]) == null ? void 0 : k.itemId) ?? "").trim();
      if (!o || !this.actor) return;
      const u = this.actor.items.get(o);
      (q = u == null ? void 0 : u.sheet) == null || q.render(!0);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
      ...
      var v, w, S, D, L, _;
      if (i.preventDefault(), !i.altKey) return;
      const a = (w = (v = i.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : w.area, c = (D = (S = i.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : D.itemId;
      if (!a || !c || !this.actor) return;
      const o = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, g = (Array.isArray((_ = o[a]) == null ? void 0 : _.items) ? o[a].items.slice() : []).filter((k) => k !== c);
      await this.actor.update({ [`system.abilities.${a}.items`]: g }), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-ability-slot-clear", async (i) => {
      var c, o;
      if (i.preventDefault(), !i.altKey) return;
    ...
    (h = (f = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : f.call(e, d)) == null || h.forEach((i) => {
      ...
      var g, v, w;
      const a = i.currentTarget, c = (v = (g = a == null ? void 0 : a.dataset) == null ? void 0 : g.itemId) == null ? void 0 : v.trim();
      if (!c || !this.actor) return;
      const o = this.actor.items.get(c);
      if (!o) return;
      const u = o.uuid;
      i.dataTransfer && (i.dataTransfer.setData("text/plain", u), i.dataTransfer.setData("application/json", JSON.stringify({ type: "Item", uuid: u })), i.dataTransfer.effectAllowed = "copyMove"), typeof ((w = i.dataTransfer) == null ? void 0 : w.setDragImage) == "function" && a && i.dataTransfer.setDragImage(a, 0, 0);
    });
    const n = this, l = (i) => {
      if (!i) return;
    ...
    n._votvNpcBlur = (i) => {
      ...
      if (!y(o)) return;
      const u = i.relatedTarget;
      u && (o.contains(u) || n.id && ((g = u.closest) != null && g.call(u, `#${CSS.escape(n.id)}`))) || l(o);
  ...
  async _onDropItem(s, e) {
    var f, h, i, a, c, o, u, g, v, w, S, D, L, _, k;
    if (!this.actor) return (f = super._onDropItem) == null ? void 0 : f.call(this, s, e);
    const r = ((q) => {
      var j;
      if (!q) return null;
      const F = q.uuid ?? q.documentUuid ?? ((j = q.data) == null ? void 0 : j.uuid) ?? (typeof q == "string" ? q : null);
      if (F) return F;
      if (typeof q == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((a = d.parent) == null ? void 0 : a.id) !== n.id) {
        ...
        q = ((c = (await n.createEmbeddedDocuments("Item", [ne]))[0]) == null ? void 0 : c.id) ?? q;
      }
      const F = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), j = ((u = n.system) == null ? void 0 : u.abilities) ?? {}, B = F === "active" ? "active" : "passive", H = Array.isArray((g = j[B]) == null ? void 0 : g.items) ? j[B].items.slice() : Array.isArray(j[B]) ? j[B].slice() : [];
    ...
    const m = (w = (await n.createEmbeddedDocuments("Item", [l]))[0]) == null ? void 0 : w.id;
    if (d.type === "Fegyver" && m) {
      const q = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, F = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (q.slotOrder ?? "").trim(), B = j ? j.split(/\s*,\s*/).filter((Q) => F.includes(Q)) : [];
      let H = F.find((Q) => {
        var me;
        return !(((me = q[Q]) == null ? void 0 : me.itemId) ?? "").trim();
      });
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", r = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, d = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", y = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${n}</p>
      ${l}
      ${y}
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (n) => {
      ...
      const l = ((o = (c = (a = foundry.applications) == null ? void 0 : a.apps) == null ? void 0 : c.FilePicker) == null ? void 0 : o.implementation) ?? globalThis.FilePicker;
      new l({
        type: "image",
    ...
    const r = (n) => {
      ...
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidWeaponSheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (n) => {
      var y, m, f;
      const l = ((y = n.target) == null ? void 0 : y.form) ?? ((f = (m = n.target) == null ? void 0 : m.closest) == null ? void 0 : f.call(m, "form"));
      d(l) && r(l);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidShieldSheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidMicrochipSheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidAbilitySheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (n) => {
      ...
      const y = (l == null ? void 0 : l.form) ?? ((m = l == null ? void 0 : l.closest) == null ? void 0 : m.call(l, "form"));
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidTargySheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
...
z(ie, "PARTS", foundry.utils.mergeObject(K(ie, ie, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Dt = K(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !1 })
}));
let He = ie;
var qt;
const re = class re extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((y) => console.warn("VoidEgyebSheet save failed", y));
    }, d = (n) => {
      var l, y, m;
      return n && (((y = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : y.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
...
Hooks.once("init", () => {
  ...
  const R = 500;
  Hooks.on("updateActor", (n, l, y, m) => {
    var w, S, D, L, _;
    const f = n == null ? void 0 : n.id;
    if (!f) return;
    const h = document.activeElement, i = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), a = [], c = (w = game.actors) == null ? void 0 : w.get(f);
    c != null && c.apps && a.push(...Array.from(c.apps));
    const o = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const k of o)
      ((S = k.document) == null ? void 0 : S.id) !== f || ((D = k.document) == null ? void 0 : D.documentName) !== "Actor" || ((L = k.constructor) == null ? void 0 : L.name) !== "VoidKarakterSheet" || a.includes(k) || a.push(k);
    if (i && a.some((k) => {
      const q = (k == null ? void 0 : k.form) ?? (k == null ? void 0 : k.element);
      return q && q.contains(h);
    })) return;
    const g = (_ = game.votv) == null ? void 0 : _._lastKarakterSheetBlurSave, v = g && Date.now() - g.at < R ? g.appId : null;
    setTimeout(() => {
      for (const k of a)
        !(k != null && k.rendered) || typeof k.render != "function" || k.id !== v && k.render(!0);
    }, 0);
  }), Hooks.on("updateItem", (n, l, y, m) => {
    var a, c, o;
    ...
    for (const [u, g] of Object.entries(h)) {
      ...
      const v = ((g == null ? void 0 : g.itemId) ?? "").trim();
      !v || v !== n.id || (i[`system.weapons.${u}.name`] = n.name ?? "", i[`system.weapons.${u}.damage`] = ((c = n.system) == null ? void 0 : c.damage) ?? "", i[`system.weapons.${u}.bonus`] = ((o = n.system) == null ? void 0 : o.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (m = (y = e.target) == null ? void 0 : y.closest) == null ? void 0 : m.call(y, "[data-document-id]"), r = (f = t == null ? void 0 : t.getAttribute) == null ? void 0 : f.call(t, "data-document-id");
      if (!r) return;
...
//# sourceMappingURL=vacuum-of-the-void-hKGqFYha.mjs.map
