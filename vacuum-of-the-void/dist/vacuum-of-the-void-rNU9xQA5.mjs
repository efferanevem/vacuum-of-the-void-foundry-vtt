...
var J = (w, i, e) => hi(w, typeof i != "symbol" ? i + "" : i, e);
var z = (w, i, e) => gi(yi(w), e, i);
const { HTMLField: bi, NumberField: C, SchemaField: K, StringField: S, BooleanField: te, ArrayField: it } = foundry.data.fields;
...
const { BooleanField: wi, NumberField: Fi, StringField: _e } = foundry.data.fields;
class Ht extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      bonus: new _e({ required: !1, blank: !0, initial: "" }),
      damage: new _e({
        required: !1,
        blank: !0,
        initial: ""
      }),
      range: new _e({ required: !1, blank: !0, initial: "" }),
      special: new _e({ required: !1, blank: !0, initial: "" }),
      quantity: new _e({ required: !1, blank: !0, initial: "1" }),
      /** Jártasság kulcs (pl. grenadeUse, firearms) – ezt a bónuszt adja hozzá a támadáshoz. Alapértelmezett: Kézifegyver Használat. */
      skillKey: new _e({ required: !1, blank: !0, initial: "grenadeUse" })
    };
  }
}
const { BooleanField: Ii, StringField: yt } = foundry.data.fields;
...
const { NumberField: _i, StringField: zt } = foundry.data.fields;
...
function vt(w) {
  ...
  d(w.terms, 1);
  const r = i.filter((u) => u === 6).length, l = i.filter((u) => u === 1).length, p = e.filter((u) => u === 6).length, m = t.filter((u) => u === 6).length, g = r + p, b = l + m;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    return (s || u) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), p;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const n = ((s = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : s.resources) ?? {}, d = ((o = (c = n.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, r = ((a = n.currentHealth) == null ? void 0 : a.legs) ?? 0, l = W._healthStatusFromRatio(r, d), p = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const n = ((l = i == null ? void 0 : i.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (p = n.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : m.value) ?? 0, r = ((g = n.currentHealth) == null ? void 0 : g[t]) ?? 0;
    return W._healthStatusFromRatio(r, d);
  }
  async _prepareContext(i) {
    var Ve, Ye, Je, Qe, k, A, x, j, ce, Q, Ee, be, Ie, ke, qe, Le, dt, mt, pt, ft, Xe, $e, Lt, Nt, At, Pt, Ft, Et, $t, xt, Rt;
    let e = await super._prepareContext(i);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((Je = (Ye = (Ve = this.actor.system) == null ? void 0 : Ve.resources) == null ? void 0 : Ye.stress) == null ? void 0 : Je.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const D = ((Qe = d[y]) == null ? void 0 : Qe.value) ?? 0, _ = r[y] ?? 0;
      e.computedHealthStatus[y] = W._healthStatusFromRatio(_, D);
    }
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), F = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], O = (Q = this.actor.system.gear) == null ? void 0 : Q.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, N = (((Ee = E.slot1) == null ? void 0 : Ee.itemId) ?? "").trim(), H = (((be = E.slot2) == null ? void 0 : be.itemId) ?? "").trim(), B = (((Ie = E.slot3) == null ? void 0 : Ie.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, q = typeof D.sort == "number" ? D.sort : 0;
      return _ - q;
    }).map((y) => {
      ...
      let X = null;
      _ && (N === y.id ? X = "slot1" : H === y.id ? X = "slot2" : B === y.id && (X = "slot3"));
      const Ze = D && ((Pe = y.system) != null && Pe.damage) ? y.system.damage : "", le = D && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Ne = ee ? Number((Te = T[ee]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.actionsTable = G;
    const Z = (((ke = this.actor.items) == null ? void 0 : ke.contents) ?? []).filter((y) => y.type === "Fegyver"), Y = Z.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = Y;
    const R = "— Nincs fegyver —", V = F.filter((y) => {
      const _ = ((T[y] ?? {}).itemId ?? "").trim();
      return _ ? !!Z.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = V.map((y, D) => {
      const _ = T[y] ?? {}, q = (_.itemId ?? "").trim(), M = Y.find((ee) => ee.id === q);
      return {
        slotKey: y,
        itemId: q,
        slotNum: D + 1,
    ...
    e.weaponsTable = Z.map((y) => {
      ...
      let _ = null, q = {};
      for (const ht of F)
        if ((((Mt = T[ht]) == null ? void 0 : Mt.itemId) ?? "").trim() === D) {
          _ = ht, q = T[ht] ?? {};
          break;
        }
      const M = !!_, ee = ((Kt = y.system) == null ? void 0 : Kt.equipped) !== void 0 && ((jt = y.system) == null ? void 0 : jt.equipped) !== null ? !!y.system.equipped : M, X = (y == null ? void 0 : y.system) ?? {}, Ze = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", Ne = (oe[le] ?? le) || "—", ve = X.size ?? "", Ae = (ge[ve] ?? ve) || "", Pe = [Ne, Ae].filter(Boolean).join(", ") || Ne || "—", Se = le === "projectile" || ve === "thrown", Te = X.quantity, et = Te != null ? String(Te).trim() : "1", xe = String(q.bonus ?? "").trim(), tt = String(X.bonus ?? "").trim(), pi = xe || tt || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    e.armorTable = re.map((y) => {
      var q, M;
      const D = (y == null ? void 0 : y.system) ?? {}, _ = ((q = y.system) == null ? void 0 : q.equipped) !== void 0 && ((M = y.system) == null ? void 0 : M.equipped) !== null ? !!y.system.equipped : !1;
      return {
        itemId: y.id,
        actorId: this.actor.id,
        ...
        level: qi((D.level ?? "").toString().trim()),
    ...
    e.itemsTable = Re.map((y) => {
      const D = (y == null ? void 0 : y.system) ?? {}, _ = (D.description ?? "").trim(), q = _ ? _.length > 60 ? _.slice(0, 57) + "…" : _ : "—", M = D.quantity != null ? String(D.quantity).trim() : "1";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const ie = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((y) => y.type === "Egyeb");
    e.egyebList = ie.map((y) => {
      const _ = (((y == null ? void 0 : y.system) ?? {}).description ?? "").trim(), q = _ ? _.length > 80 ? _.slice(0, 77) + "…" : _ : "";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const se = (((mt = this.actor.items) == null ? void 0 : mt.contents) ?? []).filter((y) => y.type === "MikroChip"), ne = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Me = "— Nincs Mikro-Chip —", Ke = ["slot1", "slot2", "slot3"], je = (y) => {
      var _, q, M;
      const D = [];
      return y !== 1 && D.push((((_ = E.slot1) == null ? void 0 : _.itemId) ?? "").trim()), y !== 2 && D.push((((q = E.slot2) == null ? void 0 : q.itemId) ?? "").trim()), y !== 3 && D.push((((M = E.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      const D = E[y] ?? {}, _ = (D.itemId ?? "").trim(), q = se.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || Me,
        img: (q == null ? void 0 : q.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const D = `slot${y}`, _ = E[D] ?? {}, q = (_.itemId ?? "").trim(), M = ne.find((ee) => ee.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Me, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = se.map((y) => {
      var ve, Ae, Pe, Se;
      const D = y.id;
      let _ = null;
      for (const Te of Ke)
        if ((((ve = E[Te]) == null ? void 0 : ve.itemId) ?? "").trim() === D) {
          _ = Te;
          break;
        }
    ...
    const Fe = this.actor.system.abilities ?? {}, st = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).map((y) => {
      var D, _, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), He = new Map(st.map((y) => [y.id, y])), nt = "— Nincs képesség —", Ue = (y) => {
      const D = Fe[y] ?? {}, _ = (D.itemId ?? "").trim(), q = _ ? He.get(_) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || nt,
        img: (q == null ? void 0 : q.img) || "",
        description: M,
        kp: ee
      };
    ...
    const at = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, rt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], De = (Pt = (At = e.system) == null ? void 0 : At.combat) == null ? void 0 : Pt.initiativeResult, he = typeof De == "number" ? De : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ge = (Et = (Ft = e.system) == null ? void 0 : Ft.combat) == null ? void 0 : Et.initiativeRanges, Oe = Array.isArray(Ge) ? Ge.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Oe.length > 0 ? Oe : ot).slice().sort((y, D) => y.min - D.min), Ce = Oe.map((y) => y.min), ct = Ce.length ? Math.min(...Ce) : 0, lt = Ce.length ? Math.max(...Ce) : 0;
    ...
    if (typeof he == "number" && he >= 0 && we.length > 0) {
      ...
      let _ = null;
      he <= y.max ? _ = y : he >= D.min ? _ = D : _ = we.find((q) => he >= q.min && he <= q.max), _ && (We = _.kp);
    }
    e.kpDots = rt.map((y, D) => {
      const _ = D + 1, q = !!Number(at[y]), M = _ <= We;
      return { index: _, used: q, usable: M };
    });
    const ut = !!((xt = ($t = game.combat) == null ? void 0 : $t.combatants) != null && xt.some((y) => {
      var D;
      return ((D = y.actor) == null ? void 0 : D.type) === "Karakter";
    }));
    return e.showHarcSection = ut, e.canEditInitiative = !!((Rt = game.user) != null && Rt.isGM), e.showInitiativeResult = typeof De == "number", e.initiativeResult = e.showInitiativeResult ? De : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-QLODvMMv.mjs");
      a(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-QLODvMMv.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-QLODvMMv.mjs");
      f(this.actor, o, a);
      ...
      if (!h) return;
      const v = ((P = (L = this.actor.items).get) == null ? void 0 : P.call(L, h)) ?? ((O = (F = this.actor.items.contents) == null ? void 0 : F.find) == null ? void 0 : O.call(F, (N) => N.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = a.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = I ? I.split(/\s*,\s*/).filter((F) => T.includes(F)) : [], P = L.find((F) => {
          var O;
          return (((O = v[F]) == null ? void 0 : O.itemId) ?? "").trim() === o;
        });
        if (P) {
          const F = L.filter((O) => O !== P);
          h["system.weapons.slotOrder"] = F.join(","), h[`system.weapons.${P}.itemId`] = "", h[`system.weapons.${P}.name`] = "", h[`system.weapons.${P}.damage`] = "", h[`system.weapons.${P}.bonus`] = "";
        }
      }
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.bonus`]: ((F = a == null ? void 0 : a.system) == null ? void 0 : F.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (T) {
        const O = I.filter((E) => E !== T);
        await this.actor.update({
      ...
      const P = h ? this.actor.items.get(h) : null, F = {
        [`system.gear.microchips.${f}.itemId`]: h,
        [`system.gear.microchips.${f}.name`]: (P == null ? void 0 : P.name) ?? ""
      };
      h && (F[`system.gear.microchips.${f}.active`] = !0), await this.actor.update(F);
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.bonus`]: ((F = a.system) == null ? void 0 : F.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (T) {
        const O = I.filter((E) => E !== T);
        await this.actor.update({
    ...
    const p = this, m = (s) => {
      var a, f, h, v;
      if (!s) return;
      const c = p._getFormDataForUpdate(s);
      ...
      var c, o, a;
      return s && (((o = (c = p.element) == null ? void 0 : c.contains) == null ? void 0 : o.call(c, s)) || p.id && ((a = s.closest) == null ? void 0 : a.call(s, `#${CSS.escape(p.id)}`)));
    };
    p._votvBlur = (s) => {
      var h;
      const c = s.target;
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = T ? T.split(/\s*,\s*/).filter((O) => L.includes(O)) : [], F = P.filter((O) => {
              var E;
              return (((E = I[O]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (F.length > 0) {
              const E = {
                "system.weapons.slotOrder": P.filter((N) => !F.includes(N)).join(",")
              };
              for (const N of F)
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((p = i.dataTransfer) == null ? void 0 : p.getData("text/plain")) || ((m = i.dataTransfer) == null ? void 0 : m.getData("application/json")) || "";
    let n;
    try {
      n = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
  ...
  async _rollWeapon(i) {
    ...
    const l = r && r.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, m = ((I = r == null ? void 0 : r.system) == null ? void 0 : I.type) || "kinetic", g = (((T = r == null ? void 0 : r.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = g && n[g] !== void 0 ? g : m === "explosive" ? "grenadeUse" : "firearms", u = Number(n[b] || 0) || 0, s = p + u, o = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, a = new Roll(o);
  ...
  async _rollWeaponDamage(i, e = "") {
    var p, m, g, b, u, s, c, o, a, f;
    const t = this.actor;
    if (!t) return;
    let n = ((m = (p = t.items).get) == null ? void 0 : m.call(p, i)) ?? ((b = (g = t.items.contents) == null ? void 0 : g.find) == null ? void 0 : b.call(g, (h) => h.id === i));
...
J(W, "PARTS", foundry.utils.mergeObject(
  ...
  z(W, W, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Vt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Jt = (Yt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.window) == null ? void 0 : Jt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const r = await super.render(i, e), l = this.element, p = this.form ?? this.element, m = d.scrollState, g = d.focus, b = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", u = () => {
      var s, c;
      if (this._applyScrollState(l, m), (g == null ? void 0 : g.name) != null || (g == null ? void 0 : g.id) != null) {
        const o = ((s = p.querySelector) == null ? void 0 : s.call(p, g.id ? `#${CSS.escape(g.id)}` : null)) ?? (g.name ? (c = p.querySelector) == null ? void 0 : c.call(p, `[name="${CSS.escape(g.name)}"]`) : null);
  ...
  async _prepareContext(i) {
    var He, nt, Ue, ze, Be, at, rt, De, he, ot, Ge, Oe, gt, we, Ce, ct, lt, We, ut, Ve, Ye, Je, Qe;
    ...
    const t = this.actor, n = ((ze = t == null ? void 0 : t.items) == null ? void 0 : ze.contents) ?? [], d = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), p = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = p.length > 0 ? p : r, s = r.filter((k) => !u.includes(k)), c = [...u, ...s], o = c.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const ce = !!x, Q = (k == null ? void 0 : k.system) ?? {}, Ee = typeof Q.range == "string" ? (Q.range || "").trim() : "", be = Q.type ?? "", Ie = (a[be] ?? be) || "—", ke = Q.size ?? "", qe = (f[ke] ?? ke) || "", Le = [Ie, qe].filter(Boolean).join(", ") || Ie || "—", dt = be === "projectile" || ke === "thrown", mt = Q.quantity != null ? String(Q.quantity).trim() : "1", pt = String(Q.bonus ?? j.bonus ?? "").trim() || "0", ft = (Q.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: A,
        actorId: t.id,
    ...
    e.microchipsTable = T.map((k) => {
      ...
      const j = ((Ie = k == null ? void 0 : k.system) == null ? void 0 : Ie.abilityType) ?? "", ce = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", Q = (((ke = k == null ? void 0 : k.system) == null ? void 0 : ke.description) ?? "").trim(), Ee = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: A,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const F = (((De = e.weaponsTable) == null ? void 0 : De.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ot = e.microchipsTable) == null ? void 0 : ot.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Oe = e.egyebList) == null ? void 0 : Oe.length) ?? 0) > 0;
    e.showEquipmentDropZone = !F;
    const O = ((gt = t == null ? void 0 : t.system) == null ? void 0 : gt.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var A, x;
      return {
        id: k.id,
        name: k.name,
    ...
    e.showHarcSection = Z;
    const Y = ((ct = e.system) == null ? void 0 : ct.resources) ?? {}, R = (We = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : We.initiativeResult, V = typeof R == "number" ? R : -1, oe = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (Ve = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ve.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, A) => k.min - A.min), se = 3;
    let ne = re.length > 0 ? re : [];
    ne.length < se && (ne = [...ne, ...Array(se - ne.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ne.map((k, A) => ({
      ...k,
      isFirst: A === 0,
    ...
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      const k = ie[0], A = ie[ie.length - 1];
      let x = null;
      V <= k.max ? x = k : V >= A.min ? x = A : x = ie.find((j) => V >= j.min && V <= j.max), x && (Me = x.kp);
    }
    const Ke = ie.length > 0 ? ie[ie.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Fe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, A) => {
      const x = A + 1, j = !!Number(Y[k]), ce = x <= Me;
      return { index: x, used: j, usable: ce };
    }), st = Math.ceil(Fe.length / 2);
    return e.kpDotsRow1 = Fe.slice(0, st), e.kpDotsRow2 = Fe.slice(st), e.canEditInitiative = !!((Ye = game.user) != null && Ye.isGM), e.showInitiativeResult = typeof R == "number", e.initiativeResult = e.showInitiativeResult ? R : "", e.speedUnitForSelect = ((Qe = (Je = e.system) == null ? void 0 : Je.combat) == null ? void 0 : Qe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(i) {
    var m, g, b;
    super._attachFrameListeners(i);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-QLODvMMv.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-QLODvMMv.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-QLODvMMv.mjs");
      a(this.actor, c, o);
      ...
      const o = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, f = (Array.isArray((P = o[s]) == null ? void 0 : P.items) ? o[s].items.slice() : []).filter((F) => F !== c);
  ...
  async _rollWeapon(i) {
    ...
    const p = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, g = ((F = l == null ? void 0 : l.system) == null ? void 0 : F.type) || "kinetic", b = (((O = l == null ? void 0 : l.system) == null ? void 0 : O.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", s = Number(d[u] || 0) || 0, c = m + s, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(a);
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((m = (p = t.items).get) == null ? void 0 : m.call(p, i)) ?? ((b = (g = t.items.contents) == null ? void 0 : g.find) == null ? void 0 : b.call(g, (h) => h.id === i));
    if (!n || n.type !== "Fegyver") return;
    let d = (((u = n.system) == null ? void 0 : u.damage) ?? "").trim();
    if (!d && e && (d = (((((s = t.system) == null ? void 0 : s.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (f = (c = ui.notifications) == null ? void 0 : c.warn) == null || f.call(c, ((a = (o = game.i18n) == null ? void 0 : o.localize) == null ? void 0 : a.call(o, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, a, f, h, v, I, T, L, P, F, O, E;
    ...
    if (d.type === "Fegyver" && m) {
      const N = ((L = r.system) == null ? void 0 : L.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (N.slotOrder ?? "").trim(), U = B ? B.split(/\s*,\s*/).filter((Y) => H.includes(Y)) : [];
      let G = H.find((Y) => {
        var R;
        return !(((R = N[Y]) == null ? void 0 : R.itemId) ?? "").trim();
      });
      G || (G = H.find((Y) => !U.includes(Y)) ?? "slot1");
      const Z = U.includes(G) ? U : [...U, G].filter((Y) => H.includes(Y));
      await r.update({
        ...
        [`system.weapons.${G}.bonus`]: ((F = d.system) == null ? void 0 : F.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const N = ((E = (O = r.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, B = ["slot1", "slot2", "slot3"].find((U) => {
        var G;
  ...
  async _postAbilityToChat(i) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((u = e.system) == null ? void 0 : u.kind) ?? "passive", n = Number(((s = e.system) == null ? void 0 : s.kp) ?? 0) || 0, d = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${r}</p>
      ${l}
      ${p}
  ...
  async _postItemToChat(i) {
    var p, m, g, b, u, s;
    const e = (m = (p = this.actor) == null ? void 0 : p.items) == null ? void 0 : m.get(i);
    if (!e || e.type !== "MikroChip" && e.type !== "Egyeb") return;
...
J(ae, "PARTS", foundry.utils.mergeObject(
  ...
  z(ae, ae, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Xt = z(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Xt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((ei = (Zt = z(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.window) == null ? void 0 : ei.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
J(ue, "PARTS", foundry.utils.mergeObject(z(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ti = z(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : ti.form) ?? {}, { submitOnChange: !1 })
}));
let St = ue;
var ii;
...
J(de, "PARTS", foundry.utils.mergeObject(z(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ii = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : ii.form) ?? {}, { submitOnChange: !1 })
}));
let Tt = de;
var si;
...
J(me, "PARTS", foundry.utils.mergeObject(z(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((si = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : si.form) ?? {}, { submitOnChange: !1 })
}));
let _t = me;
var ni;
...
J(pe, "PARTS", foundry.utils.mergeObject(z(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ni = z(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : ni.form) ?? {}, { submitOnChange: !0 })
}));
let Dt = pe;
var ai;
...
J(fe, "PARTS", foundry.utils.mergeObject(z(fe, fe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ai = z(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : ai.form) ?? {}, { submitOnChange: !1 })
}));
let Ot = fe;
var ri;
...
J(ye, "PARTS", foundry.utils.mergeObject(z(ye, ye, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ri = z(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : ri.form) ?? {}, { submitOnChange: !1 })
}));
let Ct = ye;
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = vi, CONFIG.Actor.dataModels.Npc = oi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Ht, CONFIG.Item.dataModels.weapon = Ht, CONFIG.Item.dataModels.Pancel = Si, CONFIG.Item.dataModels.MikroChip = Ti, CONFIG.Item.dataModels.Kepesseg = Bt, CONFIG.Item.dataModels.ability = Bt, CONFIG.Item.dataModels.Targy = Di, CONFIG.Item.dataModels.Egyeb = Ci, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (p, m, g, b) => {
    ...
    if ((p.type === "Karakter" || p.type === "Npc") && ((T = m == null ? void 0 : m.system) != null && T.combat) && "initiativeResult" in m.system.combat) {
      const R = Number((P = (L = p.system) == null ? void 0 : L.combat) == null ? void 0 : P.initiativeResult), V = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
        const ge = ((F = oe.combatants) == null ? void 0 : F.contents) ?? Array.from(oe.combatants ?? []);
        for (const re of ge)
          if (((O = re.actor) == null ? void 0 : O.id) === u || re.actorId === u) {
            oe.updateEmbeddedDocuments("Combatant", [{ _id: re.id, initiative: V }]).catch(() => {
            });
            break;
          }
      }
    }
    if (p.type === "Npc" && ((E = m == null ? void 0 : m.system) != null && E.identity) && "size" in m.system.identity) {
      const R = li((H = (N = p.system) == null ? void 0 : N.identity) == null ? void 0 : H.size);
      p.update({
        "prototypeToken.width": R,
        "prototypeToken.height": R
      }).catch((V) => console.warn("Vacuum of the Void | NPC token size update failed for", p.name, V));
    }
    const s = document.activeElement, c = s && (s.tagName === "INPUT" && s.type !== "checkbox" && s.type !== "radio" || s.tagName === "TEXTAREA" || s.isContentEditable), o = [], a = (B = game.actors) == null ? void 0 : B.get(u);
    ...
    if (c && o.some((R) => {
      const V = (R == null ? void 0 : R.form) ?? (R == null ? void 0 : R.element);
      return V && V.contains(s);
    })) return;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, L, P, F, O, E, N, H, B, U, G, Z, Y, R, V, oe, ge, re, Re;
    ...
    let p = ((P = game.actors) == null ? void 0 : P.get(r.actorId)) ?? ((F = game.actors) == null ? void 0 : F.get(l));
    if (p || (p = ((E = (O = game.scenes) == null ? void 0 : O.contents) == null ? void 0 : E.flatMap((se) => {
      var ne;
      return ((ne = se.tokens) == null ? void 0 : ne.contents) ?? [];
    }).map((se) => se.actor).find((se) => se && (se.id === l || se.id === r.actorId))) ?? null), !p) return;
    const m = r.itemId ? ((H = (N = p.items) == null ? void 0 : N.get) == null ? void 0 : H.call(N, r.itemId)) ?? ((G = (U = (B = p.items) == null ? void 0 : B.contents) == null ? void 0 : U.find) == null ? void 0 : G.call(U, (ie) => ie.id === r.itemId)) : null;
    let g = (r.damageFormula ?? "").trim();
    if (g || (g = (((Z = m == null ? void 0 : m.system) == null ? void 0 : Z.damage) ?? "").trim()), !g && r.slotKey && (g = (((((Y = p.system) == null ? void 0 : Y.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
      (ge = (R = ui.notifications) == null ? void 0 : R.warn) == null || ge.call(R, ((oe = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : oe.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(g);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, s = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Re = (((re = p.system) == null ? void 0 : re.weapons) ?? {})[r.slotKey]) == null ? void 0 : Re.name) ?? "" : "")) || "Fegyver";
    ...
    for (const u of t)
      try {
        const s = u.prototypeToken, c = ((l = s == null ? void 0 : s.bar1) == null ? void 0 : l.attribute) ?? "", o = ((p = s == null ? void 0 : s.bar2) == null ? void 0 : p.attribute) ?? "";
        (c || o) && await u.update({
...
Hooks.on("preCreateToken", (w, i, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = li((m = (p = d.system) == null ? void 0 : p.identity) == null ? void 0 : m.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
function di(w) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" && n.type !== "Npc" || n.update(Ai).catch((d) => {
...
Hooks.on("renderChatMessageHTML", (w, i, e) => {
  ...
  if (!n && !d && !r) return;
  const p = (g = i == null ? void 0 : i.querySelector) == null ? void 0 : g.call(i, ".dice-roll");
  if (p) {
    if (n && p.classList.add(`votv-${n}`), d) {
      const s = p.querySelector(".votv-crit-label");
      if (s)
        s.textContent = d;
      else {
    ...
    if (r && l && (l.actorId || (b = w.speaker) != null && b.actor)) {
      const s = p.querySelector(".dice-total"), c = (s == null ? void 0 : s.parentElement) ?? p;
...
//# sourceMappingURL=vacuum-of-the-void-rNU9xQA5.mjs.map
