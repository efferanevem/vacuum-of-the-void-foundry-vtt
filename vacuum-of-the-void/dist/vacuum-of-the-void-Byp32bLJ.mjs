...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var b, u, i, c, o, n, p, h, w;
    const e = s ?? this.form ?? this.element;
    let t = (b = e == null ? void 0 : e.querySelector) == null ? void 0 : b.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const a = ((i = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : i.resources) ?? {}, d = ((o = (c = a.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, r = ((n = a.currentHealth) == null ? void 0 : n.legs) ?? 0, l = U._healthStatusFromRatio(r, d), f = Number(((w = (h = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : h.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let m;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    return U._healthStatusFromRatio(r, d);
  }
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const D = ((Me = d[g]) == null ? void 0 : Me.value) ?? 0, T = r[g] ?? 0;
      e.computedHealthStatus[g] = U._healthStatusFromRatio(T, D);
    }
    const f = (Number(r.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((g) => (Number(r[g]) || 0) === 0).length;
    e.showDeathSkull = f || y >= 2;
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((je = (Re = this.actor.system) == null ? void 0 : Re.combat) == null ? void 0 : je.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const n = (Number(((Ae = (Ke = this.actor.system) == null ? void 0 : Ke.combat) == null ? void 0 : Ae.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const h = Number(p.givenSpeed);
    e.totalSpeed = (Number(p.speed) || 0) + (Number(p.speedBonus) || 0) + (Number.isFinite(h) ? h : 0);
    const w = U.BODY_PART_BY_SKILL;
    e.skillHealthStatus = {}, e.skillDisabled = {}, e.skillHasHealthTint = {};
    for (const [g, D] of Object.entries(w)) {
      const T = e.computedHealthStatus[D];
      e.skillHealthStatus[g] = T, e.skillDisabled[g] = T === 0 ? " disabled" : "", e.skillHasHealthTint[g] = !0;
    }
    const I = this.actor.system.weapons ?? {}, _ = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (I.slotOrder ?? "").trim(), O = q ? q.split(/\s*,\s*/).filter((g) => _.includes(g)) : [], C = (st = this.actor.system.gear) == null ? void 0 : st.microchips, v = C && typeof C == "object" && !Array.isArray(C) ? C : {}, E = (((it = v.slot1) == null ? void 0 : it.itemId) ?? "").trim(), A = (((rt = v.slot2) == null ? void 0 : rt.itemId) ?? "").trim(), j = (((nt = v.slot3) == null ? void 0 : nt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, D) => {
      const T = typeof g.sort == "number" ? g.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return T - L;
    }).map((g) => {
      var pe, Oe, Ce, be, ke, $e;
      const D = g.type === "Fegyver", T = g.type === "MikroChip";
      let L = 0, M = "", Q = null;
      for (let Ne = 0; Ne < O.length; Ne++) {
        const xe = O[Ne];
        if ((((pe = I[xe]) == null ? void 0 : pe.itemId) ?? "") === g.id) {
          L = Ne + 1, M = ((Oe = I[xe]) == null ? void 0 : Oe.bonus) ?? "", Q = xe;
          break;
        }
      }
      let Y = null;
      T && (E === g.id ? Y = "slot1" : A === g.id ? Y = "slot2" : j === g.id && (Y = "slot3"));
      const Fe = D && ((Ce = g.system) != null && Ce.damage) ? g.system.damage : "", se = D && typeof ((be = g.system) == null ? void 0 : be.range) == "string" ? (g.system.range || "").trim() : "", De = Q ? Number((ke = I[Q]) == null ? void 0 : ke.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.weaponItems = ee;
    const fe = "— Nincs fegyver —", le = O.filter((g) => {
      const T = ((I[g] ?? {}).itemId ?? "").trim();
      return T ? !!z.find((M) => M.id === T) : !1;
    });
    e.weaponSlots = le.map((g, D) => {
      const T = I[g] ?? {}, L = (T.itemId ?? "").trim(), M = ee.find((Q) => Q.id === L);
      return {
        slotKey: g,
        itemId: L,
        slotNum: D + 1,
        displayName: (M == null ? void 0 : M.name) || T.name || fe,
    ...
    e.armorTable = we.map((g) => {
      var L, M;
      const D = (g == null ? void 0 : g.system) ?? {}, T = ((L = g.system) == null ? void 0 : L.equipped) !== void 0 && ((M = g.system) == null ? void 0 : M.equipped) !== null ? !!g.system.equipped : !1;
      return {
        itemId: g.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = Ie.map((g) => {
      const D = (g == null ? void 0 : g.system) ?? {}, T = (D.description ?? "").trim(), L = T ? T.length > 60 ? T.slice(0, 57) + "…" : T : "—", M = D.quantity != null ? String(D.quantity).trim() : "1";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    e.egyebList = Se.map((g) => {
      const T = (((g == null ? void 0 : g.system) ?? {}).description ?? "").trim(), L = T ? T.length > 80 ? T.slice(0, 77) + "…" : T : "";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const te = (((ut = this.actor.items) == null ? void 0 : ut.contents) ?? []).filter((g) => g.type === "MikroChip"), J = te.map((g) => ({ id: g.id, name: g.name, img: g.img })), ye = "— Nincs Mikro-Chip —", Ee = ["slot1", "slot2", "slot3"], k = (g) => {
      var T, L, M;
      const D = [];
      return g !== 1 && D.push((((T = v.slot1) == null ? void 0 : T.itemId) ?? "").trim()), g !== 2 && D.push((((L = v.slot2) == null ? void 0 : L.itemId) ?? "").trim()), g !== 3 && D.push((((M = v.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = J.filter((g) => !k(1).includes(g.id)), e.microchipItemsSlot2 = J.filter((g) => !k(2).includes(g.id)), e.microchipItemsSlot3 = J.filter((g) => !k(3).includes(g.id)), e.microchipSlots = Ee.map((g) => {
      const D = v[g] ?? {}, T = (D.itemId ?? "").trim(), L = te.find((M) => M.id === T);
      return {
        slotKey: g,
        itemId: T,
      ...
      const D = `slot${g}`, T = v[D] ?? {}, L = (T.itemId ?? "").trim(), M = J.find((Q) => Q.id === L);
      e[`microchip${g}ItemId`] = L, e[`microchip${g}DisplayName`] = (M == null ? void 0 : M.name) || T.name || ye, e[`microchip${g}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = te.map((g) => {
      var pe, Oe, Ce, be;
      const D = g.id;
      let T = null;
      for (const ke of Ee)
        if ((((pe = v[ke]) == null ? void 0 : pe.itemId) ?? "").trim() === D) {
          T = ke;
          break;
        }
      const L = !!T, M = ((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.abilityType) ?? "", Q = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Fe = Number((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, se = (((be = g == null ? void 0 : g.system) == null ? void 0 : be.description) ?? "").trim(), De = se ? se.length > 60 ? se.slice(0, 57) + "…" : se : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const F = this.actor.system.abilities ?? {}, H = (((yt = this.actor.items) == null ? void 0 : yt.contents) ?? []).map((g) => {
      var D, T, L;
      return {
        id: g.id,
        name: g.name,
        ...
        description: ((T = g.system) == null ? void 0 : T.description) ?? "",
        kp: Number(((L = g.system) == null ? void 0 : L.kp) ?? 0) || 0
      };
    }), ge = new Map(H.map((g) => [g.id, g])), W = "— Nincs képesség —", Le = (g) => {
      const D = F[g] ?? {}, T = (D.itemId ?? "").trim(), L = T ? ge.get(T) : null, M = (L == null ? void 0 : L.description) ?? "", Q = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: T,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-u04UXRWm.mjs");
      n(this.actor, o);
      ...
      if (!o) {
        ...
        if (!w) return;
        o = (((((p = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : p.weapons) ?? {})[w] ?? {}).itemId ?? "").trim();
      }
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, n = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-u04UXRWm.mjs");
      p(this.actor, o, n);
      ...
      if (!n) return;
      const h = (((_ = (((I = this.actor.system) == null ? void 0 : I.weapons) ?? {})[n]) == null ? void 0 : _.itemId) ?? "").trim();
      if (!h) return;
      const w = ((O = (q = this.actor.items).get) == null ? void 0 : O.call(q, h)) ?? ((v = (C = this.actor.items.contents) == null ? void 0 : C.find) == null ? void 0 : v.call(C, (A) => A.id === h));
      (E = w == null ? void 0 : w.sheet) == null || E.render(!0);
    });
    const l = (i, c) => {
      var p;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((p == null ? void 0 : p.type) === "Fegyver") {
        const w = n.system.weapons ?? {}, I = (w.slotOrder ?? "").trim(), _ = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((C) => _.includes(C)) : [], O = q.find((C) => {
          var v;
          return (((v = w[C]) == null ? void 0 : v.itemId) ?? "").trim() === o;
        });
        if (O) {
          const C = q.filter((v) => v !== O);
          h["system.weapons.slotOrder"] = C.join(","), h[`system.weapons.${O}.itemId`] = "", h[`system.weapons.${O}.name`] = "", h[`system.weapons.${O}.damage`] = "", h[`system.weapons.${O}.bonus`] = "";
        }
      }
      ...
      const p = this.actor.system.weapons ?? {}, h = (p.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((v) => w.includes(v)) : [], _ = I.find((v) => {
        var E;
        return (((E = p[v]) == null ? void 0 : E.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (_) return;
        let v = I.find((A) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((O = n == null ? void 0 : n.system) == null ? void 0 : O.damage) ?? "",
          [`system.weapons.${v}.bonus`]: ((C = n == null ? void 0 : n.system) == null ? void 0 : C.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (_) {
        const v = I.filter((E) => E !== _);
        await this.actor.update({
      ...
      if (!p) return;
      const h = (c.dataset.itemId ?? "").trim(), w = (c.dataset.itemName ?? ((v = c.textContent) == null ? void 0 : v.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (c.dataset.itemImg ?? "").trim(), _ = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      _ && (_.textContent = w);
      let q = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      I ? (q || (q = document.createElement("img"), q.className = "karakter-microchip-slot-thumb", q.alt = "", n == null || n.insertBefore(q, _)), q.src = I, q.style.display = "") : q && q.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const O = h ? this.actor.items.get(h) : null, C = {
        [`system.gear.microchips.${p}.itemId`]: h,
        [`system.gear.microchips.${p}.name`]: (O == null ? void 0 : O.name) ?? ""
      };
      ...
      const n = ((I = (w = this.actor.system) == null ? void 0 : w.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((_) => {
        var q;
        return (((q = n[_]) == null ? void 0 : q.itemId) ?? "").trim() === c;
      });
      ...
      if (!c || !o) return;
      const n = this.actor.system.abilities ?? {}, h = (Array.isArray((w = n[c]) == null ? void 0 : w.items) ? n[c].items.slice() : []).filter((I) => I !== o);
      ...
      await n.update({ "system.quantity": p }), setTimeout(() => {
        const h = this.form ?? this.element, w = h == null ? void 0 : h.querySelector(`.karakter-weapon-quantity-input[data-item-id="${o}"]`);
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((O = n.system) == null ? void 0 : O.damage) ?? "",
          [`system.weapons.${v}.bonus`]: ((C = n.system) == null ? void 0 : C.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (_) {
        const v = I.filter((E) => E !== _);
        await this.actor.update({
      ...
      const p = (c.value ?? "").trim();
      await n.update({ "system.quantity": p }), setTimeout(() => {
        const h = this.form ?? this.element, w = h == null ? void 0 : h.querySelector(`.karakter-item-quantity-input[data-item-id="${o}"]`);
        w && this._resizeWeaponQuantityInput(w);
      }, 80);
    });
    const f = this, m = (i) => {
      ...
      const o = ((p = (n = c.system) == null ? void 0 : n.resources) == null ? void 0 : p.currentHealth) != null || ((w = (h = c.system) == null ? void 0 : h.resources) == null ? void 0 : w.hitLocations) != null;
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (n && n.documentName === "Item" && (n.type === "Kepesseg" || n.type === "ability")) {
          ...
          const h = (((r = n.system) == null ? void 0 : r.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (h === "species") {
            await this.actor.update({
          ...
          const I = h === "active" ? "active" : "passive", _ = Array.isArray((l = w[I]) == null ? void 0 : l.items) ? w[I].items.slice() : Array.isArray(w[I]) ? w[I].slice() : [];
      ...
      if (o) {
        ...
        if (n && n.documentName === "Item" && n.type === "Fegyver") {
          ...
          if (h) {
            ...
            w = ((y = (await p.createEmbeddedDocuments("Item", [I]))[0]) == null ? void 0 : y.id) ?? w;
          }
          if (h) {
            const I = ((b = p.system) == null ? void 0 : b.weapons) ?? {}, _ = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = _ ? _.split(/\s*,\s*/).filter((v) => q.includes(v)) : [], C = O.filter((v) => {
              var E;
              return (((E = I[v]) == null ? void 0 : E.itemId) ?? "").trim() === w;
            });
            if (C.length > 0) {
              const E = {
                "system.weapons.slotOrder": O.filter((A) => !C.includes(A)).join(",")
              };
              for (const A of C)
  ...
  async _rollWeapon(s) {
    ...
    const l = r && r.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, y = (((w = r == null ? void 0 : r.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", b = Number(a[y] || 0) || 0, u = f + b, c = `3d6${u !== 0 ? u > 0 ? `+${u}` : `${u}` : ""}`, o = new Roll(c);
...
G(U, "PARTS", foundry.utils.mergeObject(
  ...
  K(U, U, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Tt = K(U, U, "DEFAULT_OPTIONS")) == null ? void 0 : Tt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((_t = K(U, U, "DEFAULT_OPTIONS")) == null ? void 0 : _t.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ot = (Dt = K(U, U, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.window) == null ? void 0 : Ot.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, a = ((le = t == null ? void 0 : t.items) == null ? void 0 : le.contents) ?? [], d = ((ue = t == null ? void 0 : t.system) == null ? void 0 : ue.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = a.filter((k) => k.type === "Fegyver"), y = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      ...
      return x && m.some((H) => H.id === x);
    });
    e.weaponSlots = o.map((k) => {
      const x = d[k] ?? {}, F = (x.itemId ?? "").trim(), H = y.find((ge) => ge.id === F);
      return {
        slotKey: k,
        itemId: F,
        displayName: (H == null ? void 0 : H.name) || x.name || b,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const ge = !!F, W = (k == null ? void 0 : k.system) ?? {}, Le = typeof W.range == "string" ? (W.range || "").trim() : "", de = W.type ?? "", he = (n[de] ?? de) || "—", me = W.size ?? "", Te = (p[me] ?? me) || "", _e = [he, Te].filter(Boolean).join(", ") || he || "—", Me = de === "projectile" || me === "thrown", Re = W.quantity != null ? String(W.quantity).trim() : "1", je = String(W.bonus ?? H.bonus ?? "").trim() || "0", Ke = (W.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: F ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      var H;
      const x = (k == null ? void 0 : k.system) ?? {}, F = ((H = k.system) == null ? void 0 : H.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    const w = ((we = (ve = t == null ? void 0 : t.system) == null ? void 0 : ve.gear) == null ? void 0 : we.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], _ = a.filter((k) => k.type === "MikroChip");
    e.microchipsTable = _.map((k) => {
      var de, he, me, Te;
      const x = k.id;
      let F = null;
      for (const _e of I)
        if ((((de = w[_e]) == null ? void 0 : de.itemId) ?? "").trim() === x) {
          F = _e;
          break;
        }
      const H = ((he = k == null ? void 0 : k.system) == null ? void 0 : he.abilityType) ?? "", ge = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", W = (((me = k == null ? void 0 : k.system) == null ? void 0 : me.description) ?? "").trim(), Le = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.itemsTable = q.map((k) => {
      const x = (k == null ? void 0 : k.system) ?? {}, F = (x.description ?? "").trim(), H = F ? F.length > 60 ? F.slice(0, 57) + "…" : F : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.egyebList = O.map((k) => {
      const F = (((k == null ? void 0 : k.system) ?? {}).description ?? "").trim(), H = F ? F.length > 80 ? F.slice(0, 77) + "…" : F : "";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const C = (((Ie = e.weaponsTable) == null ? void 0 : Ie.length) ?? 0) > 0 || (((Se = e.armorTable) == null ? void 0 : Se.length) ?? 0) > 0 || (((te = e.microchipsTable) == null ? void 0 : te.length) ?? 0) > 0 || (((J = e.itemsTable) == null ? void 0 : J.length) ?? 0) > 0 || (((ye = e.egyebList) == null ? void 0 : ye.length) ?? 0) > 0;
    e.showEquipmentDropZone = !C;
    const v = ((Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.abilities) ?? {}, E = a.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, F;
      return {
        id: k.id,
        name: k.name,
    ...
    }), A = new Map(E.map((k) => [k.id, k])), j = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      const o = this.actor.items.get(c);
      (w = o == null ? void 0 : o.sheet) == null || w.render(!0);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-u04UXRWm.mjs");
      o(this.actor, c);
      ...
      !c && ((n = i == null ? void 0 : i.dataset) != null && n.slot) && (c = (((((h = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : h.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!c || !this.actor) && await this._rollWeaponDamage(c, (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slot) ?? "").trim());
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-u04UXRWm.mjs");
      n(this.actor, c, o);
      ...
      const i = (w = (h = u.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : w.area, c = (_ = (I = u.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : _.itemId;
      if (!i || !c || !this.actor) return;
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, p = (Array.isArray((O = o[i]) == null ? void 0 : O.items) ? o[i].items.slice() : []).filter((C) => C !== c);
      ...
      if (!c || !this.actor) return;
      const o = this.actor, n = (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slotKey) ?? "").trim(), p = {};
      ...
      if (!i || !this.actor) return;
      const c = ((I = (w = this.actor.system) == null ? void 0 : w.gear) == null ? void 0 : I.microchips) ?? {}, n = ["slot1", "slot2", "slot3"].find((_) => {
        var q;
        return (((q = c[_]) == null ? void 0 : q.itemId) ?? "").trim() === i;
      });
    ...
    (b = (y = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : y.call(e, d)) == null || b.forEach((u) => {
      ...
      if (!o) return;
      const n = o.uuid;
      u.dataTransfer && (u.dataTransfer.setData("text/plain", n), u.dataTransfer.setData("application/json", JSON.stringify({ type: "Item", uuid: n })), u.dataTransfer.effectAllowed = "copyMove"), typeof ((w = u.dataTransfer) == null ? void 0 : w.setDragImage) == "function" && i && u.dataTransfer.setDragImage(i, 0, 0);
    });
    const r = this, l = (u) => {
      if (!u) return;
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const a = (((I = e.system) == null ? void 0 : I.weapons) ?? {})[s] ?? {}, d = ((_ = e.system) == null ? void 0 : _.skills) ?? {}, r = ((q = e.items) == null ? void 0 : q.filter((C) => C.type === "Fegyver")) ?? [];
    let l = null;
    a.itemId && (l = r.find((C) => C.id === a.itemId) ?? null);
    const f = l && l.name || a.name || "Fegyver", m = Number(a.bonus || 0) || 0, b = (((O = l == null ? void 0 : l.system) == null ? void 0 : O.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", u = Number(d[b] || 0) || 0, i = m + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, n = new Roll(o);
    await n.evaluate({ async: !0 });
    const { resultType: p, label: h } = We(n), w = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return n.toMessage({
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, n, p, h, w, I, _, q, O, C;
    if (!this.actor) return (y = super._onDropItem) == null ? void 0 : y.call(this, s, e);
    const a = ((v) => {
      var A;
      if (!v) return null;
      const E = v.uuid ?? v.documentUuid ?? ((A = v.data) == null ? void 0 : A.uuid) ?? (typeof v == "string" ? v : null);
      if (E) return E;
      if (typeof v == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((i = d.parent) == null ? void 0 : i.id) !== r.id) {
        ...
        v = ((c = (await r.createEmbeddedDocuments("Item", [V]))[0]) == null ? void 0 : c.id) ?? v;
      }
      const E = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), A = ((n = r.system) == null ? void 0 : n.abilities) ?? {}, j = E === "active" ? "active" : "passive", B = Array.isArray((p = A[j]) == null ? void 0 : p.items) ? A[j].items.slice() : Array.isArray(A[j]) ? A[j].slice() : [];
      B.includes(v) || B.push(v), await r.update({ [`system.abilities.${j}.items`]: B }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    const m = (w = (await r.createEmbeddedDocuments("Item", [l]))[0]) == null ? void 0 : w.id;
    if (d.type === "Fegyver" && m) {
      const v = ((I = r.system) == null ? void 0 : I.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (v.slotOrder ?? "").trim(), j = A ? A.split(/\s*,\s*/).filter((z) => E.includes(z)) : [];
      let B = E.find((z) => {
        var ee;
        return !(((ee = v[z]) == null ? void 0 : ee.itemId) ?? "").trim();
      });
      B || (B = E.find((z) => !j.includes(z)) ?? "slot1");
      const V = j.includes(B) ? j : [...j, B].filter((z) => E.includes(z));
      await r.update({
        "system.weapons.slotOrder": V.join(","),
        [`system.weapons.${B}.itemId`]: m,
        [`system.weapons.${B}.name`]: d.name ?? "",
        [`system.weapons.${B}.damage`]: ((_ = d.system) == null ? void 0 : _.damage) ?? "",
        [`system.weapons.${B}.bonus`]: ((q = d.system) == null ? void 0 : q.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const v = ((C = (O = r.system) == null ? void 0 : O.gear) == null ? void 0 : C.microchips) ?? {}, A = ["slot1", "slot2", "slot3"].find((j) => {
        var B;
        return !(((B = v[j]) == null ? void 0 : B.itemId) ?? "").trim();
      });
      A && await r.update({
...
G(Z, "PARTS", foundry.utils.mergeObject(
  ...
  K(Z, Z, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ct = K(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((qt = K(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : qt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Pt = (Lt = K(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : Lt.window) == null ? void 0 : Pt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
G(ie, "PARTS", foundry.utils.mergeObject(K(ie, ie, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), G(ie, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(ie, ie, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Nt = K(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Nt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = ie;
var Et;
...
G(re, "PARTS", foundry.utils.mergeObject(K(re, re, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), G(re, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(re, re, "DEFAULT_OPTIONS"), {
...
G(ne, "PARTS", foundry.utils.mergeObject(K(ne, ne, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), G(ne, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(ne, ne, "DEFAULT_OPTIONS"), {
...
G(ae, "PARTS", foundry.utils.mergeObject(K(ae, ae, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), G(ae, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(ae, ae, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ft = K(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ft.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = ae;
var $t;
...
G(oe, "PARTS", foundry.utils.mergeObject(K(oe, oe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), G(oe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(oe, oe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject((($t = K(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : $t.form) ?? {}, { submitOnChange: !1 })
}));
let et = oe;
var xt;
...
G(ce, "PARTS", foundry.utils.mergeObject(K(ce, ce, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), G(ce, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(ce, ce, "DEFAULT_OPTIONS"), {
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    for (const v of n)
      ((_ = v.document) == null ? void 0 : _.id) !== b || ((q = v.document) == null ? void 0 : q.documentName) !== "Actor" || ((O = v.constructor) == null ? void 0 : O.name) !== "VoidKarakterSheet" || c.includes(v) || c.push(v);
    if (i && c.some((v) => {
      const E = (v == null ? void 0 : v.form) ?? (v == null ? void 0 : v.element);
      return E && E.contains(u);
    })) return;
    const h = (C = game.votv) == null ? void 0 : C._lastKarakterSheetBlurSave, w = h && Date.now() - h.at < N ? h.appId : null;
    setTimeout(() => {
      for (const v of c)
    ...
    for (const [p, h] of Object.entries(u)) {
      ...
      const w = ((h == null ? void 0 : h.itemId) ?? "").trim();
      !w || w !== l.id || (i[`system.weapons.${p}.name`] = l.name ?? "", i[`system.weapons.${p}.damage`] = ((o = l.system) == null ? void 0 : o.damage) ?? "", i[`system.weapons.${p}.bonus`] = ((n = l.system) == null ? void 0 : n.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, w, I, _, q, O, C, v, E, A, j, B, V, z, ee, fe, le, ue, ve, we, Ie, Se;
    ...
    if (!a) return;
    const d = (w = game.messages) == null ? void 0 : w.get(a), r = (_ = (I = d == null ? void 0 : d.flags) == null ? void 0 : I["vacuum-of-the-void"]) == null ? void 0 : _.weapon;
    if (!r) return;
    const l = r.actorId ?? ((q = d == null ? void 0 : d.speaker) == null ? void 0 : q.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let f = ((O = game.actors) == null ? void 0 : O.get(r.actorId)) ?? ((C = game.actors) == null ? void 0 : C.get(l));
    if (f || (f = ((E = (v = game.scenes) == null ? void 0 : v.contents) == null ? void 0 : E.flatMap((J) => {
      var ye;
      return ((ye = J.tokens) == null ? void 0 : ye.contents) ?? [];
    }).map((J) => J.actor).find((J) => J && (J.id === l || J.id === r.actorId))) ?? null), !f) return;
    const m = r.itemId ? ((j = (A = f.items) == null ? void 0 : A.get) == null ? void 0 : j.call(A, r.itemId)) ?? ((z = (V = (B = f.items) == null ? void 0 : B.contents) == null ? void 0 : V.find) == null ? void 0 : z.call(V, (te) => te.id === r.itemId)) : null;
...
Hooks.on("preCreateToken", (N, s, e) => {
  var r, l;
  const t = (r = game.votv) == null ? void 0 : r._dragSourceActorId, a = t ?? N.actorId ?? null;
...
Hooks.on("renderChatMessageHTML", (N, s, e) => {
  var m, y, b, u;
  const t = ((m = N.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, a = t.resultType, d = t.critLabel, r = t.weaponAttack, l = t.weapon;
  if (!a && !d && !r) return;
  ...
  if (f) {
    ...
    if (r && l && (l.actorId || (b = N.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = h != null && w ? `Sebzés (Találati Hely ${h} - ${w})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((u = N.speaker) == null ? void 0 : u.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(N.id ?? ""), c.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-Byp32bLJ.mjs.map
