...
var X = (w, s, e) => As(w, typeof s != "symbol" ? s + "" : s, e);
...
const { BooleanField: xs, NumberField: Js, StringField: qe } = foundry.data.fields;
class as extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      skillKey: new qe({ required: !1, blank: !0, initial: "grenadeUse" })
    };
  }
}
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ze, et, tt, st, it, nt, at, rt, ot, Ee, ct, lt, $e, k, F, E, H, re, W, fe, de, oe, Te, xe, Re, Tt, _t, Dt, Ot, ut, Ge, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt, Xt, Zt, es, ts;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((tt = (et = (Ze = this.actor.system) == null ? void 0 : Ze.resources) == null ? void 0 : et.stress) == null ? void 0 : tt.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const g of l) {
      const O = ((st = d[g]) == null ? void 0 : st.value) ?? 0, _ = r[g] ?? 0;
    ...
    const o = Number(((rt = (at = this.actor.system) == null ? void 0 : at.combat) == null ? void 0 : rt.givenProtection) ?? 0) || 0, a = (ct = (Ee = (ot = this.actor) == null ? void 0 : ot.statuses) == null ? void 0 : Ee.has) != null && ct.call(Ee, "lookaround") ? 1 : 0, f = (k = ($e = (lt = this.actor) == null ? void 0 : lt.statuses) == null ? void 0 : $e.has) != null && k.call($e, "halfcover") ? 3 : 0, h = (H = (E = (F = this.actor) == null ? void 0 : F.statuses) == null ? void 0 : E.has) != null && H.call(E, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + a + f + h;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: v } },
      { inplace: !1 }
    );
    const I = ((re = e.system) == null ? void 0 : re.combat) ?? {};
    ...
    b === 0 && (D = 0), (de = (fe = (W = this.actor) == null ? void 0 : W.statuses) == null ? void 0 : fe.has) != null && de.call(fe, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Te = (oe = e.system) == null ? void 0 : oe.combat) == null ? void 0 : Te.givenProtection } },
      { inplace: !1 }
    ), D = 0), e.totalSpeed = D;
    ...
    const C = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = (C.slotOrder ?? "").trim(), A = x ? x.split(/\s*,\s*/).filter((g) => L.includes(g)) : [], j = (xe = this.actor.system.gear) == null ? void 0 : xe.microchips, z = j && typeof j == "object" && !Array.isArray(j) ? j : {}, U = (((Re = z.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), V = (((Tt = z.slot2) == null ? void 0 : Tt.itemId) ?? "").trim(), se = (((_t = z.slot3) == null ? void 0 : _t.itemId) ?? "").trim(), M = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, P = typeof O.sort == "number" ? O.sort : 0;
      return _ - P;
    }).map((g) => {
      var _e, Ke, je, Oe, Ce, dt;
      const O = g.type === "Fegyver", _ = g.type === "MikroChip";
      let P = 0, R = "", Z = null;
      for (let Ve = 0; Ve < A.length; Ve++) {
        const mt = A[Ve];
        if ((((_e = C[mt]) == null ? void 0 : _e.itemId) ?? "") === g.id) {
          P = Ve + 1, R = ((Ke = C[mt]) == null ? void 0 : Ke.bonus) ?? "", Z = mt;
          break;
        }
      }
      let Y = null;
      _ && (U === g.id ? Y = "slot1" : V === g.id ? Y = "slot2" : se === g.id && (Y = "slot3"));
      const Me = O && ((je = g.system) != null && je.damage) ? g.system.damage : "", ce = O && typeof ((Oe = g.system) == null ? void 0 : Oe.range) == "string" ? (g.system.range || "").trim() : "", me = Z ? Number((Ce = C[Z]) == null ? void 0 : Ce.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.actionsTable = M;
    const J = (((Dt = this.actor.items) == null ? void 0 : Dt.contents) ?? []).filter((g) => g.type === "Fegyver"), ne = J.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = ne;
    const we = "— Nincs fegyver —", pe = A.filter((g) => {
      const _ = ((C[g] ?? {}).itemId ?? "").trim();
      return _ ? !!J.find((R) => R.id === _) : !1;
    });
    e.weaponSlots = pe.map((g, O) => {
      const _ = C[g] ?? {}, P = (_.itemId ?? "").trim(), R = ne.find((me) => me.id === P), Z = J.find((me) => me.id === P), Y = (Z == null ? void 0 : Z.system) ?? {}, Me = Y.size === "thrown", ce = (typeof Y.range == "string" ? (Y.range || "").trim() : "") || "—";
      return {
        slotKey: g,
        itemId: P,
        slotNum: O + 1,
        displayName: (R == null ? void 0 : R.name) || _.name || we,
    ...
    const Ie = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ae = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = J.map((g) => {
      ...
      const R = !!_, Z = ((is = g.system) == null ? void 0 : is.equipped) !== void 0 && ((ns = g.system) == null ? void 0 : ns.equipped) !== null ? !!g.system.equipped : R, Y = (g == null ? void 0 : g.system) ?? {}, Me = typeof Y.range == "string" ? (Y.range || "").trim() : "", ce = Y.type ?? "", me = (Ie[ce] ?? ce) || "—", _e = Y.size ?? "", Ke = (ae[_e] ?? _e) || "", je = [me, Ke].filter(Boolean).join(", ") || me || "—", Oe = ce === "projectile" || _e === "thrown", Ce = Y.quantity, dt = Ce != null ? String(Ce).trim() : "1", Ve = String(P.bonus ?? "").trim(), mt = String(Y.bonus ?? "").trim(), qs = Ve || mt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? we,
        ...
        typeAndSize: je,
        quantity: dt,
        quantityDisplay: Oe ? dt : "—",
        isProjectile: Oe,
        equipped: Z,
        special: (Y.special ?? "").trim() || "—"
      };
    });
    const le = (((Ot = this.actor.items) == null ? void 0 : Ot.contents) ?? []).filter((g) => g.type === "Pancel");
    e.armorTable = le.map((g) => {
      var P, R;
    ...
    const Le = (((ut = this.actor.items) == null ? void 0 : ut.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const ze = (((Ge = this.actor.items) == null ? void 0 : Ge.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const yt = (((zt = this.actor.items) == null ? void 0 : zt.contents) ?? []).filter((g) => g.type === "MikroChip"), ie = yt.map((g) => ({ id: g.id, name: g.name, img: g.img })), We = "— Nincs Mikro-Chip —", Se = ["slot1", "slot2", "slot3"], He = (g) => {
      var _, P, R;
      const O = [];
    ...
    e.microchipItemsSlot1 = ie.filter((g) => !He(1).includes(g.id)), e.microchipItemsSlot2 = ie.filter((g) => !He(2).includes(g.id)), e.microchipItemsSlot3 = ie.filter((g) => !He(3).includes(g.id)), e.microchipSlots = Se.map((g) => {
      const O = z[g] ?? {}, _ = (O.itemId ?? "").trim(), P = yt.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || O.name || We,
        img: (P == null ? void 0 : P.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, _ = z[O] ?? {}, P = (_.itemId ?? "").trim(), R = ie.find((Z) => Z.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (R == null ? void 0 : R.name) || _.name || We, e[`microchip${g}Img`] = (R == null ? void 0 : R.img) || "";
    }), e.microchipsTable = yt.map((g) => {
      var _e, Ke, je, Oe;
      const O = g.id;
      let _ = null;
      for (const Ce of Se)
        if ((((_e = z[Ce]) == null ? void 0 : _e.itemId) ?? "").trim() === O) {
          _ = Ce;
          break;
        }
      const P = !!_, R = ((Ke = g == null ? void 0 : g.system) == null ? void 0 : Ke.abilityType) ?? "", Z = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Y = R === "active", Me = Number((je = g == null ? void 0 : g.system) == null ? void 0 : je.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ce = (((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.description) ?? "").trim(), me = ce ? ce.length > 60 ? ce.slice(0, 57) + "…" : ce : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    }), Ue = new Map(jt.map((g) => [g.id, g])), bt = "— Nincs képesség —", Ye = (g) => {
      const O = ht[g] ?? {}, _ = (O.itemId ?? "").trim(), P = _ ? Ue.get(_) : null, R = (P == null ? void 0 : P.description) ?? "", Z = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: _,
    ...
    e.abilityPassiveList = Qe(Je("passive")), e.abilityActiveList = Qe(Je("active"));
    const kt = ((Wt = e.system) == null ? void 0 : Wt.resources) ?? {}, Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ne = (Jt = (Yt = e.system) == null ? void 0 : Yt.combat) == null ? void 0 : Jt.initiativeResult, ue = typeof Ne == "number" ? Ne : -1, vt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (Xt = (Qt = e.system) == null ? void 0 : Qt.combat) == null ? void 0 : Xt.initiativeRanges, Ae = Array.isArray(Pe) ? Pe.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], De = (Ae.length > 0 ? Ae : vt).slice().sort((g, O) => g.min - O.min), Fe = Ae.map((g) => g.min), wt = Fe.length ? Math.min(...Fe) : 0, It = Fe.length ? Math.max(...Fe) : 0;
    e.initiativeRanges = Ae.map((g) => ({ ...g, isFirst: g.min === wt, isLast: g.min === It }));
    let Xe = 0;
    if (typeof ue == "number" && ue >= 0 && De.length > 0) {
      const g = De[0], O = De[De.length - 1];
      let _ = null;
      ue <= g.max ? _ = g : ue >= O.min ? _ = O : _ = De.find((P) => ue >= P.min && ue <= P.max), _ && (Xe = _.kp);
    }
    e.kpDots = Be.map((g, O) => {
      const _ = O + 1, P = !!Number(kt[g]), R = _ <= Xe;
    ...
    return e.showHarcSection = St, e.canEditInitiative = !!((ts = game.user) != null && ts.isGM), e.showInitiativeResult = typeof Ne == "number", e.initiativeResult = e.showInitiativeResult ? Ne : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BpT9n8g9.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BpT9n8g9.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-BpT9n8g9.mjs");
      f(this.actor, o, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ye, Je, Qe, kt, Be, Ne, ue, vt, Pe, Ae, qt, De, Fe, wt, It, Xe, St, Ze, et, tt, st, it, nt, at, rt, ot, Ee, ct, lt, $e;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Ye = this.actor) == null ? void 0 : Ye.system), e.showDeathSkull = !1, e.sizeForSelect = (((Qe = (Je = e.system) == null ? void 0 : Je.identity) == null ? void 0 : Qe.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((kt = e.system) == null ? void 0 : kt.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (Ne = (Be = t == null ? void 0 : t.statuses) == null ? void 0 : Be.has) != null && Ne.call(Be, "lookaround") ? 1 : 0, l = (vt = (ue = t == null ? void 0 : t.statuses) == null ? void 0 : ue.has) != null && vt.call(ue, "halfcover") ? 3 : 0, m = (Ae = (Pe = t == null ? void 0 : t.statuses) == null ? void 0 : Pe.has) != null && Ae.call(Pe, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = d + r + l + m;
    const p = ((qt = t == null ? void 0 : t.items) == null ? void 0 : qt.contents) ?? [], y = ((De = t == null ? void 0 : t.system) == null ? void 0 : De.weapons) ?? {}, b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (y.slotOrder ?? "").trim(), i = u ? u.split(/\s*,\s*/).filter((k) => b.includes(k)) : [], c = p.filter((k) => k.type === "Fegyver"), o = c.map((k) => ({ id: k.id, name: k.name, img: k.img })), a = "— Nincs fegyver —", f = i.length > 0 ? i : b, h = b.filter((k) => !f.includes(k)), v = [...f, ...h], I = v.filter((k) => {
      var E;
      const F = (((E = y[k]) == null ? void 0 : E.itemId) ?? "").trim();
      return F && c.some((H) => H.id === F);
    });
    e.weaponSlots = I.map((k) => {
      const F = y[k] ?? {}, E = (F.itemId ?? "").trim(), H = o.find((oe) => oe.id === E), re = c.find((oe) => oe.id === E), W = (re == null ? void 0 : re.system) ?? {}, fe = W.size === "thrown", de = (typeof W.range == "string" ? (W.range || "").trim() : "") || "—";
      return {
        slotKey: k,
        itemId: E,
    ...
    e.weaponsTable = c.map((k) => {
      ...
      let E = null, H = {};
      for (const Ge of v)
        if ((((ut = y[Ge]) == null ? void 0 : ut.itemId) ?? "").trim() === F) {
          E = Ge, H = y[Ge] ?? {};
          break;
        }
      const re = !!E, W = (k == null ? void 0 : k.system) ?? {}, fe = typeof W.range == "string" ? (W.range || "").trim() : "", de = W.type ?? "", oe = (S[de] ?? de) || "—", Te = W.size ?? "", xe = (D[Te] ?? Te) || "", Re = [oe, xe].filter(Boolean).join(", ") || oe || "—", Tt = de === "projectile" || Te === "thrown", _t = W.quantity != null ? String(W.quantity).trim() : "1", Dt = String(W.bonus ?? H.bonus ?? "").trim() || "0", Ot = (W.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const C = ((wt = (Fe = t == null ? void 0 : t.system) == null ? void 0 : Fe.gear) == null ? void 0 : wt.microchips) ?? {}, L = ["slot1", "slot2", "slot3"], x = p.filter((k) => k.type === "MikroChip");
    e.microchipsTable = x.map((k) => {
      var de, oe, Te, xe;
      const F = k.id;
      let E = null;
      for (const Re of L)
        if ((((de = C[Re]) == null ? void 0 : de.itemId) ?? "").trim() === F) {
          E = Re;
          break;
        }
      const H = ((oe = k == null ? void 0 : k.system) == null ? void 0 : oe.abilityType) ?? "", re = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", W = (((Te = k == null ? void 0 : k.system) == null ? void 0 : Te.description) ?? "").trim(), fe = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        ...
        typeLabel: re,
        description: fe,
        kp: Number((xe = k == null ? void 0 : k.system) == null ? void 0 : xe.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: H === "active",
        slotKey: E ?? "",
        equipped: !!E
      };
    ...
    const z = (((It = e.weaponsTable) == null ? void 0 : It.length) ?? 0) > 0 || (((Xe = e.armorTable) == null ? void 0 : Xe.length) ?? 0) > 0 || (((St = e.microchipsTable) == null ? void 0 : St.length) ?? 0) > 0 || (((Ze = e.itemsTable) == null ? void 0 : Ze.length) ?? 0) > 0 || (((et = e.egyebList) == null ? void 0 : et.length) ?? 0) > 0;
    e.showEquipmentDropZone = !z;
    const U = ((tt = t == null ? void 0 : t.system) == null ? void 0 : tt.abilities) ?? {}, V = p.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, E;
      return {
        id: k.id,
        name: k.name,
    ...
    }), se = new Map(V.map((k) => [k.id, k])), Q = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const ne = t == null ? void 0 : t.id, we = !!((it = (st = game.combat) == null ? void 0 : st.combatants) != null && it.some(
      (k) => {
        var F;
        return (((F = k.actor) == null ? void 0 : F.id) ?? k.actorId) === ne;
      }
    ));
    e.showHarcSection = we;
    const pe = ((nt = e.system) == null ? void 0 : nt.resources) ?? {}, Ie = (rt = (at = e.system) == null ? void 0 : at.combat) == null ? void 0 : rt.initiativeResult, ae = typeof Ie == "number" ? Ie : -1, le = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Le = (Ee = (ot = e.system) == null ? void 0 : ot.combat) == null ? void 0 : Ee.initiativeRanges, ze = Array.isArray(Le) ? Le.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (ze.length > 0 ? ze : le).slice().sort((k, F) => k.min - F.min), We = 3;
    let Se = ze.length > 0 ? ze : [];
    Se.length < We && (Se = [...Se, ...Array(We - Se.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = Se.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === Se.length - 1
    }));
    let He = 0;
    if (typeof ae == "number" && ae >= 0 && ie.length > 0) {
      const k = ie[0], F = ie[ie.length - 1];
      let E = null;
      ae <= k.max ? E = k : ae >= F.min ? E = F : E = ie.find((H) => ae >= H.min && ae <= H.max), E && (He = E.kp);
    }
    const gt = ie.length > 0 ? ie[ie.length - 1] : null, ht = Math.min(10, gt ? gt.kp : 6), Ue = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, ht)).map((k, F) => {
      const E = F + 1, H = !!Number(pe[k]), re = E <= He;
      return { index: E, used: H, usable: re };
    }), bt = Math.ceil(Ue.length / 2);
    return e.kpDotsRow1 = Ue.slice(0, bt), e.kpDotsRow2 = Ue.slice(bt), e.canEditInitiative = !!((ct = game.user) != null && ct.isGM), e.showInitiativeResult = typeof Ie == "number", e.initiativeResult = e.showInitiativeResult ? Ie : "", e.speedUnitForSelect = (($e = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : $e.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var p, y, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BpT9n8g9.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BpT9n8g9.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BpT9n8g9.mjs");
      a(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Fegyver" && p) {
      const A = ((D = r.system) == null ? void 0 : D.weapons) ?? {}, j = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], z = (A.slotOrder ?? "").trim(), U = z ? z.split(/\s*,\s*/).filter((Q) => j.includes(Q)) : [];
      let V = j.find((Q) => {
        var M;
        return !(((M = A[Q]) == null ? void 0 : M.itemId) ?? "").trim();
      });
      V || (V = j.find((Q) => !U.includes(Q)) ?? "slot1");
      const se = U.includes(V) ? U : [...U, V].filter((Q) => j.includes(Q));
      await r.update({
...
X(ye, "PARTS", foundry.utils.mergeObject(B(ye, ye, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), X(ye, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ye, ye, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((bs = B(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : bs.form) ?? {}, { submitOnChange: !1 })
}));
let Et = ye;
var ks;
...
X(ge, "PARTS", foundry.utils.mergeObject(B(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), X(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ge, ge, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ks = B(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : ks.form) ?? {}, { submitOnChange: !1 })
}));
let $t = ge;
var vs;
...
X(he, "PARTS", foundry.utils.mergeObject(B(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), X(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(he, he, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((vs = B(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : vs.form) ?? {}, { submitOnChange: !1 })
}));
let xt = he;
var ws;
...
X(be, "PARTS", foundry.utils.mergeObject(B(be, be, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), X(be, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(be, be, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ws = B(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : ws.form) ?? {}, { submitOnChange: !0 })
}));
let Rt = be;
var Is;
...
X(ke, "PARTS", foundry.utils.mergeObject(B(ke, ke, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), X(ke, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ke, ke, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Is = B(ke, ke, "DEFAULT_OPTIONS")) == null ? void 0 : Is.form) ?? {}, { submitOnChange: !1 })
}));
let Mt = ke;
var Ss;
...
X(ve, "PARTS", foundry.utils.mergeObject(B(ve, ve, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), X(ve, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ve, ve, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ss = B(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Ss.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = ve;
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, D, N, C, L, x, A, j, z, U, V, se, Q;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const M = Number((N = (D = m.system) == null ? void 0 : D.combat) == null ? void 0 : N.initiativeResult), J = Number.isFinite(M) ? M : 0, ne = game.combat;
      if (ne) {
        const we = ((C = ne.combatants) == null ? void 0 : C.contents) ?? Array.from(ne.combatants ?? []);
        for (const pe of we)
          if (((L = pe.actor) == null ? void 0 : L.id) === u || pe.actorId === u) {
            ne.updateEmbeddedDocuments("Combatant", [{ _id: pe.id, initiative: J }]).catch(() => {
            });
            break;
          }
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, D, N, C, L, x, A, j, z, U, V, se, Q, M, J, ne, we, pe, Ie;
    ...
    if (m || (m = ((x = (L = game.scenes) == null ? void 0 : L.contents) == null ? void 0 : x.flatMap((le) => {
      var Le;
      return ((Le = le.tokens) == null ? void 0 : Le.contents) ?? [];
    }).map((le) => le.actor).find((le) => le && (le.id === l || le.id === r.actorId))) ?? null), !m) return;
    ...
    if (y || (y = (((se = p == null ? void 0 : p.system) == null ? void 0 : se.damage) ?? "").trim()), !y && r.slotKey && (y = (((((Q = m.system) == null ? void 0 : Q.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (we = (M = ui.notifications) == null ? void 0 : M.warn) == null || we.call(M, ((ne = (J = game.i18n) == null ? void 0 : J.localize) == null ? void 0 : ne.call(J, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (r.slotKey ? ((Ie = (((pe = m.system) == null ? void 0 : pe.weapons) ?? {})[r.slotKey]) == null ? void 0 : Ie.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-CML8Hom4.mjs.map
