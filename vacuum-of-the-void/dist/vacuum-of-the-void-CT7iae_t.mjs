...
const { NumberField: Kt, StringField: ct, SchemaField: Ds, ArrayField: Si } = foundry.data.fields;
...
const { NumberField: Ut, StringField: lt, SchemaField: _s, ArrayField: Di } = foundry.data.fields;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var dt, mt, pt, ft, yt, gt, ht, bt, vt, Je, kt, wt, Ze, I, E, P, G, ke, ne, qe, De, we, xe, Ye, Xe, Nt, Ft, At, Et, It, rt, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms, ps, fs;
    ...
    const me = (((ts = this.actor.items) == null ? void 0 : ts.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Me = (b) => {
      var L, A, B;
      const N = [];
    ...
    const He = (((ss = e.weaponsTable) == null ? void 0 : ss.length) ?? 0) > 0 || (((is = e.armorTable) == null ? void 0 : is.length) ?? 0) > 0 || (((ns = e.microchipsTable) == null ? void 0 : ns.length) ?? 0) > 0 || (((as = e.itemsTable) == null ? void 0 : as.length) ?? 0) > 0;
    e.showEquipmentDropZone = !He;
    const it = this.actor.system.abilities ?? {}, Ot = (((rs = this.actor.items) == null ? void 0 : rs.contents) ?? []).map((b) => {
      var N, L, A;
      return {
        id: b.id,
        name: b.name,
    ...
    const se = ((os = e.system) == null ? void 0 : os.resources) ?? {}, he = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ae = (ls = (cs = e.system) == null ? void 0 : cs.combat) == null ? void 0 : ls.initiativeResult, be = typeof ae == "number" ? ae : -1, at = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Oe = (ds = (us = e.system) == null ? void 0 : us.combat) == null ? void 0 : ds.initiativeRanges, Ce = Array.isArray(Oe) ? Oe.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], ze = (Ce.length > 0 ? Ce : at).slice().sort((b, N) => b.min - N.min), We = Ce.map((b) => b.min), Ct = We.length ? Math.min(...We) : 0, qt = We.length ? Math.max(...We) : 0;
    ...
    const Lt = !!((ps = (ms = game.combat) == null ? void 0 : ms.combatants) != null && ps.some((b) => {
      var N;
      return ((N = b.actor) == null ? void 0 : N.type) === "Karakter";
    }));
    return e.showHarcSection = Lt, e.canEditInitiative = !!((fs = game.user) != null && fs.isGM), e.showInitiativeResult = typeof ae == "number", e.initiativeResult = e.showInitiativeResult ? ae : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-jcNLAL0H.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-jcNLAL0H.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-jcNLAL0H.mjs");
      h(this.actor, o, m);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-jcNLAL0H.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-jcNLAL0H.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-jcNLAL0H.mjs");
      m(this.actor, r, o);
  ...
  async _prepareContext(s) {
    ...
    e.armorTable = d.map((D) => {
      ...
      return {
        ...
        level: qi((R.level ?? "").toString().trim()),
...
//# sourceMappingURL=vacuum-of-the-void-CT7iae_t.mjs.map
