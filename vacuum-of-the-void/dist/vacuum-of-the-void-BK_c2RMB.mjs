...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Ce, Ne, Ee, Pe, $e, xe, je, Me, Ke, Re, Ue, He, Be, Ge, ze, We, Ye;
    ...
    e.weaponSlots = dt.map((o, k) => {
      const I = g[o] ?? {}, q = (I.itemId ?? "").trim(), _ = Se.find((M) => M.id === q);
      return {
        slotKey: o,
        itemId: q,
        slotNum: k + 1,
        displayName: (_ == null ? void 0 : _.name) || I.name || qe,
    ...
    e.weaponsTable = ue.map((o) => {
      ...
      const _ = !!I, M = ((re = o.system) == null ? void 0 : re.equipped) !== void 0 && ((Qe = o.system) == null ? void 0 : Qe.equipped) !== null ? !!o.system.equipped : _, R = (o == null ? void 0 : o.system) ?? {}, ae = typeof R.range == "string" ? (R.range || "").trim() : "", Q = R.type ?? "", J = (mt[Q] ?? Q) || "—", X = R.size ?? "", ee = (pt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = R.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: I ?? "",
        itemId: k,
    ...
    const yt = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((o) => o.type === "Targy");
    ...
    e.microchipItemsSlot1 = oe.filter((o) => !me(1).includes(o.id)), e.microchipItemsSlot2 = oe.filter((o) => !me(2).includes(o.id)), e.microchipItemsSlot3 = oe.filter((o) => !me(3).includes(o.id)), e.microchipSlots = Oe.map((o) => {
      ...
      e[`microchip${o}ItemId`] = q, e[`microchip${o}DisplayName`] = (_ == null ? void 0 : _.name) || I.name || Te, e[`microchip${o}Img`] = (_ == null ? void 0 : _.img) || "";
    ...
    const De = this.actor.system.abilities ?? {}, gt = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).map((o) => {
      ...
      const k = De[o] ?? {}, I = (k.itemId ?? "").trim(), q = I ? _e.get(I) : null, _ = (q == null ? void 0 : q.description) ?? "", M = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: I,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-BmOP19r_.mjs");
      d(this.actor, u);
    ...
    r && s({ currentTarget: r }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, u = l.dataset.skill, d = ((f = l.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-BmOP19r_.mjs");
      m(this.actor, u, d);
...
//# sourceMappingURL=vacuum-of-the-void-BK_c2RMB.mjs.map
