...
var st = Reflect.get;
var rt = (N, s, e) => s in N ? et(N, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[s] = e;
var H = (N, s, e) => rt(N, typeof s != "symbol" ? s + "" : s, e);
var K = (N, s, e) => st(tt(N), e, s);
const { HTMLField: it, NumberField: v, SchemaField: T, StringField: y, BooleanField: M, ArrayField: ae } = foundry.data.fields;
...
const { NumberField: le, SchemaField: nt } = foundry.data.fields;
class ot extends at {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: lt, NumberField: yt, StringField: J } = foundry.data.fields;
...
const { NumberField: dt, StringField: Re } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const l = this.actor.system.weapons ?? {}, d = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], f = (l.slotOrder ?? "").trim(), w = f ? f.split(/\s*,\s*/).filter((m) => d.includes(m)) : [], I = (_e = this.actor.system.gear) == null ? void 0 : _e.microchips, D = I && typeof I == "object" && !Array.isArray(I) ? I : {}, F = (((Le = D.slot1) == null ? void 0 : Le.itemId) ?? "").trim(), _ = (((Ae = D.slot2) == null ? void 0 : Ae.itemId) ?? "").trim(), O = (((Fe = D.slot3) == null ? void 0 : Fe.itemId) ?? "").trim(), C = this.actor.items.contents.filter((m) => m.type !== "Kepesseg" && m.type !== "ability").slice().sort((m, S) => {
    ...
    e.weaponItems = R;
    const fe = "— Nincs fegyver —", Je = w.filter((m) => {
      const q = ((l[m] ?? {}).itemId ?? "").trim();
      return q ? !!j.find((A) => A.id === q) : !1;
    });
    e.weaponSlots = Je.map((m, S) => {
    ...
    e.weaponsTable = j.map((m) => {
      ...
      const A = !!q, x = ((X = m.system) == null ? void 0 : X.equipped) !== void 0 && ((Ke = m.system) == null ? void 0 : Ke.equipped) !== null ? !!m.system.equipped : A, P = (m == null ? void 0 : m.system) ?? {}, Q = typeof P.range == "string" ? (P.range || "").trim() : "", W = P.type ?? "", G = (Qe[W] ?? W) || "—", Z = P.size ?? "", re = (Xe[Z] ?? Z) || "", ie = [G, re].filter(Boolean).join(", ") || G || "—", V = G === "Lövedékes", ee = P.quantity, te = ee != null ? String(ee).trim() : "1";
      return {
        slotKey: q ?? "",
        itemId: S,
    ...
    const he = this.actor.system.abilities ?? {}, Ze = (((Pe = this.actor.items) == null ? void 0 : Pe.contents) ?? []).map((m) => {
      var S, q, L;
      return {
        id: m.id,
        name: m.name,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-CxrdVtm_.mjs");
      l(this.actor, o);
    ...
    n && a({ currentTarget: n }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var f;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, l = ((f = r.textContent) == null ? void 0 : f.trim()) || o, { openRollSheetForSkill: d } = await import("./roll-sheet-CxrdVtm_.mjs");
      d(this.actor, o, l);
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = ot, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ct, CONFIG.Item.dataModels.microchip = ut, CONFIG.Item.dataModels.Kepesseg = mt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health", "resources.stress"],
    value: []
  }, (a = CONFIG.Actor).typeLabels ?? (a.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", (n = CONFIG.Item).typeLabels ?? (n.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.Kepesseg = "Képesség", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", ue, {
    types: ["Karakter"],
    makeDefault: !0,
...
//# sourceMappingURL=vacuum-of-the-void-BooVIIzG.mjs.map
