...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const p = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, c = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      ...
      if (this._applyScrollState(p, h), (n == null ? void 0 : n.name) != null || (n == null ? void 0 : n.id) != null) {
        const v = ((d = y.querySelector) == null ? void 0 : d.call(y, n.id ? `#${CSS.escape(n.id)}` : null)) ?? (n.name ? (g = y.querySelector) == null ? void 0 : g.call(y, `[name="${CSS.escape(n.name)}"]`) : null);
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.speedPenalty) ?? "").trim().replace(",", "."), m = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.protectionBonus) ?? "").trim().replace(",", "."), m = Number(a);
      Number.isFinite(m) && (e += m);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, f = ((u = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : u.value) ?? 0, s = ((d = r.currentHealth) == null ? void 0 : d.legs) ?? 0, a = N._healthStatusFromRatio(s, f), m = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let p;
    a === 0 ? p = 0 : a === 1 ? p = -6 : a === 2 ? p = -3 : p = m;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const f = (Number(((p = (m = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : m.combat) == null ? void 0 : p.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((s = this.actor.system) == null ? void 0 : s.resources) ?? {}, r = ((m = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : m.value) ?? 0, f = ((p = t.currentHealth) == null ? void 0 : p[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, f = ((p = (m = r.hitLocations) == null ? void 0 : m[t]) == null ? void 0 : p.value) ?? 0, s = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
  ...
  async _prepareContext(i) {
    ...
    const m = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((o) => (Number(s[o]) || 0) === 0).length;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-BoEYmorW.mjs");
      u(this.actor, l);
      ...
      if (!l) {
        ...
        if (!v) return;
        l = (((((d = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : d.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
    ...
    f && r({ currentTarget: f }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const c = n.currentTarget, l = c.dataset.skill, u = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: d } = await import("./roll-sheet-BoEYmorW.mjs");
      d(this.actor, l, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const d = this.actor.system.weapons ?? {}, g = (d.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = g ? g.split(/\s*,\s*/).filter((k) => v.includes(k)) : [], q = S.find((k) => {
        var A;
        return (((A = d[k]) == null ? void 0 : A.itemId) ?? "").trim() === l;
      }) ?? null;
      if (c.checked) {
        if (q) return;
        let k = S.find((x) => {
      ...
      var k;
      n.preventDefault();
      const c = n.currentTarget, l = c.closest(".karakter-microchip-slot-select-wrap"), u = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), d = u == null ? void 0 : u.dataset.slot;
      if (!d) return;
    ...
    const a = this, m = (n) => {
      ...
      const l = ((d = (u = c.system) == null ? void 0 : u.resources) == null ? void 0 : d.currentHealth) != null || ((v = (g = c.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
    ...
    a._votvBlur = (n) => {
      ...
      const u = c.form;
      p(u) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), m(u));
  ...
  async _onDropItem(i, e) {
    ...
    if (e) {
      let u = e.uuid ?? e.documentUuid ?? ((m = e.data) == null ? void 0 : m.uuid) ?? (typeof e == "string" ? e : null);
      if (!u && typeof e == "object") {
        for (const d of Object.values(e))
          if (typeof d == "string" && d.includes(".") && d.startsWith("Item.")) {
            u = d;
      ...
      if (u) {
        ...
        if (d && d.documentName === "Item" && d.type === "Fegyver") {
          const g = this.actor, v = ((p = d.parent) == null ? void 0 : p.id) !== g.id;
          let S = d.id;
          if (v) {
        ...
        if (d && d.documentName === "Item" && d.type === "Pancel") {
          const g = this.actor;
          if (((n = d.parent) == null ? void 0 : n.id) !== g.id) {
        ...
        if (d && d.documentName === "Item" && (d.type === "Targy" || d.type === "Egyeb")) {
          const g = this.actor;
          ((l = d.parent) == null ? void 0 : l.id) !== g.id && await g.createEmbeddedDocuments("Item", [d.toObject()]);
          return;
        }
      }
    }
  ...
  async _postItemToChat(i) {
    ...
    let r;
    e.type === "MikroChip" ? r = ((((m = e.system) == null ? void 0 : m.abilityType) ?? "passive") === "active" ? "Aktív" : "Passzív") + " Mikro-Chip" : r = "Egyéb Információ";
    const f = t ? `<p>${t}</p>` : "", s = `
      <h2>${e.name}</h2>
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, f = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", m = f ? `<p>${f}</p>` : "", p = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      f = ((m = (await this.actor.createEmbeddedDocuments("Item", [p]))[0]) == null ? void 0 : m.id) ?? f;
    }
    await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    s === 1 ? f -= 6 : s === 2 && (f -= 3);
    const m = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, p = new Roll(m);
  ...
  async _rollWeapon(i) {
    ...
    const a = s && s.name || t.name || `Fegyver (${i})`, m = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = m + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, u = new Roll(l);
    await u.evaluate({ async: !0 });
    const d = u.total >= 18 ? "critical" : u.total <= 3 ? "fumble" : null, g = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${a} – találat`,
  ...
  async _rollWeaponDamage(i, e = "") {
    var m, p, y, h, n, c, l, u, d, g;
    const t = this.actor;
    if (!t) return;
    let r = ((p = (m = t.items).get) == null ? void 0 : p.call(m, i)) ?? ((h = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : h.call(y, (v) => v.id === i));
    ...
    if (!f && e && (f = (((((c = t.system) == null ? void 0 : c.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (g = (l = ui.notifications) == null ? void 0 : l.warn) == null || g.call(l, ((d = (u = game.i18n) == null ? void 0 : u.localize) == null ? void 0 : d.call(u, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const s = new Roll(f);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var m, p, y, h;
      if (!e.isEditable || !((p = (m = s.target) == null ? void 0 : m.closest) != null && p.call(m, ".profile")) && ((h = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
    ...
    const r = (s) => {
      ...
      var a, m, p;
      return s && (((m = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : m.call(a, s)) || e.id && ((p = s.closest) == null ? void 0 : p.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var m, p, y;
      const a = ((m = s.target) == null ? void 0 : m.form) ?? ((y = (p = s.target) == null ? void 0 : p.closest) == null ? void 0 : y.call(p, "form"));
      f(a) && r(a);
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (s) => {
      ...
      f(m) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(m), 300));
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const r = (s) => {
      if (!s) return;
      const a = e._getFormDataForUpdate(s);
      Object.keys(a).length !== 0 && e.document.update(a).catch((m) => console.warn("VoidEgyebSheet save failed", m));
    }, f = (s) => {
      var a, m, p;
      return s && (((m = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : m.call(a, s)) || e.id && ((p = s.closest) == null ? void 0 : p.call(s, `#${CSS.escape(e.id)}`)));
    };
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (p = (m = e.target) == null ? void 0 : m.closest) == null ? void 0 : p.call(m, "[data-document-id]"), r = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!r) return;
...
//# sourceMappingURL=vacuum-of-the-void-DtZcjD7e.mjs.map
