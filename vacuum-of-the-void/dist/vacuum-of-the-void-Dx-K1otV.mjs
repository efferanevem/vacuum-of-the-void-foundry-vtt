...
const { HTMLField: Ws, NumberField: F, SchemaField: z, StringField: O, BooleanField: ue, ArrayField: kt } = foundry.data.fields;
...
const J = class J extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var rt, ot, ct, lt, ut, dt, mt, pt, ft, He, yt, gt, Be, w, x, R, U, ge, ee, Se, we, he, Ne, Ge, Ve, Ct, qt, Lt, Nt, ht, Ze, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs;
    ...
    y === 0 && (D = 0), (we = (Se = (ee = this.actor) == null ? void 0 : ee.statuses) == null ? void 0 : Se.has) != null && we.call(Se, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const _ = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (_.slotOrder ?? "").trim(), A = M ? M.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], H = (Ge = this.actor.system.gear) == null ? void 0 : Ge.microchips, B = H && typeof H == "object" && !Array.isArray(H) ? H : {}, V = (((Ve = B.slot1) == null ? void 0 : Ve.itemId) ?? "").trim(), W = (((Ct = B.slot2) == null ? void 0 : Ct.itemId) ?? "").trim(), ce = (((qt = B.slot3) == null ? void 0 : qt.itemId) ?? "").trim(), k = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      for (let et = 0; et < A.length; et++) {
        ...
        if ((((Fe = _[vt]) == null ? void 0 : Fe.itemId) ?? "") === b.id) {
          E = et + 1, j = ((Je = _[vt]) == null ? void 0 : Je.bonus) ?? "", oe = vt;
          break;
        }
      }
      let se = null;
      L && (V === b.id ? se = "slot1" : W === b.id ? se = "slot2" : ce === b.id && (se = "slot3"));
      const We = N && ((Ye = b.system) != null && Ye.damage) ? b.system.damage : "", be = N && typeof ((Ee = b.system) == null ? void 0 : Ee.range) == "string" ? (b.system.range || "").trim() : "", Ie = oe ? Number((Pe = _[oe]) == null ? void 0 : Pe.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.actionsTable = k;
    const P = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).filter((b) => b.type === "Fegyver"), G = P.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = G;
    const Y = "— Nincs fegyver —", te = A.filter((b) => {
      const L = ((_[b] ?? {}).itemId ?? "").trim();
      return L ? !!P.find((j) => j.id === L) : !1;
    });
    e.weaponSlots = te.map((b, N) => {
      const L = _[b] ?? {}, E = (L.itemId ?? "").trim(), j = G.find((Ie) => Ie.id === E), oe = P.find((Ie) => Ie.id === E), se = (oe == null ? void 0 : oe.system) ?? {}, We = se.size === "thrown", be = (typeof se.range == "string" ? (se.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: E,
        slotNum: N + 1,
    ...
    const ne = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ae = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = P.map((b) => {
      ...
      const j = !!L, oe = ((us = b.system) == null ? void 0 : us.equipped) !== void 0 && ((ds = b.system) == null ? void 0 : ds.equipped) !== null ? !!b.system.equipped : j, se = (b == null ? void 0 : b.system) ?? {}, We = typeof se.range == "string" ? (se.range || "").trim() : "", be = se.type ?? "", Ie = (ne[be] ?? be) || "—", Fe = se.size ?? "", Je = (ae[Fe] ?? Fe) || "", Ye = [Ie, Je].filter(Boolean).join(", ") || Ie || "—", Ee = be === "projectile" || Fe === "thrown", Pe = se.quantity, bt = Pe != null ? String(Pe).trim() : "1", et = String(E.bonus ?? "").trim(), vt = String(se.bonus ?? "").trim(), Us = et || vt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const ie = (((Nt = this.actor.items) == null ? void 0 : Nt.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = ie.map((b) => {
      var E, j;
      const N = (b == null ? void 0 : b.system) ?? {}, L = ((E = b.system) == null ? void 0 : E.equipped) !== void 0 && ((j = b.system) == null ? void 0 : j.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    const le = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((b) => b.type === "Targy");
    e.itemsTable = le.map((b) => {
      const N = (b == null ? void 0 : b.system) ?? {}, L = (N.description ?? "").trim(), E = L ? L.length > 60 ? L.slice(0, 57) + "…" : L : "—", j = N.quantity != null ? String(N.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const de = (((Ze = this.actor.items) == null ? void 0 : Ze.contents) ?? []).filter((b) => b.type === "Egyeb");
    ...
    const xe = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), me = xe.map((b) => ({ id: b.id, name: b.name, img: b.img })), Re = "— Nincs Mikro-Chip —", X = ["slot1", "slot2", "slot3"], ye = (b) => {
      var L, E, j;
      const N = [];
      return b !== 1 && N.push((((L = B.slot1) == null ? void 0 : L.itemId) ?? "").trim()), b !== 2 && N.push((((E = B.slot2) == null ? void 0 : E.itemId) ?? "").trim()), b !== 3 && N.push((((j = B.slot3) == null ? void 0 : j.itemId) ?? "").trim()), N.filter(Boolean);
    };
    e.microchipItemsSlot1 = me.filter((b) => !ye(1).includes(b.id)), e.microchipItemsSlot2 = me.filter((b) => !ye(2).includes(b.id)), e.microchipItemsSlot3 = me.filter((b) => !ye(3).includes(b.id)), e.microchipSlots = X.map((b) => {
      const N = B[b] ?? {}, L = (N.itemId ?? "").trim(), E = xe.find((j) => j.id === L);
      return {
        slotKey: b,
        itemId: L,
      ...
      const N = `slot${b}`, L = B[N] ?? {}, E = (L.itemId ?? "").trim(), j = me.find((oe) => oe.id === E);
      e[`microchip${b}ItemId`] = E, e[`microchip${b}DisplayName`] = (j == null ? void 0 : j.name) || L.name || Re, e[`microchip${b}Img`] = (j == null ? void 0 : j.img) || "";
    }), e.microchipsTable = xe.map((b) => {
      var Fe, Je, Ye, Ee;
      const N = b.id;
      let L = null;
      for (const Pe of X)
        if ((((Fe = B[Pe]) == null ? void 0 : Fe.itemId) ?? "").trim() === N) {
          L = Pe;
          break;
        }
      const E = !!L, j = ((Je = b == null ? void 0 : b.system) == null ? void 0 : Je.abilityType) ?? "", oe = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", se = j === "active", We = Number((Ye = b == null ? void 0 : b.system) == null ? void 0 : Ye.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, be = (((Ee = b == null ? void 0 : b.system) == null ? void 0 : Ee.description) ?? "").trim(), Ie = be ? be.length > 60 ? be.slice(0, 57) + "…" : be : "—";
      return {
        itemId: N,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const Xe = this.actor.system.abilities ?? {}, It = (((es = this.actor.items) == null ? void 0 : es.contents) ?? []).map((b) => {
      ...
      const N = Xe[b] ?? {}, L = (N.itemId ?? "").trim(), E = L ? Le.get(L) : null, j = (E == null ? void 0 : E.description) ?? "", oe = (E == null ? void 0 : E.kp) ?? 0;
      return {
        itemId: L,
    ...
    const St = ((ts = e.system) == null ? void 0 : ts.resources) ?? {}, Qe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], je = (is = (ss = e.system) == null ? void 0 : ss.combat) == null ? void 0 : is.initiativeResult, ke = typeof je == "number" ? je : -1, Tt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
    ...
    let at = 0;
    if (typeof ke == "number" && ke >= 0 && Ae.length > 0) {
      const b = Ae[0], N = Ae[Ae.length - 1];
      let L = null;
      ke <= b.max ? L = b : ke >= N.min ? L = N : L = Ae.find((E) => ke >= E.min && ke <= E.max), L && (at = L.kp);
    }
    e.kpDots = Qe.map((b, N) => {
      const L = N + 1, E = !!Number(St[b]), j = L <= at;
      return { index: L, used: E, usable: j };
    });
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-bv_x7sH1.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-bv_x7sH1.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-bv_x7sH1.mjs");
      g(this.actor, c, a);
      ...
      if (!h) return;
      const v = ((C = (D = this.actor.items).get) == null ? void 0 : C.call(D, h)) ?? ((q = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : q.call(_, (A) => A.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (o.checked) {
        ...
        let q = I.find((A) => {
          var H;
          return !((H = g[A]) != null && H.itemId);
        });
        const M = new Set(I);
        if (!q) {
          const A = v.find((H) => !M.has(H));
          if (!A) return;
          q = A, I.push(A);
        }
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            ...
            if (_.length > 0) {
              const M = {
                "system.weapons.slotOrder": C.filter((A) => !_.includes(A)).join(",")
              };
              for (const A of _)
                M[`system.weapons.${A}.itemId`] = "", M[`system.weapons.${A}.name`] = "", M[`system.weapons.${A}.damage`] = "", M[`system.weapons.${A}.bonus`] = "";
              await g.update(M);
            }
          }
          return;
...
const pe = class pe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var st, it, nt, St, Qe, je, ke, Tt, Ke, ze, At, Ae, Ue, Dt, _t, at, Ot, rt, ot, ct, lt, ut, dt, mt, pt, ft, He, yt, gt, Be;
    ...
    e.weaponsTable = o.map((w) => {
      ...
      let R = null, U = {};
      for (const Ze of v)
        if ((((ht = f[Ze]) == null ? void 0 : ht.itemId) ?? "").trim() === x) {
          R = Ze, U = f[Ze] ?? {};
          break;
        }
      const ge = !!R, ee = (w == null ? void 0 : w.system) ?? {}, Se = typeof ee.range == "string" ? (ee.range || "").trim() : "", we = ee.type ?? "", he = (T[we] ?? we) || "—", Ne = ee.size ?? "", Ge = (D[Ne] ?? Ne) || "", Ve = [he, Ge].filter(Boolean).join(", ") || he || "—", Ct = we === "projectile" || Ne === "thrown", qt = ee.quantity != null ? String(ee.quantity).trim() : "1", Lt = String(ee.bonus ?? U.bonus ?? "").trim() || "0", Nt = (ee.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    const _ = ((Dt = (Ue = t == null ? void 0 : t.system) == null ? void 0 : Ue.gear) == null ? void 0 : Dt.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], M = d.filter((w) => w.type === "MikroChip");
    e.microchipsTable = M.map((w) => {
      var we, he, Ne, Ge;
      const x = w.id;
      let R = null;
      for (const Ve of q)
        if ((((we = _[Ve]) == null ? void 0 : we.itemId) ?? "").trim() === x) {
          R = Ve;
          break;
        }
      const U = ((he = w == null ? void 0 : w.system) == null ? void 0 : he.abilityType) ?? "", ge = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", ee = (((Ne = w == null ? void 0 : w.system) == null ? void 0 : Ne.description) ?? "").trim(), Se = ee ? ee.length > 60 ? ee.slice(0, 57) + "…" : ee : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (w == null ? void 0 : w.name) ?? "—",
        ...
        typeLabel: ge,
        description: Se,
        kp: Number((Ge = w == null ? void 0 : w.system) == null ? void 0 : Ge.replaceCost) >= 0 ? Number(w.system.replaceCost) : 0,
        isActive: U === "active",
        slotKey: R ?? "",
        equipped: !!R
      };
    });
    const A = d.filter((w) => w.type === "Targy");
    e.itemsTable = A.map((w) => {
    ...
    const B = (((_t = e.weaponsTable) == null ? void 0 : _t.length) ?? 0) > 0 || (((at = e.armorTable) == null ? void 0 : at.length) ?? 0) > 0 || (((Ot = e.microchipsTable) == null ? void 0 : Ot.length) ?? 0) > 0 || (((rt = e.itemsTable) == null ? void 0 : rt.length) ?? 0) > 0 || (((ot = e.egyebList) == null ? void 0 : ot.length) ?? 0) > 0;
    e.showEquipmentDropZone = !B;
    const V = ((ct = t == null ? void 0 : t.system) == null ? void 0 : ct.abilities) ?? {}, W = d.filter((w) => w.type === "Kepesseg" || w.type === "ability").map((w) => {
      var x, R, U;
      return {
        id: w.id,
        name: w.name,
    ...
    }), ce = new Map(W.map((w) => [w.id, w])), Z = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    e.abilityPassiveList = P(k("passive")), e.abilityActiveList = P(k("active"));
    const G = t == null ? void 0 : t.id, Y = !!((ut = (lt = game.combat) == null ? void 0 : lt.combatants) != null && ut.some(
      (w) => {
        var x;
    ...
    e.showHarcSection = Y;
    const te = ((dt = e.system) == null ? void 0 : dt.resources) ?? {}, ne = (pt = (mt = e.system) == null ? void 0 : mt.combat) == null ? void 0 : pt.initiativeResult, ae = typeof ne == "number" ? ne : -1, ie = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], le = (He = (ft = e.system) == null ? void 0 : ft.combat) == null ? void 0 : He.initiativeRanges, de = Array.isArray(le) ? le.map((w) => ({ min: Number(w.min) ?? 0, max: Number(w.max) ?? 0, kp: Math.min(10, Math.max(0, Number(w.kp) ?? 0)) })) : [], me = (de.length > 0 ? de : ie).slice().sort((w, x) => w.min - x.min), Re = 3;
    let X = de.length > 0 ? de : [];
    X.length < Re && (X = [...X, ...Array(Re - X.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = X.map((w, x) => ({
      ...w,
      isFirst: x === 0,
      isLast: x === X.length - 1
    }));
    let ye = 0;
    if (typeof ae == "number" && ae >= 0 && me.length > 0) {
      const w = me[0], x = me[me.length - 1];
      let R = null;
      ae <= w.max ? R = w : ae >= x.min ? R = x : R = me.find((U) => ae >= U.min && ae <= U.max), R && (ye = R.kp);
    }
    const re = me.length > 0 ? me[me.length - 1] : null, Xe = Math.min(10, re ? re.kp : 6), Le = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, Xe)).map((w, x) => {
      const R = x + 1, U = !!Number(te[w]), ge = R <= ye;
      return { index: R, used: U, usable: ge };
    }), Me = Math.ceil(Le.length / 2);
    return e.kpDotsRow1 = Le.slice(0, Me), e.kpDotsRow2 = Le.slice(Me), e.canEditInitiative = !!((yt = game.user) != null && yt.isGM), e.showInitiativeResult = typeof ne == "number", e.initiativeResult = e.showInitiativeResult ? ne : "", e.speedUnitForSelect = ((Be = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : Be.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var d, f, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-bv_x7sH1.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-bv_x7sH1.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-bv_x7sH1.mjs");
      a(this.actor, o, c);
  ...
  async _onDropItem(s, e) {
    var f, y, r, i, o, c, a, g, h, v, I, T, D, C, _, q, M;
    if (!this.actor) return (f = super._onDropItem) == null ? void 0 : f.call(this, s, e);
    const n = ((A) => {
      var B;
      if (!A) return null;
      const H = A.uuid ?? A.documentUuid ?? ((B = A.data) == null ? void 0 : B.uuid) ?? (typeof A == "string" ? A : null);
      if (H) return H;
      if (typeof A == "object") {
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      ...
      if (((c = p.parent) == null ? void 0 : c.id) !== l.id) {
        ...
        A = ((a = (await l.createEmbeddedDocuments("Item", [ce]))[0]) == null ? void 0 : a.id) ?? A;
      }
      const H = (((g = p.system) == null ? void 0 : g.kind) ?? "passive").toString(), B = ((h = l.system) == null ? void 0 : h.abilities) ?? {}, V = H === "active" ? "active" : "passive", W = Array.isArray((v = B[V]) == null ? void 0 : v.items) ? B[V].items.slice() : Array.isArray(B[V]) ? B[V].slice() : [];
      W.includes(A) || W.push(A), await l.update({ [`system.abilities.${V}.items`]: W }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (p.type === "Fegyver" && d) {
      const A = ((D = l.system) == null ? void 0 : D.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (A.slotOrder ?? "").trim(), V = B ? B.split(/\s*,\s*/).filter((Z) => H.includes(Z)) : [];
      let W = H.find((Z) => {
        var k;
        return !(((k = A[Z]) == null ? void 0 : k.itemId) ?? "").trim();
      });
      W || (W = H.find((Z) => !V.includes(Z)) ?? "slot1");
      const ce = V.includes(W) ? V : [...V, W].filter((Z) => H.includes(Z));
      await l.update({
        "system.weapons.slotOrder": ce.join(","),
        [`system.weapons.${W}.itemId`]: d,
        [`system.weapons.${W}.name`]: p.name ?? "",
        [`system.weapons.${W}.damage`]: ((C = p.system) == null ? void 0 : C.damage) ?? "",
        [`system.weapons.${W}.bonus`]: ((_ = p.system) == null ? void 0 : _.bonus) ?? ""
      });
    }
    if (p.type === "MikroChip" && d) {
      const A = ((M = (q = l.system) == null ? void 0 : q.gear) == null ? void 0 : M.microchips) ?? {}, B = ["slot1", "slot2", "slot3"].find((V) => {
        var W;
        return !(((W = A[V]) == null ? void 0 : W.itemId) ?? "").trim();
      });
      B && await l.update({
        [`system.gear.microchips.${B}.itemId`]: d,
        [`system.gear.microchips.${B}.name`]: p.name ?? ""
      });
    }
    typeof this.render == "function" && this.render(!0);
  }
...
Q(pe, "PARTS", foundry.utils.mergeObject(
  K(pe, pe, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(pe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var v, I, T, D, C, _, q, M, A, H, B, V, W, ce, Z;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((v = e.system) == null ? void 0 : v.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0), e.sizeForSelect = (((T = (I = e.system) == null ? void 0 : I.identity) == null ? void 0 : T.size) ?? "").trim() || "Közepes";
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, p = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, l = "— Nincs fegyver —", m = (((D = this.actor.items) == null ? void 0 : D.contents) ?? []).filter((k) => k.type === "Fegyver");
    e.weaponsTable = m.map((k) => {
      const P = (k == null ? void 0 : k.system) ?? {}, G = P.type ?? "", Y = (n[G] ?? G) || "—", te = P.size ?? "", ne = (p[te] ?? te) || "", ae = [Y, ne].filter(Boolean).join(", ") || Y || "—", ie = G === "projectile" || te === "thrown", le = P.quantity != null ? String(P.quantity).trim() : "1", de = (typeof P.range == "string" ? (P.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: this.actor.id,
    ...
    const u = (((C = this.actor.items) == null ? void 0 : C.contents) ?? []).filter((k) => k.type === "Pancel");
    e.armorTable = u.map((k) => {
      var Y;
      const P = (k == null ? void 0 : k.system) ?? {}, G = !!((Y = k.system) != null && Y.equipped);
      return {
        itemId: k.id,
        actorId: this.actor.id,
    ...
    const d = (((_ = this.actor.items) == null ? void 0 : _.contents) ?? []).filter((k) => k.type === "MikroChip");
    e.microchipsTable = d.map((k) => {
      var ie, le, de;
      const P = ((ie = k == null ? void 0 : k.system) == null ? void 0 : ie.abilityType) ?? "", G = P === "active" ? "Aktív" : P === "passive" ? "Passzív" : P || "—", Y = P === "active", te = Number((le = k == null ? void 0 : k.system) == null ? void 0 : le.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0, ne = (((de = k == null ? void 0 : k.system) == null ? void 0 : de.description) ?? "").trim(), ae = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const f = (((q = this.actor.items) == null ? void 0 : q.contents) ?? []).filter((k) => k.type === "Targy");
    e.itemsTable = f.map((k) => {
      const P = (k == null ? void 0 : k.system) ?? {}, G = (P.description ?? "").trim(), Y = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—", te = P.quantity != null ? String(P.quantity).trim() : "1";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const y = (((M = this.actor.items) == null ? void 0 : M.contents) ?? []).filter((k) => k.type === "Jarmuegyseg"), r = [];
    let i = 0;
    for (const k of y) {
      const P = (k == null ? void 0 : k.system) ?? {}, G = P.health ?? {}, Y = Number(P.level ?? 0) || 0, te = Number(G.max ?? 0) || 0, ne = Number(G.value ?? 0) || 0, ae = (P.hit ?? "").toString().trim(), ie = (P.speed ?? "").toString().trim().replace(",", "."), le = Number(ie);
      Number.isFinite(le) && (i += le);
      const de = P.abilities ?? {}, xe = Array.isArray(de.items) ? de.items : [], Re = (await Promise.all(
        xe.map(async (X) => {
          var ye;
          if (!X) return null;
          try {
            ...
            const re = (ye = game.items) == null ? void 0 : ye.get(X);
            if (re && (re.type === "Kepesseg" || re.type === "ability")) return re;
          }
          return null;
        })
      )).map((X, ye) => ({ doc: X, ref: xe[ye] })).filter((X) => !!X.doc && !!X.ref).map(({ doc: X, ref: ye }) => {
        var Le, Me;
    ...
    e.unitsTable = r;
    const o = (((H = (A = this.actor.system) == null ? void 0 : A.combat) == null ? void 0 : H.speed) ?? 0).toString().trim().replace(",", "."), c = Number(o), a = Number.isFinite(c) ? c : 0;
    e.unitSpeedSum = i, e.totalSpeed = a + i;
    const g = (((B = e.weaponsTable) == null ? void 0 : B.length) ?? 0) > 0 || (((V = e.armorTable) == null ? void 0 : V.length) ?? 0) > 0 || (((W = e.microchipsTable) == null ? void 0 : W.length) ?? 0) > 0 || (((ce = e.itemsTable) == null ? void 0 : ce.length) ?? 0) > 0;
    e.showEquipmentDropZone = !g;
    const h = (((Z = this.actor.items) == null ? void 0 : Z.contents) ?? []).filter((k) => k.type === "Egyeb");
    return e.egyebList = h.map((k) => {
...
Q(fe, "PARTS", foundry.utils.mergeObject(
  K(fe, fe, "PARTS") ?? {},
  {
...
Q(Te, "PARTS", foundry.utils.mergeObject(K(Te, Te, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Q(Te, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Te, Te, "DEFAULT_OPTIONS"), {
...
Q(De, "PARTS", foundry.utils.mergeObject(K(De, De, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), Q(De, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(De, De, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Fs = K(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !1 })
}));
let zt = De;
var As;
...
Q(_e, "PARTS", foundry.utils.mergeObject(K(_e, _e, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Q(_e, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(_e, _e, "DEFAULT_OPTIONS"), {
...
Q(Oe, "PARTS", foundry.utils.mergeObject(K(Oe, Oe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), Q(Oe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Oe, Oe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Es = K(Oe, Oe, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !0 })
}));
let Ht = Oe;
var Ps;
...
Q(Ce, "PARTS", foundry.utils.mergeObject(K(Ce, Ce, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), Q(Ce, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Ce, Ce, "DEFAULT_OPTIONS"), {
...
Q(qe, "PARTS", foundry.utils.mergeObject(K(qe, qe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Q(qe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(qe, qe, "DEFAULT_OPTIONS"), {
...
Q(ve, "PARTS", foundry.utils.mergeObject(K(ve, ve, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/jarmuegyseg-sheet.hbs" }
})), Q(ve, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const o = wt.getTotalSpeedRaw(i), c = (g = i.effects) == null ? void 0 : g.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (o <= 0 && !c) {
  ...
  const s = 500;
  Hooks.on("updateActor", (u, d, f, y) => {
    var T, D, C, _, q, M, A, H, B, V, W, ce, Z;
    ...
    if ((u.type === "Karakter" || u.type === "Npc") && ((T = d == null ? void 0 : d.system) != null && T.combat) && "initiativeResult" in d.system.combat) {
      const k = Number((C = (D = u.system) == null ? void 0 : D.combat) == null ? void 0 : C.initiativeResult), P = Number.isFinite(k) ? k : 0, G = game.combat;
      if (G) {
        const Y = ((_ = G.combatants) == null ? void 0 : _.contents) ?? Array.from(G.combatants ?? []);
        for (const te of Y)
          if (((q = te.actor) == null ? void 0 : q.id) === r || te.actorId === r) {
            G.updateEmbeddedDocuments("Combatant", [{ _id: te.id, initiative: P }]).catch(() => {
            });
            break;
          }
      }
    ...
    if (u.type === "Npc" && ((M = d == null ? void 0 : d.system) != null && M.identity) && "size" in d.system.identity) {
      const k = js((H = (A = u.system) == null ? void 0 : A.identity) == null ? void 0 : H.size);
      u.update({
        "prototypeToken.width": k,
        "prototypeToken.height": k
      }).catch((P) => console.warn("Vacuum of the Void | NPC token size update failed for", u.name, P));
    }
    ...
    for (const k of g) {
      ...
      const P = (ce = k.constructor) == null ? void 0 : ce.name;
      P !== "VoidKarakterSheet" && P !== "VoidJarmuSheet" || c.includes(k) || c.push(k);
    }
    if (o && c.some((k) => {
      const P = (k == null ? void 0 : k.form) ?? (k == null ? void 0 : k.element);
      return P && P.contains(i);
    })) return;
    const v = (Z = game.votv) == null ? void 0 : Z._lastKarakterSheetBlurSave, I = v && Date.now() - v.at < s ? v.appId : null;
    setTimeout(() => {
      for (const k of c)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, I, T, D, C, _, q, M, A, H, B, V, W, ce, Z, k, P, G, Y, te, ne;
    ...
    if (u || (u = ((M = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : M.flatMap((ie) => {
      var le;
      return ((le = ie.tokens) == null ? void 0 : le.contents) ?? [];
    }).map((ie) => ie.actor).find((ie) => ie && (ie.id === m || ie.id === l.actorId))) ?? null), !u) return;
    const d = l.itemId ? ((H = (A = u.items) == null ? void 0 : A.get) == null ? void 0 : H.call(A, l.itemId)) ?? ((W = (V = (B = u.items) == null ? void 0 : B.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (ae) => ae.id === l.itemId)) : null;
    let f = (l.damageFormula ?? "").trim();
    if (f || (f = (((ce = d == null ? void 0 : d.system) == null ? void 0 : ce.damage) ?? "").trim()), !f && l.slotKey && (f = (((((Z = u.system) == null ? void 0 : Z.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !f) {
      (Y = (k = ui.notifications) == null ? void 0 : k.warn) == null || Y.call(k, ((G = (P = game.i18n) == null ? void 0 : P.localize) == null ? void 0 : G.call(P, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const y = new Roll(f);
    await y.evaluate({ async: !0 });
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = l.targetName || "", o = l.hitLocationName || "", c = ((d == null ? void 0 : d.name) ?? (l.slotKey ? ((ne = (((te = u.system) == null ? void 0 : te.weapons) ?? {})[l.slotKey]) == null ? void 0 : ne.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-Dx-K1otV.mjs.map
