...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    a && r({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, l = ((y = o.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-CHlhmFJl.mjs");
      m(this.actor, c, l);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-CHlhmFJl.mjs");
      l(this.actor, c);
...
//# sourceMappingURL=vacuum-of-the-void-BdCVIIsv.mjs.map
