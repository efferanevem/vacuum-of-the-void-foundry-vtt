...
const { HTMLField: fs, NumberField: O, SchemaField: K, StringField: S, BooleanField: se, ArrayField: Ze } = foundry.data.fields;
...
const { NumberField: ft, SchemaField: ys } = foundry.data.fields;
class gs extends ns {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: bs, StringField: dt } = foundry.data.fields;
class ks extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new dt({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new dt({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new dt({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new dt({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: yt, StringField: Kt } = foundry.data.fields;
class vs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      cost: new yt({ required: !1, integer: !0, min: 0, initial: 1250 }),
      replaceCost: new yt({ required: !1, integer: !0, min: 0, initial: 3 }),
      quantity: new yt({ required: !1, integer: !0, min: 0, initial: 1 })
    };
  }
}
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ge, We, k, F, x, j, ae, X, Ae, he, Ie, be, Oe, qe, ot, ct, lt, ut, Ye, Ee, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et, Ft;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((k = (We = (Ge = this.actor.system) == null ? void 0 : Ge.resources) == null ? void 0 : We.stress) == null ? void 0 : k.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const D = ((F = d[y]) == null ? void 0 : F.value) ?? 0, _ = r[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((j = (x = this.actor.system) == null ? void 0 : x.combat) == null ? void 0 : j.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const a = (Number(((X = (ae = this.actor.system) == null ? void 0 : ae.combat) == null ? void 0 : X.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const p = ((Ae = e.system) == null ? void 0 : Ae.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (he = this.actor.system.gear) == null ? void 0 : he.microchips, E = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((Ie = E.slot1) == null ? void 0 : Ie.itemId) ?? "").trim(), H = (((be = E.slot2) == null ? void 0 : be.itemId) ?? "").trim(), B = (((Oe = E.slot3) == null ? void 0 : Oe.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, q = typeof D.sort == "number" ? D.sort : 0;
      return _ - q;
    }).map((y) => {
      var ke, Ne, Pe, Se, Te, Qe;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let q = 0, M = "", te = null;
      for (let Fe = 0; Fe < A.length; Fe++) {
        const Xe = A[Fe];
        if ((((ke = T[Xe]) == null ? void 0 : ke.itemId) ?? "") === y.id) {
          q = Fe + 1, M = ((Ne = T[Xe]) == null ? void 0 : Ne.bonus) ?? "", te = Xe;
          break;
        }
      }
      let V = null;
      _ && (N === y.id ? V = "slot1" : H === y.id ? V = "slot2" : B === y.id && (V = "slot3"));
      const Je = D && ((Pe = y.system) != null && Pe.damage) ? y.system.damage : "", oe = D && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Le = te ? Number((Te = T[te]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponSlots = J.map((y, D) => {
      const _ = T[y] ?? {}, q = (_.itemId ?? "").trim(), M = R.find((te) => te.id === q);
      return {
        slotKey: y,
        itemId: q,
        slotNum: D + 1,
    ...
    e.weaponsTable = ee.map((y) => {
      ...
      let _ = null, q = {};
      for (const pt of A)
        if (((($t = T[pt]) == null ? void 0 : $t.itemId) ?? "").trim() === D) {
          _ = pt, q = T[pt] ?? {};
          break;
        }
      const M = !!_, te = ((xt = y.system) == null ? void 0 : xt.equipped) !== void 0 && ((Rt = y.system) == null ? void 0 : Rt.equipped) !== null ? !!y.system.equipped : M, V = (y == null ? void 0 : y.system) ?? {}, Je = typeof V.range == "string" ? (V.range || "").trim() : "", oe = V.type ?? "", Le = (ve[oe] ?? oe) || "—", ke = V.size ?? "", Ne = (ne[ke] ?? ke) || "", Pe = [Le, Ne].filter(Boolean).join(", ") || Le || "—", Se = oe === "projectile" || ke === "thrown", Te = V.quantity, Qe = Te != null ? String(Te).trim() : "1", Fe = String(q.bonus ?? "").trim(), Xe = String(V.bonus ?? "").trim(), ls = Fe || Xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const $e = (((ct = this.actor.items) == null ? void 0 : ct.contents) ?? []).filter((y) => y.type === "Targy");
    ...
    const re = (((lt = this.actor.items) == null ? void 0 : lt.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const Z = (((ut = this.actor.items) == null ? void 0 : ut.contents) ?? []).filter((y) => y.type === "MikroChip"), ye = Z.map((y) => ({ id: y.id, name: y.name, img: y.img })), Ve = "— Nincs Mikro-Chip —", xe = ["slot1", "slot2", "slot3"], Re = (y) => {
      var _, q, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = ye.filter((y) => !Re(1).includes(y.id)), e.microchipItemsSlot2 = ye.filter((y) => !Re(2).includes(y.id)), e.microchipItemsSlot3 = ye.filter((y) => !Re(3).includes(y.id)), e.microchipSlots = xe.map((y) => {
      const D = E[y] ?? {}, _ = (D.itemId ?? "").trim(), q = Z.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || Ve,
        img: (q == null ? void 0 : q.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const D = `slot${y}`, _ = E[D] ?? {}, q = (_.itemId ?? "").trim(), M = ye.find((te) => te.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Ve, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = Z.map((y) => {
      var ke, Ne, Pe, Se;
      const D = y.id;
      let _ = null;
      for (const Te of xe)
        if ((((ke = E[Te]) == null ? void 0 : ke.itemId) ?? "").trim() === D) {
          _ = Te;
          break;
        }
      const q = !!_, M = ((Ne = y == null ? void 0 : y.system) == null ? void 0 : Ne.abilityType) ?? "", te = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", V = M === "active", Je = Number((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, oe = (((Se = y == null ? void 0 : y.system) == null ? void 0 : Se.description) ?? "").trim(), Le = oe ? oe.length > 60 ? oe.slice(0, 57) + "…" : oe : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const et = (((Ye = e.weaponsTable) == null ? void 0 : Ye.length) ?? 0) > 0 || (((Ee = e.armorTable) == null ? void 0 : Ee.length) ?? 0) > 0 || (((Dt = e.microchipsTable) == null ? void 0 : Dt.length) ?? 0) > 0 || (((_t = e.itemsTable) == null ? void 0 : _t.length) ?? 0) > 0;
    e.showEquipmentDropZone = !et;
    const Me = this.actor.system.abilities ?? {}, tt = (((Ct = this.actor.items) == null ? void 0 : Ct.contents) ?? []).map((y) => {
      var D, _, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), Ke = new Map(tt.map((y) => [y.id, y])), st = "— Nincs képesség —", je = (y) => {
      const D = Me[y] ?? {}, _ = (D.itemId ?? "").trim(), q = _ ? Ke.get(_) : null, M = (q == null ? void 0 : q.description) ?? "", te = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || st,
        img: (q == null ? void 0 : q.img) || "",
        description: M,
        kp: te
      };
    ...
    const it = ((Ot = e.system) == null ? void 0 : Ot.resources) ?? {}, nt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (Lt = (qt = e.system) == null ? void 0 : qt.combat) == null ? void 0 : Lt.initiativeResult, ge = typeof _e == "number" ? _e : -1, rt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ze = (Pt = (Nt = e.system) == null ? void 0 : Nt.combat) == null ? void 0 : Pt.initiativeRanges, Ce = Array.isArray(ze) ? ze.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : rt).slice().sort((y, D) => y.min - D.min);
    ...
    if (typeof ge == "number" && ge >= 0 && we.length > 0) {
      ...
      let _ = null;
      ge <= y.max ? _ = y : ge >= D.min ? _ = D : _ = we.find((q) => ge >= q.min && ge <= q.max), _ && (Be = _.kp);
    }
    e.kpDots = nt.map((y, D) => {
      const _ = D + 1, q = !!Number(it[y]), M = _ <= Be;
      return { index: _, used: q, usable: M };
    });
    const at = !!((Et = (At = game.combat) == null ? void 0 : At.combatants) != null && Et.some((y) => {
      var D;
      return ((D = y.actor) == null ? void 0 : D.type) === "Karakter";
    }));
    return e.showHarcSection = at, e.canEditInitiative = !!((Ft = game.user) != null && Ft.isGM), e.showInitiativeResult = typeof _e == "number", e.initiativeResult = e.showInitiativeResult ? _e : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-lZGtR0bh.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-lZGtR0bh.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-lZGtR0bh.mjs");
      p(this.actor, o, a);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: g, label: b } = gt(m), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: p, label: h } = gt(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var et, Me, tt, Ke, st, je, He, Ue, it, nt, _e, ge, rt, ze, Ce, mt, we, Be, at, Ge, We;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((et = this.actor) == null ? void 0 : et.system), e.showDeathSkull = !1, e.sizeForSelect = (((tt = (Me = e.system) == null ? void 0 : Me.identity) == null ? void 0 : tt.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((Ke = t == null ? void 0 : t.items) == null ? void 0 : Ke.contents) ?? [], d = ((st = t == null ? void 0 : t.system) == null ? void 0 : st.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const Ee of c)
        if ((((Ye = d[Ee]) == null ? void 0 : Ye.itemId) ?? "").trim() === F) {
          x = Ee, j = d[Ee] ?? {};
          break;
        }
      const ae = !!x, X = (k == null ? void 0 : k.system) ?? {}, Ae = typeof X.range == "string" ? (X.range || "").trim() : "", he = X.type ?? "", Ie = (a[he] ?? he) || "—", be = X.size ?? "", Oe = (p[be] ?? be) || "", qe = [Ie, Oe].filter(Boolean).join(", ") || Ie || "—", ot = he === "projectile" || be === "thrown", ct = X.quantity != null ? String(X.quantity).trim() : "1", lt = String(X.bonus ?? j.bonus ?? "").trim() || "0", ut = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: _s((F.level ?? "").toString().trim()),
        special: (F.special ?? F.other ?? "").toString().trim() || "—",
        equipped: x
      };
    });
    const v = ((He = (je = t == null ? void 0 : t.system) == null ? void 0 : je.gear) == null ? void 0 : He.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var he, Ie, be, Oe;
      const F = k.id;
      let x = null;
      for (const qe of I)
        if ((((he = v[qe]) == null ? void 0 : he.itemId) ?? "").trim() === F) {
          x = qe;
          break;
        }
      const j = ((Ie = k == null ? void 0 : k.system) == null ? void 0 : Ie.abilityType) ?? "", ae = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", X = (((be = k == null ? void 0 : k.system) == null ? void 0 : be.description) ?? "").trim(), Ae = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const A = (((Ue = e.weaponsTable) == null ? void 0 : Ue.length) ?? 0) > 0 || (((it = e.armorTable) == null ? void 0 : it.length) ?? 0) > 0 || (((nt = e.microchipsTable) == null ? void 0 : nt.length) ?? 0) > 0 || (((_e = e.itemsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((ge = e.egyebList) == null ? void 0 : ge.length) ?? 0) > 0;
    ...
    const G = t == null ? void 0 : t.id, ee = !!((Ce = (ze = game.combat) == null ? void 0 : ze.combatants) != null && Ce.some(
      (k) => {
        var F;
    ...
    const R = ((mt = e.system) == null ? void 0 : mt.resources) ?? {}, Y = (Be = (we = e.system) == null ? void 0 : we.combat) == null ? void 0 : Be.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ne = (Ge = (at = e.system) == null ? void 0 : at.combat) == null ? void 0 : Ge.initiativeRanges, fe = Array.isArray(ne) ? ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (fe.length > 0 ? fe : ve).slice().sort((k, F) => k.min - F.min), Z = fe.map((k) => k.min), ye = Z.length ? Math.min(...Z) : 0, Ve = Z.length ? Math.max(...Z) : 0;
    ...
    if (typeof J == "number" && J >= 0 && re.length > 0) {
      ...
      let x = null;
      J <= k.max ? x = k : J >= F.min ? x = F : x = re.find((j) => J >= j.min && J <= j.max), x && (xe = x.kp);
    }
    const Re = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"];
    return e.kpDots = Re.map((k, F) => {
      const x = F + 1, j = !!Number(R[k]), ae = x <= xe;
      return { index: x, used: j, usable: ae };
    }), e.canEditInitiative = !!((We = game.user) != null && We.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-lZGtR0bh.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-lZGtR0bh.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-lZGtR0bh.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: v } = gt(p), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if (l.type === "Npc" && ((C = f == null ? void 0 : f.system) != null && C.identity) && "size" in f.system.identity) {
      const R = as((N = (E = l.system) == null ? void 0 : E.identity) == null ? void 0 : N.size);
      l.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, L, P, A, C, E, N, H, B, U, G, ee, R, Y, J, ve, ne, fe, $e;
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? (($e = (((fe = f.system) == null ? void 0 : fe.weapons) ?? {})[r.slotKey]) == null ? void 0 : $e.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-DXxpWsi3.mjs.map
