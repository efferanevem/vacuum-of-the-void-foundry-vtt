...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const O = ((Me = d[g]) == null ? void 0 : Me.value) ?? 0, _ = n[g] ?? 0;
    ...
    const w = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = (w.slotOrder ?? "").trim(), q = D ? D.split(/\s*,\s*/).filter((g) => C.includes(g)) : [], T = (st = this.actor.system.gear) == null ? void 0 : st.microchips, I = T && typeof T == "object" && !Array.isArray(T) ? T : {}, E = (((it = I.slot1) == null ? void 0 : it.itemId) ?? "").trim(), A = (((rt = I.slot2) == null ? void 0 : rt.itemId) ?? "").trim(), H = (((nt = I.slot3) == null ? void 0 : nt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      ...
      for (let Ne = 0; Ne < q.length; Ne++) {
        ...
        if ((((pe = w[xe]) == null ? void 0 : pe.itemId) ?? "") === g.id) {
          L = Ne + 1, M = ((De = w[xe]) == null ? void 0 : De.bonus) ?? "", Q = xe;
          break;
        }
      }
      let Y = null;
    ...
    e.weaponsTable = z.map((g) => {
      ...
      const M = !!_, Q = ((ht = g.system) == null ? void 0 : ht.equipped) !== void 0 && ((bt = g.system) == null ? void 0 : bt.equipped) !== null ? !!g.system.equipped : M, Y = (g == null ? void 0 : g.system) ?? {}, Fe = typeof Y.range == "string" ? (Y.range || "").trim() : "", se = Y.type ?? "", Oe = (ue[se] ?? se) || "—", pe = Y.size ?? "", De = (ve[pe] ?? pe) || "", Ce = [Oe, De].filter(Boolean).join(", ") || Oe || "—", be = se === "projectile" || pe === "thrown", ke = Y.quantity, $e = ke != null ? String(ke).trim() : "1", Ne = String(L.bonus ?? "").trim(), xe = String(Y.bonus ?? "").trim(), jt = Ne || xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-YfbjQpgT.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((p = r.textContent) == null ? void 0 : p.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-YfbjQpgT.mjs");
      u(this.actor, c, o);
      ...
      if (!p) return;
      const b = ((D = (C = this.actor.items).get) == null ? void 0 : D.call(C, p)) ?? ((T = (q = this.actor.items.contents) == null ? void 0 : q.find) == null ? void 0 : T.call(q, (E) => E.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const b = o.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((q) => w.includes(q)) : [], D = C.find((q) => {
          var T;
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((D = o == null ? void 0 : o.system) == null ? void 0 : D.damage) ?? "",
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((D = o.system) == null ? void 0 : D.damage) ?? "",
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const D = a.filter((k) => k.type === "Targy");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-YfbjQpgT.mjs");
      u(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
      ...
      const o = ((D = this.actor.system) == null ? void 0 : D.abilities) ?? {}, p = (Array.isArray((q = o[r]) == null ? void 0 : q.items) ? o[r].items.slice() : []).filter((T) => T !== c);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const a = (((w = e.system) == null ? void 0 : w.weapons) ?? {})[s] ?? {}, d = ((C = e.system) == null ? void 0 : C.skills) ?? {}, n = ((D = e.items) == null ? void 0 : D.filter((T) => T.type === "Fegyver")) ?? [];
    let l = null;
  ...
  async _onDropItem(s, e) {
    var y, h, i, r, c, o, u, p, b, v, w, C, D, q, T;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, b, v, w, C, D, q, T, I, E, A, H, B, V, z, ee, fe, le, ue, ve, we, Ie, Se;
    ...
    if (!n) return;
    const l = n.actorId ?? ((D = d == null ? void 0 : d.speaker) == null ? void 0 : D.actor) ?? "";
    if (!l) return;
...
//# sourceMappingURL=vacuum-of-the-void-BE6ufd0d.mjs.map
