...
const { HTMLField: at, NumberField: I, SchemaField: D, StringField: y, BooleanField: M, ArrayField: ae } = foundry.data.fields;
...
const { NumberField: ce, StringField: Ke } = foundry.data.fields;
...
const { NumberField: mt, StringField: Me } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const b = this.element, g = this.form ?? this.element, k = d.scrollState, i = d.focus, r = typeof (k == null ? void 0 : k.formScrollTop) == "number" || typeof (k == null ? void 0 : k.windowScrollTop) == "number", o = () => {
      var m, f;
      if (this._applyScrollState(b, k), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const w = ((m = g.querySelector) == null ? void 0 : m.call(g, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (f = g.querySelector) == null ? void 0 : f.call(g, `[name="${CSS.escape(i.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var g, k, i, r, o, l, m, f, w;
    const e = s ?? this.form ?? this.element;
    let t = (g = e == null ? void 0 : e.querySelector) == null ? void 0 : g.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const a = ((i = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : i.resources) ?? {}, n = ((o = (r = a.hitLocations) == null ? void 0 : r.legs) == null ? void 0 : o.value) ?? 0, c = ((l = a.currentHealth) == null ? void 0 : l.legs) ?? 0, d = E._healthStatusFromRatio(c, n), p = Number(((w = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
    d === 0 ? b = 0 : d === 1 ? b = -6 : d === 2 ? b = -3 : b = p, t.textContent = String(b);
  }
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, a = ((p = (d = t.hitLocations) == null ? void 0 : d[e]) == null ? void 0 : p.value) ?? 0, n = ((b = t.currentHealth) == null ? void 0 : b[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const a = ((d = s == null ? void 0 : s.system) == null ? void 0 : d.resources) ?? {}, n = ((b = (p = a.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : b.value) ?? 0, c = ((g = a.currentHealth) == null ? void 0 : g[t]) ?? 0;
    return E._healthStatusFromRatio(c, n);
  }
  async _prepareContext(s) {
    var Ie, Se, qe, Te, De, Oe, _e, Le, Ae, Fe, Ne, Ee, $e, Ce, xe, je;
    ...
    for (const u of d) {
      const v = ((Te = n[u]) == null ? void 0 : Te.value) ?? 0, q = c[u] ?? 0;
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], f = (l.slotOrder ?? "").trim(), w = f ? f.split(/\s*,\s*/).filter((u) => m.includes(u)) : [], S = (_e = this.actor.system.gear) == null ? void 0 : _e.microchips, O = S && typeof S == "object" && !Array.isArray(S) ? S : {}, F = (((Le = O.slot1) == null ? void 0 : Le.itemId) ?? "").trim(), A = (((Ae = O.slot2) == null ? void 0 : Ae.itemId) ?? "").trim(), _ = (((Fe = O.slot3) == null ? void 0 : Fe.itemId) ?? "").trim(), C = this.actor.items.contents.filter((u) => u.type !== "Kepesseg" && u.type !== "ability").slice().sort((u, v) => {
      ...
      for (let Y = 0; Y < w.length; Y++) {
        ...
        if ((((Z = l[X]) == null ? void 0 : Z.itemId) ?? "") === u.id) {
          T = Y + 1, L = ((re = l[X]) == null ? void 0 : re.bonus) ?? "", x = X;
          break;
        }
      }
      let P = null;
      q && (F === u.id ? P = "slot1" : A === u.id ? P = "slot2" : _ === u.id && (P = "slot3"));
      const Q = v && ((ie = u.system) != null && ie.damage) ? u.system.damage : "", W = v && typeof ((V = u.system) == null ? void 0 : V.range) == "string" ? (u.system.range || "").trim() : "", G = x ? Number((ee = l[x]) == null ? void 0 : ee.bonus) || 0 : "";
      return {
        id: u.id,
        name: u.name,
        img: u.img,
    ...
    e.actionsTable = C;
    const j = (((Ne = this.actor.items) == null ? void 0 : Ne.contents) ?? []).filter((u) => u.type === "Fegyver"), R = j.map((u) => ({ id: u.id, name: u.name, img: u.img }));
    e.weaponItems = R;
    const fe = "— Nincs fegyver —", Je = w.filter((u) => {
      const q = ((l[u] ?? {}).itemId ?? "").trim();
      return q ? !!j.find((L) => L.id === q) : !1;
    });
    e.weaponSlots = Je.map((u, v) => {
      const q = l[u] ?? {}, T = (q.itemId ?? "").trim(), L = R.find((x) => x.id === T);
      return {
        slotKey: u,
        itemId: T,
        slotNum: v + 1,
        displayName: (L == null ? void 0 : L.name) || q.name || fe,
        img: (L == null ? void 0 : L.img) || "",
        bonus: Number(q.bonus) || 0,
        damage: q.damage ?? ""
      };
    });
    const Qe = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Xe = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = j.map((u) => {
      var Y, X, Pe;
      const v = u.id;
      let q = null, T = {};
      for (const oe of w)
        if ((((Y = l[oe]) == null ? void 0 : Y.itemId) ?? "").trim() === v) {
          q = oe, T = l[oe] ?? {};
          break;
        }
      const L = !!q, x = ((X = u.system) == null ? void 0 : X.equipped) !== void 0 && ((Pe = u.system) == null ? void 0 : Pe.equipped) !== null ? !!u.system.equipped : L, P = (u == null ? void 0 : u.system) ?? {}, Q = typeof P.range == "string" ? (P.range || "").trim() : "", W = P.type ?? "", G = (Qe[W] ?? W) || "—", Z = P.size ?? "", re = (Xe[Z] ?? Z) || "", ie = [G, re].filter(Boolean).join(", ") || G || "—", V = G === "Lövedékes", ee = P.quantity, te = ee != null ? String(ee).trim() : "1";
      return {
        slotKey: q ?? "",
        itemId: v,
        actorId: this.actor.id,
        name: (u == null ? void 0 : u.name) ?? fe,
    ...
    const Ze = (((Ee = this.actor.items) == null ? void 0 : Ee.contents) ?? []).filter((u) => u.type === "Pancél");
    e.armorTable = Ze.map((u) => {
      var T, L;
    ...
    }), e.generalItems = Array.isArray((Ce = ($e = this.actor.system) == null ? void 0 : $e.gear) == null ? void 0 : Ce.generalItems) ? this.actor.system.gear.generalItems : [];
    const ye = (((xe = this.actor.items) == null ? void 0 : xe.contents) ?? []).filter((u) => u.type === "microchip"), se = ye.map((u) => ({ id: u.id, name: u.name, img: u.img }));
    e.microchipsTable = ["1", "2", "3"].map((u) => {
      var Q, W;
      const v = `slot${u}`, q = O[v] ?? {}, T = (q.itemId ?? "").trim(), L = ye.find((G) => G.id === T), x = ((Q = L == null ? void 0 : L.system) == null ? void 0 : Q.abilityType) ?? "", P = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—";
      return {
        slotKey: v,
        itemId: T,
        name: (L == null ? void 0 : L.name) ?? q.name ?? ge,
        typeLabel: P,
        description: (((W = L == null ? void 0 : L.system) == null ? void 0 : W.description) ?? "").trim() || "—"
      };
    });
    const ge = "— Nincs Mikro-Chip —", ne = (u) => {
      const v = [];
      return u !== 1 && v.push(F), u !== 2 && v.push(A), u !== 3 && v.push(_), v;
    };
    e.microchipItemsSlot1 = se.filter((u) => !ne(1).includes(u.id)), e.microchipItemsSlot2 = se.filter((u) => !ne(2).includes(u.id)), e.microchipItemsSlot3 = se.filter((u) => !ne(3).includes(u.id)), ["1", "2", "3"].forEach((u) => {
      const v = `slot${u}`, q = O[v] ?? {}, T = (q.itemId ?? "").trim(), L = se.find((x) => x.id === T);
      e[`microchip${u}ItemId`] = T, e[`microchip${u}DisplayName`] = (L == null ? void 0 : L.name) || q.name || ge, e[`microchip${u}Img`] = (L == null ? void 0 : L.img) || "", e[`microchip${u}Active`] = q.active === !0;
    });
    const he = this.actor.system.abilities ?? {}, Ve = (((je = this.actor.items) == null ? void 0 : je.contents) ?? []).map((u) => {
      var v, q, T;
      return {
        id: u.id,
        name: u.name,
    ...
    }), we = new Map(Ve.map((u) => [u.id, u])), et = "— Nincs képesség —", be = (u) => {
      const v = he[u] ?? {}, q = (v.itemId ?? "").trim(), T = q ? we.get(q) : null, L = (T == null ? void 0 : T.description) ?? "", x = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: q,
        displayName: (T == null ? void 0 : T.name) || v.name || et,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Pt7s3D2F.mjs");
      l(this.actor, o);
      ...
      if (!o) {
        ...
        if (!w) return;
        o = (((((m = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : m.weapons) ?? {})[w] ?? {}).itemId ?? "").trim();
      }
    ...
    n && a({ currentTarget: n }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var f;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, l = ((f = r.textContent) == null ? void 0 : f.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-Pt7s3D2F.mjs");
      m(this.actor, o, l);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const w = l.system.weapons ?? {}, S = (w.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = S ? S.split(/\s*,\s*/).filter((_) => O.includes(_)) : [], A = F.find((_) => {
          var h;
          return (((h = w[_]) == null ? void 0 : h.itemId) ?? "").trim() === o;
        });
        if (A) {
      ...
      const m = this.actor.system.weapons ?? {}, f = (m.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = f ? f.split(/\s*,\s*/).filter((h) => w.includes(h)) : [], O = S.find((h) => {
        var C;
      ...
      if (!m) return;
      const f = (r.dataset.itemId ?? "").trim(), w = (r.dataset.itemName ?? ((h = r.textContent) == null ? void 0 : h.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (r.dataset.itemImg ?? "").trim(), O = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = w);
      ...
      if (!r || !o) return;
      const l = this.actor.system.abilities ?? {}, f = (Array.isArray((w = l[r]) == null ? void 0 : w.items) ? l[r].items.slice() : []).filter((S) => S !== o);
      ...
      const o = Array.isArray((m = (l = this.actor.system) == null ? void 0 : l.gear) == null ? void 0 : m.armor) ? [...this.actor.system.gear.armor] : [];
    ...
    const d = this, p = (i) => {
      ...
      const o = ((m = (l = r.system) == null ? void 0 : l.resources) == null ? void 0 : m.currentHealth) != null || ((w = (f = r.system) == null ? void 0 : f.resources) == null ? void 0 : w.hitLocations) != null;
    ...
    d._votvBlur = (i) => {
      ...
      const l = r.form;
      b(l) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: d.id, at: Date.now() }), p(l));
    ...
    if (e) {
      ...
      if (i) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          const f = l === "active" ? "active" : "passive", w = Array.isArray((d = m[f]) == null ? void 0 : d.items) ? m[f].items.slice() : Array.isArray(m[f]) ? m[f].slice() : [];
    ...
    if (e) {
      ...
      if (i) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (l) {
            const f = ((k = o.system) == null ? void 0 : k.weapons) ?? {}, w = (f.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = w ? w.split(/\s*,\s*/).filter((A) => S.includes(A)) : [], F = O.filter((A) => {
              var _;
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const n = this.actor.items.contents.slice().sort((k, i) => {
      ...
      return r - o;
    }).map((k) => k.id), c = n.indexOf(t), d = n.indexOf(e);
    if (c === -1 || d === -1) return;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", a = Number(((k = e.system) == null ? void 0 : k.kp) ?? 0) || 0, n = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", d = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", p = n ? `<p>${n}</p>` : "", b = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(s, e) {
    ...
    if (((d = a.parent) == null ? void 0 : d.id) !== this.actor.id) {
      const b = foundry.utils.mergeObject(a.toObject(), { type: "Kepesseg" });
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const c = this.actor.system.abilities ?? {}, d = Array.isArray((k = c[e]) == null ? void 0 : k.items) ? c[e].items.slice() : Array.isArray(c[e]) ? c[e].slice() : [];
  ...
  async _rollWeapon(s) {
    ...
    const d = c && c.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, g = (((w = c == null ? void 0 : c.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", k = Number(a[g] || 0) || 0, i = p + k, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, l = new Roll(o);
...
H(E, "PARTS", foundry.utils.mergeObject(K(E, E, "PARTS") ?? {}, {
  ...
  minWidth: 1e3,
  height: 800,
  form: foundry.utils.mergeObject(((He = K(E, E, "DEFAULT_OPTIONS")) == null ? void 0 : He.form) ?? {}, { submitOnChange: !1 }),
  window: foundry.utils.mergeObject(((Ue = K(E, E, "DEFAULT_OPTIONS")) == null ? void 0 : Ue.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((ze = (Be = K(E, E, "DEFAULT_OPTIONS")) == null ? void 0 : Be.window) == null ? void 0 : ze.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (n) => {
      var d, p, b;
      const c = ((d = n.target) == null ? void 0 : d.form) ?? ((b = (p = n.target) == null ? void 0 : p.closest) == null ? void 0 : b.call(p, "form"));
      a(c) && t(c);
...
H(U, "PARTS", foundry.utils.mergeObject(K(U, U, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ge = K(U, U, "DEFAULT_OPTIONS")) == null ? void 0 : Ge.form) ?? {}, { submitOnChange: !1 })
}));
let de = U;
var We;
...
H(B, "PARTS", foundry.utils.mergeObject(K(B, B, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((We = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : We.form) ?? {}, { submitOnChange: !0 })
}));
let me = B;
var Ye;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = lt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ut, CONFIG.Item.dataModels.microchip = dt, CONFIG.Item.dataModels.Kepesseg = Re, CONFIG.Item.dataModels.ability = Re, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  const N = 500;
  Hooks.on("updateActor", (c, d, p, b) => {
    var S, O, F, A, _;
    const g = c == null ? void 0 : c.id;
    if (!g) return;
    const k = document.activeElement, i = k && (k.tagName === "INPUT" && k.type !== "checkbox" && k.type !== "radio" || k.tagName === "TEXTAREA" || k.isContentEditable), r = [], o = (S = game.actors) == null ? void 0 : S.get(g);
    ...
    const f = (_ = game.votv) == null ? void 0 : _._lastKarakterSheetBlurSave, w = f && Date.now() - f.at < N ? f.appId : null;
    setTimeout(() => {
      for (const h of r)
...
//# sourceMappingURL=vacuum-of-the-void-Abd-m0c1.mjs.map
