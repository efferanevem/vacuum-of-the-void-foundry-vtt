...
const { HTMLField: Nt, NumberField: P, SchemaField: x, StringField: w, BooleanField: J, ArrayField: Ue } = foundry.data.fields;
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], L = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, _ = L && typeof L == "object" && !Array.isArray(L) ? L : {}, O = (((Ke = _.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = _.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), E = (((Te = _.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
      ...
      for (let Oe = 0; Oe < q.length; Oe++) {
        ...
        if ((((ce = b[Ee]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          C = Oe + 1, N = ((be = b[Ee]) == null ? void 0 : be.bonus) ?? "", Y = Ee;
          break;
        }
      }
      let W = null;
      T && (O === p.id ? W = "slot1" : S === p.id ? W = "slot2" : E === p.id && (W = "slot3"));
    ...
    e.weaponSlots = pe.map((p, D) => {
      const T = b[p] ?? {}, C = (T.itemId ?? "").trim(), N = ne.find((Y) => Y.id === C);
      return {
        slotKey: p,
        itemId: C,
        slotNum: D + 1,
    ...
    e.armorTable = Ne.map((p) => {
      var C, N;
      const D = (p == null ? void 0 : p.system) ?? {}, T = ((C = p.system) == null ? void 0 : C.equipped) !== void 0 && ((N = p.system) == null ? void 0 : N.equipped) !== null ? !!p.system.equipped : !1;
      return {
        itemId: p.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = $e.map((p) => {
      const D = (p == null ? void 0 : p.system) ?? {}, T = (D.description ?? "").trim(), C = T ? T.length > 60 ? T.slice(0, 57) + "…" : T : "—", N = D.quantity != null ? String(D.quantity).trim() : "1";
      return {
        itemId: p.id,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), fe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), De = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], Ie = (p) => {
      var T, C, N;
      const D = [];
      return p !== 1 && D.push((((T = _.slot1) == null ? void 0 : T.itemId) ?? "").trim()), p !== 2 && D.push((((C = _.slot2) == null ? void 0 : C.itemId) ?? "").trim()), p !== 3 && D.push((((N = _.slot3) == null ? void 0 : N.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((p) => !Ie(1).includes(p.id)), e.microchipItemsSlot2 = fe.filter((p) => !Ie(2).includes(p.id)), e.microchipItemsSlot3 = fe.filter((p) => !Ie(3).includes(p.id)), e.microchipSlots = _e.map((p) => {
      const D = _[p] ?? {}, T = (D.itemId ?? "").trim(), C = we.find((N) => N.id === T);
      return {
        slotKey: p,
        itemId: T,
      ...
      const D = `slot${p}`, T = _[D] ?? {}, C = (T.itemId ?? "").trim(), N = fe.find((Y) => Y.id === C);
      e[`microchip${p}ItemId`] = C, e[`microchip${p}DisplayName`] = (N == null ? void 0 : N.name) || T.name || De, e[`microchip${p}Img`] = (N == null ? void 0 : N.img) || "";
      ...
      const C = !!T, N = ((be = p == null ? void 0 : p.system) == null ? void 0 : be.abilityType) ?? "", Y = N === "active" ? "Aktív" : N === "passive" ? "Passzív" : N || "—", W = N === "active", Le = Number((ke = p == null ? void 0 : p.system) == null ? void 0 : ke.replaceCost) >= 0 ? Number(p.system.replaceCost) : 0, Z = (((de = p == null ? void 0 : p.system) == null ? void 0 : de.description) ?? "").trim(), he = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    }), A = new Map(k.map((p) => [p.id, p])), F = "— Nincs képesség —", K = (p) => {
      const D = Ce[p] ?? {}, T = (D.itemId ?? "").trim(), C = T ? A.get(T) : null, N = (C == null ? void 0 : C.description) ?? "", Y = (C == null ? void 0 : C.kp) ?? 0;
      return {
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || D.name || F,
        img: (C == null ? void 0 : C.img) || "",
        description: N,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-PUXbJLw8.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((y = r.textContent) == null ? void 0 : y.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-PUXbJLw8.mjs");
      l(this.actor, a, n);
      ...
      if (!y) return;
      const b = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, y)) ?? ((O = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : O.call(_, (E) => E.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((_) => I.includes(_)) : [], L = q.find((_) => {
          var O;
          return (((O = b[_]) == null ? void 0 : O.itemId) ?? "").trim() === a;
        });
        if (L) {
      ...
      const l = this.actor.system.weapons ?? {}, y = (l.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = y ? y.split(/\s*,\s*/).filter((O) => b.includes(O)) : [], I = v.find((O) => {
        var S;
        return (((S = l[O]) == null ? void 0 : S.itemId) ?? "").trim() === a;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let O = v.find((E) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.itemId`]: a,
          [`system.weapons.${O}.name`]: (n == null ? void 0 : n.name) ?? "",
          [`system.weapons.${O}.damage`]: ((L = n == null ? void 0 : n.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((_ = n == null ? void 0 : n.system) == null ? void 0 : _.bonus) ?? ""
      ...
      if (!l) return;
      const y = (r.dataset.itemId ?? "").trim(), b = (r.dataset.itemName ?? ((O = r.textContent) == null ? void 0 : O.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", v = (r.dataset.itemImg ?? "").trim(), I = a == null ? void 0 : a.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = b);
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          "system.weapons.slotOrder": v.join(","),
          [`system.weapons.${O}.itemId`]: a,
          [`system.weapons.${O}.name`]: n.name ?? "",
          [`system.weapons.${O}.damage`]: ((L = n.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((_ = n.system) == null ? void 0 : _.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (I) {
        const O = v.filter((S) => S !== I);
        await this.actor.update({
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, o = ((Fe = t == null ? void 0 : t.items) == null ? void 0 : Fe.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), f = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : c, r = c.filter((k) => !i.includes(k)), a = [...i, ...r], n = a.filter((k) => {
      var F;
      const A = (((F = d[k]) == null ? void 0 : F.itemId) ?? "").trim();
      return A && m.some((K) => K.id === A);
    });
    e.weaponSlots = n.map((k) => {
      const A = d[k] ?? {}, F = (A.itemId ?? "").trim(), K = f.find((le) => le.id === F);
      return {
        slotKey: k,
        itemId: F,
    ...
    e.armorTable = b.map((k) => {
      var K;
      const A = (k == null ? void 0 : k.system) ?? {}, F = ((K = k.system) == null ? void 0 : K.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    e.itemsTable = L.map((k) => {
      const A = (k == null ? void 0 : k.system) ?? {}, F = (A.description ?? "").trim(), K = F ? F.length > 60 ? F.slice(0, 57) + "…" : F : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const _ = o.filter((k) => k.type === "Egyeb");
    e.egyebList = _.map((k) => {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-PUXbJLw8.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
      ...
      const n = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, y = (Array.isArray((_ = n[r]) == null ? void 0 : _.items) ? n[r].items.slice() : []).filter((O) => O !== a);
  ...
  async _onDropItem(s, e) {
    var f, h, i, r, a, n, l, y, b, v, I, q, L, _, O;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, g, m, f) => {
    ...
    for (const S of l)
      ((q = S.document) == null ? void 0 : q.id) !== h || ((L = S.document) == null ? void 0 : L.documentName) !== "Actor" || ((_ = S.constructor) == null ? void 0 : _.name) !== "VoidKarakterSheet" || a.includes(S) || a.push(S);
    if (r && a.some((S) => {
      const E = (S == null ? void 0 : S.form) ?? (S == null ? void 0 : S.element);
      return E && E.contains(i);
    })) return;
    const b = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, v = b && Date.now() - b.at < j ? b.appId : null;
    setTimeout(() => {
      for (const S of a)
...
Hooks.on("preCreateToken", (j, s, e) => {
  var c, u;
  const t = (c = game.votv) == null ? void 0 : c._dragSourceActorId, o = t ?? j.actorId ?? null;
...
Hooks.on("renderTokenHUD", (j, s, e) => {
  var d;
  const t = j == null ? void 0 : j.object, o = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (j, s, e) => {
  var u, g;
  const t = ((u = j.flags) == null ? void 0 : u["vacuum-of-the-void"]) ?? {}, o = t.resultType, d = t.critLabel;
  if (!o && !d) return;
...
//# sourceMappingURL=vacuum-of-the-void-Br10hV8z.mjs.map
