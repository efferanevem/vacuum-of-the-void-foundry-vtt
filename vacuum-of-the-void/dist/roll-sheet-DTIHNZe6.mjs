import { V as C, c as Y } from "./vacuum-of-the-void-CQC9iOTz.mjs";
    ...
    if (this._isWeaponAttack && ((F = (N = game.user) == null ? void 0 : N.targets) != null && F.size)) {
      ...
      if (w) {
        ...
        if (w.type === "Karakter") {
          ...
          for (const q of L) {
            const R = String(((j = q.system) == null ? void 0 : j.protectionBonus) ?? "").trim().replace(",", "."), T = Number(R);
            Number.isFinite(T) && (V += T);
          }
        }
        const $ = z + W + H + V, O = (Number(b.total ?? 0) || 0) >= $, U = w.name ?? B.name ?? "Célpont";
        let I = null, D = null;
...
//# sourceMappingURL=roll-sheet-DTIHNZe6.mjs.map
