...
var U = (w, s, e) => ns(rs(w), e, s);
const { HTMLField: os, NumberField: O, SchemaField: K, StringField: S, BooleanField: ee, ArrayField: je } = foundry.data.fields;
...
function We(w) {
  ...
  d(w.terms, 1);
  const n = s.filter((u) => u === 6).length, l = s.filter((u) => u === 1).length, p = e.filter((u) => u === 6).length, m = t.filter((u) => u === 6).length, y = n + p, b = l + m;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const a = document.activeElement, f = n.contains(a), h = a && (a.tagName === "INPUT" && a.type !== "checkbox" && a.type !== "radio" || a.tagName === "TEXTAREA");
      f && h && (l.focus = {
        name: a.name || null,
        id: a.id || null,
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const n of s) {
      const l = String(((d = n.system) == null ? void 0 : d.speedPenalty) ?? "").trim().replace(",", "."), p = Number(l);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const n of s) {
      const l = String(((d = n.system) == null ? void 0 : d.protectionBonus) ?? "").trim().replace(",", "."), p = Number(l);
      Number.isFinite(p) && (e += p);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const r = ((i = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : i.resources) ?? {}, d = ((o = (c = r.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((a = r.currentHealth) == null ? void 0 : a.legs) ?? 0, l = W._healthStatusFromRatio(n, d), p = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!r) return;
    const p = Number(n == null ? void 0 : n.value) || 0, m = Number(l == null ? void 0 : l.value) || 0, y = Number(d == null ? void 0 : d.textContent) || 0;
    r.textContent = String(p + m + y);
  }
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, r = ((p = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : p.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const r = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (p = r.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : m.value) ?? 0, n = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    const p = (Number(n.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((g) => (Number(n[g]) || 0) === 0).length;
    ...
    const f = ((ct = e.system) == null ? void 0 : ct.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], D = (lt = this.actor.system.gear) == null ? void 0 : lt.microchips, E = D && typeof D == "object" && !Array.isArray(D) ? D : {}, N = (((ut = E.slot1) == null ? void 0 : ut.itemId) ?? "").trim(), j = (((dt = E.slot2) == null ? void 0 : dt.itemId) ?? "").trim(), G = (((mt = E.slot3) == null ? void 0 : mt.itemId) ?? "").trim(), B = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, _) => {
      const C = typeof g.sort == "number" ? g.sort : 0, L = typeof _.sort == "number" ? _.sort : 0;
      return C - L;
    }).map((g) => {
      var ge, Oe, qe, ve, we, Re;
      const _ = g.type === "Fegyver", C = g.type === "MikroChip";
      let L = 0, M = "", V = null;
      for (let Ee = 0; Ee < A.length; Ee++) {
        const Ke = A[Ee];
        if ((((ge = T[Ke]) == null ? void 0 : ge.itemId) ?? "") === g.id) {
          L = Ee + 1, M = ((Oe = T[Ke]) == null ? void 0 : Oe.bonus) ?? "", V = Ke;
          break;
        }
      }
      let Z = null;
      C && (N === g.id ? Z = "slot1" : j === g.id ? Z = "slot2" : G === g.id && (Z = "slot3"));
      const Me = _ && ((qe = g.system) != null && qe.damage) ? g.system.damage : "", ae = _ && typeof ((ve = g.system) == null ? void 0 : ve.range) == "string" ? (g.system.range || "").trim() : "", Ce = V ? Number((we = T[V]) == null ? void 0 : we.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.actionsTable = B;
    const X = (((pt = this.actor.items) == null ? void 0 : pt.contents) ?? []).filter((g) => g.type === "Fegyver"), F = X.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = F;
    const Y = "— Nincs fegyver —", te = A.filter((g) => {
      const C = ((T[g] ?? {}).itemId ?? "").trim();
      return C ? !!X.find((M) => M.id === C) : !1;
    });
    e.weaponSlots = te.map((g, _) => {
      const C = T[g] ?? {}, L = (C.itemId ?? "").trim(), M = F.find((V) => V.id === L);
      return {
        slotKey: g,
        itemId: L,
        slotNum: _ + 1,
    ...
    const pe = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, re = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = X.map((g) => {
      var qt, Lt, Nt;
      const _ = g.id;
      let C = null, L = {};
      for (const ze of A)
      ...
      const M = !!C, V = ((Lt = g.system) == null ? void 0 : Lt.equipped) !== void 0 && ((Nt = g.system) == null ? void 0 : Nt.equipped) !== null ? !!g.system.equipped : M, Z = (g == null ? void 0 : g.system) ?? {}, Me = typeof Z.range == "string" ? (Z.range || "").trim() : "", ae = Z.type ?? "", Ce = (pe[ae] ?? ae) || "—", ge = Z.size ?? "", Oe = (re[ge] ?? ge) || "", qe = [Ce, Oe].filter(Boolean).join(", ") || Ce || "—", ve = ae === "projectile" || ge === "thrown", we = Z.quantity, Re = we != null ? String(we).trim() : "1", Ee = String(L.bonus ?? "").trim(), Ke = String(Z.bonus ?? "").trim(), ss = Ee || Ke || "0";
      return {
        slotKey: C ?? "",
        itemId: _,
    ...
    const he = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const se = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((g) => g.type === "MikroChip"), ne = se.map((g) => ({ id: g.id, name: g.name, img: g.img })), Fe = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var C, L, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = ne.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = ne.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = ne.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      ...
      const _ = `slot${g}`, C = E[_] ?? {}, L = (C.itemId ?? "").trim(), M = ne.find((V) => V.id === L);
      ...
      let C = null;
      for (const we of k)
        if ((((ge = E[we]) == null ? void 0 : ge.itemId) ?? "").trim() === _) {
          C = we;
          break;
        }
      const L = !!C, M = ((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.abilityType) ?? "", V = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Z = M === "active", Me = Number((qe = g == null ? void 0 : g.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ae = (((ve = g == null ? void 0 : g.system) == null ? void 0 : ve.description) ?? "").trim(), Ce = ae ? ae.length > 60 ? ae.slice(0, 57) + "…" : ae : "—";
      return {
        itemId: _,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const z = this.actor.system.abilities ?? {}, De = (((It = this.actor.items) == null ? void 0 : It.contents) ?? []).map((g) => {
      var _, C, L;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Q = new Map(De.map((g) => [g.id, g])), $e = "— Nincs képesség —", fe = (g) => {
      const _ = z[g] ?? {}, C = (_.itemId ?? "").trim(), L = C ? Q.get(C) : null, M = (L == null ? void 0 : L.description) ?? "", V = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: C,
    ...
    e.abilityFajiSlot = fe("faji"), e.abilityHatterSlot = fe("hatter");
    const be = (g) => {
      const _ = z[g];
    ...
    e.abilityPassiveList = ye(be("passive")), e.abilityActiveList = ye(be("active"));
    const Le = ((St = e.system) == null ? void 0 : St.resources) ?? {}, Ne = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Pe = (Dt = (Tt = e.system) == null ? void 0 : Tt.combat) == null ? void 0 : Dt.initiativeResult, _e = typeof Pe == "number" ? Pe : -1;
    let ke = 0;
    _e >= 25 ? ke = 6 : _e >= 19 ? ke = 5 : _e >= 13 ? ke = 4 : _e >= 7 ? ke = 3 : _e >= 0 && (ke = 2), e.kpDots = Ne.map((g, _) => {
      const C = _ + 1, L = !!Number(Le[g]), M = C <= ke;
    ...
    return e.showHarcSection = Ue, e.canEditInitiative = !!((Ot = game.user) != null && Ot.isGM), e.showInitiativeResult = typeof Pe == "number", e.initiativeResult = e.showInitiativeResult ? Pe : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-B-x71ArL.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-B-x71ArL.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-B-x71ArL.mjs");
      f(this.actor, o, a);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((D) => v.includes(D)) : [], T = I.find((D) => {
        var E;
        return (((E = f[D]) == null ? void 0 : E.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (T) return;
        let D = I.find((N) => {
          var j;
          return !((j = f[N]) != null && j.itemId);
        });
        const E = new Set(I);
        if (!D) {
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = T ? T.split(/\s*,\s*/).filter((D) => q.includes(D)) : [], A = P.filter((D) => {
              var E;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((b = e.system) == null ? void 0 : b.kp) ?? 0) || 0, d = (((u = e.system) == null ? void 0 : u.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const l = n && n.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, m = ((I = n == null ? void 0 : n.system) == null ? void 0 : I.type) || "kinetic", y = (((T = n == null ? void 0 : n.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = y && r[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", u = Number(r[b] || 0) || 0, i = p + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
  ...
  async _rollWeaponDamage(s, e = "") {
    var p, m, y, b, u, i, c, o, a, f;
    const t = this.actor;
    if (!t) return;
    let r = ((m = (p = t.items).get) == null ? void 0 : m.call(p, s)) ?? ((b = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : b.call(y, (h) => h.id === s));
...
J(W, "PARTS", foundry.utils.mergeObject(
  ...
  U(W, W, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((xt = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : xt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Mt = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Mt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Kt = (Rt = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Rt.window) == null ? void 0 : Kt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const n = await super.render(s, e), l = this.element, p = this.form ?? this.element, m = d.scrollState, y = d.focus, b = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", u = () => {
      var i, c;
  ...
  async _prepareContext(s) {
    var B, X, F, Y, te, pe, re, Se, Te, he, se, ne, Fe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((B = this.actor) == null ? void 0 : B.system), e.showDeathSkull = !1, e.sizeForSelect = (((F = (X = e.system) == null ? void 0 : X.identity) == null ? void 0 : F.size) ?? "").trim() || "Közepes";
    const t = this.actor, r = ((Y = t == null ? void 0 : t.items) == null ? void 0 : Y.contents) ?? [], d = ((te = t == null ? void 0 : t.system) == null ? void 0 : te.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), p = l ? l.split(/\s*,\s*/).filter((k) => n.includes(k)) : [], m = r.filter((k) => k.type === "Fegyver"), y = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = p.length > 0 ? p : n, i = n.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var R;
      const x = (((R = d[k]) == null ? void 0 : R.itemId) ?? "").trim();
      return x && m.some((z) => z.id === x);
    });
    e.weaponSlots = o.map((k) => {
      const x = d[k] ?? {}, R = (x.itemId ?? "").trim(), z = y.find((De) => De.id === R);
      return {
        slotKey: k,
        itemId: R,
        displayName: (z == null ? void 0 : z.name) || x.name || b,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const De = !!R, Q = (k == null ? void 0 : k.system) ?? {}, $e = typeof Q.range == "string" ? (Q.range || "").trim() : "", fe = Q.type ?? "", be = (a[fe] ?? fe) || "—", ye = Q.size ?? "", Le = (f[ye] ?? ye) || "", Ne = [be, Le].filter(Boolean).join(", ") || be || "—", Pe = fe === "projectile" || ye === "thrown", _e = Q.quantity != null ? String(Q.quantity).trim() : "1", ke = String(Q.bonus ?? z.bonus ?? "").trim() || "0", Ue = (Q.damage ?? z.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      var z;
      const x = (k == null ? void 0 : k.system) ?? {}, R = ((z = k.system) == null ? void 0 : z.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    const v = ((re = (pe = t == null ? void 0 : t.system) == null ? void 0 : pe.gear) == null ? void 0 : re.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = r.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var fe, be, ye, Le;
      const x = k.id;
      let R = null;
      for (const Ne of I)
        if ((((fe = v[Ne]) == null ? void 0 : fe.itemId) ?? "").trim() === x) {
          R = Ne;
          break;
        }
      const z = ((be = k == null ? void 0 : k.system) == null ? void 0 : be.abilityType) ?? "", De = z === "active" ? "Aktív" : z === "passive" ? "Passzív" : z || "—", Q = (((ye = k == null ? void 0 : k.system) == null ? void 0 : ye.description) ?? "").trim(), $e = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.itemsTable = q.map((k) => {
      const x = (k == null ? void 0 : k.system) ?? {}, R = (x.description ?? "").trim(), z = R ? R.length > 60 ? R.slice(0, 57) + "…" : R : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.egyebList = P.map((k) => {
      const R = (((k == null ? void 0 : k.system) ?? {}).description ?? "").trim(), z = R ? R.length > 80 ? R.slice(0, 77) + "…" : R : "";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const A = (((Se = e.weaponsTable) == null ? void 0 : Se.length) ?? 0) > 0 || (((Te = e.armorTable) == null ? void 0 : Te.length) ?? 0) > 0 || (((he = e.microchipsTable) == null ? void 0 : he.length) ?? 0) > 0 || (((se = e.itemsTable) == null ? void 0 : se.length) ?? 0) > 0 || (((ne = e.egyebList) == null ? void 0 : ne.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const D = ((Fe = t == null ? void 0 : t.system) == null ? void 0 : Fe.abilities) ?? {}, E = r.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, R;
      return {
        id: k.id,
        name: k.name,
    ...
    return e.abilityPassiveList = H(G("passive")), e.abilityActiveList = H(G("active")), e;
  }
  _attachFrameListeners(s) {
    var m, y, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-B-x71ArL.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-B-x71ArL.mjs");
      a(this.actor, c, o);
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, f = (Array.isArray((P = o[i]) == null ? void 0 : P.items) ? o[i].items.slice() : []).filter((A) => A !== c);
    ...
    n._votvNpcBlur = (u) => {
      ...
      a && (o.contains(a) || n.id && ((f = a.closest) != null && f.call(a, `#${CSS.escape(n.id)}`))) || l(o);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const r = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, n = ((P = e.items) == null ? void 0 : P.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
    r.itemId && (l = n.find((E) => E.id === r.itemId) ?? null);
    const p = l && l.name || r.name || "Fegyver", m = Number(r.bonus || 0) || 0, y = ((A = l == null ? void 0 : l.system) == null ? void 0 : A.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(a);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const r = ((m = (p = t.items).get) == null ? void 0 : m.call(p, s)) ?? ((b = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : b.call(y, (h) => h.id === s));
    if (!r || r.type !== "Fegyver") return;
    let d = (((u = r.system) == null ? void 0 : u.damage) ?? "").trim();
    if (!d && e && (d = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (f = (c = ui.notifications) == null ? void 0 : c.warn) == null || f.call(c, ((a = (o = game.i18n) == null ? void 0 : o.localize) == null ? void 0 : a.call(o, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, a, f, h, v, I, T, q, P, A, D, E;
    if (!this.actor) return (y = super._onDropItem) == null ? void 0 : y.call(this, s, e);
    const r = ((N) => {
      var G;
      if (!N) return null;
      const j = N.uuid ?? N.documentUuid ?? ((G = N.data) == null ? void 0 : G.uuid) ?? (typeof N == "string" ? N : null);
      if (j) return j;
      if (typeof N == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((o = d.parent) == null ? void 0 : o.id) !== n.id) {
        ...
        N = ((a = (await n.createEmbeddedDocuments("Item", [X]))[0]) == null ? void 0 : a.id) ?? N;
      }
      const j = (((f = d.system) == null ? void 0 : f.kind) ?? "passive").toString(), G = ((h = n.system) == null ? void 0 : h.abilities) ?? {}, H = j === "active" ? "active" : "passive", B = Array.isArray((v = G[H]) == null ? void 0 : v.items) ? G[H].items.slice() : Array.isArray(G[H]) ? G[H].slice() : [];
      B.includes(N) || B.push(N), await n.update({ [`system.abilities.${H}.items`]: B }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && m) {
      const N = ((q = n.system) == null ? void 0 : q.weapons) ?? {}, j = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (N.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((F) => j.includes(F)) : [];
      let B = j.find((F) => {
        var Y;
        return !(((Y = N[F]) == null ? void 0 : Y.itemId) ?? "").trim();
      });
      B || (B = j.find((F) => !H.includes(F)) ?? "slot1");
      const X = H.includes(B) ? H : [...H, B].filter((F) => j.includes(F));
      await n.update({
        "system.weapons.slotOrder": X.join(","),
        [`system.weapons.${B}.itemId`]: m,
        [`system.weapons.${B}.name`]: d.name ?? "",
        [`system.weapons.${B}.damage`]: ((P = d.system) == null ? void 0 : P.damage) ?? "",
        [`system.weapons.${B}.bonus`]: ((A = d.system) == null ? void 0 : A.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const N = ((E = (D = n.system) == null ? void 0 : D.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
        return !(((B = N[H]) == null ? void 0 : B.itemId) ?? "").trim();
      });
      G && await n.update({
        [`system.gear.microchips.${G}.itemId`]: m,
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((u = e.system) == null ? void 0 : u.kind) ?? "passive", r = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, d = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${n}</p>
      ${l}
      ${p}
...
J(ie, "PARTS", foundry.utils.mergeObject(
  ...
  U(ie, ie, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((jt = U(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : jt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ht = U(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Ht.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((zt = (Ut = U(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Ut.window) == null ? void 0 : zt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const oe = class oe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const r = (n) => {
      ...
      var l, p, m;
      return n && (((p = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : p.call(l, n)) || e.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (n) => {
      var p, m, y;
      const l = ((p = n.target) == null ? void 0 : p.form) ?? ((y = (m = n.target) == null ? void 0 : m.closest) == null ? void 0 : y.call(m, "form"));
      d(l) && r(l);
...
J(oe, "PARTS", foundry.utils.mergeObject(U(oe, oe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), J(oe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(oe, oe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Bt = U(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Bt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = oe;
var Gt;
...
J(ce, "PARTS", foundry.utils.mergeObject(U(ce, ce, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), J(ce, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(ce, ce, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Gt = U(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Gt.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ce;
var Wt;
...
J(le, "PARTS", foundry.utils.mergeObject(U(le, le, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), J(le, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(le, le, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Wt = U(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Wt.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = le;
var Yt;
const ue = class ue extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (n) => {
      ...
      d(p) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(p), 300));
...
J(ue, "PARTS", foundry.utils.mergeObject(U(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Yt = U(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = ue;
var Jt;
...
J(de, "PARTS", foundry.utils.mergeObject(U(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Jt = U(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : Jt.form) ?? {}, { submitOnChange: !1 })
}));
let et = de;
var Qt;
...
J(me, "PARTS", foundry.utils.mergeObject(U(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Qt = U(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : Qt.form) ?? {}, { submitOnChange: !1 })
}));
let tt = me;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, p, m, y) => {
    var I, T, q, P, A, D, E, N, j, G, H, B, X;
    const b = l == null ? void 0 : l.id;
    if (!b) return;
    if (l.type === "Karakter" && ((I = p == null ? void 0 : p.system) != null && I.combat) && "initiativeResult" in p.system.combat) {
      const F = Number((q = (T = l.system) == null ? void 0 : T.combat) == null ? void 0 : q.initiativeResult), Y = Number.isFinite(F) ? F : 0, te = game.combat;
      if (te) {
        const pe = ((P = te.combatants) == null ? void 0 : P.contents) ?? Array.from(te.combatants ?? []);
        for (const re of pe)
          if (((A = re.actor) == null ? void 0 : A.id) === b || re.actorId === b) {
            te.updateEmbeddedDocuments("Combatant", [{ _id: re.id, initiative: Y }]).catch(() => {
            });
            break;
          }
      }
    }
    if (l.type === "Npc" && ((D = p == null ? void 0 : p.system) != null && D.identity) && "size" in p.system.identity) {
      const F = Vt((N = (E = l.system) == null ? void 0 : E.identity) == null ? void 0 : N.size);
      l.update({
        "prototypeToken.width": F,
        "prototypeToken.height": F
    ...
    for (const F of a)
      ((G = F.document) == null ? void 0 : G.id) !== b || ((H = F.document) == null ? void 0 : H.documentName) !== "Actor" || ((B = F.constructor) == null ? void 0 : B.name) !== "VoidKarakterSheet" || c.includes(F) || c.push(F);
    if (i && c.some((F) => {
      const Y = (F == null ? void 0 : F.form) ?? (F == null ? void 0 : F.element);
      return Y && Y.contains(u);
    })) return;
    const h = (X = game.votv) == null ? void 0 : X._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < w ? h.appId : null;
    setTimeout(() => {
      for (const F of c)
        !(F != null && F.rendered) || typeof F.render != "function" || F.id !== v && F.render(!0);
    }, 0);
    ...
    for (const [f, h] of Object.entries(u)) {
      ...
      !v || v !== l.id || (i[`system.weapons.${f}.name`] = l.name ?? "", i[`system.weapons.${f}.damage`] = ((o = l.system) == null ? void 0 : o.damage) ?? "", i[`system.weapons.${f}.bonus`] = ((a = l.system) == null ? void 0 : a.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, q, P, A, D, E, N, j, G, H, B, X, F, Y, te, pe, re, Se, Te;
    ...
    let p = ((P = game.actors) == null ? void 0 : P.get(n.actorId)) ?? ((A = game.actors) == null ? void 0 : A.get(l));
    if (p || (p = ((E = (D = game.scenes) == null ? void 0 : D.contents) == null ? void 0 : E.flatMap((se) => {
      var ne;
      return ((ne = se.tokens) == null ? void 0 : ne.contents) ?? [];
    }).map((se) => se.actor).find((se) => se && (se.id === l || se.id === n.actorId))) ?? null), !p) return;
    const m = n.itemId ? ((j = (N = p.items) == null ? void 0 : N.get) == null ? void 0 : j.call(N, n.itemId)) ?? ((B = (H = (G = p.items) == null ? void 0 : G.contents) == null ? void 0 : H.find) == null ? void 0 : B.call(H, (he) => he.id === n.itemId)) : null;
    let y = (n.damageFormula ?? "").trim();
    if (y || (y = (((X = m == null ? void 0 : m.system) == null ? void 0 : X.damage) ?? "").trim()), !y && n.slotKey && (y = (((((F = p.system) == null ? void 0 : F.weapons) ?? {})[n.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (re = (Y = ui.notifications) == null ? void 0 : Y.warn) == null || re.call(Y, ((pe = (te = game.i18n) == null ? void 0 : te.localize) == null ? void 0 : pe.call(te, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = n.targetName || "", c = n.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (n.slotKey ? ((Te = (((Se = p.system) == null ? void 0 : Se.weapons) ?? {})[n.slotKey]) == null ? void 0 : Te.name) ?? "" : "")) || "Fegyver";
    ...
    (e) => {
      ...
      const t = (m = (p = e.target) == null ? void 0 : p.closest) == null ? void 0 : m.call(p, "[data-document-id]"), r = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!r) return;
...
Hooks.on("preCreateToken", (w, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const y = Vt((m = (p = d.system) == null ? void 0 : p.identity) == null ? void 0 : m.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-DM89Rifa.mjs.map
