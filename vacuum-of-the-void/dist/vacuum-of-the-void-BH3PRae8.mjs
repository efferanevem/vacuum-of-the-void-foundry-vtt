...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-xlUyEKC0.mjs");
      n(this.actor, o);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-xlUyEKC0.mjs");
      l(this.actor, o, n);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-xlUyEKC0.mjs");
      l(this.actor, o, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), F = ((l = a.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", U = Array.isArray((p = F[H]) == null ? void 0 : p.items) ? F[H].items.slice() : Array.isArray(F[H]) ? F[H].slice() : [];
...
Hooks.on("renderChatMessageHTML", (E, s, e) => {
  var m, g, h, i;
  const t = ((m = E.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, c = t.resultType, d = t.critLabel, a = t.weaponAttack, u = t.weapon;
  if (!c && !d && !a) return;
  ...
  if (f) {
    ...
    if (a && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(u.actorId ?? ((i = E.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(u.itemId ?? ""), p.dataset.slotKey = String(u.slotKey ?? ""), p.dataset.targetName = String(u.targetName ?? ""), p.dataset.hitLocationName = String(u.hitLocationName ?? ""), p.dataset.messageId = String(E.id ?? ""), o.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-BH3PRae8.mjs.map
