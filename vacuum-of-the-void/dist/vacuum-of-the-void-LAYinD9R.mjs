...
var K = (A, i, e) => Tt(A, typeof i != "symbol" ? i + "" : i, e);
...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Ae, Ee, Pe, Ne, $e, xe, Me, je, Ke, Re, Ue, He, Be, Ge, ze, We, Ye, Qe;
    ...
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (b.slotOrder ?? "").trim(), C = O ? O.split(/\s*,\s*/).filter((l) => S.includes(l)) : [], F = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, D = F && typeof F == "object" && !Array.isArray(F) ? F : {}, v = (((Re = D.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), P = (((Ue = D.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = D.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((l) => l.type !== "Kepesseg" && l.type !== "ability").slice().sort((l, I) => {
      ...
      let R = null;
      k && (v === l.id ? R = "slot1" : P === l.id ? R = "slot2" : x === l.id && (R = "slot3"));
    ...
    e.weaponsTable = ue.map((l) => {
      ...
      const _ = !!k, j = ((re = l.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = l.system) == null ? void 0 : Je.equipped) !== null ? !!l.system.equipped : _, R = (l == null ? void 0 : l.system) ?? {}, ae = typeof R.range == "string" ? (R.range || "").trim() : "", Q = R.type ?? "", J = (ft[Q] ?? Q) || "—", X = R.size ?? "", ee = (yt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = R.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: k ?? "",
        itemId: I,
    ...
    e.microchipItemsSlot1 = oe.filter((l) => !me(1).includes(l.id)), e.microchipItemsSlot2 = oe.filter((l) => !me(2).includes(l.id)), e.microchipItemsSlot3 = oe.filter((l) => !me(3).includes(l.id)), e.microchipSlots = Oe.map((l) => {
      ...
      const T = !!k, _ = ((ee = l == null ? void 0 : l.system) == null ? void 0 : ee.abilityType) ?? "", j = _ === "active" ? "Aktív" : _ === "passive" ? "Passzív" : _ || "—", R = _ === "active", ae = Number((te = l == null ? void 0 : l.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(l.system.replaceCost) : 0, Q = (((Z = l == null ? void 0 : l.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-C9c3GPar.mjs");
      m(this.actor, c);
    ...
    s && r({ currentTarget: s }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const d = n.currentTarget, c = d.dataset.skill, m = ((g = d.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: p } = await import("./roll-sheet-C9c3GPar.mjs");
      p(this.actor, c, m);
...
K(N, "PARTS", foundry.utils.mergeObject(E(N, N, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
})), K(N, "DEFAULT_OPTIONS", foundry.utils.mergeObject(E(N, N, "DEFAULT_OPTIONS"), {
...
//# sourceMappingURL=vacuum-of-the-void-LAYinD9R.mjs.map
