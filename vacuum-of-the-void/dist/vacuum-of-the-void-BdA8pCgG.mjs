...
const { NumberField: fe, StringField: Je } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ae, Fe, Ce, Ne, Ee, Pe, $e, xe, je, Me, Ke, Re, Ue, He, Be, Ge, ze, We;
    ...
    for (const u of d) {
      const I = ((Ne = r[u]) == null ? void 0 : Ne.value) ?? 0, S = n[u] ?? 0;
    ...
    const h = this.actor.system.weapons ?? {}, k = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (h.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((u) => k.includes(u)) : [], L = (je = this.actor.system.gear) == null ? void 0 : je.microchips, D = L && typeof L == "object" && !Array.isArray(L) ? L : {}, w = (((Me = D.slot1) == null ? void 0 : Me.itemId) ?? "").trim(), C = (((Ke = D.slot2) == null ? void 0 : Ke.itemId) ?? "").trim(), x = (((Re = D.slot3) == null ? void 0 : Re.itemId) ?? "").trim(), lt = this.actor.items.contents.filter((u) => u.type !== "Kepesseg" && u.type !== "ability").slice().sort((u, I) => {
    ...
    e.actionsTable = lt;
    const ce = (((Ue = this.actor.items) == null ? void 0 : Ue.contents) ?? []).filter((u) => u.type === "Fegyver"), ke = ce.map((u) => ({ id: u.id, name: u.name, img: u.img }));
    e.weaponItems = ke;
    const Ie = "— Nincs fegyver —", ct = F.filter((u) => {
      const S = ((h[u] ?? {}).itemId ?? "").trim();
      return S ? !!ce.find((A) => A.id === S) : !1;
    });
    e.weaponSlots = ct.map((u, I) => {
      const S = h[u] ?? {}, q = (S.itemId ?? "").trim(), A = ke.find((j) => j.id === q);
      return {
        slotKey: u,
        itemId: q,
        slotNum: I + 1,
        displayName: (A == null ? void 0 : A.name) || S.name || Ie,
    ...
    e.weaponsTable = ce.map((u) => {
      ...
      const A = !!S, j = ((ie = u.system) == null ? void 0 : ie.equipped) !== void 0 && ((Ye = u.system) == null ? void 0 : Ye.equipped) !== null ? !!u.system.equipped : A, M = (u == null ? void 0 : u.system) ?? {}, re = typeof M.range == "string" ? (M.range || "").trim() : "", Y = M.type ?? "", J = (ut[Y] ?? Y) || "—", Q = M.size ?? "", V = (dt[Q] ?? Q) || "", ee = [J, V].filter(Boolean).join(", ") || J || "—", X = J === "Lövedékes", Z = M.quantity, ae = Z != null ? String(Z).trim() : "1";
      return {
        slotKey: S ?? "",
        itemId: I,
        actorId: this.actor.id,
        name: (u == null ? void 0 : u.name) ?? Ie,
    ...
    const mt = (((He = this.actor.items) == null ? void 0 : He.contents) ?? []).filter((u) => u.type === "Pancel");
    ...
    }), e.generalItems = Array.isArray((Ge = (Be = this.actor.system) == null ? void 0 : Be.gear) == null ? void 0 : Ge.generalItems) ? this.actor.system.gear.generalItems : [];
    const ue = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((u) => u.type === "MikroChip"), ne = ue.map((u) => ({ id: u.id, name: u.name, img: u.img })), Se = "— Nincs Mikro-Chip —", qe = ["slot1", "slot2", "slot3"], de = (u) => {
      var S, q, A;
      const I = [];
    ...
    e.microchipItemsSlot1 = ne.filter((u) => !de(1).includes(u.id)), e.microchipItemsSlot2 = ne.filter((u) => !de(2).includes(u.id)), e.microchipItemsSlot3 = ne.filter((u) => !de(3).includes(u.id)), e.microchipSlots = qe.map((u) => {
      const I = D[u] ?? {}, S = (I.itemId ?? "").trim(), q = ue.find((A) => A.id === S);
      return {
        slotKey: u,
        itemId: S,
        displayName: (q == null ? void 0 : q.name) || I.name || Se,
        img: (q == null ? void 0 : q.img) || "",
        active: I.active === !0
      };
    }), ["1", "2", "3"].forEach((u) => {
      const I = `slot${u}`, S = D[I] ?? {}, q = (S.itemId ?? "").trim(), A = ne.find((j) => j.id === q);
      e[`microchip${u}ItemId`] = q, e[`microchip${u}DisplayName`] = (A == null ? void 0 : A.name) || S.name || Se, e[`microchip${u}Img`] = (A == null ? void 0 : A.img) || "";
    ...
    const Te = this.actor.system.abilities ?? {}, pt = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).map((u) => {
      var I, S, q;
      return {
        id: u.id,
        name: u.name,
    ...
    }), Oe = new Map(pt.map((u) => [u.id, u])), ft = "— Nincs képesség —", De = (u) => {
      const I = Te[u] ?? {}, S = (I.itemId ?? "").trim(), q = S ? Oe.get(S) : null, A = (q == null ? void 0 : q.description) ?? "", j = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: S,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DUrAxDTX.mjs");
      a(this.actor, l);
    ...
    r && i({ currentTarget: r }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      o.preventDefault();
      const c = o.currentTarget, l = c.dataset.skill, a = ((f = c.textContent) == null ? void 0 : f.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-DUrAxDTX.mjs");
      m(this.actor, l, a);
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = It, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = qt, CONFIG.Item.dataModels.Pancel = Ot, CONFIG.Item.dataModels.MikroChip = Dt, CONFIG.Item.dataModels.Kepesseg = Xe, CONFIG.Item.dataModels.ability = Xe, CONFIG.Item.dataModels.Targy = Lt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-BdA8pCgG.mjs.map
