...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DvEXao7C.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DvEXao7C.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-DvEXao7C.mjs");
      h(this.actor, o, m);
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const c = ((ot = t == null ? void 0 : t.items) == null ? void 0 : ot.contents) ?? [], u = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (u.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], r = c.filter((S) => S.type === "Fegyver"), o = r.map((S) => ({ id: S.id, name: S.name, img: S.img })), m = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
      const P = (((x = u[S]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && r.some((G) => G.id === P);
    });
    e.weaponSlots = k.map((S) => {
      const P = u[S] ?? {}, x = (P.itemId ?? "").trim(), G = o.find((we) => we.id === x), ke = r.find((we) => we.id === x), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", De = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: S,
        itemId: x,
    ...
    const _ = c.filter((S) => S.type === "Pancel");
    ...
    const O = ((Ct = (Je = t == null ? void 0 : t.system) == null ? void 0 : Je.gear) == null ? void 0 : Ct.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], M = c.filter((S) => S.type === "MikroChip");
    ...
    const j = c.filter((S) => S.type === "Targy");
    ...
    const U = c.filter((S) => S.type === "Egyeb");
    e.egyebList = U.map((S) => {
    ...
    const J = ((ft = t == null ? void 0 : t.system) == null ? void 0 : ft.abilities) ?? {}, Y = c.filter((S) => S.type === "Kepesseg" || S.type === "ability").map((S) => {
      var P, x, G;
      return {
        id: S.id,
        name: S.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DvEXao7C.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DvEXao7C.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DvEXao7C.mjs");
      m(this.actor, r, o);
      ...
      var o, m, h, g;
      a.preventDefault();
      const i = (((m = (o = a.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : m.itemId) ?? ((g = (h = a.currentTarget) == null ? void 0 : h.getAttribute) == null ? void 0 : g.call(h, "data-item-id")) ?? "").trim();
      if (!i || !this.actor) return;
      const r = this.actor.items.get(i);
  ...
  async _onDropItem(s, e) {
    ...
    if (f.type === "Kepesseg" || f.type === "ability") {
      ...
      const Y = ((k = l.system) == null ? void 0 : k.abilities) ?? {}, Z = R === "active" ? "active" : "passive", X = Array.isArray((w = Y[Z]) == null ? void 0 : w.items) ? Y[Z].items.slice() : Array.isArray(Y[Z]) ? Y[Z].slice() : [];
      X.includes(J) || X.push(J), await l.update({ [`system.abilities.${Z}.items`]: X }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (f.type === "Fegyver" && c) {
      const R = ((O = l.system) == null ? void 0 : O.weapons) ?? {}, J = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Y = (R.slotOrder ?? "").trim(), Z = Y ? Y.split(/\s*,\s*/).filter((V) => J.includes(V)) : [];
      let X = J.find((V) => {
        var oe;
    ...
    if (f.type === "MikroChip" && c) {
      const R = ((U = (j = l.system) == null ? void 0 : j.gear) == null ? void 0 : U.microchips) ?? {}, Y = ["slot1", "slot2", "slot3"].find((Z) => {
        var X;
        return !(((X = R[Z]) == null ? void 0 : X.itemId) ?? "").trim();
      });
      Y && await l.update({
        [`system.gear.microchips.${Y}.itemId`]: c,
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      const u = this.actor.items.get(c);
      !u || u.type !== "MikroChip" && u.type !== "Egyeb" || await this._postItemToChat(c);
...
const it = class it extends xt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var O, C, M, j, U, R, J;
      const c = ((O = e.querySelector) == null ? void 0 : O.call(e, "form")) ?? e, u = (C = c.querySelector) == null ? void 0 : C.call(c, 'select[name="system.identity.assignment"]'), y = (M = c.querySelector) == null ? void 0 : M.call(c, 'select[name="system.identity.subAssignment"]'), a = (j = c.querySelector) == null ? void 0 : j.call(c, "input.bazis-threat-total"), i = (U = c.querySelector) == null ? void 0 : U.call(c, 'input[name="system.combat.threatBonus"]');
      if (!u || !a || !i) return;
      const r = u.value ?? "", o = (y == null ? void 0 : y.value) ?? "", m = t[r] ?? 0, h = n[o] ?? 0, g = (((J = (R = this.actor) == null ? void 0 : R.items) == null ? void 0 : J.contents) ?? []).filter((Y) => Y.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ds(this.actor), _ = m + h + k + w + T;
      a.value = _;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, l = n.combat ?? {}, p = f.assignment ?? "", d = f.subAssignment ?? "", c = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = c[p] ?? 0, i = u[d] ?? 0, r = e.sizeForSelect ?? "Kicsi", o = y[r] ?? 0, m = Number(l.threatBonus ?? 0) || 0, h = Ds(this.actor), g = a + i + o + m + h;
      e.system = foundry.utils.mergeObject(
        foundry.utils.duplicate(n),
        { combat: { ...l, threat: g, threatBonus: m } },
        { inplace: !1 }
      ), e.bazisThreatBase = a;
    }
    return e;
  ...
  _attachFrameListeners(s) {
    ...
    if (f && (f.addEventListener("dragover", (u) => {
      ...
      try {
        ...
        let m = null;
        try {
          m = TextEditor.getDragEventData(u);
        } catch {
        }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const c = l.itemId ? ((U = (j = d.items) == null ? void 0 : j.get) == null ? void 0 : U.call(j, l.itemId)) ?? ((Y = (J = (R = d.items) == null ? void 0 : R.contents) == null ? void 0 : J.find) == null ? void 0 : Y.call(J, (E) => E.id === l.itemId)) : null;
    let u = (l.damageFormula ?? "").trim();
    if (u || (u = (((Z = c == null ? void 0 : c.system) == null ? void 0 : Z.damage) ?? "").trim()), !u && l.slotKey && (u = (((((X = d.system) == null ? void 0 : X.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !u) {
...
Hooks.on("preCreateToken", (I, s, e) => {
  var l, p, d, c, u, y, a, i;
  const t = (l = game.votv) == null ? void 0 : l._dragSourceActorId, n = t ?? I.actorId ?? ((p = I._source) == null ? void 0 : p.actorId) ?? (s == null ? void 0 : s.actorId) ?? null;
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var y, a, i, r;
  const t = ((y = I.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, l = t.weaponAttack, p = t.weapon, d = t.vsDefense, c = t.vsDefenseInfo;
  if (!n && !f && !l && !d) return;
  ...
  if (u) {
    ...
    if (l && p && (p.actorId || (i = I.speaker) != null && i.actor)) {
...
//# sourceMappingURL=vacuum-of-the-void-BjVo_oKp.mjs.map
