...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const b of u) {
      const F = ((nt = p[b]) == null ? void 0 : nt.value) ?? 0, N = l[b] ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CzJRwu4J.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CzJRwu4J.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const a = i.currentTarget, o = a.dataset.skill, r = ((h = a.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: y } = await import("./roll-sheet-CzJRwu4J.mjs");
      y(this.actor, o, r);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const B = ((it = t == null ? void 0 : t.system) == null ? void 0 : it.abilities) ?? {}, G = m.filter((w) => w.type === "Kepesseg" || w.type === "ability").map((w) => {
      var P, x, H;
      return {
        id: w.id,
        name: w.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (c) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CzJRwu4J.mjs");
      o(this.actor, a);
      ...
      if (c.preventDefault(), c.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CzJRwu4J.mjs");
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CzJRwu4J.mjs");
      r(this.actor, a, o);
...
//# sourceMappingURL=vacuum-of-the-void-CgXVP9-o.mjs.map
