...
const { BooleanField: Di, StringField: zt } = foundry.data.fields;
class Oi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new zt({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new zt({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new zt({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new zt({ required: !1, blank: !0, initial: "" })
    };
  }
}
...
function Vt(I) {
  ...
  f(I.terms, 1);
  const u = s.filter((r) => r === 6).length, p = s.filter((r) => r === 1).length, d = e.filter((r) => r === 6).length, a = t.filter((r) => r === 6).length, o = u + d, y = p + a;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    return (i || r) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), d;
  }
  /**
  ...
  static getTotalSpeedRaw(s) {
    ...
    const d = Number(((m = (l = s.system) == null ? void 0 : l.combat) == null ? void 0 : m.speed) ?? 0) || 0, a = Number(((g = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : g.speedBonus) ?? 0) || 0;
    return d + a + (Number.isFinite(p) ? p : 0);
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((m = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : m.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, u = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = Q._healthStatusFromRatio(u, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let a;
    p === 0 ? a = 0 : p === 1 ? a = -6 : p === 2 ? a = -3 : a = d;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const d = Number(u == null ? void 0 : u.value) || 0, a = Number(p == null ? void 0 : p.value) || 0, o = Number(f == null ? void 0 : f.textContent) || 0;
    n.textContent = String(d + a + o);
  }
  _writeTotalSpeed(s = null) {
    ...
    const d = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, a = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, o = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((u = this.actor.system) == null ? void 0 : u.resources) ?? {}, n = ((d = (p = t.hitLocations) == null ? void 0 : p[e]) == null ? void 0 : d.value) ?? 0, f = ((a = t.currentHealth) == null ? void 0 : a[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((p = s == null ? void 0 : s.system) == null ? void 0 : p.resources) ?? {}, f = ((a = (d = n.hitLocations) == null ? void 0 : d[t]) == null ? void 0 : a.value) ?? 0, u = ((o = n.currentHealth) == null ? void 0 : o[t]) ?? 0;
    return Q._healthStatusFromRatio(u, f);
  }
  async _prepareContext(s) {
    var yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et, S, P, x, G, ke, ne, Le, Oe, we, ze, tt, st, Pt, $t, xt, Rt, Ot, dt, as, rs, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs, bs;
    ...
    const d = (Number(u.head) || 0) === 0, o = ["torso", "arms", "legs"].filter((b) => (Number(u[b]) || 0) === 0).length;
    e.showDeathSkull = d || o >= 2;
    ...
    y === 0 && (T = 0), (Oe = (Le = (ne = this.actor) == null ? void 0 : ne.statuses) == null ? void 0 : Le.has) != null && Oe.call(Le, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      ...
      { combat: { givenSpeed: 0, givenProtection: (ze = (we = e.system) == null ? void 0 : we.combat) == null ? void 0 : ze.givenProtection } },
      { inplace: !1 }
    ), T = 0), e.totalSpeed = T;
    ...
    e.weaponSlots = De.map((b, N) => {
      const L = _[b] ?? {}, A = (L.itemId ?? "").trim(), B = te.find((_e) => _e.id === A), ue = R.find((_e) => _e.id === A), re = (ue == null ? void 0 : ue.system) ?? {}, it = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
    ...
    e.armorTable = V.map((b) => {
      ...
      return {
        ...
        level: zi((N.level ?? "").toString().trim()),
    ...
    const ct = ((ds = e.system) == null ? void 0 : ds.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (ps = (ms = e.system) == null ? void 0 : ms.combat) == null ? void 0 : ps.initiativeResult, ie = typeof ye == "number" ? ye : -1, lt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Re = (ys = (fs = e.system) == null ? void 0 : fs.combat) == null ? void 0 : ys.initiativeRanges, qe = Array.isArray(Re) ? Re.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ve = (qe.length > 0 ? qe : lt).slice().sort((b, N) => b.min - N.min), Xe = qe.map((b) => b.min), Ft = Xe.length ? Math.min(...Xe) : 0, At = Xe.length ? Math.max(...Xe) : 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DZdha1Eo.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DZdha1Eo.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-DZdha1Eo.mjs");
      h(this.actor, l, m);
    ...
    const d = this, a = (i) => {
      ...
      var c, l, m;
      return i && (((l = (c = d.element) == null ? void 0 : c.contains) == null ? void 0 : l.call(c, i)) || d.id && ((m = i.closest) == null ? void 0 : m.call(i, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (i) => {
      var g;
      const c = i.target;
      ...
      h && (m.contains(h) || d.id && ((g = h.closest) != null && g.call(h, `#${CSS.escape(d.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: d.id, at: Date.now() }), a(m));
  ...
  async _onDropItem(s, e) {
    var t, n, f, u, p, d, a, o, y, r, i, c, l, m;
    if (e) {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((o = e.system) == null ? void 0 : o.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(s, e) {
    ...
    if (((p = n.parent) == null ? void 0 : p.id) !== this.actor.id) {
      ...
      f = ((d = (await this.actor.createEmbeddedDocuments("Item", [a]))[0]) == null ? void 0 : d.id) ?? f;
    }
    await this.actor.update({
  ...
  async _rollSkill(s, e) {
    ...
    u === 1 ? f -= 6 : u === 2 && (f -= 3);
    const d = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, a = new Roll(d);
  ...
  async _rollWeapon(s) {
    ...
    const p = u && u.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, a = ((k = u == null ? void 0 : u.system) == null ? void 0 : k.type) || "kinetic", o = (((w = u == null ? void 0 : u.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = o && n[o] !== void 0 ? o : a === "explosive" ? "grenadeUse" : "firearms", r = Number(n[y] || 0) || 0, i = d + r, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, m = new Roll(l);
  ...
  async _rollWeaponDamage(s, e = "") {
    var d, a, o, y, r, i, c, l, m, h;
    const t = this.actor;
    if (!t) return;
    let n = ((a = (d = t.items).get) == null ? void 0 : a.call(d, s)) ?? ((y = (o = t.items.contents) == null ? void 0 : o.find) == null ? void 0 : y.call(o, (g) => g.id === s));
...
X(Q, "PARTS", foundry.utils.mergeObject(
  ...
  z(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Fs = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((As = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : As.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ps = (Es = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Es.window) == null ? void 0 : Ps.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const u = await super.render(s, e), p = this.element, d = this.form ?? this.element, a = f.scrollState, o = f.focus, y = typeof (a == null ? void 0 : a.formScrollTop) == "number" || typeof (a == null ? void 0 : a.windowScrollTop) == "number", r = () => {
      var i, c;
      if (this._applyScrollState(p, a), (o == null ? void 0 : o.name) != null || (o == null ? void 0 : o.id) != null) {
        const l = ((i = d.querySelector) == null ? void 0 : i.call(d, o.id ? `#${CSS.escape(o.id)}` : null)) ?? (o.name ? (c = d.querySelector) == null ? void 0 : c.call(d, `[name="${CSS.escape(o.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    var He, Ye, Ge, ct, ee, ye, ie, lt, Re, qe, ut, Ve, Xe, Ft, At, ft, Et, yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et;
    ...
    const t = this.actor, n = ((ct = e.system) == null ? void 0 : ct.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, u = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, p = (lt = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && lt.call(ie, "halfcover") ? 3 : 0, d = (qe = (Re = t == null ? void 0 : t.statuses) == null ? void 0 : Re.has) != null && qe.call(Re, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + u + p + d;
    const a = ((ut = t == null ? void 0 : t.items) == null ? void 0 : ut.contents) ?? [], o = ((Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (o.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], c = a.filter((S) => S.type === "Fegyver"), l = c.map((S) => ({ id: S.id, name: S.name, img: S.img })), m = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
      const P = (((x = o[S]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && c.some((G) => G.id === P);
    });
    e.weaponSlots = k.map((S) => {
      const P = o[S] ?? {}, x = (P.itemId ?? "").trim(), G = l.find((we) => we.id === x), ke = c.find((we) => we.id === x), ne = (ke == null ? void 0 : ke.system) ?? {}, Le = ne.size === "thrown", Oe = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: S,
        itemId: x,
    ...
    e.weaponsTable = c.map((S) => {
      ...
      const ke = !!x, ne = (S == null ? void 0 : S.system) ?? {}, Le = typeof ne.range == "string" ? (ne.range || "").trim() : "", Oe = ne.type ?? "", we = (w[Oe] ?? Oe) || "—", ze = ne.size ?? "", tt = (T[ze] ?? ze) || "", st = [we, tt].filter(Boolean).join(", ") || we || "—", Pt = Oe === "projectile" || ze === "thrown", $t = ne.quantity != null ? String(ne.quantity).trim() : "1", xt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Rt = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const _ = ((Ft = (Xe = t == null ? void 0 : t.system) == null ? void 0 : Xe.gear) == null ? void 0 : Ft.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], j = a.filter((S) => S.type === "MikroChip");
    e.microchipsTable = j.map((S) => {
      ...
      const G = ((we = S == null ? void 0 : S.system) == null ? void 0 : we.abilityType) ?? "", ke = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ne = (((ze = S == null ? void 0 : S.system) == null ? void 0 : ze.description) ?? "").trim(), Le = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: P,
        actorId: t.id,
        name: (S == null ? void 0 : S.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-DZdha1Eo.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DZdha1Eo.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DZdha1Eo.mjs");
      m(this.actor, c, l);
    ...
    u._votvNpcBlur = (r) => {
      ...
      m && (l.contains(m) || u.id && ((h = m.closest) != null && h.call(m, `#${CSS.escape(u.id)}`))) || p(l);
  ...
  async _rollWeapon(s) {
    ...
    const d = p && p.name || n.name || "Fegyver", a = Number(n.bonus || 0) || 0, o = ((_ = p == null ? void 0 : p.system) == null ? void 0 : _.type) || "kinetic", y = (((C = p == null ? void 0 : p.system) == null ? void 0 : C.skillKey) ?? "").trim(), r = y && f[y] !== void 0 ? y : o === "explosive" ? "grenadeUse" : "firearms", i = Number(f[r] || 0) || 0, c = a + i, m = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, h = new Roll(m);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((a = (d = t.items).get) == null ? void 0 : a.call(d, s)) ?? ((y = (o = t.items.contents) == null ? void 0 : o.find) == null ? void 0 : y.call(o, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((r = n.system) == null ? void 0 : r.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (c = ui.notifications) == null ? void 0 : c.warn) == null || h.call(c, ((m = (l = game.i18n) == null ? void 0 : l.localize) == null ? void 0 : m.call(l, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var o, y, r, i, c, l, m, h, g, v, k, w, T, O, _, C, j, K, U;
    ...
    if (f.type === "Fegyver" && a) {
      const M = ((_ = u.system) == null ? void 0 : _.weapons) ?? {}, W = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Z = (M.slotOrder ?? "").trim(), J = Z ? Z.split(/\s*,\s*/).filter((R) => W.includes(R)) : [];
      let Y = W.find((R) => {
        var te;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((r = e.system) == null ? void 0 : r.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${d}
  ...
  async _postItemToChat(s) {
    var d, a, o, y, r, i;
    const e = (a = (d = this.actor) == null ? void 0 : d.items) == null ? void 0 : a.get(s);
    if (!e || e.type !== "MikroChip" && e.type !== "Egyeb") return;
...
X(ge, "PARTS", foundry.utils.mergeObject(
  ...
  z(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject((($s = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : $s.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((xs = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((zs = (Rs = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.window) == null ? void 0 : zs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var j, K, U, M, W, Z, J, Y, oe, R, te, de, De;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    for (const D of r) {
      ...
      const pe = E.abilities ?? {}, ae = Array.isArray(pe.items) ? pe.items : [], ce = (await Promise.all(
        ...
        var qe, ut;
        const ie = (((qe = ee.system) == null ? void 0 : qe.kind) ?? "passive").toString(), lt = Number(((ut = ee.system) == null ? void 0 : ut.kp) ?? 0) || 0, Re = ie === "species";
        return {
          id: ee.id,
          ref: ye,
          name: ee.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      var y, r, i;
      d.preventDefault();
      const a = (r = (y = d.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : r.itemId;
      if (!a) return;
      ...
      var r;
      const a = d.currentTarget, o = (r = a == null ? void 0 : a.dataset) == null ? void 0 : r.itemId;
      if (!o) return;
      ...
      if (!a) return;
      const o = this.actor.items.get(a);
      !o || o.type !== "Pancel" || await o.update({ "system.equipped": d.currentTarget.checked });
    }), t.on("click", ".jarmu-egyeb-name, .jarmu-egyeb-icon", (d) => {
      var o, y, r, i;
      d.preventDefault();
      const a = (y = (o = d.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : y.itemId;
      ...
      var y, r, i, c;
      d.preventDefault();
      const a = (((r = (y = d.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : r.itemId) ?? ((c = (i = d.currentTarget) == null ? void 0 : i.getAttribute) == null ? void 0 : c.call(i, "data-item-id")) ?? "").trim();
      ...
      var y;
      d.preventDefault(), d.stopPropagation();
      const a = d.currentTarget, o = (((y = a == null ? void 0 : a.dataset) == null ? void 0 : y.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      var r, i, c, l;
      const a = (i = (r = d.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : i.itemId, o = n._draggingUnitId;
      if (!o || !a || o === a) return;
      d.preventDefault();
      const y = (c = d.originalEvent) == null ? void 0 : c.dataTransfer;
      y && (y.dropEffect = "move"), (l = d.currentTarget) == null || l.classList.add("karakter-actions-row-drag-over");
    }), t.on("dragleave", ".jarmu-unit-row", (d) => {
      var a;
      (a = d.currentTarget) == null || a.classList.remove("karakter-actions-row-drag-over");
      ...
      const a = (k = (v = d.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : k.itemId;
      ...
      d.preventDefault();
      const a = (l = (c = (i = (r = d.currentTarget) == null ? void 0 : r.closest) == null ? void 0 : i.call(r, ".jarmu-unit-ability-pill")) == null ? void 0 : c.dataset) == null ? void 0 : l.abilityRef, o = (v = (g = (h = (m = d.currentTarget) == null ? void 0 : m.closest) == null ? void 0 : h.call(m, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (a)
        try {
          y = await fromUuid(a);
      ...
      var i, c, l, m;
      d.preventDefault();
      const a = (c = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : c.call(i, ".jarmu-unit-ability-pill"), o = (l = a == null ? void 0 : a.dataset) == null ? void 0 : l.abilityRef, y = (m = a == null ? void 0 : a.dataset) == null ? void 0 : m.abilityId, r = o || y;
      r && await this._postUnitAbilityToChat(r);
    });
    const f = (d) => {
      if (!d) return;
      const a = this._getFormDataForUpdate(d);
      Object.keys(a).length !== 0 && this.actor.update(a).catch((o) => console.warn("VoidJarmuSheet save failed", o));
    }, u = (d) => {
      var a, o, y;
      return d && (((o = (a = this.element) == null ? void 0 : a.contains) == null ? void 0 : o.call(a, d)) || this.id && ((y = d.closest) == null ? void 0 : y.call(d, `#${CSS.escape(this.id)}`)));
    };
    this._votvJarmuBlur = (d) => {
      ...
      var l, m, h;
      const a = d.currentTarget, o = (l = a == null ? void 0 : a.dataset) == null ? void 0 : l.itemId;
      if (!o) return;
      const y = this.actor.items.get(o);
      ...
      var i;
      const a = d.currentTarget, o = (i = a == null ? void 0 : a.dataset) == null ? void 0 : i.itemId;
      if (!o) return;
      const y = this.actor.items.get(o);
  ...
  async _rollUnitDamage(s) {
    var p, d, a, o, y, r, i, c, l;
    const e = this.actor;
    if (!e) return;
    const t = ((d = (p = e.items).get) == null ? void 0 : d.call(p, s)) ?? ((o = (a = e.items.contents) == null ? void 0 : a.find) == null ? void 0 : o.call(a, (m) => m.id === s));
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${d}
...
X(he, "PARTS", foundry.utils.mergeObject(
  ...
  z(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ms = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((js = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : js.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Us = (Ks = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.window) == null ? void 0 : Us.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const rt = class rt extends jt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (y == null ? void 0 : y.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((W = (M = this.actor) == null ? void 0 : M.items) == null ? void 0 : W.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ns(this.actor), O = m + h + k + w + T;
      r.value = O;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, p = f.assignment ?? "", d = f.subAssignment ?? "", a = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }, o = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[p] ?? 0, i = o[d] ?? 0, c = e.sizeForSelect ?? "Kicsi", l = y[c] ?? 0, m = Number(u.threatBonus ?? 0) || 0, h = Ns(this.actor), g = r + i + l + m + h;
      e.system = foundry.utils.mergeObject(
...
X(rt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(rt, rt, "DEFAULT_OPTIONS"),
  {
    classes: ["vacuum-of-the-void", "sheet", "actor", "Bazis"],
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Bs = z(rt, rt, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Jt = rt;
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".vallalkozas-employee-add", async (d) => {
      var y;
      if (d.preventDefault(), !this.actor) return;
    ...
    }), n.on("click", ".vallalkozas-employee-delete", async (d) => {
      var i, c, l;
      if (d.preventDefault(), !d.altKey || !this.actor) return;
      const a = ((c = (i = d.currentTarget) == null ? void 0 : i.dataset) == null ? void 0 : c.index) ?? "", o = Number(a), y = this.actor.system ?? {}, r = Array.isArray((l = y.vallalkozas) == null ? void 0 : l.employees) ? y.vallalkozas.employees.slice() : [];
      !Number.isInteger(o) || o < 0 || o >= r.length || (r.splice(o, 1), await this.actor.update({ "system.vallalkozas.employees": r }));
    }), n.on("click", ".karakter-item-chat", async (d) => {
      var y, r, i, c;
      d.preventDefault();
      const a = (((r = (y = d.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : r.itemId) ?? ((c = (i = d.currentTarget) == null ? void 0 : i.getAttribute) == null ? void 0 : c.call(i, "data-item-id")) ?? "").trim();
      if (!a || !this.actor) return;
      const o = this.actor.items.get(a);
      o && (o.type === "MikroChip" || o.type === "Egyeb") && await this._postItemToChat(a);
    }), n.on("click", ".vallalkozas-egyeb-delete", async (d) => {
      var o, y;
      if (d.preventDefault(), !d.altKey || !this.actor) return;
      const a = (((y = (o = d.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : y.itemId) ?? "").trim();
      a && await this.actor.deleteEmbeddedDocuments("Item", [a]);
    });
    const f = (d) => {
      if (!d || !this.actor) return;
      const a = e._getFormDataForUpdate(d);
      Object.keys(a).length !== 0 && e.actor.update(a).catch((o) => console.warn("VoidVallalkozasSheet save failed", o));
    }, u = (d) => {
      var a, o, y;
      return d && (((o = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : o.call(a, d)) || e.id && ((y = d.closest) == null ? void 0 : y.call(d, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (d) => {
      var o, y, r;
      const a = ((o = d.target) == null ? void 0 : o.form) ?? ((r = (y = d.target) == null ? void 0 : y.closest) == null ? void 0 : r.call(y, "form"));
      u(a) && f(a);
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  z(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Hs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !0 }),
    window: foundry.utils.mergeObject(((Gs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ws = (Vs = z(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.window) == null ? void 0 : Ws.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const Ne = class Ne extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const n = (u) => {
      ...
      var p, d, a;
      return u && (((d = (p = e.element) == null ? void 0 : p.contains) == null ? void 0 : d.call(p, u)) || e.id && ((a = u.closest) == null ? void 0 : a.call(u, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (u) => {
      var d, a, o;
      const p = ((d = u.target) == null ? void 0 : d.form) ?? ((o = (a = u.target) == null ? void 0 : a.closest) == null ? void 0 : o.call(a, "form"));
      f(p) && n(p);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
...
X(Ne, "PARTS", foundry.utils.mergeObject(z(Ne, Ne, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), X(Ne, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Ne, Ne, "DEFAULT_OPTIONS"), {
...
X(Fe, "PARTS", foundry.utils.mergeObject(z(Fe, Fe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), X(Fe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Fe, Fe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Zs = z(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : Zs.form) ?? {}, { submitOnChange: !1 })
}));
let Xt = Fe;
var Ys;
...
X(Ae, "PARTS", foundry.utils.mergeObject(z(Ae, Ae, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), X(Ae, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Ae, Ae, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ys = z(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ys.form) ?? {}, { submitOnChange: !1 })
}));
let Qt = Ae;
var Xs;
const Ee = class Ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (u) => {
      ...
      const d = (p == null ? void 0 : p.form) ?? ((a = p == null ? void 0 : p.closest) == null ? void 0 : a.call(p, "form"));
...
X(Ee, "PARTS", foundry.utils.mergeObject(z(Ee, Ee, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), X(Ee, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Ee, Ee, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xs = z(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Xs.form) ?? {}, { submitOnChange: !0 })
}));
let es = Ee;
var Qs;
...
X(Pe, "PARTS", foundry.utils.mergeObject(z(Pe, Pe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), X(Pe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Pe, Pe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Qs = z(Pe, Pe, "DEFAULT_OPTIONS")) == null ? void 0 : Qs.form) ?? {}, { submitOnChange: !1 })
}));
let ts = Pe;
var ei;
...
X($e, "PARTS", foundry.utils.mergeObject(z($e, $e, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), X($e, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z($e, $e, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ei = z($e, $e, "DEFAULT_OPTIONS")) == null ? void 0 : ei.form) ?? {}, { submitOnChange: !1 })
}));
let ss = $e;
var ti, si;
  ...
  async _prepareContext(s) {
    ...
    const p = (await Promise.all(
      f.map(async (d) => {
        ...
        if (!d) return null;
        try {
          const o = await fromUuid(d);
          if (o && (o.type === "Kepesseg" || o.type === "ability")) return o;
        } catch {
          const o = (a = game.items) == null ? void 0 : a.get(d);
          if (o && (o.type === "Kepesseg" || o.type === "ability")) return o;
        }
        return null;
      })
    )).map((d, a) => ({ doc: d, ref: f[a] })).filter((d) => !!d.doc && !!d.ref).map(({ doc: d, ref: a }) => {
      var i, c;
      const o = (((i = d.system) == null ? void 0 : i.kind) ?? "passive").toString(), y = Number(((c = d.system) == null ? void 0 : c.kp) ?? 0) || 0, r = o === "species";
      return {
        id: d.id,
        ref: a,
        name: d.name,
...
X(Se, "PARTS", foundry.utils.mergeObject(z(Se, Se, "PARTS") ?? {}, {
  ...
  z(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ti = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : ti.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((si = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : si.dragDrop) ?? [],
      {
        dragSelector: null,
...
X(Te, "PARTS", foundry.utils.mergeObject(z(Te, Te, "PARTS") ?? {}, {
  ...
  z(Te, Te, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ii = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : ii.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ni = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : ni.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, o, y, r) => {
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const R = ri((M = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : M.size);
      a.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, O, _, C, j, K, U, M, W, Z, J, Y, oe, R, te, de, De, D;
    ...
    let d = ((O = game.actors) == null ? void 0 : O.get(u.actorId)) ?? ((_ = game.actors) == null ? void 0 : _.get(p));
    if (d || (d = ((j = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : j.flatMap((V) => {
      var se;
      return ((se = V.tokens) == null ? void 0 : se.contents) ?? [];
    }).map((V) => V.actor).find((V) => V && (V.id === p || V.id === u.actorId))) ?? null), !d) return;
    const a = u.itemId ? ((U = (K = d.items) == null ? void 0 : K.get) == null ? void 0 : U.call(K, u.itemId)) ?? ((Z = (W = (M = d.items) == null ? void 0 : M.contents) == null ? void 0 : W.find) == null ? void 0 : Z.call(W, (E) => E.id === u.itemId)) : null;
    let o = (u.damageFormula ?? "").trim();
    if (o || (o = (((J = a == null ? void 0 : a.system) == null ? void 0 : J.damage) ?? "").trim()), !o && u.slotKey && (o = (((((Y = d.system) == null ? void 0 : Y.weapons) ?? {})[u.slotKey] ?? {}).damage ?? "").trim()), !o) {
    ...
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = u.targetName || "", c = u.hitLocationName || "", l = ((a == null ? void 0 : a.name) ?? (u.slotKey ? ((D = (((De = d.system) == null ? void 0 : De.weapons) ?? {})[u.slotKey]) == null ? void 0 : D.name) ?? "" : "")) || "Fegyver";
    ...
    (e) => {
      ...
      const t = (a = (d = e.target) == null ? void 0 : d.closest) == null ? void 0 : a.call(d, "[data-document-id]"), n = (o = t == null ? void 0 : t.getAttribute) == null ? void 0 : o.call(t, "data-document-id");
      if (!n) return;
    ...
    for (const p of e) {
      const d = Lt.getTotalSpeedRaw(p), a = (n = p.effects) == null ? void 0 : n.find((o) => o.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (d <= 0 && !a) {
      ...
      } else d > 0 && a && await a.delete().catch(() => {
      });
    }
    ...
    for (const r of t)
      try {
        const i = r.prototypeToken, c = ((p = i == null ? void 0 : i.bar1) == null ? void 0 : p.attribute) ?? "", l = ((d = i == null ? void 0 : i.bar2) == null ? void 0 : d.attribute) ?? "";
        (c || l) && await r.update({
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var y, r, i, c;
  const t = ((y = I.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, u = t.weaponAttack, p = t.weapon, d = t.vsDefense, a = t.vsDefenseInfo;
  if (!n && !f && !u && !d) return;
  ...
  if (o) {
    ...
    if (u && p && (p.actorId || (i = I.speaker) != null && i.actor)) {
      ...
      if (p.isHit && !o.querySelector(".votv-weapon-damage-chat")) {
        ...
        v.textContent = k != null && w ? `Sebzés (Találati Hely ${k} - ${w})` : "Sebzés", v.dataset.actorId = String(p.actorId ?? ((c = I.speaker) == null ? void 0 : c.actor) ?? ""), v.dataset.itemId = String(p.itemId ?? ""), v.dataset.slotKey = String(p.slotKey ?? ""), v.dataset.targetName = String(p.targetName ?? ""), v.dataset.hitLocationName = String(p.hitLocationName ?? ""), v.dataset.messageId = String(I.id ?? ""), m.appendChild(v);
      }
    }
    if (!u && d && a) {
...
//# sourceMappingURL=vacuum-of-the-void-BxEVzN9B.mjs.map
