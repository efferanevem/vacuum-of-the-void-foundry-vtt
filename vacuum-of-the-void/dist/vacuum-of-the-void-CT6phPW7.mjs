...
var qi = Reflect.get;
var Li = (w, i, e) => i in w ? Oi(w, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : w[i] = e;
var Y = (w, i, e) => Li(w, typeof i != "symbol" ? i + "" : i, e);
var U = (w, i, e) => qi(Ci(w), e, i);
const { HTMLField: Ni, NumberField: L, SchemaField: j, StringField: T, BooleanField: te, ArrayField: dt } = foundry.data.fields;
...
const { NumberField: Ct, SchemaField: Pi } = foundry.data.fields;
class Ai extends wi {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      attributes: new Pi({
        body: new Ct({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        mind: new Ct({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        soul: new Ct({ required: !0, integer: !0, min: 3, max: 18, initial: 10 })
      })
    };
  }
}
const { BooleanField: Fi, NumberField: Vi, StringField: Ce } = foundry.data.fields;
...
const { BooleanField: Ei, StringField: St } = foundry.data.fields;
...
const { NumberField: qt, StringField: ii } = foundry.data.fields;
class xi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      cost: new qt({ required: !1, integer: !0, min: 0, initial: 1250 }),
      replaceCost: new qt({ required: !1, integer: !0, min: 0, initial: 3 }),
      quantity: new qt({ required: !1, integer: !0, min: 0, initial: 1 })
    };
  }
}
const { NumberField: Ri, StringField: si } = foundry.data.fields;
...
class Mi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new ai({ required: !1, blank: !0, initial: "" }),
      quantity: new ai({ required: !1, blank: !0, initial: "1" })
    };
  }
}
const { StringField: Ki } = foundry.data.fields;
class ji extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const n = Number(((b = (y = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : y.combat) == null ? void 0 : b.givenProtection) ?? 0) || 0, d = (c = (s = (u = this.actor) == null ? void 0 : u.statuses) == null ? void 0 : s.has) != null && c.call(s, "lookaround") ? 1 : 0, r = (f = (a = (o = this.actor) == null ? void 0 : o.statuses) == null ? void 0 : a.has) != null && f.call(a, "halfcover") ? 3 : 0, l = n + this._getTotalArmorProtectionBonus() + d + r;
  ...
  _writeTotalSpeed(i = null) {
    var o, a, f, h, v, I, S, C;
    const e = i ?? this.form ?? this.element, t = (_) => {
      var N;
  ...
  async _prepareContext(i) {
    var Xe, Ze, et, tt, it, st, nt, at, rt, Pe, k, F, E, z, ce, J, Te, ke, _e, ve, Ae, Fe, kt, vt, wt, It, ot, je, Rt, Mt, Kt, jt, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt;
    ...
    for (const g of l) {
      const O = ((tt = d[g]) == null ? void 0 : tt.value) ?? 0, D = r[g] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((st = (it = this.actor.system) == null ? void 0 : it.combat) == null ? void 0 : st.givenSpeed) ?? 0) || 0;
    let s;
    b === 0 ? s = 0 : b === 1 ? s = -6 : b === 2 ? s = -3 : s = u;
    const c = this._getTotalArmorSpeedPenalty();
    s += c, e.effectiveGivenSpeed = s;
    const o = Number(((at = (nt = this.actor.system) == null ? void 0 : nt.combat) == null ? void 0 : at.givenProtection) ?? 0) || 0, a = (k = (Pe = (rt = this.actor) == null ? void 0 : rt.statuses) == null ? void 0 : Pe.has) != null && k.call(Pe, "lookaround") ? 1 : 0, f = o + this._getTotalArmorProtectionBonus() + a;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: s, givenProtection: f } },
      { inplace: !1 }
    );
    const h = ((F = e.system) == null ? void 0 : F.combat) ?? {}, v = (ce = (z = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : z.has) != null && ce.call(z, "halfcover") ? 3 : 0;
    e.totalDefense = (Number(h.defense) || 0) + (Number(h.defenseBonus) || 0) + (Number(h.givenProtection) || 0) + v;
    const I = Number(h.givenSpeed);
    let S = (Number(h.speed) || 0) + (Number(h.speedBonus) || 0) + (Number.isFinite(I) ? I : 0);
    b === 0 && (S = 0), (ke = (Te = (J = this.actor) == null ? void 0 : J.statuses) == null ? void 0 : Te.has) != null && ke.call(Te, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (ve = (_e = e.system) == null ? void 0 : _e.combat) == null ? void 0 : ve.givenProtection } },
      { inplace: !1 }
    ), S = 0), e.totalSpeed = S;
    ...
    const _ = this.actor.system.weapons ?? {}, N = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (_.slotOrder ?? "").trim(), x = q ? q.split(/\s*,\s*/).filter((g) => N.includes(g)) : [], A = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, K = A && typeof A == "object" && !Array.isArray(A) ? A : {}, V = (((Fe = K.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), H = (((kt = K.slot2) == null ? void 0 : kt.itemId) ?? "").trim(), G = (((vt = K.slot3) == null ? void 0 : vt.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const D = typeof g.sort == "number" ? g.sort : 0, P = typeof O.sort == "number" ? O.sort : 0;
      return D - P;
    }).map((g) => {
      var we, $e, xe, De, Oe, lt;
      const O = g.type === "Fegyver", D = g.type === "MikroChip";
      let P = 0, M = "", ee = null;
      for (let ze = 0; ze < x.length; ze++) {
        const ut = x[ze];
        if ((((we = _[ut]) == null ? void 0 : we.itemId) ?? "") === g.id) {
          P = ze + 1, M = (($e = _[ut]) == null ? void 0 : $e.bonus) ?? "", ee = ut;
          break;
        }
      }
      let X = null;
      D && (V === g.id ? X = "slot1" : H === g.id ? X = "slot2" : G === g.id && (X = "slot3"));
      const ct = O && ((xe = g.system) != null && xe.damage) ? g.system.damage : "", le = O && typeof ((De = g.system) == null ? void 0 : De.range) == "string" ? (g.system.range || "").trim() : "", Ee = ee ? Number((Oe = _[ee]) == null ? void 0 : Oe.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        ...
        rangeStr: le,
        slotBonusNum: Ee,
        quantity: Number(((lt = g.system) == null ? void 0 : lt.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = W;
    const R = (((wt = this.actor.items) == null ? void 0 : wt.contents) ?? []).filter((g) => g.type === "Fegyver"), Q = R.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = Q;
    const ae = "— Nincs fegyver —", oe = x.filter((g) => {
      const D = ((_[g] ?? {}).itemId ?? "").trim();
      return D ? !!R.find((M) => M.id === D) : !1;
    });
    e.weaponSlots = oe.map((g, O) => {
      const D = _[g] ?? {}, P = (D.itemId ?? "").trim(), M = Q.find((ee) => ee.id === P);
      return {
        slotKey: g,
        itemId: P,
        slotNum: O + 1,
    ...
    const Z = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Re = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = R.map((g) => {
      var Xt, Zt, ei;
      const O = g.id;
      let D = null, P = {};
      for (const Ot of x)
        if ((((Xt = _[Ot]) == null ? void 0 : Xt.itemId) ?? "").trim() === O) {
          D = Ot, P = _[Ot] ?? {};
          break;
        }
      const M = !!D, ee = ((Zt = g.system) == null ? void 0 : Zt.equipped) !== void 0 && ((ei = g.system) == null ? void 0 : ei.equipped) !== null ? !!g.system.equipped : M, X = (g == null ? void 0 : g.system) ?? {}, ct = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", Ee = (Z[le] ?? le) || "—", we = X.size ?? "", $e = (Re[we] ?? we) || "", xe = [Ee, $e].filter(Boolean).join(", ") || Ee || "—", De = le === "projectile" || we === "thrown", Oe = X.quantity, lt = Oe != null ? String(Oe).trim() : "1", ze = String(P.bonus ?? "").trim(), ut = String(X.bonus ?? "").trim(), Di = ze || ut || "0";
      return {
        slotKey: D ?? "",
        itemId: O,
        ...
        typeAndSize: xe,
        quantity: lt,
        quantityDisplay: De ? lt : "—",
        isProjectile: De,
        equipped: ee,
        special: (X.special ?? "").trim() || "—"
      };
    });
    const Ie = (((It = this.actor.items) == null ? void 0 : It.contents) ?? []).filter((g) => g.type === "Pancel");
    e.armorTable = Ie.map((g) => {
      ...
      return {
        ...
        level: zi((O.level ?? "").toString().trim()),
        special: (O.special ?? O.other ?? "").toString().trim() || "—",
        equipped: D
      };
    });
    const ie = (((ot = this.actor.items) == null ? void 0 : ot.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const He = (((je = this.actor.items) == null ? void 0 : je.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const re = (((Rt = this.actor.items) == null ? void 0 : Rt.contents) ?? []).filter((g) => g.type === "MikroChip"), qe = re.map((g) => ({ id: g.id, name: g.name, img: g.img })), ge = "— Nincs Mikro-Chip —", Ue = ["slot1", "slot2", "slot3"], Me = (g) => {
      var D, P, M;
      const O = [];
    ...
    e.microchipItemsSlot1 = qe.filter((g) => !Me(1).includes(g.id)), e.microchipItemsSlot2 = qe.filter((g) => !Me(2).includes(g.id)), e.microchipItemsSlot3 = qe.filter((g) => !Me(3).includes(g.id)), e.microchipSlots = Ue.map((g) => {
      const O = K[g] ?? {}, D = (O.itemId ?? "").trim(), P = re.find((M) => M.id === D);
      return {
        slotKey: g,
        itemId: D,
      ...
      const O = `slot${g}`, D = K[O] ?? {}, P = (D.itemId ?? "").trim(), M = qe.find((ee) => ee.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (M == null ? void 0 : M.name) || D.name || ge, e[`microchip${g}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = re.map((g) => {
      var we, $e, xe, De;
      const O = g.id;
      let D = null;
      for (const Oe of Ue)
        if ((((we = K[Oe]) == null ? void 0 : we.itemId) ?? "").trim() === O) {
          D = Oe;
          break;
        }
      const P = !!D, M = (($e = g == null ? void 0 : g.system) == null ? void 0 : $e.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", ct = Number((xe = g == null ? void 0 : g.system) == null ? void 0 : xe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, le = (((De = g == null ? void 0 : g.system) == null ? void 0 : De.description) ?? "").trim(), Ee = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const Tt = (((Mt = e.weaponsTable) == null ? void 0 : Mt.length) ?? 0) > 0 || (((Kt = e.armorTable) == null ? void 0 : Kt.length) ?? 0) > 0 || (((jt = e.microchipsTable) == null ? void 0 : jt.length) ?? 0) > 0 || (((zt = e.itemsTable) == null ? void 0 : zt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Tt;
    const _t = this.actor.system.abilities ?? {}, Be = (((Ht = this.actor.items) == null ? void 0 : Ht.contents) ?? []).map((g) => {
      var O, D, P;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Ge = new Map(Be.map((g) => [g.id, g])), pt = "— Nincs képesség —", Ve = (g) => {
      const O = _t[g] ?? {}, D = (O.itemId ?? "").trim(), P = D ? Ge.get(D) : null, M = (P == null ? void 0 : P.description) ?? "", ee = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: D,
        displayName: (P == null ? void 0 : P.name) || O.name || pt,
        img: (P == null ? void 0 : P.img) || "",
        description: M,
        kp: ee
      };
    ...
    const Ke = ((Ut = e.system) == null ? void 0 : Ut.resources) ?? {}, ft = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], he = (Gt = (Bt = e.system) == null ? void 0 : Bt.combat) == null ? void 0 : Gt.initiativeResult, be = typeof he == "number" ? he : -1, yt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Je = (Wt = (Vt = e.system) == null ? void 0 : Vt.combat) == null ? void 0 : Wt.initiativeRanges, Le = Array.isArray(Je) ? Je.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Se = (Le.length > 0 ? Le : yt).slice().sort((g, O) => g.min - O.min), Ne = Le.map((g) => g.min), gt = Ne.length ? Math.min(...Ne) : 0, ht = Ne.length ? Math.max(...Ne) : 0;
    e.initiativeRanges = Le.map((g) => ({ ...g, isFirst: g.min === gt, isLast: g.min === ht }));
    let Qe = 0;
    if (typeof be == "number" && be >= 0 && Se.length > 0) {
      const g = Se[0], O = Se[Se.length - 1];
      let D = null;
      be <= g.max ? D = g : be >= O.min ? D = O : D = Se.find((P) => be >= P.min && be <= P.max), D && (Qe = D.kp);
    }
    e.kpDots = ft.map((g, O) => {
      const D = O + 1, P = !!Number(Ke[g]), M = D <= Qe;
      return { index: D, used: P, usable: M };
    });
    const bt = !!((Jt = (Yt = game.combat) == null ? void 0 : Yt.combatants) != null && Jt.some((g) => {
      var O;
      return ((O = g.actor) == null ? void 0 : O.type) === "Karakter";
    }));
    return e.showHarcSection = bt, e.canEditInitiative = !!((Qt = game.user) != null && Qt.isGM), e.showInitiativeResult = typeof he == "number", e.initiativeResult = e.showInitiativeResult ? he : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CnLUoY8l.mjs");
      a(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-CnLUoY8l.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-CnLUoY8l.mjs");
      f(this.actor, o, a);
  ...
  async _rollSkill(i, e) {
    ...
    const { resultType: y, label: b } = Lt(p), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    var I, S;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, n = this.actor.system.skills ?? {}, d = this.actor.items.filter((C) => C.type === "Fegyver");
    let r = null;
    ...
    const { resultType: f, label: h } = Lt(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
Y(B, "PARTS", foundry.utils.mergeObject(
  ...
  U(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((ri = U(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : ri.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((oi = U(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : oi.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((li = (ci = U(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : ci.window) == null ? void 0 : li.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var pt, Ve, We, Ye, Ke, ft, he, be, yt, Je, Le, Dt, Se, Ne, gt, ht, Qe, bt, Xe, Ze, et, tt, it, st, nt, at, rt, Pe;
    const e = await super._prepareContext(i) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((pt = this.actor) == null ? void 0 : pt.system), e.showDeathSkull = !1, e.sizeForSelect = (((We = (Ve = e.system) == null ? void 0 : Ve.identity) == null ? void 0 : We.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((Ye = e.system) == null ? void 0 : Ye.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (ft = (Ke = t == null ? void 0 : t.statuses) == null ? void 0 : Ke.has) != null && ft.call(Ke, "lookaround") ? 1 : 0;
    e.effectiveGivenProtection = d + r, e.hasHalfcover = ((be = (he = t == null ? void 0 : t.statuses) == null ? void 0 : he.has) == null ? void 0 : be.call(he, "halfcover")) ?? !1;
    const l = ((yt = t == null ? void 0 : t.items) == null ? void 0 : yt.contents) ?? [], m = ((Je = t == null ? void 0 : t.system) == null ? void 0 : Je.weapons) ?? {}, p = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], y = (m.slotOrder ?? "").trim(), b = y ? y.split(/\s*,\s*/).filter((k) => p.includes(k)) : [], u = l.filter((k) => k.type === "Fegyver"), s = u.map((k) => ({ id: k.id, name: k.name, img: k.img })), c = "— Nincs fegyver —", o = b.length > 0 ? b : p, a = p.filter((k) => !o.includes(k)), f = [...o, ...a], h = f.filter((k) => {
      var E;
      const F = (((E = m[k]) == null ? void 0 : E.itemId) ?? "").trim();
      return F && u.some((z) => z.id === F);
    });
    e.weaponSlots = h.map((k) => {
      const F = m[k] ?? {}, E = (F.itemId ?? "").trim(), z = s.find((ce) => ce.id === E);
      return {
        slotKey: k,
        itemId: E,
        displayName: (z == null ? void 0 : z.name) || F.name || c,
    ...
    e.weaponsTable = u.map((k) => {
      ...
      let E = null, z = {};
      for (const je of f)
        if ((((ot = m[je]) == null ? void 0 : ot.itemId) ?? "").trim() === F) {
          E = je, z = m[je] ?? {};
          break;
        }
      const ce = !!E, J = (k == null ? void 0 : k.system) ?? {}, Te = typeof J.range == "string" ? (J.range || "").trim() : "", ke = J.type ?? "", _e = (v[ke] ?? ke) || "—", ve = J.size ?? "", Ae = (I[ve] ?? ve) || "", Fe = [_e, Ae].filter(Boolean).join(", ") || _e || "—", kt = ke === "projectile" || ve === "thrown", vt = J.quantity != null ? String(J.quantity).trim() : "1", wt = String(J.bonus ?? z.bonus ?? "").trim() || "0", It = (J.damage ?? z.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    e.armorTable = S.map((k) => {
      ...
      return {
        ...
        level: Hi((F.level ?? "").toString().trim()),
        special: (F.special ?? F.other ?? "").toString().trim() || "—",
        equipped: E
      };
    });
    const C = ((Dt = (Le = t == null ? void 0 : t.system) == null ? void 0 : Le.gear) == null ? void 0 : Dt.microchips) ?? {}, _ = ["slot1", "slot2", "slot3"], N = l.filter((k) => k.type === "MikroChip");
    e.microchipsTable = N.map((k) => {
      var ke, _e, ve, Ae;
      const F = k.id;
      let E = null;
      for (const Fe of _)
        if ((((ke = C[Fe]) == null ? void 0 : ke.itemId) ?? "").trim() === F) {
          E = Fe;
          break;
        }
      const z = ((_e = k == null ? void 0 : k.system) == null ? void 0 : _e.abilityType) ?? "", ce = z === "active" ? "Aktív" : z === "passive" ? "Passzív" : z || "—", J = (((ve = k == null ? void 0 : k.system) == null ? void 0 : ve.description) ?? "").trim(), Te = J ? J.length > 60 ? J.slice(0, 57) + "…" : J : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        ...
        typeLabel: ce,
        description: Te,
        kp: Number((Ae = k == null ? void 0 : k.system) == null ? void 0 : Ae.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: z === "active",
        slotKey: E ?? "",
        equipped: !!E
      };
    });
    const q = l.filter((k) => k.type === "Targy");
    ...
    const A = (((Se = e.weaponsTable) == null ? void 0 : Se.length) ?? 0) > 0 || (((Ne = e.armorTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((gt = e.microchipsTable) == null ? void 0 : gt.length) ?? 0) > 0 || (((ht = e.itemsTable) == null ? void 0 : ht.length) ?? 0) > 0 || (((Qe = e.egyebList) == null ? void 0 : Qe.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const K = ((bt = t == null ? void 0 : t.system) == null ? void 0 : bt.abilities) ?? {}, V = l.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, E;
      return {
        id: k.id,
        name: k.name,
    ...
    e.abilityPassiveList = W(ne("passive")), e.abilityActiveList = W(ne("active"));
    const R = t == null ? void 0 : t.id, Q = !!((Ze = (Xe = game.combat) == null ? void 0 : Xe.combatants) != null && Ze.some(
      (k) => {
        var F;
        return (((F = k.actor) == null ? void 0 : F.id) ?? k.actorId) === R;
      }
    ));
    e.showHarcSection = Q;
    const ae = ((et = e.system) == null ? void 0 : et.resources) ?? {}, oe = (it = (tt = e.system) == null ? void 0 : tt.combat) == null ? void 0 : it.initiativeResult, Z = typeof oe == "number" ? oe : -1, Re = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ie = (nt = (st = e.system) == null ? void 0 : st.combat) == null ? void 0 : nt.initiativeRanges, ie = Array.isArray(Ie) ? Ie.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (ie.length > 0 ? ie : Re).slice().sort((k, F) => k.min - F.min), qe = 3;
    let ge = ie.length > 0 ? ie : [];
    ge.length < qe && (ge = [...ge, ...Array(qe - ge.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ge.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === ge.length - 1
    }));
    let Ue = 0;
    if (typeof Z == "number" && Z >= 0 && re.length > 0) {
      const k = re[0], F = re[re.length - 1];
      let E = null;
      Z <= k.max ? E = k : Z >= F.min ? E = F : E = re.find((z) => Z >= z.min && Z <= z.max), E && (Ue = E.kp);
    }
    const Me = re.length > 0 ? re[re.length - 1] : null, Tt = Math.min(10, Me ? Me.kp : 6), Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, Tt)).map((k, F) => {
      const E = F + 1, z = !!Number(ae[k]), ce = E <= Ue;
      return { index: E, used: z, usable: ce };
    }), Ge = Math.ceil(Be.length / 2);
    return e.kpDotsRow1 = Be.slice(0, Ge), e.kpDotsRow2 = Be.slice(Ge), e.canEditInitiative = !!((at = game.user) != null && at.isGM), e.showInitiativeResult = typeof oe == "number", e.initiativeResult = e.showInitiativeResult ? oe : "", e.speedUnitForSelect = ((Pe = (rt = e.system) == null ? void 0 : rt.combat) == null ? void 0 : Pe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(i) {
    var p, y, b;
    super._attachFrameListeners(i);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CnLUoY8l.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-CnLUoY8l.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CnLUoY8l.mjs");
      a(this.actor, c, o);
      ...
      const o = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, f = (Array.isArray((_ = o[s]) == null ? void 0 : _.items) ? o[s].items.slice() : []).filter((N) => N !== c);
      ...
      const c = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, a = ["slot1", "slot2", "slot3"].find((S) => {
        var C;
        return (((C = c[S]) == null ? void 0 : C.itemId) ?? "").trim() === s;
      });
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, d = ((C = e.system) == null ? void 0 : C.skills) ?? {}, r = ((_ = e.items) == null ? void 0 : _.filter((x) => x.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = r.find((x) => x.id === n.itemId) ?? null);
    const m = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, y = ((N = l == null ? void 0 : l.system) == null ? void 0 : N.type) || "kinetic", b = (((q = l == null ? void 0 : l.system) == null ? void 0 : q.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", s = Number(d[u] || 0) || 0, c = p + s, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(a);
    await f.evaluate({ async: !0 });
    const { resultType: h, label: v } = Lt(f), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return f.toMessage({
  ...
  async _onDropItem(i, e) {
    var y, b, u, s, c, o, a, f, h, v, I, S, C, _, N, q, x;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((o = d.parent) == null ? void 0 : o.id) !== r.id) {
        ...
        A = ((a = (await r.createEmbeddedDocuments("Item", [ne]))[0]) == null ? void 0 : a.id) ?? A;
      }
    ...
    if (d.type === "Fegyver" && p) {
      ...
      const ne = H.includes(G) ? H : [...H, G].filter((W) => K.includes(W));
      await r.update({
...
Y(se, "PARTS", foundry.utils.mergeObject(
  ...
  U(se, se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((di = U(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : di.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((mi = U(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : mi.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((fi = (pi = U(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : pi.window) == null ? void 0 : fi.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Y(ue, "PARTS", foundry.utils.mergeObject(U(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((yi = U(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : yi.form) ?? {}, { submitOnChange: !1 })
}));
let Pt = ue;
var gi;
...
Y(de, "PARTS", foundry.utils.mergeObject(U(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((gi = U(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : gi.form) ?? {}, { submitOnChange: !1 })
}));
let At = de;
var hi;
...
Y(me, "PARTS", foundry.utils.mergeObject(U(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((hi = U(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : hi.form) ?? {}, { submitOnChange: !1 })
}));
let Ft = me;
var bi;
...
Y(pe, "PARTS", foundry.utils.mergeObject(U(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((bi = U(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : bi.form) ?? {}, { submitOnChange: !0 })
}));
let Et = pe;
var ki;
...
Y(fe, "PARTS", foundry.utils.mergeObject(U(fe, fe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ki = U(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : ki.form) ?? {}, { submitOnChange: !1 })
}));
let $t = fe;
var vi;
...
Y(ye, "PARTS", foundry.utils.mergeObject(U(ye, ye, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((vi = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : vi.form) ?? {}, { submitOnChange: !1 })
}));
let xt = ye;
const Ii = "systems/vacuum-of-the-void/assets/void-bg.jpg";
function Si(w) {
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Ai, CONFIG.Actor.dataModels.Npc = wi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ti, CONFIG.Item.dataModels.weapon = ti, CONFIG.Item.dataModels.Pancel = $i, CONFIG.Item.dataModels.MikroChip = xi, CONFIG.Item.dataModels.Kepesseg = ni, CONFIG.Item.dataModels.ability = ni, CONFIG.Item.dataModels.Targy = Mi, CONFIG.Item.dataModels.Egyeb = ji, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  CONFIG.statusEffects = [
  ...
  ], foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", mt, {
    types: ["Karakter"],
    makeDefault: !0,
    label: "VOTV.KarakterSheet"
  }), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", Nt, {
    types: ["Npc"],
    makeDefault: !0,
    label: "VOTV.NpcSheet"
    ...
    setTimeout(() => {
      ...
      const c = mt.getTotalSpeedRaw(s), o = (f = s.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (c <= 0 && !o) {
  ...
  const i = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, C, _, N, q, x, A, K, V, H, G, ne, W;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      ...
      if (ae) {
        const oe = ((N = ae.combatants) == null ? void 0 : N.contents) ?? Array.from(ae.combatants ?? []);
        for (const Z of oe)
          if (((q = Z.actor) == null ? void 0 : q.id) === u || Z.actorId === u) {
            ae.updateEmbeddedDocuments("Combatant", [{ _id: Z.id, initiative: Q }]).catch(() => {
            });
            break;
          }
      }
    ...
    if (m.type === "Npc" && ((x = p == null ? void 0 : p.system) != null && x.identity) && "size" in p.system.identity) {
      const R = Si((K = (A = m.system) == null ? void 0 : A.identity) == null ? void 0 : K.size);
      m.update({
    ...
    for (const R of f)
      ((H = R.document) == null ? void 0 : H.id) !== u || ((G = R.document) == null ? void 0 : G.documentName) !== "Actor" || ((ne = R.constructor) == null ? void 0 : ne.name) !== "VoidKarakterSheet" || o.includes(R) || o.push(R);
    if (c && o.some((R) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, C, _, N, q, x, A, K, V, H, G, ne, W, R, Q, ae, oe, Z, Re;
    ...
    if (m || (m = ((x = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : x.flatMap((ie) => {
      var He;
      return ((He = ie.tokens) == null ? void 0 : He.contents) ?? [];
    }).map((ie) => ie.actor).find((ie) => ie && (ie.id === l || ie.id === r.actorId))) ?? null), !m) return;
    const p = r.itemId ? ((K = (A = m.items) == null ? void 0 : A.get) == null ? void 0 : K.call(A, r.itemId)) ?? ((G = (H = (V = m.items) == null ? void 0 : V.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (Ie) => Ie.id === r.itemId)) : null;
    let y = (r.damageFormula ?? "").trim();
    if (y || (y = (((ne = p == null ? void 0 : p.system) == null ? void 0 : ne.damage) ?? "").trim()), !y && r.slotKey && (y = (((((W = m.system) == null ? void 0 : W.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (oe = (R = ui.notifications) == null ? void 0 : R.warn) == null || oe.call(R, ((ae = (Q = game.i18n) == null ? void 0 : Q.localize) == null ? void 0 : ae.call(Q, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, s = r.targetName || "", c = r.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (r.slotKey ? ((Re = (((Z = m.system) == null ? void 0 : Z.weapons) ?? {})[r.slotKey]) == null ? void 0 : Re.name) ?? "" : "")) || "Fegyver";
    ...
    for (const l of e) {
      const m = mt.getTotalSpeedRaw(l), p = (n = l.effects) == null ? void 0 : n.find((y) => y.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (m <= 0 && !p) {
...
Hooks.on("preCreateToken", (w, i, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const y = Si((p = (m = d.system) == null ? void 0 : m.identity) == null ? void 0 : p.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("updateCombat", (w, i, e) => {
  (i == null ? void 0 : i.round) != null && Ti(w), setTimeout(_i, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-CT6phPW7.mjs.map
