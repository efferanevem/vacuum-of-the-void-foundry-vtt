...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D6x8X0uL.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-D6x8X0uL.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-D6x8X0uL.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, h)) ?? ((_ = (N = this.actor.items.contents) == null ? void 0 : N.find) == null ? void 0 : _.call(N, (P) => P.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((N) => S.includes(N)) : [], L = q.find((N) => {
          var _;
          return (((_ = v[N]) == null ? void 0 : _.itemId) ?? "").trim() === o;
        });
        if (L) {
          const N = q.filter((_) => _ !== L);
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((_) => q.includes(_)) : [], N = L.filter((_) => {
              var F;
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-D6x8X0uL.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-D6x8X0uL.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-D6x8X0uL.mjs");
      r(this.actor, c, o);
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, f = (Array.isArray((L = o[s]) == null ? void 0 : L.items) ? o[s].items.slice() : []).filter((N) => N !== c);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, a = ((L = e.items) == null ? void 0 : L.filter((F) => F.type === "Fegyver")) ?? [];
    let l = null;
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, S, q, L, N, _, F;
...
Hooks.once("init", () => {
    ...
    setTimeout(() => {
      ...
      if (c <= 0 && !o) {
        ...
        s.createEmbeddedDocuments("ActiveEffect", [{
          ...
          var q, L, N;
          const S = ((L = (q = canvas.scene) == null ? void 0 : q.tokens) == null ? void 0 : L.filter((_) => {
            var F;
  ...
  Hooks.on("updateActor", (m, p, g, b) => {
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((L = (q = m.system) == null ? void 0 : q.combat) == null ? void 0 : L.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, q, L, N, _, F, P, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
...
//# sourceMappingURL=vacuum-of-the-void-C9wvVo8q.mjs.map
