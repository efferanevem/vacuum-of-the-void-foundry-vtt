...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BXkFHY62.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((y = r.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-BXkFHY62.mjs");
      l(this.actor, c, o);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-BXkFHY62.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    const a = ((L) => {
      var M;
      if (!L) return null;
      const E = L.uuid ?? L.documentUuid ?? ((M = L.data) == null ? void 0 : M.uuid) ?? (typeof L == "string" ? L : null);
      if (E) return E;
      if (typeof L == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), M = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = E === "active" ? "active" : "passive", B = Array.isArray((y = M[H]) == null ? void 0 : y.items) ? M[H].items.slice() : Array.isArray(M[H]) ? M[H].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const L = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (L.slotOrder ?? "").trim(), H = M ? M.split(/\s*,\s*/).filter((Q) => E.includes(Q)) : [];
      let B = E.find((Q) => {
        var pe;
    ...
    if (d.type === "MikroChip" && m) {
      const L = ((w = (_ = n.system) == null ? void 0 : _.gear) == null ? void 0 : w.microchips) ?? {}, M = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, g, m) => {
    ...
    const y = (_ = game.votv) == null ? void 0 : _._lastKarakterSheetBlurSave, b = y && Date.now() - y.at < j ? y.appId : null;
    setTimeout(() => {
      for (const w of r)
...
Hooks.on("preCreateActor", (j, s, e) => {
  (j == null ? void 0 : j.type) === "Karakter" && j.updateSource({
...
//# sourceMappingURL=vacuum-of-the-void-Cfh2iVR4.mjs.map
