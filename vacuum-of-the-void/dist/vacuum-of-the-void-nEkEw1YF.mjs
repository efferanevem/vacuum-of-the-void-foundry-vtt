...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const c = await super.render(i, e);
    requestAnimationFrame(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }), setTimeout(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }, 150);
    const f = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, u = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var m, g;
    ...
    return (u || n) && (requestAnimationFrame(l), setTimeout(l, 0), setTimeout(l, 50), setTimeout(l, 150), setTimeout(l, 300), setTimeout(l, 450)), c;
  }
  /**
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((p = s.system) == null ? void 0 : p.speedPenalty) ?? "").trim().replace(",", "."), c = Number(a);
      Number.isFinite(c) && (e += c);
    }
    return e;
  }
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((p = s.system) == null ? void 0 : p.protectionBonus) ?? "").trim().replace(",", "."), c = Number(a);
      Number.isFinite(c) && (e += c);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((u = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : u.resources) ?? {}, p = ((d = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : d.value) ?? 0, s = ((m = r.currentHealth) == null ? void 0 : m.legs) ?? 0, a = N._healthStatusFromRatio(s, p), c = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let f;
    a === 0 ? f = 0 : a === 1 ? f = -6 : a === 2 ? f = -3 : f = c;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const p = (Number(((f = (c = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : c.combat) == null ? void 0 : f.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((s = this.actor.system) == null ? void 0 : s.resources) ?? {}, r = ((c = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : c.value) ?? 0, p = ((f = t.currentHealth) == null ? void 0 : f[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, p = ((f = (c = r.hitLocations) == null ? void 0 : c[t]) == null ? void 0 : f.value) ?? 0, s = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
  ...
  async _prepareContext(i) {
    ...
    const c = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((o) => (Number(s[o]) || 0) === 0).length;
    e.showDeathSkull = c || y >= 2;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-ByNbWKpJ.mjs");
      d(this.actor, l);
      ...
      if (!l) {
        ...
        if (!v) return;
        l = (((((m = (d = this.actor) == null ? void 0 : d.system) == null ? void 0 : m.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, l = u.dataset.skill, d = ((g = u.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-ByNbWKpJ.mjs");
      m(this.actor, l, d);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if (!l) return;
      const d = this.actor, m = d.items.get(l), g = {};
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const v = d.system.weapons ?? {}, S = (v.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((O) => q.includes(O)) : [], P = L.find((O) => {
          var k;
      ...
      const l = u.closest(".karakter-microchip-slot-select-wrap"), d = l == null ? void 0 : l.classList.contains("karakter-microchip-slot-open");
      ...
      var k;
      n.preventDefault();
      const u = n.currentTarget, l = u.closest(".karakter-microchip-slot-select-wrap"), d = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), m = d == null ? void 0 : d.dataset.slot;
      if (!m) return;
      ...
      S ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", d == null || d.insertBefore(L, q)), L.src = S, L.style.display = "") : L && L.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
      ...
      const d = ((S = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : S.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((q) => {
        var L;
      ...
      u.addEventListener("dragover", (d) => this._onMicrochipSlotDragOver(d, l)), u.addEventListener("dragleave", (d) => {
        var m;
        return (m = d.currentTarget) == null ? void 0 : m.classList.remove("karakter-microchip-slot-drag-over");
      }), u.addEventListener("drop", (d) => this._onMicrochipSlotDrop(d, l));
    }), t.find(".karakter-ability-slot-single").each((n, u) => {
      const l = u.dataset.slot;
      l && (u.addEventListener("dragover", (d) => this._onAbilitySingleDragOver(d, l)), u.addEventListener("dragleave", (d) => {
        var m;
      ...
      l && (u.addEventListener("dragover", (d) => this._onAbilityAreaDragOver(d, l)), u.addEventListener("dragleave", (d) => {
        var m;
      ...
      if (!u || !l) return;
      const d = this.actor.system.abilities ?? {}, g = (Array.isArray((v = d[u]) == null ? void 0 : v.items) ? d[u].items.slice() : []).filter((S) => S !== l);
    ...
    const a = this, c = (n) => {
      ...
      const l = ((m = (d = u.system) == null ? void 0 : d.resources) == null ? void 0 : m.currentHealth) != null || ((v = (g = u.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      a.actor.update(u).then(() => {
        l && setTimeout(() => a.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, f = (n) => {
      var u, l, d;
      return n && (((l = (u = a.element) == null ? void 0 : u.contains) == null ? void 0 : l.call(u, n)) || a.id && ((d = n.closest) == null ? void 0 : d.call(n, `#${CSS.escape(a.id)}`)));
    };
    a._votvBlur = (n) => {
      const u = n.target;
      if (!u || !u.form) return;
      ...
      const d = u.form;
      f(d) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), c(d));
  ...
  async _onDropItem(i, e) {
    ...
    if (e) {
      let d = e.uuid ?? e.documentUuid ?? ((c = e.data) == null ? void 0 : c.uuid) ?? (typeof e == "string" ? e : null);
      if (!d && typeof e == "object") {
        for (const m of Object.values(e))
          if (typeof m == "string" && m.includes(".") && m.startsWith("Item.")) {
            d = m;
      ...
      if (d) {
        ...
        if (m && m.documentName === "Item" && m.type === "Fegyver") {
          const g = this.actor, v = ((f = m.parent) == null ? void 0 : f.id) !== g.id;
          let S = m.id;
          if (v) {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((c = i.dataTransfer) == null ? void 0 : c.getData("text/plain")) || ((f = i.dataTransfer) == null ? void 0 : f.getData("application/json")) || "";
    let r;
    try {
      r = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
  ...
  async _postItemToChat(i) {
    ...
    let r;
    e.type === "MikroChip" ? r = ((((c = e.system) == null ? void 0 : c.abilityType) ?? "passive") === "active" ? "Aktív" : "Passzív") + " Mikro-Chip" : r = "Egyéb Információ";
    const p = t ? `<p>${t}</p>` : "", s = `
      <h2>${e.name}</h2>
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, p = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", c = p ? `<p>${p}</p>` : "", f = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      p = ((c = (await this.actor.createEmbeddedDocuments("Item", [f]))[0]) == null ? void 0 : c.id) ?? p;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    var c, f, y, h;
    i.preventDefault(), (c = i.currentTarget) == null || c.classList.remove("karakter-ability-area-drag-over");
    const t = this._parseAbilityDrop(i);
    if (!t || !t.uuid) return;
    const r = await fromUuid(t.uuid);
    if (!r || r.type !== "Kepesseg" && r.type !== "ability") return;
  ...
  async _rollSkill(i, e) {
    ...
    s === 1 ? p -= 6 : s === 2 && (p -= 3);
    const c = `3d6${p !== 0 ? p > 0 ? `+${p}` : `${p}` : ""}`, f = new Roll(c);
  ...
  async _rollWeapon(i) {
    ...
    const a = s && s.name || t.name || `Fegyver (${i})`, c = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = c + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, d = new Roll(l);
  ...
  async _rollWeaponDamage(i, e = "") {
    var c, f, y, h, n, u, l, d, m, g;
    const t = this.actor;
    if (!t) return;
    let r = ((f = (c = t.items).get) == null ? void 0 : f.call(c, i)) ?? ((h = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : h.call(y, (v) => v.id === i));
    ...
    if (!p && e && (p = (((((u = t.system) == null ? void 0 : u.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !p) {
      (g = (l = ui.notifications) == null ? void 0 : l.warn) == null || g.call(l, ((m = (d = game.i18n) == null ? void 0 : d.localize) == null ? void 0 : m.call(d, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const s = new Roll(p);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var c, f, y, h;
      if (!e.isEditable || !((f = (c = s.target) == null ? void 0 : c.closest) != null && f.call(c, ".profile")) && ((h = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
    ...
    const r = (s) => {
      ...
      var a, c, f;
      return s && (((c = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : c.call(a, s)) || e.id && ((f = s.closest) == null ? void 0 : f.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var c, f, y;
      const a = ((c = s.target) == null ? void 0 : c.form) ?? ((y = (f = s.target) == null ? void 0 : f.closest) == null ? void 0 : y.call(f, "form"));
      p(a) && r(a);
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (s) => {
      ...
      const c = (a == null ? void 0 : a.form) ?? ((f = a == null ? void 0 : a.closest) == null ? void 0 : f.call(a, "form"));
      p(c) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(c), 300));
...
Hooks.once("init", () => {
  ...
  const E = 500;
  Hooks.on("updateActor", (s, a, c, f) => {
    var S, q, L, P, O;
    const y = s == null ? void 0 : s.id;
    if (!y) return;
    const h = document.activeElement, n = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), u = [], l = (S = game.actors) == null ? void 0 : S.get(y);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (f = (c = e.target) == null ? void 0 : c.closest) == null ? void 0 : f.call(c, "[data-document-id]"), r = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!r) return;
...
//# sourceMappingURL=vacuum-of-the-void-nEkEw1YF.mjs.map
