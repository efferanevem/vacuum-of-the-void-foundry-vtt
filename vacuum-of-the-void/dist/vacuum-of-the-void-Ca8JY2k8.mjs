...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var F, R, U, ae, Q, Ee, fe, ve, ye, _e, Ce, nt, rt, at, ot, Ge, Fe, wt, It, St, Tt, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et;
    ...
    for (const y of l) {
      const _ = ((ae = d[y]) == null ? void 0 : ae.value) ?? 0, C = r[y] ?? 0;
    ...
    const a = (Number(((ve = (fe = this.actor.system) == null ? void 0 : fe.combat) == null ? void 0 : ve.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const p = ((ye = e.system) == null ? void 0 : ye.combat) ?? {};
    ...
    e.weaponItems = x;
    const Y = "— Nincs fegyver —", X = A.filter((y) => {
    ...
    const ie = (((wt = this.actor.items) == null ? void 0 : wt.contents) ?? []).filter((y) => y.type === "MikroChip"), re = ie.map((y) => ({ id: y.id, name: y.name, img: y.img })), xe = "— Nincs Mikro-Chip —", Re = ["slot1", "slot2", "slot3"], Pe = (y) => {
      var C, L, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = re.filter((y) => !Pe(1).includes(y.id)), e.microchipItemsSlot2 = re.filter((y) => !Pe(2).includes(y.id)), e.microchipItemsSlot3 = re.filter((y) => !Pe(3).includes(y.id)), e.microchipSlots = Re.map((y) => {
    ...
    const et = ((Ct = e.system) == null ? void 0 : Ct.resources) ?? {}, tt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Te = (qt = (Ot = e.system) == null ? void 0 : Ot.combat) == null ? void 0 : qt.initiativeResult, De = typeof Te == "number" ? Te : -1, st = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ze = (Nt = (Lt = e.system) == null ? void 0 : Lt.combat) == null ? void 0 : Nt.initiativeRanges, Ae = Array.isArray(ze) ? ze.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [], it = Ae.length > 0 ? Ae : st;
    e.initiativeRanges = Ae;
    let Be = 0;
    ...
    const k = !!((At = (Pt = game.combat) == null ? void 0 : Pt.combatants) != null && At.some((y) => {
      var _;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DatU1rvH.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DatU1rvH.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-DatU1rvH.mjs");
      p(this.actor, o, a);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: g, label: b } = mt(m), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: p, label: h } = mt(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var re, xe, Re, Pe, Xe, Me, Ze, Ke, Ve, je, He, Ue, et, tt, Te, De, st, ze, Ae, it, Be;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const ae = !!R, Q = (k == null ? void 0 : k.system) ?? {}, Ee = typeof Q.range == "string" ? (Q.range || "").trim() : "", fe = Q.type ?? "", ve = (a[fe] ?? fe) || "—", ye = Q.size ?? "", _e = (p[ye] ?? ye) || "", Ce = [ve, _e].filter(Boolean).join(", ") || ve || "—", nt = fe === "projectile" || ye === "thrown", rt = Q.quantity != null ? String(Q.quantity).trim() : "1", at = String(Q.bonus ?? U.bonus ?? "").trim() || "0", ot = (Q.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const A = (((Ke = e.weaponsTable) == null ? void 0 : Ke.length) ?? 0) > 0 || (((Ve = e.armorTable) == null ? void 0 : Ve.length) ?? 0) > 0 || (((je = e.microchipsTable) == null ? void 0 : je.length) ?? 0) > 0 || (((He = e.itemsTable) == null ? void 0 : He.length) ?? 0) > 0 || (((Ue = e.egyebList) == null ? void 0 : Ue.length) ?? 0) > 0;
    ...
    const x = ((De = e.system) == null ? void 0 : De.resources) ?? {}, Y = (ze = (st = e.system) == null ? void 0 : st.combat) == null ? void 0 : ze.initiativeResult, X = typeof Y == "number" ? Y : -1, he = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ne = (it = (Ae = e.system) == null ? void 0 : Ae.combat) == null ? void 0 : it.initiativeRanges, be = Array.isArray(ne) ? ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], Ne = be.length > 0 ? be : he;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DatU1rvH.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DatU1rvH.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DatU1rvH.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const f = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, g = ((A = l == null ? void 0 : l.system) == null ? void 0 : A.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, p = new Roll(a);
    await p.evaluate({ async: !0 });
    const { resultType: h, label: v } = mt(p), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
  ...
  async _onDropItem(s, e) {
    var g, b, u, i, c, o, a, p, h, v, I, T, q, P, A, D, E;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      ...
      if (X) {
        const he = ((P = X.combatants) == null ? void 0 : P.contents) ?? Array.from(X.combatants ?? []);
        for (const ne of he)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, q, P, A, D, E, N, j, B, H, G, V, x, Y, X, he, ne, be, Ne;
    ...
    const m = r.itemId ? ((j = (N = f.items) == null ? void 0 : N.get) == null ? void 0 : j.call(N, r.itemId)) ?? ((G = (H = (B = f.items) == null ? void 0 : B.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (ke) => ke.id === r.itemId)) : null;
    let g = (r.damageFormula ?? "").trim();
    if (g || (g = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !g && r.slotKey && (g = (((((x = f.system) == null ? void 0 : x.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (r.slotKey ? ((Ne = (((be = f.system) == null ? void 0 : be.weapons) ?? {})[r.slotKey]) == null ? void 0 : Ne.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-Ca8JY2k8.mjs.map
