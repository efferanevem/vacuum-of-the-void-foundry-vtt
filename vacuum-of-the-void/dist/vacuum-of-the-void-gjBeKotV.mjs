...
const { HTMLField: Ws, NumberField: A, SchemaField: U, StringField: O, BooleanField: te, ArrayField: yt } = foundry.data.fields;
...
function xt(I) {
  ...
  const p = (c, i = 1) => {
    ...
    for (const l of c) {
      ...
      const r = typeof l.faces == "number" ? l.faces : void 0, y = Array.isArray(l.results) ? l.results : null;
  ...
  p(I.terms, 1);
  const o = s.filter((c) => c === 6).length, u = s.filter((c) => c === 1).length, d = e.filter((c) => c === 6).length, m = t.filter((c) => c === 6).length, f = o + d, g = u + m;
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const o of s) {
      const u = String(((p = o.system) == null ? void 0 : p.speedPenalty) ?? "").trim().replace(",", "."), d = Number(u);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const o of s) {
      const u = String(((p = o.system) == null ? void 0 : p.protectionBonus) ?? "").trim().replace(",", "."), d = Number(u);
      Number.isFinite(d) && (e += d);
    }
    return e;
  }
  ...
  static getTotalSpeedRaw(s) {
    ...
    const d = Number(((r = (l = s.system) == null ? void 0 : l.combat) == null ? void 0 : r.speed) ?? 0) || 0, m = Number(((h = (y = s.system) == null ? void 0 : y.combat) == null ? void 0 : h.speedBonus) ?? 0) || 0;
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((r = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : r.resources) ?? {}, p = ((h = (y = n.hitLocations) == null ? void 0 : y.legs) == null ? void 0 : h.value) ?? 0, o = ((w = n.currentHealth) == null ? void 0 : w.legs) ?? 0, u = V._healthStatusFromRatio(o, p), d = Number(((D = (T = (S = this.actor) == null ? void 0 : S.system) == null ? void 0 : T.combat) == null ? void 0 : D.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var m, f, g, c, i, a, l, r, y, h, w, S, T;
    const e = s ?? this.form ?? this.element;
    let t = (m = e == null ? void 0 : e.querySelector) == null ? void 0 : m.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((c = (g = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : g.combat) == null ? void 0 : c.givenProtection) ?? 0) || 0, p = (l = (a = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : a.has) != null && l.call(a, "lookaround") ? 1 : 0, o = (h = (y = (r = this.actor) == null ? void 0 : r.statuses) == null ? void 0 : y.has) != null && h.call(y, "halfcover") ? 3 : 0, u = (T = (S = (w = this.actor) == null ? void 0 : w.statuses) == null ? void 0 : S.has) != null && T.call(S, "threequarteredcover") ? 6 : 0, d = n + this._getTotalArmorProtectionBonus() + p + o + u;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const d = Number(o == null ? void 0 : o.value) || 0, m = Number(u == null ? void 0 : u.value) || 0, f = Number(p == null ? void 0 : p.textContent) || 0;
  ...
  _writeTotalSpeed(s = null) {
    ...
    if (!n) return;
    if ((y = (r = (l = this.actor) == null ? void 0 : l.statuses) == null ? void 0 : r.has) != null && y.call(r, "immobilized")) {
      n.textContent = "0";
      return;
    }
    const d = ((w = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : w.resources) ?? {}, m = ((T = (S = d.hitLocations) == null ? void 0 : S.legs) == null ? void 0 : T.value) ?? 0, f = ((D = d.currentHealth) == null ? void 0 : D.legs) ?? 0;
    if (V._healthStatusFromRatio(f, m) === 0) {
      n.textContent = "0";
      return;
    }
    const c = Number(o == null ? void 0 : o.value) || 0, i = Number(u == null ? void 0 : u.value) || 0, a = Number(p == null ? void 0 : p.textContent) || 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((o = this.actor.system) == null ? void 0 : o.resources) ?? {}, n = ((d = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : d.value) ?? 0, p = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, p = ((m = (d = n.hitLocations) == null ? void 0 : d[t]) == null ? void 0 : m.value) ?? 0, o = ((f = n.currentHealth) == null ? void 0 : f[t]) ?? 0;
    return V._healthStatusFromRatio(o, p);
  }
  async _prepareContext(s) {
    var tt, st, it, nt, rt, at, ot, ct, lt, xe, ut, dt, Re, k, P, x, B, oe, X, ge, pe, ce, _e, Me, je, Ot, Ct, qt, Lt, mt, We, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, rs, as, os, cs;
    ...
    for (const b of u) {
      const F = ((nt = p[b]) == null ? void 0 : nt.value) ?? 0, N = o[b] ?? 0;
      e.computedHealthStatus[b] = V._healthStatusFromRatio(N, F);
    }
    const d = (Number(o.head) || 0) === 0, f = ["torso", "arms", "legs"].filter((b) => (Number(o[b]) || 0) === 0).length;
    ...
    e.microchipItemsSlot1 = ne.filter((b) => !Be(1).includes(b.id)), e.microchipItemsSlot2 = ne.filter((b) => !Be(2).includes(b.id)), e.microchipItemsSlot3 = ne.filter((b) => !Be(3).includes(b.id)), e.microchipSlots = De.map((b) => {
      ...
      return {
        slotKey: b,
        itemId: N,
        displayName: (E == null ? void 0 : E.name) || F.name || Ye,
    ...
    if (typeof me == "number" && me >= 0 && Ce.length > 0) {
      ...
      let N = null;
      me <= b.max ? N = b : me >= F.min ? N = F : N = Ce.find((E) => me >= E.min && me <= E.max), N && (et = N.kp);
    }
    e.kpDots = Ve.map((b, F) => {
      const N = F + 1, E = !!Number(It[b]), K = N <= et;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-Cq3b1APk.mjs");
      r(this.actor, l);
      ...
      if (!l) {
        ...
        if (!w) return;
        l = (((((y = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : y.weapons) ?? {})[w] ?? {}).itemId ?? "").trim();
      }
      l && await this._rollWeaponDamage(l, ((h = a.dataset.slot) == null ? void 0 : h.trim()) ?? "");
    }), t.on("click", ".karakter-harc-initiative", async (i) => {
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: a } = await import("./roll-sheet-Cq3b1APk.mjs");
      ...
      const r = `system.resources.kpDot${l}`, y = !!Number((w = (h = this.actor.system) == null ? void 0 : h.resources) == null ? void 0 : w[`kpDot${l}`]);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', o), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const a = i.currentTarget, l = a.dataset.skill, r = ((h = a.textContent) == null ? void 0 : h.trim()) || l, { openRollSheetForSkill: y } = await import("./roll-sheet-Cq3b1APk.mjs");
      y(this.actor, l, r);
      ...
      if (!h) return;
      const w = ((q = (D = this.actor.items).get) == null ? void 0 : q.call(D, h)) ?? ((v = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : v.call(_, (C) => C.id === h));
      (L = w == null ? void 0 : w.sheet) == null || L.render(!0);
    });
    const u = (i, a) => {
      var y;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!l) return;
      const r = this.actor, y = r.items.get(l);
      if (!y) return;
      const h = {};
      if ((y == null ? void 0 : y.type) === "Fegyver") {
        const w = r.system.weapons ?? {}, S = (w.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = S ? S.split(/\s*,\s*/).filter((_) => T.includes(_)) : [], q = D.find((_) => {
          var v;
          return (((v = w[_]) == null ? void 0 : v.itemId) ?? "").trim() === l;
        });
        if (q) {
      ...
      const y = this.actor.system.weapons ?? {}, h = (y.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = h ? h.split(/\s*,\s*/).filter((v) => w.includes(v)) : [], T = S.find((v) => {
        var L;
        return (((L = y[v]) == null ? void 0 : L.itemId) ?? "").trim() === l;
      }) ?? null;
      if (a.checked) {
        if (T) return;
        let v = S.find((C) => {
      ...
      var v;
      i.preventDefault();
      const a = i.currentTarget, l = a.closest(".karakter-microchip-slot-select-wrap"), r = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), y = r == null ? void 0 : r.dataset.slot;
      if (!y) return;
      const h = (a.dataset.itemId ?? "").trim(), w = (a.dataset.itemName ?? ((v = a.textContent) == null ? void 0 : v.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (a.dataset.itemImg ?? "").trim(), T = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      T && (T.textContent = w);
      ...
      if (!a || !l) return;
      const r = this.actor.system.abilities ?? {}, h = (Array.isArray((w = r[a]) == null ? void 0 : w.items) ? r[a].items.slice() : []).filter((S) => S !== l);
      ...
      await r.update({ "system.quantity": y }), setTimeout(() => {
        const h = this.form ?? this.element, w = h == null ? void 0 : h.querySelector(`.karakter-weapon-quantity-input[data-item-id="${l}"]`);
      ...
      const l = i.currentTarget.dataset.itemId;
      if (!l) return;
      const r = this.actor, y = r.items.get(l), h = {};
      if ((y == null ? void 0 : y.type) === "Fegyver") {
        const w = r.system.weapons ?? {}, S = (w.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = S ? S.split(/\s*,\s*/).filter((_) => T.includes(_)) : [], q = D.find((_) => {
          var v;
          return (((v = w[_]) == null ? void 0 : v.itemId) ?? "").trim() === l;
      ...
      const y = (a.value ?? "").trim();
      await r.update({ "system.quantity": y }), setTimeout(() => {
        const h = this.form ?? this.element, w = h == null ? void 0 : h.querySelector(`.karakter-item-quantity-input[data-item-id="${l}"]`);
        w && this._resizeWeaponQuantityInput(w);
      }, 80);
    });
    const d = this, m = (i) => {
      ...
      const l = ((y = (r = a.system) == null ? void 0 : r.resources) == null ? void 0 : y.currentHealth) != null || ((w = (h = a.system) == null ? void 0 : h.resources) == null ? void 0 : w.hitLocations) != null;
      d.actor.update(a).then(() => {
        l && setTimeout(() => d.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, f = (i) => {
      var a, l, r;
      return i && (((l = (a = d.element) == null ? void 0 : a.contains) == null ? void 0 : l.call(a, i)) || d.id && ((r = i.closest) == null ? void 0 : r.call(i, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (i) => {
      var h;
      const a = i.target;
    ...
    if (e) {
      ...
      if (l) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          const h = (((o = r.system) == null ? void 0 : o.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (h === "species") {
            await this.actor.update({
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const S = ((g = y.system) == null ? void 0 : g.weapons) ?? {}, T = (S.slotOrder ?? "").trim(), D = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = T ? T.split(/\s*,\s*/).filter((v) => D.includes(v)) : [], _ = q.filter((v) => {
              var L;
              return (((L = S[v]) == null ? void 0 : L.itemId) ?? "").trim() === w;
            });
            if (_.length > 0) {
              const L = {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((f = e.system) == null ? void 0 : f.kind) ?? "passive", n = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, p = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = p ? `<p>${p}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const u = o && o.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, m = ((S = o == null ? void 0 : o.system) == null ? void 0 : S.type) || "kinetic", f = (((T = o == null ? void 0 : o.system) == null ? void 0 : T.skillKey) ?? "").trim(), g = f && n[f] !== void 0 ? f : m === "explosive" ? "grenadeUse" : "firearms", c = Number(n[g] || 0) || 0, i = d + c, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, r = new Roll(l);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!p && e && (p = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !p) {
      (y = (a = ui.notifications) == null ? void 0 : a.warn) == null || y.call(a, ((r = (l = game.i18n) == null ? void 0 : l.localize) == null ? void 0 : r.call(l, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const o = new Roll(p);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const o = await super.render(s, e), u = this.element, d = this.form ?? this.element, m = p.scrollState, f = p.focus, g = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", c = () => {
      var i, a;
      if (this._applyScrollState(u, m), (f == null ? void 0 : f.name) != null || (f == null ? void 0 : f.id) != null) {
        const l = ((i = d.querySelector) == null ? void 0 : i.call(d, f.id ? `#${CSS.escape(f.id)}` : null)) ?? (f.name ? (a = d.querySelector) == null ? void 0 : a.call(d, `[name="${CSS.escape(f.name)}"]`) : null);
    ...
    return (g || f) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), o;
  }
  async _prepareContext(s) {
    ...
    e.weaponsTable = a.map((k) => {
      ...
      const oe = !!x, X = (k == null ? void 0 : k.system) ?? {}, ge = typeof X.range == "string" ? (X.range || "").trim() : "", pe = X.type ?? "", ce = (T[pe] ?? pe) || "—", _e = X.size ?? "", Me = (D[_e] ?? _e) || "", je = [ce, Me].filter(Boolean).join(", ") || ce || "—", Ot = pe === "projectile" || _e === "thrown", Ct = X.quantity != null ? String(X.quantity).trim() : "1", qt = String(X.bonus ?? B.bonus ?? "").trim() || "0", Lt = (X.damage ?? B.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const q = m.filter((k) => k.type === "Pancel");
    e.armorTable = q.map((k) => {
      var B;
    ...
    const _ = ((Tt = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : Tt.microchips) ?? {}, v = ["slot1", "slot2", "slot3"], L = m.filter((k) => k.type === "MikroChip");
    ...
    const C = m.filter((k) => k.type === "Targy");
    ...
    const ye = ((at = e.system) == null ? void 0 : at.resources) ?? {}, Te = (ct = (ot = e.system) == null ? void 0 : ot.combat) == null ? void 0 : ct.initiativeResult, ae = typeof Te == "number" ? Te : -1, de = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Fe = (xe = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : xe.initiativeRanges, He = Array.isArray(Fe) ? Fe.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ne = (He.length > 0 ? He : de).slice().sort((k, P) => k.min - P.min), Ye = 3;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-portrait-img", (c) => {
      ...
      const i = ((y = (r = (l = foundry.applications) == null ? void 0 : l.apps) == null ? void 0 : r.FilePicker) == null ? void 0 : y.implementation) ?? globalThis.FilePicker;
      new i({
        type: "image",
        current: this.actor.img || "",
        callback: (h) => {
    ...
    t.on("click", ".karakter-inventory-item-name", (c) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Cq3b1APk.mjs");
      l(this.actor, a);
      ...
      !a && ((r = i == null ? void 0 : i.dataset) != null && r.slot) && (a = (((((h = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : h.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!a || !this.actor) && await this._rollWeaponDamage(a, (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slot) ?? "").trim());
    }), t.on("click", ".karakter-harc-initiative", async (c) => {
      if (c.preventDefault(), c.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Cq3b1APk.mjs");
      ...
      const l = !!Number((y = (r = this.actor.system) == null ? void 0 : r.resources) == null ? void 0 : y[`kpDot${a}`]);
      await this.actor.update({ [`system.resources.kpDot${a}`]: l ? 0 : 1 });
    }), t.on("click", ".karakter-skill-label", async (c) => {
      var y, h;
      c.preventDefault();
      const i = c.currentTarget, a = (((y = i == null ? void 0 : i.dataset) == null ? void 0 : y.skill) ?? "").trim(), l = ((h = i == null ? void 0 : i.textContent) == null ? void 0 : h.trim()) || a;
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-Cq3b1APk.mjs");
      r(this.actor, a, l);
      ...
      const i = (w = (h = c.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : w.area, a = (T = (S = c.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : T.itemId;
      if (!i || !a || !this.actor) return;
      const l = ((D = this.actor.system) == null ? void 0 : D.abilities) ?? {}, y = (Array.isArray((q = l[i]) == null ? void 0 : q.items) ? l[i].items.slice() : []).filter((_) => _ !== a);
      ...
      if (!a || !this.actor) return;
      const l = this.actor, r = (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slotKey) ?? "").trim(), y = {};
      r && (y[`system.weapons.${r}.itemId`] = "", y[`system.weapons.${r}.name`] = "", y[`system.weapons.${r}.damage`] = "", y[`system.weapons.${r}.bonus`] = ""), Object.keys(y).length && await l.update(y), await l.deleteEmbeddedDocuments("Item", [a]), typeof this.render == "function" && this.render(!0);
    ...
    o._votvNpcBlur = (c) => {
      ...
      r && (l.contains(r) || o.id && ((y = r.closest) != null && y.call(r, `#${CSS.escape(o.id)}`))) || u(l);
  ...
  async _onDropItem(s, e) {
    var f, g, c, i, a, l, r, y, h, w, S, T, D, q, _, v, L;
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      ...
      const R = (((y = p.system) == null ? void 0 : y.kind) ?? "passive").toString(), j = ((h = o.system) == null ? void 0 : h.abilities) ?? {}, H = R === "active" ? "active" : "passive", G = Array.isArray((w = j[H]) == null ? void 0 : w.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
    ...
    const m = (T = (await o.createEmbeddedDocuments("Item", [u]))[0]) == null ? void 0 : T.id;
    if (p.type === "Fegyver" && m) {
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((c = e.system) == null ? void 0 : c.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, p = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = p ? `<p>${p}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${o}</p>
      ${u}
      ${d}
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const u = Number(p == null ? void 0 : p.value) || 0, d = Number(o == null ? void 0 : o.value) || 0;
    n.textContent = String(u + d);
  }
  async _prepareContext(s) {
    var i, a, l, r, y, h, w, S, T, D, q, _;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (o) => {
      var m, f, g, c, i, a, l;
      if (!e.isEditable || !((f = (m = o.target) == null ? void 0 : m.closest) != null && f.call(m, ".profile")) && ((c = (g = o.target) == null ? void 0 : g.getAttribute) == null ? void 0 : c.call(g, "data-edit")) !== "img") return;
    ...
    const n = (o) => {
      ...
      var u, d, m;
      return o && (((d = (u = e.element) == null ? void 0 : u.contains) == null ? void 0 : d.call(u, o)) || e.id && ((m = o.closest) == null ? void 0 : m.call(o, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (o) => {
      var d, m, f;
      const u = ((d = o.target) == null ? void 0 : d.form) ?? ((f = (m = o.target) == null ? void 0 : m.closest) == null ? void 0 : f.call(m, "form"));
      p(u) && n(u);
...
const ue = class ue extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      try {
        ...
        if (T.type === "Kepesseg" || T.type === "ability") {
          const D = T.uuid ?? T.id, q = this.document.system ?? {}, _ = Array.isArray((l = q.abilities) == null ? void 0 : l.items) ? q.abilities.items.slice() : [];
          _.includes(D) || _.push(D), console.log("VOTV JarmuEgysegSheet global drop updating abilities.items to", _), await this.document.update({ "system.abilities.items": _ });
        }
      } catch (r) {
        console.error("VOTV JarmuEgysegSheet global drop handler error", r);
      }
    }, window.addEventListener("drop", this._votvGlobalDrop, !0)), n.on("click", ".karakter-ability-open", (c) => {
      var l, r, y, h;
      c.preventDefault();
      const i = (r = (l = c.currentTarget) == null ? void 0 : l.dataset) == null ? void 0 : r.itemId;
      if (!i) return;
      const a = (y = game.items) == null ? void 0 : y.get(i);
      ...
      if (!i) return;
      const a = this.document.system ?? {}, r = (Array.isArray((w = a.abilities) == null ? void 0 : w.items) ? a.abilities.items.slice() : []).filter((S) => S !== i);
    ...
    const o = (c) => {
      ...
      var i, a, l;
      return c && (((a = (i = e.element) == null ? void 0 : i.contains) == null ? void 0 : a.call(i, c)) || e.id && ((l = c.closest) == null ? void 0 : l.call(c, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (c) => {
      var a, l, r;
      const i = ((a = c.target) == null ? void 0 : a.form) ?? ((r = (l = c.target) == null ? void 0 : l.closest) == null ? void 0 : r.call(l, "form"));
      u(i) && o(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", n = Number(((c = e.system) == null ? void 0 : c.kp) ?? 0) || 0, p = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = p ? `<p>${p}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${o}</p>
      ${u}
      ${d}
  ...
  async _onDropDocument(s, e) {
    ...
    if (e.type === "Kepesseg" || e.type === "ability") {
      const o = e.uuid ?? e.id, u = this.document.system ?? {}, d = Array.isArray((n = u.abilities) == null ? void 0 : n.items) ? u.abilities.items.slice() : [];
      return d.includes(o) || d.push(o), console.log("VOTV JarmuEgysegSheet _onDropDocument updating abilities.items to", d), await this.document.update({ "system.abilities.items": d }), e;
    }
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const a = ht.getTotalSpeedRaw(i), l = (y = i.effects) == null ? void 0 : y.find((S) => S.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (a <= 0 && !l) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var y, h, w, S, T, D, q, _, v, L, C, R, j, H, G, Z, W, M, J, re, Se, ye, Te;
    ...
    let d = ((q = game.actors) == null ? void 0 : q.get(o.actorId)) ?? ((_ = game.actors) == null ? void 0 : _.get(u));
    if (d || (d = ((L = (v = game.scenes) == null ? void 0 : v.contents) == null ? void 0 : L.flatMap((de) => {
      var Fe;
      return ((Fe = de.tokens) == null ? void 0 : Fe.contents) ?? [];
    }).map((de) => de.actor).find((de) => de && (de.id === u || de.id === o.actorId))) ?? null), !d) return;
    const m = o.itemId ? ((R = (C = d.items) == null ? void 0 : C.get) == null ? void 0 : R.call(C, o.itemId)) ?? ((G = (H = (j = d.items) == null ? void 0 : j.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (ae) => ae.id === o.itemId)) : null;
    let f = (o.damageFormula ?? "").trim();
    if (f || (f = (((Z = m == null ? void 0 : m.system) == null ? void 0 : Z.damage) ?? "").trim()), !f && o.slotKey && (f = (((((W = d.system) == null ? void 0 : W.weapons) ?? {})[o.slotKey] ?? {}).damage ?? "").trim()), !f) {
    ...
    const c = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = o.targetName || "", a = o.hitLocationName || "", l = ((m == null ? void 0 : m.name) ?? (o.slotKey ? ((Te = (((ye = d.system) == null ? void 0 : ye.weapons) ?? {})[o.slotKey]) == null ? void 0 : Te.name) ?? "" : "")) || "Fegyver";
    ...
    for (const c of t)
      try {
        const i = c.prototypeToken, a = ((u = i == null ? void 0 : i.bar1) == null ? void 0 : u.attribute) ?? "", l = ((d = i == null ? void 0 : i.bar2) == null ? void 0 : d.attribute) ?? "";
        (a || l) && await c.update({
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var m, f, g, c;
  const t = ((m = I.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, n = t.resultType, p = t.critLabel, o = t.weaponAttack, u = t.weapon;
  if (!n && !p && !o) return;
  ...
  if (d) {
    if (n && d.classList.add(`votv-${n}`), p) {
      ...
      if (i)
        ...
        const a = d.querySelector(".dice-total"), l = (a == null ? void 0 : a.parentElement) ?? d, r = document.createElement("div");
...
//# sourceMappingURL=vacuum-of-the-void-gjBeKotV.mjs.map
