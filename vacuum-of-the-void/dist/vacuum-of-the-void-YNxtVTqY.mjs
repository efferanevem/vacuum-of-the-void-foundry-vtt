...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (b.slotOrder ?? "").trim(), C = S ? S.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, _ = q && typeof q == "object" && !Array.isArray(q) ? q : {}, w = (((Ke = _.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), L = (((qe = _.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = _.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
      ...
      for (let De = 0; De < C.length; De++) {
        ...
        if ((((ce = b[Ee]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          O = De + 1, N = ((be = b[Ee]) == null ? void 0 : be.bonus) ?? "", Y = Ee;
          break;
        }
      }
      let W = null;
      T && (w === p.id ? W = "slot1" : L === p.id ? W = "slot2" : A === p.id && (W = "slot3"));
    ...
    }), E = new Map(k.map((p) => [p.id, p])), F = "— Nincs képesség —", K = (p) => {
      const D = Ce[p] ?? {}, T = (D.itemId ?? "").trim(), O = T ? E.get(T) : null, N = (O == null ? void 0 : O.description) ?? "", Y = (O == null ? void 0 : O.kp) ?? 0;
      return {
        itemId: T,
        displayName: (O == null ? void 0 : O.name) || D.name || F,
        img: (O == null ? void 0 : O.img) || "",
        description: N,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Dwuwh2zo.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((y = r.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-Dwuwh2zo.mjs");
      l(this.actor, c, o);
      ...
      if (!y) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, y)) ?? ((w = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : w.call(_, (A) => A.id === y));
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Q, pe, Ae, Fe, Ne, $e, xe, we, fe, _e, Oe, Ie, Ce;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-Dwuwh2zo.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), j = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", B = Array.isArray((y = j[H]) == null ? void 0 : y.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    var t, a, d;
    const e = ((t = game.actors) == null ? void 0 : t.filter((n) => n.type === "Karakter")) ?? [];
    for (const n of e)
      try {
        const u = n.prototypeToken, g = ((a = u == null ? void 0 : u.bar1) == null ? void 0 : a.attribute) ?? "", m = ((d = u == null ? void 0 : u.bar2) == null ? void 0 : d.attribute) ?? "";
        (g || m) && await n.update({
        ...
        console.warn("Vacuum of the Void | Prototype token update failed for", n.name, u);
      }
  })();
});
...
//# sourceMappingURL=vacuum-of-the-void-YNxtVTqY.mjs.map
