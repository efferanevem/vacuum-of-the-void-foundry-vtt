...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((i = s.querySelector) == null ? void 0 : i.call(s, "form.votv.karakter-sheet")) ?? ((a = s.querySelector) == null ? void 0 : a.call(s, "form.votv")) ?? null, t = ((o = s.querySelector) == null ? void 0 : o.call(s, ".votv-scroll")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, ".window-content")) ?? null;
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const i = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, a = ((r = (l = i.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : r.value) ?? 0, o = ((m = i.currentHealth) == null ? void 0 : m.legs) ?? 0, d = E._healthStatusFromRatio(o, a), p = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let y;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((o = this.actor.system) == null ? void 0 : o.resources) ?? {}, i = ((p = (d = t.hitLocations) == null ? void 0 : d[e]) == null ? void 0 : p.value) ?? 0, a = ((y = t.currentHealth) == null ? void 0 : y[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const i = ((d = s == null ? void 0 : s.system) == null ? void 0 : d.resources) ?? {}, a = ((y = (p = i.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : y.value) ?? 0, o = ((b = i.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const i = this.actor.system.resources ?? {}, a = i.hitLocations ?? {}, o = i.currentHealth ?? {}, d = ["head", "torso", "arms", "legs"];
    ...
    const h = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (h.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((u) => v.includes(u)) : [], L = ($e = this.actor.system.gear) == null ? void 0 : $e.microchips, D = L && typeof L == "object" && !Array.isArray(L) ? L : {}, w = (((xe = D.slot1) == null ? void 0 : xe.itemId) ?? "").trim(), C = (((je = D.slot2) == null ? void 0 : je.itemId) ?? "").trim(), P = (((Me = D.slot3) == null ? void 0 : Me.itemId) ?? "").trim(), rt = this.actor.items.contents.filter((u) => u.type !== "Kepesseg" && u.type !== "ability").slice().sort((u, I) => {
    ...
    e.weaponItems = we;
    const ke = "— Nincs fegyver —", at = F.filter((u) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DAMzaaUM.mjs");
      r(this.actor, l);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const c = n.currentTarget, l = c.dataset.skill, r = ((f = c.textContent) == null ? void 0 : f.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-DAMzaaUM.mjs");
      m(this.actor, l, r);
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", i = Number(((k = e.system) == null ? void 0 : k.kp) ?? 0) || 0, a = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", d = i > 0 ? `<p><strong>KP:</strong> ${i}</p>` : "", p = a ? `<p>${a}</p>` : "", y = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const d = o && o.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((h = o == null ? void 0 : o.system) == null ? void 0 : h.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", k = Number(i[b] || 0) || 0, n = p + k, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, r = new Roll(l);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    let i = ((y = (p = t.items).get) == null ? void 0 : y.call(p, s)) ?? ((k = (b = t.items.contents) == null ? void 0 : b.find) == null ? void 0 : k.call(b, (h) => h.id === s));
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = bt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = kt, CONFIG.Item.dataModels.Pancel = It, CONFIG.Item.dataModels.MikroChip = St, CONFIG.Item.dataModels.Kepesseg = Je, CONFIG.Item.dataModels.ability = Je, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-DzX8MlNl.mjs.map
