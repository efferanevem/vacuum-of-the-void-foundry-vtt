...
var Ms = Reflect.get;
var Ks = (S, s, e) => s in S ? xs(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var J = (S, s, e) => Ks(S, typeof s != "symbol" ? s + "" : s, e);
var U = (S, s, e) => Ms(Rs(S), e, s);
...
const { SchemaField: Us, StringField: cs } = foundry.data.fields;
class Bs extends Ht {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Gs, NumberField: ri, StringField: Le } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  static getTotalSpeedRaw(s) {
    ...
    const e = s.system.resources ?? {}, t = ((b = (y = e.hitLocations) == null ? void 0 : y.legs) == null ? void 0 : b.value) ?? 0, n = ((l = e.currentHealth) == null ? void 0 : l.legs) ?? 0, d = W._healthStatusFromRatio(n, t);
    if (d === 0) return 0;
    const r = Number(((o = (i = s.system) == null ? void 0 : i.combat) == null ? void 0 : o.givenSpeed) ?? 0) || 0;
    let u;
    d === 1 ? u = -6 : d === 2 ? u = -3 : u = r, u += W._getTotalArmorSpeedPenaltyStatic(s);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((a = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : a.resources) ?? {}, d = ((h = (f = n.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, r = ((w = n.currentHealth) == null ? void 0 : w.legs) ?? 0, u = W._healthStatusFromRatio(r, d), m = Number(((O = (T = (I = this.actor) == null ? void 0 : I.system) == null ? void 0 : T.combat) == null ? void 0 : O.givenSpeed) ?? 0) || 0;
    let p;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var p, y, b, l, i, o, c, a, f, h, w, I, T;
    const e = s ?? this.form ?? this.element;
    let t = (p = e == null ? void 0 : e.querySelector) == null ? void 0 : p.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((l = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : l.givenProtection) ?? 0) || 0, d = (c = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && c.call(o, "lookaround") ? 1 : 0, r = (h = (f = (a = this.actor) == null ? void 0 : a.statuses) == null ? void 0 : f.has) != null && h.call(f, "halfcover") ? 3 : 0, u = (T = (I = (w = this.actor) == null ? void 0 : w.statuses) == null ? void 0 : I.has) != null && T.call(I, "threequarteredcover") ? 6 : 0, m = n + this._getTotalArmorProtectionBonus() + d + r + u;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const m = ((w = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : w.resources) ?? {}, p = ((T = (I = m.hitLocations) == null ? void 0 : I.legs) == null ? void 0 : T.value) ?? 0, y = ((O = m.currentHealth) == null ? void 0 : O.legs) ?? 0;
    if (W._healthStatusFromRatio(y, p) === 0) {
      n.textContent = "0";
      return;
    }
  ...
  async _prepareContext(s) {
    var et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe, k, E, x, B, oe, X, ye, me, ce, De, Re, Me, Dt, _t, Ot, Ct, dt, We, Bt, Gt, Wt, Vt, Yt, Xt, Qt, Jt, Zt, es, ts, ss, is, ns;
    ...
    for (const g of u) {
      const L = ((it = d[g]) == null ? void 0 : it.value) ?? 0, q = r[g] ?? 0;
    ...
    const c = Number(((ot = (rt = this.actor.system) == null ? void 0 : rt.combat) == null ? void 0 : ot.givenProtection) ?? 0) || 0, a = (lt = ($e = (ct = this.actor) == null ? void 0 : ct.statuses) == null ? void 0 : $e.has) != null && lt.call($e, "lookaround") ? 1 : 0, f = (k = (xe = (ut = this.actor) == null ? void 0 : ut.statuses) == null ? void 0 : xe.has) != null && k.call(xe, "halfcover") ? 3 : 0, h = (B = (x = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : x.has) != null && B.call(x, "threequarteredcover") ? 6 : 0, w = c + this._getTotalArmorProtectionBonus() + a + f + h;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: w } },
      { inplace: !1 }
    );
    const I = ((oe = e.system) == null ? void 0 : oe.combat) ?? {};
    e.totalDefense = (Number(I.defense) || 0) + (Number(I.defenseBonus) || 0) + (Number(I.givenProtection) || 0);
    const T = Number(I.givenSpeed);
    let O = (Number(I.speed) || 0) + (Number(I.speedBonus) || 0) + (Number.isFinite(T) ? T : 0);
    ...
    const N = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = (N.slotOrder ?? "").trim(), _ = C ? C.split(/\s*,\s*/).filter((g) => v.includes(g)) : [], R = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, K = R && typeof R == "object" && !Array.isArray(R) ? R : {}, H = (((Me = K.slot1) == null ? void 0 : Me.itemId) ?? "").trim(), G = (((Dt = K.slot2) == null ? void 0 : Dt.itemId) ?? "").trim(), Z = (((_t = K.slot3) == null ? void 0 : _t.itemId) ?? "").trim(), M = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, L) => {
      ...
      let Q = null;
      q && (H === g.id ? Q = "slot1" : G === g.id ? Q = "slot2" : Z === g.id && (Q = "slot3"));
    ...
    e.actionsTable = M;
    const Y = (((Ot = this.actor.items) == null ? void 0 : Ot.contents) ?? []).filter((g) => g.type === "Fegyver"), ae = Y.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = ae;
    const Se = "— Nincs fegyver —", fe = _.filter((g) => {
      const q = ((N[g] ?? {}).itemId ?? "").trim();
      return q ? !!Y.find((j) => j.id === q) : !1;
    });
    e.weaponSlots = fe.map((g, L) => {
      const q = N[g] ?? {}, P = (q.itemId ?? "").trim(), j = ae.find((pe) => pe.id === P), ee = Y.find((pe) => pe.id === P), Q = (ee == null ? void 0 : ee.system) ?? {}, Ke = Q.size === "thrown", le = (typeof Q.range == "string" ? (Q.range || "").trim() : "") || "—";
      return {
        slotKey: g,
        itemId: P,
        slotNum: L + 1,
        displayName: (j == null ? void 0 : j.name) || q.name || Se,
    ...
    e.weaponsTable = Y.map((g) => {
      ...
      let q = null, P = {};
      for (const Nt of _)
        if ((((as = N[Nt]) == null ? void 0 : as.itemId) ?? "").trim() === L) {
          q = Nt, P = N[Nt] ?? {};
          break;
        }
      const j = !!q, ee = ((rs = g.system) == null ? void 0 : rs.equipped) !== void 0 && ((os = g.system) == null ? void 0 : os.equipped) !== null ? !!g.system.equipped : j, Q = (g == null ? void 0 : g.system) ?? {}, Ke = typeof Q.range == "string" ? (Q.range || "").trim() : "", le = Q.type ?? "", pe = (Ie[le] ?? le) || "—", _e = Q.size ?? "", je = (re[_e] ?? _e) || "", ze = [pe, je].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || _e === "thrown", qe = Q.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(P.bonus ?? "").trim(), pt = String(Q.bonus ?? "").trim(), $s = Ve || pt || "0";
      return {
        slotKey: q ?? "",
        itemId: L,
    ...
    const gt = (((Bt = this.actor.items) == null ? void 0 : Bt.contents) ?? []).filter((g) => g.type === "MikroChip"), ne = gt.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ye = "— Nincs Mikro-Chip —", Te = ["slot1", "slot2", "slot3"], Ue = (g) => {
      var q, P, j;
      const L = [];
    ...
    const bt = this.actor.system.abilities ?? {}, Ut = (((Xt = this.actor.items) == null ? void 0 : Xt.contents) ?? []).map((g) => {
      var L, q, P;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Be = new Map(Ut.map((g) => [g.id, g])), vt = "— Nincs képesség —", Xe = (g) => {
    ...
    const kt = ((Qt = e.system) == null ? void 0 : Qt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ae = (Zt = (Jt = e.system) == null ? void 0 : Jt.combat) == null ? void 0 : Zt.initiativeResult, de = typeof Ae == "number" ? Ae : -1, wt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Fe = (ts = (es = e.system) == null ? void 0 : es.combat) == null ? void 0 : ts.initiativeRanges, Pe = Array.isArray(Fe) ? Fe.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Oe = (Pe.length > 0 ? Pe : wt).slice().sort((g, L) => g.min - L.min), Ee = Pe.map((g) => g.min), St = Ee.length ? Math.min(...Ee) : 0, It = Ee.length ? Math.max(...Ee) : 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BoDr8xcz.mjs");
      a(this.actor, c);
      ...
      if (!c) {
        ...
        if (!w) return;
        c = (((((f = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : f.weapons) ?? {})[w] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c, ((h = o.dataset.slot) == null ? void 0 : h.trim()) ?? "");
    }), t.on("click", ".karakter-harc-initiative", async (i) => {
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-BoDr8xcz.mjs");
      ...
      const a = `system.resources.kpDot${c}`, f = !!Number((w = (h = this.actor.system) == null ? void 0 : h.resources) == null ? void 0 : w[`kpDot${c}`]);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: f } = await import("./roll-sheet-BoDr8xcz.mjs");
      f(this.actor, c, a);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const w = a.system.weapons ?? {}, I = (w.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = I ? I.split(/\s*,\s*/).filter((N) => T.includes(N)) : [], A = O.find((N) => {
          var v;
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((v) => w.includes(v)) : [], T = I.find((v) => {
        var C;
        return (((C = f[v]) == null ? void 0 : C.itemId) ?? "").trim() === c;
      }) ?? null;
      if (o.checked) {
        if (T) return;
        let v = I.find((_) => {
          var R;
          return !((R = f[_]) != null && R.itemId);
        });
        const C = new Set(I);
        if (!v) {
      ...
      if (!f) return;
      const h = (o.dataset.itemId ?? "").trim(), w = (o.dataset.itemName ?? ((v = o.textContent) == null ? void 0 : v.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (o.dataset.itemImg ?? "").trim(), T = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      T && (T.textContent = w);
      let O = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      I ? (O || (O = document.createElement("img"), O.className = "karakter-microchip-slot-thumb", O.alt = "", a == null || a.insertBefore(O, T)), O.src = I, O.style.display = "") : O && O.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      const A = h ? this.actor.items.get(h) : null, N = {
        [`system.gear.microchips.${f}.itemId`]: h,
        [`system.gear.microchips.${f}.name`]: (A == null ? void 0 : A.name) ?? ""
      };
      ...
      const a = ((I = (w = this.actor.system) == null ? void 0 : w.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((T) => {
        var O;
        return (((O = a[T]) == null ? void 0 : O.itemId) ?? "").trim() === o;
      });
      ...
      if (!o || !c) return;
      const a = this.actor.system.abilities ?? {}, h = (Array.isArray((w = a[o]) == null ? void 0 : w.items) ? a[o].items.slice() : []).filter((I) => I !== c);
    ...
    const m = this, p = (i) => {
      ...
      const c = ((f = (a = o.system) == null ? void 0 : a.resources) == null ? void 0 : f.currentHealth) != null || ((w = (h = o.system) == null ? void 0 : h.resources) == null ? void 0 : w.hitLocations) != null;
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const y of r) {
      ...
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, W._healthStatusFromRatio(l, b));
    }
    return e;
  }
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && (a.type === "Kepesseg" || a.type === "ability")) {
          ...
          const h = (((r = a.system) == null ? void 0 : r.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (h === "species") {
            await this.actor.update({
          ...
          const I = h === "active" ? "active" : "passive", T = Array.isArray((u = w[I]) == null ? void 0 : u.items) ? w[I].items.slice() : Array.isArray(w[I]) ? w[I].slice() : [];
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            ...
            w = ((y = (await f.createEmbeddedDocuments("Item", [I]))[0]) == null ? void 0 : y.id) ?? w;
          }
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = T ? T.split(/\s*,\s*/).filter((v) => O.includes(v)) : [], N = A.filter((v) => {
              var C;
              return (((C = I[v]) == null ? void 0 : C.itemId) ?? "").trim() === w;
            });
            if (N.length > 0) {
              const C = {
  ...
  async _rollWeapon(s) {
    ...
    let r = null;
    t.itemId && (r = d.find((O) => O.id === t.itemId) ?? null);
    const u = r && r.name || t.name || `Fegyver (${s})`, m = Number(t.bonus || 0) || 0, p = ((I = r == null ? void 0 : r.system) == null ? void 0 : I.type) || "kinetic", y = (((T = r == null ? void 0 : r.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = y && n[y] !== void 0 ? y : p === "explosive" ? "grenadeUse" : "firearms", l = Number(n[b] || 0) || 0, i = m + l, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(c);
    await a.evaluate({ async: !0 });
    const { resultType: f, label: h } = Pt(a), w = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${u} – találat`,
...
J(W, "PARTS", foundry.utils.mergeObject(
  ...
  U(W, W, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((fs = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : fs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((ys = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : ys.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((hs = (gs = U(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : gs.window) == null ? void 0 : hs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Qe, Je, kt, Ge, Ae, de, wt, Fe, Pe, Lt, Oe, Ee, St, It, Ze, Tt, et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe;
    ...
    const t = this.actor, n = ((kt = e.system) == null ? void 0 : kt.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (Ae = (Ge = t == null ? void 0 : t.statuses) == null ? void 0 : Ge.has) != null && Ae.call(Ge, "lookaround") ? 1 : 0, u = (wt = (de = t == null ? void 0 : t.statuses) == null ? void 0 : de.has) != null && wt.call(de, "halfcover") ? 3 : 0, m = (Pe = (Fe = t == null ? void 0 : t.statuses) == null ? void 0 : Fe.has) != null && Pe.call(Fe, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = d + r + u + m;
    const p = ((Lt = t == null ? void 0 : t.items) == null ? void 0 : Lt.contents) ?? [], y = ((Oe = t == null ? void 0 : t.system) == null ? void 0 : Oe.weapons) ?? {}, b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (y.slotOrder ?? "").trim(), i = l ? l.split(/\s*,\s*/).filter((k) => b.includes(k)) : [], o = p.filter((k) => k.type === "Fegyver"), c = o.map((k) => ({ id: k.id, name: k.name, img: k.img })), a = "— Nincs fegyver —", f = i.length > 0 ? i : b, h = b.filter((k) => !f.includes(k)), w = [...f, ...h], I = w.filter((k) => {
      var x;
      const E = (((x = y[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return E && o.some((B) => B.id === E);
    });
    e.weaponSlots = I.map((k) => {
      const E = y[k] ?? {}, x = (E.itemId ?? "").trim(), B = c.find((ce) => ce.id === x), oe = o.find((ce) => ce.id === x), X = (oe == null ? void 0 : oe.system) ?? {}, ye = X.size === "thrown", me = (typeof X.range == "string" ? (X.range || "").trim() : "") || "—";
      return {
        slotKey: k,
        itemId: x,
        displayName: (B == null ? void 0 : B.name) || E.name || a,
    ...
    e.weaponsTable = o.map((k) => {
      ...
      let x = null, B = {};
      for (const We of w)
        if ((((dt = y[We]) == null ? void 0 : dt.itemId) ?? "").trim() === E) {
          x = We, B = y[We] ?? {};
          break;
        }
    ...
    const N = ((St = (Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.gear) == null ? void 0 : St.microchips) ?? {}, v = ["slot1", "slot2", "slot3"], C = p.filter((k) => k.type === "MikroChip");
    ...
    const K = (((It = e.weaponsTable) == null ? void 0 : It.length) ?? 0) > 0 || (((Ze = e.armorTable) == null ? void 0 : Ze.length) ?? 0) > 0 || (((Tt = e.microchipsTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((et = e.itemsTable) == null ? void 0 : et.length) ?? 0) > 0 || (((tt = e.egyebList) == null ? void 0 : tt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !K;
    const H = ((st = t == null ? void 0 : t.system) == null ? void 0 : st.abilities) ?? {}, G = p.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var E, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const ae = t == null ? void 0 : t.id, Se = !!((nt = (it = game.combat) == null ? void 0 : it.combatants) != null && nt.some(
      (k) => {
        var E;
        return (((E = k.actor) == null ? void 0 : E.id) ?? k.actorId) === ae;
      }
    ));
    ...
    const fe = ((at = e.system) == null ? void 0 : at.resources) ?? {}, Ie = (ot = (rt = e.system) == null ? void 0 : rt.combat) == null ? void 0 : ot.initiativeResult, re = typeof Ie == "number" ? Ie : -1, ue = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ne = ($e = (ct = e.system) == null ? void 0 : ct.combat) == null ? void 0 : $e.initiativeRanges, He = Array.isArray(Ne) ? Ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ne = (He.length > 0 ? He : ue).slice().sort((k, E) => k.min - E.min), Ye = 3;
    ...
    if (typeof re == "number" && re >= 0 && ne.length > 0) {
      ...
      let x = null;
      re <= k.max ? x = k : re >= E.min ? x = E : x = ne.find((B) => re >= B.min && re <= B.max), x && (Ue = x.kp);
    }
    const ht = ne.length > 0 ? ne[ne.length - 1] : null, bt = Math.min(10, ht ? ht.kp : 6), Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, bt)).map((k, E) => {
      const x = E + 1, B = !!Number(fe[k]), oe = x <= Ue;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-BoDr8xcz.mjs");
      c(this.actor, o);
      ...
      !o && ((a = i == null ? void 0 : i.dataset) != null && a.slot) && (o = (((((h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!o || !this.actor) && await this._rollWeaponDamage(o, (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slot) ?? "").trim());
    }), t.on("click", ".karakter-harc-initiative", async (l) => {
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BoDr8xcz.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BoDr8xcz.mjs");
      a(this.actor, o, c);
      ...
      const i = (w = (h = l.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : w.area, o = (T = (I = l.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : T.itemId;
      if (!i || !o || !this.actor) return;
      const c = ((O = this.actor.system) == null ? void 0 : O.abilities) ?? {}, f = (Array.isArray((A = c[i]) == null ? void 0 : A.items) ? c[i].items.slice() : []).filter((N) => N !== o);
      ...
      if (!o || !this.actor) return;
      const c = this.actor, a = (((w = i == null ? void 0 : i.dataset) == null ? void 0 : w.slotKey) ?? "").trim(), f = {};
      ...
      if (!i || !this.actor) return;
      const o = ((I = (w = this.actor.system) == null ? void 0 : w.gear) == null ? void 0 : I.microchips) ?? {}, a = ["slot1", "slot2", "slot3"].find((T) => {
        var O;
    ...
    (b = (y = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : y.call(e, d)) == null || b.forEach((l) => {
      ...
      if (!c) return;
      const a = c.uuid;
      l.dataTransfer && (l.dataTransfer.setData("text/plain", a), l.dataTransfer.setData("application/json", JSON.stringify({ type: "Item", uuid: a })), l.dataTransfer.effectAllowed = "copyMove"), typeof ((w = l.dataTransfer) == null ? void 0 : w.setDragImage) == "function" && i && l.dataTransfer.setDragImage(i, 0, 0);
    });
    const r = this, u = (l) => {
      if (!l) return;
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((O = e.system) == null ? void 0 : O.skills) ?? {}, r = ((A = e.items) == null ? void 0 : A.filter((C) => C.type === "Fegyver")) ?? [];
    let u = null;
    n.itemId && (u = r.find((C) => C.id === n.itemId) ?? null);
    const m = u && u.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, y = ((N = u == null ? void 0 : u.system) == null ? void 0 : N.type) || "kinetic", b = (((v = u == null ? void 0 : u.system) == null ? void 0 : v.skillKey) ?? "").trim(), l = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[l] || 0) || 0, o = p + i, a = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, f = new Roll(a);
    await f.evaluate({ async: !0 });
    const { resultType: h, label: w } = Pt(f), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return f.toMessage({
  ...
  async _onDropItem(s, e) {
    var y, b, l, i, o, c, a, f, h, w, I, T, O, A, N, v, C;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((c = d.parent) == null ? void 0 : c.id) !== r.id) {
        ...
        _ = ((a = (await r.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : a.id) ?? _;
      }
      const R = (((f = d.system) == null ? void 0 : f.kind) ?? "passive").toString(), K = ((h = r.system) == null ? void 0 : h.abilities) ?? {}, H = R === "active" ? "active" : "passive", G = Array.isArray((w = K[H]) == null ? void 0 : w.items) ? K[H].items.slice() : Array.isArray(K[H]) ? K[H].slice() : [];
      G.includes(_) || G.push(_), await r.update({ [`system.abilities.${H}.items`]: G }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    const p = (T = (await r.createEmbeddedDocuments("Item", [u]))[0]) == null ? void 0 : T.id;
    if (d.type === "Fegyver" && p) {
      const _ = ((O = r.system) == null ? void 0 : O.weapons) ?? {}, R = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], K = (_.slotOrder ?? "").trim(), H = K ? K.split(/\s*,\s*/).filter((V) => R.includes(V)) : [];
      let G = R.find((V) => {
        var M;
    ...
    if (d.type === "MikroChip" && p) {
      const _ = ((C = (v = r.system) == null ? void 0 : v.gear) == null ? void 0 : C.microchips) ?? {}, K = ["slot1", "slot2", "slot3"].find((H) => {
        var G;
...
J(se, "PARTS", foundry.utils.mergeObject(
  ...
  U(se, se, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((vs = U(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : vs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((ws = (ks = U(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : ks.window) == null ? void 0 : ws.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, d = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, r = "— Nincs fegyver —", u = (((a = this.actor.items) == null ? void 0 : a.contents) ?? []).filter((v) => v.type === "Fegyver");
    e.weaponsTable = u.map((v) => {
      const C = (v == null ? void 0 : v.system) ?? {}, _ = C.type ?? "", R = (n[_] ?? _) || "—", K = C.size ?? "", H = (d[K] ?? K) || "", G = [R, H].filter(Boolean).join(", ") || R || "—", Z = _ === "projectile" || K === "thrown", V = C.quantity != null ? String(C.quantity).trim() : "1", M = (typeof C.range == "string" ? (C.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: v.id,
        actorId: this.actor.id,
        name: (v == null ? void 0 : v.name) ?? r,
    ...
    const m = (((f = this.actor.items) == null ? void 0 : f.contents) ?? []).filter((v) => v.type === "Pancel");
    ...
    e.microchipsTable = p.map((v) => {
      var Z, V, M;
      const C = ((Z = v == null ? void 0 : v.system) == null ? void 0 : Z.abilityType) ?? "", _ = C === "active" ? "Aktív" : C === "passive" ? "Passzív" : C || "—", R = C === "active", K = Number((V = v == null ? void 0 : v.system) == null ? void 0 : V.replaceCost) >= 0 ? Number(v.system.replaceCost) : 0, H = (((M = v == null ? void 0 : v.system) == null ? void 0 : M.description) ?? "").trim(), G = H ? H.length > 60 ? H.slice(0, 57) + "…" : H : "—";
      return {
        itemId: v.id,
        actorId: this.actor.id,
        name: (v == null ? void 0 : v.name) ?? "—",
    ...
    const y = (((w = this.actor.items) == null ? void 0 : w.contents) ?? []).filter((v) => v.type === "Targy");
    e.itemsTable = y.map((v) => {
    ...
    const b = (((I = e.weaponsTable) == null ? void 0 : I.length) ?? 0) > 0 || (((T = e.armorTable) == null ? void 0 : T.length) ?? 0) > 0 || (((O = e.microchipsTable) == null ? void 0 : O.length) ?? 0) > 0 || (((A = e.itemsTable) == null ? void 0 : A.length) ?? 0) > 0;
...
J(ie, "PARTS", foundry.utils.mergeObject(
  ...
  U(ie, ie, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Is = U(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Is.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ds = (Ts = U(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Ts.window) == null ? void 0 : Ds.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
J(ge, "PARTS", foundry.utils.mergeObject(U(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), J(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(ge, ge, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((_s = U(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : _s.form) ?? {}, { submitOnChange: !1 })
}));
let xt = ge;
var Os;
...
J(he, "PARTS", foundry.utils.mergeObject(U(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), J(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(he, he, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Os = U(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Os.form) ?? {}, { submitOnChange: !1 })
}));
let Rt = he;
var Cs;
...
J(be, "PARTS", foundry.utils.mergeObject(U(be, be, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), J(be, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(be, be, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Cs = U(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.form) ?? {}, { submitOnChange: !1 })
}));
let Mt = be;
var qs;
...
J(ve, "PARTS", foundry.utils.mergeObject(U(ve, ve, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), J(ve, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(ve, ve, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((qs = U(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : qs.form) ?? {}, { submitOnChange: !0 })
}));
let Kt = ve;
var Ls;
...
J(ke, "PARTS", foundry.utils.mergeObject(U(ke, ke, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), J(ke, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(ke, ke, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ls = U(ke, ke, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.form) ?? {}, { submitOnChange: !1 })
}));
let jt = ke;
var Ns;
...
J(we, "PARTS", foundry.utils.mergeObject(U(we, we, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), J(we, "DEFAULT_OPTIONS", foundry.utils.mergeObject(U(we, we, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ns = U(we, we, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 })
}));
let zt = we;
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const o = yt.getTotalSpeedRaw(i), c = (f = i.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (o <= 0 && !c) {
        const I = ((w = (h = CONFIG.statusEffects) == null ? void 0 : h.find((T) => T.id === "immobilized")) == null ? void 0 : w.img) ?? "";
        i.createEmbeddedDocuments("ActiveEffect", [{
          ...
          for (const N of T)
            ((A = N == null ? void 0 : N.document) == null ? void 0 : A.actorId) === l && typeof N.draw == "function" && N.draw();
        ...
        for (const A of I)
          ((O = A == null ? void 0 : A.document) == null ? void 0 : O.actorId) === l && typeof A.draw == "function" && A.draw();
      }).catch((I) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", I));
    }, 0);
  });
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var T, O, A, N, v, C, _, R, K, H, G, Z, V;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((T = p == null ? void 0 : p.system) != null && T.combat) && "initiativeResult" in p.system.combat) {
      const M = Number((A = (O = m.system) == null ? void 0 : O.combat) == null ? void 0 : A.initiativeResult), Y = Number.isFinite(M) ? M : 0, ae = game.combat;
      if (ae) {
        const Se = ((N = ae.combatants) == null ? void 0 : N.contents) ?? Array.from(ae.combatants ?? []);
        for (const fe of Se)
          if (((v = fe.actor) == null ? void 0 : v.id) === l || fe.actorId === l) {
            ae.updateEmbeddedDocuments("Combatant", [{ _id: fe.id, initiative: Y }]).catch(() => {
            });
            break;
          }
      }
    ...
    const i = document.activeElement, o = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), c = [], a = (K = game.actors) == null ? void 0 : K.get(l);
    ...
    const w = (V = game.votv) == null ? void 0 : V._lastKarakterSheetBlurSave, I = w && Date.now() - w.at < s ? w.appId : null;
    setTimeout(() => {
      for (const M of c)
    ...
    for (const [h, w] of Object.entries(i)) {
      ...
      const I = ((w == null ? void 0 : w.itemId) ?? "").trim();
      !I || I !== m.id || (o[`system.weapons.${h}.name`] = m.name ?? "", o[`system.weapons.${h}.damage`] = ((a = m.system) == null ? void 0 : a.damage) ?? "", o[`system.weapons.${h}.bonus`] = ((f = m.system) == null ? void 0 : f.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, w, I, T, O, A, N, v, C, _, R, K, H, G, Z, V, M, Y, ae, Se, fe, Ie;
    ...
    if (!n) return;
    const d = (w = game.messages) == null ? void 0 : w.get(n), r = (T = (I = d == null ? void 0 : d.flags) == null ? void 0 : I["vacuum-of-the-void"]) == null ? void 0 : T.weapon;
    if (!r) return;
    const u = r.actorId ?? ((O = d == null ? void 0 : d.speaker) == null ? void 0 : O.actor) ?? "";
    if (!u) return;
    e.preventDefault(), e.stopPropagation();
    let m = ((A = game.actors) == null ? void 0 : A.get(r.actorId)) ?? ((N = game.actors) == null ? void 0 : N.get(u));
    ...
    const p = r.itemId ? ((R = (_ = m.items) == null ? void 0 : _.get) == null ? void 0 : R.call(_, r.itemId)) ?? ((G = (H = (K = m.items) == null ? void 0 : K.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (re) => re.id === r.itemId)) : null;
    let y = (r.damageFormula ?? "").trim();
    if (y || (y = (((Z = p == null ? void 0 : p.system) == null ? void 0 : Z.damage) ?? "").trim()), !y && r.slotKey && (y = (((((V = m.system) == null ? void 0 : V.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (Se = (M = ui.notifications) == null ? void 0 : M.warn) == null || Se.call(M, ((ae = (Y = game.i18n) == null ? void 0 : Y.localize) == null ? void 0 : ae.call(Y, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
...
Hooks.on("preCreateToken", (S, s, e) => {
  var r, u, m, p;
  const t = (r = game.votv) == null ? void 0 : r._dragSourceActorId, n = t ?? S.actorId ?? null;
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const y = Fs((p = (m = d.system) == null ? void 0 : m.identity) == null ? void 0 : p.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("combatRound", (S, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || Ps(S);
});
function Es() {
  var s, e, t;
  ...
  for (const n of ((s = game.actors) == null ? void 0 : s.filter((d) => d.type === "Karakter" || d.type === "Npc")) ?? []) {
    ...
    for (const u of r)
      !u || S.has(u.id) || (S.add(u.id), typeof u.render == "function" && u.render(!0));
  }
  for (const n of Object.values((ui == null ? void 0 : ui.windows) ?? {})) {
    ...
    d !== "Karakter" && d !== "Npc" || S.has(n.id) || (S.add(n.id), typeof n.render == "function" && n.render(!0));
  }
}
...
Hooks.on("updateCombat", (S, s, e) => {
  (s == null ? void 0 : s.round) != null && Ps(S), setTimeout(Es, 0);
});
...
Hooks.on("renderTokenHUD", (S, s, e) => {
  var d;
  const t = S == null ? void 0 : S.object, n = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var p, y, b, l;
  const t = ((p = S.flags) == null ? void 0 : p["vacuum-of-the-void"]) ?? {}, n = t.resultType, d = t.critLabel, r = t.weaponAttack, u = t.weapon;
  if (!n && !d && !r) return;
  ...
  if (m) {
    ...
    if (r && u && (u.actorId || (b = S.speaker) != null && b.actor)) {
      ...
      if (u.isHit && !m.querySelector(".votv-weapon-damage-chat")) {
        ...
        f.textContent = h != null && w ? `Sebzés (Találati Hely ${h} - ${w})` : "Sebzés", f.dataset.actorId = String(u.actorId ?? ((l = S.speaker) == null ? void 0 : l.actor) ?? ""), f.dataset.itemId = String(u.itemId ?? ""), f.dataset.slotKey = String(u.slotKey ?? ""), f.dataset.targetName = String(u.targetName ?? ""), f.dataset.hitLocationName = String(u.hitLocationName ?? ""), f.dataset.messageId = String(S.id ?? ""), o.appendChild(f);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-LWCBwc6f.mjs.map
