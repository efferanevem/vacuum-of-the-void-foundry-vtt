...
var rs = Reflect.get;
var ns = (w, s, e) => s in w ? ss(w, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : w[s] = e;
var W = (w, s, e) => ns(w, typeof s != "symbol" ? s + "" : s, e);
var j = (w, s, e) => rs(is(w), e, s);
...
const { BooleanField: ls, NumberField: Ss, StringField: ve } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const D = ((it = d[g]) == null ? void 0 : it.value) ?? 0, C = n[g] ?? 0;
    ...
    e.armorTable = Se.map((g) => {
      ...
      return {
        ...
        level: hs((D.level ?? "").toString().trim()),
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BMueCCds.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BMueCCds.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-BMueCCds.mjs");
      p(this.actor, o, a);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const _ = ((Fe = t == null ? void 0 : t.system) == null ? void 0 : Fe.abilities) ?? {}, F = r.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, R;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BMueCCds.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BMueCCds.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const f = l && l.name || r.name || "Fegyver", m = Number(r.bonus || 0) || 0, y = ((E = l == null ? void 0 : l.system) == null ? void 0 : E.type) || "kinetic", b = (((_ = l == null ? void 0 : l.system) == null ? void 0 : _.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, p = new Roll(a);
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, a, p, h, v, I, T, q, A, E, _, F;
    ...
    if (d.type === "MikroChip" && m) {
      const P = ((F = (_ = n.system) == null ? void 0 : _.gear) == null ? void 0 : F.microchips) ?? {}, H = ["slot1", "slot2", "slot3"].find((z) => {
        var G;
...
Hooks.on("combatRound", (w, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || ws(w);
});
function es() {
  var s, e, t;
...
//# sourceMappingURL=vacuum-of-the-void-CGYR2vwo.mjs.map
