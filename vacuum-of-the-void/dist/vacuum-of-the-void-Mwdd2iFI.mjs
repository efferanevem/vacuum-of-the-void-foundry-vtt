...
const { HTMLField: Nt, NumberField: P, SchemaField: x, StringField: I, BooleanField: J, ArrayField: Me } = foundry.data.fields;
...
const { NumberField: He, SchemaField: xt } = foundry.data.fields;
class jt extends $t {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      attributes: new xt({
        body: new He({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        mind: new He({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        soul: new He({ required: !0, integer: !0, min: 3, max: 18, initial: 10 })
      })
    };
  }
}
...
const { BooleanField: Kt, StringField: Ke } = foundry.data.fields;
class Ut extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new Ke({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new Ke({ required: !1, blank: !0, initial: "" }),
      /** Szint (a táblázatban: Szint). */
      level: new Ke({ required: !1, blank: !0, initial: "" }),
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const a = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((o = (c = a.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((l = a.currentHealth) == null ? void 0 : l.legs) ?? 0, u = U._healthStatusFromRatio(n, d), g = Number(((k = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(s) {
    var le, oe, ye, ge, $e, xe, je, Re, Oe, Se, Ve, et, tt, st, it, rt, nt, at;
    ...
    for (const p of u) {
      const D = ((ge = d[p]) == null ? void 0 : ge.value) ?? 0, T = n[p] ?? 0;
    ...
    const l = (Number(((Re = (je = this.actor.system) == null ? void 0 : je.combat) == null ? void 0 : Re.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const b = this.actor.system.weapons ?? {}, k = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (b.slotOrder ?? "").trim(), q = S ? S.split(/\s*,\s*/).filter((p) => k.includes(p)) : [], C = (Oe = this.actor.system.gear) == null ? void 0 : Oe.microchips, _ = C && typeof C == "object" && !Array.isArray(C) ? C : {}, w = (((Se = _.slot1) == null ? void 0 : Se.itemId) ?? "").trim(), L = (((Ve = _.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), F = (((et = _.slot3) == null ? void 0 : et.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
      ...
      for (let Te = 0; Te < q.length; Te++) {
        ...
        if ((((ce = b[Le]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          O = Te + 1, N = ((be = b[Le]) == null ? void 0 : be.bonus) ?? "", Y = Le;
          break;
        }
      }
      let W = null;
      T && (w === p.id ? W = "slot1" : L === p.id ? W = "slot2" : F === p.id && (W = "slot3"));
      const qe = D && ((ve = p.system) != null && ve.damage) ? p.system.damage : "", Z = D && typeof ((ue = p.system) == null ? void 0 : ue.range) == "string" ? (p.system.range || "").trim() : "", he = Y ? Number((de = b[Y]) == null ? void 0 : de.bonus) || 0 : "";
      return {
        id: p.id,
        name: p.name,
        img: p.img,
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), pe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), De = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], v = (p) => {
      var T, O, N;
      const D = [];
    ...
    e.microchipItemsSlot1 = pe.filter((p) => !v(1).includes(p.id)), e.microchipItemsSlot2 = pe.filter((p) => !v(2).includes(p.id)), e.microchipItemsSlot3 = pe.filter((p) => !v(3).includes(p.id)), e.microchipSlots = _e.map((p) => {
      const D = _[p] ?? {}, T = (D.itemId ?? "").trim(), O = we.find((N) => N.id === T);
      return {
        slotKey: p,
        itemId: T,
        displayName: (O == null ? void 0 : O.name) || D.name || De,
        img: (O == null ? void 0 : O.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((p) => {
      const D = `slot${p}`, T = _[D] ?? {}, O = (T.itemId ?? "").trim(), N = pe.find((Y) => Y.id === O);
      e[`microchip${p}ItemId`] = O, e[`microchip${p}DisplayName`] = (N == null ? void 0 : N.name) || T.name || De, e[`microchip${p}Img`] = (N == null ? void 0 : N.img) || "";
    }), e.microchipsTable = we.map((p) => {
      var ce, be, ve, ue;
      const D = p.id;
      let T = null;
      for (const de of _e)
        if ((((ce = _[de]) == null ? void 0 : ce.itemId) ?? "").trim() === D) {
          T = de;
          break;
        }
      const O = !!T, N = ((be = p == null ? void 0 : p.system) == null ? void 0 : be.abilityType) ?? "", Y = N === "active" ? "Aktív" : N === "passive" ? "Passzív" : N || "—", W = N === "active", qe = Number((ve = p == null ? void 0 : p.system) == null ? void 0 : ve.replaceCost) >= 0 ? Number(p.system.replaceCost) : 0, Z = (((ue = p == null ? void 0 : p.system) == null ? void 0 : ue.description) ?? "").trim(), he = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const A = this.actor.system.abilities ?? {}, E = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      ...
      const D = A[p] ?? {}, T = (D.itemId ?? "").trim(), O = T ? K.get(T) : null, N = (O == null ? void 0 : O.description) ?? "", Y = (O == null ? void 0 : O.kp) ?? 0;
      return {
        itemId: T,
        displayName: (O == null ? void 0 : O.name) || D.name || fe,
        img: (O == null ? void 0 : O.img) || "",
        description: N,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DT4K_u-w.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((y = r.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-DT4K_u-w.mjs");
      l(this.actor, c, o);
      ...
      if (!y) return;
      const b = ((C = (q = this.actor.items).get) == null ? void 0 : C.call(q, y)) ?? ((w = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : w.call(_, (F) => F.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = o.system.weapons ?? {}, k = (b.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = k ? k.split(/\s*,\s*/).filter((_) => S.includes(_)) : [], C = q.find((_) => {
          var w;
          return (((w = b[_]) == null ? void 0 : w.itemId) ?? "").trim() === c;
        });
        if (C) {
          const _ = q.filter((w) => w !== C);
          y["system.weapons.slotOrder"] = _.join(","), y[`system.weapons.${C}.itemId`] = "", y[`system.weapons.${C}.name`] = "", y[`system.weapons.${C}.damage`] = "", y[`system.weapons.${C}.bonus`] = "";
        }
      }
      ...
      const C = y ? this.actor.items.get(y) : null, _ = {
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const S = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, q = (S.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = q ? q.split(/\s*,\s*/).filter((L) => C.includes(L)) : [], w = _.filter((L) => {
              var F;
  ...
  async _rollWeapon(s) {
    ...
    const u = n && n.name || t.name || `Fegyver (${s})`, g = Number(t.bonus || 0) || 0, f = (((k = n == null ? void 0 : n.system) == null ? void 0 : k.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(a[f] || 0) || 0, i = g + h, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, o = new Roll(c);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Q, me, Pe, Ae, Fe, Ee, Ne, we, pe, De, _e;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Q = this.actor) == null ? void 0 : Q.system), e.showDeathSkull = !1;
    const t = this.actor, a = ((me = t == null ? void 0 : t.items) == null ? void 0 : me.contents) ?? [], d = ((Pe = t == null ? void 0 : t.system) == null ? void 0 : Pe.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((v) => n.includes(v)) : [], m = a.filter((v) => v.type === "Fegyver"), f = m.map((v) => ({ id: v.id, name: v.name, img: v.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : n, r = n.filter((v) => !i.includes(v)), c = [...i, ...r], o = c.filter((v) => {
      var E;
    ...
    e.weaponsTable = m.map((v) => {
      ...
      let E = null, K = {};
      for (const Se of c)
        if ((((Oe = d[Se]) == null ? void 0 : Oe.itemId) ?? "").trim() === A) {
          E = Se, K = d[Se] ?? {};
          break;
        }
      const fe = !!E, G = (v == null ? void 0 : v.system) ?? {}, Ie = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", le = (l[ae] ?? ae) || "—", oe = G.size ?? "", ye = (y[oe] ?? oe) || "", ge = [le, ye].filter(Boolean).join(", ") || le || "—", $e = ae === "projectile" || oe === "thrown", xe = G.quantity != null ? String(G.quantity).trim() : "1", je = String(G.bonus ?? K.bonus ?? "").trim() || "0", Re = (G.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: A,
        actorId: t.id,
    ...
    const b = a.filter((v) => v.type === "Pancel");
    ...
    const k = ((Fe = (Ae = t == null ? void 0 : t.system) == null ? void 0 : Ae.gear) == null ? void 0 : Fe.microchips) ?? {}, S = ["slot1", "slot2", "slot3"], q = a.filter((v) => v.type === "MikroChip");
    ...
    const C = a.filter((v) => v.type === "Targy");
    ...
    const _ = a.filter((v) => v.type === "Egyeb");
    e.egyebList = _.map((v) => {
    ...
    const L = ((_e = t == null ? void 0 : t.system) == null ? void 0 : _e.abilities) ?? {}, F = a.filter((v) => v.type === "Kepesseg" || v.type === "ability").map((v) => {
      var A, E;
      return {
        id: v.id,
        name: v.name,
    ...
    }), j = new Map(F.map((v) => [v.id, v])), H = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      !c && ((l = r == null ? void 0 : r.dataset) != null && l.slot) && (c = (((((b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.weapons) ?? {})[r.dataset.slot] ?? {}).itemId ?? "").trim()), !(!c || !this.actor) && await this._rollWeaponDamage(c, (((k = r == null ? void 0 : r.dataset) == null ? void 0 : k.slot) ?? "").trim());
    }), t.on("click", ".karakter-skill-label", async (i) => {
      var y, b;
      i.preventDefault();
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-DT4K_u-w.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
      ...
      const o = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, y = (Array.isArray((_ = o[r]) == null ? void 0 : _.items) ? o[r].items.slice() : []).filter((w) => w !== c);
  ...
  async _onDropItem(s, e) {
    var f, h, i, r, c, o, l, y, b, k, S, q, C, _, w;
    ...
    if (d.type === "Fegyver" && m) {
      ...
      await n.update({
        ...
        [`system.weapons.${B}.bonus`]: ((C = d.system) == null ? void 0 : C.bonus) ?? ""
      });
    }
...
z(se, "PARTS", foundry.utils.mergeObject(M(se, se, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((_t = M(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !0 })
}));
let Qe = se;
var Ot;
...
z(ie, "PARTS", foundry.utils.mergeObject(M(ie, ie, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ot = M(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ie;
var qt;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = jt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Mt, CONFIG.Item.dataModels.Pancel = Ut, CONFIG.Item.dataModels.MikroChip = Ht, CONFIG.Item.dataModels.Kepesseg = mt, CONFIG.Item.dataModels.ability = mt, CONFIG.Item.dataModels.Targy = zt, CONFIG.Item.dataModels.Egyeb = Wt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health", "resources.stress"],
    value: []
  }, (a = CONFIG.Actor).typeLabels ?? (a.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", (d = CONFIG.Item).typeLabels ?? (d.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", ze, {
    types: ["Karakter"],
    makeDefault: !0,
    label: "VOTV.KarakterSheet"
  }), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", Ge, {
    types: ["Npc"],
    makeDefault: !0,
    label: "VOTV.NpcSheet"
  ...
  Hooks.on("updateActor", (n, u, g, m) => {
    ...
    const y = (_ = game.votv) == null ? void 0 : _._lastKarakterSheetBlurSave, b = y && Date.now() - y.at < R ? y.appId : null;
    setTimeout(() => {
      for (const w of r)
...
Hooks.on("preCreateToken", (R, s, e) => {
  var n, u;
  const t = (n = game.votv) == null ? void 0 : n._dragSourceActorId, a = t ?? R.actorId ?? null;
...
Hooks.on("renderChatMessageHTML", (R, s, e) => {
  var u, g;
  const t = ((u = R.flags) == null ? void 0 : u["vacuum-of-the-void"]) ?? {}, a = t.resultType, d = t.critLabel;
  if (!a && !d) return;
...
//# sourceMappingURL=vacuum-of-the-void-Mwdd2iFI.mjs.map
