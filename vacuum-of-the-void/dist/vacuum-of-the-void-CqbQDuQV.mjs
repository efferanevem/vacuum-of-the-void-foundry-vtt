...
function Kt(S) {
  ...
  f(S.terms, 1);
  const c = s.filter((a) => a === 6).length, m = s.filter((a) => a === 1).length, d = e.filter((a) => a === 6).length, l = t.filter((a) => a === 6).length, p = c + d, g = m + l;
  return p > 0 && p === g ? { resultType: null, label: null } : p >= 3 ? { resultType: "critical", label: "Brutális Siker" } : p === 2 ? { resultType: "critical", label: "Kritikus Siker" } : g >= 3 ? { resultType: "fumble", label: "Brutális Sikertelenség" } : g === 2 ? { resultType: "fumble", label: "Kritikus Sikertelenség" } : { resultType: null, label: null };
}
function bi(S) {
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const l = this.element, p = this.form ?? this.element, g = m.scrollState, a = m.focus, i = typeof (g == null ? void 0 : g.formScrollTop) == "number" || typeof (g == null ? void 0 : g.windowScrollTop) == "number", o = () => {
      var u, h;
      if (this._applyScrollState(l, g), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const y = ((u = p.querySelector) == null ? void 0 : u.call(p, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (h = p.querySelector) == null ? void 0 : h.call(p, `[name="${CSS.escape(a.name)}"]`) : null);
  ...
  static getTotalSpeedRaw(s) {
    var p, g, a, i, o, r, u, h, y;
    if (!(s != null && s.system)) return 0;
    const e = s.system.resources ?? {}, t = ((g = (p = e.hitLocations) == null ? void 0 : p.legs) == null ? void 0 : g.value) ?? 0, n = ((a = e.currentHealth) == null ? void 0 : a.legs) ?? 0, f = ee._healthStatusFromRatio(n, t);
    if (f === 0) return 0;
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((u = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : u.resources) ?? {}, f = ((y = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : y.value) ?? 0, c = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, m = ee._healthStatusFromRatio(c, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let l;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var l, p, g, a, i, o, r, u, h, y, v, k, w;
    const e = s ?? this.form ?? this.element;
    let t = (l = e == null ? void 0 : e.querySelector) == null ? void 0 : l.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((a = (g = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : g.combat) == null ? void 0 : a.givenProtection) ?? 0) || 0, f = (r = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && r.call(o, "lookaround") ? 1 : 0, c = (y = (h = (u = this.actor) == null ? void 0 : u.statuses) == null ? void 0 : h.has) != null && y.call(h, "halfcover") ? 3 : 0, m = (w = (k = (v = this.actor) == null ? void 0 : v.statuses) == null ? void 0 : k.has) != null && w.call(k, "threequarteredcover") ? 6 : 0, d = n + this._getTotalArmorProtectionBonus() + f + c + m;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const d = ((v = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : v.resources) ?? {}, l = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, p = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
  ...
  async _prepareContext(s) {
    var lt, ut, dt, mt, pt, ft, yt, gt, ht, We, bt, vt, Je, I, E, P, G, ke, ne, Ce, Te, we, $e, Ye, Xe, qt, Nt, Lt, Ft, kt, at, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs, ls, us;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), z = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Ye = this.actor.system.gear) == null ? void 0 : Ye.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Xe = R.slot1) == null ? void 0 : Xe.itemId) ?? "").trim(), Z = (((qt = R.slot2) == null ? void 0 : qt.itemId) ?? "").trim(), J = (((Nt = R.slot3) == null ? void 0 : Nt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      ...
      for (let rt = 0; rt < z.length; rt++) {
        ...
        if ((((xe = O[It]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          A = rt + 1, U = ((Ze = O[It]) == null ? void 0 : Ze.bonus) ?? "", de = It;
          break;
        }
      }
      let re = null;
    ...
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, A = (N.itemId ?? "").trim(), U = ce.find((De) => De.id === A), de = W.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Qe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: L + 1,
    ...
    const st = this.actor.system.abilities ?? {}, Dt = (((ss = this.actor.items) == null ? void 0 : ss.contents) ?? []).map((b) => {
      ...
      const L = st[b] ?? {}, N = (L.itemId ?? "").trim(), A = N ? Pe.get(N) : null, U = (A == null ? void 0 : A.description) ?? "", de = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: N,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-DhxnwNV-.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-DhxnwNV-.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-DhxnwNV-.mjs");
      h(this.actor, r, u);
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const p of s.elements) {
      ...
      let g;
      p.type === "checkbox" ? g = p.checked : p.type === "number" ? g = p.value === "" ? 0 : Number(p.value) : g = p.value ?? "", foundry.utils.setProperty(e, p.name, g);
    }
    ...
    for (const p of c) {
      const g = ((l = n[p]) == null ? void 0 : l.value) ?? 0, a = f[p] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${p}`, ee._healthStatusFromRatio(a, g));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, n, f, c, m, d, l, p, g, a, i, o, r, u;
    if (e) {
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const f = this.actor.items.contents.slice().sort((g, a) => {
      ...
      return i - o;
    }).map((g) => g.id), c = f.indexOf(t), m = f.indexOf(e);
    if (c === -1 || m === -1) return;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((p = e.system) == null ? void 0 : p.kind) ?? "passive", n = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const c = this.actor.system.abilities ?? {}, m = Array.isArray((g = c[e]) == null ? void 0 : g.items) ? c[e].items.slice() : Array.isArray(c[e]) ? c[e].slice() : [];
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let c = f.id;
    ((p = f.parent) == null ? void 0 : p.id) !== this.actor.id && (c = ((g = (await this.actor.createEmbeddedDocuments("Item", [f.toObject()]))[0]) == null ? void 0 : g.id) ?? c), await this.actor.update({
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: p, label: g } = Kt(l), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return l.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
      flags: { "vacuum-of-the-void": { resultType: p, critLabel: g } },
      rollMode: a
    });
  }
  async _rollMorale() {
  ...
  async _rollWeapon(s) {
    ...
    const m = c && c.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, l = ((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic", p = (((w = c == null ? void 0 : c.system) == null ? void 0 : w.skillKey) ?? "").trim(), g = p && n[p] !== void 0 ? p : l === "explosive" ? "grenadeUse" : "firearms", a = Number(n[g] || 0) || 0, i = d + a, r = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, u = new Roll(r);
    await u.evaluate({ async: !0 });
    const { resultType: h, label: y } = Kt(u), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${m} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    var d, l, p, g, a, i, o, r, u, h;
    const t = this.actor;
    if (!t) return;
    let n = ((l = (d = t.items).get) == null ? void 0 : l.call(d, s)) ?? ((g = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : g.call(p, (y) => y.id === s));
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = await super.render(s, e), m = this.element, d = this.form ?? this.element, l = f.scrollState, p = f.focus, g = typeof (l == null ? void 0 : l.formScrollTop) == "number" || typeof (l == null ? void 0 : l.windowScrollTop) == "number", a = () => {
      var i, o;
    ...
    return (g || p) && (requestAnimationFrame(a), setTimeout(a, 0), setTimeout(a, 50), setTimeout(a, 150), setTimeout(a, 300), setTimeout(a, 450)), c;
  }
  async _prepareContext(s) {
    ...
    const l = (($t = t == null ? void 0 : t.items) == null ? void 0 : $t.contents) ?? [], p = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (p.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((I) => g.includes(I)) : [], o = l.filter((I) => I.type === "Fegyver"), r = o.map((I) => ({ id: I.id, name: I.name, img: I.img })), u = "— Nincs fegyver —", h = i.length > 0 ? i : g, y = g.filter((I) => !h.includes(I)), v = [...h, ...y], k = v.filter((I) => {
      var P;
    ...
    const D = ((ft = e.system) == null ? void 0 : ft.resources) ?? {}, x = (gt = (yt = e.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.initiativeResult, V = typeof x == "number" ? x : -1, Q = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (ht = e.system) == null ? void 0 : ht.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : Q).slice().sort((I, E) => I.min - E.min), ge = 3;
    ...
    const He = ie.length > 0 ? ie[ie.length - 1] : null, st = Math.min(10, He ? He.kp : 6), Pe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, st)).map((I, E) => {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DhxnwNV-.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DhxnwNV-.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-DhxnwNV-.mjs");
      u(this.actor, o, r);
    ...
    (g = (p = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : p.call(e, f)) == null || g.forEach((a) => {
      var i;
  ...
  async _rollWeapon(s) {
    ...
    let m = null;
    n.itemId && (m = c.find((j) => j.id === n.itemId) ?? null);
    const d = m && m.name || n.name || "Fegyver", l = Number(n.bonus || 0) || 0, p = ((O = m == null ? void 0 : m.system) == null ? void 0 : O.type) || "kinetic", g = (((q = m == null ? void 0 : m.system) == null ? void 0 : q.skillKey) ?? "").trim(), a = g && f[g] !== void 0 ? g : p === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, o = l + i, u = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, h = new Roll(u);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((l = (d = t.items).get) == null ? void 0 : l.call(d, s)) ?? ((g = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : g.call(p, (y) => y.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((u = (r = game.i18n) == null ? void 0 : r.localize) == null ? void 0 : u.call(r, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var p, g, a, i, o, r, u, h, y, v, k, w, T, _, O, q, j, z, B;
  ...
  async _postAbilityToChat(s) {
    var p, g, a, i, o, r;
    const e = (g = (p = this.actor) == null ? void 0 : p.items) == null ? void 0 : g.get(s);
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, f = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, c = "— Nincs fegyver —", m = (((j = this.actor.items) == null ? void 0 : j.contents) ?? []).filter((D) => D.type === "Fegyver");
    ...
    const p = (((R = this.actor.items) == null ? void 0 : R.contents) ?? []).filter((D) => D.type === "Targy");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      if (!p) return;
      const g = this.actor.items.get(p);
      ...
      var p, g, a, i;
      d.preventDefault();
      const l = (g = (p = d.currentTarget) == null ? void 0 : p.dataset) == null ? void 0 : g.itemId;
      ...
      var g;
      d.preventDefault(), d.stopPropagation();
      const l = d.currentTarget, p = (((g = l == null ? void 0 : l.dataset) == null ? void 0 : g.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      g && (g.setData("text/plain", p), g.effectAllowed = "move", typeof g.setDragImage == "function" && g.setDragImage(l, 0, 0));
      ...
      if (!p && g && (p = g.getData("text/plain")), n._draggingUnitId = null, !p || !l || p === l) return;
      ...
      d.preventDefault();
      const l = (r = (o = (i = (a = d.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : o.dataset) == null ? void 0 : r.abilityRef, p = (v = (y = (h = (u = d.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : h.call(u, ".jarmu-unit-ability-pill")) == null ? void 0 : y.dataset) == null ? void 0 : v.abilityId;
      let g = null;
      if (l)
        try {
          g = await fromUuid(l);
      ...
      !g && p && (g = ((k = game.items) == null ? void 0 : k.get(p)) ?? null), (w = g == null ? void 0 : g.sheet) == null || w.render(!0);
    }), t.on("click", ".jarmu-unit-ability-chat", async (d) => {
      var i, o, r, u;
      d.preventDefault();
      const l = (o = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, ".jarmu-unit-ability-pill"), p = (r = l == null ? void 0 : l.dataset) == null ? void 0 : r.abilityRef, g = (u = l == null ? void 0 : l.dataset) == null ? void 0 : u.abilityId, a = p || g;
    ...
    const f = (d) => {
      ...
      var l, p, g;
      return d && (((p = (l = this.element) == null ? void 0 : l.contains) == null ? void 0 : p.call(l, d)) || this.id && ((g = d.closest) == null ? void 0 : g.call(d, `#${CSS.escape(this.id)}`)));
    };
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${m}
      ${d}
...
const tt = class tt extends Et {
  activateListeners(s) {
    if (super.activateListeners(s), !s) return;
    const e = s.querySelector('select[name="system.identity.assignment"]'), t = s.querySelector('input[name="system.combat.threat"]');
    if (e && t) {
      const n = {
      ...
      e.addEventListener("change", (f) => {
        var d;
        const c = ((d = f.currentTarget) == null ? void 0 : d.value) ?? "", m = n[c] ?? 0;
        t.value = m;
      });
    }
  }
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, c = n.combat ?? {}, m = f.assignment ?? "", p = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }[m] ?? 0;
...
te(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  K(tt, tt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Es = K(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Ut = tt;
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (c) => {
      var l, p, g, a, i, o, r;
      if (!e.isEditable || !((p = (l = c.target) == null ? void 0 : l.closest) != null && p.call(l, ".profile")) && ((a = (g = c.target) == null ? void 0 : g.getAttribute) == null ? void 0 : a.call(g, "data-edit")) !== "img") return;
...
te(Ee, "PARTS", foundry.utils.mergeObject(K(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((js = K(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Jt = Ee;
var Ks, zs;
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const m = (await Promise.all(
      ...
      var i, o;
      const p = (((i = d.system) == null ? void 0 : i.kind) ?? "passive").toString(), g = Number(((o = d.system) == null ? void 0 : o.kp) ?? 0) || 0, a = p === "species";
      return {
        id: d.id,
        ref: l,
        name: d.name,
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, y, v, k, w, T, _, O, q, j, z, B, R, Y, Z, J, X, M, W, ce, ve, D, x;
    ...
    }).map((Q) => Q.actor).find((Q) => Q && (Q.id === m || Q.id === c.actorId))) ?? null), !d) return;
    ...
    if (p || (p = (((J = l == null ? void 0 : l.system) == null ? void 0 : J.damage) ?? "").trim()), !p && c.slotKey && (p = (((((X = d.system) == null ? void 0 : X.weapons) ?? {})[c.slotKey] ?? {}).damage ?? "").trim()), !p) {
    ...
    for (const m of e) {
      ...
      if (d <= 0 && !l) {
        const p = ((c = (f = CONFIG.statusEffects) == null ? void 0 : f.find((g) => g.id === "immobilized")) == null ? void 0 : c.img) ?? "";
...
Hooks.on("preCreateToken", (S, s, e) => {
  ...
  if (f) {
    ...
    if (f.type === "Npc") {
      const p = Hs((l = (d = f.system) == null ? void 0 : d.identity) == null ? void 0 : l.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var g, a, i, o;
  const t = ((g = S.flags) == null ? void 0 : g["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, c = t.weaponAttack, m = t.weapon, d = t.vsDefense, l = t.vsDefenseInfo;
  if (!n && !f && !c && !d) return;
  ...
  if (p) {
    if (n && p.classList.add(`votv-${n}`), f) {
      ...
      if (r)
        ...
        const u = p.querySelector(".dice-total"), h = (u == null ? void 0 : u.parentElement) ?? p, y = document.createElement("div");
    ...
    if (!c && d && l) {
      const r = p.querySelector(".dice-total"), u = (r == null ? void 0 : r.parentElement) ?? p, h = !!l.isHit, y = l.targetName || "Célpont", v = l.hitLocationRoll, k = l.hitLocationName;
      let w = p.querySelector(".votv-defense-outcome");
      w || (w = document.createElement("div"), w.className = "votv-defense-outcome", u.appendChild(w)), w.textContent = h ? `Találat – ${y}` : `Nem talált – ${y}`;
...
//# sourceMappingURL=vacuum-of-the-void-CqbQDuQV.mjs.map
