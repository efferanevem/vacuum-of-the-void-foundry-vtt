...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((l = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : l.resources) ?? {}, a = ((c = (r = s.hitLocations) == null ? void 0 : r.legs) == null ? void 0 : c.value) ?? 0, n = ((m = s.currentHealth) == null ? void 0 : m.legs) ?? 0, u = E._healthStatusFromRatio(n, a), p = Number(((I = (b = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : b.combat) == null ? void 0 : I.givenSpeed) ?? 0) || 0;
    let y;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-kmKuOtlP.mjs");
      c(this.actor, r);
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      o.preventDefault();
      const l = o.currentTarget, r = l.dataset.skill, c = ((f = l.textContent) == null ? void 0 : f.trim()) || r, { openRollSheetForSkill: m } = await import("./roll-sheet-kmKuOtlP.mjs");
      m(this.actor, r, c);
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (C) => {
      ...
      const i = (u = (n = C.target) == null ? void 0 : n.closest) == null ? void 0 : u.call(n, "[data-document-id]"), e = (p = i == null ? void 0 : i.getAttribute) == null ? void 0 : p.call(i, "data-document-id");
      if (!e) return;
...
//# sourceMappingURL=vacuum-of-the-void-DYCaeQfG.mjs.map
