...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(r = !1, e = {}) {
    ...
    if (a) {
      ...
      const m = document.activeElement, h = n.contains(m), w = m && (m.tagName === "INPUT" && m.type !== "checkbox" && m.type !== "radio" || m.tagName === "TEXTAREA");
      h && w && (u.focus = {
        name: m.name || null,
        id: m.id || null,
    ...
    const b = this.element, k = this.form ?? this.element, v = u.scrollState, i = u.focus, o = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      ...
      if (this._applyScrollState(b, v), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const w = ((m = k.querySelector) == null ? void 0 : m.call(k, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (h = k.querySelector) == null ? void 0 : h.call(k, `[name="${CSS.escape(i.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(r = null) {
    ...
    const s = ((i = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : i.resources) ?? {}, a = ((c = (o = s.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = s.currentHealth) == null ? void 0 : l.legs) ?? 0, u = C._healthStatusFromRatio(n, a), p = Number(((w = (h = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : h.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
  ...
  _getSkillHealthStatus(r) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, s = ((p = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : p.value) ?? 0, a = ((b = t.currentHealth) == null ? void 0 : b[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(r, e) {
    ...
    if (t == null) return;
    const s = ((u = r == null ? void 0 : r.system) == null ? void 0 : u.resources) ?? {}, a = ((b = (p = s.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : b.value) ?? 0, n = ((k = s.currentHealth) == null ? void 0 : k[t]) ?? 0;
    return C._healthStatusFromRatio(n, a);
  }
  async _prepareContext(r) {
    var qe, Te, De, Oe, _e, Le, Ae, Fe, $e, Ee, Ne, Ce, xe, je, Pe, Me, Ke;
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], h = (l.slotOrder ?? "").trim(), w = h ? h.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], y = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = y && typeof y == "object" && !Array.isArray(y) ? y : {}, E = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = ((($e = I.slot2) == null ? void 0 : $e.itemId) ?? "").trim(), O = (((Ee = I.slot3) == null ? void 0 : Ee.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
      ...
      const V = T && ((oe = d.system) != null && oe.damage) ? d.system.damage : "", Q = T && typeof ((re = d.system) == null ? void 0 : re.range) == "string" ? (d.system.range || "").trim() : "", Y = j ? Number((se = l[j]) == null ? void 0 : se.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
  ...
  _attachFrameListeners(r) {
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(r), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, l = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-CEu93Tpa.mjs");
      m(this.actor, c, l);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const w = l.system.weapons ?? {}, y = (w.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], E = y ? y.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], q = E.find((O) => {
          var g;
          return (((g = w[O]) == null ? void 0 : g.itemId) ?? "").trim() === c;
        });
        if (q) {
      ...
      const m = this.actor.system.weapons ?? {}, h = (m.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], y = h ? h.split(/\s*,\s*/).filter((g) => w.includes(g)) : [], I = y.find((g) => {
        var A;
      ...
      if (!m) return;
      const h = (o.dataset.itemId ?? "").trim(), w = (o.dataset.itemName ?? ((g = o.textContent) == null ? void 0 : g.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", y = (o.dataset.itemImg ?? "").trim(), I = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = w);
      ...
      if (!o || !c) return;
      const l = this.actor.system.abilities ?? {}, h = (Array.isArray((w = l[o]) == null ? void 0 : w.items) ? l[o].items.slice() : []).filter((y) => y !== c);
    ...
    }), t.on("blur", ".karakter-weapon-quantity-input", (i) => {
      this._resizeWeaponQuantityInput(i.currentTarget);
      ...
      const h = this.form ?? this.element;
      h && setTimeout(() => {
        const w = h.querySelector(`.karakter-weapon-quantity-input[data-item-id="${c}"]`);
      ...
      if (o === "armor") {
        ...
        const w = Array.isArray((h = (m = this.actor.system) == null ? void 0 : m.gear) == null ? void 0 : h.generalItems) ? [...this.actor.system.gear.generalItems] : [];
    ...
    const u = this, p = (i) => {
      ...
      const c = ((m = (l = o.system) == null ? void 0 : l.resources) == null ? void 0 : m.currentHealth) != null || ((w = (h = o.system) == null ? void 0 : h.resources) == null ? void 0 : w.hitLocations) != null;
    ...
    if (e) {
      ...
      if (w) {
        ...
        if (y && y.documentName === "Item" && y.type === "ability") {
          ...
          const E = (((v = y.system) == null ? void 0 : v.kind) ?? "passive").toString(), q = this.actor.system.abilities ?? {};
          if (s) {
  ...
  async _postAbilityToChat(r) {
    ...
    const t = ((k = e.system) == null ? void 0 : k.kind) ?? "passive", s = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, a = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", p = a ? `<p>${a}</p>` : "", b = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(r, e) {
    ...
    if (!s || s.type !== "ability") return;
    let a = s.id;
    ((b = s.parent) == null ? void 0 : b.id) !== this.actor.id && (a = ((k = (await this.actor.createEmbeddedDocuments("Item", [s.toObject()]))[0]) == null ? void 0 : k.id) ?? a);
  ...
  async _rollWeapon(r) {
    ...
    const u = n && n.name || t.name || `Fegyver (${r})`, p = Number(t.bonus || 0) || 0, k = (((w = n == null ? void 0 : n.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(s[k] || 0) || 0, i = p + v, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, l = new Roll(c);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, p, b) => {
    ...
    if (!k) return;
    const v = document.activeElement, i = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), o = [], c = (y = game.actors) == null ? void 0 : y.get(k);
    c != null && c.apps && o.push(...Array.from(c.apps));
    const l = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const g of l)
      ((I = g.document) == null ? void 0 : I.id) !== k || ((E = g.document) == null ? void 0 : E.documentName) !== "Actor" || ((q = g.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || o.includes(g) || o.push(g);
    if (i && o.some((g) => {
      const A = (g == null ? void 0 : g.form) ?? (g == null ? void 0 : g.element);
      return A && A.contains(v);
    })) return;
    const h = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, w = h && Date.now() - h.at < N ? h.appId : null;
    setTimeout(() => {
      for (const g of o)
        !(g != null && g.rendered) || typeof g.render != "function" || g.id !== w && g.render(!0);
    }, 0);
  });
});
Hooks.on("ready", () => {
...
//# sourceMappingURL=vacuum-of-the-void-D5wliU6y.mjs.map
