...
const { HTMLField: Ni, NumberField: L, SchemaField: j, StringField: T, BooleanField: ee, ArrayField: ut } = foundry.data.fields;
...
const { BooleanField: Fi, NumberField: Vi, StringField: Oe } = foundry.data.fields;
...
const { BooleanField: Ei, StringField: _t } = foundry.data.fields;
class $i extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new _t({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new _t({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new _t({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new _t({ required: !1, blank: !0, initial: "" })
    };
  }
}
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Je, Qe, Xe, Ze, et, tt, it, st, nt, Pe, at, k, F, E, z, le, Y, je, ke, Te, ve, Ae, Fe, wt, It, St, Tt, rt, ze, Mt, Kt, jt, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt;
    let e = await super._prepareContext(i);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((Xe = (Qe = (Je = this.actor.system) == null ? void 0 : Je.resources) == null ? void 0 : Qe.stress) == null ? void 0 : Xe.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const g of l) {
      const O = ((Ze = d[g]) == null ? void 0 : Ze.value) ?? 0, D = r[g] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((tt = (et = this.actor.system) == null ? void 0 : et.combat) == null ? void 0 : tt.givenSpeed) ?? 0) || 0;
    let s;
    b === 0 ? s = 0 : b === 1 ? s = -6 : b === 2 ? s = -3 : s = u;
    const c = this._getTotalArmorSpeedPenalty();
    s += c, e.effectiveGivenSpeed = s;
    const o = Number(((st = (it = this.actor.system) == null ? void 0 : it.combat) == null ? void 0 : st.givenProtection) ?? 0) || 0, a = (at = (Pe = (nt = this.actor) == null ? void 0 : nt.statuses) == null ? void 0 : Pe.has) != null && at.call(Pe, "lookaround") ? 1 : 0, f = (E = (F = (k = this.actor) == null ? void 0 : k.statuses) == null ? void 0 : F.has) != null && E.call(F, "halfcover") ? 3 : 0, h = o + this._getTotalArmorProtectionBonus() + a + f;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: s, givenProtection: h } },
      { inplace: !1 }
    );
    const v = ((z = e.system) == null ? void 0 : z.combat) ?? {};
    ...
    b === 0 && (S = 0), (je = (Y = (le = this.actor) == null ? void 0 : le.statuses) == null ? void 0 : Y.has) != null && je.call(Y, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Te = (ke = e.system) == null ? void 0 : ke.combat) == null ? void 0 : Te.givenProtection } },
      { inplace: !1 }
    ), S = 0), e.totalSpeed = S;
    ...
    const _ = this.actor.system.weapons ?? {}, N = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (_.slotOrder ?? "").trim(), x = q ? q.split(/\s*,\s*/).filter((g) => N.includes(g)) : [], A = (ve = this.actor.system.gear) == null ? void 0 : ve.microchips, K = A && typeof A == "object" && !Array.isArray(A) ? A : {}, V = (((Ae = K.slot1) == null ? void 0 : Ae.itemId) ?? "").trim(), H = (((Fe = K.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), G = (((wt = K.slot3) == null ? void 0 : wt.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const D = typeof g.sort == "number" ? g.sort : 0, P = typeof O.sort == "number" ? O.sort : 0;
      return D - P;
    }).map((g) => {
      var we, $e, xe, _e, De, ct;
      const O = g.type === "Fegyver", D = g.type === "MikroChip";
      let P = 0, M = "", Z = null;
      for (let He = 0; He < x.length; He++) {
        const lt = x[He];
        if ((((we = _[lt]) == null ? void 0 : we.itemId) ?? "") === g.id) {
          P = He + 1, M = (($e = _[lt]) == null ? void 0 : $e.bonus) ?? "", Z = lt;
          break;
        }
      }
      let X = null;
      D && (V === g.id ? X = "slot1" : H === g.id ? X = "slot2" : G === g.id && (X = "slot3"));
      const ot = O && ((xe = g.system) != null && xe.damage) ? g.system.damage : "", ue = O && typeof ((_e = g.system) == null ? void 0 : _e.range) == "string" ? (g.system.range || "").trim() : "", Ee = Z ? Number((De = _[Z]) == null ? void 0 : De.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        ...
        rangeStr: ue,
        slotBonusNum: Ee,
        quantity: Number(((ct = g.system) == null ? void 0 : ct.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = W;
    const R = (((It = this.actor.items) == null ? void 0 : It.contents) ?? []).filter((g) => g.type === "Fegyver"), Q = R.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = Q;
    ...
    const se = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, oe = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = R.map((g) => {
      ...
      const M = !!D, Z = ((Zt = g.system) == null ? void 0 : Zt.equipped) !== void 0 && ((ei = g.system) == null ? void 0 : ei.equipped) !== null ? !!g.system.equipped : M, X = (g == null ? void 0 : g.system) ?? {}, ot = typeof X.range == "string" ? (X.range || "").trim() : "", ue = X.type ?? "", Ee = (se[ue] ?? ue) || "—", we = X.size ?? "", $e = (oe[we] ?? we) || "", xe = [Ee, $e].filter(Boolean).join(", ") || Ee || "—", _e = ue === "projectile" || we === "thrown", De = X.quantity, ct = De != null ? String(De).trim() : "1", He = String(P.bonus ?? "").trim(), lt = String(X.bonus ?? "").trim(), Di = He || lt || "0";
      return {
        slotKey: D ?? "",
        itemId: O,
    ...
    const he = (((rt = this.actor.items) == null ? void 0 : rt.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const mt = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((g) => g.type === "MikroChip"), ne = mt.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ue = "— Nincs Mikro-Chip —", be = ["slot1", "slot2", "slot3"], Re = (g) => {
      var D, P, M;
      const O = [];
    ...
    e.microchipItemsSlot1 = ne.filter((g) => !Re(1).includes(g.id)), e.microchipItemsSlot2 = ne.filter((g) => !Re(2).includes(g.id)), e.microchipItemsSlot3 = ne.filter((g) => !Re(3).includes(g.id)), e.microchipSlots = be.map((g) => {
      const O = K[g] ?? {}, D = (O.itemId ?? "").trim(), P = mt.find((M) => M.id === D);
      return {
        slotKey: g,
        itemId: D,
        displayName: (P == null ? void 0 : P.name) || O.name || Ue,
        img: (P == null ? void 0 : P.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, D = K[O] ?? {}, P = (D.itemId ?? "").trim(), M = ne.find((Z) => Z.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (M == null ? void 0 : M.name) || D.name || Ue, e[`microchip${g}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = mt.map((g) => {
      var we, $e, xe, _e;
      const O = g.id;
      let D = null;
      for (const De of be)
      ...
      const P = !!D, M = (($e = g == null ? void 0 : g.system) == null ? void 0 : $e.abilityType) ?? "", Z = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", ot = Number((xe = g == null ? void 0 : g.system) == null ? void 0 : xe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ue = (((_e = g == null ? void 0 : g.system) == null ? void 0 : _e.description) ?? "").trim(), Ee = ue ? ue.length > 60 ? ue.slice(0, 57) + "…" : ue : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const pt = (((Mt = e.weaponsTable) == null ? void 0 : Mt.length) ?? 0) > 0 || (((Kt = e.armorTable) == null ? void 0 : Kt.length) ?? 0) > 0 || (((jt = e.microchipsTable) == null ? void 0 : jt.length) ?? 0) > 0 || (((zt = e.itemsTable) == null ? void 0 : zt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !pt;
    const ft = this.actor.system.abilities ?? {}, Rt = (((Ht = this.actor.items) == null ? void 0 : Ht.contents) ?? []).map((g) => {
      var O, D, P;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Me = new Map(Rt.map((g) => [g.id, g])), yt = "— Nincs képesség —", Be = (g) => {
      const O = ft[g] ?? {}, D = (O.itemId ?? "").trim(), P = D ? Me.get(D) : null, M = (P == null ? void 0 : P.description) ?? "", Z = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: D,
        displayName: (P == null ? void 0 : P.name) || O.name || yt,
        img: (P == null ? void 0 : P.img) || "",
        description: M,
        kp: Z
      };
    ...
    e.abilityPassiveList = Ve(Ge("passive")), e.abilityActiveList = Ve(Ge("active"));
    const gt = ((Ut = e.system) == null ? void 0 : Ut.resources) ?? {}, Ke = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], qe = (Gt = (Bt = e.system) == null ? void 0 : Bt.combat) == null ? void 0 : Gt.initiativeResult, ce = typeof qe == "number" ? qe : -1, ht = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], We = (Wt = (Vt = e.system) == null ? void 0 : Vt.combat) == null ? void 0 : Wt.initiativeRanges, Le = Array.isArray(We) ? We.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Se = (Le.length > 0 ? Le : ht).slice().sort((g, O) => g.min - O.min), Ne = Le.map((g) => g.min), bt = Ne.length ? Math.min(...Ne) : 0, kt = Ne.length ? Math.max(...Ne) : 0;
    e.initiativeRanges = Le.map((g) => ({ ...g, isFirst: g.min === bt, isLast: g.min === kt }));
    let Ye = 0;
    if (typeof ce == "number" && ce >= 0 && Se.length > 0) {
      const g = Se[0], O = Se[Se.length - 1];
      let D = null;
      ce <= g.max ? D = g : ce >= O.min ? D = O : D = Se.find((P) => ce >= P.min && ce <= P.max), D && (Ye = D.kp);
    }
    e.kpDots = Ke.map((g, O) => {
      const D = O + 1, P = !!Number(gt[g]), M = D <= Ye;
      return { index: D, used: P, usable: M };
    });
    const vt = !!((Jt = (Yt = game.combat) == null ? void 0 : Yt.combatants) != null && Jt.some((g) => {
      var O;
      return ((O = g.actor) == null ? void 0 : O.type) === "Karakter";
    }));
    return e.showHarcSection = vt, e.canEditInitiative = !!((Qt = game.user) != null && Qt.isGM), e.showInitiativeResult = typeof qe == "number", e.initiativeResult = e.showInitiativeResult ? qe : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CPU1GuqQ.mjs");
      a(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-CPU1GuqQ.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-CPU1GuqQ.mjs");
      f(this.actor, o, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Be, Ge, Ve, gt, Ke, qe, ce, ht, We, Le, Dt, Se, Ne, bt, kt, Ye, vt, Je, Qe, Xe, Ze, et, tt, it, st, nt, Pe, at;
    const e = await super._prepareContext(i) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Be = this.actor) == null ? void 0 : Be.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ve = (Ge = e.system) == null ? void 0 : Ge.identity) == null ? void 0 : Ve.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((gt = e.system) == null ? void 0 : gt.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (qe = (Ke = t == null ? void 0 : t.statuses) == null ? void 0 : Ke.has) != null && qe.call(Ke, "lookaround") ? 1 : 0, l = (ht = (ce = t == null ? void 0 : t.statuses) == null ? void 0 : ce.has) != null && ht.call(ce, "halfcover") ? 3 : 0;
    e.effectiveGivenProtection = d + r + l;
    const m = ((We = t == null ? void 0 : t.items) == null ? void 0 : We.contents) ?? [], p = ((Le = t == null ? void 0 : t.system) == null ? void 0 : Le.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], b = (p.slotOrder ?? "").trim(), u = b ? b.split(/\s*,\s*/).filter((k) => y.includes(k)) : [], s = m.filter((k) => k.type === "Fegyver"), c = s.map((k) => ({ id: k.id, name: k.name, img: k.img })), o = "— Nincs fegyver —", a = u.length > 0 ? u : y, f = y.filter((k) => !a.includes(k)), h = [...a, ...f], v = h.filter((k) => {
      var E;
      const F = (((E = p[k]) == null ? void 0 : E.itemId) ?? "").trim();
      return F && s.some((z) => z.id === F);
    });
    ...
    e.weaponsTable = s.map((k) => {
      var rt;
      const F = k.id;
      let E = null, z = {};
      for (const ze of h)
        if ((((rt = p[ze]) == null ? void 0 : rt.itemId) ?? "").trim() === F) {
          E = ze, z = p[ze] ?? {};
          break;
        }
      const le = !!E, Y = (k == null ? void 0 : k.system) ?? {}, je = typeof Y.range == "string" ? (Y.range || "").trim() : "", ke = Y.type ?? "", Te = (I[ke] ?? ke) || "—", ve = Y.size ?? "", Ae = (S[ve] ?? ve) || "", Fe = [Te, Ae].filter(Boolean).join(", ") || Te || "—", wt = ke === "projectile" || ve === "thrown", It = Y.quantity != null ? String(Y.quantity).trim() : "1", St = String(Y.bonus ?? z.bonus ?? "").trim() || "0", Tt = (Y.damage ?? z.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const _ = ((Se = (Dt = t == null ? void 0 : t.system) == null ? void 0 : Dt.gear) == null ? void 0 : Se.microchips) ?? {}, N = ["slot1", "slot2", "slot3"], q = m.filter((k) => k.type === "MikroChip");
    e.microchipsTable = q.map((k) => {
      var ke, Te, ve, Ae;
      const F = k.id;
      let E = null;
      for (const Fe of N)
        if ((((ke = _[Fe]) == null ? void 0 : ke.itemId) ?? "").trim() === F) {
          E = Fe;
          break;
        }
      const z = ((Te = k == null ? void 0 : k.system) == null ? void 0 : Te.abilityType) ?? "", le = z === "active" ? "Aktív" : z === "passive" ? "Passzív" : z || "—", Y = (((ve = k == null ? void 0 : k.system) == null ? void 0 : ve.description) ?? "").trim(), je = Y ? Y.length > 60 ? Y.slice(0, 57) + "…" : Y : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const K = (((Ne = e.weaponsTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((bt = e.armorTable) == null ? void 0 : bt.length) ?? 0) > 0 || (((kt = e.microchipsTable) == null ? void 0 : kt.length) ?? 0) > 0 || (((Ye = e.itemsTable) == null ? void 0 : Ye.length) ?? 0) > 0 || (((vt = e.egyebList) == null ? void 0 : vt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !K;
    const V = ((Je = t == null ? void 0 : t.system) == null ? void 0 : Je.abilities) ?? {}, H = m.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, E;
      return {
        id: k.id,
        name: k.name,
    ...
    }), G = new Map(H.map((k) => [k.id, k])), ie = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    e.abilityFajiSlot = ie, e.abilityHatterSlot = ie;
    const W = (k) => {
      const F = V[k];
    ...
    const Q = t == null ? void 0 : t.id, ae = !!((Xe = (Qe = game.combat) == null ? void 0 : Qe.combatants) != null && Xe.some(
      (k) => {
        var F;
    ...
    const Ie = ((Ze = e.system) == null ? void 0 : Ze.resources) ?? {}, se = (tt = (et = e.system) == null ? void 0 : et.combat) == null ? void 0 : tt.initiativeResult, oe = typeof se == "number" ? se : -1, Ce = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], re = (st = (it = e.system) == null ? void 0 : it.combat) == null ? void 0 : st.initiativeRanges, he = Array.isArray(re) ? re.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ne = (he.length > 0 ? he : Ce).slice().sort((k, F) => k.min - F.min), Ue = 3;
    let be = he.length > 0 ? he : [];
    be.length < Ue && (be = [...be, ...Array(Ue - be.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = be.map((k, F) => ({
      ...k,
      isFirst: F === 0,
    ...
    if (typeof oe == "number" && oe >= 0 && ne.length > 0) {
      ...
      let E = null;
      oe <= k.max ? E = k : oe >= F.min ? E = F : E = ne.find((z) => oe >= z.min && oe <= z.max), E && (Re = E.kp);
    }
    const pt = ne.length > 0 ? ne[ne.length - 1] : null, ft = Math.min(10, pt ? pt.kp : 6), Me = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, ft)).map((k, F) => {
      const E = F + 1, z = !!Number(Ie[k]), le = E <= Re;
      return { index: E, used: z, usable: le };
    }), yt = Math.ceil(Me.length / 2);
    return e.kpDotsRow1 = Me.slice(0, yt), e.kpDotsRow2 = Me.slice(yt), e.canEditInitiative = !!((nt = game.user) != null && nt.isGM), e.showInitiativeResult = typeof se == "number", e.initiativeResult = e.showInitiativeResult ? se : "", e.speedUnitForSelect = ((at = (Pe = e.system) == null ? void 0 : Pe.combat) == null ? void 0 : at.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(i) {
    var p, y, b;
    super._attachFrameListeners(i);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CPU1GuqQ.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-CPU1GuqQ.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CPU1GuqQ.mjs");
      a(this.actor, c, o);
  ...
  async _onDropItem(i, e) {
    ...
    if (d.type === "Fegyver" && p) {
      ...
      const ie = H.includes(G) ? H : [...H, G].filter((W) => K.includes(W));
      await r.update({
...
J(te, "PARTS", foundry.utils.mergeObject(
  ...
  U(te, te, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((di = U(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : di.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((mi = U(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : mi.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((fi = (pi = U(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : pi.window) == null ? void 0 : fi.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const c = dt.getTotalSpeedRaw(s), o = (f = s.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (c <= 0 && !o) {
  ...
  const i = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, C, _, N, q, x, A, K, V, H, G, ie, W;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      ...
      if (ae) {
        ...
        for (const se of Ie)
          if (((q = se.actor) == null ? void 0 : q.id) === u || se.actorId === u) {
            ae.updateEmbeddedDocuments("Combatant", [{ _id: se.id, initiative: Q }]).catch(() => {
            });
            break;
          }
      }
    ...
    for (const R of f)
      ((H = R.document) == null ? void 0 : H.id) !== u || ((G = R.document) == null ? void 0 : G.documentName) !== "Actor" || ((ie = R.constructor) == null ? void 0 : ie.name) !== "VoidKarakterSheet" || o.includes(R) || o.push(R);
    if (c && o.some((R) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, C, _, N, q, x, A, K, V, H, G, ie, W, R, Q, ae, Ie, se, oe;
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, s = r.targetName || "", c = r.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (r.slotKey ? ((oe = (((se = m.system) == null ? void 0 : se.weapons) ?? {})[r.slotKey]) == null ? void 0 : oe.name) ?? "" : "")) || "Fegyver";
    ...
    for (const l of e) {
      const m = dt.getTotalSpeedRaw(l), p = (n = l.effects) == null ? void 0 : n.find((y) => y.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (m <= 0 && !p) {
...
//# sourceMappingURL=vacuum-of-the-void-SP04zivT.mjs.map
