...
var J = (w, i, e) => Li(w, typeof i != "symbol" ? i + "" : i, e);
var U = (w, i, e) => qi(Ci(w), e, i);
const { HTMLField: Ni, NumberField: L, SchemaField: j, StringField: T, BooleanField: te, ArrayField: lt } = foundry.data.fields;
...
const { NumberField: Dt, SchemaField: Pi } = foundry.data.fields;
class Ai extends wi {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      attributes: new Pi({
        body: new Dt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        mind: new Dt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 }),
        soul: new Dt({ required: !0, integer: !0, min: 3, max: 18, initial: 10 })
      })
    };
  }
}
const { BooleanField: Fi, NumberField: Vi, StringField: De } = foundry.data.fields;
...
const { BooleanField: Ei, StringField: wt } = foundry.data.fields;
class $i extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new wt({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new wt({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new wt({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new wt({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: Ot, StringField: ii } = foundry.data.fields;
class xi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      cost: new Ot({ required: !1, integer: !0, min: 0, initial: 1250 }),
      replaceCost: new Ot({ required: !1, integer: !0, min: 0, initial: 3 }),
      quantity: new Ot({ required: !1, integer: !0, min: 0, initial: 1 })
    };
  }
}
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Qe, Xe, Ze, et, tt, it, st, nt, k, F, E, z, ce, Y, Me, ke, le, ve, Ne, Pe, ht, bt, kt, vt, at, Ke, $t, xt, Rt, Mt, Kt, jt, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((it = (tt = this.actor.system) == null ? void 0 : tt.combat) == null ? void 0 : it.givenSpeed) ?? 0) || 0;
    let s;
    b === 0 ? s = 0 : b === 1 ? s = -6 : b === 2 ? s = -3 : s = u;
    const c = this._getTotalArmorSpeedPenalty();
    s += c, e.effectiveGivenSpeed = s;
    const o = Number(((nt = (st = this.actor.system) == null ? void 0 : st.combat) == null ? void 0 : nt.givenProtection) ?? 0) || 0, a = (E = (F = (k = this.actor) == null ? void 0 : k.statuses) == null ? void 0 : F.has) != null && E.call(F, "lookaround") ? 1 : 0, f = o + this._getTotalArmorProtectionBonus() + a;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: s, givenProtection: f } },
      { inplace: !1 }
    );
    const h = ((z = e.system) == null ? void 0 : z.combat) ?? {}, v = (Me = (Y = (ce = this.actor) == null ? void 0 : ce.statuses) == null ? void 0 : Y.has) != null && Me.call(Y, "halfcover") ? 3 : 0;
    ...
    b === 0 && (S = 0), (ve = (le = (ke = this.actor) == null ? void 0 : ke.statuses) == null ? void 0 : le.has) != null && ve.call(le, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Pe = (Ne = e.system) == null ? void 0 : Ne.combat) == null ? void 0 : Pe.givenProtection } },
      { inplace: !1 }
    ), S = 0), e.totalSpeed = S;
    ...
    const _ = this.actor.system.weapons ?? {}, N = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (_.slotOrder ?? "").trim(), x = q ? q.split(/\s*,\s*/).filter((g) => N.includes(g)) : [], A = (ht = this.actor.system.gear) == null ? void 0 : ht.microchips, K = A && typeof A == "object" && !Array.isArray(A) ? A : {}, V = (((bt = K.slot1) == null ? void 0 : bt.itemId) ?? "").trim(), H = (((kt = K.slot2) == null ? void 0 : kt.itemId) ?? "").trim(), G = (((vt = K.slot3) == null ? void 0 : vt.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const D = typeof g.sort == "number" ? g.sort : 0, P = typeof O.sort == "number" ? O.sort : 0;
      return D - P;
    }).map((g) => {
      var we, Fe, Ee, Te, _e, ot;
      const O = g.type === "Fegyver", D = g.type === "MikroChip";
      let P = 0, M = "", ee = null;
      for (let je = 0; je < x.length; je++) {
        const ct = x[je];
        if ((((we = _[ct]) == null ? void 0 : we.itemId) ?? "") === g.id) {
          P = je + 1, M = ((Fe = _[ct]) == null ? void 0 : Fe.bonus) ?? "", ee = ct;
          break;
        }
      }
      let X = null;
      D && (V === g.id ? X = "slot1" : H === g.id ? X = "slot2" : G === g.id && (X = "slot3"));
      const rt = O && ((Ee = g.system) != null && Ee.damage) ? g.system.damage : "", ue = O && typeof ((Te = g.system) == null ? void 0 : Te.range) == "string" ? (g.system.range || "").trim() : "", Ae = ee ? Number((_e = _[ee]) == null ? void 0 : _e.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        ...
        rangeStr: ue,
        slotBonusNum: Ae,
        quantity: Number(((ot = g.system) == null ? void 0 : ot.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = W;
    const R = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).filter((g) => g.type === "Fegyver"), Q = R.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = Q;
    ...
    const Z = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, $e = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = R.map((g) => {
      var Xt, Zt, ei;
      const O = g.id;
      let D = null, P = {};
      for (const _t of x)
        if ((((Xt = _[_t]) == null ? void 0 : Xt.itemId) ?? "").trim() === O) {
          D = _t, P = _[_t] ?? {};
          break;
        }
      const M = !!D, ee = ((Zt = g.system) == null ? void 0 : Zt.equipped) !== void 0 && ((ei = g.system) == null ? void 0 : ei.equipped) !== null ? !!g.system.equipped : M, X = (g == null ? void 0 : g.system) ?? {}, rt = typeof X.range == "string" ? (X.range || "").trim() : "", ue = X.type ?? "", Ae = (Z[ue] ?? ue) || "—", we = X.size ?? "", Fe = ($e[we] ?? we) || "", Ee = [Ae, Fe].filter(Boolean).join(", ") || Ae || "—", Te = ue === "projectile" || we === "thrown", _e = X.quantity, ot = _e != null ? String(_e).trim() : "1", je = String(P.bonus ?? "").trim(), ct = String(X.bonus ?? "").trim(), Di = je || ct || "0";
      return {
        slotKey: D ?? "",
        itemId: O,
        ...
        typeAndSize: Ee,
        quantity: ot,
        quantityDisplay: Te ? ot : "—",
        isProjectile: Te,
        equipped: ee,
        special: (X.special ?? "").trim() || "—"
      };
    });
    const Ie = (((Ke = this.actor.items) == null ? void 0 : Ke.contents) ?? []).filter((g) => g.type === "Pancel");
    ...
    const ie = ((($t = this.actor.items) == null ? void 0 : $t.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const ze = (((xt = this.actor.items) == null ? void 0 : xt.contents) ?? []).filter((g) => g.type === "Egyeb");
    e.egyebList = ze.map((g) => {
    ...
    const re = (((Rt = this.actor.items) == null ? void 0 : Rt.contents) ?? []).filter((g) => g.type === "MikroChip"), Oe = re.map((g) => ({ id: g.id, name: g.name, img: g.img })), he = "— Nincs Mikro-Chip —", He = ["slot1", "slot2", "slot3"], xe = (g) => {
      var D, P, M;
      const O = [];
    ...
    e.microchipItemsSlot1 = Oe.filter((g) => !xe(1).includes(g.id)), e.microchipItemsSlot2 = Oe.filter((g) => !xe(2).includes(g.id)), e.microchipItemsSlot3 = Oe.filter((g) => !xe(3).includes(g.id)), e.microchipSlots = He.map((g) => {
      const O = K[g] ?? {}, D = (O.itemId ?? "").trim(), P = re.find((M) => M.id === D);
      return {
        slotKey: g,
        itemId: D,
        displayName: (P == null ? void 0 : P.name) || O.name || he,
        img: (P == null ? void 0 : P.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, D = K[O] ?? {}, P = (D.itemId ?? "").trim(), M = Oe.find((ee) => ee.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (M == null ? void 0 : M.name) || D.name || he, e[`microchip${g}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = re.map((g) => {
      var we, Fe, Ee, Te;
      const O = g.id;
      let D = null;
      for (const _e of He)
        if ((((we = K[_e]) == null ? void 0 : we.itemId) ?? "").trim() === O) {
          D = _e;
          break;
        }
      const P = !!D, M = ((Fe = g == null ? void 0 : g.system) == null ? void 0 : Fe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", rt = Number((Ee = g == null ? void 0 : g.system) == null ? void 0 : Ee.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ue = (((Te = g == null ? void 0 : g.system) == null ? void 0 : Te.description) ?? "").trim(), Ae = ue ? ue.length > 60 ? ue.slice(0, 57) + "…" : ue : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const It = (((Mt = e.weaponsTable) == null ? void 0 : Mt.length) ?? 0) > 0 || (((Kt = e.armorTable) == null ? void 0 : Kt.length) ?? 0) > 0 || (((jt = e.microchipsTable) == null ? void 0 : jt.length) ?? 0) > 0 || (((zt = e.itemsTable) == null ? void 0 : zt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !It;
    const St = this.actor.system.abilities ?? {}, Ue = (((Ht = this.actor.items) == null ? void 0 : Ht.contents) ?? []).map((g) => {
      var O, D, P;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Be = new Map(Ue.map((g) => [g.id, g])), dt = "— Nincs képesség —", Ge = (g) => {
      const O = St[g] ?? {}, D = (O.itemId ?? "").trim(), P = D ? Be.get(D) : null, M = (P == null ? void 0 : P.description) ?? "", ee = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: D,
        displayName: (P == null ? void 0 : P.name) || O.name || dt,
        img: (P == null ? void 0 : P.img) || "",
        description: M,
        kp: ee
      };
    };
    e.abilityFajiSlot = Ge("faji"), e.abilityHatterSlot = Ge("hatter");
    const Ve = (g) => {
      const O = St[g];
    ...
    e.abilityPassiveList = We(Ve("passive")), e.abilityActiveList = We(Ve("active"));
    const Re = ((Ut = e.system) == null ? void 0 : Ut.resources) ?? {}, mt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ce = (Gt = (Bt = e.system) == null ? void 0 : Bt.combat) == null ? void 0 : Gt.initiativeResult, be = typeof Ce == "number" ? Ce : -1, pt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ye = (Wt = (Vt = e.system) == null ? void 0 : Vt.combat) == null ? void 0 : Wt.initiativeRanges, qe = Array.isArray(Ye) ? Ye.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Se = (qe.length > 0 ? qe : pt).slice().sort((g, O) => g.min - O.min), Le = qe.map((g) => g.min), ft = Le.length ? Math.min(...Le) : 0, yt = Le.length ? Math.max(...Le) : 0;
    e.initiativeRanges = qe.map((g) => ({ ...g, isFirst: g.min === ft, isLast: g.min === yt }));
    let Je = 0;
    if (typeof be == "number" && be >= 0 && Se.length > 0) {
      const g = Se[0], O = Se[Se.length - 1];
      let D = null;
      be <= g.max ? D = g : be >= O.min ? D = O : D = Se.find((P) => be >= P.min && be <= P.max), D && (Je = D.kp);
    }
    e.kpDots = mt.map((g, O) => {
      const D = O + 1, P = !!Number(Re[g]), M = D <= Je;
      return { index: D, used: P, usable: M };
    });
    const gt = !!((Jt = (Yt = game.combat) == null ? void 0 : Yt.combatants) != null && Jt.some((g) => {
      var O;
      return ((O = g.actor) == null ? void 0 : O.type) === "Karakter";
    }));
    return e.showHarcSection = gt, e.canEditInitiative = !!((Qt = game.user) != null && Qt.isGM), e.showInitiativeResult = typeof Ce == "number", e.initiativeResult = e.showInitiativeResult ? Ce : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-h-1t69fs.mjs");
      a(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-h-1t69fs.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-h-1t69fs.mjs");
      f(this.actor, o, a);
  ...
  async _rollSkill(i, e) {
    ...
    const { resultType: y, label: b } = Ct(p), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    ...
    const { resultType: f, label: h } = Ct(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var dt, Ge, Ve, We, Re, mt, Ce, be, pt, Ye, qe, Tt, Se, Le, ft, yt, Je, gt, Qe, Xe, Ze, et, tt, it, st, nt;
    const e = await super._prepareContext(i) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((dt = this.actor) == null ? void 0 : dt.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ve = (Ge = e.system) == null ? void 0 : Ge.identity) == null ? void 0 : Ve.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((We = e.system) == null ? void 0 : We.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (mt = (Re = t == null ? void 0 : t.statuses) == null ? void 0 : Re.has) != null && mt.call(Re, "lookaround") ? 1 : 0;
    e.effectiveGivenProtection = d + r;
    const l = ((Ce = t == null ? void 0 : t.items) == null ? void 0 : Ce.contents) ?? [], m = ((be = t == null ? void 0 : t.system) == null ? void 0 : be.weapons) ?? {}, p = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], y = (m.slotOrder ?? "").trim(), b = y ? y.split(/\s*,\s*/).filter((k) => p.includes(k)) : [], u = l.filter((k) => k.type === "Fegyver"), s = u.map((k) => ({ id: k.id, name: k.name, img: k.img })), c = "— Nincs fegyver —", o = b.length > 0 ? b : p, a = p.filter((k) => !o.includes(k)), f = [...o, ...a], h = f.filter((k) => {
      var E;
    ...
    e.weaponsTable = u.map((k) => {
      ...
      let E = null, z = {};
      for (const Ke of f)
        if ((((at = m[Ke]) == null ? void 0 : at.itemId) ?? "").trim() === F) {
          E = Ke, z = m[Ke] ?? {};
          break;
        }
      const ce = !!E, Y = (k == null ? void 0 : k.system) ?? {}, Me = typeof Y.range == "string" ? (Y.range || "").trim() : "", ke = Y.type ?? "", le = (v[ke] ?? ke) || "—", ve = Y.size ?? "", Ne = (I[ve] ?? ve) || "", Pe = [le, Ne].filter(Boolean).join(", ") || le || "—", ht = ke === "projectile" || ve === "thrown", bt = Y.quantity != null ? String(Y.quantity).trim() : "1", kt = String(Y.bonus ?? z.bonus ?? "").trim() || "0", vt = (Y.damage ?? z.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const C = ((Ye = (pt = t == null ? void 0 : t.system) == null ? void 0 : pt.gear) == null ? void 0 : Ye.microchips) ?? {}, _ = ["slot1", "slot2", "slot3"], N = l.filter((k) => k.type === "MikroChip");
    e.microchipsTable = N.map((k) => {
      var ke, le, ve, Ne;
      const F = k.id;
      let E = null;
      for (const Pe of _)
        if ((((ke = C[Pe]) == null ? void 0 : ke.itemId) ?? "").trim() === F) {
          E = Pe;
          break;
        }
      const z = ((le = k == null ? void 0 : k.system) == null ? void 0 : le.abilityType) ?? "", ce = z === "active" ? "Aktív" : z === "passive" ? "Passzív" : z || "—", Y = (((ve = k == null ? void 0 : k.system) == null ? void 0 : ve.description) ?? "").trim(), Me = Y ? Y.length > 60 ? Y.slice(0, 57) + "…" : Y : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const A = (((qe = e.weaponsTable) == null ? void 0 : qe.length) ?? 0) > 0 || (((Tt = e.armorTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((Se = e.microchipsTable) == null ? void 0 : Se.length) ?? 0) > 0 || (((Le = e.itemsTable) == null ? void 0 : Le.length) ?? 0) > 0 || (((ft = e.egyebList) == null ? void 0 : ft.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const K = ((yt = t == null ? void 0 : t.system) == null ? void 0 : yt.abilities) ?? {}, V = l.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, E;
      return {
        id: k.id,
        name: k.name,
    ...
    const R = t == null ? void 0 : t.id, Q = !!((gt = (Je = game.combat) == null ? void 0 : Je.combatants) != null && gt.some(
      (k) => {
        var F;
    ...
    e.showHarcSection = Q;
    const ae = ((Qe = e.system) == null ? void 0 : Qe.resources) ?? {}, oe = (Ze = (Xe = e.system) == null ? void 0 : Xe.combat) == null ? void 0 : Ze.initiativeResult, Z = typeof oe == "number" ? oe : -1, $e = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ie = (tt = (et = e.system) == null ? void 0 : et.combat) == null ? void 0 : tt.initiativeRanges, ie = Array.isArray(Ie) ? Ie.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (ie.length > 0 ? ie : $e).slice().sort((k, F) => k.min - F.min), Oe = 3;
    let he = ie.length > 0 ? ie : [];
    he.length < Oe && (he = [...he, ...Array(Oe - he.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = he.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === he.length - 1
    }));
    let He = 0;
    if (typeof Z == "number" && Z >= 0 && re.length > 0) {
      const k = re[0], F = re[re.length - 1];
      let E = null;
      Z <= k.max ? E = k : Z >= F.min ? E = F : E = re.find((z) => Z >= z.min && Z <= z.max), E && (He = E.kp);
    }
    const xe = re.length > 0 ? re[re.length - 1] : null, It = Math.min(10, xe ? xe.kp : 6), Ue = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, It)).map((k, F) => {
      const E = F + 1, z = !!Number(ae[k]), ce = E <= He;
      return { index: E, used: z, usable: ce };
    }), Be = Math.ceil(Ue.length / 2);
    return e.kpDotsRow1 = Ue.slice(0, Be), e.kpDotsRow2 = Ue.slice(Be), e.canEditInitiative = !!((it = game.user) != null && it.isGM), e.showInitiativeResult = typeof oe == "number", e.initiativeResult = e.showInitiativeResult ? oe : "", e.speedUnitForSelect = ((nt = (st = e.system) == null ? void 0 : st.combat) == null ? void 0 : nt.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(i) {
    var p, y, b;
    super._attachFrameListeners(i);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-h-1t69fs.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-h-1t69fs.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-h-1t69fs.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(i) {
    ...
    const { resultType: h, label: v } = Ct(f), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return f.toMessage({
...
J(de, "PARTS", foundry.utils.mergeObject(U(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((yi = U(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : yi.form) ?? {}, { submitOnChange: !1 })
}));
let Lt = de;
var gi;
...
J(me, "PARTS", foundry.utils.mergeObject(U(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((gi = U(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : gi.form) ?? {}, { submitOnChange: !1 })
}));
let Nt = me;
var hi;
...
J(pe, "PARTS", foundry.utils.mergeObject(U(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((hi = U(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : hi.form) ?? {}, { submitOnChange: !1 })
}));
let Pt = pe;
var bi;
...
J(fe, "PARTS", foundry.utils.mergeObject(U(fe, fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((bi = U(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : bi.form) ?? {}, { submitOnChange: !0 })
}));
let At = fe;
var ki;
...
J(ye, "PARTS", foundry.utils.mergeObject(U(ye, ye, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ki = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : ki.form) ?? {}, { submitOnChange: !1 })
}));
let Ft = ye;
var vi;
...
J(ge, "PARTS", foundry.utils.mergeObject(U(ge, ge, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((vi = U(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : vi.form) ?? {}, { submitOnChange: !1 })
}));
let Et = ge;
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
  ...
  ], foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", ut, {
    types: ["Karakter"],
    makeDefault: !0,
    label: "VOTV.KarakterSheet"
  }), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", qt, {
    types: ["Npc"],
    makeDefault: !0,
    label: "VOTV.NpcSheet"
    ...
    setTimeout(() => {
      ...
      const c = ut.getTotalSpeedRaw(s), o = (f = s.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (c <= 0 && !o) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, C, _, N, q, x, A, K, V, H, G, ne, W, R, Q, ae, oe, Z, $e;
    ...
    if (m || (m = ((x = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : x.flatMap((ie) => {
      var ze;
      return ((ze = ie.tokens) == null ? void 0 : ze.contents) ?? [];
    ...
    for (const l of e) {
      const m = ut.getTotalSpeedRaw(l), p = (n = l.effects) == null ? void 0 : n.find((y) => y.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (m <= 0 && !p) {
...
//# sourceMappingURL=vacuum-of-the-void-BMY0s9gO.mjs.map
