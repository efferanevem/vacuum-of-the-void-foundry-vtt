...
const { HTMLField: Nt, NumberField: P, SchemaField: R, StringField: w, BooleanField: Q, ArrayField: He } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const y of u) {
      const O = ((ce = d[y]) == null ? void 0 : ce.value) ?? 0, _ = c[y] ?? 0;
      e.computedHealthStatus[y] = B._healthStatusFromRatio(_, O);
    }
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), D = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], C = (je = this.actor.system.gear) == null ? void 0 : je.microchips, q = C && typeof C == "object" && !Array.isArray(C) ? C : {}, T = (((Ke = q.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Le = q.slot2) == null ? void 0 : Le.itemId) ?? "").trim(), A = (((_e = q.slot3) == null ? void 0 : _e.itemId) ?? "").trim(), K = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, O) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, L = typeof O.sort == "number" ? O.sort : 0;
      return _ - L;
    }).map((y) => {
      var le, be, ke, me, pe, Ee;
      const O = y.type === "Fegyver", _ = y.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let De = 0; De < D.length; De++) {
        const Ae = D[De];
        if ((((le = b[Ae]) == null ? void 0 : le.itemId) ?? "") === y.id) {
          L = De + 1, M = ((be = b[Ae]) == null ? void 0 : be.bonus) ?? "", J = Ae;
          break;
        }
      }
      let Y = null;
      _ && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : A === y.id && (Y = "slot3"));
      const Pe = O && ((ke = y.system) != null && ke.damage) ? y.system.damage : "", ee = O && typeof ((me = y.system) == null ? void 0 : me.range) == "string" ? (y.system.range || "").trim() : "", he = J ? Number((pe = b[J]) == null ? void 0 : pe.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", V = D.filter((y) => {
      const _ = ((b[y] ?? {}).itemId ?? "").trim();
      return _ ? !!H.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = V.map((y, O) => {
    ...
    e.armorTable = Ne.map((y) => {
      var L, M;
      const O = (y == null ? void 0 : y.system) ?? {}, _ = ((L = y.system) == null ? void 0 : L.equipped) !== void 0 && ((M = y.system) == null ? void 0 : M.equipped) !== null ? !!y.system.equipped : !1;
      return {
        itemId: y.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = $e.map((y) => {
      const O = (y == null ? void 0 : y.system) ?? {}, _ = (O.description ?? "").trim(), L = _ ? _.length > 60 ? _.slice(0, 57) + "…" : _ : "—", M = O.quantity != null ? String(O.quantity).trim() : "1";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Ie = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((y) => y.type === "MikroChip"), fe = Ie.map((y) => ({ id: y.id, name: y.name, img: y.img })), Oe = "— Nincs Mikro-Chip —", Ce = ["slot1", "slot2", "slot3"], Se = (y) => {
      var _, L, M;
      const O = [];
      return y !== 1 && O.push((((_ = q.slot1) == null ? void 0 : _.itemId) ?? "").trim()), y !== 2 && O.push((((L = q.slot2) == null ? void 0 : L.itemId) ?? "").trim()), y !== 3 && O.push((((M = q.slot3) == null ? void 0 : M.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((y) => !Se(1).includes(y.id)), e.microchipItemsSlot2 = fe.filter((y) => !Se(2).includes(y.id)), e.microchipItemsSlot3 = fe.filter((y) => !Se(3).includes(y.id)), e.microchipSlots = Ce.map((y) => {
      const O = q[y] ?? {}, _ = (O.itemId ?? "").trim(), L = Ie.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || O.name || Oe,
        img: (L == null ? void 0 : L.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const O = `slot${y}`, _ = q[O] ?? {}, L = (_.itemId ?? "").trim(), M = fe.find((J) => J.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Oe, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = Ie.map((y) => {
      var le, be, ke, me;
      const O = y.id;
      let _ = null;
      for (const pe of Ce)
        if ((((le = q[pe]) == null ? void 0 : le.itemId) ?? "").trim() === O) {
          _ = pe;
          break;
        }
    ...
    const qe = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      ...
      const O = qe[y] ?? {}, _ = (O.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!n) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CimxsOy_.mjs");
      a(this.actor, n);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, n = r.dataset.skill, a = ((p = r.textContent) == null ? void 0 : p.trim()) || n, { openRollSheetForSkill: l } = await import("./roll-sheet-CimxsOy_.mjs");
      l(this.actor, n, a);
      ...
      if (!p) return;
      const b = ((C = (D = this.actor.items).get) == null ? void 0 : C.call(D, p)) ?? ((T = (q = this.actor.items.contents) == null ? void 0 : q.find) == null ? void 0 : T.call(q, (A) => A.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = a.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = v ? v.split(/\s*,\s*/).filter((q) => I.includes(q)) : [], C = D.find((q) => {
          var T;
          return (((T = b[q]) == null ? void 0 : T.itemId) ?? "").trim() === n;
        });
        if (C) {
          const q = D.filter((T) => T !== C);
      ...
      I && (I.textContent = b);
      let D = n == null ? void 0 : n.querySelector(".karakter-microchip-slot-thumb");
      v ? (D || (D = document.createElement("img"), D.className = "karakter-microchip-slot-thumb", D.alt = "", a == null || a.insertBefore(D, I)), D.src = v, D.style.display = "") : D && D.remove(), n == null || n.classList.remove("karakter-microchip-slot-open");
      ...
      const a = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, p = ["slot1", "slot2", "slot3"].find((I) => {
        var D;
        return (((D = a[I]) == null ? void 0 : D.itemId) ?? "").trim() === r;
      });
    ...
    if (e) {
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && (l.type === "Kepesseg" || l.type === "ability")) {
          ...
          const I = b === "active" ? "active" : "passive", D = Array.isArray((u = v[I]) == null ? void 0 : u.items) ? v[I].items.slice() : Array.isArray(v[I]) ? v[I].slice() : [];
          D.includes(p) || D.push(p), await this.actor.update({ [`system.abilities.${I}.items`]: D });
          return;
        }
      }
    }
    if (e) {
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, D = (I.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = D ? D.split(/\s*,\s*/).filter((S) => C.includes(S)) : [], T = q.filter((S) => {
              var A;
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (d || (d = (c.damage ?? "").trim()), !d) {
      (I = (p = ui.notifications) == null ? void 0 : p.warn) == null || I.call(p, ((v = (b = game.i18n) == null ? void 0 : b.localize) == null ? void 0 : v.call(b, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const u = (c.bonus ?? ((D = o.system) == null ? void 0 : D.bonus) ?? "").toString().trim().replace(",", "."), f = Number(u) || 0;
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, V, we, Fe, Ne, $e, xe, Ie, fe, Oe, Ce, Se, qe;
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], D = o.filter((k) => k.type === "MikroChip");
    ...
    const T = (((Ie = e.weaponsTable) == null ? void 0 : Ie.length) ?? 0) > 0 || (((fe = e.armorTable) == null ? void 0 : fe.length) ?? 0) > 0 || (((Oe = e.microchipsTable) == null ? void 0 : Oe.length) ?? 0) > 0 || (((Ce = e.itemsTable) == null ? void 0 : Ce.length) ?? 0) > 0 || (((Se = e.egyebList) == null ? void 0 : Se.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!n || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CimxsOy_.mjs");
      l(this.actor, n, a);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var n, a;
      i.preventDefault();
      ...
      var b, v, I, D, C, q;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, n = (D = (I = i.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : D.itemId;
      ...
      if (!r || !this.actor) return;
      const n = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((D) => {
        var C;
        return (((C = n[D]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, n, a, l, p, b, v, I, D, C, q, T;
...
z(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Dt = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !0 })
}));
let Ze = re;
var Ot;
...
z(ne, "PARTS", foundry.utils.mergeObject(j(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ot = j(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.form) ?? {}, { submitOnChange: !1 })
}));
let Ve = ne;
var Ct;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, f, m, g) => {
    ...
    for (const S of l)
      ((D = S.document) == null ? void 0 : D.id) !== h || ((C = S.document) == null ? void 0 : C.documentName) !== "Actor" || ((q = S.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || n.includes(S) || n.push(S);
    if (r && n.some((S) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var b, v, I, D, C, q, T, S, A, N, K, H, Z, G, V;
    const t = (v = (b = e.target) == null ? void 0 : b.closest) == null ? void 0 : v.call(b, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    e.preventDefault(), e.stopPropagation();
    const o = (t.dataset.actorId ?? "").trim(), d = (t.dataset.itemId ?? "").trim(), c = (t.dataset.slotKey ?? "").trim(), u = (t.dataset.targetName ?? "").trim(), f = (t.dataset.hitLocationName ?? "").trim(), m = o ? (I = game.actors) == null ? void 0 : I.get(o) : null;
    if (!m) return;
    let g = d ? ((C = (D = m.items) == null ? void 0 : D.get) == null ? void 0 : C.call(D, d)) ?? ((S = (T = (q = m.items) == null ? void 0 : q.contents) == null ? void 0 : T.find) == null ? void 0 : S.call(T, (we) => we.id === d)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-DSMom08D.mjs.map
