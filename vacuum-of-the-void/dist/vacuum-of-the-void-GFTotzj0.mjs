...
const { HTMLField: Tt, NumberField: q, SchemaField: L, StringField: h, BooleanField: U, ArrayField: le } = foundry.data.fields;
...
const { BooleanField: _t, NumberField: jt, StringField: ie } = foundry.data.fields;
...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((i = s.querySelector) == null ? void 0 : i.call(s, "form.votv.karakter-sheet")) ?? ((r = s.querySelector) == null ? void 0 : r.call(s, "form.votv")) ?? null, t = ((a = s.querySelector) == null ? void 0 : a.call(s, ".votv-scroll")) ?? ((l = s.querySelector) == null ? void 0 : l.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    if (r) {
      l.scrollState = this._saveScrollState(r);
    ...
    const y = this.element, b = this.form ?? this.element, v = l.scrollState, n = l.focus, c = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", u = () => {
      var m, f;
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const a of s) {
      const l = String(((r = a.system) == null ? void 0 : r.speedPenalty) ?? "").trim().replace(",", "."), p = Number(l);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const a of s) {
      const l = String(((r = a.system) == null ? void 0 : r.protectionBonus) ?? "").trim().replace(",", "."), p = Number(l);
      Number.isFinite(p) && (e += p);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var v, n, c, u, d, m, f, g, S;
    const e = s ?? this.form ?? this.element;
    let t = (v = e == null ? void 0 : e.querySelector) == null ? void 0 : v.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const i = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, r = ((d = (u = i.hitLocations) == null ? void 0 : u.legs) == null ? void 0 : d.value) ?? 0, a = ((m = i.currentHealth) == null ? void 0 : m.legs) ?? 0, l = P._healthStatusFromRatio(a, r), p = Number(((S = (g = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : g.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let y;
  ...
  _writeEffectiveGivenProtection(s = null) {
    ...
    const r = (Number(((y = (p = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : p.combat) == null ? void 0 : y.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((a = this.actor.system) == null ? void 0 : a.resources) ?? {}, i = ((p = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : p.value) ?? 0, r = ((y = t.currentHealth) == null ? void 0 : y[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const i = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, r = ((y = (p = i.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : y.value) ?? 0, a = ((b = i.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const i = this.actor.system.resources ?? {}, r = i.hitLocations ?? {}, a = i.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    ...
    const g = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (g.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((o) => S.includes(o)) : [], A = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, D = A && typeof A == "object" && !Array.isArray(A) ? A : {}, w = (((Re = D.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), N = (((Ue = D.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = D.slot3) == null ? void 0 : He.itemId) ?? "").trim(), dt = this.actor.items.contents.filter((o) => o.type !== "Kepesseg" && o.type !== "ability").slice().sort((o, I) => {
      ...
      for (let se = 0; se < F.length; se++) {
        ...
        if ((((X = g[re]) == null ? void 0 : X.itemId) ?? "") === o.id) {
          T = se + 1, _ = ((ee = g[re]) == null ? void 0 : ee.bonus) ?? "", j = re;
          break;
        }
      }
      let R = null;
      k && (w === o.id ? R = "slot1" : N === o.id ? R = "slot2" : x === o.id && (R = "slot3"));
      const ae = I && ((te = o.system) != null && te.damage) ? o.system.damage : "", Q = I && typeof ((Z = o.system) == null ? void 0 : Z.range) == "string" ? (o.system.range || "").trim() : "", J = j ? Number((V = g[j]) == null ? void 0 : V.bonus) || 0 : "";
      return {
        id: o.id,
        name: o.name,
        img: o.img,
    ...
    e.weaponItems = Se;
    const Te = "— Nincs fegyver —", mt = F.filter((o) => {
    ...
    e.weaponsTable = ue.map((o) => {
      ...
      const _ = !!k, j = ((re = o.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = o.system) == null ? void 0 : Je.equipped) !== null ? !!o.system.equipped : _, R = (o == null ? void 0 : o.system) ?? {}, ae = typeof R.range == "string" ? (R.range || "").trim() : "", Q = R.type ?? "", J = (pt[Q] ?? Q) || "—", X = R.size ?? "", ee = (ft[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = R.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: k ?? "",
        itemId: I,
    ...
    e.microchipItemsSlot1 = oe.filter((o) => !me(1).includes(o.id)), e.microchipItemsSlot2 = oe.filter((o) => !me(2).includes(o.id)), e.microchipItemsSlot3 = oe.filter((o) => !me(3).includes(o.id)), e.microchipSlots = Oe.map((o) => {
      ...
      const T = !!k, _ = ((ee = o == null ? void 0 : o.system) == null ? void 0 : ee.abilityType) ?? "", j = _ === "active" ? "Aktív" : _ === "passive" ? "Passzív" : _ || "—", R = _ === "active", ae = Number((te = o == null ? void 0 : o.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(o.system.replaceCost) : 0, Q = (((Z = o == null ? void 0 : o.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (o == null ? void 0 : o.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-DI51njKs.mjs");
      d(this.actor, u);
    ...
    r && i({ currentTarget: r }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const c = n.currentTarget, u = c.dataset.skill, d = ((f = c.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-DI51njKs.mjs");
      m(this.actor, u, d);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const m = this.actor.system.weapons ?? {}, f = (m.slotOrder ?? "").trim(), g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = f ? f.split(/\s*,\s*/).filter((w) => g.includes(w)) : [], O = S.find((w) => {
        var N;
        return (((N = m[w]) == null ? void 0 : N.itemId) ?? "").trim() === u;
      }) ?? null;
      if (c.checked) {
        if (O) return;
        let w = S.find((x) => {
      ...
      if (!m) return;
      const f = (c.dataset.itemId ?? "").trim(), g = (c.dataset.itemName ?? ((w = c.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (c.dataset.itemImg ?? "").trim(), O = u == null ? void 0 : u.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = g);
      ...
      f ? D[`system.gear.microchips.${m}.active`] = !0 : D[`system.gear.microchips.${m}.active`] = !1, await this.actor.update(D);
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const r = this.actor.items.contents.slice().sort((v, n) => {
      const c = typeof v.sort == "number" ? v.sort : 0, u = typeof n.sort == "number" ? n.sort : 0;
      return c - u;
    }).map((v) => v.id), a = r.indexOf(t), l = r.indexOf(e);
    if (a === -1 || l === -1) return;
    r.splice(a, 1), r.splice(l, 0, t);
    const p = r.map((v, n) => ({
      _id: v,
      sort: (n + 1) * 10
    }));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", i = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, r = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = i > 0 ? `<p><strong>KP:</strong> ${i}</p>` : "", p = r ? `<p>${r}</p>` : "", y = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const a = this.actor.system.abilities ?? {}, l = Array.isArray((v = a[e]) == null ? void 0 : v.items) ? a[e].items.slice() : Array.isArray(a[e]) ? a[e].slice() : [];
    l.includes(r) || l.push(r), await this.actor.update({ [`system.abilities.${e}.items`]: l });
  }
  ...
  async _rollWeapon(s) {
    ...
    const l = a && a.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((g = a == null ? void 0 : a.system) == null ? void 0 : g.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(i[b] || 0) || 0, n = p + v, u = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, d = new Roll(u);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const e = this, t = (r) => {
      ...
      var a, l, p;
      return r && (((l = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : l.call(a, r)) || e.id && ((p = r.closest) == null ? void 0 : p.call(r, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (r) => {
      var l, p, y;
      const a = ((l = r.target) == null ? void 0 : l.form) ?? ((y = (p = r.target) == null ? void 0 : p.closest) == null ? void 0 : y.call(p, "form"));
      i(a) && t(a);
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (r) => {
      ...
      const l = (a == null ? void 0 : a.form) ?? ((p = a == null ? void 0 : a.closest) == null ? void 0 : p.call(a, "form"));
...
Hooks.once("init", () => {
  ...
  const C = 500;
  Hooks.on("updateActor", (a, l, p, y) => {
    var S, O, F, A, D;
    const b = a == null ? void 0 : a.id;
    if (!b) return;
    const v = document.activeElement, n = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), c = [], u = (S = game.actors) == null ? void 0 : S.get(b);
    u != null && u.apps && c.push(...Array.from(u.apps));
    const d = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const w of d)
      ((O = w.document) == null ? void 0 : O.id) !== b || ((F = w.document) == null ? void 0 : F.documentName) !== "Actor" || ((A = w.constructor) == null ? void 0 : A.name) !== "VoidKarakterSheet" || c.includes(w) || c.push(w);
    if (n && c.some((w) => {
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (C) => {
      ...
      const s = (l = (a = C.target) == null ? void 0 : a.closest) == null ? void 0 : l.call(a, "[data-document-id]"), e = (p = s == null ? void 0 : s.getAttribute) == null ? void 0 : p.call(s, "data-document-id");
      if (!e) return;
...
Hooks.on("preCreateToken", (C, s, e) => {
  ...
  const r = i ? (l = game.actors) == null ? void 0 : l.get(i) : null;
...
//# sourceMappingURL=vacuum-of-the-void-GFTotzj0.mjs.map
