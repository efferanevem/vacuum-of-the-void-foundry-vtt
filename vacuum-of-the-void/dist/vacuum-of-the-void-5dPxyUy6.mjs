...
var K = (_, s, e) => Yt(Wt(_), e, s);
const { HTMLField: Qt, NumberField: F, SchemaField: j, StringField: I, BooleanField: Z, ArrayField: He } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var _e, Me, Re, je, Ke, Ee, Le, st, it, rt, nt, at, ot, lt, ct, ut, dt, mt, pt, ft, yt, gt, ht, bt, kt;
    ...
    for (const g of c) {
      const D = ((je = d[g]) == null ? void 0 : je.value) ?? 0, O = r[g] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Ee = (Ke = this.actor.system) == null ? void 0 : Ke.combat) == null ? void 0 : Ee.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const l = this._getTotalArmorSpeedPenalty();
    i += l, e.effectiveGivenSpeed = i;
    const a = (Number(((st = (Le = this.actor.system) == null ? void 0 : Le.combat) == null ? void 0 : st.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const f = ((it = e.system) == null ? void 0 : it.combat) ?? {};
    ...
    e.actionsTable = G;
    const te = (((lt = this.actor.items) == null ? void 0 : lt.contents) ?? []).filter((g) => g.type === "Fegyver"), Y = te.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = Y;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DcxGnVXQ.mjs");
      a(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, a = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DcxGnVXQ.mjs");
      f(this.actor, o, a);
...
W(B, "PARTS", foundry.utils.mergeObject(
  ...
  K(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ct = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((qt = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : qt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Pt = (Lt = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Lt.window) == null ? void 0 : Pt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const Te = !!M, J = (k == null ? void 0 : k.system) ?? {}, Ae = typeof J.range == "string" ? (J.range || "").trim() : "", me = J.type ?? "", ge = (a[me] ?? me) || "—", pe = J.size ?? "", qe = (f[pe] ?? pe) || "", _e = [ge, qe].filter(Boolean).join(", ") || ge || "—", Me = me === "projectile" || pe === "thrown", Re = J.quantity != null ? String(J.quantity).trim() : "1", je = String(J.bonus ?? U.bonus ?? "").trim() || "0", Ke = (J.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: ls((x.level ?? "").toString().trim()),
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DcxGnVXQ.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DcxGnVXQ.mjs");
      a(this.actor, l, o);
...
W(ee, "PARTS", foundry.utils.mergeObject(
  ...
  K(ee, ee, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Nt = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Nt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((At = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : At.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ft = (Et = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Et.window) == null ? void 0 : Ft.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
W(ne, "PARTS", foundry.utils.mergeObject(K(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject((($t = K(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : $t.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = ne;
var xt;
...
W(ae, "PARTS", foundry.utils.mergeObject(K(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((xt = K(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : xt.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ae;
var Mt;
...
W(oe, "PARTS", foundry.utils.mergeObject(K(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Mt = K(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : Mt.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = oe;
var Rt;
...
W(le, "PARTS", foundry.utils.mergeObject(K(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Rt = K(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Rt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = le;
var jt;
...
W(ce, "PARTS", foundry.utils.mergeObject(K(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((jt = K(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : jt.form) ?? {}, { submitOnChange: !1 })
}));
let et = ce;
var Kt;
...
W(ue, "PARTS", foundry.utils.mergeObject(K(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Kt = K(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : Kt.form) ?? {}, { submitOnChange: !1 })
}));
let tt = ue;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (c, p, m, y) => {
    ...
    if (c.type === "Npc" && ((w = p == null ? void 0 : p.system) != null && w.identity) && "size" in p.system.identity) {
      const L = zt((C = (S = c.system) == null ? void 0 : S.identity) == null ? void 0 : C.size);
      c.update({
...
Hooks.on("preCreateToken", (_, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const y = zt((m = (p = d.system) == null ? void 0 : p.identity) == null ? void 0 : m.size);
      _.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-5dPxyUy6.mjs.map
