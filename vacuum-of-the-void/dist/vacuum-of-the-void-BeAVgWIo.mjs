...
const { HTMLField: Ws, NumberField: F, SchemaField: U, StringField: D, BooleanField: te, ArrayField: yt } = foundry.data.fields;
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponSlots = ye.map((h, L) => {
      const q = N[h] ?? {}, E = (q.itemId ?? "").trim(), K = re.find((fe) => fe.id === E), ee = J.find((fe) => fe.id === E), Q = (ee == null ? void 0 : ee.system) ?? {}, Ke = Q.size === "thrown", le = (typeof Q.range == "string" ? (Q.range || "").trim() : "") || "—";
      return {
        slotKey: h,
        itemId: E,
        slotNum: L + 1,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CmTnqwCl.mjs");
      r(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-CmTnqwCl.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var b;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, r = ((b = c.textContent) == null ? void 0 : b.trim()) || l, { openRollSheetForSkill: g } = await import("./roll-sheet-CmTnqwCl.mjs");
      g(this.actor, l, r);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((It = e.system) == null ? void 0 : It.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, a = (Fe = (Ve = t == null ? void 0 : t.statuses) == null ? void 0 : Ve.has) != null && Fe.call(Ve, "lookaround") ? 1 : 0, u = (St = (me = t == null ? void 0 : t.statuses) == null ? void 0 : me.has) != null && St.call(me, "halfcover") ? 3 : 0, m = (Pe = (Ee = t == null ? void 0 : t.statuses) == null ? void 0 : Ee.has) != null && Pe.call(Ee, "threequarteredcover") ? 6 : 0;
    ...
    e.weaponSlots = S.map((k) => {
      const P = f[k] ?? {}, x = (P.itemId ?? "").trim(), B = l.find((ce) => ce.id === x), oe = c.find((ce) => ce.id === x), X = (oe == null ? void 0 : oe.system) ?? {}, ge = X.size === "thrown", pe = (typeof X.range == "string" ? (X.range || "").trim() : "") || "—";
      return {
        slotKey: k,
        itemId: x,
    ...
    const ye = ((at = e.system) == null ? void 0 : at.resources) ?? {}, Te = (ct = (ot = e.system) == null ? void 0 : ot.combat) == null ? void 0 : ct.initiativeResult, ae = typeof Te == "number" ? Te : -1, de = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ae = (xe = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : xe.initiativeRanges, He = Array.isArray(Ae) ? Ae.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ne = (He.length > 0 ? He : de).slice().sort((k, P) => k.min - P.min), Ye = 3;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (o) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-CmTnqwCl.mjs");
      l(this.actor, c);
      ...
      if (o.preventDefault(), o.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CmTnqwCl.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CmTnqwCl.mjs");
      r(this.actor, c, l);
...
const ue = class ue extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  /**
   * Felső szintű drop handler az egész alkalmazás ablakra.
   * Ha ez sem logol, akkor a drop esemény egyáltalán nem érkezik meg a Járműegység laphoz.
   */
  async _onDrop(s) {
    var e;
    return console.log("VOTV JarmuEgysegSheet _onDrop event=", s), (e = super._onDrop) == null ? void 0 : e.call(this, s);
  }
  /**
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, b, w, S, T, O, A, N, v, C, _, R, j, H, G, Z, W, M, J, re, Se, ye, Te;
    ...
    }).map((de) => de.actor).find((de) => de && (de.id === u || de.id === a.actorId))) ?? null), !m) return;
    ...
    const o = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = a.targetName || "", c = a.hitLocationName || "", l = ((d == null ? void 0 : d.name) ?? (a.slotKey ? ((Te = (((ye = m.system) == null ? void 0 : ye.weapons) ?? {})[a.slotKey]) == null ? void 0 : Te.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-BeAVgWIo.mjs.map
