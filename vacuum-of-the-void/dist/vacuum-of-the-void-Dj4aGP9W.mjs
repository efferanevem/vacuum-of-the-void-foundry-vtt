...
var it = Reflect.get;
var rt = (N, i, e) => i in N ? et(N, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[i] = e;
var U = (N, i, e) => rt(N, typeof i != "symbol" ? i + "" : i, e);
var R = (N, i, e) => it(tt(N), e, i);
const { HTMLField: st, NumberField: S, SchemaField: _, StringField: f, BooleanField: K, ArrayField: le } = foundry.data.fields;
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((r = i.querySelector) == null ? void 0 : r.call(i, "form.votv.karakter-sheet")) ?? ((s = i.querySelector) == null ? void 0 : s.call(i, "form.votv")) ?? null, t = ((n = i.querySelector) == null ? void 0 : n.call(i, ".votv-scroll")) ?? ((u = i.querySelector) == null ? void 0 : u.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const s = this.element, n = this.form ?? this.element;
    let u = { scrollState: {}, focus: null };
    if (s) {
      u.scrollState = this._saveScrollState(s);
    ...
    const b = this.element, k = this.form ?? this.element, v = u.scrollState, a = u.focus, o = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      var m, y;
      if (this._applyScrollState(b, v), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const w = ((m = k.querySelector) == null ? void 0 : m.call(k, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (y = k.querySelector) == null ? void 0 : y.call(k, `[name="${CSS.escape(a.name)}"]`) : null);
    ...
    return (o || a) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), p;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (r <= 0 || t <= 0) return 0;
    const s = Math.floor(r / 3), n = Math.floor(2 * r / 3);
    return t <= s ? 1 : t <= n ? 2 : 3;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((a = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : a.resources) ?? {}, s = ((c = (o = r.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = r.currentHealth) == null ? void 0 : l.legs) ?? 0, u = C._healthStatusFromRatio(n, s), p = Number(((w = (y = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : y.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, r = ((p = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : p.value) ?? 0, s = ((b = t.currentHealth) == null ? void 0 : b[e]) ?? 0;
    return C._healthStatusFromRatio(s, r);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((u = i == null ? void 0 : i.system) == null ? void 0 : u.resources) ?? {}, s = ((b = (p = r.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : b.value) ?? 0, n = ((k = r.currentHealth) == null ? void 0 : k[t]) ?? 0;
    return C._healthStatusFromRatio(n, s);
  }
  async _prepareContext(i) {
    var qe, Te, De, Oe, _e, Le, Ae, Fe, Ee, $e, Ne, Ce, xe, je, Pe, Me, Re;
    ...
    e.stressOver10 = t > 10;
    const r = this.actor.system.resources ?? {}, s = r.hitLocations ?? {}, n = r.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const d of u) {
      const T = ((Oe = s[d]) == null ? void 0 : Oe.value) ?? 0, D = n[d] ?? 0;
    ...
    const v = e.computedHealthStatus.legs ?? 3, a = Number(((Le = (_e = this.actor.system) == null ? void 0 : _e.combat) == null ? void 0 : Le.givenSpeed) ?? 0) || 0;
    let o;
    v === 0 ? o = 0 : v === 1 ? o = -6 : v === 2 ? o = -3 : o = a, e.effectiveGivenSpeed = o, e.system = foundry.utils.mergeObject(
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], y = (l.slotOrder ?? "").trim(), w = y ? y.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], g = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = g && typeof g == "object" && !Array.isArray(g) ? g : {}, E = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = (((Ee = I.slot2) == null ? void 0 : Ee.itemId) ?? "").trim(), O = ((($e = I.slot3) == null ? void 0 : $e.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
      ...
      const V = T && ((oe = d.system) != null && oe.damage) ? d.system.damage : "", Q = T && typeof ((ie = d.system) == null ? void 0 : ie.range) == "string" ? (d.system.range || "").trim() : "", Y = j ? Number((re = l[j]) == null ? void 0 : re.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
    ...
    e.actionsTable = A;
    const x = (((Ne = this.actor.items) == null ? void 0 : Ne.contents) ?? []).filter((d) => d.type === "Fegyver"), P = x.map((d) => ({ id: d.id, name: d.name, img: d.img }));
    e.weaponItems = P;
    ...
    e.weaponsTable = x.map((d) => {
      ...
      const F = !!D, j = ((ee = d.system) == null ? void 0 : ee.equipped) !== void 0 && ((Ke = d.system) == null ? void 0 : Ke.equipped) !== null ? !!d.system.equipped : F, M = (d == null ? void 0 : d.system) ?? {}, V = typeof M.range == "string" ? (M.range || "").trim() : "", Q = M.type ?? "", Y = (W[Q] ?? Q) || "—", te = M.size ?? "", ne = (Xe[te] ?? te) || "", oe = [Y, ne].filter(Boolean).join(", ") || Y || "—", ie = Y === "Lövedékes", re = M.quantity, se = re != null ? String(re).trim() : "1";
      return {
        slotKey: D ?? "",
        itemId: T,
    ...
    const be = this.actor.system.abilities ?? {}, Ze = (((Re = this.actor.items) == null ? void 0 : Re.contents) ?? []).map((d) => {
      var T, D, L;
      return {
        id: d.id,
        name: d.name,
  ...
  _attachFrameListeners(i) {
    ...
    const e = this.form ?? ((k = i == null ? void 0 : i.querySelector) == null ? void 0 : k.call(i, "form.votv.karakter-sheet")) ?? i ?? this.element, t = $(e);
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), !this.isEditable) return;
    const r = (a) => {
      var l;
      const o = a ? a.currentTarget : (l = e.querySelector) == null ? void 0 : l.call(e, 'input[name="system.resources.stress.value"]');
      if (!o) return;
    ...
    const s = (v = e.querySelector) == null ? void 0 : v.call(e, 'input[name="system.resources.stress.value"]');
    s && r({ currentTarget: s }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (a) => {
      ...
      var y;
      a.preventDefault();
      const o = a.currentTarget, c = o.dataset.skill, l = ((y = o.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-B_2J6ekv.mjs");
      m(this.actor, c, l);
    ...
    const n = (a, o) => {
      ...
      if (l) {
        if (a.classList.contains("karakter-weapon-label") && (o.altKey || o.shiftKey || o.ctrlKey || o.metaKey)) {
          const y = a.dataset.weaponSlot;
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      a.preventDefault(), n(a.currentTarget, a);
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const w = l.system.weapons ?? {}, g = (w.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], E = g ? g.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], q = E.find((O) => {
          var h;
          return (((h = w[O]) == null ? void 0 : h.itemId) ?? "").trim() === c;
        });
        if (q) {
          const O = E.filter((h) => h !== q);
      ...
      var h;
      a.preventDefault();
      const o = a.currentTarget, c = o.closest(".karakter-microchip-slot-select-wrap"), l = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), m = l == null ? void 0 : l.dataset.slot;
      if (!m) return;
      ...
      g ? (E || (E = document.createElement("img"), E.className = "karakter-microchip-slot-thumb", E.alt = "", l == null || l.insertBefore(E, I)), E.src = g, E.style.display = "") : E && E.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
    ...
    }), t.find(".karakter-microchip-slot").each((a, o) => {
    ...
    }), t.find(".karakter-ability-slot-single").each((a, o) => {
      const c = o.dataset.slot;
    ...
    }), t.find(".karakter-ability-area").each((a, o) => {
    ...
    }), t.find(".karakter-weapon-quantity-input").each((a, o) => {
      ...
      var l, m;
      a.preventDefault();
      const o = parseInt(a.currentTarget.dataset.armorIndex, 10);
      ...
      var c, l, m, y;
      a.preventDefault();
      const o = a.currentTarget.dataset.gearArray;
      if (o === "armor") {
      ...
      a.preventDefault();
      const o = a.currentTarget.dataset.slotKey;
      o && await this.actor.update({
      ...
      var l, m;
      a.preventDefault();
      const o = parseInt(a.currentTarget.dataset.itemIndex, 10);
      if (!Number.isFinite(o) || o < 0) return;
    ...
    const u = this, p = (a) => {
      var l, m, y, w;
      if (!a) return;
      const o = u._getFormDataForUpdate(a);
      ...
      var o, c, l;
      return a && (((c = (o = u.element) == null ? void 0 : o.contains) == null ? void 0 : c.call(o, a)) || u.id && ((l = a.closest) == null ? void 0 : l.call(a, `#${CSS.escape(u.id)}`)));
    };
    u._votvBlur = (a) => {
      const o = a.target;
      if (!o || !o.form) return;
  ...
  _getFormDataForUpdate(i) {
    ...
    ), r = t.hitLocations ?? {}, s = t.currentHealth ?? {}, n = ["head", "torso", "arms", "legs"];
    for (const k of n) {
      const v = ((b = r[k]) == null ? void 0 : b.value) ?? 0, a = s[k] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${k}`, C._healthStatusFromRatio(a, v));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var n, u, p, b, k, v, a, o, c, l, m, y;
    const t = i.target, r = (n = t == null ? void 0 : t.closest) == null ? void 0 : n.call(t, ".karakter-ability-slot-single"), s = (u = t == null ? void 0 : t.closest) == null ? void 0 : u.call(t, ".karakter-ability-area");
    if (e) {
      ...
      if (w) {
        ...
        if (g && g.documentName === "Item" && g.type === "ability") {
          ...
          const E = (((v = g.system) == null ? void 0 : v.kind) ?? "passive").toString(), q = this.actor.system.abilities ?? {};
          if (r) {
            ...
            if (A) {
              const x = Array.isArray((a = q[A]) == null ? void 0 : a.items) ? q[A].items.slice() : Array.isArray(q[A]) ? q[A].slice() : [];
          ...
          const O = E === "active" ? "active" : "passive", h = Array.isArray((o = q[O]) == null ? void 0 : o.items) ? q[O].items.slice() : Array.isArray(q[O]) ? q[O].slice() : [];
    ...
    if (e) {
      ...
      if (w) {
        ...
        if (g && g.documentName === "Item" && g.type === "Fegyver") {
          const I = this.actor, E = ((l = g.parent) == null ? void 0 : l.id) !== I.id;
          let q = g.id;
          if (E) {
  ...
  _onWeaponSlotDragOver(i, e) {
    var s, n, u;
    const t = ((s = i.dataTransfer) == null ? void 0 : s.getData("text/plain")) || ((n = i.dataTransfer) == null ? void 0 : n.getData("application/json")) || "";
    let r;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((p = i.dataTransfer) == null ? void 0 : p.getData("text/plain")) || ((b = i.dataTransfer) == null ? void 0 : b.getData("application/json")) || "";
    let r;
    try {
      r = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
    ...
    if (((k = s.parent) == null ? void 0 : k.id) !== this.actor.id) {
      const o = foundry.utils.mergeObject(s.toObject(), { system: { ...s.toObject().system ?? {}, equipped: !1 } });
    ...
    await this.actor.update({
      ...
      [`system.weapons.${e}.damage`]: ((v = s.system) == null ? void 0 : v.damage) ?? "",
      [`system.weapons.${e}.bonus`]: ((a = s.system) == null ? void 0 : a.bonus) ?? ""
  ...
  async _onInventoryRowDrop(i, e) {
    var b, k;
    i.preventDefault(), (b = i.currentTarget) == null || b.classList.remove("karakter-actions-row-drag-over");
    const t = this._draggingInventoryItemId || ((k = i.dataTransfer) == null ? void 0 : k.getData("text/plain"));
    if (this._draggingInventoryItemId = null, !t || !e || t === e) return;
    const s = this.actor.items.contents.slice().sort((v, a) => {
      const o = typeof v.sort == "number" ? v.sort : 0, c = typeof a.sort == "number" ? a.sort : 0;
      return o - c;
    }).map((v) => v.id), n = s.indexOf(t), u = s.indexOf(e);
    if (n === -1 || u === -1) return;
    s.splice(n, 1), s.splice(u, 0, t);
    const p = s.map((v, a) => ({
      _id: v,
      sort: (a + 1) * 10
    }));
  ...
  /** Lőszer mező szélessége tartalomhoz (auto), fókusz és blur esetén is ugyanazzal a logikával. */
  _resizeWeaponQuantityInput(i) {
    ...
    const t = i.value, r = window.getComputedStyle(i), s = document.createElement("span");
    s.setAttribute("aria-hidden", "true"), s.style.cssText = [
      "position:absolute",
      "left:-9999px",
      "visibility:hidden",
      "white-space:pre",
      ...
      "padding-left:" + r.paddingLeft,
      "padding-right:" + r.paddingRight,
      "border-left-width:" + r.borderLeftWidth,
      "border-right-width:" + r.borderRightWidth,
      "box-sizing:" + r.boxSizing
    ].join(";"), s.textContent = t, document.body.appendChild(s);
    const n = Math.ceil(s.getBoundingClientRect().width);
    document.body.removeChild(s), i.style.width = `${Math.max(e, n)}px`;
  }
  async _postAbilityToChat(i) {
    var k, v, a;
    const e = this.actor.items.get(i);
    if (!e || e.type !== "ability") return;
    const t = ((k = e.system) == null ? void 0 : k.kind) ?? "passive", r = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, s = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = s ? `<p>${s}</p>` : "", b = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    let s = r.id;
    ((u = r.parent) == null ? void 0 : u.id) !== this.actor.id && (s = ((p = (await this.actor.createEmbeddedDocuments("Item", [r.toObject()]))[0]) == null ? void 0 : p.id) ?? s), await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    if (!r || r.type !== "ability") return;
    let s = r.id;
    ((b = r.parent) == null ? void 0 : b.id) !== this.actor.id && (s = ((k = (await this.actor.createEmbeddedDocuments("Item", [r.toObject()]))[0]) == null ? void 0 : k.id) ?? s);
    ...
    u.includes(s) || u.push(s), await this.actor.update({ [`system.abilities.${e}.items`]: u });
  }
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let n = s.id;
    ((k = s.parent) == null ? void 0 : k.id) !== this.actor.id && (n = ((v = (await this.actor.createEmbeddedDocuments("Item", [s.toObject()]))[0]) == null ? void 0 : v.id) ?? n), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    n === 1 ? s -= 6 : n === 2 && (s -= 3);
    const p = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, b = new Roll(p);
  ...
  async _rollWeapon(i) {
    var w;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, s = this.actor.items.filter((g) => g.type === "Fegyver");
    let n = null;
    t.itemId && (n = s.find((g) => g.id === t.itemId) ?? null);
    const u = n && n.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, k = (((w = n == null ? void 0 : n.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(r[k] || 0) || 0, a = p + v, c = `3d6${a !== 0 ? a > 0 ? `+${a}` : `${a}` : ""}`, l = new Roll(c);
...
U(C, "PARTS", foundry.utils.mergeObject(R(C, C, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
})), U(C, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(C, C, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "actor", "Karakter"],
  template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs",
  width: 1e3,
  minWidth: 1e3,
  height: 800,
  form: foundry.utils.mergeObject(((Be = R(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : Be.form) ?? {}, { submitOnChange: !1 }),
  window: foundry.utils.mergeObject(((ze = R(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : ze.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((We = (Ge = R(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : Ge.window) == null ? void 0 : We.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const e = this, t = (s) => {
      ...
      var n, u, p;
      return s && (((u = (n = e.element) == null ? void 0 : n.contains) == null ? void 0 : u.call(n, s)) || e.id && ((p = s.closest) == null ? void 0 : p.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var u, p, b;
      const n = ((u = s.target) == null ? void 0 : u.form) ?? ((b = (p = s.target) == null ? void 0 : p.closest) == null ? void 0 : b.call(p, "form"));
      r(n) && t(n);
...
U(B, "PARTS", foundry.utils.mergeObject(R(B, B, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), U(B, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(B, B, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ye = R(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Ye.form) ?? {}, { submitOnChange: !1 })
}));
let fe = B;
var Je;
...
U(z, "PARTS", foundry.utils.mergeObject(R(z, z, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), U(z, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(z, z, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "microchip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Je = R(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : Je.form) ?? {}, { submitOnChange: !0 })
}));
let ye = z;
var Qe;
...
U(G, "PARTS", foundry.utils.mergeObject(R(G, G, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), U(G, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(G, G, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "ability"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Qe = R(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : Qe.form) ?? {}, { submitOnChange: !0 })
}));
let ge = G;
...
Hooks.once("init", () => {
  ...
  console.log("Vacuum of the Void | Initializing system"), game.votv = {
    ...
    value: []
  }, (r = CONFIG.Actor).typeLabels ?? (r.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", (s = CONFIG.Item).typeLabels ?? (s.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.ability = "Képesség", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", pe, {
    types: ["Karakter"],
    makeDefault: !0,
  ...
  Hooks.on("updateActor", (n, u, p, b) => {
    ...
    if (!k) return;
    const v = document.activeElement, a = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), o = [], c = (g = game.actors) == null ? void 0 : g.get(k);
    c != null && c.apps && o.push(...Array.from(c.apps));
    const l = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const h of l)
      ((I = h.document) == null ? void 0 : I.id) !== k || ((E = h.document) == null ? void 0 : E.documentName) !== "Actor" || ((q = h.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || o.includes(h) || o.push(h);
    if (a && o.some((h) => {
      const A = (h == null ? void 0 : h.form) ?? (h == null ? void 0 : h.element);
      return A && A.contains(v);
    })) return;
    const y = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, w = y && Date.now() - y.at < N ? y.appId : null;
    setTimeout(() => {
      for (const h of o)
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (N) => {
      var r, s, n, u, p, b;
      if (!((s = (r = N.target) == null ? void 0 : r.closest) != null && s.call(r, "#actors"))) return;
      const i = (u = (n = N.target) == null ? void 0 : n.closest) == null ? void 0 : u.call(n, "[data-document-id]"), e = (p = i == null ? void 0 : i.getAttribute) == null ? void 0 : p.call(i, "data-document-id");
      if (!e) return;
...
Hooks.on("preCreateToken", (N, i, e) => {
  ...
  const s = r ? (u = game.actors) == null ? void 0 : u.get(r) : null;
  !s || s.type !== "Karakter" || N.updateSource({
    ...t ? { actorId: t } : {},
    actorLink: !0
  });
});
...
Hooks.on("renderChatMessageHTML", (N, i, e) => {
  var s, n, u;
  const t = (n = (s = N.flags) == null ? void 0 : s["vacuum-of-the-void"]) == null ? void 0 : n.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-Dj4aGP9W.mjs.map
