...
var us = Reflect.get;
var ds = (w, s, e) => s in w ? cs(w, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : w[s] = e;
var J = (w, s, e) => ds(w, typeof s != "symbol" ? s + "" : s, e);
var z = (w, s, e) => us(ls(w), e, s);
const { HTMLField: ms, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: Ge } = foundry.data.fields;
class ss extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new K({
        biography: new ms({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: nt, SchemaField: ps } = foundry.data.fields;
class fs extends ss {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ys, NumberField: Os, StringField: Ie } = foundry.data.fields;
...
const { BooleanField: gs, StringField: st } = foundry.data.fields;
...
const { NumberField: rt, StringField: Rt } = foundry.data.fields;
...
const { NumberField: ks, StringField: Mt } = foundry.data.fields;
...
const { StringField: jt } = foundry.data.fields;
class vs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new jt({ required: !1, blank: !0, initial: "" }),
      quantity: new jt({ required: !1, blank: !0, initial: "1" })
    };
  }
}
const { StringField: ws } = foundry.data.fields;
class Is extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new ws({ required: !1, blank: !0, initial: "" })
    };
  }
}
function at(w) {
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Pe, ye, ke, ge, _e, Ce, Ze, Ve, et, tt, He, Ae, yt, gt, ht, bt, kt, vt, wt, It, St, Tt, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((ke = (ye = (Pe = this.actor.system) == null ? void 0 : Pe.resources) == null ? void 0 : ye.stress) == null ? void 0 : ke.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, a = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const _ = ((ge = d[y]) == null ? void 0 : ge.value) ?? 0, C = a[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Ce = (_e = this.actor.system) == null ? void 0 : _e.combat) == null ? void 0 : Ce.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const r = (Number(((Ve = (Ze = this.actor.system) == null ? void 0 : Ze.combat) == null ? void 0 : Ve.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: r } },
      { inplace: !1 }
    );
    const m = ((et = e.system) == null ? void 0 : et.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], D = (tt = this.actor.system.gear) == null ? void 0 : tt.microchips, E = D && typeof D == "object" && !Array.isArray(D) ? D : {}, N = (((He = E.slot1) == null ? void 0 : He.itemId) ?? "").trim(), j = (((Ae = E.slot2) == null ? void 0 : Ae.itemId) ?? "").trim(), B = (((yt = E.slot3) == null ? void 0 : yt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      ...
      const Ue = _ && ((Le = y.system) != null && Le.damage) ? y.system.damage : "", ce = _ && typeof ((ve = y.system) == null ? void 0 : ve.range) == "string" ? (y.system.range || "").trim() : "", Oe = ee ? Number((we = T[ee]) == null ? void 0 : we.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.actionsTable = G;
    const V = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).filter((y) => y.type === "Fegyver"), F = V.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = F;
    ...
    e.weaponSlots = Q.map((y, _) => {
      const C = T[y] ?? {}, L = (C.itemId ?? "").trim(), M = F.find((ee) => ee.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: _ + 1,
    ...
    e.weaponsTable = V.map((y) => {
      ...
      let C = null, L = {};
      for (const it of A)
        if ((((Et = T[it]) == null ? void 0 : Et.itemId) ?? "").trim() === _) {
          C = it, L = T[it] ?? {};
          break;
        }
      const M = !!C, ee = ((Ft = y.system) == null ? void 0 : Ft.equipped) !== void 0 && (($t = y.system) == null ? void 0 : $t.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, Ue = typeof Z.range == "string" ? (Z.range || "").trim() : "", ce = Z.type ?? "", Oe = (ne[ce] ?? ce) || "—", he = Z.size ?? "", qe = (re[he] ?? he) || "", Le = [Oe, qe].filter(Boolean).join(", ") || Oe || "—", ve = ce === "projectile" || he === "thrown", we = Z.quantity, ze = we != null ? String(we).trim() : "1", Ee = String(L.bonus ?? "").trim(), Be = String(Z.bonus ?? "").trim(), os = Ee || Be || "0";
      return {
        slotKey: C ?? "",
        itemId: _,
    ...
    const Se = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((y) => y.type === "Pancel");
    e.armorTable = Se.map((y) => {
      ...
      return {
        ...
        level: Ss((_.level ?? "").toString().trim()),
        special: (_.special ?? _.other ?? "").toString().trim() || "—",
        equipped: C
      };
    });
    const Te = (((bt = this.actor.items) == null ? void 0 : bt.contents) ?? []).filter((y) => y.type === "Targy");
    ...
    const be = (((kt = this.actor.items) == null ? void 0 : kt.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const se = (((vt = this.actor.items) == null ? void 0 : vt.contents) ?? []).filter((y) => y.type === "MikroChip"), ae = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Fe = "— Nincs Mikro-Chip —", $e = ["slot1", "slot2", "slot3"], Ne = (y) => {
      var C, L, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = ae.filter((y) => !Ne(1).includes(y.id)), e.microchipItemsSlot2 = ae.filter((y) => !Ne(2).includes(y.id)), e.microchipItemsSlot3 = ae.filter((y) => !Ne(3).includes(y.id)), e.microchipSlots = $e.map((y) => {
      ...
      const L = !!C, M = ((qe = y == null ? void 0 : y.system) == null ? void 0 : qe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Z = M === "active", Ue = Number((Le = y == null ? void 0 : y.system) == null ? void 0 : Le.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, ce = (((ve = y == null ? void 0 : y.system) == null ? void 0 : ve.description) ?? "").trim(), Oe = ce ? ce.length > 60 ? ce.slice(0, 57) + "…" : ce : "—";
      return {
        itemId: _,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const We = (((wt = e.weaponsTable) == null ? void 0 : wt.length) ?? 0) > 0 || (((It = e.armorTable) == null ? void 0 : It.length) ?? 0) > 0 || (((St = e.microchipsTable) == null ? void 0 : St.length) ?? 0) > 0 || (((Tt = e.itemsTable) == null ? void 0 : Tt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !We;
    const xe = this.actor.system.abilities ?? {}, Ye = (((Dt = this.actor.items) == null ? void 0 : Dt.contents) ?? []).map((y) => {
      var _, C, L;
      return {
        id: y.id,
        name: y.name,
    ...
    const Qe = ((_t = e.system) == null ? void 0 : _t.resources) ?? {}, Xe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], De = (Ot = (Ct = e.system) == null ? void 0 : Ct.combat) == null ? void 0 : Ot.initiativeResult, k = typeof De == "number" ? De : -1, x = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], R = (Lt = (qt = e.system) == null ? void 0 : qt.combat) == null ? void 0 : Lt.initiativeRanges, H = Array.isArray(R) ? R.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [];
    H.length > 0, e.initiativeRanges = H;
    let oe = 0;
    if (typeof k == "number" && k >= 0) {
      const y = initiativeRanges.find((_) => k >= _.min && k <= _.max);
      y && (oe = y.kp);
    }
    e.kpDots = Xe.map((y, _) => {
      const C = _ + 1, L = !!Number(Qe[y]), M = C <= oe;
      return { index: C, used: L, usable: M };
    });
    const X = !!((Pt = (Nt = game.combat) == null ? void 0 : Nt.combatants) != null && Pt.some((y) => {
      var _;
      return ((_ = y.actor) == null ? void 0 : _.type) === "Karakter";
    }));
    return e.showHarcSection = X, e.canEditInitiative = !!((At = game.user) != null && At.isGM), e.showInitiativeResult = typeof De == "number", e.initiativeResult = e.showInitiativeResult ? De : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-MB14zqiN.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-MB14zqiN.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-MB14zqiN.mjs");
      m(this.actor, o, r);
...
J(W, "PARTS", foundry.utils.mergeObject(
  ...
  z(W, W, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ht = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Ht.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ut = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Ut.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Bt = (zt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : zt.window) == null ? void 0 : Bt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((se = t == null ? void 0 : t.items) == null ? void 0 : se.contents) ?? [], d = ((ae = t == null ? void 0 : t.system) == null ? void 0 : ae.weapons) ?? {}, a = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => a.includes(k)) : [], p = n.filter((k) => k.type === "Fegyver"), g = p.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : a, i = a.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      ...
      return x && p.some((H) => H.id === x);
    });
    e.weaponSlots = o.map((k) => {
      const x = d[k] ?? {}, R = (x.itemId ?? "").trim(), H = g.find((oe) => oe.id === R);
      return {
        slotKey: k,
        itemId: R,
    ...
    e.weaponsTable = p.map((k) => {
      ...
      let R = null, H = {};
      for (const Ae of c)
        if ((((He = d[Ae]) == null ? void 0 : He.itemId) ?? "").trim() === x) {
          R = Ae, H = d[Ae] ?? {};
          break;
        }
      const oe = !!R, X = (k == null ? void 0 : k.system) ?? {}, Pe = typeof X.range == "string" ? (X.range || "").trim() : "", ye = X.type ?? "", ke = (r[ye] ?? ye) || "—", ge = X.size ?? "", _e = (m[ge] ?? ge) || "", Ce = [ke, _e].filter(Boolean).join(", ") || ke || "—", Ze = ye === "projectile" || ge === "thrown", Ve = X.quantity != null ? String(X.quantity).trim() : "1", et = String(X.bonus ?? H.bonus ?? "").trim() || "0", tt = (X.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: Ts((x.level ?? "").toString().trim()),
    ...
    e.microchipsTable = T.map((k) => {
      ...
      let R = null;
      for (const Ce of I)
        if ((((ye = v[Ce]) == null ? void 0 : ye.itemId) ?? "").trim() === x) {
          R = Ce;
          break;
        }
      const H = ((ke = k == null ? void 0 : k.system) == null ? void 0 : ke.abilityType) ?? "", oe = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", X = (((ge = k == null ? void 0 : k.system) == null ? void 0 : ge.description) ?? "").trim(), Pe = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const G = t == null ? void 0 : t.id, V = !!((Ke = (Me = game.combat) == null ? void 0 : Me.combatants) != null && Ke.some(
      (k) => {
        var x;
        return (((x = k.actor) == null ? void 0 : x.id) ?? k.actorId) === G;
      }
    ));
    e.showHarcSection = V;
    const F = ((je = e.system) == null ? void 0 : je.resources) ?? {}, Y = (Xe = (Qe = e.system) == null ? void 0 : Qe.combat) == null ? void 0 : Xe.initiativeResult, Q = typeof Y == "number" ? Y : -1;
    let ne = 0;
    Q >= 25 ? ne = 6 : Q >= 19 ? ne = 5 : Q >= 13 ? ne = 4 : Q >= 7 ? ne = 3 : Q >= 0 && (ne = 2);
    const re = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"];
    return e.kpDots = re.map((k, x) => {
      const R = x + 1, H = !!Number(F[k]), oe = R <= ne;
      return { index: R, used: H, usable: oe };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-MB14zqiN.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-MB14zqiN.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-MB14zqiN.mjs");
      r(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const j = (((m = d.system) == null ? void 0 : m.kind) ?? "passive").toString(), B = ((h = a.system) == null ? void 0 : h.abilities) ?? {}, U = j === "active" ? "active" : "passive", G = Array.isArray((v = B[U]) == null ? void 0 : v.items) ? B[U].items.slice() : Array.isArray(B[U]) ? B[U].slice() : [];
      G.includes(N) || G.push(N), await a.update({ [`system.abilities.${U}.items`]: G }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && p) {
      const N = ((q = a.system) == null ? void 0 : q.weapons) ?? {}, j = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (N.slotOrder ?? "").trim(), U = B ? B.split(/\s*,\s*/).filter((F) => j.includes(F)) : [];
      let G = j.find((F) => {
        var Y;
        return !(((Y = N[F]) == null ? void 0 : Y.itemId) ?? "").trim();
      });
      G || (G = j.find((F) => !U.includes(F)) ?? "slot1");
      const V = U.includes(G) ? U : [...U, G].filter((F) => j.includes(F));
      await a.update({
    ...
    if (d.type === "MikroChip" && p) {
      const N = ((E = (D = a.system) == null ? void 0 : D.gear) == null ? void 0 : E.microchips) ?? {}, B = ["slot1", "slot2", "slot3"].find((U) => {
        var G;
...
J(ie, "PARTS", foundry.utils.mergeObject(
  ...
  z(ie, ie, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Gt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Gt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Wt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Wt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Jt = (Yt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.window) == null ? void 0 : Jt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const le = class le extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = Ds, e;
  }
};
...
J(de, "PARTS", foundry.utils.mergeObject(z(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Zt = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.form) ?? {}, { submitOnChange: !1 })
}));
let dt = de;
var Vt;
...
J(me, "PARTS", foundry.utils.mergeObject(z(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Vt = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.form) ?? {}, { submitOnChange: !0 })
}));
let mt = me;
var es;
...
J(fe, "PARTS", foundry.utils.mergeObject(z(fe, fe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ts = z(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : ts.form) ?? {}, { submitOnChange: !1 })
}));
let ft = fe;
const is = "systems/vacuum-of-the-void/assets/void-bg.jpg";
function ns(w) {
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = fs, CONFIG.Actor.dataModels.Npc = ss, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = xt, CONFIG.Item.dataModels.weapon = xt, CONFIG.Item.dataModels.Pancel = hs, CONFIG.Item.dataModels.MikroChip = bs, CONFIG.Item.dataModels.Kepesseg = Kt, CONFIG.Item.dataModels.ability = Kt, CONFIG.Item.dataModels.Targy = vs, CONFIG.Item.dataModels.Egyeb = Is, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (l, f, p, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      const F = Number((q = (T = l.system) == null ? void 0 : T.combat) == null ? void 0 : q.initiativeResult), Y = Number.isFinite(F) ? F : 0, Q = game.combat;
      if (Q) {
    ...
    if (l.type === "Npc" && ((D = f == null ? void 0 : f.system) != null && D.identity) && "size" in f.system.identity) {
      const F = ns((N = (E = l.system) == null ? void 0 : E.identity) == null ? void 0 : N.size);
      l.update({
    ...
    for (const F of r)
      ((B = F.document) == null ? void 0 : B.id) !== b || ((U = F.document) == null ? void 0 : U.documentName) !== "Actor" || ((G = F.constructor) == null ? void 0 : G.name) !== "VoidKarakterSheet" || c.includes(F) || c.push(F);
    if (i && c.some((F) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var m, h, v, I, T, q, P, A, D, E, N, j, B, U, G, V, F, Y, Q, ne, re, Se, Te;
    ...
    const p = a.itemId ? ((j = (N = f.items) == null ? void 0 : N.get) == null ? void 0 : j.call(N, a.itemId)) ?? ((G = (U = (B = f.items) == null ? void 0 : B.contents) == null ? void 0 : U.find) == null ? void 0 : G.call(U, (be) => be.id === a.itemId)) : null;
    let g = (a.damageFormula ?? "").trim();
    if (g || (g = (((V = p == null ? void 0 : p.system) == null ? void 0 : V.damage) ?? "").trim()), !g && a.slotKey && (g = (((((F = f.system) == null ? void 0 : F.weapons) ?? {})[a.slotKey] ?? {}).damage ?? "").trim()), !g) {
...
Hooks.on("preCreateToken", (w, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = ns((p = (f = d.system) == null ? void 0 : f.identity) == null ? void 0 : p.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("updateCombat", (w, s, e) => {
  (s == null ? void 0 : s.round) != null && rs(w), setTimeout(as, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-C4u9L_0m.mjs.map
