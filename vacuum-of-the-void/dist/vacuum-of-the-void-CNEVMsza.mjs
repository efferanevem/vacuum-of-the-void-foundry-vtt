...
var W = (I, s, e) => ns(I, typeof s != "symbol" ? s + "" : s, e);
var j = (I, s, e) => rs(is(I), e, s);
const { HTMLField: as, NumberField: O, SchemaField: K, StringField: S, BooleanField: Z, ArrayField: je } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const _ = ((it = u[g]) == null ? void 0 : it.value) ?? 0, C = r[g] ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BXqNEQaa.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BXqNEQaa.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-BXqNEQaa.mjs");
      p(this.actor, o, a);
  ...
  async _rollWeapon(s) {
    ...
    const l = r && r.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, m = ((w = r == null ? void 0 : r.system) == null ? void 0 : w.type) || "kinetic", y = (((T = r == null ? void 0 : r.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = y && n[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", d = Number(n[b] || 0) || 0, i = f + d, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponSlots = o.map((k) => {
      const x = u[k] ?? {}, R = (x.itemId ?? "").trim(), U = y.find((De) => De.id === R);
      return {
        slotKey: k,
        itemId: R,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (d) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BXqNEQaa.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BXqNEQaa.mjs");
      a(this.actor, c, o);
      ...
      const i = (v = (h = d.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : v.area, c = (T = (w = d.currentTarget) == null ? void 0 : w.dataset) == null ? void 0 : T.itemId;
  ...
  async _rollWeapon(s) {
    ...
    const f = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, y = ((E = l == null ? void 0 : l.system) == null ? void 0 : E.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), d = b && u[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(u[d] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, p = new Roll(a);
  ...
  async _onDropItem(s, e) {
    var y, b, d, i, c, o, a, p, h, v, w, T, q, A, E, D, F;
    ...
    if (((w = u.parent) == null ? void 0 : w.id) === r.id) return;
    const l = u.toObject();
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    const h = (P = game.votv) == null ? void 0 : P._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < I ? h.appId : null;
    setTimeout(() => {
      for (const N of c)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    if (!n) return;
    const u = (v = game.messages) == null ? void 0 : v.get(n), r = (T = (w = u == null ? void 0 : u.flags) == null ? void 0 : w["vacuum-of-the-void"]) == null ? void 0 : T.weapon;
    if (!r) return;
...
Hooks.on("preCreateToken", (I, s, e) => {
  var r, l, f, m;
  const t = (r = game.votv) == null ? void 0 : r._dragSourceActorId, n = t ?? I.actorId ?? null;
...
Hooks.on("combatRound", (I, s, e) => {
  ...
  for (const n of I.combatants ?? []) {
    const u = n.actor;
    !u || u.type !== "Karakter" || u.update(t).catch((r) => {
      console.warn("Vacuum of the Void | KP reset end of round failed for", u.name, r);
    });
  }
});
function es() {
  var e, t, n;
  const I = /* @__PURE__ */ new Set(), s = Object.values((ui == null ? void 0 : ui.windows) ?? {});
  for (const u of s)
    ((e = u == null ? void 0 : u.document) == null ? void 0 : e.documentName) !== "Actor" || ((t = u == null ? void 0 : u.document) == null ? void 0 : t.type) !== "Karakter" || I.has(u.id) || (I.add(u.id), typeof u.render == "function" && u.render(!0));
  for (const u of ((n = game.actors) == null ? void 0 : n.filter((r) => r.type === "Karakter")) ?? [])
    for (const r of u.apps ?? [])
      !(r != null && r.rendered) || I.has(r.id) || (I.add(r.id), typeof r.render == "function" && r.render(!0));
}
...
Hooks.on("renderTokenHUD", (I, s, e) => {
  var u;
  const t = I == null ? void 0 : I.object, n = ((u = t == null ? void 0 : t.document) == null ? void 0 : u.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var m, y, b, d;
  const t = ((m = I.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, n = t.resultType, u = t.critLabel, r = t.weaponAttack, l = t.weapon;
  if (!n && !u && !r) return;
  ...
  if (f) {
    ...
    if (r && l && (l.actorId || (b = I.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((d = I.speaker) == null ? void 0 : d.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(I.id ?? ""), c.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-CNEVMsza.mjs.map
