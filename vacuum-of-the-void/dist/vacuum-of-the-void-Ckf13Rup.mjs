...
var it = Reflect.get;
var rt = (N, s, e) => s in N ? tt(N, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[s] = e;
var H = (N, s, e) => rt(N, typeof s != "symbol" ? s + "" : s, e);
var K = (N, s, e) => it(st(N), e, s);
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const b = e.computedHealthStatus.legs ?? 3, i = Number(((Oe = (De = this.actor.system) == null ? void 0 : De.combat) == null ? void 0 : Oe.givenSpeed) ?? 0) || 0;
    let r;
    ...
    e.weaponItems = R;
    const fe = "— Nincs fegyver —", Je = k.filter((u) => {
    ...
    e.weaponsTable = j.map((u) => {
      ...
      const L = !!q, x = ((X = u.system) == null ? void 0 : X.equipped) !== void 0 && ((Pe = u.system) == null ? void 0 : Pe.equipped) !== null ? !!u.system.equipped : L, P = (u == null ? void 0 : u.system) ?? {}, Q = typeof P.range == "string" ? (P.range || "").trim() : "", W = P.type ?? "", G = (Qe[W] ?? W) || "—", Z = P.size ?? "", ie = (Xe[Z] ?? Z) || "", re = [G, ie].filter(Boolean).join(", ") || G || "—", V = G === "Lövedékes", ee = P.quantity, te = ee != null ? String(ee).trim() : "1";
      return {
        slotKey: q ?? "",
        itemId: v,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-CNPuc67h.mjs");
      l(this.actor, o);
    ...
    n && a({ currentTarget: n }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var f;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, l = ((f = r.textContent) == null ? void 0 : f.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-CNPuc67h.mjs");
      m(this.actor, o, l);
...
//# sourceMappingURL=vacuum-of-the-void-Ckf13Rup.mjs.map
