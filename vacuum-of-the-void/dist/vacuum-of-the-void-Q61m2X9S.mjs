...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var tt, st, it, nt, rt, at, ot, ct, lt, xe, ut, dt, Re, w, P, x, H, oe, X, ge, pe, ce, _e, Me, je, Ot, Ct, qt, Lt, mt, We, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, rs, as, os, cs;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DMmXkaCX.mjs");
      r(this.actor, a);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DMmXkaCX.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', o), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, a = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || a, { openRollSheetForSkill: y } = await import("./roll-sheet-DMmXkaCX.mjs");
      y(this.actor, a, r);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const d = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], f = ((Ce = t == null ? void 0 : t.system) == null ? void 0 : Ce.weapons) ?? {}, g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (f.slotOrder ?? "").trim(), i = l ? l.split(/\s*,\s*/).filter((w) => g.includes(w)) : [], c = d.filter((w) => w.type === "Fegyver"), a = c.map((w) => ({ id: w.id, name: w.name, img: w.img })), r = "— Nincs fegyver —", y = i.length > 0 ? i : g, h = g.filter((w) => !y.includes(w)), k = [...y, ...h], S = k.filter((w) => {
      ...
      return P && c.some((H) => H.id === P);
    });
    e.weaponSlots = S.map((w) => {
      const P = f[w] ?? {}, x = (P.itemId ?? "").trim(), H = a.find((ce) => ce.id === x), oe = c.find((ce) => ce.id === x), X = (oe == null ? void 0 : oe.system) ?? {}, ge = X.size === "thrown", pe = (typeof X.range == "string" ? (X.range || "").trim() : "") || "—";
      return {
        slotKey: w,
        itemId: x,
    ...
    const B = ((it = t == null ? void 0 : t.system) == null ? void 0 : it.abilities) ?? {}, G = d.filter((w) => w.type === "Kepesseg" || w.type === "ability").map((w) => {
      var P, x, H;
      return {
        id: w.id,
        name: w.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DMmXkaCX.mjs");
      a(this.actor, c);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DMmXkaCX.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DMmXkaCX.mjs");
      r(this.actor, c, a);
  ...
  async _onDropItem(s, e) {
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      ...
      const R = (((y = p.system) == null ? void 0 : y.kind) ?? "passive").toString(), j = ((h = o.system) == null ? void 0 : h.abilities) ?? {}, B = R === "active" ? "active" : "passive", G = Array.isArray((k = j[B]) == null ? void 0 : k.items) ? j[B].items.slice() : Array.isArray(j[B]) ? j[B].slice() : [];
      G.includes(C) || G.push(C), await o.update({ [`system.abilities.${B}.items`]: G }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (p.type === "Fegyver" && d) {
      const C = ((D = o.system) == null ? void 0 : D.weapons) ?? {}, R = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (C.slotOrder ?? "").trim(), B = j ? j.split(/\s*,\s*/).filter((W) => R.includes(W)) : [];
      let G = R.find((W) => {
        var M;
    ...
    if (p.type === "MikroChip" && d) {
      const C = ((L = (v = o.system) == null ? void 0 : v.gear) == null ? void 0 : L.microchips) ?? {}, j = ["slot1", "slot2", "slot3"].find((B) => {
        var G;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (m, d, f, g) => {
    ...
    for (const M of y) {
      if (((B = M.document) == null ? void 0 : B.id) !== l || ((G = M.document) == null ? void 0 : G.documentName) !== "Actor") continue;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const d = o.itemId ? ((R = (C = m.items) == null ? void 0 : C.get) == null ? void 0 : R.call(C, o.itemId)) ?? ((G = (B = (j = m.items) == null ? void 0 : j.contents) == null ? void 0 : B.find) == null ? void 0 : G.call(B, (ae) => ae.id === o.itemId)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-Q61m2X9S.mjs.map
