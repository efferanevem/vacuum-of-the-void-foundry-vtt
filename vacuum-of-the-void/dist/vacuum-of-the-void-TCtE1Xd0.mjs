...
var ti = Reflect.get;
var si = (I, s, e) => s in I ? Qs(I, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : I[s] = e;
var te = (I, s, e) => si(I, typeof s != "symbol" ? s + "" : s, e);
var z = (I, s, e) => ti(ei(I), e, s);
...
const { NumberField: zt, SchemaField: ni } = foundry.data.fields;
class ai extends Rt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: pi, NumberField: Pi, StringField: Ve } = foundry.data.fields;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DlGQ8mbI.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DlGQ8mbI.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-DlGQ8mbI.mjs");
      h(this.actor, o, m);
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DlGQ8mbI.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DlGQ8mbI.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DlGQ8mbI.mjs");
      m(this.actor, r, o);
...
const it = class it extends xt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!u || !a || !i) return;
      const r = u.value ?? "", o = (y == null ? void 0 : y.value) ?? "", m = t[r] ?? 0, h = n[o] ?? 0, g = (((J = (R = this.actor) == null ? void 0 : R.items) == null ? void 0 : J.contents) ?? []).filter((Y) => Y.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ni(this.actor), _ = m + h + k + w + T;
      a.value = _;
    };
...
Hooks.on("combatRound", (I, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || Zs(I);
});
function Ys() {
  var s, e, t;
...
Hooks.on("updateCombat", (I, s, e) => {
  (s == null ? void 0 : s.round) != null && Zs(I), setTimeout(Ys, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-TCtE1Xd0.mjs.map
