...
var ci = Reflect.get;
var li = (I, s, e) => s in I ? ri(I, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : I[s] = e;
...
const { NumberField: jt, SchemaField: mi } = foundry.data.fields;
class pi extends Lt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: fi, StringField: vs, NumberField: yi } = foundry.data.fields;
class gi extends Lt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: hi, StringField: ks, NumberField: bi } = foundry.data.fields;
class vi extends Lt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      vehicle: new hi({
        ...
        type: new ks({ required: !1, blank: !0, initial: "" }),
        /** Eszközök hatótávolsága (TE) – bázisról induló támadások/érzékelés. */
        toolsRange: new ks({ required: !1, blank: !0, initial: "" }),
...
const { BooleanField: ki, NumberField: Ki, StringField: Ve } = foundry.data.fields;
...
const { BooleanField: wi, StringField: xt } = foundry.data.fields;
class Ii extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new xt({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new xt({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new xt({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new xt({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: Kt, StringField: Is } = foundry.data.fields;
...
const { NumberField: Ti, StringField: Ss } = foundry.data.fields;
...
const { StringField: Ds } = foundry.data.fields;
class Di extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new Ds({ required: !1, blank: !0, initial: "" }),
      quantity: new Ds({ required: !1, blank: !0, initial: "1" })
    };
  }
}
...
const { NumberField: Ut, StringField: dt, SchemaField: Os, ArrayField: Ci } = foundry.data.fields;
...
const { NumberField: qi, StringField: Rt, SchemaField: Ni, ArrayField: Ai } = foundry.data.fields;
...
function Bt(I) {
  ...
  f(I.terms, 1);
  const u = s.filter((r) => r === 6).length, m = s.filter((r) => r === 1).length, p = e.filter((r) => r === 6).length, a = t.filter((r) => r === 6).length, c = u + p, y = m + a;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const a = this.element, c = this.form ?? this.element, y = m.scrollState, r = m.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", o = () => {
      var d, h;
    ...
    return (i || r) && (requestAnimationFrame(o), setTimeout(o, 0), setTimeout(o, 50), setTimeout(o, 150), setTimeout(o, 300), setTimeout(o, 450)), p;
  }
  /**
  ...
  static getTotalSpeedRaw(s) {
    var c, y, r, i, o, l, d, h, g;
    if (!(s != null && s.system)) return 0;
    const e = s.system.resources ?? {}, t = ((y = (c = e.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : y.value) ?? 0, n = ((r = e.currentHealth) == null ? void 0 : r.legs) ?? 0, f = Q._healthStatusFromRatio(n, t);
    if (f === 0) return 0;
    ...
    const p = Number(((d = (l = s.system) == null ? void 0 : l.combat) == null ? void 0 : d.speed) ?? 0) || 0, a = Number(((g = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : g.speedBonus) ?? 0) || 0;
    return p + a + (Number.isFinite(m) ? m : 0);
  }
  /**
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const p = Number(u == null ? void 0 : u.value) || 0, a = Number(m == null ? void 0 : m.value) || 0, c = Number(f == null ? void 0 : f.textContent) || 0;
    n.textContent = String(p + a + c);
  }
  _writeTotalSpeed(s = null) {
    ...
    const p = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, a = ((w = (k = p.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, c = ((T = p.currentHealth) == null ? void 0 : T.legs) ?? 0;
    if (Q._healthStatusFromRatio(c, a) === 0) {
      n.textContent = "0";
      return;
    }
    const r = Number(u == null ? void 0 : u.value) || 0, i = Number(m == null ? void 0 : m.value) || 0, o = Number(f == null ? void 0 : f.textContent) || 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((u = this.actor.system) == null ? void 0 : u.resources) ?? {}, n = ((p = (m = t.hitLocations) == null ? void 0 : m[e]) == null ? void 0 : p.value) ?? 0, f = ((a = t.currentHealth) == null ? void 0 : a[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((m = s == null ? void 0 : s.system) == null ? void 0 : m.resources) ?? {}, f = ((a = (p = n.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : a.value) ?? 0, u = ((c = n.currentHealth) == null ? void 0 : c[t]) ?? 0;
    return Q._healthStatusFromRatio(u, f);
  }
  async _prepareContext(s) {
    var pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe, S, P, x, G, ke, ne, Le, Oe, we, Re, Qe, et, Ft, Et, Pt, $t, Tt, lt, ss, is, ns, as, rs, os, cs, ls, us, ds, ms, ps, fs, ys;
    ...
    const y = e.computedHealthStatus.legs ?? 3, r = Number(((bt = (ht = this.actor.system) == null ? void 0 : ht.combat) == null ? void 0 : bt.givenSpeed) ?? 0) || 0;
    let i;
    ...
    const _ = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Qe = this.actor.system.gear) == null ? void 0 : Qe.microchips, z = U && typeof U == "object" && !Array.isArray(U) ? U : {}, V = (((et = z.slot1) == null ? void 0 : et.itemId) ?? "").trim(), Z = (((Ft = z.slot2) == null ? void 0 : Ft.itemId) ?? "").trim(), J = (((Et = z.slot3) == null ? void 0 : Et.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      let re = null;
      q && (V === b.id ? re = "slot1" : Z === b.id ? re = "slot2" : J === b.id && (re = "slot3"));
    ...
    e.actionsTable = oe;
    const R = (((Pt = this.actor.items) == null ? void 0 : Pt.contents) ?? []).filter((b) => b.type === "Fegyver"), te = R.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = te;
    ...
    e.weaponSlots = De.map((b, N) => {
      const q = _[b] ?? {}, F = (q.itemId ?? "").trim(), B = te.find((_e) => _e.id === F), ue = R.find((_e) => _e.id === F), re = (ue == null ? void 0 : ue.system) ?? {}, tt = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: F,
        slotNum: N + 1,
    ...
    e.weaponsTable = R.map((b) => {
      ...
      let q = null, F = {};
      for (const zt of K)
        if ((((gs = _[zt]) == null ? void 0 : gs.itemId) ?? "").trim() === N) {
          q = zt, F = _[zt] ?? {};
          break;
        }
      const B = !!q, ue = ((hs = b.system) == null ? void 0 : hs.equipped) !== void 0 && ((bs = b.system) == null ? void 0 : bs.equipped) !== null ? !!b.system.equipped : B, re = (b == null ? void 0 : b.system) ?? {}, tt = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", _e = (D[Ie] ?? Ie) || "—", Me = re.size ?? "", st = (E[Me] ?? Me) || "", it = [_e, st].filter(Boolean).join(", ") || _e || "—", Ge = Ie === "projectile" || Me === "thrown", We = re.quantity, Dt = We != null ? String(We).trim() : "1", ut = String(F.bonus ?? "").trim(), Ot = String(re.bonus ?? "").trim(), ai = ut || Ot || "0";
      return {
        slotKey: q ?? "",
        itemId: N,
    ...
    const W = ((($t = this.actor.items) == null ? void 0 : $t.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = W.map((b) => {
      ...
      return {
        ...
        level: Pi((N.level ?? "").toString().trim()),
    ...
    const pe = (((ss = this.actor.items) == null ? void 0 : ss.contents) ?? []).filter((b) => b.type === "MikroChip"), ae = pe.map((b) => ({ id: b.id, name: b.name, img: b.img })), ve = "— Nincs Mikro-Chip —", ce = ["slot1", "slot2", "slot3"], fe = (b) => {
      var q, F, B;
      const N = [];
      return b !== 1 && N.push((((q = z.slot1) == null ? void 0 : q.itemId) ?? "").trim()), b !== 2 && N.push((((F = z.slot2) == null ? void 0 : F.itemId) ?? "").trim()), b !== 3 && N.push((((B = z.slot3) == null ? void 0 : B.itemId) ?? "").trim()), N.filter(Boolean);
    };
    e.microchipItemsSlot1 = ae.filter((b) => !fe(1).includes(b.id)), e.microchipItemsSlot2 = ae.filter((b) => !fe(2).includes(b.id)), e.microchipItemsSlot3 = ae.filter((b) => !fe(3).includes(b.id)), e.microchipSlots = ce.map((b) => {
      const N = z[b] ?? {}, q = (N.itemId ?? "").trim(), F = pe.find((B) => B.id === q);
      return {
        slotKey: b,
        itemId: q,
      ...
      const N = `slot${b}`, q = z[N] ?? {}, F = (q.itemId ?? "").trim(), B = ae.find((ue) => ue.id === F);
    ...
    const ze = (((is = e.weaponsTable) == null ? void 0 : is.length) ?? 0) > 0 || (((ns = e.armorTable) == null ? void 0 : ns.length) ?? 0) > 0 || (((as = e.microchipsTable) == null ? void 0 : as.length) ?? 0) > 0 || (((rs = e.itemsTable) == null ? void 0 : rs.length) ?? 0) > 0;
    e.showEquipmentDropZone = !ze;
    const je = this.actor.system.abilities ?? {}, $e = (((os = this.actor.items) == null ? void 0 : os.contents) ?? []).map((b) => {
      var N, q, F;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Ke = new Map($e.map((b) => [b.id, b])), at = "— Nincs képesség —", Ue = (b) => {
      const N = je[b] ?? {}, q = (N.itemId ?? "").trim(), F = q ? Ke.get(q) : null, B = (F == null ? void 0 : F.description) ?? "", ue = (F == null ? void 0 : F.kp) ?? 0;
      return {
        itemId: q,
        displayName: (F == null ? void 0 : F.name) || N.name || at,
        img: (F == null ? void 0 : F.img) || "",
        description: B,
        kp: ue
      };
    ...
    const rt = ((cs = e.system) == null ? void 0 : cs.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (us = (ls = e.system) == null ? void 0 : ls.combat) == null ? void 0 : us.initiativeResult, ie = typeof ye == "number" ? ye : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], xe = (ms = (ds = e.system) == null ? void 0 : ds.combat) == null ? void 0 : ms.initiativeRanges, Ce = Array.isArray(xe) ? xe.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], He = (Ce.length > 0 ? Ce : ot).slice().sort((b, N) => b.min - N.min), Ze = Ce.map((b) => b.min), qt = Ze.length ? Math.min(...Ze) : 0, Nt = Ze.length ? Math.max(...Ze) : 0;
    e.initiativeRanges = Ce.map((b) => ({ ...b, isFirst: b.min === qt, isLast: b.min === Nt }));
    let mt = 0;
    ...
    e.kpDots = ee.map((b, N) => {
      const q = N + 1, F = !!Number(rt[b]), B = q <= mt;
      return { index: q, used: F, usable: B };
    });
    const At = !!((fs = (ps = game.combat) == null ? void 0 : ps.combatants) != null && fs.some((b) => {
      var N;
      return ((N = b.actor) == null ? void 0 : N.type) === "Karakter";
    }));
    return e.showHarcSection = At, e.canEditInitiative = !!((ys = game.user) != null && ys.isGM), e.showInitiativeResult = typeof ye == "number", e.initiativeResult = e.showInitiativeResult ? ye : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-Bhy74iWR.mjs");
      d(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-Bhy74iWR.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, l = o.dataset.skill, d = ((g = o.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-Bhy74iWR.mjs");
      h(this.actor, l, d);
    ...
    p._votvBlur = (i) => {
      ...
      h && (d.contains(h) || p.id && ((g = h.closest) != null && g.call(h, `#${CSS.escape(p.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: p.id, at: Date.now() }), a(d));
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const c of u) {
      const y = ((a = n[c]) == null ? void 0 : a.value) ?? 0, r = f[c] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${c}`, Q._healthStatusFromRatio(r, y));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, n, f, u, m, p, a, c, y, r, i, o, l, d;
    if (e) {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((c = e.system) == null ? void 0 : c.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", p = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
  ...
  async _rollSkill(s, e) {
    ...
    u === 1 ? f -= 6 : u === 2 && (f -= 3);
    const p = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, a = new Roll(p);
    await a.evaluate({ async: !0 });
    const { resultType: c, label: y } = Bt(a), r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const m = u && u.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, a = ((k = u == null ? void 0 : u.system) == null ? void 0 : k.type) || "kinetic", c = (((w = u == null ? void 0 : u.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = c && n[c] !== void 0 ? c : a === "explosive" ? "grenadeUse" : "firearms", r = Number(n[y] || 0) || 0, i = p + r, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, d = new Roll(l);
  ...
  async _rollWeaponDamage(s, e = "") {
    var p, a, c, y, r, i, o, l, d, h;
    const t = this.actor;
    if (!t) return;
    let n = ((a = (p = t.items).get) == null ? void 0 : a.call(p, s)) ?? ((y = (c = t.items.contents) == null ? void 0 : c.find) == null ? void 0 : y.call(c, (g) => g.id === s));
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const u = await super.render(s, e), m = this.element, p = this.form ?? this.element, a = f.scrollState, c = f.focus, y = typeof (a == null ? void 0 : a.formScrollTop) == "number" || typeof (a == null ? void 0 : a.windowScrollTop) == "number", r = () => {
      var i, o;
      if (this._applyScrollState(m, a), (c == null ? void 0 : c.name) != null || (c == null ? void 0 : c.id) != null) {
      ...
      this._applyScrollState(m, a);
    };
    return (y || c) && (requestAnimationFrame(r), setTimeout(r, 0), setTimeout(r, 50), setTimeout(r, 150), setTimeout(r, 300), setTimeout(r, 450)), u;
  }
  async _prepareContext(s) {
    var Ue, Je, Be, rt, ee, ye, ie, ot, xe, Ce, ct, He, Ze, qt, Nt, mt, At, pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe;
    ...
    const t = this.actor, n = ((rt = e.system) == null ? void 0 : rt.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, u = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, m = (ot = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && ot.call(ie, "halfcover") ? 3 : 0, p = (Ce = (xe = t == null ? void 0 : t.statuses) == null ? void 0 : xe.has) != null && Ce.call(xe, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + u + m + p;
    const a = ((ct = t == null ? void 0 : t.items) == null ? void 0 : ct.contents) ?? [], c = ((He = t == null ? void 0 : t.system) == null ? void 0 : He.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (c.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], o = a.filter((S) => S.type === "Fegyver"), l = o.map((S) => ({ id: S.id, name: S.name, img: S.img })), d = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
    ...
    e.weaponsTable = o.map((S) => {
      ...
      const ke = !!x, ne = (S == null ? void 0 : S.system) ?? {}, Le = typeof ne.range == "string" ? (ne.range || "").trim() : "", Oe = ne.type ?? "", we = (w[Oe] ?? Oe) || "—", Re = ne.size ?? "", Qe = (T[Re] ?? Re) || "", et = [we, Qe].filter(Boolean).join(", ") || we || "—", Ft = Oe === "projectile" || Re === "thrown", Et = ne.quantity != null ? String(ne.quantity).trim() : "1", Pt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", $t = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    e.armorTable = O.map((S) => {
      ...
      return {
        ...
        level: $i((P.level ?? "").toString().trim()),
        special: (P.special ?? P.other ?? "").toString().trim() || "—",
        equipped: x
      };
    });
    const _ = ((qt = (Ze = t == null ? void 0 : t.system) == null ? void 0 : Ze.gear) == null ? void 0 : qt.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], j = a.filter((S) => S.type === "MikroChip");
    ...
    const z = (((Nt = e.weaponsTable) == null ? void 0 : Nt.length) ?? 0) > 0 || (((mt = e.armorTable) == null ? void 0 : mt.length) ?? 0) > 0 || (((At = e.microchipsTable) == null ? void 0 : At.length) ?? 0) > 0 || (((pt = e.itemsTable) == null ? void 0 : pt.length) ?? 0) > 0 || (((ft = e.egyebList) == null ? void 0 : ft.length) ?? 0) > 0;
    e.showEquipmentDropZone = !z;
    const V = ((yt = t == null ? void 0 : t.system) == null ? void 0 : yt.abilities) ?? {}, Z = a.filter((S) => S.type === "Kepesseg" || S.type === "ability").map((S) => {
      var P, x, G;
      return {
        id: S.id,
        name: S.name,
    ...
    const De = ((bt = e.system) == null ? void 0 : bt.resources) ?? {}, D = (kt = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : kt.initiativeResult, E = typeof D == "number" ? D : -1, W = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], se = (Ye = (wt = e.system) == null ? void 0 : wt.combat) == null ? void 0 : Ye.initiativeRanges, le = Array.isArray(se) ? se.map((S) => ({ min: Number(S.min) ?? 0, max: Number(S.max) ?? 0, kp: Math.min(10, Math.max(0, Number(S.kp) ?? 0)) })) : [], ae = (le.length > 0 ? le : W).slice().sort((S, P) => S.min - P.min), ve = 3;
    ...
    }), at = Math.ceil(Ke.length / 2);
    return e.kpDotsRow1 = Ke.slice(0, at), e.kpDotsRow2 = Ke.slice(at), e.canEditInitiative = !!((It = game.user) != null && It.isGM), e.showInitiativeResult = typeof D == "number", e.initiativeResult = e.showInitiativeResult ? D : "", e.speedUnitForSelect = ((Xe = (St = e.system) == null ? void 0 : St.combat) == null ? void 0 : Xe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var a, c, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      var d, h, g, v;
      r.preventDefault();
      const i = (h = (d = r.currentTarget) == null ? void 0 : d.closest) == null ? void 0 : h.call(d, ".karakter-weapon-slot"), o = (((g = i == null ? void 0 : i.dataset) == null ? void 0 : g.itemId) ?? "").trim();
      ...
      const i = r.currentTarget, o = (((d = i == null ? void 0 : i.dataset) == null ? void 0 : d.slot) ?? "").trim();
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Bhy74iWR.mjs");
      l(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Bhy74iWR.mjs");
      ...
      var h, g;
      r.preventDefault();
      const i = r.currentTarget, o = (((h = i == null ? void 0 : i.dataset) == null ? void 0 : h.skill) ?? "").trim(), l = ((g = i == null ? void 0 : i.textContent) == null ? void 0 : g.trim()) || o;
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-Bhy74iWR.mjs");
      d(this.actor, o, l);
    }), t.on("click", ".karakter-ability-chat", async (r) => {
      var o, l;
      r.preventDefault();
      const i = (l = (o = r.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : l.itemId;
      ...
      const i = (v = (g = r.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.area, o = (w = (k = r.currentTarget) == null ? void 0 : k.dataset) == null ? void 0 : w.itemId;
      ...
      var o, l;
      if (r.preventDefault(), !r.altKey) return;
      const i = (l = (o = r.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : l.slot;
      ...
      var g, v;
      if (r.preventDefault(), !r.altKey) return;
      const i = r.currentTarget, o = (((g = i == null ? void 0 : i.dataset) == null ? void 0 : g.itemId) ?? "").trim();
      if (!o || !this.actor) return;
      ...
      var o, l;
      if (r.preventDefault(), !r.altKey) return;
      const i = (((l = (o = r.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : l.itemId) ?? "").trim();
    ...
    (y = (c = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : c.call(e, f)) == null || y.forEach((r) => {
      ...
      var h, g, v;
      const i = r.currentTarget, o = (g = (h = i == null ? void 0 : i.dataset) == null ? void 0 : h.itemId) == null ? void 0 : g.trim();
      if (!o || !this.actor) return;
      const l = this.actor.items.get(o);
      if (!l) return;
      const d = l.uuid;
    ...
    const u = this, m = (r) => {
      ...
      var i, o, l;
      return r && (((o = (i = u.element) == null ? void 0 : i.contains) == null ? void 0 : o.call(i, r)) || u.id && ((l = r.closest) == null ? void 0 : l.call(r, `#${CSS.escape(u.id)}`)));
    };
    u._votvNpcBlur = (r) => {
      var h;
      const i = r.target;
    ...
    }, document.body.addEventListener("blur", u._votvNpcBlur, !0), u._votvNpcItemHookRegistered || (u._votvNpcItemUpdateHook = (r, i, o) => {
      var l;
      u.actor && ((l = r == null ? void 0 : r.parent) == null ? void 0 : l.id) === u.actor.id && u.render(!0);
    }, u._votvNpcItemDeleteHook = (r, i, o) => {
      var l;
      u.actor && ((l = r == null ? void 0 : r.parent) == null ? void 0 : l.id) === u.actor.id && u.render(!0);
  ...
  async _rollWeapon(s) {
    ...
    let m = null;
    n.itemId && (m = u.find((j) => j.id === n.itemId) ?? null);
    const p = m && m.name || n.name || "Fegyver", a = Number(n.bonus || 0) || 0, c = ((_ = m == null ? void 0 : m.system) == null ? void 0 : _.type) || "kinetic", y = (((C = m == null ? void 0 : m.system) == null ? void 0 : C.skillKey) ?? "").trim(), r = y && f[y] !== void 0 ? y : c === "explosive" ? "grenadeUse" : "firearms", i = Number(f[r] || 0) || 0, o = a + i, d = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, h = new Roll(d);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((a = (p = t.items).get) == null ? void 0 : a.call(p, s)) ?? ((y = (c = t.items.contents) == null ? void 0 : c.find) == null ? void 0 : y.call(c, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((r = n.system) == null ? void 0 : r.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((d = (l = game.i18n) == null ? void 0 : l.localize) == null ? void 0 : d.call(l, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var c, y, r, i, o, l, d, h, g, v, k, w, T, O, _, C, j, K, U;
    if (!this.actor) return (c = super._onDropItem) == null ? void 0 : c.call(this, s, e);
    const n = ((z) => {
      var Z;
      if (!z) return null;
      const V = z.uuid ?? z.documentUuid ?? ((Z = z.data) == null ? void 0 : Z.uuid) ?? (typeof z == "string" ? z : null);
      if (V) return V;
      if (typeof z == "object") {
    ...
    const a = (O = (await u.createEmbeddedDocuments("Item", [m]))[0]) == null ? void 0 : O.id;
    if (f.type === "Fegyver" && a) {
      const z = ((_ = u.system) == null ? void 0 : _.weapons) ?? {}, V = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Z = (z.slotOrder ?? "").trim(), J = Z ? Z.split(/\s*,\s*/).filter((R) => V.includes(R)) : [];
      let Y = V.find((R) => {
        var te;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((r = e.system) == null ? void 0 : r.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", p = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${m}
      ${p}
  ...
  async _postItemToChat(s) {
    var p, a, c, y, r, i;
    const e = (a = (p = this.actor) == null ? void 0 : p.items) == null ? void 0 : a.get(s);
    if (!e || e.type !== "MikroChip" && e.type !== "Egyeb") return;
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalDefense(s = null) {
    const e = s ?? this.form ?? this.element, t = (a) => {
      var c;
      return ((c = e == null ? void 0 : e.querySelector) == null ? void 0 : c.call(e, a)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${a}`) : null);
  ...
  async _prepareContext(s) {
    var j, K, U, z, V, Z, J, Y, oe, R, te, de, De;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = m.map((D) => {
      const E = (D == null ? void 0 : D.system) ?? {}, W = E.type ?? "", se = (n[W] ?? W) || "—", le = E.size ?? "", pe = (f[le] ?? le) || "", ae = [se, pe].filter(Boolean).join(", ") || se || "—", ve = W === "projectile" || le === "thrown", ce = E.quantity != null ? String(E.quantity).trim() : "1", fe = (typeof E.range == "string" ? (E.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.armorTable = p.map((D) => {
      ...
      return {
        ...
        level: xi((E.level ?? "").toString().trim()),
    ...
    for (const D of r) {
      ...
      const Ke = (E.hit ?? "").toString().trim(), at = (E.speed ?? "").toString().trim().replace(",", "."), Ue = Number(at);
      Number.isFinite(Ue) && (o += Ue);
      const Je = (E.range ?? "").toString().trim().replace(",", "."), Be = Number(Je);
      Number.isFinite(Be) && (l += Be);
      const rt = (E.damage ?? "").toString().trim();
      i.push({
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (p) => {
      ...
      var y, r, i;
      p.preventDefault();
      const a = (r = (y = p.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : r.itemId;
      if (!a) return;
      ...
      var r;
      const a = p.currentTarget, c = (r = a == null ? void 0 : a.dataset) == null ? void 0 : r.itemId;
      if (!c) return;
      ...
      var c, y, r, i;
      p.preventDefault();
      const a = (y = (c = p.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : y.itemId;
      ...
      var y, r, i, o;
      p.preventDefault();
      const a = (((r = (y = p.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : r.itemId) ?? ((o = (i = p.currentTarget) == null ? void 0 : i.getAttribute) == null ? void 0 : o.call(i, "data-item-id")) ?? "").trim();
      if (!a || !this.actor) return;
      const c = this.actor.items.get(a);
      !c || c.type !== "MikroChip" && c.type !== "Egyeb" || await this._postItemToChat(a);
    }), t.on("click", ".jarmu-unit-damage-button", async (p) => {
      var y;
      p.preventDefault(), p.stopPropagation();
      const a = p.currentTarget, c = (((y = a == null ? void 0 : a.dataset) == null ? void 0 : y.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (p) => {
      ...
      y && (y.setData("text/plain", c), y.effectAllowed = "move", typeof y.setDragImage == "function" && y.setDragImage(a, 0, 0));
    }), t.on("dragover", ".jarmu-unit-row", (p) => {
      var r, i, o, l;
      const a = (i = (r = p.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : i.itemId, c = n._draggingUnitId;
      if (!c || !a || c === a) return;
      p.preventDefault();
      ...
      var a;
      (a = p.currentTarget) == null || a.classList.remove("karakter-actions-row-drag-over");
      ...
      const a = (k = (v = p.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : k.itemId;
      let c = n._draggingUnitId;
      const y = (w = p.originalEvent) == null ? void 0 : w.dataTransfer;
      if (!c && y && (c = y.getData("text/plain")), n._draggingUnitId = null, !c || !a || c === a) return;
      const r = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", o = this.actor.items.contents.filter((T) => T.type === r).sort((T, O) => {
        const _ = typeof T.sort == "number" ? T.sort : 0, C = typeof O.sort == "number" ? O.sort : 0;
        return _ - C;
      }).map((T) => T.id), l = o.indexOf(c), d = o.indexOf(a);
      if (l === -1 || d === -1) return;
      ...
      var r, i, o, l, d, h, g, v, k, w;
      p.preventDefault();
      const a = (l = (o = (i = (r = p.currentTarget) == null ? void 0 : r.closest) == null ? void 0 : i.call(r, ".jarmu-unit-ability-pill")) == null ? void 0 : o.dataset) == null ? void 0 : l.abilityRef, c = (v = (g = (h = (d = p.currentTarget) == null ? void 0 : d.closest) == null ? void 0 : h.call(d, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (a)
        try {
          y = await fromUuid(a);
      ...
      var i, o, l, d;
      p.preventDefault();
      const a = (o = (i = p.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, ".jarmu-unit-ability-pill"), c = (l = a == null ? void 0 : a.dataset) == null ? void 0 : l.abilityRef, y = (d = a == null ? void 0 : a.dataset) == null ? void 0 : d.abilityId, r = c || y;
      r && await this._postUnitAbilityToChat(r);
    });
    const f = (p) => {
      if (!p) return;
      const a = this._getFormDataForUpdate(p);
      Object.keys(a).length !== 0 && this.actor.update(a).catch((c) => console.warn("VoidJarmuSheet save failed", c));
    }, u = (p) => {
      var a, c, y;
      return p && (((c = (a = this.element) == null ? void 0 : a.contains) == null ? void 0 : c.call(a, p)) || this.id && ((y = p.closest) == null ? void 0 : y.call(p, `#${CSS.escape(this.id)}`)));
    };
    this._votvJarmuBlur = (p) => {
      ...
      var l, d, h;
      const a = p.currentTarget, c = (l = a == null ? void 0 : a.dataset) == null ? void 0 : l.itemId;
      if (!c) return;
      const y = this.actor.items.get(c);
      if (!y || y.type !== "Jarmuegyseg") return;
      const r = (a.value ?? "").trim(), i = r === "" ? 0 : Number(r), o = (d = a.closest) == null ? void 0 : d.call(a, ".jarmu-unit-row");
      if (o) {
      ...
      var i;
      const a = p.currentTarget, c = (i = a == null ? void 0 : a.dataset) == null ? void 0 : i.itemId;
      if (!c) return;
      const y = this.actor.items.get(c);
  ...
  async _rollUnitDamage(s) {
    var m, p, a, c, y, r, i, o, l;
    const e = this.actor;
    if (!e) return;
    const t = ((p = (m = e.items).get) == null ? void 0 : p.call(m, s)) ?? ((c = (a = e.items.contents) == null ? void 0 : a.find) == null ? void 0 : c.call(a, (d) => d.id === s));
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", p = f ? `<p>${f}</p>` : "", a = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${m}
      ${p}
...
function _s(I) {
  ...
  return (((e = I == null ? void 0 : I.items) == null ? void 0 : e.contents) ?? []).filter((t) => t.type === "Helyiseg").reduce((t, n) => {
    var f;
    return t + Ri((f = n.system) == null ? void 0 : f.veszely);
  }, 0);
}
var zs;
const nt = class nt extends Mt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var _, C, j, K, U, z, V;
      const a = ((_ = e.querySelector) == null ? void 0 : _.call(e, "form")) ?? e, c = (C = a.querySelector) == null ? void 0 : C.call(a, 'select[name="system.identity.assignment"]'), y = (j = a.querySelector) == null ? void 0 : j.call(a, 'select[name="system.identity.subAssignment"]'), r = (K = a.querySelector) == null ? void 0 : K.call(a, "input.bazis-threat-total"), i = (U = a.querySelector) == null ? void 0 : U.call(a, 'input[name="system.combat.threatBonus"]');
      if (!c || !r || !i) return;
      const o = c.value ?? "", l = (y == null ? void 0 : y.value) ?? "", d = t[o] ?? 0, h = n[l] ?? 0, g = (((V = (z = this.actor) == null ? void 0 : z.items) == null ? void 0 : V.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = _s(this.actor), O = d + h + k + w + T;
      r.value = O;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, m = f.assignment ?? "", p = f.subAssignment ?? "", a = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }, c = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[m] ?? 0, i = c[p] ?? 0, o = e.sizeForSelect ?? "Kicsi", l = y[o] ?? 0, d = Number(u.threatBonus ?? 0) || 0, h = _s(this.actor), g = r + i + l + d + h;
      e.system = foundry.utils.mergeObject(
...
X(nt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  M(nt, nt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((zs = M(nt, nt, "DEFAULT_OPTIONS")) == null ? void 0 : zs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Gt = nt;
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return e.egyebList = f.map((m) => {
      const a = ((m.system ?? {}).description ?? "").trim(), c = a ? a.length > 80 ? `${a.slice(0, 77)}…` : a : "";
      return {
        itemId: m.id,
        actorId: t.id,
        name: m.name ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    this.isEditable && (t.on("click", ".karakter-item-chat", async (f) => {
      var p, a, c, y;
      f.preventDefault();
      const u = (((a = (p = f.currentTarget) == null ? void 0 : p.dataset) == null ? void 0 : a.itemId) ?? ((y = (c = f.currentTarget) == null ? void 0 : c.getAttribute) == null ? void 0 : y.call(c, "data-item-id")) ?? "").trim();
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  M(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((js = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 }),
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (u) => {
      var a, c, y, r, i, o, l;
      if (!e.isEditable || !((c = (a = u.target) == null ? void 0 : a.closest) != null && c.call(a, ".profile")) && ((r = (y = u.target) == null ? void 0 : y.getAttribute) == null ? void 0 : r.call(y, "data-edit")) !== "img") return;
    ...
    const n = (u) => {
      ...
      var m, p, a;
      return u && (((p = (m = e.element) == null ? void 0 : m.contains) == null ? void 0 : p.call(m, u)) || e.id && ((a = u.closest) == null ? void 0 : a.call(u, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (u) => {
      var p, a, c;
      const m = ((p = u.target) == null ? void 0 : p.form) ?? ((c = (a = u.target) == null ? void 0 : a.closest) == null ? void 0 : c.call(a, "form"));
      f(m) && n(m);
...
const Fe = class Fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (u) => {
      ...
      const p = (m == null ? void 0 : m.form) ?? ((a = m == null ? void 0 : m.closest) == null ? void 0 : a.call(m, "form"));
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      try {
        ...
        if (!(this.element && d.includes(this.element) || this.id && ((o = (i = r.target) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, `#${CSS.escape(this.id)}`)))) return;
      ...
      var d, h, g, v, k, w;
      r.preventDefault();
      const i = (h = (d = r.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemRef, o = (v = (g = r.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.itemId;
      let l = null;
      if (i)
        try {
          l = await fromUuid(i);
      ...
      var d, h, g, v;
      r.preventDefault();
      const i = (h = (d = r.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemRef, o = (v = (g = r.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.itemId, l = i || o;
      l && await this._postAbilityToChat(l);
    ...
    const u = (r) => {
      ...
      var i, o, l;
      return r && (((o = (i = e.element) == null ? void 0 : i.contains) == null ? void 0 : o.call(i, r)) || e.id && ((l = r.closest) == null ? void 0 : l.call(r, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (r) => {
      var o, l, d;
      const i = ((o = r.target) == null ? void 0 : o.form) ?? ((d = (l = r.target) == null ? void 0 : l.closest) == null ? void 0 : d.call(l, "form"));
      m(i) && u(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
    ...
    const m = (await Promise.all(
      f.map(async (p) => {
        ...
        try {
          ...
          const c = (a = game.items) == null ? void 0 : a.get(p);
          if (c && (c.type === "Kepesseg" || c.type === "ability")) return c;
        }
        return null;
      })
    )).map((p, a) => ({ doc: p, ref: f[a] })).filter((p) => !!p.doc && !!p.ref).map(({ doc: p, ref: a }) => {
      var i, o;
      const c = (((i = p.system) == null ? void 0 : i.kind) ?? "passive").toString(), y = Number(((o = p.system) == null ? void 0 : o.kp) ?? 0) || 0, r = c === "species";
      return {
        id: p.id,
        ref: a,
        name: p.name,
...
const Te = class Te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".karakter-ability-open", async (c) => {
      var o, l, d, h, g, v;
      c.preventDefault();
      const y = (l = (o = c.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : l.itemRef, r = (h = (d = c.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemId;
      let i = null;
      if (y)
        try {
          i = await fromUuid(y);
      ...
      var o, l, d, h;
      c.preventDefault();
      const y = (l = (o = c.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : l.itemRef, r = (h = (d = c.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemId, i = y || r;
      i && await this._postAbilityToChat(i);
      ...
      if (!y) return;
      const r = this.document.system ?? {}, i = Array.isArray((g = r.abilities) == null ? void 0 : g.items) ? r.abilities.items.slice() : [], o = i.indexOf(y), l = o >= 0 ? [...i.slice(0, o), ...i.slice(o + 1)] : i;
    ...
    if (f && (f.addEventListener("dragover", (c) => {
      ...
      try {
        ...
        if (!(this.element && o.includes(this.element) || this.id && ((r = (y = c.target) == null ? void 0 : y.closest) == null ? void 0 : r.call(y, `#${CSS.escape(this.id)}`)))) return;
        let d = null;
        try {
    ...
    e._votvChange = (c) => {
      var r, i, o;
      const y = ((r = c.target) == null ? void 0 : r.form) ?? ((o = (i = c.target) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, "form"));
      m(y) && u(y);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
...
Hooks.once("init", () => {
  ...
  }, (t = CONFIG.Actor).dataModels ?? (t.dataModels = {}), CONFIG.Actor.dataModels.Karakter = pi, CONFIG.Actor.dataModels.Npc = Lt, CONFIG.Actor.dataModels.Jarmu = gi, CONFIG.Actor.dataModels.Bazis = vi, CONFIG.Actor.dataModels.Vallalkozas = Ei, (n = CONFIG.Item).dataModels ?? (n.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ws, CONFIG.Item.dataModels.weapon = ws, CONFIG.Item.dataModels.Pancel = Ii, CONFIG.Item.dataModels.MikroChip = Si, CONFIG.Item.dataModels.Kepesseg = Ts, CONFIG.Item.dataModels.ability = Ts, CONFIG.Item.dataModels.Targy = Di, CONFIG.Item.dataModels.Egyeb = _i, CONFIG.Item.dataModels.Jarmuegyseg = Li, CONFIG.Item.dataModels.Helyiseg = Fi, (f = CONFIG.Actor).trackableAttributes ?? (f.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health"],
    value: []
  }, CONFIG.Actor.trackableAttributes.Npc = {
    bar: ["", "resources.health"],
    value: []
  }, (u = CONFIG.Actor).typeLabels ?? (u.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", CONFIG.Actor.typeLabels.Jarmu = "Jármű", CONFIG.Actor.typeLabels.Bazis = "Bázis", CONFIG.Actor.typeLabels.Vallalkozas = "Vállalkozás", (m = CONFIG.Combat).initiative ?? (m.initiative = {}), CONFIG.Combat.initiative.formula = "1d20", (p = CONFIG.Item).typeLabels ?? (p.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.weapon = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", CONFIG.Item.typeLabels.Jarmuegyseg = "Járműegység", CONFIG.Item.typeLabels.Helyiseg = "Helyiség";
  ...
  Hooks.on("preCreateActor", (a, c, y) => {
    ((c == null ? void 0 : c.type) === "Bazis" || (c == null ? void 0 : c.type) === "Vallalkozas") && (c.img = s);
  }), Hooks.on("preUpdateActor", (a, c, y) => {
    ((a == null ? void 0 : a.type) === "Bazis" || (a == null ? void 0 : a.type) === "Vallalkozas") && Object.prototype.hasOwnProperty.call(c ?? {}, "img") && (c.img = s);
  }), Hooks.on("ready", () => {
    var y;
    const a = s, c = (((y = game.actors) == null ? void 0 : y.contents) ?? []).filter(
      (r) => (r.type === "Bazis" || r.type === "Vallalkozas") && (r.img ?? "").toString().trim() !== a
    );
    c.length && c.forEach((r) => r.update({ img: a }).catch(() => {
    }));
  }), Hooks.on("updateActor", (a, c, y, r) => {
  ...
  const e = 500;
  Hooks.on("updateActor", (a, c, y, r) => {
    var T, O, _, C, j, K, U, z, V, Z, J, Y, oe;
    const i = a == null ? void 0 : a.id;
    if (!i) return;
    if ((a.type === "Karakter" || a.type === "Npc") && ((T = c == null ? void 0 : c.system) != null && T.combat) && "initiativeResult" in c.system.combat) {
    ...
    if (a.type === "Npc" && ((K = c == null ? void 0 : c.system) != null && K.identity) && "size" in c.system.identity) {
      const R = si((z = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : z.size);
      a.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, O, _, C, j, K, U, z, V, Z, J, Y, oe, R, te, de, De, D;
    ...
    const a = u.itemId ? ((U = (K = p.items) == null ? void 0 : K.get) == null ? void 0 : U.call(K, u.itemId)) ?? ((Z = (V = (z = p.items) == null ? void 0 : z.contents) == null ? void 0 : V.find) == null ? void 0 : Z.call(V, (E) => E.id === u.itemId)) : null;
    let c = (u.damageFormula ?? "").trim();
    if (c || (c = (((J = a == null ? void 0 : a.system) == null ? void 0 : J.damage) ?? "").trim()), !c && u.slotKey && (c = (((((Y = p.system) == null ? void 0 : Y.weapons) ?? {})[u.slotKey] ?? {}).damage ?? "").trim()), !c) {
    ...
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = u.targetName || "", o = u.hitLocationName || "", l = ((a == null ? void 0 : a.name) ?? (u.slotKey ? ((D = (((De = p.system) == null ? void 0 : De.weapons) ?? {})[u.slotKey]) == null ? void 0 : D.name) ?? "" : "")) || "Fegyver";
    ...
    (e) => {
      ...
      const t = (a = (p = e.target) == null ? void 0 : p.closest) == null ? void 0 : a.call(p, "[data-document-id]"), n = (c = t == null ? void 0 : t.getAttribute) == null ? void 0 : c.call(t, "data-document-id");
      if (!n) return;
    ...
    for (const m of e) {
      const p = Ct.getTotalSpeedRaw(m), a = (n = m.effects) == null ? void 0 : n.find((c) => c.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (p <= 0 && !a) {
      ...
      } else p > 0 && a && await a.delete().catch(() => {
      });
    }
    ...
    for (const r of t)
      try {
        const i = r.prototypeToken, o = ((m = i == null ? void 0 : i.bar1) == null ? void 0 : m.attribute) ?? "", l = ((p = i == null ? void 0 : i.bar2) == null ? void 0 : p.attribute) ?? "";
        (o || l) && await r.update({
    ...
    for (const r of game.scenes ?? []) {
      const i = ((a = r.tokens) == null ? void 0 : a.filter((o) => {
        var l;
...
Hooks.on("preCreateToken", (I, s, e) => {
  ...
  if (f) {
    if (f.type === "Bazis")
      return (y = ui == null ? void 0 : ui.notifications) == null || y.warn(((c = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : c.call(a, "VOTV.BazisNoToken")) ?? "Bázis nem helyezhető tokenként a térképre."), !1;
    ...
    if (f.type === "Npc") {
      const l = si((o = (i = f.system) == null ? void 0 : i.identity) == null ? void 0 : o.size);
      I.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
function ii(I) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" && n.type !== "Npc" || n.update(zi).catch((f) => {
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var y, r, i, o;
  const t = ((y = I.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, u = t.weaponAttack, m = t.weapon, p = t.vsDefense, a = t.vsDefenseInfo;
  if (!n && !f && !u && !p) return;
  ...
  if (c) {
    ...
    if (!u && p && a) {
      const l = c.querySelector(".dice-total"), d = (l == null ? void 0 : l.parentElement) ?? c, h = !!a.isHit, g = a.targetName || "Célpont", v = a.hitLocationRoll, k = a.hitLocationName;
...
//# sourceMappingURL=vacuum-of-the-void-4aVXJRMI.mjs.map
