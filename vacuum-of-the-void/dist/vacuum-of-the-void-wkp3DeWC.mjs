...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-3SQUx_6o.mjs");
      o(this.actor, a);
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const l = s.currentTarget, a = l.dataset.skill, o = ((h = l.textContent) == null ? void 0 : h.trim()) || a, { openRollSheetForSkill: u } = await import("./roll-sheet-3SQUx_6o.mjs");
      u(this.actor, a, o);
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    (g = (p = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : p.call(e, r)) == null || g.forEach((f) => {
      ...
      var u, h, b, v;
      const s = ((h = (u = f.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : h.call(u, "[data-item-id]")) || f.currentTarget, l = (b = s == null ? void 0 : s.dataset) == null ? void 0 : b.itemId;
      if (!l || !this.actor) return;
      const a = this.actor.items.get(l);
      if (!a) return;
      const o = a.uuid;
      f.dataTransfer && (f.dataTransfer.setData("text/plain", o), f.dataTransfer.setData("application/json", JSON.stringify({ type: "Item", uuid: o })), f.dataTransfer.effectAllowed = "copyMove"), typeof ((v = f.dataTransfer) == null ? void 0 : v.setDragImage) == "function" && s && f.dataTransfer.setDragImage(s, 0, 0);
    });
    const d = this, n = (f) => {
      if (!f) return;
...
//# sourceMappingURL=vacuum-of-the-void-wkp3DeWC.mjs.map
