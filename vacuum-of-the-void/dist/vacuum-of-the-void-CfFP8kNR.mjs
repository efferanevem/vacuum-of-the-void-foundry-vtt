...
const { HTMLField: ps, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: Ge } = foundry.data.fields;
...
const { NumberField: nt, SchemaField: fs } = foundry.data.fields;
class ys extends is {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: gs, NumberField: qs, StringField: Ie } = foundry.data.fields;
...
const { BooleanField: hs, StringField: st } = foundry.data.fields;
...
const { NumberField: rt, StringField: Mt } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var ye, ke, ge, _e, Ce, Ze, Ve, et, tt, He, Pe, yt, gt, ht, bt, kt, vt, wt, It, St, Tt, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((ge = (ke = (ye = this.actor.system) == null ? void 0 : ye.resources) == null ? void 0 : ke.stress) == null ? void 0 : ge.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, a = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const _ = ((_e = d[y]) == null ? void 0 : _e.value) ?? 0, C = a[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Ze = (Ce = this.actor.system) == null ? void 0 : Ce.combat) == null ? void 0 : Ze.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const r = (Number(((et = (Ve = this.actor.system) == null ? void 0 : Ve.combat) == null ? void 0 : et.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: r } },
      { inplace: !1 }
    );
    const m = ((tt = e.system) == null ? void 0 : tt.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (T.slotOrder ?? "").trim(), A = P ? P.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], D = (He = this.actor.system.gear) == null ? void 0 : He.microchips, E = D && typeof D == "object" && !Array.isArray(D) ? D : {}, N = (((Pe = E.slot1) == null ? void 0 : Pe.itemId) ?? "").trim(), j = (((yt = E.slot2) == null ? void 0 : yt.itemId) ?? "").trim(), B = (((gt = E.slot3) == null ? void 0 : gt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
    ...
    e.actionsTable = G;
    const V = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((y) => y.type === "Fegyver"), F = V.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = F;
    ...
    e.weaponsTable = V.map((y) => {
      ...
      let C = null, L = {};
      for (const it of A)
        if ((((Ft = T[it]) == null ? void 0 : Ft.itemId) ?? "").trim() === _) {
          C = it, L = T[it] ?? {};
          break;
        }
      const M = !!C, ee = (($t = y.system) == null ? void 0 : $t.equipped) !== void 0 && ((xt = y.system) == null ? void 0 : xt.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, Ue = typeof Z.range == "string" ? (Z.range || "").trim() : "", oe = Z.type ?? "", Oe = (ne[oe] ?? oe) || "—", he = Z.size ?? "", qe = (re[he] ?? he) || "", Le = [Oe, qe].filter(Boolean).join(", ") || Oe || "—", ve = oe === "projectile" || he === "thrown", we = Z.quantity, ze = we != null ? String(we).trim() : "1", Ae = String(L.bonus ?? "").trim(), Be = String(Z.bonus ?? "").trim(), cs = Ae || Be || "0";
      return {
        slotKey: C ?? "",
        itemId: _,
    ...
    const Se = (((bt = this.actor.items) == null ? void 0 : bt.contents) ?? []).filter((y) => y.type === "Pancel");
    ...
    const Te = (((kt = this.actor.items) == null ? void 0 : kt.contents) ?? []).filter((y) => y.type === "Targy");
    ...
    const be = (((vt = this.actor.items) == null ? void 0 : vt.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const se = (((wt = this.actor.items) == null ? void 0 : wt.contents) ?? []).filter((y) => y.type === "MikroChip"), ae = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Ee = "— Nincs Mikro-Chip —", Fe = ["slot1", "slot2", "slot3"], Ne = (y) => {
      var C, L, M;
      const _ = [];
    ...
    e.microchipItemsSlot1 = ae.filter((y) => !Ne(1).includes(y.id)), e.microchipItemsSlot2 = ae.filter((y) => !Ne(2).includes(y.id)), e.microchipItemsSlot3 = ae.filter((y) => !Ne(3).includes(y.id)), e.microchipSlots = Fe.map((y) => {
      const _ = E[y] ?? {}, C = (_.itemId ?? "").trim(), L = se.find((M) => M.id === C);
      return {
        slotKey: y,
        itemId: C,
        displayName: (L == null ? void 0 : L.name) || _.name || Ee,
        img: (L == null ? void 0 : L.img) || "",
        active: _.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const _ = `slot${y}`, C = E[_] ?? {}, L = (C.itemId ?? "").trim(), M = ae.find((ee) => ee.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || C.name || Ee, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    ...
    const We = (((It = e.weaponsTable) == null ? void 0 : It.length) ?? 0) > 0 || (((St = e.armorTable) == null ? void 0 : St.length) ?? 0) > 0 || (((Tt = e.microchipsTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((Dt = e.itemsTable) == null ? void 0 : Dt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !We;
    const $e = this.actor.system.abilities ?? {}, Ye = (((_t = this.actor.items) == null ? void 0 : _t.contents) ?? []).map((y) => {
      var _, C, L;
      return {
        id: y.id,
        name: y.name,
    ...
    }), xe = new Map(Ye.map((y) => [y.id, y])), Je = "— Nincs képesség —", Re = (y) => {
      const _ = $e[y] ?? {}, C = (_.itemId ?? "").trim(), L = C ? xe.get(C) : null, M = (L == null ? void 0 : L.description) ?? "", ee = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: C,
    ...
    e.abilityFajiSlot = Re("faji"), e.abilityHatterSlot = Re("hatter");
    const Me = (y) => {
      const _ = $e[y];
    ...
    e.abilityPassiveList = Ke(Me("passive")), e.abilityActiveList = Ke(Me("active"));
    const Qe = ((Ct = e.system) == null ? void 0 : Ct.resources) ?? {}, Xe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], De = (qt = (Ot = e.system) == null ? void 0 : Ot.combat) == null ? void 0 : qt.initiativeResult, k = typeof De == "number" ? De : -1, x = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], R = (Nt = (Lt = e.system) == null ? void 0 : Lt.combat) == null ? void 0 : Nt.initiativeRanges, H = Array.isArray(R) ? R.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [], fe = H.length > 0 ? H : x;
    e.initiativeRanges = H;
    let X = 0;
    if (typeof k == "number" && k >= 0) {
      const y = fe.find((_) => k >= _.min && k <= _.max);
      y && (X = y.kp);
    }
    e.kpDots = Xe.map((y, _) => {
      const C = _ + 1, L = !!Number(Qe[y]), M = C <= X;
      return { index: C, used: L, usable: M };
    });
    const je = !!((At = (Pt = game.combat) == null ? void 0 : Pt.combatants) != null && At.some((y) => {
      var _;
      return ((_ = y.actor) == null ? void 0 : _.type) === "Karakter";
    }));
    return e.showHarcSection = je, e.canEditInitiative = !!((Et = game.user) != null && Et.isGM), e.showInitiativeResult = typeof De == "number", e.initiativeResult = e.showInitiativeResult ? De : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-Cik4W4nT.mjs");
      r(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-Cik4W4nT.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-Cik4W4nT.mjs");
      m(this.actor, o, r);
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Se, Te, be, se, ae, Ee, Fe, Ne, We, $e, Ye, xe, Je, Re, Me, Ke, Qe, Xe, De;
    ...
    e.weaponSlots = o.map((k) => {
      const x = d[k] ?? {}, R = (x.itemId ?? "").trim(), H = g.find((fe) => fe.id === R);
      return {
        slotKey: k,
        itemId: R,
    ...
    e.weaponsTable = p.map((k) => {
      ...
      let R = null, H = {};
      for (const Pe of c)
        if ((((He = d[Pe]) == null ? void 0 : He.itemId) ?? "").trim() === x) {
          R = Pe, H = d[Pe] ?? {};
          break;
        }
      const fe = !!R, X = (k == null ? void 0 : k.system) ?? {}, je = typeof X.range == "string" ? (X.range || "").trim() : "", ye = X.type ?? "", ke = (r[ye] ?? ye) || "—", ge = X.size ?? "", _e = (m[ge] ?? ge) || "", Ce = [ke, _e].filter(Boolean).join(", ") || ke || "—", Ze = ye === "projectile" || ge === "thrown", Ve = X.quantity != null ? String(X.quantity).trim() : "1", et = String(X.bonus ?? H.bonus ?? "").trim() || "0", tt = (X.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    const v = ((Fe = (Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.gear) == null ? void 0 : Fe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      ...
      const H = ((ke = k == null ? void 0 : k.system) == null ? void 0 : ke.abilityType) ?? "", fe = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", X = (((ge = k == null ? void 0 : k.system) == null ? void 0 : ge.description) ?? "").trim(), je = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const A = (((Ne = e.weaponsTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((We = e.armorTable) == null ? void 0 : We.length) ?? 0) > 0 || ((($e = e.microchipsTable) == null ? void 0 : $e.length) ?? 0) > 0 || (((Ye = e.itemsTable) == null ? void 0 : Ye.length) ?? 0) > 0 || (((xe = e.egyebList) == null ? void 0 : xe.length) ?? 0) > 0;
    ...
    const G = t == null ? void 0 : t.id, V = !!((Me = (Re = game.combat) == null ? void 0 : Re.combatants) != null && Me.some(
      (k) => {
        var x;
    ...
    e.showHarcSection = V;
    const F = ((Ke = e.system) == null ? void 0 : Ke.resources) ?? {}, Y = (Xe = (Qe = e.system) == null ? void 0 : Qe.combat) == null ? void 0 : Xe.initiativeResult, Q = typeof Y == "number" ? Y : -1;
    let ne = 0;
    ...
    return e.kpDots = re.map((k, x) => {
      const R = x + 1, H = !!Number(F[k]), fe = R <= ne;
      return { index: R, used: H, usable: fe };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Cik4W4nT.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Cik4W4nT.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-Cik4W4nT.mjs");
      r(this.actor, c, o);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, p, g) => {
    ...
    if (l.type === "Npc" && ((D = f == null ? void 0 : f.system) != null && D.identity) && "size" in f.system.identity) {
      const F = rs((N = (E = l.system) == null ? void 0 : E.identity) == null ? void 0 : N.size);
      l.update({
...
//# sourceMappingURL=vacuum-of-the-void-CfFP8kNR.mjs.map
