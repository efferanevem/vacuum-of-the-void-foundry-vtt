...
var mt = Reflect.get;
var pt = (N, i, e) => i in N ? ut(N, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[i] = e;
var R = (N, i, e) => pt(N, typeof i != "symbol" ? i + "" : i, e);
var x = (N, i, e) => mt(dt(N), e, i);
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Oe, _e, Le, Ae, Fe, Ee, Ne, Ce, $e, Pe, xe, je, Ke, Me, Re, Be, Ue, He;
    ...
    const v = e.computedHealthStatus.legs ?? 3, o = Number(((Ee = (Fe = this.actor.system) == null ? void 0 : Fe.combat) == null ? void 0 : Ee.givenSpeed) ?? 0) || 0;
    let l;
    v === 0 ? l = 0 : v === 1 ? l = -6 : v === 2 ? l = -3 : l = o;
    const r = this._getTotalArmorSpeedPenalty();
    l += r, e.effectiveGivenSpeed = l;
    const m = (Number(((Ce = (Ne = this.actor.system) == null ? void 0 : Ne.combat) == null ? void 0 : Ce.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const b = this.actor.system.weapons ?? {}, I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (b.slotOrder ?? "").trim(), F = A ? A.split(/\s*,\s*/).filter((d) => I.includes(d)) : [], O = ($e = this.actor.system.gear) == null ? void 0 : $e.microchips, L = O && typeof O == "object" && !Array.isArray(O) ? O : {}, g = (((Pe = L.slot1) == null ? void 0 : Pe.itemId) ?? "").trim(), E = (((xe = L.slot2) == null ? void 0 : xe.itemId) ?? "").trim(), M = (((je = L.slot3) == null ? void 0 : je.itemId) ?? "").trim(), st = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, k) => {
      ...
      let j = null;
      q && (g === d.id ? j = "slot1" : E === d.id ? j = "slot2" : M === d.id && (j = "slot3"));
    ...
    const ke = "— Nincs Mikro-Chip —", ce = (d) => {
      const k = [];
      return d !== 1 && k.push(g), d !== 2 && k.push(E), d !== 3 && k.push(M), k;
    };
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-BwPsdU72.mjs");
      c(this.actor, r);
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      o.preventDefault();
      const l = o.currentTarget, r = l.dataset.skill, c = ((f = l.textContent) == null ? void 0 : f.trim()) || r, { openRollSheetForSkill: m } = await import("./roll-sheet-BwPsdU72.mjs");
      m(this.actor, r, c);
      ...
      if (l) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (m) {
            ...
            if (O.length > 0) {
              const g = {
                "system.weapons.slotOrder": F.filter((E) => !O.includes(E)).join(",")
              };
              for (const E of O)
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, p, y) => {
    ...
    const f = (L = game.votv) == null ? void 0 : L._lastKarakterSheetBlurSave, b = f && Date.now() - f.at < N ? f.appId : null;
    setTimeout(() => {
      for (const g of l)
...
//# sourceMappingURL=vacuum-of-the-void-DY6TXk3P.mjs.map
