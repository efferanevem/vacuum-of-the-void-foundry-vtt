...
function ft(A) {
  ...
  d(A.terms, 1);
  const a = s.filter((i) => i === 6).length, l = s.filter((i) => i === 1).length, f = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, g = a + f, h = l + m;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const m = this.element, g = this.form ?? this.element, h = l.scrollState, i = l.focus, r = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", o = () => {
      var u, p;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const c = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (f = c.hitLocations) == null ? void 0 : f[t]) == null ? void 0 : m.value) ?? 0, a = ((g = c.currentHealth) == null ? void 0 : g[t]) ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BNAvXRjH.mjs");
      n(this.actor, o);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || o, { openRollSheetForSkill: u } = await import("./roll-sheet-BNAvXRjH.mjs");
      u(this.actor, o, n);
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", c = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const l = a && a.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, g = (((v = a == null ? void 0 : a.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(c[g] || 0) || 0, i = f + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, n = new Roll(o);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const a = await super.render(s, e), l = this.element, f = this.form ?? this.element, m = d.scrollState, g = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var r, o;
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const he = !!x, W = (k == null ? void 0 : k.system) ?? {}, Le = typeof W.range == "string" ? (W.range || "").trim() : "", fe = W.type ?? "", be = (u[fe] ?? fe) || "—", ye = W.size ?? "", Te = (p[ye] ?? ye) || "", _e = [be, Te].filter(Boolean).join(", ") || be || "—", Me = fe === "projectile" || ye === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: N,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var n;
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget, o = (((n = r == null ? void 0 : r.dataset) == null ? void 0 : n.slot) ?? "").trim();
      !o || !this.actor || await this._rollWeapon(o);
    }), t.on("click", ".karakter-weapon-damage", async (i) => {
      var n, u, p, b, v;
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget;
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-BNAvXRjH.mjs");
      u(this.actor, o, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, o, n, u, p, b, v, I, C, q, O, T;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), F = ((u = a.system) == null ? void 0 : u.abilities) ?? {}, H = E === "active" ? "active" : "passive", U = Array.isArray((p = F[H]) == null ? void 0 : p.items) ? F[H].items.slice() : Array.isArray(F[H]) ? F[H].slice() : [];
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (a) => {
      var f, m, g;
      const l = ((f = a.target) == null ? void 0 : f.form) ?? ((g = (m = a.target) == null ? void 0 : m.closest) == null ? void 0 : g.call(m, "form"));
      d(l) && c(l);
...
Hooks.on("renderChatMessageHTML", (A, s, e) => {
  var m, g, h, i;
  const t = ((m = A.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, c = t.resultType, d = t.critLabel, a = t.weaponAttack, l = t.weapon;
  if (!c && !d && !a) return;
  ...
  if (f) {
    ...
    if (a && l && (l.actorId || (h = A.speaker) != null && h.actor)) {
      ...
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((i = A.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(A.id ?? ""), o.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-L9eMmnRq.mjs.map
