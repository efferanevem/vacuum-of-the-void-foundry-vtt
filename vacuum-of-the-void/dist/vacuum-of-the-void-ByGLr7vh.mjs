...
var St = Reflect.get;
var Tt = (A, s, e) => s in A ? kt(A, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : A[s] = e;
var K = (A, s, e) => Tt(A, typeof s != "symbol" ? s + "" : s, e);
var E = (A, s, e) => St(It(A), e, s);
...
const { BooleanField: Ct, StringField: ce } = foundry.data.fields;
...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ae, Ee, Ne, Pe, $e, xe, Me, je, Ke, Re, Ue, He, Be, Ge, ze, We, Ye, Qe;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((Ne = (Ee = (Ae = this.actor.system) == null ? void 0 : Ae.resources) == null ? void 0 : Ee.stress) == null ? void 0 : Ne.value) || 0;
    e.stressOver10 = t > 10;
    ...
    return e.abilityPassiveList = Ce(Fe("passive")), e.abilityActiveList = Ce(Fe("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-oagPuE7S.mjs");
      d(this.actor, u);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const c = n.currentTarget, u = c.dataset.skill, d = ((f = c.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-oagPuE7S.mjs");
      m(this.actor, u, d);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const g = d.system.weapons ?? {}, S = (g.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = S ? S.split(/\s*,\s*/).filter((D) => O.includes(D)) : [], C = F.find((D) => {
          var v;
          return (((v = g[D]) == null ? void 0 : v.itemId) ?? "").trim() === u;
        });
        if (C) {
          const D = F.filter((v) => v !== C);
          f["system.weapons.slotOrder"] = D.join(","), f[`system.weapons.${C}.itemId`] = "", f[`system.weapons.${C}.name`] = "", f[`system.weapons.${C}.damage`] = "", f[`system.weapons.${C}.bonus`] = "";
        }
      }
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((C = d == null ? void 0 : d.system) == null ? void 0 : C.damage) ?? "",
      ...
      const C = f ? this.actor.items.get(f) : null, D = {
        [`system.gear.microchips.${m}.itemId`]: f,
        [`system.gear.microchips.${m}.name`]: (C == null ? void 0 : C.name) ?? ""
      };
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((C = d.system) == null ? void 0 : C.damage) ?? "",
      ...
      if (d) {
        ...
        if (m && m.documentName === "Item" && (m.type === "Kepesseg" || m.type === "ability")) {
          ...
          if (((i = m.parent) == null ? void 0 : i.id) !== this.actor.id) {
            ...
            f = ((a = (await this.actor.createEmbeddedDocuments("Item", [C]))[0]) == null ? void 0 : a.id) ?? f;
          }
    ...
    if (e) {
      ...
      if (d) {
        ...
        if (m && m.documentName === "Item" && m.type === "Fegyver") {
          ...
          if (g) {
            const O = ((w = f.system) == null ? void 0 : w.weapons) ?? {}, F = (O.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = F ? F.split(/\s*,\s*/).filter((N) => C.includes(N)) : [], v = D.filter((N) => {
              var x;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = _t, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Ft, CONFIG.Item.dataModels.Pancel = At, CONFIG.Item.dataModels.MikroChip = Et, CONFIG.Item.dataModels.Kepesseg = Ve, CONFIG.Item.dataModels.ability = Ve, CONFIG.Item.dataModels.Targy = Pt, CONFIG.Item.dataModels.Egyeb = xt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (r, l, p, y) => {
    ...
    for (const v of d)
      ((O = v.document) == null ? void 0 : O.id) !== h || ((F = v.document) == null ? void 0 : F.documentName) !== "Actor" || ((C = v.constructor) == null ? void 0 : C.name) !== "VoidKarakterSheet" || c.includes(v) || c.push(v);
    if (n && c.some((v) => {
      const N = (v == null ? void 0 : v.form) ?? (v == null ? void 0 : v.element);
      return N && N.contains(w);
    })) return;
    const f = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, g = f && Date.now() - f.at < A ? f.appId : null;
    setTimeout(() => {
      for (const v of c)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    var e, t;
    try {
      const i = ((e = CONFIG.Scene) == null ? void 0 : e.documentClass) ?? ((t = game.scenes) == null ? void 0 : t.documentClass);
      if (!(i != null && i.create)) {
      ...
      }, r = await i.create(a, { parent: game });
      r && console.log("Vacuum of the Void | Default scene created:", r.id);
    } catch (i) {
      console.warn("Vacuum of the Void | Default scene creation failed:", i);
    }
  })();
});
...
//# sourceMappingURL=vacuum-of-the-void-ByGLr7vh.mjs.map
