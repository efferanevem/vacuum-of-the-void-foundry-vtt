...
const J = class J extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponItems = G;
    const Y = "— Nincs fegyver —", Q = F.filter((b) => {
      const L = ((_[b] ?? {}).itemId ?? "").trim();
      return L ? !!E.find((j) => j.id === L) : !1;
    });
    e.weaponSlots = Q.map((b, N) => {
      const L = _[b] ?? {}, P = (L.itemId ?? "").trim(), j = G.find((Se) => Se.id === P), oe = E.find((Se) => Se.id === P), ne = (oe == null ? void 0 : oe.system) ?? {}, Xe = ne.size === "thrown", ve = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: P,
        slotNum: N + 1,
    ...
    e.weaponsTable = E.map((b) => {
      ...
      const j = !!L, oe = ((us = b.system) == null ? void 0 : us.equipped) !== void 0 && ((ds = b.system) == null ? void 0 : ds.equipped) !== null ? !!b.system.equipped : j, ne = (b == null ? void 0 : b.system) ?? {}, Xe = typeof ne.range == "string" ? (ne.range || "").trim() : "", ve = ne.type ?? "", Se = (se[ve] ?? ve) || "—", Ee = ne.size ?? "", Qe = (X[Ee] ?? Ee) || "", Ze = [Se, Qe].filter(Boolean).join(", ") || Se || "—", $e = ve === "projectile" || Ee === "thrown", xe = ne.quantity, kt = xe != null ? String(xe).trim() : "1", nt = String(P.bonus ?? "").trim(), wt = String(ne.bonus ?? "").trim(), Us = nt || wt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    e.microchipItemsSlot1 = le.filter((b) => !Ne(1).includes(b.id)), e.microchipItemsSlot2 = le.filter((b) => !Ne(2).includes(b.id)), e.microchipItemsSlot3 = le.filter((b) => !Ne(3).includes(b.id)), e.microchipSlots = ge.map((b) => {
      ...
      let L = null;
      for (const xe of ge)
        if ((((Ee = B[xe]) == null ? void 0 : Ee.itemId) ?? "").trim() === N) {
          L = xe;
          break;
        }
    ...
    e.abilityPassiveList = Fe(Ke("passive")), e.abilityActiveList = Fe(Ke("active"));
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-Dm_BSJqh.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-Dm_BSJqh.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-Dm_BSJqh.mjs");
      g(this.actor, c, a);
...
const pe = class pe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var je, Ke, Fe, ze, st, Ue, we, Tt, He, Be, Et, Pe, Ge, Dt, _t, ot, Ot, ct, lt, ut, dt, mt, pt, ft, yt, gt, Ve, ht, bt, We;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((je = this.actor) == null ? void 0 : je.system), e.showDeathSkull = !1, e.sizeForSelect = (((Fe = (Ke = e.system) == null ? void 0 : Ke.identity) == null ? void 0 : Fe.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((ze = e.system) == null ? void 0 : ze.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, l = (Ue = (st = t == null ? void 0 : t.statuses) == null ? void 0 : st.has) != null && Ue.call(st, "lookaround") ? 1 : 0, m = (Tt = (we = t == null ? void 0 : t.statuses) == null ? void 0 : we.has) != null && Tt.call(we, "halfcover") ? 3 : 0, u = (Be = (He = t == null ? void 0 : t.statuses) == null ? void 0 : He.has) != null && Be.call(He, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + l + m + u;
    const d = ((Et = t == null ? void 0 : t.items) == null ? void 0 : Et.contents) ?? [], p = ((Pe = t == null ? void 0 : t.system) == null ? void 0 : Pe.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (p.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((w) => y.includes(w)) : [], o = d.filter((w) => w.type === "Fegyver"), c = o.map((w) => ({ id: w.id, name: w.name, img: w.img })), a = "— Nincs fegyver —", g = i.length > 0 ? i : y, h = y.filter((w) => !g.includes(w)), v = [...g, ...h], I = v.filter((w) => {
      var R;
    ...
    e.weaponsTable = o.map((w) => {
      ...
      const he = !!R, te = (w == null ? void 0 : w.system) ?? {}, Te = typeof te.range == "string" ? (te.range || "").trim() : "", Ie = te.type ?? "", be = (T[Ie] ?? Ie) || "—", Ae = te.size ?? "", Je = (D[Ae] ?? Ae) || "", Ye = [be, Je].filter(Boolean).join(", ") || be || "—", Ct = Ie === "projectile" || Ae === "thrown", qt = te.quantity != null ? String(te.quantity).trim() : "1", Lt = String(te.bonus ?? U.bonus ?? "").trim() || "0", Nt = (te.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: x,
        actorId: t.id,
    ...
    const V = ((ut = t == null ? void 0 : t.system) == null ? void 0 : ut.abilities) ?? {}, W = d.filter((w) => w.type === "Kepesseg" || w.type === "ability").map((w) => {
      var x, R, U;
      return {
        id: w.id,
        name: w.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-Dm_BSJqh.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Dm_BSJqh.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-Dm_BSJqh.mjs");
      a(this.actor, o, c);
  ...
  async _onDropItem(s, e) {
    ...
    if (f.type === "Fegyver" && d) {
      const F = ((D = l.system) == null ? void 0 : D.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (F.slotOrder ?? "").trim(), V = B ? B.split(/\s*,\s*/).filter((ee) => H.includes(ee)) : [];
      let W = H.find((ee) => {
        var k;
        return !(((k = F[ee]) == null ? void 0 : k.itemId) ?? "").trim();
      });
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      const E = (k == null ? void 0 : k.system) ?? {}, G = E.type ?? "", Y = (n[G] ?? G) || "—", Q = E.size ?? "", se = (f[Q] ?? Q) || "", X = [Y, se].filter(Boolean).join(", ") || Y || "—", ae = G === "projectile" || Q === "thrown", ue = E.quantity != null ? String(E.quantity).trim() : "1", me = (typeof E.range == "string" ? (E.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: this.actor.id,
    ...
    e.microchipsTable = d.map((k) => {
      var ae, ue, me;
      const E = ((ae = k == null ? void 0 : k.system) == null ? void 0 : ae.abilityType) ?? "", G = E === "active" ? "Aktív" : E === "passive" ? "Passzív" : E || "—", Y = E === "active", Q = Number((ue = k == null ? void 0 : k.system) == null ? void 0 : ue.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0, se = (((me = k == null ? void 0 : k.system) == null ? void 0 : me.description) ?? "").trim(), X = se ? se.length > 60 ? se.slice(0, 57) + "…" : se : "—";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.itemsTable = p.map((k) => {
      const E = (k == null ? void 0 : k.system) ?? {}, G = (E.description ?? "").trim(), Y = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—", Q = E.quantity != null ? String(E.quantity).trim() : "1";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    let i = 0, o = 0;
    for (const k of y) {
      const E = (k == null ? void 0 : k.system) ?? {}, G = E.health ?? {}, Y = Number(E.level ?? 0) || 0, Q = Number(G.max ?? 0) || 0, se = Number(G.value ?? 0) || 0;
      let X;
      if (Q <= 0)
        X = void 0;
      else if (se <= 0)
      ...
      const ae = (E.hit ?? "").toString().trim(), ue = (E.speed ?? "").toString().trim().replace(",", "."), me = Number(ue);
      Number.isFinite(me) && (i += me);
      const et = (E.range ?? "").toString().trim().replace(",", "."), le = Number(et);
      Number.isFinite(le) && (o += le);
      const Me = (E.damage ?? "").toString().trim(), ge = E.abilities ?? {}, Ne = Array.isArray(ge.items) ? ge.items : [], tt = (await Promise.all(
        Ne.map(async (ie) => {
          var ye;
          if (!ie) return null;
          try {
        ...
        var Fe, ze;
        const re = (((Fe = ie.system) == null ? void 0 : Fe.kind) ?? "passive").toString(), je = Number(((ze = ie.system) == null ? void 0 : ze.kp) ?? 0) || 0, Ke = re === "species";
        return {
          id: ie.id,
          ref: ye,
          name: ie.name,
...
Z(Oe, "PARTS", foundry.utils.mergeObject(K(Oe, Oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Es = K(Oe, Oe, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !1 })
}));
let Ut = Oe;
var Fs;
...
Z(Ce, "PARTS", foundry.utils.mergeObject(K(Ce, Ce, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Fs = K(Ce, Ce, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !0 })
}));
let Ht = Ce;
var Ps;
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (u, d, p, y) => {
    var T, D, C, _, q, M, F, H, B, V, W, ce, ee;
      ...
      if (G) {
        ...
        for (const Q of Y)
          if (((q = Q.actor) == null ? void 0 : q.id) === r || Q.actorId === r) {
            G.updateEmbeddedDocuments("Combatant", [{ _id: Q.id, initiative: E }]).catch(() => {
            });
            break;
          }
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, I, T, D, C, _, q, M, F, H, B, V, W, ce, ee, k, E, G, Y, Q, se;
    ...
    if (u || (u = ((M = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : M.flatMap((ae) => {
      var ue;
      return ((ue = ae.tokens) == null ? void 0 : ue.contents) ?? [];
    }).map((ae) => ae.actor).find((ae) => ae && (ae.id === m || ae.id === l.actorId))) ?? null), !u) return;
    const d = l.itemId ? ((H = (F = u.items) == null ? void 0 : F.get) == null ? void 0 : H.call(F, l.itemId)) ?? ((W = (V = (B = u.items) == null ? void 0 : B.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (X) => X.id === l.itemId)) : null;
    let p = (l.damageFormula ?? "").trim();
    if (p || (p = (((ce = d == null ? void 0 : d.system) == null ? void 0 : ce.damage) ?? "").trim()), !p && l.slotKey && (p = (((((ee = u.system) == null ? void 0 : ee.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !p) {
    ...
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = l.targetName || "", o = l.hitLocationName || "", c = ((d == null ? void 0 : d.name) ?? (l.slotKey ? ((se = (((Q = u.system) == null ? void 0 : Q.weapons) ?? {})[l.slotKey]) == null ? void 0 : se.name) ?? "" : "")) || "Fegyver";
    ...
    for (const m of e) {
      const u = St.getTotalSpeedRaw(m), d = (n = m.effects) == null ? void 0 : n.find((p) => p.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (u <= 0 && !d) {
...
//# sourceMappingURL=vacuum-of-the-void-DM_UFKtt.mjs.map
