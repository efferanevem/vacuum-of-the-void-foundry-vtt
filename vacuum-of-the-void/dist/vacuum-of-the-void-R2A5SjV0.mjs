...
const { HTMLField: _t, NumberField: _, SchemaField: P, StringField: b, BooleanField: U, ArrayField: le } = foundry.data.fields;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const m = this.element, y = this.form ?? this.element, h = n.scrollState, a = n.focus, u = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", o = () => {
      var c, g;
    ...
    return (u || a) && (requestAnimationFrame(o), setTimeout(o, 0), setTimeout(o, 50), setTimeout(o, 150), setTimeout(o, 300), setTimeout(o, 450)), f;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((u = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : u.resources) ?? {}, p = ((l = (o = r.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : l.value) ?? 0, s = ((c = r.currentHealth) == null ? void 0 : c.legs) ?? 0, n = x._healthStatusFromRatio(s, p), f = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(i) {
    ...
    const v = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (v.slotOrder ?? "").trim(), D = q ? q.split(/\s*,\s*/).filter((d) => S.includes(d)) : [], C = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), E = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), A = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, I) => {
      ...
      for (let ie = 0; ie < D.length; ie++) {
        ...
        if ((((X = v[re]) == null ? void 0 : X.itemId) ?? "") === d.id) {
          T = ie + 1, L = ((ee = v[re]) == null ? void 0 : ee.bonus) ?? "", j = re;
          break;
        }
      }
      let K = null;
    ...
    e.weaponSlots = pt.map((d, I) => {
      const w = v[d] ?? {}, T = (w.itemId ?? "").trim(), L = Se.find((j) => j.id === T);
      return {
        slotKey: d,
        itemId: T,
        slotNum: I + 1,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Igqr97Ft.mjs");
      l(this.actor, o);
      ...
      if (!o) {
        ...
        if (!v) return;
        o = (((((c = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : c.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      o && await this._rollWeaponDamage(o, ((g = u.dataset.slot) == null ? void 0 : g.trim()) ?? "");
    }), !this.isEditable) return;
    const r = (a) => {
      var l;
      const u = a ? a.currentTarget : (l = e.querySelector) == null ? void 0 : l.call(e, 'input[name="system.resources.stress.value"]');
      if (!u) return;
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      a.preventDefault();
      const u = a.currentTarget, o = u.dataset.skill, l = ((g = u.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: c } = await import("./roll-sheet-Igqr97Ft.mjs");
      c(this.actor, o, l);
    }), t.on("click", ".karakter-roll-morale-d8", (a) => {
      a.preventDefault(), this._rollMorale();
    }), t.on("click", ".karakter-weapon-slot-display", (a) => {
      var S, q, D, C, O, k, E;
      a.preventDefault();
      const o = a.currentTarget.closest(".karakter-weapon-slot"), l = o == null ? void 0 : o.dataset.slot;
      if (!l) return;
      const g = (((q = (((S = this.actor.system) == null ? void 0 : S.weapons) ?? {})[l]) == null ? void 0 : q.itemId) ?? "").trim();
      if (!g) return;
      const v = ((C = (D = this.actor.items).get) == null ? void 0 : C.call(D, g)) ?? ((k = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : k.call(O, (A) => A.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      const u = a.currentTarget, o = u.dataset.itemId;
      if (!o) return;
      const l = this.actor.items.get(o);
      if (!l) return;
      ...
      if ((c == null ? void 0 : c.type) === "Fegyver") {
        const v = l.system.weapons ?? {}, S = (v.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = S ? S.split(/\s*,\s*/).filter((O) => q.includes(O)) : [], C = D.find((O) => {
          var k;
      ...
      var C, O;
      const u = a.currentTarget, o = (u.dataset.itemId ?? "").trim();
      if (!o) return;
      const l = this.actor.items.get(o);
      ...
      var k;
      a.preventDefault();
      const u = a.currentTarget, o = u.closest(".karakter-microchip-slot-select-wrap"), l = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), c = l == null ? void 0 : l.dataset.slot;
      if (!c) return;
      const g = (u.dataset.itemId ?? "").trim(), v = (u.dataset.itemName ?? ((k = u.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (u.dataset.itemImg ?? "").trim(), q = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      q && (q.textContent = v);
      ...
      var v;
      if (a.preventDefault(), !a.altKey) return;
      const u = a.currentTarget.dataset.area, o = a.currentTarget.dataset.itemId;
      if (!u || !o) return;
      const l = this.actor.system.abilities ?? {}, g = (Array.isArray((v = l[u]) == null ? void 0 : v.items) ? l[u].items.slice() : []).filter((S) => S !== o);
    ...
    const n = this, f = (a) => {
      ...
      const o = ((c = (l = u.system) == null ? void 0 : l.resources) == null ? void 0 : c.currentHealth) != null || ((v = (g = u.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      n.actor.update(u).then(() => {
        o && setTimeout(() => n.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, m = (a) => {
      var u, o, l;
      return a && (((o = (u = n.element) == null ? void 0 : u.contains) == null ? void 0 : o.call(u, a)) || n.id && ((l = a.closest) == null ? void 0 : l.call(a, `#${CSS.escape(n.id)}`)));
    };
    n._votvBlur = (a) => {
      var g;
      const u = a.target;
      ...
      c && (l.contains(c) || n.id && ((g = c.closest) != null && g.call(c, `#${CSS.escape(n.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: n.id, at: Date.now() }), f(l));
  ...
  _getFormDataForUpdate(i) {
    ...
    for (const y of s) {
      ...
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, x._healthStatusFromRatio(a, h));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, r, p, s, n, f, m, y, h, a, u, o;
    if (e) {
      ...
      if (l) {
        ...
        if (c && c.documentName === "Item" && (c.type === "Kepesseg" || c.type === "ability")) {
          ...
          const q = v === "active" ? "active" : "passive", D = Array.isArray((n = S[q]) == null ? void 0 : n.items) ? S[q].items.slice() : Array.isArray(S[q]) ? S[q].slice() : [];
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const p = this.actor.items.contents.slice().sort((h, a) => {
      const u = typeof h.sort == "number" ? h.sort : 0, o = typeof a.sort == "number" ? a.sort : 0;
      return u - o;
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      ...
      const n = ((l = (o = (u = foundry.applications) == null ? void 0 : u.apps) == null ? void 0 : o.FilePicker) == null ? void 0 : l.implementation) ?? globalThis.FilePicker;
      new n({
        type: "image",
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (s, n, f, m) => {
    ...
    if (!y) return;
    const h = document.activeElement, a = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), u = [], o = (S = game.actors) == null ? void 0 : S.get(y);
...
//# sourceMappingURL=vacuum-of-the-void-R2A5SjV0.mjs.map
