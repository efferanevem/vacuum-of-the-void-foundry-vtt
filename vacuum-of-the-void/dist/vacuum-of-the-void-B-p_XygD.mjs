...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(r = null) {
    ...
    const s = ((i = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : i.resources) ?? {}, a = ((c = (o = s.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = s.currentHealth) == null ? void 0 : l.legs) ?? 0, u = C._healthStatusFromRatio(n, a), p = Number(((w = (y = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : y.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
  ...
  async _prepareContext(r) {
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], y = (l.slotOrder ?? "").trim(), w = y ? y.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], g = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = g && typeof g == "object" && !Array.isArray(g) ? g : {}, E = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = ((($e = I.slot2) == null ? void 0 : $e.itemId) ?? "").trim(), O = (((Ee = I.slot3) == null ? void 0 : Ee.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
  ...
  _attachFrameListeners(r) {
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(r), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, l = ((y = o.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-DJdC_ck3.mjs");
      m(this.actor, c, l);
  ...
  /** Lőszer mező szélessége tartalomhoz (auto), fókusz nélkül is megmarad. */
  ...
  async _rollWeapon(r) {
    var w;
    const t = (this.actor.system.weapons ?? {})[r] ?? {}, s = this.actor.system.skills ?? {}, a = this.actor.items.filter((g) => g.type === "Fegyver");
    let n = null;
...
//# sourceMappingURL=vacuum-of-the-void-B-p_XygD.mjs.map
