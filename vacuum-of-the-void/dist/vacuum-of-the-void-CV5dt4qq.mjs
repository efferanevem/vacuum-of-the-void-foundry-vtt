...
const { HTMLField: Ws, NumberField: F, SchemaField: z, StringField: O, BooleanField: de, ArrayField: wt } = foundry.data.fields;
...
const J = class J extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const b of m) {
      const N = ((ut = p[b]) == null ? void 0 : ut.value) ?? 0, L = l[b] ?? 0;
    ...
    e.weaponItems = G;
    const Y = "— Nincs fegyver —", ee = A.filter((b) => {
    ...
    e.weaponsTable = E.map((b) => {
      ...
      const j = !!L, oe = ((us = b.system) == null ? void 0 : us.equipped) !== void 0 && ((ds = b.system) == null ? void 0 : ds.equipped) !== null ? !!b.system.equipped : j, te = (b == null ? void 0 : b.system) ?? {}, Xe = typeof te.range == "string" ? (te.range || "").trim() : "", be = te.type ?? "", Ie = (ae[be] ?? be) || "—", Fe = te.size ?? "", Qe = (re[Fe] ?? Fe) || "", Ze = [Ie, Qe].filter(Boolean).join(", ") || Ie || "—", xe = be === "projectile" || Fe === "thrown", Re = te.quantity, vt = Re != null ? String(Re).trim() : "1", nt = String(P.bonus ?? "").trim(), kt = String(te.bonus ?? "").trim(), Us = nt || kt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const je = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), ue = je.map((b) => ({ id: b.id, name: b.name, img: b.img })), Ae = "— Nincs Mikro-Chip —", ye = ["slot1", "slot2", "slot3"], Ke = (b) => {
      var L, P, j;
      const N = [];
    ...
    e.microchipItemsSlot1 = ue.filter((b) => !Ke(1).includes(b.id)), e.microchipItemsSlot2 = ue.filter((b) => !Ke(2).includes(b.id)), e.microchipItemsSlot3 = ue.filter((b) => !Ke(3).includes(b.id)), e.microchipSlots = ye.map((b) => {
      ...
      return {
        slotKey: b,
        itemId: L,
        displayName: (P == null ? void 0 : P.name) || N.name || Ae,
        img: (P == null ? void 0 : P.img) || "",
        active: N.active === !0
      };
    }), ["1", "2", "3"].forEach((b) => {
      const N = `slot${b}`, L = B[N] ?? {}, P = (L.itemId ?? "").trim(), j = ue.find((oe) => oe.id === P);
      e[`microchip${b}ItemId`] = P, e[`microchip${b}DisplayName`] = (j == null ? void 0 : j.name) || L.name || Ae, e[`microchip${b}Img`] = (j == null ? void 0 : j.img) || "";
    }), e.microchipsTable = je.map((b) => {
      var Fe, Qe, Ze, xe;
      const N = b.id;
      let L = null;
      for (const Re of ye)
        if ((((Fe = B[Re]) == null ? void 0 : Fe.itemId) ?? "").trim() === N) {
          L = Re;
          break;
        }
    ...
    e.abilityPassiveList = Pe(Ee("passive")), e.abilityActiveList = Pe(Ee("active"));
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-JCdfZTq0.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-JCdfZTq0.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-JCdfZTq0.mjs");
      g(this.actor, c, a);
...
const me = class me extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var ze, Ee, Pe, St, st, Ue, ke, Tt, He, Be, At, $e, Ge, Dt, _t, rt, Ot, ot, ct, lt, ut, dt, mt, pt, ft, yt, Ve, gt, ht, We;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((ze = this.actor) == null ? void 0 : ze.system), e.showDeathSkull = !1, e.sizeForSelect = (((Pe = (Ee = e.system) == null ? void 0 : Ee.identity) == null ? void 0 : Pe.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((St = e.system) == null ? void 0 : St.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, l = (Ue = (st = t == null ? void 0 : t.statuses) == null ? void 0 : st.has) != null && Ue.call(st, "lookaround") ? 1 : 0, m = (Tt = (ke = t == null ? void 0 : t.statuses) == null ? void 0 : ke.has) != null && Tt.call(ke, "halfcover") ? 3 : 0, u = (Be = (He = t == null ? void 0 : t.statuses) == null ? void 0 : He.has) != null && Be.call(He, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = p + l + m + u;
    const d = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], f = (($e = t == null ? void 0 : t.system) == null ? void 0 : $e.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (f.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((w) => y.includes(w)) : [], o = d.filter((w) => w.type === "Fegyver"), c = o.map((w) => ({ id: w.id, name: w.name, img: w.img })), a = "— Nincs fegyver —", g = i.length > 0 ? i : y, h = y.filter((w) => !g.includes(w)), v = [...g, ...h], I = v.filter((w) => {
      var R;
      const x = (((R = f[w]) == null ? void 0 : R.itemId) ?? "").trim();
      return x && o.some((U) => U.id === x);
    });
    e.weaponSlots = I.map((w) => {
      const x = f[w] ?? {}, R = (x.itemId ?? "").trim(), U = c.find((he) => he.id === R), ge = o.find((he) => he.id === R), Z = (ge == null ? void 0 : ge.system) ?? {}, Se = Z.size === "thrown", we = (typeof Z.range == "string" ? (Z.range || "").trim() : "") || "—";
      return {
        slotKey: w,
        itemId: R,
    ...
    e.weaponsTable = o.map((w) => {
      ...
      let R = null, U = {};
      for (const it of v)
        if ((((bt = f[it]) == null ? void 0 : bt.itemId) ?? "").trim() === x) {
          R = it, U = f[it] ?? {};
          break;
        }
    ...
    const ee = ((mt = e.system) == null ? void 0 : mt.resources) ?? {}, ae = (ft = (pt = e.system) == null ? void 0 : pt.combat) == null ? void 0 : ft.initiativeResult, re = typeof ae == "number" ? ae : -1, se = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], le = (Ve = (yt = e.system) == null ? void 0 : yt.combat) == null ? void 0 : Ve.initiativeRanges, fe = Array.isArray(le) ? le.map((w) => ({ min: Number(w.min) ?? 0, max: Number(w.max) ?? 0, kp: Math.min(10, Math.max(0, Number(w.kp) ?? 0)) })) : [], ue = (fe.length > 0 ? fe : se).slice().sort((w, x) => w.min - x.min), Ae = 3;
    let ye = fe.length > 0 ? fe : [];
    ye.length < Ae && (ye = [...ye, ...Array(Ae - ye.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ye.map((w, x) => ({
      ...w,
      isFirst: x === 0,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-JCdfZTq0.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-JCdfZTq0.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-JCdfZTq0.mjs");
      a(this.actor, o, c);
  ...
  async _onDropItem(s, e) {
    ...
    if (p.type === "Fegyver" && d) {
      const A = ((D = l.system) == null ? void 0 : D.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (A.slotOrder ?? "").trim(), V = B ? B.split(/\s*,\s*/).filter((Q) => H.includes(Q)) : [];
      let W = H.find((Q) => {
        var k;
        return !(((k = A[Q]) == null ? void 0 : k.itemId) ?? "").trim();
      });
...
const pe = class pe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var C, _, q, M, A, H, B, V, W, ce, Q;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((C = e.system) == null ? void 0 : C.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0);
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, p = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, l = "— Nincs fegyver —", m = (((_ = this.actor.items) == null ? void 0 : _.contents) ?? []).filter((k) => k.type === "Fegyver");
    e.weaponsTable = m.map((k) => {
      const E = (k == null ? void 0 : k.system) ?? {}, G = E.type ?? "", Y = (n[G] ?? G) || "—", ee = E.size ?? "", ae = (p[ee] ?? ee) || "", re = [Y, ae].filter(Boolean).join(", ") || Y || "—", se = G === "projectile" || ee === "thrown", le = E.quantity != null ? String(E.quantity).trim() : "1", fe = (typeof E.range == "string" ? (E.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: this.actor.id,
    ...
    const f = (((A = this.actor.items) == null ? void 0 : A.contents) ?? []).filter((k) => k.type === "Targy");
    ...
    const y = (((H = this.actor.items) == null ? void 0 : H.contents) ?? []).filter((k) => k.type === "Jarmuegyseg"), r = [];
    let i = 0, o = 0;
    for (const k of y) {
      ...
      const ue = (E.damage ?? "").toString().trim(), Ae = E.abilities ?? {}, ye = Array.isArray(Ae.items) ? Ae.items : [], et = (await Promise.all(
        ye.map(async (ie) => {
          var Le;
          if (!ie) return null;
          try {
        ...
        var Ee, Pe;
        const ne = (((Ee = ie.system) == null ? void 0 : Ee.kind) ?? "passive").toString(), tt = Number(((Pe = ie.system) == null ? void 0 : Pe.kp) ?? 0) || 0, ze = ne === "species";
        return {
          id: ie.id,
          ref: Le,
          name: ie.name,
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (u, d, f, y) => {
    var T, D, C, _, q, M, A, H, B, V, W, ce, Q;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, I, T, D, C, _, q, M, A, H, B, V, W, ce, Q, k, E, G, Y, ee, ae;
    ...
    const d = l.itemId ? ((H = (A = u.items) == null ? void 0 : A.get) == null ? void 0 : H.call(A, l.itemId)) ?? ((W = (V = (B = u.items) == null ? void 0 : B.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (re) => re.id === l.itemId)) : null;
    let f = (l.damageFormula ?? "").trim();
    if (f || (f = (((ce = d == null ? void 0 : d.system) == null ? void 0 : ce.damage) ?? "").trim()), !f && l.slotKey && (f = (((((Q = u.system) == null ? void 0 : Q.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !f) {
    ...
    for (const m of e) {
      const u = It.getTotalSpeedRaw(m), d = (n = m.effects) == null ? void 0 : n.find((f) => f.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (u <= 0 && !d) {
...
//# sourceMappingURL=vacuum-of-the-void-CV5dt4qq.mjs.map
