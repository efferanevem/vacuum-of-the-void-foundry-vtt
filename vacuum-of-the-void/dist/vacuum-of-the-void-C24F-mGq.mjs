...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe, S, P, x, G, ke, ne, qe, Oe, we, Re, Qe, et, Et, Pt, $t, xt, Tt, lt, ns, rs, as, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs;
    ...
    const _ = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Qe = this.actor.system.gear) == null ? void 0 : Qe.microchips, z = U && typeof U == "object" && !Array.isArray(U) ? U : {}, V = (((et = z.slot1) == null ? void 0 : et.itemId) ?? "").trim(), Z = (((Et = z.slot2) == null ? void 0 : Et.itemId) ?? "").trim(), J = (((Pt = z.slot3) == null ? void 0 : Pt.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      let ae = null;
      L && (V === b.id ? ae = "slot1" : Z === b.id ? ae = "slot2" : J === b.id && (ae = "slot3"));
    ...
    e.weaponSlots = De.map((b, N) => {
      const L = _[b] ?? {}, A = (L.itemId ?? "").trim(), B = te.find((_e) => _e.id === A), ue = R.find((_e) => _e.id === A), ae = (ue == null ? void 0 : ue.system) ?? {}, tt = ae.size === "thrown", Ie = (typeof ae.range == "string" ? (ae.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
    ...
    e.weaponsTable = R.map((b) => {
      ...
      const B = !!L, ue = ((vs = b.system) == null ? void 0 : vs.equipped) !== void 0 && ((ks = b.system) == null ? void 0 : ks.equipped) !== null ? !!b.system.equipped : B, ae = (b == null ? void 0 : b.system) ?? {}, tt = typeof ae.range == "string" ? (ae.range || "").trim() : "", Ie = ae.type ?? "", _e = (D[Ie] ?? Ie) || "—", Me = ae.size ?? "", st = (E[Me] ?? Me) || "", it = [_e, st].filter(Boolean).join(", ") || _e || "—", Ge = Ie === "projectile" || Me === "thrown", We = ae.quantity, Dt = We != null ? String(We).trim() : "1", ut = String(A.bonus ?? "").trim(), Ot = String(ae.bonus ?? "").trim(), ci = ut || Ot || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const pe = (((ns = this.actor.items) == null ? void 0 : ns.contents) ?? []).filter((b) => b.type === "MikroChip"), re = pe.map((b) => ({ id: b.id, name: b.name, img: b.img })), ve = "— Nincs Mikro-Chip —", ce = ["slot1", "slot2", "slot3"], fe = (b) => {
      var L, A, B;
      const N = [];
    ...
    e.microchipItemsSlot1 = re.filter((b) => !fe(1).includes(b.id)), e.microchipItemsSlot2 = re.filter((b) => !fe(2).includes(b.id)), e.microchipItemsSlot3 = re.filter((b) => !fe(3).includes(b.id)), e.microchipSlots = ce.map((b) => {
      ...
      const N = `slot${b}`, L = z[N] ?? {}, A = (L.itemId ?? "").trim(), B = re.find((ue) => ue.id === A);
    ...
    const ze = (((rs = e.weaponsTable) == null ? void 0 : rs.length) ?? 0) > 0 || (((as = e.armorTable) == null ? void 0 : as.length) ?? 0) > 0 || (((os = e.microchipsTable) == null ? void 0 : os.length) ?? 0) > 0 || (((cs = e.itemsTable) == null ? void 0 : cs.length) ?? 0) > 0;
    ...
    const je = this.actor.system.abilities ?? {}, $e = (((ls = this.actor.items) == null ? void 0 : ls.contents) ?? []).map((b) => {
      ...
      return {
        itemId: L,
        displayName: (A == null ? void 0 : A.name) || N.name || rt,
        img: (A == null ? void 0 : A.img) || "",
        description: B,
        kp: ue
      };
    ...
    const at = ((us = e.system) == null ? void 0 : us.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (ms = (ds = e.system) == null ? void 0 : ds.combat) == null ? void 0 : ms.initiativeResult, ie = typeof ye == "number" ? ye : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
    ...
    e.kpDots = ee.map((b, N) => {
      const L = N + 1, A = !!Number(at[b]), B = L <= mt;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-CB7avYKQ.mjs");
      d(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-CB7avYKQ.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, l = o.dataset.skill, d = ((g = o.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-CB7avYKQ.mjs");
      h(this.actor, l, d);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: c, label: y } = Gt(r), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return r.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ue, Je, Be, at, ee, ye, ie, ot, xe, Ce, ct, He, Ze, Nt, Ft, mt, At, pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe;
    ...
    const _ = ((Nt = (Ze = t == null ? void 0 : t.system) == null ? void 0 : Ze.gear) == null ? void 0 : Nt.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], j = r.filter((S) => S.type === "MikroChip");
    ...
    const ze = re.length > 0 ? re[re.length - 1] : null, je = Math.min(10, ze ? ze.kp : 6), Ke = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((S, P) => {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-CB7avYKQ.mjs");
      l(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CB7avYKQ.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-CB7avYKQ.mjs");
      d(this.actor, o, l);
  ...
  async _onDropItem(s, e) {
    var c, y, a, i, o, l, d, h, g, v, k, w, T, O, _, C, j, K, U;
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const r = (((z = this.actor.items) == null ? void 0 : z.contents) ?? []).filter((D) => D.type === "MikroChip");
...
const nt = class nt extends jt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var _, C, j, K, U, z, V;
      const r = ((_ = e.querySelector) == null ? void 0 : _.call(e, "form")) ?? e, c = (C = r.querySelector) == null ? void 0 : C.call(r, 'select[name="system.identity.assignment"]'), y = (j = r.querySelector) == null ? void 0 : j.call(r, 'select[name="system.identity.subAssignment"]'), a = (K = r.querySelector) == null ? void 0 : K.call(r, "input.bazis-threat-total"), i = (U = r.querySelector) == null ? void 0 : U.call(r, 'input[name="system.combat.threatBonus"]');
      if (!c || !a || !i) return;
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, m = f.assignment ?? "", p = f.subAssignment ?? "", r = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = r[m] ?? 0, i = c[p] ?? 0, o = e.sizeForSelect ?? "Kicsi", l = y[o] ?? 0, d = Number(u.threatBonus ?? 0) || 0, h = Ls(this.actor), g = a + i + l + d + h;
      e.system = foundry.utils.mergeObject(
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  M(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Bs = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !1 }),
...
Hooks.once("init", () => {
  ...
  Hooks.on("preCreateActor", (r, c, y) => {
    ...
    ((r == null ? void 0 : r.type) === "Bazis" || (r == null ? void 0 : r.type) === "Vallalkozas") && Object.prototype.hasOwnProperty.call(c ?? {}, "img") && (c.img = s);
  }), Hooks.on("ready", () => {
    var y;
  ...
  Hooks.on("updateActor", (r, c, y, a) => {
    ...
    if (r.type === "Npc" && ((K = c == null ? void 0 : c.system) != null && K.identity) && "size" in c.system.identity) {
      const R = ri((z = (U = r.system) == null ? void 0 : U.identity) == null ? void 0 : z.size);
      r.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const r = u.itemId ? ((U = (K = p.items) == null ? void 0 : K.get) == null ? void 0 : U.call(K, u.itemId)) ?? ((Z = (V = (z = p.items) == null ? void 0 : z.contents) == null ? void 0 : V.find) == null ? void 0 : Z.call(V, (E) => E.id === u.itemId)) : null;
    ...
    for (const m of e) {
      const p = qt.getTotalSpeedRaw(m), r = (n = m.effects) == null ? void 0 : n.find((c) => c.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (p <= 0 && !r) {
...
Hooks.on("preCreateToken", (I, s, e) => {
  ...
  if (f) {
    ...
    if (f.type === "Npc") {
      const l = ri((o = (i = f.system) == null ? void 0 : i.identity) == null ? void 0 : o.size);
      I.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("combatRound", (I, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || ai(I);
});
function oi() {
  var s, e, t;
...
Hooks.on("updateCombat", (I, s, e) => {
  (s == null ? void 0 : s.round) != null && ai(I), setTimeout(oi, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-C24F-mGq.mjs.map
