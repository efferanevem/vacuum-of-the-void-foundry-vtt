export class VoidShieldSheet extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(html) {
    ...
    const doSubmit = (form) => {
      ...
      sheet.document.update(updateData).catch(err => console.warn("VoidShieldSheet save failed", err));
    };
