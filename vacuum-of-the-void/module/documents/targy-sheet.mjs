export class VoidTargySheet extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(html) {
    ...
    const doSubmit = (form) => {
      ...
      sheet.document.update(updateData).catch(err => console.warn("VoidTargySheet save failed", err));
    };
