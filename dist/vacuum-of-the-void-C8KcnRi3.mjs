...
const { BooleanField: Ot, NumberField: xt, StringField: se } = foundry.data.fields;
...
const { NumberField: ye, StringField: Je } = foundry.data.fields;
...
const { NumberField: At, StringField: Xe } = foundry.data.fields;
...
const { StringField: Ve } = foundry.data.fields;
class Ct extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new Ve({ required: !1, blank: !0, initial: "" }),
...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Ce, Ee, Ne, Pe, $e, xe, je, Me, Ke, Re, Ue, He, Be, Ge, ze, We, Ye;
    ...
    for (const o of c) {
      const k = ((Pe = r[o]) == null ? void 0 : Pe.value) ?? 0, I = a[o] ?? 0;
    ...
    const g = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (g.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((o) => S.includes(o)) : [], A = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, _ = A && typeof A == "object" && !Array.isArray(A) ? A : {}, w = (((Re = _.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), N = (((Ue = _.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = _.slot3) == null ? void 0 : He.itemId) ?? "").trim(), ut = this.actor.items.contents.filter((o) => o.type !== "Kepesseg" && o.type !== "ability").slice().sort((o, k) => {
      ...
      for (let ie = 0; ie < F.length; ie++) {
        ...
        if ((((X = g[re]) == null ? void 0 : X.itemId) ?? "") === o.id) {
          q = ie + 1, D = ((ee = g[re]) == null ? void 0 : ee.bonus) ?? "", j = re;
          break;
        }
      }
      let R = null;
      I && (w === o.id ? R = "slot1" : N === o.id ? R = "slot2" : x === o.id && (R = "slot3"));
      const ae = k && ((te = o.system) != null && te.damage) ? o.system.damage : "", Q = k && typeof ((Z = o.system) == null ? void 0 : Z.range) == "string" ? (o.system.range || "").trim() : "", J = j ? Number((V = g[j]) == null ? void 0 : V.bonus) || 0 : "";
      return {
        id: o.id,
        name: o.name,
        img: o.img,
    ...
    e.weaponItems = Se;
    const qe = "— Nincs fegyver —", dt = F.filter((o) => {
      const I = ((g[o] ?? {}).itemId ?? "").trim();
      return I ? !!ue.find((D) => D.id === I) : !1;
    });
    e.weaponSlots = dt.map((o, k) => {
      const I = g[o] ?? {}, q = (I.itemId ?? "").trim(), D = Se.find((j) => j.id === q);
      return {
        slotKey: o,
        itemId: q,
        slotNum: k + 1,
        displayName: (D == null ? void 0 : D.name) || I.name || qe,
    ...
    e.weaponsTable = ue.map((o) => {
      ...
      const D = !!I, j = ((re = o.system) == null ? void 0 : re.equipped) !== void 0 && ((Qe = o.system) == null ? void 0 : Qe.equipped) !== null ? !!o.system.equipped : D, R = (o == null ? void 0 : o.system) ?? {}, ae = typeof R.range == "string" ? (R.range || "").trim() : "", Q = R.type ?? "", J = (mt[Q] ?? Q) || "—", X = R.size ?? "", ee = (pt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = R.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: I ?? "",
        itemId: k,
    ...
    const ft = (((Ge = this.actor.items) == null ? void 0 : Ge.contents) ?? []).filter((o) => o.type === "Pancel");
    e.armorTable = ft.map((o) => {
      var q, D;
      const k = (o == null ? void 0 : o.system) ?? {}, I = ((q = o.system) == null ? void 0 : q.equipped) !== void 0 && ((D = o.system) == null ? void 0 : D.equipped) !== null ? !!o.system.equipped : !1;
      return {
        itemId: o.id,
        actorId: this.actor.id,
    ...
    const yt = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((o) => o.type === "Targy" || o.type === "Egyeb");
    e.itemsTable = yt.map((o) => {
      const k = (o == null ? void 0 : o.system) ?? {}, I = (k.description ?? "").trim(), q = I ? I.length > 60 ? I.slice(0, 57) + "…" : I : "—", D = o.type === "Egyeb", j = D ? "—" : k.quantity != null ? String(k.quantity).trim() : "1";
      return {
        itemId: o.id,
        actorId: this.actor.id,
        name: (o == null ? void 0 : o.name) ?? "—",
    ...
    const de = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).filter((o) => o.type === "MikroChip"), oe = de.map((o) => ({ id: o.id, name: o.name, img: o.img })), Te = "— Nincs Mikro-Chip —", Oe = ["slot1", "slot2", "slot3"], me = (o) => {
      var I, q, D;
      const k = [];
      return o !== 1 && k.push((((I = _.slot1) == null ? void 0 : I.itemId) ?? "").trim()), o !== 2 && k.push((((q = _.slot2) == null ? void 0 : q.itemId) ?? "").trim()), o !== 3 && k.push((((D = _.slot3) == null ? void 0 : D.itemId) ?? "").trim()), k.filter(Boolean);
    };
    e.microchipItemsSlot1 = oe.filter((o) => !me(1).includes(o.id)), e.microchipItemsSlot2 = oe.filter((o) => !me(2).includes(o.id)), e.microchipItemsSlot3 = oe.filter((o) => !me(3).includes(o.id)), e.microchipSlots = Oe.map((o) => {
      const k = _[o] ?? {}, I = (k.itemId ?? "").trim(), q = de.find((D) => D.id === I);
      return {
        slotKey: o,
        itemId: I,
        displayName: (q == null ? void 0 : q.name) || k.name || Te,
        img: (q == null ? void 0 : q.img) || "",
        active: k.active === !0
      };
    }), ["1", "2", "3"].forEach((o) => {
      const k = `slot${o}`, I = _[k] ?? {}, q = (I.itemId ?? "").trim(), D = oe.find((j) => j.id === q);
      e[`microchip${o}ItemId`] = q, e[`microchip${o}DisplayName`] = (D == null ? void 0 : D.name) || I.name || Te, e[`microchip${o}Img`] = (D == null ? void 0 : D.img) || "";
    }), e.microchipsTable = de.map((o) => {
      var X, ee, te, Z;
      const k = o.id;
      let I = null;
      for (const V of Oe)
        if ((((X = _[V]) == null ? void 0 : X.itemId) ?? "").trim() === k) {
          I = V;
          break;
        }
      const q = !!I, D = ((ee = o == null ? void 0 : o.system) == null ? void 0 : ee.abilityType) ?? "", j = D === "active" ? "Aktív" : D === "passive" ? "Passzív" : D || "—", R = D === "active", ae = Number((te = o == null ? void 0 : o.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(o.system.replaceCost) : 0, Q = (((Z = o == null ? void 0 : o.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: k,
        actorId: this.actor.id,
        name: (o == null ? void 0 : o.name) ?? "—",
    ...
    const De = this.actor.system.abilities ?? {}, gt = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).map((o) => {
      var k, I, q;
      return {
        id: o.id,
        name: o.name,
    ...
    }), _e = new Map(gt.map((o) => [o.id, o])), ht = "— Nincs képesség —", Le = (o) => {
      const k = De[o] ?? {}, I = (k.itemId ?? "").trim(), q = I ? _e.get(I) : null, D = (q == null ? void 0 : q.description) ?? "", j = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: I,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-DIrhp__R.mjs");
      d(this.actor, u);
    ...
    r && s({ currentTarget: r }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, u = l.dataset.skill, d = ((f = l.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-DIrhp__R.mjs");
      m(this.actor, u, d);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const g = d.system.weapons ?? {}, S = (g.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = S ? S.split(/\s*,\s*/).filter((_) => O.includes(_)) : [], A = F.find((_) => {
          var w;
          return (((w = g[_]) == null ? void 0 : w.itemId) ?? "").trim() === u;
        });
        if (A) {
          const _ = F.filter((w) => w !== A);
      ...
      if (l.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.bonus`]: ((_ = d == null ? void 0 : d.system) == null ? void 0 : _.bonus) ?? ""
      ...
      if (l.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.bonus`]: ((_ = d.system) == null ? void 0 : _.bonus) ?? ""
        }), await d.update({ "system.equipped": !0 });
      } else if (O) {
        const w = S.filter((N) => N !== O);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (d) {
        ...
        if (m && m.documentName === "Item" && m.type === "Fegyver") {
          ...
          if (g) {
            const O = ((v = f.system) == null ? void 0 : v.weapons) ?? {}, F = (O.slotOrder ?? "").trim(), A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = F ? F.split(/\s*,\s*/).filter((N) => A.includes(N)) : [], w = _.filter((N) => {
              var x;
              return (((x = O[N]) == null ? void 0 : x.itemId) ?? "").trim() === S;
            });
            if (w.length > 0) {
              const x = {
                "system.weapons.slotOrder": _.filter((M) => !w.includes(M)).join(",")
              };
              for (const M of w)
...
K(P, "PARTS", foundry.utils.mergeObject(E(P, P, "PARTS") ?? {}, {
  ...
  minWidth: 1e3,
  height: 800,
  form: foundry.utils.mergeObject(((et = E(P, P, "DEFAULT_OPTIONS")) == null ? void 0 : et.form) ?? {}, { submitOnChange: !1 }),
  window: foundry.utils.mergeObject(((tt = E(P, P, "DEFAULT_OPTIONS")) == null ? void 0 : tt.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((st = (it = E(P, P, "DEFAULT_OPTIONS")) == null ? void 0 : it.window) == null ? void 0 : st.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
K(G, "PARTS", foundry.utils.mergeObject(E(G, G, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((nt = E(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : nt.form) ?? {}, { submitOnChange: !1 })
}));
let we = G;
var ot;
...
K(z, "PARTS", foundry.utils.mergeObject(E(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ot = E(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : ot.form) ?? {}, { submitOnChange: !0 })
}));
let ve = z;
var lt;
...
K(Y, "PARTS", foundry.utils.mergeObject(E(Y, Y, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ct = E(Y, Y, "DEFAULT_OPTIONS")) == null ? void 0 : ct.form) ?? {}, { submitOnChange: !1 })
}));
let Ie = Y;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, c, p, y) => {
    ...
    const f = (_ = game.votv) == null ? void 0 : _._lastKarakterSheetBlurSave, g = f && Date.now() - f.at < C ? f.appId : null;
    setTimeout(() => {
      for (const w of l)
...
//# sourceMappingURL=vacuum-of-the-void-C8KcnRi3.mjs.map
