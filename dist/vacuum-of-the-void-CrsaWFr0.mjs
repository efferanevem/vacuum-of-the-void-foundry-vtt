...
var Q = (I, s, e) => js(I, typeof s != "symbol" ? s + "" : s, e);
var H = (I, s, e) => Ms(Rs(I), e, s);
const { HTMLField: Ks, NumberField: A, SchemaField: z, StringField: D, BooleanField: te, ArrayField: ft } = foundry.data.fields;
...
const { NumberField: Pt, SchemaField: zs } = foundry.data.fields;
class Us extends Ut {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { NumberField: At, StringField: us } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalSpeed(s = null) {
    ...
    const e = s ?? this.form ?? this.element, t = (P) => {
      var N;
      return ((N = e == null ? void 0 : e.querySelector) == null ? void 0 : N.call(e, P)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${P}`) : null);
  ...
  async _prepareContext(s) {
    var et, tt, st, it, nt, rt, at, ot, ct, $e, lt, ut, xe, k, E, x, B, oe, X, ye, me, ce, De, Re, Me, Dt, _t, Ot, Ct, dt, We, Bt, Gt, Wt, Vt, Yt, Xt, Jt, Qt, Zt, es, ts, ss, is, ns;
    ...
    const N = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = (N.slotOrder ?? "").trim(), _ = C ? C.split(/\s*,\s*/).filter((h) => v.includes(h)) : [], R = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, j = R && typeof R == "object" && !Array.isArray(R) ? R : {}, U = (((Me = j.slot1) == null ? void 0 : Me.itemId) ?? "").trim(), G = (((Dt = j.slot2) == null ? void 0 : Dt.itemId) ?? "").trim(), Z = (((_t = j.slot3) == null ? void 0 : _t.itemId) ?? "").trim(), M = this.actor.items.contents.filter((h) => h.type !== "Kepesseg" && h.type !== "ability").slice().sort((h, L) => {
      const q = typeof h.sort == "number" ? h.sort : 0, F = typeof L.sort == "number" ? L.sort : 0;
      return q - F;
    }).map((h) => {
      ...
      for (let Ve = 0; Ve < _.length; Ve++) {
        ...
        if ((((_e = N[pt]) == null ? void 0 : _e.itemId) ?? "") === h.id) {
          F = Ve + 1, K = ((Ke = N[pt]) == null ? void 0 : Ke.bonus) ?? "", ee = pt;
          break;
        }
      }
      let J = null;
      q && (U === h.id ? J = "slot1" : G === h.id ? J = "slot2" : Z === h.id && (J = "slot3"));
    ...
    e.weaponSlots = fe.map((h, L) => {
      const q = N[h] ?? {}, F = (q.itemId ?? "").trim(), K = re.find((pe) => pe.id === F), ee = Y.find((pe) => pe.id === F), J = (ee == null ? void 0 : ee.system) ?? {}, je = J.size === "thrown", le = (typeof J.range == "string" ? (J.range || "").trim() : "") || "—";
      return {
        slotKey: h,
        itemId: F,
        slotNum: L + 1,
    ...
    e.weaponsTable = Y.map((h) => {
      ...
      const K = !!q, ee = ((as = h.system) == null ? void 0 : as.equipped) !== void 0 && ((os = h.system) == null ? void 0 : os.equipped) !== null ? !!h.system.equipped : K, J = (h == null ? void 0 : h.system) ?? {}, je = typeof J.range == "string" ? (J.range || "").trim() : "", le = J.type ?? "", pe = (Se[le] ?? le) || "—", _e = J.size ?? "", Ke = (ae[_e] ?? _e) || "", ze = [pe, Ke].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || _e === "thrown", qe = J.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(J.bonus ?? "").trim(), $s = Ve || pt || "0";
      return {
        slotKey: q ?? "",
        itemId: L,
    ...
    e.armorTable = ue.map((h) => {
      var F, K;
      const L = (h == null ? void 0 : h.system) ?? {}, q = ((F = h.system) == null ? void 0 : F.equipped) !== void 0 && ((K = h.system) == null ? void 0 : K.equipped) !== null ? !!h.system.equipped : !1;
      return {
        itemId: h.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = Ne.map((h) => {
      const L = (h == null ? void 0 : h.system) ?? {}, q = (L.description ?? "").trim(), F = q ? q.length > 60 ? q.slice(0, 57) + "…" : q : "—", K = L.quantity != null ? String(L.quantity).trim() : "1";
      return {
        itemId: h.id,
        actorId: this.actor.id,
        name: (h == null ? void 0 : h.name) ?? "—",
    ...
    e.egyebList = Ue.map((h) => {
      const q = (((h == null ? void 0 : h.system) ?? {}).description ?? "").trim(), F = q ? q.length > 80 ? q.slice(0, 77) + "…" : q : "";
      return {
        itemId: h.id,
        actorId: this.actor.id,
        name: (h == null ? void 0 : h.name) ?? "—",
    ...
    const gt = (((Bt = this.actor.items) == null ? void 0 : Bt.contents) ?? []).filter((h) => h.type === "MikroChip"), ne = gt.map((h) => ({ id: h.id, name: h.name, img: h.img })), Ye = "— Nincs Mikro-Chip —", Te = ["slot1", "slot2", "slot3"], He = (h) => {
      var q, F, K;
      const L = [];
      return h !== 1 && L.push((((q = j.slot1) == null ? void 0 : q.itemId) ?? "").trim()), h !== 2 && L.push((((F = j.slot2) == null ? void 0 : F.itemId) ?? "").trim()), h !== 3 && L.push((((K = j.slot3) == null ? void 0 : K.itemId) ?? "").trim()), L.filter(Boolean);
    };
    e.microchipItemsSlot1 = ne.filter((h) => !He(1).includes(h.id)), e.microchipItemsSlot2 = ne.filter((h) => !He(2).includes(h.id)), e.microchipItemsSlot3 = ne.filter((h) => !He(3).includes(h.id)), e.microchipSlots = Te.map((h) => {
      const L = j[h] ?? {}, q = (L.itemId ?? "").trim(), F = gt.find((K) => K.id === q);
      return {
        slotKey: h,
        itemId: q,
        displayName: (F == null ? void 0 : F.name) || L.name || Ye,
        img: (F == null ? void 0 : F.img) || "",
        active: L.active === !0
      };
    }), ["1", "2", "3"].forEach((h) => {
      const L = `slot${h}`, q = j[L] ?? {}, F = (q.itemId ?? "").trim(), K = ne.find((ee) => ee.id === F);
      e[`microchip${h}ItemId`] = F, e[`microchip${h}DisplayName`] = (K == null ? void 0 : K.name) || q.name || Ye, e[`microchip${h}Img`] = (K == null ? void 0 : K.img) || "";
      ...
      const F = !!q, K = ((Ke = h == null ? void 0 : h.system) == null ? void 0 : Ke.abilityType) ?? "", ee = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", J = K === "active", je = Number((ze = h == null ? void 0 : h.system) == null ? void 0 : ze.replaceCost) >= 0 ? Number(h.system.replaceCost) : 0, le = (((Ce = h == null ? void 0 : h.system) == null ? void 0 : Ce.description) ?? "").trim(), pe = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: L,
        actorId: this.actor.id,
        name: (h == null ? void 0 : h.name) ?? "—",
    ...
    const bt = this.actor.system.abilities ?? {}, Ht = (((Xt = this.actor.items) == null ? void 0 : Xt.contents) ?? []).map((h) => {
      ...
      return {
        ...
        kp: Number(((F = h.system) == null ? void 0 : F.kp) ?? 0) || 0
      };
    }), Be = new Map(Ht.map((h) => [h.id, h])), vt = "— Nincs képesség —", Xe = (h) => {
      const L = bt[h] ?? {}, q = (L.itemId ?? "").trim(), F = q ? Be.get(q) : null, K = (F == null ? void 0 : F.description) ?? "", ee = (F == null ? void 0 : F.kp) ?? 0;
      return {
        itemId: q,
        displayName: (F == null ? void 0 : F.name) || L.name || vt,
        img: (F == null ? void 0 : F.img) || "",
        description: K,
        kp: ee
      };
    ...
    const kt = ((Jt = e.system) == null ? void 0 : Jt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Pe = (Zt = (Qt = e.system) == null ? void 0 : Qt.combat) == null ? void 0 : Zt.initiativeResult, de = typeof Pe == "number" ? Pe : -1, wt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ae = (ts = (es = e.system) == null ? void 0 : es.combat) == null ? void 0 : ts.initiativeRanges, Fe = Array.isArray(Ae) ? Ae.map((h) => ({ min: Number(h.min) ?? 0, max: Number(h.max) ?? 0, kp: Math.min(10, Math.max(0, Number(h.kp) ?? 0)) })) : [], Oe = (Fe.length > 0 ? Fe : wt).slice().sort((h, L) => h.min - L.min), Ee = Fe.map((h) => h.min), It = Ee.length ? Math.min(...Ee) : 0, St = Ee.length ? Math.max(...Ee) : 0;
    e.initiativeRanges = Fe.map((h) => ({ ...h, isFirst: h.min === It, isLast: h.min === St }));
    let Ze = 0;
    if (typeof de == "number" && de >= 0 && Oe.length > 0) {
      const h = Oe[0], L = Oe[Oe.length - 1];
      let q = null;
      de <= h.max ? q = h : de >= L.min ? q = L : q = Oe.find((F) => de >= F.min && de <= F.max), q && (Ze = q.kp);
    }
    e.kpDots = Ge.map((h, L) => {
      const q = L + 1, F = !!Number(kt[h]), K = q <= Ze;
      return { index: q, used: F, usable: K };
    });
    const Tt = !!((is = (ss = game.combat) == null ? void 0 : ss.combatants) != null && is.some((h) => {
      var L;
      return ((L = h.actor) == null ? void 0 : L.type) === "Karakter";
    }));
    return e.showHarcSection = Tt, e.canEditInitiative = !!((ns = game.user) != null && ns.isGM), e.showInitiativeResult = typeof Pe == "number", e.initiativeResult = e.showInitiativeResult ? Pe : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D6I3EsLF.mjs");
      r(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D6I3EsLF.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var b;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, r = ((b = o.textContent) == null ? void 0 : b.trim()) || c, { openRollSheetForSkill: y } = await import("./roll-sheet-D6I3EsLF.mjs");
      y(this.actor, c, r);
      ...
      if (!b) return;
      const w = ((P = (O = this.actor.items).get) == null ? void 0 : P.call(O, b)) ?? ((v = (N = this.actor.items.contents) == null ? void 0 : N.find) == null ? void 0 : v.call(N, (_) => _.id === b));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((y == null ? void 0 : y.type) === "Fegyver") {
        const w = r.system.weapons ?? {}, S = (w.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = S ? S.split(/\s*,\s*/).filter((N) => T.includes(N)) : [], P = O.find((N) => {
          var v;
          return (((v = w[N]) == null ? void 0 : v.itemId) ?? "").trim() === c;
        });
        if (P) {
          const N = O.filter((v) => v !== P);
          b["system.weapons.slotOrder"] = N.join(","), b[`system.weapons.${P}.itemId`] = "", b[`system.weapons.${P}.name`] = "", b[`system.weapons.${P}.damage`] = "", b[`system.weapons.${P}.bonus`] = "";
        }
      }
      ...
      if (o.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((P = r == null ? void 0 : r.system) == null ? void 0 : P.damage) ?? "",
      ...
      const P = b ? this.actor.items.get(b) : null, N = {
        [`system.gear.microchips.${y}.itemId`]: b,
        [`system.gear.microchips.${y}.name`]: (P == null ? void 0 : P.name) ?? ""
      };
      ...
      if (o.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${v}.damage`]: ((P = r.system) == null ? void 0 : P.damage) ?? "",
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (b) {
            const S = ((g = y.system) == null ? void 0 : g.weapons) ?? {}, T = (S.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = T ? T.split(/\s*,\s*/).filter((v) => O.includes(v)) : [], N = P.filter((v) => {
              var C;
              return (((C = S[v]) == null ? void 0 : C.itemId) ?? "").trim() === w;
            });
            if (N.length > 0) {
              const C = {
                "system.weapons.slotOrder": P.filter((_) => !N.includes(_)).join(",")
              };
              for (const _ of N)
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: f, label: g } = Ft(d), l = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return d.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: y, label: b } = Ft(r), w = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return r.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${u} – találat`,
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Je, Qe, kt, Ge, Pe, de, wt, Ae, Fe, Lt, Oe, Ee, It, St, Ze, Tt, et, tt, st, it, nt, rt, at, ot, ct, $e, lt, ut, xe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Xe = this.actor) == null ? void 0 : Xe.system), e.showDeathSkull = !1, e.sizeForSelect = (((Qe = (Je = e.system) == null ? void 0 : Je.identity) == null ? void 0 : Qe.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((kt = e.system) == null ? void 0 : kt.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, a = (Pe = (Ge = t == null ? void 0 : t.statuses) == null ? void 0 : Ge.has) != null && Pe.call(Ge, "lookaround") ? 1 : 0, u = (wt = (de = t == null ? void 0 : t.statuses) == null ? void 0 : de.has) != null && wt.call(de, "halfcover") ? 3 : 0, m = (Fe = (Ae = t == null ? void 0 : t.statuses) == null ? void 0 : Ae.has) != null && Fe.call(Ae, "threequarteredcover") ? 6 : 0;
    ...
    const P = d.filter((k) => k.type === "Pancel");
    e.armorTable = P.map((k) => {
      var B;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-D6I3EsLF.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D6I3EsLF.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-D6I3EsLF.mjs");
      r(this.actor, o, c);
      ...
      const c = ((O = this.actor.system) == null ? void 0 : O.abilities) ?? {}, y = (Array.isArray((P = c[i]) == null ? void 0 : P.items) ? c[i].items.slice() : []).filter((N) => N !== o);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, p = ((O = e.system) == null ? void 0 : O.skills) ?? {}, a = ((P = e.items) == null ? void 0 : P.filter((C) => C.type === "Fegyver")) ?? [];
    let u = null;
    ...
    const { resultType: b, label: w } = Ft(y), S = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return y.toMessage({
  ...
  async _onDropItem(s, e) {
    var f, g, l, i, o, c, r, y, b, w, S, T, O, P, N, v, C;
    ...
    if (p.type === "Fegyver" && d) {
      ...
      await a.update({
        ...
        [`system.weapons.${G}.damage`]: ((P = p.system) == null ? void 0 : P.damage) ?? "",
...
Q(se, "PARTS", foundry.utils.mergeObject(
  H(se, se, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(se, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const g = (((S = e.weaponsTable) == null ? void 0 : S.length) ?? 0) > 0 || (((T = e.armorTable) == null ? void 0 : T.length) ?? 0) > 0 || (((O = e.microchipsTable) == null ? void 0 : O.length) ?? 0) > 0 || (((P = e.itemsTable) == null ? void 0 : P.length) ?? 0) > 0;
...
Q(ge, "PARTS", foundry.utils.mergeObject(H(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Q(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(H(ge, ge, "DEFAULT_OPTIONS"), {
...
Q(he, "PARTS", foundry.utils.mergeObject(H(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), Q(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(H(he, he, "DEFAULT_OPTIONS"), {
...
Q(be, "PARTS", foundry.utils.mergeObject(H(be, be, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Q(be, "DEFAULT_OPTIONS", foundry.utils.mergeObject(H(be, be, "DEFAULT_OPTIONS"), {
...
let zt = we;
const Ps = "systems/vacuum-of-the-void/assets/void-bg.jpg";
function As(I) {
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Us, CONFIG.Actor.dataModels.Npc = Ut, CONFIG.Actor.dataModels.Jarmu = Bs, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ls, CONFIG.Item.dataModels.weapon = ls, CONFIG.Item.dataModels.Pancel = Vs, CONFIG.Item.dataModels.MikroChip = Ys, CONFIG.Item.dataModels.Kepesseg = ms, CONFIG.Item.dataModels.ability = ms, CONFIG.Item.dataModels.Targy = Js, CONFIG.Item.dataModels.Egyeb = Zs, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    ...
    setTimeout(() => {
      ...
      if (o <= 0 && !c) {
        ...
        i.createEmbeddedDocuments("ActiveEffect", [{
          ...
          for (const N of T)
            ((P = N == null ? void 0 : N.document) == null ? void 0 : P.actorId) === l && typeof N.draw == "function" && N.draw();
        ...
        for (const P of S)
          ((O = P == null ? void 0 : P.document) == null ? void 0 : O.actorId) === l && typeof P.draw == "function" && P.draw();
      }).catch((S) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", S));
    }, 0);
  });
  const s = 500;
  Hooks.on("updateActor", (m, d, f, g) => {
    var T, O, P, N, v, C, _, R, j, U, G, Z, V;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((T = d == null ? void 0 : d.system) != null && T.combat) && "initiativeResult" in d.system.combat) {
      const M = Number((P = (O = m.system) == null ? void 0 : O.combat) == null ? void 0 : P.initiativeResult), Y = Number.isFinite(M) ? M : 0, re = game.combat;
      if (re) {
    ...
    if (m.type === "Npc" && ((C = d == null ? void 0 : d.system) != null && C.identity) && "size" in d.system.identity) {
      const M = As((R = (_ = m.system) == null ? void 0 : _.identity) == null ? void 0 : R.size);
      m.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var y, b, w, S, T, O, P, N, v, C, _, R, j, U, G, Z, V, M, Y, re, Ie, fe, Se;
    ...
    let m = ((P = game.actors) == null ? void 0 : P.get(a.actorId)) ?? ((N = game.actors) == null ? void 0 : N.get(u));
...
Hooks.on("preCreateToken", (I, s, e) => {
  ...
  if (p) {
    ...
    if (p.type === "Npc") {
      const f = As((d = (m = p.system) == null ? void 0 : m.identity) == null ? void 0 : d.size);
      I.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("combatRound", (I, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || Fs(I);
});
function Es() {
  var s, e, t;
...
Hooks.on("updateCombat", (I, s, e) => {
  (s == null ? void 0 : s.round) != null && Fs(I), setTimeout(Es, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-CrsaWFr0.mjs.map
