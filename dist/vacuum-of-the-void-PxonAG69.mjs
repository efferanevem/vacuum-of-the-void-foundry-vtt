...
const { BooleanField: St, NumberField: Ft, StringField: se } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-ui7Kznt7.mjs");
      a(this.actor, l);
    ...
    r && i({ currentTarget: r }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      o.preventDefault();
      const c = o.currentTarget, l = c.dataset.skill, a = ((f = c.textContent) == null ? void 0 : f.trim()) || l, { openRollSheetForSkill: m } = await import("./roll-sheet-ui7Kznt7.mjs");
      m(this.actor, l, a);
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = It, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = qt, CONFIG.Item.dataModels.Pancel = Ot, CONFIG.Item.dataModels.MikroChip = Dt, CONFIG.Item.dataModels.Kepesseg = Qe, CONFIG.Item.dataModels.ability = Qe, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-PxonAG69.mjs.map
