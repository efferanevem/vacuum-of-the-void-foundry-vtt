...
var Q = (w, s, e) => Ks(w, typeof s != "symbol" ? s + "" : s, e);
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe, v, P, E, U, oe, Y, ye, me, ce, _e, Re, Me, _t, Dt, Ot, Ct, dt, We, Bt, Gt, Wt, Vt, Yt, Xt, Qt, Jt, Zt, es, ts, ss, is, ns;
    ...
    b === 0 && (D = 0), (me = (ye = (Y = this.actor) == null ? void 0 : Y.statuses) == null ? void 0 : ye.has) != null && me.call(ye, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const C = this.actor.system.weapons ?? {}, N = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = (C.slotOrder ?? "").trim(), A = x ? x.split(/\s*,\s*/).filter((g) => N.includes(g)) : [], z = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, H = z && typeof z == "object" && !Array.isArray(z) ? z : {}, B = (((Me = H.slot1) == null ? void 0 : Me.itemId) ?? "").trim(), W = (((_t = H.slot2) == null ? void 0 : _t.itemId) ?? "").trim(), ie = (((Dt = H.slot3) == null ? void 0 : Dt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      ...
      for (let Ve = 0; Ve < A.length; Ve++) {
        ...
        if ((((De = C[pt]) == null ? void 0 : De.itemId) ?? "") === g.id) {
          F = Ve + 1, R = ((je = C[pt]) == null ? void 0 : je.bonus) ?? "", Z = pt;
          break;
        }
      }
      let X = null;
      _ && (B === g.id ? X = "slot1" : W === g.id ? X = "slot2" : ie === g.id && (X = "slot3"));
      const Ke = O && ((ze = g.system) != null && ze.damage) ? g.system.damage : "", le = O && typeof ((Ce = g.system) == null ? void 0 : Ce.range) == "string" ? (g.system.range || "").trim() : "", pe = Z ? Number((qe = C[Z]) == null ? void 0 : qe.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.actionsTable = M;
    const V = (((Ot = this.actor.items) == null ? void 0 : Ot.contents) ?? []).filter((g) => g.type === "Fegyver"), ae = V.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = ae;
    const Se = "— Nincs fegyver —", fe = A.filter((g) => {
      const _ = ((C[g] ?? {}).itemId ?? "").trim();
      return _ ? !!V.find((R) => R.id === _) : !1;
    });
    e.weaponSlots = fe.map((g, O) => {
      const _ = C[g] ?? {}, F = (_.itemId ?? "").trim(), R = ae.find((pe) => pe.id === F), Z = V.find((pe) => pe.id === F), X = (Z == null ? void 0 : Z.system) ?? {}, Ke = X.size === "thrown", le = (typeof X.range == "string" ? (X.range || "").trim() : "") || "—";
      return {
        slotKey: g,
        itemId: F,
        slotNum: O + 1,
    ...
    e.weaponsTable = V.map((g) => {
      ...
      let _ = null, F = {};
      for (const Lt of A)
        if ((((as = C[Lt]) == null ? void 0 : as.itemId) ?? "").trim() === O) {
          _ = Lt, F = C[Lt] ?? {};
          break;
        }
      const R = !!_, Z = ((rs = g.system) == null ? void 0 : rs.equipped) !== void 0 && ((os = g.system) == null ? void 0 : os.equipped) !== null ? !!g.system.equipped : R, X = (g == null ? void 0 : g.system) ?? {}, Ke = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", pe = (Ie[le] ?? le) || "—", De = X.size ?? "", je = (re[De] ?? De) || "", ze = [pe, je].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || De === "thrown", qe = X.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(X.bonus ?? "").trim(), $s = Ve || pt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    e.microchipItemsSlot1 = ne.filter((g) => !Ue(1).includes(g.id)), e.microchipItemsSlot2 = ne.filter((g) => !Ue(2).includes(g.id)), e.microchipItemsSlot3 = ne.filter((g) => !Ue(3).includes(g.id)), e.microchipSlots = Te.map((g) => {
      ...
      const O = `slot${g}`, _ = H[O] ?? {}, F = (_.itemId ?? "").trim(), R = ne.find((Z) => Z.id === F);
      ...
      const F = !!_, R = ((je = g == null ? void 0 : g.system) == null ? void 0 : je.abilityType) ?? "", Z = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", X = R === "active", Ke = Number((ze = g == null ? void 0 : g.system) == null ? void 0 : ze.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, le = (((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.description) ?? "").trim(), pe = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const bt = this.actor.system.abilities ?? {}, Ut = (((Xt = this.actor.items) == null ? void 0 : Xt.contents) ?? []).map((g) => {
      ...
      const O = bt[g] ?? {}, _ = (O.itemId ?? "").trim(), F = _ ? Be.get(_) : null, R = (F == null ? void 0 : F.description) ?? "", Z = (F == null ? void 0 : F.kp) ?? 0;
      return {
        itemId: _,
    ...
    const kt = ((Qt = e.system) == null ? void 0 : Qt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Fe = (Zt = (Jt = e.system) == null ? void 0 : Jt.combat) == null ? void 0 : Zt.initiativeResult, de = typeof Fe == "number" ? Fe : -1, wt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ae = (ts = (es = e.system) == null ? void 0 : es.combat) == null ? void 0 : ts.initiativeRanges, Pe = Array.isArray(Ae) ? Ae.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Oe = (Pe.length > 0 ? Pe : wt).slice().sort((g, O) => g.min - O.min), Ee = Pe.map((g) => g.min), St = Ee.length ? Math.min(...Ee) : 0, It = Ee.length ? Math.max(...Ee) : 0;
    ...
    if (typeof de == "number" && de >= 0 && Oe.length > 0) {
      ...
      let _ = null;
      de <= g.max ? _ = g : de >= O.min ? _ = O : _ = Oe.find((F) => de >= F.min && de <= F.max), _ && (Ze = _.kp);
    }
    e.kpDots = Ge.map((g, O) => {
      const _ = O + 1, F = !!Number(kt[g]), R = _ <= Ze;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BeJhY3Vh.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-BeJhY3Vh.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: f } = await import("./roll-sheet-BeJhY3Vh.mjs");
      f(this.actor, c, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Qe, Je, kt, Ge, Fe, de, wt, Ae, Pe, Nt, Oe, Ee, St, It, Ze, Tt, et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe;
    ...
    e.weaponSlots = S.map((v) => {
      const P = y[v] ?? {}, E = (P.itemId ?? "").trim(), U = c.find((ce) => ce.id === E), oe = o.find((ce) => ce.id === E), Y = (oe == null ? void 0 : oe.system) ?? {}, ye = Y.size === "thrown", me = (typeof Y.range == "string" ? (Y.range || "").trim() : "") || "—";
      return {
        slotKey: v,
        itemId: E,
    ...
    e.weaponsTable = o.map((v) => {
      ...
      const oe = !!E, Y = (v == null ? void 0 : v.system) ?? {}, ye = typeof Y.range == "string" ? (Y.range || "").trim() : "", me = Y.type ?? "", ce = (I[me] ?? me) || "—", _e = Y.size ?? "", Re = (D[_e] ?? _e) || "", Me = [ce, Re].filter(Boolean).join(", ") || ce || "—", _t = me === "projectile" || _e === "thrown", Dt = Y.quantity != null ? String(Y.quantity).trim() : "1", Ot = String(Y.bonus ?? U.bonus ?? "").trim() || "0", Ct = (Y.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: P,
        actorId: t.id,
    ...
    e.microchipsTable = x.map((v) => {
      ...
      const U = ((ce = v == null ? void 0 : v.system) == null ? void 0 : ce.abilityType) ?? "", oe = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", Y = (((_e = v == null ? void 0 : v.system) == null ? void 0 : _e.description) ?? "").trim(), ye = Y ? Y.length > 60 ? Y.slice(0, 57) + "…" : Y : "—";
      return {
        itemId: P,
        actorId: t.id,
        name: (v == null ? void 0 : v.name) ?? "—",
    ...
    const H = (((It = e.weaponsTable) == null ? void 0 : It.length) ?? 0) > 0 || (((Ze = e.armorTable) == null ? void 0 : Ze.length) ?? 0) > 0 || (((Tt = e.microchipsTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((et = e.itemsTable) == null ? void 0 : et.length) ?? 0) > 0 || (((tt = e.egyebList) == null ? void 0 : tt.length) ?? 0) > 0;
    ...
    }), ie = new Map(W.map((v) => [v.id, v])), J = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    e.abilityPassiveList = V(M("passive")), e.abilityActiveList = V(M("active"));
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-BeJhY3Vh.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BeJhY3Vh.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BeJhY3Vh.mjs");
      a(this.actor, o, c);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Fegyver" && p) {
      const A = ((D = r.system) == null ? void 0 : D.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], H = (A.slotOrder ?? "").trim(), B = H ? H.split(/\s*,\s*/).filter((J) => z.includes(J)) : [];
      let W = z.find((J) => {
        var M;
        return !(((M = A[J]) == null ? void 0 : M.itemId) ?? "").trim();
      });
      W || (W = z.find((J) => !B.includes(J)) ?? "slot1");
      const ie = B.includes(W) ? B : [...B, W].filter((J) => z.includes(J));
      await r.update({
...
Q(ge, "PARTS", foundry.utils.mergeObject(j(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Q(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(ge, ge, "DEFAULT_OPTIONS"), {
...
Q(he, "PARTS", foundry.utils.mergeObject(j(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), Q(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(he, he, "DEFAULT_OPTIONS"), {
...
Q(be, "PARTS", foundry.utils.mergeObject(j(be, be, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Q(be, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(be, be, "DEFAULT_OPTIONS"), {
...
Q(ve, "PARTS", foundry.utils.mergeObject(j(ve, ve, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), Q(ve, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(ve, ve, "DEFAULT_OPTIONS"), {
...
Q(ke, "PARTS", foundry.utils.mergeObject(j(ke, ke, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), Q(ke, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(ke, ke, "DEFAULT_OPTIONS"), {
...
Q(we, "PARTS", foundry.utils.mergeObject(j(we, we, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Q(we, "DEFAULT_OPTIONS", foundry.utils.mergeObject(j(we, we, "DEFAULT_OPTIONS"), {
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var I, D, L, C, N, x, A, z, H, B, W, ie, J;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((I = p == null ? void 0 : p.system) != null && I.combat) && "initiativeResult" in p.system.combat) {
      const M = Number((L = (D = m.system) == null ? void 0 : D.combat) == null ? void 0 : L.initiativeResult), V = Number.isFinite(M) ? M : 0, ae = game.combat;
      if (ae) {
        const Se = ((C = ae.combatants) == null ? void 0 : C.contents) ?? Array.from(ae.combatants ?? []);
        for (const fe of Se)
          if (((N = fe.actor) == null ? void 0 : N.id) === l || fe.actorId === l) {
            ae.updateEmbeddedDocuments("Combatant", [{ _id: fe.id, initiative: V }]).catch(() => {
            });
            break;
          }
      }
    ...
    for (const M of f) {
      if (((B = M.document) == null ? void 0 : B.id) !== l || ((W = M.document) == null ? void 0 : W.documentName) !== "Actor") continue;
      const V = (ie = M.constructor) == null ? void 0 : ie.name;
      V !== "VoidKarakterSheet" && V !== "VoidJarmuSheet" || c.includes(M) || c.push(M);
    }
    if (o && c.some((M) => {
      const V = (M == null ? void 0 : M.form) ?? (M == null ? void 0 : M.element);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, k, S, I, D, L, C, N, x, A, z, H, B, W, ie, J, M, V, ae, Se, fe, Ie;
    ...
    if (y || (y = (((ie = p == null ? void 0 : p.system) == null ? void 0 : ie.damage) ?? "").trim()), !y && r.slotKey && (y = (((((J = m.system) == null ? void 0 : J.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (Se = (M = ui.notifications) == null ? void 0 : M.warn) == null || Se.call(M, ((ae = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : ae.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
...
//# sourceMappingURL=vacuum-of-the-void-BqqUW70W.mjs.map
