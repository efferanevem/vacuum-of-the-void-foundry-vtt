...
const { HTMLField: Fs, NumberField: q, SchemaField: K, StringField: T, BooleanField: ee, ArrayField: dt } = foundry.data.fields;
...
const { NumberField: Ct, SchemaField: Es } = foundry.data.fields;
class $s extends Ts {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Rs, StringField: St } = foundry.data.fields;
...
const { NumberField: qt, StringField: rs } = foundry.data.fields;
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Ze, et, tt, st, it, nt, at, rt, Ae, k, F, E, H, le, W, je, Ie, _e, ce, Fe, Ee, kt, vt, wt, It, ot, ze, Mt, Kt, jt, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt, Xt, Zt, es, ts;
    ...
    const o = Number(((at = (nt = this.actor.system) == null ? void 0 : nt.combat) == null ? void 0 : at.givenProtection) ?? 0) || 0, a = (k = (Ae = (rt = this.actor) == null ? void 0 : rt.statuses) == null ? void 0 : Ae.has) != null && k.call(Ae, "lookaround") ? 1 : 0, f = (H = (E = (F = this.actor) == null ? void 0 : F.statuses) == null ? void 0 : E.has) != null && H.call(E, "halfcover") ? 3 : 0, h = (je = (W = (le = this.actor) == null ? void 0 : le.statuses) == null ? void 0 : W.has) != null && je.call(W, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + a + f + h;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: v } },
      { inplace: !1 }
    );
    const I = ((Ie = e.system) == null ? void 0 : Ie.combat) ?? {};
    ...
    b === 0 && (D = 0), (Fe = (ce = (_e = this.actor) == null ? void 0 : _e.statuses) == null ? void 0 : ce.has) != null && Fe.call(ce, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (kt = (Ee = e.system) == null ? void 0 : Ee.combat) == null ? void 0 : kt.givenProtection } },
      { inplace: !1 }
    ), D = 0), e.totalSpeed = D;
    ...
    const C = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = (C.slotOrder ?? "").trim(), A = x ? x.split(/\s*,\s*/).filter((g) => L.includes(g)) : [], j = (vt = this.actor.system.gear) == null ? void 0 : vt.microchips, z = j && typeof j == "object" && !Array.isArray(j) ? j : {}, U = (((wt = z.slot1) == null ? void 0 : wt.itemId) ?? "").trim(), V = (((It = z.slot2) == null ? void 0 : It.itemId) ?? "").trim(), te = (((ot = z.slot3) == null ? void 0 : ot.itemId) ?? "").trim(), M = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, P = typeof O.sort == "number" ? O.sort : 0;
      return _ - P;
    }).map((g) => {
      var Se, xe, Re, De, Oe, lt;
      const O = g.type === "Fegyver", _ = g.type === "MikroChip";
      let P = 0, R = "", Z = null;
      for (let He = 0; He < A.length; He++) {
        const ut = A[He];
        if ((((Se = C[ut]) == null ? void 0 : Se.itemId) ?? "") === g.id) {
          P = He + 1, R = ((xe = C[ut]) == null ? void 0 : xe.bonus) ?? "", Z = ut;
          break;
        }
      }
      let X = null;
      _ && (U === g.id ? X = "slot1" : V === g.id ? X = "slot2" : te === g.id && (X = "slot3"));
      const ct = O && ((Re = g.system) != null && Re.damage) ? g.system.damage : "", ue = O && typeof ((De = g.system) == null ? void 0 : De.range) == "string" ? (g.system.range || "").trim() : "", $e = Z ? Number((Oe = C[Z]) == null ? void 0 : Oe.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.actionsTable = M;
    const Q = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((g) => g.type === "Fegyver"), ne = Q.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = ne;
    const he = "— Nincs fegyver —", ie = A.filter((g) => {
    ...
    const oe = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, qe = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = Q.map((g) => {
      var ss, is, ns;
      const O = g.id;
      let _ = null, P = {};
      for (const Ot of A)
        if ((((ss = C[Ot]) == null ? void 0 : ss.itemId) ?? "").trim() === O) {
          _ = Ot, P = C[Ot] ?? {};
          break;
        }
      const R = !!_, Z = ((is = g.system) == null ? void 0 : is.equipped) !== void 0 && ((ns = g.system) == null ? void 0 : ns.equipped) !== null ? !!g.system.equipped : R, X = (g == null ? void 0 : g.system) ?? {}, ct = typeof X.range == "string" ? (X.range || "").trim() : "", ue = X.type ?? "", $e = (oe[ue] ?? ue) || "—", Se = X.size ?? "", xe = (qe[Se] ?? Se) || "", Re = [$e, xe].filter(Boolean).join(", ") || $e || "—", De = ue === "projectile" || Se === "thrown", Oe = X.quantity, lt = Oe != null ? String(Oe).trim() : "1", He = String(P.bonus ?? "").trim(), ut = String(X.bonus ?? "").trim(), qs = He || ut || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    const ae = (((Mt = this.actor.items) == null ? void 0 : Mt.contents) ?? []).filter((g) => g.type === "Pancel");
    e.armorTable = ae.map((g) => {
      var P, R;
    ...
    const be = (((Kt = this.actor.items) == null ? void 0 : Kt.contents) ?? []).filter((g) => g.type === "Targy");
    e.itemsTable = be.map((g) => {
    ...
    const Rt = (((jt = this.actor.items) == null ? void 0 : jt.contents) ?? []).filter((g) => g.type === "Egyeb");
    e.egyebList = Rt.map((g) => {
    ...
    const re = (((zt = this.actor.items) == null ? void 0 : zt.contents) ?? []).filter((g) => g.type === "MikroChip"), Le = re.map((g) => ({ id: g.id, name: g.name, img: g.img })), ke = "— Nincs Mikro-Chip —", Ue = ["slot1", "slot2", "slot3"], Me = (g) => {
      var _, P, R;
      const O = [];
    ...
    e.microchipItemsSlot1 = Le.filter((g) => !Me(1).includes(g.id)), e.microchipItemsSlot2 = Le.filter((g) => !Me(2).includes(g.id)), e.microchipItemsSlot3 = Le.filter((g) => !Me(3).includes(g.id)), e.microchipSlots = Ue.map((g) => {
      const O = z[g] ?? {}, _ = (O.itemId ?? "").trim(), P = re.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || O.name || ke,
        img: (P == null ? void 0 : P.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, _ = z[O] ?? {}, P = (_.itemId ?? "").trim(), R = Le.find((Z) => Z.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (R == null ? void 0 : R.name) || _.name || ke, e[`microchip${g}Img`] = (R == null ? void 0 : R.img) || "";
    }), e.microchipsTable = re.map((g) => {
      var Se, xe, Re, De;
      const O = g.id;
      let _ = null;
      for (const Oe of Ue)
        if ((((Se = z[Oe]) == null ? void 0 : Se.itemId) ?? "").trim() === O) {
          _ = Oe;
          break;
        }
      const P = !!_, R = ((xe = g == null ? void 0 : g.system) == null ? void 0 : xe.abilityType) ?? "", Z = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", X = R === "active", ct = Number((Re = g == null ? void 0 : g.system) == null ? void 0 : Re.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ue = (((De = g == null ? void 0 : g.system) == null ? void 0 : De.description) ?? "").trim(), $e = ue ? ue.length > 60 ? ue.slice(0, 57) + "…" : ue : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const Tt = (((Ht = e.weaponsTable) == null ? void 0 : Ht.length) ?? 0) > 0 || (((Ut = e.armorTable) == null ? void 0 : Ut.length) ?? 0) > 0 || (((Bt = e.microchipsTable) == null ? void 0 : Bt.length) ?? 0) > 0 || (((Gt = e.itemsTable) == null ? void 0 : Gt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Tt;
    const _t = this.actor.system.abilities ?? {}, Be = (((Vt = this.actor.items) == null ? void 0 : Vt.contents) ?? []).map((g) => {
      var O, _, P;
      return {
        id: g.id,
        name: g.name,
      ...
      const O = _t[g] ?? {}, _ = (O.itemId ?? "").trim(), P = _ ? Ge.get(_) : null, R = (P == null ? void 0 : P.description) ?? "", Z = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: _,
    ...
    const Ke = ((Wt = e.system) == null ? void 0 : Wt.resources) ?? {}, ft = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ve = (Jt = (Yt = e.system) == null ? void 0 : Yt.combat) == null ? void 0 : Jt.initiativeResult, we = typeof ve == "number" ? ve : -1, yt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Je = (Xt = (Qt = e.system) == null ? void 0 : Qt.combat) == null ? void 0 : Xt.initiativeRanges, Ne = Array.isArray(Je) ? Je.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Te = (Ne.length > 0 ? Ne : yt).slice().sort((g, O) => g.min - O.min), Pe = Ne.map((g) => g.min), gt = Pe.length ? Math.min(...Pe) : 0, ht = Pe.length ? Math.max(...Pe) : 0;
    e.initiativeRanges = Ne.map((g) => ({ ...g, isFirst: g.min === gt, isLast: g.min === ht }));
    let Qe = 0;
    if (typeof we == "number" && we >= 0 && Te.length > 0) {
      const g = Te[0], O = Te[Te.length - 1];
      let _ = null;
      we <= g.max ? _ = g : we >= O.min ? _ = O : _ = Te.find((P) => we >= P.min && we <= P.max), _ && (Qe = _.kp);
    }
    e.kpDots = ft.map((g, O) => {
      const _ = O + 1, P = !!Number(Ke[g]), R = _ <= Qe;
      return { index: _, used: P, usable: R };
    });
    const bt = !!((es = (Zt = game.combat) == null ? void 0 : Zt.combatants) != null && es.some((g) => {
      var O;
      return ((O = g.actor) == null ? void 0 : O.type) === "Karakter";
    }));
    return e.showHarcSection = bt, e.canEditInitiative = !!((ts = game.user) != null && ts.isGM), e.showInitiativeResult = typeof ve == "number", e.initiativeResult = e.showInitiativeResult ? ve : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CDVNgopS.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-CDVNgopS.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-CDVNgopS.mjs");
      f(this.actor, o, a);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var pt, Ve, We, Ye, Ke, ft, ve, we, yt, Je, Ne, Dt, Te, Pe, gt, ht, Qe, bt, Xe, Ze, et, tt, st, it, nt, at, rt, Ae;
    ...
    const t = this.actor, n = ((Ye = e.system) == null ? void 0 : Ye.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (ft = (Ke = t == null ? void 0 : t.statuses) == null ? void 0 : Ke.has) != null && ft.call(Ke, "lookaround") ? 1 : 0, l = (we = (ve = t == null ? void 0 : t.statuses) == null ? void 0 : ve.has) != null && we.call(ve, "halfcover") ? 3 : 0;
    e.effectiveGivenProtection = d + r + l;
    const m = ((yt = t == null ? void 0 : t.items) == null ? void 0 : yt.contents) ?? [], p = ((Je = t == null ? void 0 : t.system) == null ? void 0 : Je.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], b = (p.slotOrder ?? "").trim(), u = b ? b.split(/\s*,\s*/).filter((k) => y.includes(k)) : [], i = m.filter((k) => k.type === "Fegyver"), c = i.map((k) => ({ id: k.id, name: k.name, img: k.img })), o = "— Nincs fegyver —", a = u.length > 0 ? u : y, f = y.filter((k) => !a.includes(k)), h = [...a, ...f], v = h.filter((k) => {
      var E;
      const F = (((E = p[k]) == null ? void 0 : E.itemId) ?? "").trim();
      return F && i.some((H) => H.id === F);
    });
    e.weaponSlots = v.map((k) => {
      const F = p[k] ?? {}, E = (F.itemId ?? "").trim(), H = c.find((le) => le.id === E);
      return {
        slotKey: k,
        itemId: E,
        displayName: (H == null ? void 0 : H.name) || F.name || o,
    ...
    e.weaponsTable = i.map((k) => {
      ...
      let E = null, H = {};
      for (const ze of h)
        if ((((ot = p[ze]) == null ? void 0 : ot.itemId) ?? "").trim() === F) {
          E = ze, H = p[ze] ?? {};
          break;
        }
      const le = !!E, W = (k == null ? void 0 : k.system) ?? {}, je = typeof W.range == "string" ? (W.range || "").trim() : "", Ie = W.type ?? "", _e = (I[Ie] ?? Ie) || "—", ce = W.size ?? "", Fe = (S[ce] ?? ce) || "", Ee = [_e, Fe].filter(Boolean).join(", ") || _e || "—", kt = Ie === "projectile" || ce === "thrown", vt = W.quantity != null ? String(W.quantity).trim() : "1", wt = String(W.bonus ?? H.bonus ?? "").trim() || "0", It = (W.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const D = m.filter((k) => k.type === "Pancel");
    ...
    const N = ((Dt = (Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.gear) == null ? void 0 : Dt.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], L = m.filter((k) => k.type === "MikroChip");
    e.microchipsTable = L.map((k) => {
      var Ie, _e, ce, Fe;
      const F = k.id;
      let E = null;
      for (const Ee of C)
        if ((((Ie = N[Ee]) == null ? void 0 : Ie.itemId) ?? "").trim() === F) {
          E = Ee;
          break;
        }
      const H = ((_e = k == null ? void 0 : k.system) == null ? void 0 : _e.abilityType) ?? "", le = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", W = (((ce = k == null ? void 0 : k.system) == null ? void 0 : ce.description) ?? "").trim(), je = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        ...
        typeLabel: le,
        description: je,
        kp: Number((Fe = k == null ? void 0 : k.system) == null ? void 0 : Fe.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: H === "active",
        slotKey: E ?? "",
        equipped: !!E
      };
    ...
    const j = (((Te = e.weaponsTable) == null ? void 0 : Te.length) ?? 0) > 0 || (((Pe = e.armorTable) == null ? void 0 : Pe.length) ?? 0) > 0 || (((gt = e.microchipsTable) == null ? void 0 : gt.length) ?? 0) > 0 || (((ht = e.itemsTable) == null ? void 0 : ht.length) ?? 0) > 0 || (((Qe = e.egyebList) == null ? void 0 : Qe.length) ?? 0) > 0;
    e.showEquipmentDropZone = !j;
    const z = ((bt = t == null ? void 0 : t.system) == null ? void 0 : bt.abilities) ?? {}, U = m.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, E;
      return {
        id: k.id,
        name: k.name,
    ...
    }), V = new Map(U.map((k) => [k.id, k])), te = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    e.abilityFajiSlot = te, e.abilityHatterSlot = te;
    const Y = (k) => {
      const F = z[k];
    ...
    e.abilityPassiveList = M(Y("passive")), e.abilityActiveList = M(Y("active"));
    const Q = t == null ? void 0 : t.id, ne = !!((Ze = (Xe = game.combat) == null ? void 0 : Xe.combatants) != null && Ze.some(
      (k) => {
        var F;
    ...
    const he = ((et = e.system) == null ? void 0 : et.resources) ?? {}, ie = (st = (tt = e.system) == null ? void 0 : tt.combat) == null ? void 0 : st.initiativeResult, oe = typeof ie == "number" ? ie : -1, qe = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ae = (nt = (it = e.system) == null ? void 0 : it.combat) == null ? void 0 : nt.initiativeRanges, be = Array.isArray(ae) ? ae.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (be.length > 0 ? be : qe).slice().sort((k, F) => k.min - F.min), Le = 3;
    let ke = be.length > 0 ? be : [];
    ke.length < Le && (ke = [...ke, ...Array(Le - ke.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ke.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === ke.length - 1
    }));
    let Ue = 0;
    if (typeof oe == "number" && oe >= 0 && re.length > 0) {
      const k = re[0], F = re[re.length - 1];
      let E = null;
      oe <= k.max ? E = k : oe >= F.min ? E = F : E = re.find((H) => oe >= H.min && oe <= H.max), E && (Ue = E.kp);
    }
    const Me = re.length > 0 ? re[re.length - 1] : null, Tt = Math.min(10, Me ? Me.kp : 6), Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, Tt)).map((k, F) => {
      const E = F + 1, H = !!Number(he[k]), le = E <= Ue;
      return { index: E, used: H, usable: le };
    }), Ge = Math.ceil(Be.length / 2);
    return e.kpDotsRow1 = Be.slice(0, Ge), e.kpDotsRow2 = Be.slice(Ge), e.canEditInitiative = !!((at = game.user) != null && at.isGM), e.showInitiativeResult = typeof ie == "number", e.initiativeResult = e.showInitiativeResult ? ie : "", e.speedUnitForSelect = ((Ae = (rt = e.system) == null ? void 0 : rt.combat) == null ? void 0 : Ae.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var p, y, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CDVNgopS.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CDVNgopS.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CDVNgopS.mjs");
      a(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((o = d.parent) == null ? void 0 : o.id) !== r.id) {
        ...
        A = ((a = (await r.createEmbeddedDocuments("Item", [te]))[0]) == null ? void 0 : a.id) ?? A;
      }
    ...
    if (d.type === "Fegyver" && p) {
      const A = ((D = r.system) == null ? void 0 : D.weapons) ?? {}, j = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], z = (A.slotOrder ?? "").trim(), U = z ? z.split(/\s*,\s*/).filter((Y) => j.includes(Y)) : [];
      let V = j.find((Y) => {
        var M;
        return !(((M = A[Y]) == null ? void 0 : M.itemId) ?? "").trim();
      });
      V || (V = j.find((Y) => !U.includes(Y)) ?? "slot1");
      const te = U.includes(V) ? U : [...U, V].filter((Y) => j.includes(Y));
      await r.update({
...
J(se, "PARTS", foundry.utils.mergeObject(
  ...
  B(se, se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((fs = B(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : fs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((ys = B(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : ys.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((hs = (gs = B(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : gs.window) == null ? void 0 : hs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const c = mt.getTotalSpeedRaw(i), o = (f = i.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (c <= 0 && !o) {
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, D, N, C, L, x, A, j, z, U, V, te, Y;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const M = Number((N = (D = m.system) == null ? void 0 : D.combat) == null ? void 0 : N.initiativeResult), Q = Number.isFinite(M) ? M : 0, ne = game.combat;
      if (ne) {
        const he = ((C = ne.combatants) == null ? void 0 : C.contents) ?? Array.from(ne.combatants ?? []);
        for (const ie of he)
          if (((L = ie.actor) == null ? void 0 : L.id) === u || ie.actorId === u) {
            ne.updateEmbeddedDocuments("Combatant", [{ _id: ie.id, initiative: Q }]).catch(() => {
            });
            break;
          }
      }
    ...
    for (const M of f)
      ((U = M.document) == null ? void 0 : U.id) !== u || ((V = M.document) == null ? void 0 : V.documentName) !== "Actor" || ((te = M.constructor) == null ? void 0 : te.name) !== "VoidKarakterSheet" || o.includes(M) || o.push(M);
    if (c && o.some((M) => {
      const Q = (M == null ? void 0 : M.form) ?? (M == null ? void 0 : M.element);
      return Q && Q.contains(i);
    })) return;
    const v = (Y = game.votv) == null ? void 0 : Y._lastKarakterSheetBlurSave, I = v && Date.now() - v.at < s ? v.appId : null;
    setTimeout(() => {
      for (const M of o)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, D, N, C, L, x, A, j, z, U, V, te, Y, M, Q, ne, he, ie, oe;
    ...
    if (m || (m = ((x = (L = game.scenes) == null ? void 0 : L.contents) == null ? void 0 : x.flatMap((ae) => {
      var be;
      return ((be = ae.tokens) == null ? void 0 : be.contents) ?? [];
    }).map((ae) => ae.actor).find((ae) => ae && (ae.id === l || ae.id === r.actorId))) ?? null), !m) return;
    const p = r.itemId ? ((j = (A = m.items) == null ? void 0 : A.get) == null ? void 0 : j.call(A, r.itemId)) ?? ((V = (U = (z = m.items) == null ? void 0 : z.contents) == null ? void 0 : U.find) == null ? void 0 : V.call(U, (qe) => qe.id === r.itemId)) : null;
    let y = (r.damageFormula ?? "").trim();
    if (y || (y = (((te = p == null ? void 0 : p.system) == null ? void 0 : te.damage) ?? "").trim()), !y && r.slotKey && (y = (((((Y = m.system) == null ? void 0 : Y.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (he = (M = ui.notifications) == null ? void 0 : M.warn) == null || he.call(M, ((ne = (Q = game.i18n) == null ? void 0 : Q.localize) == null ? void 0 : ne.call(Q, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
...
//# sourceMappingURL=vacuum-of-the-void-DKjUNhT0.mjs.map
