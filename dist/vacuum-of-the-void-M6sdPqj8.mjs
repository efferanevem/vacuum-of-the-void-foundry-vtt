...
var zt = Reflect.get;
var Gt = (N, s, e) => s in N ? Ut(N, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : N[s] = e;
var z = (N, s, e) => Gt(N, typeof s != "symbol" ? s + "" : s, e);
var K = (N, s, e) => zt(Bt(N), e, s);
...
const { BooleanField: Qt, NumberField: ns, StringField: qe } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const r = document.activeElement, f = n.contains(r), h = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA");
      f && h && (l.focus = {
        name: r.name || null,
        id: r.id || null,
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var b, u, i, c, o, r, f, h, v;
    const e = s ?? this.form ?? this.element;
    let t = (b = e == null ? void 0 : e.querySelector) == null ? void 0 : b.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const a = ((i = (u = this.actor) == null ? void 0 : u.system) == null ? void 0 : i.resources) ?? {}, d = ((o = (c = a.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((r = a.currentHealth) == null ? void 0 : r.legs) ?? 0, l = B._healthStatusFromRatio(n, d), p = Number(((v = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _writeTotalSpeed(s = null) {
    ...
    if (!a) return;
    const p = ((r = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : r.resources) ?? {}, m = ((h = (f = p.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, y = ((v = p.currentHealth) == null ? void 0 : v.legs) ?? 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, a = ((p = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : p.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const a = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (p = a.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : m.value) ?? 0, n = ((y = a.currentHealth) == null ? void 0 : y[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    for (const g of l) {
      const C = ((Re = d[g]) == null ? void 0 : Re.value) ?? 0, _ = n[g] ?? 0;
      e.computedHealthStatus[g] = B._healthStatusFromRatio(_, C);
    }
    ...
    for (const [g, C] of Object.entries(I)) {
      const _ = e.computedHealthStatus[C];
      e.skillHealthStatus[g] = _, e.skillDisabled[g] = _ === 0 ? " disabled" : "", e.skillHasHealthTint[g] = !0;
    }
    const T = this.actor.system.weapons ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = (T.slotOrder ?? "").trim(), q = L ? L.split(/\s*,\s*/).filter((g) => E.includes(g)) : [], w = (it = this.actor.system.gear) == null ? void 0 : it.microchips, O = w && typeof w == "object" && !Array.isArray(w) ? w : {}, F = (((rt = O.slot1) == null ? void 0 : rt.itemId) ?? "").trim(), D = (((nt = O.slot2) == null ? void 0 : nt.itemId) ?? "").trim(), H = (((at = O.slot3) == null ? void 0 : at.itemId) ?? "").trim(), W = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, C) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, P = typeof C.sort == "number" ? C.sort : 0;
      return _ - P;
    }).map((g) => {
      var pe, Ce, Oe, he, be, $e;
      const C = g.type === "Fegyver", _ = g.type === "MikroChip";
      let P = 0, R = "", J = null;
      for (let Pe = 0; Pe < q.length; Pe++) {
        const xe = q[Pe];
        if ((((pe = T[xe]) == null ? void 0 : pe.itemId) ?? "") === g.id) {
          P = Pe + 1, R = ((Ce = T[xe]) == null ? void 0 : Ce.bonus) ?? "", J = xe;
          break;
        }
      }
      let Y = null;
      _ && (F === g.id ? Y = "slot1" : D === g.id ? Y = "slot2" : H === g.id && (Y = "slot3"));
      const Fe = C && ((Oe = g.system) != null && Oe.damage) ? g.system.damage : "", ie = C && typeof ((he = g.system) == null ? void 0 : he.range) == "string" ? (g.system.range || "").trim() : "", De = J ? Number((be = T[J]) == null ? void 0 : be.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.weaponItems = fe;
    const te = "— Nincs fegyver —", ue = q.filter((g) => {
      const _ = ((T[g] ?? {}).itemId ?? "").trim();
      return _ ? !!ee.find((R) => R.id === _) : !1;
    });
    e.weaponSlots = ue.map((g, C) => {
      const _ = T[g] ?? {}, P = (_.itemId ?? "").trim(), R = fe.find((J) => J.id === P);
      return {
        slotKey: g,
        itemId: P,
        slotNum: C + 1,
    ...
    e.armorTable = we.map((g) => {
      var P, R;
      const C = (g == null ? void 0 : g.system) ?? {}, _ = ((P = g.system) == null ? void 0 : P.equipped) !== void 0 && ((R = g.system) == null ? void 0 : R.equipped) !== null ? !!g.system.equipped : !1;
      return {
        itemId: g.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = Ie.map((g) => {
      const C = (g == null ? void 0 : g.system) ?? {}, _ = (C.description ?? "").trim(), P = _ ? _.length > 60 ? _.slice(0, 57) + "…" : _ : "—", R = C.quantity != null ? String(C.quantity).trim() : "1";
      return {
        itemId: g.id,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const X = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((g) => g.type === "MikroChip"), se = X.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ne = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var _, P, R;
      const C = [];
      return g !== 1 && C.push((((_ = O.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && C.push((((P = O.slot2) == null ? void 0 : P.itemId) ?? "").trim()), g !== 3 && C.push((((R = O.slot3) == null ? void 0 : R.itemId) ?? "").trim()), C.filter(Boolean);
    };
    e.microchipItemsSlot1 = se.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = se.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = se.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      const C = O[g] ?? {}, _ = (C.itemId ?? "").trim(), P = X.find((R) => R.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || C.name || Ne,
        img: (P == null ? void 0 : P.img) || "",
        active: C.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const C = `slot${g}`, _ = O[C] ?? {}, P = (_.itemId ?? "").trim(), R = se.find((J) => J.id === P);
      e[`microchip${g}ItemId`] = P, e[`microchip${g}DisplayName`] = (R == null ? void 0 : R.name) || _.name || Ne, e[`microchip${g}Img`] = (R == null ? void 0 : R.img) || "";
    }), e.microchipsTable = X.map((g) => {
      var pe, Ce, Oe, he;
      const C = g.id;
      let _ = null;
      for (const be of k)
        if ((((pe = O[be]) == null ? void 0 : pe.itemId) ?? "").trim() === C) {
          _ = be;
          break;
        }
      const P = !!_, R = ((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.abilityType) ?? "", J = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Y = R === "active", Fe = Number((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, ie = (((he = g == null ? void 0 : g.system) == null ? void 0 : he.description) ?? "").trim(), De = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: C,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const U = this.actor.system.abilities ?? {}, Se = (((gt = this.actor.items) == null ? void 0 : gt.contents) ?? []).map((g) => {
      var C, _, P;
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        kind: ((C = g.system) == null ? void 0 : C.kind) ?? "passive",
      ...
      const C = U[g] ?? {}, _ = (C.itemId ?? "").trim(), P = _ ? G.get(_) : null, R = (P == null ? void 0 : P.description) ?? "", J = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: _,
        displayName: (P == null ? void 0 : P.name) || C.name || Ee,
        img: (P == null ? void 0 : P.img) || "",
        description: R,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-eqTGPL5_.mjs");
      r(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-eqTGPL5_.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((L = (E = this.actor.items).get) == null ? void 0 : L.call(E, h)) ?? ((w = (q = this.actor.items.contents) == null ? void 0 : q.find) == null ? void 0 : w.call(q, (F) => F.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], E = I ? I.split(/\s*,\s*/).filter((q) => T.includes(q)) : [], L = E.find((q) => {
          var w;
          return (((w = v[q]) == null ? void 0 : w.itemId) ?? "").trim() === o;
        });
        if (L) {
          const q = E.filter((w) => w !== L);
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.bonus`]: ((q = r == null ? void 0 : r.system) == null ? void 0 : q.bonus) ?? ""
      ...
      var w;
      i.preventDefault();
      const c = i.currentTarget, o = c.closest(".karakter-microchip-slot-select-wrap"), r = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), f = r == null ? void 0 : r.dataset.slot;
      if (!f) return;
      ...
      T && (T.textContent = v);
      let E = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      I ? (E || (E = document.createElement("img"), E.className = "karakter-microchip-slot-thumb", E.alt = "", r == null || r.insertBefore(E, T)), E.src = I, E.style.display = "") : E && E.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      h && (q[`system.gear.microchips.${f}.active`] = !0), await this.actor.update(q);
      ...
      const r = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((T) => {
        var E;
        return (((E = r[T]) == null ? void 0 : E.itemId) ?? "").trim() === c;
      });
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.bonus`]: ((q = r.system) == null ? void 0 : q.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (T) {
        const w = I.filter((O) => O !== T);
        await this.actor.update({
    ...
    const p = this, m = (i) => {
      ...
      var c, o, r;
      return i && (((o = (c = p.element) == null ? void 0 : c.contains) == null ? void 0 : o.call(c, i)) || p.id && ((r = i.closest) == null ? void 0 : r.call(i, `#${CSS.escape(p.id)}`)));
    };
    p._votvBlur = (i) => {
      var h;
      const c = i.target;
      ...
      f && (r.contains(f) || p.id && ((h = f.closest) != null && h.call(f, `#${CSS.escape(p.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: p.id, at: Date.now() }), m(r));
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
            const E = foundry.utils.mergeObject(r.toObject(), { type: "Kepesseg" });
            f = ((d = (await this.actor.createEmbeddedDocuments("Item", [E]))[0]) == null ? void 0 : d.id) ?? f;
          }
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          const f = this.actor, h = ((m = r.parent) == null ? void 0 : m.id) !== f.id;
          let v = r.id;
          if (h) {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = T ? T.split(/\s*,\s*/).filter((w) => E.includes(w)) : [], q = L.filter((w) => {
              var O;
              return (((O = I[w]) == null ? void 0 : O.itemId) ?? "").trim() === v;
            });
            if (q.length > 0) {
              const O = {
                "system.weapons.slotOrder": L.filter((F) => !q.includes(F)).join(",")
              };
              for (const F of q)
        ...
        if (r && r.documentName === "Item" && r.type === "MikroChip") {
          const f = this.actor;
          ((i = r.parent) == null ? void 0 : i.id) !== f.id && await f.createEmbeddedDocuments("Item", [r.toObject()]);
          return;
        }
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", a = Number(((b = e.system) == null ? void 0 : b.kp) ?? 0) || 0, d = (((u = e.system) == null ? void 0 : u.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const l = n && n.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, y = (((v = n == null ? void 0 : n.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", b = Number(a[y] || 0) || 0, u = p + b, c = `3d6${u !== 0 ? u > 0 ? `+${u}` : `${u}` : ""}`, o = new Roll(c);
    await o.evaluate({ async: !0 });
    const { resultType: r, label: f } = We(o), h = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
      flags: { "vacuum-of-the-void": { resultType: r, critLabel: f } },
      rollMode: h
    });
  }
  /** Sebzés gomb: fegyver sebzés formuláját dobja. */
  async _rollWeaponDamage(s, e = "") {
    var p, m, y, b, u, i, c, o, r, f;
    const t = this.actor;
    if (!t) return;
...
z(B, "PARTS", foundry.utils.mergeObject(
  ...
  K(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Dt = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ot = (Ct = K(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.window) == null ? void 0 : Ot.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, a = ((te = t == null ? void 0 : t.items) == null ? void 0 : te.contents) ?? [], d = ((ue = t == null ? void 0 : t.system) == null ? void 0 : ue.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), p = l ? l.split(/\s*,\s*/).filter((k) => n.includes(k)) : [], m = a.filter((k) => k.type === "Fegyver"), y = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = p.length > 0 ? p : n, i = n.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var M;
      const x = (((M = d[k]) == null ? void 0 : M.itemId) ?? "").trim();
      return x && m.some((U) => U.id === x);
    });
    e.weaponSlots = o.map((k) => {
      const x = d[k] ?? {}, M = (x.itemId ?? "").trim(), U = y.find((Se) => Se.id === M);
      return {
        slotKey: k,
        itemId: M,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const Se = !!M, G = (k == null ? void 0 : k.system) ?? {}, Ee = typeof G.range == "string" ? (G.range || "").trim() : "", de = G.type ?? "", ge = (r[de] ?? de) || "—", me = G.size ?? "", Te = (f[me] ?? me) || "", _e = [ge, Te].filter(Boolean).join(", ") || ge || "—", Me = de === "projectile" || me === "thrown", Re = G.quantity != null ? String(G.quantity).trim() : "1", je = String(G.bonus ?? U.bonus ?? "").trim() || "0", Ke = (G.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.microchipsTable = T.map((k) => {
      ...
      const U = ((ge = k == null ? void 0 : k.system) == null ? void 0 : ge.abilityType) ?? "", Se = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", G = (((me = k == null ? void 0 : k.system) == null ? void 0 : me.description) ?? "").trim(), Ee = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const E = a.filter((k) => k.type === "Targy");
    ...
    const L = a.filter((k) => k.type === "Egyeb");
    e.egyebList = L.map((k) => {
    ...
    const q = (((we = e.weaponsTable) == null ? void 0 : we.length) ?? 0) > 0 || (((Ie = e.armorTable) == null ? void 0 : Ie.length) ?? 0) > 0 || (((ye = e.microchipsTable) == null ? void 0 : ye.length) ?? 0) > 0 || (((X = e.itemsTable) == null ? void 0 : X.length) ?? 0) > 0 || (((se = e.egyebList) == null ? void 0 : se.length) ?? 0) > 0;
    e.showEquipmentDropZone = !q;
    ...
    }), F = new Map(O.map((k) => [k.id, k])), D = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-portrait-img", (u) => {
      ...
      const i = ((f = (r = (o = foundry.applications) == null ? void 0 : o.apps) == null ? void 0 : r.FilePicker) == null ? void 0 : f.implementation) ?? globalThis.FilePicker;
      new i({
        type: "image",
        current: this.actor.img || "",
        callback: (h) => {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      var r, f, h, v;
      u.preventDefault();
      const i = (f = (r = u.currentTarget) == null ? void 0 : r.closest) == null ? void 0 : f.call(r, ".karakter-weapon-slot"), c = (((h = i == null ? void 0 : i.dataset) == null ? void 0 : h.itemId) ?? "").trim();
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-eqTGPL5_.mjs");
      o(this.actor, c);
      ...
      !c && ((r = i == null ? void 0 : i.dataset) != null && r.slot) && (c = (((((h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!c || !this.actor) && await this._rollWeaponDamage(c, (((v = i == null ? void 0 : i.dataset) == null ? void 0 : v.slot) ?? "").trim());
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-eqTGPL5_.mjs");
      r(this.actor, c, o);
      ...
      const o = ((E = this.actor.system) == null ? void 0 : E.abilities) ?? {}, f = (Array.isArray((L = o[i]) == null ? void 0 : L.items) ? o[i].items.slice() : []).filter((q) => q !== c);
      ...
      if (!c || !this.actor) return;
      const o = this.actor, r = (((v = i == null ? void 0 : i.dataset) == null ? void 0 : v.slotKey) ?? "").trim(), f = {};
      ...
      const c = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, r = ["slot1", "slot2", "slot3"].find((T) => {
        var E;
        return (((E = c[T]) == null ? void 0 : E.itemId) ?? "").trim() === i;
      });
    ...
    n._votvNpcBlur = (u) => {
      ...
      r && (o.contains(r) || n.id && ((f = r.closest) != null && f.call(r, `#${CSS.escape(n.id)}`))) || l(o);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const a = (((I = e.system) == null ? void 0 : I.weapons) ?? {})[s] ?? {}, d = ((T = e.system) == null ? void 0 : T.skills) ?? {}, n = ((E = e.items) == null ? void 0 : E.filter((q) => q.type === "Fegyver")) ?? [];
    let l = null;
    a.itemId && (l = n.find((q) => q.id === a.itemId) ?? null);
    const p = l && l.name || a.name || "Fegyver", m = Number(a.bonus || 0) || 0, b = (((L = l == null ? void 0 : l.system) == null ? void 0 : L.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", u = Number(d[b] || 0) || 0, i = m + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, r = new Roll(o);
    await r.evaluate({ async: !0 });
    const { resultType: f, label: h } = We(r), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return r.toMessage({
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, r, f, h, v, I, T, E, L, q;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const O = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), F = ((r = n.system) == null ? void 0 : r.abilities) ?? {}, D = O === "active" ? "active" : "passive", H = Array.isArray((f = F[D]) == null ? void 0 : f.items) ? F[D].items.slice() : Array.isArray(F[D]) ? F[D].slice() : [];
      H.includes(w) || H.push(w), await n.update({ [`system.abilities.${D}.items`]: H }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && m) {
      const w = ((I = n.system) == null ? void 0 : I.weapons) ?? {}, O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = (w.slotOrder ?? "").trim(), D = F ? F.split(/\s*,\s*/).filter((W) => O.includes(W)) : [];
      let H = O.find((W) => {
        var ee;
        return !(((ee = w[W]) == null ? void 0 : ee.itemId) ?? "").trim();
      });
      H || (H = O.find((W) => !D.includes(W)) ?? "slot1");
      const V = D.includes(H) ? D : [...D, H].filter((W) => O.includes(W));
      await n.update({
        ...
        [`system.weapons.${H}.bonus`]: ((E = d.system) == null ? void 0 : E.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const w = ((q = (L = n.system) == null ? void 0 : L.gear) == null ? void 0 : q.microchips) ?? {}, F = ["slot1", "slot2", "slot3"].find((D) => {
        var H;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((u = e.system) == null ? void 0 : u.kind) ?? "passive", a = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, d = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", p = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${n}</p>
      ${l}
      ${p}
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, p, m, y) => {
    ...
    if (l.type === "Npc" && ((I = p == null ? void 0 : p.system) != null && I.identity) && "size" in p.system.identity) {
      const D = Kt((E = (T = l.system) == null ? void 0 : T.identity) == null ? void 0 : E.size);
      l.update({
    ...
    const u = document.activeElement, i = u && (u.tagName === "INPUT" && u.type !== "checkbox" && u.type !== "radio" || u.tagName === "TEXTAREA" || u.isContentEditable), c = [], o = (L = game.actors) == null ? void 0 : L.get(b);
    o != null && o.apps && c.push(...Array.from(o.apps));
    const r = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const D of r)
      ((q = D.document) == null ? void 0 : q.id) !== b || ((w = D.document) == null ? void 0 : w.documentName) !== "Actor" || ((O = D.constructor) == null ? void 0 : O.name) !== "VoidKarakterSheet" || c.includes(D) || c.push(D);
    if (i && c.some((D) => {
      const H = (D == null ? void 0 : D.form) ?? (D == null ? void 0 : D.element);
      return H && H.contains(u);
    })) return;
    const h = (F = game.votv) == null ? void 0 : F._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < N ? h.appId : null;
    setTimeout(() => {
      for (const D of c)
    ...
    for (const [f, h] of Object.entries(u)) {
      ...
      !v || v !== l.id || (i[`system.weapons.${f}.name`] = l.name ?? "", i[`system.weapons.${f}.damage`] = ((o = l.system) == null ? void 0 : o.damage) ?? "", i[`system.weapons.${f}.bonus`] = ((r = l.system) == null ? void 0 : r.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, E, L, q, w, O, F, D, H, V, W, ee, fe, te, ue, ke, ve, we, Ie;
    ...
    if (!n) return;
    const l = n.actorId ?? ((E = d == null ? void 0 : d.speaker) == null ? void 0 : E.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let p = ((L = game.actors) == null ? void 0 : L.get(n.actorId)) ?? ((q = game.actors) == null ? void 0 : q.get(l));
    if (p || (p = ((O = (w = game.scenes) == null ? void 0 : w.contents) == null ? void 0 : O.flatMap((X) => {
      var se;
      return ((se = X.tokens) == null ? void 0 : se.contents) ?? [];
    }).map((X) => X.actor).find((X) => X && (X.id === l || X.id === n.actorId))) ?? null), !p) return;
    const m = n.itemId ? ((D = (F = p.items) == null ? void 0 : F.get) == null ? void 0 : D.call(F, n.itemId)) ?? ((W = (V = (H = p.items) == null ? void 0 : H.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (ye) => ye.id === n.itemId)) : null;
    let y = (n.damageFormula ?? "").trim();
    if (y || (y = (((ee = m == null ? void 0 : m.system) == null ? void 0 : ee.damage) ?? "").trim()), !y && n.slotKey && (y = (((((fe = p.system) == null ? void 0 : fe.weapons) ?? {})[n.slotKey] ?? {}).damage ?? "").trim()), !y) {
    ...
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = n.targetName || "", c = n.hitLocationName || "", o = ((m == null ? void 0 : m.name) ?? (n.slotKey ? ((Ie = (((we = p.system) == null ? void 0 : we.weapons) ?? {})[n.slotKey]) == null ? void 0 : Ie.name) ?? "" : "")) || "Fegyver";
  ...
  if (p) {
    if (a && p.classList.add(`votv-${a}`), d) {
      ...
      if (i)
        ...
        const c = p.querySelector(".dice-total"), o = (c == null ? void 0 : c.parentElement) ?? p, r = document.createElement("div");
        r.className = `votv-crit-label votv-crit-label-${a || "neutral"}`, r.textContent = d, o.appendChild(r);
      }
    }
    if (n && l && (l.actorId || (b = N.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !p.querySelector(".votv-weapon-damage-chat")) {
        ...
        f.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", f.dataset.actorId = String(l.actorId ?? ((u = N.speaker) == null ? void 0 : u.actor) ?? ""), f.dataset.itemId = String(l.itemId ?? ""), f.dataset.slotKey = String(l.slotKey ?? ""), f.dataset.targetName = String(l.targetName ?? ""), f.dataset.hitLocationName = String(l.hitLocationName ?? ""), f.dataset.messageId = String(N.id ?? ""), c.appendChild(f);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-M6sdPqj8.mjs.map
