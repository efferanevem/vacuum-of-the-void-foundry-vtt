...
const { HTMLField: qt, NumberField: q, SchemaField: C, StringField: v, BooleanField: U, ArrayField: le } = foundry.data.fields;
...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((s = i.querySelector) == null ? void 0 : s.call(i, "form.votv.karakter-sheet")) ?? ((n = i.querySelector) == null ? void 0 : n.call(i, "form.votv")) ?? null, t = ((r = i.querySelector) == null ? void 0 : r.call(i, ".votv-scroll")) ?? ((o = i.querySelector) == null ? void 0 : o.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const n = this.element, r = this.form ?? this.element;
    let o = { scrollState: {}, focus: null };
    if (n) {
      o.scrollState = this._saveScrollState(n);
    ...
    const f = this.element, y = this.form ?? this.element, h = o.scrollState, a = o.focus, d = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", c = () => {
      var p, g;
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (s <= 0 || t <= 0) return 0;
    const n = Math.floor(s / 3), r = Math.floor(2 * s / 3);
    return t <= n ? 1 : t <= r ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    const i = (((s = (t = this.actor) == null ? void 0 : t.items) == null ? void 0 : s.contents) ?? []).filter(
      (r) => {
        var o;
        return r.type === "Pancel" && ((o = r.system) == null ? void 0 : o.equipped) === !0;
      }
    );
    let e = 0;
    for (const r of i) {
      const o = String(((n = r.system) == null ? void 0 : n.speedPenalty) ?? "").trim().replace(",", "."), u = Number(o);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const r of i) {
      const o = String(((n = r.system) == null ? void 0 : n.protectionBonus) ?? "").trim().replace(",", "."), u = Number(o);
      Number.isFinite(u) && (e += u);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((d = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : d.resources) ?? {}, n = ((m = (c = s.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : m.value) ?? 0, r = ((p = s.currentHealth) == null ? void 0 : p.legs) ?? 0, o = N._healthStatusFromRatio(r, n), u = Number(((S = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let f;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const n = (Number(((f = (u = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : u.combat) == null ? void 0 : f.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((r = this.actor.system) == null ? void 0 : r.resources) ?? {}, s = ((u = (o = t.hitLocations) == null ? void 0 : o[e]) == null ? void 0 : u.value) ?? 0, n = ((f = t.currentHealth) == null ? void 0 : f[e]) ?? 0;
    return N._healthStatusFromRatio(n, s);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const s = ((o = i == null ? void 0 : i.system) == null ? void 0 : o.resources) ?? {}, n = ((f = (u = s.hitLocations) == null ? void 0 : u[t]) == null ? void 0 : f.value) ?? 0, r = ((y = s.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return N._healthStatusFromRatio(r, n);
  }
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const s = this.actor.system.resources ?? {}, n = s.hitLocations ?? {}, r = s.currentHealth ?? {}, o = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const l of o) {
      const I = ((Ne = n[l]) == null ? void 0 : Ne.value) ?? 0, w = r[l] ?? 0;
      e.computedHealthStatus[l] = N._healthStatusFromRatio(w, I);
    }
    const u = (Number(r.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((l) => (Number(r[l]) || 0) === 0).length;
    ...
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (b.slotOrder ?? "").trim(), L = O ? O.split(/\s*,\s*/).filter((l) => S.includes(l)) : [], F = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, _ = F && typeof F == "object" && !Array.isArray(F) ? F : {}, k = (((Ke = _.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), A = (((Ue = _.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), x = (((He = _.slot3) == null ? void 0 : He.itemId) ?? "").trim(), mt = this.actor.items.contents.filter((l) => l.type !== "Kepesseg" && l.type !== "ability").slice().sort((l, I) => {
    ...
    const Te = "— Nincs fegyver —", pt = L.filter((l) => {
      const w = ((b[l] ?? {}).itemId ?? "").trim();
      return w ? !!ue.find((D) => D.id === w) : !1;
    });
    e.weaponSlots = pt.map((l, I) => {
      const w = b[l] ?? {}, T = (w.itemId ?? "").trim(), D = Se.find((j) => j.id === T);
      return {
        slotKey: l,
        itemId: T,
        slotNum: I + 1,
    ...
    e.weaponsTable = ue.map((l) => {
      ...
      const D = !!w, j = ((re = l.system) == null ? void 0 : re.equipped) !== void 0 && ((Je = l.system) == null ? void 0 : Je.equipped) !== null ? !!l.system.equipped : D, K = (l == null ? void 0 : l.system) ?? {}, ae = typeof K.range == "string" ? (K.range || "").trim() : "", Q = K.type ?? "", J = (ft[Q] ?? Q) || "—", X = K.size ?? "", ee = (yt[X] ?? X) || "", te = [J, ee].filter(Boolean).join(", ") || J || "—", Z = J === "Lövedékes", V = K.quantity, ne = V != null ? String(V).trim() : "1";
      return {
        slotKey: w ?? "",
        itemId: I,
    ...
    const de = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).filter((l) => l.type === "MikroChip"), oe = de.map((l) => ({ id: l.id, name: l.name, img: l.img })), qe = "— Nincs Mikro-Chip —", Oe = ["slot1", "slot2", "slot3"], me = (l) => {
      var w, T, D;
      const I = [];
      return l !== 1 && I.push((((w = _.slot1) == null ? void 0 : w.itemId) ?? "").trim()), l !== 2 && I.push((((T = _.slot2) == null ? void 0 : T.itemId) ?? "").trim()), l !== 3 && I.push((((D = _.slot3) == null ? void 0 : D.itemId) ?? "").trim()), I.filter(Boolean);
    };
    e.microchipItemsSlot1 = oe.filter((l) => !me(1).includes(l.id)), e.microchipItemsSlot2 = oe.filter((l) => !me(2).includes(l.id)), e.microchipItemsSlot3 = oe.filter((l) => !me(3).includes(l.id)), e.microchipSlots = Oe.map((l) => {
      const I = _[l] ?? {}, w = (I.itemId ?? "").trim(), T = de.find((D) => D.id === w);
      return {
        slotKey: l,
        itemId: w,
      ...
      const I = `slot${l}`, w = _[I] ?? {}, T = (w.itemId ?? "").trim(), D = oe.find((j) => j.id === T);
      e[`microchip${l}ItemId`] = T, e[`microchip${l}DisplayName`] = (D == null ? void 0 : D.name) || w.name || qe, e[`microchip${l}Img`] = (D == null ? void 0 : D.img) || "";
      ...
      const T = !!w, D = ((ee = l == null ? void 0 : l.system) == null ? void 0 : ee.abilityType) ?? "", j = D === "active" ? "Aktív" : D === "passive" ? "Passzív" : D || "—", K = D === "active", ae = Number((te = l == null ? void 0 : l.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(l.system.replaceCost) : 0, Q = (((Z = l == null ? void 0 : l.system) == null ? void 0 : Z.description) ?? "").trim(), J = Q ? Q.length > 60 ? Q.slice(0, 57) + "…" : Q : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const _e = this.actor.system.abilities ?? {}, vt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((l) => {
      var I, w, T;
      return {
        id: l.id,
        name: l.name,
    ...
    }), De = new Map(vt.map((l) => [l.id, l])), kt = "— Nincs képesség —", Ce = (l) => {
      const I = _e[l] ?? {}, w = (I.itemId ?? "").trim(), T = w ? De.get(w) : null, D = (T == null ? void 0 : T.description) ?? "", j = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: w,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-CAoCvcbK.mjs");
      m(this.actor, c);
    ...
    n && s({ currentTarget: n }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      a.preventDefault();
      const d = a.currentTarget, c = d.dataset.skill, m = ((g = d.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: p } = await import("./roll-sheet-CAoCvcbK.mjs");
      p(this.actor, c, m);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if ((p == null ? void 0 : p.type) === "Fegyver") {
        const b = m.system.weapons ?? {}, S = (b.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((_) => O.includes(_)) : [], F = L.find((_) => {
          var k;
          return (((k = b[_]) == null ? void 0 : k.itemId) ?? "").trim() === c;
        });
        if (F) {
      ...
      if (!p) return;
      const g = (d.dataset.itemId ?? "").trim(), b = (d.dataset.itemName ?? ((k = d.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (d.dataset.itemImg ?? "").trim(), O = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = b);
      let L = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      S ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", m == null || m.insertBefore(L, O)), L.src = S, L.style.display = "") : L && L.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
    ...
    const o = this, u = (a) => {
      var m, p, g, b;
      if (!a) return;
      const d = o._getFormDataForUpdate(a);
      ...
      var d, c, m;
      return a && (((c = (d = o.element) == null ? void 0 : d.contains) == null ? void 0 : c.call(d, a)) || o.id && ((m = a.closest) == null ? void 0 : m.call(a, `#${CSS.escape(o.id)}`)));
    };
    o._votvBlur = (a) => {
      const d = a.target;
      if (!d || !d.form) return;
  ...
  _getFormDataForUpdate(i) {
    ...
    ), s = t.hitLocations ?? {}, n = t.currentHealth ?? {}, r = ["head", "torso", "arms", "legs"];
    for (const y of r) {
      const h = ((f = s[y]) == null ? void 0 : f.value) ?? 0, a = n[y] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, N._healthStatusFromRatio(a, h));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, s, n, r, o, u, f, y, h, a, d, c;
    if (e) {
      ...
      if (m) {
        ...
        if (p && p.documentName === "Item" && (p.type === "Kepesseg" || p.type === "ability")) {
          ...
          if (((s = p.parent) == null ? void 0 : s.id) !== this.actor.id) {
            ...
            g = ((n = (await this.actor.createEmbeddedDocuments("Item", [F]))[0]) == null ? void 0 : n.id) ?? g;
          }
          ...
          const O = b === "active" ? "active" : "passive", L = Array.isArray((o = S[O]) == null ? void 0 : o.items) ? S[O].items.slice() : Array.isArray(S[O]) ? S[O].slice() : [];
  ...
  _onWeaponSlotDragOver(i, e) {
    var n, r, o;
    const t = ((n = i.dataTransfer) == null ? void 0 : n.getData("text/plain")) || ((r = i.dataTransfer) == null ? void 0 : r.getData("application/json")) || "";
    let s;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    if (((y = n.parent) == null ? void 0 : y.id) !== this.actor.id) {
      const d = foundry.utils.mergeObject(n.toObject(), { system: { ...n.toObject().system ?? {}, equipped: !1 } });
    ...
    await this.actor.update({
      ...
      [`system.weapons.${e}.damage`]: ((h = n.system) == null ? void 0 : h.damage) ?? "",
      [`system.weapons.${e}.bonus`]: ((a = n.system) == null ? void 0 : a.bonus) ?? ""
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const n = this.actor.items.contents.slice().sort((h, a) => {
      const d = typeof h.sort == "number" ? h.sort : 0, c = typeof a.sort == "number" ? a.sort : 0;
      return d - c;
    }).map((h) => h.id), r = n.indexOf(t), o = n.indexOf(e);
    if (r === -1 || o === -1) return;
    n.splice(r, 1), n.splice(o, 0, t);
    const u = n.map((h, a) => ({
      _id: h,
      sort: (a + 1) * 10
    }));
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", s = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, n = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", o = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", u = n ? `<p>${n}</p>` : "", f = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((o = s.parent) == null ? void 0 : o.id) !== this.actor.id) {
      ...
      n = ((u = (await this.actor.createEmbeddedDocuments("Item", [f]))[0]) == null ? void 0 : u.id) ?? n;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    if (((f = s.parent) == null ? void 0 : f.id) !== this.actor.id) {
      ...
      n = ((y = (await this.actor.createEmbeddedDocuments("Item", [a]))[0]) == null ? void 0 : y.id) ?? n;
    }
    const r = this.actor.system.abilities ?? {}, o = Array.isArray((h = r[e]) == null ? void 0 : h.items) ? r[e].items.slice() : Array.isArray(r[e]) ? r[e].slice() : [];
    o.includes(n) || o.push(n), await this.actor.update({ [`system.abilities.${e}.items`]: o });
  }
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let r = n.id;
    ((y = n.parent) == null ? void 0 : y.id) !== this.actor.id && (r = ((h = (await this.actor.createEmbeddedDocuments("Item", [n.toObject()]))[0]) == null ? void 0 : h.id) ?? r), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    r === 1 ? n -= 6 : r === 2 && (n -= 3);
    const u = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, f = new Roll(u);
  ...
  async _rollWeapon(i) {
    var b;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, s = this.actor.system.skills ?? {}, n = this.actor.items.filter((S) => S.type === "Fegyver");
    let r = null;
    t.itemId && (r = n.find((S) => S.id === t.itemId) ?? null);
    const o = r && r.name || t.name || `Fegyver (${i})`, u = Number(t.bonus || 0) || 0, y = (((b = r == null ? void 0 : r.system) == null ? void 0 : b.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(s[y] || 0) || 0, a = u + h, c = `3d6${a !== 0 ? a > 0 ? `+${a}` : `${a}` : ""}`, m = new Roll(c);
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    let n = (((a = s.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!n && e && (n = (((((d = t.system) == null ? void 0 : d.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !n) {
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const s = (r) => {
      ...
      var o, u, f;
      return r && (((u = (o = e.element) == null ? void 0 : o.contains) == null ? void 0 : u.call(o, r)) || e.id && ((f = r.closest) == null ? void 0 : f.call(r, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (r) => {
      var u, f, y;
      const o = ((u = r.target) == null ? void 0 : u.form) ?? ((y = (f = r.target) == null ? void 0 : f.closest) == null ? void 0 : y.call(f, "form"));
      n(o) && s(o);
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    super._attachFrameListeners(i);
    const e = this;
    if (e._votvProfileImgClick = (n) => {
      var o, u, f, y, h;
      if (!e.isEditable || !((o = e.element) != null && o.contains(n.target)) || !((f = (u = n.target) == null ? void 0 : u.closest) != null && f.call(u, ".profile")) && ((h = (y = n.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
    ...
    const t = (n) => {
      if (!n) return;
      const r = e._getFormDataForUpdate(n);
      Object.keys(r).length !== 0 && e.document.update(r).catch((o) => console.warn("VoidShieldSheet save failed", o));
    }, s = (n) => {
      var r, o, u;
      return n && (((o = (r = e.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, n)) || e.id && ((u = n.closest) == null ? void 0 : u.call(n, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (n) => {
      var o, u, f;
      const r = ((o = n.target) == null ? void 0 : o.form) ?? ((f = (u = n.target) == null ? void 0 : u.closest) == null ? void 0 : f.call(u, "form"));
      s(r) && t(r);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(i) {
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const t = (n) => {
      if (!n) return;
      const r = e._getFormDataForUpdate(n);
      Object.keys(r).length !== 0 && e.document.update(r).catch((o) => console.warn("VoidMicrochipSheet save failed", o));
    }, s = (n) => {
      var r, o, u;
      return n && (((o = (r = e.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, n)) || e.id && ((u = n.closest) == null ? void 0 : u.call(n, `#${CSS.escape(e.id)}`)));
    };
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (r) => {
      ...
      n(u) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => s(u), 300));
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const t = (n) => {
      if (!n) return;
      const r = e._getFormDataForUpdate(n);
      Object.keys(r).length !== 0 && e.document.update(r).catch((o) => console.warn("VoidEgyebSheet save failed", o));
    }, s = (n) => {
      var r, o, u;
      return n && (((o = (r = e.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, n)) || e.id && ((u = n.closest) == null ? void 0 : u.call(n, `#${CSS.escape(e.id)}`)));
    };
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      var r, o, u, f, y, h;
      if (!((o = (r = e.target) == null ? void 0 : r.closest) != null && o.call(r, "#actors"))) return;
      ...
      n && ((h = game.actors) != null && h.get(n)) && (game.votv._dragSourceActorId = n);
    },
    !0
...
Hooks.on("preCreateToken", (P, i, e) => {
  ...
  const n = s ? (o = game.actors) == null ? void 0 : o.get(s) : null;
  !n || n.type !== "Karakter" || P.updateSource({
    ...t ? { actorId: t } : {},
    actorLink: !0
  });
});
...
Hooks.on("renderChatMessageHTML", (P, i, e) => {
  var n, r, o;
  const t = (r = (n = P.flags) == null ? void 0 : n["vacuum-of-the-void"]) == null ? void 0 : r.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-DdJXxW2h.mjs.map
