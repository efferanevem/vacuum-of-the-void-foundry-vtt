...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
    ...
    const v = this.actor.system.weapons ?? {}, w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (v.slotOrder ?? "").trim(), q = S ? S.split(/\s*,\s*/).filter((p) => w.includes(p)) : [], L = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, _ = L && typeof L == "object" && !Array.isArray(L) ? L : {}, k = (((Ze = _.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), C = (((Ve = _.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), F = (((et = _.slot3) == null ? void 0 : et.itemId) ?? "").trim(), B = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, O) => {
      ...
      for (let Ie = 0; Ie < q.length; Ie++) {
        ...
        if ((((ce = v[_e]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          D = Ie + 1, N = ((he = v[_e]) == null ? void 0 : he.bonus) ?? "", Y = _e;
          break;
        }
      }
      let W = null;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Bio-GFiP.mjs");
      o(this.actor, c);
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const a = i.currentTarget, c = a.dataset.skill, o = ((g = a.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-Bio-GFiP.mjs");
      u(this.actor, c, o);
      ...
      if (!g) return;
      const v = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, g)) ?? ((k = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : k.call(_, (F) => F.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const v = o.system.weapons ?? {}, w = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = w ? w.split(/\s*,\s*/).filter((_) => S.includes(_)) : [], L = q.find((_) => {
          var k;
      ...
      const u = this.actor.system.weapons ?? {}, g = (u.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], w = g ? g.split(/\s*,\s*/).filter((k) => v.includes(k)) : [], S = w.find((k) => {
        var C;
        return (((C = u[k]) == null ? void 0 : C.itemId) ?? "").trim() === c;
      }) ?? null;
      if (a.checked) {
        if (S) return;
        let k = w.find((F) => {
      ...
      w ? (q || (q = document.createElement("img"), q.className = "karakter-microchip-slot-thumb", q.alt = "", o == null || o.insertBefore(q, S)), q.src = w, q.style.display = "") : q && q.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (u && u.documentName === "Item" && (u.type === "Kepesseg" || u.type === "ability")) {
          ...
          const S = v === "active" ? "active" : "passive", q = Array.isArray((l = w[S]) == null ? void 0 : l.items) ? w[S].items.slice() : Array.isArray(w[S]) ? w[S].slice() : [];
          q.includes(g) || q.push(g), await this.actor.update({ [`system.abilities.${S}.items`]: q });
          return;
        }
      }
    }
    if (e) {
      ...
      if (o) {
        ...
        if (u && u.documentName === "Item" && u.type === "Fegyver") {
          ...
          if (v) {
            const S = ((h = g.system) == null ? void 0 : h.weapons) ?? {}, q = (S.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = q ? q.split(/\s*,\s*/).filter((C) => L.includes(C)) : [], k = _.filter((C) => {
              var F;
              return (((F = S[C]) == null ? void 0 : F.itemId) ?? "").trim() === w;
            });
            if (k.length > 0) {
              const F = {
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const w = ((qe = (De = t == null ? void 0 : t.system) == null ? void 0 : De.gear) == null ? void 0 : qe.microchips) ?? {}, S = ["slot1", "slot2", "slot3"], q = r.filter((b) => b.type === "MikroChip");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var u, g, v, w;
      i.preventDefault();
      const a = (g = (u = i.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : g.call(u, ".karakter-weapon-slot"), c = (((v = a == null ? void 0 : a.dataset) == null ? void 0 : v.itemId) ?? "").trim();
      ...
      var v, w, S, q, L, _;
      if (i.preventDefault(), !i.altKey) return;
      const a = (w = (v = i.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : w.area, c = (q = (S = i.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : q.itemId;
  ...
  async _onDropItem(s, e) {
    var f, h, i, a, c, o, u, g, v, w, S, q, L, _, k;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((a = d.parent) == null ? void 0 : a.id) !== n.id) {
        ...
        C = ((c = (await n.createEmbeddedDocuments("Item", [ne]))[0]) == null ? void 0 : c.id) ?? C;
      }
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, l, y, m) => {
    ...
    for (const k of o)
      ((S = k.document) == null ? void 0 : S.id) !== f || ((q = k.document) == null ? void 0 : q.documentName) !== "Actor" || ((L = k.constructor) == null ? void 0 : L.name) !== "VoidKarakterSheet" || a.includes(k) || a.push(k);
    if (i && a.some((k) => {
      const C = (k == null ? void 0 : k.form) ?? (k == null ? void 0 : k.element);
      return C && C.contains(h);
    })) return;
...
//# sourceMappingURL=vacuum-of-the-void-DLVWLQlO.mjs.map
