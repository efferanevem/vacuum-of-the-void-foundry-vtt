...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((i = s.querySelector) == null ? void 0 : i.call(s, "form.votv.karakter-sheet")) ?? ((a = s.querySelector) == null ? void 0 : a.call(s, "form.votv")) ?? null, t = ((c = s.querySelector) == null ? void 0 : c.call(s, ".votv-scroll")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    const h = this.element, b = this.form ?? this.element, w = d.scrollState, n = d.focus, l = typeof (w == null ? void 0 : w.formScrollTop) == "number" || typeof (w == null ? void 0 : w.windowScrollTop) == "number", r = () => {
      var m, f;
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var b, w, n, l, r, o, m, f, k;
    const e = s ?? this.form ?? this.element;
    let t = (b = e == null ? void 0 : e.querySelector) == null ? void 0 : b.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const i = ((n = (w = this.actor) == null ? void 0 : w.system) == null ? void 0 : n.resources) ?? {}, a = ((r = (l = i.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : r.value) ?? 0, c = ((o = i.currentHealth) == null ? void 0 : o.legs) ?? 0, d = C._healthStatusFromRatio(c, a), p = Number(((k = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let h;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, i = ((p = (d = t.hitLocations) == null ? void 0 : d[e]) == null ? void 0 : p.value) ?? 0, a = ((h = t.currentHealth) == null ? void 0 : h[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const i = ((d = s == null ? void 0 : s.system) == null ? void 0 : d.resources) ?? {}, a = ((h = (p = i.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : h.value) ?? 0, c = ((b = i.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const i = this.actor.system.resources ?? {}, a = i.hitLocations ?? {}, c = i.currentHealth ?? {}, d = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const u of d) {
      const v = ((_e = a[u]) == null ? void 0 : _e.value) ?? 0, q = c[u] ?? 0;
    ...
    const o = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], f = (o.slotOrder ?? "").trim(), k = f ? f.split(/\s*,\s*/).filter((u) => m.includes(u)) : [], I = (Fe = this.actor.system.gear) == null ? void 0 : Fe.microchips, O = I && typeof I == "object" && !Array.isArray(I) ? I : {}, F = (((Ne = O.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), L = (((Ee = O.slot2) == null ? void 0 : Ee.itemId) ?? "").trim(), A = (((Ce = O.slot3) == null ? void 0 : Ce.itemId) ?? "").trim(), E = this.actor.items.contents.filter((u) => u.type !== "Kepesseg" && u.type !== "ability").slice().sort((u, v) => {
      ...
      const X = v && ((ae = u.system) != null && ae.damage) ? u.system.damage : "", Y = v && typeof ((ee = u.system) == null ? void 0 : ee.range) == "string" ? (u.system.range || "").trim() : "", W = x ? Number((te = o[x]) == null ? void 0 : te.bonus) || 0 : "";
      return {
        id: u.id,
        name: u.name,
        img: u.img,
    ...
    e.weaponsTable = j.map((u) => {
      ...
      const _ = !!q, x = ((Z = u.system) == null ? void 0 : Z.equipped) !== void 0 && ((Re = u.system) == null ? void 0 : Re.equipped) !== null ? !!u.system.equipped : _, K = (u == null ? void 0 : u.system) ?? {}, X = typeof K.range == "string" ? (K.range || "").trim() : "", Y = K.type ?? "", W = (et[Y] ?? Y) || "—", V = K.size ?? "", re = (tt[V] ?? V) || "", ae = [W, re].filter(Boolean).join(", ") || W || "—", ee = W === "Lövedékes", te = K.quantity, se = te != null ? String(te).trim() : "1";
      return {
        slotKey: q ?? "",
        itemId: v,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-vKXkGUBc.mjs");
      o(this.actor, r);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (n) => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, r = l.dataset.skill, o = ((f = l.textContent) == null ? void 0 : f.trim()) || r, { openRollSheetForSkill: m } = await import("./roll-sheet-vKXkGUBc.mjs");
      m(this.actor, r, o);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const r = l.closest(".karakter-microchip-slot-select-wrap"), o = r == null ? void 0 : r.classList.contains("karakter-microchip-slot-open");
      ...
      var y;
      n.preventDefault();
      const l = n.currentTarget, r = l.closest(".karakter-microchip-slot-select-wrap"), o = r == null ? void 0 : r.querySelector(".karakter-microchip-slot-display"), m = o == null ? void 0 : o.dataset.slot;
      if (!m) return;
      const f = (l.dataset.itemId ?? "").trim(), k = (l.dataset.itemName ?? ((y = l.textContent) == null ? void 0 : y.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (l.dataset.itemImg ?? "").trim(), O = r == null ? void 0 : r.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = k);
      let F = r == null ? void 0 : r.querySelector(".karakter-microchip-slot-thumb");
      I ? (F || (F = document.createElement("img"), F.className = "karakter-microchip-slot-thumb", F.alt = "", o == null || o.insertBefore(F, O)), F.src = I, F.style.display = "") : F && F.remove(), r == null || r.classList.remove("karakter-microchip-slot-open");
      ...
      l.addEventListener("dragover", (o) => this._onMicrochipSlotDragOver(o, r)), l.addEventListener("dragleave", (o) => {
        var m;
        return (m = o.currentTarget) == null ? void 0 : m.classList.remove("karakter-microchip-slot-drag-over");
      }), l.addEventListener("drop", (o) => this._onMicrochipSlotDrop(o, r));
    }), t.find(".karakter-ability-slot-single").each((n, l) => {
      const r = l.dataset.slot;
      r && (l.addEventListener("dragover", (o) => this._onAbilitySingleDragOver(o, r)), l.addEventListener("dragleave", (o) => {
        var m;
      ...
      r && (l.addEventListener("dragover", (o) => this._onAbilityAreaDragOver(o, r)), l.addEventListener("dragleave", (o) => {
        var m;
      ...
      if (!l || !r) return;
      const o = this.actor.system.abilities ?? {}, f = (Array.isArray((k = o[l]) == null ? void 0 : k.items) ? o[l].items.slice() : []).filter((I) => I !== r);
      ...
      if (!r) return;
      const o = this.actor.items.get(r);
      !o || o.type !== "Pancel" || await o.update({ "system.equipped": l.checked });
    ...
    const d = this, p = (n) => {
      ...
      const r = ((m = (o = l.system) == null ? void 0 : o.resources) == null ? void 0 : m.currentHealth) != null || ((k = (f = l.system) == null ? void 0 : f.resources) == null ? void 0 : k.hitLocations) != null;
      d.actor.update(l).then(() => {
        r && setTimeout(() => d.render(!0), 260);
      }).catch((I) => console.warn("VoidKarakterSheet save failed", I));
    }, h = (n) => {
      var l, r, o;
      return n && (((r = (l = d.element) == null ? void 0 : l.contains) == null ? void 0 : r.call(l, n)) || d.id && ((o = n.closest) == null ? void 0 : o.call(n, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (n) => {
      const l = n.target;
      if (!l || !l.form) return;
    ...
    if (e) {
      ...
      if (l) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          const m = (((c = r.system) == null ? void 0 : c.kind) ?? "passive").toString(), f = this.actor.system.abilities ?? {};
          if (m === "species") {
            await this.actor.update({
    ...
    if (e) {
      ...
      if (l) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          const o = this.actor, m = ((h = r.parent) == null ? void 0 : h.id) !== o.id;
          let f = r.id;
          if (m) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Pajzs" || r.type === "Pancél")) {
          const o = this.actor;
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const a = this.actor.items.contents.slice().sort((w, n) => {
      ...
      return l - r;
    }).map((w) => w.id), c = a.indexOf(t), d = a.indexOf(e);
    if (c === -1 || d === -1) return;
    a.splice(c, 1), a.splice(d, 0, t);
    const p = a.map((w, n) => ({
      _id: w,
      sort: (n + 1) * 10
    }));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", i = Number(((w = e.system) == null ? void 0 : w.kp) ?? 0) || 0, a = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", d = i > 0 ? `<p><strong>KP:</strong> ${i}</p>` : "", p = a ? `<p>${a}</p>` : "", h = `
      <h2>${e.name}</h2>
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let c = a.id;
    ((b = a.parent) == null ? void 0 : b.id) !== this.actor.id && (c = ((w = (await this.actor.createEmbeddedDocuments("Item", [a.toObject()]))[0]) == null ? void 0 : w.id) ?? c), await this.actor.update({
  ...
  async _rollWeapon(s) {
    ...
    let c = null;
    t.itemId && (c = a.find((I) => I.id === t.itemId) ?? null);
    const d = c && c.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", w = Number(i[b] || 0) || 0, n = p + w, r = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, o = new Roll(r);
  ...
  async _rollWeaponDamage(s, e = "") {
    var p, h, b, w, n, l, r, o, m, f;
    const t = this.actor;
    if (!t) return;
    let i = ((h = (p = t.items).get) == null ? void 0 : h.call(p, s)) ?? ((w = (b = t.items.contents) == null ? void 0 : b.find) == null ? void 0 : w.call(b, (k) => k.id === s));
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const e = this, t = (a) => {
      ...
      var c, d, p;
      return a && (((d = (c = e.element) == null ? void 0 : c.contains) == null ? void 0 : d.call(c, a)) || e.id && ((p = a.closest) == null ? void 0 : p.call(a, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (a) => {
      var d, p, h;
      const c = ((d = a.target) == null ? void 0 : d.form) ?? ((h = (p = a.target) == null ? void 0 : p.closest) == null ? void 0 : h.call(p, "form"));
      i(c) && t(c);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (c, d, p, h) => {
    ...
    if (!b) return;
    const w = document.activeElement, n = w && (w.tagName === "INPUT" && w.type !== "checkbox" && w.type !== "radio" || w.tagName === "TEXTAREA" || w.isContentEditable), l = [], r = (I = game.actors) == null ? void 0 : I.get(b);
...
Hooks.on("preCreateToken", (N, s, e) => {
  var c, d;
  const t = (c = game.votv) == null ? void 0 : c._dragSourceActorId, i = t ?? N.actorId ?? null;
  t && (game.votv._dragSourceActorId = null);
  const a = i ? (d = game.actors) == null ? void 0 : d.get(i) : null;
...
Hooks.on("renderChatMessageHTML", (N, s, e) => {
  var a, c, d;
  const t = (c = (a = N.flags) == null ? void 0 : a["vacuum-of-the-void"]) == null ? void 0 : c.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-Q4t5tq7S.mjs.map
