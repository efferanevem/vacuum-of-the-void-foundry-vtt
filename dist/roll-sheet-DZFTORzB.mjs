import { V as E, c as ae } from "./vacuum-of-the-void-EpvhfDNp.mjs";
class Y extends Application {
  ...
  _updateFormulaPreview(t) {
    var M, w, y, f, b, o, n, i, u, I, P, V;
    const e = t == null ? void 0 : t.querySelector(".roll-sheet-formula-preview");
    if (!e) return;
    const s = parseInt(((M = t.querySelector("input[name='advantage']")) == null ? void 0 : M.value) ?? "0", 10) || 0, l = parseInt(((w = t.querySelector("input[name='moraleDice']")) == null ? void 0 : w.value) ?? "0", 10) || 0, m = parseInt(((y = t.querySelector("input[name='constantBonus']")) == null ? void 0 : y.value) ?? "0", 10) || 0, g = parseInt(((f = t.dataset) == null ? void 0 : f.baseMod) ?? "0", 10) || 0, c = parseInt(((b = t.dataset) == null ? void 0 : b.injuryMod) ?? "0", 10) || 0, a = parseInt(((o = t.dataset) == null ? void 0 : o.injuryPenalty) ?? "0", 10) || 0, h = (u = (i = (n = this.actor) == null ? void 0 : n.statuses) == null ? void 0 : i.has) != null && u.call(i, "diseased") || (V = (P = (I = this.actor) == null ? void 0 : I.statuses) == null ? void 0 : P.has) != null && V.call(P, "poisoned") ? -1 : 0, p = g + c + a + m + h, r = [];
  ...
  getData(t = {}) {
    var y, f, b, o, n, i, u, I, P, V, v, S, B, D;
    ...
    if (this._isWeaponAttack && ((o = (b = game.user) == null ? void 0 : b.targets) != null && o.size)) {
      const L = Array.from(game.user.targets)[0], _ = (L == null ? void 0 : L.actor) ?? null;
      a = (_ == null ? void 0 : _.name) || (L == null ? void 0 : L.name) || "", (i = (n = _ == null ? void 0 : _.statuses) == null ? void 0 : n.has) != null && i.call(n, "stunned") && (h = 1, p.push(game.i18n.localize("VOTV.RollSheet.AdvantageStunnedTarget"))), (I = (u = _ == null ? void 0 : _.statuses) == null ? void 0 : u.has) != null && I.call(u, "dodge") && (d = 1, r.push(game.i18n.localize("VOTV.StatusDodge")));
    }
    (V = (P = e == null ? void 0 : e.statuses) == null ? void 0 : P.has) != null && V.call(P, "diseased") && r.push(game.i18n.localize("VOTV.StatusDiseased")), (S = (v = e == null ? void 0 : e.statuses) == null ? void 0 : v.has) != null && S.call(v, "poisoned") && r.push(game.i18n.localize("VOTV.StatusPoisoned"));
  ...
  async _doRoll(t) {
    ...
    if (e)
      try {
        const f = t.querySelector("[name='moraleDice']"), b = t.querySelector("[name='advantage']"), o = t.querySelector("[name='constantBonus']"), n = Math.min(3, Math.max(0, parseInt((f == null ? void 0 : f.value) ?? "0", 10) || 0)), i = Math.max(0, Number(((l = (s = e.system) == null ? void 0 : s.resources) == null ? void 0 : l.morale) ?? 0) || 0), u = Math.min(n, i), I = Math.min(3, Math.max(-3, parseInt((b == null ? void 0 : b.value) ?? "0", 10) || 0)), P = parseInt((o == null ? void 0 : o.value) ?? "0", 10) || 0, V = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, v = this._isWeaponAttack ? 0 : this._injuryModifier, S = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, D = ((g = (m = e.statuses) == null ? void 0 : m.has) == null ? void 0 : g.call(m, "diseased")) || ((a = (c = e.statuses) == null ? void 0 : c.has) == null ? void 0 : a.call(c, "poisoned")) ? -1 : 0, N = V + v + S + P + D, L = [
          "3d6",
          I > 0 ? `+${I}d6` : I < 0 ? `-${Math.abs(I)}d6` : "",
          u > 0 ? `+${u}d8` : "",
          N !== 0 ? N > 0 ? `+${N}` : `${N}` : ""
        ].filter(Boolean).join(" "), _ = new Roll(L);
        ...
        if (this._isWeaponAttack && ((p = (h = game.user) == null ? void 0 : h.targets) != null && p.size)) {
          ...
          if (j) {
            const W = ((r = j.system) == null ? void 0 : r.combat) ?? {}, X = Number(W.defense ?? 0) || 0, Z = Number(W.defenseBonus ?? 0) || 0, ee = Number(W.givenProtection ?? 0) || 0, te = (M = (d = j.statuses) == null ? void 0 : d.has) != null && M.call(d, "lookaround") ? 1 : 0;
            let $ = 0;
            if (j.type === "Karakter") {
            ...
            const z = X + Z + ee + $ + te, H = (Number(_.total ?? 0) || 0) >= z, se = j.name ?? C.name ?? "Célpont";
            let F = null, q = null;
...
function ie(k, t, e) {
  var a, h;
  if (!k) return;
  const s = Number(((h = (a = k.system) == null ? void 0 : a.skills) == null ? void 0 : h[t]) ?? 0) || 0, l = E.BODY_PART_BY_SKILL[t] ? E._getSkillHealthStatusStatic(k, t) : void 0;
  let m = 0;
  l === 1 ? m = -6 : l === 2 && (m = -3);
...
function re(k, t) {
  var V, v, S, B, D, N, L, _;
  if (!k || !t) return;
  const e = k != null && k.id ? game.actors.get(k.id) ?? k : k, l = (((V = e.system) == null ? void 0 : V.weapons) ?? {})[t] ?? {}, m = ((v = e.system) == null ? void 0 : v.skills) ?? {}, g = ((B = (S = e.items) == null ? void 0 : S.filter) == null ? void 0 : B.call(S, (x) => x.type === "Fegyver")) ?? [], c = (l.itemId ?? "").trim(), a = c ? g.find((x) => x.id === c) ?? null : null, h = ((a == null ? void 0 : a.name) ?? l.name ?? "").trim() || "Fegyver", p = (D = a == null ? void 0 : a.system) == null ? void 0 : D.bonus, r = l.bonus, d = p != null && String(p).trim() !== "" ? p : r ?? 0, M = Number(d) || 0, w = ((N = a == null ? void 0 : a.system) == null ? void 0 : N.type) || "kinetic", y = (((L = a == null ? void 0 : a.system) == null ? void 0 : L.skillKey) ?? "").trim(), f = y && m[y] !== void 0 ? y : w === "explosive" ? "grenadeUse" : "firearms", b = Number(m[f] || 0) || 0, o = M + b;
  let n = 0;
  if (e.type === "Karakter") {
...
//# sourceMappingURL=roll-sheet-DZFTORzB.mjs.map
