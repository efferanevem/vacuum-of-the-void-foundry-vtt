...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-CYeQ4T8p.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-CYeQ4T8p.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((g = o.textContent) == null ? void 0 : g.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-CYeQ4T8p.mjs");
      h(this.actor, r, u);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CYeQ4T8p.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CYeQ4T8p.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-CYeQ4T8p.mjs");
      u(this.actor, o, r);
  ...
  async _onDropItem(s, e) {
    ...
    if (f.type === "Fegyver" && l) {
      const x = ((O = c.system) == null ? void 0 : O.weapons) ?? {}, J = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Q = (x.slotOrder ?? "").trim(), Z = Q ? Q.split(/\s*,\s*/).filter((V) => J.includes(V)) : [];
      let Y = J.find((V) => {
        var ce;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (d, l, p, y) => {
    ...
    for (const z of h) {
      ...
      V !== "VoidKarakterSheet" && V !== "VoidJarmuSheet" && V !== "VoidBazisSheet" || r.includes(z) || r.push(z);
    }
    if (o && r.some((z) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const l = c.itemId ? ((K = (j = d.items) == null ? void 0 : j.get) == null ? void 0 : K.call(j, c.itemId)) ?? ((Q = (J = (x = d.items) == null ? void 0 : x.contents) == null ? void 0 : J.find) == null ? void 0 : Q.call(J, (W) => W.id === c.itemId)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-DOZQnZZ0.mjs.map
