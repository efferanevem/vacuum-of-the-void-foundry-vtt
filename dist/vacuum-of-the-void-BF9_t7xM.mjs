...
var J = (w, s, e) => qs(w, typeof s != "symbol" ? s + "" : s, e);
var U = (w, s, e) => Cs(Os(w), e, s);
const { HTMLField: Ls, NumberField: L, SchemaField: j, StringField: T, BooleanField: ee, ArrayField: ut } = foundry.data.fields;
...
const { NumberField: Ct, SchemaField: Ns } = foundry.data.fields;
class Ps extends vs {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Fs, StringField: _t } = foundry.data.fields;
...
const { NumberField: qt, StringField: ss } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Je, Qe, Xe, Ze, et, tt, st, it, nt, Pe, at, k, F, E, z, le, Y, je, ke, Te, ve, Ae, Fe, wt, It, St, Tt, rt, ze, Mt, Kt, jt, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt;
    ...
    const o = Number(((it = (st = this.actor.system) == null ? void 0 : st.combat) == null ? void 0 : it.givenProtection) ?? 0) || 0, a = (at = (Pe = (nt = this.actor) == null ? void 0 : nt.statuses) == null ? void 0 : Pe.has) != null && at.call(Pe, "lookaround") ? 1 : 0, f = (E = (F = (k = this.actor) == null ? void 0 : k.statuses) == null ? void 0 : F.has) != null && E.call(F, "halfcover") ? 3 : 0, h = o + this._getTotalArmorProtectionBonus() + a + f;
    ...
    e.weaponsTable = R.map((g) => {
      ...
      const M = !!D, Z = ((Zt = g.system) == null ? void 0 : Zt.equipped) !== void 0 && ((es = g.system) == null ? void 0 : es.equipped) !== null ? !!g.system.equipped : M, X = (g == null ? void 0 : g.system) ?? {}, ot = typeof X.range == "string" ? (X.range || "").trim() : "", ue = X.type ?? "", Ee = (ie[ue] ?? ue) || "—", we = X.size ?? "", $e = (oe[we] ?? we) || "", xe = [Ee, $e].filter(Boolean).join(", ") || Ee || "—", _e = ue === "projectile" || we === "thrown", De = X.quantity, ct = De != null ? String(De).trim() : "1", He = String(P.bonus ?? "").trim(), lt = String(X.bonus ?? "").trim(), _s = He || lt || "0";
      return {
        slotKey: D ?? "",
        itemId: O,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DiMJ5opD.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DiMJ5opD.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DiMJ5opD.mjs");
      f(this.actor, o, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Be, Ge, Ve, gt, Ke, qe, ce, ht, We, Le, Dt, Se, Ne, bt, kt, Ye, vt, Je, Qe, Xe, Ze, et, tt, st, it, nt, Pe, at;
    ...
    const Ie = ((Ze = e.system) == null ? void 0 : Ze.resources) ?? {}, ie = (tt = (et = e.system) == null ? void 0 : et.combat) == null ? void 0 : tt.initiativeResult, oe = typeof ie == "number" ? ie : -1, Ce = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], re = (it = (st = e.system) == null ? void 0 : st.combat) == null ? void 0 : it.initiativeRanges, he = Array.isArray(re) ? re.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ne = (he.length > 0 ? he : Ce).slice().sort((k, F) => k.min - F.min), Ue = 3;
    ...
    return e.kpDotsRow1 = Me.slice(0, yt), e.kpDotsRow2 = Me.slice(yt), e.canEditInitiative = !!((nt = game.user) != null && nt.isGM), e.showInitiativeResult = typeof ie == "number", e.initiativeResult = e.showInitiativeResult ? ie : "", e.speedUnitForSelect = ((at = (Pe = e.system) == null ? void 0 : Pe.combat) == null ? void 0 : at.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var p, y, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DiMJ5opD.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DiMJ5opD.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DiMJ5opD.mjs");
      a(this.actor, c, o);
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const c = dt.getTotalSpeedRaw(i), o = (f = i.effects) == null ? void 0 : f.find((I) => I.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (c <= 0 && !o) {
...
//# sourceMappingURL=vacuum-of-the-void-BF9_t7xM.mjs.map
