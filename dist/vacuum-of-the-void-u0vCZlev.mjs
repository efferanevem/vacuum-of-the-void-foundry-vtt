...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((r = s.querySelector) == null ? void 0 : r.call(s, "form.votv.karakter-sheet")) ?? ((a = s.querySelector) == null ? void 0 : a.call(s, "form.votv")) ?? null, t = ((c = s.querySelector) == null ? void 0 : c.call(s, ".votv-scroll")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, ".window-content")) ?? null;
  ...
  static _healthStatusFromRatio(s, e) {
    ...
    if (r <= 0 || t <= 0) return 0;
    const a = Math.floor(r / 3), c = Math.floor(2 * r / 3);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const r = ((n = (w = this.actor) == null ? void 0 : w.system) == null ? void 0 : n.resources) ?? {}, a = ((i = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : i.value) ?? 0, c = ((o = r.currentHealth) == null ? void 0 : o.legs) ?? 0, d = C._healthStatusFromRatio(c, a), p = Number(((k = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let h;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, r = ((p = (d = t.hitLocations) == null ? void 0 : d[e]) == null ? void 0 : p.value) ?? 0, a = ((h = t.currentHealth) == null ? void 0 : h[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const r = ((d = s == null ? void 0 : s.system) == null ? void 0 : d.resources) ?? {}, a = ((h = (p = r.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : h.value) ?? 0, c = ((b = r.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const r = this.actor.system.resources ?? {}, a = r.hitLocations ?? {}, c = r.currentHealth ?? {}, d = ["head", "torso", "arms", "legs"];
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!i) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DOfzK71p.mjs");
      o(this.actor, i);
    ...
    a && r({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (n) => {
      ...
      var f;
      n.preventDefault();
      const l = n.currentTarget, i = l.dataset.skill, o = ((f = l.textContent) == null ? void 0 : f.trim()) || i, { openRollSheetForSkill: m } = await import("./roll-sheet-DOfzK71p.mjs");
      m(this.actor, i, o);
  ...
  _getFormDataForUpdate(s) {
    ...
    ), r = t.hitLocations ?? {}, a = t.currentHealth ?? {}, c = ["head", "torso", "arms", "legs"];
    for (const b of c) {
      const w = ((h = r[b]) == null ? void 0 : h.value) ?? 0, n = a[b] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${b}`, C._healthStatusFromRatio(n, w));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, r, a, c, d, p, h, b, w, n;
    if (e) {
      ...
      if (l) {
        ...
        if (i && i.documentName === "Item" && (i.type === "Kepesseg" || i.type === "ability")) {
          let o = i.id;
          if (((r = i.parent) == null ? void 0 : r.id) !== this.actor.id) {
  ...
  _onWeaponSlotDragOver(s, e) {
    ...
    (r == null ? void 0 : r.type) === "Item" && (s.preventDefault(), (d = s.currentTarget) == null || d.classList.add("karakter-weapon-slot-drag-over"));
  }
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", r = Number(((w = e.system) == null ? void 0 : w.kp) ?? 0) || 0, a = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", d = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = a ? `<p>${a}</p>` : "", h = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(s, e) {
    ...
    let a = r.id;
    if (((d = r.parent) == null ? void 0 : d.id) !== this.actor.id) {
      const h = foundry.utils.mergeObject(r.toObject(), { type: "Kepesseg" });
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    if (!r || r.type !== "Kepesseg" && r.type !== "ability") return;
    let a = r.id;
    if (((h = r.parent) == null ? void 0 : h.id) !== this.actor.id) {
  ...
  _onMicrochipSlotDragOver(s, e) {
    ...
    (r == null ? void 0 : r.type) === "Item" && (s.preventDefault(), (d = s.currentTarget) == null || d.classList.add("karakter-microchip-slot-drag-over"));
  }
  ...
  async _rollWeapon(s) {
    var k;
    const t = (this.actor.system.weapons ?? {})[s] ?? {}, r = this.actor.system.skills ?? {}, a = this.actor.items.filter((I) => I.type === "Fegyver");
    let c = null;
    t.itemId && (c = a.find((I) => I.id === t.itemId) ?? null);
    const d = c && c.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", w = Number(r[b] || 0) || 0, n = p + w, i = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, o = new Roll(i);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    let r = ((h = (p = t.items).get) == null ? void 0 : h.call(p, s)) ?? ((w = (b = t.items.contents) == null ? void 0 : b.find) == null ? void 0 : w.call(b, (k) => k.id === s));
    if (!r || r.type !== "Fegyver") return;
    let a = (((n = r.system) == null ? void 0 : n.damage) ?? "").trim();
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (a) => {
      ...
      var d, p, h;
      const c = ((d = a.target) == null ? void 0 : d.form) ?? ((h = (p = a.target) == null ? void 0 : p.closest) == null ? void 0 : h.call(p, "form"));
      r(c) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => t(c), 300));
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (a) => {
      ...
      r(d) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => t(d), 300));
    }, document.body.addEventListener("change", e._votvChange, !0), document.body.addEventListener("input", e._votvInput, !0);
  }
  _tearDown(s) {
    var e;
...
Hooks.on("preCreateToken", (N, s, e) => {
  var c, d;
  const t = (c = game.votv) == null ? void 0 : c._dragSourceActorId, r = t ?? N.actorId ?? null;
  t && (game.votv._dragSourceActorId = null);
  const a = r ? (d = game.actors) == null ? void 0 : d.get(r) : null;
...
Hooks.on("renderChatMessageHTML", (N, s, e) => {
  ...
  if (!t) return;
  const r = (d = s == null ? void 0 : s.querySelector) == null ? void 0 : d.call(s, ".dice-roll");
  r && r.classList.add(`votv-${t}`);
});
export {
  me as V
};
//# sourceMappingURL=vacuum-of-the-void-u0vCZlev.mjs.map
