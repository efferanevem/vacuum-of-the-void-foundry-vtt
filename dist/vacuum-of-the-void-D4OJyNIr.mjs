...
var jt = Reflect.get;
var Kt = (E, s, e) => s in E ? Mt(E, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : E[s] = e;
var z = (E, s, e) => Kt(E, typeof s != "symbol" ? s + "" : s, e);
var j = (E, s, e) => jt(Rt(E), e, s);
const { HTMLField: Ht, NumberField: P, SchemaField: R, StringField: w, BooleanField: Q, ArrayField: He } = foundry.data.fields;
class Nt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new R({
        biography: new Ht({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: ze, SchemaField: Ut } = foundry.data.fields;
class Bt extends Nt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: zt, NumberField: es, StringField: qe } = foundry.data.fields;
class gt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Felszerelve a karakteren (karakter lap checkbox; a fegyver lapon nem jelenik meg). */
      equipped: new zt({ required: !1, initial: !1 }),
      type: new qe({
        required: !0,
        blank: !1,
...
const { BooleanField: Gt, StringField: Ue } = foundry.data.fields;
...
const { NumberField: Ge, StringField: ht } = foundry.data.fields;
...
const { NumberField: Jt, StringField: bt } = foundry.data.fields;
...
class Qt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      quantity: new vt({ required: !1, blank: !0, initial: "1" })
    };
  }
}
const { StringField: Xt } = foundry.data.fields;
class Zt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new Xt({ required: !1, blank: !0, initial: "" })
    };
  }
}
function We(E) {
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var fe, be, ye, Te, _e, Me, Re, je, Ke, Ae, Pe, st, it, rt, nt, at, ot, ct, lt, ut, dt, mt;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((ye = (be = (fe = this.actor.system) == null ? void 0 : fe.resources) == null ? void 0 : be.stress) == null ? void 0 : ye.value) || 0;
    e.stressOver10 = t > 10;
    const o = this.actor.system.resources ?? {}, d = o.hitLocations ?? {}, a = o.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const g of l) {
      const O = ((Te = d[g]) == null ? void 0 : Te.value) ?? 0, _ = a[g] ?? 0;
    ...
    const h = e.computedHealthStatus.legs ?? 3, i = Number(((Me = (_e = this.actor.system) == null ? void 0 : _e.combat) == null ? void 0 : Me.givenSpeed) ?? 0) || 0;
    let r;
    h === 0 ? r = 0 : h === 1 ? r = -6 : h === 2 ? r = -3 : r = i;
    const c = this._getTotalArmorSpeedPenalty();
    r += c, e.effectiveGivenSpeed = r;
    const u = (Number(((je = (Re = this.actor.system) == null ? void 0 : Re.combat) == null ? void 0 : je.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), C = I ? I.split(/\s*,\s*/).filter((g) => v.includes(g)) : [], q = (Ke = this.actor.system.gear) == null ? void 0 : Ke.microchips, D = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ae = D.slot1) == null ? void 0 : Ae.itemId) ?? "").trim(), S = (((Pe = D.slot2) == null ? void 0 : Pe.itemId) ?? "").trim(), A = (((st = D.slot3) == null ? void 0 : st.itemId) ?? "").trim(), H = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      const _ = typeof g.sort == "number" ? g.sort : 0, L = typeof O.sort == "number" ? O.sort : 0;
      return _ - L;
    }).map((g) => {
      var ge, De, Ce, ke, ve, Ne;
      const O = g.type === "Fegyver", _ = g.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Ee = 0; Ee < C.length; Ee++) {
        const $e = C[Ee];
        if ((((ge = b[$e]) == null ? void 0 : ge.itemId) ?? "") === g.id) {
          L = Ee + 1, M = ((De = b[$e]) == null ? void 0 : De.bonus) ?? "", J = $e;
          break;
        }
      }
      let Y = null;
      _ && (T === g.id ? Y = "slot1" : S === g.id ? Y = "slot2" : A === g.id && (Y = "slot3"));
      const Fe = O && ((Ce = g.system) != null && Ce.damage) ? g.system.damage : "", se = O && typeof ((ke = g.system) == null ? void 0 : ke.range) == "string" ? (g.system.range || "").trim() : "", Oe = J ? Number((ve = b[J]) == null ? void 0 : ve.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
        ...
        rangeStr: se,
        slotBonusNum: Oe,
        quantity: Number(((Ne = g.system) == null ? void 0 : Ne.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = H;
    const U = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((g) => g.type === "Fegyver"), X = U.map((g) => ({ id: g.id, name: g.name, img: g.img }));
    e.weaponItems = X;
    const G = "— Nincs fegyver —", ee = C.filter((g) => {
      const _ = ((b[g] ?? {}).itemId ?? "").trim();
      return _ ? !!U.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = ee.map((g, O) => {
    ...
    e.weaponsTable = U.map((g) => {
      ...
      let _ = null, L = {};
      for (const Be of C)
        if ((((pt = b[Be]) == null ? void 0 : pt.itemId) ?? "").trim() === O) {
          _ = Be, L = b[Be] ?? {};
          break;
        }
      const M = !!_, J = ((ft = g.system) == null ? void 0 : ft.equipped) !== void 0 && ((yt = g.system) == null ? void 0 : yt.equipped) !== null ? !!g.system.equipped : M, Y = (g == null ? void 0 : g.system) ?? {}, Fe = typeof Y.range == "string" ? (Y.range || "").trim() : "", se = Y.type ?? "", Oe = (we[se] ?? se) || "—", ge = Y.size ?? "", De = (le[ge] ?? ge) || "", Ce = [Oe, De].filter(Boolean).join(", ") || Oe || "—", ke = se === "projectile" || ge === "thrown", ve = Y.quantity, Ne = ve != null ? String(ve).trim() : "1", Ee = String(L.bonus ?? "").trim(), $e = String(Y.bonus ?? "").trim(), xt = Ee || $e || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
        ...
        typeAndSize: Ce,
        quantity: Ne,
        quantityDisplay: ke ? Ne : "—",
        isProjectile: ke,
        equipped: J,
        special: (Y.special ?? "").trim() || "—"
      };
    });
    const ue = (((rt = this.actor.items) == null ? void 0 : rt.contents) ?? []).filter((g) => g.type === "Pancel");
    ...
    const Ie = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const Se = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const de = (((ot = this.actor.items) == null ? void 0 : ot.contents) ?? []).filter((g) => g.type === "MikroChip"), te = de.map((g) => ({ id: g.id, name: g.name, img: g.img })), me = "— Nincs Mikro-Chip —", V = ["slot1", "slot2", "slot3"], pe = (g) => {
      var _, L, M;
      const O = [];
      return g !== 1 && O.push((((_ = D.slot1) == null ? void 0 : _.itemId) ?? "").trim()), g !== 2 && O.push((((L = D.slot2) == null ? void 0 : L.itemId) ?? "").trim()), g !== 3 && O.push((((M = D.slot3) == null ? void 0 : M.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = te.filter((g) => !pe(1).includes(g.id)), e.microchipItemsSlot2 = te.filter((g) => !pe(2).includes(g.id)), e.microchipItemsSlot3 = te.filter((g) => !pe(3).includes(g.id)), e.microchipSlots = V.map((g) => {
      const O = D[g] ?? {}, _ = (O.itemId ?? "").trim(), L = de.find((M) => M.id === _);
      return {
        slotKey: g,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || O.name || me,
        img: (L == null ? void 0 : L.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((g) => {
      const O = `slot${g}`, _ = D[O] ?? {}, L = (_.itemId ?? "").trim(), M = te.find((J) => J.id === L);
      ...
      let _ = null;
      for (const ve of V)
        if ((((ge = D[ve]) == null ? void 0 : ge.itemId) ?? "").trim() === O) {
          _ = ve;
          break;
        }
      const L = !!_, M = ((De = g == null ? void 0 : g.system) == null ? void 0 : De.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Fe = Number((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, se = (((ke = g == null ? void 0 : g.system) == null ? void 0 : ke.description) ?? "").trim(), Oe = se ? se.length > 60 ? se.slice(0, 57) + "…" : se : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const xe = (((ct = e.weaponsTable) == null ? void 0 : ct.length) ?? 0) > 0 || (((lt = e.armorTable) == null ? void 0 : lt.length) ?? 0) > 0 || (((ut = e.microchipsTable) == null ? void 0 : ut.length) ?? 0) > 0 || (((dt = e.itemsTable) == null ? void 0 : dt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !xe;
    const k = this.actor.system.abilities ?? {}, x = (((mt = this.actor.items) == null ? void 0 : mt.contents) ?? []).map((g) => {
      var O, _, L;
      return {
        id: g.id,
        name: g.name,
    ...
    }), N = new Map(x.map((g) => [g.id, g])), K = "— Nincs képesség —", he = (g) => {
      const O = k[g] ?? {}, _ = (O.itemId ?? "").trim(), L = _ ? N.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || O.name || K,
        img: (L == null ? void 0 : L.img) || "",
        description: M,
        kp: J
      };
    ...
    return e.abilityPassiveList = Le(W("passive")), e.abilityActiveList = Le(W("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-iAeEqkrN.mjs");
      n(this.actor, c);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || c, { openRollSheetForSkill: u } = await import("./roll-sheet-iAeEqkrN.mjs");
      u(this.actor, c, n);
      ...
      if (!p) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, p)) ?? ((T = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : T.call(D, (A) => A.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((u == null ? void 0 : u.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((D) => I.includes(D)) : [], q = C.find((D) => {
          var T;
          return (((T = b[D]) == null ? void 0 : T.itemId) ?? "").trim() === c;
        });
        if (q) {
          const D = C.filter((T) => T !== q);
      ...
      const u = this.actor.system.weapons ?? {}, p = (u.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = p ? p.split(/\s*,\s*/).filter((T) => b.includes(T)) : [], I = v.find((T) => {
        var S;
        return (((S = u[T]) == null ? void 0 : S.itemId) ?? "").trim() === c;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let T = v.find((A) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.bonus`]: ((D = n == null ? void 0 : n.system) == null ? void 0 : D.bonus) ?? ""
      ...
      if (!u) return;
      const p = (r.dataset.itemId ?? "").trim(), b = (r.dataset.itemName ?? ((T = r.textContent) == null ? void 0 : T.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", v = (r.dataset.itemImg ?? "").trim(), I = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = b);
      let C = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      v ? (C || (C = document.createElement("img"), C.className = "karakter-microchip-slot-thumb", C.alt = "", n == null || n.insertBefore(C, I)), C.src = v, C.style.display = "") : C && C.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      ...
      p && (D[`system.gear.microchips.${u}.active`] = !0), await this.actor.update(D);
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.bonus`]: ((D = n.system) == null ? void 0 : D.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (I) {
        const T = v.filter((S) => S !== I);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (u && u.documentName === "Item" && u.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, C = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = C ? C.split(/\s*,\s*/).filter((S) => q.includes(S)) : [], T = D.filter((S) => {
              var A;
              return (((A = I[S]) == null ? void 0 : A.itemId) ?? "").trim() === v;
            });
            if (T.length > 0) {
              const A = {
                "system.weapons.slotOrder": D.filter((F) => !T.includes(F)).join(",")
              };
              for (const F of T)
...
z(B, "PARTS", foundry.utils.mergeObject(
  ...
  j(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((wt = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : wt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((It = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : It.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Tt = (St = j(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : St.window) == null ? void 0 : Tt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, ee, we, le, ue, Ie, Se, de, te, me, V, pe, xe;
    ...
    const t = this.actor, o = ((le = t == null ? void 0 : t.items) == null ? void 0 : le.contents) ?? [], d = ((ue = t == null ? void 0 : t.system) == null ? void 0 : ue.weapons) ?? {}, a = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => a.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), y = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = f.length > 0 ? f : a, r = a.filter((k) => !i.includes(k)), c = [...i, ...r], n = c.filter((k) => {
      var N;
      const x = (((N = d[k]) == null ? void 0 : N.itemId) ?? "").trim();
      return x && m.some((K) => K.id === x);
    });
    e.weaponSlots = n.map((k) => {
      const x = d[k] ?? {}, N = (x.itemId ?? "").trim(), K = y.find((he) => he.id === N);
      return {
        slotKey: k,
        itemId: N,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const he = !!N, W = (k == null ? void 0 : k.system) ?? {}, Le = typeof W.range == "string" ? (W.range || "").trim() : "", fe = W.type ?? "", be = (u[fe] ?? fe) || "—", ye = W.size ?? "", Te = (p[ye] ?? ye) || "", _e = [be, Te].filter(Boolean).join(", ") || be || "—", Me = fe === "projectile" || ye === "thrown", Re = W.quantity != null ? String(W.quantity).trim() : "1", je = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: N ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.armorTable = b.map((k) => {
      var K;
      const x = (k == null ? void 0 : k.system) ?? {}, N = ((K = k.system) == null ? void 0 : K.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
    ...
    const v = ((Se = (Ie = t == null ? void 0 : t.system) == null ? void 0 : Ie.gear) == null ? void 0 : Se.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], C = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = C.map((k) => {
      var fe, be, ye, Te;
      const x = k.id;
      let N = null;
      for (const _e of I)
        if ((((fe = v[_e]) == null ? void 0 : fe.itemId) ?? "").trim() === x) {
          N = _e;
          break;
        }
    ...
    e.itemsTable = q.map((k) => {
      const x = (k == null ? void 0 : k.system) ?? {}, N = (x.description ?? "").trim(), K = N ? N.length > 60 ? N.slice(0, 57) + "…" : N : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const S = ((xe = t == null ? void 0 : t.system) == null ? void 0 : xe.abilities) ?? {}, A = o.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var x, N;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-iAeEqkrN.mjs");
      u(this.actor, c, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, n;
      i.preventDefault();
      ...
      var b, v, I, C, q, D;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, c = (C = (I = i.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : C.itemId;
      if (!r || !c || !this.actor) return;
      const n = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, p = (Array.isArray((D = n[r]) == null ? void 0 : D.items) ? n[r].items.slice() : []).filter((T) => T !== c);
      ...
      if (!r || !this.actor) return;
      const c = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, u = ["slot1", "slot2", "slot3"].find((C) => {
        var q;
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const o = (((I = e.system) == null ? void 0 : I.weapons) ?? {})[s] ?? {}, d = ((C = e.system) == null ? void 0 : C.skills) ?? {}, a = ((q = e.items) == null ? void 0 : q.filter((T) => T.type === "Fegyver")) ?? [];
    let l = null;
    o.itemId && (l = a.find((T) => T.id === o.itemId) ?? null);
    const f = l && l.name || o.name || "Fegyver", m = Number(o.bonus || 0) || 0, h = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", i = Number(d[h] || 0) || 0, r = m + i, n = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, u = new Roll(n);
  ...
  async _onDropItem(s, e) {
    var y, h, i, r, c, n, u, p, b, v, I, C, q, D, T;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((r = d.parent) == null ? void 0 : r.id) !== a.id) {
        ...
        S = ((c = (await a.createEmbeddedDocuments("Item", [X]))[0]) == null ? void 0 : c.id) ?? S;
      }
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((T = (D = a.system) == null ? void 0 : D.gear) == null ? void 0 : T.microchips) ?? {}, F = ["slot1", "slot2", "slot3"].find((H) => {
        var U;
...
z(Z, "PARTS", foundry.utils.mergeObject(
  ...
  j(Z, Z, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((_t = j(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ot = j(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ct = (Dt = j(Z, Z, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.window) == null ? void 0 : Ct.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
z(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Lt = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Lt.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = re;
var Pt;
...
z(ne, "PARTS", foundry.utils.mergeObject(j(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Pt = j(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Pt.form) ?? {}, { submitOnChange: !1 })
}));
let Ze = ne;
var Et;
...
z(ae, "PARTS", foundry.utils.mergeObject(j(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Et = j(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Et.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = ae;
var At;
...
z(oe, "PARTS", foundry.utils.mergeObject(j(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((At = j(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : At.form) ?? {}, { submitOnChange: !1 })
}));
let et = oe;
var Ft;
...
z(ce, "PARTS", foundry.utils.mergeObject(j(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ft = j(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Ft.form) ?? {}, { submitOnChange: !1 })
}));
let tt = ce;
const $t = "systems/vacuum-of-the-void/assets/void-bg.jpg";
Hooks.once("init", () => {
  var s, e, t, o, d, a;
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Bt, CONFIG.Actor.dataModels.Npc = Nt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = gt, CONFIG.Item.dataModels.weapon = gt, CONFIG.Item.dataModels.Pancel = Wt, CONFIG.Item.dataModels.MikroChip = Yt, CONFIG.Item.dataModels.Kepesseg = kt, CONFIG.Item.dataModels.ability = kt, CONFIG.Item.dataModels.Targy = Qt, CONFIG.Item.dataModels.Egyeb = Zt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    if (!h) return;
    const i = document.activeElement, r = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), c = [], n = (I = game.actors) == null ? void 0 : I.get(h);
    n != null && n.apps && c.push(...Array.from(n.apps));
    const u = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const S of u)
      ((C = S.document) == null ? void 0 : C.id) !== h || ((q = S.document) == null ? void 0 : q.documentName) !== "Actor" || ((D = S.constructor) == null ? void 0 : D.name) !== "VoidKarakterSheet" || c.includes(S) || c.push(S);
    if (r && c.some((S) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, b, v, I, C, q, D, T, S, A, F, H, U, X, G, ee, we, le, ue, Ie, Se, de, te;
    ...
    if (!o) return;
    const d = (v = game.messages) == null ? void 0 : v.get(o), a = (C = (I = d == null ? void 0 : d.flags) == null ? void 0 : I["vacuum-of-the-void"]) == null ? void 0 : C.weapon;
    if (!a) return;
    const l = a.actorId ?? ((q = d == null ? void 0 : d.speaker) == null ? void 0 : q.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let f = ((D = game.actors) == null ? void 0 : D.get(a.actorId)) ?? ((T = game.actors) == null ? void 0 : T.get(l));
    ...
    const i = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, r = a.targetName || "", c = a.hitLocationName || "", n = ((m == null ? void 0 : m.name) ?? (a.slotKey ? ((te = (((de = f.system) == null ? void 0 : de.weapons) ?? {})[a.slotKey]) == null ? void 0 : te.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-D4OJyNIr.mjs.map
