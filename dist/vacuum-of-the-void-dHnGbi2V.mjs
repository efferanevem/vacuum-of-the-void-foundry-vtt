...
const { HTMLField: wt, NumberField: T, SchemaField: L, StringField: g, BooleanField: K, ArrayField: oe } = foundry.data.fields;
...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const y = this.element, b = this.form ?? this.element, v = d.scrollState, o = d.focus, u = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      var m, f;
    ...
    return (u || o) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), p;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var v, o, u, c, a, m, f, h, S;
    const e = s ?? this.form ?? this.element;
    let t = (v = e == null ? void 0 : e.querySelector) == null ? void 0 : v.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const i = ((u = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : u.resources) ?? {}, r = ((a = (c = i.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : a.value) ?? 0, n = ((m = i.currentHealth) == null ? void 0 : m.legs) ?? 0, d = E._healthStatusFromRatio(n, r), p = Number(((S = (h = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : h.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let y;
  ...
  async _prepareContext(s) {
    ...
    for (const l of d) {
      const k = ((Ne = r[l]) == null ? void 0 : Ne.value) ?? 0, I = n[l] ?? 0;
      e.computedHealthStatus[l] = E._healthStatusFromRatio(I, k);
    }
    const p = (Number(n.head) || 0) === 0, b = ["torso", "arms", "legs"].filter((l) => (Number(n[l]) || 0) === 0).length;
    e.showDeathSkull = p || b >= 2;
    const v = e.computedHealthStatus.legs ?? 3, o = Number(((Pe = (Ee = this.actor.system) == null ? void 0 : Ee.combat) == null ? void 0 : Pe.givenSpeed) ?? 0) || 0;
    let u;
    v === 0 ? u = 0 : v === 1 ? u = -6 : v === 2 ? u = -3 : u = o;
    const c = this._getTotalArmorSpeedPenalty();
    u += c, e.effectiveGivenSpeed = u;
    const m = (Number(((xe = ($e = this.actor.system) == null ? void 0 : $e.combat) == null ? void 0 : xe.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    for (const [l, k] of Object.entries(f)) {
      const I = e.computedHealthStatus[k];
      e.skillHealthStatus[l] = I, e.skillDisabled[l] = I === 0 ? " disabled" : "", e.skillHasHealthTint[l] = !0;
    }
    const h = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = (h.slotOrder ?? "").trim(), F = O ? O.split(/\s*,\s*/).filter((l) => S.includes(l)) : [], A = (je = this.actor.system.gear) == null ? void 0 : je.microchips, D = A && typeof A == "object" && !Array.isArray(A) ? A : {}, w = (((Me = D.slot1) == null ? void 0 : Me.itemId) ?? "").trim(), C = (((Ke = D.slot2) == null ? void 0 : Ke.itemId) ?? "").trim(), x = (((Re = D.slot3) == null ? void 0 : Re.itemId) ?? "").trim(), ot = this.actor.items.contents.filter((l) => l.type !== "Kepesseg" && l.type !== "ability").slice().sort((l, k) => {
      const I = typeof l.sort == "number" ? l.sort : 0, q = typeof k.sort == "number" ? k.sort : 0;
      return I - q;
    }).map((l) => {
      var Q, V, ee, X, Z, ae;
      const k = l.type === "Fegyver", I = l.type === "MikroChip";
      let q = 0, _ = "", j = null;
      for (let te = 0; te < F.length; te++) {
        const ie = F[te];
        if ((((Q = h[ie]) == null ? void 0 : Q.itemId) ?? "") === l.id) {
          q = te + 1, _ = ((V = h[ie]) == null ? void 0 : V.bonus) ?? "", j = ie;
          break;
        }
      }
      let M = null;
      I && (w === l.id ? M = "slot1" : C === l.id ? M = "slot2" : x === l.id && (M = "slot3"));
      const re = k && ((ee = l.system) != null && ee.damage) ? l.system.damage : "", Y = k && typeof ((X = l.system) == null ? void 0 : X.range) == "string" ? (l.system.range || "").trim() : "", J = j ? Number((Z = h[j]) == null ? void 0 : Z.bonus) || 0 : "";
      return {
        id: l.id,
        name: l.name,
        img: l.img,
        ...
        rangeStr: Y,
        slotBonusNum: J,
        quantity: Number(((ae = l.system) == null ? void 0 : ae.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = ot;
    const ce = (((Ue = this.actor.items) == null ? void 0 : Ue.contents) ?? []).filter((l) => l.type === "Fegyver"), ke = ce.map((l) => ({ id: l.id, name: l.name, img: l.img }));
    e.weaponItems = ke;
    const Ie = "— Nincs fegyver —", lt = F.filter((l) => {
      const I = ((h[l] ?? {}).itemId ?? "").trim();
      return I ? !!ce.find((_) => _.id === I) : !1;
    });
    e.weaponSlots = lt.map((l, k) => {
      const I = h[l] ?? {}, q = (I.itemId ?? "").trim(), _ = ke.find((j) => j.id === q);
      return {
        slotKey: l,
        itemId: q,
        slotNum: k + 1,
    ...
    e.weaponsTable = ce.map((l) => {
      ...
      const _ = !!I, j = ((ie = l.system) == null ? void 0 : ie.equipped) !== void 0 && ((We = l.system) == null ? void 0 : We.equipped) !== null ? !!l.system.equipped : _, M = (l == null ? void 0 : l.system) ?? {}, re = typeof M.range == "string" ? (M.range || "").trim() : "", Y = M.type ?? "", J = (ct[Y] ?? Y) || "—", Q = M.size ?? "", V = (ut[Q] ?? Q) || "", ee = [J, V].filter(Boolean).join(", ") || J || "—", X = J === "Lövedékes", Z = M.quantity, ae = Z != null ? String(Z).trim() : "1";
      return {
        slotKey: I ?? "",
        itemId: k,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? Ie,
    ...
    const dt = (((He = this.actor.items) == null ? void 0 : He.contents) ?? []).filter((l) => l.type === "Pancel");
    e.armorTable = dt.map((l) => {
      var q, _;
      const k = (l == null ? void 0 : l.system) ?? {}, I = ((q = l.system) == null ? void 0 : q.equipped) !== void 0 && ((_ = l.system) == null ? void 0 : _.equipped) !== null ? !!l.system.equipped : !1;
      return {
        itemId: l.id,
        actorId: this.actor.id,
    ...
    const mt = (((Be = this.actor.items) == null ? void 0 : Be.contents) ?? []).filter((l) => l.type === "Targy");
    e.itemsTable = mt.map((l) => {
      const k = (l == null ? void 0 : l.system) ?? {}, I = (k.description ?? "").trim(), q = I ? I.length > 60 ? I.slice(0, 57) + "…" : I : "—", _ = k.quantity != null ? String(k.quantity).trim() : "1";
      return {
        itemId: l.id,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const ue = (((Ge = this.actor.items) == null ? void 0 : Ge.contents) ?? []).filter((l) => l.type === "MikroChip"), ne = ue.map((l) => ({ id: l.id, name: l.name, img: l.img })), Se = "— Nincs Mikro-Chip —", qe = ["slot1", "slot2", "slot3"], de = (l) => {
      var I, q, _;
      const k = [];
      return l !== 1 && k.push((((I = D.slot1) == null ? void 0 : I.itemId) ?? "").trim()), l !== 2 && k.push((((q = D.slot2) == null ? void 0 : q.itemId) ?? "").trim()), l !== 3 && k.push((((_ = D.slot3) == null ? void 0 : _.itemId) ?? "").trim()), k.filter(Boolean);
    };
    e.microchipItemsSlot1 = ne.filter((l) => !de(1).includes(l.id)), e.microchipItemsSlot2 = ne.filter((l) => !de(2).includes(l.id)), e.microchipItemsSlot3 = ne.filter((l) => !de(3).includes(l.id)), e.microchipSlots = qe.map((l) => {
      const k = D[l] ?? {}, I = (k.itemId ?? "").trim(), q = ue.find((_) => _.id === I);
      return {
        slotKey: l,
        itemId: I,
      ...
      const k = `slot${l}`, I = D[k] ?? {}, q = (I.itemId ?? "").trim(), _ = ne.find((j) => j.id === q);
      e[`microchip${l}ItemId`] = q, e[`microchip${l}DisplayName`] = (_ == null ? void 0 : _.name) || I.name || Se, e[`microchip${l}Img`] = (_ == null ? void 0 : _.img) || "";
    }), e.microchipsTable = ue.map((l) => {
      var Q, V, ee, X;
      const k = l.id;
      let I = null;
      for (const Z of qe)
      ...
      const q = !!I, _ = ((V = l == null ? void 0 : l.system) == null ? void 0 : V.abilityType) ?? "", j = _ === "active" ? "Aktív" : _ === "passive" ? "Passzív" : _ || "—", M = _ === "active", re = Number((ee = l == null ? void 0 : l.system) == null ? void 0 : ee.replaceCost) >= 0 ? Number(l.system.replaceCost) : 0, Y = (((X = l == null ? void 0 : l.system) == null ? void 0 : X.description) ?? "").trim(), J = Y ? Y.length > 60 ? Y.slice(0, 57) + "…" : Y : "—";
      return {
        itemId: k,
        actorId: this.actor.id,
        name: (l == null ? void 0 : l.name) ?? "—",
    ...
    const Te = this.actor.system.abilities ?? {}, pt = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).map((l) => {
      var k, I, q;
      return {
        id: l.id,
        name: l.name,
        img: l.img,
        kind: ((k = l.system) == null ? void 0 : k.kind) ?? "passive",
        description: ((I = l.system) == null ? void 0 : I.description) ?? "",
        kp: Number(((q = l.system) == null ? void 0 : q.kp) ?? 0) || 0
      };
    }), Oe = new Map(pt.map((l) => [l.id, l])), ft = "— Nincs képesség —", De = (l) => {
      const k = Te[l] ?? {}, I = (k.itemId ?? "").trim(), q = I ? Oe.get(I) : null, _ = (q == null ? void 0 : q.description) ?? "", j = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: I,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (o) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-Cooakau0.mjs");
      a(this.actor, c);
      ...
      if (!c) {
        const h = (u.dataset.slot ?? "").trim();
        if (!h) return;
        c = (((((m = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : m.weapons) ?? {})[h] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c, ((f = u.dataset.slot) == null ? void 0 : f.trim()) ?? "");
    }), !this.isEditable) return;
    const i = (o) => {
      var a;
      const u = o ? o.currentTarget : (a = e.querySelector) == null ? void 0 : a.call(e, 'input[name="system.resources.stress.value"]');
      if (!u) return;
    ...
    r && i({ currentTarget: r }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      o.preventDefault(), o.stopPropagation(), new FilePicker({
        ...
        callback: (u) => {
          u && this.actor.update({ img: u });
        }
      }).browse();
    }), t.on("click", ".karakter-skill-label", async (o) => {
      var f;
      o.preventDefault();
      const u = o.currentTarget, c = u.dataset.skill, a = ((f = u.textContent) == null ? void 0 : f.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-Cooakau0.mjs");
      m(this.actor, c, a);
    ...
    const n = (o, u) => {
      ...
      if (a) {
        if (o.classList.contains("karakter-weapon-label") && (u.altKey || u.shiftKey || u.ctrlKey || u.metaKey)) {
    ...
    t.on("click", ".karakter-inventory-item-name", (o) => {
      ...
      const u = o.currentTarget, c = u.dataset.itemId;
      if (!c) return;
      const a = this.actor.items.get(c);
      if (!a) return;
      ...
      if (!c) return;
      const a = this.actor, m = a.items.get(c), f = {};
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const h = a.system.weapons ?? {}, S = (h.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = S ? S.split(/\s*,\s*/).filter((D) => O.includes(D)) : [], A = F.find((D) => {
          var w;
          return (((w = h[D]) == null ? void 0 : w.itemId) ?? "").trim() === c;
        });
        if (A) {
      ...
      Object.keys(f).length && await a.update(f), await a.deleteEmbeddedDocuments("Item", [c]);
    }), t.on("change", ".karakter-weapon-equip-toggle", async (o) => {
      var A, D;
      const u = o.currentTarget, c = (u.dataset.itemId ?? "").trim();
      if (!c) return;
      const a = this.actor.items.get(c);
      if (!a || a.type !== "Fegyver") return;
      const m = this.actor.system.weapons ?? {}, f = (m.slotOrder ?? "").trim(), h = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = f ? f.split(/\s*,\s*/).filter((w) => h.includes(w)) : [], O = S.find((w) => {
        var C;
        return (((C = m[w]) == null ? void 0 : C.itemId) ?? "").trim() === c;
      }) ?? null;
      if (u.checked) {
        if (O) return;
        let w = S.find((x) => {
      ...
      const c = u.closest(".karakter-microchip-slot-select-wrap"), a = c == null ? void 0 : c.classList.contains("karakter-microchip-slot-open");
      ...
      var w;
      o.preventDefault();
      const u = o.currentTarget, c = u.closest(".karakter-microchip-slot-select-wrap"), a = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), m = a == null ? void 0 : a.dataset.slot;
      if (!m) return;
      const f = (u.dataset.itemId ?? "").trim(), h = (u.dataset.itemName ?? ((w = u.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (u.dataset.itemImg ?? "").trim(), O = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = h);
      let F = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      S ? (F || (F = document.createElement("img"), F.className = "karakter-microchip-slot-thumb", F.alt = "", a == null || a.insertBefore(F, O)), F.src = S, F.style.display = "") : F && F.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      ...
      const a = ((S = (h = this.actor.system) == null ? void 0 : h.gear) == null ? void 0 : S.microchips) ?? {}, f = ["slot1", "slot2", "slot3"].find((O) => {
        var F;
        return (((F = a[O]) == null ? void 0 : F.itemId) ?? "").trim() === u;
      });
      ...
      const u = o.currentTarget.dataset.slot;
      if (!u) return;
      const c = o.currentTarget.checked;
      await this.actor.update({ [`system.gear.microchips.${u}.active`]: c }), this.render(!0);
    }), t.find(".karakter-microchip-slot").each((o, u) => {
      const c = u.dataset.slot;
      u.addEventListener("dragover", (a) => this._onMicrochipSlotDragOver(a, c)), u.addEventListener("dragleave", (a) => {
        var m;
        return (m = a.currentTarget) == null ? void 0 : m.classList.remove("karakter-microchip-slot-drag-over");
      }), u.addEventListener("drop", (a) => this._onMicrochipSlotDrop(a, c));
    }), t.find(".karakter-ability-slot-single").each((o, u) => {
      const c = u.dataset.slot;
      c && (u.addEventListener("dragover", (a) => this._onAbilitySingleDragOver(a, c)), u.addEventListener("dragleave", (a) => {
        var m;
        return (m = a.currentTarget) == null ? void 0 : m.classList.remove("karakter-ability-slot-drag-over");
      }), u.addEventListener("drop", (a) => {
        var m;
        (m = a.currentTarget) == null || m.classList.remove("karakter-ability-slot-drag-over");
      }));
    }), t.find(".karakter-ability-area").each((o, u) => {
      const c = u.dataset.area;
      c && (u.addEventListener("dragover", (a) => this._onAbilityAreaDragOver(a, c)), u.addEventListener("dragleave", (a) => {
        var m;
      ...
      var h;
      if (o.preventDefault(), !o.altKey) return;
      const u = o.currentTarget.dataset.area, c = o.currentTarget.dataset.itemId;
      if (!u || !c) return;
      const a = this.actor.system.abilities ?? {}, f = (Array.isArray((h = a[u]) == null ? void 0 : h.items) ? a[u].items.slice() : []).filter((S) => S !== c);
      await this.actor.update({ [`system.abilities.${u}.items`]: f });
    ...
    }), t.find(".karakter-weapon-quantity-input").each((o, u) => {
      ...
      if (!c) return;
      const a = this.actor.items.get(c);
      !a || a.type !== "Pancel" || (await a.update({ "system.equipped": u.checked }), this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection());
      ...
      if (u.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((A = a.system) == null ? void 0 : A.damage) ?? "",
      ...
      if (o.preventDefault(), o.currentTarget.dataset.gearArray === "generalItems") {
        const m = Array.isArray((a = (c = this.actor.system) == null ? void 0 : c.gear) == null ? void 0 : a.generalItems) ? [...this.actor.system.gear.generalItems] : [];
      ...
      var a, m;
      o.preventDefault();
      const u = parseInt(o.currentTarget.dataset.itemIndex, 10);
      if (!Number.isFinite(u) || u < 0) return;
      const c = Array.isArray((m = (a = this.actor.system) == null ? void 0 : a.gear) == null ? void 0 : m.generalItems) ? [...this.actor.system.gear.generalItems] : [];
      c.splice(u, 1), await this.actor.update({ "system.gear.generalItems": c });
    });
    const d = this, p = (o) => {
      var a, m, f, h;
      if (!o) return;
      const u = d._getFormDataForUpdate(o);
      if (Object.keys(u).length === 0) return;
      const c = ((m = (a = u.system) == null ? void 0 : a.resources) == null ? void 0 : m.currentHealth) != null || ((h = (f = u.system) == null ? void 0 : f.resources) == null ? void 0 : h.hitLocations) != null;
      d.actor.update(u).then(() => {
        c && setTimeout(() => d.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, y = (o) => {
      var u, c, a;
      return o && (((c = (u = d.element) == null ? void 0 : u.contains) == null ? void 0 : c.call(u, o)) || d.id && ((a = o.closest) == null ? void 0 : a.call(o, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (o) => {
      const u = o.target;
      if (!u || !u.form) return;
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && (a.type === "Kepesseg" || a.type === "ability")) {
          ...
          const S = f === "active" ? "active" : "passive", O = Array.isArray((d = h[S]) == null ? void 0 : d.items) ? h[S].items.slice() : Array.isArray(h[S]) ? h[S].slice() : [];
          O.includes(m) || O.push(m), await this.actor.update({ [`system.abilities.${S}.items`]: O });
          return;
        }
      }
    }
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (f) {
            ...
            h = ((b = (await m.createEmbeddedDocuments("Item", [S]))[0]) == null ? void 0 : b.id) ?? h;
          }
          if (f) {
            const S = ((v = m.system) == null ? void 0 : v.weapons) ?? {}, O = (S.slotOrder ?? "").trim(), F = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = O ? O.split(/\s*,\s*/).filter((w) => F.includes(w)) : [], D = A.filter((w) => {
              var C;
              return (((C = S[w]) == null ? void 0 : C.itemId) ?? "").trim() === h;
            });
            if (D.length > 0) {
              const C = {
                "system.weapons.slotOrder": A.filter((x) => !D.includes(x)).join(",")
              };
              for (const x of D)
        ...
        if (a && a.documentName === "Item" && a.type === "MikroChip") {
          const m = this.actor;
          ((u = a.parent) == null ? void 0 : u.id) !== m.id && await m.createEmbeddedDocuments("Item", [a.toObject()]);
          return;
        }
      }
    }
  ...
  async _onWeaponSlotDrop(s, e) {
    ...
    if (((b = r.parent) == null ? void 0 : b.id) !== this.actor.id) {
      const u = foundry.utils.mergeObject(r.toObject(), { system: { ...r.toObject().system ?? {}, equipped: !1 } });
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const r = this.actor.items.contents.slice().sort((v, o) => {
      const u = typeof v.sort == "number" ? v.sort : 0, c = typeof o.sort == "number" ? o.sort : 0;
      return u - c;
  ...
  async _rollWeapon(s) {
    ...
    let n = null;
    t.itemId && (n = r.find((S) => S.id === t.itemId) ?? null);
    const d = n && n.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((h = n == null ? void 0 : n.system) == null ? void 0 : h.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(i[b] || 0) || 0, o = p + v, c = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, a = new Roll(c);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!r && e && (r = (((((u = t.system) == null ? void 0 : u.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !r) {
      (f = (c = ui.notifications) == null ? void 0 : c.warn) == null || f.call(c, ((m = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : m.call(a, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const n = new Roll(r);
...
R(E, "PARTS", foundry.utils.mergeObject(P(E, E, "PARTS") ?? {}, {
  ...
  window: foundry.utils.mergeObject(((Ve = P(E, E, "DEFAULT_OPTIONS")) == null ? void 0 : Ve.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((tt = (et = P(E, E, "DEFAULT_OPTIONS")) == null ? void 0 : et.window) == null ? void 0 : tt.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
R(H, "PARTS", foundry.utils.mergeObject(P(H, H, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((st = P(H, H, "DEFAULT_OPTIONS")) == null ? void 0 : st.form) ?? {}, { submitOnChange: !1 })
}));
let ge = H;
var it;
...
R(B, "PARTS", foundry.utils.mergeObject(P(B, B, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((it = P(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : it.form) ?? {}, { submitOnChange: !1 })
}));
let he = B;
var rt;
...
R(G, "PARTS", foundry.utils.mergeObject(P(G, G, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((rt = P(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : rt.form) ?? {}, { submitOnChange: !1 })
}));
let be = G;
var at;
...
R(z, "PARTS", foundry.utils.mergeObject(P(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((at = P(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : at.form) ?? {}, { submitOnChange: !0 })
}));
let we = z;
var nt;
...
R(W, "PARTS", foundry.utils.mergeObject(P(W, W, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((nt = P(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : nt.form) ?? {}, { submitOnChange: !1 })
}));
let ve = W;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, d, p, y) => {
    ...
    if (!b) return;
    const v = document.activeElement, o = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), u = [], c = (S = game.actors) == null ? void 0 : S.get(b);
    c != null && c.apps && u.push(...Array.from(c.apps));
    const a = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const w of a)
      ((O = w.document) == null ? void 0 : O.id) !== b || ((F = w.document) == null ? void 0 : F.documentName) !== "Actor" || ((A = w.constructor) == null ? void 0 : A.name) !== "VoidKarakterSheet" || u.includes(w) || u.push(w);
    if (o && u.some((w) => {
...
//# sourceMappingURL=vacuum-of-the-void-dHnGbi2V.mjs.map
