...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-D3CP7j75.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D3CP7j75.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((g = o.textContent) == null ? void 0 : g.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-D3CP7j75.mjs");
      h(this.actor, r, u);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: m, label: y } = zt(c), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return c.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D3CP7j75.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D3CP7j75.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-D3CP7j75.mjs");
      u(this.actor, o, r);
  ...
  async _onDropItem(s, e) {
    var m, y, a, i, o, r, u, h, g, v, k, w, T, _, O, q, M, j, K;
...
const tt = class tt extends Et {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!m || !a || !i) return;
      const o = m.value ?? "", r = (y == null ? void 0 : y.value) ?? "", u = t[o] ?? 0, h = n[r] ?? 0, g = (((x = (K = this.actor) == null ? void 0 : K.items) == null ? void 0 : x.contents) ?? []).filter((J) => J.type === "Jarmuegyseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = u + h + k + w;
      a.value = T;
    };
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const c = l.itemId ? ((K = (j = d.items) == null ? void 0 : j.get) == null ? void 0 : K.call(j, l.itemId)) ?? ((Q = (J = (x = d.items) == null ? void 0 : x.contents) == null ? void 0 : J.find) == null ? void 0 : Q.call(J, (V) => V.id === l.itemId)) : null;
...
Hooks.on("preCreateToken", (S, s, e) => {
  ...
  if (f) {
    if (f.type === "Bazis")
      throw new Error(((c = (d = game.i18n) == null ? void 0 : d.localize) == null ? void 0 : c.call(d, "VOTV.BazisNoToken")) ?? "Bázis nem helyezhető tokenként a térképre.");
    if (f.type === "Karakter") {
      S.updateSource({
        ...t ? { actorId: t } : {},
        actorLink: !0,
    ...
    if (f.type === "Npc") {
      const a = Bs((y = (m = f.system) == null ? void 0 : m.identity) == null ? void 0 : y.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-hCLq-ayD.mjs.map
