...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const k = this.element, b = this.form ?? this.element, v = u.scrollState, i = u.focus, n = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      var m, f;
    ...
    return (n || i) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), p;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var b, v, i, n, c, o, m, f, h;
    const e = s ?? this.form ?? this.element;
    let t = (b = e == null ? void 0 : e.querySelector) == null ? void 0 : b.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const r = ((i = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : i.resources) ?? {}, a = ((c = (n = r.hitLocations) == null ? void 0 : n.legs) == null ? void 0 : c.value) ?? 0, l = ((o = r.currentHealth) == null ? void 0 : o.legs) ?? 0, u = x._healthStatusFromRatio(l, a), p = Number(((h = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : h.givenSpeed) ?? 0) || 0;
    let k;
  ...
  async _prepareContext(s) {
    ...
    let n;
    v === 0 ? n = 0 : v === 1 ? n = -6 : v === 2 ? n = -3 : n = i, e.effectiveGivenSpeed = n, e.system = foundry.utils.mergeObject(
    ...
    const o = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], f = (o.slotOrder ?? "").trim(), h = f ? f.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], y = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = y && typeof y == "object" && !Array.isArray(y) ? y : {}, N = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = (((Ne = I.slot2) == null ? void 0 : Ne.itemId) ?? "").trim(), O = ((($e = I.slot3) == null ? void 0 : $e.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "Képesség" && d.type !== "ability").slice().sort((d, T) => {
      ...
      const V = T && ((oe = d.system) != null && oe.damage) ? d.system.damage : "", Q = T && typeof ((se = d.system) == null ? void 0 : se.range) == "string" ? (d.system.range || "").trim() : "", Y = j ? Number((re = o[j]) == null ? void 0 : re.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Umd2jpHP.mjs");
      o(this.actor, c);
    }), t.on("click", ".karakter-weapon-damage", async (i) => {
      var o, m, f;
      i.preventDefault(), i.stopPropagation();
      const n = i.currentTarget;
      let c = (n.dataset.itemId ?? "").trim();
      if (!c) {
        const h = (n.dataset.slot ?? "").trim();
        if (!h) return;
        c = (((((m = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : m.weapons) ?? {})[h] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c, ((f = n.dataset.slot) == null ? void 0 : f.trim()) ?? "");
    }), !this.isEditable) return;
    const r = (i) => {
      var o;
      const n = i ? i.currentTarget : (o = e.querySelector) == null ? void 0 : o.call(e, 'input[name="system.resources.stress.value"]');
      if (!n) return;
      const c = Number(n.value) || 0;
      n.classList.toggle("karakter-stress-over-10", c > 10);
    };
    ...
    a && r({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var f;
      i.preventDefault();
      const n = i.currentTarget, c = n.dataset.skill, o = ((f = n.textContent) == null ? void 0 : f.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-Umd2jpHP.mjs");
      m(this.actor, c, o);
    ...
    const l = (i, n) => {
      ...
      if (o) {
        if (i.classList.contains("karakter-weapon-label") && (n.altKey || n.shiftKey || n.ctrlKey || n.metaKey)) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const n = i.currentTarget, c = n.dataset.itemId;
      if (!c) return;
      const o = this.actor.items.get(c);
      if (!o) return;
      ...
      if (!c) return;
      const o = this.actor, m = o.items.get(c), f = {};
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const h = o.system.weapons ?? {}, y = (h.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = y ? y.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], q = N.find((O) => {
          var w;
      ...
      Object.keys(f).length && await o.update(f), await o.deleteEmbeddedDocuments("Item", [c]);
    }), t.on("change", ".karakter-weapon-equip-toggle", async (i) => {
      var q, O;
      const n = i.currentTarget, c = (n.dataset.itemId ?? "").trim();
      if (!c) return;
      const o = this.actor.items.get(c);
      ...
      const c = n.closest(".karakter-microchip-slot-select-wrap"), o = c == null ? void 0 : c.classList.contains("karakter-microchip-slot-open");
      ...
      var w;
      i.preventDefault();
      const n = i.currentTarget, c = n.closest(".karakter-microchip-slot-select-wrap"), o = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), m = o == null ? void 0 : o.dataset.slot;
      if (!m) return;
      const f = (n.dataset.itemId ?? "").trim(), h = (n.dataset.itemName ?? ((w = n.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", y = (n.dataset.itemImg ?? "").trim(), I = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = h);
      let N = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      y ? (N || (N = document.createElement("img"), N.className = "karakter-microchip-slot-thumb", N.alt = "", o == null || o.insertBefore(N, I)), N.src = y, N.style.display = "") : N && N.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      ...
      const n = i.currentTarget.dataset.slot;
      if (!n) return;
      const c = i.currentTarget.checked;
      this.actor.update({ [`system.gear.microchips.${n}.active`]: c });
    }), t.find(".karakter-microchip-slot").each((i, n) => {
      const c = n.dataset.slot;
      n.addEventListener("dragover", (o) => this._onMicrochipSlotDragOver(o, c)), n.addEventListener("dragleave", (o) => {
        var m;
        return (m = o.currentTarget) == null ? void 0 : m.classList.remove("karakter-microchip-slot-drag-over");
      }), n.addEventListener("drop", (o) => this._onMicrochipSlotDrop(o, c));
    }), t.find(".karakter-ability-slot-single").each((i, n) => {
      const c = n.dataset.slot;
      c && (n.addEventListener("dragover", (o) => this._onAbilitySingleDragOver(o, c)), n.addEventListener("dragleave", (o) => {
        var m;
    ...
    }), t.find(".karakter-ability-area").each((i, n) => {
      const c = n.dataset.area;
      c && (n.addEventListener("dragover", (o) => this._onAbilityAreaDragOver(o, c)), n.addEventListener("dragleave", (o) => {
        var m;
      ...
      var h;
      if (i.preventDefault(), !i.altKey) return;
      const n = i.currentTarget.dataset.area, c = i.currentTarget.dataset.itemId;
      if (!n || !c) return;
      const o = this.actor.system.abilities ?? {}, f = (Array.isArray((h = o[n]) == null ? void 0 : h.items) ? o[n].items.slice() : []).filter((y) => y !== c);
    ...
    }), t.find(".karakter-weapon-quantity-input").each((i, n) => {
      ...
      var o, m;
      i.preventDefault();
      const n = parseInt(i.currentTarget.dataset.armorIndex, 10);
      if (!Number.isFinite(n) || n < 0) return;
      const c = Array.isArray((m = (o = this.actor.system) == null ? void 0 : o.gear) == null ? void 0 : m.armor) ? [...this.actor.system.gear.armor] : [];
      c.splice(n, 1), await this.actor.update({ "system.gear.armor": c });
    }), t.on("click", ".karakter-equipment-add-row", async (i) => {
      var c, o, m, f;
      i.preventDefault();
      const n = i.currentTarget.dataset.gearArray;
      if (n === "armor") {
        const h = Array.isArray((o = (c = this.actor.system) == null ? void 0 : c.gear) == null ? void 0 : o.armor) ? [...this.actor.system.gear.armor] : [];
      ...
      i.preventDefault();
      const n = i.currentTarget.dataset.slotKey;
      n && await this.actor.update({
      ...
      var o, m;
      i.preventDefault();
      const n = parseInt(i.currentTarget.dataset.itemIndex, 10);
      if (!Number.isFinite(n) || n < 0) return;
      const c = Array.isArray((m = (o = this.actor.system) == null ? void 0 : o.gear) == null ? void 0 : m.generalItems) ? [...this.actor.system.gear.generalItems] : [];
      c.splice(n, 1), await this.actor.update({ "system.gear.generalItems": c });
    });
    const u = this, p = (i) => {
      var o, m, f, h;
      if (!i) return;
      const n = u._getFormDataForUpdate(i);
      if (Object.keys(n).length === 0) return;
      const c = ((m = (o = n.system) == null ? void 0 : o.resources) == null ? void 0 : m.currentHealth) != null || ((h = (f = n.system) == null ? void 0 : f.resources) == null ? void 0 : h.hitLocations) != null;
      u.actor.update(n).then(() => {
        c && setTimeout(() => u.render(!0), 260);
      }).catch((y) => console.warn("VoidKarakterSheet save failed", y));
    }, k = (i) => {
      var n, c, o;
      return i && (((c = (n = u.element) == null ? void 0 : n.contains) == null ? void 0 : c.call(n, i)) || u.id && ((o = i.closest) == null ? void 0 : o.call(i, `#${CSS.escape(u.id)}`)));
    };
    u._votvBlur = (i) => {
      const n = i.target;
      if (!n || !n.form) return;
      ...
      const o = n.form;
      k(o) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: u.id, at: Date.now() }), p(o));
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (y && y.documentName === "Item" && (y.type === "Képesség" || y.type === "ability")) {
          ...
          const O = N === "active" ? "active" : "passive", w = Array.isArray((n = q[O]) == null ? void 0 : n.items) ? q[O].items.slice() : Array.isArray(q[O]) ? q[O].slice() : [];
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const a = this.actor.items.contents.slice().sort((v, i) => {
      const n = typeof v.sort == "number" ? v.sort : 0, c = typeof i.sort == "number" ? i.sort : 0;
      return n - c;
  ...
  async _onAbilitySingleDrop(s, e) {
    ...
    if (((u = r.parent) == null ? void 0 : u.id) !== this.actor.id) {
      const k = foundry.utils.mergeObject(r.toObject(), { type: "Képesség" });
      a = ((p = (await this.actor.createEmbeddedDocuments("Item", [k]))[0]) == null ? void 0 : p.id) ?? a;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    if (!r || r.type !== "Képesség" && r.type !== "ability") return;
    let a = r.id;
    if (((k = r.parent) == null ? void 0 : k.id) !== this.actor.id) {
      const i = foundry.utils.mergeObject(r.toObject(), { type: "Képesség" });
      a = ((b = (await this.actor.createEmbeddedDocuments("Item", [i]))[0]) == null ? void 0 : b.id) ?? a;
    }
  ...
  async _rollWeapon(s) {
    ...
    const u = l && l.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((h = l == null ? void 0 : l.system) == null ? void 0 : h.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(r[b] || 0) || 0, i = p + v, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, o = new Roll(c);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!a && e && (a = (((((n = t.system) == null ? void 0 : n.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !a) {
      (f = (c = ui.notifications) == null ? void 0 : c.warn) == null || f.call(c, ((m = (o = game.i18n) == null ? void 0 : o.localize) == null ? void 0 : m.call(o, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const l = new Roll(a);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, u, p, k) => {
    ...
    if (!b) return;
    const v = document.activeElement, i = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), n = [], c = (y = game.actors) == null ? void 0 : y.get(b);
    c != null && c.apps && n.push(...Array.from(c.apps));
    const o = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const w of o)
      ((I = w.document) == null ? void 0 : I.id) !== b || ((N = w.document) == null ? void 0 : N.documentName) !== "Actor" || ((q = w.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || n.includes(w) || n.push(w);
    if (i && n.some((w) => {
...
//# sourceMappingURL=vacuum-of-the-void-DQ8DBLL6.mjs.map
