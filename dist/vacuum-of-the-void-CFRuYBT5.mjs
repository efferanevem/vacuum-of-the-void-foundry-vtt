...
const { HTMLField: Si, NumberField: C, SchemaField: K, StringField: T, BooleanField: te, ArrayField: it } = foundry.data.fields;
...
function wt(w) {
  ...
  u(w.terms, 1);
  const a = i.filter((d) => d === 6).length, l = i.filter((d) => d === 1).length, m = e.filter((d) => d === 6).length, p = t.filter((d) => d === 6).length, g = a + m, b = l + p;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((n = i.querySelector) == null ? void 0 : n.call(i, "form.votv.karakter-sheet")) ?? ((u = i.querySelector) == null ? void 0 : u.call(i, "form.votv")) ?? null, t = ((a = i.querySelector) == null ? void 0 : a.call(i, ".votv-scroll")) ?? ((l = i.querySelector) == null ? void 0 : l.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const u = this.element, a = this.form ?? this.element;
    ...
    const p = this.element, g = this.form ?? this.element, b = l.scrollState, d = l.focus, s = typeof (b == null ? void 0 : b.formScrollTop) == "number" || typeof (b == null ? void 0 : b.windowScrollTop) == "number", c = () => {
      var r, f;
      if (this._applyScrollState(p, b), (d == null ? void 0 : d.name) != null || (d == null ? void 0 : d.id) != null) {
        const h = ((r = g.querySelector) == null ? void 0 : r.call(g, d.id ? `#${CSS.escape(d.id)}` : null)) ?? (d.name ? (f = g.querySelector) == null ? void 0 : f.call(g, `[name="${CSS.escape(d.name)}"]`) : null);
    ...
    return (s || d) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), m;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (n <= 0 || t <= 0) return 0;
    const u = Math.floor(n / 3), a = Math.floor(2 * n / 3);
    return t <= u ? 1 : t <= a ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const a of i) {
      const l = String(((u = a.system) == null ? void 0 : u.speedPenalty) ?? "").trim().replace(",", "."), m = Number(l);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const a of i) {
      const l = String(((u = a.system) == null ? void 0 : u.protectionBonus) ?? "").trim().replace(",", "."), m = Number(l);
      Number.isFinite(m) && (e += m);
    }
    return e;
  }
  ...
  static getTotalSpeedRaw(i) {
    var g, b, d, s, c, o, r, f, h;
    if (!(i != null && i.system)) return 0;
    const e = i.system.resources ?? {}, t = ((b = (g = e.hitLocations) == null ? void 0 : g.legs) == null ? void 0 : b.value) ?? 0, n = ((d = e.currentHealth) == null ? void 0 : d.legs) ?? 0, u = B._healthStatusFromRatio(n, t);
    if (u === 0) return 0;
    const a = Number(((c = (s = i.system) == null ? void 0 : s.combat) == null ? void 0 : c.givenSpeed) ?? 0) || 0;
    let l;
    u === 1 ? l = -6 : u === 2 ? l = -3 : l = a, l += B._getTotalArmorSpeedPenaltyStatic(i);
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    if ((c = (s = (d = this.actor) == null ? void 0 : d.statuses) == null ? void 0 : s.has) != null && c.call(s, "immobilized")) {
      t.textContent = "0";
      return;
    }
    const n = ((r = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : r.resources) ?? {}, u = ((h = (f = n.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, a = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, l = B._healthStatusFromRatio(a, u), m = Number(((q = (S = (I = this.actor) == null ? void 0 : I.system) == null ? void 0 : S.combat) == null ? void 0 : q.givenSpeed) ?? 0) || 0;
    let p;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const u = (Number(((p = (m = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : m.combat) == null ? void 0 : p.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _writeTotalDefense(i = null) {
    ...
    }, n = t(".karakter-total-defense-effective"), u = t(".karakter-given-defense-effective"), a = t('input[name="system.combat.defense"]'), l = t('input[name="system.combat.defenseBonus"]');
    if (!n) return;
    const m = Number(a == null ? void 0 : a.value) || 0, p = Number(l == null ? void 0 : l.value) || 0, g = Number(u == null ? void 0 : u.textContent) || 0;
    n.textContent = String(m + p + g);
  }
  _writeTotalSpeed(i = null) {
    var o, r, f, h, v, I, S, q;
    const e = i ?? this.form ?? this.element, t = (N) => {
      var A;
      return ((A = e == null ? void 0 : e.querySelector) == null ? void 0 : A.call(e, N)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${N}`) : null);
    }, n = t(".karakter-total-speed-effective"), u = t(".karakter-given-speed-effective"), a = t('input[name="system.combat.speed"]'), l = t('input[name="system.combat.speedBonus"]');
    if (!n) return;
    if ((f = (r = (o = this.actor) == null ? void 0 : o.statuses) == null ? void 0 : r.has) != null && f.call(r, "immobilized")) {
      n.textContent = "0";
      return;
    }
    const m = ((v = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : v.resources) ?? {}, p = ((S = (I = m.hitLocations) == null ? void 0 : I.legs) == null ? void 0 : S.value) ?? 0, g = ((q = m.currentHealth) == null ? void 0 : q.legs) ?? 0;
    if (B._healthStatusFromRatio(g, p) === 0) {
      n.textContent = "0";
      return;
    }
    const d = Number(a == null ? void 0 : a.value) || 0, s = Number(l == null ? void 0 : l.value) || 0, c = Number(u == null ? void 0 : u.textContent) || 0;
    n.textContent = String(d + s + c);
  }
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((a = this.actor.system) == null ? void 0 : a.resources) ?? {}, n = ((m = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : m.value) ?? 0, u = ((p = t.currentHealth) == null ? void 0 : p[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const n = ((l = i == null ? void 0 : i.system) == null ? void 0 : l.resources) ?? {}, u = ((p = (m = n.hitLocations) == null ? void 0 : m[t]) == null ? void 0 : p.value) ?? 0, a = ((g = n.currentHealth) == null ? void 0 : g[t]) ?? 0;
    return B._healthStatusFromRatio(a, u);
  }
  async _prepareContext(i) {
    var We, Ye, Je, Qe, k, F, x, j, ce, Q, Ie, be, Se, ke, Le, Ne, mt, pt, ft, yt, Xe, $e, Lt, Nt, At, Pt, Ft, Et, $t, xt, Rt, Mt, Kt, jt, zt, Ht;
    ...
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, u = n.hitLocations ?? {}, a = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const D = ((Qe = u[y]) == null ? void 0 : Qe.value) ?? 0, _ = a[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, d = Number(((F = (k = this.actor.system) == null ? void 0 : k.combat) == null ? void 0 : F.givenSpeed) ?? 0) || 0;
    let s;
    b === 0 ? s = 0 : b === 1 ? s = -6 : b === 2 ? s = -3 : s = d;
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), A = N ? N.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], O = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, P = (((Ne = E.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), z = (((mt = E.slot2) == null ? void 0 : mt.itemId) ?? "").trim(), G = (((pt = E.slot3) == null ? void 0 : pt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return _ - L;
    }).map((y) => {
      var ve, Pe, Fe, Te, _e, et;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let L = 0, M = "", ee = null;
      for (let xe = 0; xe < A.length; xe++) {
        const tt = A[xe];
        if ((((ve = S[tt]) == null ? void 0 : ve.itemId) ?? "") === y.id) {
          L = xe + 1, M = ((Pe = S[tt]) == null ? void 0 : Pe.bonus) ?? "", ee = tt;
          break;
        }
      }
      let X = null;
      _ && (P === y.id ? X = "slot1" : z === y.id ? X = "slot2" : G === y.id && (X = "slot3"));
      const Ze = D && ((Fe = y.system) != null && Fe.damage) ? y.system.damage : "", le = D && typeof ((Te = y.system) == null ? void 0 : Te.range) == "string" ? (y.system.range || "").trim() : "", Ae = ee ? Number((_e = S[ee]) == null ? void 0 : _e.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponItems = Y;
    const R = "— Nincs fegyver —", W = A.filter((y) => {
      const _ = ((S[y] ?? {}).itemId ?? "").trim();
      return _ ? !!Z.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = W.map((y, D) => {
      const _ = S[y] ?? {}, L = (_.itemId ?? "").trim(), M = Y.find((ee) => ee.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: D + 1,
    ...
    e.weaponsTable = Z.map((y) => {
      ...
      const M = !!_, ee = ((Bt = y.system) == null ? void 0 : Bt.equipped) !== void 0 && ((Gt = y.system) == null ? void 0 : Gt.equipped) !== null ? !!y.system.equipped : M, X = (y == null ? void 0 : y.system) ?? {}, Ze = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", Ae = (oe[le] ?? le) || "—", ve = X.size ?? "", Pe = (ge[ve] ?? ve) || "", Fe = [Ae, Pe].filter(Boolean).join(", ") || Ae || "—", Te = le === "projectile" || ve === "thrown", _e = X.quantity, et = _e != null ? String(_e).trim() : "1", xe = String(L.bonus ?? "").trim(), tt = String(X.bonus ?? "").trim(), bi = xe || tt || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    e.armorTable = re.map((y) => {
      ...
      return {
        ...
        level: Fi((D.level ?? "").toString().trim()),
    ...
    const se = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).filter((y) => y.type === "MikroChip"), ne = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Me = "— Nincs Mikro-Chip —", Ke = ["slot1", "slot2", "slot3"], je = (y) => {
      var _, L, M;
      const D = [];
      return y !== 1 && D.push((((_ = E.slot1) == null ? void 0 : _.itemId) ?? "").trim()), y !== 2 && D.push((((L = E.slot2) == null ? void 0 : L.itemId) ?? "").trim()), y !== 3 && D.push((((M = E.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      const D = E[y] ?? {}, _ = (D.itemId ?? "").trim(), L = se.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
      ...
      const D = `slot${y}`, _ = E[D] ?? {}, L = (_.itemId ?? "").trim(), M = ne.find((ee) => ee.id === L);
      ...
      const L = !!_, M = ((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", Ze = Number((Fe = y == null ? void 0 : y.system) == null ? void 0 : Fe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, le = (((Te = y == null ? void 0 : y.system) == null ? void 0 : Te.description) ?? "").trim(), Ae = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const qt = (((Nt = e.weaponsTable) == null ? void 0 : Nt.length) ?? 0) > 0 || (((At = e.armorTable) == null ? void 0 : At.length) ?? 0) > 0 || (((Pt = e.microchipsTable) == null ? void 0 : Pt.length) ?? 0) > 0 || (((Ft = e.itemsTable) == null ? void 0 : Ft.length) ?? 0) > 0;
    ...
    const Ee = this.actor.system.abilities ?? {}, nt = (((Et = this.actor.items) == null ? void 0 : Et.contents) ?? []).map((y) => {
      ...
      const D = Ee[y] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? ze.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", ee = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || at,
        img: (L == null ? void 0 : L.img) || "",
        description: M,
        kp: ee
      };
    ...
    if (typeof he == "number" && he >= 0 && we.length > 0) {
      ...
      let _ = null;
      he <= y.max ? _ = y : he >= D.min ? _ = D : _ = we.find((L) => he >= L.min && he <= L.max), _ && (Ve = _.kp);
    }
    e.kpDots = ot.map((y, D) => {
      const _ = D + 1, L = !!Number(rt[y]), M = _ <= Ve;
      return { index: _, used: L, usable: M };
    });
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-E8WTFofS.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-E8WTFofS.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-E8WTFofS.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((N = (q = this.actor.items).get) == null ? void 0 : N.call(q, h)) ?? ((O = (A = this.actor.items.contents) == null ? void 0 : A.find) == null ? void 0 : O.call(A, (P) => P.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((A) => S.includes(A)) : [], N = q.find((A) => {
          var O;
          return (((O = v[A]) == null ? void 0 : O.itemId) ?? "").trim() === o;
        });
        if (N) {
          const A = q.filter((O) => O !== N);
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((O) => v.includes(O)) : [], S = I.find((O) => {
        var E;
        return (((E = f[O]) == null ? void 0 : E.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (S) return;
        let O = I.find((P) => {
          var z;
          return !((z = f[P]) != null && z.itemId);
        });
        const E = new Set(I);
        if (!O) {
          const P = v.find((z) => !E.has(z));
          if (!P) return;
          O = P, I.push(P);
        }
        await this.actor.update({
          ...
          [`system.weapons.${O}.name`]: (r == null ? void 0 : r.name) ?? "",
          [`system.weapons.${O}.damage`]: ((N = r == null ? void 0 : r.system) == null ? void 0 : N.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((A = r == null ? void 0 : r.system) == null ? void 0 : A.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const O = I.filter((E) => E !== S);
        await this.actor.update({
      ...
      if (!f) return;
      const h = (c.dataset.itemId ?? "").trim(), v = (c.dataset.itemName ?? ((O = c.textContent) == null ? void 0 : O.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (c.dataset.itemImg ?? "").trim(), S = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      let q = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      I ? (q || (q = document.createElement("img"), q.className = "karakter-microchip-slot-thumb", q.alt = "", r == null || r.insertBefore(q, S)), q.src = I, q.style.display = "") : q && q.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      const r = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((S) => {
        var q;
        return (((q = r[S]) == null ? void 0 : q.itemId) ?? "").trim() === c;
      });
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          "system.weapons.slotOrder": I.join(","),
          [`system.weapons.${O}.itemId`]: o,
          [`system.weapons.${O}.name`]: r.name ?? "",
          [`system.weapons.${O}.damage`]: ((N = r.system) == null ? void 0 : N.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((A = r.system) == null ? void 0 : A.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const O = I.filter((E) => E !== S);
        await this.actor.update({
  ...
  _getFormDataForUpdate(i) {
    ...
    ), n = t.hitLocations ?? {}, u = t.currentHealth ?? {}, a = ["head", "torso", "arms", "legs"];
    for (const g of a) {
      const b = ((p = n[g]) == null ? void 0 : p.value) ?? 0, d = u[g] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${g}`, B._healthStatusFromRatio(d, b));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, n, u, a, l, m, p, g, b, d, s, c;
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          if (((n = r.parent) == null ? void 0 : n.id) !== this.actor.id) {
            ...
            f = ((u = (await this.actor.createEmbeddedDocuments("Item", [q]))[0]) == null ? void 0 : u.id) ?? f;
          }
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = S ? S.split(/\s*,\s*/).filter((O) => q.includes(O)) : [], A = N.filter((O) => {
              var E;
              return (((E = I[O]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (A.length > 0) {
              const E = {
                "system.weapons.slotOrder": N.filter((P) => !A.includes(P)).join(",")
              };
              for (const P of A)
                E[`system.weapons.${P}.itemId`] = "", E[`system.weapons.${P}.name`] = "", E[`system.weapons.${P}.damage`] = "", E[`system.weapons.${P}.bonus`] = "";
              await f.update(E);
            }
          }
          return;
        ...
        if (r && r.documentName === "Item" && r.type === "Pancel") {
          const f = this.actor;
          if (((d = r.parent) == null ? void 0 : d.id) !== f.id) {
  ...
  _onWeaponSlotDragOver(i, e) {
    var u, a, l;
    const t = ((u = i.dataTransfer) == null ? void 0 : u.getData("text/plain")) || ((a = i.dataTransfer) == null ? void 0 : a.getData("application/json")) || "";
    let n;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    if (((g = u.parent) == null ? void 0 : g.id) !== this.actor.id) {
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const u = this.actor.items.contents.slice().sort((b, d) => {
      const s = typeof b.sort == "number" ? b.sort : 0, c = typeof d.sort == "number" ? d.sort : 0;
      return s - c;
    }).map((b) => b.id), a = u.indexOf(t), l = u.indexOf(e);
    if (a === -1 || l === -1) return;
    u.splice(a, 1), u.splice(l, 0, t);
    const m = u.map((b, d) => ({
      _id: b,
      sort: (d + 1) * 10
    }));
  ...
  _onInventoryAreaDragOver(i) {
    var n, u, a;
    const e = ((n = i.dataTransfer) == null ? void 0 : n.getData("text/plain")) || ((u = i.dataTransfer) == null ? void 0 : u.getData("application/json")) || "";
    let t = null;
  ...
  async _postItemToChat(i) {
    ...
    if (e.type === "MikroChip") {
      ...
      if (n = (b === "active" ? "Aktív" : "Passzív") + " Mikro-Chip", b === "active") {
        const d = Number(((g = e.system) == null ? void 0 : g.replaceCost) ?? 0) || 0;
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", n = Number(((b = e.system) == null ? void 0 : b.kp) ?? 0) || 0, u = (((d = e.system) == null ? void 0 : d.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = u ? `<p>${u}</p>` : "", p = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((l = n.parent) == null ? void 0 : l.id) !== this.actor.id) {
      ...
      u = ((m = (await this.actor.createEmbeddedDocuments("Item", [p]))[0]) == null ? void 0 : m.id) ?? u;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    if (((p = n.parent) == null ? void 0 : p.id) !== this.actor.id) {
      ...
      u = ((g = (await this.actor.createEmbeddedDocuments("Item", [d]))[0]) == null ? void 0 : g.id) ?? u;
    }
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let a = u.id;
    ((g = u.parent) == null ? void 0 : g.id) !== this.actor.id && (a = ((b = (await this.actor.createEmbeddedDocuments("Item", [u.toObject()]))[0]) == null ? void 0 : b.id) ?? a), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    a === 1 ? u -= 6 : a === 2 && (u -= 3);
    const m = `3d6${u !== 0 ? u > 0 ? `+${u}` : `${u}` : ""}`, p = new Roll(m);
    await p.evaluate({ async: !0 });
    const { resultType: g, label: b } = wt(p), d = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollMorale() {
    var u;
    const i = Number(((u = this.actor.system.resources) == null ? void 0 : u.morale) ?? 0) || 0;
    if (i <= 0) return;
  ...
  async _rollWeapon(i) {
    var I, S;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, n = this.actor.system.skills ?? {}, u = this.actor.items.filter((q) => q.type === "Fegyver");
    let a = null;
    t.itemId && (a = u.find((q) => q.id === t.itemId) ?? null);
    const l = a && a.name || t.name || `Fegyver (${i})`, m = Number(t.bonus || 0) || 0, p = ((I = a == null ? void 0 : a.system) == null ? void 0 : I.type) || "kinetic", g = (((S = a == null ? void 0 : a.system) == null ? void 0 : S.skillKey) ?? "").trim(), b = g && n[g] !== void 0 ? g : p === "explosive" ? "grenadeUse" : "firearms", d = Number(n[b] || 0) || 0, s = m + d, o = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, r = new Roll(o);
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    if (!u && e && (u = (((((s = t.system) == null ? void 0 : s.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !u) {
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const a = await super.render(i, e), l = this.element, m = this.form ?? this.element, p = u.scrollState, g = u.focus, b = typeof (p == null ? void 0 : p.formScrollTop) == "number" || typeof (p == null ? void 0 : p.windowScrollTop) == "number", d = () => {
      var s, c;
    ...
    return (b || g) && (requestAnimationFrame(d), setTimeout(d, 0), setTimeout(d, 50), setTimeout(d, 150), setTimeout(d, 300), setTimeout(d, 450)), a;
  }
  async _prepareContext(i) {
    ...
    const t = this.actor, n = ((Ue = t == null ? void 0 : t.items) == null ? void 0 : Ue.contents) ?? [], u = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, a = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (u.slotOrder ?? "").trim(), m = l ? l.split(/\s*,\s*/).filter((k) => a.includes(k)) : [], p = n.filter((k) => k.type === "Fegyver"), g = p.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", d = m.length > 0 ? m : a, s = a.filter((k) => !d.includes(k)), c = [...d, ...s], o = c.filter((k) => {
      var x;
      const F = (((x = u[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return F && p.some((j) => j.id === F);
    });
    e.weaponSlots = o.map((k) => {
      const F = u[k] ?? {}, x = (F.itemId ?? "").trim(), j = g.find((ce) => ce.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = p.map((k) => {
      ...
      let x = null, j = {};
      for (const $e of c)
        if ((((Xe = u[$e]) == null ? void 0 : Xe.itemId) ?? "").trim() === F) {
          x = $e, j = u[$e] ?? {};
          break;
        }
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: Ei((F.level ?? "").toString().trim()),
    ...
    e.microchipsTable = S.map((k) => {
      ...
      let x = null;
      for (const Ne of I)
        if ((((be = v[Ne]) == null ? void 0 : be.itemId) ?? "").trim() === F) {
          x = Ne;
          break;
        }
    ...
    const N = n.filter((k) => k.type === "Egyeb");
    e.egyebList = N.map((k) => {
    ...
    const A = (((Oe = e.weaponsTable) == null ? void 0 : Oe.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ct = e.microchipsTable) == null ? void 0 : ct.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Ce = e.egyebList) == null ? void 0 : Ce.length) ?? 0) > 0;
    e.showEquipmentDropZone = !A;
    const O = ((ht = t == null ? void 0 : t.system) == null ? void 0 : ht.abilities) ?? {}, E = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
    ...
    }), P = new Map(E.map((k) => [k.id, k])), z = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const V = t == null ? void 0 : t.id, Z = !!((qe = (we = game.combat) == null ? void 0 : we.combatants) != null && qe.some(
      (k) => {
        var F;
        return (((F = k.actor) == null ? void 0 : F.id) ?? k.actorId) === V;
      }
    ));
    e.showHarcSection = Z;
    const Y = ((lt = e.system) == null ? void 0 : lt.resources) ?? {}, R = (Ve = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ve.initiativeResult, W = typeof R == "number" ? R : -1, oe = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (We = (dt = e.system) == null ? void 0 : dt.combat) == null ? void 0 : We.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, F) => k.min - F.min), se = 3;
    let ne = re.length > 0 ? re : [];
    ne.length < se && (ne = [...ne, ...Array(se - ne.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ne.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === ne.length - 1
    }));
    let Me = 0;
    if (typeof W == "number" && W >= 0 && ie.length > 0) {
      const k = ie[0], F = ie[ie.length - 1];
      let x = null;
      W <= k.max ? x = k : W >= F.min ? x = F : x = ie.find((j) => W >= j.min && W <= j.max), x && (Me = x.kp);
    }
    const Ke = ie.length > 0 ? ie[ie.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, F) => {
      const x = F + 1, j = !!Number(Y[k]), ce = x <= Me;
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-portrait-img", (d) => {
      ...
      var o, r, f;
      d.preventDefault();
      const s = (r = (o = d.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : r.itemId;
    ...
    const n = (d) => {
      var o, r;
      const s = (o = d == null ? void 0 : d.dataset) == null ? void 0 : o.itemId;
      if (!s || !this.actor) return;
      const c = this.actor.items.get(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (d) => {
      ...
      var r, f, h, v;
      d.preventDefault();
      const s = (f = (r = d.currentTarget) == null ? void 0 : r.closest) == null ? void 0 : f.call(r, ".karakter-weapon-slot"), c = (((h = s == null ? void 0 : s.dataset) == null ? void 0 : h.itemId) ?? "").trim();
      ...
      const s = d.currentTarget, c = (((r = s == null ? void 0 : s.dataset) == null ? void 0 : r.slot) ?? "").trim();
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-E8WTFofS.mjs");
      o(this.actor, c);
    ...
    }), t.on("click", ".karakter-harc-initiative", async (d) => {
      if (d.preventDefault(), d.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-E8WTFofS.mjs");
      s(this.actor, "quickThinking", "Kezdeményezés");
    }), t.on("click", ".karakter-kp-dot", async (d) => {
      var r, f;
      d.preventDefault(), d.stopPropagation();
      const s = d.currentTarget, c = parseInt(s.dataset.index, 10);
      ...
      var f, h;
      d.preventDefault();
      const s = d.currentTarget, c = (((f = s == null ? void 0 : s.dataset) == null ? void 0 : f.skill) ?? "").trim(), o = ((h = s == null ? void 0 : s.textContent) == null ? void 0 : h.trim()) || c;
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-E8WTFofS.mjs");
      r(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (d) => {
      var c, o;
      d.preventDefault();
      const s = (o = (c = d.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : o.itemId;
      s && await this._postAbilityToChat(s);
    }), t.on("click", ".karakter-item-chat", async (d) => {
      var o, r;
      d.preventDefault();
      const s = (((r = (o = d.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : r.itemId) ?? "").trim();
      if (!s || !this.actor) return;
      const c = this.actor.items.get(s);
      ...
      const s = (v = (h = d.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : v.area, c = (S = (I = d.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : S.itemId;
      if (!s || !c || !this.actor) return;
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, f = (Array.isArray((N = o[s]) == null ? void 0 : N.items) ? o[s].items.slice() : []).filter((A) => A !== c);
      ...
      var c, o;
      if (d.preventDefault(), !d.altKey) return;
      const s = (o = (c = d.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : o.slot;
      ...
      var h, v;
      if (d.preventDefault(), !d.altKey) return;
      const s = d.currentTarget, c = (((h = s == null ? void 0 : s.dataset) == null ? void 0 : h.itemId) ?? "").trim();
      if (!c || !this.actor) return;
      ...
      var c, o;
      if (d.preventDefault(), !d.altKey) return;
      const s = (((o = (c = d.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : o.itemId) ?? "").trim();
      ...
      var f, h, v, I;
      if (d.preventDefault(), !d.altKey) return;
      const s = (((h = (f = d.currentTarget) == null ? void 0 : f.dataset) == null ? void 0 : h.itemId) ?? "").trim();
      if (!s || !this.actor) return;
      const c = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, r = ["slot1", "slot2", "slot3"].find((S) => {
        var q;
        return (((q = c[S]) == null ? void 0 : q.itemId) ?? "").trim() === s;
      });
    ...
    (b = (g = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : g.call(e, u)) == null || b.forEach((d) => {
      var s;
      (((s = d.dataset) == null ? void 0 : s.itemId) ?? "").trim() && (d.draggable = !0);
    }), t.on("dragstart", u, (d) => {
      var f, h, v;
      const s = d.currentTarget, c = (h = (f = s == null ? void 0 : s.dataset) == null ? void 0 : f.itemId) == null ? void 0 : h.trim();
      if (!c || !this.actor) return;
      const o = this.actor.items.get(c);
      if (!o) return;
      const r = o.uuid;
      d.dataTransfer && (d.dataTransfer.setData("text/plain", r), d.dataTransfer.setData("application/json", JSON.stringify({ type: "Item", uuid: r })), d.dataTransfer.effectAllowed = "copyMove"), typeof ((v = d.dataTransfer) == null ? void 0 : v.setDragImage) == "function" && s && d.dataTransfer.setDragImage(s, 0, 0);
    });
    const a = this, l = (d) => {
      if (!d) return;
      const s = a._getFormDataForUpdate(d);
      Object.keys(s).length !== 0 && a.actor.update(s).catch((c) => console.warn("VoidNpcSheet save failed", c));
    }, m = (d) => {
      var s, c, o;
      return d && (((c = (s = a.element) == null ? void 0 : s.contains) == null ? void 0 : c.call(s, d)) || a.id && ((o = d.closest) == null ? void 0 : o.call(d, `#${CSS.escape(a.id)}`)));
    };
    a._votvNpcBlur = (d) => {
      var f;
      const s = d.target;
    ...
    }, document.body.addEventListener("blur", a._votvNpcBlur, !0), a._votvNpcItemHookRegistered || (a._votvNpcItemUpdateHook = (d, s, c) => {
      var o;
      a.actor && ((o = d == null ? void 0 : d.parent) == null ? void 0 : o.id) === a.actor.id && a.render(!0);
    }, a._votvNpcItemDeleteHook = (d, s, c) => {
      var o;
      a.actor && ((o = d == null ? void 0 : d.parent) == null ? void 0 : o.id) === a.actor.id && a.render(!0);
  ...
  async _preClose(i) {
    ...
    return (u = super._preClose) == null ? void 0 : u.call(this, i);
  }
  _tearDown(i) {
    var e;
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, u = ((q = e.system) == null ? void 0 : q.skills) ?? {}, a = ((N = e.items) == null ? void 0 : N.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = a.find((E) => E.id === n.itemId) ?? null);
    const m = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, g = ((A = l == null ? void 0 : l.system) == null ? void 0 : A.type) || "kinetic", b = (((O = l == null ? void 0 : l.system) == null ? void 0 : O.skillKey) ?? "").trim(), d = b && u[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", s = Number(u[d] || 0) || 0, c = p + s, r = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(r);
  ...
  async _onDropItem(i, e) {
    var g, b, d, s, c, o, r, f, h, v, I, S, q, N, A, O, E;
    if (!this.actor) return (g = super._onDropItem) == null ? void 0 : g.call(this, i, e);
    const n = ((P) => {
      var G;
      if (!P) return null;
      const z = P.uuid ?? P.documentUuid ?? ((G = P.data) == null ? void 0 : G.uuid) ?? (typeof P == "string" ? P : null);
      if (z) return z;
      if (typeof P == "object") {
    ...
    if (!u || u.documentName !== "Item") return (d = super._onDropItem) == null ? void 0 : d.call(this, i, e);
    if (u.type === "Pancel") {
    ...
    if (u.type === "Kepesseg" || u.type === "ability") {
      let P = u.id;
      if (((o = u.parent) == null ? void 0 : o.id) !== a.id) {
        const Z = foundry.utils.mergeObject(u.toObject(), { type: "Kepesseg" });
        P = ((r = (await a.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : r.id) ?? P;
      }
      const z = (((f = u.system) == null ? void 0 : f.kind) ?? "passive").toString(), G = ((h = a.system) == null ? void 0 : h.abilities) ?? {}, H = z === "active" ? "active" : "passive", V = Array.isArray((v = G[H]) == null ? void 0 : v.items) ? G[H].items.slice() : Array.isArray(G[H]) ? G[H].slice() : [];
      V.includes(P) || V.push(P), await a.update({ [`system.abilities.${H}.items`]: V }), typeof this.render == "function" && this.render(!0);
      return;
    }
    if (((I = u.parent) == null ? void 0 : I.id) === a.id) return;
    const l = u.toObject();
    ...
    if (u.type === "Fegyver" && p) {
      const P = ((q = a.system) == null ? void 0 : q.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (P.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((Y) => z.includes(Y)) : [];
      let V = z.find((Y) => {
        var R;
        return !(((R = P[Y]) == null ? void 0 : R.itemId) ?? "").trim();
      });
      ...
      await a.update({
        ...
        [`system.weapons.${V}.name`]: u.name ?? "",
        [`system.weapons.${V}.damage`]: ((N = u.system) == null ? void 0 : N.damage) ?? "",
        [`system.weapons.${V}.bonus`]: ((A = u.system) == null ? void 0 : A.bonus) ?? ""
      });
    }
    if (u.type === "MikroChip" && p) {
      const P = ((E = (O = a.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var V;
        return !(((V = P[H]) == null ? void 0 : V.itemId) ?? "").trim();
      });
      G && await a.update({
        [`system.gear.microchips.${G}.itemId`]: p,
        [`system.gear.microchips.${G}.name`]: u.name ?? ""
      });
    }
    typeof this.render == "function" && this.render(!0);
  }
  async _postAbilityToChat(i) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((d = e.system) == null ? void 0 : d.kind) ?? "passive", n = Number(((s = e.system) == null ? void 0 : s.kp) ?? 0) || 0, u = (((c = e.system) == null ? void 0 : c.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = u ? `<p>${u}</p>` : "", p = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${a}</p>
      ${l}
      ${m}
...
const ue = class ue extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (a) => {
      var p, g, b, d, s, c, o;
      if (!e.isEditable || !((g = (p = a.target) == null ? void 0 : p.closest) != null && g.call(p, ".profile")) && ((d = (b = a.target) == null ? void 0 : b.getAttribute) == null ? void 0 : d.call(b, "data-edit")) !== "img") return;
...
const pe = class pe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (a) => {
      ...
      u(m) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => n(m), 300));
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      var r, f;
      const s = (r = game.actors) == null ? void 0 : r.get(d);
      if (!s || s.type !== "Karakter") return;
      const c = st.getTotalSpeedRaw(s), o = (f = s.effects) == null ? void 0 : f.find((h) => h.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      c <= 0 && !o ? s.createEmbeddedDocuments("ActiveEffect", [{
        name: "Mozgásképtelen",
        statuses: ["immobilized"],
        flags: {
          core: { overlay: !0 },
          "vacuum-of-the-void": { immobilizedFromSpeed: !0 }
        },
        origin: s.uuid
      }]).catch((h) => console.warn("Vacuum of the Void | Immobilized effect create failed:", h)) : c > 0 && o && o.delete().catch((h) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", h));
    }, 0);
  });
  const i = 500;
  Hooks.on("updateActor", (m, p, g, b) => {
    var S, q, N, A, O, E, P, z, G, H, V, Z, Y;
    const d = m == null ? void 0 : m.id;
    if (!d) return;
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((N = (q = m.system) == null ? void 0 : q.combat) == null ? void 0 : N.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
        const ge = ((A = oe.combatants) == null ? void 0 : A.contents) ?? Array.from(oe.combatants ?? []);
        for (const re of ge)
          if (((O = re.actor) == null ? void 0 : O.id) === d || re.actorId === d) {
    ...
    if (m.type === "Npc" && ((E = p == null ? void 0 : p.system) != null && E.identity) && "size" in p.system.identity) {
      const R = yi((z = (P = m.system) == null ? void 0 : P.identity) == null ? void 0 : z.size);
      m.update({
    ...
    const s = document.activeElement, c = s && (s.tagName === "INPUT" && s.type !== "checkbox" && s.type !== "radio" || s.tagName === "TEXTAREA" || s.isContentEditable), o = [], r = (G = game.actors) == null ? void 0 : G.get(d);
    r != null && r.apps && o.push(...Array.from(r.apps));
    const f = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const R of f)
      ((H = R.document) == null ? void 0 : H.id) !== d || ((V = R.document) == null ? void 0 : V.documentName) !== "Actor" || ((Z = R.constructor) == null ? void 0 : Z.name) !== "VoidKarakterSheet" || o.includes(R) || o.push(R);
    if (c && o.some((R) => {
    ...
    var o, r, f;
    const d = m == null ? void 0 : m.parent;
    if (!d || d.documentName !== "Actor" || d.type !== "Karakter" || m.type !== "Fegyver") return;
    const s = ((o = d.system) == null ? void 0 : o.weapons) ?? {}, c = {};
    ...
    Object.keys(c).length && d.update(c);
  });
});
Hooks.on("ready", () => {
  var w, i;
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, q, N, A, O, E, P, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
    ...
    if (!n) return;
    const u = (v = game.messages) == null ? void 0 : v.get(n), a = (S = (I = u == null ? void 0 : u.flags) == null ? void 0 : I["vacuum-of-the-void"]) == null ? void 0 : S.weapon;
    if (!a) return;
    const l = a.actorId ?? ((q = u == null ? void 0 : u.speaker) == null ? void 0 : q.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let m = ((N = game.actors) == null ? void 0 : N.get(a.actorId)) ?? ((A = game.actors) == null ? void 0 : A.get(l));
    if (m || (m = ((E = (O = game.scenes) == null ? void 0 : O.contents) == null ? void 0 : E.flatMap((se) => {
      var ne;
      return ((ne = se.tokens) == null ? void 0 : ne.contents) ?? [];
    }).map((se) => se.actor).find((se) => se && (se.id === l || se.id === a.actorId))) ?? null), !m) return;
    const p = a.itemId ? ((z = (P = m.items) == null ? void 0 : P.get) == null ? void 0 : z.call(P, a.itemId)) ?? ((V = (H = (G = m.items) == null ? void 0 : G.contents) == null ? void 0 : H.find) == null ? void 0 : V.call(H, (ie) => ie.id === a.itemId)) : null;
    ...
    const d = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, s = a.targetName || "", c = a.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (a.slotKey ? ((Re = (((re = m.system) == null ? void 0 : re.weapons) ?? {})[a.slotKey]) == null ? void 0 : Re.name) ?? "" : "")) || "Fegyver";
    ...
    for (const u of e) {
      const a = st.getTotalSpeedRaw(u), l = (n = u.effects) == null ? void 0 : n.find((m) => m.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      a <= 0 && !l ? await u.createEmbeddedDocuments("ActiveEffect", [{
        name: "Mozgásképtelen (sebesség)",
        statuses: ["immobilized"],
        flags: { "vacuum-of-the-void": { immobilizedFromSpeed: !0 } },
        origin: u.uuid
      }]).catch(() => {
      }) : a > 0 && l && await l.delete().catch(() => {
      });
    }
    ...
    }, t = ((a = game.actors) == null ? void 0 : a.filter((d) => d.type === "Karakter")) ?? [];
    for (const d of t)
      try {
        const s = d.prototypeToken, c = ((l = s == null ? void 0 : s.bar1) == null ? void 0 : l.attribute) ?? "", o = ((m = s == null ? void 0 : s.bar2) == null ? void 0 : m.attribute) ?? "";
        (c || o) && await d.update({
        ...
        console.warn("Vacuum of the Void | Prototype token update failed for", d.name, s);
      }
    for (const d of game.scenes ?? []) {
      const s = ((p = d.tokens) == null ? void 0 : p.filter((c) => {
        var o;
    ...
    }, u = ((g = game.actors) == null ? void 0 : g.filter((d) => d.type === "Npc")) ?? [];
    for (const d of u)
      try {
        await d.update({
          "prototypeToken.bar1.attribute": "",
        ...
        console.warn("Vacuum of the Void | NPC prototype update failed for", d.name, s);
      }
    for (const d of game.scenes ?? []) {
      const s = ((b = d.tokens) == null ? void 0 : b.filter((c) => {
        var o;
...
Hooks.on("preCreateToken", (w, i, e) => {
  ...
  if (u) {
    ...
    if (u.type === "Npc") {
      const g = yi((p = (m = u.system) == null ? void 0 : m.identity) == null ? void 0 : p.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
function gi(w) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" && n.type !== "Npc" || n.update(xi).catch((u) => {
...
function hi() {
  ...
  for (const n of ((i = game.actors) == null ? void 0 : i.filter((u) => u.type === "Karakter" || u.type === "Npc")) ?? []) {
    const u = n.apps ?? [], a = u.contents ? Array.from(u.contents) : Array.from(u);
    for (const l of a)
  ...
  for (const n of Object.values((ui == null ? void 0 : ui.windows) ?? {})) {
    ...
    const u = (t = n == null ? void 0 : n.document) == null ? void 0 : t.type;
    u !== "Karakter" && u !== "Npc" || w.has(n.id) || (w.add(n.id), typeof n.render == "function" && n.render(!0));
  }
}
...
Hooks.on("renderChatMessageHTML", (w, i, e) => {
  var p, g, b, d;
  const t = ((p = w.flags) == null ? void 0 : p["vacuum-of-the-void"]) ?? {}, n = t.resultType, u = t.critLabel, a = t.weaponAttack, l = t.weapon;
  if (!n && !u && !a) return;
  const m = (g = i == null ? void 0 : i.querySelector) == null ? void 0 : g.call(i, ".dice-roll");
  if (m) {
    if (n && m.classList.add(`votv-${n}`), u) {
      ...
      if (s)
        ...
        r.className = `votv-crit-label votv-crit-label-${n || "neutral"}`, r.textContent = u, o.appendChild(r);
      }
    }
    if (a && l && (l.actorId || (b = w.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !m.querySelector(".votv-weapon-damage-chat")) {
        ...
        f.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", f.dataset.actorId = String(l.actorId ?? ((d = w.speaker) == null ? void 0 : d.actor) ?? ""), f.dataset.itemId = String(l.itemId ?? ""), f.dataset.slotKey = String(l.slotKey ?? ""), f.dataset.targetName = String(l.targetName ?? ""), f.dataset.hitLocationName = String(l.hitLocationName ?? ""), f.dataset.messageId = String(w.id ?? ""), c.appendChild(f);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-CFRuYBT5.mjs.map
