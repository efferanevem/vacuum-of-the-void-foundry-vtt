...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), A = N ? N.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], O = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, F = (((Ne = E.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), z = (((mt = E.slot2) == null ? void 0 : mt.itemId) ?? "").trim(), G = (((pt = E.slot3) == null ? void 0 : pt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      ...
      for (let xe = 0; xe < A.length; xe++) {
        ...
        if ((((ve = S[tt]) == null ? void 0 : ve.itemId) ?? "") === y.id) {
          L = xe + 1, M = ((Fe = S[tt]) == null ? void 0 : Fe.bonus) ?? "", ee = tt;
          break;
        }
      }
      let X = null;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-Cny4VezS.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-Cny4VezS.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-Cny4VezS.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((N = (q = this.actor.items).get) == null ? void 0 : N.call(q, h)) ?? ((O = (A = this.actor.items.contents) == null ? void 0 : A.find) == null ? void 0 : O.call(A, (F) => F.id === h));
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            ...
            if (A.length > 0) {
              const E = {
                "system.weapons.slotOrder": N.filter((F) => !A.includes(F)).join(",")
              };
              for (const F of A)
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-Cny4VezS.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-Cny4VezS.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-Cny4VezS.mjs");
      r(this.actor, c, o);
  ...
  async _onDropItem(i, e) {
    ...
    if (d.type === "Fegyver" && p) {
      const F = ((q = a.system) == null ? void 0 : q.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (F.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((Y) => z.includes(Y)) : [];
      let V = z.find((Y) => {
        var R;
    ...
    if (d.type === "MikroChip" && p) {
      const F = ((E = (O = a.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var V;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, q, N, A, O, E, F, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
...
//# sourceMappingURL=vacuum-of-the-void-lEK9a1Z0.mjs.map
