...
const { HTMLField: Ws, NumberField: F, SchemaField: U, StringField: O, BooleanField: ue, ArrayField: kt } = foundry.data.fields;
      ...
      resources: new U({
        ...
        hitLocations: new U({
          head: new U({
            ...
            box1: new ue({ required: !1, initial: !1 }),
            box2: new ue({ required: !1, initial: !1 }),
            box3: new ue({ required: !1, initial: !1 })
          }),
          torso: new U({
            value: new F({ required: !1, integer: !0, min: 0, initial: 0 }),
            box1: new ue({ required: !1, initial: !1 }),
      ...
      gear: new U({
        microchips: new U({
          slot1: new U({
            itemId: new O({ required: !1, blank: !0, initial: "" }),
            name: new O({ required: !1, blank: !0, initial: "" }),
            active: new ue({ required: !1, initial: !1 })
          }),
          slot2: new U({
            itemId: new O({ required: !1, blank: !0, initial: "" }),
            name: new O({ required: !1, blank: !0, initial: "" }),
...
const { NumberField: xt, StringField: st, SchemaField: bs, ArrayField: oi } = foundry.data.fields;
class ci extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      abilities: new bs({
        items: new oi(
          new st({ required: !1, blank: !0 }),
          { required: !1, initial: [] }
        )
      }),
      /** Sebesség (szabad szöveg, opcionális). */
      speed: new st({ required: !1, blank: !0, initial: "" }),
      /** Hatótáv (szabad szöveg, opcionális). */
      range: new st({ required: !1, blank: !0, initial: "" }),
      /** Raktár (szabad szöveg, opcionális). */
      storage: new st({ required: !1, blank: !0, initial: "" }),
      /** Sebzés (szabad szöveg, opcionális). */
      damage: new st({ required: !1, blank: !0, initial: "" }),
      /** Találati érték (szabad szöveg, opcionális). */
      hit: new st({ required: !1, blank: !0, initial: "" })
    };
  }
}
function Rt(I) {
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var rt, ot, ct, lt, ut, dt, mt, pt, ft, Be, yt, gt, Ge, k, R, M, B, pe, te, Se, ke, fe, Le, Ve, We, Ct, qt, Lt, Nt, ht, et, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs;
    ...
    const c = Number(((pt = (mt = this.actor.system) == null ? void 0 : mt.combat) == null ? void 0 : pt.givenProtection) ?? 0) || 0, a = (yt = (Be = (ft = this.actor) == null ? void 0 : ft.statuses) == null ? void 0 : Be.has) != null && yt.call(Be, "lookaround") ? 1 : 0, g = (k = (Ge = (gt = this.actor) == null ? void 0 : gt.statuses) == null ? void 0 : Ge.has) != null && k.call(Ge, "halfcover") ? 3 : 0, h = (B = (M = (R = this.actor) == null ? void 0 : R.statuses) == null ? void 0 : M.has) != null && B.call(M, "threequarteredcover") ? 6 : 0, v = c + this._getTotalArmorProtectionBonus() + a + g + h;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: v } },
      { inplace: !1 }
    );
    const w = ((pe = e.system) == null ? void 0 : pe.combat) ?? {};
    ...
    y === 0 && (D = 0), (ke = (Se = (te = this.actor) == null ? void 0 : te.statuses) == null ? void 0 : Se.has) != null && ke.call(Se, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Le = (fe = e.system) == null ? void 0 : fe.combat) == null ? void 0 : Le.givenProtection } },
      { inplace: !1 }
    ), D = 0), e.totalSpeed = D;
    ...
    const _ = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), E = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], G = (Ve = this.actor.system.gear) == null ? void 0 : Ve.microchips, V = G && typeof G == "object" && !Array.isArray(G) ? G : {}, W = (((We = V.slot1) == null ? void 0 : We.itemId) ?? "").trim(), J = (((Ct = V.slot2) == null ? void 0 : Ct.itemId) ?? "").trim(), T = (((qt = V.slot3) == null ? void 0 : qt.itemId) ?? "").trim(), A = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      const L = typeof b.sort == "number" ? b.sort : 0, P = typeof N.sort == "number" ? N.sort : 0;
      return L - P;
    }).map((b) => {
      var Ne, Ye, Xe, $e, xe, bt;
      const N = b.type === "Fegyver", L = b.type === "MikroChip";
      let P = 0, K = "", oe = null;
      for (let tt = 0; tt < E.length; tt++) {
        const vt = E[tt];
        if ((((Ne = _[vt]) == null ? void 0 : Ne.itemId) ?? "") === b.id) {
          P = tt + 1, K = ((Ye = _[vt]) == null ? void 0 : Ye.bonus) ?? "", oe = vt;
          break;
        }
      }
      let se = null;
      L && (W === b.id ? se = "slot1" : J === b.id ? se = "slot2" : T === b.id && (se = "slot3"));
      const Je = N && ((Xe = b.system) != null && Xe.damage) ? b.system.damage : "", ye = N && typeof (($e = b.system) == null ? void 0 : $e.range) == "string" ? (b.system.range || "").trim() : "", we = oe ? Number((xe = _[oe]) == null ? void 0 : xe.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.actionsTable = A;
    const H = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).filter((b) => b.type === "Fegyver"), X = H.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = X;
    ...
    e.weaponSlots = ce.map((b, N) => {
      const L = _[b] ?? {}, P = (L.itemId ?? "").trim(), K = X.find((we) => we.id === P), oe = H.find((we) => we.id === P), se = (oe == null ? void 0 : oe.system) ?? {}, Je = se.size === "thrown", ye = (typeof se.range == "string" ? (se.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: P,
        slotNum: N + 1,
    ...
    const ae = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Z = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((b) => {
      ...
      const K = !!L, oe = ((us = b.system) == null ? void 0 : us.equipped) !== void 0 && ((ds = b.system) == null ? void 0 : ds.equipped) !== null ? !!b.system.equipped : K, se = (b == null ? void 0 : b.system) ?? {}, Je = typeof se.range == "string" ? (se.range || "").trim() : "", ye = se.type ?? "", we = (ae[ye] ?? ye) || "—", Ne = se.size ?? "", Ye = (Z[Ne] ?? Ne) || "", Xe = [we, Ye].filter(Boolean).join(", ") || we || "—", $e = ye === "projectile" || Ne === "thrown", xe = se.quantity, bt = xe != null ? String(xe).trim() : "1", tt = String(P.bonus ?? "").trim(), vt = String(se.bonus ?? "").trim(), Us = tt || vt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const Ie = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((b) => b.type === "Targy");
    ...
    const Fe = (((et = this.actor.items) == null ? void 0 : et.contents) ?? []).filter((b) => b.type === "Egyeb");
    ...
    const Me = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), le = Me.map((b) => ({ id: b.id, name: b.name, img: b.img })), Qe = "— Nincs Mikro-Chip —", he = ["slot1", "slot2", "slot3"], ee = (b) => {
      var L, P, K;
      const N = [];
    ...
    e.microchipItemsSlot1 = le.filter((b) => !ee(1).includes(b.id)), e.microchipItemsSlot2 = le.filter((b) => !ee(2).includes(b.id)), e.microchipItemsSlot3 = le.filter((b) => !ee(3).includes(b.id)), e.microchipSlots = he.map((b) => {
      const N = V[b] ?? {}, L = (N.itemId ?? "").trim(), P = Me.find((K) => K.id === L);
      return {
        slotKey: b,
        itemId: L,
      ...
      const N = `slot${b}`, L = V[N] ?? {}, P = (L.itemId ?? "").trim(), K = le.find((oe) => oe.id === P);
      e[`microchip${b}ItemId`] = P, e[`microchip${b}DisplayName`] = (K == null ? void 0 : K.name) || L.name || Qe, e[`microchip${b}Img`] = (K == null ? void 0 : K.img) || "";
    }), e.microchipsTable = Me.map((b) => {
      var Ne, Ye, Xe, $e;
      const N = b.id;
      let L = null;
      for (const xe of he)
        if ((((Ne = V[xe]) == null ? void 0 : Ne.itemId) ?? "").trim() === N) {
          L = xe;
          break;
        }
      const P = !!L, K = ((Ye = b == null ? void 0 : b.system) == null ? void 0 : Ye.abilityType) ?? "", oe = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", se = K === "active", Je = Number((Xe = b == null ? void 0 : b.system) == null ? void 0 : Xe.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, ye = ((($e = b == null ? void 0 : b.system) == null ? void 0 : $e.description) ?? "").trim(), we = ye ? ye.length > 60 ? ye.slice(0, 57) + "…" : ye : "—";
      return {
        itemId: N,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const be = (((Yt = e.weaponsTable) == null ? void 0 : Yt.length) ?? 0) > 0 || (((Xt = e.armorTable) == null ? void 0 : Xt.length) ?? 0) > 0 || (((Qt = e.microchipsTable) == null ? void 0 : Qt.length) ?? 0) > 0 || (((Zt = e.itemsTable) == null ? void 0 : Zt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !be;
    const re = this.actor.system.abilities ?? {}, It = (((es = this.actor.items) == null ? void 0 : es.contents) ?? []).map((b) => {
      var N, L, P;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Ae = new Map(It.map((b) => [b.id, b])), je = "— Nincs képesség —", Ee = (b) => {
      const N = re[b] ?? {}, L = (N.itemId ?? "").trim(), P = L ? Ae.get(L) : null, K = (P == null ? void 0 : P.description) ?? "", oe = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: L,
        displayName: (P == null ? void 0 : P.name) || N.name || je,
        img: (P == null ? void 0 : P.img) || "",
        description: K,
        kp: oe
      };
    };
    e.abilityFajiSlot = Ee("faji"), e.abilityHatterSlot = Ee("hatter");
    const it = (b) => {
      const N = re[b];
    ...
    const St = ((ts = e.system) == null ? void 0 : ts.resources) ?? {}, Ze = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ke = (is = (ss = e.system) == null ? void 0 : ss.combat) == null ? void 0 : is.initiativeResult, ve = typeof Ke == "number" ? Ke : -1, Tt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ze = (as = (ns = e.system) == null ? void 0 : ns.combat) == null ? void 0 : as.initiativeRanges, Ue = Array.isArray(ze) ? ze.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Pe = (Ue.length > 0 ? Ue : Tt).slice().sort((b, N) => b.min - N.min), He = Ue.map((b) => b.min), Dt = He.length ? Math.min(...He) : 0, _t = He.length ? Math.max(...He) : 0;
    e.initiativeRanges = Ue.map((b) => ({ ...b, isFirst: b.min === Dt, isLast: b.min === _t }));
    let at = 0;
    if (typeof ve == "number" && ve >= 0 && Pe.length > 0) {
      const b = Pe[0], N = Pe[Pe.length - 1];
      let L = null;
      ve <= b.max ? L = b : ve >= N.min ? L = N : L = Pe.find((P) => ve >= P.min && ve <= P.max), L && (at = L.kp);
    }
    e.kpDots = Ze.map((b, N) => {
    ...
    return e.showHarcSection = Ot, e.canEditInitiative = !!((cs = game.user) != null && cs.isGM), e.showInitiativeResult = typeof Ke == "number", e.initiativeResult = e.showInitiativeResult ? Ke : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DzQI9zHM.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-DzQI9zHM.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-DzQI9zHM.mjs");
      g(this.actor, c, a);
...
Q(Y, "PARTS", foundry.utils.mergeObject(
  z(Y, Y, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(Y, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
const de = class de extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ee, it, nt, St, Ze, Ke, ve, Tt, ze, Ue, At, Pe, He, Dt, _t, at, Ot, rt, ot, ct, lt, ut, dt, mt, pt, ft, Be, yt, gt, Ge;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Ee = this.actor) == null ? void 0 : Ee.system), e.showDeathSkull = !1, e.sizeForSelect = (((nt = (it = e.system) == null ? void 0 : it.identity) == null ? void 0 : nt.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((St = e.system) == null ? void 0 : St.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, l = (Ke = (Ze = t == null ? void 0 : t.statuses) == null ? void 0 : Ze.has) != null && Ke.call(Ze, "lookaround") ? 1 : 0, m = (Tt = (ve = t == null ? void 0 : t.statuses) == null ? void 0 : ve.has) != null && Tt.call(ve, "halfcover") ? 3 : 0, u = (Ue = (ze = t == null ? void 0 : t.statuses) == null ? void 0 : ze.has) != null && Ue.call(ze, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = p + l + m + u;
    const d = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], f = ((Pe = t == null ? void 0 : t.system) == null ? void 0 : Pe.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (f.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((k) => y.includes(k)) : [], o = d.filter((k) => k.type === "Fegyver"), c = o.map((k) => ({ id: k.id, name: k.name, img: k.img })), a = "— Nincs fegyver —", g = i.length > 0 ? i : y, h = y.filter((k) => !g.includes(k)), v = [...g, ...h], w = v.filter((k) => {
      var M;
      const R = (((M = f[k]) == null ? void 0 : M.itemId) ?? "").trim();
      return R && o.some((B) => B.id === R);
    });
    e.weaponSlots = w.map((k) => {
      const R = f[k] ?? {}, M = (R.itemId ?? "").trim(), B = c.find((fe) => fe.id === M), pe = o.find((fe) => fe.id === M), te = (pe == null ? void 0 : pe.system) ?? {}, Se = te.size === "thrown", ke = (typeof te.range == "string" ? (te.range || "").trim() : "") || "—";
      return {
        slotKey: k,
        itemId: M,
    ...
    e.weaponsTable = o.map((k) => {
      ...
      let M = null, B = {};
      for (const et of v)
        if ((((ht = f[et]) == null ? void 0 : ht.itemId) ?? "").trim() === R) {
          M = et, B = f[et] ?? {};
          break;
        }
      const pe = !!M, te = (k == null ? void 0 : k.system) ?? {}, Se = typeof te.range == "string" ? (te.range || "").trim() : "", ke = te.type ?? "", fe = (S[ke] ?? ke) || "—", Le = te.size ?? "", Ve = (D[Le] ?? Le) || "", We = [fe, Ve].filter(Boolean).join(", ") || fe || "—", Ct = ke === "projectile" || Le === "thrown", qt = te.quantity != null ? String(te.quantity).trim() : "1", Lt = String(te.bonus ?? B.bonus ?? "").trim() || "0", Nt = (te.damage ?? B.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: R,
        actorId: t.id,
    ...
    const _ = ((Dt = (He = t == null ? void 0 : t.system) == null ? void 0 : He.gear) == null ? void 0 : Dt.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], j = d.filter((k) => k.type === "MikroChip");
    e.microchipsTable = j.map((k) => {
      var ke, fe, Le, Ve;
      const R = k.id;
      let M = null;
      for (const We of q)
        if ((((ke = _[We]) == null ? void 0 : ke.itemId) ?? "").trim() === R) {
          M = We;
          break;
        }
      const B = ((fe = k == null ? void 0 : k.system) == null ? void 0 : fe.abilityType) ?? "", pe = B === "active" ? "Aktív" : B === "passive" ? "Passzív" : B || "—", te = (((Le = k == null ? void 0 : k.system) == null ? void 0 : Le.description) ?? "").trim(), Se = te ? te.length > 60 ? te.slice(0, 57) + "…" : te : "—";
      return {
        itemId: R,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const X = t == null ? void 0 : t.id, ie = !!((ut = (lt = game.combat) == null ? void 0 : lt.combatants) != null && ut.some(
      (k) => {
        var R;
        return (((R = k.actor) == null ? void 0 : R.id) ?? k.actorId) === X;
      }
    ));
    e.showHarcSection = ie;
    const ce = ((dt = e.system) == null ? void 0 : dt.resources) ?? {}, ae = (pt = (mt = e.system) == null ? void 0 : mt.combat) == null ? void 0 : pt.initiativeResult, Z = typeof ae == "number" ? ae : -1, ne = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ie = (Be = (ft = e.system) == null ? void 0 : ft.combat) == null ? void 0 : Be.initiativeRanges, Fe = Array.isArray(Ie) ? Ie.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], le = (Fe.length > 0 ? Fe : ne).slice().sort((k, R) => k.min - R.min), Qe = 3;
    let he = Fe.length > 0 ? Fe : [];
    he.length < Qe && (he = [...he, ...Array(Qe - he.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = he.map((k, R) => ({
      ...k,
      isFirst: R === 0,
      isLast: R === he.length - 1
    }));
    let ee = 0;
    if (typeof Z == "number" && Z >= 0 && le.length > 0) {
      const k = le[0], R = le[le.length - 1];
      let M = null;
      Z <= k.max ? M = k : Z >= R.min ? M = R : M = le.find((B) => Z >= B.min && Z <= B.max), M && (ee = M.kp);
    }
    const be = le.length > 0 ? le[le.length - 1] : null, re = Math.min(10, be ? be.kp : 6), Ae = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, re)).map((k, R) => {
      const M = R + 1, B = !!Number(ce[k]), pe = M <= ee;
      return { index: M, used: B, usable: pe };
    }), je = Math.ceil(Ae.length / 2);
    return e.kpDotsRow1 = Ae.slice(0, je), e.kpDotsRow2 = Ae.slice(je), e.canEditInitiative = !!((yt = game.user) != null && yt.isGM), e.showInitiativeResult = typeof ae == "number", e.initiativeResult = e.showInitiativeResult ? ae : "", e.speedUnitForSelect = ((Ge = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : Ge.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var d, f, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-DzQI9zHM.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DzQI9zHM.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DzQI9zHM.mjs");
      a(this.actor, o, c);
...
Q(de, "PARTS", foundry.utils.mergeObject(
  z(de, de, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(de, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
const me = class me extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((T) => {
      const x = (T == null ? void 0 : T.system) ?? {}, A = x.type ?? "", H = (n[A] ?? A) || "—", X = x.size ?? "", ie = (p[X] ?? X) || "", ce = [H, ie].filter(Boolean).join(", ") || H || "—", ae = A === "projectile" || X === "thrown", Z = x.quantity != null ? String(x.quantity).trim() : "1", ne = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: T.id,
        actorId: this.actor.id,
    ...
    e.microchipsTable = d.map((T) => {
      var ae, Z, ne;
      const x = ((ae = T == null ? void 0 : T.system) == null ? void 0 : ae.abilityType) ?? "", A = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—", H = x === "active", X = Number((Z = T == null ? void 0 : T.system) == null ? void 0 : Z.replaceCost) >= 0 ? Number(T.system.replaceCost) : 0, ie = (((ne = T == null ? void 0 : T.system) == null ? void 0 : ne.description) ?? "").trim(), ce = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: T.id,
        actorId: this.actor.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    e.itemsTable = f.map((T) => {
      const x = (T == null ? void 0 : T.system) ?? {}, A = (x.description ?? "").trim(), H = A ? A.length > 60 ? A.slice(0, 57) + "…" : A : "—", X = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: T.id,
        actorId: this.actor.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    let i = 0, o = 0;
    for (const T of y) {
      const x = (T == null ? void 0 : T.system) ?? {}, A = x.health ?? {}, H = Number(x.level ?? 0) || 0, X = Number(A.max ?? 0) || 0, ie = Number(A.value ?? 0) || 0, ce = (x.hit ?? "").toString().trim(), ae = (x.speed ?? "").toString().trim().replace(",", "."), Z = Number(ae);
      Number.isFinite(Z) && (i += Z);
      const ne = (x.range ?? "").toString().trim().replace(",", "."), Ie = Number(ne);
      Number.isFinite(Ie) && (o += Ie);
      const Fe = (x.damage ?? "").toString().trim(), Me = x.abilities ?? {}, le = Array.isArray(Me.items) ? Me.items : [], he = (await Promise.all(
        le.map(async (ee) => {
          var be;
          if (!ee) return null;
          try {
            const re = await fromUuid(ee);
            if (re && (re.type === "Kepesseg" || re.type === "ability")) return re;
          } catch {
            const re = (be = game.items) == null ? void 0 : be.get(ee);
            if (re && (re.type === "Kepesseg" || re.type === "ability")) return re;
          }
          return null;
        })
      )).map((ee, be) => ({ doc: ee, ref: le[be] })).filter((ee) => !!ee.doc && !!ee.ref).map(({ doc: ee, ref: be }) => {
        var je, Ee;
        const re = (((je = ee.system) == null ? void 0 : je.kind) ?? "passive").toString(), It = Number(((Ee = ee.system) == null ? void 0 : Ee.kp) ?? 0) || 0, Ae = re === "species";
        return {
          id: ee.id,
          ref: be,
          name: ee.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (u) => {
      ...
      var y;
      u.preventDefault(), u.stopPropagation();
      const d = u.currentTarget, f = (((y = d == null ? void 0 : d.dataset) == null ? void 0 : y.itemId) ?? "").trim();
      f && await this._rollUnitDamage(f);
  ...
  async _rollUnitDamage(s) {
    var m, u, d, f, y, r, i, o, c;
    const e = this.actor;
    if (!e) return;
    const t = ((u = (m = e.items).get) == null ? void 0 : u.call(m, s)) ?? ((f = (d = e.items.contents) == null ? void 0 : d.find) == null ? void 0 : f.call(d, (a) => a.id === s));
...
Q(me, "PARTS", foundry.utils.mergeObject(
  z(me, me, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/jarmu-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(me, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
Q(Te, "PARTS", foundry.utils.mergeObject(z(Te, Te, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Q(Te, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Te, Te, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ns = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = Te;
var Fs;
const De = class De extends foundry.applications.api.HandlebarsApplicationMixin(
...
Q(De, "PARTS", foundry.utils.mergeObject(z(De, De, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Fs = z(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !1 })
}));
let zt = De;
var As;
...
Q(_e, "PARTS", foundry.utils.mergeObject(z(_e, _e, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Q(_e, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(_e, _e, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((As = z(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !1 })
}));
let Ut = _e;
var Es;
...
Q(Oe, "PARTS", foundry.utils.mergeObject(z(Oe, Oe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), Q(Oe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Oe, Oe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Es = z(Oe, Oe, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !0 })
}));
let Ht = Oe;
var Ps;
...
Q(Ce, "PARTS", foundry.utils.mergeObject(z(Ce, Ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ps = z(Ce, Ce, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 })
}));
let Bt = Ce;
var $s;
...
Q(qe, "PARTS", foundry.utils.mergeObject(z(qe, qe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Q(qe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(qe, qe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject((($s = z(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : $s.form) ?? {}, { submitOnChange: !1 })
}));
let Gt = qe;
var xs, Rs;
...
Q(ge, "PARTS", foundry.utils.mergeObject(z(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/jarmuegyseg-sheet.hbs" }
})), Q(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((xs = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : xs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Rs = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.dragDrop) ?? [],
      {
        dragSelector: null,
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, d, f, y) => {
    ...
    if ((u.type === "Karakter" || u.type === "Npc") && ((S = d == null ? void 0 : d.system) != null && S.combat) && "initiativeResult" in d.system.combat) {
      const A = Number((C = (D = u.system) == null ? void 0 : D.combat) == null ? void 0 : C.initiativeResult), H = Number.isFinite(A) ? A : 0, X = game.combat;
      if (X) {
        const ie = ((_ = X.combatants) == null ? void 0 : _.contents) ?? Array.from(X.combatants ?? []);
        for (const ce of ie)
          if (((q = ce.actor) == null ? void 0 : q.id) === r || ce.actorId === r) {
            X.updateEmbeddedDocuments("Combatant", [{ _id: ce.id, initiative: H }]).catch(() => {
            });
            break;
          }
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, w, S, D, C, _, q, j, E, G, V, W, J, T, x, A, H, X, ie, ce, ae;
    ...
    if (u || (u = ((j = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : j.flatMap((ne) => {
      var Ie;
      return ((Ie = ne.tokens) == null ? void 0 : Ie.contents) ?? [];
    }).map((ne) => ne.actor).find((ne) => ne && (ne.id === m || ne.id === l.actorId))) ?? null), !u) return;
    const d = l.itemId ? ((G = (E = u.items) == null ? void 0 : E.get) == null ? void 0 : G.call(E, l.itemId)) ?? ((J = (W = (V = u.items) == null ? void 0 : V.contents) == null ? void 0 : W.find) == null ? void 0 : J.call(W, (Z) => Z.id === l.itemId)) : null;
    ...
    if (f || (f = (((T = d == null ? void 0 : d.system) == null ? void 0 : T.damage) ?? "").trim()), !f && l.slotKey && (f = (((((x = u.system) == null ? void 0 : x.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !f) {
      (ie = (A = ui.notifications) == null ? void 0 : A.warn) == null || ie.call(A, ((X = (H = game.i18n) == null ? void 0 : H.localize) == null ? void 0 : X.call(H, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const y = new Roll(f);
...
//# sourceMappingURL=vacuum-of-the-void-COS44ZUc.mjs.map
