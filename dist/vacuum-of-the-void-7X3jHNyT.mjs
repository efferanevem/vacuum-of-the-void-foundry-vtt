...
const { HTMLField: Si, NumberField: L, SchemaField: K, StringField: _, BooleanField: te, ArrayField: it } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const n = ((r = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : r.resources) ?? {}, d = ((h = (f = n.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, a = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, l = B._healthStatusFromRatio(a, d), m = Number(((C = (S = (I = this.actor) == null ? void 0 : I.system) == null ? void 0 : S.combat) == null ? void 0 : C.givenSpeed) ?? 0) || 0;
    let p;
  ...
  _writeTotalSpeed(i = null) {
    ...
    const e = i ?? this.form ?? this.element, t = (N) => {
      var q;
      return ((q = e == null ? void 0 : e.querySelector) == null ? void 0 : q.call(e, N)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${N}`) : null);
    ...
    const m = ((v = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : v.resources) ?? {}, p = ((S = (I = m.hitLocations) == null ? void 0 : I.legs) == null ? void 0 : S.value) ?? 0, g = ((C = m.currentHealth) == null ? void 0 : C.legs) ?? 0;
  ...
  async _prepareContext(i) {
    var We, Ye, Je, Qe, k, E, x, j, ce, Q, Ie, be, Se, ke, Le, Ne, mt, pt, ft, yt, Xe, $e, Lt, Nt, At, Ft, Pt, Et, $t, xt, Rt, Mt, Kt, jt, zt, Ht;
    ...
    for (const y of l) {
      const O = ((Qe = d[y]) == null ? void 0 : Qe.value) ?? 0, D = a[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((E = (k = this.actor.system) == null ? void 0 : k.combat) == null ? void 0 : E.givenSpeed) ?? 0) || 0;
    let s;
    ...
    for (const [y, O] of Object.entries(I)) {
      const D = e.computedHealthStatus[O];
      e.skillHealthStatus[y] = D, e.skillDisabled[y] = D === 0 ? " disabled" : "", e.skillHasHealthTint[y] = !0;
    }
    const S = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), q = N ? N.split(/\s*,\s*/).filter((y) => C.includes(y)) : [], T = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, F = T && typeof T == "object" && !Array.isArray(T) ? T : {}, P = (((Ne = F.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), z = (((mt = F.slot2) == null ? void 0 : mt.itemId) ?? "").trim(), G = (((pt = F.slot3) == null ? void 0 : pt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, O) => {
      const D = typeof y.sort == "number" ? y.sort : 0, A = typeof O.sort == "number" ? O.sort : 0;
      return D - A;
    }).map((y) => {
      ...
      let X = null;
      D && (P === y.id ? X = "slot1" : z === y.id ? X = "slot2" : G === y.id && (X = "slot3"));
      const Ze = O && ((Pe = y.system) != null && Pe.damage) ? y.system.damage : "", le = O && typeof ((Te = y.system) == null ? void 0 : Te.range) == "string" ? (y.system.range || "").trim() : "", Ae = ee ? Number((_e = S[ee]) == null ? void 0 : _e.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponItems = Y;
    const R = "— Nincs fegyver —", W = q.filter((y) => {
      const D = ((S[y] ?? {}).itemId ?? "").trim();
      return D ? !!Z.find((M) => M.id === D) : !1;
    });
    e.weaponSlots = W.map((y, O) => {
      const D = S[y] ?? {}, A = (D.itemId ?? "").trim(), M = Y.find((ee) => ee.id === A);
      return {
        slotKey: y,
        itemId: A,
        slotNum: O + 1,
    ...
    e.armorTable = re.map((y) => {
      var A, M;
      const O = (y == null ? void 0 : y.system) ?? {}, D = ((A = y.system) == null ? void 0 : A.equipped) !== void 0 && ((M = y.system) == null ? void 0 : M.equipped) !== null ? !!y.system.equipped : !1;
      return {
        itemId: y.id,
        actorId: this.actor.id,
        ...
        level: Pi((O.level ?? "").toString().trim()),
    ...
    e.itemsTable = Re.map((y) => {
      const O = (y == null ? void 0 : y.system) ?? {}, D = (O.description ?? "").trim(), A = D ? D.length > 60 ? D.slice(0, 57) + "…" : D : "—", M = O.quantity != null ? String(O.quantity).trim() : "1";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    e.egyebList = ie.map((y) => {
      const D = (((y == null ? void 0 : y.system) ?? {}).description ?? "").trim(), A = D ? D.length > 80 ? D.slice(0, 77) + "…" : D : "";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const se = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).filter((y) => y.type === "MikroChip"), ne = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Me = "— Nincs Mikro-Chip —", Ke = ["slot1", "slot2", "slot3"], je = (y) => {
      var D, A, M;
      const O = [];
      return y !== 1 && O.push((((D = F.slot1) == null ? void 0 : D.itemId) ?? "").trim()), y !== 2 && O.push((((A = F.slot2) == null ? void 0 : A.itemId) ?? "").trim()), y !== 3 && O.push((((M = F.slot3) == null ? void 0 : M.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      const O = F[y] ?? {}, D = (O.itemId ?? "").trim(), A = se.find((M) => M.id === D);
      return {
        slotKey: y,
        itemId: D,
        displayName: (A == null ? void 0 : A.name) || O.name || Me,
        img: (A == null ? void 0 : A.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const O = `slot${y}`, D = F[O] ?? {}, A = (D.itemId ?? "").trim(), M = ne.find((ee) => ee.id === A);
      e[`microchip${y}ItemId`] = A, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || D.name || Me, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = se.map((y) => {
      var ve, Fe, Pe, Te;
      const O = y.id;
      let D = null;
      for (const _e of Ke)
        if ((((ve = F[_e]) == null ? void 0 : ve.itemId) ?? "").trim() === O) {
          D = _e;
          break;
        }
      const A = !!D, M = ((Fe = y == null ? void 0 : y.system) == null ? void 0 : Fe.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", Ze = Number((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, le = (((Te = y == null ? void 0 : y.system) == null ? void 0 : Te.description) ?? "").trim(), Ae = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Ee = this.actor.system.abilities ?? {}, nt = (((Et = this.actor.items) == null ? void 0 : Et.contents) ?? []).map((y) => {
      ...
      const O = Ee[y] ?? {}, D = (O.itemId ?? "").trim(), A = D ? ze.get(D) : null, M = (A == null ? void 0 : A.description) ?? "", ee = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: D,
        displayName: (A == null ? void 0 : A.name) || O.name || at,
        img: (A == null ? void 0 : A.img) || "",
        description: M,
        kp: ee
      };
    ...
    const rt = (($t = e.system) == null ? void 0 : $t.resources) ?? {}, ot = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Oe = (Rt = (xt = e.system) == null ? void 0 : xt.combat) == null ? void 0 : Rt.initiativeResult, he = typeof Oe == "number" ? Oe : -1, ct = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ge = (Kt = (Mt = e.system) == null ? void 0 : Mt.combat) == null ? void 0 : Kt.initiativeRanges, Ce = Array.isArray(Ge) ? Ge.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : ct).slice().sort((y, O) => y.min - O.min), qe = Ce.map((y) => y.min), lt = qe.length ? Math.min(...qe) : 0, ut = qe.length ? Math.max(...qe) : 0;
    e.initiativeRanges = Ce.map((y) => ({ ...y, isFirst: y.min === lt, isLast: y.min === ut }));
    let Ve = 0;
    if (typeof he == "number" && he >= 0 && we.length > 0) {
      const y = we[0], O = we[we.length - 1];
      let D = null;
      he <= y.max ? D = y : he >= O.min ? D = O : D = we.find((A) => he >= A.min && he <= A.max), D && (Ve = D.kp);
    }
    e.kpDots = ot.map((y, O) => {
      const D = O + 1, A = !!Number(rt[y]), M = D <= Ve;
      return { index: D, used: A, usable: M };
    });
    const dt = !!((zt = (jt = game.combat) == null ? void 0 : jt.combatants) != null && zt.some((y) => {
      var O;
      return ((O = y.actor) == null ? void 0 : O.type) === "Karakter";
    }));
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DULXdFJM.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DULXdFJM.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DULXdFJM.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((N = (C = this.actor.items).get) == null ? void 0 : N.call(C, h)) ?? ((T = (q = this.actor.items.contents) == null ? void 0 : q.find) == null ? void 0 : T.call(q, (P) => P.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = I ? I.split(/\s*,\s*/).filter((q) => S.includes(q)) : [], N = C.find((q) => {
          var T;
          return (((T = v[q]) == null ? void 0 : T.itemId) ?? "").trim() === o;
        });
        if (N) {
          const q = C.filter((T) => T !== N);
          h["system.weapons.slotOrder"] = q.join(","), h[`system.weapons.${N}.itemId`] = "", h[`system.weapons.${N}.name`] = "", h[`system.weapons.${N}.damage`] = "", h[`system.weapons.${N}.bonus`] = "";
        }
      }
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((T) => v.includes(T)) : [], S = I.find((T) => {
        var F;
        return (((F = f[T]) == null ? void 0 : F.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (S) return;
        let T = I.find((P) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((N = r == null ? void 0 : r.system) == null ? void 0 : N.damage) ?? "",
          [`system.weapons.${T}.bonus`]: ((q = r == null ? void 0 : r.system) == null ? void 0 : q.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const T = I.filter((F) => F !== S);
        await this.actor.update({
      ...
      if (!f) return;
      const h = (c.dataset.itemId ?? "").trim(), v = (c.dataset.itemName ?? ((T = c.textContent) == null ? void 0 : T.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (c.dataset.itemImg ?? "").trim(), S = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      let C = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      I ? (C || (C = document.createElement("img"), C.className = "karakter-microchip-slot-thumb", C.alt = "", r == null || r.insertBefore(C, S)), C.src = I, C.style.display = "") : C && C.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const N = h ? this.actor.items.get(h) : null, q = {
      ...
      const r = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((S) => {
        var C;
        return (((C = r[S]) == null ? void 0 : C.itemId) ?? "").trim() === c;
      });
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((N = r.system) == null ? void 0 : N.damage) ?? "",
          [`system.weapons.${T}.bonus`]: ((q = r.system) == null ? void 0 : q.bonus) ?? ""
        }), await r.update({ "system.equipped": !0 });
      } else if (S) {
        const T = I.filter((F) => F !== S);
        await this.actor.update({
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          if (((n = r.parent) == null ? void 0 : n.id) !== this.actor.id) {
            const C = foundry.utils.mergeObject(r.toObject(), { type: "Kepesseg" });
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = S ? S.split(/\s*,\s*/).filter((T) => C.includes(T)) : [], q = N.filter((T) => {
              var F;
              return (((F = I[T]) == null ? void 0 : F.itemId) ?? "").trim() === v;
            });
            if (q.length > 0) {
              const F = {
                "system.weapons.slotOrder": N.filter((P) => !q.includes(P)).join(",")
              };
              for (const P of q)
  ...
  async _rollWeapon(i) {
    ...
    let a = null;
    t.itemId && (a = d.find((C) => C.id === t.itemId) ?? null);
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    const t = this.actor, n = ((Ue = t == null ? void 0 : t.items) == null ? void 0 : Ue.contents) ?? [], d = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, a = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), m = l ? l.split(/\s*,\s*/).filter((k) => a.includes(k)) : [], p = n.filter((k) => k.type === "Fegyver"), g = p.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = m.length > 0 ? m : a, s = a.filter((k) => !u.includes(k)), c = [...u, ...s], o = c.filter((k) => {
      var x;
      const E = (((x = d[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return E && p.some((j) => j.id === E);
    });
    e.weaponSlots = o.map((k) => {
      const E = d[k] ?? {}, x = (E.itemId ?? "").trim(), j = g.find((ce) => ce.id === x);
      return {
        slotKey: k,
        itemId: x,
        displayName: (j == null ? void 0 : j.name) || E.name || b,
    ...
    e.weaponsTable = p.map((k) => {
      ...
      let x = null, j = {};
      for (const $e of c)
        if ((((Xe = d[$e]) == null ? void 0 : Xe.itemId) ?? "").trim() === E) {
          x = $e, j = d[$e] ?? {};
          break;
        }
    ...
    e.armorTable = h.map((k) => {
      var j;
      const E = (k == null ? void 0 : k.system) ?? {}, x = ((j = k.system) == null ? void 0 : j.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
        ...
        level: Ei((E.level ?? "").toString().trim()),
    ...
    e.microchipsTable = S.map((k) => {
      ...
      let x = null;
      for (const Ne of I)
        if ((((be = v[Ne]) == null ? void 0 : be.itemId) ?? "").trim() === E) {
          x = Ne;
          break;
        }
    ...
    e.itemsTable = C.map((k) => {
      const E = (k == null ? void 0 : k.system) ?? {}, x = (E.description ?? "").trim(), j = x ? x.length > 60 ? x.slice(0, 57) + "…" : x : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const q = (((Oe = e.weaponsTable) == null ? void 0 : Oe.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ct = e.microchipsTable) == null ? void 0 : ct.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Ce = e.egyebList) == null ? void 0 : Ce.length) ?? 0) > 0;
    e.showEquipmentDropZone = !q;
    const T = ((ht = t == null ? void 0 : t.system) == null ? void 0 : ht.abilities) ?? {}, F = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var E, x;
      return {
        id: k.id,
        name: k.name,
    ...
    }), P = new Map(F.map((k) => [k.id, k])), z = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const V = t == null ? void 0 : t.id, Z = !!((qe = (we = game.combat) == null ? void 0 : we.combatants) != null && qe.some(
      (k) => {
        var E;
        return (((E = k.actor) == null ? void 0 : E.id) ?? k.actorId) === V;
      }
    ));
    e.showHarcSection = Z;
    const Y = ((lt = e.system) == null ? void 0 : lt.resources) ?? {}, R = (Ve = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : Ve.initiativeResult, W = typeof R == "number" ? R : -1, oe = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (We = (dt = e.system) == null ? void 0 : dt.combat) == null ? void 0 : We.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, E) => k.min - E.min), se = 3;
    let ne = re.length > 0 ? re : [];
    ne.length < se && (ne = [...ne, ...Array(se - ne.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ne.map((k, E) => ({
      ...k,
      isFirst: E === 0,
      isLast: E === ne.length - 1
    }));
    let Me = 0;
    if (typeof W == "number" && W >= 0 && ie.length > 0) {
      const k = ie[0], E = ie[ie.length - 1];
      let x = null;
      W <= k.max ? x = k : W >= E.min ? x = E : x = ie.find((j) => W >= j.min && W <= j.max), x && (Me = x.kp);
    }
    const Ke = ie.length > 0 ? ie[ie.length - 1] : null, je = Math.min(10, Ke ? Ke.kp : 6), Ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, je)).map((k, E) => {
      const x = E + 1, j = !!Number(Y[k]), ce = x <= Me;
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DULXdFJM.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-DULXdFJM.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-DULXdFJM.mjs");
      r(this.actor, c, o);
      ...
      const o = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, f = (Array.isArray((N = o[s]) == null ? void 0 : N.items) ? o[s].items.slice() : []).filter((q) => q !== c);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, d = ((C = e.system) == null ? void 0 : C.skills) ?? {}, a = ((N = e.items) == null ? void 0 : N.filter((F) => F.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = a.find((F) => F.id === n.itemId) ?? null);
    const m = l && l.name || n.name || "Fegyver", p = Number(n.bonus || 0) || 0, g = ((q = l == null ? void 0 : l.system) == null ? void 0 : q.type) || "kinetic", b = (((T = l == null ? void 0 : l.system) == null ? void 0 : T.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", s = Number(d[u] || 0) || 0, c = p + s, r = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(r);
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, S, C, N, q, T, F;
    ...
    if (d.type === "Fegyver" && p) {
      const P = ((C = a.system) == null ? void 0 : C.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (P.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((Y) => z.includes(Y)) : [];
      let V = z.find((Y) => {
        var R;
      ...
      await a.update({
        ...
        [`system.weapons.${V}.bonus`]: ((q = d.system) == null ? void 0 : q.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && p) {
      const P = ((F = (T = a.system) == null ? void 0 : T.gear) == null ? void 0 : F.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((H) => {
        var V;
    ...
    setTimeout(() => {
      ...
      if (c <= 0 && !o) {
        ...
        s.createEmbeddedDocuments("ActiveEffect", [{
          ...
          var C, N, q;
          const S = ((N = (C = canvas.scene) == null ? void 0 : C.tokens) == null ? void 0 : N.filter((T) => {
            var F;
            return ((F = T.actor) == null ? void 0 : F.id) === s.id;
          })) ?? [];
          for (const T of S)
            (q = T == null ? void 0 : T.object) != null && q.draw && T.object.draw();
        }).catch((S) => console.warn("Vacuum of the Void | Immobilized effect create failed:", S));
      } else c > 0 && o && o.delete().then(() => {
        var S, C, N;
        const I = ((C = (S = canvas.scene) == null ? void 0 : S.tokens) == null ? void 0 : C.filter((q) => {
          var T;
          return ((T = q.actor) == null ? void 0 : T.id) === s.id;
        })) ?? [];
        for (const q of I)
          (N = q == null ? void 0 : q.object) != null && N.draw && q.object.draw();
      }).catch((I) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", I));
    }, 0);
  });
  const i = 500;
  Hooks.on("updateActor", (m, p, g, b) => {
    var S, C, N, q, T, F, P, z, G, H, V, Z, Y;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((N = (C = m.system) == null ? void 0 : C.combat) == null ? void 0 : N.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
        const ge = ((q = oe.combatants) == null ? void 0 : q.contents) ?? Array.from(oe.combatants ?? []);
        for (const re of ge)
          if (((T = re.actor) == null ? void 0 : T.id) === u || re.actorId === u) {
    ...
    if (m.type === "Npc" && ((F = p == null ? void 0 : p.system) != null && F.identity) && "size" in p.system.identity) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, C, N, q, T, F, P, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
    ...
    if (!a) return;
    const l = a.actorId ?? ((C = d == null ? void 0 : d.speaker) == null ? void 0 : C.actor) ?? "";
    if (!l) return;
    e.preventDefault(), e.stopPropagation();
    let m = ((N = game.actors) == null ? void 0 : N.get(a.actorId)) ?? ((q = game.actors) == null ? void 0 : q.get(l));
    if (m || (m = ((F = (T = game.scenes) == null ? void 0 : T.contents) == null ? void 0 : F.flatMap((se) => {
      var ne;
...
//# sourceMappingURL=vacuum-of-the-void-7X3jHNyT.mjs.map
