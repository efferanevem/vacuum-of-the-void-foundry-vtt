...
var ee = (S, s, e) => ni(S, typeof s != "symbol" ? s + "" : s, e);
var j = (S, s, e) => ii(si(S), e, s);
const { HTMLField: ai, NumberField: F, SchemaField: H, StringField: q, BooleanField: me, ArrayField: _t } = foundry.data.fields;
...
const { SchemaField: ci, StringField: bs, NumberField: li } = foundry.data.fields;
class di extends Rt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: mi, StringField: vs, NumberField: pi } = foundry.data.fields;
class fi extends Rt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: yi, NumberField: Ai, StringField: Be } = foundry.data.fields;
...
const { BooleanField: gi, StringField: $t } = foundry.data.fields;
...
const { NumberField: zt, StringField: ws } = foundry.data.fields;
...
const { NumberField: vi, StringField: Is } = foundry.data.fields;
...
const { NumberField: Kt, StringField: lt, SchemaField: Ds, ArrayField: Si } = foundry.data.fields;
...
const { NumberField: Ut, StringField: ut, SchemaField: _s, ArrayField: Di } = foundry.data.fields;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var mt, pt, ft, yt, gt, ht, bt, vt, kt, We, wt, It, Je, I, E, P, G, ke, ae, Ce, De, we, $e, Ze, Ye, Ft, At, Et, Pt, St, ot, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms, ps, fs;
    ...
    const o = Number(((vt = (bt = this.actor.system) == null ? void 0 : bt.combat) == null ? void 0 : vt.givenProtection) ?? 0) || 0, m = (wt = (We = (kt = this.actor) == null ? void 0 : kt.statuses) == null ? void 0 : We.has) != null && wt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (It = this.actor) == null ? void 0 : It.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, g = (G = (P = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + m + h + g;
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (O.slotOrder ?? "").trim(), z = M ? M.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Ze = this.actor.system.gear) == null ? void 0 : Ze.microchips, R = U && typeof U == "object" && !Array.isArray(U) ? U : {}, J = (((Ye = R.slot1) == null ? void 0 : Ye.itemId) ?? "").trim(), X = (((Ft = R.slot2) == null ? void 0 : Ft.itemId) ?? "").trim(), Z = (((At = R.slot3) == null ? void 0 : At.itemId) ?? "").trim(), K = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      const L = typeof b.sort == "number" ? b.sort : 0, A = typeof N.sort == "number" ? N.sort : 0;
      return L - A;
    }).map((b) => {
      var xe, Qe, et, Ke, Ue, Tt;
      const N = b.type === "Fegyver", L = b.type === "MikroChip";
      let A = 0, B = "", ue = null;
      for (let ct = 0; ct < z.length; ct++) {
        const Dt = z[ct];
        if ((((xe = O[Dt]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          A = ct + 1, B = ((Qe = O[Dt]) == null ? void 0 : Qe.bonus) ?? "", ue = Dt;
          break;
        }
      }
      let re = null;
    ...
    e.actionsTable = K;
    const V = (((Et = this.actor.items) == null ? void 0 : Et.contents) ?? []).filter((b) => b.type === "Fegyver"), oe = V.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = oe;
    ...
    const te = (((St = this.actor.items) == null ? void 0 : St.contents) ?? []).filter((b) => b.type === "Targy");
    ...
    const de = (((ts = this.actor.items) == null ? void 0 : ts.contents) ?? []).filter((b) => b.type === "MikroChip"), se = de.map((b) => ({ id: b.id, name: b.name, img: b.img })), be = "— Nincs Mikro-Chip —", le = ["slot1", "slot2", "slot3"], pe = (b) => {
      var L, A, B;
      const N = [];
    ...
    const st = (((ss = e.weaponsTable) == null ? void 0 : ss.length) ?? 0) > 0 || (((is = e.armorTable) == null ? void 0 : is.length) ?? 0) > 0 || (((ns = e.microchipsTable) == null ? void 0 : ns.length) ?? 0) > 0 || (((as = e.itemsTable) == null ? void 0 : as.length) ?? 0) > 0;
    e.showEquipmentDropZone = !st;
    const He = this.actor.system.abilities ?? {}, Ct = (((rs = this.actor.items) == null ? void 0 : rs.contents) ?? []).map((b) => {
      var N, L, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Re = new Map(Ct.map((b) => [b.id, b])), Ge = "— Nincs képesség —", Me = (b) => {
    ...
    const nt = ((os = e.system) == null ? void 0 : os.resources) ?? {}, ie = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], fe = (ls = (cs = e.system) == null ? void 0 : cs.combat) == null ? void 0 : ls.initiativeResult, ne = typeof fe == "number" ? fe : -1, at = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (ds = (us = e.system) == null ? void 0 : us.combat) == null ? void 0 : ds.initiativeRanges, Oe = Array.isArray(Pe) ? Pe.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], ze = (Oe.length > 0 ? Oe : at).slice().sort((b, N) => b.min - N.min), Ve = Oe.map((b) => b.min), qt = Ve.length ? Math.min(...Ve) : 0, Lt = Ve.length ? Math.max(...Ve) : 0;
    e.initiativeRanges = Oe.map((b) => ({ ...b, isFirst: b.min === qt, isLast: b.min === Lt }));
    let dt = 0;
    if (typeof ne == "number" && ne >= 0 && ze.length > 0) {
      const b = ze[0], N = ze[ze.length - 1];
      let L = null;
      ne <= b.max ? L = b : ne >= N.min ? L = N : L = ze.find((A) => ne >= A.min && ne <= A.max), L && (dt = L.kp);
    }
    e.kpDots = ie.map((b, N) => {
      const L = N + 1, A = !!Number(nt[b]), B = L <= dt;
    ...
    return e.showHarcSection = Nt, e.canEditInitiative = !!((fs = game.user) != null && fs.isGM), e.showInitiativeResult = typeof fe == "number", e.initiativeResult = e.showInitiativeResult ? fe : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-CN0ugOm4.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CN0ugOm4.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-CN0ugOm4.mjs");
      h(this.actor, o, m);
...
ee(Q, "PARTS", foundry.utils.mergeObject(
  ...
  j(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Os = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Os.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Cs = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ls = (qs = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : qs.window) == null ? void 0 : Ls.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Me, je, it, nt, ie, fe, ne, at, Pe, Oe, rt, ze, Ve, qt, Lt, dt, Nt, mt, pt, ft, yt, gt, ht, bt, vt, kt, We, wt, It, Je;
    ...
    e.weaponsTable = r.map((I) => {
      ...
      let P = null, G = {};
      for (const ot of v)
        if ((((St = u[ot]) == null ? void 0 : St.itemId) ?? "").trim() === E) {
          P = ot, G = u[ot] ?? {};
          break;
        }
      const ke = !!P, ae = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ae.range == "string" ? (ae.range || "").trim() : "", De = ae.type ?? "", we = (w[De] ?? De) || "—", $e = ae.size ?? "", Ze = (T[$e] ?? $e) || "", Ye = [we, Ze].filter(Boolean).join(", ") || we || "—", Ft = De === "projectile" || $e === "thrown", At = ae.quantity != null ? String(ae.quantity).trim() : "1", Et = String(ae.bonus ?? G.bonus ?? "").trim() || "0", Pt = (ae.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: E,
        actorId: t.id,
    ...
    const O = ((qt = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : qt.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], M = c.filter((I) => I.type === "MikroChip");
    ...
    const R = (((Lt = e.weaponsTable) == null ? void 0 : Lt.length) ?? 0) > 0 || (((dt = e.armorTable) == null ? void 0 : dt.length) ?? 0) > 0 || (((Nt = e.microchipsTable) == null ? void 0 : Nt.length) ?? 0) > 0 || (((mt = e.itemsTable) == null ? void 0 : mt.length) ?? 0) > 0 || (((pt = e.egyebList) == null ? void 0 : pt.length) ?? 0) > 0;
    ...
    const oe = t == null ? void 0 : t.id, ve = !!((gt = (yt = game.combat) == null ? void 0 : yt.combatants) != null && gt.some(
      (I) => {
        var E;
    ...
    const he = ((ht = e.system) == null ? void 0 : ht.resources) ?? {}, D = (vt = (bt = e.system) == null ? void 0 : bt.combat) == null ? void 0 : vt.initiativeResult, x = typeof D == "number" ? D : -1, W = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], te = (We = (kt = e.system) == null ? void 0 : kt.combat) == null ? void 0 : We.initiativeRanges, ce = Array.isArray(te) ? te.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], se = (ce.length > 0 ? ce : W).slice().sort((I, E) => I.min - E.min), be = 3;
    ...
    return e.kpDotsRow1 = Re.slice(0, Ge), e.kpDotsRow2 = Re.slice(Ge), e.canEditInitiative = !!((wt = game.user) != null && wt.isGM), e.showInitiativeResult = typeof D == "number", e.initiativeResult = e.showInitiativeResult ? D : "", e.speedUnitForSelect = ((Je = (It = e.system) == null ? void 0 : It.combat) == null ? void 0 : Je.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var c, u, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CN0ugOm4.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CN0ugOm4.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-CN0ugOm4.mjs");
      m(this.actor, r, o);
...
ee(ye, "PARTS", foundry.utils.mergeObject(
  ...
  j(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ns = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Fs = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Es = (As = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : As.window) == null ? void 0 : Es.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const D of a) {
      ...
      const Ct = (x.damage ?? "").toString().trim(), Re = (x.storage ?? "").toString().trim().replace(",", "."), Ge = Number(Re);
...
ee(ge, "PARTS", foundry.utils.mergeObject(
  ...
  j(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ps = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject((($s = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : $s.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Rs = (xs = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) == null ? void 0 : Rs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const tt = class tt extends xt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!u || !a || !i) return;
      const r = u.value ?? "", o = (y == null ? void 0 : y.value) ?? "", m = t[r] ?? 0, h = n[o] ?? 0, g = (((R = (U = this.actor) == null ? void 0 : U.items) == null ? void 0 : R.contents) ?? []).filter((J) => J.type === "Jarmuegyseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = m + h + k + w;
      a.value = T;
    };
...
ee(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(tt, tt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Ms = j(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Gt = tt;
...
ee(qe, "PARTS", foundry.utils.mergeObject(j(qe, qe, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((js = j(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Vt = qe;
var zs;
...
ee(Le, "PARTS", foundry.utils.mergeObject(j(Le, Le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((zs = j(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : zs.form) ?? {}, { submitOnChange: !1 })
}));
let Wt = Le;
var Ks;
...
ee(Ne, "PARTS", foundry.utils.mergeObject(j(Ne, Ne, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ks = j(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.form) ?? {}, { submitOnChange: !1 })
}));
let Jt = Ne;
var Us;
...
ee(Fe, "PARTS", foundry.utils.mergeObject(j(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Us = j(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : Us.form) ?? {}, { submitOnChange: !0 })
}));
let Zt = Fe;
var Bs;
...
ee(Ae, "PARTS", foundry.utils.mergeObject(j(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Bs = j(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !1 })
}));
let Yt = Ae;
var Hs;
...
ee(Ee, "PARTS", foundry.utils.mergeObject(j(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Hs = j(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !1 })
}));
let Xt = Ee;
var Gs, Vs;
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = oi, CONFIG.Actor.dataModels.Npc = Rt, CONFIG.Actor.dataModels.Jarmu = di, CONFIG.Actor.dataModels.Bazis = fi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = ks, CONFIG.Item.dataModels.weapon = ks, CONFIG.Item.dataModels.Pancel = hi, CONFIG.Item.dataModels.MikroChip = bi, CONFIG.Item.dataModels.Kepesseg = Ss, CONFIG.Item.dataModels.ability = Ss, CONFIG.Item.dataModels.Targy = ki, CONFIG.Item.dataModels.Egyeb = Ii, CONFIG.Item.dataModels.Jarmuegyseg = Ti, CONFIG.Item.dataModels.Helyiseg = _i, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-Bpp-lkV8.mjs.map
