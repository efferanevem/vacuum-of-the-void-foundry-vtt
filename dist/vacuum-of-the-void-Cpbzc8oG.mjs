...
var Rs = Reflect.get;
var Ms = (w, s, e) => s in w ? $s(w, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : w[s] = e;
var X = (w, s, e) => Ms(w, typeof s != "symbol" ? s + "" : s, e);
var j = (w, s, e) => Rs(xs(w), e, s);
const { HTMLField: Ks, NumberField: q, SchemaField: K, StringField: T, BooleanField: ee, ArrayField: ft } = foundry.data.fields;
...
const { NumberField: Ft, SchemaField: js } = foundry.data.fields;
class zs extends Ns {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Hs, NumberField: si, StringField: Ne } = foundry.data.fields;
...
const { BooleanField: Us, StringField: qt } = foundry.data.fields;
...
const { NumberField: Pt, StringField: os } = foundry.data.fields;
...
const { NumberField: Ws, StringField: cs } = foundry.data.fields;
...
const { StringField: us } = foundry.data.fields;
class Vs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new us({ required: !1, blank: !0, initial: "" }),
      quantity: new us({ required: !1, blank: !0, initial: "1" })
    };
  }
}
const { StringField: Ys } = foundry.data.fields;
class Xs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((a = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : a.resources) ?? {}, d = ((h = (f = n.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : h.value) ?? 0, r = ((k = n.currentHealth) == null ? void 0 : k.legs) ?? 0, u = G._healthStatusFromRatio(r, d), m = Number(((D = (S = (I = this.actor) == null ? void 0 : I.system) == null ? void 0 : S.combat) == null ? void 0 : D.givenSpeed) ?? 0) || 0;
    let p;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var p, y, b, l, i, o, c, a, f, h, k, I, S;
    const e = s ?? this.form ?? this.element;
    let t = (p = e == null ? void 0 : e.querySelector) == null ? void 0 : p.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((l = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : l.givenProtection) ?? 0) || 0, d = (c = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && c.call(o, "lookaround") ? 1 : 0, r = (h = (f = (a = this.actor) == null ? void 0 : a.statuses) == null ? void 0 : f.has) != null && h.call(f, "halfcover") ? 3 : 0, u = (S = (I = (k = this.actor) == null ? void 0 : k.statuses) == null ? void 0 : I.has) != null && S.call(I, "threequarteredcover") ? 6 : 0, m = n + this._getTotalArmorProtectionBonus() + d + r + u;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const m = ((k = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : k.resources) ?? {}, p = ((S = (I = m.hitLocations) == null ? void 0 : I.legs) == null ? void 0 : S.value) ?? 0, y = ((D = m.currentHealth) == null ? void 0 : D.legs) ?? 0;
  ...
  async _prepareContext(s) {
    var et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe, v, A, E, U, oe, V, ye, me, ce, _e, Re, Me, _t, Dt, Ot, Ct, dt, We, Ht, Ut, Bt, Gt, Wt, Vt, Yt, Xt, Qt, Zt, Jt, es, ts, ss;
    ...
    const c = Number(((ot = (rt = this.actor.system) == null ? void 0 : rt.combat) == null ? void 0 : ot.givenProtection) ?? 0) || 0, a = (lt = ($e = (ct = this.actor) == null ? void 0 : ct.statuses) == null ? void 0 : $e.has) != null && lt.call($e, "lookaround") ? 1 : 0, f = (v = (xe = (ut = this.actor) == null ? void 0 : ut.statuses) == null ? void 0 : xe.has) != null && v.call(xe, "halfcover") ? 3 : 0, h = (U = (E = (A = this.actor) == null ? void 0 : A.statuses) == null ? void 0 : E.has) != null && U.call(E, "threequarteredcover") ? 6 : 0, k = c + this._getTotalArmorProtectionBonus() + a + f + h;
    ...
    e.weaponItems = ae;
    const Ie = "— Nincs fegyver —", fe = P.filter((g) => {
    ...
    e.weaponSlots = fe.map((g, O) => {
      ...
      return {
        ...
        itemId: F,
        slotNum: O + 1,
        displayName: (R == null ? void 0 : R.name) || _.name || Ie,
    ...
    const Se = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, re = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = Q.map((g) => {
      var is, ns, as;
      const O = g.id;
      let _ = null, F = {};
      for (const Lt of P)
        if ((((is = C[Lt]) == null ? void 0 : is.itemId) ?? "").trim() === O) {
          _ = Lt, F = C[Lt] ?? {};
          break;
        }
      const R = !!_, J = ((ns = g.system) == null ? void 0 : ns.equipped) !== void 0 && ((as = g.system) == null ? void 0 : as.equipped) !== null ? !!g.system.equipped : R, Y = (g == null ? void 0 : g.system) ?? {}, Ke = typeof Y.range == "string" ? (Y.range || "").trim() : "", le = Y.type ?? "", pe = (Se[le] ?? le) || "—", De = Y.size ?? "", je = (re[De] ?? De) || "", ze = [pe, je].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || De === "thrown", qe = Y.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(Y.bonus ?? "").trim(), Es = Ve || pt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    e.armorTable = ue.map((g) => {
      ...
      return {
        ...
        level: Qs((O.level ?? "").toString().trim()),
    ...
    const gt = (((Ht = this.actor.items) == null ? void 0 : Ht.contents) ?? []).filter((g) => g.type === "MikroChip"), ne = gt.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ye = "— Nincs Mikro-Chip —", Te = ["slot1", "slot2", "slot3"], Ue = (g) => {
      var _, F, R;
      const O = [];
    ...
    const ht = (((Ut = e.weaponsTable) == null ? void 0 : Ut.length) ?? 0) > 0 || (((Bt = e.armorTable) == null ? void 0 : Bt.length) ?? 0) > 0 || (((Gt = e.microchipsTable) == null ? void 0 : Gt.length) ?? 0) > 0 || (((Wt = e.itemsTable) == null ? void 0 : Wt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !ht;
    const bt = this.actor.system.abilities ?? {}, zt = (((Vt = this.actor.items) == null ? void 0 : Vt.contents) ?? []).map((g) => {
      var O, _, F;
      return {
        id: g.id,
        name: g.name,
    ...
    }), Be = new Map(zt.map((g) => [g.id, g])), vt = "— Nincs képesség —", Xe = (g) => {
    ...
    const kt = ((Yt = e.system) == null ? void 0 : Yt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Fe = (Qt = (Xt = e.system) == null ? void 0 : Xt.combat) == null ? void 0 : Qt.initiativeResult, de = typeof Fe == "number" ? Fe : -1, wt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (Jt = (Zt = e.system) == null ? void 0 : Zt.combat) == null ? void 0 : Jt.initiativeRanges, Ae = Array.isArray(Pe) ? Pe.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Oe = (Ae.length > 0 ? Ae : wt).slice().sort((g, O) => g.min - O.min), Ee = Ae.map((g) => g.min), It = Ee.length ? Math.min(...Ee) : 0, St = Ee.length ? Math.max(...Ee) : 0;
    e.initiativeRanges = Ae.map((g) => ({ ...g, isFirst: g.min === It, isLast: g.min === St }));
    let Je = 0;
    ...
    const Tt = !!((ts = (es = game.combat) == null ? void 0 : es.combatants) != null && ts.some((g) => {
      var O;
      return ((O = g.actor) == null ? void 0 : O.type) === "Karakter";
    }));
    return e.showHarcSection = Tt, e.canEditInitiative = !!((ss = game.user) != null && ss.isGM), e.showInitiativeResult = typeof Fe == "number", e.initiativeResult = e.showInitiativeResult ? Fe : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-mmlCgtGn.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-mmlCgtGn.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: f } = await import("./roll-sheet-mmlCgtGn.mjs");
      f(this.actor, c, a);
      ...
      if (!h) return;
      const k = ((L = (D = this.actor.items).get) == null ? void 0 : L.call(D, h)) ?? ((N = (C = this.actor.items.contents) == null ? void 0 : C.find) == null ? void 0 : N.call(C, (P) => P.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const k = a.system.weapons ?? {}, I = (k.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = I ? I.split(/\s*,\s*/).filter((C) => S.includes(C)) : [], L = D.find((C) => {
          var N;
      ...
      const f = this.actor.system.weapons ?? {}, h = (f.slotOrder ?? "").trim(), k = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((N) => k.includes(N)) : [], S = I.find((N) => {
        var x;
      ...
      if (!f) return;
      const h = (o.dataset.itemId ?? "").trim(), k = (o.dataset.itemName ?? ((N = o.textContent) == null ? void 0 : N.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (o.dataset.itemImg ?? "").trim(), S = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = k);
      ...
      const a = ((I = (k = this.actor.system) == null ? void 0 : k.gear) == null ? void 0 : I.microchips) ?? {}, h = ["slot1", "slot2", "slot3"].find((S) => {
        var D;
      ...
      if (!o || !c) return;
      const a = this.actor.system.abilities ?? {}, h = (Array.isArray((k = a[o]) == null ? void 0 : k.items) ? a[o].items.slice() : []).filter((I) => I !== c);
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && (a.type === "Kepesseg" || a.type === "ability")) {
          ...
          const I = h === "active" ? "active" : "passive", S = Array.isArray((u = k[I]) == null ? void 0 : u.items) ? k[I].items.slice() : Array.isArray(k[I]) ? k[I].slice() : [];
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            ...
            k = ((y = (await f.createEmbeddedDocuments("Item", [I]))[0]) == null ? void 0 : y.id) ?? k;
          }
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), D = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = S ? S.split(/\s*,\s*/).filter((N) => D.includes(N)) : [], C = L.filter((N) => {
              var x;
              return (((x = I[N]) == null ? void 0 : x.itemId) ?? "").trim() === k;
            });
            if (C.length > 0) {
              const x = {
                "system.weapons.slotOrder": L.filter((P) => !C.includes(P)).join(",")
              };
              for (const P of C)
                x[`system.weapons.${P}.itemId`] = "", x[`system.weapons.${P}.name`] = "", x[`system.weapons.${P}.damage`] = "", x[`system.weapons.${P}.bonus`] = "";
              await f.update(x);
            }
          }
          return;
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: y, label: b } = At(p), l = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const u = r && r.name || t.name || `Fegyver (${s})`, m = Number(t.bonus || 0) || 0, p = ((I = r == null ? void 0 : r.system) == null ? void 0 : I.type) || "kinetic", y = (((S = r == null ? void 0 : r.system) == null ? void 0 : S.skillKey) ?? "").trim(), b = y && n[y] !== void 0 ? y : p === "explosive" ? "grenadeUse" : "firearms", l = Number(n[b] || 0) || 0, i = m + l, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(c);
    await a.evaluate({ async: !0 });
    const { resultType: f, label: h } = At(a), k = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${u} – találat`,
...
X(G, "PARTS", foundry.utils.mergeObject(
  ...
  j(G, G, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((ms = j(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : ms.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((ps = j(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : ps.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((ys = (fs = j(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : fs.window) == null ? void 0 : ys.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Qe, Ze, kt, Ge, Fe, de, wt, Pe, Ae, Nt, Oe, Ee, It, St, Je, Tt, et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe;
    ...
    const t = this.actor, n = ((kt = e.system) == null ? void 0 : kt.combat) ?? {}, d = Number(n.givenProtection ?? 0) || 0, r = (Fe = (Ge = t == null ? void 0 : t.statuses) == null ? void 0 : Ge.has) != null && Fe.call(Ge, "lookaround") ? 1 : 0, u = (wt = (de = t == null ? void 0 : t.statuses) == null ? void 0 : de.has) != null && wt.call(de, "halfcover") ? 3 : 0, m = (Ae = (Pe = t == null ? void 0 : t.statuses) == null ? void 0 : Pe.has) != null && Ae.call(Pe, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = d + r + u + m;
    const p = ((Nt = t == null ? void 0 : t.items) == null ? void 0 : Nt.contents) ?? [], y = ((Oe = t == null ? void 0 : t.system) == null ? void 0 : Oe.weapons) ?? {}, b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (y.slotOrder ?? "").trim(), i = l ? l.split(/\s*,\s*/).filter((v) => b.includes(v)) : [], o = p.filter((v) => v.type === "Fegyver"), c = o.map((v) => ({ id: v.id, name: v.name, img: v.img })), a = "— Nincs fegyver —", f = i.length > 0 ? i : b, h = b.filter((v) => !f.includes(v)), k = [...f, ...h], I = k.filter((v) => {
      var E;
      const A = (((E = y[v]) == null ? void 0 : E.itemId) ?? "").trim();
      return A && o.some((U) => U.id === A);
    });
    e.weaponSlots = I.map((v) => {
      const A = y[v] ?? {}, E = (A.itemId ?? "").trim(), U = c.find((ce) => ce.id === E), oe = o.find((ce) => ce.id === E), V = (oe == null ? void 0 : oe.system) ?? {}, ye = V.size === "thrown", me = (typeof V.range == "string" ? (V.range || "").trim() : "") || "—";
      return {
        slotKey: v,
        itemId: E,
        displayName: (U == null ? void 0 : U.name) || A.name || a,
    ...
    e.weaponsTable = o.map((v) => {
      ...
      let E = null, U = {};
      for (const We of k)
        if ((((dt = y[We]) == null ? void 0 : dt.itemId) ?? "").trim() === A) {
          E = We, U = y[We] ?? {};
          break;
        }
      const oe = !!E, V = (v == null ? void 0 : v.system) ?? {}, ye = typeof V.range == "string" ? (V.range || "").trim() : "", me = V.type ?? "", ce = (S[me] ?? me) || "—", _e = V.size ?? "", Re = (D[_e] ?? _e) || "", Me = [ce, Re].filter(Boolean).join(", ") || ce || "—", _t = me === "projectile" || _e === "thrown", Dt = V.quantity != null ? String(V.quantity).trim() : "1", Ot = String(V.bonus ?? U.bonus ?? "").trim() || "0", Ct = (V.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: A,
        actorId: t.id,
    ...
    e.armorTable = L.map((v) => {
      var U;
      const A = (v == null ? void 0 : v.system) ?? {}, E = ((U = v.system) == null ? void 0 : U.equipped) === !0;
      return {
        itemId: v.id,
        actorId: t.id,
        ...
        level: Zs((A.level ?? "").toString().trim()),
        special: (A.special ?? A.other ?? "").toString().trim() || "—",
        equipped: E
      };
    });
    const C = ((It = (Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.gear) == null ? void 0 : It.microchips) ?? {}, N = ["slot1", "slot2", "slot3"], x = p.filter((v) => v.type === "MikroChip");
    e.microchipsTable = x.map((v) => {
      var me, ce, _e, Re;
      const A = v.id;
      let E = null;
      for (const Me of N)
        if ((((me = C[Me]) == null ? void 0 : me.itemId) ?? "").trim() === A) {
          E = Me;
          break;
        }
    ...
    const P = p.filter((v) => v.type === "Targy");
    e.itemsTable = P.map((v) => {
      const A = (v == null ? void 0 : v.system) ?? {}, E = (A.description ?? "").trim(), U = E ? E.length > 60 ? E.slice(0, 57) + "…" : E : "—";
      return {
        itemId: v.id,
        actorId: t.id,
        name: (v == null ? void 0 : v.name) ?? "—",
    ...
    const H = (((St = e.weaponsTable) == null ? void 0 : St.length) ?? 0) > 0 || (((Je = e.armorTable) == null ? void 0 : Je.length) ?? 0) > 0 || (((Tt = e.microchipsTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((et = e.itemsTable) == null ? void 0 : et.length) ?? 0) > 0 || (((tt = e.egyebList) == null ? void 0 : tt.length) ?? 0) > 0;
    ...
    const ae = t == null ? void 0 : t.id, Ie = !!((nt = (it = game.combat) == null ? void 0 : it.combatants) != null && nt.some(
      (v) => {
        var A;
        return (((A = v.actor) == null ? void 0 : A.id) ?? v.actorId) === ae;
      }
    ));
    e.showHarcSection = Ie;
    const fe = ((at = e.system) == null ? void 0 : at.resources) ?? {}, Se = (ot = (rt = e.system) == null ? void 0 : rt.combat) == null ? void 0 : ot.initiativeResult, re = typeof Se == "number" ? Se : -1, ue = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Le = ($e = (ct = e.system) == null ? void 0 : ct.combat) == null ? void 0 : $e.initiativeRanges, He = Array.isArray(Le) ? Le.map((v) => ({ min: Number(v.min) ?? 0, max: Number(v.max) ?? 0, kp: Math.min(10, Math.max(0, Number(v.kp) ?? 0)) })) : [], ne = (He.length > 0 ? He : ue).slice().sort((v, A) => v.min - A.min), Ye = 3;
    let Te = He.length > 0 ? He : [];
    Te.length < Ye && (Te = [...Te, ...Array(Ye - Te.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = Te.map((v, A) => ({
      ...v,
      isFirst: A === 0,
      isLast: A === Te.length - 1
    }));
    let Ue = 0;
    if (typeof re == "number" && re >= 0 && ne.length > 0) {
      const v = ne[0], A = ne[ne.length - 1];
      let E = null;
      re <= v.max ? E = v : re >= A.min ? E = A : E = ne.find((U) => re >= U.min && re <= U.max), E && (Ue = E.kp);
    }
    const ht = ne.length > 0 ? ne[ne.length - 1] : null, bt = Math.min(10, ht ? ht.kp : 6), Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, bt)).map((v, A) => {
      const E = A + 1, U = !!Number(fe[v]), oe = E <= Ue;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-mmlCgtGn.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-mmlCgtGn.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-mmlCgtGn.mjs");
      a(this.actor, o, c);
      ...
      const i = (k = (h = l.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : k.area, o = (S = (I = l.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : S.itemId;
      ...
      if (!i || !this.actor) return;
      const o = ((I = (k = this.actor.system) == null ? void 0 : k.gear) == null ? void 0 : I.microchips) ?? {}, a = ["slot1", "slot2", "slot3"].find((S) => {
        var D;
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[s] ?? {}, d = ((D = e.system) == null ? void 0 : D.skills) ?? {}, r = ((L = e.items) == null ? void 0 : L.filter((x) => x.type === "Fegyver")) ?? [];
    let u = null;
    ...
    const { resultType: h, label: k } = At(f), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return f.toMessage({
  ...
  async _onDropItem(s, e) {
    var y, b, l, i, o, c, a, f, h, k, I, S, D, L, C, N, x;
    if (!this.actor) return (y = super._onDropItem) == null ? void 0 : y.call(this, s, e);
    const n = ((P) => {
      var H;
      if (!P) return null;
      const z = P.uuid ?? P.documentUuid ?? ((H = P.data) == null ? void 0 : H.uuid) ?? (typeof P == "string" ? P : null);
      if (z) return z;
      if (typeof P == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((c = d.parent) == null ? void 0 : c.id) !== r.id) {
        ...
        P = ((a = (await r.createEmbeddedDocuments("Item", [ie]))[0]) == null ? void 0 : a.id) ?? P;
      }
      ...
      W.includes(P) || W.push(P), await r.update({ [`system.abilities.${B}.items`]: W }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    const p = (S = (await r.createEmbeddedDocuments("Item", [u]))[0]) == null ? void 0 : S.id;
    if (d.type === "Fegyver" && p) {
      const P = ((D = r.system) == null ? void 0 : D.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], H = (P.slotOrder ?? "").trim(), B = H ? H.split(/\s*,\s*/).filter((Z) => z.includes(Z)) : [];
      let W = z.find((Z) => {
        var M;
        return !(((M = P[Z]) == null ? void 0 : M.itemId) ?? "").trim();
      });
    ...
    if (d.type === "MikroChip" && p) {
      const P = ((x = (N = r.system) == null ? void 0 : N.gear) == null ? void 0 : x.microchips) ?? {}, H = ["slot1", "slot2", "slot3"].find((B) => {
        var W;
        return !(((W = P[B]) == null ? void 0 : W.itemId) ?? "").trim();
      });
      H && await r.update({
...
X(te, "PARTS", foundry.utils.mergeObject(
  ...
  j(te, te, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((hs = j(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : hs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((vs = (bs = j(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : bs.window) == null ? void 0 : vs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(se, "PARTS", foundry.utils.mergeObject(
  ...
  j(se, se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((ks = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : ks.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((ws = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : ws.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ss = (Is = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : Is.window) == null ? void 0 : Ss.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = Js, e;
  }
};
X(ge, "PARTS", foundry.utils.mergeObject(j(ge, ge, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ts = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ts.form) ?? {}, { submitOnChange: !1 })
}));
let $t = ge;
var _s;
...
X(he, "PARTS", foundry.utils.mergeObject(j(he, he, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((_s = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : _s.form) ?? {}, { submitOnChange: !1 })
}));
let xt = he;
var Ds;
...
X(be, "PARTS", foundry.utils.mergeObject(j(be, be, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ds = j(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Ds.form) ?? {}, { submitOnChange: !1 })
}));
let Rt = be;
var Os;
...
X(ve, "PARTS", foundry.utils.mergeObject(j(ve, ve, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Os = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Os.form) ?? {}, { submitOnChange: !0 })
}));
let Mt = ve;
var Cs;
...
X(ke, "PARTS", foundry.utils.mergeObject(j(ke, ke, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Cs = j(ke, ke, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = ke;
var qs;
...
X(we, "PARTS", foundry.utils.mergeObject(j(we, we, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((qs = j(we, we, "DEFAULT_OPTIONS")) == null ? void 0 : qs.form) ?? {}, { submitOnChange: !1 })
}));
let jt = we;
const Ls = "systems/vacuum-of-the-void/assets/void-bg.jpg";
function Fs(w) {
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = zs, CONFIG.Actor.dataModels.Npc = Ns, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = rs, CONFIG.Item.dataModels.weapon = rs, CONFIG.Item.dataModels.Pancel = Bs, CONFIG.Item.dataModels.MikroChip = Gs, CONFIG.Item.dataModels.Kepesseg = ls, CONFIG.Item.dataModels.ability = ls, CONFIG.Item.dataModels.Targy = Vs, CONFIG.Item.dataModels.Egyeb = Xs, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health"],
    value: []
  }, CONFIG.Actor.trackableAttributes.Npc = {
    bar: ["", "resources.health"],
    value: []
  }, (d = CONFIG.Actor).typeLabels ?? (d.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", (r = CONFIG.Combat).initiative ?? (r.initiative = {}), CONFIG.Combat.initiative.formula = "1d20", (u = CONFIG.Item).typeLabels ?? (u.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.weapon = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ";
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      if (o <= 0 && !c) {
        const I = ((k = (h = CONFIG.statusEffects) == null ? void 0 : h.find((S) => S.id === "immobilized")) == null ? void 0 : k.img) ?? "";
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, D, L, C, N, x, P, z, H, B, W, ie, Z;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      ...
      if (ae) {
        const Ie = ((C = ae.combatants) == null ? void 0 : C.contents) ?? Array.from(ae.combatants ?? []);
        for (const fe of Ie)
    ...
    if (m.type === "Npc" && ((x = p == null ? void 0 : p.system) != null && x.identity) && "size" in p.system.identity) {
      const M = Fs((z = (P = m.system) == null ? void 0 : P.identity) == null ? void 0 : z.size);
      m.update({
    ...
    const k = (Z = game.votv) == null ? void 0 : Z._lastKarakterSheetBlurSave, I = k && Date.now() - k.at < s ? k.appId : null;
    setTimeout(() => {
      for (const M of c)
    ...
    for (const [h, k] of Object.entries(i)) {
      ...
      const I = ((k == null ? void 0 : k.itemId) ?? "").trim();
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, k, I, S, D, L, C, N, x, P, z, H, B, W, ie, Z, M, Q, ae, Ie, fe, Se;
    ...
    if (!n) return;
    const d = (k = game.messages) == null ? void 0 : k.get(n), r = (S = (I = d == null ? void 0 : d.flags) == null ? void 0 : I["vacuum-of-the-void"]) == null ? void 0 : S.weapon;
    if (!r) return;
    ...
    const p = r.itemId ? ((z = (P = m.items) == null ? void 0 : P.get) == null ? void 0 : z.call(P, r.itemId)) ?? ((W = (B = (H = m.items) == null ? void 0 : H.contents) == null ? void 0 : B.find) == null ? void 0 : W.call(B, (re) => re.id === r.itemId)) : null;
    ...
    if (y || (y = (((ie = p == null ? void 0 : p.system) == null ? void 0 : ie.damage) ?? "").trim()), !y && r.slotKey && (y = (((((Z = m.system) == null ? void 0 : Z.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (Ie = (M = ui.notifications) == null ? void 0 : M.warn) == null || Ie.call(M, ((ae = (Q = game.i18n) == null ? void 0 : Q.localize) == null ? void 0 : ae.call(Q, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
    await b.evaluate({ async: !0 });
    const l = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", o = r.hitLocationName || "", c = ((p == null ? void 0 : p.name) ?? (r.slotKey ? ((Se = (((fe = m.system) == null ? void 0 : fe.weapons) ?? {})[r.slotKey]) == null ? void 0 : Se.name) ?? "" : "")) || "Fegyver";
...
function Ps(w) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" && n.type !== "Npc" || n.update(ei).catch((d) => {
...
Hooks.on("updateCombat", (w, s, e) => {
  (s == null ? void 0 : s.round) != null && Ps(w), setTimeout(As, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-Cpbzc8oG.mjs.map
