...
class Rt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      combat: new R({
        defense: new N({ required: !1, integer: !1, initial: 0 }),
        defenseBonus: new N({ required: !1, integer: !1, initial: 0 }),
        givenProtection: new N({ required: !1, integer: !0, min: 0, initial: 0 }),
        speed: new N({ required: !1, integer: !1, initial: 0 }),
        speedBonus: new N({ required: !1, integer: !1, initial: 0 }),
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-T4gu0YX8.mjs");
      r(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', n), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-T4gu0YX8.mjs");
      p(this.actor, o, r);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-T4gu0YX8.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-T4gu0YX8.mjs");
      r(this.actor, c, o);
...
//# sourceMappingURL=vacuum-of-the-void-Dz2lQqtC.mjs.map
