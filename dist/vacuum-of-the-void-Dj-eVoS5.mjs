...
const { HTMLField: fi, NumberField: F, SchemaField: H, StringField: q, BooleanField: me, ArrayField: _t } = foundry.data.fields;
...
const { BooleanField: Si, NumberField: Gi, StringField: Ve } = foundry.data.fields;
...
const { BooleanField: Ti, StringField: Rt } = foundry.data.fields;
...
const { NumberField: Ht, StringField: dt, SchemaField: Cs, ArrayField: Ni } = foundry.data.fields;
...
const { NumberField: Ai, StringField: Mt, SchemaField: Ei, ArrayField: Pi } = foundry.data.fields;
...
const { SchemaField: qs, StringField: zt, NumberField: Ct, ArrayField: xi } = foundry.data.fields;
class Ri extends Lt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      vallalkozas: new qs({
        ...
        kind: new zt({ required: !1, blank: !0, initial: "" }),
        /** Vállalkozás szintje (legalább 1). */
        level: new Ct({ required: !1, integer: !0, min: 1, initial: 1 }),
        /** Alkalmazottak aktuális száma. */
        employeesCurrent: new Ct({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Alkalmazottak maximuma. */
        employeesMax: new Ct({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Szint által adott bónuszok (szabad szöveg). */
        levelBonuses: new zt({ required: !1, blank: !0, initial: "" }),
        /** Alkalmazottak táblázat: Típus, Szint, Szám, Bónusz. */
        employees: new xi(
          new qs({
            type: new zt({ required: !1, blank: !0, initial: "" }),
            level: new Ct({ required: !1, integer: !0, min: 0, initial: 0 }),
            count: new Ct({ required: !1, integer: !0, min: 0, initial: 0 }),
            bonus: new zt({ required: !1, blank: !0, initial: "" })
          }),
          { required: !1, initial: [] }
        )
      })
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe, S, P, x, G, ke, ne, qe, Oe, we, Re, Qe, et, Et, Pt, $t, xt, Tt, lt, ns, as, rs, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs;
    ...
    for (const b of m) {
      const N = ((gt = f[b]) == null ? void 0 : gt.value) ?? 0, L = u[b] ?? 0;
    ...
    const _ = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Qe = this.actor.system.gear) == null ? void 0 : Qe.microchips, z = U && typeof U == "object" && !Array.isArray(U) ? U : {}, V = (((et = z.slot1) == null ? void 0 : et.itemId) ?? "").trim(), Z = (((Et = z.slot2) == null ? void 0 : Et.itemId) ?? "").trim(), J = (((Pt = z.slot3) == null ? void 0 : Pt.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      for (let ut = 0; ut < K.length; ut++) {
        ...
        if ((((Me = _[Ot]) == null ? void 0 : Me.itemId) ?? "") === b.id) {
          A = ut + 1, B = ((st = _[Ot]) == null ? void 0 : st.bonus) ?? "", ue = Ot;
          break;
        }
      }
      let re = null;
    ...
    e.actionsTable = oe;
    const R = ((($t = this.actor.items) == null ? void 0 : $t.contents) ?? []).filter((b) => b.type === "Fegyver"), te = R.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = te;
    ...
    e.weaponSlots = De.map((b, N) => {
      const L = _[b] ?? {}, A = (L.itemId ?? "").trim(), B = te.find((_e) => _e.id === A), ue = R.find((_e) => _e.id === A), re = (ue == null ? void 0 : ue.system) ?? {}, tt = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
    ...
    const W = (((xt = this.actor.items) == null ? void 0 : xt.contents) ?? []).filter((b) => b.type === "Pancel");
    ...
    const je = this.actor.system.abilities ?? {}, $e = (((ls = this.actor.items) == null ? void 0 : ls.contents) ?? []).map((b) => {
      ...
      return {
        itemId: L,
        displayName: (A == null ? void 0 : A.name) || N.name || at,
        img: (A == null ? void 0 : A.img) || "",
        description: B,
        kp: ue
      };
    ...
    const rt = ((us = e.system) == null ? void 0 : us.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (ms = (ds = e.system) == null ? void 0 : ds.combat) == null ? void 0 : ms.initiativeResult, ie = typeof ye == "number" ? ye : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], xe = (fs = (ps = e.system) == null ? void 0 : ps.combat) == null ? void 0 : fs.initiativeRanges, Ce = Array.isArray(xe) ? xe.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], He = (Ce.length > 0 ? Ce : ot).slice().sort((b, N) => b.min - N.min), Ze = Ce.map((b) => b.min), Nt = Ze.length ? Math.min(...Ze) : 0, Ft = Ze.length ? Math.max(...Ze) : 0;
    e.initiativeRanges = Ce.map((b) => ({ ...b, isFirst: b.min === Nt, isLast: b.min === Ft }));
    let mt = 0;
    if (typeof ie == "number" && ie >= 0 && He.length > 0) {
      const b = He[0], N = He[He.length - 1];
      let L = null;
      ie <= b.max ? L = b : ie >= N.min ? L = N : L = He.find((A) => ie >= A.min && ie <= A.max), L && (mt = L.kp);
    }
    e.kpDots = ee.map((b, N) => {
      const L = N + 1, A = !!Number(rt[b]), B = L <= mt;
      return { index: L, used: A, usable: B };
    });
    const At = !!((gs = (ys = game.combat) == null ? void 0 : ys.combatants) != null && gs.some((b) => {
      var N;
      return ((N = b.actor) == null ? void 0 : N.type) === "Karakter";
    }));
    return e.showHarcSection = At, e.canEditInitiative = !!((hs = game.user) != null && hs.isGM), e.showInitiativeResult = typeof ye == "number", e.initiativeResult = e.showInitiativeResult ? ye : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-D6YZRyM7.mjs");
      d(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D6YZRyM7.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, l = o.dataset.skill, d = ((g = o.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-D6YZRyM7.mjs");
      h(this.actor, l, d);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: c, label: y } = Gt(a), r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ue, Je, Be, rt, ee, ye, ie, ot, xe, Ce, ct, He, Ze, Nt, Ft, mt, At, pt, ft, yt, gt, ht, bt, vt, kt, wt, Ye, It, St, Xe;
    ...
    e.weaponSlots = k.map((S) => {
      const P = c[S] ?? {}, x = (P.itemId ?? "").trim(), G = l.find((we) => we.id === x), ke = o.find((we) => we.id === x), ne = (ke == null ? void 0 : ke.system) ?? {}, qe = ne.size === "thrown", Oe = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: S,
        itemId: x,
    ...
    e.weaponsTable = o.map((S) => {
      ...
      const ke = !!x, ne = (S == null ? void 0 : S.system) ?? {}, qe = typeof ne.range == "string" ? (ne.range || "").trim() : "", Oe = ne.type ?? "", we = (w[Oe] ?? Oe) || "—", Re = ne.size ?? "", Qe = (T[Re] ?? Re) || "", et = [we, Qe].filter(Boolean).join(", ") || we || "—", Et = Oe === "projectile" || Re === "thrown", Pt = ne.quantity != null ? String(ne.quantity).trim() : "1", $t = String(ne.bonus ?? G.bonus ?? "").trim() || "0", xt = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const _ = ((Nt = (Ze = t == null ? void 0 : t.system) == null ? void 0 : Ze.gear) == null ? void 0 : Nt.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], j = a.filter((S) => S.type === "MikroChip");
    ...
    const z = (((Ft = e.weaponsTable) == null ? void 0 : Ft.length) ?? 0) > 0 || (((mt = e.armorTable) == null ? void 0 : mt.length) ?? 0) > 0 || (((At = e.microchipsTable) == null ? void 0 : At.length) ?? 0) > 0 || (((pt = e.itemsTable) == null ? void 0 : pt.length) ?? 0) > 0 || (((ft = e.egyebList) == null ? void 0 : ft.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-D6YZRyM7.mjs");
      l(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D6YZRyM7.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-D6YZRyM7.mjs");
      d(this.actor, o, l);
...
const nt = class nt extends jt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!c || !r || !i) return;
      const o = c.value ?? "", l = (y == null ? void 0 : y.value) ?? "", d = t[o] ?? 0, h = n[l] ?? 0, g = (((V = (z = this.actor) == null ? void 0 : z.items) == null ? void 0 : V.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ls(this.actor), O = d + h + k + w + T;
      r.value = O;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, m = f.assignment ?? "", p = f.subAssignment ?? "", a = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[m] ?? 0, i = c[p] ?? 0, o = e.sizeForSelect ?? "Kicsi", l = y[o] ?? 0, d = Number(u.threatBonus ?? 0) || 0, h = Ls(this.actor), g = r + i + l + d + h;
      e.system = foundry.utils.mergeObject(
...
X(nt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  M(nt, nt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Us = M(nt, nt, "DEFAULT_OPTIONS")) == null ? void 0 : Us.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Vt = nt;
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    this.isEditable && (t.on("click", ".vallalkozas-employee-add", async (f) => {
      var p;
      if (f.preventDefault(), !this.actor) return;
      const u = this.actor.system ?? {}, m = Array.isArray((p = u.vallalkozas) == null ? void 0 : p.employees) ? u.vallalkozas.employees.slice() : [];
      m.push({ type: "", level: 0, count: 0, bonus: "" }), await this.actor.update({ "system.vallalkozas.employees": m });
    }), t.on("click", ".karakter-item-chat", async (f) => {
      var p, a, c, y;
      f.preventDefault();
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  M(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Hs = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ws = (Gs = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.window) == null ? void 0 : Ws.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(Le, "PARTS", foundry.utils.mergeObject(M(Le, Le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Vs = M(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.form) ?? {}, { submitOnChange: !1 })
}));
let Zt = Le;
var Js;
...
Hooks.once("init", () => {
  ...
  ], foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", qt, {
    types: ["Karakter"],
    makeDefault: !0,
  ...
  Hooks.on("preCreateActor", (a, c, y) => {
    ...
    setTimeout(() => {
      ...
      const l = qt.getTotalSpeedRaw(o), d = (g = o.effects) == null ? void 0 : g.find((w) => w.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (l <= 0 && !d) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    for (const m of e) {
      const p = qt.getTotalSpeedRaw(m), a = (n = m.effects) == null ? void 0 : n.find((c) => c.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (p <= 0 && !a) {
...
Hooks.on("preCreateToken", (I, s, e) => {
  ...
  if (f) {
    ...
    if (f.type === "Npc") {
      const l = ai((o = (i = f.system) == null ? void 0 : i.identity) == null ? void 0 : o.size);
      I.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-Dj-eVoS5.mjs.map
