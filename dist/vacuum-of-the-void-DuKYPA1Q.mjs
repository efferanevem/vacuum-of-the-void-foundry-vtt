...
const P = class P extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-xkZuCdYK.mjs");
      d(this.actor, u);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var f;
      n.preventDefault();
      const c = n.currentTarget, u = c.dataset.skill, d = ((f = c.textContent) == null ? void 0 : f.trim()) || u, { openRollSheetForSkill: m } = await import("./roll-sheet-xkZuCdYK.mjs");
      m(this.actor, u, d);
...
Hooks.on("ready", () => {
  ...
  if (document.body.addEventListener(
    ...
    try {
      ...
      t && typeof t.then == "function" && t.catch((i) => console.warn("Vacuum of the Void | Default scene creation failed:", i)), console.log("Vacuum of the Void | Default scene create requested.");
    } catch (e) {
...
//# sourceMappingURL=vacuum-of-the-void-DuKYPA1Q.mjs.map
