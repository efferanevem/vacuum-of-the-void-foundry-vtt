import { V as K, c as ae } from "./vacuum-of-the-void-BiY8x4CR.mjs";
    ...
    if (e)
      try {
        ...
        if (this._isWeaponAttack && ((g = (m = game.user) == null ? void 0 : m.targets) != null && g.size)) {
          ...
          if (j) {
            const O = ((o = j.system) == null ? void 0 : o.combat) ?? {}, X = Number(O.defense ?? 0) || 0, Z = Number(O.defenseBonus ?? 0) || 0, ee = Number(O.givenProtection ?? 0) || 0, te = (h = (r = j.statuses) == null ? void 0 : r.has) != null && h.call(r, "lookaround") ? 1 : 0;
            let W = 0;
            if (j.type === "Karakter") {
...
function ie(L, t, e) {
  var a, m;
  if (!L) return;
  const s = Number(((m = (a = L.system) == null ? void 0 : a.skills) == null ? void 0 : m[t]) ?? 0) || 0, u = K.BODY_PART_BY_SKILL[t] ? K._getSkillHealthStatusStatic(L, t) : void 0;
  let c = 0;
  u === 1 ? c = -6 : u === 2 && (c = -3);
...
function re(L, t) {
  ...
  let _ = 0;
  if (L.type === "Karakter") {
    const P = K._getSkillHealthStatusStatic(L, h);
    P === 1 ? _ = -6 : P === 2 && (_ = -3);
  }
...
//# sourceMappingURL=roll-sheet-COJW3enV.mjs.map
