...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const m = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, c = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var d, g;
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.speedPenalty) ?? "").trim().replace(",", "."), p = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((f = s.system) == null ? void 0 : f.protectionBonus) ?? "").trim().replace(",", "."), p = Number(a);
      Number.isFinite(p) && (e += p);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((c = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : c.resources) ?? {}, f = ((u = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : u.value) ?? 0, s = ((d = r.currentHealth) == null ? void 0 : d.legs) ?? 0, a = N._healthStatusFromRatio(s, f), p = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let m;
    a === 0 ? m = 0 : a === 1 ? m = -6 : a === 2 ? m = -3 : m = p;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const f = (Number(((m = (p = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : p.combat) == null ? void 0 : m.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((s = this.actor.system) == null ? void 0 : s.resources) ?? {}, r = ((p = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : p.value) ?? 0, f = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, f = ((m = (p = r.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : m.value) ?? 0, s = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
  ...
  async _prepareContext(i) {
    ...
    const p = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((o) => (Number(s[o]) || 0) === 0).length;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-vxepb-os.mjs");
      u(this.actor, l);
    ...
    f && r({ currentTarget: f }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const c = n.currentTarget, l = c.dataset.skill, u = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: d } = await import("./roll-sheet-vxepb-os.mjs");
      d(this.actor, l, u);
    ...
    a._votvBlur = (n) => {
      ...
      const u = c.form;
      m(u) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), p(u));
  ...
  async _postItemToChat(i) {
    ...
    let r;
    e.type === "MikroChip" ? r = ((((p = e.system) == null ? void 0 : p.abilityType) ?? "passive") === "active" ? "Aktív" : "Passzív") + " Mikro-Chip" : r = "Egyéb Információ";
    const f = t ? `<p>${t}</p>` : "", s = `
      <h2>${e.name}</h2>
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, f = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = f ? `<p>${f}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      f = ((p = (await this.actor.createEmbeddedDocuments("Item", [m]))[0]) == null ? void 0 : p.id) ?? f;
    }
    await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    s === 1 ? f -= 6 : s === 2 && (f -= 3);
    const p = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, m = new Roll(p);
  ...
  async _rollWeapon(i) {
    ...
    const a = s && s.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = p + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, u = new Roll(l);
  ...
  async _rollWeaponDamage(i, e = "") {
    var p, m, y, h, n, c, l, u, d, g;
    const t = this.actor;
    if (!t) return;
    let r = ((m = (p = t.items).get) == null ? void 0 : m.call(p, i)) ?? ((h = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : h.call(y, (v) => v.id === i));
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const r = (s) => {
      ...
      var a, p, m;
      return s && (((p = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : p.call(a, s)) || e.id && ((m = s.closest) == null ? void 0 : m.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var p, m, y;
      const a = ((p = s.target) == null ? void 0 : p.form) ?? ((y = (m = s.target) == null ? void 0 : m.closest) == null ? void 0 : y.call(m, "form"));
      f(a) && r(a);
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var p, m, y, h;
      if (!e.isEditable || !((m = (p = s.target) == null ? void 0 : p.closest) != null && m.call(p, ".profile")) && ((h = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (s) => {
      ...
      const p = (a == null ? void 0 : a.form) ?? ((m = a == null ? void 0 : a.closest) == null ? void 0 : m.call(a, "form"));
      f(p) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(p), 300));
...
//# sourceMappingURL=vacuum-of-the-void-DwqJofkH.mjs.map
