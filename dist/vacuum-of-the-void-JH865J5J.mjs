...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var le, oe, ye, ge, $e, xe, je, Me, Oe, Se, Ve, et, tt, st, it, rt, nt, at;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (b.slotOrder ?? "").trim(), C = S ? S.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], q = (Oe = this.actor.system.gear) == null ? void 0 : Oe.microchips, _ = q && typeof q == "object" && !Array.isArray(q) ? q : {}, w = (((Se = _.slot1) == null ? void 0 : Se.itemId) ?? "").trim(), L = (((Ve = _.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), E = (((et = _.slot3) == null ? void 0 : et.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
      const T = typeof p.sort == "number" ? p.sort : 0, O = typeof D.sort == "number" ? D.sort : 0;
      return T - O;
    }).map((p) => {
      var ce, be, ke, ue, de, qe;
      ...
      const Ce = D && ((ke = p.system) != null && ke.damage) ? p.system.damage : "", Z = D && typeof ((ue = p.system) == null ? void 0 : ue.range) == "string" ? (p.system.range || "").trim() : "", he = Y ? Number((de = b[Y]) == null ? void 0 : de.bonus) || 0 : "";
      return {
        id: p.id,
        name: p.name,
        img: p.img,
    ...
    e.weaponItems = ne;
    const Q = "— Nincs fegyver —", me = C.filter((p) => {
    ...
    e.weaponsTable = B.map((p) => {
      ...
      const N = !!T, Y = ((ct = p.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = p.system) == null ? void 0 : lt.equipped) !== null ? !!p.system.equipped : N, W = (p == null ? void 0 : p.system) ?? {}, Ce = typeof W.range == "string" ? (W.range || "").trim() : "", Z = W.type ?? "", he = (Pe[Z] ?? Z) || "—", ce = W.size ?? "", be = (Ae[ce] ?? ce) || "", ke = [he, be].filter(Boolean).join(", ") || he || "—", ue = Z === "projectile" || ce === "thrown", de = W.quantity, qe = de != null ? String(de).trim() : "1", Te = String(O.bonus ?? "").trim(), Le = String(W.bonus ?? "").trim(), Lt = Te || Le || "0";
      return {
        slotKey: T ?? "",
        itemId: D,
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), pe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), De = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], k = (p) => {
      var T, O, N;
      const D = [];
    ...
    e.microchipItemsSlot1 = pe.filter((p) => !k(1).includes(p.id)), e.microchipItemsSlot2 = pe.filter((p) => !k(2).includes(p.id)), e.microchipItemsSlot3 = pe.filter((p) => !k(3).includes(p.id)), e.microchipSlots = _e.map((p) => {
      ...
      const O = !!T, N = ((be = p == null ? void 0 : p.system) == null ? void 0 : be.abilityType) ?? "", Y = N === "active" ? "Aktív" : N === "passive" ? "Passzív" : N || "—", W = N === "active", Ce = Number((ke = p == null ? void 0 : p.system) == null ? void 0 : ke.replaceCost) >= 0 ? Number(p.system.replaceCost) : 0, Z = (((ue = p == null ? void 0 : p.system) == null ? void 0 : ue.description) ?? "").trim(), he = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CZhACgfN.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((y = r.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-CZhACgfN.mjs");
      l(this.actor, c, o);
      ...
      if (!y) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, y)) ?? ((w = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : w.call(_, (E) => E.id === y));
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const S = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, C = (S.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = C ? C.split(/\s*,\s*/).filter((L) => q.includes(L)) : [], w = _.filter((L) => {
              var E;
              return (((E = S[L]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (w.length > 0) {
              const E = {
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Q, me, Pe, Ae, Ee, Fe, Ne, we, pe, De, _e;
    ...
    e.weaponSlots = o.map((k) => {
      const A = d[k] ?? {}, F = (A.itemId ?? "").trim(), K = f.find((fe) => fe.id === F);
      return {
        slotKey: k,
        itemId: F,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const fe = !!F, G = (k == null ? void 0 : k.system) ?? {}, Ie = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", le = (l[ae] ?? ae) || "—", oe = G.size ?? "", ye = (y[oe] ?? oe) || "", ge = [le, ye].filter(Boolean).join(", ") || le || "—", $e = ae === "projectile" || oe === "thrown", xe = G.quantity != null ? String(G.quantity).trim() : "1", je = String(G.bonus ?? K.bonus ?? "").trim() || "0", Me = (G.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: F ?? "",
        itemId: A,
        actorId: t.id,
    ...
    const v = ((Ee = (Ae = t == null ? void 0 : t.system) == null ? void 0 : Ae.gear) == null ? void 0 : Ee.microchips) ?? {}, S = ["slot1", "slot2", "slot3"], C = a.filter((k) => k.type === "MikroChip");
    ...
    const w = (((Fe = e.weaponsTable) == null ? void 0 : Fe.length) ?? 0) > 0 || (((Ne = e.armorTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((we = e.microchipsTable) == null ? void 0 : we.length) ?? 0) > 0 || (((pe = e.itemsTable) == null ? void 0 : pe.length) ?? 0) > 0 || (((De = e.egyebList) == null ? void 0 : De.length) ?? 0) > 0;
    e.showEquipmentDropZone = !w;
    const L = ((_e = t == null ? void 0 : t.system) == null ? void 0 : _e.abilities) ?? {}, E = a.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var A, F;
      return {
        id: k.id,
        name: k.name,
    ...
    }), j = new Map(E.map((k) => [k.id, k])), H = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CZhACgfN.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), j = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = E === "active" ? "active" : "passive", B = Array.isArray((y = j[H]) == null ? void 0 : y.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const L = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (L.slotOrder ?? "").trim(), H = j ? j.split(/\s*,\s*/).filter((Q) => E.includes(Q)) : [];
      let B = E.find((Q) => {
        var me;
...
//# sourceMappingURL=vacuum-of-the-void-JH865J5J.mjs.map
