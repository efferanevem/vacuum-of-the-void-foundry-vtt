...
function ft(j) {
  ...
  const d = (i, r = 1) => {
    ...
    for (const a of i) {
      ...
      const b = !c && o >= 0 && (a.number === 3 || a.number === "3") ? (c = !0, s) : o >= 0 ? e : t;
      for (const v of y) {
  ...
  d(j.terms, 1);
  const n = s.filter((i) => i === 6).length, u = s.filter((i) => i === 1).length, g = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, p = n + g, h = u + m;
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((c = s.querySelector) == null ? void 0 : c.call(s, "form.votv.karakter-sheet")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, "form.votv")) ?? null, t = ((n = s.querySelector) == null ? void 0 : n.call(s, ".votv-scroll")) ?? ((u = s.querySelector) == null ? void 0 : u.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    const m = this.element, p = this.form ?? this.element, h = u.scrollState, i = u.focus, r = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", o = () => {
      var l, y;
      if (this._applyScrollState(m, h), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const b = ((l = p.querySelector) == null ? void 0 : l.call(p, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (y = p.querySelector) == null ? void 0 : y.call(p, `[name="${CSS.escape(i.name)}"]`) : null);
  ...
  static _healthStatusFromRatio(s, e) {
    ...
    if (c <= 0 || t <= 0) return 0;
    const d = Math.floor(c / 3), n = Math.floor(2 * c / 3);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const c = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((a = (o = c.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : a.value) ?? 0, n = ((l = c.currentHealth) == null ? void 0 : l.legs) ?? 0, u = U._healthStatusFromRatio(n, d), g = Number(((v = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((n = this.actor.system) == null ? void 0 : n.resources) ?? {}, c = ((g = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : g.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const c = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, d = ((m = (g = c.hitLocations) == null ? void 0 : g[t]) == null ? void 0 : m.value) ?? 0, n = ((p = c.currentHealth) == null ? void 0 : p[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const c = this.actor.system.resources ?? {}, d = c.hitLocations ?? {}, n = c.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const f of u) {
      const O = ((oe = d[f]) == null ? void 0 : oe.value) ?? 0, T = n[f] ?? 0;
      e.computedHealthStatus[f] = U._healthStatusFromRatio(T, O);
    }
    const g = (Number(n.head) || 0) === 0, p = ["torso", "arms", "legs"].filter((f) => (Number(n[f]) || 0) === 0).length;
    e.showDeathSkull = g || p >= 2;
    ...
    for (const [f, O] of Object.entries(y)) {
      const T = e.computedHealthStatus[O];
      e.skillHealthStatus[f] = T, e.skillDisabled[f] = T === 0 ? " disabled" : "", e.skillHasHealthTint[f] = !0;
    }
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (b.slotOrder ?? "").trim(), C = S ? S.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, D = q && typeof q == "object" && !Array.isArray(q) ? q : {}, w = (((Ke = D.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), L = (((qe = D.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = D.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, O) => {
      ...
      const Le = O && ((ke = f.system) != null && ke.damage) ? f.system.damage : "", Z = O && typeof ((de = f.system) == null ? void 0 : de.range) == "string" ? (f.system.range || "").trim() : "", he = Y ? Number((me = b[Y]) == null ? void 0 : me.bonus) || 0 : "";
      return {
        id: f.id,
        name: f.name,
        img: f.img,
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((f) => f.type === "MikroChip"), fe = we.map((f) => ({ id: f.id, name: f.name, img: f.img })), De = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], Ie = (f) => {
      var T, _, N;
      const O = [];
      return f !== 1 && O.push((((T = D.slot1) == null ? void 0 : T.itemId) ?? "").trim()), f !== 2 && O.push((((_ = D.slot2) == null ? void 0 : _.itemId) ?? "").trim()), f !== 3 && O.push((((N = D.slot3) == null ? void 0 : N.itemId) ?? "").trim()), O.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((f) => !Ie(1).includes(f.id)), e.microchipItemsSlot2 = fe.filter((f) => !Ie(2).includes(f.id)), e.microchipItemsSlot3 = fe.filter((f) => !Ie(3).includes(f.id)), e.microchipSlots = _e.map((f) => {
      const O = D[f] ?? {}, T = (O.itemId ?? "").trim(), _ = we.find((N) => N.id === T);
      return {
        slotKey: f,
        itemId: T,
      ...
      const O = `slot${f}`, T = D[O] ?? {}, _ = (T.itemId ?? "").trim(), N = fe.find((Y) => Y.id === _);
      e[`microchip${f}ItemId`] = _, e[`microchip${f}DisplayName`] = (N == null ? void 0 : N.name) || T.name || De, e[`microchip${f}Img`] = (N == null ? void 0 : N.img) || "";
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((f) => {
      ...
      const O = Ce[f] ?? {}, T = (O.itemId ?? "").trim(), _ = T ? E.get(T) : null, N = (_ == null ? void 0 : _.description) ?? "", Y = (_ == null ? void 0 : _.kp) ?? 0;
      return {
        itemId: T,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-Cq0n1gRJ.mjs");
      a(this.actor, o);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, a = ((y = r.textContent) == null ? void 0 : y.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-Cq0n1gRJ.mjs");
      l(this.actor, o, a);
      ...
      if (!a) return;
      const y = (((S = (((v = this.actor.system) == null ? void 0 : v.weapons) ?? {})[a]) == null ? void 0 : S.itemId) ?? "").trim();
      if (!y) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, y)) ?? ((w = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : w.call(D, (A) => A.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = a.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((D) => S.includes(D)) : [], q = C.find((D) => {
          var w;
          return (((w = b[D]) == null ? void 0 : w.itemId) ?? "").trim() === o;
        });
        if (q) {
          const D = C.filter((w) => w !== q);
          y["system.weapons.slotOrder"] = D.join(","), y[`system.weapons.${q}.itemId`] = "", y[`system.weapons.${q}.name`] = "", y[`system.weapons.${q}.damage`] = "", y[`system.weapons.${q}.bonus`] = "";
        }
      }
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((q = a == null ? void 0 : a.system) == null ? void 0 : q.damage) ?? "",
      ...
      v ? (C || (C = document.createElement("img"), C.className = "karakter-microchip-slot-thumb", C.alt = "", a == null || a.insertBefore(C, S)), C.src = v, C.style.display = "") : C && C.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const q = y ? this.actor.items.get(y) : null, D = {
      ...
      const a = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, y = ["slot1", "slot2", "slot3"].find((S) => {
        var C;
        return (((C = a[S]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((q = a.system) == null ? void 0 : q.damage) ?? "",
  ...
  _getFormDataForUpdate(s) {
    ...
    ), c = t.hitLocations ?? {}, d = t.currentHealth ?? {}, n = ["head", "torso", "arms", "legs"];
    for (const p of n) {
      const h = ((m = c[p]) == null ? void 0 : m.value) ?? 0, i = d[p] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${p}`, U._healthStatusFromRatio(i, h));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, c, d, n, u, g, m, p, h, i, r, o;
    if (e) {
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            ...
            v = ((p = (await y.createEmbeddedDocuments("Item", [S]))[0]) == null ? void 0 : p.id) ?? v;
          }
          if (b) {
            const S = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, C = (S.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = C ? C.split(/\s*,\s*/).filter((L) => q.includes(L)) : [], w = D.filter((L) => {
              var A;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((p = e.system) == null ? void 0 : p.kind) ?? "passive", c = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const u = n && n.name || t.name || `Fegyver (${s})`, g = Number(t.bonus || 0) || 0, p = (((v = n == null ? void 0 : n.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(c[p] || 0) || 0, i = g + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
  ...
  async _rollWeaponDamage(s, e = "") {
    var g, m, p, h, i, r, o, a, l, y;
    const t = this.actor;
    if (!t) return;
    let c = ((m = (g = t.items).get) == null ? void 0 : m.call(g, s)) ?? ((h = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : h.call(p, (b) => b.id === s));
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (t) {
      ...
      const r = document.activeElement, o = c.contains(r), a = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA");
      o && a && (d.focus = {
        name: r.name || null,
        id: r.id || null,
    ...
    const n = await super.render(s, e), u = this.element, g = this.form ?? this.element, m = d.scrollState, p = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var r, o;
      if (this._applyScrollState(u, m), (p == null ? void 0 : p.name) != null || (p == null ? void 0 : p.id) != null) {
        const a = ((r = g.querySelector) == null ? void 0 : r.call(g, p.id ? `#${CSS.escape(p.id)}` : null)) ?? (p.name ? (o = g.querySelector) == null ? void 0 : o.call(g, `[name="${CSS.escape(p.name)}"]`) : null);
        a && (a.tagName === "INPUT" || a.tagName === "TEXTAREA") && (a.focus({ preventScroll: !0 }), typeof a.selectionStart == "number" && (a.selectionStart = p.selectionStart ?? 0, a.selectionEnd = p.selectionEnd ?? p.selectionStart ?? 0));
      }
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, c = ((Fe = t == null ? void 0 : t.items) == null ? void 0 : Fe.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((k) => n.includes(k)) : [], m = c.filter((k) => k.type === "Fegyver"), p = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : n, r = n.filter((k) => !i.includes(k)), o = [...i, ...r], a = o.filter((k) => {
      var F;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const le = !!F, G = (k == null ? void 0 : k.system) ?? {}, Se = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", ue = (l[ae] ?? ae) || "—", oe = G.size ?? "", ye = (y[oe] ?? oe) || "", ge = [ue, ye].filter(Boolean).join(", ") || ue || "—", je = ae === "projectile" || oe === "thrown", Me = G.quantity != null ? String(G.quantity).trim() : "1", Re = String(G.bonus ?? K.bonus ?? "").trim() || "0", Ke = (G.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: F ?? "",
        itemId: E,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-Cq0n1gRJ.mjs");
      l(this.actor, o, a);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, a;
      i.preventDefault();
      ...
      var b, v, S, C, q, D;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, o = (C = (S = i.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : C.itemId;
      if (!r || !o || !this.actor) return;
      const a = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, y = (Array.isArray((D = a[r]) == null ? void 0 : D.items) ? a[r].items.slice() : []).filter((w) => w !== o);
      ...
      if (!r || !this.actor) return;
      const o = ((S = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : S.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((C) => {
        var q;
    ...
    const n = this, u = (i) => {
      ...
      Object.keys(r).length !== 0 && n.actor.update(r).catch((o) => console.warn("VoidNpcSheet save failed", o));
    }, g = (i) => {
      var r, o, a;
      return i && (((o = (r = n.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, i)) || n.id && ((a = i.closest) == null ? void 0 : a.call(i, `#${CSS.escape(n.id)}`)));
    };
    n._votvNpcBlur = (i) => {
      var y;
      const r = i.target;
      ...
      if (!g(a)) return;
      const l = i.relatedTarget;
      l && (a.contains(l) || n.id && ((y = l.closest) != null && y.call(l, `#${CSS.escape(n.id)}`))) || u(a);
    }, document.body.addEventListener("blur", n._votvNpcBlur, !0), n._votvNpcItemHookRegistered || (n._votvNpcItemUpdateHook = (i, r, o) => {
      var a;
      n.actor && ((a = i == null ? void 0 : i.parent) == null ? void 0 : a.id) === n.actor.id && n.render(!0);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const c = ((m = (g = t.items).get) == null ? void 0 : m.call(g, s)) ?? ((h = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : h.call(p, (b) => b.id === s));
    if (!c || c.type !== "Fegyver") return;
    let d = (((i = c.system) == null ? void 0 : i.damage) ?? "").trim();
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (y = (o = ui.notifications) == null ? void 0 : o.warn) == null || y.call(o, ((l = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : l.call(a, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var p, h, i, r, o, a, l, y, b, v, S, C, q, D, w;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((r = d.parent) == null ? void 0 : r.id) !== n.id) {
        ...
        L = ((o = (await n.createEmbeddedDocuments("Item", [ne]))[0]) == null ? void 0 : o.id) ?? L;
      }
      const A = (((a = d.system) == null ? void 0 : a.kind) ?? "passive").toString(), M = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", B = Array.isArray((y = M[H]) == null ? void 0 : y.items) ? M[H].items.slice() : Array.isArray(M[H]) ? M[H].slice() : [];
    ...
    if (d.type === "MikroChip" && m) {
      const L = ((w = (D = n.system) == null ? void 0 : D.gear) == null ? void 0 : w.microchips) ?? {}, M = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", c = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${n}</p>
      ${u}
      ${g}
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (n) => {
      var g, m, p;
      const u = ((g = n.target) == null ? void 0 : g.form) ?? ((p = (m = n.target) == null ? void 0 : m.closest) == null ? void 0 : p.call(m, "form"));
      d(u) && c(u);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, g, m) => {
    ...
    if (!p) return;
    const h = document.activeElement, i = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), r = [], o = (v = game.actors) == null ? void 0 : v.get(p);
    ...
    const y = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, b = y && Date.now() - y.at < j ? y.appId : null;
    setTimeout(() => {
      for (const w of r)
    ...
    for (const [l, y] of Object.entries(h)) {
      ...
      !b || b !== n.id || (i[`system.weapons.${l}.name`] = n.name ?? "", i[`system.weapons.${l}.damage`] = ((o = n.system) == null ? void 0 : o.damage) ?? "", i[`system.weapons.${l}.bonus`] = ((a = n.system) == null ? void 0 : a.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (m = (g = e.target) == null ? void 0 : g.closest) == null ? void 0 : m.call(g, "[data-document-id]"), c = (p = t == null ? void 0 : t.getAttribute) == null ? void 0 : p.call(t, "data-document-id");
      if (!c) return;
    ...
    }, d = ((p = game.actors) == null ? void 0 : p.filter((i) => i.type === "Npc")) ?? [];
    for (const i of d)
      try {
        await i.update({
          "prototypeToken.bar1.attribute": "",
...
Hooks.on("preCreateToken", (j, s, e) => {
  var n, u;
  const t = (n = game.votv) == null ? void 0 : n._dragSourceActorId, c = t ?? j.actorId ?? null;
...
Hooks.on("renderChatMessageHTML", (j, s, e) => {
  ...
  if (n && (c && n.classList.add(`votv-${c}`), d)) {
...
//# sourceMappingURL=vacuum-of-the-void-DUhvA4O5.mjs.map
