...
const { HTMLField: ai, NumberField: F, SchemaField: H, StringField: C, BooleanField: me, ArrayField: _t } = foundry.data.fields;
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (O.slotOrder ?? "").trim(), z = M ? M.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], U = (Ze = this.actor.system.gear) == null ? void 0 : Ze.microchips, R = U && typeof U == "object" && !Array.isArray(U) ? U : {}, J = (((Ye = R.slot1) == null ? void 0 : Ye.itemId) ?? "").trim(), X = (((Ft = R.slot2) == null ? void 0 : Ft.itemId) ?? "").trim(), Z = (((At = R.slot3) == null ? void 0 : At.itemId) ?? "").trim(), K = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-CXceuatL.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CXceuatL.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-CXceuatL.mjs");
      h(this.actor, o, m);
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const O = ((qt = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : qt.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], M = c.filter((I) => I.type === "MikroChip");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CXceuatL.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CXceuatL.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-CXceuatL.mjs");
      m(this.actor, r, o);
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const q = (((he = this.actor.items) == null ? void 0 : he.contents) ?? []).filter((D) => D.type === "Egyeb");
    return e.egyebList = q.map((D) => {
  ...
  Hooks.on("updateActor", (d, c, u, y) => {
    ...
    if ((d.type === "Karakter" || d.type === "Npc") && ((w = c == null ? void 0 : c.system) != null && w.combat) && "initiativeResult" in c.system.combat) {
      ...
      if (oe) {
        ...
        for (const he of ve)
          if (((q = he.actor) == null ? void 0 : q.id) === a || he.actorId === a) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, _, O, q, M, z, U, R, J, X, Z, Y, K, V, oe, ve, he, D;
    ...
    if (d || (d = ((M = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : M.flatMap((W) => {
      var te;
...
//# sourceMappingURL=vacuum-of-the-void-DIQL8jZ4.mjs.map
