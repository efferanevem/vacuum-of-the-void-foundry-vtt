...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BG51o0QF.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((g = r.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-BG51o0QF.mjs");
      l(this.actor, c, o);
      ...
      if (!g) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, g)) ?? ((w = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : w.call(D, (A) => A.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = o.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((D) => S.includes(D)) : [], q = C.find((D) => {
          var w;
          return (((w = b[D]) == null ? void 0 : w.itemId) ?? "").trim() === c;
        });
        if (q) {
          const D = C.filter((w) => w !== q);
          g["system.weapons.slotOrder"] = D.join(","), g[`system.weapons.${q}.itemId`] = "", g[`system.weapons.${q}.name`] = "", g[`system.weapons.${q}.damage`] = "", g[`system.weapons.${q}.bonus`] = "";
        }
      }
      ...
      const q = g ? this.actor.items.get(g) : null, D = {
        [`system.gear.microchips.${l}.itemId`]: g,
        [`system.gear.microchips.${l}.name`]: (q == null ? void 0 : q.name) ?? ""
      };
      g && (D[`system.gear.microchips.${l}.active`] = !0), await this.actor.update(D);
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const S = ((h = g.system) == null ? void 0 : h.weapons) ?? {}, C = (S.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = C ? C.split(/\s*,\s*/).filter((L) => q.includes(L)) : [], w = D.filter((L) => {
              var A;
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-BG51o0QF.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, g = (Array.isArray((D = o[r]) == null ? void 0 : D.items) ? o[r].items.slice() : []).filter((w) => w !== c);
  ...
  async _onDropItem(s, e) {
    var p, h, i, r, c, o, l, g, b, v, S, C, q, D, w;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), j = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", B = Array.isArray((g = j[H]) == null ? void 0 : g.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, y, m) => {
    ...
    const g = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, b = g && Date.now() - g.at < M ? g.appId : null;
    setTimeout(() => {
      for (const w of r)
...
//# sourceMappingURL=vacuum-of-the-void-C27X1ifp.mjs.map
