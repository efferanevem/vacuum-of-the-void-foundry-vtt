...
var Z = (I, s, e) => Vs(I, typeof s != "symbol" ? s + "" : s, e);
var z = (I, s, e) => Gs(Bs(I), e, s);
const { HTMLField: Ws, NumberField: F, SchemaField: U, StringField: O, BooleanField: le, ArrayField: kt } = foundry.data.fields;
      ...
      resources: new U({
        ...
        hitLocations: new U({
          head: new U({
            ...
            box1: new le({ required: !1, initial: !1 }),
            box2: new le({ required: !1, initial: !1 }),
            box3: new le({ required: !1, initial: !1 })
          }),
          torso: new U({
            value: new F({ required: !1, integer: !0, min: 0, initial: 0 }),
            box1: new le({ required: !1, initial: !1 }),
      ...
      gear: new U({
        microchips: new U({
          slot1: new U({
            itemId: new O({ required: !1, blank: !0, initial: "" }),
            name: new O({ required: !1, blank: !0, initial: "" }),
            active: new le({ required: !1, initial: !1 })
          }),
          slot2: new U({
            itemId: new O({ required: !1, blank: !0, initial: "" }),
            name: new O({ required: !1, blank: !0, initial: "" }),
...
const { BooleanField: Zs, NumberField: gi, StringField: $e } = foundry.data.fields;
class ps extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      bonus: new $e({ required: !1, blank: !0, initial: "" }),
      damage: new $e({
        required: !1,
        blank: !0,
        initial: ""
      }),
      range: new $e({ required: !1, blank: !0, initial: "" }),
      special: new $e({ required: !1, blank: !0, initial: "" }),
      quantity: new $e({ required: !1, blank: !0, initial: "1" }),
      /** Jártasság kulcs (pl. grenadeUse, firearms) – ezt a bónuszt adja hozzá a támadáshoz. Alapértelmezett: Kézifegyver Használat. */
      skillKey: new $e({ required: !1, blank: !0, initial: "grenadeUse" })
    };
  }
}
const { BooleanField: ei, StringField: Ft } = foundry.data.fields;
...
const { NumberField: xt, StringField: tt, SchemaField: bs, ArrayField: oi } = foundry.data.fields;
class ci extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      abilities: new bs({
        items: new oi(
          new tt({ required: !1, blank: !0 }),
          { required: !1, initial: [] }
        )
      }),
      /** Sebesség (szabad szöveg, opcionális). */
      speed: new tt({ required: !1, blank: !0, initial: "" }),
      /** Hatótáv (szabad szöveg, opcionális). */
      range: new tt({ required: !1, blank: !0, initial: "" }),
      /** Raktár (szabad szöveg, opcionális). */
      storage: new tt({ required: !1, blank: !0, initial: "" }),
      /** Sebzés (szabad szöveg, opcionális). */
      damage: new tt({ required: !1, blank: !0, initial: "" }),
      /** Találati érték (szabad szöveg, opcionális). */
      hit: new tt({ required: !1, blank: !0, initial: "" })
    };
  }
}
function Rt(I) {
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  static getTotalSpeedRaw(s) {
    ...
    const e = s.system.resources ?? {}, t = ((y = (f = e.hitLocations) == null ? void 0 : f.legs) == null ? void 0 : y.value) ?? 0, n = ((r = e.currentHealth) == null ? void 0 : r.legs) ?? 0, p = Y._healthStatusFromRatio(n, t);
    if (p === 0) return 0;
    const l = Number(((o = (i = s.system) == null ? void 0 : i.combat) == null ? void 0 : o.givenSpeed) ?? 0) || 0;
    let m;
    p === 1 ? m = -6 : p === 2 ? m = -3 : m = l, m += Y._getTotalArmorSpeedPenaltyStatic(s);
  ...
  static getTotalSpeed(s) {
    var e, t;
    return (t = (e = s == null ? void 0 : s.statuses) == null ? void 0 : e.has) != null && t.call(e, "immobilized") ? 0 : Y.getTotalSpeedRaw(s);
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((a = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : a.resources) ?? {}, p = ((h = (g = n.hitLocations) == null ? void 0 : g.legs) == null ? void 0 : h.value) ?? 0, l = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, m = Y._healthStatusFromRatio(l, p), u = Number(((D = (S = (w = this.actor) == null ? void 0 : w.system) == null ? void 0 : S.combat) == null ? void 0 : D.givenSpeed) ?? 0) || 0;
    let d;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var d, f, y, r, i, o, c, a, g, h, v, w, S;
    const e = s ?? this.form ?? this.element;
    let t = (d = e == null ? void 0 : e.querySelector) == null ? void 0 : d.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((r = (y = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : y.combat) == null ? void 0 : r.givenProtection) ?? 0) || 0, p = (c = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && c.call(o, "lookaround") ? 1 : 0, l = (h = (g = (a = this.actor) == null ? void 0 : a.statuses) == null ? void 0 : g.has) != null && h.call(g, "halfcover") ? 3 : 0, m = (S = (w = (v = this.actor) == null ? void 0 : v.statuses) == null ? void 0 : w.has) != null && S.call(w, "threequarteredcover") ? 6 : 0, u = n + this._getTotalArmorProtectionBonus() + p + l + m;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const u = ((v = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : v.resources) ?? {}, d = ((S = (w = u.hitLocations) == null ? void 0 : w.legs) == null ? void 0 : S.value) ?? 0, f = ((D = u.currentHealth) == null ? void 0 : D.legs) ?? 0;
    if (Y._healthStatusFromRatio(f, d) === 0) {
      n.textContent = "0";
      return;
    }
  ...
  _getSkillHealthStatus(s) {
    var l, m, u, d;
    const e = Y.BODY_PART_BY_SKILL[s];
    if (e == null) return;
    ...
    return Y._healthStatusFromRatio(p, n);
  }
  /** Static: health status 0–3 for skill on an actor (used by roll sheet without sheet instance). */
  static _getSkillHealthStatusStatic(s, e) {
    var m, u, d, f;
    const t = Y.BODY_PART_BY_SKILL[e];
    if (t == null) return;
    ...
    return Y._healthStatusFromRatio(l, p);
  }
  async _prepareContext(s) {
    var rt, ot, ct, lt, ut, dt, mt, pt, ft, He, yt, gt, Be, k, R, M, B, fe, te, Ie, ve, ye, Ne, Ge, Ve, Ct, qt, Lt, Nt, ht, Ze, Jt, Yt, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((ct = (ot = (rt = this.actor.system) == null ? void 0 : rt.resources) == null ? void 0 : ot.stress) == null ? void 0 : ct.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, p = n.hitLocations ?? {}, l = n.currentHealth ?? {}, m = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const b of m) {
      const N = ((lt = p[b]) == null ? void 0 : lt.value) ?? 0, L = l[b] ?? 0;
      e.computedHealthStatus[b] = Y._healthStatusFromRatio(L, N);
    }
    const u = (Number(l.head) || 0) === 0, f = ["torso", "arms", "legs"].filter((b) => (Number(l[b]) || 0) === 0).length;
    e.showDeathSkull = u || f >= 2;
    const y = e.computedHealthStatus.legs ?? 3, r = Number(((dt = (ut = this.actor.system) == null ? void 0 : ut.combat) == null ? void 0 : dt.givenSpeed) ?? 0) || 0;
    let i;
    y === 0 ? i = 0 : y === 1 ? i = -6 : y === 2 ? i = -3 : i = r;
    const o = this._getTotalArmorSpeedPenalty();
    i += o, e.effectiveGivenSpeed = i;
    const c = Number(((pt = (mt = this.actor.system) == null ? void 0 : mt.combat) == null ? void 0 : pt.givenProtection) ?? 0) || 0, a = (yt = (He = (ft = this.actor) == null ? void 0 : ft.statuses) == null ? void 0 : He.has) != null && yt.call(He, "lookaround") ? 1 : 0, g = (k = (Be = (gt = this.actor) == null ? void 0 : gt.statuses) == null ? void 0 : Be.has) != null && k.call(Be, "halfcover") ? 3 : 0, h = (B = (M = (R = this.actor) == null ? void 0 : R.statuses) == null ? void 0 : M.has) != null && B.call(M, "threequarteredcover") ? 6 : 0, v = c + this._getTotalArmorProtectionBonus() + a + g + h;
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: v } },
      { inplace: !1 }
    );
    const w = ((fe = e.system) == null ? void 0 : fe.combat) ?? {};
    e.totalDefense = (Number(w.defense) || 0) + (Number(w.defenseBonus) || 0) + (Number(w.givenProtection) || 0);
    const S = Number(w.givenSpeed);
    let D = (Number(w.speed) || 0) + (Number(w.speedBonus) || 0) + (Number.isFinite(S) ? S : 0);
    y === 0 && (D = 0), (ve = (Ie = (te = this.actor) == null ? void 0 : te.statuses) == null ? void 0 : Ie.has) != null && ve.call(Ie, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Ne = (ye = e.system) == null ? void 0 : ye.combat) == null ? void 0 : Ne.givenProtection } },
      { inplace: !1 }
    ), D = 0), e.totalSpeed = D;
    const C = Y.BODY_PART_BY_SKILL;
    ...
    const _ = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (_.slotOrder ?? "").trim(), E = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], G = (Ge = this.actor.system.gear) == null ? void 0 : Ge.microchips, V = G && typeof G == "object" && !Array.isArray(G) ? G : {}, W = (((Ve = V.slot1) == null ? void 0 : Ve.itemId) ?? "").trim(), J = (((Ct = V.slot2) == null ? void 0 : Ct.itemId) ?? "").trim(), T = (((qt = V.slot3) == null ? void 0 : qt.itemId) ?? "").trim(), A = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      const L = typeof b.sort == "number" ? b.sort : 0, P = typeof N.sort == "number" ? N.sort : 0;
      return L - P;
    }).map((b) => {
      var Fe, Je, Ye, Ee, Pe, bt;
      const N = b.type === "Fegyver", L = b.type === "MikroChip";
      let P = 0, K = "", oe = null;
      for (let et = 0; et < E.length; et++) {
        const vt = E[et];
        if ((((Fe = _[vt]) == null ? void 0 : Fe.itemId) ?? "") === b.id) {
          P = et + 1, K = ((Je = _[vt]) == null ? void 0 : Je.bonus) ?? "", oe = vt;
          break;
        }
      }
      let se = null;
      L && (W === b.id ? se = "slot1" : J === b.id ? se = "slot2" : T === b.id && (se = "slot3"));
      const We = N && ((Ye = b.system) != null && Ye.damage) ? b.system.damage : "", ge = N && typeof ((Ee = b.system) == null ? void 0 : Ee.range) == "string" ? (b.system.range || "").trim() : "", ke = oe ? Number((Pe = _[oe]) == null ? void 0 : Pe.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
        ...
        rangeStr: ge,
        slotBonusNum: ke,
        quantity: Number(((bt = b.system) == null ? void 0 : bt.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = A;
    const H = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).filter((b) => b.type === "Fegyver"), Q = H.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = Q;
    const ie = "— Nincs fegyver —", ce = E.filter((b) => {
      const L = ((_[b] ?? {}).itemId ?? "").trim();
      return L ? !!H.find((K) => K.id === L) : !1;
    });
    e.weaponSlots = ce.map((b, N) => {
      const L = _[b] ?? {}, P = (L.itemId ?? "").trim(), K = Q.find((ke) => ke.id === P), oe = H.find((ke) => ke.id === P), se = (oe == null ? void 0 : oe.system) ?? {}, We = se.size === "thrown", ge = (typeof se.range == "string" ? (se.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: P,
        slotNum: N + 1,
        displayName: (K == null ? void 0 : K.name) || L.name || ie,
    ...
    const ae = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ee = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((b) => {
      var ls, us, ds;
      const N = b.id;
      let L = null, P = {};
      for (const Et of E)
      ...
      const K = !!L, oe = ((us = b.system) == null ? void 0 : us.equipped) !== void 0 && ((ds = b.system) == null ? void 0 : ds.equipped) !== null ? !!b.system.equipped : K, se = (b == null ? void 0 : b.system) ?? {}, We = typeof se.range == "string" ? (se.range || "").trim() : "", ge = se.type ?? "", ke = (ae[ge] ?? ge) || "—", Fe = se.size ?? "", Je = (ee[Fe] ?? Fe) || "", Ye = [ke, Je].filter(Boolean).join(", ") || ke || "—", Ee = ge === "projectile" || Fe === "thrown", Pe = se.quantity, bt = Pe != null ? String(Pe).trim() : "1", et = String(P.bonus ?? "").trim(), vt = String(se.bonus ?? "").trim(), Us = et || vt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? ie,
        ...
        typeAndSize: Ye,
        quantity: bt,
        quantityDisplay: Ee ? bt : "—",
        isProjectile: Ee,
        equipped: oe,
        special: (se.special ?? "").trim() || "—"
      };
    });
    const ne = (((Nt = this.actor.items) == null ? void 0 : Nt.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = ne.map((b) => {
      var P, K;
      const N = (b == null ? void 0 : b.system) ?? {}, L = ((P = b.system) == null ? void 0 : P.equipped) !== void 0 && ((K = b.system) == null ? void 0 : K.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    const we = (((ht = this.actor.items) == null ? void 0 : ht.contents) ?? []).filter((b) => b.type === "Targy");
    e.itemsTable = we.map((b) => {
      const N = (b == null ? void 0 : b.system) ?? {}, L = (N.description ?? "").trim(), P = L ? L.length > 60 ? L.slice(0, 57) + "…" : L : "—", K = N.quantity != null ? String(N.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const qe = (((Ze = this.actor.items) == null ? void 0 : Ze.contents) ?? []).filter((b) => b.type === "Egyeb");
    ...
    const xe = (((Jt = this.actor.items) == null ? void 0 : Jt.contents) ?? []).filter((b) => b.type === "MikroChip"), ue = xe.map((b) => ({ id: b.id, name: b.name, img: b.img })), Re = "— Nincs Mikro-Chip —", X = ["slot1", "slot2", "slot3"], pe = (b) => {
      var L, P, K;
      const N = [];
      return b !== 1 && N.push((((L = V.slot1) == null ? void 0 : L.itemId) ?? "").trim()), b !== 2 && N.push((((P = V.slot2) == null ? void 0 : P.itemId) ?? "").trim()), b !== 3 && N.push((((K = V.slot3) == null ? void 0 : K.itemId) ?? "").trim()), N.filter(Boolean);
    };
    e.microchipItemsSlot1 = ue.filter((b) => !pe(1).includes(b.id)), e.microchipItemsSlot2 = ue.filter((b) => !pe(2).includes(b.id)), e.microchipItemsSlot3 = ue.filter((b) => !pe(3).includes(b.id)), e.microchipSlots = X.map((b) => {
      const N = V[b] ?? {}, L = (N.itemId ?? "").trim(), P = xe.find((K) => K.id === L);
      return {
        slotKey: b,
        itemId: L,
      ...
      const N = `slot${b}`, L = V[N] ?? {}, P = (L.itemId ?? "").trim(), K = ue.find((oe) => oe.id === P);
      e[`microchip${b}ItemId`] = P, e[`microchip${b}DisplayName`] = (K == null ? void 0 : K.name) || L.name || Re, e[`microchip${b}Img`] = (K == null ? void 0 : K.img) || "";
    }), e.microchipsTable = xe.map((b) => {
      var Fe, Je, Ye, Ee;
      const N = b.id;
      let L = null;
      for (const Pe of X)
        if ((((Fe = V[Pe]) == null ? void 0 : Fe.itemId) ?? "").trim() === N) {
          L = Pe;
          break;
        }
      const P = !!L, K = ((Je = b == null ? void 0 : b.system) == null ? void 0 : Je.abilityType) ?? "", oe = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", se = K === "active", We = Number((Ye = b == null ? void 0 : b.system) == null ? void 0 : Ye.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, ge = (((Ee = b == null ? void 0 : b.system) == null ? void 0 : Ee.description) ?? "").trim(), ke = ge ? ge.length > 60 ? ge.slice(0, 57) + "…" : ge : "—";
      return {
        itemId: N,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const re = (((Yt = e.weaponsTable) == null ? void 0 : Yt.length) ?? 0) > 0 || (((Xt = e.armorTable) == null ? void 0 : Xt.length) ?? 0) > 0 || (((Qt = e.microchipsTable) == null ? void 0 : Qt.length) ?? 0) > 0 || (((Zt = e.itemsTable) == null ? void 0 : Zt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !re;
    const Xe = this.actor.system.abilities ?? {}, It = (((es = this.actor.items) == null ? void 0 : es.contents) ?? []).map((b) => {
      var N, L, P;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Le = new Map(It.map((b) => [b.id, b])), Me = "— Nincs képesség —", st = (b) => {
      const N = Xe[b] ?? {}, L = (N.itemId ?? "").trim(), P = L ? Le.get(L) : null, K = (P == null ? void 0 : P.description) ?? "", oe = (P == null ? void 0 : P.kp) ?? 0;
      return {
        itemId: L,
    ...
    e.abilityFajiSlot = st("faji"), e.abilityHatterSlot = st("hatter");
    const it = (b) => {
      const N = Xe[b];
    ...
    e.abilityPassiveList = nt(it("passive")), e.abilityActiveList = nt(it("active"));
    const St = ((ts = e.system) == null ? void 0 : ts.resources) ?? {}, Qe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], je = (is = (ss = e.system) == null ? void 0 : ss.combat) == null ? void 0 : is.initiativeResult, be = typeof je == "number" ? je : -1, Tt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ke = (as = (ns = e.system) == null ? void 0 : ns.combat) == null ? void 0 : as.initiativeRanges, ze = Array.isArray(Ke) ? Ke.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ae = (ze.length > 0 ? ze : Tt).slice().sort((b, N) => b.min - N.min), Ue = ze.map((b) => b.min), Dt = Ue.length ? Math.min(...Ue) : 0, _t = Ue.length ? Math.max(...Ue) : 0;
    e.initiativeRanges = ze.map((b) => ({ ...b, isFirst: b.min === Dt, isLast: b.min === _t }));
    let at = 0;
    if (typeof be == "number" && be >= 0 && Ae.length > 0) {
      const b = Ae[0], N = Ae[Ae.length - 1];
      let L = null;
      be <= b.max ? L = b : be >= N.min ? L = N : L = Ae.find((P) => be >= P.min && be <= P.max), L && (at = L.kp);
    }
    e.kpDots = Qe.map((b, N) => {
      const L = N + 1, P = !!Number(St[b]), K = L <= at;
      return { index: L, used: P, usable: K };
    });
    const Ot = !!((os = (rs = game.combat) == null ? void 0 : rs.combatants) != null && os.some((b) => {
      var N;
      return ((N = b.actor) == null ? void 0 : N.type) === "Karakter";
    }));
    return e.showHarcSection = Ot, e.canEditInitiative = !!((cs = game.user) != null && cs.isGM), e.showInitiativeResult = typeof je == "number", e.initiativeResult = e.showInitiativeResult ? je : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DjcELlrK.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-DjcELlrK.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-DjcELlrK.mjs");
      g(this.actor, c, a);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((g == null ? void 0 : g.type) === "Fegyver") {
        const v = a.system.weapons ?? {}, w = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = w ? w.split(/\s*,\s*/).filter((_) => S.includes(_)) : [], C = D.find((_) => {
          var q;
      ...
      const g = this.actor.system.weapons ?? {}, h = (g.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], w = h ? h.split(/\s*,\s*/).filter((q) => v.includes(q)) : [], S = w.find((q) => {
        var j;
      ...
      if (o.checked) {
        ...
        let q = w.find((E) => {
          var G;
          return !((G = g[E]) != null && G.itemId);
        });
        const j = new Set(w);
        if (!q) {
          const E = v.find((G) => !j.has(G));
          if (!E) return;
          q = E, w.push(E);
        }
      ...
      if (!g) return;
      const h = (o.dataset.itemId ?? "").trim(), v = (o.dataset.itemName ?? ((q = o.textContent) == null ? void 0 : q.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", w = (o.dataset.itemImg ?? "").trim(), S = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      let D = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      w ? (D || (D = document.createElement("img"), D.className = "karakter-microchip-slot-thumb", D.alt = "", a == null || a.insertBefore(D, S)), D.src = w, D.style.display = "") : D && D.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      ...
      if (!o || !c) return;
      const a = this.actor.system.abilities ?? {}, h = (Array.isArray((v = a[o]) == null ? void 0 : v.items) ? a[o].items.slice() : []).filter((w) => w !== c);
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const f of l) {
      ...
      foundry.utils.setProperty(e, `system.resources.healthStatus.${f}`, Y._healthStatusFromRatio(r, y));
    }
    return e;
  }
    ...
    if (e) {
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && (a.type === "Kepesseg" || a.type === "ability")) {
          ...
          const w = h === "active" ? "active" : "passive", S = Array.isArray((m = v[w]) == null ? void 0 : m.items) ? v[w].items.slice() : Array.isArray(v[w]) ? v[w].slice() : [];
          S.includes(g) || S.push(g), await this.actor.update({ [`system.abilities.${w}.items`]: S });
          return;
        }
      }
    }
      ...
      if (c) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            ...
            v = ((f = (await g.createEmbeddedDocuments("Item", [w]))[0]) == null ? void 0 : f.id) ?? v;
          }
          if (h) {
            const w = ((y = g.system) == null ? void 0 : y.weapons) ?? {}, S = (w.slotOrder ?? "").trim(), D = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = S ? S.split(/\s*,\s*/).filter((q) => D.includes(q)) : [], _ = C.filter((q) => {
              var j;
              return (((j = w[q]) == null ? void 0 : j.itemId) ?? "").trim() === v;
            });
            if (_.length > 0) {
              const j = {
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: f, label: y } = Rt(d), r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return d.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const m = l && l.name || t.name || `Fegyver (${s})`, u = Number(t.bonus || 0) || 0, d = ((w = l == null ? void 0 : l.system) == null ? void 0 : w.type) || "kinetic", f = (((S = l == null ? void 0 : l.system) == null ? void 0 : S.skillKey) ?? "").trim(), y = f && n[f] !== void 0 ? f : d === "explosive" ? "grenadeUse" : "firearms", r = Number(n[y] || 0) || 0, i = u + r, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(c);
...
Z(Y, "PARTS", foundry.utils.mergeObject(
  z(Y, Y, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
  },
  { inplace: !1 }
)), Z(Y, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(Y, Y, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((vs = z(Y, Y, "DEFAULT_OPTIONS")) == null ? void 0 : vs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((ks = z(Y, Y, "DEFAULT_OPTIONS")) == null ? void 0 : ks.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Is = (ws = z(Y, Y, "DEFAULT_OPTIONS")) == null ? void 0 : ws.window) == null ? void 0 : Is.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const de = class de extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var st, it, nt, St, Qe, je, be, Tt, Ke, ze, At, Ae, Ue, Dt, _t, at, Ot, rt, ot, ct, lt, ut, dt, mt, pt, ft, He, yt, gt, Be;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((st = this.actor) == null ? void 0 : st.system), e.showDeathSkull = !1, e.sizeForSelect = (((nt = (it = e.system) == null ? void 0 : it.identity) == null ? void 0 : nt.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((St = e.system) == null ? void 0 : St.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, l = (je = (Qe = t == null ? void 0 : t.statuses) == null ? void 0 : Qe.has) != null && je.call(Qe, "lookaround") ? 1 : 0, m = (Tt = (be = t == null ? void 0 : t.statuses) == null ? void 0 : be.has) != null && Tt.call(be, "halfcover") ? 3 : 0, u = (ze = (Ke = t == null ? void 0 : t.statuses) == null ? void 0 : Ke.has) != null && ze.call(Ke, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = p + l + m + u;
    const d = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], f = ((Ae = t == null ? void 0 : t.system) == null ? void 0 : Ae.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (f.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((k) => y.includes(k)) : [], o = d.filter((k) => k.type === "Fegyver"), c = o.map((k) => ({ id: k.id, name: k.name, img: k.img })), a = "— Nincs fegyver —", g = i.length > 0 ? i : y, h = y.filter((k) => !g.includes(k)), v = [...g, ...h], w = v.filter((k) => {
      var M;
      const R = (((M = f[k]) == null ? void 0 : M.itemId) ?? "").trim();
      return R && o.some((B) => B.id === R);
    });
    e.weaponSlots = w.map((k) => {
      const R = f[k] ?? {}, M = (R.itemId ?? "").trim(), B = c.find((ye) => ye.id === M), fe = o.find((ye) => ye.id === M), te = (fe == null ? void 0 : fe.system) ?? {}, Ie = te.size === "thrown", ve = (typeof te.range == "string" ? (te.range || "").trim() : "") || "—";
      return {
        slotKey: k,
        itemId: M,
        displayName: (B == null ? void 0 : B.name) || R.name || a,
        img: (B == null ? void 0 : B.img) || "",
        isThrown: Ie,
        rangeStr: ve
      };
    ...
    e.weaponsTable = o.map((k) => {
      ...
      let M = null, B = {};
      for (const Ze of v)
        if ((((ht = f[Ze]) == null ? void 0 : ht.itemId) ?? "").trim() === R) {
          M = Ze, B = f[Ze] ?? {};
          break;
        }
      const fe = !!M, te = (k == null ? void 0 : k.system) ?? {}, Ie = typeof te.range == "string" ? (te.range || "").trim() : "", ve = te.type ?? "", ye = (S[ve] ?? ve) || "—", Ne = te.size ?? "", Ge = (D[Ne] ?? Ne) || "", Ve = [ye, Ge].filter(Boolean).join(", ") || ye || "—", Ct = ve === "projectile" || Ne === "thrown", qt = te.quantity != null ? String(te.quantity).trim() : "1", Lt = String(te.bonus ?? B.bonus ?? "").trim() || "0", Nt = (te.damage ?? B.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: R,
        actorId: t.id,
    ...
    e.armorTable = C.map((k) => {
      var B;
      const R = (k == null ? void 0 : k.system) ?? {}, M = ((B = k.system) == null ? void 0 : B.equipped) === !0;
      return {
        itemId: k.id,
        actorId: t.id,
        ...
        level: di((R.level ?? "").toString().trim()),
        special: (R.special ?? R.other ?? "").toString().trim() || "—",
        equipped: M
      };
    });
    const _ = ((Dt = (Ue = t == null ? void 0 : t.system) == null ? void 0 : Ue.gear) == null ? void 0 : Dt.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], j = d.filter((k) => k.type === "MikroChip");
    e.microchipsTable = j.map((k) => {
      var ve, ye, Ne, Ge;
      const R = k.id;
      let M = null;
      for (const Ve of q)
        if ((((ve = _[Ve]) == null ? void 0 : ve.itemId) ?? "").trim() === R) {
          M = Ve;
          break;
        }
      const B = ((ye = k == null ? void 0 : k.system) == null ? void 0 : ye.abilityType) ?? "", fe = B === "active" ? "Aktív" : B === "passive" ? "Passzív" : B || "—", te = (((Ne = k == null ? void 0 : k.system) == null ? void 0 : Ne.description) ?? "").trim(), Ie = te ? te.length > 60 ? te.slice(0, 57) + "…" : te : "—";
      return {
        itemId: R,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        ...
        typeLabel: fe,
        description: Ie,
        kp: Number((Ge = k == null ? void 0 : k.system) == null ? void 0 : Ge.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: B === "active",
        slotKey: M ?? "",
        equipped: !!M
      };
    ...
    e.itemsTable = E.map((k) => {
      const R = (k == null ? void 0 : k.system) ?? {}, M = (R.description ?? "").trim(), B = M ? M.length > 60 ? M.slice(0, 57) + "…" : M : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        img: (k == null ? void 0 : k.img) ?? "",
        quantity: R.quantity != null ? String(R.quantity).trim() : "1",
        description: B
      };
    });
    const G = d.filter((k) => k.type === "Egyeb");
    e.egyebList = G.map((k) => {
      const M = (((k == null ? void 0 : k.system) ?? {}).description ?? "").trim(), B = M ? M.length > 80 ? M.slice(0, 77) + "…" : M : "";
      return {
        itemId: k.id,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const V = (((_t = e.weaponsTable) == null ? void 0 : _t.length) ?? 0) > 0 || (((at = e.armorTable) == null ? void 0 : at.length) ?? 0) > 0 || (((Ot = e.microchipsTable) == null ? void 0 : Ot.length) ?? 0) > 0 || (((rt = e.itemsTable) == null ? void 0 : rt.length) ?? 0) > 0 || (((ot = e.egyebList) == null ? void 0 : ot.length) ?? 0) > 0;
    e.showEquipmentDropZone = !V;
    const W = ((ct = t == null ? void 0 : t.system) == null ? void 0 : ct.abilities) ?? {}, J = d.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var R, M, B;
      return {
        id: k.id,
        name: k.name,
        img: k.img,
        description: ((R = k.system) == null ? void 0 : R.description) ?? "",
        kp: Number(((M = k.system) == null ? void 0 : M.kp) ?? 0) || 0,
        kind: (((B = k.system) == null ? void 0 : B.kind) ?? "passive").toString()
      };
    }), T = new Map(J.map((k) => [k.id, k])), x = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    e.abilityFajiSlot = x, e.abilityHatterSlot = x;
    const A = (k) => {
      const R = W[k];
      return R ? Array.isArray(R == null ? void 0 : R.items) ? R.items : Array.isArray(R) ? R : [] : [];
    }, H = (k) => (k || []).map((R) => {
      const M = T.get(R);
      if (!M) return null;
      const B = M.kind === "species";
      return {
        id: M.id,
        name: M.name,
        img: M.img,
    ...
    e.abilityPassiveList = H(A("passive")), e.abilityActiveList = H(A("active"));
    const Q = t == null ? void 0 : t.id, ie = !!((ut = (lt = game.combat) == null ? void 0 : lt.combatants) != null && ut.some(
      (k) => {
        var R;
        return (((R = k.actor) == null ? void 0 : R.id) ?? k.actorId) === Q;
      }
    ));
    e.showHarcSection = ie;
    const ce = ((dt = e.system) == null ? void 0 : dt.resources) ?? {}, ae = (pt = (mt = e.system) == null ? void 0 : mt.combat) == null ? void 0 : pt.initiativeResult, ee = typeof ae == "number" ? ae : -1, ne = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], we = (He = (ft = e.system) == null ? void 0 : ft.combat) == null ? void 0 : He.initiativeRanges, qe = Array.isArray(we) ? we.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ue = (qe.length > 0 ? qe : ne).slice().sort((k, R) => k.min - R.min), Re = 3;
    let X = qe.length > 0 ? qe : [];
    X.length < Re && (X = [...X, ...Array(Re - X.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = X.map((k, R) => ({
      ...k,
      isFirst: R === 0,
      isLast: R === X.length - 1
    }));
    let pe = 0;
    if (typeof ee == "number" && ee >= 0 && ue.length > 0) {
      const k = ue[0], R = ue[ue.length - 1];
      let M = null;
      ee <= k.max ? M = k : ee >= R.min ? M = R : M = ue.find((B) => ee >= B.min && ee <= B.max), M && (pe = M.kp);
    }
    const re = ue.length > 0 ? ue[ue.length - 1] : null, Xe = Math.min(10, re ? re.kp : 6), Le = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, Xe)).map((k, R) => {
      const M = R + 1, B = !!Number(ce[k]), fe = M <= pe;
      return { index: M, used: B, usable: fe };
    }), Me = Math.ceil(Le.length / 2);
    return e.kpDotsRow1 = Le.slice(0, Me), e.kpDotsRow2 = Le.slice(Me), e.canEditInitiative = !!((yt = game.user) != null && yt.isGM), e.showInitiativeResult = typeof ae == "number", e.initiativeResult = e.showInitiativeResult ? ae : "", e.speedUnitForSelect = ((Be = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : Be.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var d, f, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-DjcELlrK.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DjcELlrK.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DjcELlrK.mjs");
      a(this.actor, o, c);
      ...
      const i = (v = (h = r.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : v.area, o = (S = (w = r.currentTarget) == null ? void 0 : w.dataset) == null ? void 0 : S.itemId;
      ...
      if (!i || !this.actor) return;
      const o = ((w = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : w.microchips) ?? {}, a = ["slot1", "slot2", "slot3"].find((S) => {
        var D;
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[s] ?? {}, p = ((D = e.system) == null ? void 0 : D.skills) ?? {}, l = ((C = e.items) == null ? void 0 : C.filter((j) => j.type === "Fegyver")) ?? [];
    let m = null;
    ...
    const { resultType: h, label: v } = Rt(g), w = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return g.toMessage({
  ...
  async _onDropItem(s, e) {
    var f, y, r, i, o, c, a, g, h, v, w, S, D, C, _, q, j;
    if (!this.actor) return (f = super._onDropItem) == null ? void 0 : f.call(this, s, e);
    const n = ((E) => {
      var V;
      if (!E) return null;
      const G = E.uuid ?? E.documentUuid ?? ((V = E.data) == null ? void 0 : V.uuid) ?? (typeof E == "string" ? E : null);
      if (G) return G;
      if (typeof E == "object") {
        for (const W of Object.values(E))
          if (typeof W == "string" && W.includes(".") && W.startsWith("Item.")) return W;
      }
      return null;
    })(e);
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      ...
      if (((c = p.parent) == null ? void 0 : c.id) !== l.id) {
        const T = foundry.utils.mergeObject(p.toObject(), { type: "Kepesseg" });
        E = ((a = (await l.createEmbeddedDocuments("Item", [T]))[0]) == null ? void 0 : a.id) ?? E;
      }
      const G = (((g = p.system) == null ? void 0 : g.kind) ?? "passive").toString(), V = ((h = l.system) == null ? void 0 : h.abilities) ?? {}, W = G === "active" ? "active" : "passive", J = Array.isArray((v = V[W]) == null ? void 0 : v.items) ? V[W].items.slice() : Array.isArray(V[W]) ? V[W].slice() : [];
      J.includes(E) || J.push(E), await l.update({ [`system.abilities.${W}.items`]: J }), typeof this.render == "function" && this.render(!0);
      return;
    }
    if (((w = p.parent) == null ? void 0 : w.id) === l.id) return;
    const m = p.toObject();
    ...
    const d = (S = (await l.createEmbeddedDocuments("Item", [m]))[0]) == null ? void 0 : S.id;
    if (p.type === "Fegyver" && d) {
      const E = ((D = l.system) == null ? void 0 : D.weapons) ?? {}, G = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], V = (E.slotOrder ?? "").trim(), W = V ? V.split(/\s*,\s*/).filter((x) => G.includes(x)) : [];
      let J = G.find((x) => {
        var A;
        return !(((A = E[x]) == null ? void 0 : A.itemId) ?? "").trim();
      });
      J || (J = G.find((x) => !W.includes(x)) ?? "slot1");
      const T = W.includes(J) ? W : [...W, J].filter((x) => G.includes(x));
      await l.update({
        "system.weapons.slotOrder": T.join(","),
        [`system.weapons.${J}.itemId`]: d,
        [`system.weapons.${J}.name`]: p.name ?? "",
        [`system.weapons.${J}.damage`]: ((C = p.system) == null ? void 0 : C.damage) ?? "",
        [`system.weapons.${J}.bonus`]: ((_ = p.system) == null ? void 0 : _.bonus) ?? ""
      });
    }
    if (p.type === "MikroChip" && d) {
      const E = ((j = (q = l.system) == null ? void 0 : q.gear) == null ? void 0 : j.microchips) ?? {}, V = ["slot1", "slot2", "slot3"].find((W) => {
        var J;
        return !(((J = E[W]) == null ? void 0 : J.itemId) ?? "").trim();
      });
      V && await l.update({
        [`system.gear.microchips.${V}.itemId`]: d,
        [`system.gear.microchips.${V}.name`]: p.name ?? ""
      });
    }
    typeof this.render == "function" && this.render(!0);
  }
...
Z(de, "PARTS", foundry.utils.mergeObject(
  z(de, de, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Z(de, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(de, de, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Ts = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : Ts.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((_s = (Ds = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : Ds.window) == null ? void 0 : _s.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const me = class me extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var v, w, S, D, C, _, q, j, E, G, V, W, J;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((v = e.system) == null ? void 0 : v.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0), e.sizeForSelect = (((S = (w = e.system) == null ? void 0 : w.identity) == null ? void 0 : S.size) ?? "").trim() || "Közepes";
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, p = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, l = "— Nincs fegyver —", m = (((D = this.actor.items) == null ? void 0 : D.contents) ?? []).filter((T) => T.type === "Fegyver");
    e.weaponsTable = m.map((T) => {
      const x = (T == null ? void 0 : T.system) ?? {}, A = x.type ?? "", H = (n[A] ?? A) || "—", Q = x.size ?? "", ie = (p[Q] ?? Q) || "", ce = [H, ie].filter(Boolean).join(", ") || H || "—", ae = A === "projectile" || Q === "thrown", ee = x.quantity != null ? String(x.quantity).trim() : "1", ne = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: T.id,
        actorId: this.actor.id,
        ...
        typeAndSize: ce,
        quantity: ee,
        quantityDisplay: ae ? ee : "—",
        isProjectile: ae,
        equipped: !1,
        special: (x.special ?? "").trim() || "—"
      };
    });
    const u = (((C = this.actor.items) == null ? void 0 : C.contents) ?? []).filter((T) => T.type === "Pancel");
    e.armorTable = u.map((T) => {
      var H;
      const x = (T == null ? void 0 : T.system) ?? {}, A = !!((H = T.system) != null && H.equipped);
      return {
        itemId: T.id,
        actorId: this.actor.id,
    ...
    const d = (((_ = this.actor.items) == null ? void 0 : _.contents) ?? []).filter((T) => T.type === "MikroChip");
    e.microchipsTable = d.map((T) => {
      var ae, ee, ne;
      const x = ((ae = T == null ? void 0 : T.system) == null ? void 0 : ae.abilityType) ?? "", A = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—", H = x === "active", Q = Number((ee = T == null ? void 0 : T.system) == null ? void 0 : ee.replaceCost) >= 0 ? Number(T.system.replaceCost) : 0, ie = (((ne = T == null ? void 0 : T.system) == null ? void 0 : ne.description) ?? "").trim(), ce = ie ? ie.length > 60 ? ie.slice(0, 57) + "…" : ie : "—";
      return {
        itemId: T.id,
        actorId: this.actor.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    const f = (((q = this.actor.items) == null ? void 0 : q.contents) ?? []).filter((T) => T.type === "Targy");
    e.itemsTable = f.map((T) => {
      const x = (T == null ? void 0 : T.system) ?? {}, A = (x.description ?? "").trim(), H = A ? A.length > 60 ? A.slice(0, 57) + "…" : A : "—", Q = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: T.id,
        actorId: this.actor.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    const y = (((j = this.actor.items) == null ? void 0 : j.contents) ?? []).filter((T) => T.type === "Jarmuegyseg"), r = [];
    let i = 0, o = 0;
    for (const T of y) {
      const x = (T == null ? void 0 : T.system) ?? {}, A = x.health ?? {}, H = Number(x.level ?? 0) || 0, Q = Number(A.max ?? 0) || 0, ie = Number(A.value ?? 0) || 0, ce = (x.hit ?? "").toString().trim(), ae = (x.speed ?? "").toString().trim().replace(",", "."), ee = Number(ae);
      Number.isFinite(ee) && (i += ee);
      const ne = (x.range ?? "").toString().trim().replace(",", "."), we = Number(ne);
      Number.isFinite(we) && (o += we);
      const qe = x.abilities ?? {}, xe = Array.isArray(qe.items) ? qe.items : [], Re = (await Promise.all(
        xe.map(async (X) => {
          var pe;
          if (!X) return null;
          try {
            const re = await fromUuid(X);
            if (re && (re.type === "Kepesseg" || re.type === "ability")) return re;
          } catch {
            const re = (pe = game.items) == null ? void 0 : pe.get(X);
            if (re && (re.type === "Kepesseg" || re.type === "ability")) return re;
          }
          return null;
        })
      )).map((X, pe) => ({ doc: X, ref: xe[pe] })).filter((X) => !!X.doc && !!X.ref).map(({ doc: X, ref: pe }) => {
        var Le, Me;
        const re = (((Le = X.system) == null ? void 0 : Le.kind) ?? "passive").toString(), Xe = Number(((Me = X.system) == null ? void 0 : Me.kp) ?? 0) || 0, It = re === "species";
        return {
          id: X.id,
          ref: pe,
          name: X.name,
    ...
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system ?? {}),
      { combat: { speed: c }, vehicle: { toolsRange: a } },
      { inplace: !1 }
    );
    const g = (((E = e.weaponsTable) == null ? void 0 : E.length) ?? 0) > 0 || (((G = e.armorTable) == null ? void 0 : G.length) ?? 0) > 0 || (((V = e.microchipsTable) == null ? void 0 : V.length) ?? 0) > 0 || (((W = e.itemsTable) == null ? void 0 : W.length) ?? 0) > 0;
    e.showEquipmentDropZone = !g;
    const h = (((J = this.actor.items) == null ? void 0 : J.contents) ?? []).filter((T) => T.type === "Egyeb");
    return e.egyebList = h.map((T) => {
      const A = (((T == null ? void 0 : T.system) ?? {}).description ?? "").trim(), H = A ? A.length > 80 ? A.slice(0, 77) + "…" : A : "";
      return {
        itemId: T.id,
        actorId: this.actor.id,
        name: (T == null ? void 0 : T.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (u) => {
      ...
      !y && f && (y = ((w = game.items) == null ? void 0 : w.get(f)) ?? null), (S = y == null ? void 0 : y.sheet) == null || S.render(!0);
...
Z(me, "PARTS", foundry.utils.mergeObject(
  z(me, me, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/jarmu-sheet.hbs" }
  },
  { inplace: !1 }
)), Z(me, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(me, me, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Os = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : Os.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Cs = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ls = (qs = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : qs.window) == null ? void 0 : Ls.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Z(Se, "PARTS", foundry.utils.mergeObject(z(Se, Se, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Z(Se, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Se, Se, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ns = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = Se;
var Fs;
...
Z(Te, "PARTS", foundry.utils.mergeObject(z(Te, Te, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), Z(Te, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Te, Te, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Fs = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.form) ?? {}, { submitOnChange: !1 })
}));
let zt = Te;
var As;
const De = class De extends foundry.applications.api.HandlebarsApplicationMixin(
...
Z(De, "PARTS", foundry.utils.mergeObject(z(De, De, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Z(De, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(De, De, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((As = z(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !1 })
}));
let Ut = De;
var Es;
...
Z(_e, "PARTS", foundry.utils.mergeObject(z(_e, _e, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), Z(_e, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(_e, _e, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Es = z(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !0 })
}));
let Ht = _e;
var Ps;
...
Z(Oe, "PARTS", foundry.utils.mergeObject(z(Oe, Oe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), Z(Oe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Oe, Oe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ps = z(Oe, Oe, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !1 })
}));
let Bt = Oe;
var $s;
...
Z(Ce, "PARTS", foundry.utils.mergeObject(z(Ce, Ce, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Z(Ce, "DEFAULT_OPTIONS", foundry.utils.mergeObject(z(Ce, Ce, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject((($s = z(Ce, Ce, "DEFAULT_OPTIONS")) == null ? void 0 : $s.form) ?? {}, { submitOnChange: !1 })
}));
let Gt = Ce;
var xs, Rs;
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      !c && o && (c = ((w = game.items) == null ? void 0 : w.get(o)) ?? null), (S = c == null ? void 0 : c.sheet) == null || S.render(!0);
      ...
      if (!i) return;
      const o = this.document.system ?? {}, c = Array.isArray((w = o.abilities) == null ? void 0 : w.items) ? o.abilities.items.slice() : [], a = c.indexOf(i), g = a >= 0 ? [...c.slice(0, a), ...c.slice(a + 1)] : c;
...
Z(he, "PARTS", foundry.utils.mergeObject(z(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/jarmuegyseg-sheet.hbs" }
})), Z(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((xs = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : xs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Rs = z(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.dragDrop) ?? [],
      {
        dragSelector: null,
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const o = wt.getTotalSpeedRaw(i), c = (g = i.effects) == null ? void 0 : g.find((w) => w.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (o <= 0 && !c) {
        const w = ((v = (h = CONFIG.statusEffects) == null ? void 0 : h.find((S) => S.id === "immobilized")) == null ? void 0 : v.img) ?? "";
  ...
  const s = 500;
  Hooks.on("updateActor", (u, d, f, y) => {
    var S, D, C, _, q, j, E, G, V, W, J, T, x;
    const r = u == null ? void 0 : u.id;
    if (!r) return;
    if ((u.type === "Karakter" || u.type === "Npc") && ((S = d == null ? void 0 : d.system) != null && S.combat) && "initiativeResult" in d.system.combat) {
      const A = Number((C = (D = u.system) == null ? void 0 : D.combat) == null ? void 0 : C.initiativeResult), H = Number.isFinite(A) ? A : 0, Q = game.combat;
      if (Q) {
        const ie = ((_ = Q.combatants) == null ? void 0 : _.contents) ?? Array.from(Q.combatants ?? []);
        for (const ce of ie)
          if (((q = ce.actor) == null ? void 0 : q.id) === r || ce.actorId === r) {
            Q.updateEmbeddedDocuments("Combatant", [{ _id: ce.id, initiative: H }]).catch(() => {
            });
            break;
          }
      }
    ...
    if (u.type === "Npc" && ((j = d == null ? void 0 : d.system) != null && j.identity) && "size" in d.system.identity) {
      const A = js((G = (E = u.system) == null ? void 0 : E.identity) == null ? void 0 : G.size);
      u.update({
        "prototypeToken.width": A,
        "prototypeToken.height": A
      }).catch((H) => console.warn("Vacuum of the Void | NPC token size update failed for", u.name, H));
    }
    const i = document.activeElement, o = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), c = [], a = (V = game.actors) == null ? void 0 : V.get(r);
    a != null && a.apps && c.push(...Array.from(a.apps));
    const g = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const A of g) {
      if (((W = A.document) == null ? void 0 : W.id) !== r || ((J = A.document) == null ? void 0 : J.documentName) !== "Actor") continue;
      const H = (T = A.constructor) == null ? void 0 : T.name;
      H !== "VoidKarakterSheet" && H !== "VoidJarmuSheet" || c.includes(A) || c.push(A);
    }
    if (o && c.some((A) => {
      const H = (A == null ? void 0 : A.form) ?? (A == null ? void 0 : A.element);
      return H && H.contains(i);
    })) return;
    const v = (x = game.votv) == null ? void 0 : x._lastKarakterSheetBlurSave, w = v && Date.now() - v.at < s ? v.appId : null;
    setTimeout(() => {
      for (const A of c)
        !(A != null && A.rendered) || typeof A.render != "function" || A.id !== w && A.render(!0);
    }, 0);
    ...
    for (const [h, v] of Object.entries(i)) {
      ...
      const w = ((v == null ? void 0 : v.itemId) ?? "").trim();
      !w || w !== u.id || (o[`system.weapons.${h}.name`] = u.name ?? "", o[`system.weapons.${h}.damage`] = ((a = u.system) == null ? void 0 : a.damage) ?? "", o[`system.weapons.${h}.bonus`] = ((g = u.system) == null ? void 0 : g.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, w, S, D, C, _, q, j, E, G, V, W, J, T, x, A, H, Q, ie, ce, ae;
    ...
    if (!n) return;
    const p = (v = game.messages) == null ? void 0 : v.get(n), l = (S = (w = p == null ? void 0 : p.flags) == null ? void 0 : w["vacuum-of-the-void"]) == null ? void 0 : S.weapon;
    if (!l) return;
    ...
    if (u || (u = ((j = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : j.flatMap((ne) => {
      var we;
      return ((we = ne.tokens) == null ? void 0 : we.contents) ?? [];
    }).map((ne) => ne.actor).find((ne) => ne && (ne.id === m || ne.id === l.actorId))) ?? null), !u) return;
    const d = l.itemId ? ((G = (E = u.items) == null ? void 0 : E.get) == null ? void 0 : G.call(E, l.itemId)) ?? ((J = (W = (V = u.items) == null ? void 0 : V.contents) == null ? void 0 : W.find) == null ? void 0 : J.call(W, (ee) => ee.id === l.itemId)) : null;
    let f = (l.damageFormula ?? "").trim();
    if (f || (f = (((T = d == null ? void 0 : d.system) == null ? void 0 : T.damage) ?? "").trim()), !f && l.slotKey && (f = (((((x = u.system) == null ? void 0 : x.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !f) {
      (ie = (A = ui.notifications) == null ? void 0 : A.warn) == null || ie.call(A, ((Q = (H = game.i18n) == null ? void 0 : H.localize) == null ? void 0 : Q.call(H, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const y = new Roll(f);
    await y.evaluate({ async: !0 });
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = l.targetName || "", o = l.hitLocationName || "", c = ((d == null ? void 0 : d.name) ?? (l.slotKey ? ((ae = (((ce = u.system) == null ? void 0 : ce.weapons) ?? {})[l.slotKey]) == null ? void 0 : ae.name) ?? "" : "")) || "Fegyver";
    ...
    for (const m of e) {
      const u = wt.getTotalSpeedRaw(m), d = (n = m.effects) == null ? void 0 : n.find((f) => f.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (u <= 0 && !d) {
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var d, f, y, r;
  const t = ((d = I.flags) == null ? void 0 : d["vacuum-of-the-void"]) ?? {}, n = t.resultType, p = t.critLabel, l = t.weaponAttack, m = t.weapon;
  if (!n && !p && !l) return;
  ...
  if (u) {
    ...
    if (l && m && (m.actorId || (y = I.speaker) != null && y.actor)) {
      ...
      if (m.isHit && !u.querySelector(".votv-weapon-damage-chat")) {
        ...
        g.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", g.dataset.actorId = String(m.actorId ?? ((r = I.speaker) == null ? void 0 : r.actor) ?? ""), g.dataset.itemId = String(m.itemId ?? ""), g.dataset.slotKey = String(m.slotKey ?? ""), g.dataset.targetName = String(m.targetName ?? ""), g.dataset.hitLocationName = String(m.hitLocationName ?? ""), g.dataset.messageId = String(I.id ?? ""), o.appendChild(g);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-CBTgpkic.mjs.map
