...
const { HTMLField: Qt, NumberField: C, SchemaField: K, StringField: I, BooleanField: Z, ArrayField: He } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Me, Re, Ke, je, Ee, Le, st, it, rt, nt, at, ot, lt, ct, ut, dt, mt, pt, ft, yt, gt, ht, bt, kt;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((Ke = (Re = (Me = this.actor.system) == null ? void 0 : Me.resources) == null ? void 0 : Re.stress) == null ? void 0 : Ke.value) || 0;
    e.stressOver10 = t > 10;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Le = (Ee = this.actor.system) == null ? void 0 : Ee.combat) == null ? void 0 : Le.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const l = this._getTotalArmorSpeedPenalty();
    i += l, e.effectiveGivenSpeed = i;
    const n = (Number(((it = (st = this.actor.system) == null ? void 0 : st.combat) == null ? void 0 : it.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: n } },
      { inplace: !1 }
    );
    const p = ((rt = e.system) == null ? void 0 : rt.combat) ?? {};
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), A = N ? N.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], T = (nt = this.actor.system.gear) == null ? void 0 : nt.microchips, E = T && typeof T == "object" && !Array.isArray(T) ? T : {}, L = (((at = E.slot1) == null ? void 0 : at.itemId) ?? "").trim(), P = (((ot = E.slot2) == null ? void 0 : ot.itemId) ?? "").trim(), H = (((lt = E.slot3) == null ? void 0 : lt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, D) => {
    ...
    const Ie = (((ut = this.actor.items) == null ? void 0 : ut.contents) ?? []).filter((g) => g.type === "Pancel");
    ...
    const Se = (((dt = this.actor.items) == null ? void 0 : dt.contents) ?? []).filter((g) => g.type === "Targy");
    ...
    const ye = (((mt = this.actor.items) == null ? void 0 : mt.contents) ?? []).filter((g) => g.type === "Egyeb");
    ...
    const V = (((pt = this.actor.items) == null ? void 0 : pt.contents) ?? []).filter((g) => g.type === "MikroChip"), ie = V.map((g) => ({ id: g.id, name: g.name, img: g.img })), Ne = "— Nincs Mikro-Chip —", k = ["slot1", "slot2", "slot3"], x = (g) => {
      var O, F, R;
      const D = [];
    ...
    const M = (((ft = e.weaponsTable) == null ? void 0 : ft.length) ?? 0) > 0 || (((yt = e.armorTable) == null ? void 0 : yt.length) ?? 0) > 0 || (((gt = e.microchipsTable) == null ? void 0 : gt.length) ?? 0) > 0 || (((ht = e.itemsTable) == null ? void 0 : ht.length) ?? 0) > 0;
    e.showEquipmentDropZone = !M;
    const U = this.actor.system.abilities ?? {}, Te = (((bt = this.actor.items) == null ? void 0 : bt.contents) ?? []).map((g) => {
      var D, O, F;
      return {
        id: g.id,
        name: g.name,
    ...
    const Ce = ((kt = e.system) == null ? void 0 : kt.resources) ?? {}, qe = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"];
    return e.kpDots = qe.map((g, D) => ({ index: D + 1, used: !!Number(Ce[g]) })), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-DNQ-6QE5.mjs");
      n(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: l } = await import("./roll-sheet-DNQ-6QE5.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, n = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-DNQ-6QE5.mjs");
      p(this.actor, o, n);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DNQ-6QE5.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-DNQ-6QE5.mjs");
      n(this.actor, l, o);
...
W(le, "PARTS", foundry.utils.mergeObject(j(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Rt = j(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Rt.form) ?? {}, { submitOnChange: !0 })
}));
let Ve = le;
var Kt;
...
W(ce, "PARTS", foundry.utils.mergeObject(j(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Kt = j(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Kt.form) ?? {}, { submitOnChange: !1 })
}));
let et = ce;
var jt;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (c, f, m, y) => {
    ...
    if (c.type === "Npc" && ((w = f == null ? void 0 : f.system) != null && w.identity) && "size" in f.system.identity) {
      const P = zt((q = (S = c.system) == null ? void 0 : S.identity) == null ? void 0 : q.size);
      c.update({
...
//# sourceMappingURL=vacuum-of-the-void-tsMloQPy.mjs.map
