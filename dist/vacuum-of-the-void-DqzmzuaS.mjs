...
const { HTMLField: Nt, NumberField: P, SchemaField: R, StringField: I, BooleanField: Q, ArrayField: He } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const o = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((a = (n = o.hitLocations) == null ? void 0 : n.legs) == null ? void 0 : a.value) ?? 0, c = ((l = o.currentHealth) == null ? void 0 : l.legs) ?? 0, u = B._healthStatusFromRatio(c, d), f = Number(((v = (b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(s) {
    var Te, oe, de, ce, ye, ge, Me, Re, je, Ke, Le, _e, tt, st, it, rt, nt, at;
    ...
    for (const y of u) {
      const D = ((ce = d[y]) == null ? void 0 : ce.value) ?? 0, O = c[y] ?? 0;
      e.computedHealthStatus[y] = B._healthStatusFromRatio(O, D);
    }
    ...
    for (const [y, D] of Object.entries(p)) {
      ...
      e.skillHealthStatus[y] = O, e.skillDisabled[y] = O === 0 ? " disabled" : "", e.skillHasHealthTint[y] = !0;
    }
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], w = (b.slotOrder ?? "").trim(), _ = w ? w.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], C = (je = this.actor.system.gear) == null ? void 0 : je.microchips, q = C && typeof C == "object" && !Array.isArray(C) ? C : {}, T = (((Ke = q.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Le = q.slot2) == null ? void 0 : Le.itemId) ?? "").trim(), A = (((_e = q.slot3) == null ? void 0 : _e.itemId) ?? "").trim(), K = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const O = typeof y.sort == "number" ? y.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return O - L;
    }).map((y) => {
      var le, be, ke, me, pe, Ee;
      const D = y.type === "Fegyver", O = y.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Oe = 0; Oe < _.length; Oe++) {
        const Ae = _[Oe];
        if ((((le = b[Ae]) == null ? void 0 : le.itemId) ?? "") === y.id) {
          L = Oe + 1, M = ((be = b[Ae]) == null ? void 0 : be.bonus) ?? "", J = Ae;
          break;
        }
      }
      let Y = null;
      O && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : A === y.id && (Y = "slot3"));
      const Pe = D && ((ke = y.system) != null && ke.damage) ? y.system.damage : "", ee = D && typeof ((me = y.system) == null ? void 0 : me.range) == "string" ? (y.system.range || "").trim() : "", he = J ? Number((pe = b[J]) == null ? void 0 : pe.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
        ...
        rangeStr: ee,
        slotBonusNum: he,
        quantity: Number(((Ee = y.system) == null ? void 0 : Ee.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = K;
    const H = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((y) => y.type === "Fegyver"), Z = H.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", V = _.filter((y) => {
      const O = ((b[y] ?? {}).itemId ?? "").trim();
      return O ? !!H.find((M) => M.id === O) : !1;
    });
    e.weaponSlots = V.map((y, D) => {
      const O = b[y] ?? {}, L = (O.itemId ?? "").trim(), M = Z.find((J) => J.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: D + 1,
        displayName: (M == null ? void 0 : M.name) || O.name || G,
        img: (M == null ? void 0 : M.img) || "",
        bonus: Number(O.bonus) || 0,
        damage: O.damage ?? ""
      };
    });
    const we = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Fe = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = H.map((y) => {
      ...
      const M = !!O, J = ((ct = y.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = y.system) == null ? void 0 : lt.equipped) !== null ? !!y.system.equipped : M, Y = (y == null ? void 0 : y.system) ?? {}, Pe = typeof Y.range == "string" ? (Y.range || "").trim() : "", ee = Y.type ?? "", he = (we[ee] ?? ee) || "—", le = Y.size ?? "", be = (Fe[le] ?? le) || "", ke = [he, be].filter(Boolean).join(", ") || he || "—", me = ee === "projectile" || le === "thrown", pe = Y.quantity, Ee = pe != null ? String(pe).trim() : "1", Oe = String(L.bonus ?? "").trim(), Ae = String(Y.bonus ?? "").trim(), Lt = Oe || Ae || "0";
      return {
        slotKey: O ?? "",
        itemId: D,
    ...
    e.armorTable = Ne.map((y) => {
      var L, M;
      const D = (y == null ? void 0 : y.system) ?? {}, O = ((L = y.system) == null ? void 0 : L.equipped) !== void 0 && ((M = y.system) == null ? void 0 : M.equipped) !== null ? !!y.system.equipped : !1;
      return {
        itemId: y.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = $e.map((y) => {
      const D = (y == null ? void 0 : y.system) ?? {}, O = (D.description ?? "").trim(), L = O ? O.length > 60 ? O.slice(0, 57) + "…" : O : "—", M = D.quantity != null ? String(D.quantity).trim() : "1";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    e.egyebList = xe.map((y) => {
      const O = (((y == null ? void 0 : y.system) ?? {}).description ?? "").trim(), L = O ? O.length > 80 ? O.slice(0, 77) + "…" : O : "";
      return {
        itemId: y.id,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Ie = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((y) => y.type === "MikroChip"), fe = Ie.map((y) => ({ id: y.id, name: y.name, img: y.img })), De = "— Nincs Mikro-Chip —", Ce = ["slot1", "slot2", "slot3"], Se = (y) => {
      var O, L, M;
      const D = [];
      return y !== 1 && D.push((((O = q.slot1) == null ? void 0 : O.itemId) ?? "").trim()), y !== 2 && D.push((((L = q.slot2) == null ? void 0 : L.itemId) ?? "").trim()), y !== 3 && D.push((((M = q.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((y) => !Se(1).includes(y.id)), e.microchipItemsSlot2 = fe.filter((y) => !Se(2).includes(y.id)), e.microchipItemsSlot3 = fe.filter((y) => !Se(3).includes(y.id)), e.microchipSlots = Ce.map((y) => {
      const D = q[y] ?? {}, O = (D.itemId ?? "").trim(), L = Ie.find((M) => M.id === O);
      return {
        slotKey: y,
        itemId: O,
      ...
      const D = `slot${y}`, O = q[D] ?? {}, L = (O.itemId ?? "").trim(), M = fe.find((J) => J.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || O.name || De, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = Ie.map((y) => {
      var le, be, ke, me;
      const D = y.id;
      let O = null;
      for (const pe of Ce)
        if ((((le = q[pe]) == null ? void 0 : le.itemId) ?? "").trim() === D) {
          O = pe;
          break;
        }
      const L = !!O, M = ((be = y == null ? void 0 : y.system) == null ? void 0 : be.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Pe = Number((ke = y == null ? void 0 : y.system) == null ? void 0 : ke.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, ee = (((me = y == null ? void 0 : y.system) == null ? void 0 : me.description) ?? "").trim(), he = ee ? ee.length > 60 ? ee.slice(0, 57) + "…" : ee : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const qe = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      var D, O, L;
      return {
        id: y.id,
        name: y.name,
        ...
        description: ((O = y.system) == null ? void 0 : O.description) ?? "",
        kp: Number(((L = y.system) == null ? void 0 : L.kp) ?? 0) || 0
      };
    }), F = new Map(k.map((y) => [y.id, y])), x = "— Nincs képesség —", U = (y) => {
      const D = qe[y] ?? {}, O = (D.itemId ?? "").trim(), L = O ? F.get(O) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: O,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!n) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CIX_DRXg.mjs");
      a(this.actor, n);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, n = r.dataset.skill, a = ((p = r.textContent) == null ? void 0 : p.trim()) || n, { openRollSheetForSkill: l } = await import("./roll-sheet-CIX_DRXg.mjs");
      l(this.actor, n, a);
      ...
      if (!a) return;
      const p = (((w = (((v = this.actor.system) == null ? void 0 : v.weapons) ?? {})[a]) == null ? void 0 : w.itemId) ?? "").trim();
      if (!p) return;
      const b = ((C = (_ = this.actor.items).get) == null ? void 0 : C.call(_, p)) ?? ((T = (q = this.actor.items.contents) == null ? void 0 : q.find) == null ? void 0 : T.call(q, (A) => A.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = a.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = v ? v.split(/\s*,\s*/).filter((q) => w.includes(q)) : [], C = _.find((q) => {
          var T;
          return (((T = b[q]) == null ? void 0 : T.itemId) ?? "").trim() === n;
        });
        if (C) {
          const q = _.filter((T) => T !== C);
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((C = a == null ? void 0 : a.system) == null ? void 0 : C.damage) ?? "",
          [`system.weapons.${T}.bonus`]: ((q = a == null ? void 0 : a.system) == null ? void 0 : q.bonus) ?? ""
      ...
      if (!l) return;
      const p = (r.dataset.itemId ?? "").trim(), b = (r.dataset.itemName ?? ((T = r.textContent) == null ? void 0 : T.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", v = (r.dataset.itemImg ?? "").trim(), w = n == null ? void 0 : n.querySelector(".karakter-microchip-slot-display-text");
      w && (w.textContent = b);
      let _ = n == null ? void 0 : n.querySelector(".karakter-microchip-slot-thumb");
      v ? (_ || (_ = document.createElement("img"), _.className = "karakter-microchip-slot-thumb", _.alt = "", a == null || a.insertBefore(_, w)), _.src = v, _.style.display = "") : _ && _.remove(), n == null || n.classList.remove("karakter-microchip-slot-open");
      ...
      const a = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, p = ["slot1", "slot2", "slot3"].find((w) => {
        var _;
        return (((_ = a[w]) == null ? void 0 : _.itemId) ?? "").trim() === r;
      });
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${T}.damage`]: ((C = a.system) == null ? void 0 : C.damage) ?? "",
          [`system.weapons.${T}.bonus`]: ((q = a.system) == null ? void 0 : q.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (w) {
        const T = v.filter((S) => S !== w);
        await this.actor.update({
    ...
    u._votvBlur = (i) => {
      ...
      l && (a.contains(l) || u.id && ((p = l.closest) != null && p.call(l, `#${CSS.escape(u.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: u.id, at: Date.now() }), f(a));
    ...
    if (e) {
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && (l.type === "Kepesseg" || l.type === "ability")) {
          ...
          const w = b === "active" ? "active" : "passive", _ = Array.isArray((u = v[w]) == null ? void 0 : u.items) ? v[w].items.slice() : Array.isArray(v[w]) ? v[w].slice() : [];
          _.includes(p) || _.push(p), await this.actor.update({ [`system.abilities.${w}.items`]: _ });
          return;
        }
      }
    }
    if (e) {
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const w = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, _ = (w.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = _ ? _.split(/\s*,\s*/).filter((S) => C.includes(S)) : [], T = q.filter((S) => {
              var A;
              return (((A = w[S]) == null ? void 0 : A.itemId) ?? "").trim() === v;
            });
            if (T.length > 0) {
              const A = {
                "system.weapons.slotOrder": q.filter((N) => !T.includes(N)).join(",")
              };
              for (const N of T)
  ...
  async _rollWeapon(s) {
    ...
    const u = c && c.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, g = (((v = c == null ? void 0 : c.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(o[g] || 0) || 0, i = f + h, n = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(n);
  ...
  async _rollWeaponDamage(s, e = "") {
    var h, i, r, n, a, l, p, b, v, w, _;
    const t = this.actor;
    if (!t) return;
    let o = ((i = (h = t.items).get) == null ? void 0 : i.call(h, s)) ?? ((n = (r = t.items.contents) == null ? void 0 : r.find) == null ? void 0 : n.call(r, (C) => C.id === s));
    if (!o || o.type !== "Fegyver") return;
    let d = (((a = o.system) == null ? void 0 : a.damage) ?? "").trim();
    ...
    const u = (c.bonus ?? ((_ = o.system) == null ? void 0 : _.bonus) ?? "").toString().trim().replace(",", "."), f = Number(u) || 0;
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, V, we, Fe, Ne, $e, xe, Ie, fe, De, Ce, Se, qe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((G = this.actor) == null ? void 0 : G.system), e.showDeathSkull = !1, e.sizeForSelect = (((we = (V = e.system) == null ? void 0 : V.identity) == null ? void 0 : we.size) ?? "").trim() || "Közepes";
    ...
    e.weaponSlots = a.map((k) => {
      const F = d[k] ?? {}, x = (F.itemId ?? "").trim(), U = g.find((ue) => ue.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, U = {};
      for (const _e of n)
        if ((((Le = d[_e]) == null ? void 0 : Le.itemId) ?? "").trim() === F) {
          x = _e, U = d[_e] ?? {};
          break;
        }
      const ue = !!x, W = (k == null ? void 0 : k.system) ?? {}, Te = typeof W.range == "string" ? (W.range || "").trim() : "", oe = W.type ?? "", de = (l[oe] ?? oe) || "—", ce = W.size ?? "", ye = (p[ce] ?? ce) || "", ge = [de, ye].filter(Boolean).join(", ") || de || "—", Me = oe === "projectile" || ce === "thrown", Re = W.quantity != null ? String(W.quantity).trim() : "1", je = String(W.bonus ?? U.bonus ?? "").trim() || "0", Ke = (W.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, w = ["slot1", "slot2", "slot3"], _ = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = _.map((k) => {
      var oe, de, ce, ye;
      const F = k.id;
      let x = null;
      for (const ge of w)
        if ((((oe = v[ge]) == null ? void 0 : oe.itemId) ?? "").trim() === F) {
          x = ge;
          break;
        }
      const U = ((de = k == null ? void 0 : k.system) == null ? void 0 : de.abilityType) ?? "", ue = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", W = (((ce = k == null ? void 0 : k.system) == null ? void 0 : ce.description) ?? "").trim(), Te = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const C = o.filter((k) => k.type === "Targy");
    ...
    const T = (((Ie = e.weaponsTable) == null ? void 0 : Ie.length) ?? 0) > 0 || (((fe = e.armorTable) == null ? void 0 : fe.length) ?? 0) > 0 || (((De = e.microchipsTable) == null ? void 0 : De.length) ?? 0) > 0 || (((Ce = e.itemsTable) == null ? void 0 : Ce.length) ?? 0) > 0 || (((Se = e.egyebList) == null ? void 0 : Se.length) ?? 0) > 0;
    e.showEquipmentDropZone = !T;
    const S = ((qe = t == null ? void 0 : t.system) == null ? void 0 : qe.abilities) ?? {}, A = o.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!n || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CIX_DRXg.mjs");
      l(this.actor, n, a);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var n, a;
      i.preventDefault();
      ...
      var b, v, w, _, C, q;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, n = (_ = (w = i.currentTarget) == null ? void 0 : w.dataset) == null ? void 0 : _.itemId;
      if (!r || !n || !this.actor) return;
      const a = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, p = (Array.isArray((q = a[r]) == null ? void 0 : q.items) ? a[r].items.slice() : []).filter((T) => T !== n);
      ...
      if (!r || !this.actor) return;
      const n = ((w = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : w.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((_) => {
        var C;
        return (((C = n[_]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const o = ((i = (h = t.items).get) == null ? void 0 : i.call(h, s)) ?? ((n = (r = t.items.contents) == null ? void 0 : r.find) == null ? void 0 : n.call(r, (C) => C.id === s));
    if (!o || o.type !== "Fegyver") return;
    let d = (((a = o.system) == null ? void 0 : a.damage) ?? "").trim();
    const c = e ? (((l = t.system) == null ? void 0 : l.weapons) ?? {})[e] ?? {} : {};
    if (d || (d = (c.damage ?? "").trim()), !d) {
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, n, a, l, p, b, v, w, _, C, q, T;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((r = d.parent) == null ? void 0 : r.id) !== c.id) {
        ...
        S = ((n = (await c.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : n.id) ?? S;
      }
      const A = (((a = d.system) == null ? void 0 : a.kind) ?? "passive").toString(), N = ((l = c.system) == null ? void 0 : l.abilities) ?? {}, K = A === "active" ? "active" : "passive", H = Array.isArray((p = N[K]) == null ? void 0 : p.items) ? N[K].items.slice() : Array.isArray(N[K]) ? N[K].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((w = c.system) == null ? void 0 : w.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), K = N ? N.split(/\s*,\s*/).filter((G) => A.includes(G)) : [];
      let H = A.find((G) => {
        var V;
        return !(((V = S[G]) == null ? void 0 : V.itemId) ?? "").trim();
      });
      H || (H = A.find((G) => !K.includes(G)) ?? "slot1");
      const Z = K.includes(H) ? K : [...K, H].filter((G) => A.includes(G));
      await c.update({
        "system.weapons.slotOrder": Z.join(","),
        [`system.weapons.${H}.itemId`]: m,
        [`system.weapons.${H}.name`]: d.name ?? "",
        [`system.weapons.${H}.damage`]: ((_ = d.system) == null ? void 0 : _.damage) ?? "",
        [`system.weapons.${H}.bonus`]: ((C = d.system) == null ? void 0 : C.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const S = ((T = (q = c.system) == null ? void 0 : q.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((K) => {
        var H;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", o = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = o > 0 ? `<p><strong>KP:</strong> ${o}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${u}
      ${f}
...
z(te, "PARTS", foundry.utils.mergeObject(j(te, te, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((St = j(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : St.form) ?? {}, { submitOnChange: !1 })
}));
let Je = te;
var Tt;
...
z(se, "PARTS", foundry.utils.mergeObject(j(se, se, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Tt = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : Tt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = se;
var _t;
...
z(ie, "PARTS", foundry.utils.mergeObject(j(ie, ie, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((_t = j(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = ie;
var Ot;
...
z(re, "PARTS", foundry.utils.mergeObject(j(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ot = j(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.form) ?? {}, { submitOnChange: !0 })
}));
let Ze = re;
var Dt;
...
z(ne, "PARTS", foundry.utils.mergeObject(j(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Dt = j(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !1 })
}));
let Ve = ne;
var Ct;
...
z(ae, "PARTS", foundry.utils.mergeObject(j(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ct = j(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 })
}));
let et = ae;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, f, m, g) => {
    ...
    if (!h) return;
    const i = document.activeElement, r = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), n = [], a = (w = game.actors) == null ? void 0 : w.get(h);
    a != null && a.apps && n.push(...Array.from(a.apps));
    const l = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const S of l)
      ((_ = S.document) == null ? void 0 : _.id) !== h || ((C = S.document) == null ? void 0 : C.documentName) !== "Actor" || ((q = S.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || n.includes(S) || n.push(S);
    if (r && n.some((S) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var b, v, w, _, C, q, T, S, A, N, K, H, Z, G, V;
    const t = (v = (b = e.target) == null ? void 0 : b.closest) == null ? void 0 : v.call(b, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    e.preventDefault(), e.stopPropagation();
    const o = (t.dataset.actorId ?? "").trim(), d = (t.dataset.itemId ?? "").trim(), c = (t.dataset.slotKey ?? "").trim(), u = (t.dataset.targetName ?? "").trim(), f = (t.dataset.hitLocationName ?? "").trim(), m = o ? (w = game.actors) == null ? void 0 : w.get(o) : null;
    if (!m) return;
    let g = d ? ((C = (_ = m.items) == null ? void 0 : _.get) == null ? void 0 : C.call(_, d)) ?? ((S = (T = (q = m.items) == null ? void 0 : q.contents) == null ? void 0 : T.find) == null ? void 0 : S.call(T, (we) => we.id === d)) : null;
    if (!g || g.type !== "Fegyver") return;
    let h = (((A = g.system) == null ? void 0 : A.damage) ?? "").trim();
    const i = c ? (((N = m.system) == null ? void 0 : N.weapons) ?? {})[c] ?? {} : {};
    if (h || (h = (i.damage ?? "").trim()), !h) {
      (G = (K = ui.notifications) == null ? void 0 : K.warn) == null || G.call(K, ((Z = (H = game.i18n) == null ? void 0 : H.localize) == null ? void 0 : Z.call(H, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const r = (i.bonus ?? ((V = g.system) == null ? void 0 : V.bonus) ?? "").toString().trim().replace(",", "."), n = Number(r) || 0;
    n !== 0 && (h += n > 0 ? `+${n}` : String(n));
    const a = new Roll(h);
    await a.evaluate({ async: !0 });
    const l = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    let p = u ? `${g.name} – sebzés – ${u}` : `${g.name} – sebzés`;
    f && (p += ` (${f})`), await a.toMessage({
    ...
    for (const i of t)
      try {
        const r = i.prototypeToken, n = ((u = r == null ? void 0 : r.bar1) == null ? void 0 : u.attribute) ?? "", a = ((f = r == null ? void 0 : r.bar2) == null ? void 0 : f.attribute) ?? "";
        (n || a) && await i.update({
  ...
  if (f) {
    if (o && f.classList.add(`votv-${o}`), d) {
      ...
      if (r)
        ...
        const n = f.querySelector(".dice-total"), a = (n == null ? void 0 : n.parentElement) ?? f, l = document.createElement("div");
    ...
    if (c && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(u.actorId ?? ((i = E.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(u.itemId ?? ""), p.dataset.slotKey = String(u.slotKey ?? ""), p.dataset.targetName = String(u.targetName ?? ""), p.dataset.hitLocationName = String(u.hitLocationName ?? ""), n.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-DqzmzuaS.mjs.map
