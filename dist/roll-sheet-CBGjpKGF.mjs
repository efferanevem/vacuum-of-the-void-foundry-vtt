import { V as P, c as F } from "./vacuum-of-the-void-CaGQqyZn.mjs";
class B extends Application {
  ...
  constructor(t = {}) {
    ...
    super(t), this._actor = a, this._skillKey = e, this._label = o ?? e, this._baseModifier = Number(i) || 0, this._injuryModifier = Number(c) || 0, this._injuryPenalty = Number(u) || 0, this._isWeaponAttack = !!l, this._weaponSlotKey = r || "", this._weaponItemId = d || "";
  }
  get actor() {
    return this._actor;
  }
  ...
  _bindRollSheetListeners() {
    ...
    i.forEach((s) => {
      s.addEventListener("click", (n) => {
        n.preventDefault(), c(s.dataset.advantageValue ?? "0"), t._updateFormulaPreview(e);
      });
    }), c((o == null ? void 0 : o.value) ?? "0");
    const u = e.querySelector(".roll-sheet-morale-wrap"), l = Math.min(3, Math.max(0, parseInt(((_ = u == null ? void 0 : u.dataset) == null ? void 0 : _.moraleMax) ?? "3", 10) || 0)), r = e.querySelector("input[name='moraleDice']"), d = e.querySelectorAll(".roll-sheet-morale-d8"), p = (s) => {
  ...
  _updateFormulaPreview(t) {
    ...
    if (!a) return;
    const e = parseInt(((b = t.querySelector("input[name='advantage']")) == null ? void 0 : b.value) ?? "0", 10) || 0, o = parseInt(((g = t.querySelector("input[name='moraleDice']")) == null ? void 0 : g.value) ?? "0", 10) || 0, i = parseInt(((v = t.querySelector("input[name='constantBonus']")) == null ? void 0 : v.value) ?? "0", 10) || 0, c = parseInt(((M = t.dataset) == null ? void 0 : M.baseMod) ?? "0", 10) || 0, u = parseInt(((f = t.dataset) == null ? void 0 : f.injuryMod) ?? "0", 10) || 0, l = parseInt(((_ = t.dataset) == null ? void 0 : _.injuryPenalty) ?? "0", 10) || 0, r = c + u + l + i, d = [];
  ...
  getData(t = {}) {
    var l, r;
    const a = this.actor, e = Math.max(0, Number(((r = (l = a == null ? void 0 : a.system) == null ? void 0 : l.resources) == null ? void 0 : r.morale) ?? 0) || 0), o = this._baseModifier !== 0 ? this._baseModifier > 0 ? `+${this._baseModifier}` : String(this._baseModifier) : "", i = this._injuryModifier !== 0 ? this._injuryModifier > 0 ? `+${this._injuryModifier}` : String(this._injuryModifier) : "", c = this._injuryPenalty !== 0 ? String(this._injuryPenalty) : "", u = ["3d6", o, i, c].filter(Boolean).join(" ") || "3d6";
    return {
  ...
  async _doRoll(t) {
    ...
    const a = this.actor;
    if (!a) return;
    const e = t.querySelector("[name='moraleDice']"), o = t.querySelector("[name='advantage']"), i = t.querySelector("[name='constantBonus']"), c = Math.min(3, Math.max(0, parseInt((e == null ? void 0 : e.value) ?? "0", 10) || 0)), u = Math.max(0, Number(((L = (S = a.system) == null ? void 0 : S.resources) == null ? void 0 : L.morale) ?? 0) || 0), l = Math.min(c, u), r = Math.min(3, Math.max(-3, parseInt((o == null ? void 0 : o.value) ?? "0", 10) || 0)), d = parseInt((i == null ? void 0 : i.value) ?? "0", 10) || 0, p = this._baseModifier, b = this._injuryModifier, g = this._injuryPenalty || 0, v = p + b + g + d, M = [
      "3d6",
    ...
    const { resultType: _, label: s } = F(f), n = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    let m = this._label;
    ...
    if (this._isWeaponAttack && ((N = (x = game.user) == null ? void 0 : x.targets) != null && N.size)) {
      ...
      if (I) {
        const j = (($ = I.system) == null ? void 0 : $.combat) ?? {}, D = Number(j.defense ?? 0) || 0, A = Number(j.defenseBonus ?? 0) || 0, R = Number(j.givenProtection ?? 0) || 0, C = D + A + R, E = (Number(f.total ?? 0) || 0) >= C, k = I.name ?? w.name ?? "Célpont", V = E ? "talált" : "nem talált";
        m = `${this._label} – ${k} (${V})`, h.weaponAttack = !0, h.weapon = {
          actorId: a.id ?? null,
...
function U(y, t, a) {
  var u, l;
  if (!y) return;
  const e = Number(((l = (u = y.system) == null ? void 0 : u.skills) == null ? void 0 : l[t]) ?? 0) || 0, o = P.BODY_PART_BY_SKILL[t] ? P._getSkillHealthStatusStatic(y, t) : void 0;
  let i = 0;
...
function H(y, t) {
  ...
  d === 1 ? p = -6 : d === 2 && (p = -3), new B({
    ...
    isWeaponAttack: !0,
    weaponSlotKey: t,
    weaponItemId: (c == null ? void 0 : c.id) ?? o
  }).render(!0);
}
export {
  B as VoidRollSheet,
  U as openRollSheetForSkill,
  H as openRollSheetForWeapon
};
//# sourceMappingURL=roll-sheet-CBGjpKGF.mjs.map
