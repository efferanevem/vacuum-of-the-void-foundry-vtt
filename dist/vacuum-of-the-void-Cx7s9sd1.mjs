...
var Q = (w, s, e) => ms(w, typeof s != "symbol" ? s + "" : s, e);
...
const { NumberField: dt, SchemaField: fs } = foundry.data.fields;
class ys extends is {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: hs, StringField: lt } = foundry.data.fields;
class bs extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new lt({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new lt({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new lt({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new lt({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: mt, StringField: Mt } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var k, P, x, j, ae, X, Ae, ge, ve, he, _e, Ce, rt, at, ot, ct, Ge, Ee, It, St, Tt, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((x = (P = (k = this.actor.system) == null ? void 0 : k.resources) == null ? void 0 : P.stress) == null ? void 0 : x.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const _ = ((j = d[y]) == null ? void 0 : j.value) ?? 0, C = r[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((X = (ae = this.actor.system) == null ? void 0 : ae.combat) == null ? void 0 : X.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const a = (Number(((ge = (Ae = this.actor.system) == null ? void 0 : Ae.combat) == null ? void 0 : ge.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const p = ((ve = e.system) == null ? void 0 : ve.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (T.slotOrder ?? "").trim(), E = A ? A.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], D = (he = this.actor.system.gear) == null ? void 0 : he.microchips, F = D && typeof D == "object" && !Array.isArray(D) ? D : {}, N = (((_e = F.slot1) == null ? void 0 : _e.itemId) ?? "").trim(), H = (((Ce = F.slot2) == null ? void 0 : Ce.itemId) ?? "").trim(), B = (((rt = F.slot3) == null ? void 0 : rt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, _) => {
      const C = typeof y.sort == "number" ? y.sort : 0, L = typeof _.sort == "number" ? _.sort : 0;
      return C - L;
    }).map((y) => {
      var be, qe, Le, we, Ie, Ye;
      const _ = y.type === "Fegyver", C = y.type === "MikroChip";
      let L = 0, M = "", ee = null;
      for (let Fe = 0; Fe < E.length; Fe++) {
        const Je = E[Fe];
        if ((((be = T[Je]) == null ? void 0 : be.itemId) ?? "") === y.id) {
          L = Fe + 1, M = ((qe = T[Je]) == null ? void 0 : qe.bonus) ?? "", ee = Je;
          break;
        }
      }
      let Z = null;
      C && (N === y.id ? Z = "slot1" : H === y.id ? Z = "slot2" : B === y.id && (Z = "slot3"));
    ...
    e.weaponSlots = J.map((y, _) => {
      const C = T[y] ?? {}, L = (C.itemId ?? "").trim(), M = R.find((ee) => ee.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: _ + 1,
    ...
    const ke = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ne = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = V.map((y) => {
      var Ft, $t, xt;
      const _ = y.id;
      let C = null, L = {};
      for (const ut of E)
        if ((((Ft = T[ut]) == null ? void 0 : Ft.itemId) ?? "").trim() === _) {
          C = ut, L = T[ut] ?? {};
          break;
        }
      const M = !!C, ee = (($t = y.system) == null ? void 0 : $t.equipped) !== void 0 && ((xt = y.system) == null ? void 0 : xt.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, We = typeof Z.range == "string" ? (Z.range || "").trim() : "", oe = Z.type ?? "", Oe = (ke[oe] ?? oe) || "—", be = Z.size ?? "", qe = (ne[be] ?? be) || "", Le = [Oe, qe].filter(Boolean).join(", ") || Oe || "—", we = oe === "projectile" || be === "thrown", Ie = Z.quantity, Ye = Ie != null ? String(Ie).trim() : "1", Fe = String(L.bonus ?? "").trim(), Je = String(Z.bonus ?? "").trim(), cs = Fe || Je || "0";
      return {
        slotKey: C ?? "",
        itemId: _,
    ...
    const re = (((Ge = this.actor.items) == null ? void 0 : Ge.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const se = (((Ee = this.actor.items) == null ? void 0 : Ee.contents) ?? []).filter((y) => y.type === "MikroChip"), ye = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), xe = "— Nincs Mikro-Chip —", Re = ["slot1", "slot2", "slot3"], Ne = (y) => {
      var C, L, M;
      const _ = [];
      return y !== 1 && _.push((((C = F.slot1) == null ? void 0 : C.itemId) ?? "").trim()), y !== 2 && _.push((((L = F.slot2) == null ? void 0 : L.itemId) ?? "").trim()), y !== 3 && _.push((((M = F.slot3) == null ? void 0 : M.itemId) ?? "").trim()), _.filter(Boolean);
    };
    e.microchipItemsSlot1 = ye.filter((y) => !Ne(1).includes(y.id)), e.microchipItemsSlot2 = ye.filter((y) => !Ne(2).includes(y.id)), e.microchipItemsSlot3 = ye.filter((y) => !Ne(3).includes(y.id)), e.microchipSlots = Re.map((y) => {
      const _ = F[y] ?? {}, C = (_.itemId ?? "").trim(), L = se.find((M) => M.id === C);
      return {
        slotKey: y,
        itemId: C,
      ...
      const _ = `slot${y}`, C = F[_] ?? {}, L = (C.itemId ?? "").trim(), M = ye.find((ee) => ee.id === L);
      ...
      let C = null;
      for (const Ie of Re)
        if ((((be = F[Ie]) == null ? void 0 : be.itemId) ?? "").trim() === _) {
          C = Ie;
          break;
        }
    ...
    const nt = !!((At = (Pt = game.combat) == null ? void 0 : Pt.combatants) != null && At.some((y) => {
      var _;
      return ((_ = y.actor) == null ? void 0 : _.type) === "Karakter";
    }));
    return e.showHarcSection = nt, e.canEditInitiative = !!((Et = game.user) != null && Et.isGM), e.showInitiativeResult = typeof Te == "number", e.initiativeResult = e.showInitiativeResult ? Te : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-wyrBZB8f.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-wyrBZB8f.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-wyrBZB8f.mjs");
      p(this.actor, o, a);
      ...
      if (!h) return;
      const v = ((A = (q = this.actor.items).get) == null ? void 0 : A.call(q, h)) ?? ((D = (E = this.actor.items.contents) == null ? void 0 : E.find) == null ? void 0 : D.call(E, (N) => N.id === h));
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var xe, Re, Ne, Xe, Me, Ze, Ke, Ve, je, He, Ue, et, tt, Te, De, st, ze, Pe, it, Be, nt;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((xe = this.actor) == null ? void 0 : xe.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ne = (Re = e.system) == null ? void 0 : Re.identity) == null ? void 0 : Ne.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((Xe = t == null ? void 0 : t.items) == null ? void 0 : Xe.contents) ?? [], d = ((Me = t == null ? void 0 : t.system) == null ? void 0 : Me.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const Ee of c)
        if ((((Ge = d[Ee]) == null ? void 0 : Ge.itemId) ?? "").trim() === P) {
          x = Ee, j = d[Ee] ?? {};
          break;
        }
      const ae = !!x, X = (k == null ? void 0 : k.system) ?? {}, Ae = typeof X.range == "string" ? (X.range || "").trim() : "", ge = X.type ?? "", ve = (a[ge] ?? ge) || "—", he = X.size ?? "", _e = (p[he] ?? he) || "", Ce = [ve, _e].filter(Boolean).join(", ") || ve || "—", rt = ge === "projectile" || he === "thrown", at = X.quantity != null ? String(X.quantity).trim() : "1", ot = String(X.bonus ?? j.bonus ?? "").trim() || "0", ct = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: Ds((P.level ?? "").toString().trim()),
        special: (P.special ?? P.other ?? "").toString().trim() || "—",
        equipped: x
      };
    });
    const v = ((Ke = (Ze = t == null ? void 0 : t.system) == null ? void 0 : Ze.gear) == null ? void 0 : Ke.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var ge, ve, he, _e;
      const P = k.id;
      let x = null;
      for (const Ce of I)
        if ((((ge = v[Ce]) == null ? void 0 : ge.itemId) ?? "").trim() === P) {
          x = Ce;
          break;
        }
      const j = ((ve = k == null ? void 0 : k.system) == null ? void 0 : ve.abilityType) ?? "", ae = j === "active" ? "Aktív" : j === "passive" ? "Passzív" : j || "—", X = (((he = k == null ? void 0 : k.system) == null ? void 0 : he.description) ?? "").trim(), Ae = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: P,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const E = (((Ve = e.weaponsTable) == null ? void 0 : Ve.length) ?? 0) > 0 || (((je = e.armorTable) == null ? void 0 : je.length) ?? 0) > 0 || (((He = e.microchipsTable) == null ? void 0 : He.length) ?? 0) > 0 || (((Ue = e.itemsTable) == null ? void 0 : Ue.length) ?? 0) > 0 || (((et = e.egyebList) == null ? void 0 : et.length) ?? 0) > 0;
    e.showEquipmentDropZone = !E;
    const D = ((tt = t == null ? void 0 : t.system) == null ? void 0 : tt.abilities) ?? {}, F = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var P, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const G = t == null ? void 0 : t.id, V = !!((De = (Te = game.combat) == null ? void 0 : Te.combatants) != null && De.some(
      (k) => {
        var P;
    ...
    e.showHarcSection = V;
    const R = ((st = e.system) == null ? void 0 : st.resources) ?? {}, Y = (Pe = (ze = e.system) == null ? void 0 : ze.combat) == null ? void 0 : Pe.initiativeResult, J = typeof Y == "number" ? Y : -1, ke = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ne = (Be = (it = e.system) == null ? void 0 : it.combat) == null ? void 0 : Be.initiativeRanges, fe = Array.isArray(ne) ? ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (fe.length > 0 ? fe : ke).slice().sort((k, P) => k.min - P.min);
    ...
    }), e.canEditInitiative = !!((nt = game.user) != null && nt.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-wyrBZB8f.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-wyrBZB8f.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-wyrBZB8f.mjs");
      a(this.actor, c, o);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, r = ((A = e.items) == null ? void 0 : A.filter((F) => F.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = r.find((F) => F.id === n.itemId) ?? null);
    const f = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, g = ((E = l == null ? void 0 : l.system) == null ? void 0 : E.type) || "kinetic", b = (((D = l == null ? void 0 : l.system) == null ? void 0 : D.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, p = new Roll(a);
  ...
  async _onDropItem(s, e) {
    var g, b, u, i, c, o, a, p, h, v, I, T, q, A, E, D, F;
    ...
    if (d.type === "Fegyver" && m) {
      const N = ((q = r.system) == null ? void 0 : q.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (N.slotOrder ?? "").trim(), U = B ? B.split(/\s*,\s*/).filter((R) => H.includes(R)) : [];
      let G = H.find((R) => {
        var Y;
    ...
    if (d.type === "MikroChip" && m) {
      const N = ((F = (D = r.system) == null ? void 0 : D.gear) == null ? void 0 : F.microchips) ?? {}, B = ["slot1", "slot2", "slot3"].find((U) => {
        var G;
...
Q(ie, "PARTS", foundry.utils.mergeObject(
  ...
  z(ie, ie, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Wt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Wt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Yt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Qt = (Jt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Jt.window) == null ? void 0 : Qt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      const R = Number((q = (T = l.system) == null ? void 0 : T.combat) == null ? void 0 : q.initiativeResult), Y = Number.isFinite(R) ? R : 0, J = game.combat;
      if (J) {
        const ke = ((A = J.combatants) == null ? void 0 : A.contents) ?? Array.from(J.combatants ?? []);
        for (const ne of ke)
    ...
    if (l.type === "Npc" && ((D = f == null ? void 0 : f.system) != null && D.identity) && "size" in f.system.identity) {
      const R = rs((N = (F = l.system) == null ? void 0 : F.identity) == null ? void 0 : N.size);
      l.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, q, A, E, D, F, N, H, B, U, G, V, R, Y, J, ke, ne, fe, $e;
    ...
    if (f || (f = ((F = (D = game.scenes) == null ? void 0 : D.contents) == null ? void 0 : F.flatMap((se) => {
      var ye;
    ...
    if (g || (g = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !g && r.slotKey && (g = (((((R = f.system) == null ? void 0 : R.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
      (ne = (Y = ui.notifications) == null ? void 0 : Y.warn) == null || ne.call(Y, ((ke = (J = game.i18n) == null ? void 0 : J.localize) == null ? void 0 : ke.call(J, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(g);
...
Hooks.on("preCreateToken", (w, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = rs((m = (f = d.system) == null ? void 0 : f.identity) == null ? void 0 : m.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-Cx7s9sd1.mjs.map
