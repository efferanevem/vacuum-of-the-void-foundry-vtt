...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((m = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : m.resources) ?? {}, p = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, d = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, y = Q._healthStatusFromRatio(d, p), u = Number(((I = (k = (w = this.actor) == null ? void 0 : w.system) == null ? void 0 : k.combat) == null ? void 0 : I.givenSpeed) ?? 0) || 0;
    let a;
  ...
  async _prepareContext(s) {
    var yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et, T, z, R, G, Ie, ne, Le, Ce, Se, Me, tt, st, Pt, $t, xt, zt, _t, dt, as, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs, bs, vs;
    ...
    f === 0 && (I = 0), (Ce = (Le = (ne = this.actor) == null ? void 0 : ne.statuses) == null ? void 0 : Le.has) != null && Ce.call(Le, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Me = (Se = e.system) == null ? void 0 : Se.combat) == null ? void 0 : Me.givenProtection } },
      { inplace: !1 }
    ), I = 0), e.totalSpeed = I;
    ...
    e.actionsTable = oe;
    const M = (((xt = this.actor.items) == null ? void 0 : xt.contents) ?? []).filter((b) => b.type === "Fegyver"), te = M.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = te;
    ...
    e.weaponSlots = Oe.map((b, L) => {
      const N = O[b] ?? {}, F = (N.itemId ?? "").trim(), B = te.find((qe) => qe.id === F), ue = M.find((qe) => qe.id === F), ae = (ue == null ? void 0 : ue.system) ?? {}, it = ae.size === "thrown", Te = (typeof ae.range == "string" ? (ae.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: F,
        slotNum: L + 1,
    ...
    e.weaponsTable = M.map((b) => {
      ...
      const B = !!N, ue = ((ws = b.system) == null ? void 0 : ws.equipped) !== void 0 && ((Is = b.system) == null ? void 0 : Is.equipped) !== null ? !!b.system.equipped : B, ae = (b == null ? void 0 : b.system) ?? {}, it = typeof ae.range == "string" ? (ae.range || "").trim() : "", Te = ae.type ?? "", qe = (D[Te] ?? Te) || "—", je = ae.size ?? "", nt = (x[je] ?? je) || "", rt = [qe, nt].filter(Boolean).join(", ") || qe || "—", Ve = Te === "projectile" || je === "thrown", Je = ae.quantity, Ot = Je != null ? String(Je).trim() : "1", mt = String(F.bonus ?? "").trim(), Ct = String(ae.bonus ?? "").trim(), li = mt || Ct || "0";
      return {
        slotKey: N ?? "",
        itemId: L,
    ...
    const pe = (((as = this.actor.items) == null ? void 0 : as.contents) ?? []).filter((b) => b.type === "MikroChip"), re = pe.map((b) => ({ id: b.id, name: b.name, img: b.img })), we = "— Nincs Mikro-Chip —", ce = ["slot1", "slot2", "slot3"], fe = (b) => {
      var N, F, B;
      const L = [];
    ...
    const ct = ((ms = e.system) == null ? void 0 : ms.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (fs = (ps = e.system) == null ? void 0 : ps.combat) == null ? void 0 : fs.initiativeResult, ie = typeof ye == "number" ? ye : -1, lt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Re = (gs = (ys = e.system) == null ? void 0 : ys.combat) == null ? void 0 : gs.initiativeRanges, Ne = Array.isArray(Re) ? Re.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], We = (Ne.length > 0 ? Ne : lt).slice().sort((b, L) => b.min - L.min), Xe = Ne.map((b) => b.min), At = Xe.length ? Math.min(...Xe) : 0, Ft = Xe.length ? Math.max(...Xe) : 0;
    ...
    const Et = !!((bs = (hs = game.combat) == null ? void 0 : hs.combatants) != null && bs.some((b) => {
      var L;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-B5MTJjdX.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-B5MTJjdX.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-B5MTJjdX.mjs");
      h(this.actor, l, m);
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (g && g.documentName === "Item" && g.type === "Fegyver") {
          const v = this.actor, w = ((f = g.parent) == null ? void 0 : f.id) !== v.id;
          let k = g.id;
          if (w) {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((o = e.system) == null ? void 0 : o.kind) ?? "passive", n = Number(((f = e.system) == null ? void 0 : f.kp) ?? 0) || 0, p = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), d = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : t === "module" ? "Modul" : "Passzív";
    let y = "";
    t === "active" && n > 0 ? y = `<p><strong>KP:</strong> ${n}</p>` : t === "module" && n > 0 && (y = `<p><strong>KP:</strong> ${n}</p>`);
    const u = p ? `<p>${p}</p>` : "", a = `
      <h2>${e.name}</h2>
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: o, label: f } = Vt(a), r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const y = d && d.name || t.name || `Fegyver (${s})`, u = Number(t.bonus || 0) || 0, a = ((w = d == null ? void 0 : d.system) == null ? void 0 : w.type) || "kinetic", o = (((k = d == null ? void 0 : d.system) == null ? void 0 : k.skillKey) ?? "").trim(), f = o && n[o] !== void 0 ? o : a === "explosive" ? "grenadeUse" : "firearms", r = Number(n[f] || 0) || 0, i = u + r, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, m = new Roll(l);
...
X(Q, "PARTS", foundry.utils.mergeObject(
  ...
  j(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((As = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Fs = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ps = (Es = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Es.window) == null ? void 0 : Ps.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var He, Ye, Ge, ct, ee, ye, ie, lt, Re, Ne, ut, We, Xe, At, Ft, ft, Et, yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et;
    ...
    const t = this.actor, n = ((ct = e.system) == null ? void 0 : ct.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, d = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, y = (lt = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && lt.call(ie, "halfcover") ? 3 : 0, u = (Ne = (Re = t == null ? void 0 : t.statuses) == null ? void 0 : Re.has) != null && Ne.call(Re, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = p + d + y + u;
    const a = ((ut = t == null ? void 0 : t.items) == null ? void 0 : ut.contents) ?? [], o = ((We = t == null ? void 0 : t.system) == null ? void 0 : We.weapons) ?? {}, f = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], r = (o.slotOrder ?? "").trim(), i = r ? r.split(/\s*,\s*/).filter((T) => f.includes(T)) : [], c = a.filter((T) => T.type === "Fegyver"), l = c.map((T) => ({ id: T.id, name: T.name, img: T.img })), m = "— Nincs fegyver —", h = i.length > 0 ? i : f, g = f.filter((T) => !h.includes(T)), v = [...h, ...g], w = v.filter((T) => {
      var R;
      const z = (((R = o[T]) == null ? void 0 : R.itemId) ?? "").trim();
      return z && c.some((G) => G.id === z);
    });
    e.weaponSlots = w.map((T) => {
      const z = o[T] ?? {}, R = (z.itemId ?? "").trim(), G = l.find((Se) => Se.id === R), Ie = c.find((Se) => Se.id === R), ne = (Ie == null ? void 0 : Ie.system) ?? {}, Le = ne.size === "thrown", Ce = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: T,
        itemId: R,
    ...
    e.weaponsTable = c.map((T) => {
      ...
      const Ie = !!R, ne = (T == null ? void 0 : T.system) ?? {}, Le = typeof ne.range == "string" ? (ne.range || "").trim() : "", Ce = ne.type ?? "", Se = (k[Ce] ?? Ce) || "—", Me = ne.size ?? "", tt = (I[Me] ?? Me) || "", st = [Se, tt].filter(Boolean).join(", ") || Se || "—", Pt = Ce === "projectile" || Me === "thrown", $t = ne.quantity != null ? String(ne.quantity).trim() : "1", xt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", zt = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: z,
        actorId: t.id,
    ...
    e.armorTable = _.map((T) => {
      var G;
      const z = (T == null ? void 0 : T.system) ?? {}, R = ((G = T.system) == null ? void 0 : G.equipped) === !0;
      return {
        itemId: T.id,
        actorId: t.id,
    ...
    e.microchipsTable = E.map((T) => {
      ...
      const G = ((Se = T == null ? void 0 : T.system) == null ? void 0 : Se.abilityType) ?? "", Ie = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ne = (((Me = T == null ? void 0 : T.system) == null ? void 0 : Me.description) ?? "").trim(), Le = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: z,
        actorId: t.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    e.itemsTable = K.map((T) => {
      const z = (T == null ? void 0 : T.system) ?? {}, R = (z.description ?? "").trim(), G = R ? R.length > 60 ? R.slice(0, 57) + "…" : R : "—";
      return {
        itemId: T.id,
        actorId: t.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    e.egyebList = U.map((T) => {
      const R = (((T == null ? void 0 : T.system) ?? {}).description ?? "").trim(), G = R ? R.length > 80 ? R.slice(0, 77) + "…" : R : "";
      return {
        itemId: T.id,
        actorId: t.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    const W = ((ht = t == null ? void 0 : t.system) == null ? void 0 : ht.abilities) ?? {}, Z = a.filter((T) => T.type === "Kepesseg" || T.type === "ability").map((T) => {
      ...
      return {
        ...
        kp: Number(((R = T.system) == null ? void 0 : R.kp) ?? 0) || 0,
    ...
    if (typeof x == "number" && x >= 0 && re.length > 0) {
      ...
      let R = null;
      x <= T.max ? R = T : x >= z.min ? R = z : R = re.find((G) => x >= G.min && x <= G.max), R && (fe = R.kp);
    }
    const Ke = re.length > 0 ? re[re.length - 1] : null, Ue = Math.min(10, Ke ? Ke.kp : 6), Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, Ue)).map((T, z) => {
      const R = z + 1, G = !!Number(Oe[T]), Ie = R <= fe;
      return { index: R, used: G, usable: Ie };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-B5MTJjdX.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-B5MTJjdX.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-B5MTJjdX.mjs");
      m(this.actor, c, l);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((k = e.system) == null ? void 0 : k.weapons) ?? {})[s] ?? {}, p = ((I = e.system) == null ? void 0 : I.skills) ?? {}, d = ((_ = e.items) == null ? void 0 : _.filter((E) => E.type === "Fegyver")) ?? [];
    let y = null;
    n.itemId && (y = d.find((E) => E.id === n.itemId) ?? null);
  ...
  async _onDropItem(s, e) {
    var o, f, r, i, c, l, m, h, g, v, w, k, I, _, O, C, E, K, U;
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      const P = (((l = p.system) == null ? void 0 : l.kind) ?? "passive").toString();
      if (P === "module") {
    ...
    if (p.type === "Fegyver" && a) {
      const P = ((O = d.system) == null ? void 0 : O.weapons) ?? {}, W = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Z = (P.slotOrder ?? "").trim(), J = Z ? Z.split(/\s*,\s*/).filter((M) => W.includes(M)) : [];
      let Y = W.find((M) => {
        var te;
        return !(((te = P[M]) == null ? void 0 : te.itemId) ?? "").trim();
      });
      Y || (Y = W.find((M) => !J.includes(M)) ?? "slot1");
      const oe = J.includes(Y) ? J : [...J, Y].filter((M) => W.includes(M));
      await d.update({
...
X(he, "PARTS", foundry.utils.mergeObject(
  ...
  j(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject((($s = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : $s.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((xs = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Rs = (zs = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : zs.window) == null ? void 0 : Rs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var E, K, U, P, W, Z, J, Y, oe, M, te, de, Oe;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = y.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, V = x.type ?? "", se = (n[V] ?? V) || "—", le = x.size ?? "", pe = (p[le] ?? le) || "", re = [se, pe].filter(Boolean).join(", ") || se || "—", we = V === "projectile" || le === "thrown", ce = x.quantity != null ? String(x.quantity).trim() : "1", fe = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    const f = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", r = (((Z = this.actor.items) == null ? void 0 : Z.contents) ?? []).filter((D) => D.type === f).sort((D, x) => {
    ...
    for (const D of r) {
      ...
      const pe = x.abilities ?? {}, re = Array.isArray(pe.items) ? pe.items : [], ce = (await Promise.all(
        ...
        var Ne, ut;
        const ie = (((Ne = ee.system) == null ? void 0 : Ne.kind) ?? "passive").toString(), lt = Number(((ut = ee.system) == null ? void 0 : ut.kp) ?? 0) || 0, Re = ie === "species";
        return {
          id: ee.id,
          ref: ye,
          name: ee.name,
  ...
  _attachFrameListeners(s) {
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (u) => {
      ...
      const f = (k = u.originalEvent) == null ? void 0 : k.dataTransfer;
      ...
      !f && o && (f = ((w = game.items) == null ? void 0 : w.get(o)) ?? null), (k = f == null ? void 0 : f.sheet) == null || k.render(!0);
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  j(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ms = j(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((js = j(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : js.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Us = (Ks = j(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.window) == null ? void 0 : Us.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const at = class at extends Kt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var O, C, E, K, U, P, W;
      const a = ((O = e.querySelector) == null ? void 0 : O.call(e, "form")) ?? e, o = (C = a.querySelector) == null ? void 0 : C.call(a, 'select[name="system.identity.assignment"]'), f = (E = a.querySelector) == null ? void 0 : E.call(a, 'select[name="system.identity.subAssignment"]'), r = (K = a.querySelector) == null ? void 0 : K.call(a, "input.bazis-threat-total"), i = (U = a.querySelector) == null ? void 0 : U.call(a, 'input[name="system.combat.threatBonus"]');
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (f == null ? void 0 : f.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((W = (P = this.actor) == null ? void 0 : P.items) == null ? void 0 : W.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", w = p[v] ?? 0, k = Number(i.value ?? 0) || 0, I = Ls(this.actor), _ = m + h + w + k + I;
      r.value = _;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, p = n.identity ?? {}, d = n.combat ?? {}, y = p.assignment ?? "", u = p.subAssignment ?? "", a = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, f = { Kicsi: -10, Közepes: 0, Nagy: 10 }, r = a[y] ?? 0, i = o[u] ?? 0, c = e.sizeForSelect ?? "Kicsi", l = f[c] ?? 0, m = Number(d.threatBonus ?? 0) || 0, h = Ls(this.actor), g = r + i + l + m + h;
      e.system = foundry.utils.mergeObject(
...
X(at, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(at, at, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Bs = j(at, at, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Zt = at;
...
const ve = class ve extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const p = {
      ...
      heavy: "Nehéz",
      thrown: "Dobható"
    }, y = "— Nincs fegyver —", u = ((m = t.items) == null ? void 0 : m.contents) ?? [], a = u.filter((k) => k.type === "Fegyver");
    e.weaponsTable = a.map((k) => {
      const I = k.system ?? {}, _ = I.type ?? "", O = (p[_] ?? _) || "—", C = I.size ?? "", E = (d[C] ?? C) || "", K = [O, E].filter(Boolean).join(", ") || O || "—", U = _ === "projectile" || C === "thrown", P = I.quantity != null ? String(I.quantity).trim() : "1", W = (typeof I.range == "string" ? (I.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: t.id,
    ...
    const f = u.filter((k) => k.type === "MikroChip");
    e.microchipsTable = f.map((k) => {
      var U, P, W;
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".vallalkozas-employee-add", async (u) => {
      ...
      if (u.preventDefault(), !this.actor) return;
      const o = (this.actor.system ?? {}).vallalkozas ?? {}, f = Array.isArray(o.militiaMissions) ? o.militiaMissions.slice() : [], r = Number(o.level ?? 1) || 1, i = Number(o.militiaPower ?? 0) || 0, c = Math.floor(Math.random() * 100) + 1, l = c * r, m = l - i;
      f.push({
        location: "",
        baseRoll: c,
        difficulty: l,
        risk: m,
        loot: ""
      }), await this.actor.update({ "system.vallalkozas.militiaMissions": f });
  ...
  async _onDropItem(s, e) {
    ...
    const y = n.toObject(), u = foundry.utils.mergeObject(y, {
...
X(ve, "PARTS", foundry.utils.mergeObject(
  ...
  j(ve, ve, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Hs = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !0 }),
    window: foundry.utils.mergeObject(((Gs = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Vs = (Ws = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.window) == null ? void 0 : Vs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(Ae, "PARTS", foundry.utils.mergeObject(j(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Js = j(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Js.form) ?? {}, { submitOnChange: !1 })
}));
let Xt = Ae;
var Zs;
...
X(Fe, "PARTS", foundry.utils.mergeObject(j(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Zs = j(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : Zs.form) ?? {}, { submitOnChange: !1 })
}));
let Qt = Fe;
var Ys;
...
X(Ee, "PARTS", foundry.utils.mergeObject(j(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ys = j(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ys.form) ?? {}, { submitOnChange: !1 })
}));
let es = Ee;
var Xs;
...
X(Pe, "PARTS", foundry.utils.mergeObject(j(Pe, Pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xs = j(Pe, Pe, "DEFAULT_OPTIONS")) == null ? void 0 : Xs.form) ?? {}, { submitOnChange: !0 })
}));
let ts = Pe;
var Qs;
...
X($e, "PARTS", foundry.utils.mergeObject(j($e, $e, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Qs = j($e, $e, "DEFAULT_OPTIONS")) == null ? void 0 : Qs.form) ?? {}, { submitOnChange: !1 })
}));
let ss = $e;
var ei;
...
X(xe, "PARTS", foundry.utils.mergeObject(j(xe, xe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ei = j(xe, xe, "DEFAULT_OPTIONS")) == null ? void 0 : ei.form) ?? {}, { submitOnChange: !1 })
}));
let is = xe;
var ti, si;
...
X(De, "PARTS", foundry.utils.mergeObject(j(De, De, "PARTS") ?? {}, {
  ...
  j(De, De, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ti = j(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : ti.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((si = j(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : si.dragDrop) ?? [],
      {
        dragSelector: null,
...
X(_e, "PARTS", foundry.utils.mergeObject(j(_e, _e, "PARTS") ?? {}, {
  ...
  j(_e, _e, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ii = j(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ii.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ni = j(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ni.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, o, f, r) => {
    ...
    if ((a.type === "Karakter" || a.type === "Npc") && ((I = o == null ? void 0 : o.system) != null && I.combat) && "initiativeResult" in o.system.combat) {
      const M = Number((O = (_ = a.system) == null ? void 0 : _.combat) == null ? void 0 : O.initiativeResult), te = Number.isFinite(M) ? M : 0, de = game.combat;
      if (de) {
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const M = ai((P = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : P.size);
      a.update({
    ...
    for (const M of g) {
      ...
      te !== "VoidKarakterSheet" && te !== "VoidJarmuSheet" && te !== "VoidBazisSheet" && te !== "VoidVallalkozasSheet" || m.includes(M) || m.push(M);
    }
    if (l && m.some((M) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, w, k, I, _, O, C, E, K, U, P, W, Z, J, Y, oe, M, te, de, Oe, D;
    ...
    }).map((V) => V.actor).find((V) => V && (V.id === y || V.id === d.actorId))) ?? null), !u) return;
    ...
    for (const y of e) {
      const u = Nt.getTotalSpeedRaw(y), a = (n = y.effects) == null ? void 0 : n.find((o) => o.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (u <= 0 && !a) {
...
Hooks.on("preCreateToken", (S, s, e) => {
  ...
  if (p) {
    ...
    if (p.type === "Npc") {
      const l = ai((c = (i = p.system) == null ? void 0 : i.identity) == null ? void 0 : c.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var f, r, i, c;
  const t = ((f = S.flags) == null ? void 0 : f["vacuum-of-the-void"]) ?? {}, n = t.resultType, p = t.critLabel, d = t.weaponAttack, y = t.weapon, u = t.vsDefense, a = t.vsDefenseInfo;
  if (!n && !p && !d && !u) return;
  ...
  if (o) {
    ...
    if (d && y && (y.actorId || (i = S.speaker) != null && i.actor)) {
      ...
      if (!o.querySelector(".votv-weapon-outcome")) {
        ...
        const v = !!y.isHit, w = y.targetName || "Célpont";
      ...
      if (y.isHit && !o.querySelector(".votv-weapon-damage-chat")) {
        ...
        const w = y.hitLocationRoll, k = y.hitLocationName;
        v.textContent = w != null && k ? `Sebzés (Találati Hely ${w} - ${k})` : "Sebzés", v.dataset.actorId = String(y.actorId ?? ((c = S.speaker) == null ? void 0 : c.actor) ?? ""), v.dataset.itemId = String(y.itemId ?? ""), v.dataset.slotKey = String(y.slotKey ?? ""), v.dataset.targetName = String(y.targetName ?? ""), v.dataset.hitLocationName = String(y.hitLocationName ?? ""), v.dataset.messageId = String(S.id ?? ""), m.appendChild(v);
      }
    }
    if (!d && u && a) {
...
//# sourceMappingURL=vacuum-of-the-void-CRBcV78g.mjs.map
