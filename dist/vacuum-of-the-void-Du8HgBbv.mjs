...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const m = this.element, y = this.form ?? this.element, h = n.scrollState, a = n.focus, c = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var d, g;
    ...
    return (c || a) && (requestAnimationFrame(l), setTimeout(l, 0), setTimeout(l, 50), setTimeout(l, 150), setTimeout(l, 300), setTimeout(l, 450)), f;
  }
  /**
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((c = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : c.resources) ?? {}, p = ((u = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : u.value) ?? 0, s = ((d = r.currentHealth) == null ? void 0 : d.legs) ?? 0, n = N._healthStatusFromRatio(s, p), f = Number(((S = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(i) {
    ...
    const f = (Number(s.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((o) => (Number(s[o]) || 0) === 0).length;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-BQwANC2h.mjs");
      u(this.actor, l);
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      a.preventDefault();
      const c = a.currentTarget, l = c.dataset.skill, u = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: d } = await import("./roll-sheet-BQwANC2h.mjs");
      d(this.actor, l, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      const c = a.currentTarget, l = c.dataset.itemId;
      if (!l) return;
      const u = this.actor.items.get(l);
      if (!u) return;
      ...
      var P, O;
      const c = a.currentTarget, l = (c.dataset.itemId ?? "").trim();
      if (!l) return;
      const u = this.actor.items.get(l);
      ...
      var k;
      a.preventDefault();
      const c = a.currentTarget, l = c.closest(".karakter-microchip-slot-select-wrap"), u = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), d = u == null ? void 0 : u.dataset.slot;
      if (!d) return;
      ...
      var v;
      if (a.preventDefault(), !a.altKey) return;
      const c = a.currentTarget.dataset.area, l = a.currentTarget.dataset.itemId;
      if (!c || !l) return;
    ...
    const n = this, f = (a) => {
      ...
      var c, l, u;
      return a && (((l = (c = n.element) == null ? void 0 : c.contains) == null ? void 0 : l.call(c, a)) || n.id && ((u = a.closest) == null ? void 0 : u.call(a, `#${CSS.escape(n.id)}`)));
    };
    n._votvBlur = (a) => {
      const c = a.target;
      if (!c || !c.form) return;
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const p = this.actor.items.contents.slice().sort((h, a) => {
      const c = typeof h.sort == "number" ? h.sort : 0, l = typeof a.sort == "number" ? a.sort : 0;
      return c - l;
  ...
  async _rollWeapon(i) {
    ...
    const n = s && s.name || t.name || `Fegyver (${i})`, f = Number(t.bonus || 0) || 0, y = (((v = s == null ? void 0 : s.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, a = f + h, l = `3d6${a !== 0 ? a > 0 ? `+${a}` : `${a}` : ""}`, u = new Roll(l);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      ...
      const n = ((u = (l = (c = foundry.applications) == null ? void 0 : c.apps) == null ? void 0 : l.FilePicker) == null ? void 0 : u.implementation) ?? globalThis.FilePicker;
      new n({
        type: "image",
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      var f, m, y, h;
      if (!e.isEditable || !((m = (f = s.target) == null ? void 0 : f.closest) != null && m.call(f, ".profile")) && ((h = (y = s.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (s, n, f, m) => {
    ...
    if (!y) return;
    const h = document.activeElement, a = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), c = [], l = (S = game.actors) == null ? void 0 : S.get(y);
...
//# sourceMappingURL=vacuum-of-the-void-Du8HgBbv.mjs.map
