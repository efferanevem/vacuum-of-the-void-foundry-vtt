...
const { BooleanField: jt, NumberField: Jt, StringField: Se } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var De, oe, de, ce, be, ke, Me, je, Re, Ke, Ee, Oe, tt, st, it, rt, nt, at;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((de = (oe = (De = this.actor.system) == null ? void 0 : De.resources) == null ? void 0 : oe.stress) == null ? void 0 : de.value) || 0;
    e.stressOver10 = t > 10;
    ...
    const h = e.computedHealthStatus.legs ?? 3, i = Number(((ke = (be = this.actor.system) == null ? void 0 : be.combat) == null ? void 0 : ke.givenSpeed) ?? 0) || 0;
    let r;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), C = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Ee = O.slot2) == null ? void 0 : Ee.itemId) ?? "").trim(), A = (((Oe = O.slot3) == null ? void 0 : Oe.itemId) ?? "").trim(), H = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return _ - L;
    }).map((y) => {
      var le, we, Ie, me, pe, Fe;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Ce = 0; Ce < C.length; Ce++) {
        const Ne = C[Ce];
        if ((((le = b[Ne]) == null ? void 0 : le.itemId) ?? "") === y.id) {
          L = Ce + 1, M = ((we = b[Ne]) == null ? void 0 : we.bonus) ?? "", J = Ne;
          break;
        }
      }
      let Y = null;
      _ && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : A === y.id && (Y = "slot3"));
      const Ae = D && ((Ie = y.system) != null && Ie.damage) ? y.system.damage : "", ee = D && typeof ((me = y.system) == null ? void 0 : me.range) == "string" ? (y.system.range || "").trim() : "", ve = J ? Number((pe = b[J]) == null ? void 0 : pe.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
        ...
        rangeStr: ee,
        slotBonusNum: ve,
        quantity: Number(((Fe = y.system) == null ? void 0 : Fe.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = H;
    const U = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((y) => y.type === "Fegyver"), Z = U.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = Z;
    const z = "— Nincs fegyver —", V = C.filter((y) => {
    ...
    const fe = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ye = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = U.map((y) => {
      ...
      const M = !!_, J = ((ct = y.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = y.system) == null ? void 0 : lt.equipped) !== null ? !!y.system.equipped : M, Y = (y == null ? void 0 : y.system) ?? {}, Ae = typeof Y.range == "string" ? (Y.range || "").trim() : "", ee = Y.type ?? "", ve = (fe[ee] ?? ee) || "—", le = Y.size ?? "", we = (ye[le] ?? le) || "", Ie = [ve, we].filter(Boolean).join(", ") || ve || "—", me = ee === "projectile" || le === "thrown", pe = Y.quantity, Fe = pe != null ? String(pe).trim() : "1", Ce = String(L.bonus ?? "").trim(), Ne = String(Y.bonus ?? "").trim(), Lt = Ce || Ne || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
        ...
        typeAndSize: Ie,
        quantity: Fe,
        quantityDisplay: me ? Fe : "—",
        isProjectile: me,
        equipped: J,
        special: (Y.special ?? "").trim() || "—"
      };
    });
    const ge = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((y) => y.type === "Pancel");
    ...
    const Te = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((y) => y.type === "MikroChip"), he = Te.map((y) => ({ id: y.id, name: y.name, img: y.img })), qe = "— Nincs Mikro-Chip —", Le = ["slot1", "slot2", "slot3"], _e = (y) => {
      var _, L, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = he.filter((y) => !_e(1).includes(y.id)), e.microchipItemsSlot2 = he.filter((y) => !_e(2).includes(y.id)), e.microchipItemsSlot3 = he.filter((y) => !_e(3).includes(y.id)), e.microchipSlots = Le.map((y) => {
      const D = O[y] ?? {}, _ = (D.itemId ?? "").trim(), L = Te.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || qe,
        img: (L == null ? void 0 : L.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const D = `slot${y}`, _ = O[D] ?? {}, L = (_.itemId ?? "").trim(), M = he.find((J) => J.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || qe, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = Te.map((y) => {
      var le, we, Ie, me;
      const D = y.id;
      let _ = null;
      for (const pe of Le)
        if ((((le = O[pe]) == null ? void 0 : le.itemId) ?? "").trim() === D) {
          _ = pe;
          break;
        }
      const L = !!_, M = ((we = y == null ? void 0 : y.system) == null ? void 0 : we.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Ae = Number((Ie = y == null ? void 0 : y.system) == null ? void 0 : Ie.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, ee = (((me = y == null ? void 0 : y.system) == null ? void 0 : me.description) ?? "").trim(), ve = ee ? ee.length > 60 ? ee.slice(0, 57) + "…" : ee : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Pe = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      var D, _, L;
      return {
        id: y.id,
        name: y.name,
      ...
      const D = Pe[y] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? N.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-G5_NNJvI.mjs");
      n(this.actor, a);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-G5_NNJvI.mjs");
      l(this.actor, a, n);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var z, V, fe, ye, ge, $e, xe, Te, he, qe, Le, _e, Pe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((z = this.actor) == null ? void 0 : z.system), e.showDeathSkull = !1, e.sizeForSelect = (((fe = (V = e.system) == null ? void 0 : V.identity) == null ? void 0 : fe.size) ?? "").trim() || "Közepes";
    const t = this.actor, c = ((ye = t == null ? void 0 : t.items) == null ? void 0 : ye.contents) ?? [], d = ((ge = t == null ? void 0 : t.system) == null ? void 0 : ge.weapons) ?? {}, o = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), f = u ? u.split(/\s*,\s*/).filter((k) => o.includes(k)) : [], m = c.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = f.length > 0 ? f : o, r = o.filter((k) => !i.includes(k)), a = [...i, ...r], n = a.filter((k) => {
      var x;
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, K = {};
      for (const Oe of a)
        if ((((Ee = d[Oe]) == null ? void 0 : Ee.itemId) ?? "").trim() === N) {
          x = Oe, K = d[Oe] ?? {};
          break;
        }
      const ue = !!x, W = (k == null ? void 0 : k.system) ?? {}, De = typeof W.range == "string" ? (W.range || "").trim() : "", oe = W.type ?? "", de = (l[oe] ?? oe) || "—", ce = W.size ?? "", be = (p[ce] ?? ce) || "", ke = [de, be].filter(Boolean).join(", ") || de || "—", Me = oe === "projectile" || ce === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: N,
        actorId: t.id,
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], C = c.filter((k) => k.type === "MikroChip");
    e.microchipsTable = C.map((k) => {
      var oe, de, ce, be;
      const N = k.id;
      let x = null;
      for (const ke of I)
        if ((((oe = v[ke]) == null ? void 0 : oe.itemId) ?? "").trim() === N) {
          x = ke;
          break;
        }
      const K = ((de = k == null ? void 0 : k.system) == null ? void 0 : de.abilityType) ?? "", ue = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", W = (((ce = k == null ? void 0 : k.system) == null ? void 0 : ce.description) ?? "").trim(), De = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: N,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
        ...
        typeLabel: ue,
        description: De,
        kp: Number((be = k == null ? void 0 : k.system) == null ? void 0 : be.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: K === "active",
        slotKey: x ?? "",
        equipped: !!x
      };
    ...
    const T = (((Te = e.weaponsTable) == null ? void 0 : Te.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((qe = e.microchipsTable) == null ? void 0 : qe.length) ?? 0) > 0 || (((Le = e.itemsTable) == null ? void 0 : Le.length) ?? 0) > 0 || (((_e = e.egyebList) == null ? void 0 : _e.length) ?? 0) > 0;
    e.showEquipmentDropZone = !T;
    const S = ((Pe = t == null ? void 0 : t.system) == null ? void 0 : Pe.abilities) ?? {}, A = c.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var N, x;
      return {
        id: k.id,
        name: k.name,
    ...
    return e.abilityPassiveList = Z(U("passive")), e.abilityActiveList = Z(U("active")), e;
  }
  _attachFrameListeners(s) {
    var m, g, h;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-G5_NNJvI.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = o.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = (S.slotOrder ?? "").trim(), H = F ? F.split(/\s*,\s*/).filter((z) => A.includes(z)) : [];
      let U = A.find((z) => {
        var V;
        return !(((V = S[z]) == null ? void 0 : V.itemId) ?? "").trim();
      });
      U || (U = A.find((z) => !H.includes(z)) ?? "slot1");
      const Z = H.includes(U) ? H : [...H, U].filter((z) => A.includes(z));
      await o.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var l, p, b, v, I, C, q, O, T, S, A, F, H, U, Z, z, V, fe, ye;
    const t = (p = (l = e.target) == null ? void 0 : l.closest) == null ? void 0 : p.call(l, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    const c = (t.dataset.messageId ?? "").trim();
    if (!c) return;
    const d = (b = game.messages) == null ? void 0 : b.get(c), o = (I = (v = d == null ? void 0 : d.flags) == null ? void 0 : v["vacuum-of-the-void"]) == null ? void 0 : I.weapon;
    if (!o) return;
    const u = o.actorId ?? ((C = d == null ? void 0 : d.speaker) == null ? void 0 : C.actor) ?? "";
    if (!u) return;
    e.preventDefault(), e.stopPropagation();
    let f = ((q = game.actors) == null ? void 0 : q.get(o.actorId)) ?? ((O = game.actors) == null ? void 0 : O.get(u));
    if (!f) return;
    const m = o.itemId ? ((S = (T = f.items) == null ? void 0 : T.get) == null ? void 0 : S.call(T, o.itemId)) ?? ((H = (F = (A = f.items) == null ? void 0 : A.contents) == null ? void 0 : F.find) == null ? void 0 : H.call(F, (ge) => ge.id === o.itemId)) : null;
    let g = (((U = m == null ? void 0 : m.system) == null ? void 0 : U.damage) ?? "").trim();
    if (!g && o.slotKey && (g = (((((Z = f.system) == null ? void 0 : Z.weapons) ?? {})[o.slotKey] ?? {}).damage ?? "").trim()), !g) {
      (ye = (z = ui.notifications) == null ? void 0 : z.warn) == null || ye.call(z, ((fe = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : fe.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const h = new Roll(g);
    await h.evaluate({ async: !0 });
    const i = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, r = o.targetName || "", a = o.hitLocationName || "";
    let n = r ? `${m.name} – sebzés – ${r}` : `${m.name} – sebzés`;
    a && (n += ` (${a})`), await h.toMessage({
...
//# sourceMappingURL=vacuum-of-the-void-7fXvAs1O.mjs.map
