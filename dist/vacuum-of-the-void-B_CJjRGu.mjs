...
var Ys = Reflect.get;
var Zs = (S, s, e) => s in S ? Ws(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var te = (S, s, e) => Zs(S, typeof s != "symbol" ? s + "" : s, e);
var K = (S, s, e) => Ys(Js(S), e, s);
const { HTMLField: Xs, NumberField: F, SchemaField: B, StringField: C, BooleanField: pe, ArrayField: St } = foundry.data.fields;
...
function Kt(S) {
  ...
  const f = (a, i = 1) => {
    ...
    for (const r of a) {
      ...
      const d = typeof r.faces == "number" ? r.faces : void 0, h = Array.isArray(r.results) ? r.results : null;
  ...
  f(S.terms, 1);
  const c = s.filter((a) => a === 6).length, p = s.filter((a) => a === 1).length, u = e.filter((a) => a === 6).length, l = t.filter((a) => a === 6).length, m = c + u, g = p + l;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (f) {
      ...
      const d = document.activeElement, h = c.contains(d), y = d && (d.tagName === "INPUT" && d.type !== "checkbox" && d.type !== "radio" || d.tagName === "TEXTAREA");
      h && y && (p.focus = {
        name: d.name || null,
        id: d.id || null,
    ...
    const l = this.element, m = this.form ?? this.element, g = p.scrollState, a = p.focus, i = typeof (g == null ? void 0 : g.formScrollTop) == "number" || typeof (g == null ? void 0 : g.windowScrollTop) == "number", o = () => {
      ...
      if (this._applyScrollState(l, g), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const y = ((d = m.querySelector) == null ? void 0 : d.call(m, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (h = m.querySelector) == null ? void 0 : h.call(m, `[name="${CSS.escape(a.name)}"]`) : null);
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const c of s) {
      const p = String(((f = c.system) == null ? void 0 : f.speedPenalty) ?? "").trim().replace(",", "."), u = Number(p);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const c of s) {
      const p = String(((f = c.system) == null ? void 0 : f.protectionBonus) ?? "").trim().replace(",", "."), u = Number(p);
      Number.isFinite(u) && (e += u);
    }
    return e;
  }
  ...
  static getTotalSpeedRaw(s) {
    ...
    const u = Number(((d = (r = s.system) == null ? void 0 : r.combat) == null ? void 0 : d.speed) ?? 0) || 0, l = Number(((y = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : y.speedBonus) ?? 0) || 0;
    return u + l + (Number.isFinite(p) ? p : 0);
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((d = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : d.resources) ?? {}, f = ((y = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : y.value) ?? 0, c = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = ee._healthStatusFromRatio(c, f), u = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let l;
    p === 0 ? l = 0 : p === 1 ? l = -6 : p === 2 ? l = -3 : l = u;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var l, m, g, a, i, o, r, d, h, y, v, k, w;
    const e = s ?? this.form ?? this.element;
    let t = (l = e == null ? void 0 : e.querySelector) == null ? void 0 : l.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((a = (g = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : g.combat) == null ? void 0 : a.givenProtection) ?? 0) || 0, f = (r = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && r.call(o, "lookaround") ? 1 : 0, c = (y = (h = (d = this.actor) == null ? void 0 : d.statuses) == null ? void 0 : h.has) != null && y.call(h, "halfcover") ? 3 : 0, p = (w = (k = (v = this.actor) == null ? void 0 : v.statuses) == null ? void 0 : k.has) != null && w.call(k, "threequarteredcover") ? 6 : 0, u = n + this._getTotalArmorProtectionBonus() + f + c + p;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const u = Number(c == null ? void 0 : c.value) || 0, l = Number(p == null ? void 0 : p.value) || 0, m = Number(f == null ? void 0 : f.textContent) || 0;
    n.textContent = String(u + l + m);
  }
  _writeTotalSpeed(s = null) {
    ...
    if (!n) return;
    if ((h = (d = (r = this.actor) == null ? void 0 : r.statuses) == null ? void 0 : d.has) != null && h.call(d, "immobilized")) {
      n.textContent = "0";
      return;
    }
    const u = ((v = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : v.resources) ?? {}, l = ((w = (k = u.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, m = ((T = u.currentHealth) == null ? void 0 : T.legs) ?? 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, n = ((u = (p = t.hitLocations) == null ? void 0 : p[e]) == null ? void 0 : u.value) ?? 0, f = ((l = t.currentHealth) == null ? void 0 : l[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((p = s == null ? void 0 : s.system) == null ? void 0 : p.resources) ?? {}, f = ((l = (u = n.hitLocations) == null ? void 0 : u[t]) == null ? void 0 : l.value) ?? 0, c = ((m = n.currentHealth) == null ? void 0 : m[t]) ?? 0;
    return ee._healthStatusFromRatio(c, f);
  }
  async _prepareContext(s) {
    var lt, ut, dt, mt, pt, ft, yt, gt, ht, We, bt, vt, Je, I, P, E, G, ke, ne, Ce, Te, we, $e, Ye, Ze, qt, Nt, Lt, Ft, kt, at, Zt, Xt, Qt, es, ts, ss, is, ns, as, rs, os, cs, ls, us;
    ...
    const u = (Number(c.head) || 0) === 0, m = ["torso", "arms", "legs"].filter((b) => (Number(c[b]) || 0) === 0).length;
    e.showDeathSkull = u || m >= 2;
    const g = e.computedHealthStatus.legs ?? 3, a = Number(((ft = (pt = this.actor.system) == null ? void 0 : pt.combat) == null ? void 0 : ft.givenSpeed) ?? 0) || 0;
    let i;
    g === 0 ? i = 0 : g === 1 ? i = -6 : g === 2 ? i = -3 : i = a;
    const o = this._getTotalArmorSpeedPenalty();
    i += o, e.effectiveGivenSpeed = i;
    const r = Number(((gt = (yt = this.actor.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.givenProtection) ?? 0) || 0, d = (bt = (We = (ht = this.actor) == null ? void 0 : ht.statuses) == null ? void 0 : We.has) != null && bt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (vt = this.actor) == null ? void 0 : vt.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, y = (G = (E = (P = this.actor) == null ? void 0 : P.statuses) == null ? void 0 : E.has) != null && G.call(E, "threequarteredcover") ? 6 : 0, v = r + this._getTotalArmorProtectionBonus() + d + h + y;
    ...
    g === 0 && (T = 0), (Te = (Ce = (ne = this.actor) == null ? void 0 : ne.statuses) == null ? void 0 : Ce.has) != null && Te.call(Ce, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), z = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], H = (Ye = this.actor.system.gear) == null ? void 0 : Ye.microchips, R = H && typeof H == "object" && !Array.isArray(H) ? H : {}, Y = (((Ze = R.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), Q = (((qt = R.slot2) == null ? void 0 : qt.itemId) ?? "").trim(), J = (((Nt = R.slot3) == null ? void 0 : Nt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      const N = typeof b.sort == "number" ? b.sort : 0, A = typeof L.sort == "number" ? L.sort : 0;
      return N - A;
    }).map((b) => {
      var xe, Qe, et, Ke, ze, wt;
      const L = b.type === "Fegyver", N = b.type === "MikroChip";
      let A = 0, U = "", de = null;
      for (let rt = 0; rt < z.length; rt++) {
        const It = z[rt];
        if ((((xe = O[It]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          A = rt + 1, U = ((Qe = O[It]) == null ? void 0 : Qe.bonus) ?? "", de = It;
          break;
        }
      }
      let re = null;
      N && (Y === b.id ? re = "slot1" : Q === b.id ? re = "slot2" : J === b.id && (re = "slot3"));
      const Xe = L && ((et = b.system) != null && et.damage) ? b.system.damage : "", Ie = L && typeof ((Ke = b.system) == null ? void 0 : Ke.range) == "string" ? (b.system.range || "").trim() : "", De = de ? Number((ze = O[de]) == null ? void 0 : ze.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    const ve = "— Nincs fegyver —", D = z.filter((b) => {
      ...
      return N ? !!W.find((U) => U.id === N) : !1;
    });
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, A = (N.itemId ?? "").trim(), U = ce.find((De) => De.id === A), de = W.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Xe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: L + 1,
        displayName: (U == null ? void 0 : U.name) || N.name || ve,
    ...
    e.weaponsTable = W.map((b) => {
      ...
      const U = !!N, de = ((ms = b.system) == null ? void 0 : ms.equipped) !== void 0 && ((ps = b.system) == null ? void 0 : ps.equipped) !== null ? !!b.system.equipped : U, re = (b == null ? void 0 : b.system) ?? {}, Xe = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", De = (x[Ie] ?? Ie) || "—", xe = re.size ?? "", Qe = (V[xe] ?? xe) || "", et = [De, Qe].filter(Boolean).join(", ") || De || "—", Ke = Ie === "projectile" || xe === "thrown", ze = re.quantity, wt = ze != null ? String(ze).trim() : "1", rt = String(A.bonus ?? "").trim(), It = String(re.bonus ?? "").trim(), Vs = rt || It || "0";
      return {
        slotKey: N ?? "",
        itemId: L,
    ...
    e.armorTable = X.map((b) => {
      var A, U;
      const L = (b == null ? void 0 : b.system) ?? {}, N = ((A = b.system) == null ? void 0 : A.equipped) !== void 0 && ((U = b.system) == null ? void 0 : U.equipped) !== null ? !!b.system.equipped : !1;
      return {
        itemId: b.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = oe.map((b) => {
      const L = (b == null ? void 0 : b.system) ?? {}, N = (L.description ?? "").trim(), A = N ? N.length > 60 ? N.slice(0, 57) + "…" : N : "—", U = L.quantity != null ? String(L.quantity).trim() : "1";
      return {
        itemId: b.id,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const me = (((Zt = this.actor.items) == null ? void 0 : Zt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Re = (b) => {
      var N, A, U;
      const L = [];
      return b !== 1 && L.push((((N = R.slot1) == null ? void 0 : N.itemId) ?? "").trim()), b !== 2 && L.push((((A = R.slot2) == null ? void 0 : A.itemId) ?? "").trim()), b !== 3 && L.push((((U = R.slot3) == null ? void 0 : U.itemId) ?? "").trim()), L.filter(Boolean);
    };
    e.microchipItemsSlot1 = ie.filter((b) => !Re(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Re(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Re(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      const L = R[b] ?? {}, N = (L.itemId ?? "").trim(), A = me.find((U) => U.id === N);
      return {
        slotKey: b,
        itemId: N,
      ...
      const L = `slot${b}`, N = R[L] ?? {}, A = (N.itemId ?? "").trim(), U = ie.find((de) => de.id === A);
      e[`microchip${b}ItemId`] = A, e[`microchip${b}DisplayName`] = (U == null ? void 0 : U.name) || N.name || ge, e[`microchip${b}Img`] = (U == null ? void 0 : U.img) || "";
    ...
    }), Ee = new Map(Dt.map((b) => [b.id, b])), He = "— Nincs képesség —", Me = (b) => {
      const L = st[b] ?? {}, N = (L.itemId ?? "").trim(), A = N ? Ee.get(N) : null, U = (A == null ? void 0 : A.description) ?? "", de = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: N,
    ...
    e.kpDots = he.map((b, L) => {
      const N = L + 1, A = !!Number(se[b]), U = N <= ct;
      return { index: N, used: A, usable: U };
    });
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: d } = await import("./roll-sheet-D9IwXq4y.mjs");
      d(this.actor, r);
      ...
      if (!r) {
        ...
        if (!v) return;
        r = (((((h = (d = this.actor) == null ? void 0 : d.system) == null ? void 0 : h.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      r && await this._rollWeaponDamage(r, ((y = o.dataset.slot) == null ? void 0 : y.trim()) ?? "");
    }), t.on("click", ".karakter-harc-initiative", async (i) => {
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D9IwXq4y.mjs");
      ...
      const d = `system.resources.kpDot${r}`, h = !!Number((v = (y = this.actor.system) == null ? void 0 : y.resources) == null ? void 0 : v[`kpDot${r}`]);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var d, h, y;
      i.preventDefault(), i.stopPropagation();
      const o = ((y = (h = (d = foundry.applications) == null ? void 0 : d.apps) == null ? void 0 : h.FilePicker) == null ? void 0 : y.implementation) ?? globalThis.FilePicker;
      new o({
        type: "image",
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, d = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-D9IwXq4y.mjs");
      h(this.actor, r, d);
      ...
      var k, w, T, _, O, q, j;
      i.preventDefault();
      const r = i.currentTarget.closest(".karakter-weapon-slot"), d = r == null ? void 0 : r.dataset.slot;
      if (!d) return;
      const y = (((w = (((k = this.actor.system) == null ? void 0 : k.weapons) ?? {})[d]) == null ? void 0 : w.itemId) ?? "").trim();
      if (!y) return;
      const v = ((_ = (T = this.actor.items).get) == null ? void 0 : _.call(T, y)) ?? ((q = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : q.call(O, (z) => z.id === y));
    ...
    const p = (i, o) => {
      ...
      if (!r) return;
      const d = this.actor.items.get(r);
      if (d) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!r) return;
      const d = this.actor, h = d.items.get(r);
      if (!h) return;
      const y = {};
      ...
      Object.keys(y).length && await d.update(y), await d.deleteEmbeddedDocuments("Item", [r]);
      ...
      if (o.checked) {
        ...
        let q = k.find((z) => {
          var H;
          return !((H = h[z]) != null && H.itemId);
        });
        const j = new Set(k);
        if (!q) {
          const z = v.find((H) => !j.has(H));
          if (!z) return;
          q = z, k.push(z);
        }
      ...
      const r = o.closest(".karakter-microchip-slot-select-wrap"), d = r == null ? void 0 : r.classList.contains("karakter-microchip-slot-open");
      t.find(".karakter-microchip-slot-select-wrap").removeClass("karakter-microchip-slot-open"), !d && r && r.classList.add("karakter-microchip-slot-open");
    }), t.on("click", ".karakter-microchip-slot-option", async (i) => {
      var q;
      i.preventDefault();
      const o = i.currentTarget, r = o.closest(".karakter-microchip-slot-select-wrap"), d = r == null ? void 0 : r.querySelector(".karakter-microchip-slot-display"), h = d == null ? void 0 : d.dataset.slot;
      if (!h) return;
      ...
      k ? (T || (T = document.createElement("img"), T.className = "karakter-microchip-slot-thumb", T.alt = "", d == null || d.insertBefore(T, w)), T.src = k, T.style.display = "") : T && T.remove(), r == null || r.classList.remove("karakter-microchip-slot-open");
      ...
      const d = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, y = ["slot1", "slot2", "slot3"].find((w) => {
        var T;
      ...
      o.addEventListener("dragover", (d) => this._onMicrochipSlotDragOver(d, r)), o.addEventListener("dragleave", (d) => {
        var h;
        return (h = d.currentTarget) == null ? void 0 : h.classList.remove("karakter-microchip-slot-drag-over");
      }), o.addEventListener("drop", (d) => this._onMicrochipSlotDrop(d, r));
    }), t.find(".karakter-ability-slot-single").each((i, o) => {
      const r = o.dataset.slot;
      r && (o.addEventListener("dragover", (d) => this._onAbilitySingleDragOver(d, r)), o.addEventListener("dragleave", (d) => {
        var h;
      ...
      r && (o.addEventListener("dragover", (d) => this._onAbilityAreaDragOver(d, r)), o.addEventListener("dragleave", (d) => {
        var h;
      ...
      if (!o || !r) return;
      const d = this.actor.system.abilities ?? {}, y = (Array.isArray((v = d[o]) == null ? void 0 : v.items) ? d[o].items.slice() : []).filter((k) => k !== r);
      ...
      if (!r) return;
      const d = this.actor.items.get(r);
      d && (d.type === "Kepesseg" || d.type === "ability" ? await this._postAbilityToChat(r) : (d.type === "MikroChip" || d.type === "Egyeb") && await this._postItemToChat(r));
      ...
      const r = i.currentTarget.dataset.itemId;
      if (!r) return;
      const d = this.actor, h = d.items.get(r), y = {};
      if ((h == null ? void 0 : h.type) === "Fegyver") {
        const v = d.system.weapons ?? {}, k = (v.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], T = k ? k.split(/\s*,\s*/).filter((O) => w.includes(O)) : [], _ = T.find((O) => {
          var q;
          return (((q = v[O]) == null ? void 0 : q.itemId) ?? "").trim() === r;
    ...
    const u = this, l = (i) => {
      ...
      const r = ((h = (d = o.system) == null ? void 0 : d.resources) == null ? void 0 : h.currentHealth) != null || ((v = (y = o.system) == null ? void 0 : y.resources) == null ? void 0 : v.hitLocations) != null;
      u.actor.update(o).then(() => {
        r && setTimeout(() => u.render(!0), 260);
      }).catch((k) => console.warn("VoidKarakterSheet save failed", k));
    }, m = (i) => {
      var o, r, d;
      return i && (((r = (o = u.element) == null ? void 0 : o.contains) == null ? void 0 : r.call(o, i)) || u.id && ((d = i.closest) == null ? void 0 : d.call(i, `#${CSS.escape(u.id)}`)));
    };
    u._votvBlur = (i) => {
      var y;
      const o = i.target;
      ...
      h && (d.contains(h) || u.id && ((y = h.closest) != null && y.call(h, `#${CSS.escape(u.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: u.id, at: Date.now() }), l(d));
  ...
  async _onDropItem(s, e) {
    var t, n, f, c, p, u, l, m, g, a, i, o, r, d;
    if (e) {
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (y && y.documentName === "Item" && y.type === "Fegyver") {
          ...
          let w = y.id;
          if (k) {
            const T = foundry.utils.mergeObject(y.toObject(), { system: { ...y.toObject().system ?? {}, equipped: !1 } });
            w = ((a = (await v.createEmbeddedDocuments("Item", [T]))[0]) == null ? void 0 : a.id) ?? w;
          }
          if (k) {
            const T = ((i = v.system) == null ? void 0 : i.weapons) ?? {}, _ = (T.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = _ ? _.split(/\s*,\s*/).filter((z) => O.includes(z)) : [], j = q.filter((z) => {
              var H;
              return (((H = T[z]) == null ? void 0 : H.itemId) ?? "").trim() === w;
            });
            if (j.length > 0) {
              const H = {
              ...
              for (const R of j)
                H[`system.weapons.${R}.itemId`] = "", H[`system.weapons.${R}.name`] = "", H[`system.weapons.${R}.damage`] = "", H[`system.weapons.${R}.bonus`] = "";
              await v.update(H);
            }
          }
          return;
        ...
        if (y && y.documentName === "Item" && (y.type === "Targy" || y.type === "Egyeb")) {
          const v = this.actor;
          ((d = y.parent) == null ? void 0 : d.id) !== v.id && await v.createEmbeddedDocuments("Item", [y.toObject()]);
          return;
        }
      }
    }
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((m = e.system) == null ? void 0 : m.kind) ?? "passive", n = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", u = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: m, label: g } = Kt(l), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return l.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const p = c && c.name || t.name || `Fegyver (${s})`, u = Number(t.bonus || 0) || 0, l = ((k = c == null ? void 0 : c.system) == null ? void 0 : k.type) || "kinetic", m = (((w = c == null ? void 0 : c.system) == null ? void 0 : w.skillKey) ?? "").trim(), g = m && n[m] !== void 0 ? m : l === "explosive" ? "grenadeUse" : "firearms", a = Number(n[g] || 0) || 0, i = u + a, r = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, d = new Roll(r);
    await d.evaluate({ async: !0 });
    const { resultType: h, label: y } = Kt(d), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return d.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${p} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    var u, l, m, g, a, i, o, r, d, h;
    const t = this.actor;
    if (!t) return;
    let n = ((l = (u = t.items).get) == null ? void 0 : l.call(u, s)) ?? ((g = (m = t.items.contents) == null ? void 0 : m.find) == null ? void 0 : g.call(m, (y) => y.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((d = (r = game.i18n) == null ? void 0 : r.localize) == null ? void 0 : d.call(r, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const c = new Roll(f);
...
te(ee, "PARTS", foundry.utils.mergeObject(
  ...
  K(ee, ee, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Is = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Is.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ss = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ss.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ds = (Ts = K(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ts.window) == null ? void 0 : Ds.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = await super.render(s, e), p = this.element, u = this.form ?? this.element, l = f.scrollState, m = f.focus, g = typeof (l == null ? void 0 : l.formScrollTop) == "number" || typeof (l == null ? void 0 : l.windowScrollTop) == "number", a = () => {
      var i, o;
      if (this._applyScrollState(p, l), (m == null ? void 0 : m.name) != null || (m == null ? void 0 : m.id) != null) {
        const r = ((i = u.querySelector) == null ? void 0 : i.call(u, m.id ? `#${CSS.escape(m.id)}` : null)) ?? (m.name ? (o = u.querySelector) == null ? void 0 : o.call(u, `[name="${CSS.escape(m.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((se = e.system) == null ? void 0 : se.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, c = (ae = (he = t == null ? void 0 : t.statuses) == null ? void 0 : he.has) != null && ae.call(he, "lookaround") ? 1 : 0, p = (nt = (be = t == null ? void 0 : t.statuses) == null ? void 0 : be.has) != null && nt.call(be, "halfcover") ? 3 : 0, u = (Oe = (_e = t == null ? void 0 : t.statuses) == null ? void 0 : _e.has) != null && Oe.call(_e, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + c + p + u;
    const l = (($t = t == null ? void 0 : t.items) == null ? void 0 : $t.contents) ?? [], m = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (m.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((I) => g.includes(I)) : [], o = l.filter((I) => I.type === "Fegyver"), r = o.map((I) => ({ id: I.id, name: I.name, img: I.img })), d = "— Nincs fegyver —", h = i.length > 0 ? i : g, y = g.filter((I) => !h.includes(I)), v = [...h, ...y], k = v.filter((I) => {
      var E;
      const P = (((E = m[I]) == null ? void 0 : E.itemId) ?? "").trim();
      return P && o.some((G) => G.id === P);
    });
    e.weaponSlots = k.map((I) => {
      const P = m[I] ?? {}, E = (P.itemId ?? "").trim(), G = r.find((we) => we.id === E), ke = o.find((we) => we.id === E), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", Te = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: I,
        itemId: E,
    ...
    e.weaponsTable = o.map((I) => {
      ...
      let E = null, G = {};
      for (const at of v)
        if ((((kt = m[at]) == null ? void 0 : kt.itemId) ?? "").trim() === P) {
          E = at, G = m[at] ?? {};
          break;
        }
      const ke = !!E, ne = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", Te = ne.type ?? "", we = (w[Te] ?? Te) || "—", $e = ne.size ?? "", Ye = (T[$e] ?? $e) || "", Ze = [we, Ye].filter(Boolean).join(", ") || we || "—", qt = Te === "projectile" || $e === "thrown", Nt = ne.quantity != null ? String(ne.quantity).trim() : "1", Lt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Ft = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: P,
        actorId: t.id,
        name: (I == null ? void 0 : I.name) ?? d,
    ...
    e.armorTable = _.map((I) => {
      var G;
      const P = (I == null ? void 0 : I.system) ?? {}, E = ((G = I.system) == null ? void 0 : G.equipped) === !0;
      return {
        itemId: I.id,
        actorId: t.id,
        ...
        level: vi((P.level ?? "").toString().trim()),
        special: (P.special ?? P.other ?? "").toString().trim() || "—",
        equipped: E
      };
    });
    const O = ((_t = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : _t.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], j = l.filter((I) => I.type === "MikroChip");
    e.microchipsTable = j.map((I) => {
      var Te, we, $e, Ye;
      const P = I.id;
      let E = null;
      for (const Ze of q)
        if ((((Te = O[Ze]) == null ? void 0 : Te.itemId) ?? "").trim() === P) {
          E = Ze;
          break;
        }
    ...
    const z = l.filter((I) => I.type === "Targy");
    e.itemsTable = z.map((I) => {
      const P = (I == null ? void 0 : I.system) ?? {}, E = (P.description ?? "").trim(), G = E ? E.length > 60 ? E.slice(0, 57) + "…" : E : "—";
      return {
        itemId: I.id,
        actorId: t.id,
        name: (I == null ? void 0 : I.name) ?? "—",
    ...
    const H = l.filter((I) => I.type === "Egyeb");
    e.egyebList = H.map((I) => {
      const E = (((I == null ? void 0 : I.system) ?? {}).description ?? "").trim(), G = E ? E.length > 80 ? E.slice(0, 77) + "…" : E : "";
      return {
        itemId: I.id,
        actorId: t.id,
        name: (I == null ? void 0 : I.name) ?? "—",
    ...
    const R = (((Ot = e.weaponsTable) == null ? void 0 : Ot.length) ?? 0) > 0 || (((ct = e.armorTable) == null ? void 0 : ct.length) ?? 0) > 0 || (((Ct = e.microchipsTable) == null ? void 0 : Ct.length) ?? 0) > 0 || (((lt = e.itemsTable) == null ? void 0 : lt.length) ?? 0) > 0 || (((ut = e.egyebList) == null ? void 0 : ut.length) ?? 0) > 0;
    e.showEquipmentDropZone = !R;
    const Y = ((dt = t == null ? void 0 : t.system) == null ? void 0 : dt.abilities) ?? {}, Q = l.filter((I) => I.type === "Kepesseg" || I.type === "ability").map((I) => {
      var P, E, G;
      return {
        id: I.id,
        name: I.name,
        ...
        kp: Number(((E = I.system) == null ? void 0 : E.kp) ?? 0) || 0,
        kind: (((G = I.system) == null ? void 0 : G.kind) ?? "passive").toString()
      };
    }), J = new Map(Q.map((I) => [I.id, I])), Z = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const ce = t == null ? void 0 : t.id, ve = !!((pt = (mt = game.combat) == null ? void 0 : mt.combatants) != null && pt.some(
      (I) => {
        var P;
        return (((P = I.actor) == null ? void 0 : P.id) ?? I.actorId) === ce;
      }
    ));
    e.showHarcSection = ve;
    const D = ((ft = e.system) == null ? void 0 : ft.resources) ?? {}, x = (gt = (yt = e.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.initiativeResult, V = typeof x == "number" ? x : -1, X = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (ht = e.system) == null ? void 0 : ht.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : X).slice().sort((I, P) => I.min - P.min), ge = 3;
    let ue = le.length > 0 ? le : [];
    ue.length < ge && (ue = [...ue, ...Array(ge - ue.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ue.map((I, P) => ({
      ...I,
      isFirst: P === 0,
      isLast: P === ue.length - 1
    }));
    let Re = 0;
    if (typeof V == "number" && V >= 0 && ie.length > 0) {
      const I = ie[0], P = ie[ie.length - 1];
      let E = null;
      V <= I.max ? E = I : V >= P.min ? E = P : E = ie.find((G) => V >= G.min && V <= G.max), E && (Re = E.kp);
    }
    const Be = ie.length > 0 ? ie[ie.length - 1] : null, st = Math.min(10, Be ? Be.kp : 6), Ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, st)).map((I, P) => {
      const E = P + 1, G = !!Number(D[I]), ke = E <= Re;
      return { index: E, used: G, usable: ke };
    }), He = Math.ceil(Ee.length / 2);
    return e.kpDotsRow1 = Ee.slice(0, He), e.kpDotsRow2 = Ee.slice(He), e.canEditInitiative = !!((bt = game.user) != null && bt.isGM), e.showInitiativeResult = typeof x == "number", e.initiativeResult = e.showInitiativeResult ? x : "", e.speedUnitForSelect = ((Je = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : Je.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var l, m, g;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-portrait-img", (a) => {
      ...
      const i = ((h = (d = (r = foundry.applications) == null ? void 0 : r.apps) == null ? void 0 : d.FilePicker) == null ? void 0 : h.implementation) ?? globalThis.FilePicker;
      new i({
        type: "image",
        current: this.actor.img || "",
        callback: (y) => {
      ...
      var r, d, h;
      a.preventDefault();
      const i = (d = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : d.itemId;
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      var d, h, y, v;
      a.preventDefault();
      const i = (h = (d = a.currentTarget) == null ? void 0 : d.closest) == null ? void 0 : h.call(d, ".karakter-weapon-slot"), o = (((y = i == null ? void 0 : i.dataset) == null ? void 0 : y.itemId) ?? "").trim();
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D9IwXq4y.mjs");
      r(this.actor, o);
      ...
      !o && ((d = i == null ? void 0 : i.dataset) != null && d.slot) && (o = (((((y = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : y.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!o || !this.actor) && await this._rollWeaponDamage(o, (((v = i == null ? void 0 : i.dataset) == null ? void 0 : v.slot) ?? "").trim());
    }), t.on("click", ".karakter-harc-initiative", async (a) => {
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D9IwXq4y.mjs");
      ...
      const r = !!Number((h = (d = this.actor.system) == null ? void 0 : d.resources) == null ? void 0 : h[`kpDot${o}`]);
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: d } = await import("./roll-sheet-D9IwXq4y.mjs");
      d(this.actor, o, r);
      ...
      var r, d;
      a.preventDefault();
      const i = (((d = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : d.itemId) ?? "").trim();
      if (!i || !this.actor) return;
      const o = this.actor.items.get(i);
      ...
      if (!o || !this.actor) return;
      const r = this.actor, d = (((v = i == null ? void 0 : i.dataset) == null ? void 0 : v.slotKey) ?? "").trim(), h = {};
      d && (h[`system.weapons.${d}.itemId`] = "", h[`system.weapons.${d}.name`] = "", h[`system.weapons.${d}.damage`] = "", h[`system.weapons.${d}.bonus`] = ""), Object.keys(h).length && await r.update(h), await r.deleteEmbeddedDocuments("Item", [o]), typeof this.render == "function" && this.render(!0);
    ...
    c._votvNpcBlur = (a) => {
      ...
      d && (r.contains(d) || c.id && ((h = d.closest) != null && h.call(d, `#${CSS.escape(c.id)}`))) || p(r);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((w = e.system) == null ? void 0 : w.weapons) ?? {})[s] ?? {}, f = ((T = e.system) == null ? void 0 : T.skills) ?? {}, c = ((_ = e.items) == null ? void 0 : _.filter((j) => j.type === "Fegyver")) ?? [];
    let p = null;
    n.itemId && (p = c.find((j) => j.id === n.itemId) ?? null);
    const u = p && p.name || n.name || "Fegyver", l = Number(n.bonus || 0) || 0, m = ((O = p == null ? void 0 : p.system) == null ? void 0 : O.type) || "kinetic", g = (((q = p == null ? void 0 : p.system) == null ? void 0 : q.skillKey) ?? "").trim(), a = g && f[g] !== void 0 ? g : m === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, o = l + i, d = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, h = new Roll(d);
    await h.evaluate({ async: !0 });
    const { resultType: y, label: v } = Kt(h), k = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return h.toMessage({
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((l = (u = t.items).get) == null ? void 0 : l.call(u, s)) ?? ((g = (m = t.items.contents) == null ? void 0 : m.find) == null ? void 0 : g.call(m, (y) => y.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (o = ui.notifications) == null ? void 0 : o.warn) == null || h.call(o, ((d = (r = game.i18n) == null ? void 0 : r.localize) == null ? void 0 : d.call(r, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var m, g, a, i, o, r, d, h, y, v, k, w, T, _, O, q, j, z, H;
    if (!this.actor) return (m = super._onDropItem) == null ? void 0 : m.call(this, s, e);
    const n = ((R) => {
      var Q;
      if (!R) return null;
      const Y = R.uuid ?? R.documentUuid ?? ((Q = R.data) == null ? void 0 : Q.uuid) ?? (typeof R == "string" ? R : null);
      if (Y) return Y;
      if (typeof R == "object") {
    ...
    if (f.type === "Kepesseg" || f.type === "ability") {
      ...
      const Q = ((k = c.system) == null ? void 0 : k.abilities) ?? {}, J = R === "active" ? "active" : "passive", Z = Array.isArray((w = Q[J]) == null ? void 0 : w.items) ? Q[J].items.slice() : Array.isArray(Q[J]) ? Q[J].slice() : [];
      Z.includes(Y) || Z.push(Y), await c.update({ [`system.abilities.${J}.items`]: Z }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (f.type === "Fegyver" && l) {
      const R = ((O = c.system) == null ? void 0 : O.weapons) ?? {}, Y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Q = (R.slotOrder ?? "").trim(), J = Q ? Q.split(/\s*,\s*/).filter((W) => Y.includes(W)) : [];
      let Z = Y.find((W) => {
        var ce;
        return !(((ce = R[W]) == null ? void 0 : ce.itemId) ?? "").trim();
      });
      Z || (Z = Y.find((W) => !J.includes(W)) ?? "slot1");
      const M = J.includes(Z) ? J : [...J, Z].filter((W) => Y.includes(W));
      await c.update({
        "system.weapons.slotOrder": M.join(","),
        [`system.weapons.${Z}.itemId`]: l,
        [`system.weapons.${Z}.name`]: f.name ?? "",
        [`system.weapons.${Z}.damage`]: ((q = f.system) == null ? void 0 : q.damage) ?? "",
        [`system.weapons.${Z}.bonus`]: ((j = f.system) == null ? void 0 : j.bonus) ?? ""
      });
    }
    if (f.type === "MikroChip" && l) {
      const R = ((H = (z = c.system) == null ? void 0 : z.gear) == null ? void 0 : H.microchips) ?? {}, Q = ["slot1", "slot2", "slot3"].find((J) => {
        var Z;
        return !(((Z = R[J]) == null ? void 0 : Z.itemId) ?? "").trim();
      });
      Q && await c.update({
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((a = e.system) == null ? void 0 : a.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", u = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${p}
      ${u}
...
te(fe, "PARTS", foundry.utils.mergeObject(
  ...
  K(fe, fe, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((_s = K(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : _s.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Os = K(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : Os.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((qs = (Cs = K(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) == null ? void 0 : qs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const p = Number(f == null ? void 0 : f.value) || 0, u = Number(c == null ? void 0 : c.value) || 0;
    n.textContent = String(p + u);
  }
  async _prepareContext(s) {
    var q, j, z, H, R, Y, Q, J, Z, M, W, ce, ve;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((q = e.system) == null ? void 0 : q.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0);
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, f = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, c = "— Nincs fegyver —", p = (((j = this.actor.items) == null ? void 0 : j.contents) ?? []).filter((D) => D.type === "Fegyver");
    e.weaponsTable = p.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, V = x.type ?? "", X = (n[V] ?? V) || "—", oe = x.size ?? "", le = (f[oe] ?? oe) || "", me = [X, le].filter(Boolean).join(", ") || X || "—", ie = V === "projectile" || oe === "thrown", ge = x.quantity != null ? String(x.quantity).trim() : "1", ue = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    const u = (((z = this.actor.items) == null ? void 0 : z.contents) ?? []).filter((D) => D.type === "Pancel");
    e.armorTable = u.map((D) => {
      var X;
      const x = (D == null ? void 0 : D.system) ?? {}, V = !!((X = D.system) != null && X.equipped);
      return {
        itemId: D.id,
        actorId: this.actor.id,
        ...
        level: ki((x.level ?? "").toString().trim()),
        special: (x.special ?? x.other ?? "").toString().trim() || "—",
        equipped: V
      };
    });
    const l = (((H = this.actor.items) == null ? void 0 : H.contents) ?? []).filter((D) => D.type === "MikroChip");
    e.microchipsTable = l.map((D) => {
      var ie, ge, ue;
      const x = ((ie = D == null ? void 0 : D.system) == null ? void 0 : ie.abilityType) ?? "", V = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—", X = x === "active", oe = Number((ge = D == null ? void 0 : D.system) == null ? void 0 : ge.replaceCost) >= 0 ? Number(D.system.replaceCost) : 0, le = (((ue = D == null ? void 0 : D.system) == null ? void 0 : ue.description) ?? "").trim(), me = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    const m = (((R = this.actor.items) == null ? void 0 : R.contents) ?? []).filter((D) => D.type === "Targy");
    e.itemsTable = m.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, V = (x.description ?? "").trim(), X = V ? V.length > 60 ? V.slice(0, 57) + "…" : V : "—", oe = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    const g = (((Y = this.actor.items) == null ? void 0 : Y.contents) ?? []).filter((D) => D.type === "Jarmuegyseg").sort((D, x) => {
      const V = typeof D.sort == "number" ? D.sort : 0, X = typeof x.sort == "number" ? x.sort : 0;
      return V - X;
    }), a = [];
    let i = 0, o = 0, r = 0;
    const d = Number(((J = (Q = this.actor.system) == null ? void 0 : Q.vehicle) == null ? void 0 : J.storage) ?? 0) || 0;
    for (const D of g) {
      const x = (D == null ? void 0 : D.system) ?? {}, V = x.health ?? {}, X = Number(x.level ?? 0) || 0, oe = Number(V.max ?? 0) || 0, le = Number(V.value ?? 0) || 0;
      let me;
      if (oe <= 0)
        me = void 0;
      else if (le <= 0)
      ...
      const Re = (x.range ?? "").toString().trim().replace(",", "."), Be = Number(Re);
      Number.isFinite(Be) && (o += Be);
      const st = (x.damage ?? "").toString().trim(), Dt = (x.storage ?? "").toString().trim().replace(",", "."), Ee = Number(Dt);
      Number.isFinite(Ee) && (r += Ee);
      const He = x.abilities ?? {}, Me = Array.isArray(He.items) ? He.items : [], Ge = (await Promise.all(
        Me.map(async (se) => {
          var he;
          if (!se) return null;
          try {
    ...
    e.unitsTable = a, e.totalStorageUsed = r, e.vehicleStorageMax = d;
    const h = g.length;
    let y = "Kicsi", v = 0, k = 0;
    ...
    e.system = foundry.utils.mergeObject(
      ...
      {
        combat: { speed: w },
        vehicle: { toolsRange: T, storage: d },
        identity: { size: y }
      },
      { inplace: !1 }
    );
    const _ = (((Z = e.weaponsTable) == null ? void 0 : Z.length) ?? 0) > 0 || (((M = e.armorTable) == null ? void 0 : M.length) ?? 0) > 0 || (((W = e.microchipsTable) == null ? void 0 : W.length) ?? 0) > 0 || (((ce = e.itemsTable) == null ? void 0 : ce.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (u) => {
      ...
      var g, a, i;
      u.preventDefault();
      const l = (a = (g = u.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : a.itemId;
      if (!l) return;
      ...
      var a;
      const l = u.currentTarget, m = (a = l == null ? void 0 : l.dataset) == null ? void 0 : a.itemId;
      if (!m) return;
      ...
      if (!l) return;
      const m = this.actor.items.get(l);
      !m || m.type !== "Pancel" || await m.update({ "system.equipped": u.currentTarget.checked });
    }), t.on("click", ".jarmu-egyeb-name, .jarmu-egyeb-icon", (u) => {
      var m, g, a, i;
      u.preventDefault();
      const l = (g = (m = u.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : g.itemId;
      ...
      var g;
      u.preventDefault(), u.stopPropagation();
      const l = u.currentTarget, m = (((g = l == null ? void 0 : l.dataset) == null ? void 0 : g.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (u) => {
      ...
      if (!m) return;
      n._draggingUnitId = m;
      const g = (i = u.originalEvent) == null ? void 0 : i.dataTransfer;
      ...
      var a, i, o, r;
      const l = (i = (a = u.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : i.itemId, m = n._draggingUnitId;
      if (!m || !l || m === l) return;
      u.preventDefault();
      const g = (o = u.originalEvent) == null ? void 0 : o.dataTransfer;
      g && (g.dropEffect = "move"), (r = u.currentTarget) == null || r.classList.add("karakter-actions-row-drag-over");
      ...
      const l = (v = (y = u.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : v.itemId;
      let m = n._draggingUnitId;
      const g = (k = u.originalEvent) == null ? void 0 : k.dataTransfer;
      ...
      var a, i, o, r, d, h, y, v, k, w;
      u.preventDefault();
      const l = (r = (o = (i = (a = u.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : o.dataset) == null ? void 0 : r.abilityRef, m = (v = (y = (h = (d = u.currentTarget) == null ? void 0 : d.closest) == null ? void 0 : h.call(d, ".jarmu-unit-ability-pill")) == null ? void 0 : y.dataset) == null ? void 0 : v.abilityId;
      let g = null;
      if (l)
        try {
          g = await fromUuid(l);
      ...
      var i, o, r, d;
      u.preventDefault();
      const l = (o = (i = u.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, ".jarmu-unit-ability-pill"), m = (r = l == null ? void 0 : l.dataset) == null ? void 0 : r.abilityRef, g = (d = l == null ? void 0 : l.dataset) == null ? void 0 : d.abilityId, a = m || g;
    ...
    const f = (u) => {
      ...
      var l, m, g;
      return u && (((m = (l = this.element) == null ? void 0 : l.contains) == null ? void 0 : m.call(l, u)) || this.id && ((g = u.closest) == null ? void 0 : g.call(u, `#${CSS.escape(this.id)}`)));
    };
    this._votvJarmuBlur = (u) => {
      ...
      var r, d, h;
      const l = u.currentTarget, m = (r = l == null ? void 0 : l.dataset) == null ? void 0 : r.itemId;
      if (!m) return;
      const g = this.actor.items.get(m);
      if (!g || g.type !== "Jarmuegyseg") return;
      const a = (l.value ?? "").trim(), i = a === "" ? 0 : Number(a), o = (d = l.closest) == null ? void 0 : d.call(l, ".jarmu-unit-row");
      if (o) {
      ...
      var i;
      const l = u.currentTarget, m = (i = l == null ? void 0 : l.dataset) == null ? void 0 : i.itemId;
      if (!m) return;
      const g = this.actor.items.get(m);
      if (!g || g.type !== "Jarmuegyseg") return;
  ...
  async _rollUnitDamage(s) {
    var p, u, l, m, g, a, i, o, r;
    const e = this.actor;
    if (!e) return;
    const t = ((u = (p = e.items).get) == null ? void 0 : u.call(p, s)) ?? ((m = (l = e.items.contents) == null ? void 0 : l.find) == null ? void 0 : m.call(l, (d) => d.id === s));
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", u = f ? `<p>${f}</p>` : "", l = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${p}
      ${u}
...
te(ye, "PARTS", foundry.utils.mergeObject(
  ...
  K(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ns = K(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ls = K(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((As = (Fs = K(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) == null ? void 0 : As.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
let Pt = ye;
var Ps;
const tt = class tt extends Pt {
  _attachFrameListeners(s) {
    var c;
    super._attachFrameListeners(s);
    const e = this.form ?? ((c = s == null ? void 0 : s.querySelector) == null ? void 0 : c.call(s, "form.votv.jarmu-sheet")) ?? s ?? this.element;
    if (!e) return;
    const t = {
      ...
      var v, k, w, T, _, O, q;
      const u = ((v = e.querySelector) == null ? void 0 : v.call(e, "form")) ?? e, l = (k = u.querySelector) == null ? void 0 : k.call(u, 'select[name="system.identity.assignment"]'), m = (w = u.querySelector) == null ? void 0 : w.call(u, 'select[name="system.identity.subAssignment"]'), g = (T = u.querySelector) == null ? void 0 : T.call(u, "input.bazis-threat-total"), a = (_ = u.querySelector) == null ? void 0 : _.call(u, 'input[name="system.combat.threatBonus"]');
      if (!l || !g || !a) return;
      const i = l.value ?? "", o = (m == null ? void 0 : m.value) ?? "", r = t[i] ?? 0, d = n[o] ?? 0, h = Number(a.value ?? 0) || 0, y = r + d + h;
      g.value = y, (q = (O = this.actor) == null ? void 0 : O.update) == null || q.call(O, {
        "system.combat.threat": y,
        "system.combat.threatBonus": h
      });
    };
    $(e).on("change input", 'select[name="system.identity.assignment"], select[name="system.identity.subAssignment"], input[name="system.combat.threatBonus"]', f);
  }
  async _prepareContext(s) {
    var t;
    const e = await super._prepareContext(s);
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, c = n.combat ?? {}, p = f.assignment ?? "", l = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }[p] ?? 0, m = Number(c.threatBonus ?? 0) || 0, g = l + m;
      e.system = foundry.utils.mergeObject(
        foundry.utils.duplicate(n),
        { combat: { ...c, threat: g, threatBonus: m } },
        { inplace: !1 }
      ), e.bazisThreatBase = l;
    }
    return e;
...
te(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  K(tt, tt, "DEFAULT_OPTIONS"),
  {
    classes: ["vacuum-of-the-void", "sheet", "actor", "Bazis"],
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Ps = K(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Ut = tt;
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const n = (c) => {
      ...
      var p, u, l;
      return c && (((u = (p = e.element) == null ? void 0 : p.contains) == null ? void 0 : u.call(p, c)) || e.id && ((l = c.closest) == null ? void 0 : l.call(c, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (c) => {
      var u, l, m;
      const p = ((u = c.target) == null ? void 0 : u.form) ?? ((m = (l = c.target) == null ? void 0 : l.closest) == null ? void 0 : m.call(l, "form"));
      f(p) && n(p);
...
te(qe, "PARTS", foundry.utils.mergeObject(K(qe, qe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), te(qe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(qe, qe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Es = K(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !1 })
}));
let Bt = qe;
var $s;
...
te(Ne, "PARTS", foundry.utils.mergeObject(K(Ne, Ne, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), te(Ne, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Ne, Ne, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject((($s = K(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : $s.form) ?? {}, { submitOnChange: !1 })
}));
let Ht = Ne;
var xs;
...
te(Le, "PARTS", foundry.utils.mergeObject(K(Le, Le, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), te(Le, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Le, Le, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((xs = K(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : xs.form) ?? {}, { submitOnChange: !1 })
}));
let Gt = Le;
var Rs;
const Fe = class Fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (c) => {
      ...
      const u = (p == null ? void 0 : p.form) ?? ((l = p == null ? void 0 : p.closest) == null ? void 0 : l.call(p, "form"));
...
te(Fe, "PARTS", foundry.utils.mergeObject(K(Fe, Fe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), te(Fe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Fe, Fe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Rs = K(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !0 })
}));
let Vt = Fe;
var Ms;
...
te(Ae, "PARTS", foundry.utils.mergeObject(K(Ae, Ae, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), te(Ae, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Ae, Ae, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ms = K(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 })
}));
let Wt = Ae;
var js;
...
te(Pe, "PARTS", foundry.utils.mergeObject(K(Pe, Pe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), te(Pe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(K(Pe, Pe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((js = K(Pe, Pe, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Jt = Pe;
var Ks, zs;
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      var d, h, y, v, k, w;
      a.preventDefault();
      const i = (h = (d = a.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemRef, o = (v = (y = a.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : v.itemId;
      let r = null;
      if (i)
        try {
          r = await fromUuid(i);
      ...
      var d, h, y, v;
      a.preventDefault();
      const i = (h = (d = a.currentTarget) == null ? void 0 : d.dataset) == null ? void 0 : h.itemRef, o = (v = (y = a.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : v.itemId, r = i || o;
      r && await this._postAbilityToChat(r);
      ...
      if (!i) return;
      const o = this.document.system ?? {}, r = Array.isArray((k = o.abilities) == null ? void 0 : k.items) ? o.abilities.items.slice() : [], d = r.indexOf(i), h = d >= 0 ? [...r.slice(0, d), ...r.slice(d + 1)] : r;
    ...
    e._votvChange = (a) => {
      var o, r, d;
      const i = ((o = a.target) == null ? void 0 : o.form) ?? ((d = (r = a.target) == null ? void 0 : r.closest) == null ? void 0 : d.call(r, "form"));
      p(i) && c(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
    ...
    const p = (await Promise.all(
      f.map(async (u) => {
        ...
        try {
          ...
          const m = (l = game.items) == null ? void 0 : l.get(u);
          if (m && (m.type === "Kepesseg" || m.type === "ability")) return m;
        }
        return null;
      })
      ...
      var i, o;
      const m = (((i = u.system) == null ? void 0 : i.kind) ?? "passive").toString(), g = Number(((o = u.system) == null ? void 0 : o.kp) ?? 0) || 0, a = m === "species";
      return {
        id: u.id,
        ref: l,
        name: u.name,
  ...
  async _onDropDocument(s, e) {
    ...
    if (e.type === "Kepesseg" || e.type === "ability") {
      const c = e.uuid ?? e.id, p = this.document.system ?? {}, u = Array.isArray((n = p.abilities) == null ? void 0 : n.items) ? p.abilities.items.slice() : [];
...
te(Se, "PARTS", foundry.utils.mergeObject(K(Se, Se, "PARTS") ?? {}, {
  ...
  K(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Ks = K(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((zs = K(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : zs.dragDrop) ?? [],
      {
        dragSelector: null,
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    makeDefault: !0,
    label: "VOTV.NpcSheet"
  }), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", Pt, {
    types: ["Jarmu"],
    makeDefault: !0,
  ...
  const s = 500;
  Hooks.on("updateActor", (u, l, m, g) => {
    var w, T, _, O, q, j, z, H, R, Y, Q, J, Z;
    const a = u == null ? void 0 : u.id;
    if (!a) return;
    if ((u.type === "Karakter" || u.type === "Npc") && ((w = l == null ? void 0 : l.system) != null && w.combat) && "initiativeResult" in l.system.combat) {
      const M = Number((_ = (T = u.system) == null ? void 0 : T.combat) == null ? void 0 : _.initiativeResult), W = Number.isFinite(M) ? M : 0, ce = game.combat;
      if (ce) {
    ...
    if (u.type === "Npc" && ((j = l == null ? void 0 : l.system) != null && j.identity) && "size" in l.system.identity) {
      const M = Bs((H = (z = u.system) == null ? void 0 : z.identity) == null ? void 0 : H.size);
      u.update({
        "prototypeToken.width": M,
        "prototypeToken.height": M
      }).catch((W) => console.warn("Vacuum of the Void | NPC token size update failed for", u.name, W));
    }
    const i = document.activeElement, o = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), r = [], d = (R = game.actors) == null ? void 0 : R.get(a);
    d != null && d.apps && r.push(...Array.from(d.apps));
    const h = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const M of h) {
      if (((Y = M.document) == null ? void 0 : Y.id) !== a || ((Q = M.document) == null ? void 0 : Q.documentName) !== "Actor") continue;
    ...
    const v = (Z = game.votv) == null ? void 0 : Z._lastKarakterSheetBlurSave, k = v && Date.now() - v.at < s ? v.appId : null;
    setTimeout(() => {
      for (const M of r)
        !(M != null && M.rendered) || typeof M.render != "function" || M.id !== k && M.render(!0);
    }, 0);
  }), Hooks.on("updateItem", (u, l, m, g) => {
    var r, d, h;
    ...
    for (const [y, v] of Object.entries(i)) {
      ...
      !k || k !== u.id || (o[`system.weapons.${y}.name`] = u.name ?? "", o[`system.weapons.${y}.damage`] = ((d = u.system) == null ? void 0 : d.damage) ?? "", o[`system.weapons.${y}.bonus`] = ((h = u.system) == null ? void 0 : h.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, y, v, k, w, T, _, O, q, j, z, H, R, Y, Q, J, Z, M, W, ce, ve, D, x;
    ...
    if (!c) return;
    const p = c.actorId ?? ((T = f == null ? void 0 : f.speaker) == null ? void 0 : T.actor) ?? "";
    if (!p) return;
    e.preventDefault(), e.stopPropagation();
    let u = ((_ = game.actors) == null ? void 0 : _.get(c.actorId)) ?? ((O = game.actors) == null ? void 0 : O.get(p));
    if (u || (u = ((j = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : j.flatMap((X) => {
      var oe;
      return ((oe = X.tokens) == null ? void 0 : oe.contents) ?? [];
    }).map((X) => X.actor).find((X) => X && (X.id === p || X.id === c.actorId))) ?? null), !u) return;
    const l = c.itemId ? ((H = (z = u.items) == null ? void 0 : z.get) == null ? void 0 : H.call(z, c.itemId)) ?? ((Q = (Y = (R = u.items) == null ? void 0 : R.contents) == null ? void 0 : Y.find) == null ? void 0 : Q.call(Y, (V) => V.id === c.itemId)) : null;
    let m = (c.damageFormula ?? "").trim();
    if (m || (m = (((J = l == null ? void 0 : l.system) == null ? void 0 : J.damage) ?? "").trim()), !m && c.slotKey && (m = (((((Z = u.system) == null ? void 0 : Z.weapons) ?? {})[c.slotKey] ?? {}).damage ?? "").trim()), !m) {
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = c.targetName || "", o = c.hitLocationName || "", r = ((l == null ? void 0 : l.name) ?? (c.slotKey ? ((x = (((D = u.system) == null ? void 0 : D.weapons) ?? {})[c.slotKey]) == null ? void 0 : x.name) ?? "" : "")) || "Fegyver";
    let d = i ? `${r} – sebzés – ${i}` : `${r} – sebzés`;
    o && (d += ` (${o})`), await g.toMessage({
    ...
    (e) => {
      ...
      const t = (l = (u = e.target) == null ? void 0 : u.closest) == null ? void 0 : l.call(u, "[data-document-id]"), n = (m = t == null ? void 0 : t.getAttribute) == null ? void 0 : m.call(t, "data-document-id");
      if (!n) return;
    ...
    for (const p of e) {
      const u = Tt.getTotalSpeedRaw(p), l = (n = p.effects) == null ? void 0 : n.find((m) => m.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (u <= 0 && !l) {
    ...
    for (const a of t)
      try {
        const i = a.prototypeToken, o = ((p = i == null ? void 0 : i.bar1) == null ? void 0 : p.attribute) ?? "", r = ((u = i == null ? void 0 : i.bar2) == null ? void 0 : u.attribute) ?? "";
        (o || r) && await a.update({
...
Hooks.on("preCreateToken", (S, s, e) => {
  ...
  if (f) {
    ...
    if (f.type === "Npc") {
      const m = Bs((l = (u = f.system) == null ? void 0 : u.identity) == null ? void 0 : l.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var g, a, i, o;
  const t = ((g = S.flags) == null ? void 0 : g["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, c = t.weaponAttack, p = t.weapon, u = t.vsDefense, l = t.vsDefenseInfo;
  if (!n && !f && !c && !u) return;
  ...
  if (m) {
    if (n && m.classList.add(`votv-${n}`), f) {
      ...
      if (r)
        ...
        const d = m.querySelector(".dice-total"), h = (d == null ? void 0 : d.parentElement) ?? m, y = document.createElement("div");
    ...
    if (c && p && (p.actorId || (i = S.speaker) != null && i.actor)) {
      const r = m.querySelector(".dice-total"), d = (r == null ? void 0 : r.parentElement) ?? m;
      if (!m.querySelector(".votv-weapon-outcome")) {
        const y = document.createElement("div");
        y.className = "votv-weapon-outcome";
        const v = !!p.isHit, k = p.targetName || "Célpont";
        y.textContent = v ? `Találat – ${k}` : `Nem talált – ${k}`, d.appendChild(y);
      }
      if (p.isHit && !m.querySelector(".votv-weapon-damage-chat")) {
        ...
        v.textContent = k != null && w ? `Sebzés (Találati Hely ${k} - ${w})` : "Sebzés", v.dataset.actorId = String(p.actorId ?? ((o = S.speaker) == null ? void 0 : o.actor) ?? ""), v.dataset.itemId = String(p.itemId ?? ""), v.dataset.slotKey = String(p.slotKey ?? ""), v.dataset.targetName = String(p.targetName ?? ""), v.dataset.hitLocationName = String(p.hitLocationName ?? ""), v.dataset.messageId = String(S.id ?? ""), d.appendChild(v);
      }
    }
    if (!c && u && l) {
      const r = m.querySelector(".dice-total"), d = (r == null ? void 0 : r.parentElement) ?? m, h = !!l.isHit, y = l.targetName || "Célpont", v = l.hitLocationRoll, k = l.hitLocationName;
      let w = m.querySelector(".votv-defense-outcome");
      w || (w = document.createElement("div"), w.className = "votv-defense-outcome", d.appendChild(w)), w.textContent = h ? `Találat – ${y}` : `Nem talált – ${y}`;
      const T = m.querySelector(".votv-defense-hitloc");
      if (h && v != null && k) {
        let _ = T;
...
//# sourceMappingURL=vacuum-of-the-void-B_CJjRGu.mjs.map
