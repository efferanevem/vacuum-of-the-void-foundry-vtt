...
var Qs = Reflect.get;
var ei = (S, s, e) => s in S ? Ys(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var te = (S, s, e) => ei(S, typeof s != "symbol" ? s + "" : s, e);
var U = (S, s, e) => Qs(Xs(S), e, s);
const { HTMLField: ti, NumberField: F, SchemaField: H, StringField: C, BooleanField: pe, ArrayField: Tt } = foundry.data.fields;
class $t extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      notes: new H({
        biography: new ti({ required: !1, blank: !0 })
      })
    };
  }
}
const { NumberField: Mt, SchemaField: si } = foundry.data.fields;
class ii extends $t {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: ni, StringField: gs, NumberField: ai } = foundry.data.fields;
class ri extends $t {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      vehicle: new ni({
        ...
        type: new gs({ required: !1, blank: !0, initial: "" }),
        /** Eszközök hatótávolsága (TE). */
        toolsRange: new gs({ required: !1, blank: !0, initial: "" }),
...
const { BooleanField: di, NumberField: Ci, StringField: Ue } = foundry.data.fields;
...
const { BooleanField: mi, StringField: Et } = foundry.data.fields;
class pi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Felszerelve a karakteren (karakter lap checkbox). */
      equipped: new mi({ required: !1, initial: !1 }),
      /** Védelem bónusz (a táblázatban: Védelem Bónusz). */
      protectionBonus: new Et({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new Et({ required: !1, blank: !0, initial: "" }),
      /** Szint: Alap, 1., 2., 3. (alapértelmezett Alap). */
      level: new Et({ required: !1, blank: !0, initial: "Alap" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new Et({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: jt, StringField: vs } = foundry.data.fields;
...
const { NumberField: yi, StringField: ks } = foundry.data.fields;
...
class gi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      quantity: new Is({ required: !1, blank: !0, initial: "1" })
    };
  }
}
const { StringField: hi } = foundry.data.fields;
class bi extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new hi({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: zt, StringField: ot, SchemaField: Ss, ArrayField: vi } = foundry.data.fields;
class ki extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Szint (0–3). */
      level: new zt({ required: !0, integer: !0, min: 0, max: 3, initial: 0 }),
      /** Életerő: max / aktuális. */
      health: new Ss({
        max: new zt({ required: !0, integer: !0, min: 0, initial: 0 }),
        value: new zt({ required: !0, integer: !0, min: 0, initial: 0 })
      }),
...
const { NumberField: Kt, StringField: ct, SchemaField: Ts, ArrayField: wi } = foundry.data.fields;
...
function Ut(S) {
  ...
  f(S.terms, 1);
  const l = s.filter((a) => a === 6).length, m = s.filter((a) => a === 1).length, d = e.filter((a) => a === 6).length, c = t.filter((a) => a === 6).length, p = l + d, y = m + c;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (f) {
      ...
      const u = document.activeElement, h = l.contains(u), g = u && (u.tagName === "INPUT" && u.type !== "checkbox" && u.type !== "radio" || u.tagName === "TEXTAREA");
      h && g && (m.focus = {
        name: u.name || null,
        id: u.id || null,
    ...
    const c = this.element, p = this.form ?? this.element, y = m.scrollState, a = m.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", r = () => {
      var u, h;
  ...
  static getTotalSpeedRaw(s) {
    ...
    let m;
    f === 1 ? m = -6 : f === 2 ? m = -3 : m = l, m += ee._getTotalArmorSpeedPenaltyStatic(s);
    const d = Number(((u = (o = s.system) == null ? void 0 : o.combat) == null ? void 0 : u.speed) ?? 0) || 0, c = Number(((g = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : g.speedBonus) ?? 0) || 0;
    return d + c + (Number.isFinite(m) ? m : 0);
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((u = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : u.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, l = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, m = ee._healthStatusFromRatio(l, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let c;
    m === 0 ? c = 0 : m === 1 ? c = -6 : m === 2 ? c = -3 : c = d;
    const p = this._getTotalArmorSpeedPenalty();
    c += p, t.textContent = String(c);
  }
  /** Kapott védelem kijelzés: tárolt givenProtection + páncélok + Körültekintés (+1) + Fél-fedezék (+3) + Háromnegyed-fedezék (+6). */
  _writeEffectiveGivenProtection(s = null) {
    var c, p, y, a, i, r, o, u, h, g, v, k, w;
    const e = s ?? this.form ?? this.element;
    let t = (c = e == null ? void 0 : e.querySelector) == null ? void 0 : c.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((a = (y = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : y.combat) == null ? void 0 : a.givenProtection) ?? 0) || 0, f = (o = (r = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : r.has) != null && o.call(r, "lookaround") ? 1 : 0, l = (g = (h = (u = this.actor) == null ? void 0 : u.statuses) == null ? void 0 : h.has) != null && g.call(h, "halfcover") ? 3 : 0, m = (w = (k = (v = this.actor) == null ? void 0 : v.statuses) == null ? void 0 : k.has) != null && w.call(k, "threequarteredcover") ? 6 : 0, d = n + this._getTotalArmorProtectionBonus() + f + l + m;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const d = Number(l == null ? void 0 : l.value) || 0, c = Number(m == null ? void 0 : m.value) || 0, p = Number(f == null ? void 0 : f.textContent) || 0;
    n.textContent = String(d + c + p);
  }
  _writeTotalSpeed(s = null) {
    ...
    const d = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, c = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, p = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
    if (ee._healthStatusFromRatio(p, c) === 0) {
      n.textContent = "0";
      return;
    }
    const a = Number(l == null ? void 0 : l.value) || 0, i = Number(m == null ? void 0 : m.value) || 0, r = Number(f == null ? void 0 : f.textContent) || 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((l = this.actor.system) == null ? void 0 : l.resources) ?? {}, n = ((d = (m = t.hitLocations) == null ? void 0 : m[e]) == null ? void 0 : d.value) ?? 0, f = ((c = t.currentHealth) == null ? void 0 : c[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((m = s == null ? void 0 : s.system) == null ? void 0 : m.resources) ?? {}, f = ((c = (d = n.hitLocations) == null ? void 0 : d[t]) == null ? void 0 : c.value) ?? 0, l = ((p = n.currentHealth) == null ? void 0 : p[t]) ?? 0;
    return ee._healthStatusFromRatio(l, f);
  }
  async _prepareContext(s) {
    var ut, dt, mt, pt, ft, yt, gt, ht, bt, We, vt, kt, Je, I, E, P, G, ke, ne, Ce, Te, we, $e, Ze, Ye, Nt, Lt, Ft, At, wt, at, Qt, es, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((mt = (dt = (ut = this.actor.system) == null ? void 0 : ut.resources) == null ? void 0 : dt.stress) == null ? void 0 : mt.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, f = n.hitLocations ?? {}, l = n.currentHealth ?? {}, m = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const b of m) {
      const L = ((pt = f[b]) == null ? void 0 : pt.value) ?? 0, N = l[b] ?? 0;
    ...
    const y = e.computedHealthStatus.legs ?? 3, a = Number(((yt = (ft = this.actor.system) == null ? void 0 : ft.combat) == null ? void 0 : yt.givenSpeed) ?? 0) || 0;
    let i;
    y === 0 ? i = 0 : y === 1 ? i = -6 : y === 2 ? i = -3 : i = a;
    const r = this._getTotalArmorSpeedPenalty();
    i += r, e.effectiveGivenSpeed = i;
    const o = Number(((ht = (gt = this.actor.system) == null ? void 0 : gt.combat) == null ? void 0 : ht.givenProtection) ?? 0) || 0, u = (vt = (We = (bt = this.actor) == null ? void 0 : bt.statuses) == null ? void 0 : We.has) != null && vt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (kt = this.actor) == null ? void 0 : kt.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, g = (G = (P = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + u + h + g;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (O.slotOrder ?? "").trim(), j = M ? M.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], K = (Ze = this.actor.system.gear) == null ? void 0 : Ze.microchips, x = K && typeof K == "object" && !Array.isArray(K) ? K : {}, J = (((Ye = x.slot1) == null ? void 0 : Ye.itemId) ?? "").trim(), Q = (((Nt = x.slot2) == null ? void 0 : Nt.itemId) ?? "").trim(), Z = (((Lt = x.slot3) == null ? void 0 : Lt.itemId) ?? "").trim(), z = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      const N = typeof b.sort == "number" ? b.sort : 0, A = typeof L.sort == "number" ? L.sort : 0;
      return N - A;
    }).map((b) => {
      var xe, Qe, et, ze, Ke, It;
      const L = b.type === "Fegyver", N = b.type === "MikroChip";
      let A = 0, B = "", de = null;
      for (let rt = 0; rt < j.length; rt++) {
        const St = j[rt];
        if ((((xe = O[St]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          A = rt + 1, B = ((Qe = O[St]) == null ? void 0 : Qe.bonus) ?? "", de = St;
          break;
        }
      }
      let re = null;
      ...
      return {
        ...
        rangeStr: Ie,
        slotBonusNum: De,
        quantity: Number(((It = b.system) == null ? void 0 : It.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = z;
    const V = (((Ft = this.actor.items) == null ? void 0 : Ft.contents) ?? []).filter((b) => b.type === "Fegyver"), ce = V.map((b) => ({ id: b.id, name: b.name, img: b.img }));
    e.weaponItems = ce;
    const ve = "— Nincs fegyver —", D = j.filter((b) => {
      const N = ((O[b] ?? {}).itemId ?? "").trim();
      return N ? !!V.find((B) => B.id === N) : !1;
    });
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, A = (N.itemId ?? "").trim(), B = ce.find((De) => De.id === A), de = V.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Xe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: L + 1,
    ...
    e.weaponsTable = V.map((b) => {
      ...
      let N = null, A = {};
      for (const Rt of j)
        if ((((ps = O[Rt]) == null ? void 0 : ps.itemId) ?? "").trim() === L) {
          N = Rt, A = O[Rt] ?? {};
          break;
        }
      const B = !!N, de = ((fs = b.system) == null ? void 0 : fs.equipped) !== void 0 && ((ys = b.system) == null ? void 0 : ys.equipped) !== null ? !!b.system.equipped : B, re = (b == null ? void 0 : b.system) ?? {}, Xe = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", De = (R[Ie] ?? Ie) || "—", xe = re.size ?? "", Qe = (W[xe] ?? xe) || "", et = [De, Qe].filter(Boolean).join(", ") || De || "—", ze = Ie === "projectile" || xe === "thrown", Ke = re.quantity, It = Ke != null ? String(Ke).trim() : "1", rt = String(A.bonus ?? "").trim(), St = String(re.bonus ?? "").trim(), Zs = rt || St || "0";
      return {
        slotKey: N ?? "",
        itemId: L,
        ...
        typeAndSize: et,
        quantity: It,
        quantityDisplay: ze ? It : "—",
        isProjectile: ze,
        equipped: de,
        special: (re.special ?? "").trim() || "—"
      };
    });
    const X = (((At = this.actor.items) == null ? void 0 : At.contents) ?? []).filter((b) => b.type === "Pancel");
    e.armorTable = X.map((b) => {
      ...
      return {
        ...
        level: Ii((L.level ?? "").toString().trim()),
        special: (L.special ?? L.other ?? "").toString().trim() || "—",
        equipped: N
      };
    });
    const oe = (((wt = this.actor.items) == null ? void 0 : wt.contents) ?? []).filter((b) => b.type === "Targy");
    ...
    const me = (((Qt = this.actor.items) == null ? void 0 : Qt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Re = (b) => {
      var N, A, B;
      const L = [];
    ...
    const Be = (((es = e.weaponsTable) == null ? void 0 : es.length) ?? 0) > 0 || (((ts = e.armorTable) == null ? void 0 : ts.length) ?? 0) > 0 || (((ss = e.microchipsTable) == null ? void 0 : ss.length) ?? 0) > 0 || (((is = e.itemsTable) == null ? void 0 : is.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Be;
    const st = this.actor.system.abilities ?? {}, _t = (((ns = this.actor.items) == null ? void 0 : ns.contents) ?? []).map((b) => {
      var L, N, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Pe = new Map(_t.map((b) => [b.id, b])), He = "— Nincs képesség —", Me = (b) => {
    ...
    const se = ((as = e.system) == null ? void 0 : as.resources) ?? {}, he = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ae = (os = (rs = e.system) == null ? void 0 : rs.combat) == null ? void 0 : os.initiativeResult, be = typeof ae == "number" ? ae : -1, nt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], _e = (ls = (cs = e.system) == null ? void 0 : cs.combat) == null ? void 0 : ls.initiativeRanges, Oe = Array.isArray(_e) ? _e.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], je = (Oe.length > 0 ? Oe : nt).slice().sort((b, L) => b.min - L.min), Ve = Oe.map((b) => b.min), Ot = Ve.length ? Math.min(...Ve) : 0, Ct = Ve.length ? Math.max(...Ve) : 0;
    e.initiativeRanges = Oe.map((b) => ({ ...b, isFirst: b.min === Ot, isLast: b.min === Ct }));
    let lt = 0;
    if (typeof be == "number" && be >= 0 && je.length > 0) {
      const b = je[0], L = je[je.length - 1];
      let N = null;
      be <= b.max ? N = b : be >= L.min ? N = L : N = je.find((A) => be >= A.min && be <= A.max), N && (lt = N.kp);
    }
    e.kpDots = he.map((b, L) => {
      const N = L + 1, A = !!Number(se[b]), B = N <= lt;
      return { index: N, used: A, usable: B };
    });
    const qt = !!((ds = (us = game.combat) == null ? void 0 : us.combatants) != null && ds.some((b) => {
      var L;
      return ((L = b.actor) == null ? void 0 : L.type) === "Karakter";
    }));
    return e.showHarcSection = qt, e.canEditInitiative = !!((ms = game.user) != null && ms.isGM), e.showInitiativeResult = typeof ae == "number", e.initiativeResult = e.showInitiativeResult ? ae : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-vU7XVM_9.mjs");
      u(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-vU7XVM_9.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, u = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-vU7XVM_9.mjs");
      h(this.actor, o, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      k ? (T || (T = document.createElement("img"), T.className = "karakter-microchip-slot-thumb", T.alt = "", u == null || u.insertBefore(T, w)), T.src = k, T.style.display = "") : T && T.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      const u = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((w) => {
        var T;
        return (((T = u[w]) == null ? void 0 : T.itemId) ?? "").trim() === r;
      });
      ...
      if (!r || !o) return;
      const u = this.actor.system.abilities ?? {}, g = (Array.isArray((v = u[r]) == null ? void 0 : v.items) ? u[r].items.slice() : []).filter((k) => k !== o);
    ...
    d._votvBlur = (i) => {
      ...
      h && (u.contains(h) || d.id && ((g = h.closest) != null && g.call(h, `#${CSS.escape(d.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: d.id, at: Date.now() }), c(u));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((p = e.system) == null ? void 0 : p.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", c = `
      <h2>${e.name}</h2>
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: p, label: y } = Ut(c), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return c.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const m = l && l.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, c = ((k = l == null ? void 0 : l.system) == null ? void 0 : k.type) || "kinetic", p = (((w = l == null ? void 0 : l.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = p && n[p] !== void 0 ? p : c === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = d + a, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, u = new Roll(o);
    await u.evaluate({ async: !0 });
    const { resultType: h, label: g } = Ut(u), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return u.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${m} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    var d, c, p, y, a, i, r, o, u, h;
    const t = this.actor;
    if (!t) return;
    let n = ((c = (d = t.items).get) == null ? void 0 : c.call(d, s)) ?? ((y = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : y.call(p, (g) => g.id === s));
...
te(ee, "PARTS", foundry.utils.mergeObject(
  ...
  U(ee, ee, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ds = U(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ds.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((_s = U(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : _s.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Cs = (Os = U(ee, ee, "DEFAULT_OPTIONS")) == null ? void 0 : Os.window) == null ? void 0 : Cs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const l = await super.render(s, e), m = this.element, d = this.form ?? this.element, c = f.scrollState, p = f.focus, y = typeof (c == null ? void 0 : c.formScrollTop) == "number" || typeof (c == null ? void 0 : c.windowScrollTop) == "number", a = () => {
      var i, r;
      if (this._applyScrollState(m, c), (p == null ? void 0 : p.name) != null || (p == null ? void 0 : p.id) != null) {
      ...
      this._applyScrollState(m, c);
    };
    return (y || p) && (requestAnimationFrame(a), setTimeout(a, 0), setTimeout(a, 50), setTimeout(a, 150), setTimeout(a, 300), setTimeout(a, 450)), l;
  }
  async _prepareContext(s) {
    var Me, it, Ge, se, he, ae, be, nt, _e, Oe, xt, je, Ve, Ot, Ct, lt, qt, ut, dt, mt, pt, ft, yt, gt, ht, bt, We, vt, kt, Je;
    ...
    const c = ((xt = t == null ? void 0 : t.items) == null ? void 0 : xt.contents) ?? [], p = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (p.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((I) => y.includes(I)) : [], r = c.filter((I) => I.type === "Fegyver"), o = r.map((I) => ({ id: I.id, name: I.name, img: I.img })), u = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((I) => !h.includes(I)), v = [...h, ...g], k = v.filter((I) => {
      var P;
      const E = (((P = p[I]) == null ? void 0 : P.itemId) ?? "").trim();
      return E && r.some((G) => G.id === E);
    });
    e.weaponSlots = k.map((I) => {
      const E = p[I] ?? {}, P = (E.itemId ?? "").trim(), G = o.find((we) => we.id === P), ke = r.find((we) => we.id === P), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", Te = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: I,
        itemId: P,
    ...
    e.weaponsTable = r.map((I) => {
      ...
      let P = null, G = {};
      for (const at of v)
        if ((((wt = p[at]) == null ? void 0 : wt.itemId) ?? "").trim() === E) {
          P = at, G = p[at] ?? {};
          break;
        }
      const ke = !!P, ne = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", Te = ne.type ?? "", we = (w[Te] ?? Te) || "—", $e = ne.size ?? "", Ze = (T[$e] ?? $e) || "", Ye = [we, Ze].filter(Boolean).join(", ") || we || "—", Nt = Te === "projectile" || $e === "thrown", Lt = ne.quantity != null ? String(ne.quantity).trim() : "1", Ft = String(ne.bonus ?? G.bonus ?? "").trim() || "0", At = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: E,
        actorId: t.id,
    ...
    e.armorTable = _.map((I) => {
      ...
      return {
        ...
        level: Si((E.level ?? "").toString().trim()),
        special: (E.special ?? E.other ?? "").toString().trim() || "—",
        equipped: P
      };
    });
    const O = ((Ot = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : Ot.microchips) ?? {}, q = ["slot1", "slot2", "slot3"], M = c.filter((I) => I.type === "MikroChip");
    ...
    const K = c.filter((I) => I.type === "Egyeb");
    e.egyebList = K.map((I) => {
    ...
    const x = (((Ct = e.weaponsTable) == null ? void 0 : Ct.length) ?? 0) > 0 || (((lt = e.armorTable) == null ? void 0 : lt.length) ?? 0) > 0 || (((qt = e.microchipsTable) == null ? void 0 : qt.length) ?? 0) > 0 || (((ut = e.itemsTable) == null ? void 0 : ut.length) ?? 0) > 0 || (((dt = e.egyebList) == null ? void 0 : dt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !x;
    const J = ((mt = t == null ? void 0 : t.system) == null ? void 0 : mt.abilities) ?? {}, Q = c.filter((I) => I.type === "Kepesseg" || I.type === "ability").map((I) => {
      var E, P, G;
      return {
        id: I.id,
        name: I.name,
    ...
    e.abilityPassiveList = V(z("passive")), e.abilityActiveList = V(z("active"));
    const ce = t == null ? void 0 : t.id, ve = !!((ft = (pt = game.combat) == null ? void 0 : pt.combatants) != null && ft.some(
      (I) => {
        var E;
    ...
    const D = ((yt = e.system) == null ? void 0 : yt.resources) ?? {}, R = (ht = (gt = e.system) == null ? void 0 : gt.combat) == null ? void 0 : ht.initiativeResult, W = typeof R == "number" ? R : -1, X = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], oe = (We = (bt = e.system) == null ? void 0 : bt.combat) == null ? void 0 : We.initiativeRanges, le = Array.isArray(oe) ? oe.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], ie = (le.length > 0 ? le : X).slice().sort((I, E) => I.min - E.min), ge = 3;
    ...
    if (typeof W == "number" && W >= 0 && ie.length > 0) {
      ...
      let P = null;
      W <= I.max ? P = I : W >= E.min ? P = E : P = ie.find((G) => W >= G.min && W <= G.max), P && (Re = P.kp);
    }
    ...
    return e.kpDotsRow1 = Pe.slice(0, He), e.kpDotsRow2 = Pe.slice(He), e.canEditInitiative = !!((vt = game.user) != null && vt.isGM), e.showInitiativeResult = typeof R == "number", e.initiativeResult = e.showInitiativeResult ? R : "", e.speedUnitForSelect = ((Je = (kt = e.system) == null ? void 0 : kt.combat) == null ? void 0 : Je.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var c, p, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-vU7XVM_9.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-vU7XVM_9.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-vU7XVM_9.mjs");
      u(this.actor, r, o);
      ...
      if (!i || !this.actor) return;
      const r = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, u = ["slot1", "slot2", "slot3"].find((w) => {
        var T;
    ...
    l._votvNpcBlur = (a) => {
      ...
      u && (o.contains(u) || l.id && ((h = u.closest) != null && h.call(u, `#${CSS.escape(l.id)}`))) || m(o);
  ...
  async _rollWeapon(s) {
    ...
    const d = m && m.name || n.name || "Fegyver", c = Number(n.bonus || 0) || 0, p = ((O = m == null ? void 0 : m.system) == null ? void 0 : O.type) || "kinetic", y = (((q = m == null ? void 0 : m.system) == null ? void 0 : q.skillKey) ?? "").trim(), a = y && f[y] !== void 0 ? y : p === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, r = c + i, u = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, h = new Roll(u);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((c = (d = t.items).get) == null ? void 0 : c.call(d, s)) ?? ((y = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : y.call(p, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (r = ui.notifications) == null ? void 0 : r.warn) == null || h.call(r, ((u = (o = game.i18n) == null ? void 0 : o.localize) == null ? void 0 : u.call(o, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var p, y, a, i, r, o, u, h, g, v, k, w, T, _, O, q, M, j, K;
    ...
    if (f.type === "Kepesseg" || f.type === "ability") {
      ...
      if (((g = f.parent) == null ? void 0 : g.id) !== l.id) {
        ...
        J = ((v = (await l.createEmbeddedDocuments("Item", [z]))[0]) == null ? void 0 : v.id) ?? J;
      }
    ...
    const c = (_ = (await l.createEmbeddedDocuments("Item", [m]))[0]) == null ? void 0 : _.id;
    if (f.type === "Fegyver" && c) {
      ...
      const z = Z.includes(Y) ? Z : [...Z, Y].filter((V) => J.includes(V));
      await l.update({
    ...
    if (f.type === "MikroChip" && c) {
      const x = ((K = (j = l.system) == null ? void 0 : j.gear) == null ? void 0 : K.microchips) ?? {}, Q = ["slot1", "slot2", "slot3"].find((Z) => {
        var Y;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((a = e.system) == null ? void 0 : a.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", c = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${l}</p>
      ${m}
      ${d}
...
te(fe, "PARTS", foundry.utils.mergeObject(
  ...
  U(fe, fe, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((qs = U(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : qs.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ns = U(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Fs = (Ls = U(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.window) == null ? void 0 : Fs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalDefense(s = null) {
    const e = s ?? this.form ?? this.element, t = (c) => {
      var p;
      return ((p = e == null ? void 0 : e.querySelector) == null ? void 0 : p.call(e, c)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${c}`) : null);
  ...
  async _prepareContext(s) {
    var q, M, j, K, x, J, Q, Z, Y, z, V, ce, ve;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((q = e.system) == null ? void 0 : q.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0);
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, f = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, l = "— Nincs fegyver —", m = (((M = this.actor.items) == null ? void 0 : M.contents) ?? []).filter((D) => D.type === "Fegyver");
    ...
    e.armorTable = d.map((D) => {
      ...
      return {
        ...
        level: Ti((R.level ?? "").toString().trim()),
        special: (R.special ?? R.other ?? "").toString().trim() || "—",
        equipped: W
      };
    });
    const c = (((K = this.actor.items) == null ? void 0 : K.contents) ?? []).filter((D) => D.type === "MikroChip");
    ...
    for (const D of y) {
      ...
      const st = (R.damage ?? "").toString().trim(), _t = (R.storage ?? "").toString().trim().replace(",", "."), Pe = Number(_t);
      Number.isFinite(Pe) && (o += Pe);
    ...
    e.unitsTable = a, e.totalStorageUsed = o, e.vehicleStorageMax = u;
    const h = y.length;
    let g = "Kicsi", v = 0, k = 0;
    ...
    const _ = (((Y = e.weaponsTable) == null ? void 0 : Y.length) ?? 0) > 0 || (((z = e.armorTable) == null ? void 0 : z.length) ?? 0) > 0 || (((V = e.microchipsTable) == null ? void 0 : V.length) ?? 0) > 0 || (((ce = e.itemsTable) == null ? void 0 : ce.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      if (!c) return;
      const p = this.actor.items.get(c);
      ...
      var a;
      const c = d.currentTarget, p = (a = c == null ? void 0 : c.dataset) == null ? void 0 : a.itemId;
      if (!p) return;
      ...
      var p, y, a, i;
      d.preventDefault();
      const c = (y = (p = d.currentTarget) == null ? void 0 : p.dataset) == null ? void 0 : y.itemId;
      ...
      var y;
      d.preventDefault(), d.stopPropagation();
      const c = d.currentTarget, p = (((y = c == null ? void 0 : c.dataset) == null ? void 0 : y.itemId) ?? "").trim();
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      y && (y.setData("text/plain", p), y.effectAllowed = "move", typeof y.setDragImage == "function" && y.setDragImage(c, 0, 0));
    }), t.on("dragover", ".jarmu-unit-row", (d) => {
      var a, i, r, o;
      const c = (i = (a = d.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : i.itemId, p = n._draggingUnitId;
      if (!p || !c || p === c) return;
      d.preventDefault();
      ...
      if (!p && y && (p = y.getData("text/plain")), n._draggingUnitId = null, !p || !c || p === c) return;
      const i = this.actor.items.contents.filter((w) => w.type === "Jarmuegyseg").sort((w, T) => {
        ...
        return _ - O;
      }).map((w) => w.id), r = i.indexOf(p), o = i.indexOf(c);
      if (r === -1 || o === -1) return;
      ...
      var a, i, r, o, u, h, g, v, k, w;
      d.preventDefault();
      const c = (o = (r = (i = (a = d.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : r.dataset) == null ? void 0 : o.abilityRef, p = (v = (g = (h = (u = d.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : h.call(u, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (c)
        try {
          y = await fromUuid(c);
      ...
      var i, r, o, u;
      d.preventDefault();
      const c = (r = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : r.call(i, ".jarmu-unit-ability-pill"), p = (o = c == null ? void 0 : c.dataset) == null ? void 0 : o.abilityRef, y = (u = c == null ? void 0 : c.dataset) == null ? void 0 : u.abilityId, a = p || y;
      a && await this._postUnitAbilityToChat(a);
    });
    const f = (d) => {
      if (!d) return;
      const c = this._getFormDataForUpdate(d);
      Object.keys(c).length !== 0 && this.actor.update(c).catch((p) => console.warn("VoidJarmuSheet save failed", p));
    }, l = (d) => {
      var c, p, y;
      return d && (((p = (c = this.element) == null ? void 0 : c.contains) == null ? void 0 : p.call(c, d)) || this.id && ((y = d.closest) == null ? void 0 : y.call(d, `#${CSS.escape(this.id)}`)));
    };
    this._votvJarmuBlur = (d) => {
      ...
      var o, u, h;
      const c = d.currentTarget, p = (o = c == null ? void 0 : c.dataset) == null ? void 0 : o.itemId;
      if (!p) return;
      const y = this.actor.items.get(p);
      if (!y || y.type !== "Jarmuegyseg") return;
      const a = (c.value ?? "").trim(), i = a === "" ? 0 : Number(a), r = (u = c.closest) == null ? void 0 : u.call(c, ".jarmu-unit-row");
      if (r) {
      ...
      var i;
      const c = d.currentTarget, p = (i = c == null ? void 0 : c.dataset) == null ? void 0 : i.itemId;
      if (!p) return;
      const y = this.actor.items.get(p);
      if (!y || y.type !== "Jarmuegyseg") return;
  ...
  async _rollUnitDamage(s) {
    var m, d, c, p, y, a, i, r, o;
    const e = this.actor;
    if (!e) return;
    const t = ((d = (m = e.items).get) == null ? void 0 : d.call(m, s)) ?? ((p = (c = e.items.contents) == null ? void 0 : c.find) == null ? void 0 : p.call(c, (u) => u.id === s));
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", m = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", c = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${l}</p>
      ${m}
      ${d}
...
te(ye, "PARTS", foundry.utils.mergeObject(
  ...
  U(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((As = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : As.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Es = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Es.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...(($s = (Ps = U(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.window) == null ? void 0 : $s.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const tt = class tt extends Pt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var _, O, q, M, j, K, x;
      const c = ((_ = e.querySelector) == null ? void 0 : _.call(e, "form")) ?? e, p = (O = c.querySelector) == null ? void 0 : O.call(c, 'select[name="system.identity.assignment"]'), y = (q = c.querySelector) == null ? void 0 : q.call(c, 'select[name="system.identity.subAssignment"]'), a = (M = c.querySelector) == null ? void 0 : M.call(c, "input.bazis-threat-total"), i = (j = c.querySelector) == null ? void 0 : j.call(c, 'input[name="system.combat.threatBonus"]');
      if (!p || !a || !i) return;
      const r = p.value ?? "", o = (y == null ? void 0 : y.value) ?? "", u = t[r] ?? 0, h = n[o] ?? 0, g = (((x = (K = this.actor) == null ? void 0 : K.items) == null ? void 0 : x.contents) ?? []).filter((J) => J.type === "Jarmuegyseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = u + h + k + w;
      a.value = T;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, l = n.combat ?? {}, m = f.assignment ?? "", d = f.subAssignment ?? "", c = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }, p = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = c[m] ?? 0, i = p[d] ?? 0, r = e.sizeForSelect ?? "Kicsi", o = y[r] ?? 0, u = Number(l.threatBonus ?? 0) || 0, h = a + i + o + u;
      e.system = foundry.utils.mergeObject(
        foundry.utils.duplicate(n),
        { combat: { ...l, threat: h, threatBonus: u } },
        { inplace: !1 }
      ), e.bazisThreatBase = a;
    }
    return e;
...
te(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  U(tt, tt, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((xs = U(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : xs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Ht = tt;
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (l) => {
      var c, p, y, a, i, r, o;
      if (!e.isEditable || !((p = (c = l.target) == null ? void 0 : c.closest) != null && p.call(c, ".profile")) && ((a = (y = l.target) == null ? void 0 : y.getAttribute) == null ? void 0 : a.call(y, "data-edit")) !== "img") return;
    ...
    const n = (l) => {
      ...
      var m, d, c;
      return l && (((d = (m = e.element) == null ? void 0 : m.contains) == null ? void 0 : d.call(m, l)) || e.id && ((c = l.closest) == null ? void 0 : c.call(l, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (l) => {
      var d, c, p;
      const m = ((d = l.target) == null ? void 0 : d.form) ?? ((p = (c = l.target) == null ? void 0 : c.closest) == null ? void 0 : p.call(c, "form"));
      f(m) && n(m);
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = Di, e;
  }
};
te(qe, "PARTS", foundry.utils.mergeObject(U(qe, qe, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Rs = U(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !1 })
}));
let Gt = qe;
var Ms;
...
te(Ne, "PARTS", foundry.utils.mergeObject(U(Ne, Ne, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ms = U(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 })
}));
let Vt = Ne;
var js;
...
te(Le, "PARTS", foundry.utils.mergeObject(U(Le, Le, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((js = U(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Wt = Le;
var zs;
const Fe = class Fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (l) => {
      ...
      const d = (m == null ? void 0 : m.form) ?? ((c = m == null ? void 0 : m.closest) == null ? void 0 : c.call(m, "form"));
...
te(Fe, "PARTS", foundry.utils.mergeObject(U(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((zs = U(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : zs.form) ?? {}, { submitOnChange: !0 })
}));
let Jt = Fe;
var Ks;
...
te(Ae, "PARTS", foundry.utils.mergeObject(U(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ks = U(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.form) ?? {}, { submitOnChange: !1 })
}));
let Zt = Ae;
var Us;
const Ee = class Ee extends foundry.applications.api.HandlebarsApplicationMixin(
...
te(Ee, "PARTS", foundry.utils.mergeObject(U(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Us = U(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Us.form) ?? {}, { submitOnChange: !1 })
}));
let Yt = Ee;
var Bs, Hs;
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      if (!i) return;
      const r = this.document.system ?? {}, o = Array.isArray((k = r.abilities) == null ? void 0 : k.items) ? r.abilities.items.slice() : [], u = o.indexOf(i), h = u >= 0 ? [...o.slice(0, u), ...o.slice(u + 1)] : o;
    ...
    const m = (await Promise.all(
      f.map(async (d) => {
        ...
        try {
          ...
          const p = (c = game.items) == null ? void 0 : c.get(d);
          if (p && (p.type === "Kepesseg" || p.type === "ability")) return p;
        }
        return null;
      })
...
te(Se, "PARTS", foundry.utils.mergeObject(U(Se, Se, "PARTS") ?? {}, {
  ...
  U(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Bs = U(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Hs = U(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.dragDrop) ?? [],
      {
        dragSelector: null,
...
let Xt = Se;
const Gs = "systems/vacuum-of-the-void/assets/void-bg.jpg";
function Vs(S) {
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = ii, CONFIG.Actor.dataModels.Npc = $t, CONFIG.Actor.dataModels.Jarmu = ri, CONFIG.Actor.dataModels.Bazis = li, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = bs, CONFIG.Item.dataModels.weapon = bs, CONFIG.Item.dataModels.Pancel = pi, CONFIG.Item.dataModels.MikroChip = fi, CONFIG.Item.dataModels.Kepesseg = ws, CONFIG.Item.dataModels.ability = ws, CONFIG.Item.dataModels.Targy = gi, CONFIG.Item.dataModels.Egyeb = bi, CONFIG.Item.dataModels.Jarmuegyseg = ki, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health"],
    value: []
  }, CONFIG.Actor.trackableAttributes.Npc = {
    bar: ["", "resources.health"],
    value: []
  }, (f = CONFIG.Actor).typeLabels ?? (f.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", CONFIG.Actor.typeLabels.Jarmu = "Jármű", CONFIG.Actor.typeLabels.Bazis = "Bázis", (l = CONFIG.Combat).initiative ?? (l.initiative = {}), CONFIG.Combat.initiative.formula = "1d20", (m = CONFIG.Item).typeLabels ?? (m.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.weapon = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", CONFIG.Item.typeLabels.Jarmuegyseg = "Járműegység";
  ...
  CONFIG.statusEffects = [
  ...
  ], foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", Dt, {
    types: ["Karakter"],
    makeDefault: !0,
    ...
    setTimeout(() => {
      ...
      const r = Dt.getTotalSpeedRaw(i), o = (h = i.effects) == null ? void 0 : h.find((k) => k.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (r <= 0 && !o) {
  ...
  Hooks.on("updateActor", (d, c, p, y) => {
    ...
    if ((d.type === "Karakter" || d.type === "Npc") && ((w = c == null ? void 0 : c.system) != null && w.combat) && "initiativeResult" in c.system.combat) {
      const z = Number((_ = (T = d.system) == null ? void 0 : T.combat) == null ? void 0 : _.initiativeResult), V = Number.isFinite(z) ? z : 0, ce = game.combat;
      if (ce) {
    ...
    if (d.type === "Npc" && ((M = c == null ? void 0 : c.system) != null && M.identity) && "size" in c.system.identity) {
      const z = Vs((K = (j = d.system) == null ? void 0 : j.identity) == null ? void 0 : K.size);
      d.update({
    ...
    const i = document.activeElement, r = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), o = [], u = (x = game.actors) == null ? void 0 : x.get(a);
    ...
    for (const z of h) {
      ...
      const V = (Z = z.constructor) == null ? void 0 : Z.name;
      V !== "VoidKarakterSheet" && V !== "VoidJarmuSheet" && V !== "VoidBazisSheet" || o.includes(z) || o.push(z);
    }
    if (r && o.some((z) => {
      const V = (z == null ? void 0 : z.form) ?? (z == null ? void 0 : z.element);
    ...
    for (const [g, v] of Object.entries(i)) {
      ...
      !k || k !== d.id || (r[`system.weapons.${g}.name`] = d.name ?? "", r[`system.weapons.${g}.damage`] = ((u = d.system) == null ? void 0 : u.damage) ?? "", r[`system.weapons.${g}.bonus`] = ((h = d.system) == null ? void 0 : h.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, _, O, q, M, j, K, x, J, Q, Z, Y, z, V, ce, ve, D, R;
    ...
    if (!l) return;
    const m = l.actorId ?? ((T = f == null ? void 0 : f.speaker) == null ? void 0 : T.actor) ?? "";
    if (!m) return;
    e.preventDefault(), e.stopPropagation();
    let d = ((_ = game.actors) == null ? void 0 : _.get(l.actorId)) ?? ((O = game.actors) == null ? void 0 : O.get(m));
    if (d || (d = ((M = (q = game.scenes) == null ? void 0 : q.contents) == null ? void 0 : M.flatMap((X) => {
      var oe;
      return ((oe = X.tokens) == null ? void 0 : oe.contents) ?? [];
    }).map((X) => X.actor).find((X) => X && (X.id === m || X.id === l.actorId))) ?? null), !d) return;
    const c = l.itemId ? ((K = (j = d.items) == null ? void 0 : j.get) == null ? void 0 : K.call(j, l.itemId)) ?? ((Q = (J = (x = d.items) == null ? void 0 : x.contents) == null ? void 0 : J.find) == null ? void 0 : Q.call(J, (W) => W.id === l.itemId)) : null;
    let p = (l.damageFormula ?? "").trim();
    if (p || (p = (((Z = c == null ? void 0 : c.system) == null ? void 0 : Z.damage) ?? "").trim()), !p && l.slotKey && (p = (((((Y = d.system) == null ? void 0 : Y.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !p) {
      (ve = (z = ui.notifications) == null ? void 0 : z.warn) == null || ve.call(z, ((ce = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : ce.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const y = new Roll(p);
    ...
    (e) => {
      ...
      const t = (c = (d = e.target) == null ? void 0 : d.closest) == null ? void 0 : c.call(d, "[data-document-id]"), n = (p = t == null ? void 0 : t.getAttribute) == null ? void 0 : p.call(t, "data-document-id");
      if (!n) return;
    ...
    for (const m of e) {
      const d = Dt.getTotalSpeedRaw(m), c = (n = m.effects) == null ? void 0 : n.find((p) => p.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (d <= 0 && !c) {
...
Hooks.on("preCreateToken", (S, s, e) => {
  var l, m, d, c, p, y, a, i;
  const t = (l = game.votv) == null ? void 0 : l._dragSourceActorId, n = t ?? S.actorId ?? ((m = S._source) == null ? void 0 : m.actorId) ?? (s == null ? void 0 : s.actorId) ?? null;
  t && (game.votv._dragSourceActorId = null);
  const f = n ? (d = game.actors) == null ? void 0 : d.get(n) : S.actor ?? null;
  if (f) {
    if (f.type === "Bazis")
      return (y = ui == null ? void 0 : ui.notifications) == null || y.warn(((p = (c = game.i18n) == null ? void 0 : c.localize) == null ? void 0 : p.call(c, "VOTV.BazisNoToken")) ?? "Bázis nem helyezhető tokenként a térképre."), !1;
    if (f.type === "Karakter") {
      S.updateSource({
        ...t ? { actorId: t } : {},
        actorLink: !0,
    ...
    if (f.type === "Npc") {
      const r = Vs((i = (a = f.system) == null ? void 0 : a.identity) == null ? void 0 : i.size);
      S.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("preCreateCombatant", (S, s, e) => {
  ...
  if ((t == null ? void 0 : t.type) === "Bazis")
    throw new Error(((m = (l = game.i18n) == null ? void 0 : l.localize) == null ? void 0 : m.call(l, "VOTV.BazisNoCombat")) ?? "Bázis nem vehet részt harcban.");
...
Hooks.on("updateCombat", (S, s, e) => {
  (s == null ? void 0 : s.round) != null && Ws(S), setTimeout(Js, 0);
});
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var y, a, i, r;
  const t = ((y = S.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, l = t.weaponAttack, m = t.weapon, d = t.vsDefense, c = t.vsDefenseInfo;
  if (!n && !f && !l && !d) return;
  const p = (a = s == null ? void 0 : s.querySelector) == null ? void 0 : a.call(s, ".dice-roll");
  if (p) {
    if (n && p.classList.add(`votv-${n}`), f) {
      const o = p.querySelector(".votv-crit-label");
      if (o)
        o.textContent = f;
      else {
    ...
    if (l && m && (m.actorId || (i = S.speaker) != null && i.actor)) {
      const o = p.querySelector(".dice-total"), u = (o == null ? void 0 : o.parentElement) ?? p;
      ...
      if (m.isHit && !p.querySelector(".votv-weapon-damage-chat")) {
        ...
        v.textContent = k != null && w ? `Sebzés (Találati Hely ${k} - ${w})` : "Sebzés", v.dataset.actorId = String(m.actorId ?? ((r = S.speaker) == null ? void 0 : r.actor) ?? ""), v.dataset.itemId = String(m.itemId ?? ""), v.dataset.slotKey = String(m.slotKey ?? ""), v.dataset.targetName = String(m.targetName ?? ""), v.dataset.hitLocationName = String(m.hitLocationName ?? ""), v.dataset.messageId = String(S.id ?? ""), u.appendChild(v);
      }
    }
    if (!l && d && c) {
      const o = p.querySelector(".dice-total"), u = (o == null ? void 0 : o.parentElement) ?? p, h = !!c.isHit, g = c.targetName || "Célpont", v = c.hitLocationRoll, k = c.hitLocationName;
...
//# sourceMappingURL=vacuum-of-the-void-CUzrAJff.mjs.map
