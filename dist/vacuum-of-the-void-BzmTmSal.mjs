...
const { BooleanField: jt, NumberField: Jt, StringField: Ce } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Le, de, he, me, Se, Te, Me, je, Re, Ke, Fe, Pe, tt, st, it, rt, nt, at;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((he = (de = (Le = this.actor.system) == null ? void 0 : Le.resources) == null ? void 0 : de.stress) == null ? void 0 : he.value) || 0;
    e.stressOver10 = t > 10;
    const o = this.actor.system.resources ?? {}, d = o.hitLocations ?? {}, c = o.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const f of u) {
      const D = ((me = d[f]) == null ? void 0 : me.value) ?? 0, _ = c[f] ?? 0;
    ...
    const h = e.computedHealthStatus.legs ?? 3, i = Number(((Te = (Se = this.actor.system) == null ? void 0 : Se.combat) == null ? void 0 : Te.givenSpeed) ?? 0) || 0;
    let r;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], O = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = O && typeof O == "object" && !Array.isArray(O) ? O : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Fe = C.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), A = (((Pe = C.slot3) == null ? void 0 : Pe.itemId) ?? "").trim(), H = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, D) => {
      const _ = typeof f.sort == "number" ? f.sort : 0, L = typeof D.sort == "number" ? D.sort : 0;
      return _ - L;
    }).map((f) => {
      var pe, De, Oe, be, ke, $e;
      const D = f.type === "Fegyver", _ = f.type === "MikroChip";
      let L = 0, M = "", J = null;
      for (let Ee = 0; Ee < q.length; Ee++) {
        const xe = q[Ee];
        if ((((pe = b[xe]) == null ? void 0 : pe.itemId) ?? "") === f.id) {
          L = Ee + 1, M = ((De = b[xe]) == null ? void 0 : De.bonus) ?? "", J = xe;
          break;
        }
      }
      let Y = null;
      _ && (T === f.id ? Y = "slot1" : S === f.id ? Y = "slot2" : A === f.id && (Y = "slot3"));
      const Ne = D && ((Oe = f.system) != null && Oe.damage) ? f.system.damage : "", se = D && typeof ((be = f.system) == null ? void 0 : be.range) == "string" ? (f.system.range || "").trim() : "", _e = J ? Number((ke = b[J]) == null ? void 0 : ke.bonus) || 0 : "";
      return {
        id: f.id,
        name: f.name,
        img: f.img,
    ...
    e.actionsTable = H;
    const U = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((f) => f.type === "Fegyver"), X = U.map((f) => ({ id: f.id, name: f.name, img: f.img }));
    e.weaponItems = X;
    ...
    e.weaponSlots = ee.map((f, D) => {
      const _ = b[f] ?? {}, L = (_.itemId ?? "").trim(), M = X.find((J) => J.id === L);
      return {
        slotKey: f,
        itemId: L,
        slotNum: D + 1,
    ...
    const le = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ve = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = U.map((f) => {
      ...
      const M = !!_, J = ((ct = f.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = f.system) == null ? void 0 : lt.equipped) !== null ? !!f.system.equipped : M, Y = (f == null ? void 0 : f.system) ?? {}, Ne = typeof Y.range == "string" ? (Y.range || "").trim() : "", se = Y.type ?? "", _e = (le[se] ?? se) || "—", pe = Y.size ?? "", De = (ve[pe] ?? pe) || "", Oe = [_e, De].filter(Boolean).join(", ") || _e || "—", be = se === "projectile" || pe === "thrown", ke = Y.quantity, $e = ke != null ? String(ke).trim() : "1", Ee = String(L.bonus ?? "").trim(), xe = String(Y.bonus ?? "").trim(), Lt = Ee || xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const we = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((f) => f.type === "Pancel");
    e.armorTable = we.map((f) => {
      var L, M;
    ...
    const Ie = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((f) => f.type === "Targy");
    e.itemsTable = Ie.map((f) => {
    ...
    const ue = (((rt = this.actor.items) == null ? void 0 : rt.contents) ?? []).filter((f) => f.type === "Egyeb");
    e.egyebList = ue.map((f) => {
    ...
    const V = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((f) => f.type === "MikroChip"), te = V.map((f) => ({ id: f.id, name: f.name, img: f.img })), fe = "— Nincs Mikro-Chip —", ye = ["slot1", "slot2", "slot3"], qe = (f) => {
      var _, L, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = te.filter((f) => !qe(1).includes(f.id)), e.microchipItemsSlot2 = te.filter((f) => !qe(2).includes(f.id)), e.microchipItemsSlot3 = te.filter((f) => !qe(3).includes(f.id)), e.microchipSlots = ye.map((f) => {
      ...
      e[`microchip${f}ItemId`] = L, e[`microchip${f}DisplayName`] = (M == null ? void 0 : M.name) || _.name || fe, e[`microchip${f}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = V.map((f) => {
      var pe, De, Oe, be;
      const D = f.id;
      let _ = null;
      for (const ke of ye)
        if ((((pe = C[ke]) == null ? void 0 : pe.itemId) ?? "").trim() === D) {
          _ = ke;
          break;
        }
      const L = !!_, M = ((De = f == null ? void 0 : f.system) == null ? void 0 : De.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Ne = Number((Oe = f == null ? void 0 : f.system) == null ? void 0 : Oe.replaceCost) >= 0 ? Number(f.system.replaceCost) : 0, se = (((be = f == null ? void 0 : f.system) == null ? void 0 : be.description) ?? "").trim(), _e = se ? se.length > 60 ? se.slice(0, 57) + "…" : se : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (f == null ? void 0 : f.name) ?? "—",
    ...
    const Ae = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((f) => {
      var D, _, L;
      return {
        id: f.id,
        name: f.name,
      ...
      const D = Ae[f] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
    ...
    return e.abilityPassiveList = W(ge("passive")), e.abilityActiveList = W(ge("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-C6rqeayH.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-C6rqeayH.mjs");
      l(this.actor, a, n);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, ee, le, ve, we, Ie, ue, V, te, fe, ye, qe, Ae;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((G = this.actor) == null ? void 0 : G.system), e.showDeathSkull = !1, e.sizeForSelect = (((le = (ee = e.system) == null ? void 0 : ee.identity) == null ? void 0 : le.size) ?? "").trim() || "Közepes";
    ...
    e.weaponSlots = n.map((k) => {
      const F = d[k] ?? {}, x = (F.itemId ?? "").trim(), K = g.find((ge) => ge.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, K = {};
      for (const Pe of a)
        if ((((Fe = d[Pe]) == null ? void 0 : Fe.itemId) ?? "").trim() === F) {
          x = Pe, K = d[Pe] ?? {};
          break;
        }
      const ge = !!x, W = (k == null ? void 0 : k.system) ?? {}, Le = typeof W.range == "string" ? (W.range || "").trim() : "", de = W.type ?? "", he = (l[de] ?? de) || "—", me = W.size ?? "", Se = (p[me] ?? me) || "", Te = [he, Se].filter(Boolean).join(", ") || he || "—", Me = de === "projectile" || me === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((ue = (Ie = t == null ? void 0 : t.system) == null ? void 0 : Ie.gear) == null ? void 0 : ue.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], q = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = q.map((k) => {
      var de, he, me, Se;
      const F = k.id;
      let x = null;
      for (const Te of I)
        if ((((de = v[Te]) == null ? void 0 : de.itemId) ?? "").trim() === F) {
          x = Te;
          break;
        }
      ...
      return {
        ...
        typeLabel: ge,
        description: Le,
        kp: Number((Se = k == null ? void 0 : k.system) == null ? void 0 : Se.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: K === "active",
        slotKey: x ?? "",
        equipped: !!x
      };
    ...
    const T = (((V = e.weaponsTable) == null ? void 0 : V.length) ?? 0) > 0 || (((te = e.armorTable) == null ? void 0 : te.length) ?? 0) > 0 || (((fe = e.microchipsTable) == null ? void 0 : fe.length) ?? 0) > 0 || (((ye = e.itemsTable) == null ? void 0 : ye.length) ?? 0) > 0 || (((qe = e.egyebList) == null ? void 0 : qe.length) ?? 0) > 0;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-C6rqeayH.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((r = d.parent) == null ? void 0 : r.id) !== c.id) {
        ...
        S = ((a = (await c.createEmbeddedDocuments("Item", [X]))[0]) == null ? void 0 : a.id) ?? S;
      }
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = c.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), H = N ? N.split(/\s*,\s*/).filter((G) => A.includes(G)) : [];
      let U = A.find((G) => {
        var ee;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((T = (C = c.system) == null ? void 0 : C.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((H) => {
        var U;
    ...
    if (c && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !y.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.type = "button", p.className = "votv-weapon-damage-chat", p.textContent = "Sebzés", p.dataset.actorId = u.actorId || ((i = E.speaker) == null ? void 0 : i.actor) || "", p.dataset.itemId = u.itemId || "", p.dataset.slotKey = u.slotKey || "", a.appendChild(p), p.addEventListener("click", async (b) => {
          var N, H, U, X, G, ee, le, ve, we, Ie, ue, V, te, fe;
          b.preventDefault(), b.stopPropagation();
          const v = b.currentTarget.dataset.actorId || "", I = b.currentTarget.dataset.itemId || "", q = b.currentTarget.dataset.slotKey || "", O = v && ((N = game.actors) == null ? void 0 : N.get(v)) || ((H = E.speaker) == null ? void 0 : H.actor) && ((U = game.actors) == null ? void 0 : U.get(E.speaker.actor)) || null;
          if (!O) return;
          let C = I ? ((G = (X = O.items) == null ? void 0 : X.get) == null ? void 0 : G.call(X, I)) ?? ((ve = (le = (ee = O.items) == null ? void 0 : ee.contents) == null ? void 0 : le.find) == null ? void 0 : ve.call(le, (ye) => ye.id === I)) : null;
          if (!C || C.type !== "Fegyver") return;
          let T = (((we = C.system) == null ? void 0 : we.damage) ?? "").trim();
          if (!T && q && (T = (((((Ie = O.system) == null ? void 0 : Ie.weapons) ?? {})[q] ?? {}).damage ?? "").trim()), !T) {
            (fe = (ue = ui.notifications) == null ? void 0 : ue.warn) == null || fe.call(
              ue,
              ((te = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : te.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája."
            );
            return;
          }
          const S = new Roll(T);
...
//# sourceMappingURL=vacuum-of-the-void-BzmTmSal.mjs.map
