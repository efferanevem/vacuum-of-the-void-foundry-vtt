...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(i = !1, e = {}) {
    ...
    const p = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, u = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var c, g;
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((u = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : u.resources) ?? {}, m = ((o = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : o.value) ?? 0, s = ((c = r.currentHealth) == null ? void 0 : c.legs) ?? 0, a = x._healthStatusFromRatio(s, m), f = Number(((w = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let p;
  ...
  async _prepareContext(i) {
    ...
    for (const d of a) {
      const T = ((xe = m[d]) == null ? void 0 : xe.value) ?? 0, I = s[d] ?? 0;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-XQxFPfWw.mjs");
      o(this.actor, l);
    ...
    m && r({ currentTarget: m }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, l = u.dataset.skill, o = ((g = u.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: c } = await import("./roll-sheet-XQxFPfWw.mjs");
      c(this.actor, l, o);
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (c && c.documentName === "Item" && c.type === "Fegyver") {
          const g = this.actor, b = ((p = c.parent) == null ? void 0 : p.id) !== g.id;
          let w = c.id;
          if (b) {
  ...
  async _rollWeapon(i) {
    var w;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, m = this.actor.items.filter((S) => S.type === "Fegyver");
    let s = null;
    t.itemId && (s = m.find((S) => S.id === t.itemId) ?? null);
...
//# sourceMappingURL=vacuum-of-the-void-BlkhLvat.mjs.map
