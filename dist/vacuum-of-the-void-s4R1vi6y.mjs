...
const { BooleanField: jt, NumberField: Jt, StringField: Le } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Pe, me, be, pe, _e, De, Me, je, Re, Ke, Fe, Ee, tt, st, it, rt, nt, at;
    ...
    for (const f of u) {
      const D = ((pe = d[f]) == null ? void 0 : pe.value) ?? 0, _ = c[f] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((f) => v.includes(f)) : [], O = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = O && typeof O == "object" && !Array.isArray(O) ? O : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Fe = C.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), A = (((Ee = C.slot3) == null ? void 0 : Ee.itemId) ?? "").trim(), U = this.actor.items.contents.filter((f) => f.type !== "Kepesseg" && f.type !== "ability").slice().sort((f, D) => {
      ...
      const Ne = D && ((qe = f.system) != null && qe.damage) ? f.system.damage : "", re = D && typeof ((ke = f.system) == null ? void 0 : ke.range) == "string" ? (f.system.range || "").trim() : "", Oe = J ? Number((ve = b[J]) == null ? void 0 : ve.bonus) || 0 : "";
      return {
        id: f.id,
        name: f.name,
        img: f.img,
    ...
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", te = q.filter((f) => {
      const _ = ((b[f] ?? {}).itemId ?? "").trim();
      return _ ? !!H.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = te.map((f, D) => {
    ...
    e.weaponsTable = H.map((f) => {
      ...
      const M = !!_, J = ((ct = f.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = f.system) == null ? void 0 : lt.equipped) !== null ? !!f.system.equipped : M, Y = (f == null ? void 0 : f.system) ?? {}, Ne = typeof Y.range == "string" ? (Y.range || "").trim() : "", re = Y.type ?? "", Oe = (we[re] ?? re) || "—", fe = Y.size ?? "", Ce = (Ie[fe] ?? fe) || "", qe = [Oe, Ce].filter(Boolean).join(", ") || Oe || "—", ke = re === "projectile" || fe === "thrown", ve = Y.quantity, $e = ve != null ? String(ve).trim() : "1", Ae = String(L.bonus ?? "").trim(), xe = String(Y.bonus ?? "").trim(), Lt = Ae || xe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const de = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((f) => f.type === "Pancel");
    e.armorTable = de.map((f) => {
      var L, M;
    ...
    const Se = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((f) => f.type === "Targy");
    e.itemsTable = Se.map((f) => {
    ...
    const V = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((f) => f.type === "MikroChip"), se = V.map((f) => ({ id: f.id, name: f.name, img: f.img })), ye = "— Nincs Mikro-Chip —", ge = ["slot1", "slot2", "slot3"], ee = (f) => {
      var _, L, M;
      const D = [];
    ...
    e.microchipItemsSlot1 = se.filter((f) => !ee(1).includes(f.id)), e.microchipItemsSlot2 = se.filter((f) => !ee(2).includes(f.id)), e.microchipItemsSlot3 = se.filter((f) => !ee(3).includes(f.id)), e.microchipSlots = ge.map((f) => {
      const D = C[f] ?? {}, _ = (D.itemId ?? "").trim(), L = V.find((M) => M.id === _);
      return {
        slotKey: f,
        itemId: _,
      ...
      const D = `slot${f}`, _ = C[D] ?? {}, L = (_.itemId ?? "").trim(), M = se.find((J) => J.id === L);
      e[`microchip${f}ItemId`] = L, e[`microchip${f}DisplayName`] = (M == null ? void 0 : M.name) || _.name || ye, e[`microchip${f}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = V.map((f) => {
      var fe, Ce, qe, ke;
      const D = f.id;
      let _ = null;
      for (const ve of ge)
        if ((((fe = C[ve]) == null ? void 0 : fe.itemId) ?? "").trim() === D) {
          _ = ve;
          break;
        }
      const L = !!_, M = ((Ce = f == null ? void 0 : f.system) == null ? void 0 : Ce.abilityType) ?? "", J = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Y = M === "active", Ne = Number((qe = f == null ? void 0 : f.system) == null ? void 0 : qe.replaceCost) >= 0 ? Number(f.system.replaceCost) : 0, re = (((ke = f == null ? void 0 : f.system) == null ? void 0 : ke.description) ?? "").trim(), Oe = re ? re.length > 60 ? re.slice(0, 57) + "…" : re : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (f == null ? void 0 : f.name) ?? "—",
    ...
    const ie = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((f) => {
      var D, _, L;
      return {
        id: f.id,
        name: f.name,
    ...
    }), F = new Map(k.map((f) => [f.id, f])), N = "— Nincs képesség —", K = (f) => {
      const D = ie[f] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
        displayName: (L == null ? void 0 : L.name) || D.name || N,
        img: (L == null ? void 0 : L.img) || "",
        description: M,
        kp: J
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-CR9w_02g.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-CR9w_02g.mjs");
      l(this.actor, a, n);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((C) => I.includes(C)) : [], O = q.find((C) => {
          var T;
      ...
      if (r.checked) {
        ...
        let T = v.find((A) => {
          var x;
          return !((x = l[A]) != null && x.itemId);
        });
        const S = new Set(v);
        if (!T) {
          const A = b.find((x) => !S.has(x));
          if (!A) return;
          T = A, v.push(A);
        }
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (l && l.documentName === "Item" && (l.type === "Kepesseg" || l.type === "ability")) {
          ...
          q.includes(p) || q.push(p), await this.actor.update({ [`system.abilities.${I}.items`]: q });
          return;
        }
      }
    }
    if (e) {
      ...
      if (n) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = p.system) == null ? void 0 : h.weapons) ?? {}, q = (I.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = q ? q.split(/\s*,\s*/).filter((S) => O.includes(S)) : [], T = C.filter((S) => {
              var A;
              return (((A = I[S]) == null ? void 0 : A.itemId) ?? "").trim() === v;
            });
            if (T.length > 0) {
              const A = {
                "system.weapons.slotOrder": C.filter((x) => !T.includes(x)).join(",")
              };
              for (const x of T)
                A[`system.weapons.${x}.itemId`] = "", A[`system.weapons.${x}.name`] = "", A[`system.weapons.${x}.damage`] = "", A[`system.weapons.${x}.bonus`] = "";
              await p.update(A);
            }
          }
          return;
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var G, te, we, Ie, de, Se, Te, V, se, ye, ge, ee, ie;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((G = this.actor) == null ? void 0 : G.system), e.showDeathSkull = !1, e.sizeForSelect = (((we = (te = e.system) == null ? void 0 : te.identity) == null ? void 0 : we.size) ?? "").trim() || "Közepes";
    const t = this.actor, o = ((Ie = t == null ? void 0 : t.items) == null ? void 0 : Ie.contents) ?? [], d = ((de = t == null ? void 0 : t.system) == null ? void 0 : de.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), y = u ? u.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = o.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = y.length > 0 ? y : c, r = c.filter((k) => !i.includes(k)), a = [...i, ...r], n = a.filter((k) => {
      var N;
      const F = (((N = d[k]) == null ? void 0 : N.itemId) ?? "").trim();
      return F && m.some((K) => K.id === F);
    });
    e.weaponSlots = n.map((k) => {
      const F = d[k] ?? {}, N = (F.itemId ?? "").trim(), K = g.find((he) => he.id === N);
      return {
        slotKey: k,
        itemId: N,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let N = null, K = {};
      for (const Ee of a)
        if ((((Fe = d[Ee]) == null ? void 0 : Fe.itemId) ?? "").trim() === F) {
          N = Ee, K = d[Ee] ?? {};
          break;
        }
      const he = !!N, W = (k == null ? void 0 : k.system) ?? {}, Pe = typeof W.range == "string" ? (W.range || "").trim() : "", me = W.type ?? "", be = (l[me] ?? me) || "—", pe = W.size ?? "", _e = (p[pe] ?? pe) || "", De = [be, _e].filter(Boolean).join(", ") || be || "—", Me = me === "projectile" || pe === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? K.bonus ?? "").trim() || "0", Ke = (W.damage ?? K.damage ?? "").trim() || "";
      return {
        slotKey: N ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((Te = (Se = t == null ? void 0 : t.system) == null ? void 0 : Se.gear) == null ? void 0 : Te.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], q = o.filter((k) => k.type === "MikroChip");
    e.microchipsTable = q.map((k) => {
      var me, be, pe, _e;
      const F = k.id;
      let N = null;
      for (const De of I)
        if ((((me = v[De]) == null ? void 0 : me.itemId) ?? "").trim() === F) {
          N = De;
          break;
        }
      const K = ((be = k == null ? void 0 : k.system) == null ? void 0 : be.abilityType) ?? "", he = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", W = (((pe = k == null ? void 0 : k.system) == null ? void 0 : pe.description) ?? "").trim(), Pe = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const T = (((V = e.weaponsTable) == null ? void 0 : V.length) ?? 0) > 0 || (((se = e.armorTable) == null ? void 0 : se.length) ?? 0) > 0 || (((ye = e.microchipsTable) == null ? void 0 : ye.length) ?? 0) > 0 || (((ge = e.itemsTable) == null ? void 0 : ge.length) ?? 0) > 0 || (((ee = e.egyebList) == null ? void 0 : ee.length) ?? 0) > 0;
    e.showEquipmentDropZone = !T;
    const S = ((ie = t == null ? void 0 : t.system) == null ? void 0 : ie.abilities) ?? {}, A = o.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, N;
      return {
        id: k.id,
        name: k.name,
    ...
    }), x = new Map(A.map((k) => [k.id, k])), U = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CR9w_02g.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, a, n, l, p, b, v, I, q, O, C, T;
    if (!this.actor) return (g = super._onDropItem) == null ? void 0 : g.call(this, s, e);
    const o = ((S) => {
      var x;
      if (!S) return null;
      const A = S.uuid ?? S.documentUuid ?? ((x = S.data) == null ? void 0 : x.uuid) ?? (typeof S == "string" ? S : null);
      if (A) return A;
      if (typeof S == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), x = ((l = c.system) == null ? void 0 : l.abilities) ?? {}, U = A === "active" ? "active" : "passive", H = Array.isArray((p = x[U]) == null ? void 0 : p.items) ? x[U].items.slice() : Array.isArray(x[U]) ? x[U].slice() : [];
      H.includes(S) || H.push(S), await c.update({ [`system.abilities.${U}.items`]: H }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = c.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = (S.slotOrder ?? "").trim(), U = x ? x.split(/\s*,\s*/).filter((G) => A.includes(G)) : [];
      let H = A.find((G) => {
        var te;
        return !(((te = S[G]) == null ? void 0 : te.itemId) ?? "").trim();
      });
      H || (H = A.find((G) => !U.includes(G)) ?? "slot1");
      const Z = U.includes(H) ? U : [...U, H].filter((G) => A.includes(G));
      await c.update({
        ...
        [`system.weapons.${H}.bonus`]: ((O = d.system) == null ? void 0 : O.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const S = ((T = (C = c.system) == null ? void 0 : C.gear) == null ? void 0 : T.microchips) ?? {}, x = ["slot1", "slot2", "slot3"].find((U) => {
        var H;
        return !(((H = S[U]) == null ? void 0 : H.itemId) ?? "").trim();
      });
      x && await c.update({
        [`system.gear.microchips.${x}.itemId`]: m,
        [`system.gear.microchips.${x}.name`]: d.name ?? ""
      });
    }
    typeof this.render == "function" && this.render(!0);
  }
...
z(ne, "PARTS", foundry.utils.mergeObject(R(ne, ne, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((St = R(ne, ne, "DEFAULT_OPTIONS")) == null ? void 0 : St.form) ?? {}, { submitOnChange: !1 })
}));
let Je = ne;
var Tt;
...
z(ae, "PARTS", foundry.utils.mergeObject(R(ae, ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Tt = R(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : Tt.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = ae;
var _t;
...
z(oe, "PARTS", foundry.utils.mergeObject(R(oe, oe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((_t = R(oe, oe, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !1 })
}));
let Xe = oe;
var Dt;
...
z(ce, "PARTS", foundry.utils.mergeObject(R(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Dt = R(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !0 })
}));
let Ze = ce;
var Ot;
...
z(le, "PARTS", foundry.utils.mergeObject(R(le, le, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), z(le, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(le, le, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ot = R(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Ot.form) ?? {}, { submitOnChange: !1 })
}));
let Ve = le;
var Ct;
...
z(ue, "PARTS", foundry.utils.mergeObject(R(ue, ue, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), z(ue, "DEFAULT_OPTIONS", foundry.utils.mergeObject(R(ue, ue, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ct = R(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : Ct.form) ?? {}, { submitOnChange: !1 })
}));
let et = ue;
  ...
  if (y) {
    ...
    if (c && u && (u.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !y.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = u.actorId || ((i = E.speaker) == null ? void 0 : i.actor) || "", p.dataset.itemId = u.itemId || "", p.dataset.slotKey = u.slotKey || "", a.appendChild(p), p.addEventListener("click", async (I) => {
          var te, we, Ie, de, Se, Te, V, se, ye, ge, ee, ie, k, F;
          I.preventDefault(), I.stopPropagation();
          const q = I.currentTarget.dataset.actorId || "", O = I.currentTarget.dataset.itemId || "", C = I.currentTarget.dataset.slotKey || "", T = q && ((te = game.actors) == null ? void 0 : te.get(q)) || ((we = E.speaker) == null ? void 0 : we.actor) && ((Ie = game.actors) == null ? void 0 : Ie.get(E.speaker.actor)) || null;
          if (!T) return;
          let S = O ? ((Se = (de = T.items) == null ? void 0 : de.get) == null ? void 0 : Se.call(de, O)) ?? ((se = (V = (Te = T.items) == null ? void 0 : Te.contents) == null ? void 0 : V.find) == null ? void 0 : se.call(V, (N) => N.id === O)) : null;
          if (!S || S.type !== "Fegyver") return;
          let A = (((ye = S.system) == null ? void 0 : ye.damage) ?? "").trim();
          if (!A && C && (A = (((((ge = T.system) == null ? void 0 : ge.weapons) ?? {})[C] ?? {}).damage ?? "").trim()), !A) {
            (F = (ee = ui.notifications) == null ? void 0 : ee.warn) == null || F.call(
              ee,
              ((k = (ie = game.i18n) == null ? void 0 : ie.localize) == null ? void 0 : k.call(ie, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája."
            );
            return;
          }
          const x = new Roll(A);
          await x.evaluate({ async: !0 });
          const U = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, H = u.targetName || "", Z = u.hitLocationName || "";
          let G = H ? `${S.name} – sebzés – ${H}` : `${S.name} – sebzés`;
          Z && (G += ` (${Z})`), await x.toMessage({
            speaker: ChatMessage.getSpeaker({ actor: T }),
            flavor: G,
            flags: { "vacuum-of-the-void": {} },
            rollMode: U
...
//# sourceMappingURL=vacuum-of-the-void-s4R1vi6y.mjs.map
