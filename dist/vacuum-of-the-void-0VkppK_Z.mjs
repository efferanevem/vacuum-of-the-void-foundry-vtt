...
var Q = (w, s, e) => As(w, typeof s != "symbol" ? s + "" : s, e);
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ze, et, tt, st, it, nt, at, rt, ot, Ee, ct, lt, $e, k, F, E, H, de, X, _e, we, De, Ie, xe, Re, Tt, _t, Dt, Ot, ut, Ge, zt, Ht, Ut, Bt, Gt, Vt, Wt, Yt, Jt, Qt, Xt, Zt, es, ts;
    ...
    b === 0 && (D = 0), (we = (_e = (X = this.actor) == null ? void 0 : X.statuses) == null ? void 0 : _e.has) != null && we.call(_e, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(e.system ?? this.actor.system),
      { combat: { givenSpeed: 0, givenProtection: (Ie = (De = e.system) == null ? void 0 : De.combat) == null ? void 0 : Ie.givenProtection } },
      { inplace: !1 }
    ), D = 0), e.totalSpeed = D;
    ...
    const C = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = (C.slotOrder ?? "").trim(), A = x ? x.split(/\s*,\s*/).filter((g) => L.includes(g)) : [], j = (xe = this.actor.system.gear) == null ? void 0 : xe.microchips, z = j && typeof j == "object" && !Array.isArray(j) ? j : {}, U = (((Re = z.slot1) == null ? void 0 : Re.itemId) ?? "").trim(), V = (((Tt = z.slot2) == null ? void 0 : Tt.itemId) ?? "").trim(), se = (((_t = z.slot3) == null ? void 0 : _t.itemId) ?? "").trim(), M = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, O) => {
      ...
      var Se, Ke, je, Oe, Ce, dt;
      const O = g.type === "Fegyver", _ = g.type === "MikroChip";
      let P = 0, R = "", Z = null;
      for (let Ve = 0; Ve < A.length; Ve++) {
        const mt = A[Ve];
        if ((((Se = C[mt]) == null ? void 0 : Se.itemId) ?? "") === g.id) {
          P = Ve + 1, R = ((Ke = C[mt]) == null ? void 0 : Ke.bonus) ?? "", Z = mt;
          break;
        }
      }
      let W = null;
      _ && (U === g.id ? W = "slot1" : V === g.id ? W = "slot2" : se === g.id && (W = "slot3"));
      const Me = O && ((je = g.system) != null && je.damage) ? g.system.damage : "", re = O && typeof ((Oe = g.system) == null ? void 0 : Oe.range) == "string" ? (g.system.range || "").trim() : "", le = Z ? Number((Ce = C[Z]) == null ? void 0 : Ce.bonus) || 0 : "";
      return {
        id: g.id,
        name: g.name,
        img: g.img,
    ...
    e.weaponItems = ne;
    const be = "— Nincs fegyver —", ue = A.filter((g) => {
      const _ = ((C[g] ?? {}).itemId ?? "").trim();
      return _ ? !!Y.find((R) => R.id === _) : !1;
    });
    e.weaponSlots = ue.map((g, O) => {
      const _ = C[g] ?? {}, P = (_.itemId ?? "").trim(), R = ne.find((le) => le.id === P), Z = Y.find((le) => le.id === P), W = (Z == null ? void 0 : Z.system) ?? {}, Me = W.size === "thrown" || W.type === "projectile", re = (typeof W.range == "string" ? (W.range || "").trim() : "") || "—";
      return {
        slotKey: g,
        itemId: P,
        slotNum: O + 1,
        displayName: (R == null ? void 0 : R.name) || _.name || be,
    ...
    const ke = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ae = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = Y.map((g) => {
      ...
      const R = !!_, Z = ((is = g.system) == null ? void 0 : is.equipped) !== void 0 && ((ns = g.system) == null ? void 0 : ns.equipped) !== null ? !!g.system.equipped : R, W = (g == null ? void 0 : g.system) ?? {}, Me = typeof W.range == "string" ? (W.range || "").trim() : "", re = W.type ?? "", le = (ke[re] ?? re) || "—", Se = W.size ?? "", Ke = (ae[Se] ?? Se) || "", je = [le, Ke].filter(Boolean).join(", ") || le || "—", Oe = re === "projectile" || Se === "thrown", Ce = W.quantity, dt = Ce != null ? String(Ce).trim() : "1", Ve = String(P.bonus ?? "").trim(), mt = String(W.bonus ?? "").trim(), qs = Ve || mt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? be,
    ...
    const oe = (((Ot = this.actor.items) == null ? void 0 : Ot.contents) ?? []).filter((g) => g.type === "Pancel");
    e.armorTable = oe.map((g) => {
      var P, R;
    ...
    const yt = (((zt = this.actor.items) == null ? void 0 : zt.contents) ?? []).filter((g) => g.type === "MikroChip"), ie = yt.map((g) => ({ id: g.id, name: g.name, img: g.img })), We = "— Nincs Mikro-Chip —", ve = ["slot1", "slot2", "slot3"], He = (g) => {
      var _, P, R;
      const O = [];
    ...
    e.microchipItemsSlot1 = ie.filter((g) => !He(1).includes(g.id)), e.microchipItemsSlot2 = ie.filter((g) => !He(2).includes(g.id)), e.microchipItemsSlot3 = ie.filter((g) => !He(3).includes(g.id)), e.microchipSlots = ve.map((g) => {
      ...
      let _ = null;
      for (const Ce of ve)
        if ((((Se = z[Ce]) == null ? void 0 : Se.itemId) ?? "").trim() === O) {
          _ = Ce;
          break;
        }
      const P = !!_, R = ((Ke = g == null ? void 0 : g.system) == null ? void 0 : Ke.abilityType) ?? "", Z = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", W = R === "active", Me = Number((je = g == null ? void 0 : g.system) == null ? void 0 : je.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, re = (((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.description) ?? "").trim(), le = re ? re.length > 60 ? re.slice(0, 57) + "…" : re : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
    ...
    const kt = ((Wt = e.system) == null ? void 0 : Wt.resources) ?? {}, Be = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Ne = (Jt = (Yt = e.system) == null ? void 0 : Yt.combat) == null ? void 0 : Jt.initiativeResult, ce = typeof Ne == "number" ? Ne : -1, vt = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (Xt = (Qt = e.system) == null ? void 0 : Qt.combat) == null ? void 0 : Xt.initiativeRanges, Ae = Array.isArray(Pe) ? Pe.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Te = (Ae.length > 0 ? Ae : vt).slice().sort((g, O) => g.min - O.min), Fe = Ae.map((g) => g.min), wt = Fe.length ? Math.min(...Fe) : 0, It = Fe.length ? Math.max(...Fe) : 0;
    e.initiativeRanges = Ae.map((g) => ({ ...g, isFirst: g.min === wt, isLast: g.min === It }));
    let Xe = 0;
    if (typeof ce == "number" && ce >= 0 && Te.length > 0) {
      const g = Te[0], O = Te[Te.length - 1];
      let _ = null;
      ce <= g.max ? _ = g : ce >= O.min ? _ = O : _ = Te.find((P) => ce >= P.min && ce <= P.max), _ && (Xe = _.kp);
    }
    e.kpDots = Be.map((g, O) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DpMZREpa.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DpMZREpa.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-DpMZREpa.mjs");
      f(this.actor, o, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Ye, Je, Qe, kt, Be, Ne, ce, vt, Pe, Ae, qt, Te, Fe, wt, It, Xe, St, Ze, et, tt, st, it, nt, at, rt, ot, Ee, ct, lt, $e;
    ...
    e.weaponsTable = c.map((k) => {
      ...
      const de = !!E, X = (k == null ? void 0 : k.system) ?? {}, _e = typeof X.range == "string" ? (X.range || "").trim() : "", we = X.type ?? "", De = (S[we] ?? we) || "—", Ie = X.size ?? "", xe = (D[Ie] ?? Ie) || "", Re = [De, xe].filter(Boolean).join(", ") || De || "—", Tt = we === "projectile" || Ie === "thrown", _t = X.quantity != null ? String(X.quantity).trim() : "1", Dt = String(X.bonus ?? H.bonus ?? "").trim() || "0", Ot = (X.damage ?? H.damage ?? "").trim() || "";
      return {
        slotKey: E ?? "",
        itemId: F,
        actorId: t.id,
    ...
    e.microchipsTable = x.map((k) => {
      ...
      let E = null;
      for (const Re of L)
        if ((((we = C[Re]) == null ? void 0 : we.itemId) ?? "").trim() === F) {
          E = Re;
          break;
        }
      const H = ((De = k == null ? void 0 : k.system) == null ? void 0 : De.abilityType) ?? "", de = H === "active" ? "Aktív" : H === "passive" ? "Passzív" : H || "—", X = (((Ie = k == null ? void 0 : k.system) == null ? void 0 : Ie.description) ?? "").trim(), _e = X ? X.length > 60 ? X.slice(0, 57) + "…" : X : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    }), se = new Map(V.map((k) => [k.id, k])), J = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const ne = t == null ? void 0 : t.id, be = !!((it = (st = game.combat) == null ? void 0 : st.combatants) != null && it.some(
      (k) => {
        var F;
    ...
    const ue = ((nt = e.system) == null ? void 0 : nt.resources) ?? {}, ke = (rt = (at = e.system) == null ? void 0 : at.combat) == null ? void 0 : rt.initiativeResult, ae = typeof ke == "number" ? ke : -1, oe = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Le = (Ee = (ot = e.system) == null ? void 0 : ot.combat) == null ? void 0 : Ee.initiativeRanges, ze = Array.isArray(Le) ? Le.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (ze.length > 0 ? ze : oe).slice().sort((k, F) => k.min - F.min), We = 3;
    let ve = ze.length > 0 ? ze : [];
    ve.length < We && (ve = [...ve, ...Array(We - ve.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = ve.map((k, F) => ({
      ...k,
      isFirst: F === 0,
      isLast: F === ve.length - 1
    }));
    let He = 0;
    ...
    const gt = ie.length > 0 ? ie[ie.length - 1] : null, ht = Math.min(10, gt ? gt.kp : 6), Ue = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, ht)).map((k, F) => {
      const E = F + 1, H = !!Number(ue[k]), de = E <= He;
      return { index: E, used: H, usable: de };
    }), bt = Math.ceil(Ue.length / 2);
    return e.kpDotsRow1 = Ue.slice(0, bt), e.kpDotsRow2 = Ue.slice(bt), e.canEditInitiative = !!((ct = game.user) != null && ct.isGM), e.showInitiativeResult = typeof ke == "number", e.initiativeResult = e.showInitiativeResult ? ke : "", e.speedUnitForSelect = (($e = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : $e.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var p, y, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DpMZREpa.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DpMZREpa.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DpMZREpa.mjs");
      a(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    ...
    if (d.type === "Fegyver" && p) {
      const A = ((D = r.system) == null ? void 0 : D.weapons) ?? {}, j = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], z = (A.slotOrder ?? "").trim(), U = z ? z.split(/\s*,\s*/).filter((J) => j.includes(J)) : [];
      let V = j.find((J) => {
        var M;
        return !(((M = A[J]) == null ? void 0 : M.itemId) ?? "").trim();
      });
      V || (V = j.find((J) => !U.includes(J)) ?? "slot1");
      const se = U.includes(V) ? U : [...U, V].filter((J) => j.includes(J));
      await r.update({
...
Q(te, "PARTS", foundry.utils.mergeObject(
  B(te, te, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), Q(te, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
...
Q(me, "PARTS", foundry.utils.mergeObject(B(me, me, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), Q(me, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(me, me, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((bs = B(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : bs.form) ?? {}, { submitOnChange: !1 })
}));
let Et = me;
var ks;
...
Q(pe, "PARTS", foundry.utils.mergeObject(B(pe, pe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs" }
})), Q(pe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(pe, pe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Pancel"],
  template: "systems/vacuum-of-the-void/templates/item/shield-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ks = B(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : ks.form) ?? {}, { submitOnChange: !1 })
}));
let $t = pe;
var vs;
...
Q(fe, "PARTS", foundry.utils.mergeObject(B(fe, fe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs" }
})), Q(fe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(fe, fe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "MikroChip"],
  template: "systems/vacuum-of-the-void/templates/item/microchip-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((vs = B(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : vs.form) ?? {}, { submitOnChange: !1 })
}));
let xt = fe;
var ws;
...
Q(ye, "PARTS", foundry.utils.mergeObject(B(ye, ye, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs" }
})), Q(ye, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ye, ye, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Kepesseg", "kepesseg"],
  template: "systems/vacuum-of-the-void/templates/item/ability-sheet.hbs",
  width: 500,
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ws = B(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : ws.form) ?? {}, { submitOnChange: !0 })
}));
let Rt = ye;
var Is;
...
Q(ge, "PARTS", foundry.utils.mergeObject(B(ge, ge, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs" }
})), Q(ge, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(ge, ge, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Targy"],
  template: "systems/vacuum-of-the-void/templates/item/targy-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Is = B(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Is.form) ?? {}, { submitOnChange: !1 })
}));
let Mt = ge;
var Ss;
...
Q(he, "PARTS", foundry.utils.mergeObject(B(he, he, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), Q(he, "DEFAULT_OPTIONS", foundry.utils.mergeObject(B(he, he, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Ss = B(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : Ss.form) ?? {}, { submitOnChange: !1 })
}));
let Kt = he;
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var S, D, N, C, L, x, A, j, z, U, V, se, J;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      ...
      if (ne) {
        const be = ((C = ne.combatants) == null ? void 0 : C.contents) ?? Array.from(ne.combatants ?? []);
        for (const ue of be)
          if (((L = ue.actor) == null ? void 0 : L.id) === u || ue.actorId === u) {
            ne.updateEmbeddedDocuments("Combatant", [{ _id: ue.id, initiative: Y }]).catch(() => {
            });
            break;
          }
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, D, N, C, L, x, A, j, z, U, V, se, J, M, Y, ne, be, ue, ke;
    ...
    if (m || (m = ((x = (L = game.scenes) == null ? void 0 : L.contents) == null ? void 0 : x.flatMap((oe) => {
      var Le;
      return ((Le = oe.tokens) == null ? void 0 : Le.contents) ?? [];
    }).map((oe) => oe.actor).find((oe) => oe && (oe.id === l || oe.id === r.actorId))) ?? null), !m) return;
    ...
    if (y || (y = (((se = p == null ? void 0 : p.system) == null ? void 0 : se.damage) ?? "").trim()), !y && r.slotKey && (y = (((((J = m.system) == null ? void 0 : J.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !y) {
      (be = (M = ui.notifications) == null ? void 0 : M.warn) == null || be.call(M, ((ne = (Y = game.i18n) == null ? void 0 : Y.localize) == null ? void 0 : ne.call(Y, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const b = new Roll(y);
    await b.evaluate({ async: !0 });
    const u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = r.targetName || "", c = r.hitLocationName || "", o = ((p == null ? void 0 : p.name) ?? (r.slotKey ? ((ke = (((ue = m.system) == null ? void 0 : ue.weapons) ?? {})[r.slotKey]) == null ? void 0 : ke.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-0VkppK_Z.mjs.map
