...
var H = (L, r, e) => nt(L, typeof r != "symbol" ? r + "" : r, e);
var x = (L, r, e) => st(at(L), e, r);
const { HTMLField: ot, NumberField: b, SchemaField: D, StringField: f, BooleanField: M, ArrayField: ee } = foundry.data.fields;
...
const F = class F extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(r = !1, e = {}) {
    ...
    if (n) {
      ...
      const g = document.activeElement, v = o.contains(g), w = g && (g.tagName === "INPUT" && g.type !== "checkbox" && g.type !== "radio" || g.tagName === "TEXTAREA");
      v && w && (c.focus = {
        name: g.name || null,
        id: g.id || null,
    ...
    const y = this.element, h = this.form ?? this.element, a = c.scrollState, s = c.focus, l = typeof (a == null ? void 0 : a.formScrollTop) == "number" || typeof (a == null ? void 0 : a.windowScrollTop) == "number", u = () => {
      ...
      if (this._applyScrollState(y, a), (s == null ? void 0 : s.name) != null || (s == null ? void 0 : s.id) != null) {
        const w = ((g = h.querySelector) == null ? void 0 : g.call(h, s.id ? `#${CSS.escape(s.id)}` : null)) ?? (s.name ? (v = h.querySelector) == null ? void 0 : v.call(h, `[name="${CSS.escape(s.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(r = null) {
    ...
    const i = ((s = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : s.resources) ?? {}, n = ((u = (l = i.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : u.value) ?? 0, o = ((d = i.currentHealth) == null ? void 0 : d.legs) ?? 0, c = F._healthStatusFromRatio(o, n), p = Number(((w = (v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let y;
  ...
  async _prepareContext(r) {
    var ke, ve, Ie, Se, qe, Te, De, _e, Oe, Le, Ae, Fe, Ne, Ee, Ce, $e, xe;
    ...
    const d = this.actor.system.weapons ?? {}, g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = (d.slotOrder ?? "").trim(), w = v ? v.split(/\s*,\s*/).filter((m) => g.includes(m)) : [], A = (De = this.actor.system.gear) == null ? void 0 : De.microchips, O = A && typeof A == "object" && !Array.isArray(A) ? A : {}, S = (((_e = O.slot1) == null ? void 0 : _e.itemId) ?? "").trim(), _ = (((Oe = O.slot2) == null ? void 0 : Oe.itemId) ?? "").trim(), N = (((Le = O.slot3) == null ? void 0 : Le.itemId) ?? "").trim(), P = this.actor.items.contents.filter((m) => m.type !== "ability").slice().sort((m, k) => {
      const I = typeof m.sort == "number" ? m.sort : 0, q = typeof k.sort == "number" ? k.sort : 0;
      return I - q;
    }).map((m) => {
      ...
      let j = null;
      I && (S === m.id ? j = "slot1" : _ === m.id ? j = "slot2" : N === m.id && (j = "slot3"));
      const W = k && ((Pe = m.system) != null && Pe.damage) ? m.system.damage : "", G = k && ((He = (je = m.system) == null ? void 0 : je.range) == null ? void 0 : He.short) != null ? m.system.range.short : null, Y = k && ((Ue = (Re = m.system) == null ? void 0 : Re.range) == null ? void 0 : Ue.long) != null ? m.system.range.long : null, X = G != null && Y != null ? `${G} / ${Y} m` : "", Z = C ? Number((Be = d[C]) == null ? void 0 : Be.bonus) || 0 : "";
      return {
        id: m.id,
        name: m.name,
        img: m.img,
    ...
    e.actionsTable = P;
    const K = (((Ae = this.actor.items) == null ? void 0 : Ae.contents) ?? []).filter((m) => m.type === "weapon"), ue = K.map((m) => ({ id: m.id, name: m.name, img: m.img }));
    e.weaponItems = ue;
    ...
    e.weaponsTable = me.map((m) => {
      var X, Z;
      const k = d[m] ?? {}, I = (k.itemId ?? "").trim(), q = K.find((Q) => Q.id === I), T = (q == null ? void 0 : q.system) ?? {}, C = (X = T.range) == null ? void 0 : X.short, j = (Z = T.range) == null ? void 0 : Z.long, W = C != null && j != null ? `${C} / ${j} m` : "", G = T.type ?? "", Y = (et[G] ?? G) || "—";
      return {
        slotKey: m,
        itemId: I,
        name: (q == null ? void 0 : q.name) ?? k.name ?? de,
        img: (q == null ? void 0 : q.img) ?? "",
        bonus: String(k.bonus ?? "").trim() || "0",
        damage: k.damage ?? T.damage ?? "",
        rangeStr: W || "—",
        typeLabel: Y,
        quantity: Number(T.quantity ?? 1) || 1,
        special: (T.special ?? "").trim() || "—"
      };
    }), e.armor = Array.isArray((Ne = (Fe = this.actor.system) == null ? void 0 : Fe.gear) == null ? void 0 : Ne.armor) ? this.actor.system.gear.armor : [], e.generalItems = Array.isArray((Ce = (Ee = this.actor.system) == null ? void 0 : Ee.gear) == null ? void 0 : Ce.generalItems) ? this.actor.system.gear.generalItems : [];
    const pe = ((($e = this.actor.items) == null ? void 0 : $e.contents) ?? []).filter((m) => m.type === "microchip"), J = pe.map((m) => ({ id: m.id, name: m.name, img: m.img }));
    e.microchipsTable = ["1", "2", "3"].map((m) => {
      var W, G;
      const k = `slot${m}`, I = O[k] ?? {}, q = (I.itemId ?? "").trim(), T = pe.find((Y) => Y.id === q), C = ((W = T == null ? void 0 : T.system) == null ? void 0 : W.abilityType) ?? "", j = C === "active" ? "Aktív" : C === "passive" ? "Passzív" : C || "—";
      return {
        slotKey: k,
        itemId: q,
    ...
    const fe = "— Nincs Mikro-Chip —", te = (m) => {
      const k = [];
      return m !== 1 && k.push(S), m !== 2 && k.push(_), m !== 3 && k.push(N), k;
    };
    e.microchipItemsSlot1 = J.filter((m) => !te(1).includes(m.id)), e.microchipItemsSlot2 = J.filter((m) => !te(2).includes(m.id)), e.microchipItemsSlot3 = J.filter((m) => !te(3).includes(m.id)), ["1", "2", "3"].forEach((m) => {
      const k = `slot${m}`, I = O[k] ?? {}, q = (I.itemId ?? "").trim(), T = J.find((C) => C.id === q);
    ...
    const ge = this.actor.system.abilities ?? {}, tt = (((xe = this.actor.items) == null ? void 0 : xe.contents) ?? []).map((m) => {
      ...
      const k = ge[m] ?? {}, I = (k.itemId ?? "").trim(), q = I ? ye.get(I) : null, T = (q == null ? void 0 : q.description) ?? "", C = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: I,
        displayName: (q == null ? void 0 : q.name) || k.name || rt,
        img: (q == null ? void 0 : q.img) || "",
        description: T,
        kp: C
      };
  ...
  _attachFrameListeners(r) {
    ...
    n && i({ currentTarget: n }), this._writeEffectiveGivenSpeed(r), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (a) => {
      ...
      var g;
      a.preventDefault();
      const s = a.currentTarget, l = s.dataset.skill, u = ((g = s.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: d } = await import("./roll-sheet-D_ocrAid.mjs");
      d(this.actor, l, u);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if ((d == null ? void 0 : d.type) === "weapon") {
        const v = u.system.weapons ?? {}, w = (v.slotOrder ?? "").trim(), A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = w ? w.split(/\s*,\s*/).filter((_) => A.includes(_)) : [], S = O.find((_) => {
          var N;
          return (((N = v[_]) == null ? void 0 : N.itemId) ?? "").trim() === l;
        });
        if (S) {
          const _ = O.filter((N) => N !== S);
      ...
      if (!l) return;
      const u = this.actor.system.weapons ?? {}, d = (u.slotOrder ?? "").trim(), g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = d ? d.split(/\s*,\s*/).filter((S) => g.includes(S)) : [], w = v.find((S) => {
        var _;
      ...
      if (s.checked) {
        ...
        const N = this.actor.items.get(l), E = {
          "system.weapons.slotOrder": v.join(","),
          [`system.weapons.${S}.itemId`]: l,
          [`system.weapons.${S}.name`]: (N == null ? void 0 : N.name) ?? "",
          [`system.weapons.${S}.damage`]: ((O = N == null ? void 0 : N.system) == null ? void 0 : O.damage) ?? ""
        };
        await this.actor.update(E);
      } else if (w) {
        const _ = {
          "system.weapons.slotOrder": v.filter((N) => N !== w).join(",")
        };
        _[`system.weapons.${w}.itemId`] = "", _[`system.weapons.${w}.name`] = "", _[`system.weapons.${w}.damage`] = "", _[`system.weapons.${w}.bonus`] = "", await this.actor.update(_);
      }
      ...
      if (!d) return;
      const g = (s.dataset.itemId ?? "").trim(), v = (s.dataset.itemName ?? ((N = s.textContent) == null ? void 0 : N.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", w = (s.dataset.itemImg ?? "").trim(), A = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      A && (A.textContent = v);
      let O = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-thumb");
      w ? (O || (O = document.createElement("img"), O.className = "karakter-microchip-slot-thumb", O.alt = "", u == null || u.insertBefore(O, A)), O.src = w, O.style.display = "") : O && O.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
      ...
      if (!s || !l) return;
      const u = this.actor.system.abilities ?? {}, g = (Array.isArray((v = u[s]) == null ? void 0 : v.items) ? u[s].items.slice() : []).filter((w) => w !== l);
      ...
      if (s === "armor") {
        ...
        const v = Array.isArray((g = (d = this.actor.system) == null ? void 0 : d.gear) == null ? void 0 : g.generalItems) ? [...this.actor.system.gear.generalItems] : [];
    ...
    const c = this, p = (a) => {
      ...
      const l = ((d = (u = s.system) == null ? void 0 : u.resources) == null ? void 0 : d.currentHealth) != null || ((v = (g = s.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
    ...
    if (e) {
      ...
      if (u) {
        ...
        if (d && d.documentName === "Item" && d.type === "ability") {
          ...
          const v = (((a = d.system) == null ? void 0 : a.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (i) {
            ...
            if (S) {
              const _ = Array.isArray((s = w[S]) == null ? void 0 : s.items) ? w[S].items.slice() : Array.isArray(w[S]) ? w[S].slice() : [];
          ...
          const A = v === "active" ? "active" : "passive", O = Array.isArray((l = w[A]) == null ? void 0 : l.items) ? w[A].items.slice() : Array.isArray(w[A]) ? w[A].slice() : [];
          O.includes(g) || O.push(g), await this.actor.update({ [`system.abilities.${A}.items`]: O });
          return;
        }
      }
    }
  ...
  async _rollWeapon(r) {
    var w;
    const t = (this.actor.system.weapons ?? {})[r] ?? {}, i = this.actor.system.skills ?? {}, n = this.actor.items.filter((A) => A.type === "weapon");
    let o = null;
    t.itemId && (o = n.find((A) => A.id === t.itemId) ?? null);
    const c = o && o.name || t.name || `Fegyver (${r})`, p = Number(t.bonus || 0) || 0, h = (((w = o == null ? void 0 : o.system) == null ? void 0 : w.type) || "light") === "thrown" ? "grenadeUse" : "firearms", a = Number(i[h] || 0) || 0, s = p + a, u = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, d = new Roll(u);
    await d.evaluate({ async: !0 });
    const g = d.total >= 18 ? "critical" : d.total <= 3 ? "fumble" : null, v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return d.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${c} – találat`,
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (o, c, p, y) => {
    ...
    if (!h) return;
    const a = document.activeElement, s = a && (a.tagName === "INPUT" && a.type !== "checkbox" && a.type !== "radio" || a.tagName === "TEXTAREA" || a.isContentEditable), l = [], u = (A = game.actors) == null ? void 0 : A.get(h);
    u != null && u.apps && l.push(...Array.from(u.apps));
    const d = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const E of d)
      ((O = E.document) == null ? void 0 : O.id) !== h || ((S = E.document) == null ? void 0 : S.documentName) !== "Actor" || ((_ = E.constructor) == null ? void 0 : _.name) !== "VoidKarakterSheet" || l.includes(E) || l.push(E);
    if (s && l.some((E) => {
      const P = (E == null ? void 0 : E.form) ?? (E == null ? void 0 : E.element);
      return P && P.contains(a);
    })) return;
    const v = (N = game.votv) == null ? void 0 : N._lastKarakterSheetBlurSave, w = v && Date.now() - v.at < L ? v.appId : null;
    setTimeout(() => {
      for (const E of l)
        !(E != null && E.rendered) || typeof E.render != "function" || E.id !== w && E.render(!0);
    }, 0);
  });
});
Hooks.on("ready", () => {
  var L;
  (L = CONFIG.Item) != null && L.typeLabels && (CONFIG.Item.typeLabels.weapon = "Fegyver"), document.body.addEventListener(
    "dragstart",
    (r) => {
      var n, o, c, p, y, h;
      if (!((o = (n = r.target) == null ? void 0 : n.closest) != null && o.call(n, "#actors"))) return;
      const e = (p = (c = r.target) == null ? void 0 : c.closest) == null ? void 0 : p.call(c, "[data-document-id]"), t = (y = e == null ? void 0 : e.getAttribute) == null ? void 0 : y.call(e, "data-document-id");
      if (!t) return;
      const i = t.includes(".") ? t.split(".").pop() : t;
      i && ((h = game.actors) != null && h.get(i)) && (game.votv._dragSourceActorId = i);
    },
    !0
  );
});
...
//# sourceMappingURL=vacuum-of-the-void-BKx4KuSF.mjs.map
