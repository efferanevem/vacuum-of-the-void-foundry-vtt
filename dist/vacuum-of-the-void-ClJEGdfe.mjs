  ...
  static defineSchema() {
    return {
      ...
      skills: new j({
        ...
        // NPC header extra mezők – itt szöveg is lehet, ezért StringField
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, r, o, n, l, y, b, v;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const a = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((n = (o = a.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : n.value) ?? 0, c = ((l = a.currentHealth) == null ? void 0 : l.legs) ?? 0, u = H._healthStatusFromRatio(c, d), g = Number(((v = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    var c, u, g, m;
    const e = H.BODY_PART_BY_SKILL[s];
    if (e == null) return;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const a = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, d = ((m = (g = a.hitLocations) == null ? void 0 : g[t]) == null ? void 0 : m.value) ?? 0, c = ((f = a.currentHealth) == null ? void 0 : f[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], L = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = L && typeof L == "object" && !Array.isArray(L) ? L : {}, _ = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = O.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), E = (((Te = O.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), U = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), fe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), De = "— Nincs Mikro-Chip —", Oe = ["slot1", "slot2", "slot3"], Ie = (p) => {
      var T, C, x;
      const D = [];
      return p !== 1 && D.push((((T = O.slot1) == null ? void 0 : T.itemId) ?? "").trim()), p !== 2 && D.push((((C = O.slot2) == null ? void 0 : C.itemId) ?? "").trim()), p !== 3 && D.push((((x = O.slot3) == null ? void 0 : x.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((p) => !Ie(1).includes(p.id)), e.microchipItemsSlot2 = fe.filter((p) => !Ie(2).includes(p.id)), e.microchipItemsSlot3 = fe.filter((p) => !Ie(3).includes(p.id)), e.microchipSlots = Oe.map((p) => {
      const D = O[p] ?? {}, T = (D.itemId ?? "").trim(), C = we.find((x) => x.id === T);
      return {
        slotKey: p,
        itemId: T,
      ...
      const D = `slot${p}`, T = O[D] ?? {}, C = (T.itemId ?? "").trim(), x = fe.find((Y) => Y.id === C);
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-JeHULEbI.mjs");
      n(this.actor, o);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, n = ((y = r.textContent) == null ? void 0 : y.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-JeHULEbI.mjs");
      l(this.actor, o, n);
      ...
      if (!y) return;
      const b = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, y)) ?? ((_ = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : _.call(O, (E) => E.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((O) => I.includes(O)) : [], L = q.find((O) => {
          var _;
          return (((_ = b[O]) == null ? void 0 : _.itemId) ?? "").trim() === o;
        });
        if (L) {
          const O = q.filter((_) => _ !== L);
          y["system.weapons.slotOrder"] = O.join(","), y[`system.weapons.${L}.itemId`] = "", y[`system.weapons.${L}.name`] = "", y[`system.weapons.${L}.damage`] = "", y[`system.weapons.${L}.bonus`] = "";
        }
      }
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${_}.bonus`]: ((O = n == null ? void 0 : n.system) == null ? void 0 : O.bonus) ?? ""
      ...
      v ? (q || (q = document.createElement("img"), q.className = "karakter-microchip-slot-thumb", q.alt = "", n == null || n.insertBefore(q, I)), q.src = v, q.style.display = "") : q && q.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const L = y ? this.actor.items.get(y) : null, O = {
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${_}.bonus`]: ((O = n.system) == null ? void 0 : O.bonus) ?? ""
        }), await n.update({ "system.equipped": !0 });
      } else if (I) {
        const _ = v.filter((S) => S !== I);
        await this.actor.update({
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const f of c) {
      ...
      foundry.utils.setProperty(e, `system.resources.healthStatus.${f}`, H._healthStatusFromRatio(i, h));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, a, d, c, u, g, m, f, h, i, r, o;
    if (e) {
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, q = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = q ? q.split(/\s*,\s*/).filter((S) => L.includes(S)) : [], _ = O.filter((S) => {
              var E;
              return (((E = I[S]) == null ? void 0 : E.itemId) ?? "").trim() === v;
            });
            if (_.length > 0) {
              const E = {
                "system.weapons.slotOrder": O.filter((M) => !_.includes(M)).join(",")
              };
              for (const M of _)
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((f = e.system) == null ? void 0 : f.kind) ?? "passive", a = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const u = c && c.name || t.name || `Fegyver (${s})`, g = Number(t.bonus || 0) || 0, f = (((v = c == null ? void 0 : c.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(a[f] || 0) || 0, i = g + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, n = new Roll(o);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], q = a.filter((k) => k.type === "MikroChip");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var y, b;
      i.preventDefault();
      const r = i.currentTarget, o = (((y = r == null ? void 0 : r.dataset) == null ? void 0 : y.skill) ?? "").trim(), n = ((b = r == null ? void 0 : r.textContent) == null ? void 0 : b.trim()) || o;
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-JeHULEbI.mjs");
      l(this.actor, o, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, n;
      i.preventDefault();
      ...
      const n = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, y = (Array.isArray((O = n[r]) == null ? void 0 : O.items) ? n[r].items.slice() : []).filter((_) => _ !== o);
  ...
  async _onDropItem(s, e) {
    var f, h, i, r, o, n, l, y, b, v, I, q, L, O, _;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((_ = (O = c.system) == null ? void 0 : O.gear) == null ? void 0 : _.microchips) ?? {}, M = ["slot1", "slot2", "slot3"].find((U) => {
        var B;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", a = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${u}
      ${g}
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const a of s.elements) {
      ...
      if (a.type === "checkbox") d = a.checked;
        ...
        if (a.value === "") continue;
        d = Number(a.value);
      } else if (a.name === "system.skills.quickThinking" || a.name === "system.skills.quickThinking2" || a.name === "system.skills.quickThinking3" || a.name === "system.resources.kp" || a.name === "system.resources.kp2" || a.name === "system.resources.kp3") {
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, g, m, f) => {
    ...
    for (const S of l)
      ((q = S.document) == null ? void 0 : q.id) !== h || ((L = S.document) == null ? void 0 : L.documentName) !== "Actor" || ((O = S.constructor) == null ? void 0 : O.name) !== "VoidKarakterSheet" || o.includes(S) || o.push(S);
    if (r && o.some((S) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    for (const i of t)
      try {
        const r = i.prototypeToken, o = ((u = r == null ? void 0 : r.bar1) == null ? void 0 : u.attribute) ?? "", n = ((g = r == null ? void 0 : r.bar2) == null ? void 0 : g.attribute) ?? "";
        (o || n) && await i.update({
...
//# sourceMappingURL=vacuum-of-the-void-ClJEGdfe.mjs.map
