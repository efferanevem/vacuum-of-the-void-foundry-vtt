...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((d = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : d.resources) ?? {}, o = ((m = (c = s.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : m.value) ?? 0, r = ((p = s.currentHealth) == null ? void 0 : p.legs) ?? 0, n = N._healthStatusFromRatio(r, o), u = Number(((S = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let f;
  ...
  async _prepareContext(i) {
    ...
    for (const l of n) {
      const I = ((Ne = o[l]) == null ? void 0 : Ne.value) ?? 0, w = r[l] ?? 0;
    ...
    const de = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).filter((l) => l.type === "MikroChip"), oe = de.map((l) => ({ id: l.id, name: l.name, img: l.img })), qe = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], me = (l) => {
      var w, T, D;
      const I = [];
    ...
    e.microchipItemsSlot1 = oe.filter((l) => !me(1).includes(l.id)), e.microchipItemsSlot2 = oe.filter((l) => !me(2).includes(l.id)), e.microchipItemsSlot3 = oe.filter((l) => !me(3).includes(l.id)), e.microchipSlots = _e.map((l) => {
    ...
    const Oe = this.actor.system.abilities ?? {}, vt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((l) => {
      var I, w, T;
      return {
        id: l.id,
        name: l.name,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (a) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-Ib5srRRC.mjs");
      m(this.actor, c);
    ...
    o && s({ currentTarget: o }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      a.preventDefault();
      const d = a.currentTarget, c = d.dataset.skill, m = ((g = d.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: p } = await import("./roll-sheet-Ib5srRRC.mjs");
      p(this.actor, c, m);
      ...
      if (m) {
        ...
        if (p && p.documentName === "Item" && (p.type === "Kepesseg" || p.type === "ability")) {
          ...
          if (((s = p.parent) == null ? void 0 : s.id) !== this.actor.id) {
            ...
            g = ((o = (await this.actor.createEmbeddedDocuments("Item", [P]))[0]) == null ? void 0 : o.id) ?? g;
          }
...
Hooks.on("preCreateToken", (F, i, e) => {
  ...
  !o || o.type !== "Karakter" || F.updateSource({
    ...t ? { actorId: t } : {},
    actorLink: !0
  });
});
...
Hooks.on("renderChatMessageHTML", (F, i, e) => {
  var o, r, n;
  const t = (r = (o = F.flags) == null ? void 0 : o["vacuum-of-the-void"]) == null ? void 0 : r.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-74CLDCSs.mjs.map
