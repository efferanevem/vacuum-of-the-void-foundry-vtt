...
const { HTMLField: Nt, NumberField: P, SchemaField: R, StringField: w, BooleanField: J, ArrayField: He } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const y of u) {
      const O = ((oe = d[y]) == null ? void 0 : oe.value) ?? 0, _ = c[y] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), D = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], C = (je = this.actor.system.gear) == null ? void 0 : je.microchips, q = C && typeof C == "object" && !Array.isArray(C) ? C : {}, T = (((Ke = q.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = q.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = q.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, O) => {
      ...
      let W = null;
      _ && (T === y.id ? W = "slot1" : S === y.id ? W = "slot2" : A === y.id && (W = "slot3"));
    ...
    e.weaponItems = ne;
    const Q = "— Nincs fegyver —", pe = D.filter((y) => {
      const _ = ((b[y] ?? {}).itemId ?? "").trim();
      return _ ? !!U.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = pe.map((y, O) => {
      const _ = b[y] ?? {}, L = (_.itemId ?? "").trim(), M = ne.find((Y) => Y.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: O + 1,
    ...
    e.microchipItemsSlot1 = fe.filter((y) => !Ie(1).includes(y.id)), e.microchipItemsSlot2 = fe.filter((y) => !Ie(2).includes(y.id)), e.microchipItemsSlot3 = fe.filter((y) => !Ie(3).includes(y.id)), e.microchipSlots = Oe.map((y) => {
      const O = q[y] ?? {}, _ = (O.itemId ?? "").trim(), L = we.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
      ...
      const O = `slot${y}`, _ = q[O] ?? {}, L = (_.itemId ?? "").trim(), M = fe.find((Y) => Y.id === L);
      ...
      const L = !!_, M = ((be = y == null ? void 0 : y.system) == null ? void 0 : be.abilityType) ?? "", Y = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", W = M === "active", Le = Number((ke = y == null ? void 0 : y.system) == null ? void 0 : ke.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, Z = (((de = y == null ? void 0 : y.system) == null ? void 0 : de.description) ?? "").trim(), he = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      ...
      const O = Ce[y] ?? {}, _ = (O.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", Y = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-CVPa1hOQ.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-CVPa1hOQ.mjs");
      l(this.actor, a, n);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = n.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = v ? v.split(/\s*,\s*/).filter((q) => I.includes(q)) : [], C = D.find((q) => {
          var T;
          return (((T = b[q]) == null ? void 0 : T.itemId) ?? "").trim() === a;
        });
        if (C) {
      ...
      v ? (D || (D = document.createElement("img"), D.className = "karakter-microchip-slot-thumb", D.alt = "", n == null || n.insertBefore(D, I)), D.src = v, D.style.display = "") : D && D.remove(), a == null || a.classList.remove("karakter-microchip-slot-open");
      ...
      const n = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, p = ["slot1", "slot2", "slot3"].find((I) => {
        var D;
        return (((D = n[I]) == null ? void 0 : D.itemId) ?? "").trim() === r;
      });
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CVPa1hOQ.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
      ...
      var b, v, I, D, C, q;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, a = (D = (I = i.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : D.itemId;
      if (!r || !a || !this.actor) return;
      const n = ((C = this.actor.system) == null ? void 0 : C.abilities) ?? {}, p = (Array.isArray((q = n[r]) == null ? void 0 : q.items) ? n[r].items.slice() : []).filter((T) => T !== a);
      ...
      if (!r || !this.actor) return;
      const a = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((D) => {
        var C;
        return (((C = a[D]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
  ...
  async _rollWeaponDamage(s, e = "") {
    var h, i, r, a, n, l, p, b, v, I, D;
    const t = this.actor;
    if (!t) return;
    const o = ((i = (h = t.items).get) == null ? void 0 : i.call(h, s)) ?? ((a = (r = t.items.contents) == null ? void 0 : r.find) == null ? void 0 : a.call(r, (C) => C.id === s));
    if (!o || o.type !== "Fegyver") return;
    let d = (((n = o.system) == null ? void 0 : n.damage) ?? "").trim();
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, a, n, l, p, b, v, I, D, C, q, T;
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = c.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), H = N ? N.split(/\s*,\s*/).filter((Q) => A.includes(Q)) : [];
      let U = A.find((Q) => {
        var pe;
      ...
      await c.update({
        ...
        [`system.weapons.${U}.damage`]: ((D = d.system) == null ? void 0 : D.damage) ?? "",
        [`system.weapons.${U}.bonus`]: ((C = d.system) == null ? void 0 : C.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const S = ((T = (q = c.system) == null ? void 0 : q.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((H) => {
        var U;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (u, f, m, g) => {
    ...
    for (const S of l)
      ((D = S.document) == null ? void 0 : D.id) !== h || ((C = S.document) == null ? void 0 : C.documentName) !== "Actor" || ((q = S.constructor) == null ? void 0 : q.name) !== "VoidKarakterSheet" || a.includes(S) || a.push(S);
    if (r && a.some((S) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var n, l, p, b, v, I, D, C, q, T, S, A, N, H;
    const t = (l = (n = e.target) == null ? void 0 : n.closest) == null ? void 0 : l.call(n, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    e.preventDefault(), e.stopPropagation();
    const o = (t.dataset.actorId ?? "").trim(), d = (t.dataset.itemId ?? "").trim(), c = (t.dataset.slotKey ?? "").trim(), u = (t.dataset.targetName ?? "").trim(), f = (t.dataset.hitLocationName ?? "").trim(), m = o ? (p = game.actors) == null ? void 0 : p.get(o) : null;
    if (!m) return;
    let g = d ? ((v = (b = m.items) == null ? void 0 : b.get) == null ? void 0 : v.call(b, d)) ?? ((C = (D = (I = m.items) == null ? void 0 : I.contents) == null ? void 0 : D.find) == null ? void 0 : C.call(D, (U) => U.id === d)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-BpnImD0-.mjs.map
