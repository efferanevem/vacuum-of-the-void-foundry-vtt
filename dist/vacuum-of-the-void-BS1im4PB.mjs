...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-LaBiD5Tx.mjs");
      r(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-LaBiD5Tx.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var b;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, r = ((b = c.textContent) == null ? void 0 : b.trim()) || l, { openRollSheetForSkill: g } = await import("./roll-sheet-LaBiD5Tx.mjs");
      g(this.actor, l, r);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (o) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-LaBiD5Tx.mjs");
      l(this.actor, c);
      ...
      if (o.preventDefault(), o.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-LaBiD5Tx.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-LaBiD5Tx.mjs");
      r(this.actor, c, l);
...
const Ie = class Ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if (p && (t.addEventListener(
      "dragover",
      (y) => {
        p.contains(y.target) && (y.preventDefault(), p.classList.add("karakter-ability-area-drag-over"));
      },
      !0
    ), t.addEventListener(
      "dragleave",
      (y) => {
        p.contains(y.target) && p.classList.remove("karakter-ability-area-drag-over");
      },
      !0
    ), t.addEventListener(
      "drop",
      (y) => {
        p.contains(y.target) && (y.preventDefault(), p.classList.remove("karakter-ability-area-drag-over"), console.log("VOTV JarmuEgysegSheet drop handler fired"), e._handleAbilityDrop(y));
      },
      !0
    )), !this.isEditable) return;
    const a = (y) => {
...
//# sourceMappingURL=vacuum-of-the-void-BS1im4PB.mjs.map
