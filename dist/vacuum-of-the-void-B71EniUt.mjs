...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((u = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : u.resources) ?? {}, p = ((o = (l = r.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : o.value) ?? 0, s = ((c = r.currentHealth) == null ? void 0 : c.legs) ?? 0, a = x._healthStatusFromRatio(s, p), f = Number(((I = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : I.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(i) {
    ...
    for (const d of a) {
      const S = ((Ne = p[d]) == null ? void 0 : Ne.value) ?? 0, w = s[d] ?? 0;
      e.computedHealthStatus[d] = x._healthStatusFromRatio(w, S);
    }
    ...
    for (const [d, S] of Object.entries(g)) {
      const w = e.computedHealthStatus[S];
      e.skillHealthStatus[d] = w, e.skillDisabled[d] = w === 0 ? " disabled" : "", e.skillHasHealthTint[d] = !0;
    }
    const b = this.actor.system.weapons ?? {}, I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], T = (b.slotOrder ?? "").trim(), O = T ? T.split(/\s*,\s*/).filter((d) => I.includes(d)) : [], C = (Me = this.actor.system.gear) == null ? void 0 : Me.microchips, D = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Ke = D.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), E = (((Ue = D.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), A = (((Be = D.slot3) == null ? void 0 : Be.itemId) ?? "").trim(), yt = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, S) => {
      const w = typeof d.sort == "number" ? d.sort : 0, _ = typeof S.sort == "number" ? S.sort : 0;
      return w - _;
    }).map((d) => {
      var J, ee, te, X, Z, ne;
      const S = d.type === "Fegyver", w = d.type === "MikroChip";
      let _ = 0, L = "", K = null;
      ...
      let j = null;
      w && (k === d.id ? j = "slot1" : E === d.id ? j = "slot2" : A === d.id && (j = "slot3"));
    ...
    e.weaponItems = Se;
    const Te = "— Nincs fegyver —", gt = O.filter((d) => {
      const w = ((b[d] ?? {}).itemId ?? "").trim();
      return w ? !!ue.find((L) => L.id === w) : !1;
    });
    e.weaponSlots = gt.map((d, S) => {
      const w = b[d] ?? {}, _ = (w.itemId ?? "").trim(), L = Se.find((K) => K.id === _);
      return {
        slotKey: d,
        itemId: _,
        slotNum: S + 1,
    ...
    e.weaponsTable = ue.map((d) => {
      ...
      const L = !!w, K = ((Xe = d.system) == null ? void 0 : Xe.equipped) !== void 0 && ((Ze = d.system) == null ? void 0 : Ze.equipped) !== null ? !!d.system.equipped : L, j = (d == null ? void 0 : d.system) ?? {}, re = typeof j.range == "string" ? (j.range || "").trim() : "", B = j.type ?? "", V = (ht[B] ?? B) || "—", J = j.size ?? "", ee = (bt[J] ?? J) || "", te = [V, ee].filter(Boolean).join(", ") || V || "—", X = B === "projectile" || J === "thrown", Z = j.quantity, ne = Z != null ? String(Z).trim() : "1", se = String(_.bonus ?? "").trim(), ae = String(j.bonus ?? "").trim(), Tt = se || ae || "0";
      return {
        slotKey: w ?? "",
        itemId: S,
    ...
    e.armorTable = vt.map((d) => {
      var _, L;
      const S = (d == null ? void 0 : d.system) ?? {}, w = ((_ = d.system) == null ? void 0 : _.equipped) !== void 0 && ((L = d.system) == null ? void 0 : L.equipped) !== null ? !!d.system.equipped : !1;
      return {
        itemId: d.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = kt.map((d) => {
      const S = (d == null ? void 0 : d.system) ?? {}, w = (S.description ?? "").trim(), _ = w ? w.length > 60 ? w.slice(0, 57) + "…" : w : "—", L = S.quantity != null ? String(S.quantity).trim() : "1";
      return {
        itemId: d.id,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    e.egyebList = wt.map((d) => {
      const w = (((d == null ? void 0 : d.system) ?? {}).description ?? "").trim(), _ = w ? w.length > 80 ? w.slice(0, 77) + "…" : w : "";
      return {
        itemId: d.id,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const de = (((Ye = this.actor.items) == null ? void 0 : Ye.contents) ?? []).filter((d) => d.type === "MikroChip"), oe = de.map((d) => ({ id: d.id, name: d.name, img: d.img })), _e = "— Nincs Mikro-Chip —", qe = ["slot1", "slot2", "slot3"], me = (d) => {
      var w, _, L;
      const S = [];
      return d !== 1 && S.push((((w = D.slot1) == null ? void 0 : w.itemId) ?? "").trim()), d !== 2 && S.push((((_ = D.slot2) == null ? void 0 : _.itemId) ?? "").trim()), d !== 3 && S.push((((L = D.slot3) == null ? void 0 : L.itemId) ?? "").trim()), S.filter(Boolean);
    };
    e.microchipItemsSlot1 = oe.filter((d) => !me(1).includes(d.id)), e.microchipItemsSlot2 = oe.filter((d) => !me(2).includes(d.id)), e.microchipItemsSlot3 = oe.filter((d) => !me(3).includes(d.id)), e.microchipSlots = qe.map((d) => {
      const S = D[d] ?? {}, w = (S.itemId ?? "").trim(), _ = de.find((L) => L.id === w);
      return {
        slotKey: d,
        itemId: w,
      ...
      const S = `slot${d}`, w = D[S] ?? {}, _ = (w.itemId ?? "").trim(), L = oe.find((K) => K.id === _);
      e[`microchip${d}ItemId`] = _, e[`microchip${d}DisplayName`] = (L == null ? void 0 : L.name) || w.name || _e, e[`microchip${d}Img`] = (L == null ? void 0 : L.img) || "";
    }), e.microchipsTable = de.map((d) => {
      var J, ee, te, X;
      const S = d.id;
      let w = null;
      for (const Z of qe)
        if ((((J = D[Z]) == null ? void 0 : J.itemId) ?? "").trim() === S) {
          w = Z;
          break;
        }
      const _ = !!w, L = ((ee = d == null ? void 0 : d.system) == null ? void 0 : ee.abilityType) ?? "", K = L === "active" ? "Aktív" : L === "passive" ? "Passzív" : L || "—", j = L === "active", re = Number((te = d == null ? void 0 : d.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(d.system.replaceCost) : 0, B = (((X = d == null ? void 0 : d.system) == null ? void 0 : X.description) ?? "").trim(), V = B ? B.length > 60 ? B.slice(0, 57) + "…" : B : "—";
      return {
        itemId: S,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const Oe = this.actor.system.abilities ?? {}, It = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((d) => {
      ...
      const S = Oe[d] ?? {}, w = (S.itemId ?? "").trim(), _ = w ? De.get(w) : null, L = (_ == null ? void 0 : _.description) ?? "", K = (_ == null ? void 0 : _.kp) ?? 0;
      return {
        itemId: w,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DmUdhPlP.mjs");
      o(this.actor, l);
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, l = u.dataset.skill, o = ((g = u.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: c } = await import("./roll-sheet-DmUdhPlP.mjs");
      c(this.actor, l, o);
      ...
      if (!o) return;
      const g = (((T = (((I = this.actor.system) == null ? void 0 : I.weapons) ?? {})[o]) == null ? void 0 : T.itemId) ?? "").trim();
      if (!g) return;
      const b = ((C = (O = this.actor.items).get) == null ? void 0 : C.call(O, g)) ?? ((k = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : k.call(D, (A) => A.id === g));
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      if ((c == null ? void 0 : c.type) === "Fegyver") {
        const b = o.system.weapons ?? {}, I = (b.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = I ? I.split(/\s*,\s*/).filter((D) => T.includes(D)) : [], C = O.find((D) => {
          var k;
          return (((k = b[D]) == null ? void 0 : k.itemId) ?? "").trim() === l;
        });
        if (C) {
          const D = O.filter((k) => k !== C);
          g["system.weapons.slotOrder"] = D.join(","), g[`system.weapons.${C}.itemId`] = "", g[`system.weapons.${C}.name`] = "", g[`system.weapons.${C}.damage`] = "", g[`system.weapons.${C}.bonus`] = "";
        }
      }
      ...
      const c = this.actor.system.weapons ?? {}, g = (c.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = g ? g.split(/\s*,\s*/).filter((k) => b.includes(k)) : [], T = I.find((k) => {
        var E;
      ...
      if (u.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${k}.bonus`]: ((D = o == null ? void 0 : o.system) == null ? void 0 : D.bonus) ?? ""
        }), await o.update({ "system.equipped": !0 });
      } else if (T) {
        const k = I.filter((E) => E !== T);
        await this.actor.update({
      ...
      if (!c) return;
      const g = (u.dataset.itemId ?? "").trim(), b = (u.dataset.itemName ?? ((k = u.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", I = (u.dataset.itemImg ?? "").trim(), T = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      T && (T.textContent = b);
      let O = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-thumb");
      I ? (O || (O = document.createElement("img"), O.className = "karakter-microchip-slot-thumb", O.alt = "", o == null || o.insertBefore(O, T)), O.src = I, O.style.display = "") : O && O.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
      const C = g ? this.actor.items.get(g) : null, D = {
        [`system.gear.microchips.${c}.itemId`]: g,
        [`system.gear.microchips.${c}.name`]: (C == null ? void 0 : C.name) ?? ""
      };
      g && (D[`system.gear.microchips.${c}.active`] = !0), await this.actor.update(D);
      ...
      const o = ((I = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : I.microchips) ?? {}, g = ["slot1", "slot2", "slot3"].find((T) => {
        var O;
        return (((O = o[T]) == null ? void 0 : O.itemId) ?? "").trim() === u;
      });
      ...
      if (!u || !l) return;
      const o = this.actor.system.abilities ?? {}, g = (Array.isArray((b = o[u]) == null ? void 0 : b.items) ? o[u].items.slice() : []).filter((I) => I !== l);
      ...
      if (u.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${k}.bonus`]: ((D = o.system) == null ? void 0 : D.bonus) ?? ""
        }), await o.update({ "system.equipped": !0 });
      } else if (T) {
        const k = I.filter((E) => E !== T);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (c && c.documentName === "Item" && (c.type === "Kepesseg" || c.type === "ability")) {
          ...
          const b = (((s = c.system) == null ? void 0 : s.kind) ?? "passive").toString(), I = this.actor.system.abilities ?? {};
          if (b === "species") {
            await this.actor.update({
          ...
          const T = b === "active" ? "active" : "passive", O = Array.isArray((a = I[T]) == null ? void 0 : a.items) ? I[T].items.slice() : Array.isArray(I[T]) ? I[T].slice() : [];
          O.includes(g) || O.push(g), await this.actor.update({ [`system.abilities.${T}.items`]: O });
          return;
        }
      }
    }
      ...
      if (o) {
        ...
        if (c && c.documentName === "Item" && c.type === "Fegyver") {
          ...
          if (b) {
            ...
            I = ((y = (await g.createEmbeddedDocuments("Item", [T]))[0]) == null ? void 0 : y.id) ?? I;
          }
          if (b) {
            const T = ((h = g.system) == null ? void 0 : h.weapons) ?? {}, O = (T.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = O ? O.split(/\s*,\s*/).filter((E) => C.includes(E)) : [], k = D.filter((E) => {
              var A;
              return (((A = T[E]) == null ? void 0 : A.itemId) ?? "").trim() === I;
            });
            if (k.length > 0) {
              const A = {
                "system.weapons.slotOrder": D.filter((R) => !k.includes(R)).join(",")
              };
              for (const R of k)
  ...
  async _rollSkill(i, e) {
    ...
    const { resultType: y, label: h } = st(m), n = h ? ` – ${h}` : "", u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${e}${n}`,
  ...
  async _rollWeapon(i) {
    var T;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, p = this.actor.items.filter((O) => O.type === "Fegyver");
    let s = null;
    t.itemId && (s = p.find((O) => O.id === t.itemId) ?? null);
    const a = s && s.name || t.name || `Fegyver (${i})`, f = Number(t.bonus || 0) || 0, y = (((T = s == null ? void 0 : s.system) == null ? void 0 : T.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = f + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, o = new Roll(l);
    await o.evaluate({ async: !0 });
    const { resultType: c, label: g } = st(o), b = g ? ` – ${g}` : "", I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${a} – találat${b}`,
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (s, a, f, m) => {
    ...
    if (!y) return;
    const h = document.activeElement, n = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), u = [], l = (I = game.actors) == null ? void 0 : I.get(y);
    l != null && l.apps && u.push(...Array.from(l.apps));
    const o = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const k of o)
      ((T = k.document) == null ? void 0 : T.id) !== y || ((O = k.document) == null ? void 0 : O.documentName) !== "Actor" || ((C = k.constructor) == null ? void 0 : C.name) !== "VoidKarakterSheet" || u.includes(k) || u.push(k);
    if (n && u.some((k) => {
      const E = (k == null ? void 0 : k.form) ?? (k == null ? void 0 : k.element);
      return E && E.contains(h);
    })) return;
    const g = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, b = g && Date.now() - g.at < F ? g.appId : null;
    setTimeout(() => {
      for (const k of u)
...
//# sourceMappingURL=vacuum-of-the-void-B71EniUt.mjs.map
