...
const E = class E extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((i = s.querySelector) == null ? void 0 : i.call(s, "form.votv.karakter-sheet")) ?? ((n = s.querySelector) == null ? void 0 : n.call(s, "form.votv")) ?? null, t = ((l = s.querySelector) == null ? void 0 : l.call(s, ".votv-scroll")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    const n = this.element, l = this.form ?? this.element;
    ...
    const g = this.element, h = this.form ?? this.element, w = d.scrollState, r = d.focus, a = typeof (w == null ? void 0 : w.formScrollTop) == "number" || typeof (w == null ? void 0 : w.windowScrollTop) == "number", o = () => {
      var m, f;
    ...
    return (a || r) && (requestAnimationFrame(o), setTimeout(o, 0), setTimeout(o, 50), setTimeout(o, 150), setTimeout(o, 300), setTimeout(o, 450)), p;
  }
  /**
  ...
  static _healthStatusFromRatio(s, e) {
    ...
    if (i <= 0 || t <= 0) return 0;
    const n = Math.floor(i / 3), l = Math.floor(2 * i / 3);
    return t <= n ? 1 : t <= l ? 2 : 3;
  }
  /** Kapott sebesség kijelzés: lábak állapotától 0 / -6 (kritikus) / -3 (sérült) / tárolt givenSpeed. Nincs kivonás. */
  _writeEffectiveGivenSpeed(s = null) {
    var h, w, r, a, o, c, m, f, k;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const i = ((r = (w = this.actor) == null ? void 0 : w.system) == null ? void 0 : r.resources) ?? {}, n = ((o = (a = i.hitLocations) == null ? void 0 : a.legs) == null ? void 0 : o.value) ?? 0, l = ((c = i.currentHealth) == null ? void 0 : c.legs) ?? 0, d = E._healthStatusFromRatio(l, n), p = Number(((k = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let g;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((l = this.actor.system) == null ? void 0 : l.resources) ?? {}, i = ((p = (d = t.hitLocations) == null ? void 0 : d[e]) == null ? void 0 : p.value) ?? 0, n = ((g = t.currentHealth) == null ? void 0 : g[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const i = ((d = s == null ? void 0 : s.system) == null ? void 0 : d.resources) ?? {}, n = ((g = (p = i.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : g.value) ?? 0, l = ((h = i.currentHealth) == null ? void 0 : h[t]) ?? 0;
    return E._healthStatusFromRatio(l, n);
  }
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const i = this.actor.system.resources ?? {}, n = i.hitLocations ?? {}, l = i.currentHealth ?? {}, d = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const u of d) {
      const v = ((_e = n[u]) == null ? void 0 : _e.value) ?? 0, q = l[u] ?? 0;
      e.computedHealthStatus[u] = E._healthStatusFromRatio(q, v);
    }
    const p = (Number(l.head) || 0) === 0, h = ["torso", "arms", "legs"].filter((u) => (Number(l[u]) || 0) === 0).length;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (r) => {
      ...
      const o = (r.currentTarget.dataset.slot ?? "").trim();
      if (!o) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-D1-gDQTe.mjs");
      c(this.actor, o);
      ...
      if (!o) {
        ...
        if (!k) return;
        o = (((((m = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : m.weapons) ?? {})[k] ?? {}).itemId ?? "").trim();
      }
      o && await this._rollWeaponDamage(o, ((f = a.dataset.slot) == null ? void 0 : f.trim()) ?? "");
    ...
    n && i({ currentTarget: n }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (r) => {
      ...
      var f;
      r.preventDefault();
      const a = r.currentTarget, o = a.dataset.skill, c = ((f = a.textContent) == null ? void 0 : f.trim()) || o, { openRollSheetForSkill: m } = await import("./roll-sheet-D1-gDQTe.mjs");
      m(this.actor, o, c);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      r.preventDefault(), l(r.currentTarget, r);
    }), t.on("click", ".karakter-inventory-item-icon", (r) => {
      r.preventDefault(), l(r.currentTarget, r);
    }), t.on("change", ".karakter-item-qty", async (r) => {
      const a = r.currentTarget, o = a.dataset.itemId;
      if (!o) return;
      const c = this.actor.items.get(o);
      if (!c) return;
      ...
      const o = r.currentTarget.dataset.itemId;
      if (!o) return;
      const c = this.actor, m = c.items.get(o), f = {};
      if ((m == null ? void 0 : m.type) === "Fegyver") {
        const k = c.system.weapons ?? {}, S = (k.slotOrder ?? "").trim(), O = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = S ? S.split(/\s*,\s*/).filter((_) => O.includes(_)) : [], A = F.find((_) => {
          var b;
          return (((b = k[_]) == null ? void 0 : b.itemId) ?? "").trim() === o;
        });
        if (A) {
      ...
      Object.keys(f).length && await c.update(f), await c.deleteEmbeddedDocuments("Item", [o]);
    }), t.on("change", ".karakter-weapon-equip-toggle", async (r) => {
      var A, _;
      const a = r.currentTarget, o = (a.dataset.itemId ?? "").trim();
      if (!o) return;
      const c = this.actor.items.get(o);
      ...
      const m = this.actor.system.weapons ?? {}, f = (m.slotOrder ?? "").trim(), k = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = f ? f.split(/\s*,\s*/).filter((b) => k.includes(b)) : [], O = S.find((b) => {
        var C;
        return (((C = m[b]) == null ? void 0 : C.itemId) ?? "").trim() === o;
      }) ?? null;
      if (a.checked) {
        if (O) return;
        let b = S.find((j) => {
      ...
      var b;
      r.preventDefault();
      const a = r.currentTarget, o = a.closest(".karakter-microchip-slot-select-wrap"), c = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), m = c == null ? void 0 : c.dataset.slot;
      if (!m) return;
      const f = (a.dataset.itemId ?? "").trim(), k = (a.dataset.itemName ?? ((b = a.textContent) == null ? void 0 : b.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (a.dataset.itemImg ?? "").trim(), O = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      O && (O.textContent = k);
      let F = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      S ? (F || (F = document.createElement("img"), F.className = "karakter-microchip-slot-thumb", F.alt = "", c == null || c.insertBefore(F, O)), F.src = S, F.style.display = "") : F && F.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      if (!a) return;
      const o = r.currentTarget.checked;
      this.actor.update({ [`system.gear.microchips.${a}.active`]: o });
      ...
      var k;
      if (r.preventDefault(), !r.altKey) return;
      const a = r.currentTarget.dataset.area, o = r.currentTarget.dataset.itemId;
      if (!a || !o) return;
      const c = this.actor.system.abilities ?? {}, f = (Array.isArray((k = c[a]) == null ? void 0 : k.items) ? c[a].items.slice() : []).filter((S) => S !== o);
      ...
      if (!o) return;
      const c = this.actor.items.get(o);
      !c || c.type !== "Pancél" && c.type !== "Pajzs" || await c.update({ "system.equipped": a.checked });
      ...
      !o || o.type !== "Pancél" && o.type !== "Pajzs" || await this.actor.deleteEmbeddedDocuments("Item", [a]);
    }), t.on("click", ".karakter-equipment-add-row", async (r) => {
      var o, c;
      if (r.preventDefault(), r.currentTarget.dataset.gearArray === "generalItems") {
        const m = Array.isArray((c = (o = this.actor.system) == null ? void 0 : o.gear) == null ? void 0 : c.generalItems) ? [...this.actor.system.gear.generalItems] : [];
      ...
      const o = Array.isArray((m = (c = this.actor.system) == null ? void 0 : c.gear) == null ? void 0 : m.generalItems) ? [...this.actor.system.gear.generalItems] : [];
      o.splice(a, 1), await this.actor.update({ "system.gear.generalItems": o });
    });
    const d = this, p = (r) => {
      var c, m, f, k;
      if (!r) return;
      ...
      const o = ((m = (c = a.system) == null ? void 0 : c.resources) == null ? void 0 : m.currentHealth) != null || ((k = (f = a.system) == null ? void 0 : f.resources) == null ? void 0 : k.hitLocations) != null;
      d.actor.update(a).then(() => {
        o && setTimeout(() => d.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, g = (r) => {
      var a, o, c;
      return r && (((o = (a = d.element) == null ? void 0 : a.contains) == null ? void 0 : o.call(a, r)) || d.id && ((c = r.closest) == null ? void 0 : c.call(r, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (r) => {
      const a = r.target;
      if (!a || !a.form) return;
  ...
  _getFormDataForUpdate(s) {
    ...
    ), i = t.hitLocations ?? {}, n = t.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    for (const h of l) {
    ...
    if (e) {
      ...
      if (r) {
        ...
        if (a && a.documentName === "Item" && (a.type === "Kepesseg" || a.type === "ability")) {
          ...
          const c = (((l = a.system) == null ? void 0 : l.kind) ?? "passive").toString(), m = this.actor.system.abilities ?? {};
          if (c === "species") {
            await this.actor.update({
    ...
    if (e) {
      ...
      if (r) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          const o = this.actor, c = ((g = a.parent) == null ? void 0 : g.id) !== o.id;
          let m = a.id;
          if (c) {
            const f = foundry.utils.mergeObject(a.toObject(), { system: { ...a.toObject().system ?? {}, equipped: !1 } });
            m = ((h = (await o.createEmbeddedDocuments("Item", [f]))[0]) == null ? void 0 : h.id) ?? m;
          }
          if (c) {
            const f = ((w = o.system) == null ? void 0 : w.weapons) ?? {}, k = (f.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], O = k ? k.split(/\s*,\s*/).filter((A) => S.includes(A)) : [], F = O.filter((A) => {
              var _;
  ...
  _onWeaponSlotDragOver(s, e) {
    var n, l, d;
    const t = ((n = s.dataTransfer) == null ? void 0 : n.getData("text/plain")) || ((l = s.dataTransfer) == null ? void 0 : l.getData("application/json")) || "";
    let i;
    try {
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const n = this.actor.items.contents.slice().sort((w, r) => {
      const a = typeof w.sort == "number" ? w.sort : 0, o = typeof r.sort == "number" ? r.sort : 0;
      return a - o;
    }).map((w) => w.id), l = n.indexOf(t), d = n.indexOf(e);
    if (l === -1 || d === -1) return;
    n.splice(l, 1), n.splice(d, 0, t);
    const p = n.map((w, r) => ({
      _id: w,
      sort: (r + 1) * 10
    }));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((h = e.system) == null ? void 0 : h.kind) ?? "passive", i = Number(((w = e.system) == null ? void 0 : w.kp) ?? 0) || 0, n = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", d = i > 0 ? `<p><strong>KP:</strong> ${i}</p>` : "", p = n ? `<p>${n}</p>` : "", g = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const l = this.actor.system.abilities ?? {}, d = Array.isArray((w = l[e]) == null ? void 0 : w.items) ? l[e].items.slice() : Array.isArray(l[e]) ? l[e].slice() : [];
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let l = n.id;
    ((h = n.parent) == null ? void 0 : h.id) !== this.actor.id && (l = ((w = (await this.actor.createEmbeddedDocuments("Item", [n.toObject()]))[0]) == null ? void 0 : w.id) ?? l), await this.actor.update({
  ...
  async _rollWeapon(s) {
    ...
    let l = null;
    t.itemId && (l = n.find((S) => S.id === t.itemId) ?? null);
    const d = l && l.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, h = (((k = l == null ? void 0 : l.system) == null ? void 0 : k.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", w = Number(i[h] || 0) || 0, r = p + w, o = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, c = new Roll(o);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!n && e && (n = (((((a = t.system) == null ? void 0 : a.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !n) {
      (f = (o = ui.notifications) == null ? void 0 : o.warn) == null || f.call(o, ((m = (c = game.i18n) == null ? void 0 : c.localize) == null ? void 0 : m.call(c, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const l = new Roll(n);
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const e = this, t = (n) => {
      ...
      var l, d, p;
      return n && (((d = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : d.call(l, n)) || e.id && ((p = n.closest) == null ? void 0 : p.call(n, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (n) => {
      var d, p, g;
      const l = ((d = n.target) == null ? void 0 : d.form) ?? ((g = (p = n.target) == null ? void 0 : p.closest) == null ? void 0 : g.call(p, "form"));
      i(l) && t(l);
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    const e = this, t = (n) => {
      if (!n) return;
      const l = e._getFormDataForUpdate(n);
      Object.keys(l).length !== 0 && e.document.update(l).catch((d) => console.warn("VoidShieldSheet save failed", d));
    }, i = (n) => {
      var l, d, p;
      return n && (((d = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : d.call(l, n)) || e.id && ((p = n.closest) == null ? void 0 : p.call(n, `#${CSS.escape(e.id)}`)));
    };
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (n) => {
      ...
      const d = (l == null ? void 0 : l.form) ?? ((p = l == null ? void 0 : l.closest) == null ? void 0 : p.call(l, "form"));
...
Hooks.once("init", () => {
  ...
  const N = 500;
  Hooks.on("updateActor", (l, d, p, g) => {
    var S, O, F, A, _;
    const h = l == null ? void 0 : l.id;
    if (!h) return;
    const w = document.activeElement, r = w && (w.tagName === "INPUT" && w.type !== "checkbox" && w.type !== "radio" || w.tagName === "TEXTAREA" || w.isContentEditable), a = [], o = (S = game.actors) == null ? void 0 : S.get(h);
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (N) => {
      ...
      const s = (d = (l = N.target) == null ? void 0 : l.closest) == null ? void 0 : d.call(l, "[data-document-id]"), e = (p = s == null ? void 0 : s.getAttribute) == null ? void 0 : p.call(s, "data-document-id");
      if (!e) return;
...
Hooks.on("renderChatMessageHTML", (N, s, e) => {
  var n, l, d;
  const t = (l = (n = N.flags) == null ? void 0 : n["vacuum-of-the-void"]) == null ? void 0 : l.resultType;
  if (!t) return;
...
//# sourceMappingURL=vacuum-of-the-void-dFJOTBlM.mjs.map
