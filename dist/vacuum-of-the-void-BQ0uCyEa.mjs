...
var Et = Reflect.get;
var Ft = (R, s, e) => s in R ? Pt(R, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : R[s] = e;
var z = (R, s, e) => Ft(R, typeof s != "symbol" ? s + "" : s, e);
var M = (R, s, e) => Et(At(R), e, s);
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const l = document.activeElement, y = n.contains(l), v = l && (l.tagName === "INPUT" && l.type !== "checkbox" && l.type !== "radio" || l.tagName === "TEXTAREA");
      y && v && (u.focus = {
        name: l.name || null,
        id: l.id || null,
    ...
    const m = this.element, f = this.form ?? this.element, h = u.scrollState, i = u.focus, a = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", c = () => {
      ...
      if (this._applyScrollState(m, h), (i == null ? void 0 : i.name) != null || (i == null ? void 0 : i.id) != null) {
        const v = ((l = f.querySelector) == null ? void 0 : l.call(f, i.id ? `#${CSS.escape(i.id)}` : null)) ?? (i.name ? (y = f.querySelector) == null ? void 0 : y.call(f, `[name="${CSS.escape(i.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, a, c, o, l, y, v, k;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const r = ((a = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, d = ((o = (c = r.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, n = ((l = r.currentHealth) == null ? void 0 : l.legs) ?? 0, u = U._healthStatusFromRatio(n, d), g = Number(((k = (v = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : v.combat) == null ? void 0 : k.givenSpeed) ?? 0) || 0;
    let m;
  ...
  async _prepareContext(s) {
    ...
    const v = this.actor.system.weapons ?? {}, k = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (v.slotOrder ?? "").trim(), q = S ? S.split(/\s*,\s*/).filter((p) => k.includes(p)) : [], C = (Se = this.actor.system.gear) == null ? void 0 : Se.microchips, D = C && typeof C == "object" && !Array.isArray(C) ? C : {}, w = (((Ze = D.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), L = (((Ve = D.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), E = (((et = D.slot3) == null ? void 0 : et.itemId) ?? "").trim(), B = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, O) => {
      ...
      for (let Te = 0; Te < q.length; Te++) {
        const Le = q[Te];
        if ((((ce = v[Le]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          _ = Te + 1, N = ((be = v[Le]) == null ? void 0 : be.bonus) ?? "", Y = Le;
          break;
        }
      }
      let W = null;
      T && (w === p.id ? W = "slot1" : L === p.id ? W = "slot2" : E === p.id && (W = "slot3"));
      const qe = O && ((ve = p.system) != null && ve.damage) ? p.system.damage : "", Z = O && typeof ((ue = p.system) == null ? void 0 : ue.range) == "string" ? (p.system.range || "").trim() : "", he = Y ? Number((de = v[Y]) == null ? void 0 : de.bonus) || 0 : "";
      return {
        id: p.id,
        name: p.name,
        img: p.img,
    ...
    e.weaponSlots = me.map((p, O) => {
      const T = v[p] ?? {}, _ = (T.itemId ?? "").trim(), N = ne.find((Y) => Y.id === _);
      return {
        slotKey: p,
        itemId: _,
        slotNum: O + 1,
    ...
    e.weaponsTable = H.map((p) => {
      ...
      let T = null, _ = {};
      for (const Ke of q)
        if ((((ot = v[Ke]) == null ? void 0 : ot.itemId) ?? "").trim() === O) {
          T = Ke, _ = v[Ke] ?? {};
          break;
        }
    ...
    const Ee = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((p) => p.type === "Pancel");
    e.armorTable = Ee.map((p) => {
      var _, N;
    ...
    const Fe = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((p) => p.type === "Targy");
    e.itemsTable = Fe.map((p) => {
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), pe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), Oe = "— Nincs Mikro-Chip —", De = ["slot1", "slot2", "slot3"], b = (p) => {
      var T, _, N;
      const O = [];
    ...
    e.microchipItemsSlot1 = pe.filter((p) => !b(1).includes(p.id)), e.microchipItemsSlot2 = pe.filter((p) => !b(2).includes(p.id)), e.microchipItemsSlot3 = pe.filter((p) => !b(3).includes(p.id)), e.microchipSlots = De.map((p) => {
    ...
    const A = this.actor.system.abilities ?? {}, F = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      var O, T, _;
      return {
        id: p.id,
        name: p.name,
    ...
    }), K = new Map(F.map((p) => [p.id, p])), fe = "— Nincs képesség —", G = (p) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-PjWTq67g.mjs");
      o(this.actor, c);
      ...
      if (!c) {
        ...
        if (!v) return;
        c = (((((l = (o = this.actor) == null ? void 0 : o.system) == null ? void 0 : l.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const a = i.currentTarget, c = a.dataset.skill, o = ((y = a.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-PjWTq67g.mjs");
      l(this.actor, c, o);
      ...
      if (!y) return;
      const v = ((C = (q = this.actor.items).get) == null ? void 0 : C.call(q, y)) ?? ((w = (D = this.actor.items.contents) == null ? void 0 : D.find) == null ? void 0 : w.call(D, (E) => E.id === y));
      (L = v == null ? void 0 : v.sheet) == null || L.render(!0);
    });
    const n = (i, a) => {
      var l;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const v = o.system.weapons ?? {}, k = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = k ? k.split(/\s*,\s*/).filter((D) => S.includes(D)) : [], C = q.find((D) => {
          var w;
          return (((w = v[D]) == null ? void 0 : w.itemId) ?? "").trim() === c;
        });
        if (C) {
      ...
      const l = this.actor.system.weapons ?? {}, y = (l.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], k = y ? y.split(/\s*,\s*/).filter((w) => v.includes(w)) : [], S = k.find((w) => {
        var L;
      ...
      if (a.checked) {
        ...
        let w = k.find((E) => {
          var j;
          return !((j = l[E]) != null && j.itemId);
        });
        const L = new Set(k);
        if (!w) {
          const E = v.find((j) => !L.has(j));
          if (!E) return;
          w = E, k.push(E);
        }
      ...
      if (!l) return;
      const y = (a.dataset.itemId ?? "").trim(), v = (a.dataset.itemName ?? ((w = a.textContent) == null ? void 0 : w.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", k = (a.dataset.itemImg ?? "").trim(), S = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      S && (S.textContent = v);
      ...
      const o = ((k = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : k.microchips) ?? {}, y = ["slot1", "slot2", "slot3"].find((S) => {
        var q;
      ...
      if (!a || !c) return;
      const o = this.actor.system.abilities ?? {}, y = (Array.isArray((v = o[a]) == null ? void 0 : v.items) ? o[a].items.slice() : []).filter((k) => k !== c);
      ...
      await o.update({ "system.quantity": l }), setTimeout(() => {
        const y = this.form ?? this.element, v = y == null ? void 0 : y.querySelector(`.karakter-weapon-quantity-input[data-item-id="${c}"]`);
      ...
      const l = (a.value ?? "").trim();
      await o.update({ "system.quantity": l }), setTimeout(() => {
        const y = this.form ?? this.element, v = y == null ? void 0 : y.querySelector(`.karakter-item-quantity-input[data-item-id="${c}"]`);
        v && this._resizeWeaponQuantityInput(v);
      }, 80);
    }), t.on("click", ".karakter-item-delete", async (i) => {
      if (i.preventDefault(), !i.altKey) return;
    ...
    const u = this, g = (i) => {
      ...
      const c = ((l = (o = a.system) == null ? void 0 : o.resources) == null ? void 0 : l.currentHealth) != null || ((v = (y = a.system) == null ? void 0 : y.resources) == null ? void 0 : v.hitLocations) != null;
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && (l.type === "Kepesseg" || l.type === "ability")) {
          ...
          const v = (((n = l.system) == null ? void 0 : n.kind) ?? "passive").toString(), k = this.actor.system.abilities ?? {};
          if (v === "species") {
            await this.actor.update({
          ...
          const S = v === "active" ? "active" : "passive", q = Array.isArray((u = k[S]) == null ? void 0 : u.items) ? k[S].items.slice() : Array.isArray(k[S]) ? k[S].slice() : [];
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          const y = this.actor, v = ((m = l.parent) == null ? void 0 : m.id) !== y.id;
          let k = l.id;
          if (v) {
          ...
          if (v) {
            const S = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, q = (S.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], D = q ? q.split(/\s*,\s*/).filter((L) => C.includes(L)) : [], w = D.filter((L) => {
              var E;
              return (((E = S[L]) == null ? void 0 : E.itemId) ?? "").trim() === k;
            });
            if (w.length > 0) {
              const E = {
        ...
        if (l && l.documentName === "Item" && l.type === "Pancel") {
          ...
          if (((i = l.parent) == null ? void 0 : i.id) !== y.id) {
            const v = foundry.utils.mergeObject(l.toObject(), { system: { ...l.toObject().system ?? {}, equipped: !1 } });
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: l, label: y } = ft(o), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${u} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    let r = ((m = (g = t.items).get) == null ? void 0 : m.call(g, s)) ?? ((h = (f = t.items.contents) == null ? void 0 : f.find) == null ? void 0 : h.call(f, (v) => v.id === s));
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Q, me, Pe, Ae, Ee, Fe, Ne, we, pe, Oe, De;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Q = this.actor) == null ? void 0 : Q.system), e.showDeathSkull = !1;
    const t = this.actor, r = ((me = t == null ? void 0 : t.items) == null ? void 0 : me.contents) ?? [], d = ((Pe = t == null ? void 0 : t.system) == null ? void 0 : Pe.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((b) => n.includes(b)) : [], m = r.filter((b) => b.type === "Fegyver"), f = m.map((b) => ({ id: b.id, name: b.name, img: b.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : n, a = n.filter((b) => !i.includes(b)), c = [...i, ...a], o = c.filter((b) => {
      var F;
      const A = (((F = d[b]) == null ? void 0 : F.itemId) ?? "").trim();
      return A && m.some((K) => K.id === A);
    });
    e.weaponSlots = o.map((b) => {
      const A = d[b] ?? {}, F = (A.itemId ?? "").trim(), K = f.find((fe) => fe.id === F);
      return {
        slotKey: b,
        itemId: F,
    ...
    e.weaponsTable = m.map((b) => {
      ...
      const fe = !!F, G = (b == null ? void 0 : b.system) ?? {}, Ie = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", le = (l[ae] ?? ae) || "—", oe = G.size ?? "", ye = (y[oe] ?? oe) || "", ge = [le, ye].filter(Boolean).join(", ") || le || "—", $e = ae === "projectile" || oe === "thrown", xe = G.quantity != null ? String(G.quantity).trim() : "1", je = String(K.bonus ?? G.bonus ?? "").trim() || "0";
      return {
        slotKey: F ?? "",
        itemId: A,
        actorId: t.id,
    ...
    e.armorTable = v.map((b) => {
      var K;
      const A = (b == null ? void 0 : b.system) ?? {}, F = ((K = b.system) == null ? void 0 : K.equipped) === !0;
      return {
        itemId: b.id,
        actorId: t.id,
    ...
    const k = ((Ee = (Ae = t == null ? void 0 : t.system) == null ? void 0 : Ae.gear) == null ? void 0 : Ee.microchips) ?? {}, S = ["slot1", "slot2", "slot3"], q = r.filter((b) => b.type === "MikroChip");
    e.microchipsTable = q.map((b) => {
      ...
      const K = ((le = b == null ? void 0 : b.system) == null ? void 0 : le.abilityType) ?? "", fe = K === "active" ? "Aktív" : K === "passive" ? "Passzív" : K || "—", G = (((oe = b == null ? void 0 : b.system) == null ? void 0 : oe.description) ?? "").trim(), Ie = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—";
      return {
        itemId: A,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const C = r.filter((b) => b.type === "Targy");
    e.itemsTable = C.map((b) => {
      const A = (b == null ? void 0 : b.system) ?? {}, F = (A.description ?? "").trim(), K = F ? F.length > 60 ? F.slice(0, 57) + "…" : F : "—";
      return {
        itemId: b.id,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const D = r.filter((b) => b.type === "Egyeb");
    e.egyebList = D.map((b) => {
      const F = (((b == null ? void 0 : b.system) ?? {}).description ?? "").trim(), K = F ? F.length > 80 ? F.slice(0, 77) + "…" : F : "";
      return {
        itemId: b.id,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const w = (((Fe = e.weaponsTable) == null ? void 0 : Fe.length) ?? 0) > 0 || (((Ne = e.armorTable) == null ? void 0 : Ne.length) ?? 0) > 0 || (((we = e.microchipsTable) == null ? void 0 : we.length) ?? 0) > 0 || (((pe = e.itemsTable) == null ? void 0 : pe.length) ?? 0) > 0 || (((Oe = e.egyebList) == null ? void 0 : Oe.length) ?? 0) > 0;
    e.showEquipmentDropZone = !w;
    const L = ((De = t == null ? void 0 : t.system) == null ? void 0 : De.abilities) ?? {}, E = r.filter((b) => b.type === "Kepesseg" || b.type === "ability").map((b) => {
      var A, F;
      return {
        id: b.id,
        name: b.name,
        img: b.img,
        description: ((A = b.system) == null ? void 0 : A.description) ?? "",
        kp: Number(((F = b.system) == null ? void 0 : F.kp) ?? 0) || 0
      };
    }), j = new Map(E.map((b) => [b.id, b])), B = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var l, y, v, k;
      i.preventDefault();
      const a = (y = (l = i.currentTarget) == null ? void 0 : l.closest) == null ? void 0 : y.call(l, ".karakter-weapon-slot"), c = (((v = a == null ? void 0 : a.dataset) == null ? void 0 : v.itemId) ?? "").trim();
      ...
      var v, k, S, q, C, D;
      if (i.preventDefault(), !i.altKey) return;
      const a = (k = (v = i.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : k.area, c = (q = (S = i.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : q.itemId;
      ...
      var v, k;
      if (i.preventDefault(), !i.altKey) return;
      const a = i.currentTarget, c = (((v = a == null ? void 0 : a.dataset) == null ? void 0 : v.itemId) ?? "").trim();
      if (!c || !this.actor) return;
      ...
      var y, v, k, S;
      if (i.preventDefault(), !i.altKey) return;
      const a = (((v = (y = i.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : v.itemId) ?? "").trim();
      if (!a || !this.actor) return;
    ...
    (h = (f = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : f.call(e, d)) == null || h.forEach((i) => {
      ...
      var y, v, k;
      const a = i.currentTarget, c = (v = (y = a == null ? void 0 : a.dataset) == null ? void 0 : y.itemId) == null ? void 0 : v.trim();
      if (!c || !this.actor) return;
      const o = this.actor.items.get(c);
      if (!o) return;
      const l = o.uuid;
  ...
  async _onDropItem(s, e) {
    var f, h, i, a, c, o, l, y, v, k, S, q, C, D, w;
    if (!this.actor) return (f = super._onDropItem) == null ? void 0 : f.call(this, s, e);
    const r = ((L) => {
      var j;
      if (!L) return null;
      const E = L.uuid ?? L.documentUuid ?? ((j = L.data) == null ? void 0 : j.uuid) ?? (typeof L == "string" ? L : null);
      if (E) return E;
      if (typeof L == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((o = d.system) == null ? void 0 : o.kind) ?? "passive").toString(), j = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, B = E === "active" ? "active" : "passive", H = Array.isArray((y = j[B]) == null ? void 0 : y.items) ? j[B].items.slice() : Array.isArray(j[B]) ? j[B].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const L = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (L.slotOrder ?? "").trim(), B = j ? j.split(/\s*,\s*/).filter((Q) => E.includes(Q)) : [];
      let H = E.find((Q) => {
        var me;
        return !(((me = L[Q]) == null ? void 0 : me.itemId) ?? "").trim();
      });
      H || (H = E.find((Q) => !B.includes(Q)) ?? "slot1");
      const ne = B.includes(H) ? B : [...B, H].filter((Q) => E.includes(Q));
      await n.update({
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, g, m) => {
    ...
    const y = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, v = y && Date.now() - y.at < R ? y.appId : null;
    setTimeout(() => {
      for (const w of a)
    ...
    for (const [l, y] of Object.entries(h)) {
      ...
      !v || v !== n.id || (i[`system.weapons.${l}.name`] = n.name ?? "", i[`system.weapons.${l}.damage`] = ((c = n.system) == null ? void 0 : c.damage) ?? "", i[`system.weapons.${l}.bonus`] = ((o = n.system) == null ? void 0 : o.bonus) ?? "");
    }
...
//# sourceMappingURL=vacuum-of-the-void-BQ0uCyEa.mjs.map
