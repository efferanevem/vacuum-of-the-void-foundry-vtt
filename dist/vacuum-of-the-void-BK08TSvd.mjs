...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BEpmvYrS.mjs");
      n(this.actor, c);
    ...
    a && r({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var f;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, n = ((f = o.textContent) == null ? void 0 : f.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-BEpmvYrS.mjs");
      m(this.actor, c, n);
...
//# sourceMappingURL=vacuum-of-the-void-BK08TSvd.mjs.map
