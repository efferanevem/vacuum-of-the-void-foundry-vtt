...
var si = Reflect.get;
var ii = (S, s, e) => s in S ? ei(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var ee = (S, s, e) => ii(S, typeof s != "symbol" ? s + "" : s, e);
var j = (S, s, e) => si(ti(S), e, s);
const { HTMLField: ni, NumberField: F, SchemaField: H, StringField: q, BooleanField: me, ArrayField: Dt } = foundry.data.fields;
...
const { NumberField: Mt, SchemaField: ai } = foundry.data.fields;
class ri extends xt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: oi, StringField: gs, NumberField: ci } = foundry.data.fields;
class li extends xt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { SchemaField: di, StringField: hs, NumberField: mi } = foundry.data.fields;
class pi extends xt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: fi, NumberField: Ai, StringField: Be } = foundry.data.fields;
...
const { NumberField: bi, StringField: ks } = foundry.data.fields;
...
const { NumberField: zt, StringField: lt, SchemaField: Ss, ArrayField: Ii } = foundry.data.fields;
...
const { NumberField: Ts, StringField: Ds, SchemaField: Ti, ArrayField: Di } = foundry.data.fields;
class _i extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Szint (0–3). */
      level: new Ts({ required: !0, integer: !0, min: 0, max: 3, initial: 0 }),
      /** Képességek: hivatkozott Képesség itemek UUID listája. */
      abilities: new Ti({
        items: new Di(
          new Ds({ required: !1, blank: !0 }),
          { required: !1, initial: [] }
        )
      }),
      /** Raktár (szabad szöveg, opcionális; a Bázis raktárkapacitás összegéhez). */
      storage: new Ds({ required: !1, blank: !0, initial: "" }),
      /** Veszély szint (%). */
      veszely: new Ts({ required: !1, integer: !1, min: 0, initial: 0 })
    };
  }
}
function Kt(S) {
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var dt, mt, pt, ft, yt, gt, ht, bt, vt, We, kt, wt, Je, I, E, P, G, ke, ae, Ce, De, we, $e, Ze, Ye, Nt, Ft, At, Et, It, ot, Qt, es, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms;
    ...
    const o = Number(((bt = (ht = this.actor.system) == null ? void 0 : ht.combat) == null ? void 0 : bt.givenProtection) ?? 0) || 0, m = (kt = (We = (vt = this.actor) == null ? void 0 : vt.statuses) == null ? void 0 : We.has) != null && kt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (wt = this.actor) == null ? void 0 : wt.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, g = (G = (P = (E = this.actor) == null ? void 0 : E.statuses) == null ? void 0 : P.has) != null && G.call(P, "threequarteredcover") ? 6 : 0, v = o + this._getTotalArmorProtectionBonus() + m + h + g;
    ...
    y === 0 && (T = 0), (De = (Ce = (ae = this.actor) == null ? void 0 : ae.statuses) == null ? void 0 : Ce.has) != null && De.call(Ce, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (O.slotOrder ?? "").trim(), z = M ? M.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Ze = this.actor.system.gear) == null ? void 0 : Ze.microchips, R = U && typeof U == "object" && !Array.isArray(U) ? U : {}, J = (((Ye = R.slot1) == null ? void 0 : Ye.itemId) ?? "").trim(), X = (((Nt = R.slot2) == null ? void 0 : Nt.itemId) ?? "").trim(), Z = (((Ft = R.slot3) == null ? void 0 : Ft.itemId) ?? "").trim(), K = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      const L = typeof b.sort == "number" ? b.sort : 0, A = typeof N.sort == "number" ? N.sort : 0;
      return L - A;
    }).map((b) => {
      var xe, Qe, et, Ke, Ue, St;
      const N = b.type === "Fegyver", L = b.type === "MikroChip";
      let A = 0, B = "", ue = null;
      for (let ct = 0; ct < z.length; ct++) {
        const Tt = z[ct];
        if ((((xe = O[Tt]) == null ? void 0 : xe.itemId) ?? "") === b.id) {
          A = ct + 1, B = ((Qe = O[Tt]) == null ? void 0 : Qe.bonus) ?? "", ue = Tt;
          break;
        }
      }
      let re = null;
      L && (J === b.id ? re = "slot1" : X === b.id ? re = "slot2" : Z === b.id && (re = "slot3"));
      const Xe = N && ((et = b.system) != null && et.damage) ? b.system.damage : "", Ie = N && typeof ((Ke = b.system) == null ? void 0 : Ke.range) == "string" ? (b.system.range || "").trim() : "", _e = ue ? Number((Ue = O[ue]) == null ? void 0 : Ue.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.weaponItems = oe;
    const ve = "— Nincs fegyver —", he = z.filter((b) => {
      const L = ((O[b] ?? {}).itemId ?? "").trim();
      return L ? !!V.find((B) => B.id === L) : !1;
    });
    e.weaponSlots = he.map((b, N) => {
      const L = O[b] ?? {}, A = (L.itemId ?? "").trim(), B = oe.find((_e) => _e.id === A), ue = V.find((_e) => _e.id === A), re = (ue == null ? void 0 : ue.system) ?? {}, Xe = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: N + 1,
    ...
    e.weaponsTable = V.map((b) => {
      ...
      let L = null, A = {};
      for (const Rt of z)
        if ((((ps = O[Rt]) == null ? void 0 : ps.itemId) ?? "").trim() === N) {
          L = Rt, A = O[Rt] ?? {};
          break;
        }
      const B = !!L, ue = ((fs = b.system) == null ? void 0 : fs.equipped) !== void 0 && ((ys = b.system) == null ? void 0 : ys.equipped) !== null ? !!b.system.equipped : B, re = (b == null ? void 0 : b.system) ?? {}, Xe = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", _e = (D[Ie] ?? Ie) || "—", xe = re.size ?? "", Qe = (x[xe] ?? xe) || "", et = [_e, Qe].filter(Boolean).join(", ") || _e || "—", Ke = Ie === "projectile" || xe === "thrown", Ue = re.quantity, St = Ue != null ? String(Ue).trim() : "1", ct = String(A.bonus ?? "").trim(), Tt = String(re.bonus ?? "").trim(), Qs = ct || Tt || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const te = (((It = this.actor.items) == null ? void 0 : It.contents) ?? []).filter((b) => b.type === "Targy");
    e.itemsTable = te.map((b) => {
    ...
    const ce = (((ot = this.actor.items) == null ? void 0 : ot.contents) ?? []).filter((b) => b.type === "Egyeb");
    e.egyebList = ce.map((b) => {
    ...
    const de = (((Qt = this.actor.items) == null ? void 0 : Qt.contents) ?? []).filter((b) => b.type === "MikroChip"), se = de.map((b) => ({ id: b.id, name: b.name, img: b.img })), be = "— Nincs Mikro-Chip —", le = ["slot1", "slot2", "slot3"], pe = (b) => {
      var L, A, B;
      const N = [];
    ...
    e.microchipItemsSlot1 = se.filter((b) => !pe(1).includes(b.id)), e.microchipItemsSlot2 = se.filter((b) => !pe(2).includes(b.id)), e.microchipItemsSlot3 = se.filter((b) => !pe(3).includes(b.id)), e.microchipSlots = le.map((b) => {
      const N = R[b] ?? {}, L = (N.itemId ?? "").trim(), A = de.find((B) => B.id === L);
      return {
        slotKey: b,
        itemId: L,
        displayName: (A == null ? void 0 : A.name) || N.name || be,
        img: (A == null ? void 0 : A.img) || "",
        active: N.active === !0
      };
    }), ["1", "2", "3"].forEach((b) => {
      const N = `slot${b}`, L = R[N] ?? {}, A = (L.itemId ?? "").trim(), B = se.find((ue) => ue.id === A);
      e[`microchip${b}ItemId`] = A, e[`microchip${b}DisplayName`] = (B == null ? void 0 : B.name) || L.name || be, e[`microchip${b}Img`] = (B == null ? void 0 : B.img) || "";
    }), e.microchipsTable = de.map((b) => {
      var xe, Qe, et, Ke;
      const N = b.id;
      let L = null;
      for (const Ue of le)
        if ((((xe = R[Ue]) == null ? void 0 : xe.itemId) ?? "").trim() === N) {
          L = Ue;
          break;
        }
      const A = !!L, B = ((Qe = b == null ? void 0 : b.system) == null ? void 0 : Qe.abilityType) ?? "", ue = B === "active" ? "Aktív" : B === "passive" ? "Passzív" : B || "—", re = B === "active", Xe = Number((et = b == null ? void 0 : b.system) == null ? void 0 : et.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, Ie = (((Ke = b == null ? void 0 : b.system) == null ? void 0 : Ke.description) ?? "").trim(), _e = Ie ? Ie.length > 60 ? Ie.slice(0, 57) + "…" : Ie : "—";
      return {
        itemId: N,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const st = (((es = e.weaponsTable) == null ? void 0 : es.length) ?? 0) > 0 || (((ts = e.armorTable) == null ? void 0 : ts.length) ?? 0) > 0 || (((ss = e.microchipsTable) == null ? void 0 : ss.length) ?? 0) > 0 || (((is = e.itemsTable) == null ? void 0 : is.length) ?? 0) > 0;
    e.showEquipmentDropZone = !st;
    const He = this.actor.system.abilities ?? {}, Ot = (((ns = this.actor.items) == null ? void 0 : ns.contents) ?? []).map((b) => {
      var N, L, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), Re = new Map(Ot.map((b) => [b.id, b])), Ge = "— Nincs képesség —", Me = (b) => {
      const N = He[b] ?? {}, L = (N.itemId ?? "").trim(), A = L ? Re.get(L) : null, B = (A == null ? void 0 : A.description) ?? "", ue = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: L,
    ...
    e.abilityPassiveList = it(je("passive")), e.abilityActiveList = it(je("active"));
    const nt = ((as = e.system) == null ? void 0 : as.resources) ?? {}, ie = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], fe = (os = (rs = e.system) == null ? void 0 : rs.combat) == null ? void 0 : os.initiativeResult, ne = typeof fe == "number" ? fe : -1, at = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (ls = (cs = e.system) == null ? void 0 : cs.combat) == null ? void 0 : ls.initiativeRanges, Oe = Array.isArray(Pe) ? Pe.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], ze = (Oe.length > 0 ? Oe : at).slice().sort((b, N) => b.min - N.min), Ve = Oe.map((b) => b.min), Ct = Ve.length ? Math.min(...Ve) : 0, qt = Ve.length ? Math.max(...Ve) : 0;
    e.initiativeRanges = Oe.map((b) => ({ ...b, isFirst: b.min === Ct, isLast: b.min === qt }));
    let ut = 0;
    if (typeof ne == "number" && ne >= 0 && ze.length > 0) {
      const b = ze[0], N = ze[ze.length - 1];
      let L = null;
      ne <= b.max ? L = b : ne >= N.min ? L = N : L = ze.find((A) => ne >= A.min && ne <= A.max), L && (ut = L.kp);
    }
    e.kpDots = ie.map((b, N) => {
      const L = N + 1, A = !!Number(nt[b]), B = L <= ut;
      return { index: L, used: A, usable: B };
    });
    const Lt = !!((ds = (us = game.combat) == null ? void 0 : us.combatants) != null && ds.some((b) => {
      var N;
      return ((N = b.actor) == null ? void 0 : N.type) === "Karakter";
    }));
    return e.showHarcSection = Lt, e.canEditInitiative = !!((ms = game.user) != null && ms.isGM), e.showInitiativeResult = typeof fe == "number", e.initiativeResult = e.showInitiativeResult ? fe : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-F4BrZyh2.mjs");
      m(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-F4BrZyh2.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: h } = await import("./roll-sheet-F4BrZyh2.mjs");
      h(this.actor, o, m);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: u, label: y } = Kt(c), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return c.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: g } = Kt(m), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${p} – találat`,
...
ee(Q, "PARTS", foundry.utils.mergeObject(
  j(Q, Q, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
  },
  { inplace: !1 }
)), ee(Q, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((_s = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : _s.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Os = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Os.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((qs = (Cs = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) == null ? void 0 : qs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Me, je, it, nt, ie, fe, ne, at, Pe, Oe, rt, ze, Ve, Ct, qt, ut, Lt, dt, mt, pt, ft, yt, gt, ht, bt, vt, We, kt, wt, Je;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Me = this.actor) == null ? void 0 : Me.system), e.showDeathSkull = !1, e.sizeForSelect = (((it = (je = e.system) == null ? void 0 : je.identity) == null ? void 0 : it.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((nt = e.system) == null ? void 0 : nt.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, l = (fe = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && fe.call(ie, "lookaround") ? 1 : 0, p = (at = (ne = t == null ? void 0 : t.statuses) == null ? void 0 : ne.has) != null && at.call(ne, "halfcover") ? 3 : 0, d = (Oe = (Pe = t == null ? void 0 : t.statuses) == null ? void 0 : Pe.has) != null && Oe.call(Pe, "threequarteredcover") ? 6 : 0;
    ...
    e.weaponSlots = k.map((I) => {
      const E = u[I] ?? {}, P = (E.itemId ?? "").trim(), G = o.find((we) => we.id === P), ke = r.find((we) => we.id === P), ae = (ke == null ? void 0 : ke.system) ?? {}, Ce = ae.size === "thrown", De = (typeof ae.range == "string" ? (ae.range || "").trim() : "") || "—";
      return {
        slotKey: I,
        itemId: P,
    ...
    e.weaponsTable = r.map((I) => {
      ...
      let P = null, G = {};
      for (const ot of v)
        if ((((It = u[ot]) == null ? void 0 : It.itemId) ?? "").trim() === E) {
          P = ot, G = u[ot] ?? {};
          break;
        }
      const ke = !!P, ae = (I == null ? void 0 : I.system) ?? {}, Ce = typeof ae.range == "string" ? (ae.range || "").trim() : "", De = ae.type ?? "", we = (w[De] ?? De) || "—", $e = ae.size ?? "", Ze = (T[$e] ?? $e) || "", Ye = [we, Ze].filter(Boolean).join(", ") || we || "—", Nt = De === "projectile" || $e === "thrown", Ft = ae.quantity != null ? String(ae.quantity).trim() : "1", At = String(ae.bonus ?? G.bonus ?? "").trim() || "0", Et = (ae.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: P ?? "",
        itemId: E,
        actorId: t.id,
    ...
    e.armorTable = _.map((I) => {
      ...
      return {
        ...
        level: Ci((E.level ?? "").toString().trim()),
        special: (E.special ?? E.other ?? "").toString().trim() || "—",
        equipped: P
      };
    });
    const O = ((Ct = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : Ct.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], M = c.filter((I) => I.type === "MikroChip");
    e.microchipsTable = M.map((I) => {
      var De, we, $e, Ze;
      const E = I.id;
      let P = null;
      for (const Ye of C)
        if ((((De = O[Ye]) == null ? void 0 : De.itemId) ?? "").trim() === E) {
          P = Ye;
          break;
        }
      const G = ((we = I == null ? void 0 : I.system) == null ? void 0 : we.abilityType) ?? "", ke = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ae = ((($e = I == null ? void 0 : I.system) == null ? void 0 : $e.description) ?? "").trim(), Ce = ae ? ae.length > 60 ? ae.slice(0, 57) + "…" : ae : "—";
      return {
        itemId: E,
        actorId: t.id,
        name: (I == null ? void 0 : I.name) ?? "—",
    ...
    const R = (((qt = e.weaponsTable) == null ? void 0 : qt.length) ?? 0) > 0 || (((ut = e.armorTable) == null ? void 0 : ut.length) ?? 0) > 0 || (((Lt = e.microchipsTable) == null ? void 0 : Lt.length) ?? 0) > 0 || (((dt = e.itemsTable) == null ? void 0 : dt.length) ?? 0) > 0 || (((mt = e.egyebList) == null ? void 0 : mt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !R;
    const J = ((pt = t == null ? void 0 : t.system) == null ? void 0 : pt.abilities) ?? {}, X = c.filter((I) => I.type === "Kepesseg" || I.type === "ability").map((I) => {
      var E, P, G;
      return {
        id: I.id,
        name: I.name,
    ...
    const oe = t == null ? void 0 : t.id, ve = !!((yt = (ft = game.combat) == null ? void 0 : ft.combatants) != null && yt.some(
      (I) => {
        var E;
        return (((E = I.actor) == null ? void 0 : E.id) ?? I.actorId) === oe;
      }
    ));
    e.showHarcSection = ve;
    const he = ((gt = e.system) == null ? void 0 : gt.resources) ?? {}, D = (bt = (ht = e.system) == null ? void 0 : ht.combat) == null ? void 0 : bt.initiativeResult, x = typeof D == "number" ? D : -1, W = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], te = (We = (vt = e.system) == null ? void 0 : vt.combat) == null ? void 0 : We.initiativeRanges, ce = Array.isArray(te) ? te.map((I) => ({ min: Number(I.min) ?? 0, max: Number(I.max) ?? 0, kp: Math.min(10, Math.max(0, Number(I.kp) ?? 0)) })) : [], se = (ce.length > 0 ? ce : W).slice().sort((I, E) => I.min - E.min), be = 3;
    let le = ce.length > 0 ? ce : [];
    le.length < be && (le = [...le, ...Array(be - le.length).fill({ min: 0, max: 0, kp: 0 })]), e.initiativeRanges = le.map((I, E) => ({
      ...I,
      isFirst: E === 0,
      isLast: E === le.length - 1
    }));
    let pe = 0;
    if (typeof x == "number" && x >= 0 && se.length > 0) {
      const I = se[0], E = se[se.length - 1];
      let P = null;
      x <= I.max ? P = I : x >= E.min ? P = E : P = se.find((G) => x >= G.min && x <= G.max), P && (pe = P.kp);
    }
    const st = se.length > 0 ? se[se.length - 1] : null, He = Math.min(10, st ? st.kp : 6), Re = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, He)).map((I, E) => {
      const P = E + 1, G = !!Number(he[I]), ke = P <= pe;
      return { index: P, used: G, usable: ke };
    }), Ge = Math.ceil(Re.length / 2);
    return e.kpDotsRow1 = Re.slice(0, Ge), e.kpDotsRow2 = Re.slice(Ge), e.canEditInitiative = !!((kt = game.user) != null && kt.isGM), e.showInitiativeResult = typeof D == "number", e.initiativeResult = e.showInitiativeResult ? D : "", e.speedUnitForSelect = ((Je = (wt = e.system) == null ? void 0 : wt.combat) == null ? void 0 : Je.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(s) {
    var c, u, y;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-F4BrZyh2.mjs");
      o(this.actor, r);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-F4BrZyh2.mjs");
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-F4BrZyh2.mjs");
      m(this.actor, r, o);
  ...
  async _onDropItem(s, e) {
    var u, y, a, i, r, o, m, h, g, v, k, w, T, _, O, C, M, z, U;
...
ee(ye, "PARTS", foundry.utils.mergeObject(
  j(ye, ye, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/npc-sheet.hbs" }
  },
  { inplace: !1 }
)), ee(ye, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ls = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ns = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((As = (Fs = j(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) == null ? void 0 : As.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var M, z, U, R, J, X, Z, Y, K, V, oe, ve, he;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = p.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, W = x.type ?? "", te = (n[W] ?? W) || "—", ce = x.size ?? "", de = (f[ce] ?? ce) || "", se = [te, de].filter(Boolean).join(", ") || te || "—", be = W === "projectile" || ce === "thrown", le = x.quantity != null ? String(x.quantity).trim() : "1", pe = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.armorTable = d.map((D) => {
      var te;
      const x = (D == null ? void 0 : D.system) ?? {}, W = !!((te = D.system) != null && te.equipped);
      return {
        itemId: D.id,
        actorId: this.actor.id,
        ...
        level: qi((x.level ?? "").toString().trim()),
    ...
    e.microchipsTable = c.map((D) => {
      var be, le, pe;
      const x = ((be = D == null ? void 0 : D.system) == null ? void 0 : be.abilityType) ?? "", W = x === "active" ? "Aktív" : x === "passive" ? "Passzív" : x || "—", te = x === "active", ce = Number((le = D == null ? void 0 : D.system) == null ? void 0 : le.replaceCost) >= 0 ? Number(D.system.replaceCost) : 0, de = (((pe = D == null ? void 0 : D.system) == null ? void 0 : pe.description) ?? "").trim(), se = de ? de.length > 60 ? de.slice(0, 57) + "…" : de : "—";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    e.itemsTable = u.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, W = (x.description ?? "").trim(), te = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—", ce = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    const y = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", a = (((X = this.actor.items) == null ? void 0 : X.contents) ?? []).filter((D) => D.type === y).sort((D, x) => {
      const W = typeof D.sort == "number" ? D.sort : 0, te = typeof x.sort == "number" ? x.sort : 0;
      return W - te;
    }), i = [];
    let r = 0, o = 0, m = 0;
    const h = Number(((Y = (Z = this.actor.system) == null ? void 0 : Z.vehicle) == null ? void 0 : Y.storage) ?? 0) || 0;
    for (const D of a) {
      const x = (D == null ? void 0 : D.system) ?? {}, W = x.health ?? {}, te = Number(x.level ?? 0) || 0, ce = Number(W.max ?? 0) || 0, de = Number(W.value ?? 0) || 0;
      let se;
      if (ce <= 0)
        se = void 0;
      else if (de <= 0)
        ...
        const ie = de / ce;
        ie > 2 / 3 ? se = 3 : ie > 1 / 3 ? se = 2 : se = 1;
      }
      const be = (x.hit ?? "").toString().trim(), le = (x.speed ?? "").toString().trim().replace(",", "."), pe = Number(le);
      Number.isFinite(pe) && (r += pe);
      const st = (x.range ?? "").toString().trim().replace(",", "."), He = Number(st);
      Number.isFinite(He) && (o += He);
      const Ot = (x.damage ?? "").toString().trim(), Re = (x.storage ?? "").toString().trim().replace(",", "."), Ge = Number(Re);
      Number.isFinite(Ge) && (m += Ge);
      const Me = x.abilities ?? {}, je = Array.isArray(Me.items) ? Me.items : [], nt = (await Promise.all(
        je.map(async (ie) => {
          var fe;
          if (!ie) return null;
          try {
            ...
            const ne = (fe = game.items) == null ? void 0 : fe.get(ie);
            if (ne && (ne.type === "Kepesseg" || ne.type === "ability")) return ne;
          }
          return null;
        })
      )).map((ie, fe) => ({ doc: ie, ref: je[fe] })).filter((ie) => !!ie.doc && !!ie.ref).map(({ doc: ie, ref: fe }) => {
        var Oe, rt;
        const ne = (((Oe = ie.system) == null ? void 0 : Oe.kind) ?? "passive").toString(), at = Number(((rt = ie.system) == null ? void 0 : rt.kp) ?? 0) || 0, Pe = ne === "species";
        return {
          id: ie.id,
          ref: fe,
          name: ie.name,
    ...
    e.unitsTable = i, e.totalStorageUsed = m, e.vehicleStorageMax = h, e.unitItemTypeLabel = this.actor.type === "Bazis" ? "Helyiség" : "Járműegység";
    const g = a.length;
    let v = "Kicsi", k = 0, w = 0;
    ...
    const O = (((K = e.weaponsTable) == null ? void 0 : K.length) ?? 0) > 0 || (((V = e.armorTable) == null ? void 0 : V.length) ?? 0) > 0 || (((oe = e.microchipsTable) == null ? void 0 : oe.length) ?? 0) > 0 || (((ve = e.itemsTable) == null ? void 0 : ve.length) ?? 0) > 0;
    ...
    return e.egyebList = C.map((D) => {
      const W = (((D == null ? void 0 : D.system) ?? {}).description ?? "").trim(), te = W ? W.length > 80 ? W.slice(0, 77) + "…" : W : "";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
...
ee(ge, "PARTS", foundry.utils.mergeObject(
  ...
  j(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Es = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ps = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((xs = ($s = j(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : $s.window) == null ? void 0 : xs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
ee(tt, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  j(tt, tt, "DEFAULT_OPTIONS"),
  {
    classes: ["vacuum-of-the-void", "sheet", "actor", "Bazis"],
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Rs = j(tt, tt, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Bt = tt;
...
ee(Se, "PARTS", foundry.utils.mergeObject(j(Se, Se, "PARTS") ?? {}, {
  ...
  j(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Hs = j(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Gs = j(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.dragDrop) ?? [],
      {
        dragSelector: null,
...
ee(Te, "PARTS", foundry.utils.mergeObject(j(Te, Te, "PARTS") ?? {}, {
  ...
  j(Te, Te, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Vs = j(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Ws = j(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = ri, CONFIG.Actor.dataModels.Npc = xt, CONFIG.Actor.dataModels.Jarmu = li, CONFIG.Actor.dataModels.Bazis = pi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = bs, CONFIG.Item.dataModels.weapon = bs, CONFIG.Item.dataModels.Pancel = gi, CONFIG.Item.dataModels.MikroChip = hi, CONFIG.Item.dataModels.Kepesseg = ws, CONFIG.Item.dataModels.ability = ws, CONFIG.Item.dataModels.Targy = vi, CONFIG.Item.dataModels.Egyeb = wi, CONFIG.Item.dataModels.Jarmuegyseg = Si, CONFIG.Item.dataModels.Helyiseg = _i, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (d, c, u, y) => {
    ...
    if ((d.type === "Karakter" || d.type === "Npc") && ((w = c == null ? void 0 : c.system) != null && w.combat) && "initiativeResult" in c.system.combat) {
      ...
      if (oe) {
        const ve = ((O = oe.combatants) == null ? void 0 : O.contents) ?? Array.from(oe.combatants ?? []);
        for (const he of ve)
    ...
    if (d.type === "Npc" && ((M = c == null ? void 0 : c.system) != null && M.identity) && "size" in c.system.identity) {
      const K = Zs((U = (z = d.system) == null ? void 0 : z.identity) == null ? void 0 : U.size);
      d.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, _, O, C, M, z, U, R, J, X, Z, Y, K, V, oe, ve, he, D;
    ...
    if (d || (d = ((M = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : M.flatMap((W) => {
      var te;
      return ((te = W.tokens) == null ? void 0 : te.contents) ?? [];
    }).map((W) => W.actor).find((W) => W && (W.id === p || W.id === l.actorId))) ?? null), !d) return;
    const c = l.itemId ? ((U = (z = d.items) == null ? void 0 : z.get) == null ? void 0 : U.call(z, l.itemId)) ?? ((X = (J = (R = d.items) == null ? void 0 : R.contents) == null ? void 0 : J.find) == null ? void 0 : X.call(J, (x) => x.id === l.itemId)) : null;
    ...
    if (u || (u = (((Z = c == null ? void 0 : c.system) == null ? void 0 : Z.damage) ?? "").trim()), !u && l.slotKey && (u = (((((Y = d.system) == null ? void 0 : Y.weapons) ?? {})[l.slotKey] ?? {}).damage ?? "").trim()), !u) {
      (ve = (K = ui.notifications) == null ? void 0 : K.warn) == null || ve.call(K, ((oe = (V = game.i18n) == null ? void 0 : V.localize) == null ? void 0 : oe.call(V, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const y = new Roll(u);
...
Hooks.on("combatRound", (S, s, e) => {
  (e == null ? void 0 : e.direction) <= 0 || Ys(S);
});
function Xs() {
  var s, e, t;
...
Hooks.on("updateCombat", (S, s, e) => {
  (s == null ? void 0 : s.round) != null && Ys(S), setTimeout(Xs, 0);
});
...
//# sourceMappingURL=vacuum-of-the-void-DlBEWqfJ.mjs.map
