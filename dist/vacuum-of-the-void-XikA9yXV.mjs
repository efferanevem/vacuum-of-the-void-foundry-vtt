...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-B1lAYHHF.mjs");
      m(this.actor, u);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-B1lAYHHF.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, u = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || u, { openRollSheetForSkill: h } = await import("./roll-sheet-B1lAYHHF.mjs");
      h(this.actor, u, m);
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-B1lAYHHF.mjs");
      u(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-B1lAYHHF.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-B1lAYHHF.mjs");
      m(this.actor, c, u);
...
X(he, "PARTS", foundry.utils.mergeObject(
  ...
  M(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((xs = M(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Rs = (zs = M(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : zs.window) == null ? void 0 : Rs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  M(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Ms = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((js = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : js.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Us = (Ks = M(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.window) == null ? void 0 : Us.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ve = class ve extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".vallalkozas-employee-add", async (l) => {
      ...
      if (l.preventDefault(), !this.actor) return;
      const o = (this.actor.system ?? {}).vallalkozas ?? {}, f = Array.isArray(o.militiaMissions) ? o.militiaMissions.slice() : [], r = Number(o.level ?? 1) || 1, i = Number(o.militiaPower ?? 0) || 0, c = Math.floor(Math.random() * 100) + 1, u = c * r, m = u - i;
      f.push({
        location: "",
        baseRoll: c,
        difficulty: u,
...
X(ve, "PARTS", foundry.utils.mergeObject(
  ...
  M(ve, ve, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 700,
    height: 600,
    form: foundry.utils.mergeObject(((Hs = M(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !0 }),
    window: foundry.utils.mergeObject(((Gs = M(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Vs = (Ws = M(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.window) == null ? void 0 : Vs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
//# sourceMappingURL=vacuum-of-the-void-XikA9yXV.mjs.map
