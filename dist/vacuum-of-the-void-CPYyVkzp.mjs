...
var X = (S, s, e) => yi(S, typeof s != "symbol" ? s + "" : s, e);
var j = (S, s, e) => fi(pi(S), e, s);
const { HTMLField: gi, NumberField: A, SchemaField: H, StringField: q, BooleanField: me, ArrayField: qt } = foundry.data.fields;
...
const { SchemaField: jt, StringField: ke, NumberField: ge, ArrayField: Vt } = foundry.data.fields;
class Mi extends Lt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  static getTotalSpeedRaw(s) {
    ...
    const e = s.system.resources ?? {}, t = ((y = (o = e.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : y.value) ?? 0, n = ((r = e.currentHealth) == null ? void 0 : r.legs) ?? 0, p = Q._healthStatusFromRatio(n, t);
    if (p === 0) return 0;
  ...
  async _prepareContext(s) {
    var yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et, T, z, M, G, Ie, ne, Le, Ce, Se, Re, tt, st, Et, $t, xt, zt, _t, dt, as, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs, bs, vs;
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (O.slotOrder ?? "").trim(), K = P ? P.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (tt = this.actor.system.gear) == null ? void 0 : tt.microchips, E = U && typeof U == "object" && !Array.isArray(U) ? U : {}, V = (((st = E.slot1) == null ? void 0 : st.itemId) ?? "").trim(), Z = (((Et = E.slot2) == null ? void 0 : Et.itemId) ?? "").trim(), J = ((($t = E.slot3) == null ? void 0 : $t.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      const N = typeof b.sort == "number" ? b.sort : 0, F = typeof L.sort == "number" ? L.sort : 0;
      return N - F;
    }).map((b) => {
      var je, nt, rt, We, Je, Ot;
      ...
      let ae = null;
      N && (V === b.id ? ae = "slot1" : Z === b.id ? ae = "slot2" : J === b.id && (ae = "slot3"));
      const it = L && ((rt = b.system) != null && rt.damage) ? b.system.damage : "", Te = L && typeof ((We = b.system) == null ? void 0 : We.range) == "string" ? (b.system.range || "").trim() : "", qe = ue ? Number((Je = O[ue]) == null ? void 0 : Je.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.microchipItemsSlot1 = re.filter((b) => !fe(1).includes(b.id)), e.microchipItemsSlot2 = re.filter((b) => !fe(2).includes(b.id)), e.microchipItemsSlot3 = re.filter((b) => !fe(3).includes(b.id)), e.microchipSlots = ce.map((b) => {
      ...
      const L = `slot${b}`, N = E[L] ?? {}, F = (N.itemId ?? "").trim(), B = re.find((ue) => ue.id === F);
    ...
    const ct = ((ms = e.system) == null ? void 0 : ms.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (fs = (ps = e.system) == null ? void 0 : ps.combat) == null ? void 0 : fs.initiativeResult, ie = typeof ye == "number" ? ye : -1, lt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Me = (gs = (ys = e.system) == null ? void 0 : ys.combat) == null ? void 0 : gs.initiativeRanges, Ne = Array.isArray(Me) ? Me.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ve = (Ne.length > 0 ? Ne : lt).slice().sort((b, L) => b.min - L.min), Xe = Ne.map((b) => b.min), At = Xe.length ? Math.min(...Xe) : 0, Ft = Xe.length ? Math.max(...Xe) : 0;
    e.initiativeRanges = Ne.map((b) => ({ ...b, isFirst: b.min === At, isLast: b.min === Ft }));
    let ft = 0;
    if (typeof ie == "number" && ie >= 0 && Ve.length > 0) {
      const b = Ve[0], L = Ve[Ve.length - 1];
      let N = null;
      ie <= b.max ? N = b : ie >= L.min ? N = L : N = Ve.find((F) => ie >= F.min && ie <= F.max), N && (ft = N.kp);
    }
    e.kpDots = ee.map((b, L) => {
    ...
    return e.showHarcSection = Pt, e.canEditInitiative = !!((vs = game.user) != null && vs.isGM), e.showInitiativeResult = typeof ye == "number", e.initiativeResult = e.showInitiativeResult ? ye : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DGluzeFW.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DGluzeFW.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-DGluzeFW.mjs");
      h(this.actor, l, m);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: o, label: y } = Wt(a), r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const f = d && d.name || t.name || `Fegyver (${s})`, u = Number(t.bonus || 0) || 0, a = ((w = d == null ? void 0 : d.system) == null ? void 0 : w.type) || "kinetic", o = (((k = d == null ? void 0 : d.system) == null ? void 0 : k.skillKey) ?? "").trim(), y = o && n[o] !== void 0 ? o : a === "explosive" ? "grenadeUse" : "firearms", r = Number(n[y] || 0) || 0, i = u + r, l = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, m = new Roll(l);
...
X(Q, "PARTS", foundry.utils.mergeObject(
  ...
  j(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Ps = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...(($s = (Es = j(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Es.window) == null ? void 0 : $s.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var He, Ye, Ge, ct, ee, ye, ie, lt, Me, Ne, ut, Ve, Xe, At, Ft, ft, Pt, yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et;
    ...
    const O = ((At = (Xe = t == null ? void 0 : t.system) == null ? void 0 : Xe.gear) == null ? void 0 : At.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], P = a.filter((T) => T.type === "MikroChip");
    ...
    const Oe = ((kt = e.system) == null ? void 0 : kt.resources) ?? {}, D = (It = (wt = e.system) == null ? void 0 : wt.combat) == null ? void 0 : It.initiativeResult, x = typeof D == "number" ? D : -1, W = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], se = (Qe = (St = e.system) == null ? void 0 : St.combat) == null ? void 0 : Qe.initiativeRanges, le = Array.isArray(se) ? se.map((T) => ({ min: Number(T.min) ?? 0, max: Number(T.max) ?? 0, kp: Math.min(10, Math.max(0, Number(T.kp) ?? 0)) })) : [], re = (le.length > 0 ? le : W).slice().sort((T, z) => T.min - z.min), we = 3;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-DGluzeFW.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DGluzeFW.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DGluzeFW.mjs");
      m(this.actor, c, l);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: g, label: v } = Wt(h), w = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return h.toMessage({
  ...
  async _onDropItem(s, e) {
    var o, y, r, i, c, l, m, h, g, v, w, k, I, _, O, C, P, K, U;
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var P, K, U, E, V, Z, J, Y, oe, R, te, de, Oe;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = f.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, W = x.type ?? "", se = (n[W] ?? W) || "—", le = x.size ?? "", pe = (p[le] ?? le) || "", re = [se, pe].filter(Boolean).join(", ") || se || "—", we = W === "projectile" || le === "thrown", ce = x.quantity != null ? String(x.quantity).trim() : "1", fe = (typeof x.range == "string" ? (x.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.armorTable = u.map((D) => {
      var se;
      const x = (D == null ? void 0 : D.system) ?? {}, W = !!((se = D.system) != null && se.equipped);
      return {
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = o.map((D) => {
      const x = (D == null ? void 0 : D.system) ?? {}, W = (x.description ?? "").trim(), se = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—", le = x.quantity != null ? String(x.quantity).trim() : "1";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    const y = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", r = (((Z = this.actor.items) == null ? void 0 : Z.contents) ?? []).filter((D) => D.type === y).sort((D, x) => {
      const W = typeof D.sort == "number" ? D.sort : 0, se = typeof x.sort == "number" ? x.sort : 0;
      return W - se;
    }), i = [];
    let c = 0, l = 0, m = 0;
    const h = Number(((Y = (J = this.actor.system) == null ? void 0 : J.vehicle) == null ? void 0 : Y.storage) ?? 0) || 0;
    for (const D of r) {
      const x = (D == null ? void 0 : D.system) ?? {}, W = Number(x.level ?? 0) || 0, se = (x.storage ?? "").toString().trim().replace(",", "."), le = Number(se);
...
const at = class at extends Kt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var O, C, P, K, U, E, V;
      const a = ((O = e.querySelector) == null ? void 0 : O.call(e, "form")) ?? e, o = (C = a.querySelector) == null ? void 0 : C.call(a, 'select[name="system.identity.assignment"]'), y = (P = a.querySelector) == null ? void 0 : P.call(a, 'select[name="system.identity.subAssignment"]'), r = (K = a.querySelector) == null ? void 0 : K.call(a, "input.bazis-threat-total"), i = (U = a.querySelector) == null ? void 0 : U.call(a, 'input[name="system.combat.threatBonus"]');
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (y == null ? void 0 : y.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((V = (E = this.actor) == null ? void 0 : E.items) == null ? void 0 : V.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", w = p[v] ?? 0, k = Number(i.value ?? 0) || 0, I = Ls(this.actor), _ = m + h + w + k + I;
      r.value = _;
    };
...
const ve = class ve extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const p = {
      ...
      heavy: "Nehéz",
      thrown: "Dobható"
    }, f = "— Nincs fegyver —", u = ((m = t.items) == null ? void 0 : m.contents) ?? [], a = u.filter((k) => k.type === "Fegyver");
    e.weaponsTable = a.map((k) => {
      const I = k.system ?? {}, _ = I.type ?? "", O = (p[_] ?? _) || "—", C = I.size ?? "", P = (d[C] ?? C) || "", K = [O, P].filter(Boolean).join(", ") || O || "—", U = _ === "projectile" || C === "thrown", E = I.quantity != null ? String(I.quantity).trim() : "1", V = (typeof I.range == "string" ? (I.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: t.id,
    ...
    e.microchipsTable = y.map((k) => {
      var U, E, V;
      const I = ((U = k.system) == null ? void 0 : U.abilityType) ?? "", _ = I === "active" ? "Aktív" : I === "passive" ? "Passzív" : I || "—", O = I === "active", C = Number((E = k.system) == null ? void 0 : E.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0, P = (((V = k.system) == null ? void 0 : V.description) ?? "").trim(), K = P ? P.length > 60 ? `${P.slice(0, 57)}…` : P : "—";
      return {
        itemId: k.id,
        actorId: t.id,
        name: k.name ?? "—",
...
X(ve, "PARTS", foundry.utils.mergeObject(
  ...
  j(ve, ve, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((Vs = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Js = (Ws = j(ve, ve, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.window) == null ? void 0 : Js.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
X(Pe, "PARTS", foundry.utils.mergeObject(j(Pe, Pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xs = j(Pe, Pe, "DEFAULT_OPTIONS")) == null ? void 0 : Xs.form) ?? {}, { submitOnChange: !1 })
}));
let es = Pe;
var Qs;
...
X(Ee, "PARTS", foundry.utils.mergeObject(j(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Qs = j(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Qs.form) ?? {}, { submitOnChange: !0 })
}));
let ts = Ee;
var ei;
...
Hooks.once("init", () => {
  ...
  const e = 500;
  Hooks.on("updateActor", (a, o, y, r) => {
    var I, _, O, C, P, K, U, E, V, Z, J, Y, oe;
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const R = oi((E = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : E.size);
      a.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, w, k, I, _, O, C, P, K, U, E, V, Z, J, Y, oe, R, te, de, Oe, D;
    ...
    if (u || (u = ((P = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : P.flatMap((W) => {
      var se;
      return ((se = W.tokens) == null ? void 0 : se.contents) ?? [];
    }).map((W) => W.actor).find((W) => W && (W.id === f || W.id === d.actorId))) ?? null), !u) return;
    const a = d.itemId ? ((U = (K = u.items) == null ? void 0 : K.get) == null ? void 0 : U.call(K, d.itemId)) ?? ((Z = (V = (E = u.items) == null ? void 0 : E.contents) == null ? void 0 : V.find) == null ? void 0 : Z.call(V, (x) => x.id === d.itemId)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-CPYyVkzp.mjs.map
