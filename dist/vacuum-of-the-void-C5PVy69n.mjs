...
function xt(I) {
  ...
  p(I.terms, 1);
  const c = s.filter((l) => l === 6).length, u = s.filter((l) => l === 1).length, m = e.filter((l) => l === 6).length, d = t.filter((l) => l === 6).length, f = c + m, g = u + d;
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((n = s.querySelector) == null ? void 0 : n.call(s, "form.votv.karakter-sheet")) ?? ((p = s.querySelector) == null ? void 0 : p.call(s, "form.votv")) ?? null, t = ((c = s.querySelector) == null ? void 0 : c.call(s, ".votv-scroll")) ?? ((u = s.querySelector) == null ? void 0 : u.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    const p = this.element, c = this.form ?? this.element;
    let u = { scrollState: {}, focus: null };
    if (p) {
      u.scrollState = this._saveScrollState(p);
      const r = document.activeElement, y = c.contains(r), h = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA");
      y && h && (u.focus = {
        name: r.name || null,
        id: r.id || null,
  ...
  static _healthStatusFromRatio(s, e) {
    ...
    if (n <= 0 || t <= 0) return 0;
    const p = Math.floor(n / 3), c = Math.floor(2 * n / 3);
    return t <= p ? 1 : t <= c ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const c of s) {
      const u = String(((p = c.system) == null ? void 0 : p.speedPenalty) ?? "").trim().replace(",", "."), m = Number(u);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const c of s) {
      const u = String(((p = c.system) == null ? void 0 : p.protectionBonus) ?? "").trim().replace(",", "."), m = Number(u);
      Number.isFinite(m) && (e += m);
    }
    return e;
  }
  ...
  static getTotalSpeedRaw(s) {
    ...
    let u;
    p === 1 ? u = -6 : p === 2 ? u = -3 : u = c, u += V._getTotalArmorSpeedPenaltyStatic(s);
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((r = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : r.resources) ?? {}, p = ((h = (y = n.hitLocations) == null ? void 0 : y.legs) == null ? void 0 : h.value) ?? 0, c = ((k = n.currentHealth) == null ? void 0 : k.legs) ?? 0, u = V._healthStatusFromRatio(c, p), m = Number(((D = (T = (S = this.actor) == null ? void 0 : S.system) == null ? void 0 : T.combat) == null ? void 0 : D.givenSpeed) ?? 0) || 0;
    let d;
  ...
  _writeEffectiveGivenProtection(s = null) {
    var d, f, g, l, i, o, a, r, y, h, k, S, T;
    const e = s ?? this.form ?? this.element;
    let t = (d = e == null ? void 0 : e.querySelector) == null ? void 0 : d.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((l = (g = (f = this.actor) == null ? void 0 : f.system) == null ? void 0 : g.combat) == null ? void 0 : l.givenProtection) ?? 0) || 0, p = (a = (o = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : o.has) != null && a.call(o, "lookaround") ? 1 : 0, c = (h = (y = (r = this.actor) == null ? void 0 : r.statuses) == null ? void 0 : y.has) != null && h.call(y, "halfcover") ? 3 : 0, u = (T = (S = (k = this.actor) == null ? void 0 : k.statuses) == null ? void 0 : S.has) != null && T.call(S, "threequarteredcover") ? 6 : 0, m = n + this._getTotalArmorProtectionBonus() + p + c + u;
  ...
  _writeTotalDefense(s = null) {
    ...
    }, n = t(".karakter-total-defense-effective"), p = t(".karakter-given-defense-effective"), c = t('input[name="system.combat.defense"]'), u = t('input[name="system.combat.defenseBonus"]');
    if (!n) return;
    const m = Number(c == null ? void 0 : c.value) || 0, d = Number(u == null ? void 0 : u.value) || 0, f = Number(p == null ? void 0 : p.textContent) || 0;
  ...
  _writeTotalSpeed(s = null) {
    ...
    }, n = t(".karakter-total-speed-effective"), p = t(".karakter-given-speed-effective"), c = t('input[name="system.combat.speed"]'), u = t('input[name="system.combat.speedBonus"]');
    if (!n) return;
    ...
    const l = Number(c == null ? void 0 : c.value) || 0, i = Number(u == null ? void 0 : u.value) || 0, o = Number(p == null ? void 0 : p.textContent) || 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, n = ((m = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : m.value) ?? 0, p = ((d = t.currentHealth) == null ? void 0 : d[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, p = ((d = (m = n.hitLocations) == null ? void 0 : m[t]) == null ? void 0 : d.value) ?? 0, c = ((f = n.currentHealth) == null ? void 0 : f[t]) ?? 0;
    return V._healthStatusFromRatio(c, p);
  }
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, p = n.hitLocations ?? {}, c = n.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const b of u) {
      const A = ((nt = p[b]) == null ? void 0 : nt.value) ?? 0, N = c[b] ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-D3Rp-e38.mjs");
      r(this.actor, a);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-D3Rp-e38.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, a = o.dataset.skill, r = ((h = o.textContent) == null ? void 0 : h.trim()) || a, { openRollSheetForSkill: y } = await import("./roll-sheet-D3Rp-e38.mjs");
      y(this.actor, a, r);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var v;
      i.preventDefault();
      const o = i.currentTarget, a = o.closest(".karakter-microchip-slot-select-wrap"), r = a == null ? void 0 : a.querySelector(".karakter-microchip-slot-display"), y = r == null ? void 0 : r.dataset.slot;
      if (!y) return;
      const h = (o.dataset.itemId ?? "").trim(), k = (o.dataset.itemName ?? ((v = o.textContent) == null ? void 0 : v.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (o.dataset.itemImg ?? "").trim(), T = a == null ? void 0 : a.querySelector(".karakter-microchip-slot-display-text");
      T && (T.textContent = k);
      ...
      if (!o || !a) return;
      const r = this.actor.system.abilities ?? {}, h = (Array.isArray((k = r[o]) == null ? void 0 : k.items) ? r[o].items.slice() : []).filter((S) => S !== a);
    ...
    const m = this, d = (i) => {
      ...
      const a = ((y = (r = o.system) == null ? void 0 : r.resources) == null ? void 0 : y.currentHealth) != null || ((k = (h = o.system) == null ? void 0 : h.resources) == null ? void 0 : k.hitLocations) != null;
      m.actor.update(o).then(() => {
        a && setTimeout(() => m.render(!0), 260);
      }).catch((S) => console.warn("VoidKarakterSheet save failed", S));
    }, f = (i) => {
      var o, a, r;
      return i && (((a = (o = m.element) == null ? void 0 : o.contains) == null ? void 0 : a.call(o, i)) || m.id && ((r = i.closest) == null ? void 0 : r.call(i, `#${CSS.escape(m.id)}`)));
    };
    m._votvBlur = (i) => {
      var h;
      const o = i.target;
  ...
  _getFormDataForUpdate(s) {
    ...
    ), n = t.hitLocations ?? {}, p = t.currentHealth ?? {}, c = ["head", "torso", "arms", "legs"];
    for (const f of c) {
    ...
    if (e) {
      ...
      if (a) {
        ...
        if (r && r.documentName === "Item" && (r.type === "Kepesseg" || r.type === "ability")) {
          ...
          const h = (((c = r.system) == null ? void 0 : c.kind) ?? "passive").toString(), k = this.actor.system.abilities ?? {};
          if (h === "species") {
            await this.actor.update({
  ...
  _onWeaponSlotDragOver(s, e) {
    var p, c, u;
    const t = ((p = s.dataTransfer) == null ? void 0 : p.getData("text/plain")) || ((c = s.dataTransfer) == null ? void 0 : c.getData("application/json")) || "";
    let n;
    try {
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const p = this.actor.items.contents.slice().sort((g, l) => {
      ...
      return i - o;
    }).map((g) => g.id), c = p.indexOf(t), u = p.indexOf(e);
    if (c === -1 || u === -1) return;
    p.splice(c, 1), p.splice(u, 0, t);
    const m = p.map((g, l) => ({
      _id: g,
      sort: (l + 1) * 10
    }));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((f = e.system) == null ? void 0 : f.kind) ?? "passive", n = Number(((g = e.system) == null ? void 0 : g.kp) ?? 0) || 0, p = (((l = e.system) == null ? void 0 : l.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = p ? `<p>${p}</p>` : "", d = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const c = this.actor.system.abilities ?? {}, u = Array.isArray((g = c[e]) == null ? void 0 : g.items) ? c[e].items.slice() : Array.isArray(c[e]) ? c[e].slice() : [];
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let c = p.id;
    ((f = p.parent) == null ? void 0 : f.id) !== this.actor.id && (c = ((g = (await this.actor.createEmbeddedDocuments("Item", [p.toObject()]))[0]) == null ? void 0 : g.id) ?? c), await this.actor.update({
  ...
  async _rollWeapon(s) {
    ...
    let c = null;
    t.itemId && (c = p.find((D) => D.id === t.itemId) ?? null);
    const u = c && c.name || t.name || `Fegyver (${s})`, m = Number(t.bonus || 0) || 0, d = ((S = c == null ? void 0 : c.system) == null ? void 0 : S.type) || "kinetic", f = (((T = c == null ? void 0 : c.system) == null ? void 0 : T.skillKey) ?? "").trim(), g = f && n[f] !== void 0 ? f : d === "explosive" ? "grenadeUse" : "firearms", l = Number(n[g] || 0) || 0, i = m + l, a = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, r = new Roll(a);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!p && e && (p = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !p) {
      (y = (o = ui.notifications) == null ? void 0 : o.warn) == null || y.call(o, ((r = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : r.call(a, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const c = new Roll(p);
...
const se = class se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = await super.render(s, e), u = this.element, m = this.form ?? this.element, d = p.scrollState, f = p.focus, g = typeof (d == null ? void 0 : d.formScrollTop) == "number" || typeof (d == null ? void 0 : d.windowScrollTop) == "number", l = () => {
      var i, o;
      if (this._applyScrollState(u, d), (f == null ? void 0 : f.name) != null || (f == null ? void 0 : f.id) != null) {
        const a = ((i = m.querySelector) == null ? void 0 : i.call(m, f.id ? `#${CSS.escape(f.id)}` : null)) ?? (f.name ? (o = m.querySelector) == null ? void 0 : o.call(m, `[name="${CSS.escape(f.name)}"]`) : null);
    ...
    return (g || f) && (requestAnimationFrame(l), setTimeout(l, 0), setTimeout(l, 50), setTimeout(l, 150), setTimeout(l, 300), setTimeout(l, 450)), c;
  }
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((It = e.system) == null ? void 0 : It.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, c = (Fe = (Ve = t == null ? void 0 : t.statuses) == null ? void 0 : Ve.has) != null && Fe.call(Ve, "lookaround") ? 1 : 0, u = (St = (me = t == null ? void 0 : t.statuses) == null ? void 0 : me.has) != null && St.call(me, "halfcover") ? 3 : 0, m = (Pe = (Ee = t == null ? void 0 : t.statuses) == null ? void 0 : Ee.has) != null && Pe.call(Ee, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = p + c + u + m;
    const d = ((At = t == null ? void 0 : t.items) == null ? void 0 : At.contents) ?? [], f = ((Ce = t == null ? void 0 : t.system) == null ? void 0 : Ce.weapons) ?? {}, g = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (f.slotOrder ?? "").trim(), i = l ? l.split(/\s*,\s*/).filter((w) => g.includes(w)) : [], o = d.filter((w) => w.type === "Fegyver"), a = o.map((w) => ({ id: w.id, name: w.name, img: w.img })), r = "— Nincs fegyver —", y = i.length > 0 ? i : g, h = g.filter((w) => !y.includes(w)), k = [...y, ...h], S = k.filter((w) => {
      var x;
      const P = (((x = f[w]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && o.some((B) => B.id === P);
    });
    e.weaponSlots = S.map((w) => {
      const P = f[w] ?? {}, x = (P.itemId ?? "").trim(), B = a.find((ce) => ce.id === x), oe = o.find((ce) => ce.id === x), X = (oe == null ? void 0 : oe.system) ?? {}, ge = X.size === "thrown", pe = (typeof X.range == "string" ? (X.range || "").trim() : "") || "—";
      return {
        slotKey: w,
        itemId: x,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-D3Rp-e38.mjs");
      a(this.actor, o);
      ...
      !o && ((r = i == null ? void 0 : i.dataset) != null && r.slot) && (o = (((((h = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : h.weapons) ?? {})[i.dataset.slot] ?? {}).itemId ?? "").trim()), !(!o || !this.actor) && await this._rollWeaponDamage(o, (((k = i == null ? void 0 : i.dataset) == null ? void 0 : k.slot) ?? "").trim());
    }), t.on("click", ".karakter-harc-initiative", async (l) => {
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D3Rp-e38.mjs");
      ...
      const a = !!Number((y = (r = this.actor.system) == null ? void 0 : r.resources) == null ? void 0 : y[`kpDot${o}`]);
      await this.actor.update({ [`system.resources.kpDot${o}`]: a ? 0 : 1 });
    }), t.on("click", ".karakter-skill-label", async (l) => {
      var y, h;
      l.preventDefault();
      const i = l.currentTarget, o = (((y = i == null ? void 0 : i.dataset) == null ? void 0 : y.skill) ?? "").trim(), a = ((h = i == null ? void 0 : i.textContent) == null ? void 0 : h.trim()) || o;
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-D3Rp-e38.mjs");
      r(this.actor, o, a);
    }), t.on("click", ".karakter-ability-chat", async (l) => {
      var o, a;
      l.preventDefault();
      const i = (a = (o = l.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.itemId;
      ...
      const i = (k = (h = l.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : k.area, o = (T = (S = l.currentTarget) == null ? void 0 : S.dataset) == null ? void 0 : T.itemId;
      if (!i || !o || !this.actor) return;
      const a = ((D = this.actor.system) == null ? void 0 : D.abilities) ?? {}, y = (Array.isArray((q = a[i]) == null ? void 0 : q.items) ? a[i].items.slice() : []).filter((_) => _ !== o);
      ...
      var o, a;
      if (l.preventDefault(), !l.altKey) return;
      const i = (a = (o = l.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.slot;
      ...
      r && (y[`system.weapons.${r}.itemId`] = "", y[`system.weapons.${r}.name`] = "", y[`system.weapons.${r}.damage`] = "", y[`system.weapons.${r}.bonus`] = ""), Object.keys(y).length && await a.update(y), await a.deleteEmbeddedDocuments("Item", [o]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (l) => {
      var o, a;
      if (l.preventDefault(), !l.altKey) return;
      const i = (((a = (o = l.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.itemId) ?? "").trim();
      ...
      if (!i || !this.actor) return;
      const o = ((S = (k = this.actor.system) == null ? void 0 : k.gear) == null ? void 0 : S.microchips) ?? {}, r = ["slot1", "slot2", "slot3"].find((T) => {
        var D;
    ...
    const c = this, u = (l) => {
      if (!l) return;
      const i = c._getFormDataForUpdate(l);
      Object.keys(i).length !== 0 && c.actor.update(i).catch((o) => console.warn("VoidNpcSheet save failed", o));
    }, m = (l) => {
      var i, o, a;
      return l && (((o = (i = c.element) == null ? void 0 : i.contains) == null ? void 0 : o.call(i, l)) || c.id && ((a = l.closest) == null ? void 0 : a.call(l, `#${CSS.escape(c.id)}`)));
    };
    c._votvNpcBlur = (l) => {
      var y;
      const i = l.target;
      ...
      r && (a.contains(r) || c.id && ((y = r.closest) != null && y.call(r, `#${CSS.escape(c.id)}`))) || u(a);
    }, document.body.addEventListener("blur", c._votvNpcBlur, !0), c._votvNpcItemHookRegistered || (c._votvNpcItemUpdateHook = (l, i, o) => {
      var a;
      c.actor && ((a = l == null ? void 0 : l.parent) == null ? void 0 : a.id) === c.actor.id && c.render(!0);
    }, c._votvNpcItemDeleteHook = (l, i, o) => {
      var a;
      c.actor && ((a = l == null ? void 0 : l.parent) == null ? void 0 : a.id) === c.actor.id && c.render(!0);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, p = ((D = e.system) == null ? void 0 : D.skills) ?? {}, c = ((q = e.items) == null ? void 0 : q.filter((L) => L.type === "Fegyver")) ?? [];
    let u = null;
    n.itemId && (u = c.find((L) => L.id === n.itemId) ?? null);
    const m = u && u.name || n.name || "Fegyver", d = Number(n.bonus || 0) || 0, f = ((_ = u == null ? void 0 : u.system) == null ? void 0 : _.type) || "kinetic", g = (((v = u == null ? void 0 : u.system) == null ? void 0 : v.skillKey) ?? "").trim(), l = g && p[g] !== void 0 ? g : f === "explosive" ? "grenadeUse" : "firearms", i = Number(p[l] || 0) || 0, o = d + i, r = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, y = new Roll(r);
  ...
  async _onDropItem(s, e) {
    var f, g, l, i, o, a, r, y, h, k, S, T, D, q, _, v, L;
    ...
    if (p.type === "Kepesseg" || p.type === "ability") {
      let C = p.id;
      if (((a = p.parent) == null ? void 0 : a.id) !== c.id) {
        const Z = foundry.utils.mergeObject(p.toObject(), { type: "Kepesseg" });
        C = ((r = (await c.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : r.id) ?? C;
      }
      const R = (((y = p.system) == null ? void 0 : y.kind) ?? "passive").toString(), j = ((h = c.system) == null ? void 0 : h.abilities) ?? {}, H = R === "active" ? "active" : "passive", G = Array.isArray((k = j[H]) == null ? void 0 : k.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
      G.includes(C) || G.push(C), await c.update({ [`system.abilities.${H}.items`]: G }), typeof this.render == "function" && this.render(!0);
      return;
    }
    if (((S = p.parent) == null ? void 0 : S.id) === c.id) return;
    const u = p.toObject();
    ...
    const d = (T = (await c.createEmbeddedDocuments("Item", [u]))[0]) == null ? void 0 : T.id;
    if (p.type === "Fegyver" && d) {
      const C = ((D = c.system) == null ? void 0 : D.weapons) ?? {}, R = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (C.slotOrder ?? "").trim(), H = j ? j.split(/\s*,\s*/).filter((W) => R.includes(W)) : [];
      let G = R.find((W) => {
        var M;
    ...
    if (p.type === "MikroChip" && d) {
      const C = ((L = (v = c.system) == null ? void 0 : v.gear) == null ? void 0 : L.microchips) ?? {}, j = ["slot1", "slot2", "slot3"].find((H) => {
        var G;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((l = e.system) == null ? void 0 : l.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, p = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = p ? `<p>${p}</p>` : "", d = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${u}
      ${m}
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    var n, p, c, u;
    if (!s) return { form: null, windowContent: null };
    const e = ((n = s.querySelector) == null ? void 0 : n.call(s, "form.votv.jarmu-sheet")) ?? ((p = s.querySelector) == null ? void 0 : p.call(s, "form.votv")) ?? null, t = ((c = s.querySelector) == null ? void 0 : c.call(s, ".votv-scroll")) ?? ((u = s.querySelector) == null ? void 0 : u.call(s, ".window-content")) ?? null;
    return { form: e, windowContent: t };
  }
  _saveScrollState(s) {
    const { form: e, windowContent: t } = this._getScrollContainers(s), n = {};
  ...
  _writeTotalDefense(s = null) {
    ...
    }, n = t(".jarmu-total-defense-effective"), p = t('input[name="system.combat.defense"]'), c = t('input[name="system.combat.givenProtection"]');
    if (!n) return;
    const u = Number(p == null ? void 0 : p.value) || 0, m = Number(c == null ? void 0 : c.value) || 0;
    n.textContent = String(u + m);
  }
  async _prepareContext(s) {
    var i, o, a, r, y, h, k, S, T, D, q, _;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((i = e.system) == null ? void 0 : i.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0), e.sizeForSelect = (((a = (o = e.system) == null ? void 0 : o.identity) == null ? void 0 : a.size) ?? "").trim() || "Közepes";
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, p = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, c = "— Nincs fegyver —", u = (((r = this.actor.items) == null ? void 0 : r.contents) ?? []).filter((v) => v.type === "Fegyver");
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (c) => {
      var d, f, g, l, i, o, a;
      if (!e.isEditable || !((f = (d = c.target) == null ? void 0 : d.closest) != null && f.call(d, ".profile")) && ((l = (g = c.target) == null ? void 0 : g.getAttribute) == null ? void 0 : l.call(g, "data-edit")) !== "img") return;
      c.preventDefault(), c.stopPropagation();
      const u = ((a = (o = (i = foundry.applications) == null ? void 0 : i.apps) == null ? void 0 : o.FilePicker) == null ? void 0 : a.implementation) ?? globalThis.FilePicker;
      new u({
        type: "image",
    ...
    const n = (c) => {
      ...
      var u, m, d;
      return c && (((m = (u = e.element) == null ? void 0 : u.contains) == null ? void 0 : m.call(u, c)) || e.id && ((d = c.closest) == null ? void 0 : d.call(c, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (c) => {
      var m, d, f;
      const u = ((m = c.target) == null ? void 0 : m.form) ?? ((f = (d = c.target) == null ? void 0 : d.closest) == null ? void 0 : f.call(d, "form"));
      p(u) && n(u);
...
const ue = class ue extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      try {
        ...
        if (!(this.element && r.includes(this.element) || this.id && ((o = (i = l.target) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, `#${CSS.escape(this.id)}`)))) return;
      ...
      var r, y, h, k, S, T;
      l.preventDefault();
      const i = (y = (r = l.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : y.itemRef, o = (k = (h = l.currentTarget) == null ? void 0 : h.dataset) == null ? void 0 : k.itemId;
      let a = null;
      if (i)
        try {
          a = await fromUuid(i);
      ...
      !a && o && (a = ((S = game.items) == null ? void 0 : S.get(o)) ?? null), (T = a == null ? void 0 : a.sheet) == null || T.render(!0);
      ...
      if (!i) return;
      const o = this.document.system ?? {}, a = Array.isArray((S = o.abilities) == null ? void 0 : S.items) ? o.abilities.items.slice() : [], r = a.indexOf(i), y = r >= 0 ? [...a.slice(0, r), ...a.slice(r + 1)] : a;
    ...
    const c = (l) => {
      ...
      var i, o, a;
      return l && (((o = (i = e.element) == null ? void 0 : i.contains) == null ? void 0 : o.call(i, l)) || e.id && ((a = l.closest) == null ? void 0 : a.call(l, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (l) => {
      var o, a, r;
      const i = ((o = l.target) == null ? void 0 : o.form) ?? ((r = (a = l.target) == null ? void 0 : a.closest) == null ? void 0 : r.call(a, "form"));
      u(i) && c(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
  ...
  async _prepareContext(s) {
    ...
    const c = Array.isArray(n.items) ? n.items : [], m = (await Promise.all(
      c.map(async (d) => {
        var f;
        if (!d) return null;
        try {
    ...
    )).map((d, f) => ({ doc: d, ref: c[f] })).filter((d) => !!d.doc && !!d.ref).map(({ doc: d, ref: f }) => {
      var g;
      return {
        id: d.id,
        ref: f,
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", n = Number(((l = e.system) == null ? void 0 : l.kp) ?? 0) || 0, p = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", m = p ? `<p>${p}</p>` : "", d = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${u}
      ${m}
  ...
  async _onDropDocument(s, e) {
    ...
    if (e.type === "Kepesseg" || e.type === "ability") {
      const c = e.uuid ?? e.id, u = this.document.system ?? {}, m = Array.isArray((n = u.abilities) == null ? void 0 : n.items) ? u.abilities.items.slice() : [];
      return m.push(c), console.log("VOTV JarmuEgysegSheet _onDropDocument updating abilities.items to", m), await this.document.update({ "system.abilities.items": m }), e;
    }
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
    ...
    setTimeout(() => {
      ...
      const o = ht.getTotalSpeedRaw(i), a = (y = i.effects) == null ? void 0 : y.find((S) => S.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (o <= 0 && !a) {
  ...
  Hooks.on("updateActor", (m, d, f, g) => {
    ...
    const i = document.activeElement, o = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), a = [], r = (j = game.actors) == null ? void 0 : j.get(l);
    ...
    const i = ((a = l.system) == null ? void 0 : a.weapons) ?? {}, o = {};
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    if (!n) return;
    const p = (k = game.messages) == null ? void 0 : k.get(n), c = (T = (S = p == null ? void 0 : p.flags) == null ? void 0 : S["vacuum-of-the-void"]) == null ? void 0 : T.weapon;
    if (!c) return;
    const u = c.actorId ?? ((D = p == null ? void 0 : p.speaker) == null ? void 0 : D.actor) ?? "";
    if (!u) return;
    e.preventDefault(), e.stopPropagation();
    let m = ((q = game.actors) == null ? void 0 : q.get(c.actorId)) ?? ((_ = game.actors) == null ? void 0 : _.get(u));
    ...
    const d = c.itemId ? ((R = (C = m.items) == null ? void 0 : C.get) == null ? void 0 : R.call(C, c.itemId)) ?? ((G = (H = (j = m.items) == null ? void 0 : j.contents) == null ? void 0 : H.find) == null ? void 0 : G.call(H, (ae) => ae.id === c.itemId)) : null;
    let f = (c.damageFormula ?? "").trim();
    if (f || (f = (((Z = d == null ? void 0 : d.system) == null ? void 0 : Z.damage) ?? "").trim()), !f && c.slotKey && (f = (((((W = m.system) == null ? void 0 : W.weapons) ?? {})[c.slotKey] ?? {}).damage ?? "").trim()), !f) {
    ...
    const l = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = c.targetName || "", o = c.hitLocationName || "", a = ((d == null ? void 0 : d.name) ?? (c.slotKey ? ((Te = (((ye = m.system) == null ? void 0 : ye.weapons) ?? {})[c.slotKey]) == null ? void 0 : Te.name) ?? "" : "")) || "Fegyver";
    ...
    for (const u of e) {
      ...
      if (m <= 0 && !d) {
        const f = ((c = (p = CONFIG.statusEffects) == null ? void 0 : p.find((g) => g.id === "immobilized")) == null ? void 0 : c.img) ?? "";
    ...
    }, t = ((c = game.actors) == null ? void 0 : c.filter((l) => l.type === "Karakter")) ?? [];
    for (const l of t)
      try {
        const i = l.prototypeToken, o = ((u = i == null ? void 0 : i.bar1) == null ? void 0 : u.attribute) ?? "", a = ((m = i == null ? void 0 : i.bar2) == null ? void 0 : m.attribute) ?? "";
        (o || a) && await l.update({
...
function zs() {
  ...
  for (const n of ((s = game.actors) == null ? void 0 : s.filter((p) => p.type === "Karakter" || p.type === "Npc")) ?? []) {
    const p = n.apps ?? [], c = p.contents ? Array.from(p.contents) : Array.from(p);
    for (const u of c)
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var d, f, g, l;
  const t = ((d = I.flags) == null ? void 0 : d["vacuum-of-the-void"]) ?? {}, n = t.resultType, p = t.critLabel, c = t.weaponAttack, u = t.weapon;
  if (!n && !p && !c) return;
  ...
  if (m) {
    if (n && m.classList.add(`votv-${n}`), p) {
      ...
      if (i)
        ...
        const o = m.querySelector(".dice-total"), a = (o == null ? void 0 : o.parentElement) ?? m, r = document.createElement("div");
        r.className = `votv-crit-label votv-crit-label-${n || "neutral"}`, r.textContent = p, a.appendChild(r);
      }
    }
    if (c && u && (u.actorId || (g = I.speaker) != null && g.actor)) {
...
//# sourceMappingURL=vacuum-of-the-void-C5PVy69n.mjs.map
