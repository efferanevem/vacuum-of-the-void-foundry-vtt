...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BxZvlCP_.mjs");
      n(this.actor, o);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, n = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-BxZvlCP_.mjs");
      f(this.actor, o, n);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const Te = !!M, J = (k == null ? void 0 : k.system) ?? {}, Ae = typeof J.range == "string" ? (J.range || "").trim() : "", me = J.type ?? "", ge = (n[me] ?? me) || "—", pe = J.size ?? "", _e = (f[pe] ?? pe) || "", De = [ge, _e].filter(Boolean).join(", ") || ge || "—", Me = me === "projectile" || pe === "thrown", Re = J.quantity != null ? String(J.quantity).trim() : "1", je = String(J.bonus ?? U.bonus ?? "").trim() || "0", Ke = (J.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: M ?? "",
        itemId: x,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BxZvlCP_.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-BxZvlCP_.mjs");
      n(this.actor, l, o);
  ...
  async _rollWeapon(s) {
    ...
    let c = null;
    a.itemId && (c = r.find((A) => A.id === a.itemId) ?? null);
    const p = c && c.name || a.name || "Fegyver", m = Number(a.bonus || 0) || 0, y = ((N = c == null ? void 0 : c.system) == null ? void 0 : N.type) || "kinetic", b = (((T = c == null ? void 0 : c.system) == null ? void 0 : T.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : y === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, l = m + i, n = `3d6${l !== 0 ? l > 0 ? `+${l}` : `${l}` : ""}`, f = new Roll(n);
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, l, o, n, f, h, v, w, S, C, P, N, T, A;
    ...
    if (d.type === "Pancel") {
      (l = (i = ui.notifications) == null ? void 0 : i.info) == null || l.call(i, "Az NPC-knek nincs páncélfelszerelésük. A páncélt csak karakter lapra húzhatod.");
      return;
    }
    const r = this.actor;
...
//# sourceMappingURL=vacuum-of-the-void-KaC52LJK.mjs.map
