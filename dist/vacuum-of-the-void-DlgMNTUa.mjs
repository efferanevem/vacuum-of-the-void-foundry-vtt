...
function ft(E) {
  ...
  const d = (i, r = 1) => {
    ...
    for (const a of i) {
      ...
      const l = typeof a.faces == "number" ? a.faces : void 0, y = Array.isArray(a.results) ? a.results : null;
      if (!l || !y || l === 8 || l !== 6) continue;
      const b = !n && o >= 0 && (a.number === 3 || a.number === "3") ? (n = !0, s) : o >= 0 ? e : t;
      for (const v of y) {
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, r, o, a, l, y, b, v;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const n = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((a = (o = n.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : a.value) ?? 0, c = ((l = n.currentHealth) == null ? void 0 : l.legs) ?? 0, u = U._healthStatusFromRatio(c, d), g = Number(((v = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((c = this.actor.system) == null ? void 0 : c.resources) ?? {}, n = ((g = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : g.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, d = ((m = (g = n.hitLocations) == null ? void 0 : g[t]) == null ? void 0 : m.value) ?? 0, c = ((f = n.currentHealth) == null ? void 0 : f[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((p) => v.includes(p)) : [], L = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, _ = L && typeof L == "object" && !Array.isArray(L) ? L : {}, O = (((Ke = _.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = _.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = _.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, D) => {
      const T = typeof p.sort == "number" ? p.sort : 0, C = typeof D.sort == "number" ? D.sort : 0;
      return T - C;
    }).map((p) => {
      ...
      for (let Oe = 0; Oe < q.length; Oe++) {
        const Ee = q[Oe];
        if ((((ce = b[Ee]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          C = Oe + 1, x = ((be = b[Ee]) == null ? void 0 : be.bonus) ?? "", Y = Ee;
          break;
        }
      }
      let W = null;
      T && (O === p.id ? W = "slot1" : S === p.id ? W = "slot2" : A === p.id && (W = "slot3"));
    ...
    e.weaponsTable = B.map((p) => {
      ...
      const x = !!T, Y = ((ct = p.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = p.system) == null ? void 0 : lt.equipped) !== null ? !!p.system.equipped : x, W = (p == null ? void 0 : p.system) ?? {}, Le = typeof W.range == "string" ? (W.range || "").trim() : "", Z = W.type ?? "", he = (Ae[Z] ?? Z) || "—", ce = W.size ?? "", be = (Fe[ce] ?? ce) || "", ke = [he, be].filter(Boolean).join(", ") || he || "—", de = Z === "projectile" || ce === "thrown", me = W.quantity, Pe = me != null ? String(me).trim() : "1", Oe = String(C.bonus ?? "").trim(), Ee = String(W.bonus ?? "").trim(), Lt = Oe || Ee || "0";
      return {
        slotKey: T ?? "",
        itemId: D,
    ...
    e.armorTable = Ne.map((p) => {
      var C, x;
      const D = (p == null ? void 0 : p.system) ?? {}, T = ((C = p.system) == null ? void 0 : C.equipped) !== void 0 && ((x = p.system) == null ? void 0 : x.equipped) !== null ? !!p.system.equipped : !1;
      return {
        itemId: p.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = $e.map((p) => {
      const D = (p == null ? void 0 : p.system) ?? {}, T = (D.description ?? "").trim(), C = T ? T.length > 60 ? T.slice(0, 57) + "…" : T : "—", x = D.quantity != null ? String(D.quantity).trim() : "1";
      return {
        itemId: p.id,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const we = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), fe = we.map((p) => ({ id: p.id, name: p.name, img: p.img })), De = "— Nincs Mikro-Chip —", _e = ["slot1", "slot2", "slot3"], Ie = (p) => {
      var T, C, x;
      const D = [];
      return p !== 1 && D.push((((T = _.slot1) == null ? void 0 : T.itemId) ?? "").trim()), p !== 2 && D.push((((C = _.slot2) == null ? void 0 : C.itemId) ?? "").trim()), p !== 3 && D.push((((x = _.slot3) == null ? void 0 : x.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = fe.filter((p) => !Ie(1).includes(p.id)), e.microchipItemsSlot2 = fe.filter((p) => !Ie(2).includes(p.id)), e.microchipItemsSlot3 = fe.filter((p) => !Ie(3).includes(p.id)), e.microchipSlots = _e.map((p) => {
      const D = _[p] ?? {}, T = (D.itemId ?? "").trim(), C = we.find((x) => x.id === T);
      return {
        slotKey: p,
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || D.name || De,
        img: (C == null ? void 0 : C.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((p) => {
      const D = `slot${p}`, T = _[D] ?? {}, C = (T.itemId ?? "").trim(), x = fe.find((Y) => Y.id === C);
      e[`microchip${p}ItemId`] = C, e[`microchip${p}DisplayName`] = (x == null ? void 0 : x.name) || T.name || De, e[`microchip${p}Img`] = (x == null ? void 0 : x.img) || "";
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      ...
      const D = Ce[p] ?? {}, T = (D.itemId ?? "").trim(), C = T ? F.get(T) : null, x = (C == null ? void 0 : C.description) ?? "", Y = (C == null ? void 0 : C.kp) ?? 0;
      return {
        itemId: T,
        displayName: (C == null ? void 0 : C.name) || D.name || N,
        img: (C == null ? void 0 : C.img) || "",
        description: x,
        kp: Y
      };
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-D1Uv23XX.mjs");
      a(this.actor, o);
      ...
      if (!o) {
        ...
        if (!b) return;
        o = (((((l = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : l.weapons) ?? {})[b] ?? {}).itemId ?? "").trim();
      }
    ...
    d && n({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var a, l, y;
      i.preventDefault(), i.stopPropagation();
      const r = ((y = (l = (a = foundry.applications) == null ? void 0 : a.apps) == null ? void 0 : l.FilePicker) == null ? void 0 : y.implementation) ?? globalThis.FilePicker;
      new r({
        type: "image",
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, a = ((y = r.textContent) == null ? void 0 : y.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-D1Uv23XX.mjs");
      l(this.actor, o, a);
      ...
      if (!a) return;
      const y = (((I = (((v = this.actor.system) == null ? void 0 : v.weapons) ?? {})[a]) == null ? void 0 : I.itemId) ?? "").trim();
      if (!y) return;
      const b = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, y)) ?? ((O = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : O.call(_, (A) => A.id === y));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o) return;
      const a = this.actor, l = a.items.get(o), y = {};
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = a.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = v ? v.split(/\s*,\s*/).filter((_) => I.includes(_)) : [], L = q.find((_) => {
          var O;
          return (((O = b[_]) == null ? void 0 : O.itemId) ?? "").trim() === o;
        });
        if (L) {
          const _ = q.filter((O) => O !== L);
          y["system.weapons.slotOrder"] = _.join(","), y[`system.weapons.${L}.itemId`] = "", y[`system.weapons.${L}.name`] = "", y[`system.weapons.${L}.damage`] = "", y[`system.weapons.${L}.bonus`] = "";
        }
      }
      Object.keys(y).length && await a.update(y), await a.deleteEmbeddedDocuments("Item", [o]);
      ...
      const l = this.actor.system.weapons ?? {}, y = (l.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = y ? y.split(/\s*,\s*/).filter((O) => b.includes(O)) : [], I = v.find((O) => {
        var S;
        return (((S = l[O]) == null ? void 0 : S.itemId) ?? "").trim() === o;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let O = v.find((A) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((L = a == null ? void 0 : a.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((_ = a == null ? void 0 : a.system) == null ? void 0 : _.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (I) {
        const O = v.filter((S) => S !== I);
        await this.actor.update({
      ...
      var O;
      i.preventDefault();
      const r = i.currentTarget, o = r.closest(".karakter-microchip-slot-select-wrap"), a = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display"), l = a == null ? void 0 : a.dataset.slot;
      if (!l) return;
      const y = (r.dataset.itemId ?? "").trim(), b = (r.dataset.itemName ?? ((O = r.textContent) == null ? void 0 : O.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", v = (r.dataset.itemImg ?? "").trim(), I = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-display-text");
      I && (I.textContent = b);
      let q = o == null ? void 0 : o.querySelector(".karakter-microchip-slot-thumb");
      v ? (q || (q = document.createElement("img"), q.className = "karakter-microchip-slot-thumb", q.alt = "", a == null || a.insertBefore(q, I)), q.src = v, q.style.display = "") : q && q.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      const L = y ? this.actor.items.get(y) : null, _ = {
      ...
      const a = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, y = ["slot1", "slot2", "slot3"].find((I) => {
        var q;
        return (((q = a[I]) == null ? void 0 : q.itemId) ?? "").trim() === r;
      });
      ...
      if (!r || !o) return;
      const a = this.actor.system.abilities ?? {}, y = (Array.isArray((b = a[r]) == null ? void 0 : b.items) ? a[r].items.slice() : []).filter((v) => v !== o);
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${O}.damage`]: ((L = a.system) == null ? void 0 : L.damage) ?? "",
          [`system.weapons.${O}.bonus`]: ((_ = a.system) == null ? void 0 : _.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (I) {
        const O = v.filter((S) => S !== I);
        await this.actor.update({
    ...
    const u = this, g = (i) => {
      ...
      const o = ((l = (a = r.system) == null ? void 0 : a.resources) == null ? void 0 : l.currentHealth) != null || ((b = (y = r.system) == null ? void 0 : y.resources) == null ? void 0 : b.hitLocations) != null;
      u.actor.update(r).then(() => {
        o && setTimeout(() => u.render(!0), 260);
      }).catch((v) => console.warn("VoidKarakterSheet save failed", v));
    }, m = (i) => {
      var r, o, a;
      return i && (((o = (r = u.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, i)) || u.id && ((a = i.closest) == null ? void 0 : a.call(i, `#${CSS.escape(u.id)}`)));
    };
    u._votvBlur = (i) => {
      var y;
      const r = i.target;
      ...
      l && (a.contains(l) || u.id && ((y = l.closest) != null && y.call(l, `#${CSS.escape(u.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: u.id, at: Date.now() }), g(a));
  ...
  async _onDropItem(s, e) {
    ...
    if (e) {
      let a = e.uuid ?? e.documentUuid ?? ((g = e.data) == null ? void 0 : g.uuid) ?? (typeof e == "string" ? e : null);
      if (!a && typeof e == "object") {
        for (const l of Object.values(e))
          if (typeof l == "string" && l.includes(".") && l.startsWith("Item.")) {
            a = l;
      ...
      if (a) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          ...
          if (b) {
            const I = ((h = y.system) == null ? void 0 : h.weapons) ?? {}, q = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = q ? q.split(/\s*,\s*/).filter((S) => L.includes(S)) : [], O = _.filter((S) => {
              var A;
              return (((A = I[S]) == null ? void 0 : A.itemId) ?? "").trim() === v;
            });
            if (O.length > 0) {
              const A = {
                "system.weapons.slotOrder": _.filter((M) => !O.includes(M)).join(",")
              };
              for (const M of O)
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((f = e.system) == null ? void 0 : f.kind) ?? "passive", n = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    var v;
    const t = (this.actor.system.weapons ?? {})[s] ?? {}, n = this.actor.system.skills ?? {}, d = this.actor.items.filter((I) => I.type === "Fegyver");
    let c = null;
    t.itemId && (c = d.find((I) => I.id === t.itemId) ?? null);
    const u = c && c.name || t.name || `Fegyver (${s})`, g = Number(t.bonus || 0) || 0, f = (((v = c == null ? void 0 : c.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(n[f] || 0) || 0, i = g + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
    await a.evaluate({ async: !0 });
    const { resultType: l, label: y } = ft(a), b = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${u} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (y = (o = ui.notifications) == null ? void 0 : o.warn) == null || y.call(o, ((l = (a = game.i18n) == null ? void 0 : a.localize) == null ? void 0 : l.call(a, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const c = new Roll(d);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (t) {
      ...
      const r = document.activeElement, o = n.contains(r), a = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA");
      o && a && (d.focus = {
        name: r.name || null,
        id: r.id || null,
    ...
    const c = await super.render(s, e), u = this.element, g = this.form ?? this.element, m = d.scrollState, f = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      ...
      if (this._applyScrollState(u, m), (f == null ? void 0 : f.name) != null || (f == null ? void 0 : f.id) != null) {
        const a = ((r = g.querySelector) == null ? void 0 : r.call(g, f.id ? `#${CSS.escape(f.id)}` : null)) ?? (f.name ? (o = g.querySelector) == null ? void 0 : o.call(g, `[name="${CSS.escape(f.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((Fe = t == null ? void 0 : t.items) == null ? void 0 : Fe.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, c = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((k) => c.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), f = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : c, r = c.filter((k) => !i.includes(k)), o = [...i, ...r], a = o.filter((k) => {
      var N;
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], q = n.filter((k) => k.type === "MikroChip");
    ...
    const _ = n.filter((k) => k.type === "Egyeb");
    e.egyebList = _.map((k) => {
    ...
    const O = (((we = e.weaponsTable) == null ? void 0 : we.length) ?? 0) > 0 || (((fe = e.armorTable) == null ? void 0 : fe.length) ?? 0) > 0 || (((De = e.microchipsTable) == null ? void 0 : De.length) ?? 0) > 0 || (((_e = e.itemsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((Ie = e.egyebList) == null ? void 0 : Ie.length) ?? 0) > 0;
    e.showEquipmentDropZone = !O;
    const S = ((Ce = t == null ? void 0 : t.system) == null ? void 0 : Ce.abilities) ?? {}, A = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, N;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget;
      let o = (((a = r == null ? void 0 : r.dataset) == null ? void 0 : a.itemId) ?? "").trim();
      ...
      var y, b;
      i.preventDefault();
      const r = i.currentTarget, o = (((y = r == null ? void 0 : r.dataset) == null ? void 0 : y.skill) ?? "").trim(), a = ((b = r == null ? void 0 : r.textContent) == null ? void 0 : b.trim()) || o;
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-D1Uv23XX.mjs");
      l(this.actor, o, a);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, a;
      i.preventDefault();
      const r = (a = (o = i.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.itemId;
      ...
      var b, v, I, q, L, _;
      if (i.preventDefault(), !i.altKey) return;
      const r = (v = (b = i.currentTarget) == null ? void 0 : b.dataset) == null ? void 0 : v.area, o = (q = (I = i.currentTarget) == null ? void 0 : I.dataset) == null ? void 0 : q.itemId;
      if (!r || !o || !this.actor) return;
      const a = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, y = (Array.isArray((_ = a[r]) == null ? void 0 : _.items) ? a[r].items.slice() : []).filter((O) => O !== o);
      await this.actor.update({ [`system.abilities.${r}.items`]: y }), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-ability-slot-clear", async (i) => {
      var o, a;
      if (i.preventDefault(), !i.altKey) return;
      const r = (a = (o = i.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.slot;
      r && (await this.actor.update({
        [`system.abilities.${r}.itemId`]: "",
        [`system.abilities.${r}.name`]: ""
      ...
      if (!o || !this.actor) return;
      const a = this.actor, l = (((v = r == null ? void 0 : r.dataset) == null ? void 0 : v.slotKey) ?? "").trim(), y = {};
      l && (y[`system.weapons.${l}.itemId`] = "", y[`system.weapons.${l}.name`] = "", y[`system.weapons.${l}.damage`] = "", y[`system.weapons.${l}.bonus`] = ""), Object.keys(y).length && await a.update(y), await a.deleteEmbeddedDocuments("Item", [o]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (i) => {
      var o, a;
      if (i.preventDefault(), !i.altKey) return;
      const r = (((a = (o = i.currentTarget) == null ? void 0 : o.dataset) == null ? void 0 : a.itemId) ?? "").trim();
      ...
      if (!r || !this.actor) return;
      const o = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((q) => {
        var L;
        return (((L = o[q]) == null ? void 0 : L.itemId) ?? "").trim() === r;
      });
    ...
    const c = this, u = (i) => {
      ...
      var r, o, a;
      return i && (((o = (r = c.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, i)) || c.id && ((a = i.closest) == null ? void 0 : a.call(i, `#${CSS.escape(c.id)}`)));
    };
    c._votvNpcBlur = (i) => {
      var y;
      const r = i.target;
      ...
      if (!g(a)) return;
      const l = i.relatedTarget;
      l && (a.contains(l) || c.id && ((y = l.closest) != null && y.call(l, `#${CSS.escape(c.id)}`))) || u(a);
    ...
    }, Hooks.on("updateItem", c._votvNpcItemUpdateHook), c._votvNpcItemHookRegistered = !0);
  }
  _tearDown(s) {
    var t, n, d;
  ...
  async _onDropItem(s, e) {
    var f, h, i, r, o, a, l, y, b, v, I, q, L, _, O;
    if (!this.actor) return (f = super._onDropItem) == null ? void 0 : f.call(this, s, e);
    const n = ((S) => {
      var M;
      if (!S) return null;
      const A = S.uuid ?? S.documentUuid ?? ((M = S.data) == null ? void 0 : M.uuid) ?? (typeof S == "string" ? S : null);
      if (A) return A;
      if (typeof S == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((a = d.system) == null ? void 0 : a.kind) ?? "passive").toString(), M = ((l = c.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", B = Array.isArray((y = M[H]) == null ? void 0 : y.items) ? M[H].items.slice() : Array.isArray(M[H]) ? M[H].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = c.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (S.slotOrder ?? "").trim(), H = M ? M.split(/\s*,\s*/).filter((Q) => A.includes(Q)) : [];
      let B = A.find((Q) => {
        var pe;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((O = (_ = c.system) == null ? void 0 : _.gear) == null ? void 0 : O.microchips) ?? {}, M = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", n = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), c = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${c}</p>
      ${u}
      ${g}
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (c) => {
      ...
      const u = ((a = (o = (r = foundry.applications) == null ? void 0 : r.apps) == null ? void 0 : o.FilePicker) == null ? void 0 : a.implementation) ?? globalThis.FilePicker;
      new u({
        type: "image",
...
Hooks.once("init", () => {
  ...
  console.log("Vacuum of the Void | Initializing system"), game.votv = {
    ...
    bar: ["", "resources.health"],
    value: []
  }, (n = CONFIG.Actor).typeLabels ?? (n.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", (d = CONFIG.Combat).initiative ?? (d.initiative = {}), CONFIG.Combat.initiative.formula = null, (c = CONFIG.Item).typeLabels ?? (c.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", We, {
    types: ["Karakter"],
    makeDefault: !0,
  ...
  Hooks.on("updateActor", (u, g, m, f) => {
    ...
    if (!h) return;
    const i = document.activeElement, r = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), o = [], a = (I = game.actors) == null ? void 0 : I.get(h);
    a != null && a.apps && o.push(...Array.from(a.apps));
    const l = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const S of l)
      ((q = S.document) == null ? void 0 : q.id) !== h || ((L = S.document) == null ? void 0 : L.documentName) !== "Actor" || ((_ = S.constructor) == null ? void 0 : _.name) !== "VoidKarakterSheet" || o.includes(S) || o.push(S);
    if (r && o.some((S) => {
      const A = (S == null ? void 0 : S.form) ?? (S == null ? void 0 : S.element);
      return A && A.contains(i);
    })) return;
    const b = (O = game.votv) == null ? void 0 : O._lastKarakterSheetBlurSave, v = b && Date.now() - b.at < E ? b.appId : null;
    setTimeout(() => {
      for (const S of o)
    ...
    for (const [y, b] of Object.entries(i)) {
      ...
      !v || v !== u.id || (r[`system.weapons.${y}.name`] = u.name ?? "", r[`system.weapons.${y}.damage`] = ((a = u.system) == null ? void 0 : a.damage) ?? "", r[`system.weapons.${y}.bonus`] = ((l = u.system) == null ? void 0 : l.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    for (const i of t)
      try {
        const r = i.prototypeToken, o = ((u = r == null ? void 0 : r.bar1) == null ? void 0 : u.attribute) ?? "", a = ((g = r == null ? void 0 : r.bar2) == null ? void 0 : g.attribute) ?? "";
        (o || a) && await i.update({
...
Hooks.on("preCreateToken", (E, s, e) => {
  var c, u;
  const t = (c = game.votv) == null ? void 0 : c._dragSourceActorId, n = t ?? E.actorId ?? null;
...
Hooks.on("renderCombatTrackerConfig", (E, s, e) => {
});
Hooks.on("renderSidebarTab", (E, s, e) => {
  var d, c;
  if ((E == null ? void 0 : E.id) !== "combat") return;
  const t = "[data-action='rollAll'], [data-action='rollNPCs'], [data-action='rollInitiative'], .combat-control[title*='Roll'], .combat-control[title*='roll']", n = s[0] ?? s;
  (c = (d = n == null ? void 0 : n.querySelectorAll) == null ? void 0 : d.call(n, t)) == null || c.forEach((u) => {
    u.style.display = "none";
  });
});
Hooks.on("renderTokenHUD", (E, s, e) => {
  var d;
  const t = E == null ? void 0 : E.object, n = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (E, s, e) => {
  var u, g;
  const t = ((u = E.flags) == null ? void 0 : u["vacuum-of-the-void"]) ?? {}, n = t.resultType, d = t.critLabel;
  if (!n && !d) return;
  const c = (g = s == null ? void 0 : s.querySelector) == null ? void 0 : g.call(s, ".dice-roll");
  if (c && (n && c.classList.add(`votv-${n}`), d)) {
...
//# sourceMappingURL=vacuum-of-the-void-DlgMNTUa.mjs.map
