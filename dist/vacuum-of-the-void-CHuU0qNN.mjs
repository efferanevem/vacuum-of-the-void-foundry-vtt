...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const i = ((r = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : r.resources) ?? {}, a = ((c = (o = i.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, l = ((n = i.currentHealth) == null ? void 0 : n.legs) ?? 0, u = C._healthStatusFromRatio(l, a), p = Number(((h = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : h.givenSpeed) ?? 0) || 0;
    let k;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((l = this.actor.system) == null ? void 0 : l.resources) ?? {}, i = ((p = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : p.value) ?? 0, a = ((k = t.currentHealth) == null ? void 0 : k[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const i = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, a = ((k = (p = i.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : k.value) ?? 0, l = ((b = i.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (r) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-DrapHcac.mjs");
      n(this.actor, c);
    ...
    a && i({ currentTarget: a }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (r) => {
      ...
      var f;
      r.preventDefault();
      const o = r.currentTarget, c = o.dataset.skill, n = ((f = o.textContent) == null ? void 0 : f.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-DrapHcac.mjs");
      m(this.actor, c, n);
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const b of l) {
      const v = ((k = i[b]) == null ? void 0 : k.value) ?? 0, r = a[b] ?? 0;
  ...
  async _onDropItem(s, e) {
    ...
    const t = s.target, i = (l = t == null ? void 0 : t.closest) == null ? void 0 : l.call(t, ".karakter-ability-slot-single"), a = (u = t == null ? void 0 : t.closest) == null ? void 0 : u.call(t, ".karakter-ability-area");
    if (e) {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", i = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, a = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = i > 0 ? `<p><strong>KP:</strong> ${i}</p>` : "", p = a ? `<p>${a}</p>` : "", k = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    if (!i || i.type !== "ability") return;
    let a = i.id;
    ((k = i.parent) == null ? void 0 : k.id) !== this.actor.id && (a = ((b = (await this.actor.createEmbeddedDocuments("Item", [i.toObject()]))[0]) == null ? void 0 : b.id) ?? a);
  ...
  async _rollWeapon(s) {
    ...
    const u = l && l.name || t.name || `Fegyver (${s})`, p = Number(t.bonus || 0) || 0, b = (((h = l == null ? void 0 : l.system) == null ? void 0 : h.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(i[b] || 0) || 0, r = p + v, c = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, n = new Roll(c);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    let i = ((k = (p = t.items).get) == null ? void 0 : k.call(p, s)) ?? ((v = (b = t.items.contents) == null ? void 0 : b.find) == null ? void 0 : v.call(b, (h) => h.id === s));
...
Hooks.on("preCreateToken", (E, s, e) => {
  var l, u;
  const t = (l = game.votv) == null ? void 0 : l._dragSourceActorId, i = t ?? E.actorId ?? null;
...
//# sourceMappingURL=vacuum-of-the-void-CHuU0qNN.mjs.map
