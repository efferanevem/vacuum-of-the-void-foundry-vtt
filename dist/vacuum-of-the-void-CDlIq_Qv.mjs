...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const c = this.element, m = this.form ?? this.element, y = p.scrollState, a = p.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", o = () => {
      var u, h;
  ...
  static getTotalSpeedRaw(s) {
    ...
    const d = Number(((u = (r = s.system) == null ? void 0 : r.combat) == null ? void 0 : u.speed) ?? 0) || 0, c = Number(((g = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : g.speedBonus) ?? 0) || 0;
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((u = (r = this.actor) == null ? void 0 : r.system) == null ? void 0 : u.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, l = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = ee._healthStatusFromRatio(l, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let c;
  ...
  _writeTotalSpeed(s = null) {
    ...
    const a = Number(l == null ? void 0 : l.value) || 0, i = Number(p == null ? void 0 : p.value) || 0, o = Number(f == null ? void 0 : f.textContent) || 0;
  ...
  async _prepareContext(s) {
    ...
    const r = Number(((gt = (yt = this.actor.system) == null ? void 0 : yt.combat) == null ? void 0 : gt.givenProtection) ?? 0) || 0, u = (bt = (We = (ht = this.actor) == null ? void 0 : ht.statuses) == null ? void 0 : We.has) != null && bt.call(We, "lookaround") ? 1 : 0, h = (I = (Je = (vt = this.actor) == null ? void 0 : vt.statuses) == null ? void 0 : Je.has) != null && I.call(Je, "halfcover") ? 3 : 0, g = (G = (E = (P = this.actor) == null ? void 0 : P.statuses) == null ? void 0 : E.has) != null && G.call(E, "threequarteredcover") ? 6 : 0, v = r + this._getTotalArmorProtectionBonus() + u + h + g;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-Cuh0DC8G.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-Cuh0DC8G.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((g = o.textContent) == null ? void 0 : g.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-Cuh0DC8G.mjs");
      h(this.actor, r, u);
  ...
  async _onDropItem(s, e) {
    var t, n, f, l, p, d, c, m, y, a, i, o, r, u;
    if (e) {
  ...
  async _rollWeapon(s) {
    ...
    const p = l && l.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, c = ((k = l == null ? void 0 : l.system) == null ? void 0 : k.type) || "kinetic", m = (((w = l == null ? void 0 : l.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = m && n[m] !== void 0 ? m : c === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = d + a, r = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, u = new Roll(r);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const c = (($t = t == null ? void 0 : t.items) == null ? void 0 : $t.contents) ?? [], m = ((je = t == null ? void 0 : t.system) == null ? void 0 : je.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (m.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((I) => y.includes(I)) : [], o = c.filter((I) => I.type === "Fegyver"), r = o.map((I) => ({ id: I.id, name: I.name, img: I.img })), u = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((I) => !h.includes(I)), v = [...h, ...g], k = v.filter((I) => {
      var E;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-Cuh0DC8G.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-Cuh0DC8G.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-Cuh0DC8G.mjs");
      u(this.actor, o, r);
    ...
    const l = this, p = (a) => {
      ...
      var i, o, r;
      return a && (((o = (i = l.element) == null ? void 0 : i.contains) == null ? void 0 : o.call(i, a)) || l.id && ((r = a.closest) == null ? void 0 : r.call(a, `#${CSS.escape(l.id)}`)));
    };
    l._votvNpcBlur = (a) => {
      var h;
      const i = a.target;
      ...
      u && (r.contains(u) || l.id && ((h = u.closest) != null && h.call(u, `#${CSS.escape(l.id)}`))) || p(r);
    }, document.body.addEventListener("blur", l._votvNpcBlur, !0), l._votvNpcItemHookRegistered || (l._votvNpcItemUpdateHook = (a, i, o) => {
      var r;
      l.actor && ((r = a == null ? void 0 : a.parent) == null ? void 0 : r.id) === l.actor.id && l.render(!0);
  ...
  async _rollWeapon(s) {
    ...
    const d = p && p.name || n.name || "Fegyver", c = Number(n.bonus || 0) || 0, m = ((O = p == null ? void 0 : p.system) == null ? void 0 : O.type) || "kinetic", y = (((q = p == null ? void 0 : p.system) == null ? void 0 : q.skillKey) ?? "").trim(), a = y && f[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, o = c + i, u = `3d6${o !== 0 ? o > 0 ? `+${o}` : `${o}` : ""}`, h = new Roll(u);
  ...
  async _onDropItem(s, e) {
    var m, y, a, i, o, r, u, h, g, v, k, w, T, _, O, q, M, j, z;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((a = e.system) == null ? void 0 : a.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", c = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${l}</p>
      ${p}
      ${d}
  ...
  _attachFrameListeners(s) {
    ...
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      const i = this.actor.items.contents.filter((w) => w.type === "Jarmuegyseg").sort((w, T) => {
        ...
        return _ - O;
      }).map((w) => w.id), o = i.indexOf(m), r = i.indexOf(c);
      if (o === -1 || r === -1) return;
      ...
      d.preventDefault();
      const c = (r = (o = (i = (a = d.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : o.dataset) == null ? void 0 : r.abilityRef, m = (v = (g = (h = (u = d.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : h.call(u, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (c)
        try {
          y = await fromUuid(c);
      ...
      var i, o, r, u;
      d.preventDefault();
      const c = (o = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : o.call(i, ".jarmu-unit-ability-pill"), m = (r = c == null ? void 0 : c.dataset) == null ? void 0 : r.abilityRef, y = (u = c == null ? void 0 : c.dataset) == null ? void 0 : u.abilityId, a = m || y;
    ...
    this._votvJarmuBlur = (d) => {
      ...
      var r, u, h;
      const c = d.currentTarget, m = (r = c == null ? void 0 : c.dataset) == null ? void 0 : r.itemId;
      if (!m) return;
      const y = this.actor.items.get(m);
      if (!y || y.type !== "Jarmuegyseg") return;
      const a = (c.value ?? "").trim(), i = a === "" ? 0 : Number(a), o = (u = c.closest) == null ? void 0 : u.call(c, ".jarmu-unit-row");
      if (o) {
...
const tt = class tt extends Pt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!m || !a || !i) return;
      const o = m.value ?? "", r = (y == null ? void 0 : y.value) ?? "", u = t[o] ?? 0, h = n[r] ?? 0, g = (((x = (z = this.actor) == null ? void 0 : z.items) == null ? void 0 : x.contents) ?? []).filter((J) => J.type === "Jarmuegyseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = u + h + k + w;
      a.value = T;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, l = n.combat ?? {}, p = f.assignment ?? "", d = f.subAssignment ?? "", c = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = c[p] ?? 0, i = m[d] ?? 0, o = e.sizeForSelect ?? "Kicsi", r = y[o] ?? 0, u = Number(l.threatBonus ?? 0) || 0, h = a + i + r + u;
      e.system = foundry.utils.mergeObject(
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (d, c, m, y) => {
    ...
    for (const K of h) {
      ...
      W !== "VoidKarakterSheet" && W !== "VoidJarmuSheet" || r.includes(K) || r.push(K);
    }
    if (o && r.some((K) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = l.targetName || "", o = l.hitLocationName || "", r = ((c == null ? void 0 : c.name) ?? (l.slotKey ? ((R = (((D = d.system) == null ? void 0 : D.weapons) ?? {})[l.slotKey]) == null ? void 0 : R.name) ?? "" : "")) || "Fegyver";
    ...
    for (const a of game.scenes ?? []) {
      const i = ((c = a.tokens) == null ? void 0 : c.filter((o) => {
        var r;
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  ...
  if (m) {
    ...
    if (!l && d && c) {
      const r = m.querySelector(".dice-total"), u = (r == null ? void 0 : r.parentElement) ?? m, h = !!c.isHit, g = c.targetName || "Célpont", v = c.hitLocationRoll, k = c.hitLocationName;
...
//# sourceMappingURL=vacuum-of-the-void-CDlIq_Qv.mjs.map
