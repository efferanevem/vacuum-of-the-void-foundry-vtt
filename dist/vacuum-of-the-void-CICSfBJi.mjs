...
const { NumberField: Rt, StringField: hs } = foundry.data.fields;
...
const { NumberField: Mt, StringField: ot, SchemaField: ws, ArrayField: gi } = foundry.data.fields;
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var lt, ut, dt, mt, pt, ft, yt, gt, ht, Je, bt, vt, Ye, I, E, P, G, ke, ne, Ce, Te, we, xe, Xe, Qe, qt, Nt, Lt, Ft, kt, at, Xt, Qt, Zt, es, ts, ss, is, ns, as, rs, os, cs, ls, us;
    ...
    const O = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), z = j ? j.split(/\s*,\s*/).filter((b) => q.includes(b)) : [], B = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, R = B && typeof B == "object" && !Array.isArray(B) ? B : {}, Y = (((Qe = R.slot1) == null ? void 0 : Qe.itemId) ?? "").trim(), Z = (((qt = R.slot2) == null ? void 0 : qt.itemId) ?? "").trim(), J = (((Nt = R.slot3) == null ? void 0 : Nt.itemId) ?? "").trim(), M = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, L) => {
      ...
      var Re, et, tt, ze, Ue, wt;
      const L = b.type === "Fegyver", N = b.type === "MikroChip";
      let A = 0, U = "", de = null;
      for (let rt = 0; rt < z.length; rt++) {
        const It = z[rt];
        if ((((Re = O[It]) == null ? void 0 : Re.itemId) ?? "") === b.id) {
          A = rt + 1, U = ((et = O[It]) == null ? void 0 : et.bonus) ?? "", de = It;
          break;
        }
      }
      let re = null;
      N && (Y === b.id ? re = "slot1" : Z === b.id ? re = "slot2" : J === b.id && (re = "slot3"));
      const Ze = L && ((tt = b.system) != null && tt.damage) ? b.system.damage : "", Ie = L && typeof ((ze = b.system) == null ? void 0 : ze.range) == "string" ? (b.system.range || "").trim() : "", De = de ? Number((Ue = O[de]) == null ? void 0 : Ue.bonus) || 0 : "";
      return {
        id: b.id,
        name: b.name,
        img: b.img,
    ...
    e.weaponSlots = D.map((b, L) => {
      const N = O[b] ?? {}, A = (N.itemId ?? "").trim(), U = ce.find((De) => De.id === A), de = W.find((De) => De.id === A), re = (de == null ? void 0 : de.system) ?? {}, Ze = re.size === "thrown", Ie = (typeof re.range == "string" ? (re.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: A,
        slotNum: L + 1,
    ...
    e.weaponsTable = W.map((b) => {
      ...
      let N = null, A = {};
      for (const $t of z)
        if ((((ds = O[$t]) == null ? void 0 : ds.itemId) ?? "").trim() === L) {
          N = $t, A = O[$t] ?? {};
          break;
        }
      const U = !!N, de = ((ms = b.system) == null ? void 0 : ms.equipped) !== void 0 && ((ps = b.system) == null ? void 0 : ps.equipped) !== null ? !!b.system.equipped : U, re = (b == null ? void 0 : b.system) ?? {}, Ze = typeof re.range == "string" ? (re.range || "").trim() : "", Ie = re.type ?? "", De = (x[Ie] ?? Ie) || "—", Re = re.size ?? "", et = (V[Re] ?? Re) || "", tt = [De, et].filter(Boolean).join(", ") || De || "—", ze = Ie === "projectile" || Re === "thrown", Ue = re.quantity, wt = Ue != null ? String(Ue).trim() : "1", rt = String(A.bonus ?? "").trim(), It = String(re.bonus ?? "").trim(), Vs = rt || It || "0";
      return {
        slotKey: N ?? "",
        itemId: L,
    ...
    const me = (((Xt = this.actor.items) == null ? void 0 : Xt.contents) ?? []).filter((b) => b.type === "MikroChip"), ie = me.map((b) => ({ id: b.id, name: b.name, img: b.img })), ge = "— Nincs Mikro-Chip —", ue = ["slot1", "slot2", "slot3"], Me = (b) => {
      var N, A, U;
      const L = [];
    ...
    e.microchipItemsSlot1 = ie.filter((b) => !Me(1).includes(b.id)), e.microchipItemsSlot2 = ie.filter((b) => !Me(2).includes(b.id)), e.microchipItemsSlot3 = ie.filter((b) => !Me(3).includes(b.id)), e.microchipSlots = ue.map((b) => {
      ...
      let N = null;
      for (const Ue of ue)
        if ((((Re = R[Ue]) == null ? void 0 : Re.itemId) ?? "").trim() === L) {
          N = Ue;
          break;
        }
      const A = !!N, U = ((et = b == null ? void 0 : b.system) == null ? void 0 : et.abilityType) ?? "", de = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", re = U === "active", Ze = Number((tt = b == null ? void 0 : b.system) == null ? void 0 : tt.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0, Ie = (((ze = b == null ? void 0 : b.system) == null ? void 0 : ze.description) ?? "").trim(), De = Ie ? Ie.length > 60 ? Ie.slice(0, 57) + "…" : Ie : "—";
      return {
        itemId: L,
        actorId: this.actor.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const Be = (((Qt = e.weaponsTable) == null ? void 0 : Qt.length) ?? 0) > 0 || (((Zt = e.armorTable) == null ? void 0 : Zt.length) ?? 0) > 0 || (((es = e.microchipsTable) == null ? void 0 : es.length) ?? 0) > 0 || (((ts = e.itemsTable) == null ? void 0 : ts.length) ?? 0) > 0;
    ...
    const st = this.actor.system.abilities ?? {}, Dt = (((ss = this.actor.items) == null ? void 0 : ss.contents) ?? []).map((b) => {
      ...
      const L = st[b] ?? {}, N = (L.itemId ?? "").trim(), A = N ? $e.get(N) : null, U = (A == null ? void 0 : A.description) ?? "", de = (A == null ? void 0 : A.kp) ?? 0;
      return {
        itemId: N,
        displayName: (A == null ? void 0 : A.name) || L.name || Ge,
        img: (A == null ? void 0 : A.img) || "",
    ...
    const se = ((is = e.system) == null ? void 0 : is.resources) ?? {}, he = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ae = (as = (ns = e.system) == null ? void 0 : ns.combat) == null ? void 0 : as.initiativeResult, be = typeof ae == "number" ? ae : -1, nt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], _e = (os = (rs = e.system) == null ? void 0 : rs.combat) == null ? void 0 : os.initiativeRanges, Oe = Array.isArray(_e) ? _e.map((b) => ({ min: Number(b.min) ?? 0, max: Number(b.max) ?? 0, kp: Math.min(10, Math.max(0, Number(b.kp) ?? 0)) })) : [], Ke = (Oe.length > 0 ? Oe : nt).slice().sort((b, L) => b.min - L.min), We = Oe.map((b) => b.min), _t = We.length ? Math.min(...We) : 0, Ot = We.length ? Math.max(...We) : 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-DjT0Kt-6.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-DjT0Kt-6.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-DjT0Kt-6.mjs");
      h(this.actor, r, u);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-DjT0Kt-6.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DjT0Kt-6.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-DjT0Kt-6.mjs");
      u(this.actor, o, r);
  ...
  async _onDropItem(s, e) {
    var m, g, a, i, o, r, u, h, y, v, k, w, T, _, O, q, j, z, B;
...
//# sourceMappingURL=vacuum-of-the-void-CICSfBJi.mjs.map
