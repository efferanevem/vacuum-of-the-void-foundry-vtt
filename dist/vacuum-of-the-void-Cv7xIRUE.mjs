...
const { HTMLField: Nt, NumberField: P, SchemaField: x, StringField: w, BooleanField: J, ArrayField: xe } = foundry.data.fields;
...
const { NumberField: Me, SchemaField: xt } = foundry.data.fields;
class jt extends $t {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Kt, StringField: je } = foundry.data.fields;
class Ut extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      protectionBonus: new je({ required: !1, blank: !0, initial: "" }),
      /** Sebesség levonás (a táblázatban: Sebesség Levonás). */
      speedPenalty: new je({ required: !1, blank: !0, initial: "" }),
      /** Szint (a táblázatban: Szint). */
      level: new je({ required: !1, blank: !0, initial: "" }),
      /** Speciális (a táblázatban: Speciális). */
      special: new je({ required: !1, blank: !0, initial: "" })
    };
  }
}
const { NumberField: Ke, StringField: ut } = foundry.data.fields;
class Bt extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      ...
      cost: new Ke({ required: !1, integer: !0, min: 0, initial: 1250 }),
      replaceCost: new Ke({ required: !1, integer: !0, min: 0, initial: 3 }),
      quantity: new Ke({ required: !1, integer: !0, min: 0, initial: 1 })
    };
  }
}
...
const K = class K extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const r = ((l = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : l.resources) ?? {}, d = ((c = (a = r.hitLocations) == null ? void 0 : a.legs) == null ? void 0 : c.value) ?? 0, n = ((u = r.currentHealth) == null ? void 0 : u.legs) ?? 0, o = K._healthStatusFromRatio(n, d), g = Number(((I = (v = (h = this.actor) == null ? void 0 : h.system) == null ? void 0 : v.combat) == null ? void 0 : I.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    var n, o, g, m;
    const e = K.BODY_PART_BY_SKILL[s];
    if (e == null) return;
  ...
  async _prepareContext(s) {
    var fe, ye, Ee, Ne, $e, Oe, we, Qe, Xe, Ze, Ve, et, tt, st, it, rt, nt, at;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((Ee = (ye = (fe = this.actor.system) == null ? void 0 : fe.resources) == null ? void 0 : ye.stress) == null ? void 0 : Ee.value) || 0;
    e.stressOver10 = t > 10;
    const r = this.actor.system.resources ?? {}, d = r.hitLocations ?? {}, n = r.currentHealth ?? {}, o = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const p of o) {
      const O = ((Ne = d[p]) == null ? void 0 : Ne.value) ?? 0, T = n[p] ?? 0;
      e.computedHealthStatus[p] = K._healthStatusFromRatio(T, O);
    }
    const g = (Number(n.head) || 0) === 0, y = ["torso", "arms", "legs"].filter((p) => (Number(n[p]) || 0) === 0).length;
    e.showDeathSkull = g || y >= 2;
    const f = e.computedHealthStatus.legs ?? 3, i = Number(((Oe = ($e = this.actor.system) == null ? void 0 : $e.combat) == null ? void 0 : Oe.givenSpeed) ?? 0) || 0;
    let l;
    f === 0 ? l = 0 : f === 1 ? l = -6 : f === 2 ? l = -3 : l = i;
    const a = this._getTotalArmorSpeedPenalty();
    l += a, e.effectiveGivenSpeed = l;
    const u = (Number(((Qe = (we = this.actor.system) == null ? void 0 : we.combat) == null ? void 0 : Qe.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: l, givenProtection: u } },
      { inplace: !1 }
    );
    const h = K.BODY_PART_BY_SKILL;
    ...
    const v = this.actor.system.weapons ?? {}, I = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], S = (v.slotOrder ?? "").trim(), q = S ? S.split(/\s*,\s*/).filter((p) => I.includes(p)) : [], L = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, _ = L && typeof L == "object" && !Array.isArray(L) ? L : {}, k = (((Ze = _.slot1) == null ? void 0 : Ze.itemId) ?? "").trim(), C = (((Ve = _.slot2) == null ? void 0 : Ve.itemId) ?? "").trim(), E = (((et = _.slot3) == null ? void 0 : et.itemId) ?? "").trim(), H = this.actor.items.contents.filter((p) => p.type !== "Kepesseg" && p.type !== "ability").slice().sort((p, O) => {
      const T = typeof p.sort == "number" ? p.sort : 0, D = typeof O.sort == "number" ? O.sort : 0;
      return T - D;
    }).map((p) => {
      var ce, he, be, ue, de, _e;
      const O = p.type === "Fegyver", T = p.type === "MikroChip";
      let D = 0, N = "", Y = null;
      for (let Ie = 0; Ie < q.length; Ie++) {
        const qe = q[Ie];
        if ((((ce = v[qe]) == null ? void 0 : ce.itemId) ?? "") === p.id) {
          D = Ie + 1, N = ((he = v[qe]) == null ? void 0 : he.bonus) ?? "", Y = qe;
          break;
        }
      }
      let W = null;
      T && (k === p.id ? W = "slot1" : C === p.id ? W = "slot2" : E === p.id && (W = "slot3"));
      const De = O && ((be = p.system) != null && be.damage) ? p.system.damage : "", Z = O && typeof ((ue = p.system) == null ? void 0 : ue.range) == "string" ? (p.system.range || "").trim() : "", ge = Y ? Number((de = v[Y]) == null ? void 0 : de.bonus) || 0 : "";
      return {
        id: p.id,
        name: p.name,
        img: p.img,
        ...
        rangeStr: Z,
        slotBonusNum: ge,
        quantity: Number(((_e = p.system) == null ? void 0 : _e.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = H;
    const U = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((p) => p.type === "Fegyver"), ne = U.map((p) => ({ id: p.id, name: p.name, img: p.img }));
    e.weaponItems = ne;
    const Q = "— Nincs fegyver —", me = q.filter((p) => {
      const T = ((v[p] ?? {}).itemId ?? "").trim();
      return T ? !!U.find((N) => N.id === T) : !1;
    });
    ...
    const Ce = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Le = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = U.map((p) => {
      var ot, ct, lt;
      const O = p.id;
      let T = null, D = {};
      for (const Re of q)
        if ((((ot = v[Re]) == null ? void 0 : ot.itemId) ?? "").trim() === O) {
          T = Re, D = v[Re] ?? {};
          break;
        }
      const N = !!T, Y = ((ct = p.system) == null ? void 0 : ct.equipped) !== void 0 && ((lt = p.system) == null ? void 0 : lt.equipped) !== null ? !!p.system.equipped : N, W = (p == null ? void 0 : p.system) ?? {}, De = typeof W.range == "string" ? (W.range || "").trim() : "", Z = W.type ?? "", ge = (Ce[Z] ?? Z) || "—", ce = W.size ?? "", he = (Le[ce] ?? ce) || "", be = [ge, he].filter(Boolean).join(", ") || ge || "—", ue = Z === "projectile" || ce === "thrown", de = W.quantity, _e = de != null ? String(de).trim() : "1", Ie = String(D.bonus ?? "").trim(), qe = String(W.bonus ?? "").trim(), Lt = Ie || qe || "0";
      return {
        slotKey: T ?? "",
        itemId: O,
        ...
        typeAndSize: be,
        quantity: _e,
        quantityDisplay: ue ? _e : "—",
        isProjectile: ue,
        equipped: Y,
        special: (W.special ?? "").trim() || "—"
      };
    });
    const Pe = (((st = this.actor.items) == null ? void 0 : st.contents) ?? []).filter((p) => p.type === "Pancel");
    e.armorTable = Pe.map((p) => {
      var D, N;
    ...
    const Ae = (((it = this.actor.items) == null ? void 0 : it.contents) ?? []).filter((p) => p.type === "Targy");
    e.itemsTable = Ae.map((p) => {
    ...
    const ke = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).filter((p) => p.type === "MikroChip"), pe = ke.map((p) => ({ id: p.id, name: p.name, img: p.img })), b = "— Nincs Mikro-Chip —", F = ["slot1", "slot2", "slot3"], A = (p) => {
      var T, D, N;
      const O = [];
    ...
    e.microchipItemsSlot1 = pe.filter((p) => !A(1).includes(p.id)), e.microchipItemsSlot2 = pe.filter((p) => !A(2).includes(p.id)), e.microchipItemsSlot3 = pe.filter((p) => !A(3).includes(p.id)), e.microchipSlots = F.map((p) => {
      const O = _[p] ?? {}, T = (O.itemId ?? "").trim(), D = ke.find((N) => N.id === T);
      return {
        slotKey: p,
        itemId: T,
        displayName: (D == null ? void 0 : D.name) || O.name || b,
        img: (D == null ? void 0 : D.img) || "",
        active: O.active === !0
      };
    }), ["1", "2", "3"].forEach((p) => {
      const O = `slot${p}`, T = _[O] ?? {}, D = (T.itemId ?? "").trim(), N = pe.find((Y) => Y.id === D);
      e[`microchip${p}ItemId`] = D, e[`microchip${p}DisplayName`] = (N == null ? void 0 : N.name) || T.name || b, e[`microchip${p}Img`] = (N == null ? void 0 : N.img) || "";
    }), e.microchipsTable = ke.map((p) => {
      var ce, he, be, ue;
      const O = p.id;
      let T = null;
      for (const de of F)
      ...
      const D = !!T, N = ((he = p == null ? void 0 : p.system) == null ? void 0 : he.abilityType) ?? "", Y = N === "active" ? "Aktív" : N === "passive" ? "Passzív" : N || "—", W = N === "active", De = Number((be = p == null ? void 0 : p.system) == null ? void 0 : be.replaceCost) >= 0 ? Number(p.system.replaceCost) : 0, Z = (((ue = p == null ? void 0 : p.system) == null ? void 0 : ue.description) ?? "").trim(), ge = Z ? Z.length > 60 ? Z.slice(0, 57) + "…" : Z : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (p == null ? void 0 : p.name) ?? "—",
    ...
    const B = this.actor.system.abilities ?? {}, Se = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((p) => {
      var O, T, D;
      return {
        id: p.id,
        name: p.name,
    ...
    }), G = new Map(Se.map((p) => [p.id, p])), Te = "— Nincs képesség —", ae = (p) => {
      const O = B[p] ?? {}, T = (O.itemId ?? "").trim(), D = T ? G.get(T) : null, N = (D == null ? void 0 : D.description) ?? "", Y = (D == null ? void 0 : D.kp) ?? 0;
      return {
        itemId: T,
        displayName: (D == null ? void 0 : D.name) || O.name || Te,
        img: (D == null ? void 0 : D.img) || "",
        description: N,
        kp: Y
      };
    ...
    return e.abilityPassiveList = oe(le("passive")), e.abilityActiveList = oe(le("active")), e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-D940nnc-.mjs");
      c(this.actor, a);
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, a = l.dataset.skill, c = ((h = l.textContent) == null ? void 0 : h.trim()) || a, { openRollSheetForSkill: u } = await import("./roll-sheet-D940nnc-.mjs");
      u(this.actor, a, c);
      ...
      if (!h) return;
      const v = ((L = (q = this.actor.items).get) == null ? void 0 : L.call(q, h)) ?? ((k = (_ = this.actor.items.contents) == null ? void 0 : _.find) == null ? void 0 : k.call(_, (E) => E.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (l.checked) {
        ...
        let k = I.find((E) => {
          var j;
          return !((j = u[E]) != null && j.itemId);
        });
        const C = new Set(I);
        if (!k) {
          const E = v.find((j) => !C.has(j));
          if (!E) return;
          k = E, I.push(E);
        }
  ...
  _getFormDataForUpdate(s) {
    ...
    for (const y of n) {
      ...
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, K._healthStatusFromRatio(i, f));
    }
    return e;
  }
        ...
        if (u && u.documentName === "Item" && u.type === "Fegyver") {
          ...
          if (v) {
            const S = ((f = h.system) == null ? void 0 : f.weapons) ?? {}, q = (S.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], _ = q ? q.split(/\s*,\s*/).filter((C) => L.includes(C)) : [], k = _.filter((C) => {
              var E;
              return (((E = S[C]) == null ? void 0 : E.itemId) ?? "").trim() === I;
            });
            if (k.length > 0) {
              const E = {
              ...
              for (const j of k)
                E[`system.weapons.${j}.itemId`] = "", E[`system.weapons.${j}.name`] = "", E[`system.weapons.${j}.damage`] = "", E[`system.weapons.${j}.bonus`] = "";
              await h.update(E);
            }
          }
          return;
...
z(K, "PARTS", foundry.utils.mergeObject(
  M(K, K, "PARTS") ?? {},
  {
    content: { template: "systems/vacuum-of-the-void/templates/actor/karakter-sheet.hbs" }
  },
  { inplace: !1 }
)), z(K, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  M(K, K, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((yt = M(K, K, "DEFAULT_OPTIONS")) == null ? void 0 : yt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((gt = M(K, K, "DEFAULT_OPTIONS")) == null ? void 0 : gt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((bt = (ht = M(K, K, "DEFAULT_OPTIONS")) == null ? void 0 : ht.window) == null ? void 0 : bt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var me, Ce, Le, Pe, Ae, Fe, ke, pe;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((me = this.actor) == null ? void 0 : me.system), e.showDeathSkull = !1;
    const t = this.actor, r = ((Ce = t == null ? void 0 : t.items) == null ? void 0 : Ce.contents) ?? [], d = ((Le = t == null ? void 0 : t.system) == null ? void 0 : Le.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], o = (d.slotOrder ?? "").trim(), g = o ? o.split(/\s*,\s*/).filter((b) => n.includes(b)) : [], m = r.filter((b) => b.type === "Fegyver"), y = m.map((b) => ({ id: b.id, name: b.name, img: b.img })), f = "— Nincs fegyver —", i = [];
    for (const b of g.length ? g : n) {
      const F = (((Pe = d[b]) == null ? void 0 : Pe.itemId) ?? "").trim();
      if (!F || !m.some((B) => B.id === F)) continue;
      const A = y.find((B) => B.id === F);
      i.push({
        slotKey: b,
        itemId: F,
        displayName: (A == null ? void 0 : A.name) || ((Ae = d[b]) == null ? void 0 : Ae.name) || f,
        img: (A == null ? void 0 : A.img) || ""
      });
    }
    const l = new Set(i.map((b) => b.itemId)), a = m.filter(
      (b) => {
        var F, A;
        return (((F = b.system) == null ? void 0 : F.equipped) === !0 || ((A = b.system) == null ? void 0 : A.equipped) === "true") && !l.has(b.id);
      }
    ), c = new Set(i.map((b) => b.slotKey)), u = n.filter((b) => !c.has(b)), h = a.slice(0, u.length).map((b, F) => ({
      slotKey: u[F],
      itemId: b.id,
    ...
    e.weaponsTable = m.map((b) => {
      ...
      const F = b.id;
      let A = null, B = {};
      for (const we of slotKeys)
        if ((((Oe = d[we]) == null ? void 0 : Oe.itemId) ?? "").trim() === F) {
          A = we, B = d[we] ?? {};
          break;
        }
      const Se = !!A, G = (b == null ? void 0 : b.system) ?? {}, Te = typeof G.range == "string" ? (G.range || "").trim() : "", ae = G.type ?? "", le = (v[ae] ?? ae) || "—", oe = G.size ?? "", fe = (I[oe] ?? oe) || "", ye = [le, fe].filter(Boolean).join(", ") || le || "—", Ee = ae === "projectile" || oe === "thrown", Ne = G.quantity != null ? String(G.quantity).trim() : "1", $e = String(B.bonus ?? G.bonus ?? "").trim() || "0";
      return {
        slotKey: A ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const S = r.filter((b) => b.type === "Pancel");
    e.armorTable = S.map((b) => {
      var B;
      const F = (b == null ? void 0 : b.system) ?? {}, A = ((B = b.system) == null ? void 0 : B.equipped) === !0;
      return {
        itemId: b.id,
        actorId: t.id,
    ...
    const q = ((ke = (Fe = t == null ? void 0 : t.system) == null ? void 0 : Fe.gear) == null ? void 0 : ke.microchips) ?? {}, L = ["slot1", "slot2", "slot3"], _ = r.filter((b) => b.type === "MikroChip");
    e.microchipsTable = _.map((b) => {
      var ae, le, oe, fe;
      const F = b.id;
      let A = null;
      for (const ye of L)
        if ((((ae = q[ye]) == null ? void 0 : ae.itemId) ?? "").trim() === F) {
          A = ye;
          break;
        }
      const B = ((le = b == null ? void 0 : b.system) == null ? void 0 : le.abilityType) ?? "", Se = B === "active" ? "Aktív" : B === "passive" ? "Passzív" : B || "—", G = (((oe = b == null ? void 0 : b.system) == null ? void 0 : oe.description) ?? "").trim(), Te = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
        ...
        typeLabel: Se,
        description: Te,
        kp: Number((fe = b == null ? void 0 : b.system) == null ? void 0 : fe.replaceCost) >= 0 ? Number(b.system.replaceCost) : 0,
        isActive: B === "active",
        slotKey: A ?? "",
        equipped: !!A
      };
    ...
    e.itemsTable = k.map((b) => {
      const F = (b == null ? void 0 : b.system) ?? {}, A = (F.description ?? "").trim(), B = A ? A.length > 60 ? A.slice(0, 57) + "…" : A : "—";
      return {
        itemId: b.id,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const C = r.filter((b) => b.type === "Egyeb");
    e.egyebList = C.map((b) => {
      const A = (((b == null ? void 0 : b.system) ?? {}).description ?? "").trim(), B = A ? A.length > 80 ? A.slice(0, 77) + "…" : A : "";
      return {
        itemId: b.id,
        actorId: t.id,
        name: (b == null ? void 0 : b.name) ?? "—",
    ...
    const E = ((pe = t == null ? void 0 : t.system) == null ? void 0 : pe.abilities) ?? {}, j = r.filter((b) => b.type === "Kepesseg" || b.type === "ability").map((b) => {
      var F, A;
      return {
        id: b.id,
        name: b.name,
    ...
    }), H = new Map(j.map((b) => [b.id, b])), U = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    return e.abilityPassiveList = Q(ne("passive")), e.abilityActiveList = Q(ne("active")), e;
  }
  _attachFrameListeners(s) {
    var g, m, y;
    super._attachFrameListeners(s);
  ...
  async _onDropItem(s, e) {
    ...
    const r = ((C) => {
      var j;
      if (!C) return null;
      const E = C.uuid ?? C.documentUuid ?? ((j = C.data) == null ? void 0 : j.uuid) ?? (typeof C == "string" ? C : null);
      if (E) return E;
      if (typeof C == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((c = d.system) == null ? void 0 : c.kind) ?? "passive").toString(), j = ((u = n.system) == null ? void 0 : u.abilities) ?? {}, H = E === "active" ? "active" : "passive", U = Array.isArray((h = j[H]) == null ? void 0 : h.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
      U.includes(C) || U.push(C), await n.update({ [`system.abilities.${H}.items`]: U }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && m) {
      const C = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (C.slotOrder ?? "").trim(), H = j ? j.split(/\s*,\s*/).filter((Q) => E.includes(Q)) : [];
      let U = E.find((Q) => {
        var me;
        return !(((me = C[Q]) == null ? void 0 : me.itemId) ?? "").trim();
      });
      U || (U = E.find((Q) => !H.includes(Q)) ?? "slot1");
      const ne = H.includes(U) ? H : [...H, U].filter((Q) => E.includes(Q));
      await n.update({
        ...
        [`system.weapons.${U}.bonus`]: ((L = d.system) == null ? void 0 : L.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && m) {
      const C = ((k = (_ = n.system) == null ? void 0 : _.gear) == null ? void 0 : k.microchips) ?? {}, j = ["slot1", "slot2", "slot3"].find((H) => {
        var U;
        return !(((U = C[H]) == null ? void 0 : U.itemId) ?? "").trim();
      });
      j && await n.update({
...
//# sourceMappingURL=vacuum-of-the-void-Cv7xIRUE.mjs.map
