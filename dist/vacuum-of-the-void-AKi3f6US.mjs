...
var rs = Reflect.get;
var ns = (S, s, e) => s in S ? ss(S, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : S[s] = e;
var W = (S, s, e) => ns(S, typeof s != "symbol" ? s + "" : s, e);
var j = (S, s, e) => rs(is(S), e, s);
const { HTMLField: as, NumberField: O, SchemaField: K, StringField: I, BooleanField: Z, ArrayField: je } = foundry.data.fields;
...
const { NumberField: Be, SchemaField: os } = foundry.data.fields;
class cs extends Xt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: ls, NumberField: ws, StringField: ve } = foundry.data.fields;
...
const { BooleanField: us, StringField: He } = foundry.data.fields;
...
const { NumberField: ps, StringField: Et } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = te.map((g) => {
      ...
      const M = !!C, X = ((Lt = g.system) == null ? void 0 : Lt.equipped) !== void 0 && ((Pt = g.system) == null ? void 0 : Pt.equipped) !== null ? !!g.system.equipped : M, Q = (g == null ? void 0 : g.system) ?? {}, Me = typeof Q.range == "string" ? (Q.range || "").trim() : "", re = Q.type ?? "", Ce = (we[re] ?? re) || "—", fe = Q.size ?? "", Oe = (Ie[fe] ?? fe) || "", qe = [Ce, Oe].filter(Boolean).join(", ") || Ce || "—", be = re === "projectile" || fe === "thrown", ke = Q.quantity, Re = ke != null ? String(ke).trim() : "1", Ee = String(L.bonus ?? "").trim(), Ke = String(Q.bonus ?? "").trim(), ts = Ee || Ke || "0";
      return {
        slotKey: C ?? "",
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BasTTICA.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BasTTICA.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-BasTTICA.mjs");
      p(this.actor, o, a);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((p == null ? void 0 : p.type) === "Fegyver") {
        const v = a.system.weapons ?? {}, w = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = w ? w.split(/\s*,\s*/).filter((E) => T.includes(E)) : [], A = q.find((E) => {
          var D;
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            const w = ((b = p.system) == null ? void 0 : b.weapons) ?? {}, T = (w.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = T ? T.split(/\s*,\s*/).filter((D) => q.includes(D)) : [], E = A.filter((D) => {
              var F;
  ...
  async _rollWeapon(s) {
    ...
    const l = r && r.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, m = ((w = r == null ? void 0 : r.system) == null ? void 0 : w.type) || "kinetic", y = (((T = r == null ? void 0 : r.system) == null ? void 0 : T.skillKey) ?? "").trim(), b = y && n[y] !== void 0 ? y : m === "explosive" ? "grenadeUse" : "firearms", u = Number(n[b] || 0) || 0, i = f + u, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, a = new Roll(o);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: bs((x.level ?? "").toString().trim()),
        special: (x.special ?? x.other ?? "").toString().trim() || "—",
        equipped: R
      };
    });
    const v = ((Ie = (we = t == null ? void 0 : t.system) == null ? void 0 : we.gear) == null ? void 0 : Ie.microchips) ?? {}, w = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BasTTICA.mjs");
      o(this.actor, c);
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BasTTICA.mjs");
      a(this.actor, c, o);
  ...
  async _onDropItem(s, e) {
    var y, b, u, i, c, o, a, p, h, v, w, T, q, A, E, D, F;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = cs, CONFIG.Actor.dataModels.Npc = Xt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Nt, CONFIG.Item.dataModels.weapon = Nt, CONFIG.Item.dataModels.Pancel = ds, CONFIG.Item.dataModels.MikroChip = ms, CONFIG.Item.dataModels.Kepesseg = Ft, CONFIG.Item.dataModels.ability = Ft, CONFIG.Item.dataModels.Targy = fs, CONFIG.Item.dataModels.Egyeb = gs, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (l, f, m, y) => {
    ...
    const h = (P = game.votv) == null ? void 0 : P._lastKarakterSheetBlurSave, v = h && Date.now() - h.at < S ? h.appId : null;
    setTimeout(() => {
      for (const N of c)
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, w, T, q, A, E, D, F, P, N, H, z, G, te, Y, se, de, we, Ie, Se, Te;
    ...
    if (!n) return;
    const d = (v = game.messages) == null ? void 0 : v.get(n), r = (T = (w = d == null ? void 0 : d.flags) == null ? void 0 : w["vacuum-of-the-void"]) == null ? void 0 : T.weapon;
    if (!r) return;
...
function es() {
  ...
  for (const t of S)
    ((s = t == null ? void 0 : t.document) == null ? void 0 : s.documentName) !== "Actor" || ((e = t == null ? void 0 : t.document) == null ? void 0 : e.type) !== "Karakter" || typeof t.render == "function" && t.render(!0);
}
...
Hooks.on("renderChatMessageHTML", (S, s, e) => {
  var m, y, b, u;
  const t = ((m = S.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, n = t.resultType, d = t.critLabel, r = t.weaponAttack, l = t.weapon;
  if (!n && !d && !r) return;
  ...
  if (f) {
    ...
    if (r && l && (l.actorId || (b = S.speaker) != null && b.actor)) {
      ...
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = h != null && v ? `Sebzés (Találati Hely ${h} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((u = S.speaker) == null ? void 0 : u.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(S.id ?? ""), c.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-AKi3f6US.mjs.map
