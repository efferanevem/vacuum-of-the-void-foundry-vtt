...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalSpeed(i = null) {
    ...
    const e = i ?? this.form ?? this.element, t = (I) => {
      var S;
      return ((S = e == null ? void 0 : e.querySelector) == null ? void 0 : S.call(e, I)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${I}`) : null);
  ...
  async _prepareContext(i) {
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = (S.slotOrder ?? "").trim(), F = P ? P.split(/\s*,\s*/).filter((y) => q.includes(y)) : [], O = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, N = (((Ne = E.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), z = (((mt = E.slot2) == null ? void 0 : mt.itemId) ?? "").trim(), G = (((pt = E.slot3) == null ? void 0 : pt.itemId) ?? "").trim(), V = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-B_v7sCDf.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-B_v7sCDf.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-B_v7sCDf.mjs");
      f(this.actor, o, r);
      ...
      if (!h) return;
      const v = ((P = (q = this.actor.items).get) == null ? void 0 : P.call(q, h)) ?? ((O = (F = this.actor.items.contents) == null ? void 0 : F.find) == null ? void 0 : O.call(F, (N) => N.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (s) => {
      ...
      if ((f == null ? void 0 : f.type) === "Fegyver") {
        const v = r.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = I ? I.split(/\s*,\s*/).filter((F) => S.includes(F)) : [], P = q.find((F) => {
          var O;
          return (((O = v[F]) == null ? void 0 : O.itemId) ?? "").trim() === o;
        });
        if (P) {
          const F = q.filter((O) => O !== P);
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (r && r.documentName === "Item" && r.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = f.system) == null ? void 0 : b.weapons) ?? {}, S = (I.slotOrder ?? "").trim(), q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], P = S ? S.split(/\s*,\s*/).filter((O) => q.includes(O)) : [], F = P.filter((O) => {
              var E;
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-B_v7sCDf.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-B_v7sCDf.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-B_v7sCDf.mjs");
      r(this.actor, c, o);
      ...
      const o = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, f = (Array.isArray((P = o[s]) == null ? void 0 : P.items) ? o[s].items.slice() : []).filter((F) => F !== c);
  ...
  async _rollWeapon(i) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((S = e.system) == null ? void 0 : S.weapons) ?? {})[i] ?? {}, d = ((q = e.system) == null ? void 0 : q.skills) ?? {}, a = ((P = e.items) == null ? void 0 : P.filter((E) => E.type === "Fegyver")) ?? [];
    let l = null;
  ...
  async _onDropItem(i, e) {
    var g, b, u, s, c, o, r, f, h, v, I, S, q, P, F, O, E;
    ...
    if (d.type === "Fegyver" && p) {
      const N = ((q = a.system) == null ? void 0 : q.weapons) ?? {}, z = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (N.slotOrder ?? "").trim(), H = G ? G.split(/\s*,\s*/).filter((Y) => z.includes(Y)) : [];
      let V = z.find((Y) => {
        var R;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (m, p, g, b) => {
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((S = p == null ? void 0 : p.system) != null && S.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((P = (q = m.system) == null ? void 0 : q.combat) == null ? void 0 : P.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, S, q, P, F, O, E, N, z, G, H, V, Z, Y, R, W, oe, ge, re, Re;
...
//# sourceMappingURL=vacuum-of-the-void-CV1_nJYE.mjs.map
