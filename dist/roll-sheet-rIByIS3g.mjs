import { V as K, c as ae } from "./vacuum-of-the-void-QghTGnMG.mjs";
class U extends Application {
  ...
  constructor(t = {}) {
    ...
    super(t), this._actor = e, this._skillKey = s ?? "", this._label = i ?? s ?? "", this._baseModifier = Number(m) || 0, this._injuryModifier = Number(_) || 0, this._injuryPenalty = Number(h) || 0, this._isWeaponAttack = !!a, this._isInitiativeRoll = !!u, this._weaponSlotKey = f || "", this._weaponItemId = r || "", this._weaponDamageFormula = typeof l == "string" ? l.trim() : "";
  }
  get actor() {
    return this._actor;
  }
  ...
  _bindRollSheetListeners() {
    ...
    const h = s.querySelector(".roll-sheet-morale-wrap"), a = Math.min(3, Math.max(0, parseInt(((g = h == null ? void 0 : h.dataset) == null ? void 0 : g.moraleMax) ?? "3", 10) || 0)), u = s.querySelector("input[name='moraleDice']"), f = s.querySelectorAll(".roll-sheet-morale-d8"), r = (n) => {
  ...
  getData(t = {}) {
    var S, b, g, n, o, c, d, w, j, V, y, M, B, x;
    ...
    if (this._isWeaponAttack && ((n = (g = game.user) == null ? void 0 : g.targets) != null && n.size)) {
      const I = Array.from(game.user.targets)[0], k = (I == null ? void 0 : I.actor) ?? null;
      a = (k == null ? void 0 : k.name) || (I == null ? void 0 : I.name) || "", (c = (o = k == null ? void 0 : k.statuses) == null ? void 0 : o.has) != null && c.call(o, "stunned") && (u = 1, f.push(game.i18n.localize("VOTV.RollSheet.AdvantageStunnedTarget"))), (w = (d = k == null ? void 0 : k.statuses) == null ? void 0 : d.has) != null && w.call(d, "dodge") && (l = 1, r.push(game.i18n.localize("VOTV.StatusDodge")));
    }
    (V = (j = e == null ? void 0 : e.statuses) == null ? void 0 : j.has) != null && V.call(j, "diseased") && r.push(game.i18n.localize("VOTV.StatusDiseased")), (M = (y = e == null ? void 0 : e.statuses) == null ? void 0 : y.has) != null && M.call(y, "poisoned") && r.push(game.i18n.localize("VOTV.StatusPoisoned"));
  ...
  _getCurrentWeaponBaseModifier() {
    ...
    const t = this.actor.id ? game.actors.get(this.actor.id) ?? this.actor : this.actor, s = (((p = t.system) == null ? void 0 : p.weapons) ?? {})[this._weaponSlotKey] ?? {}, i = ((S = (v = t.items) == null ? void 0 : v.filter) == null ? void 0 : S.call(v, (n) => n.type === "Fegyver")) ?? [], m = (s.itemId ?? "").trim(), _ = m ? i.find((n) => n.id === m) ?? null : null, h = _ != null ? ((b = _.system) == null ? void 0 : b.bonus) ?? s.bonus : s.bonus, a = Number(h ?? 0) || 0, u = this._skillKey, f = ((g = t.system) == null ? void 0 : g.skills) ?? {}, r = Number(f[u] ?? 0) || 0;
    let l = 0;
  ...
  async _doRoll(t) {
    var s, i, m, _, h, a, u, f, r, l, p, v, S;
    const e = this.actor;
    if (e)
      try {
        const b = t.querySelector("[name='moraleDice']"), g = t.querySelector("[name='advantage']"), n = t.querySelector("[name='constantBonus']"), o = Math.min(3, Math.max(0, parseInt((b == null ? void 0 : b.value) ?? "0", 10) || 0)), c = Math.max(0, Number(((i = (s = e.system) == null ? void 0 : s.resources) == null ? void 0 : i.morale) ?? 0) || 0), d = Math.min(o, c), w = Math.min(3, Math.max(-3, parseInt((g == null ? void 0 : g.value) ?? "0", 10) || 0)), j = parseInt((n == null ? void 0 : n.value) ?? "0", 10) || 0, V = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, y = this._isWeaponAttack ? 0 : this._injuryModifier, M = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, x = ((_ = (m = e.statuses) == null ? void 0 : m.has) == null ? void 0 : _.call(m, "diseased")) || ((a = (h = e.statuses) == null ? void 0 : h.has) == null ? void 0 : a.call(h, "poisoned")) ? -1 : 0, N = V + y + M + j + x, I = [
          "3d6",
          w > 0 ? `+${w}d6` : w < 0 ? `-${Math.abs(w)}d6` : "",
          d > 0 ? `+${d}d8` : "",
          N !== 0 ? N > 0 ? `+${N}` : `${N}` : ""
        ].filter(Boolean).join(" "), k = new Roll(I);
        ...
        if (this._isWeaponAttack && ((f = (u = game.user) == null ? void 0 : u.targets) != null && f.size)) {
          ...
          if (L) {
            const O = ((r = L.system) == null ? void 0 : r.combat) ?? {}, X = Number(O.defense ?? 0) || 0, Z = Number(O.defenseBonus ?? 0) || 0, ee = Number(O.givenProtection ?? 0) || 0, te = (p = (l = L.statuses) == null ? void 0 : l.has) != null && p.call(l, "lookaround") ? 1 : 0;
            let W = 0;
            if (L.type === "Karakter") {
            ...
            const $ = X + Z + ee + W + te, z = (Number(k.total ?? 0) || 0) >= $, se = L.name ?? R.name ?? "Célpont";
            let D = null, T = null;
...
function ie(P, t, e) {
  var a, u;
  if (!P) return;
  const s = Number(((u = (a = P.system) == null ? void 0 : a.skills) == null ? void 0 : u[t]) ?? 0) || 0, i = K.BODY_PART_BY_SKILL[t] ? K._getSkillHealthStatusStatic(P, t) : void 0;
  let m = 0;
  i === 1 ? m = -6 : i === 2 && (m = -3);
...
function re(P, t) {
  var w, j, V, y, M, B, x, N;
  if (!P || !t) return;
  const e = P != null && P.id ? game.actors.get(P.id) ?? P : P, i = (((w = e.system) == null ? void 0 : w.weapons) ?? {})[t] ?? {}, m = ((j = e.system) == null ? void 0 : j.skills) ?? {}, _ = ((y = (V = e.items) == null ? void 0 : V.filter) == null ? void 0 : y.call(V, (I) => I.type === "Fegyver")) ?? [], h = (i.itemId ?? "").trim(), a = h ? _.find((I) => I.id === h) ?? null : null, u = ((a == null ? void 0 : a.name) ?? i.name ?? "").trim() || "Fegyver", f = a != null ? ((M = a.system) == null ? void 0 : M.bonus) ?? i.bonus : i.bonus, r = Number(f ?? 0) || 0, l = ((B = a == null ? void 0 : a.system) == null ? void 0 : B.type) || "kinetic", p = (((x = a == null ? void 0 : a.system) == null ? void 0 : x.skillKey) ?? "").trim(), v = p && m[p] !== void 0 ? p : l === "explosive" ? "grenadeUse" : "firearms", S = Number(m[v] || 0) || 0, b = r + S;
  let g = 0;
  if (e.type === "Karakter") {
    const I = K._getSkillHealthStatusStatic(e, v);
    I === 1 ? g = -6 : I === 2 && (g = -3);
  }
...
//# sourceMappingURL=roll-sheet-rIByIS3g.mjs.map
