...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var We, Ye, Je, Qe, k, P, x, j, ce, Q, Ie, be, Se, ke, Le, Ne, dt, mt, pt, ft, Xe, $e, Lt, Nt, Pt, At, Ft, Et, $t, xt, Rt, Mt, Kt, jt, Ht, zt;
    ...
    e.weaponItems = Y;
    const R = "— Nincs fegyver —", W = F.filter((y) => {
    ...
    e.weaponsTable = Z.map((y) => {
      ...
      let _ = null, q = {};
      for (const bt of F)
        if ((((Ut = T[bt]) == null ? void 0 : Ut.itemId) ?? "").trim() === D) {
          _ = bt, q = T[bt] ?? {};
          break;
        }
    ...
    }), He = new Map(st.map((y) => [y.id, y])), nt = "— Nincs képesség —", ze = (y) => {
    ...
    if (typeof he == "number" && he >= 0 && we.length > 0) {
      ...
      let _ = null;
      he <= y.max ? _ = y : he >= D.min ? _ = D : _ = we.find((q) => he >= q.min && he <= q.max), _ && (Ve = _.kp);
    }
    e.kpDots = rt.map((y, D) => {
      const _ = D + 1, q = !!Number(at[y]), M = _ <= Ve;
    ...
    return e.showHarcSection = ut, e.canEditInitiative = !!((zt = game.user) != null && zt.isGM), e.showInitiativeResult = typeof Oe == "number", e.initiativeResult = e.showInitiativeResult ? Oe : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-C_jXjfJr.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-C_jXjfJr.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-C_jXjfJr.mjs");
      f(this.actor, o, r);
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var He, nt, ze, Ue, Be, at, rt, Oe, he, ot, Ge, Ce, ht, we, qe, ct, lt, Ve, ut, We, Ye, Je, Qe;
    const e = await super._prepareContext(i) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((He = this.actor) == null ? void 0 : He.system), e.showDeathSkull = !1, e.sizeForSelect = (((ze = (nt = e.system) == null ? void 0 : nt.identity) == null ? void 0 : ze.size) ?? "").trim() || "Közepes";
    ...
    e.abilityPassiveList = z(G("passive")), e.abilityActiveList = z(G("active"));
    ...
    e.showHarcSection = Z;
    const Y = ((ct = e.system) == null ? void 0 : ct.resources) ?? {}, R = (Ve = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : Ve.initiativeResult, W = typeof R == "number" ? R : -1, oe = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ge = (We = (ut = e.system) == null ? void 0 : ut.combat) == null ? void 0 : We.initiativeRanges, re = Array.isArray(ge) ? ge.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(10, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (re.length > 0 ? re : oe).slice().sort((k, P) => k.min - P.min), se = 3;
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-C_jXjfJr.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-C_jXjfJr.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-C_jXjfJr.mjs");
      r(this.actor, c, o);
  ...
  async _onDropItem(i, e) {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const H = (((f = d.system) == null ? void 0 : f.kind) ?? "passive").toString(), G = ((h = a.system) == null ? void 0 : h.abilities) ?? {}, z = H === "active" ? "active" : "passive", V = Array.isArray((v = G[z]) == null ? void 0 : v.items) ? G[z].items.slice() : Array.isArray(G[z]) ? G[z].slice() : [];
      V.includes(N) || V.push(N), await a.update({ [`system.abilities.${z}.items`]: V }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (d.type === "Fegyver" && p) {
      const N = ((L = a.system) == null ? void 0 : L.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], G = (N.slotOrder ?? "").trim(), z = G ? G.split(/\s*,\s*/).filter((Y) => H.includes(Y)) : [];
      let V = H.find((Y) => {
        var R;
        return !(((R = N[Y]) == null ? void 0 : R.itemId) ?? "").trim();
      });
      V || (V = H.find((Y) => !z.includes(Y)) ?? "slot1");
      const Z = z.includes(V) ? z : [...z, V].filter((Y) => H.includes(Y));
      await a.update({
        ...
        [`system.weapons.${V}.bonus`]: ((F = d.system) == null ? void 0 : F.bonus) ?? ""
      });
    }
    if (d.type === "MikroChip" && p) {
      const N = ((E = (O = a.system) == null ? void 0 : O.gear) == null ? void 0 : E.microchips) ?? {}, G = ["slot1", "slot2", "slot3"].find((z) => {
        var V;
        return !(((V = N[z]) == null ? void 0 : V.itemId) ?? "").trim();
      });
      G && await a.update({
...
Hooks.once("init", () => {
  ...
  CONFIG.statusEffects = [
  ...
  ], foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", gt, {
    types: ["Karakter"],
    makeDefault: !0,
    ...
    var u;
    if ((m == null ? void 0 : m.type) === "Karakter") {
      const s = gt.getTotalSpeedRaw(m), c = (u = m.effects) == null ? void 0 : u.find((o) => {
        var r;
        return ((r = o.flags["vacuum-of-the-void"]) == null ? void 0 : r.immobilizedFromSpeed) === !0;
      });
      s <= 0 && !c ? m.createEmbeddedDocuments("ActiveEffect", [{
        name: "Mozgásképtelen (sebesség)",
        statuses: ["immobilized"],
        flags: { "vacuum-of-the-void": { immobilizedFromSpeed: !0 } },
        origin: m.uuid
      }]).catch((o) => console.warn("Vacuum of the Void | Immobilized effect create failed:", o)) : s > 0 && c && c.delete().catch((o) => console.warn("Vacuum of the Void | Immobilized effect delete failed:", o));
    }
  });
  const i = 500;
  Hooks.on("updateActor", (m, p, g, b) => {
    var T, L, A, F, O, E, N, H, G, z, V, Z, Y;
    ...
    if ((m.type === "Karakter" || m.type === "Npc") && ((T = p == null ? void 0 : p.system) != null && T.combat) && "initiativeResult" in p.system.combat) {
      const R = Number((A = (L = m.system) == null ? void 0 : L.combat) == null ? void 0 : A.initiativeResult), W = Number.isFinite(R) ? R : 0, oe = game.combat;
      if (oe) {
    ...
    for (const R of f)
      ((z = R.document) == null ? void 0 : z.id) !== u || ((V = R.document) == null ? void 0 : V.documentName) !== "Actor" || ((Z = R.constructor) == null ? void 0 : Z.name) !== "VoidKarakterSheet" || o.includes(R) || o.push(R);
    if (c && o.some((R) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, v, I, T, L, A, F, O, E, N, H, G, z, V, Z, Y, R, W, oe, ge, re, Re;
    ...
    const p = a.itemId ? ((H = (N = m.items) == null ? void 0 : N.get) == null ? void 0 : H.call(N, a.itemId)) ?? ((V = (z = (G = m.items) == null ? void 0 : G.contents) == null ? void 0 : z.find) == null ? void 0 : V.call(z, (ie) => ie.id === a.itemId)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-DiM2aj-Z.mjs.map
