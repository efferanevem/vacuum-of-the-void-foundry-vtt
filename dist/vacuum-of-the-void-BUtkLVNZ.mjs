...
var At = Reflect.get;
var Ft = (M, s, e) => s in M ? Pt(M, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : M[s] = e;
var z = (M, s, e) => Ft(M, typeof s != "symbol" ? s + "" : s, e);
var R = (M, s, e) => At(Et(M), e, s);
...
function ft(M) {
  ...
  const d = (i, r = 1) => {
    ...
    for (const c of i) {
      ...
      const b = !a && o >= 0 && (c.number === 3 || c.number === "3") ? (a = !0, s) : o >= 0 ? e : t;
      for (const v of y) {
...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const a = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((c = (o = a.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = a.currentHealth) == null ? void 0 : l.legs) ?? 0, u = U._healthStatusFromRatio(n, d), g = Number(((v = (b = (y = this.actor) == null ? void 0 : y.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const a = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, d = ((m = (g = a.hitLocations) == null ? void 0 : g[t]) == null ? void 0 : m.value) ?? 0, n = ((p = a.currentHealth) == null ? void 0 : p[t]) ?? 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-C56_FrMj.mjs");
      c(this.actor, o);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, c = ((y = r.textContent) == null ? void 0 : y.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-C56_FrMj.mjs");
      l(this.actor, o, c);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((l == null ? void 0 : l.type) === "Fegyver") {
        const b = c.system.weapons ?? {}, v = (b.slotOrder ?? "").trim(), S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], C = v ? v.split(/\s*,\s*/).filter((D) => S.includes(D)) : [], q = C.find((D) => {
          var w;
      ...
      if (r.checked) {
        ...
        let w = v.find((A) => {
          var j;
          return !((j = l[A]) != null && j.itemId);
        });
        const L = new Set(v);
        if (!w) {
          const A = b.find((j) => !L.has(j));
          if (!A) return;
          w = A, v.push(A);
        }
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((q = c == null ? void 0 : c.system) == null ? void 0 : q.damage) ?? "",
          [`system.weapons.${w}.bonus`]: ((D = c == null ? void 0 : c.system) == null ? void 0 : D.bonus) ?? ""
      ...
      v ? (C || (C = document.createElement("img"), C.className = "karakter-microchip-slot-thumb", C.alt = "", c == null || c.insertBefore(C, S)), C.src = v, C.style.display = "") : C && C.remove(), o == null || o.classList.remove("karakter-microchip-slot-open");
      ...
      const c = ((v = (b = this.actor.system) == null ? void 0 : b.gear) == null ? void 0 : v.microchips) ?? {}, y = ["slot1", "slot2", "slot3"].find((S) => {
        var C;
        return (((C = c[S]) == null ? void 0 : C.itemId) ?? "").trim() === r;
      });
      ...
      if (r.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${w}.damage`]: ((q = c.system) == null ? void 0 : q.damage) ?? "",
          [`system.weapons.${w}.bonus`]: ((D = c.system) == null ? void 0 : D.bonus) ?? ""
        }), await c.update({ "system.equipped": !0 });
      } else if (S) {
        const w = v.filter((L) => L !== S);
        await this.actor.update({
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((p = e.system) == null ? void 0 : p.kind) ?? "passive", a = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(s) {
    ...
    const u = n && n.name || t.name || `Fegyver (${s})`, g = Number(t.bonus || 0) || 0, p = (((v = n == null ? void 0 : n.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(a[p] || 0) || 0, i = g + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, c = new Roll(o);
  ...
  async _rollWeaponDamage(s, e = "") {
    var g, m, p, h, i, r, o, c, l, y;
    const t = this.actor;
    if (!t) return;
    let a = ((m = (g = t.items).get) == null ? void 0 : m.call(g, s)) ?? ((h = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : h.call(p, (b) => b.id === s));
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (t) {
      ...
      const r = document.activeElement, o = a.contains(r), c = r && (r.tagName === "INPUT" && r.type !== "checkbox" && r.type !== "radio" || r.tagName === "TEXTAREA");
      o && c && (d.focus = {
        name: r.name || null,
        id: r.id || null,
    ...
    const n = await super.render(s, e), u = this.element, g = this.form ?? this.element, m = d.scrollState, p = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      ...
      if (this._applyScrollState(u, m), (p == null ? void 0 : p.name) != null || (p == null ? void 0 : p.id) != null) {
        const c = ((r = g.querySelector) == null ? void 0 : r.call(g, p.id ? `#${CSS.escape(p.id)}` : null)) ?? (p.name ? (o = g.querySelector) == null ? void 0 : o.call(g, `[name="${CSS.escape(p.name)}"]`) : null);
  ...
  async _prepareContext(s) {
    ...
    const t = this.actor, a = ((Fe = t == null ? void 0 : t.items) == null ? void 0 : Fe.contents) ?? [], d = ((Ne = t == null ? void 0 : t.system) == null ? void 0 : Ne.weapons) ?? {}, n = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], u = (d.slotOrder ?? "").trim(), g = u ? u.split(/\s*,\s*/).filter((k) => n.includes(k)) : [], m = a.filter((k) => k.type === "Fegyver"), p = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), h = "— Nincs fegyver —", i = g.length > 0 ? g : n, r = n.filter((k) => !i.includes(k)), o = [...i, ...r], c = o.filter((k) => {
      var F;
    ...
    const D = a.filter((k) => k.type === "Egyeb");
    e.egyebList = D.map((k) => {
    ...
    }), j = new Map(A.map((k) => [k.id, k])), H = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-C56_FrMj.mjs");
      l(this.actor, o, c);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, c;
      i.preventDefault();
      ...
      const c = ((q = this.actor.system) == null ? void 0 : q.abilities) ?? {}, y = (Array.isArray((D = c[r]) == null ? void 0 : D.items) ? c[r].items.slice() : []).filter((w) => w !== o);
    ...
    const n = this, u = (i) => {
      ...
      var r, o, c;
      return i && (((o = (r = n.element) == null ? void 0 : r.contains) == null ? void 0 : o.call(r, i)) || n.id && ((c = i.closest) == null ? void 0 : c.call(i, `#${CSS.escape(n.id)}`)));
    };
    n._votvNpcBlur = (i) => {
      var y;
      const r = i.target;
      ...
      if (!g(c)) return;
      const l = i.relatedTarget;
      l && (c.contains(l) || n.id && ((y = l.closest) != null && y.call(l, `#${CSS.escape(n.id)}`))) || u(c);
    }, document.body.addEventListener("blur", n._votvNpcBlur, !0), n._votvNpcItemHookRegistered || (n._votvNpcItemUpdateHook = (i, r, o) => {
      var c;
      n.actor && ((c = i == null ? void 0 : i.parent) == null ? void 0 : c.id) === n.actor.id && n.render(!0);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const a = ((m = (g = t.items).get) == null ? void 0 : m.call(g, s)) ?? ((h = (p = t.items.contents) == null ? void 0 : p.find) == null ? void 0 : h.call(p, (b) => b.id === s));
    if (!a || a.type !== "Fegyver") return;
    let d = (((i = a.system) == null ? void 0 : i.damage) ?? "").trim();
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (y = (o = ui.notifications) == null ? void 0 : o.warn) == null || y.call(o, ((l = (c = game.i18n) == null ? void 0 : c.localize) == null ? void 0 : l.call(c, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var p, h, i, r, o, c, l, y, b, v, S, C, q, D, w;
    if (!this.actor) return (p = super._onDropItem) == null ? void 0 : p.call(this, s, e);
    const a = ((L) => {
      var j;
      if (!L) return null;
      const A = L.uuid ?? L.documentUuid ?? ((j = L.data) == null ? void 0 : j.uuid) ?? (typeof L == "string" ? L : null);
      if (A) return A;
      if (typeof L == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const A = (((c = d.system) == null ? void 0 : c.kind) ?? "passive").toString(), j = ((l = n.system) == null ? void 0 : l.abilities) ?? {}, H = A === "active" ? "active" : "passive", B = Array.isArray((y = j[H]) == null ? void 0 : y.items) ? j[H].items.slice() : Array.isArray(j[H]) ? j[H].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const L = ((S = n.system) == null ? void 0 : S.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (L.slotOrder ?? "").trim(), H = j ? j.split(/\s*,\s*/).filter((Q) => A.includes(Q)) : [];
      let B = A.find((Q) => {
        var pe;
    ...
    if (d.type === "MikroChip" && m) {
      const L = ((w = (D = n.system) == null ? void 0 : D.gear) == null ? void 0 : w.microchips) ?? {}, j = ["slot1", "slot2", "slot3"].find((H) => {
        var B;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", a = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = a > 0 ? `<p><strong>KP:</strong> ${a}</p>` : "", g = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${n}</p>
      ${u}
      ${g}
  ...
  async _postItemToChat(s) {
    ...
    if (e.type === "MikroChip") {
      ...
      if (a = (o === "active" ? "Aktív" : "Passzív") + " Mikro-Chip", o === "active") {
        const c = Number(((i = e.system) == null ? void 0 : i.replaceCost) ?? 0) || 0;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, g, m) => {
    ...
    const y = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, b = y && Date.now() - y.at < M ? y.appId : null;
    setTimeout(() => {
      for (const w of r)
    ...
    for (const [l, y] of Object.entries(h)) {
      ...
      !b || b !== n.id || (i[`system.weapons.${l}.name`] = n.name ?? "", i[`system.weapons.${l}.damage`] = ((o = n.system) == null ? void 0 : o.damage) ?? "", i[`system.weapons.${l}.bonus`] = ((c = n.system) == null ? void 0 : c.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (m = (g = e.target) == null ? void 0 : g.closest) == null ? void 0 : m.call(g, "[data-document-id]"), a = (p = t == null ? void 0 : t.getAttribute) == null ? void 0 : p.call(t, "data-document-id");
      if (!a) return;
    ...
    }, t = ((a = game.actors) == null ? void 0 : a.filter((p) => p.type === "Karakter")) ?? [];
    for (const p of t)
      try {
        const h = p.prototypeToken, i = ((d = h == null ? void 0 : h.bar1) == null ? void 0 : d.attribute) ?? "", r = ((n = h == null ? void 0 : h.bar2) == null ? void 0 : n.attribute) ?? "";
        (i || r) && await p.update({
        ...
        console.warn("Vacuum of the Void | Prototype token update failed for", p.name, h);
      }
    for (const p of game.scenes ?? []) {
      const h = ((u = p.tokens) == null ? void 0 : u.filter((i) => {
        const r = i.actor;
        return r && r.type === "Karakter";
      })) ?? [];
      for (const i of h)
        try {
          const r = ((g = i.bar1) == null ? void 0 : g.attribute) ?? "", o = ((m = i.bar2) == null ? void 0 : m.attribute) ?? "";
          (r || o) && await i.update(e);
        } catch (r) {
          console.warn("Vacuum of the Void | Token update failed for", i.name, r);
        }
    }
  })();
});
...
//# sourceMappingURL=vacuum-of-the-void-BUtkLVNZ.mjs.map
