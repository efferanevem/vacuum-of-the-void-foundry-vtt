...
const { HTMLField: $t, NumberField: E, SchemaField: j, StringField: w, BooleanField: X, ArrayField: He } = foundry.data.fields;
...
const { NumberField: zt, StringField: dt } = foundry.data.fields;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Se, oe, de, ce, ye, ge, Me, je, Re, Ke, qe, Te, tt, st, it, rt, at, nt;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), q = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], O = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = O && typeof O == "object" && !Array.isArray(O) ? O : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = C.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = C.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), H = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
    ...
    e.actionsTable = H;
    const U = (((tt = this.actor.items) == null ? void 0 : tt.contents) ?? []).filter((y) => y.type === "Fegyver"), J = U.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = J;
    ...
    const we = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).filter((y) => y.type === "MikroChip"), fe = we.map((y) => ({ id: y.id, name: y.name, img: y.img })), De = "— Nincs Mikro-Chip —", Oe = ["slot1", "slot2", "slot3"], Ie = (y) => {
      var _, P, M;
      const D = [];
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((nt = this.actor.items) == null ? void 0 : nt.contents) ?? []).map((y) => {
      var D, _, P;
      return {
        id: y.id,
        name: y.name,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-C3R6i4pq.mjs");
      n(this.actor, a);
    ...
    d && o({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: l } = await import("./roll-sheet-C3R6i4pq.mjs");
      l(this.actor, a, n);
...
const V = class V extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-C3R6i4pq.mjs");
      l(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
...
G(se, "PARTS", foundry.utils.mergeObject(R(se, se, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((_t = R(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : _t.form) ?? {}, { submitOnChange: !1 })
}));
let Qe = se;
var Dt;
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = jt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Kt, CONFIG.Item.dataModels.Pancel = Ut, CONFIG.Item.dataModels.MikroChip = Bt, CONFIG.Item.dataModels.Kepesseg = mt, CONFIG.Item.dataModels.ability = mt, CONFIG.Item.dataModels.Targy = Gt, CONFIG.Item.dataModels.Egyeb = Yt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
async function yt(L) {
  var r, a, n, l, p, b, v, I, q, O, C, T, S, A, F, H, U;
  ...
  if (!e || !t) {
    const J = (s.dataset.messageId ?? "").trim(), z = J ? (n = game.messages) == null ? void 0 : n.get(J) : null, Z = (p = (l = z == null ? void 0 : z.flags) == null ? void 0 : l["vacuum-of-the-void"]) == null ? void 0 : p.weapon;
  ...
  if (!u) return;
  const f = t ? ((I = (v = u.items) == null ? void 0 : v.get) == null ? void 0 : I.call(v, t)) ?? ((C = (O = (q = u.items) == null ? void 0 : q.contents) == null ? void 0 : O.find) == null ? void 0 : C.call(O, (J) => J.id === t)) : null;
...
Hooks.on("ready", () => {
  var s, e;
  document.body.addEventListener("click", yt);
  const L = document.querySelector("#chat-log");
  L && L.addEventListener("click", yt), document.body.addEventListener(
    "dragstart",
    (t) => {
      var u, f, m, g, h, i;
  ...
  if (f) {
    ...
    if (c && u && (u.actorId || (h = L.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(u.actorId ?? ((i = L.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(u.itemId ?? ""), p.dataset.slotKey = String(u.slotKey ?? ""), p.dataset.targetName = String(u.targetName ?? ""), p.dataset.hitLocationName = String(u.hitLocationName ?? ""), p.dataset.messageId = String(L.id ?? ""), a.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-DmWxQOL7.mjs.map
