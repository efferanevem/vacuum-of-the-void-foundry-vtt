...
function ft(E) {
  ...
  d(E.terms, 1);
  const o = s.filter((i) => i === 6).length, l = s.filter((i) => i === 1).length, f = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, g = o + f, h = l + m;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((c = s.querySelector) == null ? void 0 : c.call(s, "form.votv.karakter-sheet")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, "form.votv")) ?? null, t = ((o = s.querySelector) == null ? void 0 : o.call(s, ".votv-scroll")) ?? ((l = s.querySelector) == null ? void 0 : l.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const u = document.activeElement, p = o.contains(u), b = u && (u.tagName === "INPUT" && u.type !== "checkbox" && u.type !== "radio" || u.tagName === "TEXTAREA");
      p && b && (l.focus = {
        name: u.name || null,
        id: u.id || null,
    ...
    const m = this.element, g = this.form ?? this.element, h = l.scrollState, i = l.focus, r = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", a = () => {
      var u, p;
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    const s = (((c = (t = this.actor) == null ? void 0 : t.items) == null ? void 0 : c.contents) ?? []).filter(
      (o) => {
        var l;
        return o.type === "Pancel" && ((l = o.system) == null ? void 0 : l.equipped) === !0;
      }
    );
    let e = 0;
    for (const o of s) {
      const l = String(((d = o.system) == null ? void 0 : d.speedPenalty) ?? "").trim().replace(",", "."), f = Number(l);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const o of s) {
      const l = String(((d = o.system) == null ? void 0 : d.protectionBonus) ?? "").trim().replace(",", "."), f = Number(l);
      Number.isFinite(f) && (e += f);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    var h, i, r, a, n, u, p, b, v;
    const e = s ?? this.form ?? this.element;
    let t = (h = e == null ? void 0 : e.querySelector) == null ? void 0 : h.call(e, ".karakter-given-speed-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-speed-effective`)), !t) return;
    const c = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((n = (a = c.hitLocations) == null ? void 0 : a.legs) == null ? void 0 : n.value) ?? 0, o = ((u = c.currentHealth) == null ? void 0 : u.legs) ?? 0, l = B._healthStatusFromRatio(o, d), f = Number(((v = (b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((o = this.actor.system) == null ? void 0 : o.resources) ?? {}, c = ((f = (l = t.hitLocations) == null ? void 0 : l[e]) == null ? void 0 : f.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const c = ((l = s == null ? void 0 : s.system) == null ? void 0 : l.resources) ?? {}, d = ((m = (f = c.hitLocations) == null ? void 0 : f[t]) == null ? void 0 : m.value) ?? 0, o = ((g = c.currentHealth) == null ? void 0 : g[t]) ?? 0;
    return B._healthStatusFromRatio(o, d);
  }
  async _prepareContext(s) {
    var Se, oe, de, ce, ye, ge, Me, je, Re, Ke, qe, Te, tt, st, it, rt, nt, at;
    ...
    e.stressOver10 = t > 10;
    const c = this.actor.system.resources ?? {}, d = c.hitLocations ?? {}, o = c.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const D = ((ce = d[y]) == null ? void 0 : ce.value) ?? 0, _ = o[y] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), O = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, C = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ke = C.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((qe = C.slot2) == null ? void 0 : qe.itemId) ?? "").trim(), A = (((Te = C.slot3) == null ? void 0 : Te.itemId) ?? "").trim(), K = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      ...
      for (let _e = 0; _e < O.length; _e++) {
        ...
        if ((((le = b[Ee]) == null ? void 0 : le.itemId) ?? "") === y.id) {
          L = _e + 1, M = ((be = b[Ee]) == null ? void 0 : be.bonus) ?? "", J = Ee;
          break;
        }
      }
      let Y = null;
      _ && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : A === y.id && (Y = "slot3"));
      const Le = D && ((ke = y.system) != null && ke.damage) ? y.system.damage : "", ee = D && typeof ((me = y.system) == null ? void 0 : me.range) == "string" ? (y.system.range || "").trim() : "", he = J ? Number((pe = b[J]) == null ? void 0 : pe.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.weaponItems = Z;
    const G = "— Nincs fegyver —", V = O.filter((y) => {
      const _ = ((b[y] ?? {}).itemId ?? "").trim();
      return _ ? !!H.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = V.map((y, D) => {
      const _ = b[y] ?? {}, L = (_.itemId ?? "").trim(), M = Z.find((J) => J.id === L);
      return {
        slotKey: y,
        itemId: L,
        slotNum: D + 1,
    ...
    e.microchipItemsSlot1 = fe.filter((y) => !Ie(1).includes(y.id)), e.microchipItemsSlot2 = fe.filter((y) => !Ie(2).includes(y.id)), e.microchipItemsSlot3 = fe.filter((y) => !Ie(3).includes(y.id)), e.microchipSlots = Oe.map((y) => {
      const D = C[y] ?? {}, _ = (D.itemId ?? "").trim(), L = we.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
      ...
      const D = `slot${y}`, _ = C[D] ?? {}, L = (_.itemId ?? "").trim(), M = fe.find((J) => J.id === L);
      e[`microchip${y}ItemId`] = L, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || De, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    ...
    const Ce = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      ...
      const D = Ce[y] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? F.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BSnOUK1u.mjs");
      n(this.actor, a);
      ...
      if (!a) {
        ...
        if (!b) return;
        a = (((((u = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : u.weapons) ?? {})[b] ?? {}).itemId ?? "").trim();
      }
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, a = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || a, { openRollSheetForSkill: u } = await import("./roll-sheet-BSnOUK1u.mjs");
      u(this.actor, a, n);
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!a) return;
      const n = this.actor, u = n.items.get(a), p = {};
      ...
      const u = this.actor.system.weapons ?? {}, p = (u.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = p ? p.split(/\s*,\s*/).filter((T) => b.includes(T)) : [], I = v.find((T) => {
        var S;
        return (((S = u[T]) == null ? void 0 : S.itemId) ?? "").trim() === a;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let T = v.find((A) => {
      ...
      var T;
      i.preventDefault();
      const r = i.currentTarget, a = r.closest(".karakter-microchip-slot-select-wrap"), n = a == null ? void 0 : a.querySelector(".karakter-microchip-slot-display"), u = n == null ? void 0 : n.dataset.slot;
      if (!u) return;
    ...
    const l = this, f = (i) => {
      ...
      const a = ((u = (n = r.system) == null ? void 0 : n.resources) == null ? void 0 : u.currentHealth) != null || ((b = (p = r.system) == null ? void 0 : p.resources) == null ? void 0 : b.hitLocations) != null;
      l.actor.update(r).then(() => {
        a && setTimeout(() => l.render(!0), 260);
      }).catch((v) => console.warn("VoidKarakterSheet save failed", v));
    }, m = (i) => {
      var r, a, n;
      return i && (((a = (r = l.element) == null ? void 0 : r.contains) == null ? void 0 : a.call(r, i)) || l.id && ((n = i.closest) == null ? void 0 : n.call(i, `#${CSS.escape(l.id)}`)));
    };
    l._votvBlur = (i) => {
      var p;
      const r = i.target;
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (u && u.documentName === "Item" && (u.type === "Kepesseg" || u.type === "ability")) {
          ...
          const b = (((o = u.system) == null ? void 0 : o.kind) ?? "passive").toString(), v = this.actor.system.abilities ?? {};
          if (b === "species") {
            await this.actor.update({
    ...
    if (e) {
      ...
      if (n) {
        ...
        if (u && u.documentName === "Item" && (u.type === "Targy" || u.type === "Egyeb")) {
          const p = this.actor;
          ((a = u.parent) == null ? void 0 : a.id) !== p.id && await p.createEmbeddedDocuments("Item", [u.toObject()]);
          return;
        }
      }
    }
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const d = this.actor.items.contents.slice().sort((h, i) => {
      ...
      return r - a;
    }).map((h) => h.id), o = d.indexOf(t), l = d.indexOf(e);
    if (o === -1 || l === -1) return;
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", c = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    const o = this.actor.system.abilities ?? {}, l = Array.isArray((h = o[e]) == null ? void 0 : h.items) ? o[e].items.slice() : Array.isArray(o[e]) ? o[e].slice() : [];
  ...
  async _rollWeapon(s) {
    ...
    const l = o && o.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, g = (((v = o == null ? void 0 : o.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(c[g] || 0) || 0, i = f + h, a = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, n = new Roll(a);
    await n.evaluate({ async: !0 });
    const { resultType: u, label: p } = ft(n), b = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return n.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (p = (a = ui.notifications) == null ? void 0 : a.warn) == null || p.call(a, ((u = (n = game.i18n) == null ? void 0 : n.localize) == null ? void 0 : u.call(n, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const o = new Roll(d);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const o = await super.render(s, e), l = this.element, f = this.form ?? this.element, m = d.scrollState, g = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var r, a;
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const ue = !!x, W = (k == null ? void 0 : k.system) ?? {}, Se = typeof W.range == "string" ? (W.range || "").trim() : "", oe = W.type ?? "", de = (u[oe] ?? oe) || "—", ce = W.size ?? "", ye = (p[ce] ?? ce) || "", ge = [de, ye].filter(Boolean).join(", ") || de || "—", Me = oe === "projectile" || ce === "thrown", je = W.quantity != null ? String(W.quantity).trim() : "1", Re = String(W.bonus ?? U.bonus ?? "").trim() || "0", Ke = (W.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: F,
        actorId: t.id,
    ...
    const v = ((xe = ($e = t == null ? void 0 : t.system) == null ? void 0 : $e.gear) == null ? void 0 : xe.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], O = c.filter((k) => k.type === "MikroChip");
    e.microchipsTable = O.map((k) => {
      ...
      const U = ((de = k == null ? void 0 : k.system) == null ? void 0 : de.abilityType) ?? "", ue = U === "active" ? "Aktív" : U === "passive" ? "Passzív" : U || "—", W = (((ce = k == null ? void 0 : k.system) == null ? void 0 : ce.description) ?? "").trim(), Se = W ? W.length > 60 ? W.slice(0, 57) + "…" : W : "—";
      return {
        itemId: F,
        actorId: t.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    const C = c.filter((k) => k.type === "Egyeb");
    e.egyebList = C.map((k) => {
    ...
    const S = ((Ce = t == null ? void 0 : t.system) == null ? void 0 : Ce.abilities) ?? {}, A = c.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var F, x;
      return {
        id: k.id,
        name: k.name,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      var u, p, b, v;
      i.preventDefault();
      const r = (p = (u = i.currentTarget) == null ? void 0 : u.closest) == null ? void 0 : p.call(u, ".karakter-weapon-slot"), a = (((b = r == null ? void 0 : r.dataset) == null ? void 0 : b.itemId) ?? "").trim();
      ...
      var u;
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget, a = (((u = r == null ? void 0 : r.dataset) == null ? void 0 : u.slot) ?? "").trim();
      if (!a || !this.actor) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-BSnOUK1u.mjs");
      n(this.actor, a);
    }), t.on("click", ".karakter-weapon-damage", async (i) => {
      ...
      !a && ((u = r == null ? void 0 : r.dataset) != null && u.slot) && (a = (((((b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.weapons) ?? {})[r.dataset.slot] ?? {}).itemId ?? "").trim()), !(!a || !this.actor) && await this._rollWeaponDamage(a, (((v = r == null ? void 0 : r.dataset) == null ? void 0 : v.slot) ?? "").trim());
    }), t.on("click", ".karakter-skill-label", async (i) => {
      var p, b;
      i.preventDefault();
      ...
      if (!a || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-BSnOUK1u.mjs");
      u(this.actor, a, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var a, n;
      i.preventDefault();
      ...
      u && (p[`system.weapons.${u}.itemId`] = "", p[`system.weapons.${u}.name`] = "", p[`system.weapons.${u}.damage`] = "", p[`system.weapons.${u}.bonus`] = ""), Object.keys(p).length && await n.update(p), await n.deleteEmbeddedDocuments("Item", [a]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (i) => {
      var a, n;
      if (i.preventDefault(), !i.altKey) return;
      ...
      if (!r || !this.actor) return;
      const a = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, u = ["slot1", "slot2", "slot3"].find((O) => {
        var q;
    ...
    o._votvNpcBlur = (i) => {
      ...
      if (!f(n)) return;
      const u = i.relatedTarget;
      u && (n.contains(u) || o.id && ((p = u.closest) != null && p.call(u, `#${CSS.escape(o.id)}`))) || l(n);
  ...
  async _preClose(s) {
    ...
    if (e && this.actor) {
      ...
      Object.keys(o).length > 0 && await this.actor.update(o).catch((l) => console.warn("VoidNpcSheet save on preClose failed", l));
    }
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, a, n, u, p, b, v, I, O, q, C, T;
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      if (((r = d.parent) == null ? void 0 : r.id) !== o.id) {
        ...
        S = ((a = (await o.createEmbeddedDocuments("Item", [Z]))[0]) == null ? void 0 : a.id) ?? S;
      }
      const A = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), N = ((u = o.system) == null ? void 0 : u.abilities) ?? {}, K = A === "active" ? "active" : "passive", H = Array.isArray((p = N[K]) == null ? void 0 : p.items) ? N[K].items.slice() : Array.isArray(N[K]) ? N[K].slice() : [];
      H.includes(S) || H.push(S), await o.update({ [`system.abilities.${K}.items`]: H }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    const m = (v = (await o.createEmbeddedDocuments("Item", [l]))[0]) == null ? void 0 : v.id;
    if (d.type === "Fegyver" && m) {
      const S = ((I = o.system) == null ? void 0 : I.weapons) ?? {}, A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), K = N ? N.split(/\s*,\s*/).filter((G) => A.includes(G)) : [];
      let H = A.find((G) => {
        var V;
    ...
    if (d.type === "MikroChip" && m) {
      const S = ((T = (C = o.system) == null ? void 0 : C.gear) == null ? void 0 : T.microchips) ?? {}, N = ["slot1", "slot2", "slot3"].find((K) => {
        var H;
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", c = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), o = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", l = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${o}</p>
      ${l}
      ${f}
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (o) => {
      ...
      const l = ((n = (a = (r = foundry.applications) == null ? void 0 : r.apps) == null ? void 0 : a.FilePicker) == null ? void 0 : n.implementation) ?? globalThis.FilePicker;
      new l({
        type: "image",
    ...
    const c = (o) => {
      ...
      var l, f, m;
      return o && (((f = (l = e.element) == null ? void 0 : l.contains) == null ? void 0 : f.call(l, o)) || e.id && ((m = o.closest) == null ? void 0 : m.call(o, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (o) => {
      var f, m, g;
      const l = ((f = o.target) == null ? void 0 : f.form) ?? ((g = (m = o.target) == null ? void 0 : m.closest) == null ? void 0 : g.call(m, "form"));
      d(l) && c(l);
...
z(te, "PARTS", foundry.utils.mergeObject(R(te, te, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((St = R(te, te, "DEFAULT_OPTIONS")) == null ? void 0 : St.form) ?? {}, { submitOnChange: !1 })
}));
let Je = te;
var Tt;
...
z(re, "PARTS", foundry.utils.mergeObject(R(re, re, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Dt = R(re, re, "DEFAULT_OPTIONS")) == null ? void 0 : Dt.form) ?? {}, { submitOnChange: !0 })
}));
let Ze = re;
var Ot;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var n, u, p, b, v, I, O, q, C, T, S, A, N, K, H, Z, G;
    const t = (u = (n = e.target) == null ? void 0 : n.closest) == null ? void 0 : u.call(n, ".votv-weapon-damage-chat");
    if (!t || t.disabled) return;
    const c = (t.dataset.messageId ?? "").trim();
    if (!c) return;
    const d = (p = game.messages) == null ? void 0 : p.get(c), o = (v = (b = d == null ? void 0 : d.flags) == null ? void 0 : b["vacuum-of-the-void"]) == null ? void 0 : v.weapon;
    if (!(o != null && o.actorId) || !(o != null && o.itemId)) return;
    e.preventDefault(), e.stopPropagation();
    const l = (I = game.actors) == null ? void 0 : I.get(o.actorId);
    if (!l) return;
    const f = ((q = (O = l.items) == null ? void 0 : O.get) == null ? void 0 : q.call(O, o.itemId)) ?? ((S = (T = (C = l.items) == null ? void 0 : C.contents) == null ? void 0 : T.find) == null ? void 0 : S.call(T, (V) => V.id === o.itemId));
    if (!f || f.type !== "Fegyver") return;
    let m = (((A = f.system) == null ? void 0 : A.damage) ?? "").trim();
    if (!m && o.slotKey && (m = (((((N = l.system) == null ? void 0 : N.weapons) ?? {})[o.slotKey] ?? {}).damage ?? "").trim()), !m) {
    ...
    const h = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = o.targetName || "", r = o.hitLocationName || "";
    let a = i ? `${f.name} – sebzés – ${i}` : `${f.name} – sebzés`;
    ...
    (e) => {
      var o, l, f, m, g, h;
      if (!((l = (o = e.target) == null ? void 0 : o.closest) != null && l.call(o, "#actors"))) return;
    ...
    for (const i of t)
      try {
        const r = i.prototypeToken, a = ((l = r == null ? void 0 : r.bar1) == null ? void 0 : l.attribute) ?? "", n = ((f = r == null ? void 0 : r.bar2) == null ? void 0 : f.attribute) ?? "";
        (a || n) && await i.update({
...
Hooks.on("renderChatMessageHTML", (E, s, e) => {
  var m, g, h, i;
  const t = ((m = E.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, c = t.resultType, d = t.critLabel, o = t.weaponAttack, l = t.weapon;
  if (!c && !d && !o) return;
  ...
  if (f) {
    if (c && f.classList.add(`votv-${c}`), d) {
      ...
      if (r)
        ...
        const a = f.querySelector(".dice-total"), n = (a == null ? void 0 : a.parentElement) ?? f, u = document.createElement("div");
        u.className = `votv-crit-label votv-crit-label-${c || "neutral"}`, u.textContent = d, n.appendChild(u);
      }
    }
    if (o && l && (l.actorId || (h = E.speaker) != null && h.actor)) {
      ...
      if (!f.querySelector(".votv-weapon-outcome")) {
        ...
        u.textContent = p ? `Találat – ${b}` : `Nem talált – ${b}`, a.appendChild(u);
      }
      if (l.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(l.actorId ?? ((i = E.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(l.itemId ?? ""), p.dataset.slotKey = String(l.slotKey ?? ""), p.dataset.targetName = String(l.targetName ?? ""), p.dataset.hitLocationName = String(l.hitLocationName ?? ""), p.dataset.messageId = String(E.id ?? ""), a.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-fFcH-Joz.mjs.map
