...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    for (const y of l) {
      const _ = ((ke = d[y]) == null ? void 0 : ke.value) ?? 0, C = r[y] ?? 0;
    ...
    const a = (Number(((Ze = (Ce = this.actor.system) == null ? void 0 : Ce.combat) == null ? void 0 : Ze.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BnviFj5S.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BnviFj5S.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-BnviFj5S.mjs");
      p(this.actor, o, a);
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: g, label: b } = at(m), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      ...
      const fe = !!R, X = (k == null ? void 0 : k.system) ?? {}, Pe = typeof X.range == "string" ? (X.range || "").trim() : "", ye = X.type ?? "", ke = (a[ye] ?? ye) || "—", ge = X.size ?? "", _e = (p[ge] ?? ge) || "", Ce = [ke, _e].filter(Boolean).join(", ") || ke || "—", Ze = ye === "projectile" || ge === "thrown", Ve = X.quantity != null ? String(X.quantity).trim() : "1", et = String(X.bonus ?? U.bonus ?? "").trim() || "0", tt = (X.damage ?? U.damage ?? "").trim() || "";
      return {
        slotKey: R ?? "",
        itemId: F,
        actorId: t.id,
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BnviFj5S.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BnviFj5S.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BnviFj5S.mjs");
      a(this.actor, c, o);
...
Hooks.on("preCreateToken", (w, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = is((m = (f = d.system) == null ? void 0 : f.identity) == null ? void 0 : m.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
//# sourceMappingURL=vacuum-of-the-void-Ctu3jTkJ.mjs.map
