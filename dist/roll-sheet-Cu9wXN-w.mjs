import { V as ie, c as ze } from "./vacuum-of-the-void-B77b_pQi.mjs";
class pe extends Application {
  ...
  _updateFormulaPreview(t) {
    ...
    if (!e) return;
    const a = parseInt(((p = t.querySelector("input[name='advantage']")) == null ? void 0 : p.value) ?? "0", 10) || 0, i = parseInt(((T = t.querySelector("input[name='moraleDice']")) == null ? void 0 : T.value) ?? "0", 10) || 0, f = parseInt(((y = t.querySelector("input[name='constantBonus']")) == null ? void 0 : y.value) ?? "0", 10) || 0, k = parseInt(((I = t.dataset) == null ? void 0 : I.baseMod) ?? "0", 10) || 0, h = parseInt(((_ = t.dataset) == null ? void 0 : _.injuryMod) ?? "0", 10) || 0, s = parseInt(((o = t.dataset) == null ? void 0 : o.injuryPenalty) ?? "0", 10) || 0, u = ((l = (c = (r = this.actor) == null ? void 0 : r.statuses) == null ? void 0 : c.has) != null && l.call(c, "diseased") ? -1 : 0) + ((z = (V = (g = this.actor) == null ? void 0 : g.statuses) == null ? void 0 : V.has) != null && z.call(V, "poisoned") ? -1 : 0), m = k + h + s + f + u, n = [];
...
//# sourceMappingURL=roll-sheet-Cu9wXN-w.mjs.map
