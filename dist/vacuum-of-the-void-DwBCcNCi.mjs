...
var it = Reflect.get;
var st = (E, i, e) => i in E ? et(E, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : E[i] = e;
var U = (E, i, e) => st(E, typeof i != "symbol" ? i + "" : i, e);
var K = (E, i, e) => it(tt(E), e, i);
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((s = i.querySelector) == null ? void 0 : s.call(i, "form.votv.karakter-sheet")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, "form.votv")) ?? null, t = ((l = i.querySelector) == null ? void 0 : l.call(i, ".votv-scroll")) ?? ((u = i.querySelector) == null ? void 0 : u.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const k = this.element, b = this.form ?? this.element, v = u.scrollState, r = u.focus, o = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      var m, f;
      if (this._applyScrollState(k, v), (r == null ? void 0 : r.name) != null || (r == null ? void 0 : r.id) != null) {
        const h = ((m = b.querySelector) == null ? void 0 : m.call(b, r.id ? `#${CSS.escape(r.id)}` : null)) ?? (r.name ? (f = b.querySelector) == null ? void 0 : f.call(b, `[name="${CSS.escape(r.name)}"]`) : null);
    ...
    return (o || r) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), p;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (s <= 0 || t <= 0) return 0;
    const a = Math.floor(s / 3), l = Math.floor(2 * s / 3);
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((r = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : r.resources) ?? {}, a = ((c = (o = s.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, l = ((n = s.currentHealth) == null ? void 0 : n.legs) ?? 0, u = C._healthStatusFromRatio(l, a), p = Number(((h = (f = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : f.combat) == null ? void 0 : h.givenSpeed) ?? 0) || 0;
    let k;
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((l = this.actor.system) == null ? void 0 : l.resources) ?? {}, s = ((p = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : p.value) ?? 0, a = ((k = t.currentHealth) == null ? void 0 : k[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const s = ((u = i == null ? void 0 : i.system) == null ? void 0 : u.resources) ?? {}, a = ((k = (p = s.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : k.value) ?? 0, l = ((b = s.currentHealth) == null ? void 0 : b[t]) ?? 0;
  ...
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const s = this.actor.system.resources ?? {}, a = s.hitLocations ?? {}, l = s.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    ...
    const v = e.computedHealthStatus.legs ?? 3, r = Number(((Le = (_e = this.actor.system) == null ? void 0 : _e.combat) == null ? void 0 : Le.givenSpeed) ?? 0) || 0;
    let o;
    v === 0 ? o = 0 : v === 1 ? o = -6 : v === 2 ? o = -3 : o = r, e.effectiveGivenSpeed = o, e.system = foundry.utils.mergeObject(
    ...
    const n = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], f = (n.slotOrder ?? "").trim(), h = f ? f.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], y = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = y && typeof y == "object" && !Array.isArray(y) ? y : {}, N = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = (((Ne = I.slot2) == null ? void 0 : Ne.itemId) ?? "").trim(), O = ((($e = I.slot3) == null ? void 0 : $e.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
      const D = typeof d.sort == "number" ? d.sort : 0, L = typeof T.sort == "number" ? T.sort : 0;
      return D - L;
    }).map((d) => {
      var te, ne, oe, ie, se, re;
      ...
      const V = T && ((oe = d.system) != null && oe.damage) ? d.system.damage : "", Q = T && typeof ((ie = d.system) == null ? void 0 : ie.range) == "string" ? (d.system.range || "").trim() : "", Y = j ? Number((se = n[j]) == null ? void 0 : se.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (r) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-D4KE_AgX.mjs");
      n(this.actor, c);
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (r) => {
      ...
      var f;
      r.preventDefault();
      const o = r.currentTarget, c = o.dataset.skill, n = ((f = o.textContent) == null ? void 0 : f.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-D4KE_AgX.mjs");
      m(this.actor, c, n);
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      const o = r.currentTarget, c = o.dataset.itemId;
      if (!c) return;
      const n = this.actor.items.get(c);
      if (!n) return;
      ...
      var q, O;
      const o = r.currentTarget, c = (o.dataset.itemId ?? "").trim();
      if (!c) return;
      const n = this.actor.items.get(c);
      ...
      var w;
      r.preventDefault();
      const o = r.currentTarget, c = o.closest(".karakter-microchip-slot-select-wrap"), n = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), m = n == null ? void 0 : n.dataset.slot;
      if (!m) return;
      ...
      var h;
      if (r.preventDefault(), !r.altKey) return;
      const o = r.currentTarget.dataset.area, c = r.currentTarget.dataset.itemId;
      if (!o || !c) return;
    ...
    const u = this, p = (r) => {
      ...
      var o, c, n;
      return r && (((c = (o = u.element) == null ? void 0 : o.contains) == null ? void 0 : c.call(o, r)) || u.id && ((n = r.closest) == null ? void 0 : n.call(r, `#${CSS.escape(u.id)}`)));
    };
    u._votvBlur = (r) => {
      const o = r.target;
      if (!o || !o.form) return;
  ...
  _getFormDataForUpdate(i) {
    ...
    ), s = t.hitLocations ?? {}, a = t.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    for (const b of l) {
      const v = ((k = s[b]) == null ? void 0 : k.value) ?? 0, r = a[b] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${b}`, C._healthStatusFromRatio(r, v));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var l, u, p, k, b, v, r, o, c, n, m, f;
    const t = i.target, s = (l = t == null ? void 0 : t.closest) == null ? void 0 : l.call(t, ".karakter-ability-slot-single"), a = (u = t == null ? void 0 : t.closest) == null ? void 0 : u.call(t, ".karakter-ability-area");
    if (e) {
      ...
      if (h) {
        ...
        if (y && y.documentName === "Item" && y.type === "ability") {
          let I = y.id;
          ((k = y.parent) == null ? void 0 : k.id) !== this.actor.id && (I = ((b = (await this.actor.createEmbeddedDocuments("Item", [y.toObject()]))[0]) == null ? void 0 : b.id) ?? I);
    ...
    if (e) {
      ...
      if (h) {
        ...
        if (y && y.documentName === "Item" && y.type === "Fegyver") {
          ...
          if (N) {
            const O = ((f = I.system) == null ? void 0 : f.weapons) ?? {}, w = (O.slotOrder ?? "").trim(), A = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], x = w ? w.split(/\s*,\s*/).filter((J) => A.includes(J)) : [], P = x.filter((J) => {
              var H;
  ...
  _onWeaponSlotDragOver(i, e) {
    var a, l, u;
    const t = ((a = i.dataTransfer) == null ? void 0 : a.getData("text/plain")) || ((l = i.dataTransfer) == null ? void 0 : l.getData("application/json")) || "";
    let s;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((p = i.dataTransfer) == null ? void 0 : p.getData("text/plain")) || ((k = i.dataTransfer) == null ? void 0 : k.getData("application/json")) || "";
    let s;
    try {
      s = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
  ...
  async _onInventoryRowDrop(i, e) {
    var k, b;
    i.preventDefault(), (k = i.currentTarget) == null || k.classList.remove("karakter-actions-row-drag-over");
    const t = this._draggingInventoryItemId || ((b = i.dataTransfer) == null ? void 0 : b.getData("text/plain"));
    if (this._draggingInventoryItemId = null, !t || !e || t === e) return;
    const a = this.actor.items.contents.slice().sort((v, r) => {
      const o = typeof v.sort == "number" ? v.sort : 0, c = typeof r.sort == "number" ? r.sort : 0;
      return o - c;
  ...
  _onInventoryAreaDragOver(i) {
    ...
    t && t.type !== "Item" || (i.preventDefault(), (l = i.currentTarget) == null || l.classList.add("karakter-actions-table-drag-over"));
  }
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((b = e.system) == null ? void 0 : b.kind) ?? "passive", s = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, a = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), l = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", p = a ? `<p>${a}</p>` : "", k = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    var l, u, p;
    i.preventDefault(), (l = i.currentTarget) == null || l.classList.remove("karakter-ability-slot-drag-over");
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    if (!s || s.type !== "ability") return;
    let a = s.id;
    ((k = s.parent) == null ? void 0 : k.id) !== this.actor.id && (a = ((b = (await this.actor.createEmbeddedDocuments("Item", [s.toObject()]))[0]) == null ? void 0 : b.id) ?? a);
  ...
  async _rollSkill(i, e) {
    ...
    let a = Number(s) || 0;
    const l = this._getSkillHealthStatus(i);
    l === 1 ? a -= 6 : l === 2 && (a -= 3);
  ...
  async _rollWeapon(i) {
    var h;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, s = this.actor.system.skills ?? {}, a = this.actor.items.filter((y) => y.type === "Fegyver");
    let l = null;
    t.itemId && (l = a.find((y) => y.id === t.itemId) ?? null);
    const u = l && l.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, b = (((h = l == null ? void 0 : l.system) == null ? void 0 : h.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(s[b] || 0) || 0, r = p + v, c = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, n = new Roll(c);
  ...
  async _rollWeaponDamage(i, e = "") {
    var p, k, b, v, r, o, c, n, m, f;
    const t = this.actor;
    if (!t) return;
    let s = ((k = (p = t.items).get) == null ? void 0 : k.call(p, i)) ?? ((v = (b = t.items.contents) == null ? void 0 : b.find) == null ? void 0 : v.call(b, (h) => h.id === i));
    if (!s || s.type !== "Fegyver") return;
    let a = (((r = s.system) == null ? void 0 : r.damage) ?? "").trim();
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (a) => {
      ...
      var u, p, k;
      const l = ((u = a.target) == null ? void 0 : u.form) ?? ((k = (p = a.target) == null ? void 0 : p.closest) == null ? void 0 : k.call(p, "form"));
      s(l) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => t(l), 300));
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, u, p, k) => {
    ...
    if (!b) return;
    const v = document.activeElement, r = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), o = [], c = (y = game.actors) == null ? void 0 : y.get(b);
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (E) => {
      ...
      const i = (u = (l = E.target) == null ? void 0 : l.closest) == null ? void 0 : u.call(l, "[data-document-id]"), e = (p = i == null ? void 0 : i.getAttribute) == null ? void 0 : p.call(i, "data-document-id");
      if (!e) return;
...
Hooks.on("preCreateToken", (E, i, e) => {
  var l, u;
  const t = (l = game.votv) == null ? void 0 : l._dragSourceActorId, s = t ?? E.actorId ?? null;
...
//# sourceMappingURL=vacuum-of-the-void-DwBCcNCi.mjs.map
