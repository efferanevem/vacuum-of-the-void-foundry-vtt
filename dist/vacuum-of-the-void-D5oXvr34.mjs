...
const { BooleanField: lt, NumberField: yt, StringField: Q } = foundry.data.fields;
...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(r) {
    ...
    const l = this.actor.system.weapons ?? {}, m = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], h = (l.slotOrder ?? "").trim(), v = h ? h.split(/\s*,\s*/).filter((d) => m.includes(d)) : [], y = (Ae = this.actor.system.gear) == null ? void 0 : Ae.microchips, I = y && typeof y == "object" && !Array.isArray(y) ? y : {}, E = (((Fe = I.slot1) == null ? void 0 : Fe.itemId) ?? "").trim(), q = (((Ee = I.slot2) == null ? void 0 : Ee.itemId) ?? "").trim(), O = (((Ne = I.slot3) == null ? void 0 : Ne.itemId) ?? "").trim(), A = this.actor.items.contents.filter((d) => d.type !== "ability").slice().sort((d, T) => {
      ...
      for (let Z = 0; Z < v.length; Z++) {
        ...
        if ((((te = l[ee]) == null ? void 0 : te.itemId) ?? "") === d.id) {
          L = Z + 1, F = ((ne = l[ee]) == null ? void 0 : ne.bonus) ?? "", j = ee;
          break;
        }
      }
      let M = null;
    ...
    const W = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, Ze = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = x.map((d) => {
      var Z, ee, Re;
      const T = d.id;
      let D = null, L = {};
      for (const ue of v)
        if ((((Z = l[ue]) == null ? void 0 : Z.itemId) ?? "").trim() === T) {
          D = ue, L = l[ue] ?? {};
          break;
        }
      const F = !!D, j = ((ee = d.system) == null ? void 0 : ee.equipped) !== void 0 && ((Re = d.system) == null ? void 0 : Re.equipped) !== null ? !!d.system.equipped : F, M = (d == null ? void 0 : d.system) ?? {}, V = typeof M.range == "string" ? (M.range || "").trim() : "", X = M.type ?? "", Y = (W[X] ?? X) || "—", te = M.size ?? "", ne = (Ze[te] ?? te) || "", oe = [Y, ne].filter(Boolean).join(", ") || Y || "—", re = Y === "Lövedékes", se = M.quantity, ie = se != null ? String(se).trim() : "1";
      return {
        slotKey: D ?? "",
        itemId: T,
    ...
    const be = this.actor.system.abilities ?? {}, Qe = (((Ke = this.actor.items) == null ? void 0 : Ke.contents) ?? []).map((d) => {
      var T, D, L;
      return {
        id: d.id,
        name: d.name,
    ...
    }), ke = new Map(Qe.map((d) => [d.id, d])), Ve = "— Nincs képesség —", ve = (d) => {
  ...
  _attachFrameListeners(r) {
    ...
    a && s({ currentTarget: a }), this._writeEffectiveGivenSpeed(r), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (i) => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, l = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-ChG73Gd6.mjs");
      m(this.actor, c, l);
...
U(C, "PARTS", foundry.utils.mergeObject(K(C, C, "PARTS") ?? {}, {
  ...
  window: foundry.utils.mergeObject(((Ge = K(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : Ge.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((We = (ze = K(C, C, "DEFAULT_OPTIONS")) == null ? void 0 : ze.window) == null ? void 0 : We.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
U(G, "PARTS", foundry.utils.mergeObject(K(G, G, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Je = K(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : Je.form) ?? {}, { submitOnChange: !0 })
}));
let ye = G;
var Xe;
...
U(z, "PARTS", foundry.utils.mergeObject(K(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xe = K(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : Xe.form) ?? {}, { submitOnChange: !0 })
}));
let ge = z;
...
//# sourceMappingURL=vacuum-of-the-void-D5oXvr34.mjs.map
