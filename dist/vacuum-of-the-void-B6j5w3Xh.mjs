...
var _t = Reflect.get;
var qt = (F, i, e) => i in F ? St(F, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : F[i] = e;
var M = (F, i, e) => qt(F, typeof i != "symbol" ? i + "" : i, e);
var N = (F, i, e) => _t(Tt(F), e, i);
const { HTMLField: Ot, NumberField: _, SchemaField: P, StringField: v, BooleanField: U, ArrayField: le } = foundry.data.fields;
...
const { NumberField: fe, SchemaField: Ct } = foundry.data.fields;
class Lt extends Dt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Pt, NumberField: Kt, StringField: se } = foundry.data.fields;
...
const { BooleanField: Et, StringField: ce } = foundry.data.fields;
...
const { NumberField: $t, StringField: et } = foundry.data.fields;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Fe, Ee, Ae, Ne, $e, xe, je, Me, Re, Ke, Ue, He, Be, Ge, ze, We, Ye, Qe;
    ...
    const c = (Number(((Me = (je = this.actor.system) == null ? void 0 : je.combat) == null ? void 0 : Me.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    ...
    const b = this.actor.system.weapons ?? {}, S = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = (b.slotOrder ?? "").trim(), D = q ? q.split(/\s*,\s*/).filter((d) => S.includes(d)) : [], C = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), E = (((Ue = O.slot2) == null ? void 0 : Ue.itemId) ?? "").trim(), A = (((He = O.slot3) == null ? void 0 : He.itemId) ?? "").trim(), ft = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, I) => {
      ...
      for (let ie = 0; ie < D.length; ie++) {
        ...
        if ((((J = b[ae]) == null ? void 0 : J.itemId) ?? "") === d.id) {
          T = ie + 1, L = ((ee = b[ae]) == null ? void 0 : ee.bonus) ?? "", R = ae;
          break;
        }
      }
      let K = null;
      w && (k === d.id ? K = "slot1" : E === d.id ? K = "slot2" : A === d.id && (K = "slot3"));
      const re = I && ((te = d.system) != null && te.damage) ? d.system.damage : "", H = I && typeof ((X = d.system) == null ? void 0 : X.range) == "string" ? (d.system.range || "").trim() : "", V = R ? Number((Z = b[R]) == null ? void 0 : Z.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
    ...
    e.weaponItems = Se;
    const Te = "— Nincs fegyver —", yt = D.filter((d) => {
      const w = ((b[d] ?? {}).itemId ?? "").trim();
      return w ? !!ue.find((L) => L.id === w) : !1;
    });
    e.weaponSlots = yt.map((d, I) => {
      const w = b[d] ?? {}, T = (w.itemId ?? "").trim(), L = Se.find((R) => R.id === T);
      return {
        slotKey: d,
        itemId: T,
        slotNum: I + 1,
    ...
    const gt = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, ht = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" };
    e.weaponsTable = ue.map((d) => {
      var Je, Xe, Ze;
      const I = d.id;
      let w = null, T = {};
      for (const pe of D)
        if ((((Je = b[pe]) == null ? void 0 : Je.itemId) ?? "").trim() === I) {
          w = pe, T = b[pe] ?? {};
          break;
        }
      const L = !!w, R = ((Xe = d.system) == null ? void 0 : Xe.equipped) !== void 0 && ((Ze = d.system) == null ? void 0 : Ze.equipped) !== null ? !!d.system.equipped : L, K = (d == null ? void 0 : d.system) ?? {}, re = typeof K.range == "string" ? (K.range || "").trim() : "", H = K.type ?? "", V = (gt[H] ?? H) || "—", J = K.size ?? "", ee = (ht[J] ?? J) || "", te = [V, ee].filter(Boolean).join(", ") || V || "—", X = H === "projectile" || J === "thrown", Z = K.quantity, ne = Z != null ? String(Z).trim() : "1", ie = String(T.bonus ?? "").trim(), ae = ie !== "" ? ie : "0";
      return {
        slotKey: w ?? "",
        itemId: I,
    ...
    const bt = (((Ge = this.actor.items) == null ? void 0 : Ge.contents) ?? []).filter((d) => d.type === "Pancel");
    e.armorTable = bt.map((d) => {
      var T, L;
    ...
    const vt = (((ze = this.actor.items) == null ? void 0 : ze.contents) ?? []).filter((d) => d.type === "Targy");
    e.itemsTable = vt.map((d) => {
    ...
    const kt = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).filter((d) => d.type === "Egyeb");
    e.egyebList = kt.map((d) => {
    ...
    e.microchipItemsSlot1 = oe.filter((d) => !me(1).includes(d.id)), e.microchipItemsSlot2 = oe.filter((d) => !me(2).includes(d.id)), e.microchipItemsSlot3 = oe.filter((d) => !me(3).includes(d.id)), e.microchipSlots = qe.map((d) => {
      ...
      const I = `slot${d}`, w = O[I] ?? {}, T = (w.itemId ?? "").trim(), L = oe.find((R) => R.id === T);
      ...
      let w = null;
      for (const Z of qe)
        if ((((J = O[Z]) == null ? void 0 : J.itemId) ?? "").trim() === I) {
          w = Z;
          break;
        }
      const T = !!w, L = ((ee = d == null ? void 0 : d.system) == null ? void 0 : ee.abilityType) ?? "", R = L === "active" ? "Aktív" : L === "passive" ? "Passzív" : L || "—", K = L === "active", re = Number((te = d == null ? void 0 : d.system) == null ? void 0 : te.replaceCost) >= 0 ? Number(d.system.replaceCost) : 0, H = (((X = d == null ? void 0 : d.system) == null ? void 0 : X.description) ?? "").trim(), V = H ? H.length > 60 ? H.slice(0, 57) + "…" : H : "—";
      return {
        itemId: I,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const Oe = this.actor.system.abilities ?? {}, wt = (((Qe = this.actor.items) == null ? void 0 : Qe.contents) ?? []).map((d) => {
      var I, w, T;
      return {
        id: d.id,
        name: d.name,
    ...
    }), De = new Map(wt.map((d) => [d.id, d])), It = "— Nincs képesség —", Ce = (d) => {
      const I = Oe[d] ?? {}, w = (I.itemId ?? "").trim(), T = w ? De.get(w) : null, L = (T == null ? void 0 : T.description) ?? "", R = (T == null ? void 0 : T.kp) ?? 0;
      return {
        itemId: w,
        displayName: (T == null ? void 0 : T.name) || I.name || It,
        img: (T == null ? void 0 : T.img) || "",
        description: L,
        kp: R
      };
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-Cb6dRKzj.mjs");
      l(this.actor, o);
    ...
    p && r({ currentTarget: p }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, o = u.dataset.skill, l = ((g = u.textContent) == null ? void 0 : g.trim()) || o, { openRollSheetForSkill: c } = await import("./roll-sheet-Cb6dRKzj.mjs");
      c(this.actor, o, l);
      ...
      if (l) {
        ...
        if (c && c.documentName === "Item" && c.type === "Fegyver") {
          ...
          if (b) {
            ...
            if (k.length > 0) {
              const A = {
                "system.weapons.slotOrder": O.filter((j) => !k.includes(j)).join(",")
              };
              for (const j of k)
...
M(x, "PARTS", foundry.utils.mergeObject(N(x, x, "PARTS") ?? {}, {
  ...
  minWidth: 1e3,
  height: 800,
  form: foundry.utils.mergeObject(((st = N(x, x, "DEFAULT_OPTIONS")) == null ? void 0 : st.form) ?? {}, { submitOnChange: !1 }),
  window: foundry.utils.mergeObject(((rt = N(x, x, "DEFAULT_OPTIONS")) == null ? void 0 : rt.window) ?? {}, {
    resizable: !0,
    contentClasses: [
      ...((at = (nt = N(x, x, "DEFAULT_OPTIONS")) == null ? void 0 : nt.window) == null ? void 0 : at.contentClasses) ?? [],
      "votv-scroll"
    ]
  })
...
M(B, "PARTS", foundry.utils.mergeObject(N(B, B, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs" }
})), M(B, "DEFAULT_OPTIONS", foundry.utils.mergeObject(N(B, B, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Fegyver"],
  template: "systems/vacuum-of-the-void/templates/item/weapon-sheet.hbs",
  width: 550,
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ot = N(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : ot.form) ?? {}, { submitOnChange: !1 })
}));
let he = B;
var lt;
...
M(G, "PARTS", foundry.utils.mergeObject(N(G, G, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((lt = N(G, G, "DEFAULT_OPTIONS")) == null ? void 0 : lt.form) ?? {}, { submitOnChange: !1 })
}));
let be = G;
var ct;
...
M(z, "PARTS", foundry.utils.mergeObject(N(z, z, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ct = N(z, z, "DEFAULT_OPTIONS")) == null ? void 0 : ct.form) ?? {}, { submitOnChange: !1 })
}));
let ve = z;
var ut;
...
M(W, "PARTS", foundry.utils.mergeObject(N(W, W, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ut = N(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : ut.form) ?? {}, { submitOnChange: !0 })
}));
let ke = W;
var dt;
...
M(Y, "PARTS", foundry.utils.mergeObject(N(Y, Y, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((dt = N(Y, Y, "DEFAULT_OPTIONS")) == null ? void 0 : dt.form) ?? {}, { submitOnChange: !1 })
}));
let we = Y;
var mt;
...
M(Q, "PARTS", foundry.utils.mergeObject(N(Q, Q, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((mt = N(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : mt.form) ?? {}, { submitOnChange: !1 })
}));
let Ie = Q;
...
Hooks.once("init", () => {
  ...
  }, (i = CONFIG.Actor).dataModels ?? (i.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Lt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Ft, CONFIG.Item.dataModels.Pancel = At, CONFIG.Item.dataModels.MikroChip = Nt, CONFIG.Item.dataModels.Kepesseg = tt, CONFIG.Item.dataModels.ability = tt, CONFIG.Item.dataModels.Targy = xt, CONFIG.Item.dataModels.Egyeb = Mt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-B6j5w3Xh.mjs.map
