...
const { SchemaField: si, StringField: ii } = foundry.data.fields, { BooleanField: Hs, NumberField: ni, StringField: Ne } = foundry.data.fields;
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponItems = ae;
    const Se = "— Nincs fegyver —", fe = P.filter((g) => {
    ...
    e.weaponsTable = Q.map((g) => {
      ...
      const R = !!_, J = ((ns = g.system) == null ? void 0 : ns.equipped) !== void 0 && ((as = g.system) == null ? void 0 : as.equipped) !== null ? !!g.system.equipped : R, Y = (g == null ? void 0 : g.system) ?? {}, Ke = typeof Y.range == "string" ? (Y.range || "").trim() : "", le = Y.type ?? "", pe = (Ie[le] ?? le) || "—", De = Y.size ?? "", je = (re[De] ?? De) || "", ze = [pe, je].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || De === "thrown", qe = Y.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(Y.bonus ?? "").trim(), Es = Ve || pt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    const kt = ((Yt = e.system) == null ? void 0 : Yt.resources) ?? {}, Ge = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Fe = (Qt = (Xt = e.system) == null ? void 0 : Xt.combat) == null ? void 0 : Qt.initiativeResult, de = typeof Fe == "number" ? Fe : -1, wt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Pe = (Jt = (Zt = e.system) == null ? void 0 : Zt.combat) == null ? void 0 : Jt.initiativeRanges, Ae = Array.isArray(Pe) ? Pe.map((g) => ({ min: Number(g.min) ?? 0, max: Number(g.max) ?? 0, kp: Math.min(10, Math.max(0, Number(g.kp) ?? 0)) })) : [], Oe = (Ae.length > 0 ? Ae : wt).slice().sort((g, O) => g.min - O.min), Ee = Ae.map((g) => g.min), St = Ee.length ? Math.min(...Ee) : 0, It = Ee.length ? Math.max(...Ee) : 0;
    e.initiativeRanges = Ae.map((g) => ({ ...g, isFirst: g.min === St, isLast: g.min === It }));
    let Je = 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-DBZl9mgI.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-DBZl9mgI.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: f } = await import("./roll-sheet-DBZl9mgI.mjs");
      f(this.actor, c, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Xe, Qe, Ze, kt, Ge, Fe, de, wt, Pe, Ae, Nt, Oe, Ee, St, It, Je, Tt, et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-DBZl9mgI.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DBZl9mgI.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-DBZl9mgI.mjs");
      a(this.actor, o, c);
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: h, label: k } = At(f), S = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return f.toMessage({
...
X(se, "PARTS", foundry.utils.mergeObject(
  ...
  j(se, se, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((ws = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : ws.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Is = (Ss = j(se, se, "DEFAULT_OPTIONS")) == null ? void 0 : Ss.window) == null ? void 0 : Is.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (m, p, y, b) => {
    var I, D, L, C, N, x, P, z, H, B, W, ie, Z;
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, k, S, I, D, L, C, N, x, P, z, H, B, W, ie, Z, M, Q, ae, Se, fe, Ie;
...
//# sourceMappingURL=vacuum-of-the-void-Bng3Gjjp.mjs.map
