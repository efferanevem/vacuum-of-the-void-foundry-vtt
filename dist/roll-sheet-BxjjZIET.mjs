import { V as K, c as ae } from "./vacuum-of-the-void-CYPlPrRb.mjs";
class U extends Application {
  ...
  _bindRollSheetListeners() {
    var h, I, S, _, y;
    const t = this, e = this.id ?? "votv-roll-sheet", s = document.querySelector(`form.votv.roll-sheet[data-votv-roll-sheet="${CSS.escape(e)}"]`) ?? ((I = (h = this.element) == null ? void 0 : h.querySelector) == null ? void 0 : I.call(h, "form.votv.roll-sheet")) ?? ((_ = (S = this.element) == null ? void 0 : S.matches) != null && _.call(S, "form.votv.roll-sheet") ? this.element : null);
  ...
  _updateFormulaPreview(t) {
    var h, I, S, _, y, n, i, d, l, b, w, V;
    const e = t == null ? void 0 : t.querySelector(".roll-sheet-formula-preview");
    if (!e) return;
    const s = parseInt(((h = t.querySelector("input[name='advantage']")) == null ? void 0 : h.value) ?? "0", 10) || 0, u = parseInt(((I = t.querySelector("input[name='moraleDice']")) == null ? void 0 : I.value) ?? "0", 10) || 0, c = parseInt(((S = t.querySelector("input[name='constantBonus']")) == null ? void 0 : S.value) ?? "0", 10) || 0, v = parseInt(((_ = t.dataset) == null ? void 0 : _.baseMod) ?? "0", 10) || 0, p = parseInt(((y = t.dataset) == null ? void 0 : y.injuryMod) ?? "0", 10) || 0, a = parseInt(((n = t.dataset) == null ? void 0 : n.injuryPenalty) ?? "0", 10) || 0, m = (l = (d = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : d.has) != null && l.call(d, "diseased") || (V = (w = (b = this.actor) == null ? void 0 : b.statuses) == null ? void 0 : w.has) != null && V.call(w, "poisoned") ? -1 : 0, g = v + p + a + c + m, o = [];
  ...
  getData(t = {}) {
    var S, _, y, n, i, d, l, b, w, V, f, M, N, D;
    const e = this.actor, s = Math.max(0, Number(((_ = (S = e == null ? void 0 : e.system) == null ? void 0 : S.resources) == null ? void 0 : _.morale) ?? 0) || 0), u = this._baseModifier !== 0 ? this._baseModifier > 0 ? `+${this._baseModifier}` : String(this._baseModifier) : "", c = this._injuryModifier !== 0 ? this._injuryModifier > 0 ? `+${this._injuryModifier}` : String(this._injuryModifier) : "", v = this._injuryPenalty !== 0 ? String(this._injuryPenalty) : "", p = ["3d6", u, c, v].filter(Boolean).join(" ") || "3d6";
    let a = "", m = 0;
    const g = [], o = [];
    let r = 0;
  ...
  _getCurrentWeaponBaseModifier() {
    ...
    const t = this.actor.id ? game.actors.get(this.actor.id) ?? this.actor : this.actor, s = (((r = t.system) == null ? void 0 : r.weapons) ?? {})[this._weaponSlotKey] ?? {}, u = ((I = (h = t.items) == null ? void 0 : h.filter) == null ? void 0 : I.call(h, (y) => y.type === "Fegyver")) ?? [], c = (s.itemId ?? "").trim(), v = c ? u.find((y) => y.id === c) ?? null : null, p = Number(s.bonus ?? ((S = v == null ? void 0 : v.system) == null ? void 0 : S.bonus) ?? 0) || 0, a = this._skillKey, m = ((_ = t.system) == null ? void 0 : _.skills) ?? {}, g = Number(m[a] ?? 0) || 0;
    let o = 0;
    if (t.type === "Karakter" && a) {
      const y = K._getSkillHealthStatusStatic(t, a);
      y === 1 ? o = -6 : y === 2 && (o = -3);
    }
    return p + g + o;
  }
  async _doRoll(t) {
    var s, u, c, v, p, a, m, g, o, r, h, I, S;
    const e = this.actor;
    if (e)
      try {
        const _ = t.querySelector("[name='moraleDice']"), y = t.querySelector("[name='advantage']"), n = t.querySelector("[name='constantBonus']"), i = Math.min(3, Math.max(0, parseInt((_ == null ? void 0 : _.value) ?? "0", 10) || 0)), d = Math.max(0, Number(((u = (s = e.system) == null ? void 0 : s.resources) == null ? void 0 : u.morale) ?? 0) || 0), l = Math.min(i, d), b = Math.min(3, Math.max(-3, parseInt((y == null ? void 0 : y.value) ?? "0", 10) || 0)), w = parseInt((n == null ? void 0 : n.value) ?? "0", 10) || 0, V = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, f = this._isWeaponAttack ? 0 : this._injuryModifier, M = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, D = ((v = (c = e.statuses) == null ? void 0 : c.has) == null ? void 0 : v.call(c, "diseased")) || ((a = (p = e.statuses) == null ? void 0 : p.has) == null ? void 0 : a.call(p, "poisoned")) ? -1 : 0, L = V + f + M + w + D, x = [
          "3d6",
        ...
        if (this._isWeaponAttack && ((g = (m = game.user) == null ? void 0 : m.targets) != null && g.size)) {
          const R = Array.from(game.user.targets)[0], P = (R == null ? void 0 : R.actor) ?? null;
          if (P) {
            const O = ((o = P.system) == null ? void 0 : o.combat) ?? {}, X = Number(O.defense ?? 0) || 0, Z = Number(O.defenseBonus ?? 0) || 0, ee = Number(O.givenProtection ?? 0) || 0, te = (h = (r = P.statuses) == null ? void 0 : r.has) != null && h.call(r, "lookaround") ? 1 : 0;
            let W = 0;
            if (P.type === "Karakter") {
              const C = (((I = P.items) == null ? void 0 : I.contents) ?? []).filter(
                (q) => {
                  var A;
            ...
            const $ = X + Z + ee + W + te, z = (Number(k.total ?? 0) || 0) >= $, se = P.name ?? R.name ?? "Célpont";
            let B = null, T = null;
...
function ie(j, t, e) {
  var a, m;
  if (!j) return;
  const s = Number(((m = (a = j.system) == null ? void 0 : a.skills) == null ? void 0 : m[t]) ?? 0) || 0, u = K.BODY_PART_BY_SKILL[t] ? K._getSkillHealthStatusStatic(j, t) : void 0;
  let c = 0;
  u === 1 ? c = -6 : u === 2 && (c = -3);
...
//# sourceMappingURL=roll-sheet-BxjjZIET.mjs.map
