...
const { BooleanField: wi, NumberField: Fi, StringField: De } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    ...
    e.weaponSlots = V.map((y, _) => {
      const D = T[y] ?? {}, q = (D.itemId ?? "").trim(), M = Y.find((ee) => ee.id === q);
      return {
        slotKey: y,
        itemId: q,
        slotNum: _ + 1,
    ...
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      const _ = E[y] ?? {}, D = (_.itemId ?? "").trim(), q = se.find((M) => M.id === D);
      return {
        slotKey: y,
        itemId: D,
      ...
      const _ = `slot${y}`, D = E[_] ?? {}, q = (D.itemId ?? "").trim(), M = ne.find((ee) => ee.id === q);
      ...
      let D = null;
      for (const Te of Ke)
        if ((((ve = E[Te]) == null ? void 0 : ve.itemId) ?? "").trim() === _) {
          D = Te;
          break;
        }
    ...
    const Fe = this.actor.system.abilities ?? {}, st = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).map((y) => {
      ...
      const _ = Fe[y] ?? {}, D = (_.itemId ?? "").trim(), q = D ? He.get(D) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: D,
    ...
    const at = ((Nt = e.system) == null ? void 0 : Nt.resources) ?? {}, rt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (Pt = (At = e.system) == null ? void 0 : At.combat) == null ? void 0 : Pt.initiativeResult, he = typeof _e == "number" ? _e : -1, ot = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ge = (Et = (Ft = e.system) == null ? void 0 : Ft.combat) == null ? void 0 : Et.initiativeRanges, Oe = Array.isArray(Ge) ? Ge.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Oe.length > 0 ? Oe : ot).slice().sort((y, _) => y.min - _.min), Ce = Oe.map((y) => y.min), ct = Ce.length ? Math.min(...Ce) : 0, lt = Ce.length ? Math.max(...Ce) : 0;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BXECt9nB.mjs");
      a(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BXECt9nB.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-BXECt9nB.mjs");
      f(this.actor, o, a);
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var He, nt, Ue, ze, Be, at, rt, _e, he, ot, Ge, Oe, gt, we, Ce, ct, lt, We, ut, Ve, Ye, Je, Qe;
    ...
    const F = (((_e = e.weaponsTable) == null ? void 0 : _e.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ot = e.microchipsTable) == null ? void 0 : ot.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Oe = e.egyebList) == null ? void 0 : Oe.length) ?? 0) > 0;
  ...
  _attachFrameListeners(i) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BXECt9nB.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-BXECt9nB.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BXECt9nB.mjs");
      a(this.actor, c, o);
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = vi, CONFIG.Actor.dataModels.Npc = oi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Ht, CONFIG.Item.dataModels.weapon = Ht, CONFIG.Item.dataModels.Pancel = Si, CONFIG.Item.dataModels.MikroChip = Ti, CONFIG.Item.dataModels.Kepesseg = Bt, CONFIG.Item.dataModels.ability = Bt, CONFIG.Item.dataModels.Targy = _i, CONFIG.Item.dataModels.Egyeb = Ci, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
//# sourceMappingURL=vacuum-of-the-void-3-gFKj1y.mjs.map
