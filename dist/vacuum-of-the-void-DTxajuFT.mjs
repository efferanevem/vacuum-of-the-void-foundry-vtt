...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!r) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-CbC6DPX0.mjs");
      u(this.actor, r);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-CbC6DPX0.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', c), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var y;
      i.preventDefault();
      const o = i.currentTarget, r = o.dataset.skill, u = ((y = o.textContent) == null ? void 0 : y.trim()) || r, { openRollSheetForSkill: h } = await import("./roll-sheet-CbC6DPX0.mjs");
      h(this.actor, r, u);
...
const fe = class fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-CbC6DPX0.mjs");
      r(this.actor, o);
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CbC6DPX0.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: u } = await import("./roll-sheet-CbC6DPX0.mjs");
      u(this.actor, o, r);
...
const tt = class tt extends Et {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var o, r, u, h, y, v, k, w, T;
      const c = (o = e.querySelector) == null ? void 0 : o.call(e, "form"), p = (u = (r = c ?? e).querySelector) == null ? void 0 : u.call(r, 'select[name="system.identity.assignment"]'), d = (y = (h = c ?? e).querySelector) == null ? void 0 : y.call(h, "input.bazis-threat-total"), l = (k = (v = c ?? e).querySelector) == null ? void 0 : k.call(v, 'input[name="system.combat.threatBonus"]');
      if (!p || !d || !l) return;
      const m = p.value ?? "", g = t[m] ?? 0, a = Number(l.value ?? 0) || 0, i = g + a;
      d.value = i, (T = (w = this.actor) == null ? void 0 : w.update) == null || T.call(w, {
        "system.combat.threat": i,
        "system.combat.threatBonus": a
      });
    };
    $(e).on("change input", 'select[name="system.identity.assignment"], input[name="system.combat.threatBonus"]', n);
  }
  async _prepareContext(s) {
    var t;
    const e = await super._prepareContext(s);
...
//# sourceMappingURL=vacuum-of-the-void-DTxajuFT.mjs.map
