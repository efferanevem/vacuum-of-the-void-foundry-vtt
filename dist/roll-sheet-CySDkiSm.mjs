import { V as re, c as Pe } from "./vacuum-of-the-void-Css_gojV.mjs";
class fe extends Application {
  ...
  constructor(t = {}) {
    ...
    super(t), this._actor = e, this._skillKey = a ?? "", this._label = i ?? a ?? "", this._baseModifier = Number(v) || 0, this._injuryModifier = Number(S) || 0, this._injuryPenalty = Number(d) || 0, this._isWeaponAttack = !!s, this._isInitiativeRoll = !!m, this._weaponSlotKey = h || "", this._weaponItemId = o || "", this._weaponDamageFormula = typeof c == "string" ? c.trim() : "", this._blockHeavyInHalfCover = !!p, this._blockMediumHeavyInThreeQuarterCover = !!M, this._blockNonThrownInFullCover = !!b;
  }
  get actor() {
    return this._actor;
  }
  ...
  _bindRollSheetListeners() {
    var p, M, b, C, k;
    const t = this, e = this.id ?? "votv-roll-sheet", a = document.querySelector(`form.votv.roll-sheet[data-votv-roll-sheet="${CSS.escape(e)}"]`) ?? ((M = (p = this.element) == null ? void 0 : p.querySelector) == null ? void 0 : M.call(p, "form.votv.roll-sheet")) ?? ((C = (b = this.element) == null ? void 0 : b.matches) != null && C.call(b, "form.votv.roll-sheet") ? this.element : null);
    ...
    const d = a.querySelector(".roll-sheet-morale-wrap"), s = Math.min(3, Math.max(0, parseInt(((k = d == null ? void 0 : d.dataset) == null ? void 0 : k.moraleMax) ?? "3", 10) || 0)), m = a.querySelector("input[name='moraleDice']"), h = a.querySelectorAll(".roll-sheet-morale-d8"), o = (n) => {
      let r = Math.min(3, Math.max(0, parseInt(n, 10) || 0));
      r = Math.min(r, s), m && (m.value = String(r)), h.forEach((u, l) => {
  ...
  _updateFormulaPreview(t) {
    ...
    if (h !== 0) {
      const g = document.createElement("span");
      g.textContent = h > 0 ? ` + ${h}` : ` − ${Math.abs(h)}`, o.push(g);
    }
  ...
  getData(t = {}) {
    ...
    if ((L = (z = game.user) == null ? void 0 : z.targets) != null && L.size) {
      const T = Array.from(game.user.targets)[0], f = (T == null ? void 0 : T.actor) ?? null;
      if (s = (f == null ? void 0 : f.name) || (T == null ? void 0 : T.name) || "", f) {
        const $ = (((w = (g = f.system) == null ? void 0 : g.identity) == null ? void 0 : w.size) ?? "").toString().trim();
        [
          "Jármű (Kicsi)",
          "Jármű (Közepes)",
          "Jármű (Nagy)",
      ...
      (Z = (W = f == null ? void 0 : f.statuses) == null ? void 0 : W.has) != null && Z.call(W, "stunned") && (h += 1, o.push(game.i18n.localize("VOTV.RollSheet.AdvantageStunnedTarget"))), (Y = (P = f == null ? void 0 : f.statuses) == null ? void 0 : P.has) != null && Y.call(P, "unconscious") && (h += 1, o.push(game.i18n.localize("VOTV.StatusUnconscious"))), (X = (D = f == null ? void 0 : f.statuses) == null ? void 0 : D.has) != null && X.call(D, "grappled") && (h += 1, o.push(game.i18n.localize("VOTV.StatusGrappled"))), (A = (O = f == null ? void 0 : f.statuses) == null ? void 0 : O.has) != null && A.call(O, "dodge") && (p = 1, c.push(game.i18n.localize("VOTV.StatusDodge")));
    }
    let M = p;
  ...
  _getCurrentWeaponBaseModifier() {
    ...
    const t = this.actor, a = (((k = t.system) == null ? void 0 : k.weapons) ?? {})[this._weaponSlotKey] ?? {}, i = ((r = (n = t.items) == null ? void 0 : n.filter) == null ? void 0 : r.call(n, (y) => y.type === "Fegyver")) ?? [], v = (a.itemId ?? "").trim(), S = v ? i.find((y) => y.id === v) ?? null : null, d = (u = S == null ? void 0 : S.system) == null ? void 0 : u.bonus, s = a.bonus, m = d != null && String(d).trim() !== "", h = s != null && String(s).trim() !== "", c = Number(m ? d : h ? s : 0) || 0, p = this._skillKey, M = ((l = t.system) == null ? void 0 : l.skills) ?? {}, b = Number(M[p] ?? 0) || 0;
    let C = 0;
    if (t.type === "Karakter" && p) {
      const y = re._getSkillHealthStatusStatic(t, p);
      y === 1 ? C = -6 : y === 2 && (C = -3);
    }
    return c + b + C;
  }
  async _doRoll(t) {
    var a, i, v, S, d, s, m, h, o, c, p, M, b, C, k, n, r, u, l, y, z, L, g, w, W, Z, P, Y, D, X, O, A, Q, R, H, j, K, J, te, T, f;
    const e = this.actor;
    if (e) {
      if (this._isWeaponAttack && this._weaponSlotKey) {
        ...
        if ((s = (d = e.statuses) == null ? void 0 : d.has) != null && s.call(d, "fullcover") && E !== "thrown") {
          ...
          (h = (m = ui.notifications) == null ? void 0 : m.warn) == null || h.call(m, I);
          return;
        }
        if ((c = (o = e.statuses) == null ? void 0 : o.has) != null && c.call(o, "threequarteredcover") && (E === "medium" || E === "heavy")) {
          ...
          (M = (p = ui.notifications) == null ? void 0 : p.warn) == null || M.call(p, I);
          return;
        }
      ...
      try {
        ...
        if ((w = (g = game.user) == null ? void 0 : g.targets) != null && w.size) {
          ...
          if (_) {
            ...
            const je = Te + me + Ne + Ve + Fe, ce = Ce + ze + je + de, Be = Number(ne.total ?? 0) || 0, ue = !(((f = (T = _.statuses) == null ? void 0 : T.has) == null ? void 0 : f.call(T, "fullcover")) ?? !1) && Be >= ce, he = _.name ?? ae.name ?? "Célpont";
...
//# sourceMappingURL=roll-sheet-CySDkiSm.mjs.map
