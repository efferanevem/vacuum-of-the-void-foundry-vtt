...
var Ft = Reflect.get;
var Nt = (A, s, e) => s in A ? At(A, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : A[s] = e;
var z = (A, s, e) => Nt(A, typeof s != "symbol" ? s + "" : s, e);
var R = (A, s, e) => Ft(Et(A), e, s);
const { HTMLField: $t, NumberField: P, SchemaField: j, StringField: w, BooleanField: Q, ArrayField: He } = foundry.data.fields;
...
function ft(A) {
  ...
  d(A.terms, 1);
  const a = s.filter((i) => i === 6).length, u = s.filter((i) => i === 1).length, f = e.filter((i) => i === 6).length, m = t.filter((i) => i === 6).length, g = a + f, h = u + m;
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(s) {
    ...
    const e = ((c = s.querySelector) == null ? void 0 : c.call(s, "form.votv.karakter-sheet")) ?? ((d = s.querySelector) == null ? void 0 : d.call(s, "form.votv")) ?? null, t = ((a = s.querySelector) == null ? void 0 : a.call(s, ".votv-scroll")) ?? ((u = s.querySelector) == null ? void 0 : u.call(s, ".window-content")) ?? null;
  ...
  async render(s = !1, e = {}) {
    ...
    if (d) {
      ...
      const l = document.activeElement, p = a.contains(l), b = l && (l.tagName === "INPUT" && l.type !== "checkbox" && l.type !== "radio" || l.tagName === "TEXTAREA");
      p && b && (u.focus = {
        name: l.name || null,
        id: l.id || null,
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const a of s) {
      const u = String(((d = a.system) == null ? void 0 : d.speedPenalty) ?? "").trim().replace(",", "."), f = Number(u);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const a of s) {
      const u = String(((d = a.system) == null ? void 0 : d.protectionBonus) ?? "").trim().replace(",", "."), f = Number(u);
      Number.isFinite(f) && (e += f);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const c = ((r = (i = this.actor) == null ? void 0 : i.system) == null ? void 0 : r.resources) ?? {}, d = ((n = (o = c.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : n.value) ?? 0, a = ((l = c.currentHealth) == null ? void 0 : l.legs) ?? 0, u = B._healthStatusFromRatio(a, d), f = Number(((v = (b = (p = this.actor) == null ? void 0 : p.system) == null ? void 0 : b.combat) == null ? void 0 : v.givenSpeed) ?? 0) || 0;
    let m;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((a = this.actor.system) == null ? void 0 : a.resources) ?? {}, c = ((f = (u = t.hitLocations) == null ? void 0 : u[e]) == null ? void 0 : f.value) ?? 0, d = ((m = t.currentHealth) == null ? void 0 : m[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const c = ((u = s == null ? void 0 : s.system) == null ? void 0 : u.resources) ?? {}, d = ((m = (f = c.hitLocations) == null ? void 0 : f[t]) == null ? void 0 : m.value) ?? 0, a = ((g = c.currentHealth) == null ? void 0 : g[t]) ?? 0;
  ...
  async _prepareContext(s) {
    ...
    e.stressOver10 = t > 10;
    const c = this.actor.system.resources ?? {}, d = c.hitLocations ?? {}, a = c.currentHealth ?? {}, u = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of u) {
      const D = ((ye = d[y]) == null ? void 0 : ye.value) ?? 0, _ = a[y] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = (b.slotOrder ?? "").trim(), C = I ? I.split(/\s*,\s*/).filter((y) => v.includes(y)) : [], q = (Re = this.actor.system.gear) == null ? void 0 : Re.microchips, O = q && typeof q == "object" && !Array.isArray(q) ? q : {}, T = (((Ke = O.slot1) == null ? void 0 : Ke.itemId) ?? "").trim(), S = (((Fe = O.slot2) == null ? void 0 : Fe.itemId) ?? "").trim(), E = (((Pe = O.slot3) == null ? void 0 : Pe.itemId) ?? "").trim(), H = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      ...
      for (let Ae = 0; Ae < C.length; Ae++) {
        ...
        if ((((ge = b[xe]) == null ? void 0 : ge.itemId) ?? "") === y.id) {
          L = Ae + 1, M = ((Oe = b[xe]) == null ? void 0 : Oe.bonus) ?? "", J = xe;
          break;
        }
      }
      let Y = null;
      _ && (T === y.id ? Y = "slot1" : S === y.id ? Y = "slot2" : E === y.id && (Y = "slot3"));
    ...
    const Ee = this.actor.system.abilities ?? {}, k = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).map((y) => {
      var D, _, L;
      return {
        id: y.id,
        name: y.name,
      ...
      const D = Ee[y] ?? {}, _ = (D.itemId ?? "").trim(), L = _ ? N.get(_) : null, M = (L == null ? void 0 : L.description) ?? "", J = (L == null ? void 0 : L.kp) ?? 0;
      return {
        itemId: _,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-IHiXw_59.mjs");
      n(this.actor, o);
    ...
    d && c({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var p;
      i.preventDefault();
      const r = i.currentTarget, o = r.dataset.skill, n = ((p = r.textContent) == null ? void 0 : p.trim()) || o, { openRollSheetForSkill: l } = await import("./roll-sheet-IHiXw_59.mjs");
      l(this.actor, o, n);
      ...
      if (!p) return;
      const b = ((q = (C = this.actor.items).get) == null ? void 0 : q.call(C, p)) ?? ((T = (O = this.actor.items.contents) == null ? void 0 : O.find) == null ? void 0 : T.call(O, (E) => E.id === p));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      const l = this.actor.system.weapons ?? {}, p = (l.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], v = p ? p.split(/\s*,\s*/).filter((T) => b.includes(T)) : [], I = v.find((T) => {
        var S;
        return (((S = l[T]) == null ? void 0 : S.itemId) ?? "").trim() === o;
      }) ?? null;
      if (r.checked) {
        if (I) return;
        let T = v.find((E) => {
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((g = e.system) == null ? void 0 : g.kind) ?? "passive", c = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, d = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let a = d.id;
    ((g = d.parent) == null ? void 0 : g.id) !== this.actor.id && (a = ((h = (await this.actor.createEmbeddedDocuments("Item", [d.toObject()]))[0]) == null ? void 0 : h.id) ?? a), await this.actor.update({
  ...
  async _rollWeapon(s) {
    ...
    const u = a && a.name || t.name || `Fegyver (${s})`, f = Number(t.bonus || 0) || 0, g = (((v = a == null ? void 0 : a.system) == null ? void 0 : v.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(c[g] || 0) || 0, i = f + h, o = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, n = new Roll(o);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    if (!d && e && (d = (((((r = t.system) == null ? void 0 : r.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !d) {
      (p = (o = ui.notifications) == null ? void 0 : o.warn) == null || p.call(o, ((l = (n = game.i18n) == null ? void 0 : n.localize) == null ? void 0 : l.call(n, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const a = new Roll(d);
...
const Z = class Z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    const a = await super.render(s, e), u = this.element, f = this.form ?? this.element, m = d.scrollState, g = d.focus, h = typeof (m == null ? void 0 : m.formScrollTop) == "number" || typeof (m == null ? void 0 : m.windowScrollTop) == "number", i = () => {
      var r, o;
    ...
    return (h || g) && (requestAnimationFrame(i), setTimeout(i, 0), setTimeout(i, 50), setTimeout(i, 150), setTimeout(i, 300), setTimeout(i, 450)), a;
  }
  async _prepareContext(s) {
    var G, ee, we, le, ue, Ie, Se, de, te, me, V, pe, Ee;
    ...
    const S = ((Ee = t == null ? void 0 : t.system) == null ? void 0 : Ee.abilities) ?? {}, E = c.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var N, x;
      return {
        id: k.id,
        name: k.name,
    ...
    }), F = new Map(E.map((k) => [k.id, k])), H = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-IHiXw_59.mjs");
      l(this.actor, o, n);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var o, n;
      i.preventDefault();
      ...
      if (!r || !this.actor) return;
      const o = ((I = (v = this.actor.system) == null ? void 0 : v.gear) == null ? void 0 : I.microchips) ?? {}, l = ["slot1", "slot2", "slot3"].find((C) => {
        var q;
    ...
    a._votvNpcBlur = (i) => {
      ...
      if (!f(n)) return;
      const l = i.relatedTarget;
      l && (n.contains(l) || a.id && ((p = l.closest) != null && p.call(l, `#${CSS.escape(a.id)}`))) || u(n);
  ...
  async _onDropItem(s, e) {
    var g, h, i, r, o, n, l, p, b, v, I, C, q, O, T;
    if (!this.actor) return (g = super._onDropItem) == null ? void 0 : g.call(this, s, e);
    const c = ((S) => {
      var F;
      if (!S) return null;
      const E = S.uuid ?? S.documentUuid ?? ((F = S.data) == null ? void 0 : F.uuid) ?? (typeof S == "string" ? S : null);
      if (E) return E;
      if (typeof S == "object") {
    ...
    if (d.type === "Kepesseg" || d.type === "ability") {
      ...
      const E = (((n = d.system) == null ? void 0 : n.kind) ?? "passive").toString(), F = ((l = a.system) == null ? void 0 : l.abilities) ?? {}, H = E === "active" ? "active" : "passive", U = Array.isArray((p = F[H]) == null ? void 0 : p.items) ? F[H].items.slice() : Array.isArray(F[H]) ? F[H].slice() : [];
    ...
    if (d.type === "Fegyver" && m) {
      const S = ((I = a.system) == null ? void 0 : I.weapons) ?? {}, E = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], F = (S.slotOrder ?? "").trim(), H = F ? F.split(/\s*,\s*/).filter((G) => E.includes(G)) : [];
      let U = E.find((G) => {
        var ee;
        return !(((ee = S[G]) == null ? void 0 : ee.itemId) ?? "").trim();
      });
      U || (U = E.find((G) => !H.includes(G)) ?? "slot1");
      const X = H.includes(U) ? H : [...H, U].filter((G) => E.includes(G));
      await a.update({
  ...
  async _postAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((i = e.system) == null ? void 0 : i.kind) ?? "passive", c = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, d = (((o = e.system) == null ? void 0 : o.description) ?? "").trim(), a = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = c > 0 ? `<p><strong>KP:</strong> ${c}</p>` : "", f = d ? `<p>${d}</p>` : "", m = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${a}</p>
      ${u}
      ${f}
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (a) => {
      var m, g, h, i, r, o, n;
      if (!e.isEditable || !((g = (m = a.target) == null ? void 0 : m.closest) != null && g.call(m, ".profile")) && ((i = (h = a.target) == null ? void 0 : h.getAttribute) == null ? void 0 : i.call(h, "data-edit")) !== "img") return;
    ...
    const c = (a) => {
      ...
      var u, f, m;
      return a && (((f = (u = e.element) == null ? void 0 : u.contains) == null ? void 0 : f.call(u, a)) || e.id && ((m = a.closest) == null ? void 0 : m.call(a, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (a) => {
      var f, m, g;
      const u = ((f = a.target) == null ? void 0 : f.form) ?? ((g = (m = a.target) == null ? void 0 : m.closest) == null ? void 0 : g.call(m, "form"));
      d(u) && c(u);
...
Hooks.once("init", () => {
  ...
  }, (s = CONFIG.Actor).dataModels ?? (s.dataModels = {}), CONFIG.Actor.dataModels.Karakter = Mt, CONFIG.Actor.dataModels.Npc = qt, (e = CONFIG.Item).dataModels ?? (e.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Rt, CONFIG.Item.dataModels.Pancel = Ht, CONFIG.Item.dataModels.MikroChip = Ut, CONFIG.Item.dataModels.Kepesseg = mt, CONFIG.Item.dataModels.ability = mt, CONFIG.Item.dataModels.Targy = zt, CONFIG.Item.dataModels.Egyeb = Wt, (t = CONFIG.Actor).trackableAttributes ?? (t.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, b, v, I, C, q, O, T, S, E, F, H, U, X, G, ee, we, le, ue, Ie, Se, de, te;
    ...
    if (!a) return;
    const u = a.actorId ?? ((q = d == null ? void 0 : d.speaker) == null ? void 0 : q.actor) ?? "";
    if (!u) return;
    e.preventDefault(), e.stopPropagation();
    let f = ((O = game.actors) == null ? void 0 : O.get(a.actorId)) ?? ((T = game.actors) == null ? void 0 : T.get(u));
    if (f || (f = ((E = (S = game.scenes) == null ? void 0 : S.contents) == null ? void 0 : E.flatMap((V) => {
      var pe;
      return ((pe = V.tokens) == null ? void 0 : pe.contents) ?? [];
    }).map((V) => V.actor).find((V) => V && (V.id === u || V.id === a.actorId))) ?? null), !f) return;
    ...
    if (g || (g = (((ee = m == null ? void 0 : m.system) == null ? void 0 : ee.damage) ?? "").trim()), !g && a.slotKey && (g = (((((we = f.system) == null ? void 0 : we.weapons) ?? {})[a.slotKey] ?? {}).damage ?? "").trim()), !g) {
...
Hooks.on("preCreateToken", (A, s, e) => {
  var a, u;
  const t = (a = game.votv) == null ? void 0 : a._dragSourceActorId, c = t ?? A.actorId ?? null;
...
Hooks.on("renderTokenHUD", (A, s, e) => {
  var d;
  const t = A == null ? void 0 : A.object, c = ((d = t == null ? void 0 : t.document) == null ? void 0 : d.actor) ?? (t == null ? void 0 : t.actor);
...
Hooks.on("renderChatMessageHTML", (A, s, e) => {
  var m, g, h, i;
  const t = ((m = A.flags) == null ? void 0 : m["vacuum-of-the-void"]) ?? {}, c = t.resultType, d = t.critLabel, a = t.weaponAttack, u = t.weapon;
  if (!c && !d && !a) return;
  ...
  if (f) {
    ...
    if (a && u && (u.actorId || (h = A.speaker) != null && h.actor)) {
      ...
      if (u.isHit && !f.querySelector(".votv-weapon-damage-chat")) {
        ...
        p.textContent = b != null && v ? `Sebzés (Találati Hely ${b} - ${v})` : "Sebzés", p.dataset.actorId = String(u.actorId ?? ((i = A.speaker) == null ? void 0 : i.actor) ?? ""), p.dataset.itemId = String(u.itemId ?? ""), p.dataset.slotKey = String(u.slotKey ?? ""), p.dataset.targetName = String(u.targetName ?? ""), p.dataset.hitLocationName = String(u.hitLocationName ?? ""), p.dataset.messageId = String(A.id ?? ""), o.appendChild(p);
      }
    }
  }
});
...
//# sourceMappingURL=vacuum-of-the-void-B7IZS9tt.mjs.map
