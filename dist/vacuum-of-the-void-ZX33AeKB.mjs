...
const { HTMLField: hs, NumberField: O, SchemaField: K, StringField: S, BooleanField: se, ArrayField: Ve } = foundry.data.fields;
...
const { BooleanField: ws, StringField: ft } = foundry.data.fields;
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const tt = this.actor.system.abilities ?? {}, st = (((Lt = this.actor.items) == null ? void 0 : Lt.contents) ?? []).map((y) => {
      var _, D, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), Ke = new Map(st.map((y) => [y.id, y])), it = "— Nincs képesség —", je = (y) => {
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-99kVsXQk.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-99kVsXQk.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-99kVsXQk.mjs");
      p(this.actor, o, a);
...
const ne = class ne extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var st, Ke, it, je, He, Ue, nt, rt, _e, ge, at, ze, Ce, gt, we, Oe, ot, ct, Be, lt, Ge, We, Ye;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((st = this.actor) == null ? void 0 : st.system), e.showDeathSkull = !1, e.sizeForSelect = (((it = (Ke = e.system) == null ? void 0 : Ke.identity) == null ? void 0 : it.size) ?? "").trim() || "Közepes";
    ...
    const R = ((Oe = e.system) == null ? void 0 : Oe.resources) ?? {}, Y = (ct = (ot = e.system) == null ? void 0 : ot.combat) == null ? void 0 : ct.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], re = (lt = (Be = e.system) == null ? void 0 : Be.combat) == null ? void 0 : lt.initiativeRanges, fe = Array.isArray(re) ? re.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], ie = (fe.length > 0 ? fe : ve).slice().sort((k, F) => k.min - F.min), Z = fe.map((k) => k.min), ye = Z.length ? Math.min(...Z) : 0, et = Z.length ? Math.max(...Z) : 0;
    ...
    const Ee = ie.length > 0 ? ie[ie.length - 1] : null, yt = Ee ? Ee.kp : 6, tt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"];
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-99kVsXQk.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-99kVsXQk.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-99kVsXQk.mjs");
      a(this.actor, c, o);
...
//# sourceMappingURL=vacuum-of-the-void-ZX33AeKB.mjs.map
