...
const J = class J extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponItems = G;
    const Y = "— Nincs fegyver —", ee = E.filter((b) => {
      const L = ((_[b] ?? {}).itemId ?? "").trim();
      return L ? !!F.find((j) => j.id === L) : !1;
    });
    e.weaponSlots = ee.map((b, N) => {
      const L = _[b] ?? {}, P = (L.itemId ?? "").trim(), j = G.find((Ie) => Ie.id === P), oe = F.find((Ie) => Ie.id === P), te = (oe == null ? void 0 : oe.system) ?? {}, Xe = te.size === "thrown", be = (typeof te.range == "string" ? (te.range || "").trim() : "") || "—";
      return {
        slotKey: b,
        itemId: P,
        slotNum: N + 1,
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-CY5mCcPr.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-CY5mCcPr.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', l), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: g } = await import("./roll-sheet-CY5mCcPr.mjs");
      g(this.actor, c, a);
...
const me = class me extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    const E = d.filter((w) => w.type === "Targy");
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-CY5mCcPr.mjs");
      c(this.actor, o);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CY5mCcPr.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-CY5mCcPr.mjs");
      a(this.actor, o, c);
  ...
  async _onDropItem(s, e) {
    ...
    if (f.type === "Fegyver" && d) {
      const E = ((D = l.system) == null ? void 0 : D.weapons) ?? {}, H = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], B = (E.slotOrder ?? "").trim(), V = B ? B.split(/\s*,\s*/).filter((Q) => H.includes(Q)) : [];
      let W = H.find((Q) => {
        var k;
        return !(((k = E[Q]) == null ? void 0 : k.itemId) ?? "").trim();
      });
...
const pe = class pe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    e.weaponsTable = m.map((k) => {
      const F = (k == null ? void 0 : k.system) ?? {}, G = F.type ?? "", Y = (n[G] ?? G) || "—", ee = F.size ?? "", ae = (f[ee] ?? ee) || "", re = [Y, ae].filter(Boolean).join(", ") || Y || "—", se = G === "projectile" || ee === "thrown", le = F.quantity != null ? String(F.quantity).trim() : "1", fe = (typeof F.range == "string" ? (F.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: k.id,
        actorId: this.actor.id,
    ...
    e.microchipsTable = d.map((k) => {
      var se, le, fe;
      const F = ((se = k == null ? void 0 : k.system) == null ? void 0 : se.abilityType) ?? "", G = F === "active" ? "Aktív" : F === "passive" ? "Passzív" : F || "—", Y = F === "active", ee = Number((le = k == null ? void 0 : k.system) == null ? void 0 : le.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0, ae = (((fe = k == null ? void 0 : k.system) == null ? void 0 : fe.description) ?? "").trim(), re = ae ? ae.length > 60 ? ae.slice(0, 57) + "…" : ae : "—";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    e.itemsTable = p.map((k) => {
      const F = (k == null ? void 0 : k.system) ?? {}, G = (F.description ?? "").trim(), Y = G ? G.length > 60 ? G.slice(0, 57) + "…" : G : "—", ee = F.quantity != null ? String(F.quantity).trim() : "1";
      return {
        itemId: k.id,
        actorId: this.actor.id,
        name: (k == null ? void 0 : k.name) ?? "—",
    ...
    let i = 0, o = 0;
    for (const k of y) {
      const F = (k == null ? void 0 : k.system) ?? {}, G = F.health ?? {}, Y = Number(F.level ?? 0) || 0, ee = Number(G.max ?? 0) || 0, ae = Number(G.value ?? 0) || 0, re = (F.hit ?? "").toString().trim(), se = (F.speed ?? "").toString().trim().replace(",", "."), le = Number(se);
      Number.isFinite(le) && (i += le);
      const fe = (F.range ?? "").toString().trim().replace(",", "."), je = Number(fe);
      Number.isFinite(je) && (o += je);
      const ue = (F.damage ?? "").toString().trim(), Ee = F.abilities ?? {}, ye = Array.isArray(Ee.items) ? Ee.items : [], et = (await Promise.all(
        ye.map(async (ie) => {
          var Le;
          if (!ie) return null;
          try {
  ...
  _attachFrameListeners(s) {
    ...
    const n = this;
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-drag-handle", (u) => {
      var r, i, o, c;
      const d = (i = (r = u.currentTarget) == null ? void 0 : r.closest) == null ? void 0 : i.call(r, ".jarmu-unit-row"), p = (o = d == null ? void 0 : d.dataset) == null ? void 0 : o.itemId;
      if (!p) return;
      n._draggingUnitId = p;
...
Hooks.once("init", () => {
  ...
  const s = 500;
  Hooks.on("updateActor", (u, d, p, y) => {
    var T, D, C, _, q, M, E, H, B, V, W, ce, Q;
    ...
    if ((u.type === "Karakter" || u.type === "Npc") && ((T = d == null ? void 0 : d.system) != null && T.combat) && "initiativeResult" in d.system.combat) {
      const k = Number((C = (D = u.system) == null ? void 0 : D.combat) == null ? void 0 : C.initiativeResult), F = Number.isFinite(k) ? k : 0, G = game.combat;
      if (G) {
        const Y = ((_ = G.combatants) == null ? void 0 : _.contents) ?? Array.from(G.combatants ?? []);
        for (const ee of Y)
          if (((q = ee.actor) == null ? void 0 : q.id) === r || ee.actorId === r) {
            G.updateEmbeddedDocuments("Combatant", [{ _id: ee.id, initiative: F }]).catch(() => {
            });
            break;
          }
      }
    ...
    if (u.type === "Npc" && ((M = d == null ? void 0 : d.system) != null && M.identity) && "size" in d.system.identity) {
      const k = js((H = (E = u.system) == null ? void 0 : E.identity) == null ? void 0 : H.size);
      u.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var g, h, v, I, T, D, C, _, q, M, E, H, B, V, W, ce, Q, k, F, G, Y, ee, ae;
    ...
    const d = l.itemId ? ((H = (E = u.items) == null ? void 0 : E.get) == null ? void 0 : H.call(E, l.itemId)) ?? ((W = (V = (B = u.items) == null ? void 0 : B.contents) == null ? void 0 : V.find) == null ? void 0 : W.call(V, (re) => re.id === l.itemId)) : null;
...
//# sourceMappingURL=vacuum-of-the-void-Uc_CvrMp.mjs.map
