...
var te = (I, s, e) => ii(I, typeof s != "symbol" ? s + "" : s, e);
var z = (I, s, e) => si(ti(I), e, s);
const { HTMLField: ni, NumberField: F, SchemaField: H, StringField: q, BooleanField: de, ArrayField: _t } = foundry.data.fields;
...
function Ut(I) {
  ...
  const f = (a, i = 1) => {
    ...
    for (const c of a) {
      ...
      const m = typeof c.faces == "number" ? c.faces : void 0, h = Array.isArray(c.results) ? c.results : null;
      if (!m || !h || m === 8 || m !== 6) continue;
      const g = !n && r >= 0 && (c.number === 3 || c.number === "3") ? (n = !0, s) : r >= 0 ? e : t;
      for (const v of h) {
  ...
  f(I.terms, 1);
  const u = s.filter((a) => a === 6).length, p = s.filter((a) => a === 1).length, d = e.filter((a) => a === 6).length, o = t.filter((a) => a === 6).length, l = u + d, y = p + o;
  return l > 0 && l === y ? { resultType: null, label: null } : l >= 3 ? { resultType: "critical", label: "Brutális Siker" } : l === 2 ? { resultType: "critical", label: "Kritikus Siker" } : y >= 3 ? { resultType: "fumble", label: "Brutális Sikertelenség" } : y === 2 ? { resultType: "fumble", label: "Kritikus Sikertelenség" } : { resultType: null, label: null };
}
function Ci(I) {
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (f) {
      ...
      const m = document.activeElement, h = u.contains(m), g = m && (m.tagName === "INPUT" && m.type !== "checkbox" && m.type !== "radio" || m.tagName === "TEXTAREA");
      h && g && (p.focus = {
        name: m.name || null,
        id: m.id || null,
    ...
    const o = this.element, l = this.form ?? this.element, y = p.scrollState, a = p.focus, i = typeof (y == null ? void 0 : y.formScrollTop) == "number" || typeof (y == null ? void 0 : y.windowScrollTop) == "number", r = () => {
      var m, h;
      if (this._applyScrollState(o, y), (a == null ? void 0 : a.name) != null || (a == null ? void 0 : a.id) != null) {
        const g = ((m = l.querySelector) == null ? void 0 : m.call(l, a.id ? `#${CSS.escape(a.id)}` : null)) ?? (a.name ? (h = l.querySelector) == null ? void 0 : h.call(l, `[name="${CSS.escape(a.name)}"]`) : null);
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const u of s) {
      const p = String(((f = u.system) == null ? void 0 : f.speedPenalty) ?? "").trim().replace(",", "."), d = Number(p);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const u of s) {
      const p = String(((f = u.system) == null ? void 0 : f.protectionBonus) ?? "").trim().replace(",", "."), d = Number(p);
      Number.isFinite(d) && (e += d);
    }
    return e;
  }
  ...
  static getTotalSpeedRaw(s) {
    var l, y, a, i, r, c, m, h, g;
    if (!(s != null && s.system)) return 0;
    const e = s.system.resources ?? {}, t = ((y = (l = e.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : y.value) ?? 0, n = ((a = e.currentHealth) == null ? void 0 : a.legs) ?? 0, f = Q._healthStatusFromRatio(n, t);
    if (f === 0) return 0;
    const u = Number(((r = (i = s.system) == null ? void 0 : i.combat) == null ? void 0 : r.givenSpeed) ?? 0) || 0;
    let p;
    f === 1 ? p = -6 : f === 2 ? p = -3 : p = u, p += Q._getTotalArmorSpeedPenaltyStatic(s);
    const d = Number(((m = (c = s.system) == null ? void 0 : c.combat) == null ? void 0 : m.speed) ?? 0) || 0, o = Number(((g = (h = s.system) == null ? void 0 : h.combat) == null ? void 0 : g.speedBonus) ?? 0) || 0;
    return d + o + (Number.isFinite(p) ? p : 0);
  }
  /**
  ...
  _writeEffectiveGivenSpeed(s = null) {
    ...
    const n = ((m = (c = this.actor) == null ? void 0 : c.system) == null ? void 0 : m.resources) ?? {}, f = ((g = (h = n.hitLocations) == null ? void 0 : h.legs) == null ? void 0 : g.value) ?? 0, u = ((v = n.currentHealth) == null ? void 0 : v.legs) ?? 0, p = Q._healthStatusFromRatio(u, f), d = Number(((T = (w = (k = this.actor) == null ? void 0 : k.system) == null ? void 0 : w.combat) == null ? void 0 : T.givenSpeed) ?? 0) || 0;
    let o;
    p === 0 ? o = 0 : p === 1 ? o = -6 : p === 2 ? o = -3 : o = d;
    const l = this._getTotalArmorSpeedPenalty();
    o += l, t.textContent = String(o);
  }
  /** Kapott védelem kijelzés: tárolt givenProtection + páncélok + Körültekintés (+1) + Fél-fedezék (+3) + Háromnegyed-fedezék (+6). */
  _writeEffectiveGivenProtection(s = null) {
    var o, l, y, a, i, r, c, m, h, g, v, k, w;
    const e = s ?? this.form ?? this.element;
    let t = (o = e == null ? void 0 : e.querySelector) == null ? void 0 : o.call(e, ".karakter-given-defense-effective");
    if (!t && this.id && (t = document.querySelector(`#${CSS.escape(this.id)} .karakter-given-defense-effective`)), !t) return;
    const n = Number(((a = (y = (l = this.actor) == null ? void 0 : l.system) == null ? void 0 : y.combat) == null ? void 0 : a.givenProtection) ?? 0) || 0, f = (c = (r = (i = this.actor) == null ? void 0 : i.statuses) == null ? void 0 : r.has) != null && c.call(r, "lookaround") ? 1 : 0, u = (g = (h = (m = this.actor) == null ? void 0 : m.statuses) == null ? void 0 : h.has) != null && g.call(h, "halfcover") ? 3 : 0, p = (w = (k = (v = this.actor) == null ? void 0 : v.statuses) == null ? void 0 : k.has) != null && w.call(k, "threequarteredcover") ? 6 : 0, d = n + this._getTotalArmorProtectionBonus() + f + u + p;
  ...
  _writeTotalDefense(s = null) {
    ...
    if (!n) return;
    const d = Number(u == null ? void 0 : u.value) || 0, o = Number(p == null ? void 0 : p.value) || 0, l = Number(f == null ? void 0 : f.textContent) || 0;
    n.textContent = String(d + o + l);
  }
  _writeTotalSpeed(s = null) {
    ...
    if (!n) return;
    if ((h = (m = (c = this.actor) == null ? void 0 : c.statuses) == null ? void 0 : m.has) != null && h.call(m, "immobilized")) {
      n.textContent = "0";
      return;
    }
    const d = ((v = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : v.resources) ?? {}, o = ((w = (k = d.hitLocations) == null ? void 0 : k.legs) == null ? void 0 : w.value) ?? 0, l = ((T = d.currentHealth) == null ? void 0 : T.legs) ?? 0;
    if (Q._healthStatusFromRatio(l, o) === 0) {
      n.textContent = "0";
      return;
    }
    const a = Number(u == null ? void 0 : u.value) || 0, i = Number(p == null ? void 0 : p.value) || 0, r = Number(f == null ? void 0 : f.textContent) || 0;
  ...
  _getSkillHealthStatus(s) {
    ...
    if (e == null) return;
    const t = ((u = this.actor.system) == null ? void 0 : u.resources) ?? {}, n = ((d = (p = t.hitLocations) == null ? void 0 : p[e]) == null ? void 0 : d.value) ?? 0, f = ((o = t.currentHealth) == null ? void 0 : o[e]) ?? 0;
  ...
  static _getSkillHealthStatusStatic(s, e) {
    ...
    if (t == null) return;
    const n = ((p = s == null ? void 0 : s.system) == null ? void 0 : p.resources) ?? {}, f = ((o = (d = n.hitLocations) == null ? void 0 : d[t]) == null ? void 0 : o.value) ?? 0, u = ((l = n.currentHealth) == null ? void 0 : l[t]) ?? 0;
    return Q._healthStatusFromRatio(u, f);
  }
  async _prepareContext(s) {
    var mt, pt, ft, yt, gt, ht, bt, vt, kt, Ze, wt, It, Ye, S, P, x, G, ke, ne, Ce, De, we, xe, Xe, Qe, Nt, Ft, At, Et, St, ct, es, ts, ss, is, ns, as, rs, os, cs, ls, us, ds, ms, ps;
    ...
    for (const b of p) {
      const N = ((yt = f[b]) == null ? void 0 : yt.value) ?? 0, L = u[b] ?? 0;
      e.computedHealthStatus[b] = Q._healthStatusFromRatio(L, N);
    }
    const d = (Number(u.head) || 0) === 0, l = ["torso", "arms", "legs"].filter((b) => (Number(u[b]) || 0) === 0).length;
    e.showDeathSkull = d || l >= 2;
    ...
    const c = Number(((vt = (bt = this.actor.system) == null ? void 0 : bt.combat) == null ? void 0 : vt.givenProtection) ?? 0) || 0, m = (wt = (Ze = (kt = this.actor) == null ? void 0 : kt.statuses) == null ? void 0 : Ze.has) != null && wt.call(Ze, "lookaround") ? 1 : 0, h = (S = (Ye = (It = this.actor) == null ? void 0 : It.statuses) == null ? void 0 : Ye.has) != null && S.call(Ye, "halfcover") ? 3 : 0, g = (G = (x = (P = this.actor) == null ? void 0 : P.statuses) == null ? void 0 : x.has) != null && G.call(x, "threequarteredcover") ? 6 : 0, v = c + this._getTotalArmorProtectionBonus() + m + h + g;
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], M = (O.slotOrder ?? "").trim(), j = M ? M.split(/\s*,\s*/).filter((b) => C.includes(b)) : [], U = (Xe = this.actor.system.gear) == null ? void 0 : Xe.microchips, R = U && typeof U == "object" && !Array.isArray(U) ? U : {}, J = (((Qe = R.slot1) == null ? void 0 : Qe.itemId) ?? "").trim(), Y = (((Nt = R.slot2) == null ? void 0 : Nt.itemId) ?? "").trim(), Z = (((Ft = R.slot3) == null ? void 0 : Ft.itemId) ?? "").trim(), K = this.actor.items.contents.filter((b) => b.type !== "Kepesseg" && b.type !== "ability").slice().sort((b, N) => {
      ...
      let re = null;
      L && (J === b.id ? re = "slot1" : Y === b.id ? re = "slot2" : Z === b.id && (re = "slot3"));
    ...
    e.armorTable = W.map((b) => {
      ...
      return {
        ...
        level: Ci((N.level ?? "").toString().trim()),
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-CLVNIT1f.mjs");
      m(this.actor, c);
      ...
      if (!c) {
        ...
        if (!v) return;
        c = (((((h = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : h.weapons) ?? {})[v] ?? {}).itemId ?? "").trim();
      }
      c && await this._rollWeaponDamage(c, ((g = r.dataset.slot) == null ? void 0 : g.trim()) ?? "");
    }), t.on("click", ".karakter-harc-initiative", async (i) => {
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: r } = await import("./roll-sheet-CLVNIT1f.mjs");
      r(this.actor, "quickThinking", "Kezdeményezés");
    }), t.on("click", ".karakter-kp-dot", async (i) => {
      var g, v;
      i.preventDefault(), i.stopPropagation();
      const r = i.currentTarget, c = parseInt(r.dataset.index, 10);
      if (!Number.isFinite(c) || c < 1 || c > 6) return;
      const m = `system.resources.kpDot${c}`, h = !!Number((v = (g = this.actor.system) == null ? void 0 : g.resources) == null ? void 0 : v[`kpDot${c}`]);
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', u), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, m = ((g = r.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: h } = await import("./roll-sheet-CLVNIT1f.mjs");
      h(this.actor, c, m);
      ...
      var k, w, T, _, O, C, M;
      i.preventDefault();
      const c = i.currentTarget.closest(".karakter-weapon-slot"), m = c == null ? void 0 : c.dataset.slot;
      if (!m) return;
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c) return;
      const m = this.actor, h = m.items.get(c);
      if (!h) return;
      const g = {};
      if ((h == null ? void 0 : h.type) === "Fegyver") {
        const v = m.system.weapons ?? {}, k = (v.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], T = k ? k.split(/\s*,\s*/).filter((O) => w.includes(O)) : [], _ = T.find((O) => {
          var C;
          return (((C = v[O]) == null ? void 0 : C.itemId) ?? "").trim() === c;
        });
        if (_) {
      ...
      const h = this.actor.system.weapons ?? {}, g = (h.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], k = g ? g.split(/\s*,\s*/).filter((C) => v.includes(C)) : [], w = k.find((C) => {
        var M;
        return (((M = h[C]) == null ? void 0 : M.itemId) ?? "").trim() === c;
      }) ?? null;
      if (r.checked) {
        if (w) return;
        let C = k.find((j) => {
      ...
      const c = r.closest(".karakter-microchip-slot-select-wrap"), m = c == null ? void 0 : c.classList.contains("karakter-microchip-slot-open");
      ...
      var C;
      i.preventDefault();
      const r = i.currentTarget, c = r.closest(".karakter-microchip-slot-select-wrap"), m = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), h = m == null ? void 0 : m.dataset.slot;
      if (!h) return;
      const g = (r.dataset.itemId ?? "").trim(), v = (r.dataset.itemName ?? ((C = r.textContent) == null ? void 0 : C.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", k = (r.dataset.itemImg ?? "").trim(), w = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      w && (w.textContent = v);
      let T = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-thumb");
      k ? (T || (T = document.createElement("img"), T.className = "karakter-microchip-slot-thumb", T.alt = "", m == null || m.insertBefore(T, w)), T.src = k, T.style.display = "") : T && T.remove(), c == null || c.classList.remove("karakter-microchip-slot-open");
      ...
      r.addEventListener("dragover", (m) => this._onMicrochipSlotDragOver(m, c)), r.addEventListener("dragleave", (m) => {
        var h;
        return (h = m.currentTarget) == null ? void 0 : h.classList.remove("karakter-microchip-slot-drag-over");
      }), r.addEventListener("drop", (m) => this._onMicrochipSlotDrop(m, c));
    }), t.find(".karakter-ability-slot-single").each((i, r) => {
      const c = r.dataset.slot;
      c && (r.addEventListener("dragover", (m) => this._onAbilitySingleDragOver(m, c)), r.addEventListener("dragleave", (m) => {
        var h;
      ...
      c && (r.addEventListener("dragover", (m) => this._onAbilityAreaDragOver(m, c)), r.addEventListener("dragleave", (m) => {
        var h;
      ...
      if (!r || !c) return;
      const m = this.actor.system.abilities ?? {}, g = (Array.isArray((v = m[r]) == null ? void 0 : v.items) ? m[r].items.slice() : []).filter((k) => k !== c);
      ...
      await m.update({ "system.quantity": h }), setTimeout(() => {
        const g = this.form ?? this.element, v = g == null ? void 0 : g.querySelector(`.karakter-weapon-quantity-input[data-item-id="${c}"]`);
      ...
      const c = i.currentTarget.dataset.itemId;
      if (!c) return;
      const m = this.actor, h = m.items.get(c), g = {};
      if ((h == null ? void 0 : h.type) === "Fegyver") {
        const v = m.system.weapons ?? {}, k = (v.slotOrder ?? "").trim(), w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], T = k ? k.split(/\s*,\s*/).filter((O) => w.includes(O)) : [], _ = T.find((O) => {
          var C;
          return (((C = v[O]) == null ? void 0 : C.itemId) ?? "").trim() === c;
      ...
      const h = (r.value ?? "").trim();
      await m.update({ "system.quantity": h }), setTimeout(() => {
        const g = this.form ?? this.element, v = g == null ? void 0 : g.querySelector(`.karakter-item-quantity-input[data-item-id="${c}"]`);
        v && this._resizeWeaponQuantityInput(v);
      }, 80);
    });
    const d = this, o = (i) => {
      ...
      const c = ((h = (m = r.system) == null ? void 0 : m.resources) == null ? void 0 : h.currentHealth) != null || ((v = (g = r.system) == null ? void 0 : g.resources) == null ? void 0 : v.hitLocations) != null;
      d.actor.update(r).then(() => {
        c && setTimeout(() => d.render(!0), 260);
      }).catch((k) => console.warn("VoidKarakterSheet save failed", k));
    }, l = (i) => {
      var r, c, m;
      return i && (((c = (r = d.element) == null ? void 0 : r.contains) == null ? void 0 : c.call(r, i)) || d.id && ((m = i.closest) == null ? void 0 : m.call(i, `#${CSS.escape(d.id)}`)));
    };
    d._votvBlur = (i) => {
      var g;
      const r = i.target;
      ...
      h && (m.contains(h) || d.id && ((g = h.closest) != null && g.call(h, `#${CSS.escape(d.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: d.id, at: Date.now() }), o(m));
  ...
  _getFormDataForUpdate(s) {
    var p, d, o;
    const e = {};
    for (const l of s.elements) {
      if (!l.name || l.disabled || l.type === "radio" && !l.checked || l.name.startsWith("system.resources.healthStatus.")) continue;
      let y;
      l.type === "checkbox" ? y = l.checked : l.type === "number" ? y = l.value === "" ? 0 : Number(l.value) : y = l.value ?? "", foundry.utils.setProperty(e, l.name, y);
    }
    ...
    for (const l of u) {
      const y = ((o = n[l]) == null ? void 0 : o.value) ?? 0, a = f[l] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${l}`, Q._healthStatusFromRatio(a, y));
    }
    return e;
  }
  async _onDropItem(s, e) {
    var t, n, f, u, p, d, o, l, y, a, i, r, c, m;
    if (e) {
    ...
    if (e) {
      let h = e.uuid ?? e.documentUuid ?? ((l = e.data) == null ? void 0 : l.uuid) ?? (typeof e == "string" ? e : null);
      if (!h && typeof e == "object") {
        for (const g of Object.values(e))
          if (typeof g == "string" && g.includes(".") && g.startsWith("Item.")) {
            h = g;
      ...
      if (h) {
        ...
        if (g && g.documentName === "Item" && g.type === "MikroChip") {
          const v = this.actor;
          ((c = g.parent) == null ? void 0 : c.id) !== v.id && await v.createEmbeddedDocuments("Item", [g.toObject()]);
          return;
        }
  ...
  async _onWeaponSlotDrop(s, e) {
    ...
    if (((l = f.parent) == null ? void 0 : l.id) !== this.actor.id) {
  ...
  async _onInventoryRowDrop(s, e) {
    ...
    const t = this._draggingInventoryItemId || ((l = s.dataTransfer) == null ? void 0 : l.getData("text/plain"));
  ...
  async _postAbilityToChat(s) {
    ...
    const t = ((l = e.system) == null ? void 0 : l.kind) ?? "passive", n = Number(((y = e.system) == null ? void 0 : y.kp) ?? 0) || 0, f = (((a = e.system) == null ? void 0 : a.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
  ...
  async _onAbilityAreaDrop(s, e) {
    ...
    if (((o = n.parent) == null ? void 0 : o.id) !== this.actor.id) {
      ...
      f = ((l = (await this.actor.createEmbeddedDocuments("Item", [a]))[0]) == null ? void 0 : l.id) ?? f;
    }
  ...
  async _onMicrochipSlotDrop(s, e) {
    ...
    let u = f.id;
    ((l = f.parent) == null ? void 0 : l.id) !== this.actor.id && (u = ((y = (await this.actor.createEmbeddedDocuments("Item", [f.toObject()]))[0]) == null ? void 0 : y.id) ?? u), await this.actor.update({
  ...
  async _rollSkill(s, e) {
    ...
    u === 1 ? f -= 6 : u === 2 && (f -= 3);
    const d = `3d6${f !== 0 ? f > 0 ? `+${f}` : `${f}` : ""}`, o = new Roll(d);
    await o.evaluate({ async: !0 });
    const { resultType: l, label: y } = Ut(o), a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const p = u && u.name || t.name || `Fegyver (${s})`, d = Number(t.bonus || 0) || 0, o = ((k = u == null ? void 0 : u.system) == null ? void 0 : k.type) || "kinetic", l = (((w = u == null ? void 0 : u.system) == null ? void 0 : w.skillKey) ?? "").trim(), y = l && n[l] !== void 0 ? l : o === "explosive" ? "grenadeUse" : "firearms", a = Number(n[y] || 0) || 0, i = d + a, c = `3d6${i !== 0 ? i > 0 ? `+${i}` : `${i}` : ""}`, m = new Roll(c);
  ...
  async _rollWeaponDamage(s, e = "") {
    var d, o, l, y, a, i, r, c, m, h;
    const t = this.actor;
    if (!t) return;
    let n = ((o = (d = t.items).get) == null ? void 0 : o.call(d, s)) ?? ((y = (l = t.items.contents) == null ? void 0 : l.find) == null ? void 0 : y.call(l, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (r = ui.notifications) == null ? void 0 : r.warn) == null || h.call(r, ((m = (c = game.i18n) == null ? void 0 : c.localize) == null ? void 0 : m.call(c, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
      return;
    }
    const u = new Roll(f);
...
te(Q, "PARTS", foundry.utils.mergeObject(
  ...
  z(Q, Q, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((_s = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : _s.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Os = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Os.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((qs = (Cs = z(Q, Q, "DEFAULT_OPTIONS")) == null ? void 0 : Cs.window) == null ? void 0 : qs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ye = class ye extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async render(s = !1, e = {}) {
    ...
    if (t) {
      ...
      const i = document.activeElement, r = n.contains(i), c = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA");
      r && c && (f.focus = {
        name: i.name || null,
        id: i.id || null,
    ...
    const u = await super.render(s, e), p = this.element, d = this.form ?? this.element, o = f.scrollState, l = f.focus, y = typeof (o == null ? void 0 : o.formScrollTop) == "number" || typeof (o == null ? void 0 : o.windowScrollTop) == "number", a = () => {
      var i, r;
      if (this._applyScrollState(p, o), (l == null ? void 0 : l.name) != null || (l == null ? void 0 : l.id) != null) {
        const c = ((i = d.querySelector) == null ? void 0 : i.call(d, l.id ? `#${CSS.escape(l.id)}` : null)) ?? (l.name ? (r = d.querySelector) == null ? void 0 : r.call(d, `[name="${CSS.escape(l.name)}"]`) : null);
        c && (c.tagName === "INPUT" || c.tagName === "TEXTAREA") && (c.focus({ preventScroll: !0 }), typeof c.selectionStart == "number" && (c.selectionStart = l.selectionStart ?? 0, c.selectionEnd = l.selectionEnd ?? l.selectionStart ?? 0));
      }
      this._applyScrollState(p, o);
    };
    return (y || l) && (requestAnimationFrame(a), setTimeout(a, 0), setTimeout(a, 50), setTimeout(a, 150), setTimeout(a, 300), setTimeout(a, 450)), u;
  }
  async _prepareContext(s) {
    ...
    const t = this.actor, n = ((at = e.system) == null ? void 0 : at.combat) ?? {}, f = Number(n.givenProtection ?? 0) || 0, u = (fe = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && fe.call(ee, "lookaround") ? 1 : 0, p = (rt = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && rt.call(ie, "halfcover") ? 3 : 0, d = (Oe = ($e = t == null ? void 0 : t.statuses) == null ? void 0 : $e.has) != null && Oe.call($e, "threequarteredcover") ? 6 : 0;
    e.effectiveGivenProtection = f + u + p + d;
    const o = ((ot = t == null ? void 0 : t.items) == null ? void 0 : ot.contents) ?? [], l = ((Be = t == null ? void 0 : t.system) == null ? void 0 : Be.weapons) ?? {}, y = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], a = (l.slotOrder ?? "").trim(), i = a ? a.split(/\s*,\s*/).filter((S) => y.includes(S)) : [], r = o.filter((S) => S.type === "Fegyver"), c = r.map((S) => ({ id: S.id, name: S.name, img: S.img })), m = "— Nincs fegyver —", h = i.length > 0 ? i : y, g = y.filter((S) => !h.includes(S)), v = [...h, ...g], k = v.filter((S) => {
      var x;
      const P = (((x = l[S]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && r.some((G) => G.id === P);
    });
    e.weaponSlots = k.map((S) => {
      const P = l[S] ?? {}, x = (P.itemId ?? "").trim(), G = c.find((we) => we.id === x), ke = r.find((we) => we.id === x), ne = (ke == null ? void 0 : ke.system) ?? {}, Ce = ne.size === "thrown", De = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: S,
        itemId: x,
    ...
    e.weaponsTable = r.map((S) => {
      var St;
      const P = S.id;
      let x = null, G = {};
      for (const ct of v)
        if ((((St = l[ct]) == null ? void 0 : St.itemId) ?? "").trim() === P) {
          x = ct, G = l[ct] ?? {};
          break;
        }
      const ke = !!x, ne = (S == null ? void 0 : S.system) ?? {}, Ce = typeof ne.range == "string" ? (ne.range || "").trim() : "", De = ne.type ?? "", we = (w[De] ?? De) || "—", xe = ne.size ?? "", Xe = (T[xe] ?? xe) || "", Qe = [we, Xe].filter(Boolean).join(", ") || we || "—", Nt = De === "projectile" || xe === "thrown", Ft = ne.quantity != null ? String(ne.quantity).trim() : "1", At = String(ne.bonus ?? G.bonus ?? "").trim() || "0", Et = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const O = ((Ct = (Je = t == null ? void 0 : t.system) == null ? void 0 : Je.gear) == null ? void 0 : Ct.microchips) ?? {}, C = ["slot1", "slot2", "slot3"], M = o.filter((S) => S.type === "MikroChip");
    e.microchipsTable = M.map((S) => {
      var De, we, xe, Xe;
      const P = S.id;
      let x = null;
      for (const Qe of C)
      ...
      const G = ((we = S == null ? void 0 : S.system) == null ? void 0 : we.abilityType) ?? "", ke = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ne = (((xe = S == null ? void 0 : S.system) == null ? void 0 : xe.description) ?? "").trim(), Ce = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: P,
        actorId: t.id,
        name: (S == null ? void 0 : S.name) ?? "—",
    ...
    const j = o.filter((S) => S.type === "Targy");
    e.itemsTable = j.map((S) => {
    ...
    const J = ((ft = t == null ? void 0 : t.system) == null ? void 0 : ft.abilities) ?? {}, Y = o.filter((S) => S.type === "Kepesseg" || S.type === "ability").map((S) => {
      var P, x, G;
      return {
        id: S.id,
        name: S.name,
    ...
    }), Z = new Map(Y.map((S) => [S.id, S])), X = { itemId: "", displayName: "— Nincs képesség —", img: "", description: "", kp: 0 };
    ...
    const oe = t == null ? void 0 : t.id, be = !!((gt = (yt = game.combat) == null ? void 0 : yt.combatants) != null && gt.some(
      (S) => {
        var P;
        return (((P = S.actor) == null ? void 0 : P.id) ?? S.actorId) === oe;
      }
    ));
    ...
    const he = ((ht = e.system) == null ? void 0 : ht.resources) ?? {}, D = (vt = (bt = e.system) == null ? void 0 : bt.combat) == null ? void 0 : vt.initiativeResult, E = typeof D == "number" ? D : -1, W = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], se = (Ze = (kt = e.system) == null ? void 0 : kt.combat) == null ? void 0 : Ze.initiativeRanges, le = Array.isArray(se) ? se.map((S) => ({ min: Number(S.min) ?? 0, max: Number(S.max) ?? 0, kp: Math.min(10, Math.max(0, Number(S.kp) ?? 0)) })) : [], ae = (le.length > 0 ? le : W).slice().sort((S, P) => S.min - P.min), ve = 3;
    ...
    if (typeof E == "number" && E >= 0 && ae.length > 0) {
      ...
      let x = null;
      E <= S.max ? x = S : E >= P.min ? x = P : x = ae.find((G) => E >= G.min && E <= G.max), x && (pe = x.kp);
    }
    const Me = ae.length > 0 ? ae[ae.length - 1] : null, ze = Math.min(10, Me ? Me.kp : 6), je = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6", "kpDot7", "kpDot8", "kpDot9", "kpDot10"].slice(0, Math.max(1, ze)).map((S, P) => {
      const x = P + 1, G = !!Number(he[S]), ke = x <= pe;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-portrait-img", (a) => {
      ...
      const i = ((h = (m = (c = foundry.applications) == null ? void 0 : c.apps) == null ? void 0 : m.FilePicker) == null ? void 0 : h.implementation) ?? globalThis.FilePicker;
      new i({
        type: "image",
        current: this.actor.img || "",
        callback: (g) => {
      ...
      var c, m, h;
      a.preventDefault();
      const i = (m = (c = a.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : m.itemId;
    ...
    t.on("click", ".karakter-inventory-item-name", (a) => {
      ...
      if (!r || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-CLVNIT1f.mjs");
      c(this.actor, r);
    }), t.on("click", ".karakter-weapon-damage", async (a) => {
      var c, m, h, g, v;
      a.preventDefault(), a.stopPropagation();
      const i = a.currentTarget;
      let r = (((c = i == null ? void 0 : i.dataset) == null ? void 0 : c.itemId) ?? "").trim();
      ...
      if (a.preventDefault(), a.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-CLVNIT1f.mjs");
      ...
      const c = !!Number((h = (m = this.actor.system) == null ? void 0 : m.resources) == null ? void 0 : h[`kpDot${r}`]);
      await this.actor.update({ [`system.resources.kpDot${r}`]: c ? 0 : 1 });
    }), t.on("click", ".karakter-skill-label", async (a) => {
      var h, g;
      a.preventDefault();
      const i = a.currentTarget, r = (((h = i == null ? void 0 : i.dataset) == null ? void 0 : h.skill) ?? "").trim(), c = ((g = i == null ? void 0 : i.textContent) == null ? void 0 : g.trim()) || r;
      if (!r || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-CLVNIT1f.mjs");
      m(this.actor, r, c);
    }), t.on("click", ".karakter-ability-chat", async (a) => {
      var r, c;
      a.preventDefault();
      const i = (c = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : c.itemId;
      i && await this._postAbilityToChat(i);
    }), t.on("click", ".karakter-item-chat", async (a) => {
      var c, m, h, g;
      a.preventDefault();
      const i = (((m = (c = a.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : m.itemId) ?? ((g = (h = a.currentTarget) == null ? void 0 : h.getAttribute) == null ? void 0 : g.call(h, "data-item-id")) ?? "").trim();
      if (!i || !this.actor) return;
      const r = this.actor.items.get(i);
      ...
      const c = ((T = this.actor.system) == null ? void 0 : T.abilities) ?? {}, h = (Array.isArray((_ = c[i]) == null ? void 0 : _.items) ? c[i].items.slice() : []).filter((O) => O !== r);
      ...
      var r, c;
      if (a.preventDefault(), !a.altKey) return;
      const i = (c = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : c.slot;
      ...
      if (!r || !this.actor) return;
      const c = this.actor, m = (((v = i == null ? void 0 : i.dataset) == null ? void 0 : v.slotKey) ?? "").trim(), h = {};
      m && (h[`system.weapons.${m}.itemId`] = "", h[`system.weapons.${m}.name`] = "", h[`system.weapons.${m}.damage`] = "", h[`system.weapons.${m}.bonus`] = ""), Object.keys(h).length && await c.update(h), await c.deleteEmbeddedDocuments("Item", [r]), typeof this.render == "function" && this.render(!0);
    }), t.on("click", ".karakter-armor-delete", async (a) => {
      var r, c;
      if (a.preventDefault(), !a.altKey) return;
      const i = (((c = (r = a.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : c.itemId) ?? "").trim();
      ...
      var c, m;
      if (a.preventDefault(), !a.altKey) return;
      const i = (((m = (c = a.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : m.itemId) ?? "").trim();
      if (!i || !this.actor) return;
      const r = this.actor.items.get(i);
    ...
    (y = (l = e == null ? void 0 : e.querySelectorAll) == null ? void 0 : l.call(e, f)) == null || y.forEach((a) => {
      var i;
    ...
    const u = this, p = (a) => {
      ...
      Object.keys(i).length !== 0 && u.actor.update(i).catch((r) => console.warn("VoidNpcSheet save failed", r));
    }, d = (a) => {
      var i, r, c;
      return a && (((r = (i = u.element) == null ? void 0 : i.contains) == null ? void 0 : r.call(i, a)) || u.id && ((c = a.closest) == null ? void 0 : c.call(a, `#${CSS.escape(u.id)}`)));
    };
    u._votvNpcBlur = (a) => {
      var h;
      const i = a.target;
      ...
      m && (c.contains(m) || u.id && ((h = m.closest) != null && h.call(m, `#${CSS.escape(u.id)}`))) || p(c);
    }, document.body.addEventListener("blur", u._votvNpcBlur, !0), u._votvNpcItemHookRegistered || (u._votvNpcItemUpdateHook = (a, i, r) => {
      var c;
      u.actor && ((c = a == null ? void 0 : a.parent) == null ? void 0 : c.id) === u.actor.id && u.render(!0);
    }, u._votvNpcItemDeleteHook = (a, i, r) => {
      var c;
      u.actor && ((c = a == null ? void 0 : a.parent) == null ? void 0 : c.id) === u.actor.id && u.render(!0);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((w = e.system) == null ? void 0 : w.weapons) ?? {})[s] ?? {}, f = ((T = e.system) == null ? void 0 : T.skills) ?? {}, u = ((_ = e.items) == null ? void 0 : _.filter((M) => M.type === "Fegyver")) ?? [];
    let p = null;
    n.itemId && (p = u.find((M) => M.id === n.itemId) ?? null);
    const d = p && p.name || n.name || "Fegyver", o = Number(n.bonus || 0) || 0, l = ((O = p == null ? void 0 : p.system) == null ? void 0 : O.type) || "kinetic", y = (((C = p == null ? void 0 : p.system) == null ? void 0 : C.skillKey) ?? "").trim(), a = y && f[y] !== void 0 ? y : l === "explosive" ? "grenadeUse" : "firearms", i = Number(f[a] || 0) || 0, r = o + i, m = `3d6${r !== 0 ? r > 0 ? `+${r}` : `${r}` : ""}`, h = new Roll(m);
  ...
  async _rollWeaponDamage(s, e = "") {
    ...
    const t = this.actor;
    if (!t) return;
    const n = ((o = (d = t.items).get) == null ? void 0 : o.call(d, s)) ?? ((y = (l = t.items.contents) == null ? void 0 : l.find) == null ? void 0 : y.call(l, (g) => g.id === s));
    if (!n || n.type !== "Fegyver") return;
    let f = (((a = n.system) == null ? void 0 : a.damage) ?? "").trim();
    if (!f && e && (f = (((((i = t.system) == null ? void 0 : i.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !f) {
      (h = (r = ui.notifications) == null ? void 0 : r.warn) == null || h.call(r, ((m = (c = game.i18n) == null ? void 0 : c.localize) == null ? void 0 : m.call(c, "votv.weapon.no-damage")) ?? "A fegyvernek nincs sebzés formulája.");
  ...
  async _onDropItem(s, e) {
    var l, y, a, i, r, c, m, h, g, v, k, w, T, _, O, C, M, j, U;
    if (!this.actor) return (l = super._onDropItem) == null ? void 0 : l.call(this, s, e);
    const n = ((R) => {
      var Y;
      if (!R) return null;
      const J = R.uuid ?? R.documentUuid ?? ((Y = R.data) == null ? void 0 : Y.uuid) ?? (typeof R == "string" ? R : null);
      if (J) return J;
      if (typeof R == "object") {
    ...
    if (f.type === "Kepesseg" || f.type === "ability") {
      const R = (((c = f.system) == null ? void 0 : c.kind) ?? "passive").toString();
      if (R === "module") {
      ...
      if (((g = f.parent) == null ? void 0 : g.id) !== u.id) {
        ...
        J = ((v = (await u.createEmbeddedDocuments("Item", [K]))[0]) == null ? void 0 : v.id) ?? J;
      }
      const Y = ((k = u.system) == null ? void 0 : k.abilities) ?? {}, Z = R === "active" ? "active" : "passive", X = Array.isArray((w = Y[Z]) == null ? void 0 : w.items) ? Y[Z].items.slice() : Array.isArray(Y[Z]) ? Y[Z].slice() : [];
      X.includes(J) || X.push(J), await u.update({ [`system.abilities.${Z}.items`]: X }), typeof this.render == "function" && this.render(!0);
      return;
    }
    ...
    if (f.type === "Fegyver" && o) {
      const R = ((O = u.system) == null ? void 0 : O.weapons) ?? {}, J = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], Y = (R.slotOrder ?? "").trim(), Z = Y ? Y.split(/\s*,\s*/).filter((V) => J.includes(V)) : [];
      let X = J.find((V) => {
        var oe;
        return !(((oe = R[V]) == null ? void 0 : oe.itemId) ?? "").trim();
      });
      X || (X = J.find((V) => !Z.includes(V)) ?? "slot1");
      const K = Z.includes(X) ? Z : [...Z, X].filter((V) => J.includes(V));
      await u.update({
        "system.weapons.slotOrder": K.join(","),
        [`system.weapons.${X}.itemId`]: o,
        [`system.weapons.${X}.name`]: f.name ?? "",
        [`system.weapons.${X}.damage`]: ((C = f.system) == null ? void 0 : C.damage) ?? "",
        [`system.weapons.${X}.bonus`]: ((M = f.system) == null ? void 0 : M.bonus) ?? ""
      });
    }
    if (f.type === "MikroChip" && o) {
      const R = ((U = (j = u.system) == null ? void 0 : j.gear) == null ? void 0 : U.microchips) ?? {}, Y = ["slot1", "slot2", "slot3"].find((Z) => {
        var X;
        return !(((X = R[Z]) == null ? void 0 : X.itemId) ?? "").trim();
      });
      Y && await u.update({
        [`system.gear.microchips.${Y}.itemId`]: o,
  ...
  async _postAbilityToChat(s) {
    var l, y, a, i, r, c;
    const e = (y = (l = this.actor) == null ? void 0 : l.items) == null ? void 0 : y.get(s);
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((a = e.system) == null ? void 0 : a.kind) ?? "passive", n = Number(((i = e.system) == null ? void 0 : i.kp) ?? 0) || 0, f = (((r = e.system) == null ? void 0 : r.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${d}
  ...
  async _postItemToChat(s) {
    var d, o, l, y, a, i;
    const e = (o = (d = this.actor) == null ? void 0 : d.items) == null ? void 0 : o.get(s);
    if (!e || e.type !== "MikroChip" && e.type !== "Egyeb") return;
...
te(ye, "PARTS", foundry.utils.mergeObject(
  ...
  z(ye, ye, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Ls = z(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ls.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ns = z(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Ns.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((As = (Fs = z(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : Fs.window) == null ? void 0 : As.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _writeTotalDefense(s = null) {
    const e = s ?? this.form ?? this.element, t = (o) => {
      var l;
      return ((l = e == null ? void 0 : e.querySelector) == null ? void 0 : l.call(e, o)) ?? (this.id ? document.querySelector(`#${CSS.escape(this.id)} ${o}`) : null);
    }, n = t(".jarmu-total-defense-effective"), f = t('input[name="system.combat.defense"]'), u = t('input[name="system.combat.givenProtection"]');
    if (!n) return;
    const p = Number(f == null ? void 0 : f.value) || 0, d = Number(u == null ? void 0 : u.value) || 0;
    n.textContent = String(p + d);
  }
  async _prepareContext(s) {
    var M, j, U, R, J, Y, Z, X, K, V, oe, be, he;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = ((M = e.system) == null ? void 0 : M.combat) ?? {};
    e.totalDefense = (Number(t.defense) || 0) + (Number(t.givenProtection) || 0);
    const n = { kinetic: "Kinetikus", projectile: "Lövedékes", blade: "Pengés", explosive: "Robbanó", other: "Egyéb" }, f = { light: "Könnyű", medium: "Közepes", heavy: "Nehéz", thrown: "Dobható" }, u = "— Nincs fegyver —", p = (((j = this.actor.items) == null ? void 0 : j.contents) ?? []).filter((D) => D.type === "Fegyver");
    ...
    const o = (((R = this.actor.items) == null ? void 0 : R.contents) ?? []).filter((D) => D.type === "MikroChip");
    ...
    const l = (((J = this.actor.items) == null ? void 0 : J.contents) ?? []).filter((D) => D.type === "Targy");
    e.itemsTable = l.map((D) => {
    ...
    const y = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", a = (((Y = this.actor.items) == null ? void 0 : Y.contents) ?? []).filter((D) => D.type === y).sort((D, E) => {
      const W = typeof D.sort == "number" ? D.sort : 0, se = typeof E.sort == "number" ? E.sort : 0;
      return W - se;
    }), i = [];
    let r = 0, c = 0, m = 0;
    const h = Number(((X = (Z = this.actor.system) == null ? void 0 : Z.vehicle) == null ? void 0 : X.storage) ?? 0) || 0;
    for (const D of a) {
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".jarmu-portrait-img", (d) => {
      ...
      const o = ((i = (a = (y = foundry.applications) == null ? void 0 : y.apps) == null ? void 0 : a.FilePicker) == null ? void 0 : i.implementation) ?? globalThis.FilePicker;
      new o({
        type: "image",
        current: this.actor.img || "",
        callback: (r) => {
      ...
      var y, a, i;
      d.preventDefault();
      const o = (a = (y = d.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : a.itemId;
      if (!o) return;
      const l = this.actor.items.get(o);
      (i = l == null ? void 0 : l.sheet) == null || i.render(!0);
      ...
      var a;
      const o = d.currentTarget, l = (a = o == null ? void 0 : o.dataset) == null ? void 0 : a.itemId;
      if (!l) return;
      const y = this.actor.items.get(l);
      ...
      if (!o) return;
      const l = this.actor.items.get(o);
      !l || l.type !== "Pancel" || await l.update({ "system.equipped": d.currentTarget.checked });
    }), t.on("click", ".jarmu-egyeb-name, .jarmu-egyeb-icon", (d) => {
      var l, y, a, i;
      d.preventDefault();
      const o = (y = (l = d.currentTarget) == null ? void 0 : l.dataset) == null ? void 0 : y.itemId;
      o && ((i = (a = this.actor.items.get(o)) == null ? void 0 : a.sheet) == null || i.render(!0));
      ...
      var y, a, i, r;
      d.preventDefault();
      const o = (((a = (y = d.currentTarget) == null ? void 0 : y.dataset) == null ? void 0 : a.itemId) ?? ((r = (i = d.currentTarget) == null ? void 0 : i.getAttribute) == null ? void 0 : r.call(i, "data-item-id")) ?? "").trim();
      if (!o || !this.actor) return;
      const l = this.actor.items.get(o);
      !l || l.type !== "MikroChip" && l.type !== "Egyeb" || await this._postItemToChat(o);
    }), t.on("click", ".jarmu-unit-damage-button", async (d) => {
      var y;
      d.preventDefault(), d.stopPropagation();
      const o = d.currentTarget, l = (((y = o == null ? void 0 : o.dataset) == null ? void 0 : y.itemId) ?? "").trim();
      l && await this._rollUnitDamage(l);
    });
    const n = this;
    this._draggingUnitId = null, t.on("dragstart", ".jarmu-unit-row", (d) => {
      ...
      y && (y.setData("text/plain", l), y.effectAllowed = "move", typeof y.setDragImage == "function" && y.setDragImage(o, 0, 0));
    }), t.on("dragover", ".jarmu-unit-row", (d) => {
      var a, i, r, c;
      const o = (i = (a = d.currentTarget) == null ? void 0 : a.dataset) == null ? void 0 : i.itemId, l = n._draggingUnitId;
      if (!l || !o || l === o) return;
      d.preventDefault();
      ...
      var o;
      (o = d.currentTarget) == null || o.classList.remove("karakter-actions-row-drag-over");
      ...
      const o = (k = (v = d.currentTarget) == null ? void 0 : v.dataset) == null ? void 0 : k.itemId;
      let l = n._draggingUnitId;
      const y = (w = d.originalEvent) == null ? void 0 : w.dataTransfer;
      if (!l && y && (l = y.getData("text/plain")), n._draggingUnitId = null, !l || !o || l === o) return;
      const a = this.actor.type === "Bazis" ? "Helyiseg" : "Jarmuegyseg", r = this.actor.items.contents.filter((T) => T.type === a).sort((T, _) => {
        ...
        return O - C;
      }).map((T) => T.id), c = r.indexOf(l), m = r.indexOf(o);
      if (c === -1 || m === -1) return;
      r.splice(c, 1), r.splice(m, 0, l);
      const h = r.map((T, _) => ({
        _id: T,
        sort: (_ + 1) * 10
      }));
      ...
      var a, i, r, c, m, h, g, v, k, w;
      d.preventDefault();
      const o = (c = (r = (i = (a = d.currentTarget) == null ? void 0 : a.closest) == null ? void 0 : i.call(a, ".jarmu-unit-ability-pill")) == null ? void 0 : r.dataset) == null ? void 0 : c.abilityRef, l = (v = (g = (h = (m = d.currentTarget) == null ? void 0 : m.closest) == null ? void 0 : h.call(m, ".jarmu-unit-ability-pill")) == null ? void 0 : g.dataset) == null ? void 0 : v.abilityId;
      let y = null;
      if (o)
        try {
          y = await fromUuid(o);
      ...
      !y && l && (y = ((k = game.items) == null ? void 0 : k.get(l)) ?? null), (w = y == null ? void 0 : y.sheet) == null || w.render(!0);
    }), t.on("click", ".jarmu-unit-ability-chat", async (d) => {
      var i, r, c, m;
      d.preventDefault();
      const o = (r = (i = d.currentTarget) == null ? void 0 : i.closest) == null ? void 0 : r.call(i, ".jarmu-unit-ability-pill"), l = (c = o == null ? void 0 : o.dataset) == null ? void 0 : c.abilityRef, y = (m = o == null ? void 0 : o.dataset) == null ? void 0 : m.abilityId, a = l || y;
      a && await this._postUnitAbilityToChat(a);
    });
    const f = (d) => {
      if (!d) return;
      const o = this._getFormDataForUpdate(d);
      Object.keys(o).length !== 0 && this.actor.update(o).catch((l) => console.warn("VoidJarmuSheet save failed", l));
    }, u = (d) => {
      var o, l, y;
      return d && (((l = (o = this.element) == null ? void 0 : o.contains) == null ? void 0 : l.call(o, d)) || this.id && ((y = d.closest) == null ? void 0 : y.call(d, `#${CSS.escape(this.id)}`)));
    };
    this._votvJarmuBlur = (d) => {
      ...
      var c, m, h;
      const o = d.currentTarget, l = (c = o == null ? void 0 : o.dataset) == null ? void 0 : c.itemId;
      if (!l) return;
      const y = this.actor.items.get(l);
      if (!y || y.type !== "Jarmuegyseg") return;
      const a = (o.value ?? "").trim(), i = a === "" ? 0 : Number(a), r = (m = o.closest) == null ? void 0 : m.call(o, ".jarmu-unit-row");
      if (r) {
      ...
      var i;
      const o = d.currentTarget, l = (i = o == null ? void 0 : o.dataset) == null ? void 0 : i.itemId;
      if (!l) return;
      const y = this.actor.items.get(l);
  ...
  async _rollUnitDamage(s) {
    var p, d, o, l, y, a, i, r, c;
    const e = this.actor;
    if (!e) return;
    const t = ((d = (p = e.items).get) == null ? void 0 : d.call(p, s)) ?? ((l = (o = e.items.contents) == null ? void 0 : o.find) == null ? void 0 : l.call(o, (m) => m.id === s));
    if (!t || t.type !== "Jarmuegyseg" && t.type !== "Helyiseg") return;
    const n = (((y = t.system) == null ? void 0 : y.damage) ?? "").trim();
    if (!n) {
      (c = (a = ui.notifications) == null ? void 0 : a.warn) == null || c.call(
        a,
  ...
  async _postUnitAbilityToChat(s) {
    ...
    try {
      ...
      e = ((l = game.items) == null ? void 0 : l.get(s)) ?? null;
    }
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((a = e.system) == null ? void 0 : a.kp) ?? 0) || 0, f = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), u = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", p = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", d = f ? `<p>${f}</p>` : "", o = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${u}</p>
      ${p}
      ${d}
...
te(ge, "PARTS", foundry.utils.mergeObject(
  ...
  z(ge, ge, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Es = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Es.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Ps = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : Ps.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((xs = ($s = z(ge, ge, "DEFAULT_OPTIONS")) == null ? void 0 : $s.window) == null ? void 0 : xs.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
function Ds(I) {
  ...
  return (((e = I == null ? void 0 : I.items) == null ? void 0 : e.contents) ?? []).filter((t) => t.type === "Helyiseg").reduce((t, n) => {
    var f;
    return t + Ni((f = n.system) == null ? void 0 : f.veszely);
  }, 0);
}
var Rs;
const it = class it extends xt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      var O, C, M, j, U, R, J;
      const o = ((O = e.querySelector) == null ? void 0 : O.call(e, "form")) ?? e, l = (C = o.querySelector) == null ? void 0 : C.call(o, 'select[name="system.identity.assignment"]'), y = (M = o.querySelector) == null ? void 0 : M.call(o, 'select[name="system.identity.subAssignment"]'), a = (j = o.querySelector) == null ? void 0 : j.call(o, "input.bazis-threat-total"), i = (U = o.querySelector) == null ? void 0 : U.call(o, 'input[name="system.combat.threatBonus"]');
      if (!l || !a || !i) return;
      const r = l.value ?? "", c = (y == null ? void 0 : y.value) ?? "", m = t[r] ?? 0, h = n[c] ?? 0, g = (((J = (R = this.actor) == null ? void 0 : R.items) == null ? void 0 : J.contents) ?? []).filter((Y) => Y.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", k = f[v] ?? 0, w = Number(i.value ?? 0) || 0, T = Ds(this.actor), _ = m + h + k + w + T;
      a.value = _;
    };
  ...
  async _prepareContext(s) {
    ...
    if (((t = e == null ? void 0 : e.actor) == null ? void 0 : t.type) === "Bazis") {
      const n = e.system ?? this.actor.system ?? {}, f = n.identity ?? {}, u = n.combat ?? {}, p = f.assignment ?? "", d = f.subAssignment ?? "", o = {
        "Középső Rendszerek": -10,
        "Köztársasági Ágak": 10,
        "Peremvidék, vagy azon túl": 30
      }, l = {
        ...
        "Elhagyott Zóna": 30,
        "Zónán kívüli terület": 30
      }, y = { Kicsi: -10, Közepes: 0, Nagy: 10 }, a = o[p] ?? 0, i = l[d] ?? 0, r = e.sizeForSelect ?? "Kicsi", c = y[r] ?? 0, m = Number(u.threatBonus ?? 0) || 0, h = Ds(this.actor), g = a + i + c + m + h;
      e.system = foundry.utils.mergeObject(
        foundry.utils.duplicate(n),
        { combat: { ...u, threat: g, threatBonus: m } },
        { inplace: !1 }
      ), e.bazisThreatBase = a;
    }
    return e;
...
te(it, "DEFAULT_OPTIONS", foundry.utils.mergeObject(
  z(it, it, "DEFAULT_OPTIONS"),
  {
    ...
    width: 1e3,
    height: 600,
    form: foundry.utils.mergeObject(((Rs = z(it, it, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !0 })
  },
  { inplace: !1 }
));
let Ht = it;
...
const qe = class qe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvProfileImgClick = (u) => {
      var o, l, y, a, i, r, c;
      if (!e.isEditable || !((l = (o = u.target) == null ? void 0 : o.closest) != null && l.call(o, ".profile")) && ((a = (y = u.target) == null ? void 0 : y.getAttribute) == null ? void 0 : a.call(y, "data-edit")) !== "img") return;
      u.preventDefault(), u.stopPropagation();
      const p = ((c = (r = (i = foundry.applications) == null ? void 0 : i.apps) == null ? void 0 : r.FilePicker) == null ? void 0 : c.implementation) ?? globalThis.FilePicker;
      new p({
        type: "image",
    ...
    const n = (u) => {
      ...
      var p, d, o;
      return u && (((d = (p = e.element) == null ? void 0 : p.contains) == null ? void 0 : d.call(p, u)) || e.id && ((o = u.closest) == null ? void 0 : o.call(u, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (u) => {
      var d, o, l;
      const p = ((d = u.target) == null ? void 0 : d.form) ?? ((l = (o = u.target) == null ? void 0 : o.closest) == null ? void 0 : l.call(o, "form"));
      f(p) && n(p);
...
te(qe, "PARTS", foundry.utils.mergeObject(z(qe, qe, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Ms = z(qe, qe, "DEFAULT_OPTIONS")) == null ? void 0 : Ms.form) ?? {}, { submitOnChange: !1 })
}));
let Gt = qe;
var zs;
...
te(Le, "PARTS", foundry.utils.mergeObject(z(Le, Le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((zs = z(Le, Le, "DEFAULT_OPTIONS")) == null ? void 0 : zs.form) ?? {}, { submitOnChange: !1 })
}));
let Vt = Le;
var js;
...
te(Ne, "PARTS", foundry.utils.mergeObject(z(Ne, Ne, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((js = z(Ne, Ne, "DEFAULT_OPTIONS")) == null ? void 0 : js.form) ?? {}, { submitOnChange: !1 })
}));
let Wt = Ne;
var Ks;
const Fe = class Fe extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    e._votvChange = (u) => {
      ...
      const d = (p == null ? void 0 : p.form) ?? ((o = p == null ? void 0 : p.closest) == null ? void 0 : o.call(p, "form"));
...
te(Fe, "PARTS", foundry.utils.mergeObject(z(Fe, Fe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ks = z(Fe, Fe, "DEFAULT_OPTIONS")) == null ? void 0 : Ks.form) ?? {}, { submitOnChange: !0 })
}));
let Jt = Fe;
var Us;
...
te(Ae, "PARTS", foundry.utils.mergeObject(z(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Us = z(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Us.form) ?? {}, { submitOnChange: !1 })
}));
let Zt = Ae;
var Bs;
...
te(Ee, "PARTS", foundry.utils.mergeObject(z(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Bs = z(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Bs.form) ?? {}, { submitOnChange: !1 })
}));
let Yt = Ee;
var Hs, Gs;
const Se = class Se extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    console.log(
      ...
      "id=",
      (l = this.document) == null ? void 0 : l.id,
      "root=",
      t
      ...
      try {
        ...
        if (w.type === "Kepesseg" || w.type === "ability") {
          const T = w.uuid ?? w.id, _ = this.document.system ?? {}, O = Array.isArray((c = _.abilities) == null ? void 0 : c.items) ? _.abilities.items.slice() : [];
      ...
      !c && r && (c = ((k = game.items) == null ? void 0 : k.get(r)) ?? null), (w = c == null ? void 0 : c.sheet) == null || w.render(!0);
    }), n.on("click", ".karakter-ability-chat", async (a) => {
      var m, h, g, v;
      a.preventDefault();
      const i = (h = (m = a.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : h.itemRef, r = (v = (g = a.currentTarget) == null ? void 0 : g.dataset) == null ? void 0 : v.itemId, c = i || r;
      c && await this._postAbilityToChat(c);
      ...
      if (!i) return;
      const r = this.document.system ?? {}, c = Array.isArray((k = r.abilities) == null ? void 0 : k.items) ? r.abilities.items.slice() : [], m = c.indexOf(i), h = m >= 0 ? [...c.slice(0, m), ...c.slice(m + 1)] : c;
    ...
    const u = (a) => {
      ...
      var i, r, c;
      return a && (((r = (i = e.element) == null ? void 0 : i.contains) == null ? void 0 : r.call(i, a)) || e.id && ((c = a.closest) == null ? void 0 : c.call(a, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (a) => {
      var r, c, m;
      const i = ((r = a.target) == null ? void 0 : r.form) ?? ((m = (c = a.target) == null ? void 0 : c.closest) == null ? void 0 : m.call(c, "form"));
      p(i) && u(i);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
  ...
  async _prepareContext(s) {
    ...
    const p = (await Promise.all(
      f.map(async (d) => {
        ...
        if (!d) return null;
        try {
          const l = await fromUuid(d);
          if (l && (l.type === "Kepesseg" || l.type === "ability")) return l;
        } catch {
          const l = (o = game.items) == null ? void 0 : o.get(d);
          if (l && (l.type === "Kepesseg" || l.type === "ability")) return l;
        }
        return null;
      })
    )).map((d, o) => ({ doc: d, ref: f[o] })).filter((d) => !!d.doc && !!d.ref).map(({ doc: d, ref: o }) => {
      var i, r;
      const l = (((i = d.system) == null ? void 0 : i.kind) ?? "passive").toString(), y = Number(((r = d.system) == null ? void 0 : r.kp) ?? 0) || 0, a = l === "species";
      return {
        id: d.id,
        ref: o,
        name: d.name,
  ...
  async _onDropDocument(s, e) {
    ...
    if (e.type === "Kepesseg" || e.type === "ability") {
      const u = e.uuid ?? e.id, p = this.document.system ?? {}, d = Array.isArray((n = p.abilities) == null ? void 0 : n.items) ? p.abilities.items.slice() : [];
      return d.push(u), console.log("VOTV JarmuEgysegSheet _onDropDocument updating abilities.items to", d), await this.document.update({ "system.abilities.items": d }), e;
    }
...
te(Se, "PARTS", foundry.utils.mergeObject(z(Se, Se, "PARTS") ?? {}, {
  ...
  z(Se, Se, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Hs = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Hs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Gs = z(Se, Se, "DEFAULT_OPTIONS")) == null ? void 0 : Gs.dragDrop) ?? [],
      {
        dragSelector: null,
...
const Te = class Te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    n.on("click", ".karakter-ability-open", async (l) => {
      var r, c, m, h, g, v;
      l.preventDefault();
      const y = (c = (r = l.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : c.itemRef, a = (h = (m = l.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : h.itemId;
      let i = null;
      if (y)
        try {
          i = await fromUuid(y);
      ...
      var r, c, m, h;
      l.preventDefault();
      const y = (c = (r = l.currentTarget) == null ? void 0 : r.dataset) == null ? void 0 : c.itemRef, a = (h = (m = l.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : h.itemId, i = y || a;
      i && await this._postAbilityToChat(i);
    }), n.on("click", ".karakter-ability-pill-remove", async (l) => {
      var m, h, g;
      if (l.preventDefault(), !l.altKey) return;
      const y = (h = (m = l.currentTarget) == null ? void 0 : m.dataset) == null ? void 0 : h.itemRef;
      if (!y) return;
      const a = this.document.system ?? {}, i = Array.isArray((g = a.abilities) == null ? void 0 : g.items) ? a.abilities.items.slice() : [], r = i.indexOf(y), c = r >= 0 ? [...i.slice(0, r), ...i.slice(r + 1)] : i;
      await this.document.update({ "system.abilities.items": c });
    });
    const f = (o = t == null ? void 0 : t.querySelector) == null ? void 0 : o.call(t, ".karakter-ability-area[data-area='abilities']");
    if (f && (f.addEventListener("dragover", (l) => {
      l.preventDefault(), f.classList.add("karakter-ability-area-drag-over");
    }), f.addEventListener("dragleave", () => {
      f.classList.remove("karakter-ability-area-drag-over");
    }), f.addEventListener("drop", () => {
      f.classList.remove("karakter-ability-area-drag-over");
      ...
      try {
        ...
        if (!(this.element && r.includes(this.element) || this.id && ((a = (y = l.target) == null ? void 0 : y.closest) == null ? void 0 : a.call(y, `#${CSS.escape(this.id)}`)))) return;
        let m = null;
        try {
          m = TextEditor.getDragEventData(l);
        } catch {
        }
        ...
        console.error("VoidHelyisegSheet global drop error", r);
      }
    }, window.addEventListener("drop", this._votvGlobalDrop, !0)), !this.isEditable) return;
    const u = (l) => {
      if (!l) return;
      const y = e._getFormDataForUpdate(l);
      Object.keys(y).length !== 0 && e.document.update(y).catch((a) => console.warn("VoidHelyisegSheet save failed", a));
    }, p = (l) => {
      var y, a, i;
      return l && (((a = (y = e.element) == null ? void 0 : y.contains) == null ? void 0 : a.call(y, l)) || e.id && ((i = l.closest) == null ? void 0 : i.call(l, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (l) => {
      var a, i, r;
      const y = ((a = l.target) == null ? void 0 : a.form) ?? ((r = (i = l.target) == null ? void 0 : i.closest) == null ? void 0 : r.call(i, "form"));
      p(y) && u(y);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(s) {
  ...
  async _onDropDocument(s, e) {
    ...
    if (e.type === "Kepesseg" || e.type === "ability") {
      const u = e.uuid ?? e.id, p = this.document.system ?? {}, d = Array.isArray((n = p.abilities) == null ? void 0 : n.items) ? p.abilities.items.slice() : [];
      return d.push(u), await this.document.update({ "system.abilities.items": d }), e;
    }
    return (f = super._onDropDocument) == null ? void 0 : f.call(this, s, e);
  }
};
te(Te, "PARTS", foundry.utils.mergeObject(z(Te, Te, "PARTS") ?? {}, {
  ...
  z(Te, Te, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((Vs = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Vs.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((Ws = z(Te, Te, "DEFAULT_OPTIONS")) == null ? void 0 : Ws.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = ri, CONFIG.Actor.dataModels.Npc = Rt, CONFIG.Actor.dataModels.Jarmu = li, CONFIG.Actor.dataModels.Bazis = pi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = vs, CONFIG.Item.dataModels.weapon = vs, CONFIG.Item.dataModels.Pancel = gi, CONFIG.Item.dataModels.MikroChip = hi, CONFIG.Item.dataModels.Kepesseg = Is, CONFIG.Item.dataModels.ability = Is, CONFIG.Item.dataModels.Targy = vi, CONFIG.Item.dataModels.Egyeb = wi, CONFIG.Item.dataModels.Jarmuegyseg = Si, CONFIG.Item.dataModels.Helyiseg = Oi, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
    bar: ["resources.health"],
    value: []
  }, CONFIG.Actor.trackableAttributes.Npc = {
    bar: ["", "resources.health"],
    value: []
  }, (f = CONFIG.Actor).typeLabels ?? (f.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", CONFIG.Actor.typeLabels.Npc = "NPC", CONFIG.Actor.typeLabels.Jarmu = "Jármű", CONFIG.Actor.typeLabels.Bazis = "Bázis", (u = CONFIG.Combat).initiative ?? (u.initiative = {}), CONFIG.Combat.initiative.formula = "1d20", (p = CONFIG.Item).typeLabels ?? (p.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.weapon = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", CONFIG.Item.typeLabels.Jarmuegyseg = "Járműegység", CONFIG.Item.typeLabels.Helyiseg = "Helyiség";
  ...
  CONFIG.statusEffects = [
  ...
  }), Hooks.on("preCreateActor", (d, o, l) => {
    (o == null ? void 0 : o.type) === "Bazis" && (o.img = "");
  }), Hooks.on("preUpdateActor", (d, o, l) => {
    (d == null ? void 0 : d.type) === "Bazis" && Object.prototype.hasOwnProperty.call(o ?? {}, "img") && (o.img = "");
  }), Hooks.on("ready", () => {
    var o;
    const d = (((o = game.actors) == null ? void 0 : o.contents) ?? []).filter((l) => l.type === "Bazis" && (l.img ?? "").toString().trim() !== "");
    d.length && d.forEach((l) => l.update({ img: "" }).catch(() => {
    }));
  }), Hooks.on("updateActor", (d, o, l, y) => {
    ...
    setTimeout(() => {
      ...
      const r = Ot.getTotalSpeedRaw(i), c = (h = i.effects) == null ? void 0 : h.find((k) => k.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (r <= 0 && !c) {
  ...
  const s = 500;
  Hooks.on("updateActor", (d, o, l, y) => {
    var w, T, _, O, C, M, j, U, R, J, Y, Z, X;
    const a = d == null ? void 0 : d.id;
    if (!a) return;
    if ((d.type === "Karakter" || d.type === "Npc") && ((w = o == null ? void 0 : o.system) != null && w.combat) && "initiativeResult" in o.system.combat) {
    ...
    if (d.type === "Npc" && ((M = o == null ? void 0 : o.system) != null && M.identity) && "size" in o.system.identity) {
      const K = Zs((U = (j = d.system) == null ? void 0 : j.identity) == null ? void 0 : U.size);
      d.update({
    ...
    const i = document.activeElement, r = i && (i.tagName === "INPUT" && i.type !== "checkbox" && i.type !== "radio" || i.tagName === "TEXTAREA" || i.isContentEditable), c = [], m = (R = game.actors) == null ? void 0 : R.get(a);
    m != null && m.apps && c.push(...Array.from(m.apps));
    const h = Object.values((ui == null ? void 0 : ui.windows) ?? {});
    for (const K of h) {
      if (((J = K.document) == null ? void 0 : J.id) !== a || ((Y = K.document) == null ? void 0 : Y.documentName) !== "Actor") continue;
      const V = (Z = K.constructor) == null ? void 0 : Z.name;
      V !== "VoidKarakterSheet" && V !== "VoidJarmuSheet" && V !== "VoidBazisSheet" || c.includes(K) || c.push(K);
    }
    if (r && c.some((K) => {
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, v, k, w, T, _, O, C, M, j, U, R, J, Y, Z, X, K, V, oe, be, he, D;
    ...
    let d = ((_ = game.actors) == null ? void 0 : _.get(u.actorId)) ?? ((O = game.actors) == null ? void 0 : O.get(p));
    if (d || (d = ((M = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : M.flatMap((W) => {
      var se;
      return ((se = W.tokens) == null ? void 0 : se.contents) ?? [];
    }).map((W) => W.actor).find((W) => W && (W.id === p || W.id === u.actorId))) ?? null), !d) return;
    const o = u.itemId ? ((U = (j = d.items) == null ? void 0 : j.get) == null ? void 0 : U.call(j, u.itemId)) ?? ((Y = (J = (R = d.items) == null ? void 0 : R.contents) == null ? void 0 : J.find) == null ? void 0 : Y.call(J, (E) => E.id === u.itemId)) : null;
    let l = (u.damageFormula ?? "").trim();
    if (l || (l = (((Z = o == null ? void 0 : o.system) == null ? void 0 : Z.damage) ?? "").trim()), !l && u.slotKey && (l = (((((X = d.system) == null ? void 0 : X.weapons) ?? {})[u.slotKey] ?? {}).damage ?? "").trim()), !l) {
    ...
    const a = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = u.targetName || "", r = u.hitLocationName || "", c = ((o == null ? void 0 : o.name) ?? (u.slotKey ? ((D = (((he = d.system) == null ? void 0 : he.weapons) ?? {})[u.slotKey]) == null ? void 0 : D.name) ?? "" : "")) || "Fegyver";
    let m = i ? `${c} – sebzés – ${i}` : `${c} – sebzés`;
    ...
    (e) => {
      ...
      const t = (o = (d = e.target) == null ? void 0 : d.closest) == null ? void 0 : o.call(d, "[data-document-id]"), n = (l = t == null ? void 0 : t.getAttribute) == null ? void 0 : l.call(t, "data-document-id");
      if (!n) return;
    ...
    for (const p of e) {
      const d = Ot.getTotalSpeedRaw(p), o = (n = p.effects) == null ? void 0 : n.find((l) => l.getFlag("vacuum-of-the-void", "immobilizedFromSpeed") === !0);
      if (d <= 0 && !o) {
        const l = ((u = (f = CONFIG.statusEffects) == null ? void 0 : f.find((y) => y.id === "immobilized")) == null ? void 0 : u.img) ?? "";
      ...
      } else d > 0 && o && await o.delete().catch(() => {
      });
    }
    ...
    for (const a of t)
      try {
        const i = a.prototypeToken, r = ((p = i == null ? void 0 : i.bar1) == null ? void 0 : p.attribute) ?? "", c = ((d = i == null ? void 0 : i.bar2) == null ? void 0 : d.attribute) ?? "";
        (r || c) && await a.update({
    ...
    for (const a of game.scenes ?? []) {
      const i = ((o = a.tokens) == null ? void 0 : o.filter((r) => {
        var c;
        return ((c = r.actor) == null ? void 0 : c.type) === "Karakter";
      })) ?? [];
      for (const r of i)
        try {
          await r.update(e);
        } catch (c) {
          console.warn("Vacuum of the Void | Token update failed for", r.name, c);
        }
    }
    const n = {
      "bar1.attribute": "",
      "bar2.attribute": "resources.health"
    }, f = ((l = game.actors) == null ? void 0 : l.filter((a) => a.type === "Npc")) ?? [];
    for (const a of f)
      try {
        await a.update({
          "prototypeToken.bar1.attribute": "",
    ...
    for (const a of game.scenes ?? []) {
      const i = ((y = a.tokens) == null ? void 0 : y.filter((r) => {
        var c;
        return ((c = r.actor) == null ? void 0 : c.type) === "Npc";
      })) ?? [];
      for (const r of i)
        try {
          await r.update(n);
        } catch (c) {
          console.warn("Vacuum of the Void | NPC token update failed for", r.name, c);
        }
    }
  })();
});
Hooks.on("preCreateToken", (I, s, e) => {
  ...
  const f = n ? (d = game.actors) == null ? void 0 : d.get(n) : I.actor ?? null;
  if (f) {
    if (f.type === "Bazis")
      return (y = ui == null ? void 0 : ui.notifications) == null || y.warn(((l = (o = game.i18n) == null ? void 0 : o.localize) == null ? void 0 : l.call(o, "VOTV.BazisNoToken")) ?? "Bázis nem helyezhető tokenként a térképre."), !1;
    if (f.type === "Karakter") {
      I.updateSource({
        ...t ? { actorId: t } : {},
        actorLink: !0,
    ...
    if (f.type === "Npc") {
      const r = Zs((i = (a = f.system) == null ? void 0 : a.identity) == null ? void 0 : i.size);
      I.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
Hooks.on("renderChatMessageHTML", (I, s, e) => {
  var y, a, i, r;
  const t = ((y = I.flags) == null ? void 0 : y["vacuum-of-the-void"]) ?? {}, n = t.resultType, f = t.critLabel, u = t.weaponAttack, p = t.weapon, d = t.vsDefense, o = t.vsDefenseInfo;
  if (!n && !f && !u && !d) return;
  const l = (a = s == null ? void 0 : s.querySelector) == null ? void 0 : a.call(s, ".dice-roll");
  if (l) {
    if (n && l.classList.add(`votv-${n}`), f) {
      const c = l.querySelector(".votv-crit-label");
      if (c)
        c.textContent = f;
      else {
        const m = l.querySelector(".dice-total"), h = (m == null ? void 0 : m.parentElement) ?? l, g = document.createElement("div");
    ...
    if (u && p && (p.actorId || (i = I.speaker) != null && i.actor)) {
      const c = l.querySelector(".dice-total"), m = (c == null ? void 0 : c.parentElement) ?? l;
      if (!l.querySelector(".votv-weapon-outcome")) {
      ...
      if (p.isHit && !l.querySelector(".votv-weapon-damage-chat")) {
        const v = document.createElement("button");
        v.type = "button", v.className = "votv-weapon-damage-chat";
        const k = p.hitLocationRoll, w = p.hitLocationName;
        v.textContent = k != null && w ? `Sebzés (Találati Hely ${k} - ${w})` : "Sebzés", v.dataset.actorId = String(p.actorId ?? ((r = I.speaker) == null ? void 0 : r.actor) ?? ""), v.dataset.itemId = String(p.itemId ?? ""), v.dataset.slotKey = String(p.slotKey ?? ""), v.dataset.targetName = String(p.targetName ?? ""), v.dataset.hitLocationName = String(p.hitLocationName ?? ""), v.dataset.messageId = String(I.id ?? ""), m.appendChild(v);
      }
    }
    if (!u && d && o) {
      const c = l.querySelector(".dice-total"), m = (c == null ? void 0 : c.parentElement) ?? l, h = !!o.isHit, g = o.targetName || "Célpont", v = o.hitLocationRoll, k = o.hitLocationName;
      let w = l.querySelector(".votv-defense-outcome");
      w || (w = document.createElement("div"), w.className = "votv-defense-outcome", m.appendChild(w)), w.textContent = h ? `Találat – ${g}` : `Nem talált – ${g}`;
      const T = l.querySelector(".votv-defense-hitloc");
      if (h && v != null && k) {
        let _ = T;
...
//# sourceMappingURL=vacuum-of-the-void-CyQaGln0.mjs.map
