...
var ms = Reflect.get;
var ps = (w, s, e) => s in w ? us(w, s, { enumerable: !0, configurable: !0, writable: !0, value: e }) : w[s] = e;
var Q = (w, s, e) => ps(w, typeof s != "symbol" ? s + "" : s, e);
var z = (w, s, e) => ms(ds(w), e, s);
const { HTMLField: fs, NumberField: O, SchemaField: K, StringField: S, BooleanField: te, ArrayField: Xe } = foundry.data.fields;
...
const { NumberField: dt, SchemaField: ys } = foundry.data.fields;
class gs extends ns {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: hs, NumberField: Ls, StringField: De } = foundry.data.fields;
...
const { BooleanField: bs, StringField: ct } = foundry.data.fields;
class ks extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      /** Felszerelve a karakteren (karakter lap checkbox). */
      equipped: new bs({ required: !1, initial: !1 }),
...
const { NumberField: mt, StringField: Kt } = foundry.data.fields;
...
const { NumberField: ws, StringField: jt } = foundry.data.fields;
...
const { StringField: Ut } = foundry.data.fields;
class Is extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new Ut({ required: !1, blank: !0, initial: "" }),
      quantity: new Ut({ required: !1, blank: !0, initial: "1" })
    };
  }
}
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var P, x, j, ae, X, Ee, he, Ie, be, Oe, qe, nt, rt, at, ot, We, Fe, It, St, Tt, Dt, _t, Ct, Ot, qt, Lt, Nt, Pt, At, Et, Ft;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    const t = Number((j = (x = (P = this.actor.system) == null ? void 0 : P.resources) == null ? void 0 : x.stress) == null ? void 0 : j.value) || 0;
    e.stressOver10 = t > 10;
    const n = this.actor.system.resources ?? {}, d = n.hitLocations ?? {}, r = n.currentHealth ?? {}, l = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const y of l) {
      const D = ((ae = d[y]) == null ? void 0 : ae.value) ?? 0, _ = r[y] ?? 0;
    ...
    const b = e.computedHealthStatus.legs ?? 3, u = Number(((Ee = (X = this.actor.system) == null ? void 0 : X.combat) == null ? void 0 : Ee.givenSpeed) ?? 0) || 0;
    let i;
    b === 0 ? i = 0 : b === 1 ? i = -6 : b === 2 ? i = -3 : i = u;
    const c = this._getTotalArmorSpeedPenalty();
    i += c, e.effectiveGivenSpeed = i;
    const a = (Number(((Ie = (he = this.actor.system) == null ? void 0 : he.combat) == null ? void 0 : Ie.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
    e.system = foundry.utils.mergeObject(
      foundry.utils.duplicate(this.actor.system),
      { combat: { givenSpeed: i, givenProtection: a } },
      { inplace: !1 }
    );
    const p = ((be = e.system) == null ? void 0 : be.combat) ?? {};
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (T.slotOrder ?? "").trim(), E = A ? A.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], C = (Oe = this.actor.system.gear) == null ? void 0 : Oe.microchips, F = C && typeof C == "object" && !Array.isArray(C) ? C : {}, N = (((qe = F.slot1) == null ? void 0 : qe.itemId) ?? "").trim(), H = (((nt = F.slot2) == null ? void 0 : nt.itemId) ?? "").trim(), B = (((rt = F.slot3) == null ? void 0 : rt.itemId) ?? "").trim(), G = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, q = typeof D.sort == "number" ? D.sort : 0;
      return _ - q;
    }).map((y) => {
      var ke, Ne, Pe, Se, Te, Je;
      const D = y.type === "Fegyver", _ = y.type === "MikroChip";
      let q = 0, M = "", ee = null;
      for (let $e = 0; $e < E.length; $e++) {
        const Qe = E[$e];
        if ((((ke = T[Qe]) == null ? void 0 : ke.itemId) ?? "") === y.id) {
          q = $e + 1, M = ((Ne = T[Qe]) == null ? void 0 : Ne.bonus) ?? "", ee = Qe;
          break;
        }
      }
      let Z = null;
      _ && (N === y.id ? Z = "slot1" : H === y.id ? Z = "slot2" : B === y.id && (Z = "slot3"));
      const Ye = D && ((Pe = y.system) != null && Pe.damage) ? y.system.damage : "", oe = D && typeof ((Se = y.system) == null ? void 0 : Se.range) == "string" ? (y.system.range || "").trim() : "", Le = ee ? Number((Te = T[ee]) == null ? void 0 : Te.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
        ...
        rangeStr: oe,
        slotBonusNum: Le,
        quantity: Number(((Je = y.system) == null ? void 0 : Je.quantity) ?? 1) || 1
      };
    });
    e.actionsTable = G;
    const V = (((at = this.actor.items) == null ? void 0 : at.contents) ?? []).filter((y) => y.type === "Fegyver"), R = V.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = R;
    const Y = "— Nincs fegyver —", J = E.filter((y) => {
      const _ = ((T[y] ?? {}).itemId ?? "").trim();
      return _ ? !!V.find((M) => M.id === _) : !1;
    });
    e.weaponSlots = J.map((y, D) => {
      const _ = T[y] ?? {}, q = (_.itemId ?? "").trim(), M = R.find((ee) => ee.id === q);
      return {
        slotKey: y,
        itemId: q,
        slotNum: D + 1,
        displayName: (M == null ? void 0 : M.name) || _.name || Y,
    ...
    e.weaponsTable = V.map((y) => {
      ...
      let _ = null, q = {};
      for (const ut of E)
        if (((($t = T[ut]) == null ? void 0 : $t.itemId) ?? "").trim() === D) {
          _ = ut, q = T[ut] ?? {};
          break;
        }
      const M = !!_, ee = ((xt = y.system) == null ? void 0 : xt.equipped) !== void 0 && ((Rt = y.system) == null ? void 0 : Rt.equipped) !== null ? !!y.system.equipped : M, Z = (y == null ? void 0 : y.system) ?? {}, Ye = typeof Z.range == "string" ? (Z.range || "").trim() : "", oe = Z.type ?? "", Le = (ve[oe] ?? oe) || "—", ke = Z.size ?? "", Ne = (ne[ke] ?? ke) || "", Pe = [Le, Ne].filter(Boolean).join(", ") || Le || "—", Se = oe === "projectile" || ke === "thrown", Te = Z.quantity, Je = Te != null ? String(Te).trim() : "1", $e = String(q.bonus ?? "").trim(), Qe = String(Z.bonus ?? "").trim(), ls = $e || Qe || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
        ...
        bonus: ls,
        damage: q.damage ?? Z.damage ?? "",
        rangeStr: Ye || "—",
        typeLabel: Le,
        typeAndSize: Pe,
        quantity: Je,
        quantityDisplay: Se ? Je : "—",
        isProjectile: Se,
        equipped: ee,
        special: (Z.special ?? "").trim() || "—"
      };
    });
    const fe = (((ot = this.actor.items) == null ? void 0 : ot.contents) ?? []).filter((y) => y.type === "Pancel");
    e.armorTable = fe.map((y) => {
      ...
      return {
        ...
        level: Ds((D.level ?? "").toString().trim()),
        special: (D.special ?? D.other ?? "").toString().trim() || "—",
        equipped: _
      };
    });
    const xe = (((We = this.actor.items) == null ? void 0 : We.contents) ?? []).filter((y) => y.type === "Targy");
    ...
    const re = (((Fe = this.actor.items) == null ? void 0 : Fe.contents) ?? []).filter((y) => y.type === "Egyeb");
    ...
    const se = (((It = this.actor.items) == null ? void 0 : It.contents) ?? []).filter((y) => y.type === "MikroChip"), ye = se.map((y) => ({ id: y.id, name: y.name, img: y.img })), Re = "— Nincs Mikro-Chip —", Me = ["slot1", "slot2", "slot3"], Ae = (y) => {
      var _, q, M;
      const D = [];
      return y !== 1 && D.push((((_ = F.slot1) == null ? void 0 : _.itemId) ?? "").trim()), y !== 2 && D.push((((q = F.slot2) == null ? void 0 : q.itemId) ?? "").trim()), y !== 3 && D.push((((M = F.slot3) == null ? void 0 : M.itemId) ?? "").trim()), D.filter(Boolean);
    };
    e.microchipItemsSlot1 = ye.filter((y) => !Ae(1).includes(y.id)), e.microchipItemsSlot2 = ye.filter((y) => !Ae(2).includes(y.id)), e.microchipItemsSlot3 = ye.filter((y) => !Ae(3).includes(y.id)), e.microchipSlots = Me.map((y) => {
      const D = F[y] ?? {}, _ = (D.itemId ?? "").trim(), q = se.find((M) => M.id === _);
      return {
        slotKey: y,
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || Re,
        img: (q == null ? void 0 : q.img) || "",
        active: D.active === !0
      };
    }), ["1", "2", "3"].forEach((y) => {
      const D = `slot${y}`, _ = F[D] ?? {}, q = (_.itemId ?? "").trim(), M = ye.find((ee) => ee.id === q);
      e[`microchip${y}ItemId`] = q, e[`microchip${y}DisplayName`] = (M == null ? void 0 : M.name) || _.name || Re, e[`microchip${y}Img`] = (M == null ? void 0 : M.img) || "";
    }), e.microchipsTable = se.map((y) => {
      var ke, Ne, Pe, Se;
      const D = y.id;
      let _ = null;
      for (const Te of Me)
        if ((((ke = F[Te]) == null ? void 0 : ke.itemId) ?? "").trim() === D) {
          _ = Te;
          break;
        }
      const q = !!_, M = ((Ne = y == null ? void 0 : y.system) == null ? void 0 : Ne.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", Z = M === "active", Ye = Number((Pe = y == null ? void 0 : y.system) == null ? void 0 : Pe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, oe = (((Se = y == null ? void 0 : y.system) == null ? void 0 : Se.description) ?? "").trim(), Le = oe ? oe.length > 60 ? oe.slice(0, 57) + "…" : oe : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const Ze = (((St = e.weaponsTable) == null ? void 0 : St.length) ?? 0) > 0 || (((Tt = e.armorTable) == null ? void 0 : Tt.length) ?? 0) > 0 || (((Dt = e.microchipsTable) == null ? void 0 : Dt.length) ?? 0) > 0 || (((_t = e.itemsTable) == null ? void 0 : _t.length) ?? 0) > 0;
    e.showEquipmentDropZone = !Ze;
    const Ke = this.actor.system.abilities ?? {}, Ve = (((Ct = this.actor.items) == null ? void 0 : Ct.contents) ?? []).map((y) => {
      var D, _, q;
      return {
        id: y.id,
        name: y.name,
    ...
    }), je = new Map(Ve.map((y) => [y.id, y])), et = "— Nincs képesség —", He = (y) => {
      const D = Ke[y] ?? {}, _ = (D.itemId ?? "").trim(), q = _ ? je.get(_) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: _,
        displayName: (q == null ? void 0 : q.name) || D.name || et,
        img: (q == null ? void 0 : q.img) || "",
        description: M,
        kp: ee
      };
    ...
    const tt = ((Ot = e.system) == null ? void 0 : Ot.resources) ?? {}, st = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], _e = (Lt = (qt = e.system) == null ? void 0 : qt.combat) == null ? void 0 : Lt.initiativeResult, ge = typeof _e == "number" ? _e : -1, it = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Be = (Pt = (Nt = e.system) == null ? void 0 : Nt.combat) == null ? void 0 : Pt.initiativeRanges, Ce = Array.isArray(Be) ? Be.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(6, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : it).slice().sort((y, D) => y.min - D.min);
    e.initiativeRanges = Ce.map((y, D) => ({ ...y, isFirst: D === 0, isLast: D === Ce.length - 1 }));
    let Ge = 0;
    if (typeof ge == "number" && ge >= 0 && we.length > 0) {
      const y = we[0], D = we[we.length - 1];
      let _ = null;
      ge <= y.max ? _ = y : ge >= D.min ? _ = D : _ = we.find((q) => ge >= q.min && ge <= q.max), _ && (Ge = _.kp);
    }
    e.kpDots = st.map((y, D) => {
      const _ = D + 1, q = !!Number(tt[y]), M = _ <= Ge;
      return { index: _, used: q, usable: M };
    });
    const k = !!((Et = (At = game.combat) == null ? void 0 : At.combatants) != null && Et.some((y) => {
      var D;
      return ((D = y.actor) == null ? void 0 : D.type) === "Karakter";
    }));
    return e.showHarcSection = k, e.canEditInitiative = !!((Ft = game.user) != null && Ft.isGM), e.showInitiativeResult = typeof _e == "number", e.initiativeResult = e.showInitiativeResult ? _e : "", e;
  }
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-D2EctOhF.mjs");
      a(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-D2EctOhF.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const c = i.currentTarget, o = c.dataset.skill, a = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-D2EctOhF.mjs");
      p(this.actor, o, a);
      ...
      if (!h) return;
      const v = ((A = (L = this.actor.items).get) == null ? void 0 : A.call(L, h)) ?? ((C = (E = this.actor.items.contents) == null ? void 0 : E.find) == null ? void 0 : C.call(E, (N) => N.id === h));
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if ((p == null ? void 0 : p.type) === "Fegyver") {
        const v = a.system.weapons ?? {}, I = (v.slotOrder ?? "").trim(), T = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], L = I ? I.split(/\s*,\s*/).filter((E) => T.includes(E)) : [], A = L.find((E) => {
          var C;
          return (((C = v[E]) == null ? void 0 : C.itemId) ?? "").trim() === o;
        });
        if (A) {
          const E = L.filter((C) => C !== A);
      ...
      const p = this.actor.system.weapons ?? {}, h = (p.slotOrder ?? "").trim(), v = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], I = h ? h.split(/\s*,\s*/).filter((C) => v.includes(C)) : [], T = I.find((C) => {
        var F;
        return (((F = p[C]) == null ? void 0 : F.itemId) ?? "").trim() === o;
      }) ?? null;
      if (c.checked) {
        if (T) return;
        let C = I.find((N) => {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${C}.damage`]: ((A = a == null ? void 0 : a.system) == null ? void 0 : A.damage) ?? "",
          [`system.weapons.${C}.bonus`]: ((E = a == null ? void 0 : a.system) == null ? void 0 : E.bonus) ?? ""
      ...
      if (c.checked) {
        ...
        await this.actor.update({
          ...
          [`system.weapons.${C}.damage`]: ((A = a.system) == null ? void 0 : A.damage) ?? "",
          [`system.weapons.${C}.bonus`]: ((E = a.system) == null ? void 0 : E.bonus) ?? ""
        }), await a.update({ "system.equipped": !0 });
      } else if (T) {
        const C = I.filter((F) => F !== T);
        await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (a && a.documentName === "Item" && a.type === "Fegyver") {
          ...
          if (h) {
            const I = ((b = p.system) == null ? void 0 : b.weapons) ?? {}, T = (I.slotOrder ?? "").trim(), L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = T ? T.split(/\s*,\s*/).filter((C) => L.includes(C)) : [], E = A.filter((C) => {
              var F;
              return (((F = I[C]) == null ? void 0 : F.itemId) ?? "").trim() === v;
            });
            if (E.length > 0) {
              const F = {
                "system.weapons.slotOrder": A.filter((N) => !E.includes(N)).join(",")
              };
              for (const N of E)
  ...
  async _rollSkill(s, e) {
    ...
    const { resultType: g, label: b } = pt(m), u = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return m.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(s) {
    ...
    const { resultType: p, label: h } = pt(a), v = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return a.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${l} – találat`,
...
Q(W, "PARTS", foundry.utils.mergeObject(
  ...
  z(W, W, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((zt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : zt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Bt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Bt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Wt = (Gt = z(W, W, "DEFAULT_OPTIONS")) == null ? void 0 : Gt.window) == null ? void 0 : Wt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ie = class ie extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var Re, Me, Ae, Ze, Ke, Ve, je, et, He, Ue, ze, tt, st, _e, ge, it, Be, Ce, lt, we, Ge;
    const e = await super._prepareContext(s) ?? {};
    e.actor = e.actor ?? this.actor, e.system = e.system ?? ((Re = this.actor) == null ? void 0 : Re.system), e.showDeathSkull = !1, e.sizeForSelect = (((Ae = (Me = e.system) == null ? void 0 : Me.identity) == null ? void 0 : Ae.size) ?? "").trim() || "Közepes";
    const t = this.actor, n = ((Ze = t == null ? void 0 : t.items) == null ? void 0 : Ze.contents) ?? [], d = ((Ke = t == null ? void 0 : t.system) == null ? void 0 : Ke.weapons) ?? {}, r = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], l = (d.slotOrder ?? "").trim(), f = l ? l.split(/\s*,\s*/).filter((k) => r.includes(k)) : [], m = n.filter((k) => k.type === "Fegyver"), g = m.map((k) => ({ id: k.id, name: k.name, img: k.img })), b = "— Nincs fegyver —", u = f.length > 0 ? f : r, i = r.filter((k) => !u.includes(k)), c = [...u, ...i], o = c.filter((k) => {
      var x;
      const P = (((x = d[k]) == null ? void 0 : x.itemId) ?? "").trim();
      return P && m.some((j) => j.id === P);
    });
    e.weaponSlots = o.map((k) => {
      const P = d[k] ?? {}, x = (P.itemId ?? "").trim(), j = g.find((ae) => ae.id === x);
      return {
        slotKey: k,
        itemId: x,
    ...
    e.weaponsTable = m.map((k) => {
      ...
      let x = null, j = {};
      for (const Fe of c)
        if ((((We = d[Fe]) == null ? void 0 : We.itemId) ?? "").trim() === P) {
          x = Fe, j = d[Fe] ?? {};
          break;
        }
      const ae = !!x, X = (k == null ? void 0 : k.system) ?? {}, Ee = typeof X.range == "string" ? (X.range || "").trim() : "", he = X.type ?? "", Ie = (a[he] ?? he) || "—", be = X.size ?? "", Oe = (p[be] ?? be) || "", qe = [Ie, Oe].filter(Boolean).join(", ") || Ie || "—", nt = he === "projectile" || be === "thrown", rt = X.quantity != null ? String(X.quantity).trim() : "1", at = String(X.bonus ?? j.bonus ?? "").trim() || "0", ot = (X.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    e.armorTable = h.map((k) => {
      ...
      return {
        ...
        level: _s((P.level ?? "").toString().trim()),
        special: (P.special ?? P.other ?? "").toString().trim() || "—",
        equipped: x
      };
    });
    const v = ((je = (Ve = t == null ? void 0 : t.system) == null ? void 0 : Ve.gear) == null ? void 0 : je.microchips) ?? {}, I = ["slot1", "slot2", "slot3"], T = n.filter((k) => k.type === "MikroChip");
    e.microchipsTable = T.map((k) => {
      var he, Ie, be, Oe;
      const P = k.id;
      let x = null;
      for (const qe of I)
        if ((((he = v[qe]) == null ? void 0 : he.itemId) ?? "").trim() === P) {
          x = qe;
          break;
        }
      ...
      return {
        ...
        typeLabel: ae,
        description: Ee,
        kp: Number((Oe = k == null ? void 0 : k.system) == null ? void 0 : Oe.replaceCost) >= 0 ? Number(k.system.replaceCost) : 0,
        isActive: j === "active",
        slotKey: x ?? "",
        equipped: !!x
      };
    ...
    const E = (((et = e.weaponsTable) == null ? void 0 : et.length) ?? 0) > 0 || (((He = e.armorTable) == null ? void 0 : He.length) ?? 0) > 0 || (((Ue = e.microchipsTable) == null ? void 0 : Ue.length) ?? 0) > 0 || (((ze = e.itemsTable) == null ? void 0 : ze.length) ?? 0) > 0 || (((tt = e.egyebList) == null ? void 0 : tt.length) ?? 0) > 0;
    e.showEquipmentDropZone = !E;
    const C = ((st = t == null ? void 0 : t.system) == null ? void 0 : st.abilities) ?? {}, F = n.filter((k) => k.type === "Kepesseg" || k.type === "ability").map((k) => {
      var P, x;
      return {
        id: k.id,
        name: k.name,
    ...
    const G = t == null ? void 0 : t.id, V = !!((ge = (_e = game.combat) == null ? void 0 : _e.combatants) != null && ge.some(
      (k) => {
        var P;
        return (((P = k.actor) == null ? void 0 : P.id) ?? k.actorId) === G;
      }
    ));
    e.showHarcSection = V;
    const R = ((it = e.system) == null ? void 0 : it.resources) ?? {}, Y = (Ce = (Be = e.system) == null ? void 0 : Be.combat) == null ? void 0 : Ce.initiativeResult, J = typeof Y == "number" ? Y : -1, ve = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], ne = (we = (lt = e.system) == null ? void 0 : lt.combat) == null ? void 0 : we.initiativeRanges, fe = Array.isArray(ne) ? ne.map((k) => ({ min: Number(k.min) ?? 0, max: Number(k.max) ?? 0, kp: Math.min(6, Math.max(0, Number(k.kp) ?? 0)) })) : [], re = (fe.length > 0 ? fe : ve).slice().sort((k, P) => k.min - P.min);
    e.initiativeRanges = fe.map((k, P) => ({ ...k, isFirst: P === 0, isLast: P === fe.length - 1 }));
    let se = 0;
    if (typeof J == "number" && J >= 0 && re.length > 0) {
      const k = re[0], P = re[re.length - 1];
      let x = null;
      J <= k.max ? x = k : J >= P.min ? x = P : x = re.find((j) => J >= j.min && J <= j.max), x && (se = x.kp);
    }
    const ye = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"];
    return e.kpDots = ye.map((k, P) => {
      const x = P + 1, j = !!Number(R[k]), ae = x <= se;
      return { index: x, used: j, usable: ae };
    }), e.canEditInitiative = !!((Ge = game.user) != null && Ge.isGM), e.showInitiativeResult = typeof Y == "number", e.initiativeResult = e.showInitiativeResult ? Y : "", e;
  }
  _attachFrameListeners(s) {
    var m, g, b;
    super._attachFrameListeners(s);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-D2EctOhF.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-D2EctOhF.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-D2EctOhF.mjs");
      a(this.actor, c, o);
      ...
      const o = ((L = this.actor.system) == null ? void 0 : L.abilities) ?? {}, p = (Array.isArray((A = o[i]) == null ? void 0 : A.items) ? o[i].items.slice() : []).filter((E) => E !== c);
  ...
  async _rollWeapon(s) {
    ...
    const e = this.actor;
    if (!e) return;
    const n = (((T = e.system) == null ? void 0 : T.weapons) ?? {})[s] ?? {}, d = ((L = e.system) == null ? void 0 : L.skills) ?? {}, r = ((A = e.items) == null ? void 0 : A.filter((F) => F.type === "Fegyver")) ?? [];
    let l = null;
    n.itemId && (l = r.find((F) => F.id === n.itemId) ?? null);
    const f = l && l.name || n.name || "Fegyver", m = Number(n.bonus || 0) || 0, g = ((E = l == null ? void 0 : l.system) == null ? void 0 : E.type) || "kinetic", b = (((C = l == null ? void 0 : l.system) == null ? void 0 : C.skillKey) ?? "").trim(), u = b && d[b] !== void 0 ? b : g === "explosive" ? "grenadeUse" : "firearms", i = Number(d[u] || 0) || 0, c = m + i, a = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, p = new Roll(a);
    await p.evaluate({ async: !0 });
    const { resultType: h, label: v } = pt(p), I = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
  ...
  async _onDropItem(s, e) {
    var g, b, u, i, c, o, a, p, h, v, I, T, L, A, E, C, F;
    ...
    if (d.type === "Fegyver" && m) {
      ...
      const V = U.includes(G) ? U : [...U, G].filter((R) => H.includes(R));
      await r.update({
    ...
    if (d.type === "MikroChip" && m) {
      const N = ((F = (C = r.system) == null ? void 0 : C.gear) == null ? void 0 : F.microchips) ?? {}, B = ["slot1", "slot2", "slot3"].find((U) => {
        var G;
...
Q(ie, "PARTS", foundry.utils.mergeObject(
  ...
  z(ie, ie, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((Yt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Yt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Jt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Jt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Xt = (Qt = z(ie, ie, "DEFAULT_OPTIONS")) == null ? void 0 : Qt.window) == null ? void 0 : Xt.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ce = class ce extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    ...
    return (typeof t.range != "string" || t.range === "[object Object]") && (t.range = ""), (t.skillKey === void 0 || t.skillKey === null || String(t.skillKey).trim() === "") && (t.skillKey = "grenadeUse"), e.system = t, e.skillOptions = Cs, e;
  }
};
Q(ce, "PARTS", foundry.utils.mergeObject(z(ce, ce, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Zt = z(ce, ce, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.form) ?? {}, { submitOnChange: !1 })
}));
let gt = ce;
var Vt;
...
Q(le, "PARTS", foundry.utils.mergeObject(z(le, le, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Vt = z(le, le, "DEFAULT_OPTIONS")) == null ? void 0 : Vt.form) ?? {}, { submitOnChange: !1 })
}));
let ht = le;
var es;
...
Q(ue, "PARTS", foundry.utils.mergeObject(z(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((es = z(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : es.form) ?? {}, { submitOnChange: !1 })
}));
let bt = ue;
var ts;
...
Q(de, "PARTS", foundry.utils.mergeObject(z(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ts = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : ts.form) ?? {}, { submitOnChange: !0 })
}));
let kt = de;
var ss;
...
Q(me, "PARTS", foundry.utils.mergeObject(z(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ss = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : ss.form) ?? {}, { submitOnChange: !1 })
}));
let vt = me;
var is;
...
Q(pe, "PARTS", foundry.utils.mergeObject(z(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((is = z(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : is.form) ?? {}, { submitOnChange: !1 })
}));
let wt = pe;
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (l, f, m, g) => {
    ...
    if ((l.type === "Karakter" || l.type === "Npc") && ((I = f == null ? void 0 : f.system) != null && I.combat) && "initiativeResult" in f.system.combat) {
      ...
      if (J) {
        const ve = ((A = J.combatants) == null ? void 0 : A.contents) ?? Array.from(J.combatants ?? []);
        for (const ne of ve)
    ...
    if (l.type === "Npc" && ((C = f == null ? void 0 : f.system) != null && C.identity) && "size" in f.system.identity) {
      const R = as((N = (F = l.system) == null ? void 0 : F.identity) == null ? void 0 : N.size);
      l.update({
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var p, h, v, I, T, L, A, E, C, F, N, H, B, U, G, V, R, Y, J, ve, ne, fe, xe;
    ...
    if (f || (f = ((F = (C = game.scenes) == null ? void 0 : C.contents) == null ? void 0 : F.flatMap((se) => {
      var ye;
      return ((ye = se.tokens) == null ? void 0 : ye.contents) ?? [];
    ...
    if (g || (g = (((V = m == null ? void 0 : m.system) == null ? void 0 : V.damage) ?? "").trim()), !g && r.slotKey && (g = (((((R = f.system) == null ? void 0 : R.weapons) ?? {})[r.slotKey] ?? {}).damage ?? "").trim()), !g) {
...
Hooks.on("preCreateToken", (w, s, e) => {
  ...
  if (d) {
    ...
    if (d.type === "Npc") {
      const g = as((m = (f = d.system) == null ? void 0 : f.identity) == null ? void 0 : m.size);
      w.updateSource({
        ...t ? { actorId: t } : {},
        "bar1.attribute": "",
        "bar2.attribute": "resources.health",
...
function os(w) {
  ...
  for (const t of e) {
    const n = t.actor;
    !n || n.type !== "Karakter" && n.type !== "Npc" || n.update(Os).catch((d) => {
...
//# sourceMappingURL=vacuum-of-the-void-b4iVb1Ip.mjs.map
