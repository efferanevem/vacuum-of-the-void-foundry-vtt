...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et, T, z, M, G, Ie, ne, Le, Ce, Se, Re, tt, st, Pt, $t, xt, zt, _t, dt, as, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs, bs, vs;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DWW1GNfI.mjs");
      m(this.actor, l);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DWW1GNfI.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, l = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: h } = await import("./roll-sheet-DWW1GNfI.mjs");
      h(this.actor, l, m);
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: l } = await import("./roll-sheet-DWW1GNfI.mjs");
      l(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DWW1GNfI.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DWW1GNfI.mjs");
      m(this.actor, c, l);
...
X(he, "PARTS", foundry.utils.mergeObject(
  ...
  j(he, he, "DEFAULT_OPTIONS"),
  {
    ...
    window: foundry.utils.mergeObject(((xs = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : xs.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((Ms = (zs = j(he, he, "DEFAULT_OPTIONS")) == null ? void 0 : zs.window) == null ? void 0 : Ms.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _postUnitAbilityToChat(s) {
    ...
    if (!e || e.type !== "Kepesseg" && e.type !== "ability") return;
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", n = Number(((r = e.system) == null ? void 0 : r.kp) ?? 0) || 0, p = (((i = e.system) == null ? void 0 : i.description) ?? "").trim(), d = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", f = n > 0 ? `<p><strong>KP:</strong> ${n}</p>` : "", u = p ? `<p>${p}</p>` : "", a = `
      <h2>${e.name}</h2>
      <p><strong>Típus:</strong> ${d}</p>
      ${f}
      ${u}
...
X(be, "PARTS", foundry.utils.mergeObject(
  ...
  j(be, be, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Rs = j(be, be, "DEFAULT_OPTIONS")) == null ? void 0 : Rs.form) ?? {}, { submitOnChange: !1 }),
...
const at = class at extends Kt {
  _attachFrameListeners(s) {
    ...
    const t = {
      ...
      if (!o || !r || !i) return;
      const c = o.value ?? "", l = (y == null ? void 0 : y.value) ?? "", m = t[c] ?? 0, h = n[l] ?? 0, g = (((W = (P = this.actor) == null ? void 0 : P.items) == null ? void 0 : W.contents) ?? []).filter((Z) => Z.type === "Helyiseg").length, v = g >= 11 ? "Nagy" : g >= 6 ? "Közepes" : "Kicsi", w = p[v] ?? 0, k = Number(i.value ?? 0) || 0, I = Ls(this.actor), _ = m + h + w + k + I;
      r.value = _;
    };
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (a, o, y, r) => {
    ...
    if (a.type === "Npc" && ((K = o == null ? void 0 : o.system) != null && K.identity) && "size" in o.system.identity) {
      const R = ai((P = (U = a.system) == null ? void 0 : U.identity) == null ? void 0 : P.size);
      a.update({
...
//# sourceMappingURL=vacuum-of-the-void-DgzF4_2j.mjs.map
