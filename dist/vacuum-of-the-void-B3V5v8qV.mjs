...
var z = (w, i, e) => wi(vi(w), e, i);
const { HTMLField: Si, NumberField: C, SchemaField: K, StringField: S, BooleanField: te, ArrayField: it } = foundry.data.fields;
...
const { NumberField: bt, SchemaField: Ti } = foundry.data.fields;
class _i extends pi {
  static defineSchema() {
    return {
      ...super.defineSchema(),
...
const { BooleanField: Oi, StringField: yt } = foundry.data.fields;
...
const { NumberField: kt, StringField: Vt } = foundry.data.fields;
...
const { StringField: Pi } = foundry.data.fields;
class Ai extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    return {
      description: new Pi({ required: !1, blank: !0, initial: "" })
    };
  }
}
function vt(w) {
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var Ve, Ye, Je, Qe, k, P, x, j, ce, Q, Ie, be, Se, ke, Le, Ne, dt, mt, pt, ft, Xe, $e, Lt, Nt, Pt, At, Ft, Et, $t, xt, Rt, Mt, Kt, jt, Ht, Ut;
    ...
    const T = this.actor.system.weapons ?? {}, L = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], A = (T.slotOrder ?? "").trim(), F = A ? A.split(/\s*,\s*/).filter((y) => L.includes(y)) : [], O = (Le = this.actor.system.gear) == null ? void 0 : Le.microchips, E = O && typeof O == "object" && !Array.isArray(O) ? O : {}, N = (((Ne = E.slot1) == null ? void 0 : Ne.itemId) ?? "").trim(), H = (((dt = E.slot2) == null ? void 0 : dt.itemId) ?? "").trim(), G = (((mt = E.slot3) == null ? void 0 : mt.itemId) ?? "").trim(), W = this.actor.items.contents.filter((y) => y.type !== "Kepesseg" && y.type !== "ability").slice().sort((y, D) => {
      const _ = typeof y.sort == "number" ? y.sort : 0, q = typeof D.sort == "number" ? D.sort : 0;
      return _ - q;
    }).map((y) => {
      var ve, Ae, Fe, Te, _e, et;
      ...
      const Ze = D && ((Fe = y.system) != null && Fe.damage) ? y.system.damage : "", le = D && typeof ((Te = y.system) == null ? void 0 : Te.range) == "string" ? (y.system.range || "").trim() : "", Pe = ee ? Number((_e = T[ee]) == null ? void 0 : _e.bonus) || 0 : "";
      return {
        id: y.id,
        name: y.name,
        img: y.img,
    ...
    e.actionsTable = W;
    const Z = (((pt = this.actor.items) == null ? void 0 : pt.contents) ?? []).filter((y) => y.type === "Fegyver"), Y = Z.map((y) => ({ id: y.id, name: y.name, img: y.img }));
    e.weaponItems = Y;
    ...
    e.weaponsTable = Z.map((y) => {
      ...
      let _ = null, q = {};
      for (const ht of F)
        if ((((zt = T[ht]) == null ? void 0 : zt.itemId) ?? "").trim() === D) {
          _ = ht, q = T[ht] ?? {};
          break;
        }
      const M = !!_, ee = ((Bt = y.system) == null ? void 0 : Bt.equipped) !== void 0 && ((Gt = y.system) == null ? void 0 : Gt.equipped) !== null ? !!y.system.equipped : M, X = (y == null ? void 0 : y.system) ?? {}, Ze = typeof X.range == "string" ? (X.range || "").trim() : "", le = X.type ?? "", Pe = (oe[le] ?? le) || "—", ve = X.size ?? "", Ae = (ge[ve] ?? ve) || "", Fe = [Pe, Ae].filter(Boolean).join(", ") || Pe || "—", Te = le === "projectile" || ve === "thrown", _e = X.quantity, et = _e != null ? String(_e).trim() : "1", xe = String(q.bonus ?? "").trim(), tt = String(X.bonus ?? "").trim(), bi = xe || tt || "0";
      return {
        slotKey: _ ?? "",
        itemId: D,
    ...
    const re = (((ft = this.actor.items) == null ? void 0 : ft.contents) ?? []).filter((y) => y.type === "Pancel");
    ...
    e.microchipItemsSlot1 = ne.filter((y) => !je(1).includes(y.id)), e.microchipItemsSlot2 = ne.filter((y) => !je(2).includes(y.id)), e.microchipItemsSlot3 = ne.filter((y) => !je(3).includes(y.id)), e.microchipSlots = Ke.map((y) => {
      ...
      const q = !!_, M = ((Ae = y == null ? void 0 : y.system) == null ? void 0 : Ae.abilityType) ?? "", ee = M === "active" ? "Aktív" : M === "passive" ? "Passzív" : M || "—", X = M === "active", Ze = Number((Fe = y == null ? void 0 : y.system) == null ? void 0 : Fe.replaceCost) >= 0 ? Number(y.system.replaceCost) : 0, le = (((Te = y == null ? void 0 : y.system) == null ? void 0 : Te.description) ?? "").trim(), Pe = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (y == null ? void 0 : y.name) ?? "—",
    ...
    const qt = (((Nt = e.weaponsTable) == null ? void 0 : Nt.length) ?? 0) > 0 || (((Pt = e.armorTable) == null ? void 0 : Pt.length) ?? 0) > 0 || (((At = e.microchipsTable) == null ? void 0 : At.length) ?? 0) > 0 || (((Ft = e.itemsTable) == null ? void 0 : Ft.length) ?? 0) > 0;
    e.showEquipmentDropZone = !qt;
    const Ee = this.actor.system.abilities ?? {}, st = (((Et = this.actor.items) == null ? void 0 : Et.contents) ?? []).map((y) => {
      var D, _, q;
      return {
        id: y.id,
        name: y.name,
      ...
      const D = Ee[y] ?? {}, _ = (D.itemId ?? "").trim(), q = _ ? He.get(_) : null, M = (q == null ? void 0 : q.description) ?? "", ee = (q == null ? void 0 : q.kp) ?? 0;
      return {
        itemId: _,
    ...
    const at = (($t = e.system) == null ? void 0 : $t.resources) ?? {}, rt = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], Oe = (Rt = (xt = e.system) == null ? void 0 : xt.combat) == null ? void 0 : Rt.initiativeResult, he = typeof Oe == "number" ? Oe : -1, ot = [
      { min: 0, max: 6, kp: 2 },
      { min: 7, max: 12, kp: 3 },
      { min: 13, max: 18, kp: 4 },
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Ge = (Kt = (Mt = e.system) == null ? void 0 : Mt.combat) == null ? void 0 : Kt.initiativeRanges, Ce = Array.isArray(Ge) ? Ge.map((y) => ({ min: Number(y.min) ?? 0, max: Number(y.max) ?? 0, kp: Math.min(10, Math.max(0, Number(y.kp) ?? 0)) })) : [], we = (Ce.length > 0 ? Ce : ot).slice().sort((y, D) => y.min - D.min), qe = Ce.map((y) => y.min), ct = qe.length ? Math.min(...qe) : 0, lt = qe.length ? Math.max(...qe) : 0;
    e.initiativeRanges = Ce.map((y) => ({ ...y, isFirst: y.min === ct, isLast: y.min === lt }));
    let We = 0;
    ...
    const ut = !!((Ht = (jt = game.combat) == null ? void 0 : jt.combatants) != null && Ht.some((y) => {
      var D;
      return ((D = y.actor) == null ? void 0 : D.type) === "Karakter";
    }));
    return e.showHarcSection = ut, e.canEditInitiative = !!((Ut = game.user) != null && Ut.isGM), e.showInitiativeResult = typeof Oe == "number", e.initiativeResult = e.showInitiativeResult ? Oe : "", e;
  }
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: r } = await import("./roll-sheet-BbYbVx8I.mjs");
      r(this.actor, o);
      ...
      s.preventDefault(), s.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-BbYbVx8I.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', a), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(i), this._writeTotalDefense(e), this._writeTotalSpeed(i), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      s.preventDefault();
      const c = s.currentTarget, o = c.dataset.skill, r = ((h = c.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: f } = await import("./roll-sheet-BbYbVx8I.mjs");
      f(this.actor, o, r);
...
J(B, "PARTS", foundry.utils.mergeObject(
  ...
  z(B, B, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 1e3,
    height: 800,
    form: foundry.utils.mergeObject(((Xt = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Xt.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((Zt = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : Zt.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((ti = (ei = z(B, B, "DEFAULT_OPTIONS")) == null ? void 0 : ei.window) == null ? void 0 : ti.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
const ae = class ae extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(i) {
    var He, nt, Ue, ze, Be, at, rt, Oe, he, ot, Ge, Ce, gt, we, qe, ct, lt, We, ut, Ve, Ye, Je, Qe;
    ...
    e.weaponsTable = p.map((k) => {
      ...
      const ce = !!x, Q = (k == null ? void 0 : k.system) ?? {}, Ie = typeof Q.range == "string" ? (Q.range || "").trim() : "", be = Q.type ?? "", Se = (r[be] ?? be) || "—", ke = Q.size ?? "", Le = (f[ke] ?? ke) || "", Ne = [Se, Le].filter(Boolean).join(", ") || Se || "—", dt = be === "projectile" || ke === "thrown", mt = Q.quantity != null ? String(Q.quantity).trim() : "1", pt = String(Q.bonus ?? j.bonus ?? "").trim() || "0", ft = (Q.damage ?? j.damage ?? "").trim() || "";
      return {
        slotKey: x ?? "",
        itemId: P,
        actorId: t.id,
    ...
    const F = (((Oe = e.weaponsTable) == null ? void 0 : Oe.length) ?? 0) > 0 || (((he = e.armorTable) == null ? void 0 : he.length) ?? 0) > 0 || (((ot = e.microchipsTable) == null ? void 0 : ot.length) ?? 0) > 0 || (((Ge = e.itemsTable) == null ? void 0 : Ge.length) ?? 0) > 0 || (((Ce = e.egyebList) == null ? void 0 : Ce.length) ?? 0) > 0;
    ...
    const W = t == null ? void 0 : t.id, Z = !!((qe = (we = game.combat) == null ? void 0 : we.combatants) != null && qe.some(
      (k) => {
        var P;
    ...
    }), st = Math.ceil(Ee.length / 2);
    return e.kpDotsRow1 = Ee.slice(0, st), e.kpDotsRow2 = Ee.slice(st), e.canEditInitiative = !!((Ye = game.user) != null && Ye.isGM), e.showInitiativeResult = typeof R == "number", e.initiativeResult = e.showInitiativeResult ? R : "", e.speedUnitForSelect = ((Qe = (Je = e.system) == null ? void 0 : Je.combat) == null ? void 0 : Qe.speedUnit) ?? "m", e;
  }
  _attachFrameListeners(i) {
    var p, g, b;
    super._attachFrameListeners(i);
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-BbYbVx8I.mjs");
      o(this.actor, c);
      ...
      if (u.preventDefault(), u.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: s } = await import("./roll-sheet-BbYbVx8I.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: r } = await import("./roll-sheet-BbYbVx8I.mjs");
      r(this.actor, c, o);
...
J(ae, "PARTS", foundry.utils.mergeObject(
  ...
  z(ae, ae, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 800,
    height: 720,
    form: foundry.utils.mergeObject(((ii = z(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : ii.form) ?? {}, { submitOnChange: !1 }),
    window: foundry.utils.mergeObject(((si = z(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : si.window) ?? {}, {
      resizable: !0,
      contentClasses: [
        ...((ai = (ni = z(ae, ae, "DEFAULT_OPTIONS")) == null ? void 0 : ni.window) == null ? void 0 : ai.contentClasses) ?? [],
        "votv-scroll"
      ]
    })
  },
...
J(ue, "PARTS", foundry.utils.mergeObject(z(ue, ue, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((ri = z(ue, ue, "DEFAULT_OPTIONS")) == null ? void 0 : ri.form) ?? {}, { submitOnChange: !1 })
}));
let St = ue;
var oi;
...
J(de, "PARTS", foundry.utils.mergeObject(z(de, de, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((oi = z(de, de, "DEFAULT_OPTIONS")) == null ? void 0 : oi.form) ?? {}, { submitOnChange: !1 })
}));
let Tt = de;
var ci;
...
J(me, "PARTS", foundry.utils.mergeObject(z(me, me, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((ci = z(me, me, "DEFAULT_OPTIONS")) == null ? void 0 : ci.form) ?? {}, { submitOnChange: !1 })
}));
let _t = me;
var li;
...
J(pe, "PARTS", foundry.utils.mergeObject(z(pe, pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((li = z(pe, pe, "DEFAULT_OPTIONS")) == null ? void 0 : li.form) ?? {}, { submitOnChange: !0 })
}));
let Dt = pe;
var di;
...
J(fe, "PARTS", foundry.utils.mergeObject(z(fe, fe, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((di = z(fe, fe, "DEFAULT_OPTIONS")) == null ? void 0 : di.form) ?? {}, { submitOnChange: !1 })
}));
let Ot = fe;
var mi;
...
J(ye, "PARTS", foundry.utils.mergeObject(z(ye, ye, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((mi = z(ye, ye, "DEFAULT_OPTIONS")) == null ? void 0 : mi.form) ?? {}, { submitOnChange: !1 })
}));
let Ct = ye;
...
Hooks.once("init", () => {
  ...
  }, (e = CONFIG.Actor).dataModels ?? (e.dataModels = {}), CONFIG.Actor.dataModels.Karakter = _i, CONFIG.Actor.dataModels.Npc = pi, (t = CONFIG.Item).dataModels ?? (t.dataModels = {}), CONFIG.Item.dataModels.Fegyver = Wt, CONFIG.Item.dataModels.weapon = Wt, CONFIG.Item.dataModels.Pancel = Ci, CONFIG.Item.dataModels.MikroChip = qi, CONFIG.Item.dataModels.Kepesseg = Jt, CONFIG.Item.dataModels.ability = Jt, CONFIG.Item.dataModels.Targy = Ni, CONFIG.Item.dataModels.Egyeb = Ai, (n = CONFIG.Actor).trackableAttributes ?? (n.trackableAttributes = {}), CONFIG.Actor.trackableAttributes.Karakter = {
  ...
  Hooks.on("updateActor", (m, p, g, b) => {
    ...
    if (m.type === "Npc" && ((E = p == null ? void 0 : p.system) != null && E.identity) && "size" in p.system.identity) {
      const R = yi((H = (N = m.system) == null ? void 0 : N.identity) == null ? void 0 : H.size);
      m.update({
...
//# sourceMappingURL=vacuum-of-the-void-B3V5v8qV.mjs.map
