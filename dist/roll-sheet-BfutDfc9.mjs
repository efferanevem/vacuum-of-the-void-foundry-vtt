import { V as $, c as Y } from "./vacuum-of-the-void-DyxTO1D2.mjs";
class z extends Application {
  ...
  constructor(t = {}) {
    ...
    super(t), this._actor = s, this._skillKey = a ?? "", this._label = l ?? a ?? "", this._baseModifier = Number(h) || 0, this._injuryModifier = Number(v) || 0, this._injuryPenalty = Number(o) || 0, this._isWeaponAttack = !!e, this._isInitiativeRoll = !!isInitiativeRoll, this._weaponSlotKey = m || "", this._weaponItemId = u || "", this._weaponDamageFormula = typeof c == "string" ? c.trim() : "";
  }
  get actor() {
    return this._actor;
  }
  ...
  _bindRollSheetListeners() {
    ...
    const o = a.querySelector(".roll-sheet-morale-wrap"), e = Math.min(3, Math.max(0, parseInt(((S = o == null ? void 0 : o.dataset) == null ? void 0 : S.moraleMax) ?? "3", 10) || 0)), m = a.querySelector("input[name='moraleDice']"), u = a.querySelectorAll(".roll-sheet-morale-d8"), c = (i) => {
      let n = Math.min(3, Math.max(0, parseInt(i, 10) || 0));
      n = Math.min(n, e), m && (m.value = String(n)), u.forEach((r, p) => {
    ...
    a.querySelectorAll(".roll-sheet-morale-reset, .roll-sheet-morale-d8").forEach((i) => {
      i.addEventListener("click", (n) => {
        ...
        c(r), t._updateFormulaPreview(a);
      });
    }), c((m == null ? void 0 : m.value) ?? "0");
    const d = a.querySelector("input[name='constantBonus']");
    d && d.addEventListener("input", () => t._updateFormulaPreview(a)), d && d.addEventListener("change", () => t._updateFormulaPreview(a)), t._updateFormulaPreview(a), a._votvRollBound = !0, a.addEventListener("click", (i) => {
      var n, r, p, I;
  ...
  _updateFormulaPreview(t) {
    ...
    if (!s) return;
    const a = parseInt(((d = t.querySelector("input[name='constantBonus']")) == null ? void 0 : d.value) ?? "0", 10) || 0, l = parseInt(((f = t.dataset) == null ? void 0 : f.baseMod) ?? "0", 10) || 0, h = parseInt(((g = t.dataset) == null ? void 0 : g.injuryMod) ?? "0", 10) || 0, v = parseInt(((_ = t.dataset) == null ? void 0 : _.injuryPenalty) ?? "0", 10) || 0, o = l + h + v + a;
    ...
    const e = parseInt(((S = t.querySelector("input[name='advantage']")) == null ? void 0 : S.value) ?? "0", 10) || 0, m = parseInt(((i = t.querySelector("input[name='moraleDice']")) == null ? void 0 : i.value) ?? "0", 10) || 0, u = [];
    ...
    if (c.src = "systems/vacuum-of-the-void/assets/d6.svg", c.alt = "d6", c.className = "roll-sheet-preview-die", u[0].appendChild(c), e !== 0) {
      ...
      r.src = e > 0 ? "systems/vacuum-of-the-void/assets/advantage_d6.svg" : "systems/vacuum-of-the-void/assets/disadvantage_d6.svg", r.alt = e > 0 ? "előny d6" : "hátrány d6", r.className = "roll-sheet-preview-die", n.appendChild(r), u.push(n);
    }
    if (m > 0) {
      const n = document.createElement("span");
      n.textContent = ` + ${m} `;
      const r = document.createElement("img");
      r.src = "systems/vacuum-of-the-void/assets/moral_d8.svg", r.alt = "d8", r.className = "roll-sheet-preview-die", n.appendChild(r), u.push(n);
    }
    if (o !== 0) {
      const n = document.createElement("span");
...
//# sourceMappingURL=roll-sheet-BfutDfc9.mjs.map
