...
const { SchemaField: jt, StringField: ve, NumberField: ke, ArrayField: Wt } = foundry.data.fields;
class zi extends Nt {
  static defineSchema() {
    return {
      ...super.defineSchema(),
      vallalkozas: new jt({
        ...
        kind: new ve({ required: !1, blank: !0, initial: "" }),
        /** Vállalkozás szintje (legalább 1). */
        level: new ke({ required: !1, integer: !0, min: 1, initial: 1 }),
        /** Alkalmazottak aktuális száma. */
        employeesCurrent: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Alkalmazottak maximuma. */
        employeesMax: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Szint által adott bónuszok (szabad szöveg). */
        levelBonuses: new ve({ required: !1, blank: !0, initial: "" }),
        /** Szolgáltatás típusa (Szolgáltatások fajtánál). */
        servicesType: new ve({ required: !1, blank: !0, initial: "" }),
        /** Szolgáltatás bevétel / idő: numerikus rész (cr). */
        servicesIncomeAmount: new ke({ required: !1, integer: !1, initial: 0 }),
        /** Szolgáltatás bevétel / idő: időegység szövege (pl. nap, hét, hónap). */
        servicesIncomePeriod: new ve({ required: !1, blank: !0, initial: "" }),
        /** Marketing típusa (Szolgáltatások fajtánál). */
        marketingType: new ve({ required: !1, blank: !0, initial: "" }),
        /** Marketing ára / hét (cr). */
        marketingCostPerWeek: new ke({ required: !1, integer: !1, initial: 0 }),
        /** Marketing profit (%). */
        marketingProfitPercent: new ke({ required: !1, integer: !1, initial: 0 }),
        /** Alkalmazottak táblázat: Típus, Szint, Szám, Bónusz. */
        employees: new Wt(
          new jt({
            type: new ve({ required: !1, blank: !0, initial: "" }),
            level: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
            count: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
            bonus: new ve({ required: !1, blank: !0, initial: "" })
          }),
          { required: !1, initial: [] }
        ),
        /** Gyártási specializáció (Gyártás fajtánál). */
        manufacturingSpecialization: new ve({ required: !1, blank: !0, initial: "" }),
        /** Gyártható dolgok listája (többsoros szabad szöveg). */
        manufacturingProducts: new ve({ required: !1, blank: !0, initial: "" }),
        /** Gyártósor táblázat: Gyártott Termék, Szám, Gyártási Idő. */
        productionLines: new Wt(
          new jt({
            product: new ve({ required: !1, blank: !0, initial: "" }),
            count: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
            time: new ve({ required: !1, blank: !0, initial: "" })
          }),
          { required: !1, initial: [] }
        ),
        /** Milícia: Erő Pont. */
        militiaPower: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Milícia: Morál Pont. */
        militiaMorale: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
        /** Milícia küldetések táblázat: Helyszín, Nehézség, Rizikó, Zsákmány. */
        militiaMissions: new Wt(
          new jt({
            location: new ve({ required: !1, blank: !0, initial: "" }),
            difficulty: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
            risk: new ke({ required: !1, integer: !0, min: 0, initial: 0 }),
            loot: new ve({ required: !1, blank: !0, initial: "" })
          }),
          { required: !1, initial: [] }
        )
      })
...
const Q = class Q extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et, T, x, z, G, Ie, ne, Ne, Ce, Se, Me, tt, st, Pt, $t, xt, zt, _t, dt, as, os, cs, ls, us, ds, ms, ps, fs, ys, gs, hs, bs, vs;
    ...
    f === 0 && (I = 0), (Ce = (Ne = (ne = this.actor) == null ? void 0 : ne.statuses) == null ? void 0 : Ne.has) != null && Ce.call(Ne, "immobilized") && (e.effectiveGivenSpeed = 0, e.system = foundry.utils.mergeObject(
    ...
    const O = this.actor.system.weapons ?? {}, C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], j = (O.slotOrder ?? "").trim(), K = j ? j.split(/\s*,\s*/).filter((v) => C.includes(v)) : [], U = (tt = this.actor.system.gear) == null ? void 0 : tt.microchips, E = U && typeof U == "object" && !Array.isArray(U) ? U : {}, V = (((st = E.slot1) == null ? void 0 : st.itemId) ?? "").trim(), Z = (((Pt = E.slot2) == null ? void 0 : Pt.itemId) ?? "").trim(), J = ((($t = E.slot3) == null ? void 0 : $t.itemId) ?? "").trim(), oe = this.actor.items.contents.filter((v) => v.type !== "Kepesseg" && v.type !== "ability").slice().sort((v, N) => {
      ...
      const it = N && ((rt = v.system) != null && rt.damage) ? v.system.damage : "", Te = N && typeof ((Ve = v.system) == null ? void 0 : Ve.range) == "string" ? (v.system.range || "").trim() : "", qe = ue ? Number((Je = O[ue]) == null ? void 0 : Je.bonus) || 0 : "";
      return {
        id: v.id,
        name: v.name,
        img: v.img,
    ...
    e.weaponSlots = Oe.map((v, N) => {
      const L = O[v] ?? {}, F = (L.itemId ?? "").trim(), B = te.find((qe) => qe.id === F), ue = R.find((qe) => qe.id === F), ae = (ue == null ? void 0 : ue.system) ?? {}, it = ae.size === "thrown", Te = (typeof ae.range == "string" ? (ae.range || "").trim() : "") || "—";
      return {
        slotKey: v,
        itemId: F,
        slotNum: N + 1,
    ...
    e.weaponsTable = R.map((v) => {
      ...
      let L = null, F = {};
      for (const Ut of K)
        if ((((ks = O[Ut]) == null ? void 0 : ks.itemId) ?? "").trim() === N) {
          L = Ut, F = O[Ut] ?? {};
          break;
        }
      const B = !!L, ue = ((ws = v.system) == null ? void 0 : ws.equipped) !== void 0 && ((Is = v.system) == null ? void 0 : Is.equipped) !== null ? !!v.system.equipped : B, ae = (v == null ? void 0 : v.system) ?? {}, it = typeof ae.range == "string" ? (ae.range || "").trim() : "", Te = ae.type ?? "", qe = (D[Te] ?? Te) || "—", je = ae.size ?? "", nt = (P[je] ?? je) || "", rt = [qe, nt].filter(Boolean).join(", ") || qe || "—", Ve = Te === "projectile" || je === "thrown", Je = ae.quantity, Ot = Je != null ? String(Je).trim() : "1", mt = String(F.bonus ?? "").trim(), Ct = String(ae.bonus ?? "").trim(), li = mt || Ct || "0";
      return {
        slotKey: L ?? "",
        itemId: N,
    ...
    const pe = (((as = this.actor.items) == null ? void 0 : as.contents) ?? []).filter((v) => v.type === "MikroChip"), re = pe.map((v) => ({ id: v.id, name: v.name, img: v.img })), we = "— Nincs Mikro-Chip —", ce = ["slot1", "slot2", "slot3"], fe = (v) => {
      var L, F, B;
      const N = [];
    ...
    e.microchipItemsSlot1 = re.filter((v) => !fe(1).includes(v.id)), e.microchipItemsSlot2 = re.filter((v) => !fe(2).includes(v.id)), e.microchipItemsSlot3 = re.filter((v) => !fe(3).includes(v.id)), e.microchipSlots = ce.map((v) => {
      ...
      return {
        slotKey: v,
        itemId: L,
        displayName: (F == null ? void 0 : F.name) || N.name || we,
        img: (F == null ? void 0 : F.img) || "",
        active: N.active === !0
      };
    }), ["1", "2", "3"].forEach((v) => {
      const N = `slot${v}`, L = E[N] ?? {}, F = (L.itemId ?? "").trim(), B = re.find((ue) => ue.id === F);
      e[`microchip${v}ItemId`] = F, e[`microchip${v}DisplayName`] = (B == null ? void 0 : B.name) || L.name || we, e[`microchip${v}Img`] = (B == null ? void 0 : B.img) || "";
    }), e.microchipsTable = pe.map((v) => {
      var je, nt, rt, Ve;
      const N = v.id;
      let L = null;
      for (const Je of ce)
        if ((((je = E[Je]) == null ? void 0 : je.itemId) ?? "").trim() === N) {
          L = Je;
          break;
        }
      const F = !!L, B = ((nt = v == null ? void 0 : v.system) == null ? void 0 : nt.abilityType) ?? "", ue = B === "active" ? "Aktív" : B === "passive" ? "Passzív" : B || "—", ae = B === "active", it = Number((rt = v == null ? void 0 : v.system) == null ? void 0 : rt.replaceCost) >= 0 ? Number(v.system.replaceCost) : 0, Te = (((Ve = v == null ? void 0 : v.system) == null ? void 0 : Ve.description) ?? "").trim(), qe = Te ? Te.length > 60 ? Te.slice(0, 57) + "…" : Te : "—";
      return {
        itemId: N,
        actorId: this.actor.id,
        name: (v == null ? void 0 : v.name) ?? "—",
    ...
    const ct = ((ms = e.system) == null ? void 0 : ms.resources) ?? {}, ee = ["kpDot1", "kpDot2", "kpDot3", "kpDot4", "kpDot5", "kpDot6"], ye = (fs = (ps = e.system) == null ? void 0 : ps.combat) == null ? void 0 : fs.initiativeResult, ie = typeof ye == "number" ? ye : -1, lt = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], Re = (gs = (ys = e.system) == null ? void 0 : ys.combat) == null ? void 0 : gs.initiativeRanges, Le = Array.isArray(Re) ? Re.map((v) => ({ min: Number(v.min) ?? 0, max: Number(v.max) ?? 0, kp: Math.min(10, Math.max(0, Number(v.kp) ?? 0)) })) : [], We = (Le.length > 0 ? Le : lt).slice().sort((v, N) => v.min - N.min), Xe = Le.map((v) => v.min), At = Xe.length ? Math.min(...Xe) : 0, Ft = Xe.length ? Math.max(...Xe) : 0;
    e.initiativeRanges = Le.map((v) => ({ ...v, isFirst: v.min === At, isLast: v.min === Ft }));
    let ft = 0;
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!u) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-DOrePjVD.mjs");
      m(this.actor, u);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: c } = await import("./roll-sheet-DOrePjVD.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', d), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const c = i.currentTarget, u = c.dataset.skill, m = ((g = c.textContent) == null ? void 0 : g.trim()) || u, { openRollSheetForSkill: h } = await import("./roll-sheet-DOrePjVD.mjs");
      h(this.actor, u, m);
...
const ge = class ge extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var He, Ye, Ge, ct, ee, ye, ie, lt, Re, Le, ut, We, Xe, At, Ft, ft, Et, yt, gt, ht, bt, vt, kt, wt, It, St, Qe, Tt, Dt, et;
    ...
    const t = this.actor, n = ((ct = e.system) == null ? void 0 : ct.combat) ?? {}, p = Number(n.givenProtection ?? 0) || 0, d = (ye = (ee = t == null ? void 0 : t.statuses) == null ? void 0 : ee.has) != null && ye.call(ee, "lookaround") ? 1 : 0, y = (lt = (ie = t == null ? void 0 : t.statuses) == null ? void 0 : ie.has) != null && lt.call(ie, "halfcover") ? 3 : 0, l = (Le = (Re = t == null ? void 0 : t.statuses) == null ? void 0 : Re.has) != null && Le.call(Re, "threequarteredcover") ? 6 : 0;
    ...
    e.weaponSlots = b.map((T) => {
      const x = o[T] ?? {}, z = (x.itemId ?? "").trim(), G = u.find((Se) => Se.id === z), Ie = c.find((Se) => Se.id === z), ne = (Ie == null ? void 0 : Ie.system) ?? {}, Ne = ne.size === "thrown", Ce = (typeof ne.range == "string" ? (ne.range || "").trim() : "") || "—";
      return {
        slotKey: T,
        itemId: z,
    ...
    e.weaponsTable = c.map((T) => {
      ...
      const Ie = !!z, ne = (T == null ? void 0 : T.system) ?? {}, Ne = typeof ne.range == "string" ? (ne.range || "").trim() : "", Ce = ne.type ?? "", Se = (w[Ce] ?? Ce) || "—", Me = ne.size ?? "", tt = (I[Me] ?? Me) || "", st = [Se, tt].filter(Boolean).join(", ") || Se || "—", Pt = Ce === "projectile" || Me === "thrown", $t = ne.quantity != null ? String(ne.quantity).trim() : "1", xt = String(ne.bonus ?? G.bonus ?? "").trim() || "0", zt = (ne.damage ?? G.damage ?? "").trim() || "";
      return {
        slotKey: z ?? "",
        itemId: x,
        actorId: t.id,
    ...
    e.microchipsTable = j.map((T) => {
      ...
      const G = ((Se = T == null ? void 0 : T.system) == null ? void 0 : Se.abilityType) ?? "", Ie = G === "active" ? "Aktív" : G === "passive" ? "Passzív" : G || "—", ne = (((Me = T == null ? void 0 : T.system) == null ? void 0 : Me.description) ?? "").trim(), Ne = ne ? ne.length > 60 ? ne.slice(0, 57) + "…" : ne : "—";
      return {
        itemId: x,
        actorId: t.id,
        name: (T == null ? void 0 : T.name) ?? "—",
    ...
    const Oe = ((kt = e.system) == null ? void 0 : kt.resources) ?? {}, D = (It = (wt = e.system) == null ? void 0 : wt.combat) == null ? void 0 : It.initiativeResult, P = typeof D == "number" ? D : -1, W = [
      ...
      { min: 19, max: 24, kp: 5 },
      { min: 25, max: 999, kp: 6 }
    ], se = (Qe = (St = e.system) == null ? void 0 : St.combat) == null ? void 0 : Qe.initiativeRanges, le = Array.isArray(se) ? se.map((T) => ({ min: Number(T.min) ?? 0, max: Number(T.max) ?? 0, kp: Math.min(10, Math.max(0, Number(T.kp) ?? 0)) })) : [], re = (le.length > 0 ? le : W).slice().sort((T, x) => T.min - x.min), we = 3;
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (r) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForWeapon: u } = await import("./roll-sheet-DOrePjVD.mjs");
      u(this.actor, c);
      ...
      if (r.preventDefault(), r.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-DOrePjVD.mjs");
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: m } = await import("./roll-sheet-DOrePjVD.mjs");
      m(this.actor, c, u);
...
const he = class he extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var j, K, U, E, V, Z, J, Y, oe, R, te, de, Oe;
    let e = await super._prepareContext(s);
    e = e ?? {}, e.actor = e.actor ?? this.actor, e.system = e.system ?? this.actor.system;
    ...
    e.weaponsTable = y.map((D) => {
      const P = (D == null ? void 0 : D.system) ?? {}, W = P.type ?? "", se = (n[W] ?? W) || "—", le = P.size ?? "", pe = (p[le] ?? le) || "", re = [se, pe].filter(Boolean).join(", ") || se || "—", we = W === "projectile" || le === "thrown", ce = P.quantity != null ? String(P.quantity).trim() : "1", fe = (typeof P.range == "string" ? (P.range || "").trim() : "") || "—";
      return {
        slotKey: "",
        itemId: D.id,
        actorId: this.actor.id,
    ...
    e.microchipsTable = a.map((D) => {
      var we, ce, fe;
      const P = ((we = D == null ? void 0 : D.system) == null ? void 0 : we.abilityType) ?? "", W = P === "active" ? "Aktív" : P === "passive" ? "Passzív" : P || "—", se = P === "active", le = Number((ce = D == null ? void 0 : D.system) == null ? void 0 : ce.replaceCost) >= 0 ? Number(D.system.replaceCost) : 0, pe = (((fe = D == null ? void 0 : D.system) == null ? void 0 : fe.description) ?? "").trim(), re = pe ? pe.length > 60 ? pe.slice(0, 57) + "…" : pe : "—";
      return {
        itemId: D.id,
        actorId: this.actor.id,
        name: (D == null ? void 0 : D.name) ?? "—",
    ...
    for (const D of r) {
      ...
      const pe = P.abilities ?? {}, re = Array.isArray(pe.items) ? pe.items : [], ce = (await Promise.all(
        ...
        var Le, ut;
        const ie = (((Le = ee.system) == null ? void 0 : Le.kind) ?? "passive").toString(), lt = Number(((ut = ee.system) == null ? void 0 : ut.kp) ?? 0) || 0, Re = ie === "species";
        return {
          id: ee.id,
          ref: ye,
          name: ee.name,
...
const be = class be extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    }), n.on("click", ".vallalkozas-mission-add", async (l) => {
      if (l.preventDefault(), !this.actor) return;
      const o = (this.actor.system ?? {}).vallalkozas ?? {}, f = Array.isArray(o.militiaMissions) ? o.militiaMissions.slice() : [], r = Number(o.level ?? 1) || 1, i = Number(o.militiaPower ?? 0) || 0, u = (Math.floor(Math.random() * 100) + 1) * r, m = u - i;
      f.push({
        location: "",
        difficulty: u,
        risk: m,
    ...
    }), n.on("click", ".vallalkozas-mission-delete", async (l) => {
      var c, u;
      if (l.preventDefault(), !l.altKey || !this.actor) return;
      const a = ((u = (c = l.currentTarget) == null ? void 0 : c.dataset) == null ? void 0 : u.index) ?? "", o = Number(a), r = (this.actor.system ?? {}).vallalkozas ?? {}, i = Array.isArray(r.militiaMissions) ? r.militiaMissions.slice() : [];
...
X(Ae, "PARTS", foundry.utils.mergeObject(M(Ae, Ae, "PARTS") ?? {}, {
  ...
  minWidth: 550,
  height: 400,
  form: foundry.utils.mergeObject(((Js = M(Ae, Ae, "DEFAULT_OPTIONS")) == null ? void 0 : Js.form) ?? {}, { submitOnChange: !1 })
}));
let Xt = Ae;
var Zs;
...
X(Ee, "PARTS", foundry.utils.mergeObject(M(Ee, Ee, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Ys = M(Ee, Ee, "DEFAULT_OPTIONS")) == null ? void 0 : Ys.form) ?? {}, { submitOnChange: !1 })
}));
let es = Ee;
var Xs;
...
X(Pe, "PARTS", foundry.utils.mergeObject(M(Pe, Pe, "PARTS") ?? {}, {
  ...
  minWidth: 500,
  height: 420,
  form: foundry.utils.mergeObject(((Xs = M(Pe, Pe, "DEFAULT_OPTIONS")) == null ? void 0 : Xs.form) ?? {}, { submitOnChange: !0 })
}));
let ts = Pe;
var Qs;
...
X($e, "PARTS", foundry.utils.mergeObject(M($e, $e, "PARTS") ?? {}, {
  ...
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((Qs = M($e, $e, "DEFAULT_OPTIONS")) == null ? void 0 : Qs.form) ?? {}, { submitOnChange: !1 })
}));
let ss = $e;
var ei;
...
X(xe, "PARTS", foundry.utils.mergeObject(M(xe, xe, "PARTS") ?? {}, {
  content: { template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs" }
})), X(xe, "DEFAULT_OPTIONS", foundry.utils.mergeObject(M(xe, xe, "DEFAULT_OPTIONS"), {
  classes: ["vacuum-of-the-void", "sheet", "item", "Egyeb"],
  template: "systems/vacuum-of-the-void/templates/item/egyeb-sheet.hbs",
  width: 480,
  minWidth: 400,
  height: 360,
  form: foundry.utils.mergeObject(((ei = M(xe, xe, "DEFAULT_OPTIONS")) == null ? void 0 : ei.form) ?? {}, { submitOnChange: !1 })
}));
let is = xe;
var ti, si;
...
X(De, "PARTS", foundry.utils.mergeObject(M(De, De, "PARTS") ?? {}, {
  ...
  M(De, De, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ti = M(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : ti.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((si = M(De, De, "DEFAULT_OPTIONS")) == null ? void 0 : si.dragDrop) ?? [],
      {
        dragSelector: null,
...
X(_e, "PARTS", foundry.utils.mergeObject(M(_e, _e, "PARTS") ?? {}, {
  ...
  M(_e, _e, "DEFAULT_OPTIONS"),
  {
    ...
    minWidth: 520,
    height: 480,
    form: foundry.utils.mergeObject(((ii = M(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ii.form) ?? {}, { submitOnChange: !1 }),
    dragDrop: [
      ...((ni = M(_e, _e, "DEFAULT_OPTIONS")) == null ? void 0 : ni.dragDrop) ?? [],
      {
        dragSelector: null,
        dropSelector: ".karakter-ability-area[data-area='abilities']"
      }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var h, g, k, b, w, I, _, O, C, j, K, U, E, V, Z, J, Y, oe, R, te, de, Oe, D;
    ...
    const r = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC, i = d.targetName || "", c = d.hitLocationName || "", u = ((a == null ? void 0 : a.name) ?? (d.slotKey ? ((D = (((Oe = l.system) == null ? void 0 : Oe.weapons) ?? {})[d.slotKey]) == null ? void 0 : D.name) ?? "" : "")) || "Fegyver";
...
//# sourceMappingURL=vacuum-of-the-void-BDS0j7xI.mjs.map
