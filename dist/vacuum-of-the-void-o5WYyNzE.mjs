...
const K = class K extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (s) => {
      ...
      if (!a) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-B-I9pLVK.mjs");
      c(this.actor, a);
    ...
    d && r({ currentTarget: d }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var y;
      s.preventDefault();
      const l = s.currentTarget, a = l.dataset.skill, c = ((y = l.textContent) == null ? void 0 : y.trim()) || a, { openRollSheetForSkill: u } = await import("./roll-sheet-B-I9pLVK.mjs");
      u(this.actor, a, c);
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _onDropItem(i, e) {
    ...
    const o = d.toObject();
    d.type === "Fegyver" && foundry.utils.mergeObject(o, { system: { ...o.system ?? {}, equipped: !1 } }, { inplace: !0 }), d.type === "Pancel" && foundry.utils.mergeObject(o, { system: { ...o.system ?? {}, equipped: !1 } }, { inplace: !0 }), await n.createEmbeddedDocuments("Item", [o]), typeof this.render == "function" && this.render(!0);
  }
  async _postAbilityToChat(i) {
    var h, f, s, l, a;
...
//# sourceMappingURL=vacuum-of-the-void-o5WYyNzE.mjs.map
