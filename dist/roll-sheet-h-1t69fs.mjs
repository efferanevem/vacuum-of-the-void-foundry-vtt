import { V as G, c as pe } from "./vacuum-of-the-void-BMY0s9gO.mjs";
class ae extends Application {
  ...
  _bindRollSheetListeners() {
    var m, j, w, I, b;
    const t = this, e = this.id ?? "votv-roll-sheet", a = document.querySelector(`form.votv.roll-sheet[data-votv-roll-sheet="${CSS.escape(e)}"]`) ?? ((j = (m = this.element) == null ? void 0 : m.querySelector) == null ? void 0 : j.call(m, "form.votv.roll-sheet")) ?? ((I = (w = this.element) == null ? void 0 : w.matches) != null && I.call(w, "form.votv.roll-sheet") ? this.element : null);
    ...
    const h = a.querySelector(".roll-sheet-morale-wrap"), s = Math.min(3, Math.max(0, parseInt(((b = h == null ? void 0 : h.dataset) == null ? void 0 : b.moraleMax) ?? "3", 10) || 0)), u = a.querySelector("input[name='moraleDice']"), p = a.querySelectorAll(".roll-sheet-morale-d8"), l = (n) => {
  ...
  getData(t = {}) {
    var I, b, n, i, o, c, d, P, V, M, g, C, B, z;
    const e = this.actor, a = Math.max(0, Number(((b = (I = e == null ? void 0 : e.system) == null ? void 0 : I.resources) == null ? void 0 : b.morale) ?? 0) || 0), r = this._baseModifier !== 0 ? this._baseModifier > 0 ? `+${this._baseModifier}` : String(this._baseModifier) : "", y = this._injuryModifier !== 0 ? this._injuryModifier > 0 ? `+${this._injuryModifier}` : String(this._injuryModifier) : "", v = this._injuryPenalty !== 0 ? String(this._injuryPenalty) : "", h = ["3d6", r, y, v].filter(Boolean).join(" ") || "3d6";
    let s = "", u = 0;
    const p = [], l = [];
    let f = 0;
    ...
    (M = (V = e == null ? void 0 : e.statuses) == null ? void 0 : V.has) != null && M.call(V, "diseased") && l.push(game.i18n.localize("VOTV.StatusDiseased")), (C = (g = e == null ? void 0 : e.statuses) == null ? void 0 : g.has) != null && C.call(g, "poisoned") && l.push(game.i18n.localize("VOTV.StatusPoisoned"));
  ...
  _getCurrentWeaponBaseModifier() {
    ...
    const t = this.actor, a = (((b = t.system) == null ? void 0 : b.weapons) ?? {})[this._weaponSlotKey] ?? {}, r = ((i = (n = t.items) == null ? void 0 : n.filter) == null ? void 0 : i.call(n, (d) => d.type === "Fegyver")) ?? [], y = (a.itemId ?? "").trim(), v = y ? r.find((d) => d.id === y) ?? null : null, h = (o = v == null ? void 0 : v.system) == null ? void 0 : o.bonus, s = a.bonus, u = h != null && String(h).trim() !== "", p = s != null && String(s).trim() !== "", f = Number(u ? h : p ? s : 0) || 0, m = this._skillKey, j = ((c = t.system) == null ? void 0 : c.skills) ?? {}, w = Number(j[m] ?? 0) || 0;
    let I = 0;
  ...
  async _doRoll(t) {
    var a, r, y, v, h, s, u, p, l, f, m, j, w, I, b, n, i, o, c, d, P, V, M;
    const e = this.actor;
    if (e) {
      if (this._isWeaponAttack && this._weaponSlotKey && ((r = (a = e.statuses) == null ? void 0 : a.has) != null && r.call(a, "halfcover"))) {
        const C = (((y = e.system) == null ? void 0 : y.weapons) ?? {})[this._weaponSlotKey] ?? {}, B = (C.itemId ?? "").trim(), z = B ? (((h = (v = e.items) == null ? void 0 : v.filter) == null ? void 0 : h.call(v, (S) => S.type === "Fegyver")) ?? []).find((S) => S.id === B) ?? null : null;
        if ((((s = z == null ? void 0 : z.system) == null ? void 0 : s.size) ?? C.size ?? "").toString().toLowerCase() === "heavy") {
      ...
      try {
        const g = t.querySelector("[name='moraleDice']"), C = t.querySelector("[name='advantage']"), B = t.querySelector("[name='constantBonus']"), z = Math.min(3, Math.max(0, parseInt((g == null ? void 0 : g.value) ?? "0", 10) || 0)), D = Math.max(0, Number(((f = (l = e.system) == null ? void 0 : l.resources) == null ? void 0 : f.morale) ?? 0) || 0), S = Math.min(z, D), _ = Math.min(3, Math.max(-3, parseInt((C == null ? void 0 : C.value) ?? "0", 10) || 0)), A = parseInt((B == null ? void 0 : B.value) ?? "0", 10) || 0, O = this._isWeaponAttack ? this._getCurrentWeaponBaseModifier() : this._baseModifier, q = this._isWeaponAttack ? 0 : this._injuryModifier, W = this._isWeaponAttack ? 0 : this._injuryPenalty || 0, E = ((j = (m = e.statuses) == null ? void 0 : m.has) == null ? void 0 : j.call(m, "diseased")) || ((I = (w = e.statuses) == null ? void 0 : w.has) == null ? void 0 : I.call(w, "poisoned")) ? -1 : 0, F = O + q + W + A + E, $ = [
          "3d6",
          _ > 0 ? `+${_}d6` : _ < 0 ? `-${Math.abs(_)}d6` : "",
          S > 0 ? `+${S}d8` : "",
          F !== 0 ? F > 0 ? `+${F}` : `${F}` : ""
        ].filter(Boolean).join(" "), L = new Roll($);
        await L.evaluate({ async: !0 });
        const { resultType: ne, label: oe } = pe(L), ie = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
        let le = this._label;
        ...
        if (this._isWeaponAttack && ((n = (b = game.user) == null ? void 0 : b.targets) != null && n.size)) {
          ...
          if (k) {
            ...
            const ee = re + ce + ue + Z + de + me, te = (Number(L.total ?? 0) || 0) >= ee, he = k.name ?? H.name ?? "Célpont";
            let x = null, K = null;
            if (te && k.type === "Karakter")
              try {
                const T = new Roll("1d8");
                await T.evaluate({ async: !0 }), x = Number(T.total ?? 0) || 1, x === 1 ? K = "Fej" : x >= 2 && x <= 4 ? K = "Törzs" : x === 5 || x === 6 ? K = "Karok" : K = "Lábak";
              } catch (T) {
...
function ge(N, t) {
  ...
  if (!N || !t) return;
  const e = N, r = (((D = e.system) == null ? void 0 : D.weapons) ?? {})[t] ?? {}, y = ((S = e.system) == null ? void 0 : S.skills) ?? {}, v = ((A = (_ = e.items) == null ? void 0 : _.filter) == null ? void 0 : A.call(_, (L) => L.type === "Fegyver")) ?? [], h = (r.itemId ?? "").trim(), s = h ? v.find((L) => L.id === h) ?? null : null, u = ((s == null ? void 0 : s.name) ?? r.name ?? "").trim() || "Fegyver", p = (O = s == null ? void 0 : s.system) == null ? void 0 : O.bonus, l = r.bonus, f = p != null && String(p).trim() !== "", m = l != null && String(l).trim() !== "", w = Number(f ? p : m ? l : 0) || 0, I = ((q = s == null ? void 0 : s.system) == null ? void 0 : q.type) || "kinetic", b = (((W = s == null ? void 0 : s.system) == null ? void 0 : W.skillKey) ?? "").trim(), n = b && y[b] !== void 0 ? b : I === "explosive" ? "grenadeUse" : "firearms", i = Number(y[n] || 0) || 0, o = w + i;
  let c = 0;
  if (e.type === "Karakter") {
    const L = G._getSkillHealthStatusStatic(e, n);
    L === 1 ? c = -6 : L === 2 && (c = -3);
  }
  const d = (((J = s == null ? void 0 : s.system) == null ? void 0 : J.damage) ?? "").trim(), P = (r.damage ?? "").trim(), V = d || P || "", M = ((E = s == null ? void 0 : s.system) == null ? void 0 : E.size) ?? r.size ?? "", g = String(M).toLowerCase() === "heavy", C = (($ = (F = e.statuses) == null ? void 0 : F.has) == null ? void 0 : $.call(F, "halfcover")) ?? !1, B = g && C;
  new ae({
    actor: N,
    skillKey: n,
    label: u,
...
//# sourceMappingURL=roll-sheet-h-1t69fs.mjs.map
