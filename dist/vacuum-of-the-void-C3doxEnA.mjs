...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var et, tt, st, it, nt, at, rt, ot, ct, $e, lt, ut, xe, v, P, E, U, oe, V, ye, me, ce, _e, Re, Me, _t, Dt, Ot, Ct, dt, We, Bt, Gt, Wt, Vt, Yt, Xt, Qt, Jt, Zt, es, ts, ss, is, ns;
    ...
    e.weaponSlots = fe.map((g, O) => {
      const _ = C[g] ?? {}, F = (_.itemId ?? "").trim(), R = ae.find((pe) => pe.id === F), Z = Q.find((pe) => pe.id === F), Y = (Z == null ? void 0 : Z.system) ?? {}, Ke = Y.size === "thrown", le = (typeof Y.range == "string" ? (Y.range || "").trim() : "") || "—";
      return {
        slotKey: g,
        itemId: F,
        slotNum: O + 1,
    ...
    e.weaponsTable = Q.map((g) => {
      ...
      const R = !!_, Z = ((rs = g.system) == null ? void 0 : rs.equipped) !== void 0 && ((os = g.system) == null ? void 0 : os.equipped) !== null ? !!g.system.equipped : R, Y = (g == null ? void 0 : g.system) ?? {}, Ke = typeof Y.range == "string" ? (Y.range || "").trim() : "", le = Y.type ?? "", pe = (Ie[le] ?? le) || "—", De = Y.size ?? "", je = (re[De] ?? De) || "", ze = [pe, je].filter(Boolean).join(", ") || pe || "—", Ce = le === "projectile" || De === "thrown", qe = Y.quantity, mt = qe != null ? String(qe).trim() : "1", Ve = String(F.bonus ?? "").trim(), pt = String(Y.bonus ?? "").trim(), $s = Ve || pt || "0";
      return {
        slotKey: _ ?? "",
        itemId: O,
    ...
    e.microchipItemsSlot1 = ne.filter((g) => !Ue(1).includes(g.id)), e.microchipItemsSlot2 = ne.filter((g) => !Ue(2).includes(g.id)), e.microchipItemsSlot3 = ne.filter((g) => !Ue(3).includes(g.id)), e.microchipSlots = Te.map((g) => {
      ...
      const F = !!_, R = ((je = g == null ? void 0 : g.system) == null ? void 0 : je.abilityType) ?? "", Z = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Y = R === "active", Ke = Number((ze = g == null ? void 0 : g.system) == null ? void 0 : ze.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, le = (((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.description) ?? "").trim(), pe = le ? le.length > 60 ? le.slice(0, 57) + "…" : le : "—";
      return {
        itemId: O,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: a } = await import("./roll-sheet-BjFgt8Cs.mjs");
      a(this.actor, c);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: o } = await import("./roll-sheet-BjFgt8Cs.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const o = i.currentTarget, c = o.dataset.skill, a = ((h = o.textContent) == null ? void 0 : h.trim()) || c, { openRollSheetForSkill: f } = await import("./roll-sheet-BjFgt8Cs.mjs");
      f(this.actor, c, a);
...
const te = class te extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (l) => {
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForWeapon: c } = await import("./roll-sheet-BjFgt8Cs.mjs");
      c(this.actor, o);
      ...
      if (l.preventDefault(), l.stopPropagation(), !this.actor) return;
      const { openRollSheetForSkill: i } = await import("./roll-sheet-BjFgt8Cs.mjs");
      ...
      if (!o || !this.actor) return;
      const { openRollSheetForSkill: a } = await import("./roll-sheet-BjFgt8Cs.mjs");
      a(this.actor, o, c);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener("click", async (e) => {
    var f, h, k, S, I, D, L, C, N, x, A, z, H, B, W, ie, J, M, Q, ae, Se, fe, Ie;
...
//# sourceMappingURL=vacuum-of-the-void-C3doxEnA.mjs.map
