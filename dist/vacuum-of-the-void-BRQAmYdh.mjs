...
function nt(F) {
  ...
  const m = (n, u = 1) => {
    ...
    for (const o of n) {
      ...
      const b = !r && c >= 0 && (o.number === 3 || o.number === "3") ? (r = !0, i) : c >= 0 ? e : t;
      for (const w of g) {
  ...
  m(F.terms, 1);
  const s = i.filter((n) => n === 6).length, a = i.filter((n) => n === 1).length, f = e.filter((n) => n === 6).length, p = t.filter((n) => n === 6).length, y = s + f, h = a + p;
...
const x = class x extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((r = i.querySelector) == null ? void 0 : r.call(i, "form.votv.karakter-sheet")) ?? ((m = i.querySelector) == null ? void 0 : m.call(i, "form.votv")) ?? null, t = ((s = i.querySelector) == null ? void 0 : s.call(i, ".votv-scroll")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const m = this.element, s = this.form ?? this.element;
    let a = { scrollState: {}, focus: null };
    if (m) {
      a.scrollState = this._saveScrollState(m);
      const l = document.activeElement, g = s.contains(l), b = l && (l.tagName === "INPUT" && l.type !== "checkbox" && l.type !== "radio" || l.tagName === "TEXTAREA");
      g && b && (a.focus = {
        name: l.name || null,
        id: l.id || null,
    ...
    const p = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, u = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", c = () => {
      var l, g;
    ...
    return (u || n) && (requestAnimationFrame(c), setTimeout(c, 0), setTimeout(c, 50), setTimeout(c, 150), setTimeout(c, 300), setTimeout(c, 450)), f;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (r <= 0 || t <= 0) return 0;
    const m = Math.floor(r / 3), s = Math.floor(2 * r / 3);
    return t <= m ? 1 : t <= s ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((m = s.system) == null ? void 0 : m.speedPenalty) ?? "").trim().replace(",", "."), f = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const s of i) {
      const a = String(((m = s.system) == null ? void 0 : m.protectionBonus) ?? "").trim().replace(",", "."), f = Number(a);
      Number.isFinite(f) && (e += f);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((u = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : u.resources) ?? {}, m = ((o = (c = r.hitLocations) == null ? void 0 : c.legs) == null ? void 0 : o.value) ?? 0, s = ((l = r.currentHealth) == null ? void 0 : l.legs) ?? 0, a = x._healthStatusFromRatio(s, m), f = Number(((w = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let p;
    a === 0 ? p = 0 : a === 1 ? p = -6 : a === 2 ? p = -3 : p = f;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const m = (Number(((p = (f = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : f.combat) == null ? void 0 : p.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((s = this.actor.system) == null ? void 0 : s.resources) ?? {}, r = ((f = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : f.value) ?? 0, m = ((p = t.currentHealth) == null ? void 0 : p[e]) ?? 0;
    return x._healthStatusFromRatio(m, r);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, m = ((p = (f = r.hitLocations) == null ? void 0 : f[t]) == null ? void 0 : p.value) ?? 0, s = ((y = r.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return x._healthStatusFromRatio(s, m);
  }
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const r = this.actor.system.resources ?? {}, m = r.hitLocations ?? {}, s = r.currentHealth ?? {}, a = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const d of a) {
      const S = ((xe = m[d]) == null ? void 0 : xe.value) ?? 0, I = s[d] ?? 0;
    ...
    const b = this.actor.system.weapons ?? {}, w = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], T = (b.slotOrder ?? "").trim(), D = T ? T.split(/\s*,\s*/).filter((d) => w.includes(d)) : [], C = (Ue = this.actor.system.gear) == null ? void 0 : Ue.microchips, q = C && typeof C == "object" && !Array.isArray(C) ? C : {}, k = (((Be = q.slot1) == null ? void 0 : Be.itemId) ?? "").trim(), A = (((He = q.slot2) == null ? void 0 : He.itemId) ?? "").trim(), N = (((Ge = q.slot3) == null ? void 0 : Ge.itemId) ?? "").trim(), wt = this.actor.items.contents.filter((d) => d.type !== "Kepesseg" && d.type !== "ability").slice().sort((d, S) => {
      ...
      const ne = S && ((ie = d.system) != null && ie.damage) ? d.system.damage : "", H = S && typeof ((Z = d.system) == null ? void 0 : Z.range) == "string" ? (d.system.range || "").trim() : "", ee = K ? Number((V = b[K]) == null ? void 0 : V.bonus) || 0 : "";
      return {
        id: d.id,
        name: d.name,
        img: d.img,
    ...
    e.weaponsTable = de.map((d) => {
      ...
      const L = !!I, K = ((Ve = d.system) == null ? void 0 : Ve.equipped) !== void 0 && ((et = d.system) == null ? void 0 : et.equipped) !== null ? !!d.system.equipped : L, M = (d == null ? void 0 : d.system) ?? {}, ne = typeof M.range == "string" ? (M.range || "").trim() : "", H = M.type ?? "", ee = (St[H] ?? H) || "—", X = M.size ?? "", te = (Tt[X] ?? X) || "", ie = [ee, te].filter(Boolean).join(", ") || ee || "—", Z = H === "projectile" || X === "thrown", V = M.quantity, ae = V != null ? String(V).trim() : "1", re = String(O.bonus ?? "").trim(), oe = String(M.bonus ?? "").trim(), Lt = re || oe || "0";
      return {
        slotKey: I ?? "",
        itemId: S,
    ...
    e.armorTable = Ot.map((d) => {
      var O, L;
      const S = (d == null ? void 0 : d.system) ?? {}, I = ((O = d.system) == null ? void 0 : O.equipped) !== void 0 && ((L = d.system) == null ? void 0 : L.equipped) !== null ? !!d.system.equipped : !1;
      return {
        itemId: d.id,
        actorId: this.actor.id,
    ...
    e.itemsTable = _t.map((d) => {
      const S = (d == null ? void 0 : d.system) ?? {}, I = (S.description ?? "").trim(), O = I ? I.length > 60 ? I.slice(0, 57) + "…" : I : "—", L = S.quantity != null ? String(S.quantity).trim() : "1";
      return {
        itemId: d.id,
        actorId: this.actor.id,
        name: (d == null ? void 0 : d.name) ?? "—",
    ...
    const me = (((Je = this.actor.items) == null ? void 0 : Je.contents) ?? []).filter((d) => d.type === "MikroChip"), ce = me.map((d) => ({ id: d.id, name: d.name, img: d.img })), qe = "— Nincs Mikro-Chip —", De = ["slot1", "slot2", "slot3"], pe = (d) => {
      var I, O, L;
      const S = [];
      return d !== 1 && S.push((((I = q.slot1) == null ? void 0 : I.itemId) ?? "").trim()), d !== 2 && S.push((((O = q.slot2) == null ? void 0 : O.itemId) ?? "").trim()), d !== 3 && S.push((((L = q.slot3) == null ? void 0 : L.itemId) ?? "").trim()), S.filter(Boolean);
    };
    e.microchipItemsSlot1 = ce.filter((d) => !pe(1).includes(d.id)), e.microchipItemsSlot2 = ce.filter((d) => !pe(2).includes(d.id)), e.microchipItemsSlot3 = ce.filter((d) => !pe(3).includes(d.id)), e.microchipSlots = De.map((d) => {
      const S = q[d] ?? {}, I = (S.itemId ?? "").trim(), O = me.find((L) => L.id === I);
      return {
        slotKey: d,
        itemId: I,
      ...
      const S = `slot${d}`, I = q[S] ?? {}, O = (I.itemId ?? "").trim(), L = ce.find((K) => K.id === O);
    ...
    const Ce = this.actor.system.abilities ?? {}, Dt = (((Xe = this.actor.items) == null ? void 0 : Xe.contents) ?? []).map((d) => {
      ...
      const S = Ce[d] ?? {}, I = (S.itemId ?? "").trim(), O = I ? Le.get(I) : null, L = (O == null ? void 0 : O.description) ?? "", K = (O == null ? void 0 : O.kp) ?? 0;
      return {
        itemId: I,
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-0JxhAAXE.mjs");
      o(this.actor, c);
    ...
    m && r({ currentTarget: m }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }), setTimeout(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
      ...
      var o, l, g;
      n.preventDefault(), n.stopPropagation();
      const u = ((g = (l = (o = foundry.applications) == null ? void 0 : o.apps) == null ? void 0 : l.FilePicker) == null ? void 0 : g.implementation) ?? globalThis.FilePicker;
      new u({
        type: "image",
      ...
      var g;
      n.preventDefault();
      const u = n.currentTarget, c = u.dataset.skill, o = ((g = u.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-0JxhAAXE.mjs");
      l(this.actor, c, o);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const l = this.actor.system.weapons ?? {}, g = (l.slotOrder ?? "").trim(), b = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], w = g ? g.split(/\s*,\s*/).filter((k) => b.includes(k)) : [], T = w.find((k) => {
        var A;
        return (((A = l[k]) == null ? void 0 : A.itemId) ?? "").trim() === c;
      }) ?? null;
      if (u.checked) {
        if (T) return;
        let k = w.find((N) => {
      ...
      const c = u.closest(".karakter-microchip-slot-select-wrap"), o = c == null ? void 0 : c.classList.contains("karakter-microchip-slot-open");
      ...
      var k;
      n.preventDefault();
      const u = n.currentTarget, c = u.closest(".karakter-microchip-slot-select-wrap"), o = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display"), l = o == null ? void 0 : o.dataset.slot;
      if (!l) return;
      const g = (u.dataset.itemId ?? "").trim(), b = (u.dataset.itemName ?? ((k = u.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", w = (u.dataset.itemImg ?? "").trim(), T = c == null ? void 0 : c.querySelector(".karakter-microchip-slot-display-text");
      T && (T.textContent = b);
      ...
      u.addEventListener("dragover", (o) => this._onMicrochipSlotDragOver(o, c)), u.addEventListener("dragleave", (o) => {
        var l;
        return (l = o.currentTarget) == null ? void 0 : l.classList.remove("karakter-microchip-slot-drag-over");
      }), u.addEventListener("drop", (o) => this._onMicrochipSlotDrop(o, c));
    }), t.find(".karakter-ability-slot-single").each((n, u) => {
      const c = u.dataset.slot;
      c && (u.addEventListener("dragover", (o) => this._onAbilitySingleDragOver(o, c)), u.addEventListener("dragleave", (o) => {
        var l;
      ...
      c && (u.addEventListener("dragover", (o) => this._onAbilityAreaDragOver(o, c)), u.addEventListener("dragleave", (o) => {
        var l;
      ...
      if (!u || !c) return;
      const o = this.actor.system.abilities ?? {}, g = (Array.isArray((b = o[u]) == null ? void 0 : b.items) ? o[u].items.slice() : []).filter((w) => w !== c);
    ...
    const a = this, f = (n) => {
      ...
      const c = ((l = (o = u.system) == null ? void 0 : o.resources) == null ? void 0 : l.currentHealth) != null || ((b = (g = u.system) == null ? void 0 : g.resources) == null ? void 0 : b.hitLocations) != null;
      a.actor.update(u).then(() => {
        c && setTimeout(() => a.render(!0), 260);
      }).catch((w) => console.warn("VoidKarakterSheet save failed", w));
    }, p = (n) => {
      var u, c, o;
      return n && (((c = (u = a.element) == null ? void 0 : u.contains) == null ? void 0 : c.call(u, n)) || a.id && ((o = n.closest) == null ? void 0 : o.call(n, `#${CSS.escape(a.id)}`)));
    };
    a._votvBlur = (n) => {
      var g;
      const u = n.target;
      ...
      l && (o.contains(l) || a.id && ((g = l.closest) != null && g.call(l, `#${CSS.escape(a.id)}`))) || (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), f(o));
  ...
  _getFormDataForUpdate(i) {
    ...
    ), r = t.hitLocations ?? {}, m = t.currentHealth ?? {}, s = ["head", "torso", "arms", "legs"];
    for (const y of s) {
      const h = ((p = r[y]) == null ? void 0 : p.value) ?? 0, n = m[y] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, x._healthStatusFromRatio(n, h));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, r, m, s, a, f, p, y, h, n, u, c;
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && (l.type === "Kepesseg" || l.type === "ability")) {
          ...
          const b = (((s = l.system) == null ? void 0 : s.kind) ?? "passive").toString(), w = this.actor.system.abilities ?? {};
          if (b === "species") {
            await this.actor.update({
    ...
    if (e) {
      ...
      if (o) {
        ...
        if (l && l.documentName === "Item" && l.type === "Fegyver") {
          const g = this.actor, b = ((p = l.parent) == null ? void 0 : p.id) !== g.id;
          let w = l.id;
          if (b) {
            const T = foundry.utils.mergeObject(l.toObject(), { system: { ...l.toObject().system ?? {}, equipped: !1 } });
            w = ((y = (await g.createEmbeddedDocuments("Item", [T]))[0]) == null ? void 0 : y.id) ?? w;
          }
          if (b) {
            const T = ((h = g.system) == null ? void 0 : h.weapons) ?? {}, D = (T.slotOrder ?? "").trim(), C = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], q = D ? D.split(/\s*,\s*/).filter((A) => C.includes(A)) : [], k = q.filter((A) => {
              var N;
  ...
  _onWeaponSlotDragOver(i, e) {
    var m, s, a;
    const t = ((m = i.dataTransfer) == null ? void 0 : m.getData("text/plain")) || ((s = i.dataTransfer) == null ? void 0 : s.getData("application/json")) || "";
    let r;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const t = ((f = i.dataTransfer) == null ? void 0 : f.getData("text/plain")) || ((p = i.dataTransfer) == null ? void 0 : p.getData("application/json")) || "";
    let r;
    try {
      r = typeof t == "string" ? JSON.parse(t) : t;
    } catch {
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const m = this.actor.items.contents.slice().sort((h, n) => {
      ...
      return u - c;
    }).map((h) => h.id), s = m.indexOf(t), a = m.indexOf(e);
    if (s === -1 || a === -1) return;
    m.splice(s, 1), m.splice(a, 0, t);
    const f = m.map((h, n) => ({
      _id: h,
      sort: (n + 1) * 10
    }));
  ...
  _onInventoryAreaDragOver(i) {
    var r, m, s;
    const e = ((r = i.dataTransfer) == null ? void 0 : r.getData("text/plain")) || ((m = i.dataTransfer) == null ? void 0 : m.getData("application/json")) || "";
    let t = null;
  ...
  async _postItemToChat(i) {
    ...
    let r, m = "";
    if (e.type === "MikroChip") {
      const h = ((p = e.system) == null ? void 0 : p.abilityType) ?? "passive";
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", r = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, m = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), s = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", f = m ? `<p>${m}</p>` : "", p = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = r.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      m = ((f = (await this.actor.createEmbeddedDocuments("Item", [p]))[0]) == null ? void 0 : f.id) ?? m;
    }
    await this.actor.update({
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let s = m.id;
    ((y = m.parent) == null ? void 0 : y.id) !== this.actor.id && (s = ((h = (await this.actor.createEmbeddedDocuments("Item", [m.toObject()]))[0]) == null ? void 0 : h.id) ?? s), await this.actor.update({
  ...
  async _rollSkill(i, e) {
    ...
    s === 1 ? m -= 6 : s === 2 && (m -= 3);
    const f = `3d6${m !== 0 ? m > 0 ? `+${m}` : `${m}` : ""}`, p = new Roll(f);
    await p.evaluate({ async: !0 });
    const { resultType: y, label: h } = nt(p), n = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return p.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: e,
  ...
  async _rollWeapon(i) {
    var w;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, m = this.actor.items.filter((T) => T.type === "Fegyver");
    let s = null;
    t.itemId && (s = m.find((T) => T.id === t.itemId) ?? null);
    const a = s && s.name || t.name || `Fegyver (${i})`, f = Number(t.bonus || 0) || 0, y = (((w = s == null ? void 0 : s.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(r[y] || 0) || 0, n = f + h, c = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, o = new Roll(c);
    await o.evaluate({ async: !0 });
    const { resultType: l, label: g } = nt(o), b = game.settings.get("core", "rollMode") ?? CONST.DICE_ROLL_MODES.PUBLIC;
    return o.toMessage({
      speaker: ChatMessage.getSpeaker({ actor: this.actor }),
      flavor: `${a} – találat`,
  ...
  async _rollWeaponDamage(i, e = "") {
    var f, p, y, h, n, u, c, o, l, g;
    const t = this.actor;
    if (!t) return;
    let r = ((p = (f = t.items).get) == null ? void 0 : p.call(f, i)) ?? ((h = (y = t.items.contents) == null ? void 0 : y.find) == null ? void 0 : h.call(y, (b) => b.id === i));
    if (!r || r.type !== "Fegyver") return;
    let m = (((n = r.system) == null ? void 0 : n.damage) ?? "").trim();
...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const e = this, t = (m) => {
      if (!m) return;
      const s = e._getFormDataForUpdate(m);
      Object.keys(s).length !== 0 && e.actor.update(s).catch((a) => console.warn("VoidNpcSheet save failed", a));
    }, r = (m) => {
      var s, a, f;
      return m && (((a = (s = e.element) == null ? void 0 : s.contains) == null ? void 0 : a.call(s, m)) || e.id && ((f = m.closest) == null ? void 0 : f.call(m, `#${CSS.escape(e.id)}`)));
    };
    e._votvNpcBlur = (m) => {
      var y;
      const s = m.target;
      ...
      p && (f.contains(p) || e.id && ((y = p.closest) != null && y.call(p, `#${CSS.escape(e.id)}`))) || t(f);
  ...
  _getFormDataForUpdate(i) {
    ...
    for (const r of i.elements) {
      ...
      let m;
      r.type === "checkbox" ? m = r.checked : r.type === "number" ? m = r.value === "" ? 0 : Number(r.value) : m = r.value ?? "", m !== void 0 && foundry.utils.setProperty(e, r.name, m);
    }
...
const G = class G extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvProfileImgClick = (s) => {
      ...
      const a = ((o = (c = (u = foundry.applications) == null ? void 0 : u.apps) == null ? void 0 : c.FilePicker) == null ? void 0 : o.implementation) ?? globalThis.FilePicker;
      new a({
        type: "image",
    ...
    const r = (s) => {
      ...
      var a, f, p;
      return s && (((f = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : f.call(a, s)) || e.id && ((p = s.closest) == null ? void 0 : p.call(s, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (s) => {
      var f, p, y;
      const a = ((f = s.target) == null ? void 0 : f.form) ?? ((y = (p = s.target) == null ? void 0 : p.closest) == null ? void 0 : y.call(p, "form"));
      m(a) && r(a);
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (s) => {
      ...
      const f = (a == null ? void 0 : a.form) ?? ((p = a == null ? void 0 : a.closest) == null ? void 0 : p.call(a, "form"));
      m(f) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => r(f), 300));
...
Hooks.once("init", () => {
  ...
  const F = 500;
  Hooks.on("updateActor", (s, a, f, p) => {
    var w, T, D, C, q;
    const y = s == null ? void 0 : s.id;
    if (!y) return;
    const h = document.activeElement, n = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), u = [], c = (w = game.actors) == null ? void 0 : w.get(y);
    ...
    for (const [l, g] of Object.entries(h)) {
      ...
      !b || b !== s.id || (n[`system.weapons.${l}.name`] = s.name ?? "", n[`system.weapons.${l}.damage`] = ((c = s.system) == null ? void 0 : c.damage) ?? "", n[`system.weapons.${l}.bonus`] = ((o = s.system) == null ? void 0 : o.bonus) ?? "");
    }
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      const t = (p = (f = e.target) == null ? void 0 : f.closest) == null ? void 0 : p.call(f, "[data-document-id]"), r = (y = t == null ? void 0 : t.getAttribute) == null ? void 0 : y.call(t, "data-document-id");
      if (!r) return;
      const m = r.includes(".") ? r.split(".").pop() : r;
...
Hooks.on("preCreateToken", (F, i, e) => {
  ...
  const m = r ? (a = game.actors) == null ? void 0 : a.get(r) : null;
...
Hooks.on("renderChatMessageHTML", (F, i, e) => {
  var a, f;
  const t = ((a = F.flags) == null ? void 0 : a["vacuum-of-the-void"]) ?? {}, r = t.resultType, m = t.critLabel;
  if (!r && !m) return;
  const s = (f = i == null ? void 0 : i.querySelector) == null ? void 0 : f.call(i, ".dice-roll");
  if (s && (r && s.classList.add(`votv-${r}`), m)) {
    const p = s.querySelector(".votv-crit-label");
    if (p) {
      p.textContent = m;
      return;
    }
    const y = s.querySelector(".dice-total"), h = (y == null ? void 0 : y.parentElement) ?? s, n = document.createElement("div");
    n.className = `votv-crit-label votv-crit-label-${r || "neutral"}`, n.textContent = m, h.appendChild(n);
  }
});
export {
  he as V,
...
//# sourceMappingURL=vacuum-of-the-void-BRQAmYdh.mjs.map
