...
const U = class U extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!c) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-CdFWeIge.mjs");
      o(this.actor, c);
    ...
    d && a({ currentTarget: d }), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      ...
      var g;
      i.preventDefault();
      const r = i.currentTarget, c = r.dataset.skill, o = ((g = r.textContent) == null ? void 0 : g.trim()) || c, { openRollSheetForSkill: l } = await import("./roll-sheet-CdFWeIge.mjs");
      l(this.actor, c, o);
...
const X = class X extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (i) => {
      ...
      if (!c || !this.actor) return;
      const { openRollSheetForSkill: l } = await import("./roll-sheet-CdFWeIge.mjs");
      l(this.actor, c, o);
    }), t.on("click", ".karakter-ability-chat", async (i) => {
      var c, o;
      i.preventDefault();
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, y, m) => {
    ...
    const g = (D = game.votv) == null ? void 0 : D._lastKarakterSheetBlurSave, b = g && Date.now() - g.at < j ? g.appId : null;
    setTimeout(() => {
      for (const w of r)
...
//# sourceMappingURL=vacuum-of-the-void-BQSYDIaS.mjs.map
