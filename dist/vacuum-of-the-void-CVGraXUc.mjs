...
const N = class N extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((s = i.querySelector) == null ? void 0 : s.call(i, "form.votv.karakter-sheet")) ?? ((c = i.querySelector) == null ? void 0 : c.call(i, "form.votv")) ?? null, t = ((r = i.querySelector) == null ? void 0 : r.call(i, ".votv-scroll")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const c = this.element, r = this.form ?? this.element;
    let a = { scrollState: {}, focus: null };
    if (c) {
      a.scrollState = this._saveScrollState(c);
    ...
    const f = this.element, y = this.form ?? this.element, h = a.scrollState, n = a.focus, d = typeof (h == null ? void 0 : h.formScrollTop) == "number" || typeof (h == null ? void 0 : h.windowScrollTop) == "number", l = () => {
      var p, g;
    ...
    return (d || n) && (requestAnimationFrame(l), setTimeout(l, 0), setTimeout(l, 50), setTimeout(l, 150), setTimeout(l, 300), setTimeout(l, 450)), u;
  }
  /**
  ...
  static _healthStatusFromRatio(i, e) {
    ...
    if (s <= 0 || t <= 0) return 0;
    const c = Math.floor(s / 3), r = Math.floor(2 * s / 3);
    return t <= c ? 1 : t <= r ? 2 : 3;
  }
  ...
  _getTotalArmorSpeedPenalty() {
    ...
    let e = 0;
    for (const r of i) {
      const a = String(((c = r.system) == null ? void 0 : c.speedPenalty) ?? "").trim().replace(",", "."), u = Number(a);
  ...
  _getTotalArmorProtectionBonus() {
    ...
    let e = 0;
    for (const r of i) {
      const a = String(((c = r.system) == null ? void 0 : c.protectionBonus) ?? "").trim().replace(",", "."), u = Number(a);
      Number.isFinite(u) && (e += u);
    }
    return e;
  }
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const s = ((d = (n = this.actor) == null ? void 0 : n.system) == null ? void 0 : d.resources) ?? {}, c = ((m = (l = s.hitLocations) == null ? void 0 : l.legs) == null ? void 0 : m.value) ?? 0, r = ((p = s.currentHealth) == null ? void 0 : p.legs) ?? 0, a = N._healthStatusFromRatio(r, c), u = Number(((S = (b = (g = this.actor) == null ? void 0 : g.system) == null ? void 0 : b.combat) == null ? void 0 : S.givenSpeed) ?? 0) || 0;
    let f;
    a === 0 ? f = 0 : a === 1 ? f = -6 : a === 2 ? f = -3 : f = u;
  ...
  _writeEffectiveGivenProtection(i = null) {
    ...
    const c = (Number(((f = (u = (a = this.actor) == null ? void 0 : a.system) == null ? void 0 : u.combat) == null ? void 0 : f.givenProtection) ?? 0) || 0) + this._getTotalArmorProtectionBonus();
  ...
  _getSkillHealthStatus(i) {
    ...
    if (e == null) return;
    const t = ((r = this.actor.system) == null ? void 0 : r.resources) ?? {}, s = ((u = (a = t.hitLocations) == null ? void 0 : a[e]) == null ? void 0 : u.value) ?? 0, c = ((f = t.currentHealth) == null ? void 0 : f[e]) ?? 0;
    return N._healthStatusFromRatio(c, s);
  }
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const s = ((a = i == null ? void 0 : i.system) == null ? void 0 : a.resources) ?? {}, c = ((f = (u = s.hitLocations) == null ? void 0 : u[t]) == null ? void 0 : f.value) ?? 0, r = ((y = s.currentHealth) == null ? void 0 : y[t]) ?? 0;
    return N._healthStatusFromRatio(r, c);
  }
  async _prepareContext(i) {
    ...
    e.stressOver10 = t > 10;
    const s = this.actor.system.resources ?? {}, c = s.hitLocations ?? {}, r = s.currentHealth ?? {}, a = ["head", "torso", "arms", "legs"];
    e.computedHealthStatus = {};
    for (const o of a) {
      const I = ((Ne = c[o]) == null ? void 0 : Ne.value) ?? 0, w = r[o] ?? 0;
  ...
  _attachFrameListeners(i) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (n) => {
      ...
      if (!l) return;
      const { openRollSheetForWeapon: m } = await import("./roll-sheet-BtPKN1Nj.mjs");
      m(this.actor, l);
    ...
    const c = (h = e.querySelector) == null ? void 0 : h.call(e, 'input[name="system.resources.stress.value"]');
    c && s({ currentTarget: c }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(i), this._writeEffectiveGivenProtection(e), requestAnimationFrame(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
    }), setTimeout(() => {
      this._writeEffectiveGivenSpeed(), this._writeEffectiveGivenProtection();
      ...
      var g;
      n.preventDefault();
      const d = n.currentTarget, l = d.dataset.skill, m = ((g = d.textContent) == null ? void 0 : g.trim()) || l, { openRollSheetForSkill: p } = await import("./roll-sheet-BtPKN1Nj.mjs");
      p(this.actor, l, m);
    ...
    t.on("click", ".karakter-inventory-item-name", (n) => {
      ...
      const d = n.currentTarget, l = d.dataset.itemId;
      if (!l) return;
      const m = this.actor.items.get(l);
      if (!m) return;
      ...
      var P, O;
      const d = n.currentTarget, l = (d.dataset.itemId ?? "").trim();
      if (!l) return;
      const m = this.actor.items.get(l);
      ...
      var k;
      n.preventDefault();
      const d = n.currentTarget, l = d.closest(".karakter-microchip-slot-select-wrap"), m = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display"), p = m == null ? void 0 : m.dataset.slot;
      if (!p) return;
      const g = (d.dataset.itemId ?? "").trim(), b = (d.dataset.itemName ?? ((k = d.textContent) == null ? void 0 : k.trim()) ?? "").trim() || "— Nincs Mikro-Chip —", S = (d.dataset.itemImg ?? "").trim(), _ = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-display-text");
      _ && (_.textContent = b);
      let L = l == null ? void 0 : l.querySelector(".karakter-microchip-slot-thumb");
      S ? (L || (L = document.createElement("img"), L.className = "karakter-microchip-slot-thumb", L.alt = "", m == null || m.insertBefore(L, _)), L.src = S, L.style.display = "") : L && L.remove(), l == null || l.classList.remove("karakter-microchip-slot-open");
      ...
      var b;
      if (n.preventDefault(), !n.altKey) return;
      const d = n.currentTarget.dataset.area, l = n.currentTarget.dataset.itemId;
      if (!d || !l) return;
    ...
    const a = this, u = (n) => {
      ...
      var d, l, m;
      return n && (((l = (d = a.element) == null ? void 0 : d.contains) == null ? void 0 : l.call(d, n)) || a.id && ((m = n.closest) == null ? void 0 : m.call(n, `#${CSS.escape(a.id)}`)));
    };
    a._votvBlur = (n) => {
      const d = n.target;
      if (!d || !d.form) return;
      ...
      const m = d.form;
      f(m) && (game.votv && (game.votv._lastKarakterSheetBlurSave = { appId: a.id, at: Date.now() }), u(m));
  ...
  _getFormDataForUpdate(i) {
    ...
    ), s = t.hitLocations ?? {}, c = t.currentHealth ?? {}, r = ["head", "torso", "arms", "legs"];
    for (const y of r) {
      const h = ((f = s[y]) == null ? void 0 : f.value) ?? 0, n = c[y] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${y}`, N._healthStatusFromRatio(n, h));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var t, s, c, r, a, u, f, y, h, n, d, l;
    if (e) {
      ...
      if (m) {
        ...
        if (p && p.documentName === "Item" && (p.type === "Kepesseg" || p.type === "ability")) {
          ...
          if (((s = p.parent) == null ? void 0 : s.id) !== this.actor.id) {
            ...
            g = ((c = (await this.actor.createEmbeddedDocuments("Item", [P]))[0]) == null ? void 0 : c.id) ?? g;
          }
          ...
          const _ = b === "active" ? "active" : "passive", L = Array.isArray((a = S[_]) == null ? void 0 : a.items) ? S[_].items.slice() : Array.isArray(S[_]) ? S[_].slice() : [];
  ...
  _onWeaponSlotDragOver(i, e) {
    var c, r, a;
    const t = ((c = i.dataTransfer) == null ? void 0 : c.getData("text/plain")) || ((r = i.dataTransfer) == null ? void 0 : r.getData("application/json")) || "";
    let s;
    try {
  ...
  async _onWeaponSlotDrop(i, e) {
    ...
    const c = await fromUuid(s.uuid);
    if (!c || c.type !== "Fegyver") return;
    if (((y = c.parent) == null ? void 0 : y.id) !== this.actor.id) {
      const d = foundry.utils.mergeObject(c.toObject(), { system: { ...c.toObject().system ?? {}, equipped: !1 } });
    ...
    await this.actor.update({
      ...
      [`system.weapons.${e}.name`]: c.name,
      [`system.weapons.${e}.damage`]: ((h = c.system) == null ? void 0 : h.damage) ?? "",
      [`system.weapons.${e}.bonus`]: ((n = c.system) == null ? void 0 : n.bonus) ?? ""
  ...
  async _onInventoryRowDrop(i, e) {
    ...
    const c = this.actor.items.contents.slice().sort((h, n) => {
      const d = typeof h.sort == "number" ? h.sort : 0, l = typeof n.sort == "number" ? n.sort : 0;
      return d - l;
    }).map((h) => h.id), r = c.indexOf(t), a = c.indexOf(e);
    if (r === -1 || a === -1) return;
    c.splice(r, 1), c.splice(a, 0, t);
    const u = c.map((h, n) => ({
      _id: h,
      sort: (n + 1) * 10
    }));
  ...
  _onInventoryAreaDragOver(i) {
    var s, c, r;
    const e = ((s = i.dataTransfer) == null ? void 0 : s.getData("text/plain")) || ((c = i.dataTransfer) == null ? void 0 : c.getData("application/json")) || "";
    let t = null;
  ...
  async _postAbilityToChat(i) {
    ...
    const t = ((y = e.system) == null ? void 0 : y.kind) ?? "passive", s = Number(((h = e.system) == null ? void 0 : h.kp) ?? 0) || 0, c = (((n = e.system) == null ? void 0 : n.description) ?? "").trim(), r = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", a = s > 0 ? `<p><strong>KP:</strong> ${s}</p>` : "", u = c ? `<p>${c}</p>` : "", f = `
      <h2>${e.name}</h2>
  ...
  async _onAbilitySingleDrop(i, e) {
    ...
    if (((a = s.parent) == null ? void 0 : a.id) !== this.actor.id) {
      ...
      c = ((u = (await this.actor.createEmbeddedDocuments("Item", [f]))[0]) == null ? void 0 : u.id) ?? c;
    }
    await this.actor.update({
  ...
  async _onAbilityAreaDrop(i, e) {
    ...
    if (((f = s.parent) == null ? void 0 : f.id) !== this.actor.id) {
      ...
      c = ((y = (await this.actor.createEmbeddedDocuments("Item", [n]))[0]) == null ? void 0 : y.id) ?? c;
    }
    ...
    a.includes(c) || a.push(c), await this.actor.update({ [`system.abilities.${e}.items`]: a });
  }
  ...
  async _onMicrochipSlotDrop(i, e) {
    ...
    let r = c.id;
    ((y = c.parent) == null ? void 0 : y.id) !== this.actor.id && (r = ((h = (await this.actor.createEmbeddedDocuments("Item", [c.toObject()]))[0]) == null ? void 0 : h.id) ?? r), await this.actor.update({
      [`system.gear.microchips.${e}.itemId`]: r,
      [`system.gear.microchips.${e}.name`]: c.name,
  ...
  async _rollSkill(i, e) {
    ...
    r === 1 ? c -= 6 : r === 2 && (c -= 3);
    const u = `3d6${c !== 0 ? c > 0 ? `+${c}` : `${c}` : ""}`, f = new Roll(u);
  ...
  async _rollMorale() {
    var c;
    const i = Number(((c = this.actor.system.resources) == null ? void 0 : c.morale) ?? 0) || 0;
    if (i <= 0) return;
  ...
  async _rollWeapon(i) {
    var b;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, s = this.actor.system.skills ?? {}, c = this.actor.items.filter((S) => S.type === "Fegyver");
    let r = null;
    t.itemId && (r = c.find((S) => S.id === t.itemId) ?? null);
    const a = r && r.name || t.name || `Fegyver (${i})`, u = Number(t.bonus || 0) || 0, y = (((b = r == null ? void 0 : r.system) == null ? void 0 : b.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", h = Number(s[y] || 0) || 0, n = u + h, l = `3d6${n !== 0 ? n > 0 ? `+${n}` : `${n}` : ""}`, m = new Roll(l);
  ...
  async _rollWeaponDamage(i, e = "") {
    ...
    let c = (((n = s.system) == null ? void 0 : n.damage) ?? "").trim();
    if (!c && e && (c = (((((d = t.system) == null ? void 0 : d.weapons) ?? {})[e] ?? {}).damage ?? "").trim()), !c) {
...
const H = class H extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const s = (r) => {
      ...
      var a, u, f;
      return r && (((u = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : u.call(a, r)) || e.id && ((f = r.closest) == null ? void 0 : f.call(r, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (r) => {
      var u, f, y;
      const a = ((u = r.target) == null ? void 0 : u.form) ?? ((y = (f = r.target) == null ? void 0 : f.closest) == null ? void 0 : y.call(f, "form"));
      c(a) && s(a);
...
const z = class z extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    e._votvChange = (r) => {
      ...
      const u = (a == null ? void 0 : a.form) ?? ((f = a == null ? void 0 : a.closest) == null ? void 0 : f.call(a, "form"));
      c(u) && (clearTimeout(e._votvInputDebounce), e._votvInputDebounce = setTimeout(() => s(u), 300));
...
const W = class W extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    ...
    const s = (r) => {
      if (!r) return;
      const a = e._getFormDataForUpdate(r);
      Object.keys(a).length !== 0 && e.document.update(a).catch((u) => console.warn("VoidTargySheet save failed", u));
    }, c = (r) => {
      var a, u, f;
      return r && (((u = (a = e.element) == null ? void 0 : a.contains) == null ? void 0 : u.call(a, r)) || e.id && ((f = r.closest) == null ? void 0 : f.call(r, `#${CSS.escape(e.id)}`)));
    };
...
const Y = class Y extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(i) {
    super._attachFrameListeners(i);
    const e = this;
    if (e._votvProfileImgClick = (c) => {
      var a, u, f, y, h;
      if (!e.isEditable || !((a = e.element) != null && a.contains(c.target)) || !((f = (u = c.target) == null ? void 0 : u.closest) != null && f.call(u, ".profile")) && ((h = (y = c.target) == null ? void 0 : y.getAttribute) == null ? void 0 : h.call(y, "data-edit")) !== "img") return;
      c.preventDefault(), c.stopPropagation(), new FilePicker({
        type: "image",
        current: e.document.img || "",
        callback: (n) => {
          n && e.document.update({ img: n });
    ...
    const t = (c) => {
      if (!c) return;
      const r = e._getFormDataForUpdate(c);
      Object.keys(r).length !== 0 && e.document.update(r).catch((a) => console.warn("VoidEgyebSheet save failed", a));
    }, s = (c) => {
      var r, a, u;
      return c && (((a = (r = e.element) == null ? void 0 : r.contains) == null ? void 0 : a.call(r, c)) || e.id && ((u = c.closest) == null ? void 0 : u.call(c, `#${CSS.escape(e.id)}`)));
    };
    e._votvChange = (c) => {
      var a, u, f;
      const r = ((a = c.target) == null ? void 0 : a.form) ?? ((f = (u = c.target) == null ? void 0 : u.closest) == null ? void 0 : f.call(u, "form"));
      s(r) && t(r);
    }, document.body.addEventListener("change", e._votvChange, !0);
  }
  _tearDown(i) {
...
Hooks.once("init", () => {
  ...
  console.log("Vacuum of the Void | Initializing system"), game.votv = {
    ...
    value: []
  }, (s = CONFIG.Actor).typeLabels ?? (s.typeLabels = {}), CONFIG.Actor.typeLabels.Karakter = "Karakter", (c = CONFIG.Item).typeLabels ?? (c.typeLabels = {}), CONFIG.Item.typeLabels.Fegyver = "Fegyver", CONFIG.Item.typeLabels.Pancel = "Páncél", CONFIG.Item.typeLabels.MikroChip = "Mikro-Chip", CONFIG.Item.typeLabels.Kepesseg = "Képesség", CONFIG.Item.typeLabels.ability = "Képesség", CONFIG.Item.typeLabels.Targy = "Tárgy", CONFIG.Item.typeLabels.Egyeb = "Egyéb Információ", foundry.documents.collections.Actors.unregisterSheet("core", foundry.applications.sheets.ActorSheetV2), foundry.documents.collections.Actors.registerSheet("vacuum-of-the-void", ge, {
    types: ["Karakter"],
    makeDefault: !0,
  ...
  const E = 500;
  Hooks.on("updateActor", (r, a, u, f) => {
    var S, _, L, P, O;
    const y = r == null ? void 0 : r.id;
    if (!y) return;
    const h = document.activeElement, n = h && (h.tagName === "INPUT" && h.type !== "checkbox" && h.type !== "radio" || h.tagName === "TEXTAREA" || h.isContentEditable), d = [], l = (S = game.actors) == null ? void 0 : S.get(y);
...
Hooks.on("ready", () => {
  ...
  document.body.addEventListener(
    ...
    (e) => {
      ...
      c && ((h = game.actors) != null && h.get(c)) && (game.votv._dragSourceActorId = c);
    },
    !0
...
Hooks.on("preCreateToken", (E, i, e) => {
  ...
  const c = s ? (a = game.actors) == null ? void 0 : a.get(s) : null;
  !c || c.type !== "Karakter" || E.updateSource({
    ...t ? { actorId: t } : {},
    actorLink: !0
  });
});
...
Hooks.on("renderChatMessageHTML", (E, i, e) => {
  var c, r, a;
  const t = (r = (c = E.flags) == null ? void 0 : c["vacuum-of-the-void"]) == null ? void 0 : r.resultType;
  if (!t) return;
  const s = (a = i == null ? void 0 : i.querySelector) == null ? void 0 : a.call(i, ".dice-roll");
  s && s.classList.add(`votv-${t}`);
});
export {
  ge as V
};
//# sourceMappingURL=vacuum-of-the-void-CVGraXUc.mjs.map
