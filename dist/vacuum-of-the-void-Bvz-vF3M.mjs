...
const B = class B extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  async _prepareContext(s) {
    var _e, Me, Re, Ke, je, Ee, Le, st, it, rt, nt, at, ot, lt, ct, ut, dt, mt, pt, ft, yt, gt, ht, bt, kt;
    ...
    const S = this.actor.system.weapons ?? {}, q = ["slot1", "slot2", "slot3", "slot4", "slot5", "slot6", "slot7", "slot8", "slot9", "slot10"], N = (S.slotOrder ?? "").trim(), A = N ? N.split(/\s*,\s*/).filter((g) => q.includes(g)) : [], T = (rt = this.actor.system.gear) == null ? void 0 : rt.microchips, E = T && typeof T == "object" && !Array.isArray(T) ? T : {}, L = (((nt = E.slot1) == null ? void 0 : nt.itemId) ?? "").trim(), P = (((at = E.slot2) == null ? void 0 : at.itemId) ?? "").trim(), H = (((ot = E.slot3) == null ? void 0 : ot.itemId) ?? "").trim(), G = this.actor.items.contents.filter((g) => g.type !== "Kepesseg" && g.type !== "ability").slice().sort((g, D) => {
      ...
      for (let Pe = 0; Pe < A.length; Pe++) {
        ...
        if ((((fe = S[xe]) == null ? void 0 : fe.itemId) ?? "") === g.id) {
          F = Pe + 1, R = ((Oe = S[xe]) == null ? void 0 : Oe.bonus) ?? "", X = xe;
          break;
        }
      }
      let Q = null;
    ...
    e.microchipItemsSlot1 = ie.filter((g) => !x(1).includes(g.id)), e.microchipItemsSlot2 = ie.filter((g) => !x(2).includes(g.id)), e.microchipItemsSlot3 = ie.filter((g) => !x(3).includes(g.id)), e.microchipSlots = k.map((g) => {
      ...
      const F = !!O, R = ((Oe = g == null ? void 0 : g.system) == null ? void 0 : Oe.abilityType) ?? "", X = R === "active" ? "Aktív" : R === "passive" ? "Passzív" : R || "—", Q = R === "active", Fe = Number((Ce = g == null ? void 0 : g.system) == null ? void 0 : Ce.replaceCost) >= 0 ? Number(g.system.replaceCost) : 0, re = (((he = g == null ? void 0 : g.system) == null ? void 0 : he.description) ?? "").trim(), De = re ? re.length > 60 ? re.slice(0, 57) + "…" : re : "—";
      return {
        itemId: D,
        actorId: this.actor.id,
        name: (g == null ? void 0 : g.name) ?? "—",
  ...
  _attachFrameListeners(s) {
    ...
    if ($(document).off("click.votv-weapon-dropdown"), $(document).off("click.votv-microchip-dropdown"), t.on("click", ".karakter-weapon-attack", async (i) => {
      ...
      if (!o) return;
      const { openRollSheetForWeapon: n } = await import("./roll-sheet-DLiBkpdT.mjs");
      n(this.actor, o);
      ...
      i.preventDefault(), i.stopPropagation();
      const { openRollSheetForSkill: l } = await import("./roll-sheet-DLiBkpdT.mjs");
    ...
    t.on("input change", 'input[name="system.combat.defense"], input[name="system.combat.defenseBonus"], input[name="system.combat.speed"], input[name="system.combat.speedBonus"]', r), this._writeEffectiveGivenSpeed(s), this._writeEffectiveGivenSpeed(e), this._writeEffectiveGivenProtection(s), this._writeEffectiveGivenProtection(e), this._writeTotalDefense(s), this._writeTotalDefense(e), this._writeTotalSpeed(s), this._writeTotalSpeed(e), requestAnimationFrame(() => {
      ...
      var h;
      i.preventDefault();
      const l = i.currentTarget, o = l.dataset.skill, n = ((h = l.textContent) == null ? void 0 : h.trim()) || o, { openRollSheetForSkill: p } = await import("./roll-sheet-DLiBkpdT.mjs");
      p(this.actor, o, n);
...
const ee = class ee extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _attachFrameListeners(s) {
    ...
    t.on("click", ".karakter-inventory-item-name", (u) => {
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForWeapon: o } = await import("./roll-sheet-DLiBkpdT.mjs");
      o(this.actor, l);
      ...
      if (!l || !this.actor) return;
      const { openRollSheetForSkill: n } = await import("./roll-sheet-DLiBkpdT.mjs");
      n(this.actor, l, o);
...
//# sourceMappingURL=vacuum-of-the-void-Bvz-vF3M.mjs.map
