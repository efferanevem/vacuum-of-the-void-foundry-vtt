...
const C = class C extends foundry.applications.api.HandlebarsApplicationMixin(
  ...
  _getScrollContainers(i) {
    ...
    const e = ((r = i.querySelector) == null ? void 0 : r.call(i, "form.votv.karakter-sheet")) ?? ((a = i.querySelector) == null ? void 0 : a.call(i, "form.votv")) ?? null, t = ((n = i.querySelector) == null ? void 0 : n.call(i, ".votv-scroll")) ?? ((u = i.querySelector) == null ? void 0 : u.call(i, ".window-content")) ?? null;
  ...
  async render(i = !1, e = {}) {
    ...
    const b = this.element, k = this.form ?? this.element, v = u.scrollState, s = u.focus, o = typeof (v == null ? void 0 : v.formScrollTop) == "number" || typeof (v == null ? void 0 : v.windowScrollTop) == "number", c = () => {
      ...
      if (this._applyScrollState(b, v), (s == null ? void 0 : s.name) != null || (s == null ? void 0 : s.id) != null) {
        const w = ((m = k.querySelector) == null ? void 0 : m.call(k, s.id ? `#${CSS.escape(s.id)}` : null)) ?? (s.name ? (y = k.querySelector) == null ? void 0 : y.call(k, `[name="${CSS.escape(s.name)}"]`) : null);
  ...
  _writeEffectiveGivenSpeed(i = null) {
    ...
    const r = ((s = (v = this.actor) == null ? void 0 : v.system) == null ? void 0 : s.resources) ?? {}, a = ((c = (o = r.hitLocations) == null ? void 0 : o.legs) == null ? void 0 : c.value) ?? 0, n = ((l = r.currentHealth) == null ? void 0 : l.legs) ?? 0, u = C._healthStatusFromRatio(n, a), p = Number(((w = (y = (m = this.actor) == null ? void 0 : m.system) == null ? void 0 : y.combat) == null ? void 0 : w.givenSpeed) ?? 0) || 0;
    let b;
  ...
  static _getSkillHealthStatusStatic(i, e) {
    ...
    if (t == null) return;
    const r = ((u = i == null ? void 0 : i.system) == null ? void 0 : u.resources) ?? {}, a = ((b = (p = r.hitLocations) == null ? void 0 : p[t]) == null ? void 0 : b.value) ?? 0, n = ((k = r.currentHealth) == null ? void 0 : k[t]) ?? 0;
  ...
  _attachFrameListeners(i) {
    ...
    a && r({ currentTarget: a }), this._writeEffectiveGivenSpeed(i), this._writeEffectiveGivenSpeed(e), requestAnimationFrame(() => this._writeEffectiveGivenSpeed()), setTimeout(() => this._writeEffectiveGivenSpeed(), 100), t.on("click", ".karakter-portrait-img", (s) => {
      ...
      var y;
      s.preventDefault();
      const o = s.currentTarget, c = o.dataset.skill, l = ((y = o.textContent) == null ? void 0 : y.trim()) || c, { openRollSheetForSkill: m } = await import("./roll-sheet-D3mMtqud.mjs");
      m(this.actor, c, l);
    ...
    }), t.on("input", ".karakter-weapon-quantity-input", (s) => {
      this._resizeWeaponQuantityInput(s.currentTarget);
    }), t.on("blur", ".karakter-weapon-quantity-input", (s) => {
      this._resizeWeaponQuantityInput(s.currentTarget);
  ...
  _getFormDataForUpdate(i) {
    ...
    for (const k of n) {
      const v = ((b = r[k]) == null ? void 0 : b.value) ?? 0, s = a[k] ?? 0;
      foundry.utils.setProperty(e, `system.resources.healthStatus.${k}`, C._healthStatusFromRatio(s, v));
    }
    return e;
  }
  async _onDropItem(i, e) {
    var n, u, p, b, k, v, s, o, c, l, m, y;
    const t = i.target, r = (n = t == null ? void 0 : t.closest) == null ? void 0 : n.call(t, ".karakter-ability-slot-single"), a = (u = t == null ? void 0 : t.closest) == null ? void 0 : u.call(t, ".karakter-ability-area");
    if (e) {
  ...
  _resizeWeaponQuantityInput(i) {
    ...
    const t = i.value, r = window.getComputedStyle(i), a = document.createElement("span");
    a.setAttribute("aria-hidden", "true"), a.style.cssText = [
      "position:absolute",
      "left:-9999px",
      "visibility:hidden",
      "white-space:pre",
    ...
    ].join(";"), a.textContent = t, document.body.appendChild(a);
    const n = Math.ceil(a.getBoundingClientRect().width);
    document.body.removeChild(a), i.style.width = `${Math.max(e, n)}px`;
  }
  async _postAbilityToChat(i) {
    var k, v, s;
    const e = this.actor.items.get(i);
    if (!e || e.type !== "ability") return;
    const t = ((k = e.system) == null ? void 0 : k.kind) ?? "passive", r = Number(((v = e.system) == null ? void 0 : v.kp) ?? 0) || 0, a = (((s = e.system) == null ? void 0 : s.description) ?? "").trim(), n = t === "active" ? "Aktív" : t === "species" ? "Faji" : t === "background" ? "Háttér" : "Passzív", u = r > 0 ? `<p><strong>KP:</strong> ${r}</p>` : "", p = a ? `<p>${a}</p>` : "", b = `
      <h2>${e.name}</h2>
  ...
  async _rollWeapon(i) {
    var w;
    const t = (this.actor.system.weapons ?? {})[i] ?? {}, r = this.actor.system.skills ?? {}, a = this.actor.items.filter((g) => g.type === "Fegyver");
    let n = null;
    t.itemId && (n = a.find((g) => g.id === t.itemId) ?? null);
    const u = n && n.name || t.name || `Fegyver (${i})`, p = Number(t.bonus || 0) || 0, k = (((w = n == null ? void 0 : n.system) == null ? void 0 : w.type) || "kinetic") === "explosive" ? "grenadeUse" : "firearms", v = Number(r[k] || 0) || 0, s = p + v, c = `3d6${s !== 0 ? s > 0 ? `+${s}` : `${s}` : ""}`, l = new Roll(c);
...
Hooks.once("init", () => {
  ...
  Hooks.on("updateActor", (n, u, p, b) => {
    ...
    if (!k) return;
    const v = document.activeElement, s = v && (v.tagName === "INPUT" && v.type !== "checkbox" && v.type !== "radio" || v.tagName === "TEXTAREA" || v.isContentEditable), o = [], c = (g = game.actors) == null ? void 0 : g.get(k);
...
Hooks.on("ready", () => {
  document.body.addEventListener(
    ...
    (N) => {
      var r, a, n, u, p, b;
      if (!((a = (r = N.target) == null ? void 0 : r.closest) != null && a.call(r, "#actors"))) return;
...
//# sourceMappingURL=vacuum-of-the-void-15-e_-by.mjs.map
